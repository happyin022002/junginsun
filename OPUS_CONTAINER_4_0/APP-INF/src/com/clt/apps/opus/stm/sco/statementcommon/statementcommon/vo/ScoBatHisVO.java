...
*@FileName : ScoBatHisVO.java
*@FileTitle : ScoBatHisVO
*Open Issues :
*Change history :
...
public class ScoBatHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScoBatHisVO> models = new ArrayList<ScoBatHisVO>();
	...
	public ScoBatHisVO(String ibflag, String pagerows, String batSeq, String pgmSubSysCd, String batPgmNo, String applPgmNo, String batParaCtnt, String batStDt, String batEndDt, String batRsltCd, String batRsltDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return ScoBatHisVO[]
	 */
	public ScoBatHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScoBatHisVO[]
	 */
	public ScoBatHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScoBatHisVO model = null;
	 ...
	 * @return ScoBatHisVO[]
	 */
	public ScoBatHisVO[] getScoBatHisVOs(){
		ScoBatHisVO[] vos = (ScoBatHisVO[])models.toArray(new ScoBatHisVO[models.size()]);
		return vos;
	}
