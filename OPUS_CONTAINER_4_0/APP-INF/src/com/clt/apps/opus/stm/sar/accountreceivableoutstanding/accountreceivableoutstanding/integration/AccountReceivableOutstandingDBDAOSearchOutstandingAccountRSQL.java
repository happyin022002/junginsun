...
*@FileName : AccountReceivableOutstandingDBDAOSearchOutstandingAccountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOSearchOutstandingAccountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOSearchOutstandingAccountRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOSearchOutstandingAccountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	AND ((ACCT_TP_CD = @[acct_tp_cd] AND REV_ACCT_DIV_CD <> 'P') OR REV_ACCT_DIV_CD = 'P')" ).append("\n"); 
