...
*@FileName : StatementCommonDBDAOInsertLookupHeaderCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOInsertLookupHeaderCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StatementCommonDBDAOInsertLookupHeaderCSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOInsertLookupHeaderCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCO_LU_HDR" ).append("\n"); 
		query.append("(LU_APPL_CD" ).append("\n"); 
