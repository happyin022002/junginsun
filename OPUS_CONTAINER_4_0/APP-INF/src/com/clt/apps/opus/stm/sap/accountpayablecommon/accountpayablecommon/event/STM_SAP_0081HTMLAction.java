...
*@FileName : STM_SAP_0081HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class STM_SAP_0081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0081HTMLAction 객체를 생성
	 */
	public STM_SAP_0081HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0081Event event = new StmSap0081Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setBankBranchVO((BankBranchVO) getVO(request, BankBranchVO.class));
		}
