...
*@FileName : AdjustHisListVO.java
*@FileTitle : AdjustHisListVO
*Open Issues :
*Change history :
...
public class AdjustHisListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AdjustHisListVO> models = new ArrayList<AdjustHisListVO>();
...
/**
	 ...
	 * @param request
	 * @return AdjustHisListVO[]
	 */
	public AdjustHisListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AdjustHisListVO[]
	 */
	public AdjustHisListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AdjustHisListVO model = null;
	 ...
	 * @return AdjustHisListVO[]
	 */
	public AdjustHisListVO[] getAdjustHisListVOs(){
		AdjustHisListVO[] vos = (AdjustHisListVO[])models.toArray(new AdjustHisListVO[models.size()]);
		return vos;
	}
