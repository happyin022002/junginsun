...
*@FileName : STM_SAP_0032HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : Hannh Lee
*@LastVersion : 1.0
...
public class STM_SAP_0032HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0032HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0032Event event = new StmSap0032Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {								
		    ...
		    String callFlag	 = JSPUtil.getParameter(request, "call_flag" , "");
		    String vndr_name	 = JSPUtil.getParameter(request, "vndr_name" , "");
		    
			event.setVndr_seq(vndr_seq);
			event.setCurr_cd(curr_cd);
			event.setBankAcctTpNm(bankAcctTpNm);
			event.setCallFlag(callFlag);
			event.setVndr_name(vndr_name);
		}
