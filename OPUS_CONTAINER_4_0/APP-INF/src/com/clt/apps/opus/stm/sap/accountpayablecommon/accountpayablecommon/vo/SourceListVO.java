...
*@FileName : SourceListVO.java
*@FileTitle : SourceListVO
*Open Issues :
*Change history :
...
public class SourceListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SourceListVO> models = new ArrayList<SourceListVO>();
	...
	public SourceListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @return SourceListVO[]
	 */
	public SourceListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SourceListVO[]
	 */
	public SourceListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SourceListVO model = null;
	 ...
	 * @return SourceListVO[]
	 */
	public SourceListVO[] getSourceListVOs(){
		SourceListVO[] vos = (SourceListVO[])models.toArray(new SourceListVO[models.size()]);
		return vos;
	}
