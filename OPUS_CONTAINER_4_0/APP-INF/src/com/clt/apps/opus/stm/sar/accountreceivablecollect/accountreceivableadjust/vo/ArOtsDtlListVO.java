...
*@FileName : ArOtsDtlListVO.java
*@FileTitle : ArOtsDtlListVO
*Open Issues :
*Change history :
...
public class ArOtsDtlListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ArOtsDtlListVO> models = new ArrayList<ArOtsDtlListVO>();
...
/**
	 ...
	 * @param request
	 * @return ArOtsDtlListVO[]
	 */
	public ArOtsDtlListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ArOtsDtlListVO[]
	 */
	public ArOtsDtlListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ArOtsDtlListVO model = null;
	 ...
	 * @return ArOtsDtlListVO[]
	 */
	public ArOtsDtlListVO[] getArOtsDtlListVOs(){
		ArOtsDtlListVO[] vos = (ArOtsDtlListVO[])models.toArray(new ArOtsDtlListVO[models.size()]);
		return vos;
	}
