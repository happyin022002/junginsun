...
public class STM_SAR_2005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_1003HTMLAction 객체를 생성
	 */
	public STM_SAR_2005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar2005Event event = new StmSar2005Event();

    	RCTViewAccountingListVO paramVO = (RCTViewAccountingListVO)getVO(request, RCTViewAccountingListVO.class);    	
		event.setRctViewAccountingListVO(paramVO);
