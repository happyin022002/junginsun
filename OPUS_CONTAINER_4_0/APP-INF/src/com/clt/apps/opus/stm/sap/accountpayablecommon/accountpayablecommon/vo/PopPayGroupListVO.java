...
*@FileName : PopPayGroupListVO.java
*@FileTitle : PopPayGroupListVO
*Open Issues :
*Change history :
...
public class PopPayGroupListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PopPayGroupListVO> models = new ArrayList<PopPayGroupListVO>();
	...
	public PopPayGroupListVO() {}

	public PopPayGroupListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @param request
	 * @return PopPayGroupListVO[]
	 */
	public PopPayGroupListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PopPayGroupListVO[]
	 */
	public PopPayGroupListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PopPayGroupListVO model = null;
	 ...
	 * @return PopPayGroupListVO[]
	 */
	public PopPayGroupListVO[] getPopPayGroupListVOs(){
		PopPayGroupListVO[] vos = (PopPayGroupListVO[])models.toArray(new PopPayGroupListVO[models.size()]);
		return vos;
	}
