...
*@FileName : AccountReceivableCommonDBDAOsearchOtsSourceExcludeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableCommonDBDAOsearchOtsSourceExcludeListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Outstanding Source To Exclude  Popup
	  * </pre>
	  */
	public AccountReceivableCommonDBDAOsearchOtsSourceExcludeListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.stm.sar.accountreceivablecommon.accountreceivablecommon.integration").append("\n"); 
		query.append("FileName : AccountReceivableCommonDBDAOsearchOtsSourceExcludeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   D.LU_TP_CD = 'OTS SRC CD'" ).append("\n"); 
