...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvHeaderCancelInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailInvHeaderCancelInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailInvHeaderCancelInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailInvHeaderCancelInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvHeaderCancelInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            , DECODE(SIGN(NVL(SIH.INV_CXL_AMT, SIH.INV_AMT) * (-1)), -1, NVL(SIH.INV_CXL_AMT, SIH.INV_AMT), NULL)                    AS INP_DR_AMT" ).append("\n"); 
		query.append("            , DECODE(SIGN(NVL(SIH.INV_CXL_AMT, SIH.INV_AMT) * (-1)), -1, NULL, (NVL(SIH.INV_CXL_AMT, SIH.INV_AMT)) * (-1))           AS INP_CR_AMT" ).append("\n"); 
		query.append("            , DECODE(SIGN(NVL(SIH.INV_CXL_AMT, SIH.INV_AMT) * (-1)), -1, ROUND((NVL(SIH.INV_CXL_AMT, SIH.INV_AMT)) * NVL(SIH.INV_XCH_RT, 1), " ).append("\n"); 
		...
		query.append("            , DECODE(SIGN(NVL(SIH.INV_CXL_AMT, SIH.INV_AMT) * (-1)), -1, NULL, ROUND(((NVL(SIH.INV_CXL_AMT, SIH.INV_AMT)) * (-1)) * NVL(SIH.INV_XCH_RT, 1), " ).append("\n"); 
