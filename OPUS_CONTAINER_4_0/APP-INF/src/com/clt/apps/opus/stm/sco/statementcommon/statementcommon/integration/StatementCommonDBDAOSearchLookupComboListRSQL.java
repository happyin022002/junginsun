...
*@FileName : StatementCommonDBDAOSearchLookupComboListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOSearchLookupComboListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchLookupComboList
	  * </pre>
	  */
	public StatementCommonDBDAOSearchLookupComboListRSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOSearchLookupComboListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
