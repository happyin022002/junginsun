...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddInterfaceSAPStandardJPHeaderPrepayInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                      , 'LIABILITY(PREPAY)' AS IF_ITEM_CATEGROY" ).append("\n"); 
		query.append("                FROM    ( " ).append("\n"); 
		...
		query.append("                              , ROUND((SID.DTRB_AMT - NVL(SID.GLO_ATTR_CTNT1, 0)) * NVL(SID.DTRB_XCH_RT, SIH.INV_XCH_RT), " ).append("\n"); 
		...
		query.append("                              , SID.DTRB_AMT - NVL(SID.GLO_ATTR_CTNT1, 0) AS DTRB_AMT" ).append("\n"); 
		...
		query.append("                                                'A106') ) )         AS BIZ_PARTNER_REF_KEY1 --2015.02.09 수정 -- 2015.01.28 변경 -- Profit Center (Code Conversion)" ).append("\n"); 
		...
		query.append("                              , SID.ATTR_CTNT1                      AS PAYMENT_REFERENCE  --2015.01.26 수정 -- Vendor Invoice No Check" ).append("\n"); 
		...
		query.append("                        AND     SID.DTRB_AMT - NVL(SID.GLO_ATTR_CTNT1, 0) <> 0 )" ).append("\n"); 
