...
*@FileName : AccountReceivableCommonDBDAOsearchAdjustReceiptNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableCommonDBDAOsearchAdjustReceiptNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Adjust No, Receipt No 조회
	  * </pre>
	  */
	public AccountReceivableCommonDBDAOsearchAdjustReceiptNoRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableCommonDBDAOsearchAdjustReceiptNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT AR_TJ_TP_CD||TP_OFC_CD||TP_CRE_DT||LPAD(TP_SEQ+1,5,'0') AS ADJ_REC_NO" ).append("\n"); 
