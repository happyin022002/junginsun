...
*@FileName : AccountPayableCommonDBDAOModifyAPVendorInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOModifyAPVendorInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountPayableCommonDBDAOModifyAPVendorInfoUSQL(){
		setQuery();
		...
		params.put("pay_cd_cmb_seq",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.stm.sap.accountpayablecommon.accountpayablecommon.integration").append("\n"); 
		query.append("FileName : AccountPayableCommonDBDAOModifyAPVendorInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SAP_VENDOR" ).append("\n"); 
		query.append("SET" ).append("\n"); 
		query.append("     LIAB_CD_CMB_SEQ = @[liab_cd_cmb_seq]" ).append("\n"); 
		query.append("   , PAY_CD_CMB_SEQ = @[pay_cd_cmb_seq]" ).append("\n"); 
		query.append("   , PAY_PRIO_CD =  @[pay_prio_cd]" ).append("\n"); 
		query.append("   , UPD_USR_ID = @[usr_id]" ).append("\n"); 
		query.append("   , UPD_DT = SYSDATE" ).append("\n"); 
		query.append("WHERE  1=1" ).append("\n"); 
		query.append("AND    VNDR_NO = @[vndr_no]" ).append("\n"); 
