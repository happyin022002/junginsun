...
*@FileName : AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingHistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingHistRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search interface for Outstanding History
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingHistRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingHistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT A.IF_NO" ).append("\n"); 
		...
		query.append("	, A.BL_CURR_CD CURR_CD" ).append("\n"); 
		...
		query.append("	, A.IF_NO REF_NO" ).append("\n"); 
		...
		query.append("	, A.VSL_CD||A.SKD_VOY_NO||A.DIR_CD||A.DIR_CD REV_VVD_CD" ).append("\n"); 
