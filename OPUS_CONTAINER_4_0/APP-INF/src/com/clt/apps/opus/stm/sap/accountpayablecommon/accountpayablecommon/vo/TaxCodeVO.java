...
public class TaxCodeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TaxCodeVO> models = new ArrayList<TaxCodeVO>();
	...
	public TaxCodeVO(String ibflag, String pagerows, String apTaxNm, String taxNo, String taxRt, String taxNaidFlg, String faFlg, String taxNslFlg, String avalFlg, String creUsrId, String creDt, String updUsrId, String updDt, String eaiEvntDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTaxRt(JSPUtil.getParameter(request, prefix + "tax_rt", ""));
		...
		setTaxNo(JSPUtil.getParameter(request, prefix + "tax_no", ""));
	 ...
	 * @return TaxCodeVO[]
	 */
	public TaxCodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TaxCodeVO[]
	 */
	public TaxCodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TaxCodeVO model = null;
	...
	public TaxCodeVO[] getTaxCodeVOs(){
		TaxCodeVO[] vos = (TaxCodeVO[])models.toArray(new TaxCodeVO[models.size()]);
		return vos;
	}
