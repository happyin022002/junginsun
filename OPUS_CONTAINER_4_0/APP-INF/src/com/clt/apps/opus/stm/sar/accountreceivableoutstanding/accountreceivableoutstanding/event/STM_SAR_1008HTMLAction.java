...
public class STM_SAR_1008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_1003HTMLAction 객체를 생성
	 */
	public STM_SAR_1008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar1008Event event = new StmSar1008Event();

    	OTSViewAccountingListVO paramVO = (OTSViewAccountingListVO)getVO(request, OTSViewAccountingListVO.class);    	
		event.setOtsViewAccountingListVO(paramVO);
