...
*@FileName : STM_SAP_0012HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0012Event event = new StmSap0012Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			String registerNo  = JSPUtil.getParameter(request, "rgst_no" , "");
