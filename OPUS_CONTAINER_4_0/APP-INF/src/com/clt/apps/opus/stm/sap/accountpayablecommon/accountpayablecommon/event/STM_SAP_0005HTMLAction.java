...
*@FileName : STM_SAP_0005HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0005Event event = new StmSap0005Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			String source  = JSPUtil.getParameter(request, "lu_cd" , "");
