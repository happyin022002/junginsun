...
*@FileName : AccountReceivalbeAgentDBDAOsearchAgentCollectionListInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivalbeAgentDBDAOsearchAgentCollectionListInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivalbeAgentDBDAOsearchAgentCollectionListInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivalbeAgentDBDAOsearchAgentCollectionListInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" ASA_NO         ,BL_NO      ,INV_NO         ,CHG_TP_CD       ,ASA_CLT_SEQ     " ).append("\n"); 
		query.append(",AR_OFC_CD      ,VVD_CD     ,PORT_CD        ,ASA_XCH_RT1     ,ASA_CURR_CD" ).append("\n"); 
		query.append(",ASA_XCH_RT2    ,ASA_RMK    ,AGN_CD         ,SVC_SCP_CD      ,EFF_DT" ).append("\n"); 
		query.append(",IB_OB_CD       ,GL_YRMON   ,LOCL_CURR_CD   ,SAIL_ARR_DT     ,TO_CHAR(DUE_DT,'YYYYMMDD') AS DUE_DT" ).append("\n"); 
		query.append(",ASA_TP_CD      ,TTL_AMT    ,USD_AMT        ,CHG_USD_AMT     ,EQV_LOCL_AMT" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(", EQV_LOCL_AMT2  ,LOCL_AMT" ).append("\n"); 
		query.append("" ).append("\n"); 
