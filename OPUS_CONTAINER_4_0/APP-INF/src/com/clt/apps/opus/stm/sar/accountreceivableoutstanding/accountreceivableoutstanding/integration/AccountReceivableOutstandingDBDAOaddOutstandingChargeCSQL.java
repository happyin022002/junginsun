...
*@FileName : AccountReceivableOutstandingDBDAOaddOutstandingChargeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOaddOutstandingChargeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOaddOutstandingChargeCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOaddOutstandingChargeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SAR_OTS_CHG" ).append("\n"); 
		query.append("(" ).append("\n"); 
