...
*@FileName : ReceiptListByBankDateVO.java
*@FileTitle : ReceiptListByBankDateVO
*Open Issues :
*Change history :
...
public class ReceiptListByBankDateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ReceiptListByBankDateVO> models = new ArrayList<ReceiptListByBankDateVO>();
	
	/* Column Info */
	private String uniAmt = null;
	/* Column Info */
	private String rctOrDpsDt = null;
	/* Column Info */
	...
	public ReceiptListByBankDateVO() {}

	public ReceiptListByBankDateVO(String ibflag, String pagerows, String rctOfcCd, String bankAcctNm, String rctOrDpsDt, String rctCurrCd, String rctAmt, String unaAmt, String uniAmt, String bouAmt, String refAmt) {
		this.uniAmt = uniAmt;
		this.rctOrDpsDt = rctOrDpsDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rct_or_dps_dt", getRctOrDpsDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rct_or_dps_dt", "rctOrDpsDt");
	 ...
	 * @return rctOrDpsDt
	 */
	public String getRctOrDpsDt() {
		return this.rctOrDpsDt;
	}
	 ...
	 * @param rctOrDpsDt
	 */
	public void setRctOrDpsDt(String rctOrDpsDt) {
		this.rctOrDpsDt = rctOrDpsDt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRctOrDpsDt(JSPUtil.getParameter(request, prefix + "rct_or_dps_dt", ""));
	 ...
	 * @param request
	 * @return ReceiptListByBankDateVO[]
	 */
	public ReceiptListByBankDateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ReceiptListByBankDateVO[]
	 */
	public ReceiptListByBankDateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ReceiptListByBankDateVO model = null;
		...
		try {
			...
			String[] rctOrDpsDt = (JSPUtil.getParameter(request, prefix	+ "rct_or_dps_dt", length));
			...
			for (int i = 0; i < length; i++) {
				model = new ReceiptListByBankDateVO();
				if (uniAmt[i] != null)
					model.setUniAmt(uniAmt[i]);
				if (rctOrDpsDt[i] != null)
					model.setRctOrDpsDt(rctOrDpsDt[i]);
				if (rctCurrCd[i] != null)
		...
		return getReceiptListByBankDateVOs();
	}
	 ...
	 * @return ReceiptListByBankDateVO[]
	 */
	public ReceiptListByBankDateVO[] getReceiptListByBankDateVOs(){
		ReceiptListByBankDateVO[] vos = (ReceiptListByBankDateVO[])models.toArray(new ReceiptListByBankDateVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.rctOrDpsDt = this.rctOrDpsDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
