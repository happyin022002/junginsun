...
*@FileName : AccountPayableCommonDBDAOAddAPVendorInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOAddAPVendorInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountPayableCommonDBDAOAddAPVendorInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOAddAPVendorInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SAP_VENDOR ( " ).append("\n"); 
		query.append("VNDR_NO" ).append("\n"); 
		query.append(", LIAB_CD_CMB_SEQ" ).append("\n"); 
		query.append(", PAY_CD_CMB_SEQ" ).append("\n"); 
