...
*@FileName : AccountReceivableCollectIFDBDAOmodifyDtrbStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableCollectIFDBDAOmodifyDtrbStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableCollectIFDBDAOmodifyDtrbStatusUSQL(){
		setQuery();
		...
		params.put("clt_dtrb_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccountReceivableCollectIFDBDAOmodifyDtrbStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE CLT_DTRB_SEQ =  @[clt_dtrb_seq]" ).append("\n"); 
