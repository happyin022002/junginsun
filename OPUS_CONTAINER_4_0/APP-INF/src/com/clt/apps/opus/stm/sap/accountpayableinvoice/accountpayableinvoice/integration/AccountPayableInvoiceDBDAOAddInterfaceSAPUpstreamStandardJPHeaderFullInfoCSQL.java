...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardJPHeaderFullInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardJPHeaderFullInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 국내지역 선급금 정산 처리시 Line의 Activity Date의 의한 환율과 Apply 선급금 Header G/L date간의 동일 환율 적용시 전체 금액 대 남은 금액을 직접 계산시 Round 발생 내역에 대해서 추가 처리
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardJPHeaderFullInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardJPHeaderFullInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
