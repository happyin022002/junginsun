...
*@FileName : STM_SAP_0230HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0230HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0230HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0230Event event = new StmSap0230Event();

        // 전성운 추가 시작
    	if(command.isCommand(FormCommand.SEARCH)) {								
			
			String bankNm = JSPUtil.getParameter(request, "bank_nm" , "");
			
			event.setBankNm(bankNm);
		}    	
        // 전성운 추가 끝
