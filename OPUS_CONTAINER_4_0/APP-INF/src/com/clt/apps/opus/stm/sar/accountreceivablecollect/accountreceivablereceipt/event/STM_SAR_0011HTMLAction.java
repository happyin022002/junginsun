...
*@FileName : STM_SAR_0011HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_0011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_0011HTMLAction 객체를 생성
	 */
	public STM_SAR_0011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar0011Event event = new StmSar0011Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setUnapplyReceiptCondVO((UnapplyReceiptCondVO)getVO(request, UnapplyReceiptCondVO .class));
		}
