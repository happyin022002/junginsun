...
*@FileName : AccountPayablePaymentDBDAOModifySOInterfaceTRSRailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOModifySOInterfaceTRSRailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySOInterfaceTRSRail
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOModifySOInterfaceTRSRailUSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOModifySOInterfaceTRSRailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--		,INV_CHK_TRNS_NO		= [INV_CHK_TRNS_NO]   -- 용도는 AP에서의 SERVICE PROVIDER에 대한 INTERFACE되는 INVOICE CHECK TRANSFER NUMBER " ).append("\n"); 
		query.append("--		,INV_PAY_MZD_CD 		= [INV_PAY_MZD_CD]				" ).append("\n"); 
		query.append("--WHERE 	CSR_NO" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UPDATE TRS_TRSP_RAIL_INV_WRK A" ).append("\n"); 
