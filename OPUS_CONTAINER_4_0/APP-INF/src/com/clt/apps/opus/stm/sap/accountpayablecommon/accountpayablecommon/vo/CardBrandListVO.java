...
*@FileName : CardBrandListVO.java
*@FileTitle : CardBrandListVO
*Open Issues :
*Change history :
...
public class CardBrandListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CardBrandListVO> models = new ArrayList<CardBrandListVO>();
	...
	public CardBrandListVO() {}

	public CardBrandListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @param request
	 * @return CardBrandListVO[]
	 */
	public CardBrandListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CardBrandListVO[]
	 */
	public CardBrandListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CardBrandListVO model = null;
	 ...
	 * @return CardBrandListVO[]
	 */
	public CardBrandListVO[] getCardBrandListVOs(){
		CardBrandListVO[] vos = (CardBrandListVO[])models.toArray(new CardBrandListVO[models.size()]);
		return vos;
	}
