...
*@FileName : AccountPayableCommonDBDAOSearchPopSourceListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOSearchPopSourceListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * STM_SAP_0211의 검색조건 VO
	  * </pre>
	  */
	public AccountPayableCommonDBDAOSearchPopSourceListRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOSearchPopSourceListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND SLH.LU_TP_CD = 'AP SOURCE'" ).append("\n"); 
