...
*@FileName : STM_SAR_5004HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_5004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_5004HTMLAction 객체를 생성
	 */
	public STM_SAR_5004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar5004Event event = new StmSar5004Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {			
			
			UnreportedOtsReportVO vo = (UnreportedOtsReportVO)getVO(request, UnreportedOtsReportVO .class);
		    event.setUnreportedOtsReportVO(vo);
