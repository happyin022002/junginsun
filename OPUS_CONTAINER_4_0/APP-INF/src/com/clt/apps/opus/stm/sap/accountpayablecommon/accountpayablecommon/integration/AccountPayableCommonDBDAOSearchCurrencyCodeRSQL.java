...
*@FileName : AccountPayableCommonDBDAOSearchCurrencyCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOSearchCurrencyCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountPayableCommonDBDAOSearchCurrencyCodeRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOSearchCurrencyCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND CURR_CD = @[value0]" ).append("\n"); 
