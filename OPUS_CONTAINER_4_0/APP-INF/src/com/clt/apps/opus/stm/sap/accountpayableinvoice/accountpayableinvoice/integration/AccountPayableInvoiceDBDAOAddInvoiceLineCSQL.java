...
*@FileName : AccountPayableInvoiceDBDAOAddInvoiceLineCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInvoiceLineCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInvoiceLineCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInvoiceLineCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append(" TO_DATE( REPLACE( @[acctg_dt], '-', ''), 'YYYYMMDD')" ).append("\n"); 
		query.append(",@[accl_bk_pst_flg]" ).append("\n"); 
		query.append(",NVL( @[aset_add_flg], 'N')" ).append("\n"); 
		query.append(",NVL( @[aset_trak_flg], 'N')" ).append("\n"); 
		query.append(",@[csh_bk_pst_flg]" ).append("\n"); 
		query.append(",@[dtrb_line_no]" ).append("\n"); 
		query.append(",@[dtrb_coa_co_cd]" ).append("\n"); 
		query.append(",@[dtrb_coa_rgn_cd]" ).append("\n"); 
		...
		query.append(",@[inv_seq]" ).append("\n"); 
		query.append(",@[line_tp_lu_cd]" ).append("\n"); 
		query.append(",NVL ( @[eff_yrmon], SUBSTR(REPLACE( @[acctg_dt], '-', ''), 0, 6) ) " ).append("\n"); 
		query.append(",ROUND( TO_NUMBER( REPLACE( @[dtrb_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",ROUND( TO_NUMBER( REPLACE( @[dtrb_func_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",ROUND( TO_NUMBER( REPLACE( @[inv_rnd_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",@[bat_seq]" ).append("\n"); 
		query.append(",@[dtrb_desc]" ).append("\n"); 
		query.append(",NVL (@[mtch_sts_flg], 'A')" ).append("\n"); 
		query.append(",NVL (@[acctg_pst_flg], 'N' ) " ).append("\n"); 
		query.append(",@[rvs_flg]" ).append("\n"); 
		query.append(",TO_DATE(REPLACE( @[dtrb_xch_dt], '-', ''),'YYYYMMDD')" ).append("\n"); 
		query.append(",@[dtrb_xch_rt]" ).append("\n"); 
		query.append(",@[dtrb_xch_rt_tp_cd]" ).append("\n"); 
		query.append(",REPLACE(@[attr_ctnt1], chr(9), '')" ).append("\n"); 
		query.append(",REPLACE( @[attr_ctnt2], '-', '')" ).append("\n"); 
		query.append(",@[attr_ctnt3]" ).append("\n"); 
		query.append(",@[attr_ctnt4]" ).append("\n"); 
		query.append(",@[attr_ctnt5]" ).append("\n"); 
		query.append(",@[attr_ctnt6]" ).append("\n"); 
		...
		query.append(",@[attr_ctnt9]" ).append("\n"); 
		query.append(",@[attr_ctnt10]" ).append("\n"); 
		query.append(",REPLACE( @[attr_ctnt11], '-', '')" ).append("\n"); 
		query.append(",@[attr_ctnt12]" ).append("\n"); 
		query.append(",@[attr_ctnt13]" ).append("\n"); 
		query.append(",@[attr_ctnt14]" ).append("\n"); 
		query.append(",@[attr_ctnt15]" ).append("\n"); 
		query.append(",NVL ( @[attr_cate_nm], @[dtrb_coa_acct_no] ) " ).append("\n"); 
		query.append(",ROUND( TO_NUMBER( REPLACE( @[ppay_rmn_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",@[glo_attr_cate_nm]" ).append("\n"); 
		query.append(",@[glo_attr_ctnt1]" ).append("\n"); 
		query.append(",@[glo_attr_ctnt2]" ).append("\n"); 
		query.append(",@[glo_attr_ctnt3]" ).append("\n"); 
		...
		query.append(",@[glo_attr_ctnt19]" ).append("\n"); 
		query.append(",@[glo_attr_ctnt20]" ).append("\n"); 
		query.append(",NVL( @[dtrb_mtch_tp_nm],'NOT_MATCHED' ) " ).append("\n"); 
		query.append(",SAP_INV_DTL_SEQ.NEXTVAL" ).append("\n"); 
		query.append(",@[prnt_rvs_dtrb_seq]" ).append("\n"); 
		query.append(",@[acctg_evnt_seq]" ).append("\n"); 
		query.append(",@[ppay_dtrb_seq]" ).append("\n"); 
		query.append(",NVL ( @[dtrb_clss_nm],'PERMANENT' ) " ).append("\n"); 
		query.append(",@[dtrb_vat_cd]" ).append("\n"); 
		query.append(",@[old_dtrb_seq]" ).append("\n"); 
		...
		query.append(",@[usr_id]" ).append("\n"); 
		query.append(",SYSDATE" ).append("\n"); 
		query.append(",TO_NUMBER( @[dtrb_cd_cmb_seq] )" ).append("\n"); 
		query.append(",REPLACE( @[dtrb_func_gain_amt], ',', '')" ).append("\n"); 
		query.append(",REPLACE( @[dtrb_func_lss_amt], ',', '')" ).append("\n"); 
		query.append(")" ).append("\n"); 
