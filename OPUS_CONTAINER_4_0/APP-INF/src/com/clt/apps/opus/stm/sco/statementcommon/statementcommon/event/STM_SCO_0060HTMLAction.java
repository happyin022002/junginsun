...
*@FileName : STM_SCO_0060HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SCO_0060HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SCO_0060HTMLAction 객체를 생성
	 */
	public STM_SCO_0060HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 StmSco0060Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {		
    	...
    	StmSco0060Event event = new StmSco0060Event();
		
    	if(command.isCommand(FormCommand.MULTI)) {
			event.setRevenuePortEachLaneVOs((RevenuePortEachLaneVO[])getVOs(request, RevenuePortEachLaneVO.class,""));
