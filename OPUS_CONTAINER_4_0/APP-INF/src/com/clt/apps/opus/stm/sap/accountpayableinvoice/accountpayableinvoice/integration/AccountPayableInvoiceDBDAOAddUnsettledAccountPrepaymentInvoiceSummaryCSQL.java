...
*@FileName : AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentInvoiceSummaryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentInvoiceSummaryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentInvoiceSummaryCSQL
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentInvoiceSummaryCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentInvoiceSummaryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , 'SAP_INV_DTL'                       AS UNSTL_CATE_NM" ).append("\n"); 
		...
		query.append("      , SID.DTRB_AMT                        AS INP_DR_AMT" ).append("\n"); 
		query.append("      , 0                                   AS INP_CR_AMT" ).append("\n"); 
		query.append("      , NVL(SID.DTRB_FUNC_AMT,SID.DTRB_AMT) AS ACCT_DR_AMT" ).append("\n"); 
