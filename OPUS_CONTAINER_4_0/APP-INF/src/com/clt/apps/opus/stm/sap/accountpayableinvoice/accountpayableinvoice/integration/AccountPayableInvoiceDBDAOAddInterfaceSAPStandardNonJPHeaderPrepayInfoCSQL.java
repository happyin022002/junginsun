...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPHeaderPrepayInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPHeaderPrepayInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddInterfaceSAPStandardNonJPHeaderPrepayInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPHeaderPrepayInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPHeaderPrepayInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                              , MO.MODI_AGN_CD                      AS LINE_ITEM_REF_KEY --2015.01.26 변경" ).append("\n"); 
