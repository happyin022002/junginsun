...
*@FileName : STM_SAP_0003HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0003Event event = new StmSap0003Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {		
			event.setApCSRNoListVO((ApCSRNoListVO)getVO(request, ApCSRNoListVO.class));
		}
