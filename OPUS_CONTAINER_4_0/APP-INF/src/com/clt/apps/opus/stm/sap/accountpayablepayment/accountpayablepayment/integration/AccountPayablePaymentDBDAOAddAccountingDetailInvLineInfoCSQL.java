...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvLineInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailInvLineInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailInvLineInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailInvLineInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvLineInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
