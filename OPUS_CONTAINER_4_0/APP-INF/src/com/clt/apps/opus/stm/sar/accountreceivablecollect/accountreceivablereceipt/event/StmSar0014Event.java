 ...
 * @author 
 * @see StmSar0014Event 참조
 * @since J2EE 1.4
 */

public class StmSar0014Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	private ReceiptUserListConditionVO receiptUserListConditionVO = null;
		
	public ReceiptUserListConditionVO getReceiptUserListConditionVO() {
		return receiptUserListConditionVO;
	}


	public void setReceiptUserListConditionVO(
			ReceiptUserListConditionVO receiptUserListConditionVO) {
		this.receiptUserListConditionVO = receiptUserListConditionVO;
	}
