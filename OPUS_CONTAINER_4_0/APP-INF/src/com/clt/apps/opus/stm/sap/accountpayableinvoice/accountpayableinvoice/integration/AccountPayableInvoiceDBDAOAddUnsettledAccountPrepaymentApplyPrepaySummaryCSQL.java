...
*@FileName : AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentApplyPrepaySummaryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentApplyPrepaySummaryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentApplyPrepaySummaryCSQL
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentApplyPrepaySummaryCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddUnsettledAccountPrepaymentApplyPrepaySummaryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , TO_CHAR(SID.PPAY_LINE_NO)         AS UNSTL_DL_LINE_NO" ).append("\n"); 
		...
		query.append("      , SAP_INV_HDR PINV" ).append("\n"); 
		...
		query.append("AND     SID.PPAY_INV_SEQ = PINV.INV_SEQ" ).append("\n"); 
