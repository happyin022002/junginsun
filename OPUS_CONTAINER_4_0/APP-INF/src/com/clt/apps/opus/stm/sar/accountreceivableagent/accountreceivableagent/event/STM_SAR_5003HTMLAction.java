...
*@FileName : STM_SAR_5003HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_5003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_5003HTMLAction 객체를 생성
	 */
	public STM_SAR_5003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar5003Event event = new StmSar5003Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {			
			
			ASAInquiryListVO vo = (ASAInquiryListVO)getVO(request, ASAInquiryListVO .class);
		    event.setASAInquiryListVO(vo);
