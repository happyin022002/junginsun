...
*@FileName : STM_SAP_0010HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
 ...
 * @author ORKIM
 * @see STM_SAP_0010HTMLAction 참조
 * @since J2EE 1.6
 */

public class STM_SAP_0010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0010Event event = new StmSap0010Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setInvoiceEntryCondVO((InvoiceEntryCondVO)getVO(request, InvoiceEntryCondVO.class));
			...
			event.setInvoiceEntryLineListVOs((InvoiceEntryLineListVO[])getVOs(request, InvoiceEntryLineListVO.class, "sheet2_"));
			event.setInvoicePayScheduleListVOs((InvoicePayScheduleListVO[])getVOs(request, InvoicePayScheduleListVO.class, "sheet3_"));
