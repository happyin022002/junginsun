...
*@FileName : StatementCommonDBDAOSearchMDMOfficeInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOSearchMDMOfficeInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * search MDM officeInfo
	  * </pre>
	  */
	public StatementCommonDBDAOSearchMDMOfficeInfoRSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOSearchMDMOfficeInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			  , NVL((SELECT DECODE(OTS_SMRY_CD, 'CLR', 'BL', OTS_SMRY_CD) FROM INV_AR_STUP_OFC WHERE AR_OFC_CD = @[ofc_cd])," ).append("\n"); 
		query.append("				    (SELECT NVL(OTS_CATE_CD, 'BL') FROM SCO_OFC_INFO WHERE OFC_CD = @[ofc_cd])) OTS_SMRY_CD" ).append("\n"); 
