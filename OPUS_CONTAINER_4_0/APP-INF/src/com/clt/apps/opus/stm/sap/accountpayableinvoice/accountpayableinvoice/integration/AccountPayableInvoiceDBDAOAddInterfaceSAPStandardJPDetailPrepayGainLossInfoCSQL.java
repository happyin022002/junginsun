...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayGainLossInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayGainLossInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 선급금 정산 전표 처리시 Line의 환율과 Apply되는 선급금의 환율의 차가 발생하는 경우 Gain/Loss 가 발생하는데 해당 내역을 추가 처리
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayGainLossInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayGainLossInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
