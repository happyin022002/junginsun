...
*@FileName : STM_SAP_0004HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0004Event event = new StmSap0004Event();
		

        if(command.isCommand(FormCommand.SEARCH)) {								
			
			String luCd = JSPUtil.getParameter(request, "lu_cd" , "");
			String attrCtnt1  = JSPUtil.getParameter(request, "attr_ctnt1" , "");
