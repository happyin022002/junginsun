...
*@FileName : AccountPayableCommonDBDAOSearchBankAccountSupplierBankCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOSearchBankAccountSupplierBankCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Bank Account(Supplier) 저장시 중복 체크
	  * </pre>
	  */
	public AccountPayableCommonDBDAOSearchBankAccountSupplierBankCheckRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOSearchBankAccountSupplierBankCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
