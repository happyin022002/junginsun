...
*@FileName : STM_SAP_CommonHTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_CommonHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_CommonHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSapCommonEvent event = new StmSapCommonEvent();		
    	event.setSapCommonVO((SapCommonVO)getVO(request, SapCommonVO.class));
    	event.setTaxCodeVO((TaxCodeVO)getVO(request, TaxCodeVO.class));
		return  event;
	}
