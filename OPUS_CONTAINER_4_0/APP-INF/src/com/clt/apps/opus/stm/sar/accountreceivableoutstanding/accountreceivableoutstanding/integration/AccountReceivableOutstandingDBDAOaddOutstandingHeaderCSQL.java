...
*@FileName : AccountReceivableOutstandingDBDAOaddOutstandingHeaderCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOaddOutstandingHeaderCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOaddOutstandingHeaderCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOaddOutstandingHeaderCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SAR_OTS_HDR" ).append("\n"); 
		query.append("(" ).append("\n"); 
