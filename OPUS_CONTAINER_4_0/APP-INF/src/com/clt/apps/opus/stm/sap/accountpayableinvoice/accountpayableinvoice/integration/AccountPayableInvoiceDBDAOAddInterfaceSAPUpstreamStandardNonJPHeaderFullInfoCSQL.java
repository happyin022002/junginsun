...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderFullInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderFullInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Upstream Module에 I/F된 Standard 비용 전표에 대해서 Hold 처리 후 Apply 한 내역을 SAKURA로 보낼 때 해당 Liability가 Full로 Apply된 경우에 대해서 AP 금액 처리
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderFullInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderFullInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
