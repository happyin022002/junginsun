...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLiabilityInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLiabilityInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPrepayApplyLiabilityInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLiabilityInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLiabilityInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
