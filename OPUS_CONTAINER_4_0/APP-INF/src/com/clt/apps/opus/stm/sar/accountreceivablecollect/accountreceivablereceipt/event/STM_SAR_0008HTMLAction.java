...
*@FileName : STM_SAR_0008HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
 ...
 * @author 
 * @see StmSar0008Event 참조
 * @since J2EE 1.4
 */

public class STM_SAR_0008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_0008HTMLAction 객체를 생성
	 */
	public STM_SAR_0008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar0008Event event = new StmSar0008Event();
