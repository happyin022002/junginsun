 ...
 * @author 
 * @see StmSar2002Event 참조
 * @since J2EE 1.4
 */

public class StmSar2002Event extends EventSupport {

	private static final long serialVersionUID = 1L;

	private ReceiptListByDetailCondVO receiptListByDetailCondVO = null;
	
	public ReceiptListByDetailCondVO getReceiptListByDetailCondVO() {
		return receiptListByDetailCondVO;
	}
	public void setReceiptListByDetailCondVO(
			ReceiptListByDetailCondVO receiptListByDetailCondVO) {
		this.receiptListByDetailCondVO = receiptListByDetailCondVO;
	}
}