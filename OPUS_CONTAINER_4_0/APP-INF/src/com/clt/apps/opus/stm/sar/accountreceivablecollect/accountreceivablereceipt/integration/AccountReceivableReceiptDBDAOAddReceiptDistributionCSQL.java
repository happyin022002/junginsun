...
*@FileName : AccountReceivableReceiptDBDAOAddReceiptDistributionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableReceiptDBDAOAddReceiptDistributionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add Receipt Distribution
	  * </pre>
	  */
	public AccountReceivableReceiptDBDAOAddReceiptDistributionCSQL(){
		setQuery();
		...
		params.put("fm_acct_cr_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("fm_acct_dr_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("fm_dtrb_src_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("fm_inp_dr_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("rvs_src_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("fm_inp_cr_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccountReceivableReceiptDBDAOAddReceiptDistributionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
