...
*@FileName : StatementCommonDBDAOAddScoBatHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOAddScoBatHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StatementCommonDBDAOAddScoBatHisCSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOAddScoBatHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
