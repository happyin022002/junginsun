...
*@FileName : OtsTypeExcludeListVO.java
*@FileTitle : OtsTypeExcludeListVO
*Open Issues :
*Change history :
...
public class OtsTypeExcludeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OtsTypeExcludeListVO> models = new ArrayList<OtsTypeExcludeListVO>();
	...
	public OtsTypeExcludeListVO() {}

	public OtsTypeExcludeListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @param request
	 * @return OtsTypeExcludeListVO[]
	 */
	public OtsTypeExcludeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OtsTypeExcludeListVO[]
	 */
	public OtsTypeExcludeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OtsTypeExcludeListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new OtsTypeExcludeListVO();
				if (ibflag[i] != null)
		...
		return getOtsTypeExcludeListVOs();
	}
	 ...
	 * @return OtsTypeExcludeListVO[]
	 */
	public OtsTypeExcludeListVO[] getOtsTypeExcludeListVOs(){
		OtsTypeExcludeListVO[] vos = (OtsTypeExcludeListVO[])models.toArray(new OtsTypeExcludeListVO[models.size()]);
		return vos;
	}
