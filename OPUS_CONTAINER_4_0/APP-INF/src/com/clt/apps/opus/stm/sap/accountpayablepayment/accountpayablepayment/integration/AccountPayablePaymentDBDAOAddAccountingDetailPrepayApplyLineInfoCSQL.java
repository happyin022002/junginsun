...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLineInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLineInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPrepayApplyLineInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLineInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyLineInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
