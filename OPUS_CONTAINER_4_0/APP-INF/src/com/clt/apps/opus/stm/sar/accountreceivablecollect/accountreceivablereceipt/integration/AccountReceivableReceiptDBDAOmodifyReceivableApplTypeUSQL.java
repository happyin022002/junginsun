...
*@FileName : AccountReceivableReceiptDBDAOmodifyReceivableApplTypeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableReceiptDBDAOmodifyReceivableApplTypeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Receivable Application 의 상태정보 변경
	  * </pre>
	  */
	public AccountReceivableReceiptDBDAOmodifyReceivableApplTypeUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableReceiptDBDAOmodifyReceivableApplTypeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	RCV_APPL_TP_CD = @[rcv_appl_tp_cd]" ).append("\n"); 
		query.append("	, DP_FLG = 'N'" ).append("\n"); 
