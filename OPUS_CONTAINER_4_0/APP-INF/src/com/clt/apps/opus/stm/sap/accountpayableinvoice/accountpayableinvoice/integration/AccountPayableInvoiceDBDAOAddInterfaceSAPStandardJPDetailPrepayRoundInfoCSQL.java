...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayRoundInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayRoundInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayRoundInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPDetailPrepayRoundInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
