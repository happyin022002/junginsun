...
*@FileName : AccountReceivableAdjustDBDAOAddSarDtrbRoundingListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAdjustDBDAOAddSarDtrbRoundingListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Save SAR Distribution CASE 'ROUNDING'
	  * </pre>
	  */
	public AccountReceivableAdjustDBDAOAddSarDtrbRoundingListCSQL(){
		setQuery();
		...
		params.put("diff_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccountReceivableAdjustDBDAOAddSarDtrbRoundingListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    @[dtrb_src_seq]," ).append("\n"); 
		query.append("    'ADJ'," ).append("\n"); 
		query.append("    @[dtrb_src_tp_cd]," ).append("\n"); 
		query.append("    @[cd_cmb_seq]," ).append("\n"); 
		query.append("    CASE " ).append("\n"); 
		query.append("        WHEN REPLACE(@[adj_amt], ',', '') >= 0 THEN 0" ).append("\n"); 
		query.append("    END," ).append("\n"); 
		query.append("    CASE " ).append("\n"); 
		query.append("        WHEN REPLACE(@[adj_amt], ',', '') <= 0 THEN 0" ).append("\n"); 
		query.append("    END," ).append("\n"); 
		query.append("    CASE " ).append("\n"); 
		query.append("        WHEN @[diff_flg] < 0 THEN" ).append("\n"); 
