...
*@FileName : AccountPayablePaymentDBDAOAddAccountingHeaderPrepayApplyInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingHeaderPrepayApplyInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingHeaderPrepayApplyInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingHeaderPrepayApplyInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingHeaderPrepayApplyInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
