...
*@FileName : AccountReceivableOutstandingMigrationDBDAOSearchLookupListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOSearchLookupListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOSearchLookupListRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOSearchLookupListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    SCO_LU_HDR H" ).append("\n"); 
		query.append("     ,  SCO_LU_DTL D" ).append("\n"); 
