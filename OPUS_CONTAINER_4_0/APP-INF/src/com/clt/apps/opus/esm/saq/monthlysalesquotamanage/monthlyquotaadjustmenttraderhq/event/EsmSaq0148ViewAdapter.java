...
*@FileName : EsmSaq0148ViewAdapter.java
*@FileTitle : Regional Group Vs. Trade Group 에서 호출하는 Monthly Adjustment (Popup)
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0148ViewAdapter extends ViewAdapter {

	public EsmSaq0148ViewAdapter() {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		if( conditionVO.getChkCommand().equals("SEARCHLIST")){
			...
			List<SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO> searchMonthlyQuotaAdjustmentTradeModifyListVOs=  (List<SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO>) listVO.getList(0);
