...
public class BLIssuanceDBDAOsearchDblEdiCntrMfRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       || 'D_DESC:' || REPLACE(TO_CLOB(CNTR_MF_GDS_DESC), CHR(10), ' ') || CHR(10)" ).append("\n"); 
		query.append("       || '{CUS_MARK' || CHR(10) " ).append("\n"); 
		query.append("       || 'D_MARK:' || REPLACE(TO_CLOB(CNTR_MF_MK_DESC), CHR(10), CHR(10) || 'D_MARK:')|| CHR(10) " ).append("\n"); 
		query.append("       || '}CUS_MARK' || CHR(10) " ).append("\n"); 
