...
*@FileName : JapanManifestListDownloadDBDAOaddJpcusBlCustCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOaddJpcusBlCustCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOaddJpcusBlCustCSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOaddJpcusBlCustCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_JP_BL_CUST (" ).append("\n"); 
		...
		query.append(",	@[cust_nm]" ).append("\n"); 
		query.append(",	@[cust_addr]" ).append("\n"); 
		query.append(",	REPLACE(REPLACE(@[phn_no], '-', ''), ' ', '')" ).append("\n"); 
		query.append(",	REPLACE(REPLACE(@[fax_no], '-', ''), ' ', '')" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
