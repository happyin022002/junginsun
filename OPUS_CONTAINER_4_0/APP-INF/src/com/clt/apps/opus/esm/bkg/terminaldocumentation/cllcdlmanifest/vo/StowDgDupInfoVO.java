...
*@FileName : CLLCDLManifestStowDgDupInfoVO.java
*@FileTitle : CLLCDLManifestStowDgDupInfoVO
*Open Issues :
*Change history :
...
public class StowDgDupInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<StowDgDupInfoVO> models = new ArrayList<StowDgDupInfoVO>();
	...
	public StowDgDupInfoVO() {}

	public StowDgDupInfoVO(String ibflag, String pagerows, String stwgExist, String stwgCd) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return CLLCDLManifestStowDgDupInfoVO[]
	 */
	public StowDgDupInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CLLCDLManifestStowDgDupInfoVO[]
	 */
	public StowDgDupInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		StowDgDupInfoVO model = null;
		...
		return getCLLCDLManifestStowDgDupInfoVOs();
	}
	 ...
	 * @return CLLCDLManifestStowDgDupInfoVO[]
	 */
	public StowDgDupInfoVO[] getCLLCDLManifestStowDgDupInfoVOs(){
		StowDgDupInfoVO[] vos = (StowDgDupInfoVO[])models.toArray(new StowDgDupInfoVO[models.size()]);
		return vos;
	}
