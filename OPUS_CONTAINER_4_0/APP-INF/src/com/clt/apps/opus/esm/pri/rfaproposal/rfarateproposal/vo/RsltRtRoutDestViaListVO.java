...
*@FileName : RsltRtRoutDestViaListVO.java
*@FileTitle : RsltRtRoutDestViaListVO
*Open Issues :
*Change history :
...
public class RsltRtRoutDestViaListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltRtRoutDestViaListVO> models = new ArrayList<RsltRtRoutDestViaListVO>();
	 ...
	 * @param request
	 * @return RsltRtRoutDestViaListVO[]
	 */
	public RsltRtRoutDestViaListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltRtRoutDestViaListVO[]
	 */
	public RsltRtRoutDestViaListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltRtRoutDestViaListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltRtRoutDestViaListVO();
				if (amdtSeq[i] != null)
		...
		return getRsltRtRoutDestViaListVOs();
	}
	 ...
	 * @return RsltRtRoutDestViaListVO[]
	 */
	public RsltRtRoutDestViaListVO[] getRsltRtRoutDestViaListVOs(){
		RsltRtRoutDestViaListVO[] vos = (RsltRtRoutDestViaListVO[])models.toArray(new RsltRtRoutDestViaListVO[models.size()]);
		return vos;
	}
