...
public class PerformanceReportDBDAOSearchCaSummaryReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("--           AND BKG.VSL_CD     = SUBSTR('HJXX0001E', 0, 4)" ).append("\n"); 
		query.append("--           AND BKG.SKD_VOY_NO = SUBSTR('HJXX0001E', 5, 4)" ).append("\n"); 
		query.append("--           AND BKG.SKD_DIR_CD = SUBSTR('HJXX0001E', 9, 1)" ).append("\n"); 
