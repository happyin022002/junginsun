...
*@FileName : ESM_PRI_3505HTMLAction.java
...
public class ESM_PRI_3505HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3505HTMLAction 객체를 생성
	 */
	public ESM_PRI_3505HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3505Event event = new EsmPri3505Event();
		
		if(command.isCommand(FormCommand.MODIFY05)) {
