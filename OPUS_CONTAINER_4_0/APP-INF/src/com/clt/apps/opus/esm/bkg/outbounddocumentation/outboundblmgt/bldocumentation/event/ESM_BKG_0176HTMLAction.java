 ...
 *@FileName : ESM_BKG_0176HTMLAction.java
...
public class ESM_BKG_0176HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;

    /**
     * ESM_BKG_0176HTMLAction 객체를 생성
     */
    public ESM_BKG_0176HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0176Event event = new EsmBkg0176Event();
        log.debug(":: ESM_BKG_0176HTMLAction - " + command.getCommand());
