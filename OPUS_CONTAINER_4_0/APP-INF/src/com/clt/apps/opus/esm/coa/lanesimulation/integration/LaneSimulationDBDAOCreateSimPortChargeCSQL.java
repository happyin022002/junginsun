...
public class LaneSimulationDBDAOCreateSimPortChargeCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        		      AND VOP_CD = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("		              AND NVL(DELT_FLG, 'N') = 'N'" ).append("\n"); 
		query.append("		            UNION ALL" ).append("\n"); 
		query.append("        	      SELECT VSL_CD," ).append("\n"); 
		query.append("			             VSL_CLSS_CAPA" ).append("\n"); 
		query.append("		            FROM COA_SIM_VSL_RGST" ).append("\n"); 
		query.append("         		   WHERE VOP_CD = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC() ) A2" ).append("\n"); 
		...
		query.append("				  	COA_PORT_TRF C2" ).append("\n"); 
