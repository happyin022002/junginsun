...
*@FileName : ESM_BKG_0641HTMLAction.java
...
public class ESM_BKG_0641HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0641HTMLAction 객체를 생성
	 */
	public ESM_BKG_0641HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0641Event event = new EsmBkg0641Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCdlCondVO((CdlCondVO)getVO(request, CdlCondVO .class));
		}
