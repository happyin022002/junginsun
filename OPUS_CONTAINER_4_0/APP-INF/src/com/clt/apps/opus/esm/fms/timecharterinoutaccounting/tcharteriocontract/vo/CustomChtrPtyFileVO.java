...
*@FileName : CustomChtrPtyFileVO.java
*@FileTitle : CustomChtrPtyFileVO
*Open Issues :
*Change history : 
...
public class CustomChtrPtyFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomChtrPtyFileVO> models = new ArrayList<CustomChtrPtyFileVO>();
	 ...
	 * @return 
	 */
	public CustomChtrPtyFileVO(String ibflag, String pagerows, String fletCtrtNo, String fileSeq, String fletFileTpCd, String fileNm, String fileDesc, String fileSavId, String creUsrId, String creDt, String updUsrId, String updDt, String effDt, String expDt) {
		this.updDt = updDt;
	...
	public CustomChtrPtyFileVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CustomChtrPtyFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomChtrPtyFileVO model = null;
		...
		return getCustomChtrPtyFileVOs();
	}

	public CustomChtrPtyFileVO[] getCustomChtrPtyFileVOs(){
		CustomChtrPtyFileVO[] vos = (CustomChtrPtyFileVO[])models.toArray(new CustomChtrPtyFileVO[models.size()]);
		return vos;
	}
