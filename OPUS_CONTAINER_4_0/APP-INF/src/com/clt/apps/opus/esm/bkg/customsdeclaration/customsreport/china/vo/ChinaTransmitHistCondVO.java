...
public class ChinaTransmitHistCondVO extends TransmitHistCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<ChinaTransmitHistCondVO> models = new ArrayList<ChinaTransmitHistCondVO>();
	...
	public ChinaTransmitHistCondVO() {}

	public ChinaTransmitHistCondVO(String ibflag, String pagerows, String sendIndicator, String vvdCd, String ofcCd, String usrId, String errorCheck, String dateCheck, String startSndDt, String startSndDt2, String endSndDt, String endSndDt2, String rhqOfcCd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("send_indicator", getJpSndLogId());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rhq_ofc_cd","rhq_ofc_cd");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSendIndicator(JSPUtil.getParameter(request, "send_indicator", ""));
	 ...
	 */
	public ChinaTransmitHistCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapanTransmitHistCondVO[]
	 */
	public ChinaTransmitHistCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ChinaTransmitHistCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ChinaTransmitHistCondVO();
		...
		return getChinaTransmitHistCondVOs();
	}
	 ...
	 * @return JapanTransmitHistCondVO[]
	 */
	public ChinaTransmitHistCondVO[] getChinaTransmitHistCondVOs(){
		ChinaTransmitHistCondVO[] vos = (ChinaTransmitHistCondVO[])models.toArray(new ChinaTransmitHistCondVO[models.size()]);
		return vos;
	}
