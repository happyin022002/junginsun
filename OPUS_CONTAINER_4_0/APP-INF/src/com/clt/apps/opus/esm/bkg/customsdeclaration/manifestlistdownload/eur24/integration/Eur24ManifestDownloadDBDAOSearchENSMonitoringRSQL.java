...
public class Eur24ManifestDownloadDBDAOSearchENSMonitoringRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , J.BL_TOT_CNT ,J.ENS_SNT_CNT ,J.ENS_SNT_ACC ,J.ENS_SNT_REJ ,J.ENS_SNT_NRCV ,J.ENS_SNT_DONLD ,J.ENS_UNSNT_CNT ,J.ENS_AMD_CNT ,J.ENS_AMT ,J.MCF_AMT" ).append("\n"); 
		...
		query.append("         FROM ( SELECT VVD.VSL_CD" ).append("\n"); 
		...
		query.append("                  AND BCR_ENS.CHG_CD(+) = 'ESD'" ).append("\n"); 
		query.append("                  AND BCR_ENS.FRT_INCL_XCLD_DIV_CD(+) = 'N'" ).append("\n"); 
		query.append("                  AND BCR_MCF.CHG_CD(+) = 'AMA'" ).append("\n"); 
