...
*@FileName : FFCommCalculationDBDAOModifyFFMasterErrorMSGUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOModifyFFMasterErrorMSGUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOModifyFFMasterErrorMSGUSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAOModifyFFMasterErrorMSGUSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOModifyFFMasterErrorMSGUSQL").append("\n");
		query.append("*/").append("\n");
	}
