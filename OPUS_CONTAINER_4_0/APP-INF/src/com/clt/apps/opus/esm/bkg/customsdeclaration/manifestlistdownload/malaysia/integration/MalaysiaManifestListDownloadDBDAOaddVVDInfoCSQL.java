...
*@FileName : MalaysiaManifestListDownloadDBDAOaddVVDInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MalaysiaManifestListDownloadDBDAOaddVVDInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MalaysiaManifestListDownloadDBDAOaddVVDInfoCSQL(){
		setQuery();
		...
		query.append("FileName : MalaysiaManifestListDownloadDBDAOaddVVDInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO BKG_CSTMS_MY_VVD " ).append("\n"); 
