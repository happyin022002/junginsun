...
*@FileName : PerformanceReportDBDAOAddAutoRtHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOAddAutoRtHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_AUTO_RT_HIS 생성작업
	  * </pre>
	  */
	public PerformanceReportDBDAOAddAutoRtHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOAddAutoRtHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL BKG_AUTO_RT_HIS_PRC" ).append("\n"); 
