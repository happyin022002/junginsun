...
*@FileName : ESM_PRI_2043HTMLAction.java
...
public class ESM_PRI_2043HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_2043HTMLAction 객체를 생성
	 */
	public ESM_PRI_2043HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2043Event event = new EsmPri2043Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchRFAListVO((RsltSearchRFAListVO)getVO(request, RsltSearchRFAListVO.class));
		}
