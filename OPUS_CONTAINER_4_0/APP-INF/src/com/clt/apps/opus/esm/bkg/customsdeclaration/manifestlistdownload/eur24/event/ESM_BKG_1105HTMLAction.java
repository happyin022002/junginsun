...
public class ESM_BKG_1105HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0745HTMLAction 객체를 생성
	 */
	public ESM_BKG_1105HTMLAction(){}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1105Event event = new EsmBkg1105Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setRvis_n1st_clpt_cd(request.getParameter("rvis_n1st_clpt_cd"));
