...
*@FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab02RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab02RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab02RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab02RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            DECODE(@[ctrt_rhq_cd], '', '01', '02') AS FIRST_STEP," ).append("\n"); 
		query.append("            DECODE(@[ctrt_rhq_cd], '', '02', '01') AS SECOND_STEP," ).append("\n"); 
		query.append("            DECODE(@[ctrt_rhq_cd], '', '00', 'FN') AS FINAL_STATUS" ).append("\n"); 
		...
		query.append("    MIN(CASE WHEN UNI.GUBUN = 'RCT_MONTHLY' AND UNI.MON_SEQ = '0' THEN" ).append("\n"); 
		query.append("           DECODE( ITM.CODE,  '01', UNI.TOT_BSA," ).append("\n"); 
		query.append("                    '02', UNI.TOT_VOY," ).append("\n"); 
		query.append("                    '03', UNI.TOT_LOD," ).append("\n"); 
		query.append("                    '04', DECODE(UNI.TOT_BSA, 0, '', ROUND((UNI.TOT_LOD/UNI.TOT_BSA)*100, 1))," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("    DECODE( ITM.CODE,  '01', SUM( DECODE(UNI.GUBUN , 'TRADE',UNI.TOT_BSA,0))," ).append("\n"); 
		...
		query.append("                '04', DECODE(SUM(DECODE(UNI.GUBUN , 'TRADE',UNI.TOT_BSA,0)), 0, '', ROUND((SUM(DECODE(UNI.GUBUN , 'TRADE',UNI.TOT_LOD,0))/SUM(DECODE(UNI.GUBUN , 'TRADE',UNI.TOT_BSA,0)))*100, 1))," ).append("\n"); 
		...
		query.append("    DECODE( ITM.CODE,  '01', SUM( DECODE(UNI.GUBUN , 'FINAL',UNI.TOT_BSA,0))," ).append("\n"); 
		...
		query.append("                '04', DECODE(SUM(DECODE(UNI.GUBUN , 'FINAL',UNI.TOT_BSA,0)), 0, '', ROUND((SUM(DECODE(UNI.GUBUN , 'FINAL',UNI.TOT_LOD,0))/SUM(DECODE(UNI.GUBUN , 'FINAL',UNI.TOT_BSA,0)))*100, 1))," ).append("\n"); 
		...
		query.append("    DECODE( ITM.CODE,  '01', SUM( DECODE(UNI.GUBUN , 'ADJUSTED',UNI.TOT_BSA,0))," ).append("\n"); 
		...
		query.append("                '04', DECODE(SUM(DECODE(UNI.GUBUN , 'ADJUSTED',UNI.TOT_BSA,0)), 0, '', ROUND((SUM(DECODE(UNI.GUBUN , 'ADJUSTED',UNI.TOT_LOD,0))/SUM(DECODE(UNI.GUBUN , 'ADJUSTED',UNI.TOT_BSA,0)))*100, 1))," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if (${ctrt_rhq_cd} == '')" ).append("\n"); 
		...
		query.append("        DECODE(MIN(mon_seq),0,'RCT_MONTHLY','MONTHLY') AS GUBUN," ).append("\n"); 
		...
		query.append("        DECODE(TRD.SUB_TRD_CD, '', 'TOTAL', TRD.SUB_TRD_CD) AS SUB_TRD_CD," ).append("\n"); 
		query.append("        DECODE(TRD.DIR_CD, '', 'TOTAL', TRD.DIR_CD) AS DIR_CD," ).append("\n"); 
		...
		query.append("        AND    TRD.CTRT_RHQ_CD LIKE INP.CTRT_RHQ_CD||'%'" ).append("\n"); 
		query.append("        GROUP BY TRD.MQTA_STEP_CD,TRD.BSE_YR,TRD.BSE_MON,TRD.SUB_TRD_CD,TRD.RLANE_CD,TRD.DIR_CD," ).append("\n"); 
		query.append("              TRD.SPRT_GRP_CD,TRD.BSA_GRP_CD" ).append("\n"); 
		query.append("        ) TRD" ).append("\n"); 
		query.append("    GROUP BY ROLLUP(TRD.SUB_TRD_CD, TRD.DIR_CD), TRD.MQTA_STEP_CD, TRD.BSE_MON" ).append("\n"); 
		query.append("    UNION ALL" ).append("\n"); 
		...
		query.append("    GROUP BY ROLLUP(RHQ.SUB_TRD_CD, RHQ.DIR_CD), RHQ.BSE_MON" ).append("\n"); 
