...
*@FileName : ESM_BKG_0068HTMLAction.java
...
public class ESM_BKG_0772HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0068HTMLAction 객체를 생성
     */
    public ESM_BKG_0772HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0772Event event = new EsmBkg0772Event();

		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((BkgClearanceCrossCheckListInVO) getVO(request, BkgClearanceCrossCheckListInVO.class));
