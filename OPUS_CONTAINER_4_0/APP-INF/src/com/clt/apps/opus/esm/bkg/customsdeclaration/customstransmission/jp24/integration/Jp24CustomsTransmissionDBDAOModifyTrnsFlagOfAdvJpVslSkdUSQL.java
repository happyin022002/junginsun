...
*@FileName : Jp24CustomsTransmissionDBDAOModifyTrnsFlagOfAdvJpVslSkdUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Jp24CustomsTransmissionDBDAOModifyTrnsFlagOfAdvJpVslSkdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24CustomsTransmissionDBDAOModifyTrnsFlagOfAdvJpVslSkdUSQL(){
		setQuery();
		...
		query.append("FileName : Jp24CustomsTransmissionDBDAOModifyTrnsFlagOfAdvJpVslSkdUSQL").append("\n");
		query.append("*/").append("\n");
	}
