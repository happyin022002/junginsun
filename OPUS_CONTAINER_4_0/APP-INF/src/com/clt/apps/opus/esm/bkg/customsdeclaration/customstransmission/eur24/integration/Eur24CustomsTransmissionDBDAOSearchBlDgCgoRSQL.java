...
*@FileName : Eur24CustomsTransmissionDBDAOSearchBlDgCgoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24CustomsTransmissionDBDAOSearchBlDgCgoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24CustomsTransmissionDBDAOSearchBlDgCgoRSQL
	  * </pre>
	  */
	public Eur24CustomsTransmissionDBDAOSearchBlDgCgoRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24CustomsTransmissionDBDAOSearchBlDgCgoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* Eur24BlDgCgoListVOs Eur24CustomsTransmissionDBDAOSearchBlDgCgo ( String blNo , String vslCd , String skdVoyNo , String skdDirCd ,String cstmsPortCd, String cntrNo) */" ).append("\n"); 
		...
		query.append("FROM BKG_CSTMS_EUR_DG_CGO X" ).append("\n"); 
