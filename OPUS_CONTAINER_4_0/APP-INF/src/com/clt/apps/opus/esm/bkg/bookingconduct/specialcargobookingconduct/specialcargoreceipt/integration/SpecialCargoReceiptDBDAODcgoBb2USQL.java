...
*@FileName : SpecialCargoReceiptDBDAODcgoBb2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAODcgoBb2USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAODcgoBb2USQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAODcgoBb2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND DCGO_SEQ = @[bb_dcgo_seq]" ).append("\n"); 
