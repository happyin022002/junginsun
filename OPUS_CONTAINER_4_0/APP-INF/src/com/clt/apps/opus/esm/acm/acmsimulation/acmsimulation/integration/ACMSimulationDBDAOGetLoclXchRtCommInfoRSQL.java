...
*@FileName : ACMSimulationDBDAOGetLoclXchRtCommInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOGetLoclXchRtCommInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOGetLoclXchRtCommInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOGetLoclXchRtCommInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	DECODE( @[pay_xch_rt2],0,0,round ( @[fx_real_amt] / @[pay_xch_rt2] ,13)) as usd_fx_comm2," ).append("\n"); 
