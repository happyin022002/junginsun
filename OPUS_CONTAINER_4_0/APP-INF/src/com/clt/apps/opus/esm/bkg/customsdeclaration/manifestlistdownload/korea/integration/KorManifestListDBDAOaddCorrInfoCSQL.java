...
*@FileName : KorManifestListDBDAOaddCorrInfoCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOaddCorrInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOaddCorrInfoCSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOaddCorrInfoCSQL").append("\n");
		query.append("*/").append("\n");
	}
