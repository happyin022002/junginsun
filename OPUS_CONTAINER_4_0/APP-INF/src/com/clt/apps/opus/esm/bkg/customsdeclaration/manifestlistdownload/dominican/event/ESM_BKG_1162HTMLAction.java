...
*@FileName : ESM_BKG_1162HTMLAction.java
...
* 
=========================================================*/
package com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.dominican.event;
...
public class ESM_BKG_1162HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1162HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1162HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1162Event event = new EsmBkg1162Event();
		
		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01) || command.isCommand(FormCommand.MULTI01)) {
			
			DominicanManifestListCondVO condVO = (DominicanManifestListCondVO)getVO(request, DominicanManifestListCondVO.class);
