...
public class JapanManifestListDownloadDBDAOsearchBkgCntrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       (SELECT NVL(MIN(CNTR_SEAL_NO), 'Unknown')" ).append("\n"); 
		...
		query.append("       DECODE(D.LSTM_CD, 'SH', '1', '2') AS LSTM_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("   AND (B.BB_CGO_FLG = 'N' and B.CNTR_TPSZ_CD not like 'B%')" ).append("\n"); 
