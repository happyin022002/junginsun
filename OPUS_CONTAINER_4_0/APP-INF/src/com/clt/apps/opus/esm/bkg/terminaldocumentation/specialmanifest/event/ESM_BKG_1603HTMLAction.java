 ...
 *@FileName : ESM_BKG_1603HTMLAction.java
 *@FileTitle :
 *Open Issues :
 *Change history :
 *@LastModifyDate : 
 ...
 * 
 * @author CLT
 * @see EsmBkg1603Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_1603HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_FMS_1603HTMLAction 객체를 생성
	 */
	public ESM_BKG_1603HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1603Event event = new EsmBkg1603Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setEurDgListVO((EurDgListVO) getVO(request, EurDgListVO.class));
			
		}  else if (command.isCommand(FormCommand.MULTI01)) {
			event.setEurDgListVOs((EurDgListVO[]) getVOs(request, EurDgListVO.class));
		}
