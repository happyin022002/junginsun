...
*@FileName : SCMQCProposalDBDAORsltPriSpScpMqcHisVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCMQCProposalDBDAORsltPriSpScpMqcHisVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * scope mqc amend history list
	  * </pre>
	  */
	public SCMQCProposalDBDAORsltPriSpScpMqcHisVORSQL(){
		setQuery();
		...
		query.append("FileName : SCMQCProposalDBDAORsltPriSpScpMqcHisVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND 1 = (SELECT 1 FROM PRI_SP_SCP_MQC" ).append("\n"); 
