...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOCheckCancelAllCurrentVersion0085RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOCheckCancelAllCurrentVersion0085RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOCheckCancelAllCurrentVersion0085RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOCheckCancelAllCurrentVersion0085RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
