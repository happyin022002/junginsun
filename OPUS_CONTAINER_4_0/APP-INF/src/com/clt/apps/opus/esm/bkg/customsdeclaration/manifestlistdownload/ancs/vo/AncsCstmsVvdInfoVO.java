...
*@FileName : AncsCstmsVvdInfoVO.java
*@FileTitle : AncsCstmsVvdInfoVO
*Open Issues :
*Change history :
...
public class AncsCstmsVvdInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AncsCstmsVvdInfoVO> models = new ArrayList<AncsCstmsVvdInfoVO>();
	...
	public AncsCstmsVvdInfoVO() {}

	public AncsCstmsVvdInfoVO(String ibflag, String pagerows, String vvd, String ssrNo, String vvdNm, String anrMsgStsCd, String etaDt) {
		this.vvd = vvd;
		this.ibflag = ibflag;
		this.etaDt = etaDt;
	 ...
	 */
	public AncsCstmsVvdInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AncsCstmsVvdInfoVO[]
	 */
	public AncsCstmsVvdInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AncsCstmsVvdInfoVO model = null;
	...
	public AncsCstmsVvdInfoVO[] getAncsCstmsVvdInfoVOs(){
		AncsCstmsVvdInfoVO[] vos = (AncsCstmsVvdInfoVO[])models.toArray(new AncsCstmsVvdInfoVO[models.size()]);
		return vos;
	}
