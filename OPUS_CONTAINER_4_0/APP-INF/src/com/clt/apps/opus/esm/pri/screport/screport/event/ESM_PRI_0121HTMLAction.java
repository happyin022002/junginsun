...
*@FileName : ESM_PRI_0121HTMLAction.java
...
public class ESM_PRI_0121HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0121HTMLAction 객체를 생성
	 */
	public ESM_PRI_0121HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0121Event event = new EsmPri0121Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchSCMOTFilingListVO((RsltSearchSCMOTFilingListVO)getVO(request, RsltSearchSCMOTFilingListVO .class));
		}
