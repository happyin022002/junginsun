...
public class UsaCustomsTransmissionDBDAOsearchCFlagHWYRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            WHEN @[icr_code] <> '1C' THEN" ).append("\n"); 
		query.append("                CASE WHEN TB.PCK_QTY = TB.W_QTY THEN 'W'" ).append("\n"); 
		...
		query.append("                CASE WHEN TB.PCK_QTY = TB.Y_ENT_QTY AND TB.PCK_QTY = TB.Y_RLS_QTY THEN 'Y'" ).append("\n"); 
		query.append("                     WHEN Y_TOT_FLG = 'Y' AND TB.PCK_QTY = TB.Y_TOT_QTY THEN 'Y'" ).append("\n"); 
