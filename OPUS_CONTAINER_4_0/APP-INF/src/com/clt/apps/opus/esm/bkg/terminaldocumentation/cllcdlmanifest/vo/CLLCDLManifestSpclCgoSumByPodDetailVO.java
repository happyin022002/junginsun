...
public class CLLCDLManifestSpclCgoSumByPodDetailVO extends AbstractValueObject {
	...
	public CLLCDLManifestSpclCgoSumByPodDetailVO(String ibflag, String pagerows, String podCd2, String dLo40, String dLo20, String dLo40h, String rLo40, String rLo20, String rLo40h, String fLo40, String fLo20, String fLo40h, String oLo40, String oLo20, String oLo40h, String dTs40, String dTs20, String dTs40h, String rTs40, String rTs20, String rTs40h, String fTs40, String fTs20, String fTs40h, String oTs40, String oTs20, String oTs40h, String dLoTs40, String dLoTs20, String dLoTs40h, String rLoTs40, String rLoTs20, String rLoTs40h, String fLoTs40, String fLoTs20, String fLoTs40h, String oLoTs40, String oLoTs20, String oLoTs40h) {
		this.rLo20 = rLo20;
	...
	public void fromRequest(HttpServletRequest request) {
		setRLo20(JSPUtil.getParameter(request, "r_lo_20", ""));
		setFLoTs20(JSPUtil.getParameter(request, "f_lo_ts_20", ""));
		setRLo40(JSPUtil.getParameter(request, "r_lo_40", ""));
		setDLo40(JSPUtil.getParameter(request, "d_lo_40", ""));
		setFLoTs40(JSPUtil.getParameter(request, "f_lo_ts_40", ""));
		setDTs40h(JSPUtil.getParameter(request, "d_ts_40h", ""));
		setDLo20(JSPUtil.getParameter(request, "d_lo_20", ""));
		setRLoTs20(JSPUtil.getParameter(request, "r_lo_ts_20", ""));
		setDTs20(JSPUtil.getParameter(request, "d_ts_20", ""));
		setRLoTs40(JSPUtil.getParameter(request, "r_lo_ts_40", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setOLoTs20(JSPUtil.getParameter(request, "o_lo_ts_20", ""));
		setFLo40(JSPUtil.getParameter(request, "f_lo_40", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setDLoTs20(JSPUtil.getParameter(request, "d_lo_ts_20", ""));
		setFLoTs40h(JSPUtil.getParameter(request, "f_lo_ts_40h", ""));
		setDLoTs40(JSPUtil.getParameter(request, "d_lo_ts_40", ""));
		setFLo20(JSPUtil.getParameter(request, "f_lo_20", ""));
		setRTs20(JSPUtil.getParameter(request, "r_ts_20", ""));
		setFTs40(JSPUtil.getParameter(request, "f_ts_40", ""));
		setDLo40h(JSPUtil.getParameter(request, "d_lo_40h", ""));
		setDLoTs40h(JSPUtil.getParameter(request, "d_lo_ts_40h", ""));
		setRTs40h(JSPUtil.getParameter(request, "r_ts_40h", ""));
		setRTs40(JSPUtil.getParameter(request, "r_ts_40", ""));
		setFTs20(JSPUtil.getParameter(request, "f_ts_20", ""));
		setOLoTs40(JSPUtil.getParameter(request, "o_lo_ts_40", ""));
		setOLoTs40h(JSPUtil.getParameter(request, "o_lo_ts_40h", ""));
		setFLo40h(JSPUtil.getParameter(request, "f_lo_40h", ""));
		setPodCd2(JSPUtil.getParameter(request, "pod_cd2", ""));
		setOTs40(JSPUtil.getParameter(request, "o_ts_40", ""));
		setOTs40h(JSPUtil.getParameter(request, "o_ts_40h", ""));
		setOLo40(JSPUtil.getParameter(request, "o_lo_40", ""));
		setOLo40h(JSPUtil.getParameter(request, "o_lo_40h", ""));
		setRLoTs40h(JSPUtil.getParameter(request, "r_lo_ts_40h", ""));
		setOTs20(JSPUtil.getParameter(request, "o_ts_20", ""));
		setDTs40(JSPUtil.getParameter(request, "d_ts_40", ""));
		setFTs40h(JSPUtil.getParameter(request, "f_ts_40h", ""));
		setOLo20(JSPUtil.getParameter(request, "o_lo_20", ""));
		setRLo40h(JSPUtil.getParameter(request, "r_lo_40h", ""));
	}
