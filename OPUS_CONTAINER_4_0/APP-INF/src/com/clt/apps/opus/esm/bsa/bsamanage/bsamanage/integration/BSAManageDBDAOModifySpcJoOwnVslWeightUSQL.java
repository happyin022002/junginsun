...
*@FileName : BSAManageDBDAOModifySpcJoOwnVslWeightUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifySpcJoOwnVslWeightUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySpcJoOwnVslWeight UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOModifySpcJoOwnVslWeightUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifySpcJoOwnVslWeightUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET OWNR_VSL_WGT = @[ownr_vsl_wgt]" ).append("\n"); 
