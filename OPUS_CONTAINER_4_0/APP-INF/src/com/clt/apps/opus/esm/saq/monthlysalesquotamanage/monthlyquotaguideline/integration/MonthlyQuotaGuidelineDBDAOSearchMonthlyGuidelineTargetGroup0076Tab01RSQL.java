...
*@FileName : MonthlyQuotaGuidelineDBDAOSearchMonthlyGuidelineTargetGroup0076Tab01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaGuidelineDBDAOSearchMonthlyGuidelineTargetGroup0076Tab01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaGuidelineDBDAOSearchMonthlyGuidelineTargetGroup0076Tab01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaGuidelineDBDAOSearchMonthlyGuidelineTargetGroup0076Tab01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        UNI.SUB_SEQ, " ).append("\n"); 
		query.append("        DECODE(UNI.TRD_CD, 'TOT', 'TOTAL', UNI.TRD_CD) AS TRD_CD,                                          " ).append("\n"); 
		...
		query.append("        SUM(CASE WHEN UNI.GUBUN = 'RECENT_YR' AND UNI.MON_SEQ = '0' THEN                                            " ).append("\n"); 
		...
		query.append("            END) AS RECENT_YR,                                                                                " ).append("\n"); 
		...
		query.append("                DECODE(QTA.TRD_CD, '',0, @[trade] ,1,2) SUB_SEQ,                                                               " ).append("\n"); 
		query.append("                DECODE(QTA.TRD_CD, '', 'TOT', QTA.TRD_CD) AS TRD_CD,                                              " ).append("\n"); 
		...
		query.append("                ROLLUP(QTA.TRD_CD, QTA.DIR_CD), QTA.BSE_MON                                                  " ).append("\n"); 
		query.append("                                                                                                          " ).append("\n"); 
		query.append("                                                                                                          " ).append("\n"); 
		...
		query.append("                                                                                                                  " ).append("\n"); 
		query.append("                GROUP BY" ).append("\n"); 
		query.append("                        QTA.BSE_YR, QTA.BSE_MON, QTA.TRD_CD, QTA.RLANE_CD, NVL(DIR.CONV_DIR_CD, QTA.DIR_CD),     " ).append("\n"); 
		query.append("                        VVD.VSL_CD,VVD.SKD_VOY_NO,VVD.SKD_DIR_CD                                                 " ).append("\n"); 
		query.append("                ) QTA                                                                                             " ).append("\n"); 
		query.append("                                                                                                          " ).append("\n"); 
		query.append("        GROUP BY" ).append("\n"); 
		...
		query.append("                DECODE(MRS.TRD_CD, '',0, @[trade] ,1,2) SUB_SEQ,                                                         " ).append("\n"); 
		query.append("                DECODE(MRS.TRD_CD, '', 'TOT', MRS.TRD_CD) AS TRD_CD,                                                                            " ).append("\n"); 
		...
		query.append("	                 AND  DIR.BSE_QTR_CD (+)  = @[bse_qtr_cd]" ).append("\n"); 
		query.append("                GROUP BY" ).append("\n"); 
		query.append("                        MRS.BSE_YR, MRS.BSE_MON, MRS.TRD_CD, MRS.RLANE_CD, MRS.DIR_CD,                           " ).append("\n"); 
		query.append("                   		  VVD.VSL_CD,VVD.SKD_VOY_NO,VVD.SKD_DIR_CD                                                    " ).append("\n"); 
		query.append("                ) MRS                                                                                             " ).append("\n"); 
		query.append("        GROUP BY" ).append("\n"); 
		query.append("                GROUPING SETS(								       											 " ).append("\n"); 
		query.append("                    (MRS.BSE_MON, MRS.TRD_CD),						       										 " ).append("\n"); 
		query.append("                    (MRS.BSE_MON, MRS.TRD_CD, MRS.DIR_CD),					       								 " ).append("\n"); 
		query.append("                    (MRS.TRD_CD, MRS.DIR_CD),						       										 " ).append("\n"); 
		query.append("                    (MRS.BSE_MON), (MRS.TRD_CD),						      										 " ).append("\n"); 
		query.append("                    ()									       													 " ).append("\n"); 
		query.append("                    )                                                                                         " ).append("\n"); 
		query.append("                                                                                                              " ).append("\n"); 
		...
		query.append("                DECODE(TRD.TRD_CD,'',0, @[trade] ,1,2) SUB_SEQ,                                                          " ).append("\n"); 
		query.append("                DECODE(TRD.TRD_CD, '', 'TOT', TRD.TRD_CD) AS TRD_CD,                                                             " ).append("\n"); 
		...
		query.append("                GROUP BY" ).append("\n"); 
		query.append("                        TRD.MQTA_STEP_CD,TRD.BSE_YR,TRD.BSE_MON,TRD.TRD_CD,TRD.RLANE_CD,TRD.DIR_CD,              " ).append("\n"); 
		query.append("                        TRD.SPRT_GRP_CD,TRD.BSA_GRP_CD                                                              " ).append("\n"); 
		query.append("                ) TRD                                                                                             " ).append("\n"); 
		query.append("          GROUP BY" ).append("\n"); 
		query.append("                  GROUPING SETS(								       											 " ).append("\n"); 
		query.append("                    (TRD.BSE_MON, TRD.TRD_CD),						       										 " ).append("\n"); 
		query.append("                    (TRD.BSE_MON, TRD.TRD_CD, TRD.DIR_CD),					       								 " ).append("\n"); 
		query.append("                    (TRD.TRD_CD, TRD.DIR_CD),						       										 " ).append("\n"); 
		query.append("                    (TRD.BSE_MON), (TRD.TRD_CD),						      										 " ).append("\n"); 
		query.append("                    ()									       													 " ).append("\n"); 
		query.append("                    ),TRD.MQTA_STEP_CD                                                                        " ).append("\n"); 
		query.append("                                                                                                              " ).append("\n"); 
		...
		query.append("                                                                                                              " ).append("\n"); 
		query.append("                DECODE(RHQ.TRD_CD,'',0, @[trade] ,1,2) SUB_SEQ,    		    									         " ).append("\n"); 
		query.append("                DECODE(RHQ.TRD_CD,'', 'TOT', RHQ.TRD_CD ) AS TRD_CD,                                                                       " ).append("\n"); 
		...
		query.append("                GROUP BY" ).append("\n"); 
		query.append("                        RHQ.MQTA_STEP_CD,RHQ.BSE_YR,RHQ.BSE_MON,RHQ.TRD_CD,RHQ.RLANE_CD,RHQ.DIR_CD,              " ).append("\n"); 
		query.append("                        RHQ.SPRT_GRP_CD,RHQ.BSA_GRP_CD                                                              " ).append("\n"); 
		query.append("                ) RHQ                                                                                             " ).append("\n"); 
		query.append("          GROUP BY" ).append("\n"); 
		query.append("                  GROUPING SETS(								       											 " ).append("\n"); 
		query.append("                    (RHQ.BSE_MON, RHQ.TRD_CD),						       										 " ).append("\n"); 
		query.append("                    (RHQ.BSE_MON, RHQ.TRD_CD, RHQ.DIR_CD),					       								 " ).append("\n"); 
		query.append("                    (RHQ.TRD_CD, RHQ.DIR_CD),						       										 " ).append("\n"); 
		query.append("                    (RHQ.BSE_MON), (RHQ.TRD_CD),						      										 " ).append("\n"); 
		query.append("                    ()									       													 " ).append("\n"); 
		query.append("                    )                                                                                         " ).append("\n"); 
		query.append("                                                                                                              " ).append("\n"); 
		...
		query.append("GROUP BY UNI.SUB_SEQ, UNI.DIR_SEQ, UNI.DIR_CD, ITM.CODE, ITM.TEXT, ITM.ROW_SEQ, UNI.TRD_CD                " ).append("\n"); 
		query.append("ORDER BY UNI.SUB_SEQ, UNI.TRD_CD, UNI.DIR_SEQ, ITM.ROW_SEQ" ).append("\n"); 
