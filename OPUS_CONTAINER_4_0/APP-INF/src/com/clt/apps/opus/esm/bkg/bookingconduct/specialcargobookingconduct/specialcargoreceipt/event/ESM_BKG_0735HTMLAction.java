...
*@FileName : ESM_BKG_0735HTMLAction.java
...
public class ESM_BKG_0735HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0735HTMLAction 객체를 생성
	 */
	public ESM_BKG_0735HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0735Event event = new EsmBkg0735Event();
        log.debug("::CALL::> ESM_BKG_0735_HTMLAction - " + command.getCommand());
        ...
        if(command.isCommand(FormCommand.DEFAULT)) {
        	...
        	String bkgNo = JSPUtil.getParameter(request, "bkg_no");
        	String pckTpCd = JSPUtil.getParameter(request, "pck_tp_cd");
