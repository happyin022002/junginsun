...
*@FileName : AGNCommApprovalDBDAOGetAudNoFromAcmAgmCommRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommApprovalDBDAOGetAudNoFromAcmAgmCommRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommApprovalDBDAOGetAudNoFromAcmAgmCommRSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommApprovalDBDAOGetAudNoFromAcmAgmCommRSQL").append("\n");
		query.append("*/").append("\n");
	}
