...
*@FileName : ESM_SAQ_0149HTMLAction.java
...
public class ESM_SAQ_0149HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0149HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0149HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0149Event event = new EsmSaq0149Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonQtaRhqVOs = saqMonQtaRhqVO.fromRequestGrid(request, event.getQuotaConditionVO(), "0149", "0149");
