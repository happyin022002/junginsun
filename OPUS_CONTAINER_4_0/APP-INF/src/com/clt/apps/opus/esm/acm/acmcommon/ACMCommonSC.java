...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.acm.acmcommon;

import java.util.List;

import com.clt.apps.opus.esm.acm.acmcommon.acmcommon.basic.ACMCommonBC;
import com.clt.apps.opus.esm.acm.acmcommon.acmcommon.basic.ACMCommonBCImpl;
import com.clt.apps.opus.esm.acm.acmcommon.acmcommon.event.AcmCommonEvent;
import com.clt.apps.opus.esm.acm.acmcommon.acmcommon.event.EsmAcm0113Event;
import com.clt.apps.opus.esm.acm.acmcommon.acmcommon.integration.ACMCommonDBDAO;
...
/**
 * OPUS-ACMCommon Business Logic ServiceCommand - OPUS-ACMCommon 대한 비지니스 트랜잭션을 처리한다.
 *
 * @author KIM, Sang-Soo
 * @see ACMCommonDBDAO
 * @since J2EE 1.6
...
public class ACMCommonSC extends ServiceCommandSupport {
	 ...
	 * OPUS-ACMCommon system 업무에서 발생하는 모든 이벤트의 분기처리<br>
	 *
	 * @param e Event
