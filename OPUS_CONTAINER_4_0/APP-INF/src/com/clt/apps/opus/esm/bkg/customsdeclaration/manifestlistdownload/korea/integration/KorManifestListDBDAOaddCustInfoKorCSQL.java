...
*@FileName : KorManifestListDBDAOaddCustInfoKorCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOaddCustInfoKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOaddCustInfoKorCSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOaddCustInfoKorCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("DECODE(@[bkg_cgo_tp], 'P', COM_ConstantMgr_PKG.COM_getCompanyName_FNC(), TRIM(BKG_SPCLCHAR_CONV_FNC(@[cust_name], 'Y'))), " ).append("\n"); 
