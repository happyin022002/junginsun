...
*@FileName : FACCommCalculationDBDAOSearchRevLanebndInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FACCommCalculationDBDAOSearchRevLanebndInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FACCommCalculationDBDAOSearchRevLanebndInfoRSQL
	  * </pre>
	  */
	public FACCommCalculationDBDAOSearchRevLanebndInfoRSQL(){
		setQuery();
		...
		query.append("FileName : FACCommCalculationDBDAOSearchRevLanebndInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
