...
*@FileName : LaneSimulationDBDAOMultiSimGrpbProjUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimGrpbProjUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimGrpbProjUSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimGrpbProjUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO COA_SIM_VOL_PRJ A" ).append("\n"); 
		...
		query.append("SET GRS_RPB_REV = @[grs_rpb_rev]," ).append("\n"); 
