...
public class EurTroDtlVO extends AbstractValueObject {
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setArrDtHhmi(JSPUtil.getParameter(request, prefix + "arr_dt_hhmi", ""));
        ...
        setDorAddr1(JSPUtil.getParameter(request, prefix + "dor_addr_1", ""));
        setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
        setDorAddr3(JSPUtil.getParameter(request, prefix + "dor_addr_3", ""));
        setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
        setBkgNo(JSPUtil.getParameter(request, prefix + "bkg_no", ""));
        setDorAddr2(JSPUtil.getParameter(request, prefix + "dor_addr_2", ""));
        setDorAddr4(JSPUtil.getParameter(request, prefix + "dor_addr_4", ""));
