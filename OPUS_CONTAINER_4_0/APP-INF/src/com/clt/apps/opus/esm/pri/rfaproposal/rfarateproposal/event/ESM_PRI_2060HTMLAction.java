...
public class ESM_PRI_2060HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2060Event event = new EsmPri2060Event();

		if (command.isCommand(FormCommand.MODIFY02)) {
			PriRpScpRtCmdtHdrVO vo = (PriRpScpRtCmdtHdrVO) getVO(request, PriRpScpRtCmdtHdrVO.class);
			event.setPriRpScpRtCmdtHdrVO(vo);
