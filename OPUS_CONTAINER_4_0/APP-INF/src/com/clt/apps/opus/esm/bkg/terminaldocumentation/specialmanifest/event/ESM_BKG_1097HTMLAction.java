...
*@FileName : ESM_BKG_0969HTMLAction.java
 ...
 * @see EsmBkg1097Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_1097HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1097Event event = new EsmBkg1097Event();

		if(command.isCommand(FormCommand.SEARCH)) {

			event.setFeederInfoVO((FeederInfoVO) getVO(request, FeederInfoVO.class));

		} else if(command.isCommand(FormCommand.MULTI)) {

			event.setFeederInfoVOs((FeederInfoVO[])getVOs(request, FeederInfoVO.class, "sheet1_"));
		}
