...
public class AncsManifestListDownloadDBDAOsearchAncsCstmsCntrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           AND A_VVD.POD_CD     = B.POD_CD) E" ).append("\n"); 
		...
		query.append("          AND B.VSL_CD = SUBSTR( E.VVDINFO, 1, 4 )" ).append("\n"); 
		query.append("          AND B.SKD_VOY_NO = SUBSTR( E.VVDINFO, 5, 4 )" ).append("\n"); 
		query.append("          AND B.SKD_DIR_CD = SUBSTR( E.VVDINFO, 9, 1 )" ).append("\n"); 
		...
		query.append("  AND BL.POD_CD = A_VVD.POD_CD" ).append("\n"); 
		query.append("  AND BL.BKG_NO = A_VVD.BKG_NO" ).append("\n"); 
