...
public class ESM_BKG_0360HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0360Event event = new EsmBkg0360Event();
        log.debug("***** ESM_BKG_360HTMLAction : " + command.getCommand());
