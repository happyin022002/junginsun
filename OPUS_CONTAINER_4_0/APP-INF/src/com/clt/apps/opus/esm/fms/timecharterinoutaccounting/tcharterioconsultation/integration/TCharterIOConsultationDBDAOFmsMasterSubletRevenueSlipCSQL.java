...
*@FileName : TCharterIOConsultationDBDAOFmsMasterSubletRevenueSlipCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOFmsMasterSubletRevenueSlipCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Master Sublet Revenue Insert
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOFmsMasterSubletRevenueSlipCSQL(){
		setQuery();
		...
		params.put("csr_usr_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TCharterIOConsultationDBDAOFmsMasterSubletRevenueSlipCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	@[flet_ctrt_no]," ).append("\n"); 
		query.append("	@[csr_curr_cd]," ).append("\n"); 
		query.append("	ROUND(@[rqst_amt], (SELECT DP_PRCS_KNT FROM MDM_CURRENCY WHERE CURR_CD = @[csr_curr_cd])), " ).append("\n"); 
		query.append("	@[csr_usr_id]," ).append("\n"); 
		query.append("	@[csr_desc]," ).append("\n"); 
		query.append("	ROUND(@[rqst_amt], (SELECT DP_PRCS_KNT FROM MDM_CURRENCY WHERE CURR_CD = @[csr_curr_cd]))," ).append("\n"); 
		query.append("	@[eff_dt]," ).append("\n"); 
