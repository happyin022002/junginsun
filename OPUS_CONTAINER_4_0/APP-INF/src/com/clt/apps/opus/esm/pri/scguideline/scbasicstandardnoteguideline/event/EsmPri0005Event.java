...
public class EsmPri0005Event extends EventSupport {
	...
	public void setPriSgStndNoteVOS(PriSgStndNoteVO[] prisgstndnotevos){
		if (prisgstndnotevos != null) {
			PriSgStndNoteVO[] tmpVOs = new PriSgStndNoteVO[prisgstndnotevos.length];
			System.arraycopy(prisgstndnotevos, 0, tmpVOs, 0, tmpVOs.length);
			this.prisgstndnotevos = tmpVOs;
		}
	}
	...
	public void setPriSgStndNoteCtntVOS(PriSgStndNoteCtntVO[] prisgstndnotectntvos){
		if (prisgstndnotectntvos != null) {
			PriSgStndNoteCtntVO[] tmpVOs = new PriSgStndNoteCtntVO[prisgstndnotectntvos.length];
			System.arraycopy(prisgstndnotectntvos, 0, tmpVOs, 0, tmpVOs.length);
			this.prisgstndnotectntvos = tmpVOs;
		}
	}
	...
	public void setPriSgStndNoteHdrVOS(PriSgStndNoteHdrVO[] prisgstndnotehdrvos){
		if (prisgstndnotehdrvos != null) {
			PriSgStndNoteHdrVO[] tmpVOs = new PriSgStndNoteHdrVO[prisgstndnotehdrvos.length];
			System.arraycopy(prisgstndnotehdrvos, 0, tmpVOs, 0, tmpVOs.length);
			this.prisgstndnotehdrvos = tmpVOs;
		}
	}
	...
	public PriSgStndNoteVO[] getPriSgStndNoteVOS(){
		PriSgStndNoteVO[] tmpVOs = null;
		if (this.prisgstndnotevos != null) {
			tmpVOs = new PriSgStndNoteVO[prisgstndnotevos.length];
			System.arraycopy(prisgstndnotevos, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
	...
	public PriSgStndNoteCtntVO[] getPriSgStndNoteCtntVOS(){
		PriSgStndNoteCtntVO[] tmpVOs = null;
		if (this.prisgstndnotectntvos != null) {
			tmpVOs = new PriSgStndNoteCtntVO[prisgstndnotectntvos.length];
			System.arraycopy(prisgstndnotectntvos, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
	...
	public PriSgStndNoteHdrVO[] getPriSgStndNoteHdrVOS(){
		PriSgStndNoteHdrVO[] tmpVOs = null;
		if (this.prisgstndnotehdrvos != null) {
			tmpVOs = new PriSgStndNoteHdrVO[prisgstndnotehdrvos.length];
			System.arraycopy(prisgstndnotehdrvos, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
