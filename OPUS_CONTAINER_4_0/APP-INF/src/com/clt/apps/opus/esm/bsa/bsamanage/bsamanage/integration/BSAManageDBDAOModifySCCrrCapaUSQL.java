...
*@FileName : BSAManageDBDAOModifySCCrrCapaUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifySCCrrCapaUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySCCrrCapa UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOModifySCCrrCapaUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifySCCrrCapaUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BSA_SLT_CHTR_CRR_CAPA" ).append("\n"); 
