...
public class CargoReleaseOrderDBDAOAddJapDorHistoryByTransCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC(@[evnt_ofc_cd])) AS EVNT_DT" ).append("\n"); 
		query.append("     , GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,sysdate,'GMT') AS EVNT_GDT  " ).append("\n"); 
