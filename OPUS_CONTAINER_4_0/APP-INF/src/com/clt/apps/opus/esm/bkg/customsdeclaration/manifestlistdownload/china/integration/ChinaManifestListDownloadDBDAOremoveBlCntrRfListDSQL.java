...
*@FileName : ChinaManifestListDownloadDBDAOremoveBlCntrRfListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOremoveBlCntrRfListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOremoveBlCntrRfListDSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOremoveBlCntrRfListDSQL").append("\n");
		query.append("*/").append("\n");
	}
