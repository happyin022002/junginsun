 ...
 * EAIDAO 연동 처리
 * @author Choi Do soon
 * @see com.clt.framework.support.layer.integration.EAIDAOSupport
 * @since J2EE 1.4
 */
public class EmptyReleaseOrderEAIDAO extends EAIDAOSupport {
	 ...
	 * @throws Exception
	 */
	private List<String> sendRDEmail(SendMtyRlseOrdVO[] emailInfos,BkgEmlEdtVO bkgEmlEdtVO,String ccEmail, String bccRcvrEml) throws Exception {
		...
		try {
			...
			for (int i=0; i<emailInfos.length; i++) {
				...
				vo.setXptFileNm("OPUS"+bkgNo+".pdf");
	 ...
	 * @throws Exception
	 */
	public String sendMtyRlseOrdByEmail(SendMtyRlseOrdVO sendMtyRlseOrdVO,BkgEmlEdtVO bkgEmlEdtVO,String ccEmail, String bccRcvrEml) throws Exception {
				
		SendMtyRlseOrdVO[] infos = new SendMtyRlseOrdVO[1];

		infos[0] = sendMtyRlseOrdVO;
		
		List<String> sendId = sendRDEmail(infos, bkgEmlEdtVO, ccEmail, bccRcvrEml);
