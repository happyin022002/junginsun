...
*@FileName : MonthlyQuotaCreationDBDAODeleteOfcAdjustDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCreationDBDAODeleteOfcAdjustDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 버전의 Office Adjust Data를 삭제한다.
	  * </pre>
	  */
	public MonthlyQuotaCreationDBDAODeleteOfcAdjustDSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCreationDBDAODeleteOfcAdjustDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
