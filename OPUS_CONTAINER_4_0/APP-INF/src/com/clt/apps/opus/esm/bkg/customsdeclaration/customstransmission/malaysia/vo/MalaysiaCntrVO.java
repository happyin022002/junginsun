...
*@FileName : MalaysiaCntrVO.java
*@FileTitle : MalaysiaCntrVO
*Open Issues :
*Change history :
...
public class MalaysiaCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MalaysiaCntrVO> models = new ArrayList<MalaysiaCntrVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tp_cd_2nd", getTpCd2nd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tp_cd_2nd", "tpCd2nd");
	 ...
	 * @param tpCd2nd
	 */
	public void setTpCd2nd(String tpCd2nd) {
		this.tpCd2nd = tpCd2nd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTpCd2nd(JSPUtil.getParameter(request, prefix + "tp_cd_2nd", ""));
	 ...
	 * @param request
	 * @return MalaysiaCntrVO[]
	 */
	public MalaysiaCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MalaysiaCntrVO[]
	 */
	public MalaysiaCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MalaysiaCntrVO model = null;
		...
		try {
			...
			String[] tpCd2nd = (JSPUtil.getParameter(request, prefix	+ "tp_cd_2nd", length));
	 ...
	 * @return MalaysiaCntrVO[]
	 */
	public MalaysiaCntrVO[] getMalaysiaCntrVOs(){
		MalaysiaCntrVO[] vos = (MalaysiaCntrVO[])models.toArray(new MalaysiaCntrVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tpCd2nd = this.tpCd2nd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
