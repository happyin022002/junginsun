...
*@FileName : MalaysiaManifestListDownloadDBDAOaddImpStsInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MalaysiaManifestListDownloadDBDAOaddImpStsInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MalaysiaManifestListDownloadDBDAOaddImpStsInfoCSQL(){
		setQuery();
		...
		query.append("FileName : MalaysiaManifestListDownloadDBDAOaddImpStsInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_MY_IMP_STS" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("        NVL(@[vgm_wgt], 0)," ).append("\n"); 
