...
public class EsmBkg0588Event extends EventSupport {
	...
	public void setSpecialCargoSummaryReportVOS(SpecialCargoSummaryReportVO[] specialCargoSummaryReportVOs){
		if(specialCargoSummaryReportVOs != null){
			SpecialCargoSummaryReportVO[] tmpVOs = Arrays.copyOf(specialCargoSummaryReportVOs, specialCargoSummaryReportVOs.length);
			this.specialCargoSummaryReportVOs = tmpVOs;
		}
	}
	...
	public SpecialCargoSummaryReportVO[] getSpecialCargoSummaryReportVOS(){
		SpecialCargoSummaryReportVO[] rtnVOs = null;
		if(this.specialCargoSummaryReportVOs != null){
			rtnVOs= Arrays.copyOf(specialCargoSummaryReportVOs, specialCargoSummaryReportVOs.length);
		}
		return rtnVOs;
	}
