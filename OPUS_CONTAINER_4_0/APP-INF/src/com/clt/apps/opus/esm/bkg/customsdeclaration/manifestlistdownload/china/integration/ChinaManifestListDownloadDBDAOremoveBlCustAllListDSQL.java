...
*@FileName : ChinaManifestListDownloadDBDAOremoveBlCustAllListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOremoveBlCustAllListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOremoveBlCustAllListDSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOremoveBlCustAllListDSQL").append("\n");
		query.append("*/").append("\n");
	}
