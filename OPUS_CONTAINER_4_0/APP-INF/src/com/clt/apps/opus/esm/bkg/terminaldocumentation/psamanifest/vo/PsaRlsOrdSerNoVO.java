...
*@FileName : PsaRlsOrdSerNoVO.java
*@FileTitle : PsaRlsOrdSerNoVO
*Open Issues :
*Change history :
...
public class PsaRlsOrdSerNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<PsaRlsOrdSerNoVO> models = new ArrayList<PsaRlsOrdSerNoVO>();
	...
	public PsaRlsOrdSerNoVO() {}

	public PsaRlsOrdSerNoVO(String ibflag, String pagerows, String bkgNo, String bkgSeq, String addSeq, String psaSerNo) {
...
/**
	 ...
	 * @param request
	 * @return PsaRlsOrdSerNoVO[]
	 */
	public PsaRlsOrdSerNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaRlsOrdSerNoVO[]
	 */
	public PsaRlsOrdSerNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaRlsOrdSerNoVO model = null;
	 ...
	 * @return PsaRlsOrdSerNoVO[]
	 */
	public PsaRlsOrdSerNoVO[] getPsaRlsOrdSerNoVOs(){
		PsaRlsOrdSerNoVO[] vos = (PsaRlsOrdSerNoVO[])models.toArray(new PsaRlsOrdSerNoVO[models.size()]);
		return vos;
	}
