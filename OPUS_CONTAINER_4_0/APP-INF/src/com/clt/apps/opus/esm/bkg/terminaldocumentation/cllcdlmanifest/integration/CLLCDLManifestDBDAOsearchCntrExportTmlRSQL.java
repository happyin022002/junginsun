...
public class CLLCDLManifestDBDAOsearchCntrExportTmlRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND VSL_CD     = SUBSTR( @[form_nyk_vvd], 1, 4 )" ).append("\n");
		query.append("AND SKD_VOY_NO = SUBSTR( @[form_nyk_vvd], 5, 4 )" ).append("\n");
		query.append("AND SKD_DIR_CD = SUBSTR( @[form_nyk_vvd], 9, 1 )" ).append("\n");
