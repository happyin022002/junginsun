...
*@FileName : CommonDBDAOSearchSaqMonQtaRhqOfficeAddSubtrdListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqMonQtaRhqOfficeAddSubtrdListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchSaqMonQtaRhqOfficeAddSubtrdListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchSaqMonQtaRhqOfficeAddSubtrdListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT R.SUB_TRD_CD AS TEXT, R.SUB_TRD_CD AS CODE   " ).append("\n"); 
		...
		query.append("ORDER BY R.SUB_TRD_CD                                                   " ).append("\n"); 
