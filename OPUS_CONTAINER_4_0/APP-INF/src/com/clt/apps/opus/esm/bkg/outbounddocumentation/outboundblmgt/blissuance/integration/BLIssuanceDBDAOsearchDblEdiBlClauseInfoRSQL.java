...
*@FileName : BLIssuanceDBDAOsearchDblEdiBlClauseInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOsearchDblEdiBlClauseInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BLIssuanceDBDAOsearchDblEdiBlClauseInfo
	  * </pre>
	  */
	public BLIssuanceDBDAOsearchDblEdiBlClauseInfoRSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOsearchDblEdiBlClauseInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT '{I_BL_CLAUSE' || CHR (10) || " ).append("\n"); 
		query.append("       'IB_BL_CLAUSE_DESC:' || BL_CLUZ_DESC || CHR (10) || " ).append("\n"); 
		query.append("       'IB_BL_CLAUSE_CD:' || BL_CLUZ_CD || CHR (10) || " ).append("\n"); 
		query.append("       '}I_BL_CLAUSE' || CHR (10) AS FF" ).append("\n"); 
