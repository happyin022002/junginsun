...
public class DubaiManifestListDownloadDBDAOsearchDubaiCntrManifestListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                                        BKG_GET_BKG_CTMS_CD_FNC('DU','MANI_CNTR_TPSZ_CD','3593',1), BKG_GET_BKG_CTMS_CD_FNC('DU','MANI_CNTR_TPSZ_CD','3593',2), 0), MDM.CNTR_TPSZ_TARE_WGT) , S.TARE_WGT) " ).append("\n");
		...
		query.append("          ,B.PCK_CMDT_DESC || B.CNTR_CMDT_DESC || B.CMDT_DESC || CHR(10) AS CNTR_MF_GDS_DESC" ).append("\n");
