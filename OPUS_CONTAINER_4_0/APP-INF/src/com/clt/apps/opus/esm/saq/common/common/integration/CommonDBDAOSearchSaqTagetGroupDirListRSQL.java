...
*@FileName : CommonDBDAOSearchSaqTagetGroupDirListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqTagetGroupDirListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Direction Code search in Target Group and Trade Code
	  * </pre>
	  */
	public CommonDBDAOSearchSaqTagetGroupDirListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchSaqTagetGroupDirListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND  SAQ_TGT_GRP_CD = NVL(@[targetGrp], SAQ_TGT_GRP_CD)" ).append("\n"); 
