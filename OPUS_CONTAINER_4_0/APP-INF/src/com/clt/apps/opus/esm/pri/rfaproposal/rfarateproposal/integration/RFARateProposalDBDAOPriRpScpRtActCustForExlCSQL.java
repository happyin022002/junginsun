...
*@FileName : RFARateProposalDBDAOPriRpScpRtActCustForExlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtActCustForExlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT PRI_RP_SCP_RT_ACT_CUST
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtActCustForExlCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtActCustForExlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ INDEX_DESC(A PRI_RP_SCP_RT_ACT_CUST) */" ).append("\n"); 
		query.append("                  ACT_CUST_SEQ" ).append("\n"); 
