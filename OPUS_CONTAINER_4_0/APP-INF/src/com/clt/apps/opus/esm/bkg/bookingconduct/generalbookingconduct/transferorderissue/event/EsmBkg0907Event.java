...
public class EsmBkg0907Event extends EventSupport {
	...
	public BkgEurCntrListVO[] getBkgEurCntrListVOs() {
		BkgEurCntrListVO[] tmpVOs = null;
		if (this. bkgEurCntrListVOs != null) {
			tmpVOs = Arrays.copyOf(bkgEurCntrListVOs, bkgEurCntrListVOs .length);
		}
		return tmpVOs;
	}

	public void setBkgEurCntrListVOs(BkgEurCntrListVO[] bkgEurCntrListVOs) {
		if (bkgEurCntrListVOs != null) {
			BkgEurCntrListVO[] tmpVOs = Arrays.copyOf(bkgEurCntrListVOs, bkgEurCntrListVOs .length);
			this. bkgEurCntrListVOs = tmpVOs;
		}
	}
