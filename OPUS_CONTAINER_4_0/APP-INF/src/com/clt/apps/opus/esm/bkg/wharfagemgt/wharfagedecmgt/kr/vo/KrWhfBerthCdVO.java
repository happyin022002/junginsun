...
*@FileName : KrWhfBerthCdVO.java
*@FileTitle : KrWhfBerthCdVO
*Open Issues :
*Change history :
...
public class KrWhfBerthCdVO extends WhfBerthCdVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrWhfBerthCdVO> models = new ArrayList<KrWhfBerthCdVO>();
	...
	public KrWhfBerthCdVO() {}

	public KrWhfBerthCdVO(String ibflag, String pagerows, String portCd, String brthCd, String brthKrNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public KrWhfBerthCdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfBerthCdVO[]
	 */
	public KrWhfBerthCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrWhfBerthCdVO model = null;
	 ...
	 * @return KrWhfBerthCdVO[]
	 */
	public KrWhfBerthCdVO[] getKrWhfBerthCdVOs(){
		KrWhfBerthCdVO[] vos = (KrWhfBerthCdVO[])models.toArray(new KrWhfBerthCdVO[models.size()]);
		return vos;
	}
