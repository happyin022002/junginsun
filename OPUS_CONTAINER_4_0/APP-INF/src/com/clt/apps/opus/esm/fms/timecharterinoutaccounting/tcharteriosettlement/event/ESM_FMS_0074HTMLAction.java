...
*@FileName : ESM_FMS_0074HTMLAction.java
...
public class ESM_FMS_0074HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0074HTMLAction 객체를 생성
	 */
	public ESM_FMS_0074HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0074Event event = new EsmFms0074Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondSearchPrepaymentSettleVO((CondSearchPrepaymentSettleVO)getVO(request, CondSearchPrepaymentSettleVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setCondSearchPrepaymentSettleVvdVO((CondSearchPrepaymentSettleVvdVO)getVO(request, CondSearchPrepaymentSettleVvdVO .class));
		}
