...
*@FileName : MxChargeTotalVO.java
*@FileTitle : MxChargeTotalVO
*Open Issues :
*Change history :
...
public class MxChargeTotalVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MxChargeTotalVO> models = new ArrayList<MxChargeTotalVO>();
	...
	public MxChargeTotalVO() {}

	public MxChargeTotalVO(String ibflag, String pagerows, String ppdTotal, String cctTotal, String totalCur) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return MxChargeTotalVO[]
	 */
	public MxChargeTotalVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MxChargeTotalVO[]
	 */
	public MxChargeTotalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MxChargeTotalVO model = null;
	 ...
	 * @return MxChargeTotalVO[]
	 */
	public MxChargeTotalVO[] getMxChargeTotalVOs(){
		MxChargeTotalVO[] vos = (MxChargeTotalVO[])models.toArray(new MxChargeTotalVO[models.size()]);
		return vos;
	}
