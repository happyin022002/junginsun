...
*@FileName : MonthlyQuotaAdjustmentRHQDBDAOGetRgnSaqStsCdCount0075RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentRHQDBDAOGetRgnSaqStsCdCount0075RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentRHQDBDAOGetRgnSaqStsCdCount0075RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentRHQDBDAOGetRgnSaqStsCdCount0075RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE  MQTA_STEP_CD = '05'" ).append("\n"); 
		...
		query.append("    SELECT DISTINCT CTRT_RGN_OFC_CD" ).append("\n"); 
		query.append("    FROM   SAQ_MON_QTA_RHQ" ).append("\n"); 
		query.append("    WHERE  MQTA_STEP_CD = '04'" ).append("\n"); 
		query.append("    AND    BSE_YR = @[year]" ).append("\n"); 
		query.append("    AND    BSE_QTR_CD = @[bse_quarter]" ).append("\n"); 
		query.append("    AND    TRD_CD = @[trade]" ).append("\n"); 
		query.append("    AND    DIR_CD = @[bound]" ).append("\n"); 
		...
		query.append("    AND   B.INTG_CD_VAL_CTNT = @[saq_sts_cd]" ).append("\n"); 
