...
*@FileName : AGNCommAgreementDBDAOAddAgentRateDetailChgHisListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateDetailChgHisListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgentRateDetailChgHisList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateDetailChgHisListCSQL(){
		setQuery();
		...
		params.put("chg_div_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateDetailChgHisListCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_AGMT_DTL_CHG_HIS" ).append("\n");
