...
*@FileName : CommonDBDAOSearchSaqMonQtaRhqOfficeAddAreaListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqMonQtaRhqOfficeAddAreaListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchSaqMonQtaRhqOfficeAddAreaListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchSaqMonQtaRhqOfficeAddAreaListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	                                                                                          AND MQTA_VER_NO  = @[mqta_ver_no]" ).append("\n"); 
		query.append("	                                                                                          AND RLANE_CD     = @[rlane_cd]  )  )" ).append("\n"); 
		query.append("	 ORDER BY DECODE(NVL(N3RD_PRNT_OFC_CD, 99), '99', 99, 11)||N3RD_PRNT_OFC_CD" ).append("\n"); 
