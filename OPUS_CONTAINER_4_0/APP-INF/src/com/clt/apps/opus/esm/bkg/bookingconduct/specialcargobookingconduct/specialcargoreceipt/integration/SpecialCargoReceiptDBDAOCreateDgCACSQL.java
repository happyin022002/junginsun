...
*@FileName : SpecialCargoReceiptDBDAOCreateDgCACSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOCreateDgCACSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SpecialCargoReceiptDBDAOCreateDgCACSQL
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOCreateDgCACSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOCreateDgCACSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	, CSTMS_EXPT_FLG" ).append("\n"); 
		query.append("	, N1ST_PRE_VVD_CD" ).append("\n"); 
		query.append("   )" ).append("\n"); 
		query.append("#if (${copy_type_cd} == 'BKG')" ).append("\n"); 
