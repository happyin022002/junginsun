...
*@FileName : EBookingReceiptDBDAOSearchOpusDgRiderListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOSearchOpusDgRiderListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EBookingReceiptDBDAOSearchOpusDgRiderListRSQL
	  * </pre>
	  */
	public EBookingReceiptDBDAOSearchOpusDgRiderListRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOSearchOpusDgRiderListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
