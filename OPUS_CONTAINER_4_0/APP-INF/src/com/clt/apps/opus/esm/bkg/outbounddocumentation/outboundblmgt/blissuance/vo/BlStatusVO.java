...
public class BlStatusVO extends AbstractValueObject {
	...
	/* Column Info */
	private String cntrReady = null;
	/* Column Info */
	private String cneeReady = null;
	/* Page Number */
	...
	public BlStatusVO(String ibflag, String pagerows, String chgReady, String mkReady, String chgPpdInd, String chgPpdThirdInd, String doChkInd, String cntrReady, String cneeReady) {
		...
		this.cntrReady = cntrReady;
		this.cneeReady = cneeReady;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cntr_ready", getCntrReady());
		this.hashColumns.put("cnee_ready", getCneeReady());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cntr_ready", "cntrReady");
		this.hashFields.put("cnee_ready", "cneeReady");
	 ...
	 * @return cntrReady
	 */
	public String getCntrReady() {
		return this.cntrReady;
	}
	 ...
	 * @return cneeReady
	 */
	public String getCneeReady() {
		return this.cneeReady;
	}
	 ...
	 * @param cntrReady
	 */
	public void setCntrReady(String cntrReady) {
		this.cntrReady = cntrReady;
	}
	 ...
	 * @param cneeReady
	 */
	public void setCneeReady(String cneeReady) {
		this.cneeReady = cneeReady;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCntrReady(JSPUtil.getParameter(request, "cntr_ready", ""));
		setCneeReady(JSPUtil.getParameter(request, "cnee_ready", ""));
	}
	...
	public BlStatusVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cntrReady = (JSPUtil.getParameter(request, prefix	+ "cntr_ready", length));
			String[] cneeReady = (JSPUtil.getParameter(request, prefix	+ "cnee_ready", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (cntrReady[i] != null)
					model.setCntrReady(cntrReady[i]);
				if (cneeReady[i] != null)
					model.setCneeReady(cneeReady[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.cntrReady = this.cntrReady .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cneeReady = this.cneeReady .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
