...
*@FileName : Eur24ManifestDownloadDBDAOEur24BlinfoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOEur24BlinfoVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAOEur24BlinfoVORSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOEur24BlinfoVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.eur24.integration").append("\n"); 
		query.append("FileName : Eur24ManifestDownloadDBDAOEur24BlinfoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
