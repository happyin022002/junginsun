...
*@FileName : SCAffiliateProposalDBDAOPriSpAfilVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCAffiliateProposalDBDAOPriSpAfilVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCAffiliateProposalDBDAOPriSpAfilVODSQL(){
		setQuery();
		...
		query.append("FileName : SCAffiliateProposalDBDAOPriSpAfilVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_SP_AFIL" ).append("\n"); 
