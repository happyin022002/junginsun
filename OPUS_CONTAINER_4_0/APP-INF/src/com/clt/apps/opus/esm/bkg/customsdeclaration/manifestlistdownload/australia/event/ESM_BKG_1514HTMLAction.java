...
*@FileName : ESM_BKG_1514HTMLAction.java
*@FileTitle : ESM_BKG_1514HTMLAction
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
/**
 * HTTP Parser<br>
 * - ESM_BKG_1514 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author KIM, Sang-Soo
 * @see EsmBkg1514Event 참조
 * @since J2EE 1.6
 */

public class ESM_BKG_1514HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1514HTMLAction 객체를 생성
	 */
	public ESM_BKG_1514HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmBkg1514Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1514Event event = new EsmBkg1514Event();
