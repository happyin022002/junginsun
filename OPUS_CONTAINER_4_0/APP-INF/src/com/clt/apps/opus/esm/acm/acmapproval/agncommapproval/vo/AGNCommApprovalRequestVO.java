...
public class AGNCommApprovalRequestVO extends AbstractValueObject {
	...
	/* Column Info */
	private String hAprlOfcCd = null;
	/* Column Info */
	private String hAprlOfcNm = null;
	/* Column Info */
	...
	public AGNCommApprovalRequestVO(String ibflag, String pagerows, String audNo, String asaNo, String invDt, String arOfcCd, String agnCd, String invTaxRt, String creUsrId, String updUsrId, String usrNm, String usrEml, String sRevChg, String asaCnt, String asaCurrCd, String localDt, String errBkgNo, String errBkgCreDt, String fincRgnCd, String coaIntrCmpyCd, String errVvdBkgNo, String errVvd, String vndrSeq, String apCtrCd, String arHdQtrOfcCd, String csrNo, String tjOfcCd, String dtrbCnt, String vndrNo, String invTermDt, String csrCurrCd, String csrAmt, String glDt, String currCd, String vndrTermNm, String invDesc, String payMzdLuCd, String payGrpLuCd, String apOfcCd, String calcNo, String hAprlOfcCd, String hAprlOfcNm
		...
		this.hAprlOfcCd = hAprlOfcCd;
		this.hAprlOfcNm = hAprlOfcNm;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("h_aprl_ofc_cd", getHAprlOfcCd());
		this.hashColumns.put("h_aprl_ofc_nm", getHAprlOfcNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("h_aprl_ofc_cd", "hAprlOfcCd");
		this.hashFields.put("h_aprl_ofc_nm", "hAprlOfcNm");
	 ...
	 * @return hAprlOfcCd
	 */
	public String getHAprlOfcCd() {
		return this.hAprlOfcCd;
	}
	 ...
	 * @return hAprlOfcNm
	 */
	public String getHAprlOfcNm() {
		return this.hAprlOfcNm;
	}
	 ...
	 * @param hAprlOfcCd
	 */
	public void setHAprlOfcCd(String hAprlOfcCd) {
		this.hAprlOfcCd = hAprlOfcCd;
	}
	 ...
	 * @param hAprlOfcNm
	 */
	public void setHAprlOfcNm(String hAprlOfcNm) {
		this.hAprlOfcNm = hAprlOfcNm;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setHAprlOfcCd(JSPUtil.getParameter(request, prefix + "h_aprl_ofc_cd", ""));
		setHAprlOfcNm(JSPUtil.getParameter(request, prefix + "h_aprl_ofc_nm", ""));
	...
	public AGNCommApprovalRequestVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] hAprlOfcCd = (JSPUtil.getParameter(request, prefix	+ "h_aprl_ofc_cd", length));
			String[] hAprlOfcNm = (JSPUtil.getParameter(request, prefix	+ "h_aprl_ofc_nm", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (hAprlOfcCd[i] != null)
					model.setHAprlOfcCd(hAprlOfcCd[i]);
				if (hAprlOfcNm[i] != null)
					model.setHAprlOfcNm(hAprlOfcNm[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.hAprlOfcCd = this.hAprlOfcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.hAprlOfcNm = this.hAprlOfcNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
