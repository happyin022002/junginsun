...
public class NewZealandCstmsMfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<NewZealandCstmsMfVO> models = new ArrayList<NewZealandCstmsMfVO>();
	...
	public NewZealandCstmsMfVO() {}

	public NewZealandCstmsMfVO(String ibflag, String pagerows, String pol, String polAtd, String pod, String bdr, String bdrDate, String bl, String dnld, String acpt, String diff, String cntr, String cntrDnld, String cntrAcpt, String cntrDiff) {
	 ...
	 * @param request
	 * @return NewZealandCstmsMfVO[]
	 */
	public NewZealandCstmsMfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NewZealandCstmsMfVO[]
	 */
	public NewZealandCstmsMfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandCstmsMfVO model = null;
		...
		return getNewZealandCstmsMfVOs();
	}
	 ...
	 * @return NewZealandCstmsMfVO[]
	 */
	public NewZealandCstmsMfVO[] getNewZealandCstmsMfVOs(){
		NewZealandCstmsMfVO[] vos = (NewZealandCstmsMfVO[])models.toArray(new NewZealandCstmsMfVO[models.size()]);
		return vos;
	}
