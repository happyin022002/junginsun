...
*@FileName : Eur24ManifestDownloadDBDAORemoveBlCntrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAORemoveBlCntrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAORemoveBlCntrDSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAORemoveBlCntrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM BKG_CSTMS_EUR_CNTR" ).append("\n"); 
