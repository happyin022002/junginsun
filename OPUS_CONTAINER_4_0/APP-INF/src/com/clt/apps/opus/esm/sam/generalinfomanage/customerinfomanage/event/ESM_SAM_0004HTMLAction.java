...
*@FileName : ESM_SAM_0004HTMLAction.java
...
public class ESM_SAM_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0004HTMLAction 객체를 생성
	 */
	public ESM_SAM_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSam0004Event event = new EsmSam0004Event();
