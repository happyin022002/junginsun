...
*@FileName : NewZealandManifestListDownloadDBDAOaddBkgCstmsCndVsl1CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NewZealandManifestListDownloadDBDAOaddBkgCstmsCndVsl1CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NewZealandManifestListDownloadDBDAOaddBkgCstmsCndVsl1CSQL(){
		setQuery();
		...
		query.append("FileName : NewZealandManifestListDownloadDBDAOaddBkgCstmsCndVsl1CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
