...
*@FileName       : EsmSaq0128ViewAdapter02.java
...
public class EsmSaq0128ViewAdapter02 extends ViewAdapter {
...
//		sbufXML.append("<DATA COLORDER='" + JSPUtil.convertStringArrayToString(changedColNms, "|") + "' COLSEPARATOR='" + DELIMITER + "' TOTAL='" + totCnt +"'>\n");
		...
		for(int k=0;k<realCnt;k++){ 
			...
			listVo = (SearchMonthlyQuotaInquiry0126Tab02VO) list.get(k); //list 에서 한 줄 씩 빼내서 결과vo에 입력
