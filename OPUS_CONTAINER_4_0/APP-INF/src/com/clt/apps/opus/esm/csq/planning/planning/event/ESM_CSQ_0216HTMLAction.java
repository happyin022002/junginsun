...
*@FileName       : ESM_CSQ_0216HTMLAction.java
 ...
 * @author CSQ USER
 * @see EsmCsq0216Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0216HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0216HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0216HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0216Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCsq0216Event event = new EsmCsq0216Event();
