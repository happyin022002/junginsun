...
*@FileName : MainGrpCostCodeVO.java
*@FileTitle : MainGrpCostCodeVO
*Open Issues :
*Change history :
...
public class MainGrpCostCodeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MainGrpCostCodeVO> models = new ArrayList<MainGrpCostCodeVO>();
	...
	public MainGrpCostCodeVO() {}

	public MainGrpCostCodeVO(String ibflag, String pagerows, String stndCostTpCd, String mgrpCostCd, String mgrpCostCdDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setMgrpCostCd(JSPUtil.getParameter(request, prefix + "mgrp_cost_cd", ""));
	 ...
	 * @param request
	 * @return SearchMainGrpCostCodeVO[]
	 */
	public MainGrpCostCodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMainGrpCostCodeVO[]
	 */
	public MainGrpCostCodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MainGrpCostCodeVO model = null;
		...
		return getSearchMainGrpCostCodeVOs();
	}
	 ...
	 * @return SearchMainGrpCostCodeVO[]
	 */
	public MainGrpCostCodeVO[] getSearchMainGrpCostCodeVOs(){
		MainGrpCostCodeVO[] vos = (MainGrpCostCodeVO[])models.toArray(new MainGrpCostCodeVO[models.size()]);
		return vos;
	}
