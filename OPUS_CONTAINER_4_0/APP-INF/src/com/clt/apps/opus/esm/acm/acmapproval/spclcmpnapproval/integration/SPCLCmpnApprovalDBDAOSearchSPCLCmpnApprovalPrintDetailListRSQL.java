...
*@FileName : SPCLCmpnApprovalDBDAOSearchSPCLCmpnApprovalPrintDetailListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalDBDAOSearchSPCLCmpnApprovalPrintDetailListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSPCLCmpnApprovalPrintDetailList
	  * </pre>
	  */
	public SPCLCmpnApprovalDBDAOSearchSPCLCmpnApprovalPrintDetailListRSQL(){
		setQuery();
		...
		query.append("FileName : SPCLCmpnApprovalDBDAOSearchSPCLCmpnApprovalPrintDetailListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
