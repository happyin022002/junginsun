...
public class KrWhfPortRtVO extends WhfPortRtVO {
	...
	public KrWhfPortRtVO(String ibflag, String pagerows, String updDt, String teuAmtRt, String hcAmtRt, String creDt, String feuPrc, String ioBndCd, String cntrBlkDivCd, String hcPrc, String feuAmtRt, String creUsrId, String teuPrc, String portCd, String updUsrId, String dcRtoNo, String blkUtRt, String blkRtRto, String cntr20UtRt, String cntr40UtRt, String cntr45UtRt) {
	...
	public void fromRequest(HttpServletRequest request) {
		setCntr40UtRt(JSPUtil.getParameter(request, "cntr_40_ut_rt", ""));
		...
		setBlkRtRto(JSPUtil.getParameter(request, "blk_rt_rto", ""));
		setFeuAmtRt(JSPUtil.getParameter(request, "feu_amt_rt", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setCntr45UtRt(JSPUtil.getParameter(request, "cntr_45_ut_rt", ""));
		setTeuPrc(JSPUtil.getParameter(request, "teu_prc", ""));
		setPortCd(JSPUtil.getParameter(request, "port_cd", ""));
		setBlkUtRt(JSPUtil.getParameter(request, "blk_ut_rt", ""));
		setCntr20UtRt(JSPUtil.getParameter(request, "cntr_20_ut_rt", ""));
