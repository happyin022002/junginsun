 ...
 *@FileName       : ESM_SPC_3001HTMLAction.java
...
public class ESM_SPC_3001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_SPC_3001HTMLAction 객체를 생성
	 */
	public ESM_SPC_3001HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmSpc3001Event event = new EsmSpc3001Event();
		return event;
	}
