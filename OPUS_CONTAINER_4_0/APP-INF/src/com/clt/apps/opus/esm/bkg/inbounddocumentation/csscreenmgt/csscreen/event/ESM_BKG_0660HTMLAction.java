...
*@FileName : UI_BKG_0660HTMLAction.java
...
public class ESM_BKG_0660HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_BKG_0660HTMLAction 객체를 생성
	 */
	public ESM_BKG_0660HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0660Event event = new EsmBkg0660Event();
