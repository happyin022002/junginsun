...
*@FileName : SCRateProposalDBDAORsltRsltPriSpScpRoutDirRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRsltPriSpScpRoutDirRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SELECT PRI_SP_SCP_RT_ROUT_DIR
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRsltPriSpScpRoutDirRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRsltPriSpScpRoutDirRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
