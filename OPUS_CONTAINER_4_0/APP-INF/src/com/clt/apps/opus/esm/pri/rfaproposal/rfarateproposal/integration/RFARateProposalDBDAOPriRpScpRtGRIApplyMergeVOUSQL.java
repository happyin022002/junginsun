...
*@FileName : RFARateProposalDBDAOPriRpScpRtGRIApplyMergeVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 2013.06.02
*@LastModifier : 송호진
*@LastVersion : 1.0
* 2013.06.02 송호진
* 1.0 Creation
...
public class RFARateProposalDBDAOPriRpScpRtGRIApplyMergeVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * GRI Apply
	  * 
	  * 2010.08.24 CHM-201005538-01 GRI Calculate SQL 퍼포먼스 개선
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtGRIApplyMergeVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtGRIApplyMergeVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET A.PROP_FRT_RT_AMT        = DECODE(A.AMDT_SEQ, 0, A.PROP_FRT_RT_AMT, A.FNL_FRT_RT_AMT) +" ).append("\n"); 
		query.append("                                DECODE(T.FLT_PCT_TP_CD, 'F', T.GRI_RT_AMT, 'P', T.GRI_RT_RTO / 100 * A.PROP_FRT_RT_AMT)" ).append("\n"); 
		query.append("      ,A.COFFR_FRT_RT_AMT       = DECODE(A.AMDT_SEQ, 0, A.COFFR_FRT_RT_AMT, NULL)" ).append("\n"); 
		query.append("      ,A.FNL_FRT_RT_AMT         = DECODE(A.AMDT_SEQ, 0, A.FNL_FRT_RT_AMT, NULL)" ).append("\n"); 
		query.append("      ,A.GRI_APPL_TP_CD         = 'A'" ).append("\n"); 
		query.append("      ,A.GRI_APPL_AMT           = DECODE(T.FLT_PCT_TP_CD, 'F', T.GRI_RT_AMT, 'P', T.GRI_RT_RTO / 100 * A.PROP_FRT_RT_AMT)" ).append("\n"); 
		query.append("      ,A.PRC_PROG_STS_CD        = 'I'" ).append("\n"); 
		query.append("      ,A.SRC_INFO_CD            = DECODE(A.N1ST_CMNC_AMDT_SEQ" ).append("\n"); 
		query.append("                                      ,A.AMDT_SEQ" ).append("\n"); 
		query.append("                                      ,DECODE(A.SRC_INFO_CD, 'GC', 'GM', 'PC', 'PM', A.SRC_INFO_CD)" ).append("\n"); 
		query.append("                                      ,'AM')" ).append("\n"); 
		query.append("      ,A.N1ST_CMNC_AMDT_SEQ     = A.AMDT_SEQ" ).append("\n"); 
