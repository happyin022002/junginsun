...
public class DblEdiInVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("final_ata", getFinalAta());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("final_ata", "finalAta");
	 ...
	 * @return finalAta
	 */
	public String getFinalAta() {
		return this.finalAta;
	}
	 ...
	 * @param finalAta
	 */
	public void setFinalAta(String finalAta) {
		this.finalAta = finalAta;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFinalAta(JSPUtil.getParameter(request, "final_ata",""));
	}
	...
	public DblEdiInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] finalAta = (JSPUtil.getParameter(request, prefix	+ "final_ata", length));
	...
	*/
	public void unDataFormat(){
		...
		this.finalAta = this.finalAta .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
