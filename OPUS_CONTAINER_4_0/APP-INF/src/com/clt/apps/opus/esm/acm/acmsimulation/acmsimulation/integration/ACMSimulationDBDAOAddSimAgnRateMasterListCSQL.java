...
*@FileName : ACMSimulationDBDAOAddSimAgnRateMasterListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAddSimAgnRateMasterListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOAddSimAgnRateMasterListCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAddSimAgnRateMasterListCSQL").append("\n");
		query.append("*/").append("\n");
	}
