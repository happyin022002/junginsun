...
*@FileName : BSAManageDBDAOSearchBSATableHeaderListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOSearchBSATableHeaderListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchBSATableHeaderList
	  * </pre>
	  */
	public BSAManageDBDAOSearchBSATableHeaderListRSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOSearchBSATableHeaderListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  AND ((A.BSA_OP_JB_CD = '001' AND A.CRR_CD <> COM_ConstantMgr_PKG.COM_getCompanyCode_FNC)" ).append("\n"); 
