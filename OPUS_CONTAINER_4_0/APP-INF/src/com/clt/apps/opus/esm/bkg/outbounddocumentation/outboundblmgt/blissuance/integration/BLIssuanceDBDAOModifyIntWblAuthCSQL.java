...
*@FileName : BLIssuanceDBDAOModifyIntWblAuthCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOModifyIntWblAuthCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BLIssuanceDBDAOModifyIntWblAuthCSQL
	  * </pre>
	  */
	public BLIssuanceDBDAOModifyIntWblAuthCSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOModifyIntWblAuthCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
