...
*@FileName : ExternalFinderDAORemoveOtherCodeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExternalFinderDAORemoveOtherCodeDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ExternalFinderDAORemoveOtherCodeDSQL(){
		setQuery();
		...
		query.append("FileName : ExternalFinderDAORemoveOtherCodeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM FMS_PPT_SET" ).append("\n"); 
		query.append("WHERE PPT_NM = @[org_ppt_nm]" ).append("\n"); 
