...
*@FileName : CargoReleaseOrderDBDAOmodifyEuDoRcvrInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOmodifyEuDoRcvrInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOmodifyEuDoRcvrInfoUSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOmodifyEuDoRcvrInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET     RCVR_CNEE_NM = @[rcvr_cnee_nm]," ).append("\n"); 
		query.append("RCVR_PHN_NO  = @[rcvr_phn_no]," ).append("\n"); 
		query.append("RCVR_FAX_NO  = @[rcvr_fax_no]," ).append("\n"); 
