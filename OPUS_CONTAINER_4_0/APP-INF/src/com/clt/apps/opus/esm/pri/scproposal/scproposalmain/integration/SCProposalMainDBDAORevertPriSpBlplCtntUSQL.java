...
*@FileName : SCProposalMainDBDAORevertPriSpBlplCtntUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpBlplCtntUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_BLPL_CTNT
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpBlplCtntUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpBlplCtntUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_BLPL_CTNT" ).append("\n"); 
