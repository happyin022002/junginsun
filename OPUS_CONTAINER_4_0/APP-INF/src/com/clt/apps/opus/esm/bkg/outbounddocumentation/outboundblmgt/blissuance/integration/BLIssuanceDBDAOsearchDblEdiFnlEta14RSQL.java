...
*@FileName : BLIssuanceDBDAOsearchDblEdiFnlEta14RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOsearchDblEdiFnlEta14RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLIssuanceDBDAOsearchDblEdiFnlEta14RSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOsearchDblEdiFnlEta14RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(VPS.VPS_ETA_DT + 3, 'YYYYMMDDHH24MI')" ).append("\n"); 
		query.append("INTO :FINAL_ETA:IND" ).append("\n"); 
