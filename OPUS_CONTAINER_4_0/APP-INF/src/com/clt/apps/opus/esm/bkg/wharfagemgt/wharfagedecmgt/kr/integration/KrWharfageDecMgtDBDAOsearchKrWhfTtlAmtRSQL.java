...
*@FileName : KrWharfageDecMgtDBDAOsearchKrWhfTtlAmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOsearchKrWhfTtlAmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOsearchKrWhfTtlAmtRSQL(){
		setQuery();
		...
		query.append("FileName : KrWharfageDecMgtDBDAOsearchKrWhfTtlAmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(SUM(WHF_AMT),0) AS WHF_RT_AMT" ).append("\n"); 
		...
		query.append("   AND WHF_BND_CD = DECODE(@[whf_bnd_cd], 'OO', 'OO', 'II', 'II', 'IN', 'II')" ).append("\n"); 
