...
public class ESM_BKG_2001_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_2001_01HTMLAction 객체를 생성
	 */
	public ESM_BKG_2001_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg200101Event event = new EsmBkg200101Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCstmsCdConvSeqVO((CstmsCdConvSeqVO)getVO(request, CstmsCdConvSeqVO.class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setCstmsCdConvSeqVOs((CstmsCdConvSeqVO[])getVOs(request, CstmsCdConvSeqVO.class));
