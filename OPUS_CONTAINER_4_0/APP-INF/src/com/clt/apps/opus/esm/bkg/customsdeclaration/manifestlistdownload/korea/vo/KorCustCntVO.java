...
*@FileName : KorCustCntVO.java
*@FileTitle : KorCustCntVO
*Open Issues :
*Change history :
...
public class KorCustCntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorCustCntVO> models = new ArrayList<KorCustCntVO>();
	...
	public KorCustCntVO(String ibflag, String pagerows, String bkgNo, String blNo, String cstmsDeclTpCd, String portCd, String trnsSeq, String usrId) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return KorCustCntVO[]
	 */
	public KorCustCntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCustCntVO[]
	 */
	public KorCustCntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCustCntVO model = null;
	 ...
	 * @return KorCustCntVO[]
	 */
	public KorCustCntVO[] getKorCustCntVOs(){
		KorCustCntVO[] vos = (KorCustCntVO[])models.toArray(new KorCustCntVO[models.size()]);
		return vos;
	}
