...
*@FileName : MonthlyQuotaAdjustmentTradeDBDAOModifySaqMonQtaStepVERinclPortFlg0048USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeDBDAOModifySaqMonQtaStepVERinclPortFlg0048USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeDBDAOModifySaqMonQtaStepVERinclPortFlg0048USQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeDBDAOModifySaqMonQtaStepVERinclPortFlg0048USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    MQTA_VER_NO LIKE @[mQtaVerNo]||'%'" ).append("\n"); 
