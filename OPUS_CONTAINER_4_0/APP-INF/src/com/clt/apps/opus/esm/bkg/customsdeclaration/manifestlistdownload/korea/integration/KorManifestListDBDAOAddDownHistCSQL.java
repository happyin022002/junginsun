...
*@FileName : KorManifestListDBDAOAddDownHistCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class KorManifestListDBDAOAddDownHistCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOAddDownHistCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : KorManifestListDBDAOAddDownHistCSQL").append("\n");
		query.append("*/").append("\n");
	}
}