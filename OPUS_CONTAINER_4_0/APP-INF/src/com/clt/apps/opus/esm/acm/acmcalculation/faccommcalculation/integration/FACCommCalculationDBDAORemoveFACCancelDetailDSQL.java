...
*@FileName : FACCommCalculationDBDAORemoveFACCancelDetailDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FACCommCalculationDBDAORemoveFACCancelDetailDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FACCommCalculationDBDAORemoveFACCancelDetailDSQL
	  * </pre>
	  */
	public FACCommCalculationDBDAORemoveFACCancelDetailDSQL(){
		setQuery();
		...
		query.append("FileName : FACCommCalculationDBDAORemoveFACCancelDetailDSQL").append("\n");
		query.append("*/").append("\n");
	}
