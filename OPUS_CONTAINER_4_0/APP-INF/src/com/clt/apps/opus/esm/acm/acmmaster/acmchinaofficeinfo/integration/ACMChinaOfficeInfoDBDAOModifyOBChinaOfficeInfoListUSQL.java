...
*@FileName : ACMChinaOfficeInfoDBDAOModifyOBChinaOfficeInfoListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMChinaOfficeInfoDBDAOModifyOBChinaOfficeInfoListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * O/B China Agent Office 정보를 수정한다.
	  * </pre>
	  */
	public ACMChinaOfficeInfoDBDAOModifyOBChinaOfficeInfoListUSQL(){
		setQuery();
		...
		query.append("FileName : ACMChinaOfficeInfoDBDAOModifyOBChinaOfficeInfoListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	AUTO_DP_CHK_FLG = @[auto_dp_chk_flg]" ).append("\n"); 
