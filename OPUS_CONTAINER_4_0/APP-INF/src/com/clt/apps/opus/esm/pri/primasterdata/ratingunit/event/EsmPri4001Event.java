...
/**
 * ESM_PRI_4001 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_PRI_4001HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Seung Jun Lee
 * @see ESM_PRI_4001HTMLAction 참조
 * @since J2EE 1.4
 */

public class EsmPri4001Event extends EventSupport {
