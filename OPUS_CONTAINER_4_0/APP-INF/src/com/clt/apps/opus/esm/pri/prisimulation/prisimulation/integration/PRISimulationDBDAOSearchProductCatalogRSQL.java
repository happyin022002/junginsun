...
*@FileName : PRISimulationDBDAOSearchProductCatalogRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRISimulationDBDAOSearchProductCatalogRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PRISimulationDBDAOSearchProductCatalogRSQL(){
		setQuery();
		...
		query.append("FileName : PRISimulationDBDAOSearchProductCatalogRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
