...
*@FileName : RFARateProposalDBDAOPriRpScpRtForExlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtForExlVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT PRI_RP_SCP_RT
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtForExlVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtForExlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	CMDT_HDR_SEQ" ).append("\n"); 
		query.append(",	ROUT_SEQ" ).append("\n"); 
		query.append(",   NVL(A.RT_SEQ, (B.MAX_RT_SEQ + 1)) AS RT_SEQ" ).append("\n"); 
		query.append(",	RAT_UT_CD" ).append("\n"); 
		query.append(",	PRC_CGO_TP_CD" ).append("\n"); 
		query.append(",	CURR_CD" ).append("\n"); 
		query.append(",	PROP_FRT_RT_AMT" ).append("\n"); 
		...
		query.append(",	@[prop_frt_rt_amt] AS PROP_FRT_RT_AMT" ).append("\n"); 
		query.append(",	@[coffr_frt_rt_amt] AS COFFR_FRT_RT_AMT" ).append("\n"); 
		query.append(",	@[fnl_frt_rt_amt] AS FNL_FRT_RT_AMT" ).append("\n"); 
		query.append(",	@[gri_appl_tp_cd] AS GRI_APPL_TP_CD" ).append("\n"); 
		query.append(",	@[gri_appl_amt] AS GRI_APPL_AMT" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ INDEX_DESC(A XPKPRI_RP_SCP_RT) */" ).append("\n"); 
		query.append("                  RT_SEQ" ).append("\n"); 
		...
		query.append("          ,0) AS MAX_RT_SEQ" ).append("\n"); 
