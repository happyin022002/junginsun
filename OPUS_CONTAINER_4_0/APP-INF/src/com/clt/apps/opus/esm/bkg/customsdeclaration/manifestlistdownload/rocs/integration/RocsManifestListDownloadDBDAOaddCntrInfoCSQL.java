...
*@FileName : RocsManifestListDownloadDBDAOaddCntrInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestListDownloadDBDAOaddCntrInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestListDownloadDBDAOaddCntrInfoCSQL(){
		setQuery();
		...
		query.append("FileName : RocsManifestListDownloadDBDAOaddCntrInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[bkg_no]" ).append("\n"); 
		query.append(",	@[cntr_no]" ).append("\n"); 
		query.append(",	NVL(@[cntr_tpsz_cd],'')" ).append("\n"); 
		query.append(",	NVL(@[iso_cntr_tpsz_cd],'')" ).append("\n"); 
		query.append(",	NVL(@[cntr_tpsz_desc],'')" ).append("\n"); 
		query.append(",	NVL(@[cntr_seal_no],'')" ).append("\n"); 
		query.append(",	NVL(@[pck_tp_cd],'')" ).append("\n"); 
		...
		query.append(",	@[user_id]" ).append("\n"); 
		query.append(",	sysdate" ).append("\n"); 
		query.append(",   SUBSTR(@[vvd_number], 1, 4)" ).append("\n"); 
		query.append(",	SUBSTR(@[vvd_number], 5, 4)" ).append("\n"); 
		query.append(",	SUBSTR(@[vvd_number], 9, 1)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(")" ).append("\n"); 
