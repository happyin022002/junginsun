...
*@FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailList2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailList2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailList2RSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailList2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("           (" ).append("\n"); 
		query.append("              SELECT MAX(CTRL_LVL)" ).append("\n"); 
		...
		query.append("          --DECODE(IOC_CD, 'E', 0, 1) * DECODE(NQTA_MD * NCFM_MD, 0, 0, 1) * DECODE(DECODE(IOC_CD, 'I', 3, 'T', 3, DECODE(REP_TRD_CD, TRD_CD, DECODE(CTRL_LVL, 'O', 1, 'L', 2, 'D', 3), 3)), LVL, 1, 0) AS EDIT ," ).append("\n"); 
		...
		query.append("         NVL(Z.BASE_RHQ_CD, 'Z')," ).append("\n"); 
