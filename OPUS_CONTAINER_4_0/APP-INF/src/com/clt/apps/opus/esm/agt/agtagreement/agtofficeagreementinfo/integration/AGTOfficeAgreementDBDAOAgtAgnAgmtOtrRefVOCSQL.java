...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_otr_ref 테이블에 추가
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVOCSQL(){
		setQuery();
		...
		params.put("otr_lvl_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("otr_info_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO   AGT_AGN_OTR_REF( AGMT_OFC_CD," ).append("\n"); 
