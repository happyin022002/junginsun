...
*@FileName : RsltAddChgHistoryListVO.java
*@FileTitle : RsltAddChgHistoryListVO
*Open Issues :
*Change history :
...
public class RsltAddChgHistoryListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltAddChgHistoryListVO> models = new ArrayList<RsltAddChgHistoryListVO>();
	 ...
	 * @param request
	 * @return RsltAddChgHistoryListVO[]
	 */
	public RsltAddChgHistoryListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltAddChgHistoryListVO[]
	 */
	public RsltAddChgHistoryListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltAddChgHistoryListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltAddChgHistoryListVO();
				if (addChgSeq[i] != null)
		...
		return getRsltAddChgHistoryListVOs();
	}
	 ...
	 * @return RsltAddChgHistoryListVO[]
	 */
	public RsltAddChgHistoryListVO[] getRsltAddChgHistoryListVOs(){
		RsltAddChgHistoryListVO[] vos = (RsltAddChgHistoryListVO[])models.toArray(new RsltAddChgHistoryListVO[models.size()]);
		return vos;
	}
