...
*@FileName : ESM_BKG_1048HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_1048HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1048HTMLAction 객체를 생성
	 */
	public ESM_BKG_1048HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1048Event event = new EsmBkg1048Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEdiRefId(request.getParameter("edi_ref_id"));
