...
*@FileName : MonthlyQuotaAdjustmentTradeDBDAOGetNewMonthlyQuotaStepVersionNumber0048RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeDBDAOGetNewMonthlyQuotaStepVersionNumber0048RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeDBDAOGetNewMonthlyQuotaStepVersionNumber0048RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeDBDAOGetNewMonthlyQuotaStepVersionNumber0048RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MIN(GLINE_VER_NO)" ).append("\n"); 
		query.append("           ||TO_CHAR(NVL(MAX(SUBSTR(MQTA_VER_NO," ).append("\n"); 
		query.append("           		LENGTH(GLINE_VER_NO)+1)), 0)+1,'FM09')" ).append("\n"); 
