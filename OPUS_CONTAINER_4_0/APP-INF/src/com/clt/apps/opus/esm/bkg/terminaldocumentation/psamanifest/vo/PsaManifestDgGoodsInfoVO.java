...
*@FileName : PsaManifestDgGoodsInfoVO.java
*@FileTitle : PsaManifestDgGoodsInfoVO
*Open Issues :
*Change history :
...
public class PsaManifestDgGoodsInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsaManifestDgGoodsInfoVO> models = new ArrayList<PsaManifestDgGoodsInfoVO>();
	...
	public PsaManifestDgGoodsInfoVO() {}

	public PsaManifestDgGoodsInfoVO(String ibflag, String pagerows, String hazardCd, String undgNo, String flashPoint) {
...
/**
	 ...
	 * @param request
	 * @return PsaManifestDgGoodsInfoVO[]
	 */
	public PsaManifestDgGoodsInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaManifestDgGoodsInfoVO[]
	 */
	public PsaManifestDgGoodsInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaManifestDgGoodsInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PsaManifestDgGoodsInfoVO();
		...
		return getPsaManifestDgGoodsInfoVOs();
	}
	 ...
	 * @return PsaManifestDgGoodsInfoVO[]
	 */
	public PsaManifestDgGoodsInfoVO[] getPsaManifestDgGoodsInfoVOs(){
		PsaManifestDgGoodsInfoVO[] vos = (PsaManifestDgGoodsInfoVO[])models.toArray(new PsaManifestDgGoodsInfoVO[models.size()]);
		return vos;
	}
