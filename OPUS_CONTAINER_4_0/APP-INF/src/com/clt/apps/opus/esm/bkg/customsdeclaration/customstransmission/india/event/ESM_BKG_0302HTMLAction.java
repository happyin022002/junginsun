 ...
 *@FileName : ESM_BKG_0302HTMLAction.java
 *@FileTitle : ESM_BKG_0302HTMLAction
 *Open Issues :
 *Change history :
 ...
 * @see EsmBkg0302Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_0302HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	public ESM_BKG_0302HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0302Event event = new EsmBkg0302Event();
