...
public class CLLCDLManifestDBDAOsearchSpclStowRqst2ByMlbRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n");
		query.append("" ).append("\n");
		query.append("CASE WHEN BK.STWG_CD IS NOT NULL AND BK.STWG_CD = 'PC'" ).append("\n");
		query.append("THEN DECODE(DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0), 0))" ).append("\n");
		...
		query.append("" ).append("\n");
		query.append("CASE WHEN BK.STWG_CD IS NOT NULL AND BK.STWG_CD = 'PC'" ).append("\n");
		query.append("THEN DECODE(DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'4',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'4',BQ.OP_CNTR_QTY,0),0))" ).append("\n");
		query.append("WHEN BK.STWG_CD IS NULL" ).append("\n");
		...
		query.append("" ).append("\n");
		query.append("CASE WHEN BK.STWG_CD IS NOT NULL AND BK.STWG_CD = 'PC'" ).append("\n");
		query.append("THEN DECODE(DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '4', 0,  '7', 0, BQ.OP_CNTR_QTY),0),0,'',DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '4', 0,  '7', 0, BQ.OP_CNTR_QTY),0))" ).append("\n");
		query.append("WHEN BK.STWG_CD IS NULL" ).append("\n");
		...
		query.append("" ).append("\n");
		query.append("CASE WHEN BK.STWG_CD IS NOT NULL AND BK.STWG_CD = 'PC'" ).append("\n");
		query.append("THEN DECODE(DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'PC',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0),0))" ).append("\n");
		query.append("WHEN BK.STWG_CD IS NULL" ).append("\n");
		...
		query.append("GROUP BY NVL(LO.UN_LOC_CD,BV.POD_CD), BK.STWG_CD, BQ.CNTR_TPSZ_CD, OP_CNTR_QTY, VPS.CLPT_SEQ, CM.REP_IMDG_LVL_CD, BK.BKG_NO" ).append("\n");
		query.append("" ).append("\n");
