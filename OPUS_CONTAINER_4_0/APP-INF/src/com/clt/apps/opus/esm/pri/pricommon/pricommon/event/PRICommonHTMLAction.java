...
public class PRICommonHTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//2014.10.13 COMMAND41, COMMAND42 ADD <start> ------
		else if(command.isCommand(FormCommand.COMMAND41)) {
			event.setPriParaCdVO((PriParaCdVO)getVO(request, PriParaCdVO .class));
		}
		else if(command.isCommand(FormCommand.COMMAND42)) {
			event.setPriParaCdDtlVO((PriParaCdDtlVO)getVO(request, PriParaCdDtlVO .class));
		}
		//2014.10.13 COMMAND41, COMMAND42 ADD <end> ------
