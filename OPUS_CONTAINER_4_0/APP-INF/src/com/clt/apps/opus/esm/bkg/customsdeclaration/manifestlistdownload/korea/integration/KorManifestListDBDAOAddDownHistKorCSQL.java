...
*@FileName : KorManifestListDBDAOAddDownHistKorCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOAddDownHistKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOAddDownHistKorCSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOAddDownHistKorCSQL").append("\n");
		query.append("*/").append("\n");
	}
