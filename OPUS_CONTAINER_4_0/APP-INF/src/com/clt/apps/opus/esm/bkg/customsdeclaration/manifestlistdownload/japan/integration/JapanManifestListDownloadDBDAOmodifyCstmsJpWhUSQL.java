...
*@FileName : JapanManifestListDownloadDBDAOmodifyCstmsJpWhUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOmodifyCstmsJpWhUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOmodifyCstmsJpWhUSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOmodifyCstmsJpWhUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_JP_WH" ).append("\n"); 
		query.append("" ).append("\n"); 
