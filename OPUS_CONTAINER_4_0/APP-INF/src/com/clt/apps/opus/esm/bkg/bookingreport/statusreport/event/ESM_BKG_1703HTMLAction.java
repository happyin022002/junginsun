...
*@FileName : ESM_BKG_1703HTMLAction.java
 ...
 * @see EsmBkg1703Event 참조
 * @since J2EE 1.6
 */

public class ESM_BKG_1703HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_1703HTMLAction 객체를 생성
     */
    public ESM_BKG_1703HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmBkg1703Event 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1703Event event = new EsmBkg1703Event(); 		
