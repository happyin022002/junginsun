...
*@FileName : ESM_PRI_6101HTMLAction.java
...
public class ESM_PRI_6101HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6101HTMLAction 객체를 생성
	 */
	public ESM_PRI_6101HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6101Event event = new EsmPri6101Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			PriCntrSrhCondVO vo = (PriCntrSrhCondVO)getVO(request, PriCntrSrhCondVO.class );
			event.setPriCustSrhCondVO(vo);
		} 
