...
*@FileName : AncsManifestListDownloadDBDAOcheckIfSsrNoExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsManifestListDownloadDBDAOcheckIfSsrNoExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsManifestListDownloadDBDAOcheckIfSsrNoExistRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : AncsManifestListDownloadDBDAOcheckIfSsrNoExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}