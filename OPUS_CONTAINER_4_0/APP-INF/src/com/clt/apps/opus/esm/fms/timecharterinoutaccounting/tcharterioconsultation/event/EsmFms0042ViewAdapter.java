...
*@FileName : EsmFms0042ViewAdapter.java
 ...
 * @since J2EE 1.6
 */
public class EsmFms0042ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"~~","slp_seq_no","acct_cd","ownr_cd","ctr_cd","slp_loc_cd",
				   			   "eff_dt","csr_amt","dr_amt","cr_amt","flet_ctrt_tp_cd",
				   			   "~~","slp_seq_no","csr_desc","csr_desc1","csr_desc2","csr_desc3",
				   			   "vvd_cd","key_num","dr_amt","cr_amt","flet_ctrt_tp_cd",};
