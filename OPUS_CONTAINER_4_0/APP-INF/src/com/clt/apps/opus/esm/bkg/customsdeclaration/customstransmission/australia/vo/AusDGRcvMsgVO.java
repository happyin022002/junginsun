...
*@FileName : AusDGRcvMsgVO.java
*@FileTitle : AusDGRcvMsgVO
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
public class AusDGRcvMsgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusDGRcvMsgVO> models = new ArrayList<AusDGRcvMsgVO>();
	...
	/* Column Info */
	private String ausVslName = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("aus_vsl_name", getAusVslName());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("aus_vsl_name", "ausVslName");
	 ...
	 * @return ausVslName
	 */
	public String getAusVslName() {
		return this.ausVslName;
	}
	 ...
	 * @param ausVslName
	 */
	public void setAusVslName(String ausVslName) {
		this.ausVslName = ausVslName;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAusVslName(JSPUtil.getParameter(request, prefix + "aus_vsl_name", ""));
	 ...
	 * @param request
	 * @return AusDGRcvMsgVO[]
	 */
	public AusDGRcvMsgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusDGRcvMsgVO[]
	 */
	public AusDGRcvMsgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusDGRcvMsgVO model = null;
		...
		try {
			...
			String[] ausVslName = (JSPUtil.getParameter(request, prefix	+ "aus_vsl_name", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ausVslName[i] != null)
					model.setAusVslName(ausVslName[i]);
	 ...
	 * @return AusDGRcvMsgVO[]
	 */
	public AusDGRcvMsgVO[] getAusDGRcvMsgVOs(){
		AusDGRcvMsgVO[] vos = (AusDGRcvMsgVO[])models.toArray(new AusDGRcvMsgVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.ausVslName = this.ausVslName .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
