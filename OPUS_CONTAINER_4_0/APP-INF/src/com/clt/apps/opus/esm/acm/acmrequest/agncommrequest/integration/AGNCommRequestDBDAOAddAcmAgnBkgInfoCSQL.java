...
*@FileName : AGNCommRequestDBDAOAddAcmAgnBkgInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOAddAcmAgnBkgInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommRequestDBDAOAddAcmAgnBkgInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOAddAcmAgnBkgInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_BKG_INFO" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append(", C.VSL_CD||C.SKD_VOY_NO||C.FINC_DIR_CD AS REV_VVD_CD" ).append("\n"); 
		...
		query.append(", ( SELECT SUBSTR(MAX (CUST_REF_NO_CTNT),1,19) FROM BKG_REFERENCE FMC WHERE FMC.BKG_NO = B.BKG_NO AND FMC.BKG_REF_TP_CD = 'FMCN' AND ROWNUM = 1 ) AS FMC_NO" ).append("\n"); 
		...
		query.append(", @[usr_id]" ).append("\n"); 
		query.append(", SYSDATE" ).append("\n"); 
		query.append(", (SELECT CUST_CNT_CD FROM BKG_CUSTOMER CUST WHERE CUST.BKG_NO = B.BKG_NO AND CUST.BKG_CUST_TP_CD = 'S' )" ).append("\n"); 
		query.append(", (SELECT CUST_SEQ    FROM BKG_CUSTOMER CUST WHERE CUST.BKG_NO = B.BKG_NO AND CUST.BKG_CUST_TP_CD = 'S' )" ).append("\n"); 
		query.append(", (SELECT CUST_CNT_CD FROM BKG_CUSTOMER CUST WHERE CUST.BKG_NO = B.BKG_NO AND CUST.BKG_CUST_TP_CD = 'F' )" ).append("\n"); 
		query.append(", (SELECT CUST_SEQ    FROM BKG_CUSTOMER CUST WHERE CUST.BKG_NO = B.BKG_NO AND CUST.BKG_CUST_TP_CD = 'F' )" ).append("\n"); 
		query.append("" ).append("\n"); 
