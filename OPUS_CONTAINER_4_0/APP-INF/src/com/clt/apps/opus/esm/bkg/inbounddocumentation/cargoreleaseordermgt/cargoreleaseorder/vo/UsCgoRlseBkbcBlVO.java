...
*@FileName : UsCgoRlseBkbcBlVO.java
*@FileTitle : UsCgoRlseBkbcBlVO
*Open Issues :
*Change history :
...
public class UsCgoRlseBkbcBlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsCgoRlseBkbcBlVO> models = new ArrayList<UsCgoRlseBkbcBlVO>();
	...
	/* Column Info */
	private String crntFrtCltFlg = null;
	/* Column Info */
	private String crntOblRdemFlg = null;
	/* Column Info */
	private String crntCstmsClrCd = null;
	/* Column Info */
	private String inlndFullRlseEdiCd = null;
	/* Column Info */
	private String inlndCd = null;
	/* Column Info */
	private String inlndYdEdiSndCd = null;
	
	private String ipiMvmt = null;
	...
	public UsCgoRlseBkbcBlVO() {}

	public UsCgoRlseBkbcBlVO(String ibflag, String pagerows, String blNo, String vvd, String podCd, String delCd, String fincCtrlOfcCd, String ipiStatus, String fullRlseEdiCd, String termId, String cValue, String cstmsDspoCd, String cgorEdiSndCd, String hisSeq, String partialCnt, String allCInd, String partialClear, String oldFrtCltFlg, String oldOblRdemFlg, String oldCstmsClrCd, String newFrtCltFlg, String newOblRdemFlg, String newCstmsClrCd, String crntFrtCltFlg, String crntOblRdemFlg, String crntCstmsClrCd, String inlndFullRlseEdiCd, String inlndCd, String inlndYdEdiSndCd, String ipiMvmt) {
		...
		this.crntFrtCltFlg = crntFrtCltFlg;
		this.crntOblRdemFlg = crntOblRdemFlg;
		this.crntCstmsClrCd = crntCstmsClrCd;
		this.inlndFullRlseEdiCd = inlndFullRlseEdiCd;
		this.inlndCd = inlndCd;
		this.inlndYdEdiSndCd = inlndYdEdiSndCd;
		this.ipiMvmt = ipiMvmt;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("crnt_frt_clt_flg", getCrntFrtCltFlg());
		this.hashColumns.put("crnt_obl_rdem_flg", getCrntOblRdemFlg());
		this.hashColumns.put("crnt_cstms_clr_cd", getCrntCstmsClrCd());
		this.hashColumns.put("inlnd_cd", getInlndCd());
		this.hashColumns.put("inlnd_full_rlse_edi_cd", getInlndFullRlseEdiCd());
		this.hashColumns.put("inlnd_yd_edi_snd_cd", getInlndYdEdiSndCd());
		this.hashColumns.put("ipi_mvmt", getIpiMvmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("crnt_frt_clt_flg", "crntFrtCltFlg");
		this.hashFields.put("crnt_obl_rdem_flg", "crntOblRdemFlg");
		this.hashFields.put("crnt_cstms_clr_cd", "crntCstmsClrCd");
		this.hashFields.put("inlnd_cd", "inlndCd");
		this.hashFields.put("inlnd_full_rlse_edi_cd", "inlndFullRlseEdiCd");
		this.hashFields.put("inlnd_yd_edi_snd_cd", "inlndYdEdiSndCd");
		this.hashFields.put("ipi_mvmt", "ipiMvmt");
	...
	/**
	 * Column Info
	 * @return inlndFullRlseEdiCd
	 */
	public String getInlndFullRlseEdiCd() {
		return this.inlndFullRlseEdiCd;
	}
	...
	/**
	 * Column Info
	 * @return crntFrtCltFlg
	 */
	public String getCrntFrtCltFlg() {
		return this.crntFrtCltFlg;
	}
	
	/**
	 * Column Info
	 * @return crntOblRdemFlg
	 */
	public String getCrntOblRdemFlg() {
		return this.crntOblRdemFlg;
	}
	
	/**
	 * Column Info
	 * @return crntCstmsClrCd
	 */
	public String getCrntCstmsClrCd() {
		return this.crntCstmsClrCd;
	}
	 ...
	 * @param inlndCd
	 */
	public void setInlndCd(String inlndCd) {
		this.inlndCd = inlndCd;
	}
	...
	/**
	 * Column Info
	 * @param inlndFullRlseEdiCd
	 */
	public void setInlndFullRlseEdiCd(String inlndFullRlseEdiCd) {
		this.inlndFullRlseEdiCd = inlndFullRlseEdiCd;
	}
	 ...
	 * @param crntFrtCltFlg
	 */
	public void setCrntFrtCltFlg(String crntFrtCltFlg) {
		this.crntFrtCltFlg = crntFrtCltFlg;
	}
	
	/**
	 * Column Info
	 * @param crntOblRdemFlg
	 */
	public void setCrntOblRdemFlg(String crntOblRdemFlg) {
		this.crntOblRdemFlg = crntOblRdemFlg;
	}
	
	/**
	 * Column Info
	 * @param crntCstmsClrCd
	 */
	public void setCrntCstmsClrCd(String crntCstmsClrCd) {
		this.crntCstmsClrCd = crntCstmsClrCd;
	}
	 ...
	 * @param ipiMvmt
	 */
	public void setIpiMvmt(String ipiMvmt) {
		this.ipiMvmt = ipiMvmt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCrntFrtCltFlg(JSPUtil.getParameter(request, "crnt_frt_clt_flg", ""));
		setCrntOblRdemFlg(JSPUtil.getParameter(request, "crnt_obl_rdem_flg", ""));
		setCrntCstmsClrCd(JSPUtil.getParameter(request, "crnt_cstms_clr_cd", ""));
		setInlndCd(JSPUtil.getParameter(request, "inlnd_cd", ""));
		setInlndFullRlseEdiCd(JSPUtil.getParameter(request, "inlnd_full_rlse_edi_cd", ""));
		setInlndYdEdiSndCd(JSPUtil.getParameter(request, "inlnd_yd_edi_snd_cd", ""));
		setIpiMvmt(JSPUtil.getParameter(request, "ipi_mvmt", ""));
	 ...
	 */
	public UsCgoRlseBkbcBlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsCgoRlseBkbcBlVO[]
	 */
	public UsCgoRlseBkbcBlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsCgoRlseBkbcBlVO model = null;
		...
		try {
			...
			String[] crntFrtCltFlg = (JSPUtil.getParameter(request, prefix	+ "crnt_frt_clt_flg", length));
			String[] crntOblRdemFlg = (JSPUtil.getParameter(request, prefix	+ "crnt_obl_rdem_flg", length));
			String[] crntCstmsClrCd = (JSPUtil.getParameter(request, prefix	+ "crnt_cstms_clr_cd", length));
			String[] inlndCd = (JSPUtil.getParameter(request, prefix	+ "inlnd_cd", length));
			String[] inlndFullRlseEdiCd = (JSPUtil.getParameter(request, prefix	+ "inlnd_full_rlse_edi_cd", length));
			String[] inlndYdEdiSndCd = (JSPUtil.getParameter(request, prefix	+ "inlnd_yd_edi_snd_cd", length));
			String[] ipiMvmt = (JSPUtil.getParameter(request, prefix	+ "ipi_mvmt", length));
			
			for (int i = 0; i < length; i++) {
				model = new UsCgoRlseBkbcBlVO();
				if (ipiStatus[i] != null)
				...
				if (crntFrtCltFlg[i] != null)
					model.setCrntFrtCltFlg(crntFrtCltFlg[i]);
				if (crntOblRdemFlg[i] != null)
					model.setCrntOblRdemFlg(crntOblRdemFlg[i]);
				if (crntCstmsClrCd[i] != null)
					model.setCrntCstmsClrCd(crntCstmsClrCd[i]);
				if (inlndCd[i] != null)
					model.setInlndCd(inlndCd[i]);
				if (inlndFullRlseEdiCd[i] != null)
					model.setInlndFullRlseEdiCd(inlndFullRlseEdiCd[i]);
				if (inlndYdEdiSndCd[i] != null)
					model.setInlndYdEdiSndCd(inlndYdEdiSndCd[i]);
				if (ipiMvmt[i] != null)
					model.setIpiMvmt(ipiMvmt[i]);
				models.add(model);
			}
	 ...
	 * @return UsCgoRlseBkbcBlVO[]
	 */
	public UsCgoRlseBkbcBlVO[] getUsCgoRlseBkbcBlVOs(){
		UsCgoRlseBkbcBlVO[] vos = (UsCgoRlseBkbcBlVO[])models.toArray(new UsCgoRlseBkbcBlVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.crntFrtCltFlg = this.crntFrtCltFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.crntOblRdemFlg = this.crntOblRdemFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.crntCstmsClrCd = this.crntCstmsClrCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.inlndCd = this.inlndCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.inlndFullRlseEdiCd = this.inlndFullRlseEdiCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.inlndYdEdiSndCd = this.inlndYdEdiSndCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ipiMvmt = this.ipiMvmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
