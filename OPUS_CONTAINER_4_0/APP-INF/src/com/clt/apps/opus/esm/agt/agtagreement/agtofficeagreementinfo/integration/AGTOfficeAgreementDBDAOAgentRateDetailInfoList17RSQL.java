...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList17RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList17RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_otr_ref 조회 하여 lane_inp_term_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList17RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList17RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    OTR_REF_DIV_CD = 'LANE'" ).append("\n"); 
		query.append("AND    OTR_LVL_CD = '5' )) T START WITH NO = 1 CONNECT BY NOCYCLE PRIOR NO = NO - 1" ).append("\n"); 
