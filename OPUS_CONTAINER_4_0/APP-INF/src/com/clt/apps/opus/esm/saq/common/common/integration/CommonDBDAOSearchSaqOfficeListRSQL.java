...
*@FileName : CommonDBDAOSearchSaqOfficeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqOfficeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchSaqOfficeListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchSaqOfficeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
