...
*@FileName : KrWhfBkgInfoVO.java
*@FileTitle : KrWhfBkgInfoVO
*Open Issues :
*Change history :
...
public class KrWhfBkgInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrWhfBkgInfoVO> models = new ArrayList<KrWhfBkgInfoVO>();
	...
	public KrWhfBkgInfoVO() {}

	public KrWhfBkgInfoVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String whfBlThruTsFlg, String bkgCgoTpCd, String obSlsOfcCd, String slanCd) {
		this.vslCd = vslCd;
	 ...
	 */
	public KrWhfBkgInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfBkgInfoVO[]
	 */
	public KrWhfBkgInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrWhfBkgInfoVO model = null;
	 ...
	 * @return KrWhfBkgInfoVO[]
	 */
	public KrWhfBkgInfoVO[] getKrWhfBkgInfoVOs(){
		KrWhfBkgInfoVO[] vos = (KrWhfBkgInfoVO[])models.toArray(new KrWhfBkgInfoVO[models.size()]);
		return vos;
	}
