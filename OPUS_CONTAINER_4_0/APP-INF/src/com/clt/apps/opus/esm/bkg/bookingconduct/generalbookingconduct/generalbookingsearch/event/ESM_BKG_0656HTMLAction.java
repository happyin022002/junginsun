...
*@FileName : ESM_BKG_0656HTMLAction.java
...
public class ESM_BKG_0656HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0656HTMLAction 객체를 생성
	 */
	public ESM_BKG_0656HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0656Event event = new EsmBkg0656Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setUiNm(request.getParameter("ui_id"));
		}
