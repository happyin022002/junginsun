...
public class PickUpNoticeDBDAOSearchPkupNtcSentHistoryRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                                           , 'E', GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,EMSD.EML_DT,ORGN.LOC_CD)                         " ).append("\n"); 
		query.append("                                           ) " ).append("\n"); 
		query.append("                        ) , " ).append("\n"); 
		...
		query.append("        AND BCST.BKG_CUST_TP_CD      = DECODE(PNTC.PKUP_NTC_TP_CD, 'TO', 'C', NHIS.BKG_CUST_TP_CD) -- Trucker 에게 보내는 건 His table에 cust_tp_cd가 안쌓이고있어서 수정 2016-08-17 " ).append("\n"); 
		query.append("" ).append("\n"); 
