...
*@FileName : SCProposalMainDBDAORsltAcceptListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORsltAcceptListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAORsltAcceptListRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCProposalMainDBDAORsltAcceptListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}