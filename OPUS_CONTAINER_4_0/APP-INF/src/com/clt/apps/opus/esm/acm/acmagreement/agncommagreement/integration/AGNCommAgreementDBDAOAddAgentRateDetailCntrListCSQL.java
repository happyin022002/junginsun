...
*@FileName : AGNCommAgreementDBDAOAddAgentRateDetailCntrListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateDetailCntrListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateDetailCntrListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateDetailCntrListCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_AGMT_DTL_CNTR" ).append("\n");
