...
*@FileName : AGNCommRequestDBDAOSearchCalcDtlBkgQtyListRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOSearchCalcDtlBkgQtyListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommRequestDBDAOSearchCalcDtlBkgQtyListRSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOSearchCalcDtlBkgQtyListRSQL").append("\n");
		query.append("*/").append("\n");
	}
