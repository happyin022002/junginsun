...
public class Eur24ManifestDownloadDBDAOAddCustomsSetupCSQL implements ISQLTemplate{
	...
	public Eur24ManifestDownloadDBDAOAddCustomsSetupCSQL(){
		...
		params.put("customs_nm",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("(PORT_CD,         TML_CD,         N1ST_EUR_PORT_FLG,    EUR_CSTMS_OFC_ID, EUR_CSTMS_OFC_NM," ).append("\n"); 
		...
		query.append("(@[port_cd],      @[tml_cd], NULL,          @[customs_cd], @[customs_nm]," ).append("\n"); 
