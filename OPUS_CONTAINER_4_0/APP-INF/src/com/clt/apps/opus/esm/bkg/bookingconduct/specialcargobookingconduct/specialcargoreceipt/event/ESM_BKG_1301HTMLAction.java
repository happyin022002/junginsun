...
*@FileName : ESM_BKG_1301HTMLAction.java
...
public class ESM_BKG_1301HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1301HTMLAction 객체를 생성
	 */
	public ESM_BKG_1301HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1301Event event = new EsmBkg1301Event();
        log.debug("::CALL::> ESM_BKG_1301_HTMLAction - " + command.getCommand());
        
        if(command.isCommand(FormCommand.INIT)) {
        	event.setDotExpNo(JSPUtil.getParameter(request, "dot_exp_no"));
        	event.setDotSpclAproNo(JSPUtil.getParameter(request, "dot_spcl_apro_no"));
        	event.setDotAuthNo(JSPUtil.getParameter(request, "dot_auth_no"));
		}
