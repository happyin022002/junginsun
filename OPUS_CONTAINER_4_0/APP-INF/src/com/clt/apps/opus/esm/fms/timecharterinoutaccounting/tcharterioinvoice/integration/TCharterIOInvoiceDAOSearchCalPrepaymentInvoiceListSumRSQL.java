...
public class TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceListSumRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               CASE WHEN CURR_CD = 'KRW' OR CURR_CD = 'JPY' OR CURR_CD = 'PAB' " ).append("\n"); 
		query.append("                        THEN TO_CHAR(ROUND(SUM(INV_AMT),2),'999,999,999,999,999,999')" ).append("\n"); 
		query.append("                    ELSE TO_CHAR(ROUND(SUM(INV_AMT),2),'999,999,999,999,999,999.00') " ).append("\n"); 
		query.append("                END INV_AMT, " ).append("\n"); 
		query.append("			   CURR_CD2," ).append("\n"); 
		query.append("			   CASE WHEN CURR_CD2 = 'KRW' OR CURR_CD2 = 'JPY' OR CURR_CD2 = 'PAB' " ).append("\n"); 
		query.append("                        THEN TO_CHAR(ROUND(SUM(INV_AMT2),2),'999,999,999,999,999,999')" ).append("\n"); 
		query.append("				    ELSE TO_CHAR(ROUND(SUM(INV_AMT2),2),'999,999,999,999,999,999.00') " ).append("\n"); 
