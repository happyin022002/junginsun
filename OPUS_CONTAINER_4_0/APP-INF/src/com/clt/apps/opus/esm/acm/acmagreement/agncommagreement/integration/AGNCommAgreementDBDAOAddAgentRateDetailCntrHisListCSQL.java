...
*@FileName : AGNCommAgreementDBDAOAddAgentRateDetailCntrHisListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateDetailCntrHisListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgentRateDetailCntrHisList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateDetailCntrHisListCSQL(){
		setQuery();
		...
		params.put("agn_agmt_cntr_seq",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n");
		query.append("Path : com.clt.apps.opus.esm.acm.acmagreement.agncommagreement.integration").append("\n");
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateDetailCntrHisListCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_AGMT_DTL_CNTR_HIS" ).append("\n");
		...
		query.append("        AGN_AGMT_CNTR_SEQ," ).append("\n");
