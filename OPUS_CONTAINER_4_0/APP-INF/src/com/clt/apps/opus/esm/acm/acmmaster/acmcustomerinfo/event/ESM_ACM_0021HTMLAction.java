...
*@FileName : ESM_ACM_0021HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see EsmAcm0021Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0021HTMLAction 객체를 생성
	 */
	public ESM_ACM_0021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0021Event event = new EsmAcm0021Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setFACExSettingVO((FACExSettingVO)getVO(request, FACExSettingVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setFACExSettingVOs((FACExSettingVO[])getVOs(request, FACExSettingVO.class, ""));
		}
