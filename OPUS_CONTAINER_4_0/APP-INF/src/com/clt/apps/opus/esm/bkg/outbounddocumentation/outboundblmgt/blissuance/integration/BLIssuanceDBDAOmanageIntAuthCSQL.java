...
public class BLIssuanceDBDAOmanageIntAuthCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		NVL(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[upd_office]),SYSDATE)," ).append("\n"); 
		...
		query.append("		DELT_DT = NVL(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[upd_office]),SYSDATE)" ).append("\n"); 
