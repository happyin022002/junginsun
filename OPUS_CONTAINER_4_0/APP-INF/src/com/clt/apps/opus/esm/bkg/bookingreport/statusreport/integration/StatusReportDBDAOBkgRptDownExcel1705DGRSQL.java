...
*@FileName : StatusReportDBDAOBkgRptDownExcel1705DGRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOBkgRptDownExcel1705DGRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BkgRptDownExcel1705DG
	  * </pre>
	  */
	public StatusReportDBDAOBkgRptDownExcel1705DGRSQL(){
		setQuery();
		...
		query.append("FileName : StatusReportDBDAOBkgRptDownExcel1705DGRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,'DG Info' AS	UN_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	IMDG_CLSS_CD" ).append("\n"); 
		query.append("        ,'DG Info' AS	DG_GRS_WGT" ).append("\n"); 
		query.append("        ,'DG Info' AS	DG_GRS_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'DG Info' AS	DG_NET_WGT" ).append("\n"); 
		query.append("        ,'DG Info' AS	DG_NET_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'DG Info' AS	PRP_SHP_NM" ).append("\n"); 
		query.append("        ,'DG Info' AS	TECH_NM" ).append("\n"); 
		query.append("        ,'DG Info' AS	FLSH_PNT_CDO_TEMP" ).append("\n"); 
		query.append("        ,'DG Info' AS	IMDG_PCK_GRP_CD" ).append("\n"); 
		query.append("        ,'DG Info' AS	IMDG_LMT_QTY_FLG" ).append("\n"); 
		query.append("        ,'DG Info' AS	SUB_LABEL" ).append("\n"); 
		query.append("        ,'DG Info' AS	CGO_STS" ).append("\n"); 
		query.append("        ,'DG Info' AS	MRN_POLUT_FLG" ).append("\n"); 
		query.append("        ,'DG Info' AS	IMDG_EXPT_QTY_FLG" ).append("\n"); 
		query.append("        ,'DG Info' AS	IMDG_SEGR_GRP_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	RESIDUE" ).append("\n"); 
		query.append("        ,'DG Info' AS	APRO_STS" ).append("\n"); 
		query.append("        ,'DG Info' AS	NET_EXPLO_WGT" ).append("\n"); 
		query.append("        ,'DG Info' AS	RADA_SKD_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	ACTIVITY" ).append("\n"); 
		query.append("        ,'DG Info' AS	RADA_TRSP_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	EMER_CNTC" ).append("\n"); 
		query.append("        ,'DG Info' AS	CNTC_PSON_NM" ).append("\n"); 
		query.append("        ,'DG Info' AS	CERTI_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	APRO_REF_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	EMS_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	ERG_NO" ).append("\n"); 
		query.append("        ,'DG Info' AS	CTRL_TEMP" ).append("\n"); 
		query.append("        ,'DG Info' AS	EMER_TEMP" ).append("\n"); 
		query.append("        ,'DG Info' AS	DG_RMK" ).append("\n"); 
		query.append("        ,'DG Info' AS	SEGR_DESC" ).append("\n"); 
		query.append("        ,'DG Info' AS	OUTER_PCK_QTY" ).append("\n"); 
		query.append("        ,'DG Info' AS	OUTER_PCK_DESC" ).append("\n"); 
		query.append("        ,'DG Info' AS	OUTER_PCK2_QTY" ).append("\n"); 
		query.append("        ,'DG Info' AS	OUTER_PCK2_DESC" ).append("\n"); 
		query.append("        ,'DG Info' AS	INTMD_PCK_QTY" ).append("\n"); 
		query.append("        ,'DG Info' AS	INTMD_PCK_DESC" ).append("\n"); 
		query.append("        ,'DG Info' AS	INTMD_PCK2_QTY" ).append("\n"); 
		query.append("        ,'DG Info' AS	INTMD_PCK2_DESC" ).append("\n"); 
		query.append("        ,'DG Info' AS	INNER_PCK_QTY" ).append("\n"); 
		query.append("        ,'DG Info' AS	INNER_PCK_DESC" ).append("\n"); 
		query.append("        ,'DG Info' AS	INNER_PCK2_QTY" ).append("\n"); 
		query.append("        ,'DG Info' AS	INNER_PCK2_DESC" ).append("\n"); 
		query.append("        ,'DG Info' AS	CONC_PCT" ).append("\n"); 
		query.append("        ,'DG Info' AS	IBC" ).append("\n"); 
		query.append("        ,'DG Info' AS	SUBS_RSK_1" ).append("\n"); 
		query.append("        ,'DG Info' AS	SUBS_RSK_2" ).append("\n"); 
		query.append("        ,'' AS DG_CNTR_SEQ--for ORDER BY" ).append("\n"); 
		query.append("        ,'' AS CNTR_CGO_SEQ--for ORDER BY" ).append("\n"); 
		...
		query.append("        ,'UN No.' AS	UN_NO" ).append("\n"); 
		query.append("        ,'IMDG Class' AS	IMDG_CLSS_CD" ).append("\n"); 
		query.append("        ,'Gross Weight' AS	DG_GRS_WGT" ).append("\n"); 
		query.append("        ,'Gross Weight Unit' AS	DG_GRS_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'Net Weight' AS	DG_NET_WGT" ).append("\n"); 
		query.append("        ,'Net Weight Unit' AS	DG_NET_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'Proper Shipping Name' AS	PRP_SHP_NM" ).append("\n"); 
		query.append("        ,'Technical Name' AS	TECH_NM" ).append("\n"); 
		query.append("        ,'Flash Point (C)' AS	FLSH_PNT_CDO_TEMP" ).append("\n"); 
		query.append("        ,'Packing Group' AS	IMDG_PCK_GRP_CD" ).append("\n"); 
		query.append("        ,'Limited Quantity (DG)' AS	IMDG_LMT_QTY_FLG" ).append("\n"); 
		query.append("        ,'Sub Label' AS	SUB_LABEL" ).append("\n"); 
		query.append("        ,'Cargo Status' AS	CGO_STS" ).append("\n"); 
		query.append("        ,'Marine Pollutant ' AS	MRN_POLUT_FLG" ).append("\n"); 
		query.append("        ,'Expected Quantity' AS	IMDG_EXPT_QTY_FLG" ).append("\n"); 
		query.append("        ,'Segregation Group' AS	IMDG_SEGR_GRP_NO" ).append("\n"); 
		query.append("        ,'Residue Last Contained (DG)' AS	RESIDUE" ).append("\n"); 
		query.append("        ,'Approval Status' AS	APRO_STS" ).append("\n"); 
		query.append("        ,'Net Explosive Weight (class 1)' AS	NET_EXPLO_WGT" ).append("\n"); 
		query.append("        ,'Schedule (class 7)' AS	RADA_SKD_NO" ).append("\n"); 
		query.append("        ,'Activity (class 7)' AS	ACTIVITY" ).append("\n"); 
		query.append("        ,'Transportation Index (class 7)' AS	RADA_TRSP_NO" ).append("\n"); 
		query.append("        ,'Emergency Contact (DG)' AS	EMER_CNTC" ).append("\n"); 
		query.append("        ,'Contact Person' AS	CNTC_PSON_NM" ).append("\n"); 
		query.append("        ,'Certificate No.' AS	CERTI_NO" ).append("\n"); 
		query.append("        ,'Approval Ref. No' AS	APRO_REF_NO" ).append("\n"); 
		query.append("        ,'EMS No' AS	EMS_NO" ).append("\n"); 
		query.append("        ,'ERG' AS	ERG_NO" ).append("\n"); 
		query.append("        ,'Control Temp C' AS	CTRL_TEMP" ).append("\n"); 
		query.append("        ,'Emergency Temp C' AS	EMER_TEMP" ).append("\n"); 
		query.append("        ,'Remarks' AS	DG_RMK" ).append("\n"); 
		query.append("        ,'Stowage and Segregation' AS	SEGR_DESC" ).append("\n"); 
		query.append("        ,'Outer PKG 1st Q''ty' AS	OUTER_PCK_QTY" ).append("\n"); 
		query.append("        ,'Outer PKG 1st Q''ty Type: Code & Description' AS	OUTER_PCK_DESC" ).append("\n"); 
		query.append("        ,'Outer PKG 2nd Q''ty' AS	OUTER_PCK2_QTY" ).append("\n"); 
		query.append("        ,'Outer PKG 2nd Q''ty Type: Code & Description' AS	OUTER_PCK2_DESC" ).append("\n"); 
		query.append("        ,'Intermediate PKG 1st Q''ty' AS	INTMD_PCK_QTY" ).append("\n"); 
		query.append("        ,'Intermediate PKG 1st Q''ty Type: Code & Description' AS	INTMD_PCK_DESC" ).append("\n"); 
		query.append("        ,'Intermediate PKG 2nd Q''ty' AS	INTMD_PCK2_QTY" ).append("\n"); 
		query.append("        ,'Intermediate PKG 2nd Q''ty Type: Code & Description' AS	INTMD_PCK2_DESC" ).append("\n"); 
		query.append("        ,'Inner PKG 1st Q''ty' AS	INNER_PCK_QTY" ).append("\n"); 
		query.append("        ,'Inner PKG 1st Q''ty Type: Code & Description' AS	INNER_PCK_DESC" ).append("\n"); 
		query.append("        ,'Inner PKG 2nd Q''ty' AS	INNER_PCK2_QTY" ).append("\n"); 
		query.append("        ,'Inner PKG 2nd Q''ty Type: Code & Description' AS	INNER_PCK2_DESC" ).append("\n"); 
		query.append("        ,'Concentration (%)' AS	CONC_PCT" ).append("\n"); 
		query.append("        ,'IBC/LP Code (DG)' AS	IBC" ).append("\n"); 
		query.append("        ,'Subsidiary Risk 1' AS	SUBS_RSK_1" ).append("\n"); 
		query.append("        ,'Subsidiary Risk 2' AS	SUBS_RSK_2" ).append("\n"); 
		query.append("        ,'' AS DG_CNTR_SEQ--for ORDER BY" ).append("\n"); 
		query.append("        ,'' AS CNTR_CGO_SEQ--for ORDER BY" ).append("\n"); 
		query.append("    FROM DUAL" ).append("\n"); 
		query.append("    UNION ALL" ).append("\n"); 
		...
		query.append("    -----------------------------------------------------------" ).append("\n"); 
		query.append("         , DG.IMDG_UN_NO UN_NO" ).append("\n"); 
		query.append("         , DG.IMDG_CLSS_CD" ).append("\n"); 
		query.append("         , TRIM(TO_CHAR(DG.GRS_WGT,'999,999,999,990.99')) DG_GRS_WGT" ).append("\n"); 
		query.append("         , DG.WGT_UT_CD DG_GRS_WGT_UT_CD" ).append("\n"); 
		query.append("         , TRIM(TO_CHAR(DG.NET_WGT,'999,999,999,990.99')) DG_NET_WGT" ).append("\n"); 
		query.append("         , DG.WGT_UT_CD DG_NET_WGT_UT_CD" ).append("\n"); 
		query.append("         , DG.PRP_SHP_NM" ).append("\n"); 
		query.append("         , DG.HZD_DESC TECH_NM" ).append("\n"); 
		query.append("         , DECODE(DG.FLSH_PNT_CDO_TEMP,NULL,'',TO_CHAR(DG.FLSH_PNT_CDO_TEMP)) AS FLSH_PNT_CDO_TEMP" ).append("\n"); 
		query.append("         , DG.IMDG_PCK_GRP_CD" ).append("\n"); 
		query.append("         , DG.IMDG_LMT_QTY_FLG" ).append("\n"); 
		query.append("         , UN_NO.IMDG_SUBS_RSK_LBL_RMK SUB_LABEL" ).append("\n"); 
		query.append("         , (SELECT INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("              FROM COM_INTG_CD_DTL " ).append("\n"); 
		query.append("             WHERE INTG_CD_ID = 'CD01164'" ).append("\n"); 
		query.append("               AND INTG_CD_VAL_CTNT = DG.DCGO_STS_CD) CGO_STS" ).append("\n"); 
		query.append("         , DG.MRN_POLUT_FLG" ).append("\n"); 
		query.append("         , DG.IMDG_EXPT_QTY_FLG" ).append("\n"); 
		query.append("         , TO_CHAR(DG.IMDG_SEGR_GRP_NO) IMDG_SEGR_GRP_NO" ).append("\n"); 
		query.append("         , DG.RSD_FLG RESIDUE" ).append("\n"); 
		query.append("         , (SELECT INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("              FROM COM_INTG_CD_DTL " ).append("\n"); 
		query.append("             WHERE INTG_CD_ID = 'CD01955'" ).append("\n"); 
		query.append("               AND INTG_CD_VAL_CTNT = DG.SPCL_CGO_APRO_CD) APRO_STS" ).append("\n"); 
		query.append("         , TO_CHAR(DG.NET_EXPLO_WGT,'999,999,999,990.99') NET_EXPLO_WGT" ).append("\n"); 
		query.append("         , DG.RADA_SKD_NO" ).append("\n"); 
		query.append("         , DECODE(DG.IMDG_CLSS_CD, 7, RADA_AMT||RADA_UT_CD, '') ACTIVITY" ).append("\n"); 
		query.append("         , DG.RADA_TRSP_NO" ).append("\n"); 
		query.append("         , DG.EMER_CNTC_PHN_NO_CTNT EMER_CNTC" ).append("\n"); 
		query.append("         , DG.EMER_CNTC_PSON_NM CNTC_PSON_NM" ).append("\n"); 
		query.append("         , DG.CERTI_NO" ).append("\n"); 
		query.append("         , (SELECT APRO_REF_NO " ).append("\n"); 
		query.append("              FROM SCG_APRO_RQST RQST, SCG_AUTHORIZATION AUTH " ).append("\n"); 
		query.append("             WHERE DG.BKG_NO      = RQST.BKG_NO" ).append("\n"); 
		query.append("               AND DG.BKG_NO      = AUTH.BKG_NO(+)" ).append("\n"); 
		query.append("               AND DG.DCGO_SEQ = AUTH.DCGO_SEQ(+)" ).append("\n"); 
		...
		query.append("               AND RQST.SPCL_CGO_CATE_CD = 'DG'" ).append("\n"); 
		query.append("               AND ROWNUM=1 --안전하게" ).append("\n"); 
		query.append("               ) APRO_REF_NO" ).append("\n"); 
		query.append("         , DG.EMS_NO" ).append("\n"); 
		query.append("         , DG.EMER_RSPN_GID_NO ERG_NO" ).append("\n"); 
		query.append("         , DECODE(DG.CTRL_TEMP_CTNT,NULL,'',DG.CTRL_TEMP_CTNT) CTRL_TEMP" ).append("\n"); 
		query.append("         , DECODE(DG.EMER_TEMP_CTNT,NULL,'',DG.EMER_TEMP_CTNT) EMER_TEMP " ).append("\n"); 
		query.append("         , REPLACE(REPLACE(REPLACE(DG.DIFF_RMK,CHR(10),' '),CHR(9),' '),CHR(34),'') DG_RMK" ).append("\n"); 
		query.append("         , UN_NO.SEGR_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(DG.OUT_IMDG_PCK_QTY1) OUTER_PCK_QTY" ).append("\n"); 
		query.append("         , DG.OUT_IMDG_PCK_CD1||(SELECT '('||IMDG_PCK_DESC||')' FROM SCG_IMDG_PCK_CD PCK WHERE PCK.IMDG_PCK_CD = DG.OUT_IMDG_PCK_CD1) OUTER_PCK_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(DG.OUT_IMDG_PCK_QTY2) OUTER_PCK2_QTY" ).append("\n"); 
		query.append("         , DG.OUT_IMDG_PCK_CD2||(SELECT '('||IMDG_PCK_DESC||')' FROM SCG_IMDG_PCK_CD PCK WHERE PCK.IMDG_PCK_CD = DG.OUT_IMDG_PCK_CD2) OUTER_PCK2_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(DG.INTMD_IMDG_PCK_QTY1) INTMD_PCK_QTY" ).append("\n"); 
		query.append("         , DG.INTMD_IMDG_PCK_CD1||(SELECT '('||IMDG_PCK_DESC||')' FROM SCG_IMDG_PCK_CD PCK WHERE PCK.IMDG_PCK_CD = DG.INTMD_IMDG_PCK_CD1) INTMD_PCK_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(DG.INTMD_IMDG_PCK_QTY2) INTMD_PCK2_QTY" ).append("\n"); 
		query.append("         , DG.INTMD_IMDG_PCK_CD2||(SELECT '('||IMDG_PCK_DESC||')' FROM SCG_IMDG_PCK_CD PCK WHERE PCK.IMDG_PCK_CD = DG.INTMD_IMDG_PCK_CD2) INTMD_PCK2_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(DG.IN_IMDG_PCK_QTY1) INNER_PCK_QTY" ).append("\n"); 
		query.append("         , DG.IN_IMDG_PCK_CD1||(SELECT '('||IMDG_PCK_DESC||')' FROM SCG_IMDG_PCK_CD PCK WHERE PCK.IMDG_PCK_CD = DG.IN_IMDG_PCK_CD1) INNER_PCK_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(DG.IN_IMDG_PCK_QTY2) INNER_PCK2_QTY" ).append("\n"); 
		query.append("         , DG.IN_IMDG_PCK_CD2||(SELECT '('||IMDG_PCK_DESC||')' FROM SCG_IMDG_PCK_CD PCK WHERE PCK.IMDG_PCK_CD = DG.IN_IMDG_PCK_CD2) INNER_PCK2_DESC" ).append("\n"); 
		query.append("         , (SELECT IMDG_CONC_RT_CTNT FROM SCG_IMDG_UN_NO_ORG_RACT RACT WHERE DG.IMDG_UN_NO = RACT.IMDG_UN_NO AND DG.IMDG_UN_NO_SEQ = RACT.IMDG_UN_NO_SEQ) CONC_PCT" ).append("\n"); 
		query.append("         , UN_NO.N1ST_IMDG_IBC_INSTR_CD IBC" ).append("\n"); 
		query.append("         , DG.IMDG_SUBS_RSK_LBL_CD1 SUBS_RSK_1" ).append("\n"); 
		query.append("         , DG.IMDG_SUBS_RSK_LBL_CD2 SUBS_RSK_2" ).append("\n"); 
		query.append("         , TO_CHAR(DG.DG_CNTR_SEQ) AS DG_CNTR_SEQ--for ORDER BY" ).append("\n"); 
		query.append("         , TO_CHAR(DG.CNTR_CGO_SEQ) AS CNTR_CGO_SEQ--for ORDER BY" ).append("\n"); 
		...
		query.append("         , SCG_IMDG_UN_NO UN_NO" ).append("\n"); 
		...
		query.append("       AND DG.IMDG_UN_NO = UN_NO.IMDG_UN_NO(+)" ).append("\n"); 
		query.append("       AND DG.IMDG_UN_NO_SEQ = UN_NO.IMDG_UN_NO_SEQ(+)" ).append("\n"); 
		...
		query.append("ORDER BY TEMP, BKG_NO, TO_NUMBER(DG_CNTR_SEQ), TO_NUMBER(CNTR_CGO_SEQ)" ).append("\n"); 
		query.append("#else" ).append("\n"); 
