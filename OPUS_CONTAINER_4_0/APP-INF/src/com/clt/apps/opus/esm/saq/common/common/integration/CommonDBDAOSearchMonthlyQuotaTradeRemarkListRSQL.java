...
*@FileName : CommonDBDAOSearchMonthlyQuotaTradeRemarkListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchMonthlyQuotaTradeRemarkListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchMonthlyQuotaTradeRemarkListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchMonthlyQuotaTradeRemarkListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   RMK.CTRT_RHQ_CD   = @[ctrt_rhq_cd]                                         " ).append("\n"); 
