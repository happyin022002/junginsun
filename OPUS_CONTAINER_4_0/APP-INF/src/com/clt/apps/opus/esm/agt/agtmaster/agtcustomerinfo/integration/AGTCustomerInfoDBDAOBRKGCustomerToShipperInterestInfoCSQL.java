...
*@FileName : AGTCustomerInfoDBDAOBRKGCustomerToShipperInterestInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerInfoDBDAOBRKGCustomerToShipperInterestInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCustomerInfoDBDAOBRKGCustomerToShipperInterestInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerInfoDBDAOBRKGCustomerToShipperInterestInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO AGT_BROG_CUST_INT(" ).append("\n"); 
