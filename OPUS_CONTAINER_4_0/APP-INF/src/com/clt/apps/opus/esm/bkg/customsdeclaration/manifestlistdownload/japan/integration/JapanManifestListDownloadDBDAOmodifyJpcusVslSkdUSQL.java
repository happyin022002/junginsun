...
*@FileName : JapanManifestListDownloadDBDAOmodifyJpcusVslSkdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOmodifyJpcusVslSkdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOmodifyJpcusVslSkdUSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOmodifyJpcusVslSkdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("   SET CALL_SGN_NO = @[call_sgn_no]," ).append("\n"); 
