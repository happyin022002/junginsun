...
*@FileName : ScInformInVO.java
*@FileTitle : ScInformInVO
*Open Issues :
*Change history :
...
public class ScInformInVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<ScInformInVO> models = new ArrayList<ScInformInVO>();
	...
	public ScInformInVO(String ibflag, String pagerows, String bkgNo, String scNo, String startDate, String endDate, String ctrtTpCd, String rtAplyDt, String caFlg) {
	 ...
	 * @return ScInformInVO[]
	 */
	public ScInformInVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScInformInVO[]
	 */
	public ScInformInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScInformInVO model = null;
	...
	public ScInformInVO[] getScInformInVOs(){
		ScInformInVO[] vos = (ScInformInVO[])models.toArray(new ScInformInVO[models.size()]);
		return vos;
	}
