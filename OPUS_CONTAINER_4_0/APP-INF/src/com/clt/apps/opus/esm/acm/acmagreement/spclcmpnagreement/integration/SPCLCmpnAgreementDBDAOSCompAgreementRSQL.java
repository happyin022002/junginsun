...
public class SPCLCmpnAgreementDBDAOSCompAgreementRSQL implements ISQLTemplate{
	...
	public SPCLCmpnAgreementDBDAOSCompAgreementRSQL(){
		...
		params.put("fcust_cnt_seq",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("       A.DELT_FLG AS G_DELT_FLG" ).append("\n"); 
		...
		query.append("#if (${fcust_cnt_seq} != '')" ).append("\n"); 
		query.append("   AND A.CUST_CNT_CD||TO_CHAR(A.CUST_SEQ, 'FM000000') LIKE @[fcust_cnt_seq]||'%'" ).append("\n"); 
