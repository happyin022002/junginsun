...
*@FileName : ESM_COA_0142HTMLAction.java
...
public class ESM_COA_0142HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0142HTMLAction 객체를 생성
	 */
	public ESM_COA_0142HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0142Event event = new EsmCoa0142Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCoaMonVvdVOS((CoaMonVvdVO[])getVOs(request, CoaMonVvdVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchVVDCheckListVO((SearchVVDCheckListVO)getVO(request, SearchVVDCheckListVO .class));
