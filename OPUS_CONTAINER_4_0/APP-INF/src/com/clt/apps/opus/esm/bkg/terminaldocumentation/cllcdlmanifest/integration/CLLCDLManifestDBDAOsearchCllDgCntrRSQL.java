...
public class CLLCDLManifestDBDAOsearchCllDgCntrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	'PERSON:'||NVL(D.EMER_CNTC_PSON_NM,'')||CHR(10)||" ).append("\n"); 
		...
		query.append("	'DG_REMARK:'||REPLACE(NVL(D.DG_RMK,' '),CHR(10),' ')||CHR(10)||" ).append("\n"); 
		...
		query.append("    'DG_APPROVE_NO:'|| NVL(D.APLY_NO, '')||CHR(10)||" ).append("\n"); 
		query.append("    'DG_REF_NO:'|| NVL(D.DCGO_REF_NO, '')||CHR(10)||" ).append("\n"); 
