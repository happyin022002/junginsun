...
public class SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowLaneOfficeListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                         (N.TRD_CD, N.RLANE_CD, N.VVD, N.COST_YR, N.COST_WK, N.AQ_CD, N.OFC_CD)," ).append("\n"); 
		query.append("                         (N.TRD_CD, N.RLANE_CD, N.VVD, N.COST_YR, N.COST_WK, N.AQ_CD)," ).append("\n"); 
		query.append("                         (N.TRD_CD, N.RLANE_CD, N.VVD, N.COST_YR, N.COST_WK)," ).append("\n"); 
		query.append("                         (N.TRD_CD, N.RLANE_CD)," ).append("\n"); 
