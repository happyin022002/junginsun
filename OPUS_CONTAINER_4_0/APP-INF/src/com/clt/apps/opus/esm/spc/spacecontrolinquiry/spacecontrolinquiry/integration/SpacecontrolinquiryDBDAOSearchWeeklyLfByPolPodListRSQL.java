...
public class SpacecontrolinquiryDBDAOSearchWeeklyLfByPolPodListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            ,DECODE(S.OPR_CD,COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,S.OPR_CD,'COS','COS','KKL','KKL','YML','YML','OTH') OPR_CD" ).append("\n"); 
		...
		query.append("           SUM(DECODE(NUM||OPR_CD,'1'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,TEU,BSA),0)) WK1_COM_QTY," ).append("\n"); 
		query.append("           SUM(DECODE(NUM||OPR_CD,'1'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,WGT,BSA),0)) WK1_COM_WGT," ).append("\n"); 
		...
		query.append("           SUM(DECODE(NUM||OPR_CD,'2'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,TEU,BSA),0)) WK2_COM_QTY," ).append("\n"); 
		query.append("           SUM(DECODE(NUM||OPR_CD,'2'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,WGT,BSA),0)) WK2_COM_WGT," ).append("\n"); 
		...
		query.append("           SUM(DECODE(NUM||OPR_CD,'3'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,TEU,BSA),0)) WK3_COM_QTY," ).append("\n"); 
		query.append("           SUM(DECODE(NUM||OPR_CD,'3'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,WGT,BSA),0)) WK3_COM_WGT," ).append("\n"); 
		...
		query.append("           SUM(DECODE(NUM||OPR_CD,'4'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,TEU,BSA),0)) WK4_COM_QTY," ).append("\n"); 
		query.append("           SUM(DECODE(NUM||OPR_CD,'4'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,WGT,BSA),0)) WK4_COM_WGT," ).append("\n"); 
		...
		query.append("           SUM(DECODE(NUM||OPR_CD,'5'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,TEU,BSA),0)) WK5_COM_QTY," ).append("\n"); 
		query.append("           SUM(DECODE(NUM||OPR_CD,'5'||COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,WGT,BSA),0)) WK5_COM_WGT," ).append("\n"); 
		...
		query.append("           SUM(DECODE(OPR_CD,COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,TEU,BSA),0))       GTL_COM_QTY," ).append("\n"); 
		query.append("           SUM(DECODE(OPR_CD,COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,DECODE(KB,1,WGT,BSA),0))       GTL_COM_WGT," ).append("\n"); 
		...
		query.append("       #end" ).append("\n"); 
		query.append("	   BSA," ).append("\n"); 
		query.append("       VVD1 AS WK1_COM_QTY," ).append("\n"); 
		query.append("       VVD1 AS WK1_COM_WGT," ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("       VVD2 AS WK2_COM_QTY," ).append("\n"); 
		query.append("       VVD2 AS WK2_COM_WGT," ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("       VVD3 AS WK3_COM_QTY," ).append("\n"); 
		query.append("       VVD3 AS WK3_COM_WGT," ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("       VVD4 AS WK4_COM_QTY," ).append("\n"); 
		query.append("       VVD4 AS WK4_COM_WGT," ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("       VVD5 AS WK5_COM_QTY," ).append("\n"); 
		query.append("       VVD5 AS WK5_COM_WGT," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("       '' AS GTL_COM_QTY," ).append("\n"); 
		query.append("       '' AS GTL_COM_WGT," ).append("\n"); 
		...
		query.append("	                  " ).append("\n"); 
		query.append("	,BSA" ).append("\n"); 
		query.append("    ,TO_CHAR(WK1_COM_QTY,'999,990')    WK1_COM_QTY" ).append("\n"); 
		query.append("    ,TO_CHAR(WK1_COM_WGT,'999,990')    WK1_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(WK2_COM_QTY,'999,990')    WK2_COM_QTY" ).append("\n"); 
		query.append("    ,TO_CHAR(WK2_COM_WGT,'999,990')    WK2_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(WK3_COM_QTY,'999,990')    WK3_COM_QTY" ).append("\n"); 
		query.append("    ,TO_CHAR(WK3_COM_WGT,'999,990')    WK3_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(WK4_COM_QTY,'999,990')    WK4_COM_QTY" ).append("\n"); 
		query.append("    ,TO_CHAR(WK4_COM_WGT,'999,990')    WK4_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(WK5_COM_QTY,'999,990')    WK5_COM_QTY" ).append("\n"); 
		query.append("    ,TO_CHAR(WK5_COM_WGT,'999,990')    WK5_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(GTL_COM_QTY,'999,990')    GTL_COM_QTY" ).append("\n"); 
		query.append("    ,TO_CHAR(GTL_COM_WGT,'999,990')    GTL_COM_WGT" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("	,A.BSA" ).append("\n"); 
		query.append("    ,TO_CHAR(DECODE(B.WK1_COM_QTY,0,0,A.WK1_COM_QTY/B.WK1_COM_QTY*100),'9,990.0')||'%'   WK1_COM_QTY" ).append("\n"); 
		query.append("    ,'' WK1_COM_WGT" ).append("\n"); 
		...
		query.append("                                                                       " ).append("\n"); 
		query.append("    ,TO_CHAR(DECODE(B.WK2_COM_QTY,0,0,A.WK2_COM_QTY/B.WK2_COM_QTY*100),'9,990.0')||'%'   WK2_COM_QTY" ).append("\n"); 
		query.append("    ,'' WK2_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(DECODE(B.WK3_COM_QTY,0,0,A.WK3_COM_QTY/B.WK3_COM_QTY*100),'9,990.0')||'%'   WK3_COM_QTY" ).append("\n"); 
		query.append("    ,'' WK3_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(DECODE(B.WK4_COM_QTY,0,0,A.WK4_COM_QTY/B.WK4_COM_QTY*100),'9,990.0')||'%'   WK4_COM_QTY" ).append("\n"); 
		query.append("    ,'' WK4_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TO_CHAR(DECODE(B.WK5_COM_QTY,0,0,A.WK5_COM_QTY/B.WK5_COM_QTY*100),'9,990.0')||'%'   WK5_COM_QTY" ).append("\n"); 
		query.append("    ,'' WK5_COM_WGT" ).append("\n"); 
		...
		query.append("                                                                   " ).append("\n"); 
		query.append("    ,TO_CHAR(DECODE(B.GTL_COM_QTY,0,0,A.GTL_COM_QTY/B.GTL_COM_QTY*100),'9,990.0')||'%'   GTL_COM_QTY" ).append("\n"); 
		query.append("    ,'' GTL_COM_WGT" ).append("\n"); 
		...
		query.append("	,TRIM(A.WK1_COM_QTY) WK1_COM_QTY" ).append("\n"); 
		query.append("    ,TRIM(A.WK1_COM_WGT) WK1_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TRIM(A.WK2_COM_QTY) WK2_COM_QTY" ).append("\n"); 
		query.append("    ,TRIM(A.WK2_COM_WGT) WK2_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TRIM(A.WK3_COM_QTY) WK3_COM_QTY" ).append("\n"); 
		query.append("    ,TRIM(A.WK3_COM_WGT) WK3_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TRIM(A.WK4_COM_QTY) WK4_COM_QTY" ).append("\n"); 
		query.append("    ,TRIM(A.WK4_COM_WGT) WK4_COM_WGT" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,TRIM(A.WK5_COM_QTY) WK5_COM_QTY" ).append("\n"); 
		query.append("    ,TRIM(A.WK5_COM_WGT) WK5_COM_WGT" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("    ,TRIM(A.GTL_COM_QTY) GTL_COM_QTY" ).append("\n"); 
		query.append("    ,TRIM(A.GTL_COM_WGT) GTL_COM_WGT" ).append("\n"); 
