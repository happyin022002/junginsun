...
*@FileName : SearchCOMSalesAmountListVO.java
*@FileTitle : SearchCOMSalesAmountListVO
*Open Issues :
*Change history :
...
public class SearchCOMSalesAmountListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchCOMSalesAmountListVO> models = new ArrayList<SearchCOMSalesAmountListVO>();
	...
	public SearchCOMSalesAmountListVO() {}

	public SearchCOMSalesAmountListVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String vslCd, String skdVoyNo, String dirCd, String vopCd, String vslCapa, String bsaCapa, String bsaOpCd, String bsaOpNm, String fnlCoBsaCapa, String coBsaCapa, String coBsaRto, String chtrBsaRto, String tsUcAmt, String amt101, String amt102, String amt103, String amt104, String amt105, String amt106, String amt107, String amt108, String amt109, String amt110, String amt111, String amt112, String amt113, String amt114, String amt115, String amt201, String amt202, String amt203, String amt204, String amt205, String amt206, String amt207, String amt208, String amt209, String amt210, String amt211, String amt212, String amt213, String amt214, String amt215, String amt301, String amt302, String amt303, String amt304, String amt305, String amt306, String amt307, String amt308, String amt309, String amt310, String amt311, String amt312, String amt313, String amt314, String amt315) {
		this.vslCd = vslCd;
		this.amt309 = amt309;
		this.amt307 = amt307;
		this.amt308 = amt308;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("amt_2_15", getAmt215());
		...
		this.hashColumns.put("amt_3_15", getAmt315());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("amt_2_15", "amt215");
		...
		this.hashFields.put("amt_3_15", "amt315");
	 ...
	 * @param amt215
	 */
	public void setAmt215(String amt215) {
		this.amt215 = amt215;
	}
	 ...
	 * @param amt315
	 */
	public void setAmt315(String amt315) {
		this.amt315 = amt315;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFnlCoBsaCapa(JSPUtil.getParameter(request, prefix + "fnl_co_bsa_capa", ""));
		...
		setAmt215(JSPUtil.getParameter(request, prefix + "amt_2_15", ""));
		...
		setAmt315(JSPUtil.getParameter(request, prefix + "amt_3_15", ""));
	 ...
	 * @param request
	 * @return SearchCOMSalesAmountListVO[]
	 */
	public SearchCOMSalesAmountListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCOMSalesAmountListVO[]
	 */
	public SearchCOMSalesAmountListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchCOMSalesAmountListVO model = null;
		...
		try {
			...
			String[] amt215 = (JSPUtil.getParameter(request, prefix	+ "amt_2_15", length));
			...
			String[] amt315 = (JSPUtil.getParameter(request, prefix	+ "amt_3_15", length));
			String[] amt314 = (JSPUtil.getParameter(request, prefix	+ "amt_3_14", length));
			
			for (int i = 0; i < length; i++) {
				model = new SearchCOMSalesAmountListVO();
				if (vslCd[i] != null)
		...
		return getSearchCOMSalesAmountListVOs();
	}
	 ...
	 * @return SearchCOMSalesAmountListVO[]
	 */
	public SearchCOMSalesAmountListVO[] getSearchCOMSalesAmountListVOs(){
		SearchCOMSalesAmountListVO[] vos = (SearchCOMSalesAmountListVO[])models.toArray(new SearchCOMSalesAmountListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.amt215 = this.amt215 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.amt315 = this.amt315 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
