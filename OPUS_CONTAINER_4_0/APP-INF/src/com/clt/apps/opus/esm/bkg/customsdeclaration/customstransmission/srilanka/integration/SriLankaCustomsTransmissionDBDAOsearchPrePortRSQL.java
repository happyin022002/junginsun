...
*@FileName : SriLankaCustomsTransmissionDBDAOsearchPrePortRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SriLankaCustomsTransmissionDBDAOsearchPrePortRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SriLankaCustomsTransmissionDBDAOsearchPrePortRSQL(){
		setQuery();
		...
		query.append("FileName : SriLankaCustomsTransmissionDBDAOsearchPrePortRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
