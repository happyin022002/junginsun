...
*@FileName : PsaRlsOrdSubSerNoVO.java
*@FileTitle : PsaRlsOrdSubSerNoVO
*Open Issues :
*Change history :
...
public class PsaRlsOrdSubSerNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<PsaRlsOrdSubSerNoVO> models = new ArrayList<PsaRlsOrdSubSerNoVO>();
	...
	/* Column Info */
	private String addVal2 = null;
	/* Column Info */
	private String addVal1 = null;
	/* Column Info */
	...
	public PsaRlsOrdSubSerNoVO() {}

	public PsaRlsOrdSubSerNoVO(String ibflag, String pagerows, String addVal1, String addVal2, String bkgNo, String bkgSeq, String psaSerNo, String subPsaSerNo) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("add_val2", getAddVal2());
		this.hashColumns.put("add_val1", getAddVal1());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("add_val2", "addVal2");
		this.hashFields.put("add_val1", "addVal1");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAddVal2(JSPUtil.getParameter(request, prefix + "add_val2", ""));
		setAddVal1(JSPUtil.getParameter(request, prefix + "add_val1", ""));
	 ...
	 * @param request
	 * @return PsaRlsOrdSubSerNoVO[]
	 */
	public PsaRlsOrdSubSerNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaRlsOrdSubSerNoVO[]
	 */
	public PsaRlsOrdSubSerNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaRlsOrdSubSerNoVO model = null;
		...
		try {
			...
			String[] addVal2 = (JSPUtil.getParameter(request, prefix	+ "add_val2", length));
			String[] addVal1 = (JSPUtil.getParameter(request, prefix	+ "add_val1", length));
			String[] bkgSeq = (JSPUtil.getParameter(request, prefix	+ "bkg_seq", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));

			for (int i = 0; i < length; i++) {
				model = new PsaRlsOrdSubSerNoVO();
				if (psaSerNo[i] != null)
				...
				if (addVal2[i] != null)
					model.setAddVal2(addVal2[i]);
				if (addVal1[i] != null)
					model.setAddVal1(addVal1[i]);
				if (bkgSeq[i] != null)
		...
		return getPsaRlsOrdSubSerNoVOs();
	}
	 ...
	 * @return PsaRlsOrdSubSerNoVO[]
	 */
	public PsaRlsOrdSubSerNoVO[] getPsaRlsOrdSubSerNoVOs(){
		PsaRlsOrdSubSerNoVO[] vos = (PsaRlsOrdSubSerNoVO[])models.toArray(new PsaRlsOrdSubSerNoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.addVal2 = this.addVal2 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.addVal1 = this.addVal1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
