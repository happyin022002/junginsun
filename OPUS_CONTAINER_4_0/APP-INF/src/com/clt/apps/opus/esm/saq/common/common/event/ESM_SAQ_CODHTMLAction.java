...
*@FileName       : ESM_SAQ_CODHTMLAction.java
*@FileTitle      : 공통
*Open Issues     :
*Change history  :
*@LastModifyDate : 
 ...
 *
 * @author 김원섭
 * @see EsmSaqCodEvent , EsmSaqCodEventResponse 참조
 * @since J2EE 1.4
 */

public class ESM_SAQ_CODHTMLAction extends HTMLActionSupport {

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSaqCodEvent 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaqCodEvent event = new EsmSaqCodEvent();
