...
*@FileName : AusDgEdiVO.java
*@FileTitle : AusDgEdiVO
*Open Issues :
*Change history :
...
public class AusDgEdiVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusDgEdiVO> models = new ArrayList<AusDgEdiVO>();
...
/**
	 ...
	 * @return AusDgEdiVO[]
	 */
	public AusDgEdiVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusDgEdiVO[]
	 */
	public AusDgEdiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusDgEdiVO model = null;
	...
	public AusDgEdiVO[] getAusDgEdiVOs(){
		AusDgEdiVO[] vos = (AusDgEdiVO[])models.toArray(new AusDgEdiVO[models.size()]);
		return vos;
	}
