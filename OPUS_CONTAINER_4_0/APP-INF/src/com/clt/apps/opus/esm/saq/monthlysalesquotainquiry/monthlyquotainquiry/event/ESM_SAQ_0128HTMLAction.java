...
*@FileName       : ESM_SAQ_0128HTMLAction.java
...
public class ESM_SAQ_0128HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0128HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0128HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0128Event event = new EsmSaq0128Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			...
			quotaConditionVO.setOrgType("OFC"); //기존 소스 BCImpl에서 조건 파라미터 중 orgType을 하드코딩으로 입력하였기에 다음과 같이 처리.
