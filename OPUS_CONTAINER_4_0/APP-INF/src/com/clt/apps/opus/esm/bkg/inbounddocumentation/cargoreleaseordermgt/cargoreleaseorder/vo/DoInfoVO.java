...
public class DoInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DoInfoVO> models = new ArrayList<DoInfoVO>();
	...
	public DoInfoVO(String ibflag, String pagerows, String bkgNo, String rlseSeq, String doNo, String doNoSplit) {
		this.doNo = doNo;
	 ...
	 * @return DoInfoVO[]
	 */
	public DoInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DoInfoVO[]
	 */
	public DoInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DoInfoVO model = null;
	 ...
	 * @return DoInfoVO[]
	 */
	public DoInfoVO[] getDoInfoVOs(){
		DoInfoVO[] vos = (DoInfoVO[])models.toArray(new DoInfoVO[models.size()]);
		return vos;
	}
