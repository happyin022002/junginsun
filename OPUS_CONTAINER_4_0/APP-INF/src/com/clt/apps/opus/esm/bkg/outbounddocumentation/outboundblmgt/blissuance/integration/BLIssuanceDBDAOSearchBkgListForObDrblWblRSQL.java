...
public class BLIssuanceDBDAOSearchBkgListForObDrblWblRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       TO_CHAR(NVL(FAX.SND_DT, NVL(FAX.SND_DT, FAX.SND_RQST_DT)),'YYYY-MM-DD HH24:MI') AS FAX_DATE," ).append("\n"); 
		...
		query.append("       TO_CHAR(NVL(EML.SND_DT, EML.SND_RQST_DT),'YYYY-MM-DD HH24:MI') AS EML_DATE," ).append("\n"); 
		...
		query.append("#if ('W'==${bl_tp_cd} || 'C'==${bl_tp_cd})" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("	   (SELECT DECODE(NVL(BL_CPY_ESIG_FLG,'N'),'N',0,1)" ).append("\n"); 
		query.append("			FROM BKG_BL_ESIG_OFC_ASGN" ).append("\n"); 
		query.append("			WHERE BL_ISS_OFC_CD = DECODE(ISS.OBL_ISS_OFC_CD,NULL,BKG.BKG_OFC_CD,ISS.OBL_ISS_OFC_CD) AND ROWNUM = 1) SGN_CPY_SND_FLG" ).append("\n"); 
		...
		query.append("#if ('D'==${bl_tp_cd})" ).append("\n"); 
		...
		query.append("#if ('W'==${bl_tp_cd} || 'C'==${bl_tp_cd})" ).append("\n"); 
		query.append("   AND 'W' = ISS.BL_ISS_TP_CD  /*BL_ISS_TP_CD*/" ).append("\n"); 
