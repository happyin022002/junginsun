...
*@FileName : VietnamManifestListBlInfoVO.java
*@FileTitle : VietnamManifestListBlInfoVO
*Open Issues :
*Change history :
...
public class VietnamManifestListBlInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VietnamManifestListBlInfoVO> models = new ArrayList<VietnamManifestListBlInfoVO>();
	...
	public VietnamManifestListBlInfoVO() {}

	public VietnamManifestListBlInfoVO(String ibflag, String pagerows, String actWgt, String actWgtSum, String bkgNo, String blNo, String bDel, String bDelCd, String bPor, String cntrNo, String cntrTpszCd, String counting, String custNm, String dg, String eta, String etd, String freight, String frmPodCd, String frmPolCd, String frmPortCd, String ls, String measQty, String measUtCd, String pckQty, String pckTpCd, String polGubun, String rd, String rf, String seq, String sf, String sDate, String tpsz20Chk, String tpsz40Chk, String tpszTotChk, String trsmSts, String usrId, String vslCallsign, String vslNm, String vvd, String vPod, String vPodCd, String vPol, String wgtUtCd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("act_wgt_sum", getActWgtSum());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("act_wgt_sum", "actWgtSum");
	 ...
	 * @return actWgtSum
	 */
	public String getActWgtSum() {
		return this.actWgtSum;
	}
	 ...
	 * @param actWgtSum
	 */
	public void setActWgtSum(String actWgtSum) {
		this.actWgtSum = actWgtSum;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setActWgtSum(JSPUtil.getParameter(request, prefix + "act_wgt_sum", ""));
	 ...
	 * @param request
	 * @return VietnamManifestListBlInfoVO[]
	 */
	public VietnamManifestListBlInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VietnamManifestListBlInfoVO[]
	 */
	public VietnamManifestListBlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VietnamManifestListBlInfoVO model = null;
		...
		try {
			...
			String[] actWgtSum = (JSPUtil.getParameter(request, prefix	+ "act_wgt_sum", length));
			...
			for (int i = 0; i < length; i++) {
				model = new VietnamManifestListBlInfoVO();
				...
				if (actWgtSum[i] != null)
					model.setActWgtSum(actWgtSum[i]);
		...
		return getVietnamManifestListBlInfoVOs();
	}
	...
	public VietnamManifestListBlInfoVO[] getVietnamManifestListBlInfoVOs(){
		VietnamManifestListBlInfoVO[] vos = (VietnamManifestListBlInfoVO[])models.toArray(new VietnamManifestListBlInfoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.actWgtSum = this.actWgtSum .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
