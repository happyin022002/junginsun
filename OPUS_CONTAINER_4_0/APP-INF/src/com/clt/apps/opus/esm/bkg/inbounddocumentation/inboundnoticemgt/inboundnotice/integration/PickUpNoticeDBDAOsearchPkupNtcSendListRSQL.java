...
public class PickUpNoticeDBDAOsearchPkupNtcSendListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       DECODE(PKUP_NTC.MNL_FLG, 'Y', 1, 0) AS MNL_FLG_SHOW," ).append("\n"); 
		query.append("--       PKUP_NTC.MNL_FLG AS MNL_FLG_SHOW," ).append("\n"); 
		query.append("       DECODE(PKUP_NTC.PKUP_NTC_TP_CD,'WO','MA','CT','MA',PKUP_NTC.PKUP_NTC_TP_CD) AS PKUP_NTC_TP_CD," ).append("\n"); 
		...
		query.append("       (SELECT  SUBSTR(MAX ( CASE WHEN COPD.ACT_CD = 'FITRDO' OR COPD.ACT_CD = 'FITYDO' THEN '1'" ).append("\n"); 
		query.append("                                                                   WHEN COPD.ACT_CD = 'FUVMAD' THEN '0' END || NVL(TO_CHAR(NVL(COPD.ACT_DT,COPD.ESTM_DT), 'YYYYMMDDHH24MISS'), '00000000000000')" ).append("\n"); 
		...
		query.append("                                                              ) , 30) COP_VAL" ).append("\n"); 
		...
		query.append("                                            AND COPM.BKG_NO = PKUP_NTC.BKG_NO" ).append("\n"); 
		query.append("                                            AND COPD.COP_NO = COPM.COP_NO" ).append("\n"); 
		query.append("                                            AND COPM.COP_STS_CD <> 'X'" ).append("\n"); 
		query.append("                                            AND COPD.ACT_CD IN ('FITRDO','FITYDO','FUVMAD')) AS COP_PKUP_YD_CD," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("       (CASE WHEN SUBSTR(BKG.POD_CD,1,2) = 'CA' THEN                  " ).append("\n"); 
		...
		query.append("       BKG_GET_IB_PRD_ROUT_GID_FNC(@[bl_no]) AS ROUT_GID_DESC," ).append("\n"); 
		...
		query.append("       GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,PKUP_NTC.AUTO_SND_STOP_DT,USR_ORG.LOC_CD ) AS AUTO_SND_STOP_DT," ).append("\n"); 
		query.append("       PKUP_NTC.AUTO_SND_STOP_USR_ID," ).append("\n"); 
		query.append("       GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,PKUP_NTC.AUTO_SND_RESM_DT,USR_ORG.LOC_CD ) AS AUTO_SND_RESM_DT," ).append("\n"); 
		...
		query.append("               MAX(DECODE(C.CUST_CNTC_TP_CD,'C1',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD)))))) AS C1_EML_SND_DT," ).append("\n"); 
		...
		query.append("               MAX(DECODE(C.CUST_CNTC_TP_CD,'C2',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD)))))) AS C2_EML_SND_DT,                        " ).append("\n"); 
		...
		query.append("               MAX(DECODE(C.CUST_CNTC_TP_CD,'B1',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD)))))) AS B1_EML_SND_DT,                        " ).append("\n"); 
		...
		query.append("               MAX(DECODE(C.CUST_CNTC_TP_CD,'B2',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD)))))) AS B2_EML_SND_DT,                        " ).append("\n"); 
		...
		query.append("               MAX(DECODE(C.CUST_CNTC_TP_CD,'AN',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD)))))) AS AN_EML_SND_DT,                        " ).append("\n"); 
		...
		query.append("               MAX(                                                                                                   " ).append("\n"); 
		query.append("               GREATEST(NVL(DECODE(C.CUST_CNTC_TP_CD,'C1',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD))))),NULL_DT), " ).append("\n"); 
		query.append("                        NVL(DECODE(C.CUST_CNTC_TP_CD,'C2',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD))))),NULL_DT),                   " ).append("\n"); 
		query.append("                        NVL(DECODE(C.CUST_CNTC_TP_CD,'B1',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD))))),NULL_DT),                   " ).append("\n"); 
		query.append("                        NVL(DECODE(C.CUST_CNTC_TP_CD,'B2',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD))))),NULL_DT),                   " ).append("\n"); 
		query.append("                        NVL(DECODE(C.CUST_CNTC_TP_CD,'AN',NVL(C.EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, COM_MAIL.EML_DT, NVL(ORG.LOC_CD,DECODE(A.EDI_322_MVMT_CD,'RL',D.POD_CD,D.DEL_CD))))),NULL_DT))) AS GRT_EML_SND_DT," ).append("\n"); 
		query.append("              " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("   AND LOC.EQ_CTRL_OFC_CD      = PKUP_NO.OFC_CD" ).append("\n"); 
