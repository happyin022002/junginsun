...
public class BLDocumentationCMDBDAOModifyBkgRouteNmUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	SET    POR_NM 		= SUBSTR(NVL(@[por_nm], POR_NM),0,25)" ).append("\n"); 
		query.append("		 , POL_NM 		= SUBSTR(NVL(@[pol_nm], POL_NM),0,25)" ).append("\n"); 
		query.append("		 , POD_NM 		= SUBSTR(NVL(@[pod_nm], POD_NM),0,25)" ).append("\n"); 
		query.append("		 , DEL_NM 		= SUBSTR(NVL(@[del_nm], DEL_NM),0,25)" ).append("\n"); 
