...
*@FileName : EBookingReceiptDBDAOaddBkgXterXptLicNoCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterXptLicNoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterXptLicNoCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_XPT_LIC_NO" ).append("\n");
		query.append("(" ).append("\n");
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterXptLicNoCSQL").append("\n");
		query.append("*/").append("\n");
	}
}