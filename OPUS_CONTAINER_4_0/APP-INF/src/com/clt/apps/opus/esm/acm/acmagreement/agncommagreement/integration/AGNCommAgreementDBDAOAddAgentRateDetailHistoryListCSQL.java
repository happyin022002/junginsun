...
*@FileName : AGNCommAgreementDBDAOAddAgentRateDetailHistoryListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateDetailHistoryListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgentRateDetailHistoryList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateDetailHistoryListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateDetailHistoryListCSQL").append("\n");
		query.append("*/").append("\n");
	}
