...
*@FileName : KorCustExistVO.java
*@FileTitle : KorCustExistVO
*Open Issues :
*Change history :
...
public class KorCustExistVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorCustExistVO> models = new ArrayList<KorCustExistVO>();
	...
	public KorCustExistVO() {}

	public KorCustExistVO(String ibflag, String pagerows, String cnt, String dmstPortCd, String bkgNo, String cstmsDeclTpCd, String trnsSeq, String bkgCustTpCd) {
		this.bkgNo = bkgNo;
...
/**
	 ...
	 * @param request
	 * @return KorCustExistVO[]
	 */
	public KorCustExistVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCustExistVO[]
	 */
	public KorCustExistVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCustExistVO model = null;
	 ...
	 * @return KorCustExistVO[]
	 */
	public KorCustExistVO[] getKorCustExistVOs(){
		KorCustExistVO[] vos = (KorCustExistVO[])models.toArray(new KorCustExistVO[models.size()]);
		return vos;
	}
