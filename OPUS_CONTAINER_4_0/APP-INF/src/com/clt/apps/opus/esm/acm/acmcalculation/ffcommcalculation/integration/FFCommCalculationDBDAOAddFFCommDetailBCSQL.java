...
*@FileName : FFCommCalculationDBDAOAddFFCommDetailBCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOAddFFCommDetailBCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOAddFFCommDetailBCSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAOAddFFCommDetailBCSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOAddFFCommDetailBCSQL").append("\n");
		query.append("*/").append("\n");
	}
