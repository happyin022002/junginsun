...
*@FileName : SalesActivityManageDBDAOModifyCustSatisFactionUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesActivityManageDBDAOModifyCustSatisFactionUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Sales Activity Report 화면의 3번째 탭 ( Cust.SatisFaction ) 수정 후 저장용 쿼리
	  * </pre>
	  */
	public SalesActivityManageDBDAOModifyCustSatisFactionUSQL(){
		setQuery();
		...
		query.append("FileName : SalesActivityManageDBDAOModifyCustSatisFactionUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SAM_CUST_SATSFC" ).append("\n"); 
		query.append("SET CUST_SATSFC_GRD_CD = @[grd]" ).append("\n"); 
		query.append(", CUST_SATSFC_RSN = @[rsn]" ).append("\n"); 
		...
		query.append("AND CUST_SATSFC_ITM_CD = @[cust_satsfc_itm_cd]" ).append("\n"); 
