...
*@FileName : ESM_BKG_0754HTMLAction.java
...
public class ESM_BKG_0754HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0754HTMLAction 객체를 생성
	 */
	public ESM_BKG_0754HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0754Event event = new EsmBkg0754Event();
        log.debug("::CALL::> ESM_BKG_0754_HTMLAction - " + command.getCommand());
