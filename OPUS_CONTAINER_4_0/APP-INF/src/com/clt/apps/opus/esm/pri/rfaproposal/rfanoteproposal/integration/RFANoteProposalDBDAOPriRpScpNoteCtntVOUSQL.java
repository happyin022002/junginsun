...
*@FileName : RFANoteProposalDBDAOPriRpScpNoteCtntVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteProposalDBDAOPriRpScpNoteCtntVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFANoteProposalDBDAOPriRpScpNoteCtntVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFANoteProposalDBDAOPriRpScpNoteCtntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,NOTE_CONV_MAPG_ID 		= NVL(@[note_conv_mapg_id], NOTE_CONV_MAPG_ID)" ).append("\n"); 
