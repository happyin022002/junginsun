...
*@FileName : CostStructureDBDAOModifyWeekPeriodUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAOModifyWeekPeriodUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostStructureDBDAOModifyWeekPeriodUSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAOModifyWeekPeriodUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_WK_PRD SET " ).append("\n"); 
		query.append("	SLS_FM_DT = @[sls_fm_dt]," ).append("\n"); 
		query.append("	SLS_TO_DT = @[sls_to_dt]," ).append("\n"); 
		query.append("	EQ_WK = @[eq_wk]," ).append("\n"); 
