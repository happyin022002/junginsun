 ...
 *@FileName       : ESM_SPC_9010HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.spc.dailyforecast 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_SPC_9010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_SPC_9010HTMLAction 객체를 생성
	 */
	public ESM_SPC_9010HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc9010Event event = new EsmSpc9010Event();
		//DlyFctInpListVO dlyFctInpListVO = new DlyFctInpListVO();

		if (command.isCommand(FormCommand.ADD)) {
			// event.setSpcDlyFcastCustVOS(spcDlyFcastCustVO.fromRequestGridDate(request, ""));
			event.setDlyFctInpListVOS((DlyFctInpListVO[]) getVOs(request, DlyFctInpListVO.class, ""));
