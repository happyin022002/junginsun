...
*@FileName : EmptyReleaseOrderDBDAOMtyRlseOrdCMRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyReleaseOrderDBDAOMtyRlseOrdCMRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EmptyReleaseOrderDBDAOMtyRlseOrdCMRSQL
	  * </pre>
	  */
	public EmptyReleaseOrderDBDAOMtyRlseOrdCMRSQL(){
		setQuery();
		...
		query.append("FileName : EmptyReleaseOrderDBDAOMtyRlseOrdCMRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ,REPLACE(REPLACE(REPLACE(NVL(CM.CNTR_MF_GDS_DESC, ' '), CHR(10), ' '), CHR(13), ' '),',',' ') AS CNTR_MF_GDS_DESC" ).append("\n"); 
		query.append("FROM BKG_BOOKING BB" ).append("\n"); 
		query.append("     ,BKG_CNTR_MF_DESC CM" ).append("\n"); 
		query.append("WHERE BB.BKG_NO = CM.BKG_NO" ).append("\n"); 
