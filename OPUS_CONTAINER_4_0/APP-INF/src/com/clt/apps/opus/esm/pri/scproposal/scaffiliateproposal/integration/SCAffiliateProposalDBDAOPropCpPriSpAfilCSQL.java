...
*@FileName : SCAffiliateProposalDBDAOPropCpPriSpAfilCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCAffiliateProposalDBDAOPropCpPriSpAfilCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCAffiliateProposalDBDAOPropCpPriSpAfilCSQL(){
		setQuery();
		...
		query.append("FileName : SCAffiliateProposalDBDAOPropCpPriSpAfilCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
