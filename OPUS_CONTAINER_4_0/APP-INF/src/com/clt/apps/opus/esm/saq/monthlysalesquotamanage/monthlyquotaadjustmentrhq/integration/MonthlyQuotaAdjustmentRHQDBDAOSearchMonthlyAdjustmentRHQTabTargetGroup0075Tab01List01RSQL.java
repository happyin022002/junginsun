...
*@FileName : MonthlyQuotaAdjustmentRHQDBDAOSearchMonthlyAdjustmentRHQTabTargetGroup0075Tab01List01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentRHQDBDAOSearchMonthlyAdjustmentRHQTabTargetGroup0075Tab01List01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentRHQDBDAOSearchMonthlyAdjustmentRHQTabTargetGroup0075Tab01List01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentRHQDBDAOSearchMonthlyAdjustmentRHQTabTargetGroup0075Tab01List01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		 		   ( " ).append("\n"); 
		query.append("		 			(	 " ).append("\n"); 
		query.append("		 				VER.MQTA_STEP_CD = INP.SECOND_STEP          " ).append("\n"); 
		query.append("		 				AND INP.FIRST_STEP = '05' AND VER.GLINE_VER_NO = INP.GLINE_VER_NO         		" ).append("\n"); 
		query.append("		 				AND VER.TRD_CD = INP.SEL_TRD_CD AND VER.DIR_CD = INP.DIR_CD " ).append("\n"); 
		query.append("		 			)  " ).append("\n"); 
		query.append("		 			OR " ).append("\n"); 
		query.append("		 			(	VER.MQTA_STEP_CD = INP.SECOND_STEP  " ).append("\n"); 
		...
		query.append("		        GROUP BY RHQ.MQTA_STEP_CD,RHQ.BSE_YR,RHQ.BSE_MON,RHQ.TRD_CD,RHQ.RLANE_CD,RHQ.DIR_CD,    " ).append("\n"); 
