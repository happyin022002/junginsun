...
*@FileName : QtaAdjustmentDBDAOSearchQtaEditOfficeAddRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaAdjustmentDBDAOSearchQtaEditOfficeAddRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Qta Edit Office Add for IAS Sector List 를 조회 합니다.
	  * </pre>
	  */
	public QtaAdjustmentDBDAOSearchQtaEditOfficeAddRSQL(){
		setQuery();
		...
		query.append("FileName : QtaAdjustmentDBDAOSearchQtaEditOfficeAddRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("AND A1.RHQ_CD||A1.RGN_OFC_CD NOT IN ( SELECT DISTINCT RHQ_CD||RGN_OFC_CD" ).append("\n"); 
