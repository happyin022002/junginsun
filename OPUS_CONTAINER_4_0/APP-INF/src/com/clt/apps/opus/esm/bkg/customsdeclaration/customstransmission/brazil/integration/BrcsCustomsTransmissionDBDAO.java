...
public class BrcsCustomsTransmissionDBDAO extends DBDAOSupport {
	...
	/**
	 * BrSealInfoVO -> Seal 정보를 조회한다.
	 * 
	 * @param brVslCondVO
	 * @return List<BrSealInfoVO>
	 * @throws DAOException
	 */
	@SuppressWarnings("unchecked")
	public List<BrSealInfoVO> searchSealInfo(BrVslCondVO brVslCondVO) throws DAOException {
		
		List<BrSealInfoVO> list = null;
		...
		try
		{
			...
			DBRowSet dbRowset = new SQLExecuter("").executeQuery(
					(ISQLTemplate) new BrcsCustomsTransmissionDBDAOsearchSealInfoRSQL(), param, velParam);
			
			list = (List) RowSetUtil.rowSetToVOs(dbRowset,BrSealInfoVO.class);
