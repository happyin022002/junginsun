...
*@FileName : ChinaManifestListDownloadDBDAOaddBlCntrCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOaddBlCntrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOaddBlCntrCSQL(){
		setQuery();
		...
		params.put("cntr_meas_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOaddBlCntrCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_CHN_CNTR (" ).append("\n");
		...
		query.append("CNTR_MEAS_QTY," ).append("\n");
		...
		query.append("@[wgt_ut_cd]," ).append("\n");
		query.append("NVL(@[cntr_meas_qty], 0)," ).append("\n");
		query.append("@[meas_ut_cd]," ).append("\n");
