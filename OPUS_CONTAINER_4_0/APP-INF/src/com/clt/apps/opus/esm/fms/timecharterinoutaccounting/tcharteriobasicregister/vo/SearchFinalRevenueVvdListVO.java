...
*@FileName : SearchFinalRevenueVvdListVO.java
*@FileTitle : SearchFinalRevenueVvdListVO
*Open Issues :
*Change history :
 ...
 */
public class SearchFinalRevenueVvdListVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<SearchFinalRevenueVvdListVO> models = new ArrayList<SearchFinalRevenueVvdListVO>();
    ...
    public SearchFinalRevenueVvdListVO() {
    }

    public SearchFinalRevenueVvdListVO(String ibflag, String pagerows, String revYrmon, String vslCd, String skdVoyNo, String skdDirCd, String revDirCd, String vstDt, String vedDt, String rlaneCd, String slanCd, String vvdCd, String comVvdFlg) {
        this.vstDt = vstDt;
	 ...
	 */
    public SearchFinalRevenueVvdListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchFinalRevenueVvdListVO[]
	 */
    public SearchFinalRevenueVvdListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        SearchFinalRevenueVvdListVO model = null;
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                model = new SearchFinalRevenueVvdListVO();
                if (vstDt[i] != null)
        ...
        return getSearchFinalRevenueVvdListVOs();
    }
	 ...
	 * @return SearchFinalRevenueVvdListVO[]
	 */
    public SearchFinalRevenueVvdListVO[] getSearchFinalRevenueVvdListVOs() {
        SearchFinalRevenueVvdListVO[] vos = (SearchFinalRevenueVvdListVO[]) models.toArray(new SearchFinalRevenueVvdListVO[models.size()]);
        return vos;
    }
