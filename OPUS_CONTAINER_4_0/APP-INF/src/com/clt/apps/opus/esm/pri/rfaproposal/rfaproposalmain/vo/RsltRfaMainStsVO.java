...
*@FileName : RsltRfaMainStsVO.java
*@FileTitle : RsltRfaMainStsVO
*Open Issues :
*Change history :
...
public class RsltRfaMainStsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltRfaMainStsVO> models = new ArrayList<RsltRfaMainStsVO>();
	...
	public RsltRfaMainStsVO() {}

	public RsltRfaMainStsVO(String ibflag, String pagerows, String propStsCd, String propSts) {
...
/**
	 ...
	 * @param request
	 * @return RsltRfaMainStsVO[]
	 */
	public RsltRfaMainStsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltRfaMainStsVO[]
	 */
	public RsltRfaMainStsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltRfaMainStsVO model = null;
	 ...
	 * @return RsltRfaMainStsVO[]
	 */
	public RsltRfaMainStsVO[] getRsltRfaMainStsVOs(){
		RsltRfaMainStsVO[] vos = (RsltRfaMainStsVO[])models.toArray(new RsltRfaMainStsVO[models.size()]);
		return vos;
	}
