...
*@FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOGetPreviousCheckKey0156RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentSlsRHQDBDAOGetPreviousCheckKey0156RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MonthlyQuotaAdjustmentRhq의 데이타를 조회하기 위한 mqta_mdl_ver_no, sls_fcast_pub_no 값을 조회한다.
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentSlsRHQDBDAOGetPreviousCheckKey0156RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOGetPreviousCheckKey0156RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        VER.QTA_MST_VER_NO," ).append("\n"); 
		query.append("        VER.SAQ_STS_CD," ).append("\n"); 
		query.append("        VER.INCL_PORT_FLG," ).append("\n"); 
		query.append("        GVR.SAQ_TGT_GRP_CD" ).append("\n"); 
