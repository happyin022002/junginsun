...
*@FileName : EsmBkg1013Event.java
*@FileTitle : EsmBkg1013Event
*Open Issues :
*Change history :
...
/**
 * esm_bkg_1013 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_BKG_1013HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author
 * @see ESM_BKG_1013HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmBkg1013Event extends EventSupport {
