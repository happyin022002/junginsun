 ...
 *@FileName : ESM_PRI_2025HTMLAction.java
...
public class ESM_PRI_2025HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2025Event event = new EsmPri2025Event();

		if (command.isCommand(FormCommand.MODIFY01)) {
			event.setPriRpScpRtRoutOrgPntVO((PriRpScpRtRoutPntVO[]) getVOs(request, PriRpScpRtRoutPntVO.class,
					"sheet1_"));
			event.setPriRpScpRtRoutOrgViaVO((PriRpScpRtRoutViaVO[]) getVOs(request, PriRpScpRtRoutViaVO.class,
					"sheet2_"));
			event.setPriRpScpRtRoutDestViaVO((PriRpScpRtRoutViaVO[]) getVOs(request, PriRpScpRtRoutViaVO.class,
					"sheet3_"));
			event.setPriRpScpRtRoutDestPntVO((PriRpScpRtRoutPntVO[]) getVOs(request, PriRpScpRtRoutPntVO.class,
					"sheet4_"));
