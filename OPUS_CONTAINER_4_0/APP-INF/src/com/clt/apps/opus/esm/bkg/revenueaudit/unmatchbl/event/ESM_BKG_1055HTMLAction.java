...
*@FileName : ESM_BKG_1055HTMLAction.java
...
public class ESM_BKG_1055HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1055HTMLAction 객체를 생성
	 */
	public ESM_BKG_1055HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1055Event event = new EsmBkg1055Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchUnmatchTypeListVO((RsltSearchUnmatchTypeListVO)getVO(request, RsltSearchUnmatchTypeListVO.class));
		}
