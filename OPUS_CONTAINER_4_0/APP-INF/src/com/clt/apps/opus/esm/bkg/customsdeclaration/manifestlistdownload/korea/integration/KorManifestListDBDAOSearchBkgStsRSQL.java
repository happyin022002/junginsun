...
*@FileName : KorManifestListDBDAOSearchBkgStsRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchBkgStsRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchBkgStsRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchBkgStsRSQL").append("\n");
		query.append("*/").append("\n");
	}
