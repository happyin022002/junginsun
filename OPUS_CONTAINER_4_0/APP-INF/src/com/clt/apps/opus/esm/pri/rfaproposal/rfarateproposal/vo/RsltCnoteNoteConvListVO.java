 ...
 *@FileName : RsltCnoteNoteConvListVO.java
 *@FileTitle : RsltCnoteNoteConvListVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class RsltCnoteNoteConvListVO	extends	 AbstractValueObject {

	private	 static final long serialVersionUID = 1L;

	private	 Collection<RsltCnoteNoteConvListVO>  models =	new	ArrayList<RsltCnoteNoteConvListVO>();
	 ...
	 * @param request
	 * @return RsltCnoteNoteConvListVO[]
	 */
	public RsltCnoteNoteConvListVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return RsltCnoteNoteConvListVO[]
	 */
	public RsltCnoteNoteConvListVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		RsltCnoteNoteConvListVO model = null;
		...
		try	{
			...
			for	(int i = 0;	i <	length;	i++) {
				model =	new	RsltCnoteNoteConvListVO();
				if ( ibflag[i] !=	null)
		...
		return getRsltCnoteNoteConvListVOs();
	}
	 ...
	 * @return RsltCnoteNoteConvListVO[]
	 */
	public RsltCnoteNoteConvListVO[]	 getRsltCnoteNoteConvListVOs(){
		RsltCnoteNoteConvListVO[] vos = (RsltCnoteNoteConvListVO[])models.toArray(new	RsltCnoteNoteConvListVO[models.size()]);
		return vos;
	}
