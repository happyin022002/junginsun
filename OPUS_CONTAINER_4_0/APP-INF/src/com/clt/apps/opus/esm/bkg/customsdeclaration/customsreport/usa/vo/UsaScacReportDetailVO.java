...
public class UsaScacReportDetailVO extends ScacReportDetailVO {
	...
	public UsaScacReportDetailVO(String ibflag, String pagerows, String scac, String scacNm, String nvoccCbl, String hbl, String nvoccVslNm, String nvoccSkdVoyNo, String cstmsPodCd, String nvoccPodCd, String mbl, String comScac, String mfRspnRcvFlg, String rcvDt, String podErr) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("com_scac", getComScac());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("com_scac", "comScac");
	 ...
	 * @param comScac
	 */
	public void setComScac(String comScac) {
		this.comScac = comScac;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setComScac(JSPUtil.getParameter(request, "com_scac", ""));
	...
	public UsaScacReportDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] comScac = (JSPUtil.getParameter(request, prefix	+ "com_scac", length));
	...
	*/
	public void unDataFormat(){
		...
		this.comScac = this.comScac .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
