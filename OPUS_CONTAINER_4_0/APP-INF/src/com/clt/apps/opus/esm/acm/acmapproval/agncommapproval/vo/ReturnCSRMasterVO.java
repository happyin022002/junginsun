...
public class ReturnCSRMasterVO extends AbstractValueObject {
	...
	public ReturnCSRMasterVO(String ibflag, String pagerows, String csrNo, String csrNoMaster, String bkgCnt, String dateFm, String dateTo, String arOfcCd, String agnCd, String audNo, String usrId) {
		this.dateFm = dateFm;
		this.audNo = audNo;
		this.agnCd = agnCd;
		this.csrNo = csrNo;
