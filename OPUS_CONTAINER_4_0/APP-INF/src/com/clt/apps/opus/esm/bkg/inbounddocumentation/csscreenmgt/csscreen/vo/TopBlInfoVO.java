...
*@FileName : TopBlInfoVO.java
*@FileTitle : TopBlInfoVO
*Open Issues :
*Change history :
...
public class TopBlInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TopBlInfoVO> models = new ArrayList<TopBlInfoVO>();
	...
	public TopBlInfoVO(String ibflag, String pagerows, String bkgNo, String blNo, String blTpCd, String splitFlg) {
	 ...
	 * @return TopBlInfoVO[]
	 */
	public TopBlInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TopBlInfoVO[]
	 */
	public TopBlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TopBlInfoVO model = null;
	 ...
	 * @return TopBlInfoVO[]
	 */
	public TopBlInfoVO[] getTopBlInfoVOs(){
		TopBlInfoVO[] vos = (TopBlInfoVO[])models.toArray(new TopBlInfoVO[models.size()]);
		return vos;
	}
