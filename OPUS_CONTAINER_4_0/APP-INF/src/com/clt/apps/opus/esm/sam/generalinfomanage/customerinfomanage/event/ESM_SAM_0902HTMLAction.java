...
*@FileName : ESM_SAM_0902HTMLAction.java
...
public class ESM_SAM_0902HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0004HTMLAction 객체를 생성
	 */
	public ESM_SAM_0902HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSam0902Event event = new EsmSam0902Event();
