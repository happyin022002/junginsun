...
*@FileName : AcssAlwInfoVO.java
*@FileTitle : AcssAlwInfoVO
*Open Issues :
*Change history :
...
public class AcssAlwInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AcssAlwInfoVO> models = new ArrayList<AcssAlwInfoVO>();
	 ...
	 * @param request
	 * @return AcssAlwInfoVO[]
	 */
	public AcssAlwInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AcssAlwInfoVO[]
	 */
	public AcssAlwInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AcssAlwInfoVO model = null;
	 ...
	 * @return AcssAlwInfoVO[]
	 */
	public AcssAlwInfoVO[] getAcssAlwInfoVOs(){
		AcssAlwInfoVO[] vos = (AcssAlwInfoVO[])models.toArray(new AcssAlwInfoVO[models.size()]);
		return vos;
	}
