...
*@FileName : SCRateProposalDBDAOPriSpScpRtCnoteAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCnoteAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCRateProposalDBDAOPriSpScpRtCnoteAmdVOCSQL
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCnoteAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCnoteAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    PRI_SP_SCP_RT_CNOTE CNOTE" ).append("\n"); 
		...
		query.append("    WHERE   " ).append("\n"); 
		query.append("        PROP_NO             = CNOTE.PROP_NO" ).append("\n"); 
		query.append("    AND AMDT_SEQ            = CNOTE.AMDT_SEQ" ).append("\n"); 
		query.append("    AND SVC_SCP_CD          = CNOTE.SVC_SCP_CD" ).append("\n"); 
		query.append("    AND GEN_SPCL_RT_TP_CD   = CNOTE.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		query.append("    AND CMDT_HDR_SEQ        = CNOTE.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("	AND SRC_INFO_CD			<> 'AD'   " ).append("\n"); 
		query.append(")" ).append("\n"); 
