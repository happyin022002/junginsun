...
*@FileName : NewZealandManifestDgGoodsInfoVO.java
*@FileTitle : NewZealandManifestDgGoodsInfoVO
*Open Issues :
*Change history :
...
public class NewZealandManifestDgGoodsInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<NewZealandManifestDgGoodsInfoVO> models = new ArrayList<NewZealandManifestDgGoodsInfoVO>();
	...
	public NewZealandManifestDgGoodsInfoVO() {}

	public NewZealandManifestDgGoodsInfoVO(String ibflag, String pagerows, String imoClassNo, String imoPageNo, String hazardCd, String flashPoint, String flashPointUnit, String packingGroup, String emsNo, String mfag, String tremCardNo) {
		this.mfag = mfag;
...
/**
	 ...
	 * @param request
	 * @return NewZealandManifestDgGoodsInfoVO[]
	 */
	public NewZealandManifestDgGoodsInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NewZealandManifestDgGoodsInfoVO[]
	 */
	public NewZealandManifestDgGoodsInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandManifestDgGoodsInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandManifestDgGoodsInfoVO();
				if (mfag[i] != null)
		...
		return getNewZealandManifestDgGoodsInfoVOs();
	}
	 ...
	 * @return NewZealandManifestDgGoodsInfoVO[]
	 */
	public NewZealandManifestDgGoodsInfoVO[] getNewZealandManifestDgGoodsInfoVOs(){
		NewZealandManifestDgGoodsInfoVO[] vos = (NewZealandManifestDgGoodsInfoVO[])models.toArray(new NewZealandManifestDgGoodsInfoVO[models.size()]);
		return vos;
	}
