...
*@FileName : BasicDataDBDAOCreateAddPolPodPairForSectorYrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BasicDataDBDAOCreateAddPolPodPairForSectorYrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Pol Pod Pair 정보를 추가 생성합니다._Year
	  * </pre>
	  */
	public BasicDataDBDAOCreateAddPolPodPairForSectorYrCSQL(){
		setQuery();
		...
		query.append("FileName : BasicDataDBDAOCreateAddPolPodPairForSectorYrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
