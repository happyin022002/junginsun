...
*@FileName : FACommAgreementDBDAOApprovalFACAgreementListUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FACommAgreementDBDAOApprovalFACAgreementListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ACM_FAC_AGMT에 승인 관련 정보를 업데이트한다.
	  * </pre>
	  */
	public FACommAgreementDBDAOApprovalFACAgreementListUSQL(){
		setQuery();
		...
		query.append("FileName : FACommAgreementDBDAOApprovalFACAgreementListUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("SET    FAC_STS_CD = 'PS'," ).append("\n");
