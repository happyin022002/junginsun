...
public class UpdateSaqMonCfmQtaSlsRep0173VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UpdateSaqMonCfmQtaSlsRep0173VO> models = new ArrayList<UpdateSaqMonCfmQtaSlsRep0173VO>();
	...
	public UpdateSaqMonCfmQtaSlsRep0173VO() {}
	 ...
	 */
	public UpdateSaqMonCfmQtaSlsRep0173VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqMonCfmQtaSlsRepVO[]
	 */
	public UpdateSaqMonCfmQtaSlsRep0173VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UpdateSaqMonCfmQtaSlsRep0173VO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UpdateSaqMonCfmQtaSlsRep0173VO();
				if (vslCd[i] != null)
	 ...
	 * @return SaqMonCfmQtaSlsRepVO[]
	 */
	public UpdateSaqMonCfmQtaSlsRep0173VO[] getSaqMonCfmQtaSlsRepVOs(){
		UpdateSaqMonCfmQtaSlsRep0173VO[] vos = (UpdateSaqMonCfmQtaSlsRep0173VO[])models.toArray(new UpdateSaqMonCfmQtaSlsRep0173VO[models.size()]);
		return vos;
	}
