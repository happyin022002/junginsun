...
*@FileName : UsaHblCheckCondVO.java
*@FileTitle : UsaHblCheckCondVO
*Open Issues :
*Change history :
...
public class UsaHblCheckCondVO extends HouseBlCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaHblCheckCondVO> models = new ArrayList<UsaHblCheckCondVO>();
	...
	public UsaHblCheckCondVO() {}

	public UsaHblCheckCondVO(String ibflag, String pagerows, String vvd, String polCd, String podCd, String contiCd, String bkgOfcCd, String obSrepCd, String mblFiler, String errFlg) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setErrFlg(JSPUtil.getParameter(request, "err_flg", ""));
		setMblFiler(JSPUtil.getParameter(request, "mbl_filer", ""));
	 ...
	 * @param request
	 * @return UsaHblCheckCondVO[]
	 */
	public UsaHblCheckCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaHblCheckCondVO[]
	 */
	public UsaHblCheckCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaHblCheckCondVO model = null;
	 ...
	 * @return UsaHblCheckCondVO[]
	 */
	public UsaHblCheckCondVO[] getUsaHblCheckCondVOs(){
		UsaHblCheckCondVO[] vos = (UsaHblCheckCondVO[])models.toArray(new UsaHblCheckCondVO[models.size()]);
		return vos;
	}
