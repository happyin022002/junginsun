...
*@FileName : FFCommCalculationDBDAOSearchSADateOfSURSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOSearchSADateOfSURSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOSearchSADateOfSURSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAOSearchSADateOfSURSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOSearchSADateOfSURSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	AND T1.CLPT_IND_SEQ = T3.CAL_IND" ).append("\n"); 
		query.append("	AND NVL(T1.SKD_CNG_STS_CD,' ') <> 'S'" ).append("\n"); 
		query.append("	AND T1.VT_ADD_CALL_FLG IS NULL	) T" ).append("\n"); 
