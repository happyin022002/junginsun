...
*@FileName : ESM_COA_4009HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
import com.clt.apps.opus.esm.coa.weeklypfmc.opmaster.event.EsmCoa4009Event;
 ...
 * @author Kim Ki Dae
 * @see EsmCoa4009Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_4009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * TESTHTMLAction 객체를 생성
	 */
	public ESM_COA_4009HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCoa4009Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa4009Event event = new EsmCoa4009Event();  	
		...
		if(command.isCommand(FormCommand.SEARCH01)) {// Retrieve
			...
			event.setMultiOmPortMngVOS((MultiOmPortMngVO[])getVOs(request, MultiOmPortMngVO .class,""));
