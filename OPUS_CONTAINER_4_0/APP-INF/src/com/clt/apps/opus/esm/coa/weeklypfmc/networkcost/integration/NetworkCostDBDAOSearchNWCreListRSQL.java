...
public class NetworkCostDBDAOSearchNWCreListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    ,(CASE WHEN STND_COST_CD = '53101000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '53102000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '53200000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54100000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54250000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54300000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54200000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54150000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54450000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54180000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54550000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           WHEN STND_COST_CD = '54350000' THEN COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
		query.append("           ELSE ''" ).append("\n"); 
		...
		query.append("   AND COA_COST_SRC_PRT_CD IN ('PA','CO')" ).append("\n"); 
		query.append("   AND MGRP_COST_CD in ('OV','OF','GE')" ).append("\n"); 
		query.append("   AND STND_COST_CD NOT IN ('54400000','65000000','54400010')	--20150623.ADD" ).append("\n"); 
