...
public class BKG_CSTMS_COMMON_HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ACM_COMMON_HTMLAction 객체를 생성
	 */
	public BKG_CSTMS_COMMON_HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		BkgCstmsCommonEvent event = new BkgCstmsCommonEvent();
		event.setBkgCstmsCommonInputVO((BkgCstmsCommonInputVO)getVO(request, BkgCstmsCommonInputVO.class));
		return  event;
	}
