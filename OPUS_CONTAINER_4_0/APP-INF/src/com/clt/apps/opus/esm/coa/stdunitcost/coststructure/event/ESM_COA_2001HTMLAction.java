...
*@FileName : ESM_COA_2001HTMLAction.java
...
public class ESM_COA_2001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_2001HTMLAction 객체를 생성
	 */
	public ESM_COA_2001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa2001Event event = new EsmCoa2001Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMainGrpCostCodeVOS((MainGrpCostCodeVO[])getVOs(request, MainGrpCostCodeVO .class));
		}
