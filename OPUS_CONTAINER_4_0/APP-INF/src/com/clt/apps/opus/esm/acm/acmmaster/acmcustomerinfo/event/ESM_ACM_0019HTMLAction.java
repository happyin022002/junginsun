...
*@FileName : ESM_ACM_0019HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see EsmAcm0019Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0019HTMLAction 객체를 생성
	 */
	public ESM_ACM_0019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0019Event event = new EsmAcm0019Event();

		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			event.setFFVendorMatchVO((FFVendorMatchVO)getVO(request, FFVendorMatchVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setFFVendorMatchVOs((FFVendorMatchVO[])getVOs(request, FFVendorMatchVO.class, ""));
		}
