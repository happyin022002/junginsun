...
public class BDRCorrectionDBDAOSearchOftChnRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("OR NVL(K1_FRT_TERM_CD, ' ') != NVL(K2_FRT_TERM_CD, ' ')" ).append("\n"); 
		...
		query.append("OR NVL(K1_N3PTY_RCV_OFC_CD, ' ') != NVL(K2_N3PTY_RCV_OFC_CD, ' ')" ).append("\n"); 
		query.append("OR NVL(K1_N3PTY_CUST_CNT_CD, ' ') != NVL(K2_N3PTY_CUST_CNT_CD, ' ')" ).append("\n"); 
		query.append("OR NVL(K1_N3PTY_CUST_SEQ, 0) ! = NVL(K1_N3PTY_CUST_SEQ, 0)" ).append("\n"); 
		query.append("OR NVL(K1_FRT_INCL_XCLD_DIV_CD, ' ') != NVL(K1_FRT_INCL_XCLD_DIV_CD, ' ')" ).append("\n"); 
		query.append("OR NVL(K1_PRN_HDN_FLG, ' ') != NVL(K1_PRN_HDN_FLG, ' ')" ).append("\n"); 
