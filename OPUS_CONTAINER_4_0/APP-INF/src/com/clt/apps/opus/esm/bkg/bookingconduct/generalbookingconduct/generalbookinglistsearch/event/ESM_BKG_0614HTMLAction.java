...
*@FileName : ESM_BKG_0614HTMLAction.java
...
public class ESM_BKG_0614HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0614HTMLAction 객체를 생성
	 */
	public ESM_BKG_0614HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0614Event event = new EsmBkg0614Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			BkgListForWorkWithBkgInputVO bkgListForWorkWithBkgInputVO = (BkgListForWorkWithBkgInputVO) getVO(request, BkgListForWorkWithBkgInputVO.class);
			event.setBkgListForWorkWithBkgInputVO(bkgListForWorkWithBkgInputVO);
		}
			...
			event.setBkgListForWorkWithBkgVOs((BkgListForWorkWithBkgVO[])getVOs(request,BkgListForWorkWithBkgVO.class,"sheet1_"));
