...
*@FileName : KorCustRPTDAOVvdPolRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustRPTDAOVvdPolRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustRPTDAOVvdPolRSQL(){
		setQuery();
		...
		params.put("txt_pol",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("AND VSL_CD     = SUBSTR(@[txt_vvd],1,4)" ).append("\n");
		query.append("AND SKD_VOY_NO = SUBSTR(@[txt_vvd],5,4)" ).append("\n");
		query.append("AND SKD_DIR_CD = SUBSTR(@[txt_vvd],9,1)" ).append("\n");
		query.append("#end" ).append("\n");
		query.append("#if (${txt_pol} != '')" ).append("\n");
		query.append("AND POL_CD = @[txt_pol]" ).append("\n");
		query.append("#end" ).append("\n");
		...
		query.append("FileName : KorCustRPTDAOVvdPolRSQL").append("\n");
		query.append("*/").append("\n");
	}
}