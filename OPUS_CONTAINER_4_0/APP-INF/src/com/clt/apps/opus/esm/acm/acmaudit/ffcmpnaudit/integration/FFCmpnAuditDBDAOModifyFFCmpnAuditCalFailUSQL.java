...
*@FileName : FFCmpnAuditDBDAOModifyFFCmpnAuditCalFailUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCmpnAuditDBDAOModifyFFCmpnAuditCalFailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyFFCmpnAuditCalFail
	  * </pre>
	  */
	public FFCmpnAuditDBDAOModifyFFCmpnAuditCalFailUSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnAuditDBDAOModifyFFCmpnAuditCalFailUSQL").append("\n");
		query.append("*/").append("\n");
	}
