...
*@FileName : ESM_BKG_1073HTMLAction.java
 ...
 * @see EsmBkg1073Event 참조
 * @since J2EE 1.5
 */

public class ESM_BKG_1073HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_1073HTMLAction 객체를 생성
     */
    public ESM_BKG_1073HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg1073Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1073Event event = new EsmBkg1073Event();
		
		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((SearchEDIGrpIDVO) getVO(request, SearchEDIGrpIDVO.class));
		}
