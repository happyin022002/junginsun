...
*@FileName : FwdrListVO.java
*@FileTitle : FwdrListVO
*Open Issues :
*Change history :
...
public class FwdrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<FwdrListVO> models = new ArrayList<FwdrListVO>();
	...
	public FwdrListVO(String ibflag, String pagerows, String anrFwrdId, String oldAnrFwrdId, String fwrdNm, String fwrdAddr1, String fwrdAddr2, String fwrdAddr3, String fwrdAddr4, String fwrdFaxNo, String fwrdPhnNo, String cntcPsonNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.ibflag = ibflag;
	...
	public FwdrListVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public FwdrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FwdrListVO model = null;
		...
		return getFwdrListVOs();
	}

	public FwdrListVO[] getFwdrListVOs(){
		FwdrListVO[] vos = (FwdrListVO[])models.toArray(new FwdrListVO[models.size()]);
		return vos;
	}
