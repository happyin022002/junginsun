...
*@FileName : BookingMasterMgtDBDAOmodifyBdrVslChkFlgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOmodifyBdrVslChkFlgUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingMasterMgtDBDAOmodifyBdrVslChkFlgUSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOmodifyBdrVslChkFlgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${chk_flg} != 'N')" ).append("\n"); 
