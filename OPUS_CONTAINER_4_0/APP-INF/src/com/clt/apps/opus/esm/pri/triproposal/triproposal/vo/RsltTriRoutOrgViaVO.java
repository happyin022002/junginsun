...
*@FileName : RsltTriRoutOrgViaVO.java
*@FileTitle : RsltTriRoutOrgViaVO
*Open Issues :
*Change history :
...
public class RsltTriRoutOrgViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltTriRoutOrgViaVO> models = new ArrayList<RsltTriRoutOrgViaVO>();
	...
	public RsltTriRoutOrgViaVO() {}

	public RsltTriRoutOrgViaVO(String ibflag, String pagerows, String triPropNo, String orgDestTpCd, String routViaSeq, String routViaPortCd, String routViaPortNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltTriRoutOrgViaVO[]
	 */
	public RsltTriRoutOrgViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltTriRoutOrgViaVO[]
	 */
	public RsltTriRoutOrgViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltTriRoutOrgViaVO model = null;
		...
		return getRsltTriRoutOrgViaVOs();
	}
	 ...
	 * @return RsltTriRoutOrgViaVO[]
	 */
	public RsltTriRoutOrgViaVO[] getRsltTriRoutOrgViaVOs(){
		RsltTriRoutOrgViaVO[] vos = (RsltTriRoutOrgViaVO[])models.toArray(new RsltTriRoutOrgViaVO[models.size()]);
		return vos;
	}
