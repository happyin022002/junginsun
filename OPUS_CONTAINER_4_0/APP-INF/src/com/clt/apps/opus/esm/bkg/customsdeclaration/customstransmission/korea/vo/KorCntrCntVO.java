...
*@FileName : KorCntrCntVO.java
*@FileTitle : KorCntrCntVO
*Open Issues :
*Change history :
...
public class KorCntrCntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorCntrCntVO> models = new ArrayList<KorCntrCntVO>();
	...
	public KorCntrCntVO(String ibflag, String pagerows, String teuCnt, String feuCnt, String bkgNo, String cstmsDeclTpCd, String portCd) {
		this.teuCnt = teuCnt;
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @return KorCntrCntVO[]
	 */
	public KorCntrCntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCntrCntVO[]
	 */
	public KorCntrCntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCntrCntVO model = null;
	 ...
	 * @return KorCntrCntVO[]
	 */
	public KorCntrCntVO[] getKorCntrCntVOs(){
		KorCntrCntVO[] vos = (KorCntrCntVO[])models.toArray(new KorCntrCntVO[models.size()]);
		return vos;
	}
