...
public class MtyRlseOrdInVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("excel_seq", getExcelSeq());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("excel_seq", "excelSeq");
    ...
    public void setExcelSeq(String excelSeq) {
        this.excelSeq = excelSeq;
    }

    public String getExcelSeq() {
        return this.excelSeq;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setExcelSeq(JSPUtil.getParameter(request, "excel_seq", ""));
    }
    ...
    public MtyRlseOrdInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] excelSeq = (JSPUtil.getParameter(request, prefix + "excel_seq", length));
	...
	*/
    public void unDataFormat() {
        ...
        this.excelSeq = this.excelSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
