...
*@FileName : AusDgListCondVO.java
*@FileTitle : AusDgListCondVO
*Open Issues :
*Change history :
...
public class AusDgListCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusDgListCondVO> models = new ArrayList<AusDgListCondVO>();
...
/**
	 ...
	 */
	public AusDgListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusDgListCondVO[]
	 */
	public AusDgListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusDgListCondVO model = null;
	 ...
	 * @return AusDgListCondVO[]
	 */
	public AusDgListCondVO[] getAusDgListCondVOs(){
		AusDgListCondVO[] vos = (AusDgListCondVO[])models.toArray(new AusDgListCondVO[models.size()]);
		return vos;
	}
