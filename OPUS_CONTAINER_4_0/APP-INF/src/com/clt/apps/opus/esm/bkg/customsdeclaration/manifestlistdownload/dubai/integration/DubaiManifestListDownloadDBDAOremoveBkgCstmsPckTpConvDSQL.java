...
*@FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsPckTpConvDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DubaiManifestListDownloadDBDAOremoveBkgCstmsPckTpConvDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeBkgCstmsPckTpConv
	  * </pre>
	  */
	public DubaiManifestListDownloadDBDAOremoveBkgCstmsPckTpConvDSQL(){
		setQuery();
		...
		query.append("FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsPckTpConvDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
