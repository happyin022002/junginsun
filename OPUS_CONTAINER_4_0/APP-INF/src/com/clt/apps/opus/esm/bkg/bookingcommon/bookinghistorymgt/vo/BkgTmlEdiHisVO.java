...
public class BkgTmlEdiHisVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("rspn_gdt", getRspnGdt());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("rspn_gdt", "rspnGdt");
    ...
    public void setRspnGdt(String rspnGdt) {
        this.rspnGdt = rspnGdt;
    }

    public String getRspnGdt() {
        return this.rspnGdt;
    }
    ...
    public BkgTmlEdiHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] rspnGdt = (JSPUtil.getParameter(request, prefix + "rspn_gdt", length));
	...
	*/
    public void unDataFormat() {
        ...
        this.rspnGdt = this.rspnGdt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
