...
*@FileName : TariffRuleDBDAOPriTrfRuleVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffRuleDBDAOPriTrfRuleVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TariffRuleDBDAOPriTrfRuleVODSQL(){
		setQuery();
		...
		query.append("FileName : TariffRuleDBDAOPriTrfRuleVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRF_RULE" ).append("\n"); 
