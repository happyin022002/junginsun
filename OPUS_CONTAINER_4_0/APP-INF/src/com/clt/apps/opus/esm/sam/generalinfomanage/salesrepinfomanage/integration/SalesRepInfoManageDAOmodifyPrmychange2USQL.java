...
*@FileName : SalesRepInfoManageDAOmodifyPrmychange2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesRepInfoManageDAOmodifyPrmychange2USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * prmy 값이 N -> Y, Y->N 으로 변경하는 쿼리
	  * </pre>
	  */
	public SalesRepInfoManageDAOmodifyPrmychange2USQL(){
		setQuery();
		...
		query.append("FileName : SalesRepInfoManageDAOmodifyPrmychange2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET SREP_PRMRY_FLG = @[srep_prmry_flg]" ).append("\n"); 
