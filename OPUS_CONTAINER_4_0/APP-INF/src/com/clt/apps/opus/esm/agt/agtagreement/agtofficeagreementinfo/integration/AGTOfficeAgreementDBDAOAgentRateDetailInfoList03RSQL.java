...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList03RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList03RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_otr_ref 조회 결과를 cntr_inp_term_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList03RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList03RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    OTR_REF_DIV_CD = 'CUST'" ).append("\n"); 
		query.append("AND    OTR_LVL_CD = '2' )) T START WITH NO = 1 CONNECT BY NOCYCLE PRIOR NO = NO - 1" ).append("\n"); 
