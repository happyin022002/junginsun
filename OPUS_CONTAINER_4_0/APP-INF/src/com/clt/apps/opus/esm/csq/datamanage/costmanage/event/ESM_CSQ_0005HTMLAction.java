...
*@FileName       : ESM_CSQ_0005HTMLAction.java
*@FileTitle      : New Office Creation
*Open Issues     :
*Change history  :
*@LastModifyDate : 2013.05.
*@LastModifier   : SMQ USER
*@LastVersion    : 1.0
* 2013.05.03 SMQ USER
* 1.0 Creation
=========================================================*/
 ...
 * @author SMQ USER
 * @see EsmCsq0005Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0005HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0005HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0005Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCsq0005Event event = new EsmCsq0005Event();
		

		if(command.isCommand(FormCommand.COMMAND01)) {// creation
