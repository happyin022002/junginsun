	 ...
	 *@FileName : ESM_BKG_2004_01HTMLAction.java
...
public class ESM_BKG_2004_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_2004_01HTMLAction 객체를 생성
	 */
	public ESM_BKG_2004_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg200401Event event = new EsmBkg200401Event();

		HrdCdgDesc2VO searchHrdCdgDesc2VO = new HrdCdgDesc2VO();
		searchHrdCdgDesc2VO.fromRequest(request);
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchHrdCdgDesc2VO(searchHrdCdgDesc2VO);
		}
		return  event;
	}
