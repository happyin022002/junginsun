...
public class IsraelCustomsTransmissionDBDAOsearchBlGeneralRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               AND AA.PCK_TP_CD = BD.PCK_TP_CD" ).append("\n"); 
		...
		query.append("   , DECODE((SELECT FRT_TERM_CD FROM BKG_RATE WHERE 1=1 AND BKG_NO = BK.BKG_NO), 'P', 'H', 'Z') AS PAYMENT_CD" ).append("\n"); 
		...
		query.append("                             WHERE A.BKG_NO = BD.BKG_NO" ).append("\n"); 
