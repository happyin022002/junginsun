...
public class CostManageDBDAOCreateBasicCmcbNewLaneAvgCostCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("INSERT INTO CSQ_QTA_LANE_OFC_COST (BSE_TP_CD, BSE_YR, BSE_QTR_CD, OFC_VW_CD, TRD_CD, RLANE_CD, DIR_CD, RGN_OFC_CD, RHQ_CD, GID_PA_CM_UC_AMT, GID_RA_CM_UC_AMT, PA_CM_UC_AMT, RA_CM_UC_AMT, ADD_FLG, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT )" ).append("\n"); 
