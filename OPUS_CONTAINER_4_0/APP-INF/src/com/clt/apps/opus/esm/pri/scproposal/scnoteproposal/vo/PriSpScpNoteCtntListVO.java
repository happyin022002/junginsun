...
*@FileName : PriSpScpNoteCtntListVO.java
*@FileTitle : PriSpScpNoteCtntListVO
*Open Issues :
*Change history :
...
public class PriSpScpNoteCtntListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpNoteCtntListVO> models = new ArrayList<PriSpScpNoteCtntListVO>();
	...
	public PriSpScpNoteCtntListVO() {}

	public PriSpScpNoteCtntListVO(String ibflag, String pagerows, String dpSeq, String noteChgTpCd, String amdtSeq, String svcScpCd, String actionMode, String noteTitNm, String creDt, String noteCtnt, String chgCd, String prcProgStsCd, String effDt, String noteClssCd, String noteTpCd, String expDt, String noteConvTpCd, String prcCustTpCd, String updUsrId, String updDt, String prevNoteConvMapgId, String acptOfcCd, String acptDt, String srcInfoCd, String acptUsrId, String noteSeq, String noteConvFlg, String noteCtntSeq, String noteConvMapgId, String creUsrId, String n1stCmncAmdtSeq, String amendYn, String propNo, String conChk, String befEffDt, String befExpDt) {
		this.dpSeq = dpSeq;
	 ...
	 */
	public PriSpScpNoteCtntListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpNoteCtntListVO[]
	 */
	public PriSpScpNoteCtntListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpNoteCtntListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriSpScpNoteCtntListVO();
				if (dpSeq[i] != null)
		...
		return getPriSpScpNoteCtntListVOs();
	}
	...
	public PriSpScpNoteCtntListVO[] getPriSpScpNoteCtntListVOs(){
		PriSpScpNoteCtntListVO[] vos = (PriSpScpNoteCtntListVO[])models.toArray(new PriSpScpNoteCtntListVO[models.size()]);
		return vos;
	}
