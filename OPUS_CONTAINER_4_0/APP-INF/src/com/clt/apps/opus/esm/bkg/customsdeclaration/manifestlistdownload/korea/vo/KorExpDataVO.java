...
*@FileName : KorExpDataVO.java
*@FileTitle : KorExpDataVO
*Open Issues :
*Change history :
...
public class KorExpDataVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorExpDataVO> models = new ArrayList<KorExpDataVO>();
	...
	public KorExpDataVO(String ibflag, String pagerows, String inType, String ioBndCd, String podCd, String podTml, String polCd, String polTml, String portCd, String vvd) {
		this.vvd = vvd;
		this.podCd = podCd;
		this.polCd = polCd;
		this.inType = inType;
...
/**
	 ...
	 * @return KorExpDataVO[]
	 */
	public KorExpDataVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorExpDataVO[]
	 */
	public KorExpDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorExpDataVO model = null;
	 ...
	 * @return KorExpDataVO[]
	 */
	public KorExpDataVO[] getKorExpDataVOs(){
		KorExpDataVO[] vos = (KorExpDataVO[])models.toArray(new KorExpDataVO[models.size()]);
		return vos;
	}
