...
public class BookingMasterMgtDBDAOAddBkgChnBkgNoGenListCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("@[cre_usr_id]," ).append("\n"); 
		query.append("GLOBALDATE_PKG.TIME_CONV_FNC(COM_CONSTANTMGR_PKG.COM_GETBASELOCATIONCODE_FNC(), SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[cre_ofc_cd]))," ).append("\n"); 
		query.append("@[cre_usr_id]," ).append("\n"); 
		query.append("GLOBALDATE_PKG.TIME_CONV_FNC(COM_CONSTANTMGR_PKG.COM_GETBASELOCATIONCODE_FNC(), SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[cre_ofc_cd]))," ).append("\n"); 
		query.append("@[agn_flg]" ).append("\n"); 
		query.append(")" ).append("\n"); 
