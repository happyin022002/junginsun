...
public class SpecialManifestDBDAOsearchCntrCgoByCntrBaseRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    ,NVL((SELECT A.OUT_IMDG_PCK_CD1" ).append("\n"); 
		query.append("            FROM BKG_CSTMS_CD_CONV_CTNT CTNT" ).append("\n"); 
		query.append("           WHERE CTNT.CNT_CD = 'EU'" ).append("\n"); 
		query.append("             AND CTNT.CSTMS_DIV_ID = 'EU_DG_PKG_ISO'" ).append("\n"); 
		query.append("             AND CTNT.ATTR_CTNT1 = A.OUT_IMDG_PCK_CD1" ).append("\n"); 
		query.append("             AND CTNT.DELT_FLG = 'N'), '') PKG_TP" ).append("\n"); 
		query.append("    ,NVL((SELECT A.OUT_IMDG_PCK_CD1" ).append("\n"); 
		query.append("            FROM BKG_CSTMS_CD_CONV_CTNT CTNT" ).append("\n"); 
		query.append("           WHERE CTNT.CNT_CD = 'EU'" ).append("\n"); 
		query.append("             AND CTNT.CSTMS_DIV_ID = 'EU_DG_PKG_ISO'" ).append("\n"); 
		query.append("             AND CTNT.ATTR_CTNT1 = A.OUT_IMDG_PCK_CD1" ).append("\n"); 
		query.append("             AND CTNT.DELT_FLG = 'N'), '') OUTPKG_TP" ).append("\n"); 
		...
		query.append("    ,DECODE(A.IMDG_PCK_GRP_CD, 'N' , '', A.IMDG_PCK_GRP_CD)         PKG_GROUP" ).append("\n"); 
