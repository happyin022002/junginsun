...
public class CstShInqVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		setSscNo(JSPUtil.getParameter(request, "ssc_no", ""));
		setSmqcSignNm(JSPUtil.getParameter(request, "smqc_sign_nm", ""));
		setSeffDt1(JSPUtil.getParameter(request, "seff_dt1", ""));
		setSscTypeCd(JSPUtil.getParameter(request, "ssc_type_cd", ""));
		setSpropOfcCd(JSPUtil.getParameter(request, "sprop_ofc_cd", ""));
		setSpropSrepCd(JSPUtil.getParameter(request, "sprop_srep_cd", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setSpropAproOfcCd(JSPUtil.getParameter(request, "sprop_apro_ofc_cd", ""));
		setSpropMqcQty(JSPUtil.getParameter(request, "sprop_mqc_qty", ""));
		setSpropStsCd(JSPUtil.getParameter(request, "sprop_sts_cd", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setSpropNo(JSPUtil.getParameter(request, "sprop_no", ""));
		setSmqcSignCd(JSPUtil.getParameter(request, "smqc_sign_cd", ""));
		setScustCntCd(JSPUtil.getParameter(request, "scust_cnt_cd", ""));
		setScustSeq(JSPUtil.getParameter(request, "scust_seq", ""));
		setScreDt1(JSPUtil.getParameter(request, "scre_dt1", ""));
		setScreDt2(JSPUtil.getParameter(request, "scre_dt2", ""));
		setSeffDt2(JSPUtil.getParameter(request, "seff_dt2", ""));
	}
