...
*@FileName : BbCntrListVO.java
*@FileTitle : BbCntrListVO
*Open Issues :
*Change history :
...
public class BbCntrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BbCntrListVO> models = new ArrayList<BbCntrListVO>();
	 ...
	 * @return BbCntrListVO[]
	 */
	public BbCntrListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BbCntrListVO[]
	 */
	public BbCntrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BbCntrListVO model = null;
	...
	public BbCntrListVO[] getBbCntrListVOs(){
		BbCntrListVO[] vos = (BbCntrListVO[])models.toArray(new BbCntrListVO[models.size()]);
		return vos;
	}
