...
public class Eur24ManifestDownloadDBDAOSearchBlInfoOBRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        ||','||  CASE WHEN DR_YN1 = 'Y' THEN 'Y' ELSE 'N' END " ).append("\n"); 
		...
		query.append("              , DECODE(NVL(OPUSADM.BKG_GET_TOKEN_FNC(CM_DATA,6),0),0,'N','Y') AS CM_HTS" ).append("\n"); 
		query.append("         " ).append("\n"); 
		...
		query.append(", TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC(COM_ConstantMgr_PKG.COM_getHeadOfficeCode_FNC(), CRE_DT, SND_USR_OFC_CD ), 'YYYY-MM-DD HH24:MI') AS LOCAL_TIME" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
