...
*@FileName : CndCustomsTransmissionDBDAOsearchBlForCrrBatNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndCustomsTransmissionDBDAOsearchBlForCrrBatNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndCustomsTransmissionDBDAOsearchBlForCrrBatNoRSQL(){
		setQuery();
		...
		query.append("FileName : CndCustomsTransmissionDBDAOsearchBlForCrrBatNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
