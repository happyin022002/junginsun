...
*@FileName : RFADurationProposalDBDAOPriRpScpDurHisVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFADurationProposalDBDAOPriRpScpDurHisVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * scope amend history search
	  * </pre>
	  */
	public RFADurationProposalDBDAOPriRpScpDurHisVORSQL(){
		setQuery();
		...
		query.append("FileName : RFADurationProposalDBDAOPriRpScpDurHisVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND  NOT EXISTS ( SELECT 'X' FROM PRI_RP_SCP_DUR B" ).append("\n"); 
		query.append("WHERE" ).append("\n"); 
		...
		query.append("AND 1 = (SELECT 1 FROM PRI_RP_SCP_DUR" ).append("\n"); 
