...
public class RocsSearchBlInfoVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String preFullname = null;

    /* Column Info */
    private String postFullname = null;
    ...
    public RocsSearchBlInfoVO(String ibflag, String pagerows, String headCd, String vvd, String flag, String wgt, String wgtU, String frtOpt, String blNo, String mrnNo, String t1Ind, String scac, String lloydCd, String vslFullname, String vslCntCd, String pod, String podFullname, String berthCd, String berthDesc, String podEta, String pol, String polAtd, String pre, String post, String por, String delCd, String ssRefNo, String senderId, String sender, String senderCd, String carrierId, String carrier, String shprEori, String shprName, String shprAddrStr, String shprAddrCity, String shprAddrPlc, String shprAddrCntry, String shprAddr, String cneeEori, String cneeName, String cneeAddrStr, String cneeAddrCity, String cneeAddrPlc, String cneeAddrCntry, String cneeAddr, String ntfyEori, String ntfyName, String ntfyAddrStr, String ntfyAddrCity, String ntfyAddrPlc, String ntfyAddrCntry, String ntfyAddr, String vslCallRefNo, String bkgNo, String polFullname, String preFullname, String postFullname, String cmPkgDesc, String custToOrdFlg) {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("berth_desc", getBerthDesc());
        ...
        this.hashColumns.put("pre_fullname", getPreFullname());
        this.hashColumns.put("post_fullname", getPostFullname());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("berth_desc", "berthDesc");
        ...
        this.hashFields.put("pre_fullname", "preFullname");
        this.hashFields.put("post_fullname", "postFullname");
    ...
    public void setPreFullname(String preFullname) {
        this.preFullname = preFullname;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setBerthDesc(JSPUtil.getParameter(request, prefix + "berth_desc", ""));
        ...
        setPreFullname(JSPUtil.getParameter(request, prefix + "pre_fullname", ""));
        setPostFullname(JSPUtil.getParameter(request, prefix + "post_fullname", ""));
    ...
    public RocsSearchBlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] berthDesc = (JSPUtil.getParameter(request, prefix + "berth_desc", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (berthDesc[i] != null)
                    model.setBerthDesc(berthDesc[i]);
                if (shprName[i] != null)
	...
	*/
    public void unDataFormat() {
        ...
        this.berthDesc = this.berthDesc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.preFullname = this.preFullname.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.postFullname = this.postFullname.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
