...
*@FileName : RsltPriSpBlplCtntInqVO.java
*@FileTitle : RsltPriSpBlplCtntInqVO
*Open Issues :
*Change history :
...
public class RsltPriSpBlplCtntInqVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpBlplCtntInqVO> models = new ArrayList<RsltPriSpBlplCtntInqVO>();
	...
	public RsltPriSpBlplCtntInqVO() {}

	public RsltPriSpBlplCtntInqVO(String ibflag, String pagerows, String propNo, String amdtSeq, String blplSeq, String blplCtntSeq, String blplCtnt, String n1stCmncAmdtSeq, String effDt, String expDt, String dpSeq, String srcInfoCd, String srcInfoDtl, String prcProgStsCd, String prcProgStsDtl, String acptUsrId, String acptOfcCd, String acptDt, String acptUsrNm) {
		this.dpSeq = dpSeq;
		this.acptDt = acptDt;
	 ...
	 * @param request
	 * @return RsltPriSpBlplCtntInqVO[]
	 */
	public RsltPriSpBlplCtntInqVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSpBlplCtntInqVO[]
	 */
	public RsltPriSpBlplCtntInqVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpBlplCtntInqVO model = null;
		...
		try {
			...
			String[] blplCtntSeq = (JSPUtil.getParameter(request, prefix	+ "blpl_ctnt_seq", length));
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSpBlplCtntInqVO();
				if (dpSeq[i] != null)
		...
		return getRsltPriSpBlplCtntInqVOs();
	}
	 ...
	 * @return RsltPriSpBlplCtntInqVO[]
	 */
	public RsltPriSpBlplCtntInqVO[] getRsltPriSpBlplCtntInqVOs(){
		RsltPriSpBlplCtntInqVO[] vos = (RsltPriSpBlplCtntInqVO[])models.toArray(new RsltPriSpBlplCtntInqVO[models.size()]);
		return vos;
	}
