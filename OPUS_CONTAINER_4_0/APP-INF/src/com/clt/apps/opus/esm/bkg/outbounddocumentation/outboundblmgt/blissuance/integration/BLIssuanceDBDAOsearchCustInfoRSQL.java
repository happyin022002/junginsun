...
public class BLIssuanceDBDAOsearchCustInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BLIssuanceDBDAOsearchCustInfoRSQL.Query
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("	DECODE(BKG_CUST_TP_CD, 'S', 'SHPR', 'FWDR') as CUST_TP, " ).append("\n"); 
		query.append("	CUST_CNT_CD||DECODE(LPAD(CUST_SEQ, 6, 0), '000000', '', LPAD(CUST_SEQ, 6, 0)) as CUST_CD, " ).append("\n"); 
