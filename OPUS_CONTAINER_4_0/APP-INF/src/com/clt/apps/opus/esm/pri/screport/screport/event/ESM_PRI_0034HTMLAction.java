...
*@FileName : ESM_PRI_0034HTMLAction.java
*@FileTitle : Contract Note pop-up
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class ESM_PRI_0034HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0121HTMLAction 객체를 생성
	 */
	public ESM_PRI_0034HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmPri0034Event event = new EsmPri0034Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchNoteCtntVO((RsltSearchNoteCtntVO)getVO(request, RsltSearchNoteCtntVO.class));
		} 
