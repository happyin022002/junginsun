...
public class WeeklyCMDBDAOMultiWeeklyTargetVVD1USQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("         SELECT null LST_LODG_PORT_ETD_DT, MIN(PF_ETD_DT) N1ST_LODG_PORT_ETD_DT" ).append("\n"); 
		query.append("         FROM VSK_VSL_PORT_SKD" ).append("\n"); 
		query.append("         WHERE VSL_CD      = @[vsl_cd]" ).append("\n"); 
		query.append("           AND SKD_VOY_NO  = @[skd_voy_no]" ).append("\n"); 
		query.append("           AND SKD_DIR_CD  = @[skd_dir_cd]" ).append("\n"); 
		query.append("         UNION ALL" ).append("\n"); 
		query.append("         SELECT PF_ETD_DT LST_LODG_PORT_ETD_DT, null N1ST_LODG_PORT_ETD_DT" ).append("\n"); 
		query.append("         FROM VSK_VSL_PORT_SKD" ).append("\n"); 
		query.append("         WHERE VSL_CD      = @[vsl_cd]" ).append("\n"); 
		query.append("           AND SKD_VOY_NO  = @[skd_voy_no]" ).append("\n"); 
		query.append("           AND SKD_DIR_CD  = @[skd_dir_cd]" ).append("\n"); 
