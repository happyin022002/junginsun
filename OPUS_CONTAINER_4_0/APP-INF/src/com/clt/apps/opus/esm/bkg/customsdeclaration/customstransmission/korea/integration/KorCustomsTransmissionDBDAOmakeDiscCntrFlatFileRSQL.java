...
*@FileName : KorCustomsTransmissionDBDAOmakeDiscCntrFlatFileRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeDiscCntrFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeDiscCntrFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeDiscCntrFlatFileRSQL").append("\n");
		query.append("*/").append("\n");
	}
