...
public class BlIssInfoVO extends AbstractValueObject {
	...
	/* Column Info */
	private String inetCtrlPtyCustNm = null;
	/* Column Info */
	...
	private String blMvTpPrnFlg = null;
	private String rcvDeTermPrnFlg = null;
	/* Column Info */
	private String rqstBlTpCd = null;
	/* Column Info */
	private String issSaveFlg = null;
	...
	public BlIssInfoVO(String ibflag, String pagerows, String oblIssRmk, String vesselDirection, String blProofbyshipperDate, String oblPrnFlg, String blackCustomerFlag, String trdPpdOffice, String trdCctBy, String docProcSeq, String issuedEnable, String tpbIndicator, String cctConfirm, String fFwdAddress, String updUsrId, String trdCctRcvDt, String trdCctConfirm, String doIssueAt, String finalDest, String oBlreceiveType, String blReadyOffice, String doIssueBy, String cctDate, String trdCctRcv, String bkgNo, String tpbStatus, String trdCctRcvUserId, String oBlreceiveAt, String cctRcvUserOffice, String delName, String blReadyBy, String preCarriageBy, String ppdOffice, String cctBy, String bkgSts, String trdPpdDate, String fFwdName, String trdPpdRcvUserId, String polCode, String blProofbyshipperBy, String doIssueNo, String bdr, String trdPpdRcv, String flgRate, String onBoardType, String blProofbyshipperOffice, String doIssueDate, String ppdRcvDt, String docProcModyflg, String flgToOrder, String blIssueDate, String oBlreceiveNo, String porCode, String blReadyType, String ppdDate, String trdCctOffice, String blIssueNo, String moveType, String oBlreceiveDate, String buttontype, String blIssueblType, String trdPpdConfirm, String shprAddress, String surrender, String trdCctDate, String blIssueAt, String polEtdDt, String cgoRcvDt, String blNo, String cctRcvUserId, String ppdRcvUserId, String cctOffice, String blIssueRelease, String custToOrdFlg, String blProofbyshipperCheckbox, String onBoardDate, String printOption, String blReadyCheckbox, String issued, String tvvd, String delCode, String trdCctRcvUserOffice, String ppdRcvUserOffice, String cctRcvDt, String blIssueBy, String docProcType, String blReadyDate, String ppdBy, String shprName, String trdPpdRcvDt, String internetAuth, String trdPpdRcvUserOffice, String released, String ppdConfirm, String podName, String docRequestFlag, String polName, String cntcPsonEml, String authFlag, String porName, String updOffice, String oBlreceiveBy, String cctRcv, String flgDo, String podCode, String flgMd, String flgPpd, String trdPpdBy, String ppdRcv, String trdFlgPpd, String inetCtrlPtyCustNm, String inetCtrlPtyNo, String inetCtrlPtyNm, String wblPrnFlg, String blCpyNo, String blIssTpCd, String blMvTpPrnFlg, String rcvDeTermPrnFlg , String rqstBlTpCd, String issSaveFlg) {
		...
		this.inetCtrlPtyCustNm = inetCtrlPtyCustNm;
		this.wblPrnFlg = wblPrnFlg;
		this.blCpyNo = blCpyNo;
		this.blIssTpCd = blIssTpCd;
		this.blMvTpPrnFlg = blMvTpPrnFlg;
		this.rcvDeTermPrnFlg = rcvDeTermPrnFlg;
		this.rqstBlTpCd = rqstBlTpCd;
		this.issSaveFlg = issSaveFlg;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inet_ctrl_pty_cust_nm", getInetCtrlPtyCustNm());
		...
		this.hashColumns.put("bl_mv_tp_prn_flg",  getBlMvTpPrnFlg());
		this.hashColumns.put("rcv_de_term_prn_flg",  getRcvDeTermPrnFlg());
		this.hashColumns.put("rqst_bl_tp_cd",  getRqstBlTpCd());
		this.hashColumns.put("iss_save_flg",  getIssSaveFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inet_ctrl_pty_cust_nm", "inetCtrlPtyCustNm");
		...
		this.hashFields.put("bl_mv_tp_prn_flg", "blMvTpPrnFlg");
		this.hashFields.put("rcv_de_term_prn_flg", "rcvDeTermPrnFlg");
		this.hashFields.put("rqst_bl_tp_cd", "rqstBlTpCd");
		this.hashFields.put("iss_save_flg", "issSaveFlg");
	...
	public String getInetCtrlPtyNo() {
		return this.inetCtrlPtyNo;
	}
	
	/**
	 * @return the inetCtrlPtyCustNm
	 */
	public String getInetCtrlPtyCustNm() {
		return this.inetCtrlPtyCustNm;
	}
	...
	public String getInetCtrlPtyNm() {
		return this.inetCtrlPtyNm;
	}
	
	/**
	 * @return the trdFlgPpd
	 */
	...
	/**
	 * @return the issSaveFlg
	 */
	public String getIssSaveFlg() {
		return issSaveFlg;
	}
	...
	/**
	 * @param inetCtrlPtyCustNm
	 */
	public void setInetCtrlPtyCustNm(String inetCtrlPtyCustNm) {
		this.inetCtrlPtyCustNm = inetCtrlPtyCustNm;
	}
	...
	/**
	 * @param trdFlgPpd the trdFlgPpd to set
	 */
	 ...
	 * @param issSaveFlg
	 */
	public void setIssSaveFlg(String issSaveFlg) {
		this.issSaveFlg = issSaveFlg;
	}

	/**
	 * @return the blMvTpPrnFlg
	 */
	public String getBlMvTpPrnFlg() {
		return blMvTpPrnFlg;
	}

	/**
	 * @param blMvTpPrnFlg the blMvTpPrnFlg to set
	 */
	public void setBlMvTpPrnFlg(String blMvTpPrnFlg) {
		this.blMvTpPrnFlg = blMvTpPrnFlg;
	}
	...
	/**
	 * @return the rcvDeTermPrnFlg
	 */
	public String getRcvDeTermPrnFlg() {
		return rcvDeTermPrnFlg;
	}

	/**
	 * @param rcvDeTermPrnFlg the rcvDeTermPrnFlg to set
	 */
	public void setRcvDeTermPrnFlg(String rcvDeTermPrnFlg) {
		this.rcvDeTermPrnFlg = rcvDeTermPrnFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInetCtrlPtyCustNm(JSPUtil.getParameter(request, "inet_ctrl_pty_cust_nm", ""));
		...
		setBlMvTpPrnFlg(JSPUtil.getParameter(request, "bl_mv_tp_prn_flg", ""));
		setRcvDeTermPrnFlg(JSPUtil.getParameter(request, "rcv_de_term_prn_flg", ""));
		setRqstBlTpCd(JSPUtil.getParameter(request, "rqst_bl_tp_cd", ""));
		setIssSaveFlg(JSPUtil.getParameter(request, "iss_save_flg", ""));
	}
	...
	public BlIssInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] inetCtrlPtyCustNm = (JSPUtil.getParameter(request, prefix	+ "inet_ctrl_pty_cust_nm", length));
			...
			String[] blMvTpPrnFlg = (JSPUtil.getParameter(request, prefix + "bl_mv_tp_prn_flg", length));
			String[] rcvDeTermPrnFlg = (JSPUtil.getParameter(request, prefix + "rcv_de_term_prn_flg", length));
			String[] rqstBlTpCd = (JSPUtil.getParameter(request, prefix + "rqst_bl_tp_cd", length));
			String[] issSaveFlg = (JSPUtil.getParameter(request, prefix + "iss_save_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (inetCtrlPtyCustNm[i] != null)
					model.setInetCtrlPtyCustNm(inetCtrlPtyCustNm[i]);
				if (wblPrnFlg[i] != null)
				...
				if (blMvTpPrnFlg[i] != null)
					model.setBlMvTpPrnFlg(blMvTpPrnFlg[i]);
				if (rcvDeTermPrnFlg[i] != null)
					model.setRcvDeTermPrnFlg(rcvDeTermPrnFlg[i]);
				if (rqstBlTpCd[i] != null)
					model.setRqstBlTpCd(rqstBlTpCd[i]);
				if (issSaveFlg[i] != null)
					model.setIssSaveFlg(issSaveFlg[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.inetCtrlPtyCustNm = this.inetCtrlPtyCustNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.blMvTpPrnFlg = this.blMvTpPrnFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.rcvDeTermPrnFlg = this.rcvDeTermPrnFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.rqstBlTpCd = this.rqstBlTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.issSaveFlg = this.issSaveFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
