...
*@FileName : SCMQCProposalDBDAOPriSpSubMqcAutoAcceptVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCMQCProposalDBDAOPriSpSubMqcAutoAcceptVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCMQCProposalDBDAOPriSpSubMqcAutoAcceptVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCMQCProposalDBDAOPriSpSubMqcAutoAcceptVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SUB_MQC MQC SET " ).append("\n"); 
