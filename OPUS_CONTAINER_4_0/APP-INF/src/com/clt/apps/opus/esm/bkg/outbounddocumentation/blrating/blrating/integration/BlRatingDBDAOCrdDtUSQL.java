...
*@FileName : BlRatingDBDAOCrdDtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOCrdDtUSQL implements ISQLTemplate{
	...
	public BlRatingDBDAOCrdDtUSQL(){
		...
		query.append("FileName : BlRatingDBDAOCrdDtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET    CGO_RCV_DT= TO_DATE(@[cgo_rcv_dt], 'YYYY-MM-DD')" ).append("\n"); 
