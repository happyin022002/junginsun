...
public class JapanCustomsTransmissionDBDAOsearchDetailInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n");
		query.append("SELECT SUBSTR(EDI_SND_MSG_CTNT, INSTR(EDI_SND_MSG_CTNT, CHR(10), 1, 1)+2)||CHR(10) AS EDI_SND_MSG" ).append("\n");
		...
		query.append("  AND SND_DT = TO_DATE(@[msg_snd_dt], 'YYYYMMDD HH24MISS')" ).append("\n");
