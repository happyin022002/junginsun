...
*@FileName : EsmBsa0026ViewAdapter4.java
*@FileTitle : EsmBsa0026ViewAdapter4
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmBsa0026ViewAdapter4 extends DefaultViewAdapter {
	
    public EsmBsa0026ViewAdapter4(){
    	super();
    }
