...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteMigHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteMigHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Insert PRI_SP_SCP_NOTE_MIG_HIS about NOTE_CLSS_CD = 'D'
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteMigHisCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteMigHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
