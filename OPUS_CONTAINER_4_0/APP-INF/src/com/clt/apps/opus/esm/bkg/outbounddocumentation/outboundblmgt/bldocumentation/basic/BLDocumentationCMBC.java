...
public interface BLDocumentationCMBC {
     ...
     * @exception   EventException
     */
    public void modifyBlActWgt(BkgBlNoVO bkgBlNoVO, String actWgt, String wgtUtCd, SignOnUserAccount account, String vslUpdate) throws EventException;
    ...
    /**
     * multi split占쎌뮇肉�sourceBkg占쎈Ŋ苑�bkg_cntr, bkg_cntr_seal_no�쒙옙占쎌럩堉깍옙占퐐argetBkg占쏙옙insert占쎌뮆��<br>
     * 
     * @param BkgBlNoVO sourceBkg
     * @param BkgBlNoVO[] targetBkg
