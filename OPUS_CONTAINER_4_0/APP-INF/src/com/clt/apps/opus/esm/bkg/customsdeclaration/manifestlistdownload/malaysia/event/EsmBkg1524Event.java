...
*@FileName : EsmBkg1524Event.java
*@FileTitle : EsmBkg1524Event
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
/**
 * esm_bkg_1524 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_BKG_1524HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author
 * @see ESM_BKG_1524HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmBkg1524Event extends EventSupport {
