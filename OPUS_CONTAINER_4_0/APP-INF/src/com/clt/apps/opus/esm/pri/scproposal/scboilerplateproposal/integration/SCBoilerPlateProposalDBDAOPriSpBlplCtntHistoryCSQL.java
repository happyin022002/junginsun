...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCtntHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * insert history PRI_SP_BLPL_CTNT into PRI_SP_BLPL_CTNT_MIG_HIS
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCtntHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
