...
*@FileName : RocsManifestListDwonloadDBDAOremoveCrnUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestListDwonloadDBDAOremoveCrnUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestListDwonloadDBDAOremoveCrnUSQL(){
		setQuery();
		...
		query.append("FileName : RocsManifestListDwonloadDBDAOremoveCrnUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET VSL_CALL_REF_STS_CD = 'C'," ).append("\n"); 
