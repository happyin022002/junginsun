...
*@FileName : SearchBlListByCntrNoVO.java
*@FileTitle : SearchBlListByCntrNoVO
*Open Issues :
*Change history :
...
public class SearchBlListByCntrNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBlListByCntrNoVO> models = new ArrayList<SearchBlListByCntrNoVO>();
	 ...
	 * @param request
	 * @return SearchBlListByCntrNoVO[]
	 */
	public SearchBlListByCntrNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBlListByCntrNoVO[]
	 */
	public SearchBlListByCntrNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBlListByCntrNoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBlListByCntrNoVO();
				if (corrRmk[i] != null)
		...
		return getSearchBlListByCntrNoVOs();
	}
	 ...
	 * @return SearchBlListByCntrNoVO[]
	 */
	public SearchBlListByCntrNoVO[] getSearchBlListByCntrNoVOs(){
		SearchBlListByCntrNoVO[] vos = (SearchBlListByCntrNoVO[])models.toArray(new SearchBlListByCntrNoVO[models.size()]);
		return vos;
	}
