...
*@FileName : BSAManageDBDAOModifyCarrierRegisterJOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifyCarrierRegisterJOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyCarrierRegisterJO UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOModifyCarrierRegisterJOUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifyCarrierRegisterJOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
