...
*@FileName : KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtIfApUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtIfApUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtIfApUSQL(){
		setQuery();
		...
		query.append("FileName : KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtIfApUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
