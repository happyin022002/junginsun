...
*@FileName : CommonDBDAOSearchSaqMonthlyQuotaStepVersionListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqMonthlyQuotaStepVersionListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchSaqMonthlyQuotaStepVersionListRSQL(){
		setQuery();
		...
		params.put("searchFlag",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CommonDBDAOSearchSaqMonthlyQuotaStepVersionListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MQTA_VER_NO||':'||GLINE_VER_NO AS CODE,                    " ).append("\n"); 
		query.append("       SUBSTR(MQTA_VER_NO, 1, LENGTH(MQTA_VER_NO)-2)              " ).append("\n"); 
		query.append("           ||'-'||SUBSTR(MQTA_VER_NO, LENGTH(MQTA_VER_NO)-1)      " ).append("\n"); 
		...
		query.append("AND   ('ALL' = @[searchFlag] OR SAQ_STS_CD IN ('FN', 'QN', 'QF'))             " ).append("\n"); 
		query.append("ORDER BY MQTA_VER_NO DESC  	" ).append("\n"); 
