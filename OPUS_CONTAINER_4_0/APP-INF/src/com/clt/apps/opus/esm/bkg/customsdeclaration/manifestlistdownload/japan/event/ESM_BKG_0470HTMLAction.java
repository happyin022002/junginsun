...
public class ESM_BKG_0470HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.MULTI) || command.isCommand(FormCommand.MULTI01)) {
			event.setJapanVesselArrivalVO((JapanVesselArrivalVO)getVO(request, JapanVesselArrivalVO.class));
		}
