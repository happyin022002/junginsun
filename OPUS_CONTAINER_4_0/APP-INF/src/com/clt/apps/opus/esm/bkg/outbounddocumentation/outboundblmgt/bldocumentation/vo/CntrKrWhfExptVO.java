...
*@FileName : CntrKrWhfExptVO.java
*@FileTitle : CntrKrWhfExptVO
*Open Issues :
*Change history :
...
public class CntrKrWhfExptVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntrKrWhfExptVO> models = new ArrayList<CntrKrWhfExptVO>();
	...
	public CntrKrWhfExptVO() {}

	public CntrKrWhfExptVO(String ibflag, String pagerows, String bkgNo, String cntrNo, String cntrWfgExptFlg, String updUsrId) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
		this.cntrNo = cntrNo;
	 ...
	 */
	public CntrKrWhfExptVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntrKrWhfExptVO[]
	 */
	public CntrKrWhfExptVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntrKrWhfExptVO model = null;
	...
	public CntrKrWhfExptVO[] getCntrKrWhfExptVOs(){
		CntrKrWhfExptVO[] vos = (CntrKrWhfExptVO[])models.toArray(new CntrKrWhfExptVO[models.size()]);
		return vos;
	}
