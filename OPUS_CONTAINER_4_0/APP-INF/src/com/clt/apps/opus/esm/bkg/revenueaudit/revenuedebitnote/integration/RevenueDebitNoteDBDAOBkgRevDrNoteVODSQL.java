...
*@FileName : RevenueDebitNoteDBDAOBkgRevDrNoteVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RevenueDebitNoteDBDAOBkgRevDrNoteVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOBkgRevDrNoteVODSQL(){
		setQuery();
		...
		query.append("FileName : RevenueDebitNoteDBDAOBkgRevDrNoteVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_REV_DR_NOTE" ).append("\n"); 
