...
public class EsmBkg0110Event extends EventSupport {
	...
	public void setCaPerformanceReportInVOS(CaPerformanceReportInVO[] caPerformanceReportInVOs){
		if(caPerformanceReportInVOs != null){
			CaPerformanceReportInVO[] tmpVOs = Arrays.copyOf(caPerformanceReportInVOs, caPerformanceReportInVOs.length);
			this.caPerformanceReportInVOs = tmpVOs;
		}
	}
	...
	public CaPerformanceReportInVO[] getCaPerformanceReportInVOS(){
		CaPerformanceReportInVO[] rtnVOs = null;
		if(this.caPerformanceReportInVOs != null){
			rtnVOs= Arrays.copyOf(caPerformanceReportInVOs, caPerformanceReportInVOs.length);
		}
		return rtnVOs;
	}
