...
*@FileName : UsaManifestListDownloadDBDAOaddImportRuleSetupCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaManifestListDownloadDBDAOaddImportRuleSetupCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaManifestListDownloadDBDAOaddImportRuleSetupCSQL(){
		setQuery();
		...
		query.append("FileName : UsaManifestListDownloadDBDAOaddImportRuleSetupCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	DECODE(NVL(@[xpt_imp_ref_flg7],'N'), '1', 'Y', 'N')," ).append("\n"); 
