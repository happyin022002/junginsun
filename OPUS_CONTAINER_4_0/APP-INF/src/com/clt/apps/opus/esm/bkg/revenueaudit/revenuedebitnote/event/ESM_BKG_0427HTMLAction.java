...
public class ESM_BKG_0427HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0427HTMLAction 객체를 생성
	 */
	public ESM_BKG_0427HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0427Event event = new EsmBkg0427Event();
		
		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltBkgRevDrNotesStatusVO((RsltBkgRevDrNotesStatusVO) getVO(request,	RsltBkgRevDrNotesStatusVO.class));
		} 
