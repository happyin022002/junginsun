...
*@FileName : FFCmpnAuditDBDAOModifyFFCmpnAuditBkgInfoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCmpnAuditDBDAOModifyFFCmpnAuditBkgInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyFFCmpnAuditBkgInfo
	  * </pre>
	  */
	public FFCmpnAuditDBDAOModifyFFCmpnAuditBkgInfoUSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnAuditDBDAOModifyFFCmpnAuditBkgInfoUSQL").append("\n");
		query.append("*/").append("\n");
	}
