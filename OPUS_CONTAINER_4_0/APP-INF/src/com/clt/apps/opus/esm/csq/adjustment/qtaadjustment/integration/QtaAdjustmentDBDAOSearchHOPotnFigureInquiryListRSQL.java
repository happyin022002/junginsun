...
public class QtaAdjustmentDBDAOSearchHOPotnFigureInquiryListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Portion Adjutment by HO 화면내 Figure Inquiry 팝업을 조회한다.
	...
	public void setQuery(){
		...
		query.append("SELECT DISTINCT T.BSE_YR" ).append("\n"); 
		...
		query.append("      ,T.CSQ_CNG_TP_CD" ).append("\n"); 
		query.append("      ,@[f_gubun] AS GUBUN" ).append("\n"); 
		...
		query.append("       )T, CSQ_CFM_QTA Q" ).append("\n"); 
		...
		query.append("  AND Q.CSQ_CNG_TP_CD   = 'I'" ).append("\n"); 
		query.append("" ).append("\n"); 
