...
*@FileName : RFANoteProposalDBDAORsltNoteInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteProposalDBDAORsltNoteInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFANoteProposalDBDAORsltNoteInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFANoteProposalDBDAORsltNoteInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND EXISTS ( SELECT 'X' FROM PRI_RP_SCP_NOTE_CTNT" ).append("\n"); 
