...
public class AusCustomsTransmissionDBDAOsearchBlMarkDescRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT	REPLACE(REGEXP_REPLACE(REPLACE(DOC.PCK_CMDT_DESC,CHR(10),'$$$$$'),'[^ a-zA-Z0-9~!@#$%^&*()-_+={}|:;,<.>/]',' ', 1, 0, 'im'),'$$$$$',CHR(10))||CHR(10)||" ).append("\n");
		query.append("        REPLACE(REGEXP_REPLACE(REPLACE(DOC.CNTR_CMDT_DESC,CHR(10),'$$$$$'),'[^ a-zA-Z0-9~!@#$%^&*()-_+={}|:;,<.>/]',' ', 1, 0, 'im'),'$$$$$',CHR(10))||CHR(10)||" ).append("\n");
		query.append("        REPLACE(REGEXP_REPLACE(REPLACE(BMD.CMDT_DESC,CHR(10),'$$$$$'),'[^ a-zA-Z0-9~!@#$%^&*()-_+={}|:;,<.>/]',' ', 1, 0, 'im'),'$$$$$',CHR(10)) CMDT_DESC," ).append("\n");
		query.append("        REPLACE(REGEXP_REPLACE(REPLACE(BMD.MK_DESC,CHR(10),'$$$$$'),'[^ a-zA-Z0-9~!@#$%^&*()-_+={}|:;,<.>/]',' ', 1, 0, 'im'),'$$$$$',CHR(10)) MK_DESC" ).append("\n");
