...
*@FileName       : EsmSaq0049ViewAdapter.java
 ...
 */
	...
	public class EsmSaq0049ViewAdapter extends ViewAdapter {

		public EsmSaq0049ViewAdapter() {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		List<SearchMonthlyQuotaInquiry0049Tab01VO> volist = null;
		int realCnt = 0;
		ReturnVO returnVO = (ReturnVO)vos.get(0);		
		if (returnVO !=null) {
		    volist = (List<SearchMonthlyQuotaInquiry0049Tab01VO>)returnVO.getList(0);
...
//		String fontColor = "";
		...
		if( formcommand.isCommand(FormCommand.SEARCHLIST01)){	//2.1
