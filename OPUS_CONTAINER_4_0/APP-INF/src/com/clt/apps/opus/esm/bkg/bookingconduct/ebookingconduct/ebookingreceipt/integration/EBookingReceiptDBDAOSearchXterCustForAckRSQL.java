...
public class EBookingReceiptDBDAOSearchXterCustForAckRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       'IBCS_NM:'       || BKG_TOKEN_NL_FNC(cust_nm, 1, '')      ||CHR(10)||" ).append("\n"); 
		query.append("       'IBCS_NM1:'      || BKG_TOKEN_NL_FNC(cust_nm, 2, '')      ||CHR(10)||" ).append("\n"); 
		query.append("       'IBCS_ADDR:'     || BKG_TOKEN_NL_FNC(CUST_ADDR, 1, '')    ||CHR(10)||" ).append("\n"); 
		query.append("       'IBCS_ADDR1:'    || BKG_TOKEN_NL_FNC(CUST_ADDR, 2, '')    ||CHR(10)||" ).append("\n"); 
		query.append("       'IBCS_ADDR2:'    || BKG_TOKEN_NL_FNC(CUST_ADDR, 3, '')    ||CHR(10)||" ).append("\n"); 
		query.append("       'IBCS_ADDR3:'    || BKG_TOKEN_NL_FNC(CUST_ADDR, 4, '')    ||CHR(10)||" ).append("\n"); 
		query.append("       'IBCS_ADDR4:'    || BKG_TOKEN_NL_FNC(CUST_ADDR, 5, '')    ||CHR(10)||" ).append("\n"); 
