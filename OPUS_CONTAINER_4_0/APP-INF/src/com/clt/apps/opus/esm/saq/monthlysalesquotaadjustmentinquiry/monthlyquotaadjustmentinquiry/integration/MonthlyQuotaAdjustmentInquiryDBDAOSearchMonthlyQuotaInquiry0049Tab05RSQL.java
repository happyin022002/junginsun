...
*@FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab05RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab05RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Lane/Area Direcotr/C. Office - Weekly
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab05RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab05RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		 	  SMR.BSE_YR," ).append("\n"); 
		query.append("		 	  SMR.BSE_WK," ).append("\n"); 
		query.append("		 	  --LOD, (GROUP BY 에러 나서 삭제함)" ).append("\n"); 
		...
		query.append("		                                 MIN(SMR.BSE_YR||SMR.BSE_WK||SMR.SUB_TRD_CD||DECODE(SMR.RLANE_CD,'RBCCO','ZZ',SUBSTR(SMR.RLANE_CD,-2))||SMR.RLANE_CD||SMR.VVD_GRP_CD||VVD_CD||SMR.RHQ_CD||SMR.AQ_CD||SMR.OFC_CD) AS KEY," ).append("\n"); 
		query.append("		                                 SMR.SUB_TRD_CD," ).append("\n"); 
		query.append("		                                 SMR.RLANE_CD," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("		                                        GROUP BY SMR.SUB_TRD_CD,SMR.RLANE_CD,VVD.VVD_GRP_CD, SMR.RHQ_CD, NVL(SMR.AQ_CD, '  '), SMR.RGN_OFC_CD, SMR.BSE_YR,VVD.BSE_WK,VVD.VSL_CD || VVD.SKD_VOY_NO || VVD.SKD_DIR_CD " ).append("\n"); 
