...
*@FileName : AusCustomsTransmissionDBDAOsearchBlChargeTotalRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOsearchBlChargeTotalRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOsearchBlChargeTotalRSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOsearchBlChargeTotalRSQL").append("\n");
		query.append("*/").append("\n");
	}
