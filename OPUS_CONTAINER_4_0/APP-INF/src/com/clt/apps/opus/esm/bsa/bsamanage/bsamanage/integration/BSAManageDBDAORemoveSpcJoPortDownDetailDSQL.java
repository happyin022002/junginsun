...
*@FileName : BSAManageDBDAORemoveSpcJoPortDownDetailDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveSpcJoPortDownDetailDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveSpcJoPortDownDetail DELETE
	  * </pre>
	  */
	public BSAManageDBDAORemoveSpcJoPortDownDetailDSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveSpcJoPortDownDetailDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
