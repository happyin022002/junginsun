...
*@FileName : TCharterIOInvoiceDAORemoveOffhireInvDtlsDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAORemoveOffhireInvDtlsDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOInvoiceDAORemoveOffhireInvDtlsDSQL
	  * </pre>
	  */
	public TCharterIOInvoiceDAORemoveOffhireInvDtlsDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : TCharterIOInvoiceDAORemoveOffhireInvDtlsDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}