...
*@FileName : RFAGroupCommodityProposalDBDAORsltGrpCmdtListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityProposalDBDAORsltGrpCmdtListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAGroupCommodityProposalDBDAORsltGrpCmdtListVORSQL
	  * </pre>
	  */
	public RFAGroupCommodityProposalDBDAORsltGrpCmdtListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityProposalDBDAORsltGrpCmdtListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,(SELECT PRC_GRP_CMDT_DESC FROM PRI_RP_SCP_GRP_CMDT SUB" ).append("\n"); 
