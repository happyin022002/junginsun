...
public class CLLCDLManifestLoadSumByPodDetailVO extends AbstractValueObject {
	...
	public CLLCDLManifestLoadSumByPodDetailVO(String ibflag, String pagerows, String podCd, String lo40h, String lo40, String lo20, String lo45, String ts40h, String ts40, String ts20, String ts45, String mt40h, String mt40, String mt20, String mt45, String to40h, String to40, String to20, String to45, String wgtMt) {
		this.mt45 = mt45;
		this.mt40h = mt40h;
		this.ts45 = ts45;
		this.wgtMt = wgtMt;
	...
	public void fromRequest(HttpServletRequest request) {
		setMt45(JSPUtil.getParameter(request, "mt_45", ""));
		setMt40h(JSPUtil.getParameter(request, "mt_40h", ""));
		setTs45(JSPUtil.getParameter(request, "ts_45", ""));
		setWgtMt(JSPUtil.getParameter(request, "wgt_mt", ""));
		setTo40(JSPUtil.getParameter(request, "to_40", ""));
		setTs20(JSPUtil.getParameter(request, "ts_20", ""));
		setMt20(JSPUtil.getParameter(request, "mt_20", ""));
		setMt40(JSPUtil.getParameter(request, "mt_40", ""));
		setTo45(JSPUtil.getParameter(request, "to_45", ""));
		setLo40(JSPUtil.getParameter(request, "lo_40", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setTo20(JSPUtil.getParameter(request, "to_20", ""));
		setPodCd(JSPUtil.getParameter(request, "pod_cd", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setLo45(JSPUtil.getParameter(request, "lo_45", ""));
		setLo20(JSPUtil.getParameter(request, "lo_20", ""));
		setTs40h(JSPUtil.getParameter(request, "ts_40h", ""));
		setTo40h(JSPUtil.getParameter(request, "to_40h", ""));
		setLo40h(JSPUtil.getParameter(request, "lo_40h", ""));
