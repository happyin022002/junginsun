...
*@FileName : ESM_BKG_0658HTMLAction.java
...
public class ESM_BKG_0658HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0658HTMLAction 객체를 생성
	 */
	public ESM_BKG_0658HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0658Event event = new EsmBkg0658Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setStopOffLocCd(request.getParameter("stop_off_loc_cd"));
		}
