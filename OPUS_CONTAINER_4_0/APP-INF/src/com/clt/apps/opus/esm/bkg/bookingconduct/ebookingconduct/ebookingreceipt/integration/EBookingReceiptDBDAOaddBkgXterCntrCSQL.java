...
*@FileName : EBookingReceiptDBDAOaddBkgXterCntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterCntrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterCntrCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterCntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
