...
*@FileName : CustomsCommonMgtDBDAOsearchCstmtsCdConvSeqCtntListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomsCommonMgtDBDAOsearchCstmtsCdConvSeqCtntListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomsCommonMgtDBDAOsearchCstmtsCdConvSeqCtntListRSQL(){
		setQuery();
		...
		query.append("FileName : CustomsCommonMgtDBDAOsearchCstmtsCdConvSeqCtntListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND CNT_CD=@[chk_cnt_cd]" ).append("\n"); 
