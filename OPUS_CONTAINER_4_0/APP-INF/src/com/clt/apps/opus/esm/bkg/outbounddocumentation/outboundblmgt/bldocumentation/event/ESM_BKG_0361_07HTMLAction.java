...
*@FileName : ESM_BKG_0361_07HTMLAction.java
...
public class ESM_BKG_0361_07HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0361_07HTMLAction 객체를 생성
	 */
	public ESM_BKG_0361_07HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        log.debug("##### CALL:ESM_BKG_0361_07HTMLAction - " + command.getCommand());

        if(command.isCommand(FormCommand.DEFAULT)) {
            log.debug("##### CALL:ESM_BKG_0361_07HTMLAction ----- DEFAULT ");
			// search MnD
            ...
            String goCntNm       = JSPUtil.getParameter(request, "go_cnt_nm");
            ...
            event.setGoCntNm(goCntNm);
            event.setCntCd(goCntCd);
            ...
            log.debug("##### CALL:ESM_BKG_0361_07HTMLAction ----- SEARCH ");
			// search MnD
        	String bkgNo      = JSPUtil.getParameter(request, "bkg_no");
            String ioBndCd     = JSPUtil.getParameter(request, "io_bnd_cd");
            String cntCd       = JSPUtil.getParameter(request, "go_cnt_cd", "MX");	//DEFAULT- MX
            ...
            String pkgTp       = JSPUtil.getParameter(request, "pkg_tp");
            String wgtTp       = JSPUtil.getParameter(request, "wgt_tp");
            String cntCd       = JSPUtil.getParameter(request, "go_cnt_cd", "MX");
