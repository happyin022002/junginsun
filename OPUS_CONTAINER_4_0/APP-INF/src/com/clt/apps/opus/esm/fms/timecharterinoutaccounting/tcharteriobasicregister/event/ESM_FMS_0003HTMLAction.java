...
*@FileName : ESM_FMS_0003HTMLAction.java
...
public class ESM_FMS_0003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0003HTMLAction 객체를 생성
	 */
	public ESM_FMS_0003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0003Event event = new EsmFms0003Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomAcctCateVOS((CustomAcctCateVO[])getVOs(request, CustomAcctCateVO .class,""));
		}
