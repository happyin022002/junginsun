...
*@FileName : PsaManifestMarkInfoVO.java
*@FileTitle : PsaManifestMarkInfoVO
*Open Issues :
*Change history :
...
public class PsaManifestMarkInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsaManifestMarkInfoVO> models = new ArrayList<PsaManifestMarkInfoVO>();
	...
	public PsaManifestMarkInfoVO() {}

	public PsaManifestMarkInfoVO(String ibflag, String pagerows, String mark1, String mark2, String mark3, String mark4, String mark5, String mark6, String mark7, String mark8, String mark9, String mark10) {
		this.mark4 = mark4;
		this.mark3 = mark3;
		this.mark2 = mark2;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return PsaManifestMarkInfoVO[]
	 */
	public PsaManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaManifestMarkInfoVO[]
	 */
	public PsaManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaManifestMarkInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PsaManifestMarkInfoVO();
				if (mark4[i] != null)
		...
		return getPsaManifestMarkInfoVOs();
	}
	 ...
	 * @return PsaManifestMarkInfoVO[]
	 */
	public PsaManifestMarkInfoVO[] getPsaManifestMarkInfoVOs(){
		PsaManifestMarkInfoVO[] vos = (PsaManifestMarkInfoVO[])models.toArray(new PsaManifestMarkInfoVO[models.size()]);
		return vos;
	}
