...
*@FileName : PickUpNoticeDBDAOmodifySendIdByEmailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PickUpNoticeDBDAOmodifySendIdByEmailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PickUpNoticeDBDAOmodifySendIdByEmailUSQL(){
		setQuery();
		...
		query.append("FileName : PickUpNoticeDBDAOmodifySendIdByEmailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	EML_NTC_SND_ID = @[eml_ntc_snd_id]" ).append("\n"); 
