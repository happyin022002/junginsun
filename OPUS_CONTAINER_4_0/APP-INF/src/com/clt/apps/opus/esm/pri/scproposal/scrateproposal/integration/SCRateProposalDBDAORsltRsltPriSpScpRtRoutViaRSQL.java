...
*@FileName : SCRateProposalDBDAORsltRsltPriSpScpRtRoutViaRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRsltPriSpScpRtRoutViaRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SELECT PRI_SP_SCP_RT_ROUT_VIA
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRsltPriSpScpRtRoutViaRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRsltPriSpScpRtRoutViaRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
