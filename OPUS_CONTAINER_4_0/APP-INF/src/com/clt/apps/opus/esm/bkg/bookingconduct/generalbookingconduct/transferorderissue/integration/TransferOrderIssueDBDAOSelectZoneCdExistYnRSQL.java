...
*@FileName : TransferOrderIssueDBDAOSelectZoneCdExistYnRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOSelectZoneCdExistYnRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TransferOrderIssueDBDAOSelectZoneCdExistYnRSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(ZN_CD), 0, 'N', 'Y') EXIST_YN" ).append("\n");
		...
		query.append("FileName : TransferOrderIssueDBDAOSelectZoneCdExistYnRSQL").append("\n");
		query.append("*/").append("\n");
	}
}