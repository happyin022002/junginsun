...
*@FileName : JapanManifestListDownloadDBDAOremoveCstmsJpWhDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOremoveCstmsJpWhDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOremoveCstmsJpWhDSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOremoveCstmsJpWhDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       BKG_CSTMS_JP_WH" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(" WHERE YD_CD = @[org_yd_cd]" ).append("\n"); 
