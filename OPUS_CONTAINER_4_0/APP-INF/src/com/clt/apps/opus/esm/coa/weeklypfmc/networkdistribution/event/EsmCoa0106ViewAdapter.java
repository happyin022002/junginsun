	    ...
	    if(totCnt > 0){
	    	try{
	            ...
	            for(int i=0; i<totCnt; i++){
	            	...
	            	strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("co_sls_amt"))+"</TD>");
	            	...
	            	//SJH.20141104.MOD : ipt_asgn_amt -> slt_inter_amt
	            	strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("slt_inter_amt"))+"</TD>");
	            	strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("co_sales_final"))+"</TD>");
