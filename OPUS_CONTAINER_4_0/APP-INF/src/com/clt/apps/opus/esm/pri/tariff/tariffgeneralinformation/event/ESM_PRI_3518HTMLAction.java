...
*@FileName : ESM_PRI_3518HTMLAction.java
...
public class ESM_PRI_3518HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3518HTMLAction 객체를 생성
	 */
	public ESM_PRI_3518HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3518Event event = new EsmPri3518Event();
		

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.MODIFY01)) {
