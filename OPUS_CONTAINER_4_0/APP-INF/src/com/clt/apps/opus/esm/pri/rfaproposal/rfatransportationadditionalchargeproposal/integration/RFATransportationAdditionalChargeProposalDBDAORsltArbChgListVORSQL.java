...
public class RFATransportationAdditionalChargeProposalDBDAORsltArbChgListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Arbitrary List 조회 - RFA Proposal & Amendment Creation ( ESM_PRI_2003 )
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("     , A.RAT_UT_CD AS PER_TYPE" ).append("\n"); 
		...
		query.append("     ,(SELECT NOTE_DP_SEQ FROM PRI_RP_SCP_TRSP_ADD_CHG" ).append("\n"); 
