...
*@FileName : TAAProposalDBDAOPriTaaTriListVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TAAProposalDBDAOPriTaaTriListVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TAAProposalDBDAOPriTaaTriListVODSQL(){
		setQuery();
		...
		query.append("FileName : TAAProposalDBDAOPriTaaTriListVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TAA_TRI_LIST" ).append("\n"); 
		query.append("WHERE TAA_PROP_NO = @[taa_prop_no]" ).append("\n"); 
		query.append("AND	  AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("AND	  TRI_PROP_NO = @[tri_prop_no]" ).append("\n"); 
