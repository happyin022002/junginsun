...
*@FileName : RFAProposalMainDBDAOPriRpScpAmdtSmryVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriRpScpAmdtSmryVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriRpScpAmdtSmryVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriRpScpAmdtSmryVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTG_CD_ID = 'CD01740'" ).append("\n"); 
