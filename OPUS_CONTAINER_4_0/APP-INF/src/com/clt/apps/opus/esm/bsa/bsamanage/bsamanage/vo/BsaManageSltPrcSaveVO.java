...
public class BsaManageSltPrcSaveVO extends AbstractValueObject {
	...
	/*sheet6 */
	/* Column Info */
	private String vslCapa = null;		//20150514.ADD
	private String exclYn = null;		//20150514.ADD	
...
//	private List<HashMap<String, Object>> D_slt_prc_capa_B = new ArrayList<HashMap<String, Object>>();	
	...
	public BsaManageSltPrcSaveVO(
			...
			String bsaSltPrcFmDt, 	String bsaSltPrcToDt, 	String coBfrSubCapa, 	String subChtrBsaCapa, 
			...
			String crrCd2, 			String bsaOpJbCd2,
			String unit,			String rdoType2,		String rateType,		String vslCapa,			String exclYn) 		//20150514.ADD
	{
		this.updDt 			= updDt;
		...
		this.vslCapa		= vslCapa;				//20150514.ADD
		this.exclYn         = exclYn;				//20150514.ADD
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("vsl_capa", getVslCapa());				//20150514.ADD
		this.hashColumns.put("excl_yn", getExclYn());				//20150514.ADD
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("vsl_capa", "vslCapa");						//20150514.ADD
		this.hashFields.put("excl_yn", "exclYn");						//20150514.ADD
	...
	//20150514.ADD
	public void setExclYn(String exclYn) {
		this.exclYn = exclYn;
	}	
...
//		setCoBfrSubCapa	(JSPUtil.getParameter(request, "M_co_bfr_sub_capa", ""));
...
//		setSltPrcCapa		(JSPUtil.getParameter(request, "slt_Prc_Capa", ""));
		...
		setExclYn(JSPUtil.getParameter(request, "excl_yn", ""));			//20150518.ADD
	...
	public BsaManageSltPrcSaveVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] coBfrSubCapa 	= (JSPUtil.getParameter(request, prefix	+ "M_co_bfr_sub_capa", length));
...
//			String[] bsaOpJbCd 		= (JSPUtil.getParameter(request, prefix	+ "bsa_Op_Jb_Cd", length));
			...
			String[] vslCapa 		= (JSPUtil.getParameter(request, prefix	+ "M_vsl_capa", length));		//20150514.ADD
			...
			if (gsNo.equals("1")){			
				for (int i = 0; i < length; i++) {
					for (int j= 0; j <arrCrrCd.length; j++ ){
						...
						if (coBfrSubCapa[i] != null)			model.setCoBfrSubCapa(coBfrSubCapa[i]);
						...
						if (vslCapa[i] != null)					model.setVslCapa(vslCapa[i]);						//20150515.ADD
						if (exclYn !=null)						model.setExclYn(exclYn);							//20150515.ADD
	...
	*/
	public void unDataFormat(){
		...
		this.vslCapa = this.vslCapa .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		//20150514.ADD
		this.exclYn = this.exclYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");			//20150514.ADD
	}
}
