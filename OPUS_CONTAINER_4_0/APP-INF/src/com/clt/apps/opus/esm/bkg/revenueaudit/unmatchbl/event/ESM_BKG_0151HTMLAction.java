...
public class ESM_BKG_0151HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0151HTMLAction 객체를 생성
	 */
	public ESM_BKG_0151HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0151Event event = new EsmBkg0151Event();
		
		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRsltSearchChargeFilteringListVO((RsltSearchChargeFilteringListVO)getVO(request, RsltSearchChargeFilteringListVO.class));
		}
