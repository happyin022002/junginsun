...
*@FileName : BSAManageDBDAOSearchOpSlotCostListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOSearchOpSlotCostListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSAManageDBDAOSearchOpSlotCostListRSQL
	  * </pre>
	  */
	public BSAManageDBDAOSearchOpSlotCostListRSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOSearchOpSlotCostListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      RANK() OVER (ORDER BY A.TRD_CD||A.RLANE_CD||A.DIR_CD||A.VSL_CAPA) GRP," ).append("\n"); 
		query.append("	  MAX(A.SLT_PRC_SEQ) OVER(PARTITION BY A.TRD_CD||A.RLANE_CD||A.DIR_CD||A.VSL_CAPA) MAXSEQ, " ).append("\n"); 
		...
		query.append("    BSA_OP_SLT_PRC     A " ).append("\n"); 
		query.append("   ,BSA_OP_SLT_PRC_CRR B " ).append("\n"); 
		query.append("   ,(SELECT  " ).append("\n"); 
		...
		query.append("         ,K.VSL_CAPA" ).append("\n"); 
		...
		query.append("                ,Z.VSL_CAPA" ).append("\n"); 
		...
		query.append("                       ,X.VSL_CAPA" ).append("\n"); 
		...
		query.append("AND     B.VSL_CAPA           = C.VSL_CAPA (+) " ).append("\n"); 
