...
*@FileName : KorManifestListDBDAOSearchNoneBLVVDInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchNoneBLVVDInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchNoneBLVVDInfoRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchNoneBLVVDInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", COM_ConstantMgr_PKG.COM_getScacCode_FNC()                                            SHP_CO_CD" ).append("\n"); 
		query.append(", v.CALL_SGN_NO                                     VSL_CALL_SGN_CD" ).append("\n"); 
		query.append(", DECODE(mani.PORT_CD,'KRPUS','030197004','KRKAN','062112001','KRINC','020104002','KRPTK','016105001','KRUSN','110109004','KRGIN','020112001','030197004') CSTMS_DCHG_CD" ).append("\n"); 
		...
		query.append(", DECODE(mani.PORT_CD,'KRPUS',20,'KRINC',30,'KRKAN',622,'KRPTK',31,0) KT_PA /** kt_pa **/ " ).append("\n"); 
		...
		query.append(", DECODE(@[port_cd],'KRINC', '020', 'KRPUS', '030', 'KRKAN', '062','KRPTK','016') LOCL_CSTMS_CD /** Local Customs **/ " ).append("\n"); 
		query.append(", DECODE(@[port_cd],'KRINC', '10', 'KRPUS', DECODE(@[io_bnd_cd],'I', '27','10'), 'KRKAN', '10','KRPTK','10') LOCL_CSTMS_PRT_CD /** Local Customs **/ " ).append("\n"); 
