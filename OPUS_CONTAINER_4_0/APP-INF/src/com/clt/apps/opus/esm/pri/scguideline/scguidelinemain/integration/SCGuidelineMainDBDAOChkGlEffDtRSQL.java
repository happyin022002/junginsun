...
*@FileName : SCGuidelineMainDBDAOChkGlEffDtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGuidelineMainDBDAOChkGlEffDtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGuidelineMainDBDAOChkGlEffDtRSQL(){
		setQuery();
		...
		query.append("FileName : SCGuidelineMainDBDAOChkGlEffDtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
