...
public class GrpBlPrtInVO extends AbstractValueObject {
	...
	/* Column Info */
	private String sortHeader = null;
	/* Column Info */
	...
	private String grpBlEmail = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sort_header", getSortHeader());
		...
		this.hashColumns.put("grp_bl_email", getGrpBlEmail());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sort_header", "sortHeader");
		...
		this.hashFields.put("grp_bl_email", "grpBlEmail");
	...
	/**
	 * @return the grpBlEmail
	 */
	public String getGrpBlEmail() {
		return grpBlEmail;
	}

	/**
	 * @param grpBlEmail the grpBlEmail to set
	 */
	public void setGrpBlEmail(String grpBlEmail) {
		this.grpBlEmail = grpBlEmail;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSortHeader(JSPUtil.getParameter(request, prefix + "sort_header", ""));
		...
		setGrpBlEmail(JSPUtil.getParameter(request, prefix + "grp_bl_email", ""));
	}
	...
	public GrpBlPrtInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sortHeader = (JSPUtil.getParameter(request, prefix	+ "sort_header", length));
			...
			String[] grpBlEmail = (JSPUtil.getParameter(request, prefix	+ "grp_bl_email", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (sortHeader[i] != null)
					model.setSortHeader(sortHeader[i]);
				if (bbCgoFlg[i] != null)
				...
				if (grpBlEmail[i] != null)
					model.setGrpBlEmail(grpBlEmail[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.sortHeader = this.sortHeader .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.grpBlEmail = this.grpBlEmail .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
