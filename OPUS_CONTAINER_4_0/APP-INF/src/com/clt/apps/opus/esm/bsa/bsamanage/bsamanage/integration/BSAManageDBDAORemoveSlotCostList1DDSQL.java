...
*@FileName : BSAManageDBDAORemoveSlotCostList1DDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveSlotCostList1DDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAORemoveSlotCostList1DDSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveSlotCostList1DDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_SLT_PRC_CRR" ).append("\n"); 
