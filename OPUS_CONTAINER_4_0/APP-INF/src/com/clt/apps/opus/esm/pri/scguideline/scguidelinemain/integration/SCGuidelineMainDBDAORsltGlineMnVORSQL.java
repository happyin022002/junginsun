...
*@FileName : SCGuidelineMainDBDAORsltGlineMnVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGuidelineMainDBDAORsltGlineMnVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGuidelineMainDBDAORsltGlineMnVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGuidelineMainDBDAORsltGlineMnVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND GLINE_SEQ = A.GLINE_SEQ) AS SALES_CNT" ).append("\n"); 
		query.append(",(SELECT COUNT(*)" ).append("\n"); 
		...
		query.append("WHERE SVC_SCP_CD = A.SVC_SCP_CD" ).append("\n"); 
		query.append("AND GLINE_SEQ = A.GLINE_SEQ) AS GOH_CNT" ).append("\n"); 
		query.append(",(SELECT COUNT(*)" ).append("\n"); 
		query.append("FROM PRI_SG_CTRT_CLUZ" ).append("\n"); 
		query.append("WHERE SVC_SCP_CD = A.SVC_SCP_CD" ).append("\n"); 
		query.append("AND GLINE_SEQ = A.GLINE_SEQ) AS CTRT_CNT" ).append("\n"); 
		query.append("FROM PRI_SG_MN A, COM_USER B" ).append("\n"); 
