...
*@FileName : ESM_FMS_0029HTMLAction.java
...
public class ESM_FMS_0029HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0029HTMLAction 객체를 생성
	 */
	public ESM_FMS_0029HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0029Event event = new EsmFms0029Event();
