...
public class ESM_BKG_1604HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setEurDgListVO((EurDgListVO) getVO(request, EurDgListVO.class));
		}else if (command.isCommand(FormCommand.SEARCH02)) {
			event.setEurDgSummaryListVO((EurDgSummaryListVO) getVO(request, EurDgSummaryListVO.class));
		}
