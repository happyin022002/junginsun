...
*@FileName : ESM_BKG_0989HTMLAction.java
*@FileTitle : ESM_BKG_0989HTMLAction
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0989HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 2792293631096541043L;

	public ESM_BKG_0989HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		// EVENT 생성
		EsmBkg0989Event event = new EsmBkg0989Event();

		// COMMAND 구분에 따른 처리
		if (command.isCommand(FormCommand.SEARCH)) {
			// 조회의 경우 처리
			KorTransmitHistDtlCondVO korTransmitHistDtlCondVO = (KorTransmitHistDtlCondVO)getVO(request, KorTransmitHistDtlCondVO.class);
			event.setKorTransmitHistDtlCondVO(korTransmitHistDtlCondVO);
		}
