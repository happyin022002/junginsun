...
*@FileName : ESM_FMS_0036HTMLAction.java
...
public class ESM_FMS_0036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0036HTMLAction 객체를 생성
	 */
	public ESM_FMS_0036HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0036Event event = new EsmFms0036Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchLaneCodeListVO((SearchLaneCodeListVO)getVO(request, SearchLaneCodeListVO .class));
		}
