...
public class BLDocumentationBLDBDAOAddMtyBkgContainerCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(), SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC((SELECT OFC_CD FROM COM_USER WHERE USR_ID = @[cre_usr_id])))," ).append("\n"); 
		query.append("    @[cre_usr_id]," ).append("\n"); 
