...
*@FileName : AGTOfficeAgreementInfoDBDAORemoveAgentInfoForAgreementMasterDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAORemoveAgentInfoForAgreementMasterDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAORemoveAgentInfoForAgreementMasterDSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAORemoveAgentInfoForAgreementMasterDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE AGT_AGN_AGMT_MST" ).append("\n"); 
