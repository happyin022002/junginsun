...
*@FileName : ArgManifestListDetailVO.java
*@FileTitle : ArgManifestListDetailVO
*Open Issues :
*Change history :
...
public class ArgManifestListDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ArgManifestListDetailVO> models = new ArrayList<ArgManifestListDetailVO>();
...
/**
	 ...
	 * @param request
	 * @return ArgManifestListDetailVO[]
	 */
	public ArgManifestListDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ArgManifestListDetailVO[]
	 */
	public ArgManifestListDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ArgManifestListDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ArgManifestListDetailVO();
				if (vslCd[i] != null)
	...
	public ArgManifestListDetailVO[] getArgManifestListDetailVOs(){
		ArgManifestListDetailVO[] vos = (ArgManifestListDetailVO[])models.toArray(new ArgManifestListDetailVO[models.size()]);
		return vos;
	}
