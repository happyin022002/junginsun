...
*@FileName : SearchSlipDetailListVO.java
*@FileTitle : SearchSlipDetailListVO
*Open Issues :
*Change history :
...
public class SearchSlipDetailListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSlipDetailListVO> models = new ArrayList<SearchSlipDetailListVO>();
	...
	public SearchSlipDetailListVO() {}

	public SearchSlipDetailListVO(String ibflag, String pagerows, String slpSeqNo, String acctCd, String ownrCd, String ctrCd, String slpLocCd, String effDt, String csrAmt, String csrDesc, String csrDesc1, String csrDesc2, String csrDesc3, String vvdCd, String keyNum, String drAmt, String crAmt, String fletCtrtTpCd) {
	 ...
	 */
	public SearchSlipDetailListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSlipDetailListVO[]
	 */
	public SearchSlipDetailListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSlipDetailListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSlipDetailListVO();
		...
		return getSearchSlipDetailListVOs();
	}
	 ...
	 * @return SearchSlipDetailListVO[]
	 */
	public SearchSlipDetailListVO[] getSearchSlipDetailListVOs(){
		SearchSlipDetailListVO[] vos = (SearchSlipDetailListVO[])models.toArray(new SearchSlipDetailListVO[models.size()]);
		return vos;
	}
