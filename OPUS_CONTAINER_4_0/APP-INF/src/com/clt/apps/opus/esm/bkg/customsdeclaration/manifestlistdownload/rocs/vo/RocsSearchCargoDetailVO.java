...
*@FileName : RocsSearchCargoDetailVO.java
*@FileTitle : RocsSearchCargoDetailVO
*Open Issues :
*Change history :
...
public class RocsSearchCargoDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsSearchCargoDetailVO> models = new ArrayList<RocsSearchCargoDetailVO>();
	...
	private String cntrMfDesc2 = null;
	/* Column Info */
	...
	public RocsSearchCargoDetailVO() {}

	public RocsSearchCargoDetailVO(String ibflag, String pagerows, String vslCallRefNo, 
			String bkgNo, String bkgNoSplit, String cntrNo, String cntrMfSeq, String pckTpCd, 
			String pckQty, String pckDesc, String cntrWgtUtCd, String cntrMfWgt, String hamoTrfCd, 
			String cntrMfDesc,String cntrMfDesc2) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cntr_mf_desc2", getCntrMfDesc2());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cntr_mf_desc2", "cntrMfDesc2");
	...
	public String getCntrMfDesc2() {
		return this.cntrMfDesc2;
	}
	...
	public void setCntrMfDesc2(String cntrMfDesc2) {
		this.cntrMfDesc2 = cntrMfDesc2;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCntrMfDesc2(JSPUtil.getParameter(request, "cntr_mf_desc2", ""));
	 ...
	 */
	public RocsSearchCargoDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsSearchCargoDetailVO[]
	 */
	public RocsSearchCargoDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsSearchCargoDetailVO model = null;
		...
		try {
			...
			String[] cntrMfDesc2 = (JSPUtil.getParameter(request, prefix	+ "cntr_mf_desc2".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				model = new RocsSearchCargoDetailVO();
				if (hamoTrfCd[i] != null)
				...
				if (cntrMfDesc2[i] != null)
					model.setCntrMfDesc2(cntrMfDesc2[i]);
				if (cntrNo[i] != null)
		...
		return getRocsSearchCargoDetailVOs();
	}
	 ...
	 * @return RocsSearchCargoDetailVO[]
	 */
	public RocsSearchCargoDetailVO[] getRocsSearchCargoDetailVOs(){
		RocsSearchCargoDetailVO[] vos = (RocsSearchCargoDetailVO[])models.toArray(new RocsSearchCargoDetailVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.cntrMfDesc2 = this.cntrMfDesc2 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
