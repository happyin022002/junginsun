...
public class AgnReqCalCondVO extends AbstractValueObject {
	...
	public AgnReqCalCondVO(String ibflag, String pagerows, String bkgNo, String obSaDt, String ibSaDt, String bkgCreDt, String revMon, String calcNo, String usrId) {
		this.calcNo = calcNo;
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
		this.usrId = usrId;
