...
*@FileName : StiDetailCndVO.java
*@FileTitle : StiDetailCndVO
*Open Issues :
*Change history :
...
public class StiDetailCndVO extends ManifestTransmitVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<StiDetailCndVO> models = new ArrayList<StiDetailCndVO>();
	...
	/* Column Info */
	private String lpolClptSeq = null;
	/* Column Info */
	...
	public StiDetailCndVO(String ibflag, String pagerows, String cntrNo, String oprCd, String pol, String pod, String sztp, String fe, String stiPos, String imdg, String unno, String searchVvdCd, String lPol, String sentTime, String custResult, String oPod, String vvd, String excludeca, String vslEngNm, String vslVoy, String crrCd, String tmp1, String tmp2, String tmp3, String tmp4, String tmp5, String lastpol, String vpsPortCd, String lpolClptIndSeq, String clptIndSeq, String lpolClptSeq, String clptSeq, String cvyRefNo, String vvdBaplie, String hiddenVvd) {
		...
		this.lpolClptSeq = lpolClptSeq;
		this.clptSeq = clptSeq;
		this.cvyRefNo = cvyRefNo;
		this.vvdBaplie = vvdBaplie;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("lpol_clpt_seq", getLpolClptSeq());
		this.hashColumns.put("clpt_seq", getClptSeq());
		this.hashColumns.put("cvy_ref_no", getCvyRefNo());
		this.hashColumns.put("vvd_baplie", getVvdBaplie());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("lpol_clpt_seq", "lpolClptSeq");
		this.hashFields.put("clpt_seq", "clptSeq");
		this.hashFields.put("cvy_ref_no", "cvyRefNo");
		this.hashFields.put("vvd_baplie", "vvdBaplie");
	 ...
	 * @return lpolClptSeq
	 */
	public String getLpolClptSeq() {
		return this.lpolClptSeq;
	}
	 ...
	 * @return vvdBaplie
	 */
	public String getVvdBaplie() {
		return this.vvdBaplie;
	}
	 ...
	 * @param lpolClptSeq
	 */
	public void setLpolClptSeq(String lpolClptSeq) {
		this.lpolClptSeq = lpolClptSeq;
	}
	 ...
	 * @param vvdBaplie
	 */
	public void setVvdBaplie(String vvdBaplie) {
		this.vvdBaplie = vvdBaplie;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setLpolClptSeq(JSPUtil.getParameter(request, prefix + "lpol_clpt_seq", ""));
		setClptSeq(JSPUtil.getParameter(request, prefix + "clpt_seq", ""));
		setCvyRefNo(JSPUtil.getParameter(request, prefix + "cvy_ref_no", ""));
		setVvdBaplie(JSPUtil.getParameter(request, prefix + "vvd_baplie", ""));
	 ...
	 * @param request
	 * @return StiDetailCndVO[]
	 */
	public StiDetailCndVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StiDetailCndVO[]
	 */
	public StiDetailCndVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		StiDetailCndVO model = null;
		...
		try {
			...
			String[] lpolClptSeq = (JSPUtil.getParameter(request, prefix	+ "lpol_clpt_seq", length));
			String[] clptSeq = (JSPUtil.getParameter(request, prefix	+ "clpt_seq", length));
			String[] cvyRefNo = (JSPUtil.getParameter(request, prefix	+ "cvy_ref_no", length));
			String[] vvdBaplie = (JSPUtil.getParameter(request, prefix	+ "vvd_baplie", length));
			String[] hiddenVvd = (JSPUtil.getParameter(request, prefix	+ "hidden_vvd", length));
			
			for (int i = 0; i < length; i++) {
				model = new StiDetailCndVO();
				if (excludeca[i] != null)
				...
				if (lpolClptSeq[i] != null)
					model.setLpolClptSeq(lpolClptSeq[i]);
				if (clptSeq[i] != null)
					model.setClptSeq(clptSeq[i]);
				if (cvyRefNo[i] != null)
					model.setCvyRefNo(cvyRefNo[i]);
				if (vvdBaplie[i] != null)
					model.setVvdBaplie(vvdBaplie[i]);
				if (hiddenVvd[i] != null)
	 ...
	 * @return StiDetailCndVO[]
	 */
	public StiDetailCndVO[] getStiDetailCndVOs(){
		StiDetailCndVO[] vos = (StiDetailCndVO[])models.toArray(new StiDetailCndVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.lpolClptSeq = this.lpolClptSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.clptSeq = this.clptSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cvyRefNo = this.cvyRefNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.vvdBaplie = this.vvdBaplie .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
