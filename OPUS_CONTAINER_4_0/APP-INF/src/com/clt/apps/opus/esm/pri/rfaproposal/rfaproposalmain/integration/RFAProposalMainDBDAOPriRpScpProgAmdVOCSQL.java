...
*@FileName : RFAProposalMainDBDAOPriRpScpProgAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriRpScpProgAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAProposalMainDBDAOPriRpScpProgAmdVOCSQL
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriRpScpProgAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriRpScpProgAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_RP_SCP_PROG" ).append("\n"); 
		query.append("WHERE" ).append("\n"); 
		query.append("PROP_NO         	= @[prop_no]" ).append("\n"); 
		query.append("AND AMDT_SEQ            = @[amdt_seq]" ).append("\n"); 
		query.append("AND PROP_SCP_PROG_SEQ   = 1" ).append("\n"); 
