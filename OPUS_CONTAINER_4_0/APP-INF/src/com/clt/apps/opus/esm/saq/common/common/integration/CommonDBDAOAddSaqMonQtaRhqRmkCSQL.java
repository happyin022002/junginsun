...
*@FileName : CommonDBDAOAddSaqMonQtaRhqRmkCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOAddSaqMonQtaRhqRmkCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAQ_MON_QTA_RHQ_RMK의 데이타 모델을 DB에 저장한다.
	  * </pre>
	  */
	public CommonDBDAOAddSaqMonQtaRhqRmkCSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOAddSaqMonQtaRhqRmkCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SAQ_MON_QTA_RHQ_RMK (          " ).append("\n"); 
