...
*@FileName : MTCostDBDAOSearchMTCostListVO11RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCostListVO11RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * COA_MTY_ECC_UT_COST, COA_MTY_CNTR_ROUT_PERF, COA_LOCATION_V  테이블의 데이터 조회   
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCostListVO11RSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCostListVO11RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
