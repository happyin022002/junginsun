...
import com.clt.irep.enisEsm.ESM0560001Document;
import com.clt.irep.enisEsm.ESM0560001Document.ESM0560001;
import com.clt.irep.enisEsm.ESM0560001Document.ESM0560001.DataArea.BKGDOCRefCollection;
import com.clt.irep.enisEsm.ESM0560001Document.ESM0560001.DataArea.BKGDOCRefCollection.BKGDOCRefRequest;
import com.clt.irep.enisEsm.ESM0560001Document.ESM0560001.DataArea.BKGDOCRefCollection.BKGDOCRefResponse;
...
public class AGTCustomerInfoEAIDAO extends EAIDAOSupport {
	 ...
	 * (ESM_AGT_030) FAC Shipper 관계 관리의 정보를 등록,수정,삭제 후 OPUS 에 Interface 한다.<br>
