...
public class AGNCommApprovalDBDAOASearchGNCommApprovalMasterListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       (SELECT VNDR_LGL_ENG_NM FROM MDM_VENDOR M WHERE M.VNDR_SEQ = A.VNDR_SEQ AND M.DELT_FLG = 'N') AS VNDR_NM," ).append("\n"); 
		...
		query.append("       B.CRE_DT      AS CSR_CRE_DT," ).append("\n"); 
		query.append("       C.RQST_USR_ID AS RQST_USR_ID," ).append("\n"); 
		query.append("       C.RQST_USR_NM AS RQST_USR_NM," ).append("\n"); 
		query.append("       C.APRO_USR_ID AS APRO_USR_ID," ).append("\n"); 
		query.append("       C.APRO_USR_NM AS APRO_USR_NM" ).append("\n"); 
		...
		query.append("#if(${ac_sts_cd} == 'IE')" ).append("\n"); 
		query.append("   AND B.IF_FLG = 'E'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
