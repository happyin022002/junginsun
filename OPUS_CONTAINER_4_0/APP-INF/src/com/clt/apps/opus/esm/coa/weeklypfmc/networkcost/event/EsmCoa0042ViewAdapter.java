	    ...
	    if(totCnt > 0){
	    	try{
	            ...
	            for(int i=0; i<totCnt; i++){
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("vsl_clss_capa" ))+"</TD>");	//20151201.ADD
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("stnd_ldb_capa" ))+"</TD>");	//20151201.ADD
