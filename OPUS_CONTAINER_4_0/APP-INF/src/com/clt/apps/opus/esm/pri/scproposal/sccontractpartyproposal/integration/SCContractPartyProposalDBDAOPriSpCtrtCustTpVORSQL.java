...
*@FileName : SCContractPartyProposalDBDAOPriSpCtrtCustTpVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCContractPartyProposalDBDAOPriSpCtrtCustTpVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCContractPartyProposalDBDAOPriSpCtrtCustTpVORSQL(){
		setQuery();
		...
		query.append("FileName : SCContractPartyProposalDBDAOPriSpCtrtCustTpVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    A.PRC_CTRT_CUST_TP_CD           ," ).append("\n"); 
		...
		query.append("    PRI_SP_CTRT_CUST_TP A  ," ).append("\n"); 
		...
		query.append("            AND  NOT EXISTS ( SELECT 'X' FROM PRI_SP_CTRT_CUST_TP B" ).append("\n"); 
		query.append("                               WHERE " ).append("\n"); 
