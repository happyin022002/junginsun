...
*@FileName : RsltPerformanceVO.java
*@FileTitle : RsltPerformanceVO
*Open Issues :
*Change history :
...
public class RsltPerformanceVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPerformanceVO> models = new ArrayList<RsltPerformanceVO>();
	...
	public RsltPerformanceVO() {}

	public RsltPerformanceVO(String ibflag, String pagerows, String opCntrQty, String proRtMqcPerf) {
		this.ibflag = ibflag;
	 ...
	 */
	public RsltPerformanceVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPerformanceVO[]
	 */
	public RsltPerformanceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPerformanceVO model = null;
	 ...
	 * @return RsltPerformanceVO[]
	 */
	public RsltPerformanceVO[] getRsltPerformanceVOs(){
		RsltPerformanceVO[] vos = (RsltPerformanceVO[])models.toArray(new RsltPerformanceVO[models.size()]);
		return vos;
	}
