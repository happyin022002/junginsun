...
*@FileName : RsltPriCrmSlLdVO.java
*@FileTitle : RsltPriCrmSlLdVO
*Open Issues :
*Change history :
...
public class RsltPriCrmSlLdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCrmSlLdVO> models = new ArrayList<RsltPriCrmSlLdVO>();
	...
	public RsltPriCrmSlLdVO() {}

	public RsltPriCrmSlLdVO(String ibflag, String pagerows, String slsLdNo, String slsLdNm) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return RsltPriCrmSlLdVO[]
	 */
	public RsltPriCrmSlLdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCrmSlLdVO[]
	 */
	public RsltPriCrmSlLdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCrmSlLdVO model = null;
	 ...
	 * @return RsltPriCrmSlLdVO[]
	 */
	public RsltPriCrmSlLdVO[] getRsltPriCrmSlLdVOs(){
		RsltPriCrmSlLdVO[] vos = (RsltPriCrmSlLdVO[])models.toArray(new RsltPriCrmSlLdVO[models.size()]);
		return vos;
	}
