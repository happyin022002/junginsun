...
*@FileName : Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCntrMfDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCntrMfDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCntrMfDSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCntrMfDSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.eur24.integration").append("\n"); 
		query.append("FileName : Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCntrMfDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE BKG_CSTMS_EUR_IO_CNTR_MF" ).append("\n"); 
