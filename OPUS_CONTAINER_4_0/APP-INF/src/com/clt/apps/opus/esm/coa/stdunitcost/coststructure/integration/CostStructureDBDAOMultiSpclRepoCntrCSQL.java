...
*@FileName : CostStructureDBDAOMultiSpclRepoCntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAOMultiSpclRepoCntrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 스페셜 컨테이너 타입사이즈를 입력한다
	  * </pre>
	  */
	public CostStructureDBDAOMultiSpclRepoCntrCSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAOMultiSpclRepoCntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO COA_SPCL_REPO_CNTR_RGST (" ).append("\n"); 
		query.append("LIST_BX_SET_LVL_CD" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("VALUES ('0001'" ).append("\n"); 
		query.append(",@[cntr_tpsz_cd]" ).append("\n"); 
		query.append(",@[spcl_cntr_tpsz_cd]" ).append("\n"); 
		query.append(",@[repo_flg]" ).append("\n"); 
		query.append(",@[list_bx_desc]" ).append("\n"); 
