...
*@FileName : CostManageDBDAOCreateNewLaneSecCmcbPairCostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostManageDBDAOCreateNewLaneSecCmcbPairCostCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * New Lane Sector CMCB Pair Cost를 생성한다.
	  * </pre>
	  */
	public CostManageDBDAOCreateNewLaneSecCmcbPairCostCSQL(){
		setQuery();
		...
		query.append("FileName : CostManageDBDAOCreateNewLaneSecCmcbPairCostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CSQ_SCTR_NEW_PAIR_COST" ).append("\n"); 
		...
		query.append("                  ,CSQ_SCTR_PERF_IF A2" ).append("\n"); 
		query.append("             WHERE 1=1" ).append("\n"); 
		...
		query.append("               AND A2.RLANE_CD(+) = @[src_rlane_cd]" ).append("\n"); 
