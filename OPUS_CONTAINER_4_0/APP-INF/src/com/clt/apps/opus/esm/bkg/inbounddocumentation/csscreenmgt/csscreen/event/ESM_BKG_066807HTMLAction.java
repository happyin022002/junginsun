...
*@FileName : ESM_BKG_066807HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_066807HTMLAction extends HTMLActionSupport {
     ...
     */
    public ESM_BKG_066807HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg066807Event event = new EsmBkg066807Event();
        ...
        log.debug("===================================");
        log.debug("    ESM_BKG_066807HTMLAction Start ");
        log.debug("===================================");
