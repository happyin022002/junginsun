...
*@FileName : SCRateProposalDBDAOPriSpScpRtCmdtHdrVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCmdtHdrVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCmdtHdrVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_SP_SCP_RT_CMDT_HDR A" ).append("\n"); 
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCmdtHdrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}