...
*@FileName : ESM_BKG_0740HTMLAction.java
 ...
 * @see EsmBkg0940Event 참조
 * @since J2EE 1.5
 */

public class ESM_BKG_0940HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0940HTMLAction 객체를 생성
     */
    public ESM_BKG_0940HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg0940Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0940Event event = new EsmBkg0940Event();
		
		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((InBoundReportInVO) getVO(request, InBoundReportInVO.class));
