...
*@FileName : ESM_COA_0137HTMLAction.java
...
public class ESM_COA_0137HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0137HTMLAction 객체를 생성
	 */
	public ESM_COA_0137HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0137Event event = new EsmCoa0137Event();
