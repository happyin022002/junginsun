...
public class QtaAdjustmentDBDAOUpdateCfmQtaUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("MERGE INTO CSQ_CFM_QTA T" ).append("\n"); 
		...
		query.append("               ,DECODE(DECODE(@[ibflag], 'I', @[coa_fnl_bsa_capa], @[fnl_bsa_capa]), 0, 0, NVL(ROUND(@[coa_fnl_bsa_capa] * LOD_QTY / DECODE(@[ibflag], 'I', (SELECT FNL_BSA_CAPA" ).append("\n"); 
		query.append("                                                                                                                                                               FROM CSQ_CFM_TGT_VVD T" ).append("\n"); 
		...
		query.append("               ,DECODE(@[ibflag], 'I', 'M', CSQ_CNG_TP_CD) AS CSQ_CNG_TP_CD" ).append("\n"); 
		...
		query.append("           ,T.CSQ_CNG_TP_CD = C.CSQ_CNG_TP_CD" ).append("\n"); 
