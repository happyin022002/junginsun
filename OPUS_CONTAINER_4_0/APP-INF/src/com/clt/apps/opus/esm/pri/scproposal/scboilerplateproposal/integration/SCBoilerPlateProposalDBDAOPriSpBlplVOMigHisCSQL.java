...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplVOMigHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplVOMigHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Cancel 버튼으로 계약 삭제시 Boiler plate 삭제할 때
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplVOMigHisCSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplVOMigHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
