...
*@FileName : SCRateGuidelineDBDAOPriSgRtCmdtRoutGlineMainCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtCmdtRoutGlineMainCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtCmdtRoutGlineMainCopyCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtCmdtRoutGlineMainCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SG_RT_CMDT_ROUT (" ).append("\n"); 
		...
		query.append("        , @[upd_usr_id]" ).append("\n"); 
		query.append("        , SYSDATE" ).append("\n"); 
		query.append("     FROM PRI_SG_RT_CMDT_ROUT" ).append("\n"); 
