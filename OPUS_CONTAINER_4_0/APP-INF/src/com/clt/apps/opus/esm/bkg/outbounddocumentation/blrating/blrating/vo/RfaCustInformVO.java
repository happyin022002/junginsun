...
*@FileName : RfaCustInformVO.java
*@FileTitle : RfaCustInformVO
*Open Issues :
*Change history :
...
public class RfaCustInformVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RfaCustInformVO> models = new ArrayList<RfaCustInformVO>();
	 ...
	 */
	public RfaCustInformVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RfaCustInformVO[]
	 */
	public RfaCustInformVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RfaCustInformVO model = null;
	 ...
	 * @return RfaCustInformVO[]
	 */
	public RfaCustInformVO[] getRfaCustInformVOs(){
		RfaCustInformVO[] vos = (RfaCustInformVO[])models.toArray(new RfaCustInformVO[models.size()]);
		return vos;
	}
