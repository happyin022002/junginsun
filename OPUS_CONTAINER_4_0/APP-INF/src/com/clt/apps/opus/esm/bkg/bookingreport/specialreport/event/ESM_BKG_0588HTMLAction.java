...
*@FileName : ESM_BKG_0588HTMLAction.java
...
public class ESM_BKG_0588HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0588HTMLAction 객체를 생성
	 */
	public ESM_BKG_0588HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0588Event event = new EsmBkg0588Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSpecialCargoSummaryReportVO((SpecialCargoSummaryReportVO)getVO(request, SpecialCargoSummaryReportVO .class));
		}
