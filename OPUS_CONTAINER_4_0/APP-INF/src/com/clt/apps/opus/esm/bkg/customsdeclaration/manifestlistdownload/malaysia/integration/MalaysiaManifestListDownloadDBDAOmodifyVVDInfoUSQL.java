...
*@FileName : MalaysiaManifestListDownloadDBDAOmodifyVVDInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MalaysiaManifestListDownloadDBDAOmodifyVVDInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MalaysiaManifestListDownloadDBDAOmodifyVVDInfoUSQL(){
		setQuery();
		...
		query.append("FileName : MalaysiaManifestListDownloadDBDAOmodifyVVDInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_MY_VVD" ).append("\n"); 
