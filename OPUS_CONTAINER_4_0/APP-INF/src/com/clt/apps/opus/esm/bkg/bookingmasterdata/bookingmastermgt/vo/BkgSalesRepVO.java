...
public class BkgSalesRepVO extends AbstractValueObject {
	...
	public BkgSalesRepVO(String ibflag, String pagerows, String srepCd, String custCntCd, String custSeq, String deltFlg, String dpSeq, String srepCustClssCd, String userId, String opCd) {
		this.dpSeq = dpSeq;
		this.ibflag = ibflag;
