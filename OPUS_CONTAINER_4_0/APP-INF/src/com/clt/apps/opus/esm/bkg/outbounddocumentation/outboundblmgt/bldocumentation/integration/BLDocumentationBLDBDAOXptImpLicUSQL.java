...
public class BLDocumentationBLDBDAOXptImpLicUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   SET CAED_TP_CD               = @[caed_tp_cd]," ).append("\n"); 
		...
		query.append("UPDATE BKG_XPT_IMP_LIC" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("   SET AES_TP_CD                = @[aes_tp_cd]," ).append("\n"); 
		...
		query.append("       AES_EXPT_CTNT            = DECODE(@[aes_tp_cd],'EX',@[aes_expt_ctnt],'')," ).append("\n"); 
		query.append("       upd_usr_id 				= @[upd_usr_id]," ).append("\n"); 
		query.append("	   upd_dt 				    = sysdate" ).append("\n"); 
		query.append(" WHERE BKG_NO       = @[bkg_no]" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
