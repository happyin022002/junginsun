...
*@FileName : KorCertiVO.java
*@FileTitle : KorCertiVO
*Open Issues :
*Change history :
...
public class KorCertiVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorCertiVO> models = new ArrayList<KorCertiVO>();
	...
	public KorCertiVO(String ibflag, String pagerows, String vvdSeq, String mrnNo) {
		this.ibflag = ibflag;
		this.mrnNo = mrnNo;
		this.vvdSeq = vvdSeq;
	 ...
	 * @return KorCertiVO[]
	 */
	public KorCertiVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCertiVO[]
	 */
	public KorCertiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCertiVO model = null;
	 ...
	 * @return KorCertiVO[]
	 */
	public KorCertiVO[] getKorCertiVOs(){
		KorCertiVO[] vos = (KorCertiVO[])models.toArray(new KorCertiVO[models.size()]);
		return vos;
	}
