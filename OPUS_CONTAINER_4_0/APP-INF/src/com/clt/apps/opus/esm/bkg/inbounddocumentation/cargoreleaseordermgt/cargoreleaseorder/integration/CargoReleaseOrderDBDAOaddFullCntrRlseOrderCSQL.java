...
public class CargoReleaseOrderDBDAOaddFullCntrRlseOrderCSQL implements ISQLTemplate{
	...
	public CargoReleaseOrderDBDAOaddFullCntrRlseOrderCSQL(){
		...
		params.put("cntr_slt_no",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("          ,@[rlse_ofc_cd]" ).append("\n"); 
		query.append("          ,@[cgor_mzd_cd]" ).append("\n"); 
		query.append("          ,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC(@[rlse_ofc_cd]) )     " ).append("\n"); 
		query.append("          ,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,sysdate,'GMT')  -- Rlse GMT" ).append("\n"); 
		query.append("		  ,TO_DATE(@[rlse_exp_dt], 'YYYYMMDD')" ).append("\n"); 
		query.append("          ,@[rlse_hdr_ctnt]" ).append("\n"); 
		query.append("          ,@[rlse_ftr_ctnt]" ).append("\n"); 
