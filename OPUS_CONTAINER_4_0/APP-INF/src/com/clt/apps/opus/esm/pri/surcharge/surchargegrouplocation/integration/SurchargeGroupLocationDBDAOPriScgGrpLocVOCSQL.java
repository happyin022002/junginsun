...
*@FileName : SurchargeGroupLocationDBDAOPriScgGrpLocVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeGroupLocationDBDAOPriScgGrpLocVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SurchargeGroupLocationDBDAOPriScgGrpLocVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("insert into pri_scg_grp_loc (" ).append("\n"); 
		...
		query.append("FileName : SurchargeGroupLocationDBDAOPriScgGrpLocVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}