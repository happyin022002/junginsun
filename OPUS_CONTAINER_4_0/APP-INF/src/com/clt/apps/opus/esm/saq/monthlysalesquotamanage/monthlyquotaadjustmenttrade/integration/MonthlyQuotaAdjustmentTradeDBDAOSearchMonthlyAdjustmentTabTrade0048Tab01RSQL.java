...
*@FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyAdjustmentTabTrade0048Tab01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            DECODE(@[ctrt_rhq_cd], '', 'FC', 'FN') AS FINAL_STATUS" ).append("\n"); 
		...
		query.append("        DECODE(TRD.TRD_CD, '', 'TOTAL', TRD.TRD_CD) AS TRD_CD," ).append("\n"); 
		...
		query.append("            TRD.TRD_CD AS TRD_CD," ).append("\n"); 
		...
		query.append(" 		   (" ).append("\n"); 
		query.append(" 			(" ).append("\n"); 
		query.append(" 				VER.MQTA_STEP_CD = INP.SECOND_STEP AND VER.GLINE_VER_NO = INP.GLINE_VER_NO" ).append("\n"); 
		query.append(" 				AND VER.TRD_CD = INP.SEL_TRD_CD AND VER.DIR_CD = INP.DIR_CD" ).append("\n"); 
		query.append(" 				AND VER.SAQ_STS_CD IN (SELECT A.INTG_CD_VAL_CTNT" ).append("\n"); 
		query.append(" 						      FROM COM_INTG_CD_DTL A," ).append("\n"); 
		query.append(" 							   COM_INTG_CD_DTL B" ).append("\n"); 
		...
		query.append(" 		   (" ).append("\n"); 
		query.append(" 			(" ).append("\n"); 
		query.append(" 				VER.MQTA_STEP_CD = '03' AND VER.GLINE_VER_NO = INP.GLINE_VER_NO" ).append("\n"); 
		query.append(" 				AND VER.TRD_CD = INP.SEL_TRD_CD AND VER.DIR_CD = INP.DIR_CD" ).append("\n"); 
		query.append(" 				AND VER.SAQ_STS_CD IN (SELECT A.INTG_CD_VAL_CTNT" ).append("\n"); 
		query.append(" 						      FROM COM_INTG_CD_DTL A," ).append("\n"); 
		query.append(" 							   COM_INTG_CD_DTL B" ).append("\n"); 
		...
		query.append(" 			)" ).append("\n"); 
		query.append(" 			OR" ).append("\n"); 
		query.append(" 			(	VER.MQTA_STEP_CD = '03'" ).append("\n"); 
		query.append(" 				AND NOT(VER.TRD_CD = INP.SEL_TRD_CD AND VER.DIR_CD = INP.DIR_CD)" ).append("\n"); 
		query.append(" 				AND VER.SAQ_STS_CD IN (SELECT A.INTG_CD_VAL_CTNT" ).append("\n"); 
		query.append(" 						      FROM COM_INTG_CD_DTL A," ).append("\n"); 
		query.append(" 							   COM_INTG_CD_DTL B" ).append("\n"); 
		...
		query.append("        GROUP BY TRD.MQTA_STEP_CD,TRD.BSE_YR,TRD.BSE_MON,TRD.TRD_CD,TRD.RLANE_CD,TRD.DIR_CD," ).append("\n"); 
		query.append("              TRD.SPRT_GRP_CD,TRD.BSA_GRP_CD" ).append("\n"); 
		query.append("        ) TRD" ).append("\n"); 
		query.append("    GROUP BY ROLLUP(TRD.TRD_CD, TRD.DIR_CD), TRD.MQTA_STEP_CD, TRD.BSE_MON" ).append("\n"); 
		query.append("    UNION ALL" ).append("\n"); 
		...
		query.append("    GROUP BY ROLLUP(RHQ.TRD_CD, RHQ.DIR_CD), RHQ.BSE_MON" ).append("\n"); 
