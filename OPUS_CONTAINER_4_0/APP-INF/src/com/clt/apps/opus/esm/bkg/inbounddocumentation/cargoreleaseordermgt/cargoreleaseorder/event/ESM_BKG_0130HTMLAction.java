...
public class ESM_BKG_0130HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0052HTMLAction 객체를 생성
	 */
	public ESM_BKG_0130HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0130Event event = new EsmBkg0130Event();
		if(command.isCommand(FormCommand.SEARCH))
		{
			event.setDoRcvrInfoVO((DoRcvrInfoVO) getVO(request, DoRcvrInfoVO.class));
		}
