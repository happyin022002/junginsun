...
*@FileName : SalesAdminCommonDBDAOSamActTpMstVODSQL.java
...
public class SalesAdminCommonDBDAOSamActTpMstVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SalesAdminCommonDBDAOSamActTpMstVODSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.sam.salesadmincommon.salesadmincommon.integration").append("\n"); 
		query.append("FileName : SalesAdminCommonDBDAOSamActTpMstVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
