...
//		            instanceId = "ESM062-" + timestamp + "ACM" +"("+startNo+"/"+endNo+")"; //2007.05.31 modify
		            instanceId.append("ESM062-");
		            instanceId.append(timestamp);
		            instanceId.append("ACM");
...
//
					...
					instanceId.append("(");
					instanceId.append(bkgNo);
					instanceId.append("/");
					instanceId.append(bkgNoSplit);
					instanceId.append("/");
					instanceId.append(agnCd);
					instanceId.append("/");
					instanceId.append(ioBndCd);
					instanceId.append("/");
					instanceId.append(acTpCd);
					instanceId.append("/");
					instanceId.append(acSeq);
					instanceId.append(")");
					
//					instanceId = instanceId + "("+bkgNo+"/"+bkgNoSplit+"/"+agnCd+"/"+ioBndCd+"/"+acTpCd+"/"+""+acSeq+")";
					headerType.setInstanceId(instanceId.toString());

					log.error("\n ### docReq["+i+"].instanceId:"+instanceId.toString() +
