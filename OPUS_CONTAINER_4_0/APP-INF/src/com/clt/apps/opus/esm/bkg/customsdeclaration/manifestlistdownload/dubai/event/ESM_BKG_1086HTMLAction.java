 ...
 *@FileName : ESM_BKG_1086HTMLAction.java
 ...
 * @see EsmBkg1086Event 참조
 * @since J2EE 1.4
 */
public class ESM_BKG_1086HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1086HTMLAction 객체를 생성
	 */
	public ESM_BKG_1086HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1086Event event = new EsmBkg1086Event();
		...
		{
			event.setBkgCstmsCdConvCtntVOs((BkgCstmsCdConvCtntVO[]) getVOs(request, BkgCstmsCdConvCtntVO.class));
		}
