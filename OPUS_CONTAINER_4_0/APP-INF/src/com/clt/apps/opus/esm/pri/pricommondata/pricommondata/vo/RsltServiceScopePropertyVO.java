...
*@FileName : RsltServiceScopePropertyVO.java
*@FileTitle : RsltServiceScopePropertyVO
*Open Issues :
*Change history :
...
public class RsltServiceScopePropertyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltServiceScopePropertyVO> models = new ArrayList<RsltServiceScopePropertyVO>();
	...
	public RsltServiceScopePropertyVO() {}

	public RsltServiceScopePropertyVO(String ibflag, String pagerows, String svcScpPptCd, String svcScpPptDesc) {
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public RsltServiceScopePropertyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltServiceScopePropertyVO[]
	 */
	public RsltServiceScopePropertyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltServiceScopePropertyVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltServiceScopePropertyVO();
				if (ibflag[i] != null)
		...
		return getRsltServiceScopePropertyVOs();
	}
	...
	public RsltServiceScopePropertyVO[] getRsltServiceScopePropertyVOs(){
		RsltServiceScopePropertyVO[] vos = (RsltServiceScopePropertyVO[])models.toArray(new RsltServiceScopePropertyVO[models.size()]);
		return vos;
	}
