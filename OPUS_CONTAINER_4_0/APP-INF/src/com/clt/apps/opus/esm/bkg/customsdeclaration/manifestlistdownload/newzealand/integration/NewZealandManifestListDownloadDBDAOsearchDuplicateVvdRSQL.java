...
*@FileName : NewZealandManifestListDownloadDBDAOsearchDuplicateVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NewZealandManifestListDownloadDBDAOsearchDuplicateVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NewZealandManifestListDownloadDBDAOsearchDuplicateVvdRSQL(){
		setQuery();
		...
		query.append("FileName : NewZealandManifestListDownloadDBDAOsearchDuplicateVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND  VSL_CD || SKD_VOY_NO || SKD_DIR_CD NOT IN (${vvd_cd})" ).append("\n"); 
