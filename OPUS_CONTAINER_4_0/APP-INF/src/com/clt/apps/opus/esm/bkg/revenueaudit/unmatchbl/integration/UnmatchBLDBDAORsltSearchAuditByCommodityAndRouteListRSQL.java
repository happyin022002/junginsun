...
public class UnmatchBLDBDAORsltSearchAuditByCommodityAndRouteListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        SUBSTR(REPLACE(S_CUST_NM,CHR(10),' '), 0, 40) AS S_CUST_NM             ," ).append("\n"); 
		query.append("        SUBSTR(REPLACE(C_CUST_NM,CHR(10),' '), 0, 40) AS C_CUST_NM             ," ).append("\n"); 
		query.append("        SUBSTR(REPLACE(N_CUST_NM,CHR(10),' '), 0, 40) AS N_CUST_NM             ," ).append("\n"); 
