...
*@FileName : ChinaManifestListDownloadDBDAOaddBlCntrAkListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOaddBlCntrAkListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOaddBlCntrAkListCSQL(){
		setQuery();
		...
		params.put("awk_seq_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOaddBlCntrAkListCSQL").append("\n");
		query.append("*/").append("\n");
	}
