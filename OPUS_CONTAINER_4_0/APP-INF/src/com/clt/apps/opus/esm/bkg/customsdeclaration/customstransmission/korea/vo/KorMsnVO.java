...
public class KorMsnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorMsnVO> models = new ArrayList<KorMsnVO>();
	...
	public KorMsnVO(String ibflag, String pagerows, String userId, String mrnNo, String mrnChkNo, String vslCd, String skdVoyNo, String skdDirCd, String portCd) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 * @return KorMsnVO[]
	 */
	public KorMsnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMsnVO[]
	 */
	public KorMsnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMsnVO model = null;
	 ...
	 * @return KorMsnVO[]
	 */
	public KorMsnVO[] getKorMsnVOs(){
		KorMsnVO[] vos = (KorMsnVO[])models.toArray(new KorMsnVO[models.size()]);
		return vos;
	}
