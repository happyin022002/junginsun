...
*@FileName : RocsSearchCRNForAddVO.java
*@FileTitle : RocsSearchCRNForAddVO
*Open Issues :
*Change history :
...
public class RocsSearchCRNForAddVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsSearchCRNForAddVO> models = new ArrayList<RocsSearchCRNForAddVO>();
	...
	public RocsSearchCRNForAddVO() {}

	public RocsSearchCRNForAddVO(String ibflag, String pagerows, String crnNumber, String vslCd, String skdVoyNo, String skdDirCd, String vvdNumber) {
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return RocsSearchCRNForAddVO[]
	 */
	public RocsSearchCRNForAddVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsSearchCRNForAddVO[]
	 */
	public RocsSearchCRNForAddVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsSearchCRNForAddVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RocsSearchCRNForAddVO();
				if (vslCd[i] != null)
		...
		return getRocsSearchCRNForAddVOs();
	}
	 ...
	 * @return RocsSearchCRNForAddVO[]
	 */
	public RocsSearchCRNForAddVO[] getRocsSearchCRNForAddVOs(){
		RocsSearchCRNForAddVO[] vos = (RocsSearchCRNForAddVO[])models.toArray(new RocsSearchCRNForAddVO[models.size()]);
		return vos;
	}
