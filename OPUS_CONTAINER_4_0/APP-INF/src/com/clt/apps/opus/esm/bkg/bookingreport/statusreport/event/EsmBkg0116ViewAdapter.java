		...
		if (tempColValues.get("tab_tp") != null){ 
			...
			if (tempColValues.get("tab_tp").equals("CM")){ 
				...
				for(int i = 0 ; i < realCnt ; i++){
					...
					sbufXML.append("  <TD DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(JSPUtil.getNull(nowColValues.get("cntr_mf_wgt"))); sbufXML.append("]]></TD>\n");
					sbufXML.append("  <TD DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(JSPUtil.getNull(nowColValues.get("meas_qty"))); sbufXML.append("]]></TD>\n");
					...
					if (!nowCntrNo.equals(nexCntrNo)){		//소계처리									
						...
						sbufXML.append("  <TD DATA-ALIGN=\"daRight\" DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(Float.toString(subTotWeight));  sbufXML.append("]]></TD>\n");
						sbufXML.append("  <TD DATA-ALIGN=\"daRight\" DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(Float.toString(subTotMeasure)); sbufXML.append("]]></TD>\n");
						sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
						sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
						sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
						sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
				...
				sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
				sbufXML.append("  <TD DATA-ALIGN=\"daRight\"  BOLD=\"TRUE\" DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(Float.toString(totWeight));  sbufXML.append("]]></TD>\n");
				sbufXML.append("  <TD DATA-ALIGN=\"daRight\"  BOLD=\"TRUE\" DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(Float.toString(totMeasure)); sbufXML.append("]]></TD>\n");
				sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
				sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
				sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
				sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
				...
				for(int i = 0 ; i < realCnt ; i++){
					...
					*/
					...
					sbufXML.append("  <TD><![CDATA["); sbufXML.append(JSPUtil.getNull(nowColValues.get("cntr_mf_gds_desc"))); sbufXML.append("]]></TD>\n");
					sbufXML.append("  <TD DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(JSPUtil.getNull(nowColValues.get("pck_qty"))); sbufXML.append("]]></TD>\n");
					sbufXML.append("  <TD DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(JSPUtil.getNull(nowColValues.get("act_wgt"))); sbufXML.append("]]></TD>\n");
					sbufXML.append("  <TD DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(JSPUtil.getNull(nowColValues.get("meas_qty"))); sbufXML.append("]]></TD>\n");
					...
					if (!nowCustNm.equals(nexCustNm) && !nowFaxNo.equals(nexFaxNo)){		//Grand Total 	
						...
						sbufXML.append("  <TD DATA-ALIGN=\"daRight\" DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(Float.toString(grandWeight));  sbufXML.append("]]></TD>\n");
						sbufXML.append("  <TD DATA-ALIGN=\"daRight\" DATA-FORMAT=\"dfInteger\"><![CDATA["); sbufXML.append(Float.toString(grandMeasure)); sbufXML.append("]]></TD>\n");					
						sbufXML.append("  <TD><![CDATA[ ]]></TD>\n");
