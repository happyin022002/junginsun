...
*@FileName       : SearchMonthlyQuotaInquiry0139Tab03Sub01VO.java
*@FileTitle      : SearchMonthlyQuotaInquiry0139Tab03Sub01VO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiry0139Tab03Sub01VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiry0139Tab03Sub01VO> models = new ArrayList<SearchMonthlyQuotaInquiry0139Tab03Sub01VO>();
	...
	public SearchMonthlyQuotaInquiry0139Tab03Sub01VO() {}

	public SearchMonthlyQuotaInquiry0139Tab03Sub01VO(String ibflag, String pagerows, String key, String slevel, String tgtGrpCd, String trdCd, String dirCd, String rhqCd, String aqCd, String ofcCd, String subTrdCd, String rlaneCd, String convDirCd, String rowSeq, String item, String itemText, String val00, String val01, String val02, String val03) {
		this.val01 = val01;
		this.val02 = val02;
		this.val00 = val00;
		this.rhqCd = rhqCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tgt_grp_cd", getTgtGrpCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tgt_grp_cd", "tgtGrpCd");
	 ...
	 * @return tgtGrpCd
	 */
	public String getTgtGrpCd() {
		return this.tgtGrpCd;
	}
	 ...
	 * @param tgtGrpCd
	 */
	public void setTgtGrpCd(String tgtGrpCd) {
		this.tgtGrpCd = tgtGrpCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTgtGrpCd(JSPUtil.getParameter(request, "tgt_grp_cd", ""));
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiry0139Tab03Sub01VO[]
	 */
	public SearchMonthlyQuotaInquiry0139Tab03Sub01VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiry0139Tab03Sub01VO[]
	 */
	public SearchMonthlyQuotaInquiry0139Tab03Sub01VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiry0139Tab03Sub01VO model = null;
		...
		try {
			...
			String[] tgtGrpCd = (JSPUtil.getParameter(request, prefix	+ "tgt_grp_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiry0139Tab03Sub01VO();
				if (val01[i] != null)
		...
		return getSearchMonthlyQuotaInquiry0139Tab03Sub01VOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiry0139Tab03Sub01VO[]
	 */
	public SearchMonthlyQuotaInquiry0139Tab03Sub01VO[] getSearchMonthlyQuotaInquiry0139Tab03Sub01VOs(){
		SearchMonthlyQuotaInquiry0139Tab03Sub01VO[] vos = (SearchMonthlyQuotaInquiry0139Tab03Sub01VO[])models.toArray(new SearchMonthlyQuotaInquiry0139Tab03Sub01VO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tgtGrpCd = this.tgtGrpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
