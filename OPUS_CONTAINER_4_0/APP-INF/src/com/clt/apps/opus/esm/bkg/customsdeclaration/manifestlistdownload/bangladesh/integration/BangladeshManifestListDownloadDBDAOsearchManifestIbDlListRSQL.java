...
*@FileName : BangladeshManifestListDownloadDBDAOsearchManifestIbDlListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BangladeshManifestListDownloadDBDAOsearchManifestIbDlListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BangladeshManifestListDownloadDBDAOsearchManifestIbDlListRSQL(){
		setQuery();
		...
		query.append("FileName : BangladeshManifestListDownloadDBDAOsearchManifestIbDlListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  BL_LINE_NO LINE_NO," ).append("\n"); 
		query.append("		COM_ConstantMgr_PKG.COM_getScacCode_FNC()||BL_NO BL_NO," ).append("\n"); 
		query.append("  		NVL(BKG_CNTR_QTY,0) QTY," ).append("\n"); 
		query.append("  		PCK_DESC DESCRIPTION," ).append("\n"); 
		query.append("  		MK_DESC MARKS," ).append("\n"); 
		query.append("  		CSTMS_DESC GOODS_DESC," ).append("\n"); 
		query.append("  		to_char(to_date(SAIL_DT, 'YYYY-MM-DD'), 'YYYY-MM-DD') GOODS_DATE," ).append("\n"); 
		query.append("  		CNEE_LIC_NO CONS_LICE," ).append("\n"); 
		query.append("  		CNEE_RMK CONS_NM," ).append("\n"); 
		query.append("  		NTFY_LIC_NO NOTY_LICE," ).append("\n"); 
		query.append("  		NTFY_RMK NOTY_NM," ).append("\n"); 
		query.append("  		TRIM(TO_CHAR(NVL(CNTR_WGT,0),'999999999.99'))||' '||WGT_UT_CD BL_GROSS_WGT," ).append("\n"); 
		query.append("  		NET_WGT BL_NET_WGT," ).append("\n"); 
		query.append("  		CNTR_NO CNTR_NO," ).append("\n"); 
		query.append("  		MLT_CNTR_SEAL_NO_DESC SEAL," ).append("\n"); 
		query.append("  		DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', '20', '4', '40', '5', '40', '7', '45', '8', '48', '9', '48', ' ') CNTR_SIZE," ).append("\n"); 
		...
		query.append(" 	 	TRIM(to_char(NVL(CNTR_WGT,'0'), '99999999.99')) CNTR_GROSS_WGT,   		" ).append("\n"); 
		...
		query.append("  		BIL_RMK REMARKS," ).append("\n"); 
		...
		query.append("        ,HBL_FLG AS HBL_IND" ).append("\n"); 
		query.append("        ,BD_CNTR_LOC_CD AS CNTR_LOC_CD" ).append("\n"); 
		query.append("        ,DECODE(HBL_FLG, '1', 'MSB','HSB') AS HBL_CODE" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("    AND POL_CD      						like @[pol_code]||'%'" ).append("\n"); 
