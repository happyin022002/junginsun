...
*@FileName : KorImpPrtCntrVO.java
*@FileTitle : KorImpPrtCntrVO
*Open Issues :
*Change history :
...
public class KorImpPrtCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorImpPrtCntrVO> models = new ArrayList<KorImpPrtCntrVO>();
	...
	public KorImpPrtCntrVO() {}

	public KorImpPrtCntrVO(String ibflag, String pagerows, String cntrInfo, String dgClss) {
	 ...
	 */
	public KorImpPrtCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorImpPrtCntrVO[]
	 */
	public KorImpPrtCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorImpPrtCntrVO model = null;
	 ...
	 * @return KorImpPrtCntrVO[]
	 */
	public KorImpPrtCntrVO[] getKorImpPrtCntrVOs(){
		KorImpPrtCntrVO[] vos = (KorImpPrtCntrVO[])models.toArray(new KorImpPrtCntrVO[models.size()]);
		return vos;
	}
