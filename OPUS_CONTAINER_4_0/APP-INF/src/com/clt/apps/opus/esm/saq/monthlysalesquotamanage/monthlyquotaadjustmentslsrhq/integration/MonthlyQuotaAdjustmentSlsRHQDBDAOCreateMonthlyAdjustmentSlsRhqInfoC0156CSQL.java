...
*@FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOCreateMonthlyAdjustmentSlsRhqInfoC0156CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentSlsRHQDBDAOCreateMonthlyAdjustmentSlsRhqInfoC0156CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentSlsRHQDBDAOCreateMonthlyAdjustmentSlsRhqInfoC0156CSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOCreateMonthlyAdjustmentSlsRhqInfoC0156CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    LOD_TGT.POL_CD," ).append("\n"); 
		query.append("    LOD_TGT.POD_CD," ).append("\n"); 
		query.append("    LOD_TGT.SUB_TRD_CD," ).append("\n"); 
		query.append("    LOD_TGT.SLS_RHQ_CD," ).append("\n"); 
		query.append("    LOD_TGT.SLS_AQ_CD," ).append("\n"); 
		query.append("    LOD_TGT.LOD_QTY," ).append("\n"); 
		query.append("    LOD_TGT.GRS_RPB_REV," ).append("\n"); 
		query.append("    LOD_TGT.CM_UC_AMT," ).append("\n"); 
		query.append("    LOD_TGT.OPFIT_UC_AMT," ).append("\n"); 
		query.append("    LOD_TGT.RA_CM_UC_AMT," ).append("\n"); 
		query.append("    LOD_TGT.RA_OPFIT_UC_AMT," ).append("\n"); 
