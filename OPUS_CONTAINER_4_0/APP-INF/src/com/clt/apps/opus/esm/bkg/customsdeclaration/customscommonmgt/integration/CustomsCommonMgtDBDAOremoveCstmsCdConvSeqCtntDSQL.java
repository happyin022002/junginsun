...
*@FileName : CustomsCommonMgtDBDAOremoveCstmsCdConvSeqCtntDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomsCommonMgtDBDAOremoveCstmsCdConvSeqCtntDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomsCommonMgtDBDAOremoveCstmsCdConvSeqCtntDSQL(){
		setQuery();
		...
		query.append("FileName : CustomsCommonMgtDBDAOremoveCstmsCdConvSeqCtntDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
