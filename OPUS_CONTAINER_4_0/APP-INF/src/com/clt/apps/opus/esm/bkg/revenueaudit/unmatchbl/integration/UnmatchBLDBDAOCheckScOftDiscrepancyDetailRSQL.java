...
*@FileName : UnmatchBLDBDAOCheckScOftDiscrepancyDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 2015.06.28
*@LastModifier : 
*@LastVersion : 1.0
* 2015.06.28 
* 1.0 Creation
...
public class UnmatchBLDBDAOCheckScOftDiscrepancyDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UnmatchBLDBDAOCheckScOftDiscrepancyDetailRSQL
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckScOftDiscrepancyDetailRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckScOftDiscrepancyDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
