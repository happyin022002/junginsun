...
*@FileName : CargoReleaseOrderDBDAOsearchUsCgoRlseBlStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchUsCgoRlseBlStatusRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchUsCgoRlseBlStatusRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchUsCgoRlseBlStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       DECODE(B.OBL_SRND_FLG,'Y','S', NVL(DECODE(A.BL_TP_CD,'W',DECODE(B.OBL_RLSE_FLG,'Y','W','B')),'B')) AS BL_STATUS," ).append("\n"); 
		...
		query.append("       SUBSTR(DECODE(SUBSTR(A.DEL_CD,1,2),'US',A.DEL_CD," ).append("\n"); 
		query.append("              DECODE(SUBSTR(F.DEL_CD,1,2),'US',F.DEL_CD,F.CSTMS_PORT_CD)),1,2) DEL_CD," ).append("\n"); 
