...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutViaGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutViaGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutViaGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutViaGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                ,ORG_DEST_TP_CD" ).append("\n"); 
		query.append("                ,DENSE_RANK() OVER(PARTITION BY SVC_SCP_CD, GLINE_SEQ, PRC_CUST_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD ORDER BY ROUT_VIA_SEQ) AS ROUT_VIA_SEQ" ).append("\n"); 
		query.append("                ,ROUT_VIA_PORT_TP_CD" ).append("\n"); 
		query.append("                ,ROUT_VIA_PORT_DEF_CD" ).append("\n"); 
