...
*@FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtCmdtRoutCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOGlineCopyPriSpScpRtCmdtRoutCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOGlineCopyPriSpScpRtCmdtRoutCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtCmdtRoutCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , 0 AS NOTE_DP_SEQ" ).append("\n"); 
