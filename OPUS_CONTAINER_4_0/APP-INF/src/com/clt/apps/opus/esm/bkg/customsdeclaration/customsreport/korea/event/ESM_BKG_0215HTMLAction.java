...
public class ESM_BKG_0215HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0215HTMLAction 객체를 생성
	 */
	public ESM_BKG_0215HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0215Event event = new EsmBkg0215Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setCstmsVvdInfoVO((BkgCstmsKrDlHisVO)getVO(request, BkgCstmsKrDlHisVO.class));
		}
