...
*@FileName : AGTAuditDBDAOModifyRejectAGTCommForAuditUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOModifyRejectAGTCommForAuditUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyRejectAGTCommForAudit
	  * </pre>
	  */
	public AGTAuditDBDAOModifyRejectAGTCommForAuditUSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOModifyRejectAGTCommForAuditUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
