...
*@FileName : CndManifestListDownloadDBDAOaddBkgCstmsAdvCntrMfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndManifestListDownloadDBDAOaddBkgCstmsAdvCntrMfCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndManifestListDownloadDBDAOaddBkgCstmsAdvCntrMfCSQL(){
		setQuery();
		...
		query.append("FileName : CndManifestListDownloadDBDAOaddBkgCstmsAdvCntrMfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO  BKG_CSTMS_ADV_CNTR_MF" ).append("\n"); 
		query.append("(" ).append("\n"); 
