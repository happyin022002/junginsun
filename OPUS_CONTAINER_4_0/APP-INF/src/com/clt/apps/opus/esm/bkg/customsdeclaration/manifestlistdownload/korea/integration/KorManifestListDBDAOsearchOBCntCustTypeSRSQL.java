...
*@FileName : KorManifestListDBDAOsearchOBCntCustTypeSRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchOBCntCustTypeSRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OutBound 일 경우일 경우에는 Type = 'S'를 구한다.
	  * </pre>
	  */
	public KorManifestListDBDAOsearchOBCntCustTypeSRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchOBCntCustTypeSRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("(SELECT BKG_NO, CSTMS_DECL_TP_CD, DMST_PORT_CD, MAX(TRNS_SEQ), 'S'" ).append("\n");
