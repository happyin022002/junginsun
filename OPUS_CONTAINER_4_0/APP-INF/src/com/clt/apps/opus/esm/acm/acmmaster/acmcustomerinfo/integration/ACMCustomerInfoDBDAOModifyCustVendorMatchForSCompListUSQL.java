...
*@FileName : ACMCustomerInfoDBDAOModifyCustVendorMatchForSCompListUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMCustomerInfoDBDAOModifyCustVendorMatchForSCompListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCustomerInfoDBDAOModifyCustVendorMatchForSCompListUSQL(){
		setQuery();
		...
		query.append("FileName : ACMCustomerInfoDBDAOModifyCustVendorMatchForSCompListUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("UPDATE ACM_SPCL_CUST_VNDR_MTCH" ).append("\n");
		query.append("   SET CUST_CNT_CD = SUBSTR(@[cust_cnt_seq], 1, 2)," ).append("\n");
