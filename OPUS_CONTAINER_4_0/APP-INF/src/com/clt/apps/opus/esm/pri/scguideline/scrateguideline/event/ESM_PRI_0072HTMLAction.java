 ...
 *@FileName : ESM_PRI_0072HTMLAction.java
...
public class ESM_PRI_0072HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0072Event event = new EsmPri0072Event();
