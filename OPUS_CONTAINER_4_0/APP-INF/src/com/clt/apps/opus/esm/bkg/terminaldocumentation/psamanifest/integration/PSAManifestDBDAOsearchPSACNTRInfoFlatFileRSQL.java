...
public class PSAManifestDBDAOsearchPSACNTRInfoFlatFileRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT NVL(PS.TS_TP_CD, '') AS TS_TP_CD," ).append("\n"); 
		...
		query.append("       NVL(N3RD_POD_CD, (SELECT DECODE(PT2.PSA_LOC_CD, NULL, DECODE(PT1.PSA_LOC_CD, NULL, NVL(MDM.UN_LOC_CD, MDM.LOC_CD), PT1.PSA_LOC_CD), PT2.PSA_LOC_CD)" ).append("\n"); 
		...
		query.append("                            AND BV.POD_CD = PS.N1ST_POD_CD" ).append("\n"); 
		...
		query.append("                            AND PS.N1ST_POD_CD = MDM.LOC_CD(+)" ).append("\n"); 
		...
		query.append("               MDM_LOCATION MDM" ).append("\n"); 
		query.append("         WHERE BV.BKG_NO = PS.BKG_NO" ).append("\n"); 
		query.append("           AND BV.POD_CD = PS.N2ND_POD_CD" ).append("\n"); 
		query.append("           AND BV.POD_CD = PT1.LOC_CD(+)" ).append("\n"); 
		query.append("           AND LENGTH(PT1.TML_CD(+)) = 5" ).append("\n"); 
		query.append("           AND BV.POD_CD = PT2.LOC_CD(+)" ).append("\n"); 
		query.append("           AND BV.POD_YD_CD = PT2.TML_CD(+)" ).append("\n"); 
		query.append("           AND PS.N2ND_POD_CD = MDM.LOC_CD(+)" ).append("\n"); 
		...
		query.append("               MDM_LOCATION MDM" ).append("\n"); 
		query.append("         WHERE BV.BKG_NO = PS.BKG_NO" ).append("\n"); 
		query.append("           AND BV.POD_CD = PS.POD_CD" ).append("\n"); 
		query.append("           AND BV.POD_CD = PT1.LOC_CD(+)" ).append("\n"); 
		query.append("           AND LENGTH(PT1.TML_CD(+)) = 5" ).append("\n"); 
		query.append("           AND BV.POD_CD = PT2.LOC_CD(+)" ).append("\n"); 
		query.append("           AND BV.POD_YD_CD = PT2.TML_CD(+)" ).append("\n"); 
		query.append("           AND PS.POD_CD = MDM.LOC_CD(+)" ).append("\n"); 
		...
		query.append("               MDM_LOCATION MDM" ).append("\n"); 
		query.append("         WHERE BV.BKG_NO = PS.BKG_NO" ).append("\n"); 
		query.append("           AND BV.POL_CD = PS.POL_CD" ).append("\n"); 
		query.append("           AND BV.POL_CD = PT1.LOC_CD(+)" ).append("\n"); 
		query.append("           AND LENGTH(PT1.TML_CD(+)) = 5" ).append("\n"); 
		query.append("           AND BV.POL_CD = PT2.LOC_CD(+)" ).append("\n"); 
		query.append("           AND BV.POL_YD_CD = PT2.TML_CD(+)" ).append("\n"); 
		query.append("           AND PS.POL_CD = MDM.LOC_CD(+)" ).append("\n"); 
		query.append("           AND ROWNUM = 1) AS POL_CD," ).append("\n"); 
		query.append("       (SELECT DECODE(PT1.PSA_LOC_CD, NULL, NVL(MDM.UN_LOC_CD, MDM.LOC_CD), PT1.PSA_LOC_CD)" ).append("\n"); 
		query.append("          FROM BKG_CSTMS_PSA_PORT PT1," ).append("\n"); 
		query.append("               BKG_BOOKING BV," ).append("\n"); 
		query.append("               MDM_LOCATION MDM" ).append("\n"); 
		query.append("         WHERE BV.BKG_NO = PS.BKG_NO" ).append("\n"); 
		query.append("           AND BV.POR_CD = PT1.LOC_CD(+)" ).append("\n"); 
		...
		query.append("               MDM_LOCATION MDM" ).append("\n"); 
		query.append("         WHERE BV.BKG_NO = PS.BKG_NO" ).append("\n"); 
		query.append("           AND BV.DEL_CD = PT1.LOC_CD(+)" ).append("\n"); 
		query.append("           AND LENGTH(PT1.TML_CD(+)) = 5" ).append("\n"); 
		...
		query.append("         WHERE BKG_NO = PS.BKG_NO" ).append("\n"); 
		query.append("           AND POL_CD LIKE 'SG%'" ).append("\n"); 
		query.append("           AND ROWNUM = 1) AS SLAN_CD," ).append("\n"); 
		query.append("       PS.PSA_CRE_TP_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("  FROM BKG_CSTMS_PSA_VVD PV," ).append("\n"); 
		query.append("       BKG_CSTMS_PSA_IMP_STS PS," ).append("\n"); 
		query.append("       BKG_CSTMS_PSA_IMP_STS_SPCL PC," ).append("\n"); 
