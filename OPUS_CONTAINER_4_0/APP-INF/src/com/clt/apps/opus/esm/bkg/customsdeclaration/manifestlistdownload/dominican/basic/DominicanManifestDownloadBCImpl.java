...
import com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.dominican.integration.DominicanManifestDownloadDBDAO;
 ...
 * @since J2EE 1.4
 */
public class DominicanManifestDownloadBCImpl extends BasicCommandSupport implements DominicanManifestDownloadBC {
...
//					rootElement.appendChild(manifestBL);	
				...
				// xml 헤더 제거
				token = new StringTokenizer(sw.toString(), "\n");
				String strToken = "";
				int ii = 0;
				while (token.hasMoreTokens()) {
					strToken = token.nextToken();
					//if (ii > 0) {
						ret.append(strToken).append("\n");
