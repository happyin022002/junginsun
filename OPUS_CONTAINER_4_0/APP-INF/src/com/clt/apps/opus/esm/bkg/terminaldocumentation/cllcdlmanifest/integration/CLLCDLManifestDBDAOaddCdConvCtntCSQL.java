...
*@FileName : CLLCDLManifestDBDAOaddCdConvCtntCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class CLLCDLManifestDBDAOaddCdConvCtntCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLLCDLManifestDBDAOaddCdConvCtntCSQL(){
		setQuery();
		...
		query.append("FileName : CLLCDLManifestDBDAOaddCdConvCtntCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("	@[cnt_cd]" ).append("\n");
		query.append(",	@[cstms_div_id]" ).append("\n");
		query.append(",	(SELECT NVL(MAX(CSTMS_DIV_ID_SEQ), 0) + 1 FROM BKG_CSTMS_CD_CONV_CTNT WHERE CNT_CD = @[cnt_cd] AND CSTMS_DIV_ID = @[cstms_div_id])" ).append("\n");
		query.append(",	@[attr_ctnt1]" ).append("\n");
		query.append(",	@[attr_ctnt2]" ).append("\n");
		query.append(",	@[attr_ctnt3]" ).append("\n");
		query.append(",	@[attr_ctnt4]" ).append("\n");
