...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportGeneral2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportGeneral2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportGeneral2RSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportGeneral2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              ,SUM(DECODE(SUBSTR(QUA.CNTR_TPSZ_CD,-1),'2',NVL(QUA.OP_CNTR_QTY,0),0)) TEU" ).append("\n"); 
		query.append("              ,SUM(DECODE(SUBSTR(QUA.CNTR_TPSZ_CD,-1),'2',0,NVL(QUA.OP_CNTR_QTY,0))) FEU" ).append("\n"); 
		query.append("              ,SUM(DECODE(SUBSTR(QUA.CNTR_TPSZ_CD,-1),'2',NVL(QUA.OP_CNTR_QTY,0),NVL(QUA.OP_CNTR_QTY,0)*2)) TTL " ).append("\n"); 
		...
		query.append("#if (${r_option} == 'V')" ).append("\n"); 
		query.append(" ORDER BY SALE.TTL DESC" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(" ORDER BY SALE.TEU_GROSS DESC, SALE.FEU_GROSS DESC" ).append("\n"); 
		query.append("#end" ).append("\n"); 
