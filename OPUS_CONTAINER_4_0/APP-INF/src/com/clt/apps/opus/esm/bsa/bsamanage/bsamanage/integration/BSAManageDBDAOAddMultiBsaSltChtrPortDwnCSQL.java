...
*@FileName : BSAManageDBDAOAddMultiBsaSltChtrPortDwnCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOAddMultiBsaSltChtrPortDwnCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BSA_0026 화면의 Bsa_Slt_Chtr_Port_Dwn INSERT
	  * </pre>
	  */
	public BSAManageDBDAOAddMultiBsaSltChtrPortDwnCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOAddMultiBsaSltChtrPortDwnCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
