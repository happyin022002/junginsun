...
*@FileName : SCNoteProposalDBDAOPropCpPriSpScpNoteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPropCpPriSpScpNoteCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_NOTE Insert
	  * </pre>
	  */
	public SCNoteProposalDBDAOPropCpPriSpScpNoteCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPropCpPriSpScpNoteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
