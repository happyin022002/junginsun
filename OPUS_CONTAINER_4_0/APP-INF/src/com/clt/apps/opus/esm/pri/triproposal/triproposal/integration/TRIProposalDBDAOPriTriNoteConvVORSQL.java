...
*@FileName : TRIProposalDBDAOPriTriNoteConvVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriNoteConvVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriNoteConvVORSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriNoteConvVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, DECODE(TO_CHAR(A.EXP_DT,'YYYYMMDD'),'99991231','',TO_CHAR(A.EXP_DT,'YYYYMMDD')) EXP_DT" ).append("\n"); 
		...
		query.append("		, A.CURR_CD					ASC NULLS FIRST" ).append("\n"); 
