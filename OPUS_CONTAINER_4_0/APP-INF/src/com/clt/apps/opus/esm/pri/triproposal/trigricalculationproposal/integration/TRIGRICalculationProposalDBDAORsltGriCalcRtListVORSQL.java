...
*@FileName : TRIGRICalculationProposalDBDAORsltGriCalcRtListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAORsltGriCalcRtListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAORsltGriCalcRtListVORSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAORsltGriCalcRtListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_TRI_GRI_RT" ).append("\n"); 
