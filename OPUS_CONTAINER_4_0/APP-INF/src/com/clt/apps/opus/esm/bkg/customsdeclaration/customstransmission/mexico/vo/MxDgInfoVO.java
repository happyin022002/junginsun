...
*@FileName : MxDgInfoVO.java
*@FileTitle : MxDgInfoVO
*Open Issues :
*Change history :
...
public class MxDgInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MxDgInfoVO> models = new ArrayList<MxDgInfoVO>();
	 ...
	 * @return MxDgInfoVO[]
	 */
	public MxDgInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MxDgInfoVO[]
	 */
	public MxDgInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MxDgInfoVO model = null;
	 ...
	 * @return MxDgInfoVO[]
	 */
	public MxDgInfoVO[] getMxDgInfoVOs(){
		MxDgInfoVO[] vos = (MxDgInfoVO[])models.toArray(new MxDgInfoVO[models.size()]);
		return vos;
	}
