...
*@FileName : AusCuscarCstmsInfoVO.java
*@FileTitle : AusCuscarCstmsInfoVO
*Open Issues :
*Change history :
...
public class AusCuscarCstmsInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AusCuscarCstmsInfoVO> models = new ArrayList<AusCuscarCstmsInfoVO>();
	...
	public AusCuscarCstmsInfoVO() {}

	public AusCuscarCstmsInfoVO(String ibflag, String pagerows, String customerType, String customerCd, String customerNm1, String customerNm2, String customerAddr1, String customerAddr2, String customerAddr3, String contactNm, String contactTel, String contactFax, String contactEmail) {
...
/**
	 ...
	 * @param request
	 * @return AusCuscarCstmsInfoVO[]
	 */
	public AusCuscarCstmsInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusCuscarCstmsInfoVO[]
	 */
	public AusCuscarCstmsInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusCuscarCstmsInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AusCuscarCstmsInfoVO();
		...
		return getAusCuscarCstmsInfoVOs();
	}
	 ...
	 * @return AusCuscarCstmsInfoVO[]
	 */
	public AusCuscarCstmsInfoVO[] getAusCuscarCstmsInfoVOs(){
		AusCuscarCstmsInfoVO[] vos = (AusCuscarCstmsInfoVO[])models.toArray(new AusCuscarCstmsInfoVO[models.size()]);
		return vos;
	}
