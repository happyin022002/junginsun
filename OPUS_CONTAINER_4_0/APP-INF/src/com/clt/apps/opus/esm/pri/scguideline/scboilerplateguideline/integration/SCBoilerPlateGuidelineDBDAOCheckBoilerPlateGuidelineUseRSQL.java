...
*@FileName : SCBoilerPlateGuidelineDBDAOCheckBoilerPlateGuidelineUseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateGuidelineDBDAOCheckBoilerPlateGuidelineUseRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * the count of PRI_SP_MN about BLPL_HDR_SEQ
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOCheckBoilerPlateGuidelineUseRSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOCheckBoilerPlateGuidelineUseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
