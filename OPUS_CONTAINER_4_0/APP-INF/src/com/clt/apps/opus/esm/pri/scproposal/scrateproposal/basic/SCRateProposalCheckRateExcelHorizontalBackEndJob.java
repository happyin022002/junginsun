...
*@FileName : SCRateProposalCheckRateExcelHorizontalBackEndJob.java
*@FileTitle : S/C Excel Check BackEndJob
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
/**
 * handling a biz logic about Check S/C Contract Rate Excel Info
 * 
 * @author 
 * @see SCRateProposalBCImpl
 * @since J2EE 1.6
 */
public class SCRateProposalCheckRateExcelHorizontalBackEndJob extends BackEndCommandSupport{
	...
	/**
	 * Check S/C Contract Rate Info Of Excel(Call SCRateProposalBCImpl.checkRateExcelHorizontal) <br>
	 *  
	 ...
	 */
	 public List<RsltRtListHorizontalExcelVO> doStart() throws Exception {
		 ...
		 try {
			...
			resultVOS = cmd.checkRateExcelHorizontal(priSpScpRtCmdtHdrVO, rsltRtListHorizontalExcelVOS, termOrgCodeList, termDestCodeList, trspModCodeList, account);
