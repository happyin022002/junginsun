...
*@FileName : RsltPriSpSubMqcHisVO.java
*@FileTitle : RsltPriSpSubMqcHisVO
*Open Issues :
*Change history :
...
public class RsltPriSpSubMqcHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpSubMqcHisVO> models = new ArrayList<RsltPriSpSubMqcHisVO>();
	...
	public RsltPriSpSubMqcHisVO() {}

	public RsltPriSpSubMqcHisVO(String ibflag, String pagerows, String subMqcCtnt, String effDt, String expDt, String srcInfoNm, String prcProgStsNm, String acptUsrNm, String acptDt, String amdtSeq, String n1stCmncAmdtSeq) {
		this.effDt = effDt;
		this.ibflag = ibflag;
		this.acptDt = acptDt;
	 ...
	 * @param request
	 * @return RsltPriSpSubMqcHisVO[]
	 */
	public RsltPriSpSubMqcHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSpSubMqcHisVO[]
	 */
	public RsltPriSpSubMqcHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpSubMqcHisVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSpSubMqcHisVO();
				if (effDt[i] != null)
		...
		return getRsltPriSpSubMqcHisVOs();
	}
	 ...
	 * @return RsltPriSpSubMqcHisVO[]
	 */
	public RsltPriSpSubMqcHisVO[] getRsltPriSpSubMqcHisVOs(){
		RsltPriSpSubMqcHisVO[] vos = (RsltPriSpSubMqcHisVO[])models.toArray(new RsltPriSpSubMqcHisVO[models.size()]);
		return vos;
	}
