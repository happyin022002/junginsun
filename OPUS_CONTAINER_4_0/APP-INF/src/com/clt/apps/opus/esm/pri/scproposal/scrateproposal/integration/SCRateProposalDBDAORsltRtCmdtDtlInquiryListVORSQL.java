...
*@FileName : SCRateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY CMDT_HDR_SEQ, DECODE(PRC_CMDT_TP_CD, 'G', 1, 'C', 2, 99), PRC_CMDT_DEF_CD ,CMDT_SEQ" ).append("\n"); 
