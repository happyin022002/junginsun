...
*@FileName : SearchSlipApprovalTaxDetailVO.java
*@FileTitle : SearchSlipApprovalTaxDetailVO
*Open Issues :
*Change history :
...
public class SearchSlipApprovalTaxDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSlipApprovalTaxDetailVO> models = new ArrayList<SearchSlipApprovalTaxDetailVO>();
	...
	public SearchSlipApprovalTaxDetailVO() {}

	public SearchSlipApprovalTaxDetailVO(String ibflag, String pagerows, String itmNm, String splAmt, String taxAmt) {
		this.ibflag = ibflag;
		this.taxAmt = taxAmt;
		this.splAmt = splAmt;
		this.itmNm = itmNm;
	 ...
	 */
	public SearchSlipApprovalTaxDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSlipApprovalTaxDetailVO[]
	 */
	public SearchSlipApprovalTaxDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSlipApprovalTaxDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSlipApprovalTaxDetailVO();
				if (ibflag[i] != null)
		...
		return getSearchSlipApprovalTaxDetailVOs();
	}
	 ...
	 * @return SearchSlipApprovalTaxDetailVO[]
	 */
	public SearchSlipApprovalTaxDetailVO[] getSearchSlipApprovalTaxDetailVOs(){
		SearchSlipApprovalTaxDetailVO[] vos = (SearchSlipApprovalTaxDetailVO[])models.toArray(new SearchSlipApprovalTaxDetailVO[models.size()]);
		return vos;
	}
