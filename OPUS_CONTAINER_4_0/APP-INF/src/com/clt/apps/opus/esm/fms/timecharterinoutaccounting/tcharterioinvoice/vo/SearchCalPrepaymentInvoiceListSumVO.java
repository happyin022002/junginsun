...
*@FileName : SearchCalPrepaymentInvoiceListSumVO.java
*@FileTitle : SearchCalPrepaymentInvoiceListSumVO
*Open Issues :
*Change history :
...
public class SearchCalPrepaymentInvoiceListSumVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchCalPrepaymentInvoiceListSumVO> models = new ArrayList<SearchCalPrepaymentInvoiceListSumVO>();
	 ...
	 * @return 
	 */
	public SearchCalPrepaymentInvoiceListSumVO() {}
	 ...
	 * @return 
	 */
	public SearchCalPrepaymentInvoiceListSumVO(String ibflag, String pagerows, String currCd, String invAmt, String currCd2, String invAmt2) {
		this.ibflag = ibflag;
		this.currCd = currCd;
	 ...
	 */
	public SearchCalPrepaymentInvoiceListSumVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCalPrepaymentInvoiceListSumVO[]
	 */
	public SearchCalPrepaymentInvoiceListSumVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchCalPrepaymentInvoiceListSumVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchCalPrepaymentInvoiceListSumVO();
				if (ibflag[i] != null)
		...
		return getSearchCalPrepaymentInvoiceListSumVOs();
	}
	 ...
	 * @return SearchCalPrepaymentInvoiceListSumVO[]
	 */
	public SearchCalPrepaymentInvoiceListSumVO[] getSearchCalPrepaymentInvoiceListSumVOs(){
		SearchCalPrepaymentInvoiceListSumVO[] vos = (SearchCalPrepaymentInvoiceListSumVO[])models.toArray(new SearchCalPrepaymentInvoiceListSumVO[models.size()]);
		return vos;
	}
