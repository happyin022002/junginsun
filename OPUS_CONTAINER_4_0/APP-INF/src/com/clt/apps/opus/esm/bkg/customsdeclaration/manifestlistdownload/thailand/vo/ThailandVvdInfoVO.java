...
*@FileName : ThailandVvdInfoVO.java
*@FileTitle : ThailandVvdInfoVO
*Open Issues :
*Change history :
...
public class ThailandVvdInfoVO extends CstmsVvdInfoVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<ThailandVvdInfoVO> models = new ArrayList<ThailandVvdInfoVO>();
	...
	public ThailandVvdInfoVO() {}

	public ThailandVvdInfoVO(String ibflag, String pagerows, String trnkVvd, String feeder, String polCd, String podCd, String etaDt, String subtotal, String sVvd, String sDelCd, String sDelNodCd, String sPolCd) {
		this.podCd = podCd;
...
/**
	 ...
	 */
	public ThailandVvdInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ThailandVvdInfoVO[]
	 */
	public ThailandVvdInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ThailandVvdInfoVO model = null;
	 ...
	 * @return ThailandVvdInfoVO[]
	 */
	public ThailandVvdInfoVO[] getThailandVvdInfoVOs(){
		ThailandVvdInfoVO[] vos = (ThailandVvdInfoVO[])models.toArray(new ThailandVvdInfoVO[models.size()]);
		return vos;
	}
