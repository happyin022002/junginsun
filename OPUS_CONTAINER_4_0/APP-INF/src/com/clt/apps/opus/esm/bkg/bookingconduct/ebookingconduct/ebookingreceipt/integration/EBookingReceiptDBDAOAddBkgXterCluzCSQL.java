...
*@FileName : EBookingReceiptDBDAOAddBkgXterCluzCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOAddBkgXterCluzCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOAddBkgXterCluzCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOAddBkgXterCluzCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" (SELECT NVL(MAX(XTER_BL_CLUZ_SEQ), 0) + 1 " ).append("\n"); 
		query.append("   FROM BKG_XTER_CLUZ" ).append("\n"); 
