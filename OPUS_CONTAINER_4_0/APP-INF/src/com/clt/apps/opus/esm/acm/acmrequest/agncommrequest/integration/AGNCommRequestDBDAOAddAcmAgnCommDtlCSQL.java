...
public class AGNCommRequestDBDAOAddAcmAgnCommDtlCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(BKG_NO, AGN_CD, IO_BND_CD, AC_TP_CD, AC_SEQ, CNTR_TPSZ_CD, BKG_VOL_QTY, IF_DTRB_AMT, CURR_CD, PAY_IF_DTRB_AMT, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT)" ).append("\n"); 
		...
		query.append("  AND H.REV_DIV_CD IS NOT NULL" ).append("\n"); 
