...
*@FileName : PlanningDBDAOCreateTransferCsqSctrPairCostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOCreateTransferCsqSctrPairCostCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [CSQ_SCTR_PAIR_COST] 데이터를 1Q로 복사한다.
	  * </pre>
	  */
	public PlanningDBDAOCreateTransferCsqSctrPairCostCSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOCreateTransferCsqSctrPairCostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CSQ_SCTR_PAIR_COST(BSE_TP_CD, BSE_YR, BSE_QTR_CD, RLANE_CD, DIR_CD, POL_CD, POD_CD, TRD_CD, SUB_TRD_CD, GID_PA_CM_UC_AMT, GID_RA_CM_UC_AMT, PA_CM_UC_AMT, RA_CM_UC_AMT, ADD_FLG, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT )" ).append("\n"); 
