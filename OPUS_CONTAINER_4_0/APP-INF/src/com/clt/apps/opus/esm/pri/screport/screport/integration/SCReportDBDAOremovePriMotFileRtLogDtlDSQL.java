...
*@FileName : SCReportDBDAOremovePriMotFileRtLogDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAOremovePriMotFileRtLogDtlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCReportDBDAOremovePriMotFileRtLogDtlDSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAOremovePriMotFileRtLogDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM	PRI_MOT_FILE_RT_LOG_DTL" ).append("\n"); 
