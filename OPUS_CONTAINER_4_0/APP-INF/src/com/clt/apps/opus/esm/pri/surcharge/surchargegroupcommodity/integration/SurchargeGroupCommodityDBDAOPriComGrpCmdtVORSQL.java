...
*@FileName : SurchargeGroupCommodityDBDAOPriComGrpCmdtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeGroupCommodityDBDAOPriComGrpCmdtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SurchargeGroupCommodityDBDAOPriComGrpCmdtVORSQL(){
		setQuery();
		...
		query.append("FileName : SurchargeGroupCommodityDBDAOPriComGrpCmdtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY SCG_GRP_CMDT_CD" ).append("\n"); 
