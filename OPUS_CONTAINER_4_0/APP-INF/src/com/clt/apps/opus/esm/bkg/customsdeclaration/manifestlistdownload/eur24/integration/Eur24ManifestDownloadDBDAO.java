...
import com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.eur24.vo.Eur24VesselFIArrivalCondVO;
...
/**
 * OPUS Eur24ManifestDownloadDBDAO <br>
...
public class Eur24ManifestDownloadDBDAO extends DBDAOSupport{
	...
	public List<ManifestListDetailVO> searchEur24BlManifestList(ManifestListCondVO manifestListCondVO,SignOnUserAccount account) throws DAOException {
		DBRowSet dbRowset = null;
		List<ManifestListDetailVO> list = null;
		manifestListCondVO.setUpdUsrId(account.getUsr_id());
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Eur24BlGeneralInfoVO searchBlGeneral(String blNo, String vvd,String cstmsPortCd, String cstmsYdCd, SignOnUserAccount account) throws DAOException {
		DBRowSet dbRowset = null;
		...
		try{
			...
			param.put("account", usrId);
			velParam.put("account", usrId);
