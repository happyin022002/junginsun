...
*@FileName : NetworkCostDBDAOPndlmSvcDtlHeadRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOPndlmSvcDtlHeadRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOPndlmSvcDtlHeadRSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOPndlmSvcDtlHeadRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 WHERE SLAN_CD = NVL(@[f_selslane],SLAN_CD) " ).append("\n"); 
