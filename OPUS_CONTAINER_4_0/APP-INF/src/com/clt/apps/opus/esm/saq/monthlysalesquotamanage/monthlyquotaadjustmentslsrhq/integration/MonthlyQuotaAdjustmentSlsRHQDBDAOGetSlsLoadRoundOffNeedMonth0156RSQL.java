...
*@FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOGetSlsLoadRoundOffNeedMonth0156RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentSlsRHQDBDAOGetSlsLoadRoundOffNeedMonth0156RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentSlsRHQDBDAOGetSlsLoadRoundOffNeedMonth0156RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOGetSlsLoadRoundOffNeedMonth0156RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
