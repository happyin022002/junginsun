...
*@FileName : AusSearchContainerDescVO.java
*@FileTitle : AusSearchContainerDescVO
*Open Issues :
*Change history :
...
public class AusSearchContainerDescVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusSearchContainerDescVO> models = new ArrayList<AusSearchContainerDescVO>();
	...
	public AusSearchContainerDescVO() {}

	public AusSearchContainerDescVO(String ibflag, String pagerows, String dCmdt, String dPunit, String dPkg, String dWgt, String dMeas, String dDesc, String dMark) {
		this.dMark = dMark;
		this.ibflag = ibflag;
		this.dMeas = dMeas;
		this.dDesc = dDesc;
	 ...
	 * @param request
	 * @return AusSearchContainerDescVO[]
	 */
	public AusSearchContainerDescVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusSearchContainerDescVO[]
	 */
	public AusSearchContainerDescVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusSearchContainerDescVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AusSearchContainerDescVO();
				if (dMark[i] != null)
		...
		return getAusSearchContainerDescVOs();
	}
	 ...
	 * @return AusSearchContainerDescVO[]
	 */
	public AusSearchContainerDescVO[] getAusSearchContainerDescVOs(){
		AusSearchContainerDescVO[] vos = (AusSearchContainerDescVO[])models.toArray(new AusSearchContainerDescVO[models.size()]);
		return vos;
	}
