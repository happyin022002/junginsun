...
*@FileName : AncsCstmsBlVO.java
*@FileTitle : AncsCstmsBlVO
*Open Issues :
*Change history :
...
public class AncsCstmsBlVO extends BlDetailVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<AncsCstmsBlVO> models = new ArrayList<AncsCstmsBlVO>();
	...
	public AncsCstmsBlVO() {}

	public AncsCstmsBlVO(String ibflag, String pagerows, String blNo, String vvdSeq, String vvd, String svcRqstNo, 
			String cstmsPrcCd, String anrMsgStsCd, String blLastEdi, String faxNo, String ntfyEml, String shprAddr, 
			String shprName, String cneeAddr, String cneeName, String ntfyNm, String ntfyAddr, String bkgNo, String blAck, String blLastEdi2, String actWgt, String actWgtUtCd, String pckQty, String pckTpCd) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setNtfyAddr(JSPUtil.getParameter(request, "bkg_no", ""));
	 ...
	 */
	public AncsCstmsBlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AncsCstmsBlVO[]
	 */
	public AncsCstmsBlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AncsCstmsBlVO model = null;
		...
		try {
			...
			String[] blLastEdi2 = (JSPUtil.getParameter(request, prefix	+ "bl_last_edi2".trim(), length));
	...
	public AncsCstmsBlVO[] getAncsCstmsBlVOs(){
		AncsCstmsBlVO[] vos = (AncsCstmsBlVO[])models.toArray(new AncsCstmsBlVO[models.size()]);
		return vos;
	}
