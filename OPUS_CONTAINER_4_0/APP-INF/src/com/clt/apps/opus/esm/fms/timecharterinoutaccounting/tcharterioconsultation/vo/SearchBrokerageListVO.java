...
public class SearchBrokerageListVO extends AbstractValueObject {
    ...
    public SearchBrokerageListVO(String ibflag, String pagerows, String invDesc, String effDt, String expDt, String acctItmNm, String acctCd, String acctItmSeq, String currCd, String invAmt, String vvdCd, String fletCtrtNo, String fletIssTpCd, String invSeq, String invDtlSeq, String fletCtrtTpCd, String vvdCdTxt) {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("vvd_cd_txt", getVvdCdTxt());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("vvd_cd_txt", "vvdCdTxt");
    ...
    public void setVvdCdTxt(String vvdCdTxt) {
        this.vvdCdTxt = vvdCdTxt;
    }

    public String getVvdCdTxt() {
        return this.vvdCdTxt;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setVvdCdTxt(JSPUtil.getParameter(request, "vvd_cd_txt", ""));
    }
    ...
    public SearchBrokerageListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] vvdCdTxt = (JSPUtil.getParameter(request, prefix + "vvd_cd_txt", length));
	...
	*/
    public void unDataFormat() {
        ...
        this.vvdCdTxt = this.vvdCdTxt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
