...
*@FileName : KorDoRlseVO.java
*@FileTitle : KorDoRlseVO
*Open Issues :
*Change history :
...
public class KorDoRlseVO extends AbstractValueObject {

   /**
    *
    */
    private static final long serialVersionUID = -2701380665960045263L;	
	
	private Collection<KorDoRlseVO> models = new ArrayList<KorDoRlseVO>();
	...
	public KorDoRlseVO(String ibflag, String pagerows, String bkgNo, String cstmsRefNm, String cstmsRefCtnt, String cstmsAsgnNm, String cstmsAsgnCtnt, String interRmk, String doHldFlg, String creUsrId, String creDt, String updUsrId, String updDt, String cyOpCd, String infoCgoFlg, String idaImpGenMfNo, String idaCgorOrdYr, String idaCstmsAsgnLineNo, String doSplitFlg, String oblCngFlg, String doCngEvntCd, String oldOblRdemKnt, String newOblRdemKnt, String doNo, String rlseStsCd, String podCd, String rlseSeq, String selfTrnsFlg, String discLocCd,String cgorRmk) {
	 ...
	 * @return KorDoRlseVO[]
	 */
	public KorDoRlseVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDoRlseVO[]
	 */
	public KorDoRlseVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDoRlseVO model = null;
	 ...
	 * @return KorDoRlseVO[]
	 */
	public KorDoRlseVO[] getKorDoRlseVOs(){
		KorDoRlseVO[] vos = (KorDoRlseVO[])models.toArray(new KorDoRlseVO[models.size()]);
		return vos;
	}
