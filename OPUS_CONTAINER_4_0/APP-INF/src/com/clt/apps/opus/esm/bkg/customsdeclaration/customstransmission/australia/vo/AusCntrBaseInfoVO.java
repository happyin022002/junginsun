...
*@FileName : AusCntrBaseInfoVO.java
*@FileTitle : AusCntrBaseInfoVO
*Open Issues :
*Change history :
...
public class AusCntrBaseInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AusCntrBaseInfoVO> models = new ArrayList<AusCntrBaseInfoVO>();
	...
	/* Column Info */
	private String podBkgLocDesc = null;
	/* Column Info */
	...
	/* Column Info */
	private String polBkgLocDesc = null;
	/* Column Info */
	...
	public AusCntrBaseInfoVO() {}

	public AusCntrBaseInfoVO(String ibflag, String pagerows, String bkgCgoTpCd, String bkgDate, String bkgDateType, String blNo, String bkgNo, String bBkgId, String bBkgIdType, String cntrtsCd, String cntrNo, String dType, String imex, String iso, String lBkgId, String lBkgIdType, String msgSndNo, String podBkgLoc, String podBkgLocDesc, String podBkgLocType, String polBkgLoc, String polBkgLocDesc, String polBkgLocType, String portCd, String pBoundCd, String pPodCd, String pPolCd, String subAddress1, String subAddress2, String subAddress3, String subAddress4, String subAddress5, String subAuthorized, String subContact, String subConVvd, String subFax, String subId, String subIdType, String subLicense, String subMeansType, String subMode, String subName, String subNation, String subPartyId, String subPartyType, String subPhone, String subRef, String subSsr, String subVvd, String usrId, String vvdCd) {
		...
		this.podBkgLocDesc = podBkgLocDesc;
		this.subId = subId;
		this.subVvd = subVvd;
		...
		this.polBkgLocDesc = polBkgLocDesc;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pod_bkg_loc_desc", getPodBkgLocDesc());
		...
		this.hashColumns.put("pol_bkg_loc_desc", getPolBkgLocDesc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pod_bkg_loc_desc", "podBkgLocDesc");
		...
		this.hashFields.put("pol_bkg_loc_desc", "polBkgLocDesc");
	...
	/**
	 * Column Info
	 * @return podBkgLocDesc
	 */
	public String getPodBkgLocDesc() {
		return this.podBkgLocDesc;
	}
	...
	/**
	 * Column Info
	 * @return polBkgLocDesc
	 */
	public String getPolBkgLocDesc() {
		return this.polBkgLocDesc;
	}
	 ...
	 * @param podBkgLocDesc
	 */
	public void setPodBkgLocDesc(String podBkgLocDesc) {
		this.podBkgLocDesc = podBkgLocDesc;
	}
	 ...
	 * @param polBkgLocDesc
	 */
	public void setPolBkgLocDesc(String polBkgLocDesc) {
		this.polBkgLocDesc = polBkgLocDesc;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPodBkgLocDesc(JSPUtil.getParameter(request, prefix + "pod_bkg_loc_desc", ""));
		...
		setPolBkgLocDesc(JSPUtil.getParameter(request, prefix + "pol_bkg_loc_desc", ""));
	 ...
	 * @param request
	 * @return AusCntrBaseInfoVO[]
	 */
	public AusCntrBaseInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusCntrBaseInfoVO[]
	 */
	public AusCntrBaseInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusCntrBaseInfoVO model = null;
		...
		try {
			...
			String[] podBkgLocDesc = (JSPUtil.getParameter(request, prefix	+ "pod_bkg_loc_desc", length));
			...
			String[] polBkgLocDesc = (JSPUtil.getParameter(request, prefix	+ "pol_bkg_loc_desc", length));
			String[] msgSndNo = (JSPUtil.getParameter(request, prefix	+ "msg_snd_no", length));
			
			for (int i = 0; i < length; i++) {
				model = new AusCntrBaseInfoVO();
				if (cntrtsCd[i] != null)
				...
				if (podBkgLocDesc[i] != null)
					model.setPodBkgLocDesc(podBkgLocDesc[i]);
				if (subId[i] != null)
				...
				if (polBkgLocDesc[i] != null)
					model.setPolBkgLocDesc(polBkgLocDesc[i]);
				if (msgSndNo[i] != null)
	 ...
	 * @return AusCntrBaseInfoVO[]
	 */
	public AusCntrBaseInfoVO[] getAusCntrBaseInfoVOs(){
		AusCntrBaseInfoVO[] vos = (AusCntrBaseInfoVO[])models.toArray(new AusCntrBaseInfoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.podBkgLocDesc = this.podBkgLocDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.polBkgLocDesc = this.polBkgLocDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
