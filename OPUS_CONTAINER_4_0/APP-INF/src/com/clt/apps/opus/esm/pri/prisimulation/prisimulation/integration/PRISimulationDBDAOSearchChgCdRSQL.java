...
*@FileName : PRISimulationDBDAOSearchChgCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRISimulationDBDAOSearchChgCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PRISimulationDBDAOSearchChgCdRSQL(){
		setQuery();
		...
		query.append("FileName : PRISimulationDBDAOSearchChgCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT CHG.CHG_CD" ).append("\n"); 
