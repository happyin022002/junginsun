...
*@FileName : SearchMonthlyQuotaAdjustmentTradeRhqListVO.java
*@FileTitle : SearchMonthlyQuotaAdjustmentTradeRhqListVO
*Open Issues :
*Change history :
...
public class SearchMonthlyQuotaAdjustmentTradeRhqListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaAdjustmentTradeRhqListVO> models = new ArrayList<SearchMonthlyQuotaAdjustmentTradeRhqListVO>();
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaAdjustmentTradeRhqListVO[]
	 */
	public SearchMonthlyQuotaAdjustmentTradeRhqListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaAdjustmentTradeRhqListVO[]
	 */
	public SearchMonthlyQuotaAdjustmentTradeRhqListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaAdjustmentTradeRhqListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaAdjustmentTradeRhqListVO();
				if (cmUcAmt[i] != null)
		...
		return getSearchMonthlyQuotaAdjustmentTradeRhqListVOs();
	}
	 ...
	 * @return SearchMonthlyQuotaAdjustmentTradeRhqListVO[]
	 */
	public SearchMonthlyQuotaAdjustmentTradeRhqListVO[] getSearchMonthlyQuotaAdjustmentTradeRhqListVOs(){
		SearchMonthlyQuotaAdjustmentTradeRhqListVO[] vos = (SearchMonthlyQuotaAdjustmentTradeRhqListVO[])models.toArray(new SearchMonthlyQuotaAdjustmentTradeRhqListVO[models.size()]);
		return vos;
	}
