...
public class ESM_COA_0010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0010HTMLAction 객체를 생성
	 */
	public ESM_COA_0010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0010Event event = new EsmCoa0010Event();
