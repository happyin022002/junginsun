...
*@FileName : CstBlplCopyVO.java
*@FileTitle : CstBlplCopyVO
*Open Issues :
*Change history :
...
public class CstBlplCopyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstBlplCopyVO> models = new ArrayList<CstBlplCopyVO>();
	...
	public CstBlplCopyVO() {}

	public CstBlplCopyVO(String ibflag, String pagerows, String propNo, String amdtSeq, String effDt, String n1stCmncDt, String blplHdrSeq, String creUsrId, String updUsrId, String hdrEffDt) {
	 ...
	 */
	public CstBlplCopyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstBlplCopyVO[]
	 */
	public CstBlplCopyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstBlplCopyVO model = null;
	 ...
	 * @return CstBlplCopyVO[]
	 */
	public CstBlplCopyVO[] getCstBlplCopyVOs(){
		CstBlplCopyVO[] vos = (CstBlplCopyVO[])models.toArray(new CstBlplCopyVO[models.size()]);
		return vos;
	}
