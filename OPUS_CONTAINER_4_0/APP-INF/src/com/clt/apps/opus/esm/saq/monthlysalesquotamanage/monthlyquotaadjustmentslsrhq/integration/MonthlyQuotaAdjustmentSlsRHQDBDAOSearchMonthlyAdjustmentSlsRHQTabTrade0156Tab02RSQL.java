...
*@FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyAdjustmentSlsRHQTabTrade0156Tab02RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyAdjustmentSlsRHQTabTrade0156Tab02RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MonthlyQuotaAdjustmentSlsRHQ 상단 Sub Trade TAB 의 데이타 모델에 해당되는 값을 불러온다.
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyAdjustmentSlsRHQTabTrade0156Tab02RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyAdjustmentSlsRHQTabTrade0156Tab02RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        DECODE(FSM.SUB_TRD_CD, '', 'TOTAL', FSM.SUB_TRD_CD) AS SUB_TRD_CD," ).append("\n"); 
		...
		query.append("        GROUP BY FSM.BSE_YR, FSM.BSE_MON, FSM.SUB_TRD_CD, FSM.RLANE_CD, FSM.DIR_CD," ).append("\n"); 
		query.append("        		 VVD.VSL_CD,VVD.SKD_VOY_NO,VVD.SKD_DIR_CD" ).append("\n"); 
		query.append("        ) FSM" ).append("\n"); 
		query.append("    GROUP BY ROLLUP(FSM.SUB_TRD_CD, FSM.DIR_CD), FSM.BSE_MON" ).append("\n"); 
		query.append("    UNION ALL" ).append("\n"); 
		...
		query.append("        GROUP BY INP.FIRST_STEP, RHQ.MQTA_STEP_CD,RHQ.BSE_YR,RHQ.BSE_MON,RHQ.SUB_TRD_CD,RHQ.RLANE_CD,RHQ.DIR_CD," ).append("\n"); 
