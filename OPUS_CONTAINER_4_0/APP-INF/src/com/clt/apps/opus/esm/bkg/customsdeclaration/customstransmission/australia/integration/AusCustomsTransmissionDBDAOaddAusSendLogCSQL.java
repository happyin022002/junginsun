...
*@FileName : AusCustomsTransmissionDBDAOaddAusSendLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOaddAusSendLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOaddAusSendLogCSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOaddAusSendLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_AUS_DG_SND (" ).append("\n");
