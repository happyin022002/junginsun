...
*@FileName : EBookingReceiptDBDAOSearchOpusXptImpLicListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOSearchOpusXptImpLicListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Opus의 export/import licens no를 조회한다.
	  * </pre>
	  */
	public EBookingReceiptDBDAOSearchOpusXptImpLicListRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOSearchOpusXptImpLicListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       , decode(nvl(B13A_XPT_NO1, 'x'), 'x', '',B13A_XPT_NO1)||decode(nvl(B13A_XPT_NO2, 'x'), 'x', '',B13A_XPT_NO2) B13A_XPT_CTNT" ).append("\n"); 
