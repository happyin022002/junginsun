...
*@FileName : EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addBkgCstmsEurDgSndLog
	  * </pre>
	  */
	public EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndLogCSQL(){
		setQuery();
		...
		query.append("FileName : EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO BKG_CSTMS_EUR_DG_SND_LOG" ).append("\n"); 
