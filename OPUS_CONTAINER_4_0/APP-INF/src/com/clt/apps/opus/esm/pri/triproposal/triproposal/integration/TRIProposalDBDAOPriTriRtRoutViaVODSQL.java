...
*@FileName : TRIProposalDBDAOPriTriRtRoutViaVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtRoutViaVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_ROUT_VIA DELETE
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtRoutViaVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtRoutViaVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT_ROUT_VIA" ).append("\n"); 
