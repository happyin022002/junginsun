...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOSearchMonthlyAdjustmentTradeRhq0085Tab03RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOSearchMonthlyAdjustmentTradeRhq0085Tab03RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MonthlyQuotaAdjustmentTradeRHQ의 상단 TAB Lane의 데이타 모델에 해당되는 값을 불러온다.
	  * 2011.02.15 김종준 [T-선사] YEARLY QTA 부분 삭제
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOSearchMonthlyAdjustmentTradeRhq0085Tab03RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOSearchMonthlyAdjustmentTradeRhq0085Tab03RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            OR (VER.MQTA_STEP_CD = '02'" ).append("\n"); 
		...
		query.append("            OR (VER.MQTA_STEP_CD = '03' AND VER.SAQ_STS_CD NOT IN ('00', 'XX'))" ).append("\n"); 
		...
		query.append("    AND    TRD.CTRT_RHQ_CD = INP.CTRT_RHQ_CD" ).append("\n"); 
