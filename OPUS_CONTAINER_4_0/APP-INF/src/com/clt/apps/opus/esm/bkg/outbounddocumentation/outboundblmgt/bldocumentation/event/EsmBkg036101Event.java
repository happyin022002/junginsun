...
public class EsmBkg036101Event extends EventSupport {
    ...
    public XptImpLicVO[] getXptImpLicVOs() {
		...
		if(this.xptImpLicVOs != null){
			rtnVOs = Arrays.copyOf(xptImpLicVOs, xptImpLicVOs.length);
		}
		return rtnVOs;
    }
	 ...
	 * @return the goCntNm
	 */
	public String getGoCntNm() {
		return goCntNm;
	}

	/**
	 * @param goCntNm the goCntNm to set
	 */
	public void setGoCntNm(String goCntNm) {
		this.goCntNm = goCntNm;
	}
