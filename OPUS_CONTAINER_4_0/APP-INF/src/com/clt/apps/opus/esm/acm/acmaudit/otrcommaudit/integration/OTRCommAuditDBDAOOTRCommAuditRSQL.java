...
public class OTRCommAuditDBDAOOTRCommAuditRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     WHEN A.AC_STS_CD IN ('PS', 'IF') AND E.IF_FLG = 'E' THEN E.IF_ERR_RSN" ).append("\n"); 
		...
		query.append("CASE WHEN A.AC_STS_CD IN ('PS', 'IF') AND E.IF_FLG = 'E'" ).append("\n"); 
		query.append("     THEN 'IE'" ).append("\n"); 
		query.append("     ELSE A.AC_STS_CD" ).append("\n"); 
		query.append(" END AC_STS_CD,				" ).append("\n"); 
		query.append("A.COMM_YRMON				" ).append("\n"); 
		query.append("FROM ACM_AGN_OTR_COMM A, MDM_ORGANIZATION B, GL_MON_XCH_RT C, MDM_VENDOR D, AP_INV_HDR E				" ).append("\n"); 
		...
		query.append("	AND E.IF_FLG = 'Y'" ).append("\n"); 
		query.append("#elseif (${ac_sts_cd} == 'RJ')" ).append("\n"); 
		query.append("	AND 1 = (CASE WHEN A.AC_STS_CD IN ('PS', 'IF') AND E.IF_FLG = 'E' THEN 1 " ).append("\n"); 
		query.append("                  WHEN A.AC_STS_CD IN ('RR','AR','PR','IC') THEN 1 " ).append("\n"); 
