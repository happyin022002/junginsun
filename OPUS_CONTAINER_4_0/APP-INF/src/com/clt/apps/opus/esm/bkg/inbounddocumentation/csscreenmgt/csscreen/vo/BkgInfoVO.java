...
public class BkgInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgInfoVO> models = new ArrayList<BkgInfoVO>();
	...
	public BkgInfoVO(String ibflag, String pagerows, String blNo, String bkgNo, String splitFlg, String blTpCd) {
	 ...
	 * @return BkgInfoVO[]
	 */
	public BkgInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgInfoVO[]
	 */
	public BkgInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgInfoVO model = null;
	 ...
	 * @return BkgInfoVO[]
	 */
	public BkgInfoVO[] getBkgInfoVOs(){
		BkgInfoVO[] vos = (BkgInfoVO[])models.toArray(new BkgInfoVO[models.size()]);
		return vos;
	}
