...
*@FileName : ACMCustomerInfoDBDAOAddFFCmpnExSettingListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMCustomerInfoDBDAOAddFFCmpnExSettingListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCustomerInfoDBDAOAddFFCmpnExSettingListCSQL(){
		setQuery();
		...
		query.append("FileName : ACMCustomerInfoDBDAOAddFFCmpnExSettingListCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_FF_EXCLU_SET" ).append("\n");
