...
public class CndCstmsSndHisVO extends CstmsSndHisVO {
	...
	public CndCstmsSndHisVO(String ibflag, String pagerows, String trsmMsgTpId, String sndDt, String sndHm, String sndUsrOfcCd, String sndUsrId, String vvdCd, String polCd, String podCd, String blNo, String ackRcvTpId, String ackRcvDesc, String updDt, String updHm, String ackSndKnt, String ackRcvKnt, String ackAcptKnt, String cntCd, String ioBndCd, String dtlSndDt, String hisSeq, String stwgSndId, String vvdBaplie) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setVvdBaplie(JSPUtil.getParameter(request, "vvd_baplie", ""));
	}
	...
	public CndCstmsSndHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] stwgSndId = (JSPUtil.getParameter(request, prefix	+ "stwg_snd_id".trim(), length));
			String[] vvdBaplie = (JSPUtil.getParameter(request, prefix	+ "vvd_baplie".trim(), length));
