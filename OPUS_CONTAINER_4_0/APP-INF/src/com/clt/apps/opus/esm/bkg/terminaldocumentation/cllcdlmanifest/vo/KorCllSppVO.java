...
*@FileName : KorCllSppVO.java
*@FileTitle : KorCllSppVO
*Open Issues :
*Change history :
...
public class KorCllSppVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorCllSppVO> models = new ArrayList<KorCllSppVO>();
	...
	public KorCllSppVO(String ibflag, String pagerows, String attrCtnt1, String attrCtnt2, String cstmsDivIdSeq, String deltFlg, String cstmsDivId, String cntCd, String updUsrId, String creUsrId) {
	 ...
	 * @return KorCllSppVO[]
	 */
	public KorCllSppVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCllSppVO[]
	 */
	public KorCllSppVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCllSppVO model = null;
	...
	public KorCllSppVO[] getKorCllSppVOs(){
		KorCllSppVO[] vos = (KorCllSppVO[])models.toArray(new KorCllSppVO[models.size()]);
		return vos;
	}
