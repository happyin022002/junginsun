...
*@FileName : UnmatchBLDBDAOCheckRfaEffectiveDateDiscrepancyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckRfaEffectiveDateDiscrepancyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * A EffectiveDateDiscrepancy
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckRfaEffectiveDateDiscrepancyRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckRfaEffectiveDateDiscrepancyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
