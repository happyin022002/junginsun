...
*@FileName : ACMCommonDBDAOGetAgnByUserOfficeListRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMCommonDBDAOGetAgnByUserOfficeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCommonDBDAOGetAgnByUserOfficeListRSQL(){
		setQuery();
		...
		query.append("FileName : ACMCommonDBDAOGetAgnByUserOfficeListRSQL").append("\n");
		query.append("*/").append("\n");
	}
