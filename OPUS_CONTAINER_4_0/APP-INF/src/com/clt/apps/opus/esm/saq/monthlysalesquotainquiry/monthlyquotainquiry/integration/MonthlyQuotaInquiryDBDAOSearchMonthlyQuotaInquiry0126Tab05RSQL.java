...
*@FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab05RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab05RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab05RSQL(){
		setQuery();
		...
		params.put("aqCd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab05RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        @[rhqCd] AS AQ_CD_ORG,  		" ).append("\n"); 
		query.append("        @[aqCd] AS AQ_CD,  " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("            SMR.RLANE_CD = INP.RLANE_CD AND " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("            SMR.RHQ_CD LIKE INP.RHQ_CD||'%' AND " ).append("\n"); 
		query.append("            NVL(SMR.AQ_CD, '  ') LIKE INP.AQ_CD||'%'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${isRhq} == 'false') " ).append("\n"); 
		query.append("		        AND NVL(SMR.AQ_CD, '  ') LIKE INP.AQ_CD_ORG||'%'" ).append("\n"); 
		query.append("#end	" ).append("\n"); 
		query.append("		" ).append("\n"); 
		...
		query.append("            VVD.BSE_WK BETWEEN INP.FROM_WK AND INP.TO_WK AND 		" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if (${rlaneCd} != '')" ).append("\n"); 
		query.append("	             AND   VVD.RLANE_CD = INP.RLANE_CD " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		query.append("            JOIN" ).append("\n"); 
		...
		query.append("               SMR.BSE_QTR_CD = VVD.BSE_QTR_CD  AND          " ).append("\n"); 
		query.append("               SMR.BSE_WK = VVD.BSE_WK            " ).append("\n"); 
		query.append("            )               " ).append("\n"); 
		query.append("     GROUP BY VVD.BSE_WK,VVD.VSL_CD, VVD.SKD_VOY_NO, VVD.SKD_DIR_CD, VVD.RLANE_CD||'-'||VVD.SPRT_GRP_CD||VVD.BSA_GRP_CD, VVD.TRD_CD, VVD.CONV_DIR_CD, VVD.SUB_TRD_CD, VVD.RLANE_CD, VVD.BSE_YR)" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append(" SELECT  " ).append("\n"); 
		...
		query.append("       WHEN SLEVEL = 7 THEN 'TOTAL'" ).append("\n"); 
		query.append("       ELSE ''" ).append("\n"); 
		...
		query.append(" 	     WHEN 6 THEN 'TOTAL'" ).append("\n"); 
		...
		query.append(" 		     WHEN '01111111' THEN 1" ).append("\n"); 
		query.append(" 		     WHEN '00111111' THEN 2" ).append("\n"); 
		query.append(" 		     WHEN '00011111' THEN 3" ).append("\n"); 
		query.append(" 		     WHEN '00001111' THEN 4" ).append("\n"); 
		query.append(" 		     WHEN '00000011' THEN 5" ).append("\n"); 
		query.append(" 		     WHEN '00000001' THEN 6" ).append("\n"); 
		query.append(" 		     WHEN '00000000' THEN 7" ).append("\n"); 
		...
		query.append(" 					SMR.TRD_CD = INP.TRD_CD AND  " ).append("\n"); 
		query.append(" 					SMR.CONV_DIR_CD = INP.DIR_CD AND " ).append("\n"); 
		query.append(" 					SMR.RLANE_CD LIKE INP.RLANE_CD || '%' AND " ).append("\n"); 
		query.append(" 					SMR.RHQ_CD LIKE INP.RHQ_CD||'%' AND " ).append("\n"); 
		query.append(" 					NVL(SMR.AQ_CD, '  ') LIKE INP.AQ_CD||'%' " ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("#if (${isRhq} == 'false') " ).append("\n"); 
		...
		query.append(" 				       SMR.RLANE_CD = VVD.RLANE_CD AND" ).append("\n"); 
		query.append(" 				       SMR.BSE_YR = VVD.BSE_YR AND" ).append("\n"); 
		query.append(" 				       SMR.VSL_CD = VVD.VSL_CD AND" ).append("\n"); 
		query.append(" 				       SMR.SKD_VOY_NO = VVD.SKD_VOY_NO AND" ).append("\n"); 
		query.append(" 				       SMR.SKD_DIR_CD = VVD.SKD_DIR_CD AND" ).append("\n"); 
		query.append(" 					   VVD.BSE_WK BETWEEN INP.FROM_WK AND INP.TO_WK AND 		" ).append("\n"); 
		query.append(" 					   VVD.SUB_TRD_CD LIKE INP.SUB_TRD_CD || '%' 		" ).append("\n"); 
		query.append(" 				     )                                               " ).append("\n"); 
		query.append(" 				GROUP BY VVD.SUB_TRD_CD,SMR.RLANE_CD,VVD.VVD_GRP_CD, SMR.RHQ_CD, NVL(SMR.AQ_CD, '  '), SMR.RGN_OFC_CD, SMR.BSE_YR,VVD.BSE_WK, VVD.VSL_CD || VVD.SKD_VOY_NO || VVD.SKD_DIR_CD" ).append("\n"); 
		...
		query.append(" 					    (SMR.BSE_YR,SMR.BSE_WK,SMR.SUB_TRD_CD,SMR.RLANE_CD,SMR.VVD_GRP_CD,VVD_CD, SMR.RHQ_CD),  " ).append("\n"); 
		query.append(" 					    (SMR.BSE_YR,SMR.BSE_WK,SMR.SUB_TRD_CD,SMR.RLANE_CD,SMR.VVD_GRP_CD,VVD_CD, SMR.RHQ_CD, SMR.AQ_CD)," ).append("\n"); 
		query.append(" 					    (SMR.BSE_YR,SMR.BSE_WK,SMR.SUB_TRD_CD,SMR.RLANE_CD,SMR.VVD_GRP_CD,VVD_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.OFC_CD))     " ).append("\n"); 
		query.append(" 		  ) SMR     " ).append("\n"); 
		query.append(" 	  ) SMR                                                                     " ).append("\n"); 
		query.append(" 	  JOIN  " ).append("\n"); 
		query.append(" 	  (  " ).append("\n"); 
		...
		query.append(" 	  TMP_INPUT_PARAMS INP " ).append("\n"); 
		query.append(" 	  ON 1 = 1            " ).append("\n"); 
		query.append("       GROUP BY SMR.BSE_YR,SMR.BSE_WK,SMR.SUB_TRD_CD,SMR.RLANE_CD,SMR.SLEVEL, SMR.VVD_GRP_CD,SMR.VVD_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.OFC_CD, ITM.ROW_SEQ, ITM.TEXT, ITM.CODE   " ).append("\n"); 
		query.append("       ) SMR  " ).append("\n"); 
		query.append("    ,     (                                                                                          " ).append("\n"); 
		query.append("          SELECT                                                                                    " ).append("\n"); 
