...
public class BlRatingDBDAOAutoRatingHistoryUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		SELECT 	COUNT(BKG_NO) FROM BKG_AUTO_RT_HIS_CNG WHERE BKG_NO= @[bkg_no] AND CORR_NO = 'TMP0000001'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	#if(${caflag} == 'Y')" ).append("\n"); 
		query.append("		DELETE  FROM BKG_AUTO_RT_HIS_CNG WHERE BKG_NO  = @[bkg_no] AND CORR_NO = 'TMP0000001'" ).append("\n"); 
		query.append("	#else" ).append("\n"); 
		...
		query.append("	#if(${caflag} == 'Y')" ).append("\n"); 
		query.append("		BKG_AUTO_RT_HIS_CNG ( CORR_NO, " ).append("\n"); 
		query.append("	#else" ).append("\n"); 
		query.append("		BKG_AUTO_RT_HIS (" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("	   RT_SEQ, BKG_NO, BL_RT_SEQ, DP_SEQ, " ).append("\n"); 
		...
		query.append("	   (SELECT  NVL(MAX(RT_SEQ),0)+1 AS SEQ " ).append("\n"); 
