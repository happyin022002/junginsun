...
import com.clt.apps.opus.esm.agt.common.event.CommonEventResponse;
...
/**
 * OPUS-Agent Commission에 대한 공통업무 처리를 담당<br>
 * - OPUS-Agent Commission에 대한 공통업무 비지니스 로직을 처리한다.<br>
 * 
...
public class CommonBCImpl   extends BasicCommandSupport implements CommonBC {
     ...
     * @throws EventException
     */
    public HashMap<String, String> searchCustomerName( Event et ) throws EventException{
