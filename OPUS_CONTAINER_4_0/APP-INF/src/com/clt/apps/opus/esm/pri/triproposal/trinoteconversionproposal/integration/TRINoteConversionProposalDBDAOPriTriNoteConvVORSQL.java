...
*@FileName : TRINoteConversionProposalDBDAOPriTriNoteConvVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRINoteConversionProposalDBDAOPriTriNoteConvVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRINoteConversionProposalDBDAOPriTriNoteConvVORSQL(){
		setQuery();
		...
		query.append("FileName : TRINoteConversionProposalDBDAOPriTriNoteConvVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ORDER BY A.NOTE_CONV_RULE_CD" ).append("\n"); 
		query.append("	    , A.NOTE_CONV_CHG_CD" ).append("\n"); 
