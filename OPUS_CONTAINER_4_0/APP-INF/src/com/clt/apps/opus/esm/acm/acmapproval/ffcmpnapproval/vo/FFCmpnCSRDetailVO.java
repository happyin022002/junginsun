...
*@FileName : FFCmpnCSRDetailVO.java
*@FileTitle : FFCmpnCSRDetailVO
*Open Issues :
*Change history :
...
public class FFCmpnCSRDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<FFCmpnCSRDetailVO> models = new ArrayList<FFCmpnCSRDetailVO>();
...
/**
	 ...
	 * @param request
	 * @return FFCmpnCSRDetailVO[]
	 */
	public FFCmpnCSRDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FFCmpnCSRDetailVO[]
	 */
	public FFCmpnCSRDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FFCmpnCSRDetailVO model = null;
	 ...
	 * @return FFCmpnCSRDetailVO[]
	 */
	public FFCmpnCSRDetailVO[] getFFCmpnCSRDetailVOs(){
		FFCmpnCSRDetailVO[] vos = (FFCmpnCSRDetailVO[])models.toArray(new FFCmpnCSRDetailVO[models.size()]);
		return vos;
	}
