...
*@FileName : ESM_FMS_0033HTMLAction.java
...
public class ESM_FMS_0033HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0032HTMLAction 객체를 생성
	 */
	public ESM_FMS_0033HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0033Event event = new EsmFms0033Event();

 		if(command.isCommand(FormCommand.SEARCH)) {
 			event.setCondReverseCsrForSubletVO((CondReverseCsrForSubletVO)getVO(request, CondReverseCsrForSubletVO.class));
