...
*@FileName : CostStructureDBDAORemoveUSAServiceModeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAORemoveUSAServiceModeDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveUSAServiceMode
	  * </pre>
	  */
	public CostStructureDBDAORemoveUSAServiceModeDSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAORemoveUSAServiceModeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM COA_USA_SVC_MOD" ).append("\n"); 
