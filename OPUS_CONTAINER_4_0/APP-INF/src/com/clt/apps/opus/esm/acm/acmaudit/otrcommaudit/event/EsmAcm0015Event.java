...
public class EsmAcm0015Event extends EventSupport {
	...
	public OTRCommAuditVO[] getOtrCommAuditVOs() {
		OTRCommAuditVO[] rtnVOs = null;
		if (this.otrCommAuditVOs != null) {
			rtnVOs = Arrays.copyOf(otrCommAuditVOs, otrCommAuditVOs.length);
		}
		return rtnVOs;
	}

	public void setOtrCommAuditVOs(OTRCommAuditVO[] otrCommAuditVOs) {
		if(otrCommAuditVOs != null){
			OTRCommAuditVO[] tmpVOs = Arrays.copyOf(otrCommAuditVOs, otrCommAuditVOs.length);
			this.otrCommAuditVOs  = tmpVOs;
		}
	}
