...
public class HongKongCustomsTransmissionDBDAOsearchCntrDescRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("'D_DESC:'||REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRANSLATE(NVL(CNTR_MF_GDS_DESC,' '),CHR(10),' '),'&',CHR(38)||'amp'||CHR(59)),'<',CHR(38)||'lt'||CHR(59)),'>',CHR(38)||'gt'||CHR(59)),'\"',CHR(38)||'quot'||CHR(59)),CHR(39),CHR(38)||'apos'||CHR(59)) d_desc," ).append("\n");
		query.append("DECODE(CNTR_MF_MK_DESC,NULL,'', REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(Translate(NVL(CNTR_MF_MK_DESC,''),CHR(10),''),'&',CHR(38)||'amp'||CHR(59)),'<',CHR(38)||'lt'||CHR(59)),'>',CHR(38)||'gt'||CHR(59)),'\"',CHR(38)||'quot'||CHR(59)),CHR(39),CHR(38)||'apos'||CHR(59))||CHR(10)||'') cus_mark" ).append("\n");
