...
public class BrcsCustomsTransmissionDBDAOsearchCntrRfAkBrCgoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        " ).append("\n"); 
		query.append("        ,REPLACE(BKG_TOKEN_NL_FNC(NVL(STWG_RQST_DESC, ' '),0, ''), CHR(9), ' ') STWG_REQ   " ).append("\n"); 
		...
		query.append("              AND CNTR_NO = BC.CNTR_NO" ).append("\n"); 
		query.append("              AND ROWNUM = 1" ).append("\n"); 
		query.append("         ) ATB" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("       , DECODE(BC.SOC_FLG,'N','2','Y','1') SUPL_TYPE	" ).append("\n"); 
		query.append("                        " ).append("\n"); 
		...
		query.append("    ,NVL(BRC.CDO_TEMP, '') TEMP" ).append("\n"); 
		...
		query.append("    ,REPLACE(BKG_TOKEN_NL_FNC(NVL(BRC.DIFF_RMK, ' '),0, ''), CHR(9), ' ') RF_REMARK" ).append("\n"); 
