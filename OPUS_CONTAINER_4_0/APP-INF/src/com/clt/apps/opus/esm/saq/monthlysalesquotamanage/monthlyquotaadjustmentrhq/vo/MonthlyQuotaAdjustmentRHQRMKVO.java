...
*@FileName : MonthlyQuotaAdjustmentRHQRMKVO.java
*@FileTitle : MonthlyQuotaAdjustmentRHQRMKVO
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentRHQRMKVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MonthlyQuotaAdjustmentRHQRMKVO> models = new ArrayList<MonthlyQuotaAdjustmentRHQRMKVO>();
	...
	public MonthlyQuotaAdjustmentRHQRMKVO() {}

	public MonthlyQuotaAdjustmentRHQRMKVO(String ibflag, String pagerows, String mqtaStepCd, String bseYr, String bseQtrCd, String trdCd, String dirCd, String mqtaVerNo, String rlaneGrp, String rlaneCd, String sprtGrpCd, String bsaGrpCd, String ctrtRgnOfcCd, String polCd, String podCd, String bseMon, String creSeq, String subjCtnt, String creOfcCd, String cmtCtnt, String saqStsCd, String rmkCreGdt, String rnk) {
		this.creSeq = creSeq;
	 ...
	 * @param request
	 * @return MonthlyQuotaAdjustmentRHQRMKVO[]
	 */
	public MonthlyQuotaAdjustmentRHQRMKVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MonthlyQuotaAdjustmentRHQRMKVO[]
	 */
	public MonthlyQuotaAdjustmentRHQRMKVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MonthlyQuotaAdjustmentRHQRMKVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MonthlyQuotaAdjustmentRHQRMKVO();
				if (creSeq[i] != null)
		...
		return getMonthlyQuotaAdjustmentRHQRMKVOs();
	}
	 ...
	 * @return MonthlyQuotaAdjustmentRHQRMKVO[]
	 */
	public MonthlyQuotaAdjustmentRHQRMKVO[] getMonthlyQuotaAdjustmentRHQRMKVOs(){
		MonthlyQuotaAdjustmentRHQRMKVO[] vos = (MonthlyQuotaAdjustmentRHQRMKVO[])models.toArray(new MonthlyQuotaAdjustmentRHQRMKVO[models.size()]);
		return vos;
	}
