...
*@FileName       : EsmSaq0127ViewAdapter01.java
...
public class EsmSaq0127ViewAdapter01 extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		SearchMonthlyQuotaInquiry0126Tab01VO listVo = null; // 차후 루프문을 통해 결과리스트의 정보를 한 로우씩 입력할 결과VO를 세팅 (0126공유)
...
//			sbufXML.append("<TR LEVEL=\"" + listVo.getSlevel() + "\" expand= \"" + isExpand + "\">");
			...
			sbufXML.append("<TD bgColor=\"" + bgColor[level-1] + "\"><![CDATA[" + listVo.getItem() + "]]></TD>");
