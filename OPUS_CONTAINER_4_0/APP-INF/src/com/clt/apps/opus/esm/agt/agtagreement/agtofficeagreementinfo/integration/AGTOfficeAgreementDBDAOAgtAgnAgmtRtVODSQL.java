...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtRtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtRtVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_agmt_rt 에서 조건 정보 삭제
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtRtVODSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM AGT_AGN_AGMT_RT" ).append("\n"); 
