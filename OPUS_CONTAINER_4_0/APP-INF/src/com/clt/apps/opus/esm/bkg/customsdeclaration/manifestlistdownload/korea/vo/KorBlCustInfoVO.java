...
*@FileName : KorBlCustInfoVO.java
*@FileTitle : KorBlCustInfoVO
*Open Issues :
*Change history :
...
public class KorBlCustInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorBlCustInfoVO> models = new ArrayList<KorBlCustInfoVO>();
	...
	public KorBlCustInfoVO() {}

	public KorBlCustInfoVO(String ibflag, String pagerows, String inType, String ioBndCd, String podCd, String podTml, String polCd, String polTml, String portCd, String vvd) {
		this.vvd = vvd;
		this.podCd = podCd;
		this.polCd = polCd;
		this.inType = inType;
...
/**
	 ...
	 * @param request
	 * @return KorBlCustInfoVO[]
	 */
	public KorBlCustInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorBlCustInfoVO[]
	 */
	public KorBlCustInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorBlCustInfoVO model = null;
	 ...
	 * @return KorBlCustInfoVO[]
	 */
	public KorBlCustInfoVO[] getKorBlCustInfoVOs(){
		KorBlCustInfoVO[] vos = (KorBlCustInfoVO[])models.toArray(new KorBlCustInfoVO[models.size()]);
		return vos;
	}
