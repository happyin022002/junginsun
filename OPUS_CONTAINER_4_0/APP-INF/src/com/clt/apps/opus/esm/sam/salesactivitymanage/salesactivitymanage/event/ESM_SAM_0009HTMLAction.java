...
*@FileName : ESM_SAM_0009HTMLAction.java
...
public class ESM_SAM_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0009HTMLAction 객체를 생성
	 */
	public ESM_SAM_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSam0009Event event = new EsmSam0009Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSamPFMCbyCustInputVO((SamPFMCbyCustInputVO)getVO(request, SamPFMCbyCustInputVO .class));
