...
*@FileName : TRIProposalDBDAOPriTriMnVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriMnVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriMnVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriMnVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_MN" ).append("\n"); 
