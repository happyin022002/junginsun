...
*@FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                    FROM  (    " ).append("\n"); 
		query.append("                            SELECT   " ).append("\n"); 
		query.append("                                 GROUPING(CONV_DIR_CD)||GROUPING(RHQ_CD)||GROUPING(AQ_CD)||GROUPING(SUB_TRD_CD)AS G_FLAG," ).append("\n"); 
		query.append("                                 MIN(SMR.CONV_DIR_CD||SMR.RHQ_CD||SMR.AQ_CD||SMR.SUB_TRD_CD) AS KEY,  " ).append("\n"); 
		...
		query.append("                                             )                                               		" ).append("\n"); 
		query.append("                                    GROUP BY SMR.DIR_CD, SMR.CONV_DIR_CD, SMR.RHQ_CD, NVL(SMR.AQ_CD, '  '), VVD.SUB_TRD_CD, SMR.BSE_YR||SMR.BSE_MON ,VVD.VSL_CD || VVD.SKD_VOY_NO || VVD.SKD_DIR_CD" ).append("\n"); 
		...
		query.append("                                                    (SMR.CONV_DIR_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.SUB_TRD_CD, SMR.YRMON))     " ).append("\n"); 
		query.append("                          ) SMR                              " ).append("\n"); 
		query.append("                  ) SMR                                                                                    " ).append("\n"); 
		query.append("          ) SMR  " ).append("\n"); 
		query.append("          JOIN  " ).append("\n"); 
