...
*@FileName : BSAManageDBDAORemoveMultiBsaSltChtrPortDwnDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveMultiBsaSltChtrPortDwnDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BSA_0026 화면의 Bsa_Slt_Chtr_Port_Dwn DELETE
	  * </pre>
	  */
	public BSAManageDBDAORemoveMultiBsaSltChtrPortDwnDSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveMultiBsaSltChtrPortDwnDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_SLT_CHTR_PORT_DWN" ).append("\n"); 
