...
*@FileName : CargoReleaseOrderDBDAOModifyEdoDoByCusagdDoEdiTransUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOModifyEdoDoByCusagdDoEdiTransUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOModifyEdoDoByCusagdDoEdiTransUSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOModifyEdoDoByCusagdDoEdiTransUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET EDO_TRSM_DT = sysdate" ).append("\n"); 
