...
*@FileName : KorDownHistVO.java
*@FileTitle : KorDownHistVO
*Open Issues :
*Change history :
...
public class KorDownHistVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorDownHistVO> models = new ArrayList<KorDownHistVO>();
	...
	public KorDownHistVO() {}

	public KorDownHistVO(String ibflag, String pagerows, String office, String mrnPort, String mrnChk, String username, String vvdCd, String kdhSeq, String mrnNbr, String mrnUpdateCnt, String actionTime, String bound, String blKnt) {
		this.office = office;
		this.kdhSeq = kdhSeq;
...
/**
	 ...
	 * @param request
	 * @return KorDownHistVO[]
	 */
	public KorDownHistVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDownHistVO[]
	 */
	public KorDownHistVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDownHistVO model = null;
	 ...
	 * @return KorDownHistVO[]
	 */
	public KorDownHistVO[] getKorDownHistVOs(){
		KorDownHistVO[] vos = (KorDownHistVO[])models.toArray(new KorDownHistVO[models.size()]);
		return vos;
	}
