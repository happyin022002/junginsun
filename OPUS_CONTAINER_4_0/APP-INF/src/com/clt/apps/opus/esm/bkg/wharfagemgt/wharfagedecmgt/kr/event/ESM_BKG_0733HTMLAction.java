 ...
 *@FileName : ESM_BKG_0733HTMLAction.java
 *@FileTitle : ESM_BKG_0733HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_0733HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0733HTMLAction 객체를 생성
	 */
	public ESM_BKG_0733HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0733Event event = new EsmBkg0733Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setKrWhfLocCdListCondVO( (KrWhfLocCdListCondVO)getVO( request, KrWhfLocCdListCondVO.class ) );
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setKrBkgCstmsLocVOs2( (KrBkgCstmsLocVO[])getVOs(request, KrBkgCstmsLocVO.class, "sheet1_") ); 
		} 
