...
public class CLLCDLManifestDBDAOsearchLoadSumByPodRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	" ).append("\n"); 
		query.append("	, SUM(DECODE(BKG_CGO_TP_CD, 'P', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0), 'R', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0), 0)) MT_20" ).append("\n"); 
		query.append("	, SUM(DECODE(BKG_CGO_TP_CD, 'P', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '5', 0, '7', 0, '8', 0, '9', 0, BQ.OP_CNTR_QTY), 'R', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '5', 0, '7', 0, '8', 0, '9', 0, BQ.OP_CNTR_QTY), 0)) MT_40" ).append("\n"); 
		query.append("	, SUM(DECODE(BKG_CGO_TP_CD, 'P', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'5',BQ.OP_CNTR_QTY,'8',BQ.OP_CNTR_QTY,'9',BQ.OP_CNTR_QTY,0), 'R', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'5',BQ.OP_CNTR_QTY,'8',BQ.OP_CNTR_QTY,'9',BQ.OP_CNTR_QTY,0), 0)) MT_40H" ).append("\n"); 
		query.append("	, SUM(DECODE(BKG_CGO_TP_CD, 'P', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0), 'R', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0), 0)) MT_45" ).append("\n"); 
		...
		query.append("GROUP BY POD_CD, CLPT_SEQ" ).append("\n"); 
