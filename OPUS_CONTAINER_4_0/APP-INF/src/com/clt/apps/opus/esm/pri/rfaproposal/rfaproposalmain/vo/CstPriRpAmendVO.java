...
*@FileName : CstPriRpAmendVO.java
*@FileTitle : CstPriRpAmendVO
*Open Issues :
*Change history :
...
public class CstPriRpAmendVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriRpAmendVO> models = new ArrayList<CstPriRpAmendVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("new_dur_flg", getNewDurFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("new_dur_flg", "newDurFlg");
	 ...
	 * @return newDurFlg
	 */
	public String getNewDurFlg() {
		return this.newDurFlg;
	}
	 ...
	 * @param newDurFlg
	 */
	public void setNewDurFlg(String newDurFlg) {
		this.newDurFlg = newDurFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setNewDurFlg(JSPUtil.getParameter(request, prefix + "new_dur_flg", ""));
	 ...
	 */
	public CstPriRpAmendVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriRpAmendVO[]
	 */
	public CstPriRpAmendVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriRpAmendVO model = null;
		...
		try {
			...
			String[] newDurFlg = (JSPUtil.getParameter(request, prefix	+ "new_dur_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (newDurFlg[i] != null)
					model.setNewDurFlg(newDurFlg[i]);
				if (pagerows[i] != null)
	 ...
	 * @return CstPriRpAmendVO[]
	 */
	public CstPriRpAmendVO[] getCstPriRpAmendVOs(){
		CstPriRpAmendVO[] vos = (CstPriRpAmendVO[])models.toArray(new CstPriRpAmendVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.newDurFlg = this.newDurFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
