...
/**
 *  SCTransportationAdditionalChargeProposalDBDAO <br>
...
public class SCTransportationAdditionalChargeProposalDBDAO extends DBDAOSupport {
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<RsltAddChgListVO> searchArbitraryChargeHistoryList(PriSpScpTrspAddChgVO priSpScpTrspAddChgVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltAddChgListVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 * @exception DAOException
	 */
	public String searchArbitraryChargeDuplicate(PriSpScpTrspAddChgVO priSpScpTrspAddChgVO) throws DAOException {
		DBRowSet dbRowset = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<RsltAddChgListVO> searchCurrentNoteSeqContent(PriSpScpTrspAddChgVO[] priSpScpTrspAddChgVOs) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltAddChgListVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try{
			if(priSpScpTrspAddChgVOs != null){
				Map<String, String> mapVO = priSpScpTrspAddChgVOs[0].getColumnValues();			
				param.putAll(mapVO);
				velParam.putAll(mapVO);

			}
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new SCTransportationAdditionalChargeProposalDBDAOCurrentNoteSeqContentRSQL(), param, velParam);		
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, RsltAddChgListVO.class);
		}catch(SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage(),se);
