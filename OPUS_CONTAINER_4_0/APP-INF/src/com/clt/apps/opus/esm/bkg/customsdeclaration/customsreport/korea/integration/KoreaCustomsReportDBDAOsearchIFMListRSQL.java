...
*@FileName : KoreaCustomsReportDBDAOsearchIFMListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchIFMListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchIFMListRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchIFMListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MSN.MF_REF_NO, ' ') MF_REF_NO" ).append("\n"); 
		query.append("	 , NVL(MSN.MF_SEQ_NO, ' ') MF_SEQ_NO" ).append("\n"); 
		...
		query.append("     , VVPS.IB_CSSM_VOY_NO CON_VVD" ).append("\n"); 
