...
*@FileName : SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRDetailVVDCNTCheckRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRDetailVVDCNTCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSPCLCmpnCSRDetailVVDCNTCheck
	  * </pre>
	  */
	public SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRDetailVVDCNTCheckRSQL(){
		setQuery();
		...
		query.append("FileName : SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRDetailVVDCNTCheckRSQL").append("\n");
		query.append("*/").append("\n");
	}
