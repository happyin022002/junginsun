...
*@FileName       : EsmCsq0202ViewAdapter.java
 ...
 * @since CSQ USER
 */
public class EsmCsq0202ViewAdapter extends ViewAdapter {
...
//      	csq_act_flg = getNull(colValues.get("csq_act_flg"));
            ...
            sbufXML.append("<TD"+ (sctr_ofc_cre_flg.equals("N")?" EDIT='TRUE'":" EDIT='FALSE' ") +">" + getNull(colValues.get("csq_act_flg")) + "</TD>");
            sbufXML.append("<TD>" + getNull(colValues.get("sctr_ofc_cre_flg"))+ "</TD>");
//            sbufXML.append("<TD"+ (csq_act_flg.equals("1")?" EDIT='TRUE'":" EDIT='FALSE' ") +">" + getNull(colValues.get("csq_mn_sctr_flg")) + "</TD>");
            sbufXML.append("<TD EDIT='TRUE'>" + getNull(colValues.get("csq_mn_sctr_flg"))          + "</TD>");
			sbufXML.append("</TR>\n");
		}
		sbufXML.append("</DATA>\n");
