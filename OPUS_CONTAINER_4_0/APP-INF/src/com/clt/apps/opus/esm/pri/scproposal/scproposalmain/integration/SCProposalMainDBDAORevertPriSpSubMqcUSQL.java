...
*@FileName : SCProposalMainDBDAORevertPriSpSubMqcUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpSubMqcUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_SUB_MQC
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpSubMqcUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpSubMqcUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SUB_MQC " ).append("\n"); 
		...
		query.append("     , ACPT_OFC_CD       = DECODE(@[prop_sts_cd], 'I', NULL, @[prop_ofc_cd])    " ).append("\n"); 
