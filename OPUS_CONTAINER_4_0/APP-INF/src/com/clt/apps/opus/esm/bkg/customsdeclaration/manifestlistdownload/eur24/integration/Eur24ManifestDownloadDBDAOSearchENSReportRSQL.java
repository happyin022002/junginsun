...
public class Eur24ManifestDownloadDBDAOSearchENSReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("             ,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELBB',TO_DATE(BKG_GET_TOKEN_FNC(RCV,4),'YYYY-MM-DD HH24:MI'), SND_USR_OFC_CD ), 'YYYY-MM-DD HH24:MI')  AS ACK_RCV_DT" ).append("\n"); 
		query.append("             ,BKG_GET_TOKEN_FNC(RCV,5) AS RESULT_CD" ).append("\n"); 
		query.append("             ,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELBB',TO_DATE(BKG_GET_TOKEN_FNC(RCV,4),'YYYY-MM-DD HH24:MI'), 'GMT'),           'YYYY-MM-DD HH24:MI')  AS ACK_RCV_GMT_DT" ).append("\n"); 
