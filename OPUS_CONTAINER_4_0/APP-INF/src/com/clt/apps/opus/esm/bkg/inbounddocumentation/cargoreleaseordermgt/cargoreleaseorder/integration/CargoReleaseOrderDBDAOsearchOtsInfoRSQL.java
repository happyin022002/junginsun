...
*@FileName : CargoReleaseOrderDBDAOsearchOtsInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchOtsInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ERP Interface를 대신해서 OTS 정보 Interface Table을 조회한다.
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchOtsInfoRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchOtsInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                 , P.UPD_DT RCV_DT" ).append("\n"); 
		...
		query.append("                 WHERE A.BKG_NO = (SELECT BKG_NO " ).append("\n"); 
		query.append("                                     FROM BKG_BOOKING " ).append("\n"); 
		query.append("                                    WHERE BL_NO = @[bl_no]" ).append("\n"); 
		query.append("                                      AND ROWNUM =1)" ).append("\n"); 
