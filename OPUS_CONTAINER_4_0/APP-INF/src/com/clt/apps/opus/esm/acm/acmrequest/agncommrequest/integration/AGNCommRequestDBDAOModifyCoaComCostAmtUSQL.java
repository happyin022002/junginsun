...
public class AGNCommRequestDBDAOModifyCoaComCostAmtUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                 FROM COA_COM_COST_PARA CPA, " ).append("\n");
		query.append("                    (" ).append("\n");
		query.append("                          SELECT " ).append("\n");
		...
		query.append("                                       FROM COA_COM_PARA      PAR, " ).append("\n");
		query.append("                                            COA_COM_COST_PARA CPA " ).append("\n");
		...
		query.append("                 AND CPA.COA_COST_SRC_CD   = CST.COMM_STND_COST_CD " ).append("\n");
