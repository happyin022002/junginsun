...
*@FileName : EsmSaq0166ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0166ViewAdapter extends ViewAdapter {

	public EsmSaq0166ViewAdapter() {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		if(conditionVO.getChkCommand().equals("SEARCHLIST")){
			...
			for(int j=0; j<totCnt; j++){
				...
				sbufXML.append("<TD>"+colValues.getGrp()+"</TD>");
				sbufXML.append("<TD>"+colValues.getMon()+"</TD>");
				sbufXML.append("<TD>"+colValues.getWeek()+"</TD>");
				sbufXML.append("<TD>"+colValues.getVvd()+"</TD>");
				sbufXML.append("<TD>"+colValues.getBsa()+"</TD>");
				sbufXML.append("</TR>\n");
