...
*@FileName : FFCmpnCSRINFtoAPVO.java
*@FileTitle : FFCmpnCSRINFtoAPVO
*Open Issues :
*Change history :
...
public class FFCmpnCSRINFtoAPVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<FFCmpnCSRINFtoAPVO> models = new ArrayList<FFCmpnCSRINFtoAPVO>();
...
/**
	 ...
	 * @param request
	 * @return FFCmpnCSRINFtoAPVO[]
	 */
	public FFCmpnCSRINFtoAPVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FFCmpnCSRINFtoAPVO[]
	 */
	public FFCmpnCSRINFtoAPVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FFCmpnCSRINFtoAPVO model = null;
	 ...
	 * @return FFCmpnCSRINFtoAPVO[]
	 */
	public FFCmpnCSRINFtoAPVO[] getFFCmpnCSRINFtoAPVOs(){
		FFCmpnCSRINFtoAPVO[] vos = (FFCmpnCSRINFtoAPVO[])models.toArray(new FFCmpnCSRINFtoAPVO[models.size()]);
		return vos;
	}
