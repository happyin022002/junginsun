...
*@FileName : ESM_PRI_0003_01HTMLAction.java
...
public class ESM_PRI_0003_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0003_01HTMLAction 객체를 생성
	 */
	public ESM_PRI_0003_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri000301Event event = new EsmPri000301Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriSpScpRoutPntVOS((PriSpScpRoutPntVO[])getVOs(request, PriSpScpRoutPntVO .class,""));
		}
			...
			event.setRsltRoutPntLocListVO((RsltRoutPntLocListVO)getVO(request, RsltRoutPntLocListVO .class));
		}
