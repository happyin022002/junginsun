...
*@FileName : KoreaCustomsReportDBDAOsearchImpCgoManiPrtCstmDescRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchImpCgoManiPrtCstmDescRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchImpCgoManiPrtCstmDescRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchImpCgoManiPrtCstmDescRSQL").append("\n");
		query.append("*/").append("\n");
	}
