...
public class KorCblVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorCblVO> models = new ArrayList<KorCblVO>();
	...
	public KorCblVO(String ibflag, String pagerows, String cstmsDeclTpCd, String bkgNo, String trnsSeq, String dmstPortCd, String cBlNo, String vvd) {
		this.vvd = vvd;
...
/**
	 ...
	 * @return KorCblVO[]
	 */
	public KorCblVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCblVO[]
	 */
	public KorCblVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCblVO model = null;
	 ...
	 * @return KorCblVO[]
	 */
	public KorCblVO[] getKorCblVOs(){
		KorCblVO[] vos = (KorCblVO[])models.toArray(new KorCblVO[models.size()]);
		return vos;
	}
