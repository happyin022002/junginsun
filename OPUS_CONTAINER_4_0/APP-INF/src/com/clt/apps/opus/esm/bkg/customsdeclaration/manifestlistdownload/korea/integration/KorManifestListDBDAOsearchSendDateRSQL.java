...
*@FileName : KorManifestListDBDAOsearchSendDateRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchSendDateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchSendDateRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchSendDateRSQL").append("\n");
		query.append("*/").append("\n");
	}
