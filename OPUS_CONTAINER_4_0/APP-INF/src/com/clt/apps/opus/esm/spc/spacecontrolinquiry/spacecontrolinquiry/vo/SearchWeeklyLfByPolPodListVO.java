...
public class SearchWeeklyLfByPolPodListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String wk3ComWgt = null;
	/* Column Info */
	private String wk4ComQty = null;
	/* Column Info */
	private String gtlComQty = null;
	/* Column Info */
	...
	/* Column Info */
	private String wk5ComQty = null;
	/* Column Info */
	private String gtlComWgt = null;
	/* Column Info */
	...
	public SearchWeeklyLfByPolPodListVO(String ibflag, String pagerows, String lvl0, String lvl, String seq, String grpId, String trdCd, String subTrdCd, String subRlaneCd, String pod, String pol, String bsa, String wk1ComQty, String wk1ComWgt, String wk1CosQty, String wk1CosWgt, String wk1KklQty, String wk1KklWgt, String wk1YmlQty, String wk1YmlWgt, String wk1OthQty, String wk1OthWgt, String wk1PolQty, String wk1PolWgt, String wk2ComQty, String wk2ComWgt, String wk2CosQty, String wk2CosWgt, String wk2KklQty, String wk2KklWgt, String wk2YmlQty, String wk2YmlWgt, String wk2OthQty, String wk2OthWgt, String wk2PolQty, String wk2PolWgt, String wk3ComQty, String wk3ComWgt, String wk3CosQty, String wk3CosWgt, String wk3KklQty, String wk3KklWgt, String wk3YmlQty, String wk3YmlWgt, String wk3OthQty, String wk3OthWgt, String wk3PolQty, String wk3PolWgt, String wk4ComQty, String wk4ComWgt, String wk4CosQty, String wk4CosWgt, String wk4KklQty, String wk4KklWgt, String wk4YmlQty, String wk4YmlWgt, String wk4OthQty, String wk4OthWgt, String wk4PolQty, String wk4PolWgt, String wk5ComQty, String wk5ComWgt, String wk5CosQty, String wk5CosWgt, String wk5KklQty, String wk5KklWgt, String wk5YmlQty, String wk5YmlWgt, String wk5OthQty, String wk5OthWgt, String wk5PolQty, String wk5PolWgt, String gtlComQty, String gtlComWgt, String gtlCosQty, String gtlCosWgt, String gtlKklQty, String gtlKklWgt, String gtlYmlQty, String gtlYmlWgt, String gtlOthQty, String gtlOthWgt, String gtlPolQty, String gtlPolWgt, String costYrwk) {
		...
		this.wk3ComWgt = wk3ComWgt;
		this.wk4ComQty = wk4ComQty;
		this.gtlComQty = gtlComQty;
		this.grpId = grpId;
		...
		this.wk5ComQty = wk5ComQty;
		this.gtlComWgt = gtlComWgt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("wk3_com_qty", getWk3ComQty());
		...
		this.hashColumns.put("wk4_com_wgt", getWk4ComWgt());
		...
		this.hashColumns.put("wk1_com_qty", getWk1ComQty());
		...
		this.hashColumns.put("wk5_com_wgt", getWk5ComWgt());
		...
		this.hashColumns.put("wk2_com_qty", getWk2ComQty());
		...
		this.hashColumns.put("wk1_com_wgt", getWk1ComWgt());
		...
		this.hashColumns.put("wk3_com_wgt", getWk3ComWgt());
		this.hashColumns.put("wk4_com_qty", getWk4ComQty());
		this.hashColumns.put("gtl_com_qty", getGtlComQty());
		...
		this.hashColumns.put("wk5_com_qty", getWk5ComQty());
		this.hashColumns.put("gtl_com_wgt", getGtlComWgt());
		...
		this.hashColumns.put("wk2_com_wgt", getWk2ComWgt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("wk3_com_qty", "wk3ComQty");
		...
		this.hashFields.put("wk4_com_wgt", "wk4ComWgt");
		...
		this.hashFields.put("wk1_com_qty", "wk1ComQty");
		...
		this.hashFields.put("wk5_com_wgt", "wk5ComWgt");
		...
		this.hashFields.put("wk2_com_qty", "wk2ComQty");
		...
		this.hashFields.put("wk1_com_wgt", "wk1ComWgt");
		...
		this.hashFields.put("wk3_com_wgt", "wk3ComWgt");
		this.hashFields.put("wk4_com_qty", "wk4ComQty");
		this.hashFields.put("gtl_com_qty", "gtlComQty");
		...
		this.hashFields.put("wk5_com_qty", "wk5ComQty");
		this.hashFields.put("gtl_com_wgt", "gtlComWgt");
		...
		this.hashFields.put("wk2_com_wgt", "wk2ComWgt");
	 ...
	 * @return wk3ComQty
	 */
	public String getWk3ComQty() {
		return this.wk3ComQty;
	}
	 ...
	 * @return wk4ComWgt
	 */
	public String getWk4ComWgt() {
		return this.wk4ComWgt;
	}
	 ...
	 * @return wk1ComQty
	 */
	public String getWk1ComQty() {
		return this.wk1ComQty;
	}
	 ...
	 * @return wk5ComWgt
	 */
	public String getWk5ComWgt() {
		return this.wk5ComWgt;
	}
	 ...
	 * @return wk2ComQty
	 */
	public String getWk2ComQty() {
		return this.wk2ComQty;
	}
	 ...
	 * @return wk1ComWgt
	 */
	public String getWk1ComWgt() {
		return this.wk1ComWgt;
	}
	 ...
	 * @return wk3ComWgt
	 */
	public String getWk3ComWgt() {
		return this.wk3ComWgt;
	}
	 ...
	 * @return wk4ComQty
	 */
	public String getWk4ComQty() {
		return this.wk4ComQty;
	}
	 ...
	 * @return gtlComQty
	 */
	public String getGtlComQty() {
		return this.gtlComQty;
	}
	 ...
	 * @return wk5ComQty
	 */
	public String getWk5ComQty() {
		return this.wk5ComQty;
	}
	 ...
	 * @return gtlComWgt
	 */
	public String getGtlComWgt() {
		return this.gtlComWgt;
	}
	 ...
	 * @return wk2ComWgt
	 */
	public String getWk2ComWgt() {
		return this.wk2ComWgt;
	}
	 ...
	 * @param wk3ComQty
	 */
	public void setWk3ComQty(String wk3ComQty) {
		this.wk3ComQty = wk3ComQty;
	}
	 ...
	 * @param wk4ComWgt
	 */
	public void setWk4ComWgt(String wk4ComWgt) {
		this.wk4ComWgt = wk4ComWgt;
	}
	 ...
	 * @param wk1ComQty
	 */
	public void setWk1ComQty(String wk1ComQty) {
		this.wk1ComQty = wk1ComQty;
	}
	 ...
	 * @param wk5ComWgt
	 */
	public void setWk5ComWgt(String wk5ComWgt) {
		this.wk5ComWgt = wk5ComWgt;
	}
	 ...
	 * @param wk2ComQty
	 */
	public void setWk2ComQty(String wk2ComQty) {
		this.wk2ComQty = wk2ComQty;
	}
	 ...
	 * @param wk1ComWgt
	 */
	public void setWk1ComWgt(String wk1ComWgt) {
		this.wk1ComWgt = wk1ComWgt;
	}
	 ...
	 * @param wk3ComWgt
	 */
	public void setWk3ComWgt(String wk3ComWgt) {
		this.wk3ComWgt = wk3ComWgt;
	}
	 ...
	 * @param wk4ComQty
	 */
	public void setWk4ComQty(String wk4ComQty) {
		this.wk4ComQty = wk4ComQty;
	}
	 ...
	 * @param gtlComQty
	 */
	public void setGtlComQty(String gtlComQty) {
		this.gtlComQty = gtlComQty;
	}
	 ...
	 * @param wk5ComQty
	 */
	public void setWk5ComQty(String wk5ComQty) {
		this.wk5ComQty = wk5ComQty;
	}
	 ...
	 * @param gtlComWgt
	 */
	public void setGtlComWgt(String gtlComWgt) {
		this.gtlComWgt = gtlComWgt;
	}
	 ...
	 * @param wk2ComWgt
	 */
	public void setWk2ComWgt(String wk2ComWgt) {
		this.wk2ComWgt = wk2ComWgt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setWk3ComQty(JSPUtil.getParameter(request, prefix + "wk3_com_qty", ""));
		...
		setWk4ComWgt(JSPUtil.getParameter(request, prefix + "wk4_com_wgt", ""));
		...
		setWk1ComQty(JSPUtil.getParameter(request, prefix + "wk1_com_qty", ""));
		...
		setWk5ComWgt(JSPUtil.getParameter(request, prefix + "wk5_com_wgt", ""));
		...
		setWk2ComQty(JSPUtil.getParameter(request, prefix + "wk2_com_qty", ""));
		...
		setWk1ComWgt(JSPUtil.getParameter(request, prefix + "wk1_com_wgt", ""));
		...
		setWk3ComWgt(JSPUtil.getParameter(request, prefix + "wk3_com_wgt", ""));
		setWk4ComQty(JSPUtil.getParameter(request, prefix + "wk4_com_qty", ""));
		setGtlComQty(JSPUtil.getParameter(request, prefix + "gtl_com_qty", ""));
		...
		setWk5ComQty(JSPUtil.getParameter(request, prefix + "wk5_com_qty", ""));
		setGtlComWgt(JSPUtil.getParameter(request, prefix + "gtl_com_wgt", ""));
		...
		setWk2ComWgt(JSPUtil.getParameter(request, prefix + "wk2_com_wgt", ""));
	...
	public SearchWeeklyLfByPolPodListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] wk3ComQty = (JSPUtil.getParameter(request, prefix	+ "wk3_com_qty", length));
			...
			String[] wk4ComWgt = (JSPUtil.getParameter(request, prefix	+ "wk4_com_wgt", length));
			...
			String[] wk1ComQty = (JSPUtil.getParameter(request, prefix	+ "wk1_com_qty", length));
			...
			String[] wk5ComWgt = (JSPUtil.getParameter(request, prefix	+ "wk5_com_wgt", length));
			...
			String[] wk2ComQty = (JSPUtil.getParameter(request, prefix	+ "wk2_com_qty", length));
			...
			String[] wk1ComWgt = (JSPUtil.getParameter(request, prefix	+ "wk1_com_wgt", length));
			...
			String[] wk3ComWgt = (JSPUtil.getParameter(request, prefix	+ "wk3_com_wgt", length));
			String[] wk4ComQty = (JSPUtil.getParameter(request, prefix	+ "wk4_com_qty", length));
			String[] gtlComQty = (JSPUtil.getParameter(request, prefix	+ "gtl_com_qty", length));
			...
			String[] wk5ComQty = (JSPUtil.getParameter(request, prefix	+ "wk5_com_qty", length));
			String[] gtlComWgt = (JSPUtil.getParameter(request, prefix	+ "gtl_com_wgt", length));
			...
			String[] wk2ComWgt = (JSPUtil.getParameter(request, prefix	+ "wk2_com_wgt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (wk3ComQty[i] != null)
					model.setWk3ComQty(wk3ComQty[i]);
				if (wk1KklWgt[i] != null)
				...
				if (wk4ComWgt[i] != null)
					model.setWk4ComWgt(wk4ComWgt[i]);
				if (wk2YmlWgt[i] != null)
				...
				if (wk1ComQty[i] != null)
					model.setWk1ComQty(wk1ComQty[i]);
				if (wk1YmlQty[i] != null)
				...
				if (wk5ComWgt[i] != null)
					model.setWk5ComWgt(wk5ComWgt[i]);
				if (wk2CosWgt[i] != null)
				...
				if (bsa[i] != null)
					model.setBsa(bsa[i]);
				if (wk2ComQty[i] != null)
					model.setWk2ComQty(wk2ComQty[i]);
				if (wk1PolQty[i] != null)
				...
				if (wk1ComWgt[i] != null)
					model.setWk1ComWgt(wk1ComWgt[i]);
				if (subTrdCd[i] != null)
				...
				if (wk3ComWgt[i] != null)
					model.setWk3ComWgt(wk3ComWgt[i]);
				if (wk4ComQty[i] != null)
					model.setWk4ComQty(wk4ComQty[i]);
				if (gtlComQty[i] != null)
					model.setGtlComQty(gtlComQty[i]);
				if (grpId[i] != null)
				...
				if (wk5ComQty[i] != null)
					model.setWk5ComQty(wk5ComQty[i]);
				if (gtlComWgt[i] != null)
					model.setGtlComWgt(gtlComWgt[i]);
				if (wk2PolWgt[i] != null)
				...
				if (wk2ComWgt[i] != null)
					model.setWk2ComWgt(wk2ComWgt[i]);
				if (wk4YmlWgt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.wk3ComQty = this.wk3ComQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk4ComWgt = this.wk4ComWgt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk1ComQty = this.wk1ComQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk5ComWgt = this.wk5ComWgt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk2ComQty = this.wk2ComQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk1ComWgt = this.wk1ComWgt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk3ComWgt = this.wk3ComWgt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.wk4ComQty = this.wk4ComQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.gtlComQty = this.gtlComQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk5ComQty = this.wk5ComQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.gtlComWgt = this.gtlComWgt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.wk2ComWgt = this.wk2ComWgt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
