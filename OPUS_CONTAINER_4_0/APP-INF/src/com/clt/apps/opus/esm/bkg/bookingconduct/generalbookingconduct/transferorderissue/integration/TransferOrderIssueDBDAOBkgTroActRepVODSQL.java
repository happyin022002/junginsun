...
*@FileName : TransferOrderIssueDBDAOBkgTroActRepVODSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOBkgTroActRepVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BKG_0905 t2 master delete
	  * </pre>
	  */
	public TransferOrderIssueDBDAOBkgTroActRepVODSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : TransferOrderIssueDBDAOBkgTroActRepVODSQL").append("\n");
		query.append("*/").append("\n");
	}
}