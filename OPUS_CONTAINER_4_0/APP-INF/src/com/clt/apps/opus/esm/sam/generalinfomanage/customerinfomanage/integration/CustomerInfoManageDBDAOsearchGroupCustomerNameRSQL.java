...
*@FileName : CustomerInfoManageDBDAOsearchGroupCustomerNameRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerInfoManageDBDAOsearchGroupCustomerNameRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CustomerInfoManageDBDAOsearchGroupCustomerName
	  * </pre>
	  */
	public CustomerInfoManageDBDAOsearchGroupCustomerNameRSQL(){
		setQuery();
		...
		query.append("FileName : CustomerInfoManageDBDAOsearchGroupCustomerNameRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
