...
public class RevenueDebitNoteDBDAORsltSearchRDNIssueMailingListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                  SELECT 'taekyoung.kim@cyberlogitec.com' AS USR_EML, 'C' AS GROUP_GB FROM DUAL" ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("        " ).append("\n"); 
		...
		query.append("              ,CASE WHEN INSTR(R.USR_EML, 'OPUS Co.') > 0 THEN 'G'" ).append("\n"); 
