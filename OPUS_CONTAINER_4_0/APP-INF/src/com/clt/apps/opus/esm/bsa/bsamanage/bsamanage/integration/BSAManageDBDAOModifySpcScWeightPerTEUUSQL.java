...
*@FileName : BSAManageDBDAOModifySpcScWeightPerTEUUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifySpcScWeightPerTEUUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySpcScWeightPerTEU
	  * </pre>
	  */
	public BSAManageDBDAOModifySpcScWeightPerTEUUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifySpcScWeightPerTEUUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM BSA_SLT_CHTR_CRR_CAPA Y" ).append("\n"); 
