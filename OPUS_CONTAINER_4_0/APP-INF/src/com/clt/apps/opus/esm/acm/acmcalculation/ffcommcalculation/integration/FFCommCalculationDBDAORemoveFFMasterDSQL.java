...
*@FileName : FFCommCalculationDBDAORemoveFFMasterDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAORemoveFFMasterDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAORemoveFFMasterDSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAORemoveFFMasterDSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAORemoveFFMasterDSQL").append("\n");
		query.append("*/").append("\n");
	}
