...
*@FileName : MonthlyQuotaCreationDBDAOCreateMonthlyQuotaGuidelineInfoSub0077CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCreationDBDAOCreateMonthlyQuotaGuidelineInfoSub0077CSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * guideline data 생성 3. saq_mon_qta_gline_sub_trd insert
	  * </pre>
	  */
	public MonthlyQuotaCreationDBDAOCreateMonthlyQuotaGuidelineInfoSub0077CSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCreationDBDAOCreateMonthlyQuotaGuidelineInfoSub0077CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("--3. SAQ_MON_QTA_GLINE_SUB_TRD INSERT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("INSERT INTO SAQ_MON_QTA_GLINE_SUB_TRD (                     " ).append("\n"); 
