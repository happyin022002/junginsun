...
*@FileName : ESM_BKG_0510_01HTMLAction.java
...
public class ESM_BKG_0510_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0510HTMLAction 객체를 생성
	 */
	public ESM_BKG_0510_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setHldNtcSearchVO((HldNtcSearchVO)getVO(request, HldNtcSearchVO.class));
				...
				command.isCommand(FormCommand.MULTI12)) {
			event.setConfirmHldNtcSendListVOs((ConfirmHldNtcSendListVO[])getVOs(request, ConfirmHldNtcSendListVO.class, "sheet1_"));
		} 
		return  event;
	}
