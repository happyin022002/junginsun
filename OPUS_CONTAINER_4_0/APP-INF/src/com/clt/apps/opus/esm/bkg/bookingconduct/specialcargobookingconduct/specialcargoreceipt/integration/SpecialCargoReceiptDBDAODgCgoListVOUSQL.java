...
public class SpecialCargoReceiptDBDAODgCgoListVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	INTMD_IMDG_PCK_QTY1 = @[intmd_imdg_pck_qty1]" ).append("\n"); 
		query.append(",	INTMD_IMDG_PCK_CD1 = @[intmd_imdg_pck_cd1]" ).append("\n"); 
		query.append(",	INTMD_IMDG_PCK_QTY2 = @[intmd_imdg_pck_qty2]" ).append("\n"); 
		query.append(",	INTMD_IMDG_PCK_CD2 = @[intmd_imdg_pck_cd2]" ).append("\n"); 
		...
		query.append(",	ERAP_NO = @[erap_no]" ).append("\n"); 
		query.append(",	ERAP_CNTC_NO = @[erap_cntc_no]" ).append("\n"); 
		query.append(",	ERAP_APRO_REF_NO = @[erap_apro_ref_no]" ).append("\n"); 
		query.append(",	DOT_EXP_NO = @[dot_exp_no]" ).append("\n"); 
		query.append(",	DOT_SPCL_APRO_NO = @[dot_spcl_apro_no]" ).append("\n"); 
		query.append(",	DOT_AUTH_NO = @[dot_auth_no]" ).append("\n"); 
		query.append(",	IMDG_UN_NO_SPCL_PROVI_CTNT = @[imdg_un_no_spcl_provi_ctnt]" ).append("\n"); 
