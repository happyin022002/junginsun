...
public class BkgCstmsKrBlVO extends AbstractValueObject {
	...
	public BkgCstmsKrBlVO(String ibflag, String pagerows, String bac, String bizNo, String bizRgstNo, String bkgNo, String bkgNoSplit, String bkgTpCd, String blMeasUtCd, String blNo, String bondAreaCode, String bKtSeq, String cmdtCd, String cneeA, String cneeN, String cnt, String cntr, String cntrTtlWgt, String correction, String cusName, String cBlNo, String descCode, String elnoA, String elnoB, String exptKcdTp, String inBound, String kcdTp, String krBlAmdtStsCd, String krCstmsBndCd, String ktPort, String ktSeq, String ktSndDtChk, String ktSts, String match, String measQty, String mfSndDt, String mrnType, String mstBlSeq, String ntfyA, String ntfyN, String obType, String pckQty, String pckTpCd, String pkgCode, String pkgValue, String podCd, String podLoc, String podTml, String polCd, String polLoc, String polTml, String preVvd, String sc, String shprA, String shprN, String sumBl1, String sumBl10, String sumBl11, String sumBl2, String sumBl3, String sumBl4, String sumBl5, String sumBl6, String sumBl7, String sumBl8, String sumBl9, String tpCd, String tr, String transType, String trnsSeq, String tsPodCd, String tsPolCd, String username, String usrId, String vslCd, String wgtCode, String wgtUtCd, String wgtValue, String wh) {
		this.ntfyA = ntfyA;
		this.vslCd = vslCd;
		this.elnoB = elnoB;
		this.elnoA = elnoA;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setBkgTpCd(JSPUtil.getParameter(request, prefix + "bkg_tp_cd", ""));
		...
		setKtSndDtChk(JSPUtil.getParameter(request, prefix + "kt_snd_dt_chk", ""));
		...
		setSumBl1(JSPUtil.getParameter(request, prefix + "sum_bl1", ""));
		setSumBl2(JSPUtil.getParameter(request, prefix + "sum_bl2", ""));
		setSumBl3(JSPUtil.getParameter(request, prefix + "sum_bl3", ""));
		setSumBl4(JSPUtil.getParameter(request, prefix + "sum_bl4", ""));
		...
		setSumBl10(JSPUtil.getParameter(request, prefix + "sum_bl10", ""));
		setMfSndDt(JSPUtil.getParameter(request, prefix + "mf_snd_dt", ""));
		setSumBl11(JSPUtil.getParameter(request, prefix + "sum_bl11", ""));
		...
		setMstBlSeq(JSPUtil.getParameter(request, prefix + "mst_bl_seq", ""));
		setCntr(JSPUtil.getParameter(request, prefix + "cntr", ""));
		setSumBl8(JSPUtil.getParameter(request, prefix + "sum_bl8", ""));
		setSumBl7(JSPUtil.getParameter(request, prefix + "sum_bl7", ""));
		setShprA(JSPUtil.getParameter(request, prefix + "shpr_a", ""));
		setSumBl6(JSPUtil.getParameter(request, prefix + "sum_bl6", ""));
		setSumBl5(JSPUtil.getParameter(request, prefix + "sum_bl5", ""));
		setPodTml(JSPUtil.getParameter(request, prefix + "pod_tml", ""));
		setCBlNo(JSPUtil.getParameter(request, prefix + "c_bl_no", ""));
		setBKtSeq(JSPUtil.getParameter(request, prefix + "b_kt_seq", ""));
		setSumBl9(JSPUtil.getParameter(request, prefix + "sum_bl9", ""));
	}
