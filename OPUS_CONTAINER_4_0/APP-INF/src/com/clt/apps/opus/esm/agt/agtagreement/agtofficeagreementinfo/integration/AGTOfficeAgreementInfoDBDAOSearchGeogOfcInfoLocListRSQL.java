...
*@FileName : AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoLocListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoLocListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchGeogOfcInfoLocList
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoLocListRSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoLocListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#else" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("CASE B.LOC_CD" ).append("\n"); 
		...
		query.append("AND ROUT_LVL_CD      = '6'" ).append("\n"); 
		query.append(") A" ).append("\n"); 
		query.append("WHERE B.LOC_CD                      = A.ROUT_INFO_CD" ).append("\n"); 
