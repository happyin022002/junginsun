...
*@FileName : RFARateGuidelineDBDAOGlineCopyRtRoutPntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOGlineCopyRtRoutPntCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOGlineCopyRtRoutPntCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOGlineCopyRtRoutPntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY G.SVC_SCP_CD, G.GLINE_SEQ, G.CMDT_HDR_SEQ, G.ROUT_SEQ, F.ORG_DEST_TP_CD, F.ROUT_PNT_SEQ) AS ROUT_PNT_SEQ" ).append("\n"); 
		query.append(", F.ROUT_PNT_LOC_TP_CD" ).append("\n"); 
		query.append(", F.ROUT_PNT_LOC_DEF_CD" ).append("\n"); 
		query.append(", F.PRC_TRSP_MOD_CD" ).append("\n"); 
		query.append(", F.RCV_DE_TERM_CD" ).append("\n"); 
