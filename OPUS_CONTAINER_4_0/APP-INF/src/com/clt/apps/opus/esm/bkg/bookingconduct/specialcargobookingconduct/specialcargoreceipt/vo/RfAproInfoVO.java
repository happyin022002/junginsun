...
*@FileName : RfAproInfoVO.java
*@FileTitle : RfAproInfoVO
*Open Issues :
*Change history :
...
public class RfAproInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RfAproInfoVO> models = new ArrayList<RfAproInfoVO>();
	...
	public RfAproInfoVO(String ibflag, String pagerows, String rqstUsrId, String rqstDt, String rqstGdt) {
		this.rqstDt = rqstDt;
...
/**
	 ...
	 * @return RfAproInfoVO[]
	 */
	public RfAproInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RfAproInfoVO[]
	 */
	public RfAproInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RfAproInfoVO model = null;
	...
	public RfAproInfoVO[] getRfAproInfoVOs(){
		RfAproInfoVO[] vos = (RfAproInfoVO[])models.toArray(new RfAproInfoVO[models.size()]);
		return vos;
	}
