...
*@FileName : SCNoteConversionProposalDBDAOPriScNoteConvUptVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAOPriScNoteConvUptVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAOPriScNoteConvUptVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteConversionProposalDBDAOPriScNoteConvUptVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        FROM PRI_SP_SCP_NOTE_CTNT NOTE" ).append("\n"); 
		query.append("            ,PRI_SP_SCP_NOTE_CTNT N_NOTE" ).append("\n"); 
		...
		query.append("        AND N_NOTE.NOTE_TP_CD    = NOTE.NOTE_TP_CD" ).append("\n"); 
		query.append("        AND N_NOTE.NOTE_SEQ      = NOTE.NOTE_SEQ" ).append("\n"); 
		query.append("        AND N_NOTE.NOTE_CTNT_SEQ = NOTE.NOTE_CTNT_SEQ" ).append("\n"); 
		...
		query.append("        AND N_NOTE.NOTE_TP_CD    ='P'" ).append("\n"); 
