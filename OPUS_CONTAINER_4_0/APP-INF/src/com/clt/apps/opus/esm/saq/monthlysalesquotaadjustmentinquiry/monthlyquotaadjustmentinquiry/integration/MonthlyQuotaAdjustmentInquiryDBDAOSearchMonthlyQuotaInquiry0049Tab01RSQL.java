...
*@FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		       AND SMR.RGN_OFC_CD LIKE INP.OFC_CD||'%'       " ).append("\n"); 
		...
		query.append("		            )               " ).append("\n"); 
		query.append("		     GROUP BY VVD.TRD_CD, VVD.DIR_CD, VVD.SUB_TRD_CD, VVD.BSE_YR||VVD.BSE_MON) " ).append("\n"); 
		query.append("		SELECT " ).append("\n"); 
		...
		query.append("		                           AND   DIR_CD = SMR.DIR_CD) AS BSA_LVL_3," ).append("\n"); 
		query.append("		                          (SELECT SUM(BSA) " ).append("\n"); 
		query.append("		                           FROM  VVD " ).append("\n"); 
		query.append("		                           WHERE YRMON = SMR.YRMON" ).append("\n"); 
		query.append("		                           AND   TRD_CD = SMR.TRD_CD" ).append("\n"); 
		...
		query.append("		                    FROM  (" ).append("\n"); 
		query.append("		                            SELECT" ).append("\n"); 
		query.append("		                                  GROUPING(TRD_CD)||GROUPING(DIR_CD)||GROUPING(SUB_TRD_CD)AS G_FLAG," ).append("\n"); 
		query.append("		                                  MIN(SMR.TRD_CD||SMR.DIR_CD||SMR.SUB_TRD_CD) AS KEY,                  " ).append("\n"); 
		query.append("		                                  TRD_CD," ).append("\n"); 
		query.append("		                                  DIR_CD," ).append("\n"); 
		query.append("		                                  SUB_TRD_CD," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("		                                           AND SMR.RHQ_CD LIKE INP.RHQ_CD||'%'   " ).append("\n"); 
		query.append("		                                           AND SMR.LOD_QTY > 0  " ).append("\n"); 
		query.append("		                                           AND SMR.RGN_OFC_CD LIKE INP.OFC_CD||'%'       " ).append("\n"); 
		query.append("		                                           AND SMR.BSE_YR = HDR.BSE_YR " ).append("\n"); 
		query.append("		                                           AND SMR.BSE_QTR_CD = HDR.BSE_QTR_CD " ).append("\n"); 
		query.append("		                                           AND SMR.SAQ_TGT_GRP_CD = HDR.SAQ_TGT_GRP_CD " ).append("\n"); 
		...
		query.append("		                                           AND SMR.DIR_CD = HDR.DIR_CD " ).append("\n"); 
		query.append("		                                           AND SMR.DAT_CRE_STEP_CD = HDR.DAT_CRE_STEP_CD " ).append("\n"); 
		query.append("		                                    GROUP BY SMR.TRD_CD, SMR.DIR_CD, SMR.SUB_TRD_CD, SMR.BSE_YR||SMR.BSE_MON" ).append("\n"); 
		query.append("		                                  ) SMR " ).append("\n"); 
		query.append("		                            GROUP BY GROUPING SETS((YRMON), " ).append("\n"); 
		query.append("		                                                    (SMR.TRD_CD, YRMON), " ).append("\n"); 
		query.append("		                                                    (SMR.TRD_CD, SMR.DIR_CD, YRMON), " ).append("\n"); 
		query.append("		                                                    (SMR.TRD_CD, SMR.DIR_CD, SMR.SUB_TRD_CD, YRMON))    " ).append("\n"); 
		query.append("		                          ) SMR    " ).append("\n"); 
		query.append("		                  ) SMR                                                                                " ).append("\n"); 
		query.append("		          ) SMR " ).append("\n"); 
		query.append("		          JOIN " ).append("\n"); 
		...
		query.append("	      #elseif (${orgType} == 'RHQ' )  -- 지역본부는 BSA, L/F를 보여주지 않는다." ).append("\n"); 
		query.append("			       WHERE INTG_CD_ID = 'CD01390' " ).append("\n"); 
		query.append("	      #elseif (${orgType} == 'OFC' )  --  점소는 BSA, L/F, 실적 CM/OP 를 보여주지 않는다." ).append("\n"); 
