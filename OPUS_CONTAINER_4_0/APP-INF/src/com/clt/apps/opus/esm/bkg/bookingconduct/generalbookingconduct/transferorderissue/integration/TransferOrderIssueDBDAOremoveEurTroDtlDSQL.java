...
*@FileName : TransferOrderIssueDBDAOremoveEurTroDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOremoveEurTroDtlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TransferOrderIssueDBDAOremoveEurTroDtlDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_EUR_TRO_DTL" ).append("\n"); 
		...
		query.append("FileName : TransferOrderIssueDBDAOremoveEurTroDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}