...
*@FileName       : SearchMonthlyQuotaInquiry0139Tab03VO.java
*@FileTitle      : SearchMonthlyQuotaInquiry0139Tab03VO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiry0139Tab03VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiry0139Tab03VO> models = new ArrayList<SearchMonthlyQuotaInquiry0139Tab03VO>();
	...
	public SearchMonthlyQuotaInquiry0139Tab03VO() {}

	public SearchMonthlyQuotaInquiry0139Tab03VO(String ibflag, String pagerows, String key, String slevel, String tgtGrpCd, String trdCd, String dirCd, String rhqCd, String aqCd, String ofcCd, String subTrdCd, String rlaneCd, String convDirCd, String rowSeq, String itemText, String item, String val00, String val01, String val02, String val03) {
		this.val01 = val01;
		this.val02 = val02;
		this.val00 = val00;
		this.rhqCd = rhqCd;
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiry0139Tab03VO[]
	 */
	public SearchMonthlyQuotaInquiry0139Tab03VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiry0139Tab03VO[]
	 */
	public SearchMonthlyQuotaInquiry0139Tab03VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiry0139Tab03VO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiry0139Tab03VO();
				if (val01[i] != null)
		...
		return getSearchMonthlyQuotaInquiry0139Tab03VOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiry0139Tab03VO[]
	 */
	public SearchMonthlyQuotaInquiry0139Tab03VO[] getSearchMonthlyQuotaInquiry0139Tab03VOs(){
		SearchMonthlyQuotaInquiry0139Tab03VO[] vos = (SearchMonthlyQuotaInquiry0139Tab03VO[])models.toArray(new SearchMonthlyQuotaInquiry0139Tab03VO[models.size()]);
		return vos;
	}
