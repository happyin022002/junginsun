...
*@FileName : KorMsnNoInfoVO.java
*@FileTitle : KorMsnNoInfoVO
*Open Issues :
*Change history :
...
public class KorMsnNoInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorMsnNoInfoVO> models = new ArrayList<KorMsnNoInfoVO>();
	...
	public KorMsnNoInfoVO() {}

	public KorMsnNoInfoVO(String ibflag, String pagerows, String msnNo, String bkgNo, String blNo, String cstmsDeclTpCd, String portCd, String trnsSeq, String usrId) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return KorMsnNoInfoVO[]
	 */
	public KorMsnNoInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMsnNoInfoVO[]
	 */
	public KorMsnNoInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMsnNoInfoVO model = null;
	 ...
	 * @return KorMsnNoInfoVO[]
	 */
	public KorMsnNoInfoVO[] getKorMsnNoInfoVOs(){
		KorMsnNoInfoVO[] vos = (KorMsnNoInfoVO[])models.toArray(new KorMsnNoInfoVO[models.size()]);
		return vos;
	}
