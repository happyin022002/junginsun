    	...
    	try{
		    ...
		    if(totCnt2 > 0){
	    		while(rowSet2.next()){
	                ...
	                log.debug("fnl_co_bsa_capa     = " + JSPUtil.getNull((String)rowSet2.getString("fnl_co_bsa_capa"    )));
					...
					strBuilder.append("  <TD>"+JSPUtil.getNull((String)rowSet2.getString("fnl_co_bsa_capa"		))+"</TD>");
