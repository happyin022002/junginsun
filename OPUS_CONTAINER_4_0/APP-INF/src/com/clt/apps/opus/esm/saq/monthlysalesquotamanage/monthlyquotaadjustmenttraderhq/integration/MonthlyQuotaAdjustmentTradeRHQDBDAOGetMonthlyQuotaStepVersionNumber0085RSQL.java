...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetMonthlyQuotaStepVersionNumber0085RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOGetMonthlyQuotaStepVersionNumber0085RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 기존 version을 select한다.
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOGetMonthlyQuotaStepVersionNumber0085RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetMonthlyQuotaStepVersionNumber0085RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
