...
*@FileName : EurCustomsTransmissionDBDAOsearchCctUsdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurCustomsTransmissionDBDAOsearchCctUsdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurCustomsTransmissionDBDAOsearchCctUsdRSQL(){
		setQuery();
		...
		query.append("FileName : EurCustomsTransmissionDBDAOsearchCctUsdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(ROUND(NVL(SUM(CHG_AMT * DECODE(INV_XCH_RT, 0, MON_RT, INV_XCH_RT)),0), 6), 'FM999999999999990.000000') AS TOTAL_COLLECT" ).append("\n"); 
		...
		query.append("                                      ,ROW_NUMBER() OVER(ORDER BY V.VSL_PRE_PST_CD DESC, VSL_SEQ DESC) AS RNUM" ).append("\n"); 
