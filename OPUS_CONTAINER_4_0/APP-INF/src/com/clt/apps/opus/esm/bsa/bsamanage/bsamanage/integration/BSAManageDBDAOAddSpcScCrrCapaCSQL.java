...
*@FileName : BSAManageDBDAOAddSpcScCrrCapaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOAddSpcScCrrCapaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAOAddSpcScCrrCapaCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOAddSpcScCrrCapaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
