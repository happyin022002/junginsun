...
*@FileName : CstPriSpCtrtPtyVO.java
*@FileTitle : CstPriSpCtrtPtyVO
*Open Issues :
*Change history :
...
public class CstPriSpCtrtPtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriSpCtrtPtyVO> models = new ArrayList<CstPriSpCtrtPtyVO>();
	 ...
	 * @param request
	 * @return CstPriSpCtrtPtyVO[]
	 */
	public CstPriSpCtrtPtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpCtrtPtyVO[]
	 */
	public CstPriSpCtrtPtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriSpCtrtPtyVO model = null;
	 ...
	 * @return CstPriSpCtrtPtyVO[]
	 */
	public CstPriSpCtrtPtyVO[] getCstPriSpCtrtPtyVOs(){
		CstPriSpCtrtPtyVO[] vos = (CstPriSpCtrtPtyVO[])models.toArray(new CstPriSpCtrtPtyVO[models.size()]);
		return vos;
	}
