...
*@FileName       : SearchMonthlyQuotaInquiryHR0049Tab03VO.java
*@FileTitle      : SearchMonthlyQuotaInquiryHR0049Tab03VO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiryHR0049Tab03VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiryHR0049Tab03VO> models = new ArrayList<SearchMonthlyQuotaInquiryHR0049Tab03VO>();
	...
	public SearchMonthlyQuotaInquiryHR0049Tab03VO() {}

	public SearchMonthlyQuotaInquiryHR0049Tab03VO(String ibflag, String pagerows, String key, String slevel, String dirCd, String rhqCd, String aqCd, String ofcCd, String subTrdCd, String rlaneCd, String convDirCd, String rowSeq, String itemText, String item, String val00, String val01, String val02, String val03) {
		this.val01 = val01;
		this.val02 = val02;
		this.val00 = val00;
		this.rhqCd = rhqCd;
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiryHR0049Tab03VO[]
	 */
	public SearchMonthlyQuotaInquiryHR0049Tab03VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiryHR0049Tab03VO[]
	 */
	public SearchMonthlyQuotaInquiryHR0049Tab03VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiryHR0049Tab03VO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiryHR0049Tab03VO();
				if (val01[i] != null)
		...
		return getSearchMonthlyQuotaInquiryHR0049Tab03VOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiryHR0049Tab03VO[]
	 */
	public SearchMonthlyQuotaInquiryHR0049Tab03VO[] getSearchMonthlyQuotaInquiryHR0049Tab03VOs(){
		SearchMonthlyQuotaInquiryHR0049Tab03VO[] vos = (SearchMonthlyQuotaInquiryHR0049Tab03VO[])models.toArray(new SearchMonthlyQuotaInquiryHR0049Tab03VO[models.size()]);
		return vos;
	}
