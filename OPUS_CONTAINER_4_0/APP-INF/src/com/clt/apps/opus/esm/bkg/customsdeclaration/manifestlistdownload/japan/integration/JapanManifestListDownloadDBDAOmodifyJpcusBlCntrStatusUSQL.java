...
*@FileName : JapanManifestListDownloadDBDAOmodifyJpcusBlCntrStatusUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOmodifyJpcusBlCntrStatusUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyJpcusBlCntrStatus
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOmodifyJpcusBlCntrStatusUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("JP_CSTMS_CNTR_STS_CD = 'A'" ).append("\n");
		...
		query.append("FileName : JapanManifestListDownloadDBDAOmodifyJpcusBlCntrStatusUSQL").append("\n");
		query.append("*/").append("\n");
	}
}