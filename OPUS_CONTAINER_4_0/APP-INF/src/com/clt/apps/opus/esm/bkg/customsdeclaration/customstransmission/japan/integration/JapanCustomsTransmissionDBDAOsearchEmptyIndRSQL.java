...
*@FileName : JapanCustomsTransmissionDBDAOsearchEmptyIndRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanCustomsTransmissionDBDAOsearchEmptyIndRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanCustomsTransmissionDBDAOsearchEmptyIndRSQL(){
		setQuery();
		...
		query.append("FileName : JapanCustomsTransmissionDBDAOsearchEmptyIndRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT FULL_MTY_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
