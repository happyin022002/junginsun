...
public class ESM_BKG_0381HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI01)) {
			...
			event.setListVOS((ArrNtcSendListVO[]) getVOs(request, ArrNtcSendListVO.class,"t1sheet1_"));
		...
		//E-Mail 전송
			...
			event.setSearchVO((ArrivalNoticeSearchVO) getVO(request, ArrivalNoticeSearchVO.class));
			event.setListVO((ArrNtcSendListVO) getVO(request, ArrNtcSendListVO.class,"t1sheet1_"));
