...
*@FileName : ScCustInformVO.java
*@FileTitle : ScCustInformVO
*Open Issues :
*Change history :
...
public class ScCustInformVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScCustInformVO> models = new ArrayList<ScCustInformVO>();
	 ...
	 */
	public ScCustInformVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScCustInformVO[]
	 */
	public ScCustInformVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScCustInformVO model = null;
	...
	public ScCustInformVO[] getScCustInformVOs(){
		ScCustInformVO[] vos = (ScCustInformVO[])models.toArray(new ScCustInformVO[models.size()]);
		return vos;
	}
