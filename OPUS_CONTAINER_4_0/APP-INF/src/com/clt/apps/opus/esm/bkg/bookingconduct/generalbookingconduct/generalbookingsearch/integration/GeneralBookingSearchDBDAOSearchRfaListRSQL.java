...
public class GeneralBookingSearchDBDAOSearchRfaListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("with cust as (select cust_cnt_cd, cust_seq, cust_lgl_eng_nm" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("		union" ).append("\n"); 
		query.append("		select '' cust_cnt_cd, null as cust_seq, '' cust_lgl_eng_nm" ).append("\n"); 
		...
		query.append("    AND MAIN.exp_dt + 0.9999 > APPL.APPL_DT" ).append("\n"); 
		query.append("    AND main.prop_sts_cd    = 'A'" ).append("\n"); 
		query.append("    AND NVL(MAIN.TRF_CTRT_FLG,'N') = 'Y' -- Tariff Rate" ).append("\n"); 
		query.append("	AND cust.cust_cnt_cd is null" ).append("\n"); 
