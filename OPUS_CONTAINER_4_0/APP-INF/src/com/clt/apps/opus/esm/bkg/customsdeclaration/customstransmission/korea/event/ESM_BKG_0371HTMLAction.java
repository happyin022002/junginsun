...
public class ESM_BKG_0371HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if (command.isCommand(FormCommand.SEARCH)) {
			// MRN 조회
			event.setKorMrnCreateInfoCondVO((KorMrnCreateInfoCondVO)getVO(request, KorMrnCreateInfoCondVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			// MRN SAVE
//↓↓↓↓↓↓↓↓↓↓///////////////////////////
			event.setAttribute("ff_div", request.getParameter("ff_div"));
//↑↑↑↑↑↑↑↑↑↑///////////////////////////
			event.setKorMrnCreateInfoVOs((KorMrnCreateInfoVO[])getVOs(request, KorMrnCreateInfoVO.class, "sheet_"));
