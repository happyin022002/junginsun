...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList08RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList08RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_rout_ref 를 조회하여 결과를 bkg_ofc_inp_term_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList08RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList08RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    ROUT_REF_DIV_CD = 'BKOF'" ).append("\n"); 
