...
*@FileName : BlRatingDBDAOcopyChgRateByBkgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOcopyChgRateByBkgCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOcopyChgRateByBkgCSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOcopyChgRateByBkgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CHG_RT(BKG_NO" ).append("\n"); 
		...
		query.append("		,(SELECT /*+index_desc (bkg_chg_rt XPKBKG_CHG_RT)*/" ).append("\n"); 
		query.append("					NVL(SUM(RT_SEQ),0)+CHG.RT_SEQ" ).append("\n"); 
		query.append("					FROM BKG_CHG_RT" ).append("\n"); 
		query.append("					WHERE RT_SEQ >= 0" ).append("\n"); 
		query.append("					AND ROWNUM <= 1" ).append("\n"); 
		query.append("					AND BKG_NO = @[mst_bkg_no]) RT_SEQ" ).append("\n"); 
		query.append("        , DP_SEQ" ).append("\n"); 
		query.append("        , FRT_TERM_CD" ).append("\n"); 
		query.append("        , TRF_ITM_NO" ).append("\n"); 
		query.append("        , CGO_CATE_CD" ).append("\n"); 
