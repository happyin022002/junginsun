...
public class Eur24ManifestDownloadDBDAOSearchVesselArrivalNotice1RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC(COM_ConstantMgr_PKG.COM_getHeadOfficeCode_FNC(), TO_DATE(BKG_GET_TOKEN_FNC(EDI, 1),'YYYYMMDDHH24MISS')  , BKG_GET_TOKEN_FNC(EDI, 8) ), 'YYYY-MM-DD HH24:MI') AS EDI_RCV_DT," ).append("\n"); 
		...
		query.append("            DECODE(CONV.ATTR_CTNT1, NULL, TO_CHAR(XXX.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD HH24') ||':00'" ).append("\n"); 
		query.append("                                        , TO_CHAR(XXX.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD') || ' ' || CONV.ATTR_CTNT2)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("                ELSE " ).append("\n"); 
		query.append("                    DECODE(CONV.ATTR_CTNT1, NULL, TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD HH24')||':00'" ).append("\n"); 
		query.append("                                                , TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD') || ' ' || CONV.ATTR_CTNT2)" ).append("\n"); 
		query.append("            END" ).append("\n"); 
		query.append("            " ).append("\n"); 
		...
		query.append("          AND EV.RVIS_CSTMS_YD_CD LIKE DECODE(A.TML_CD, 'ALL' , '%' , A.TML_CD)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("      AND VSL.VSL_RGST_CNT_CD = CNT.CNT_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
