...
*@FileName : ChinaManifestListDownloadDBDAOsearchVslRgstFromChnCorrVvdRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOsearchVslRgstFromChnCorrVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOsearchVslRgstFromChnCorrVvdRSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOsearchVslRgstFromChnCorrVvdRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("               CHN.CRR_CD," ).append("\n");
		query.append("               CNTR.VSL_ENG_NM," ).append("\n");
		query.append("               CNTR.LLOYD_NO," ).append("\n");
		query.append("               SKD.VSL_CD," ).append("\n");
		query.append("               CHN.IB_SKD_VOY_NO," ).append("\n");
		query.append("               CHN.IB_SKD_DIR_NM," ).append("\n");
		query.append("               CHN.OB_SKD_VOY_NO," ).append("\n");
		query.append("               CHN.OB_SKD_DIR_NM," ).append("\n");
