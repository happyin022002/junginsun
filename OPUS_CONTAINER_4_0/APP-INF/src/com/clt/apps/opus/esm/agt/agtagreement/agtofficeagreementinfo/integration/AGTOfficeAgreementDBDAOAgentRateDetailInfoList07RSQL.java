...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList07RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList07RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_ctrt_ref 조회 결과를 rfa_ofc_inp_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList07RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList07RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    CTRT_REF_DIV_CD = 'RFAO'" ).append("\n"); 
		query.append("AND    CTRT_LVL_CD = '2' )) T START WITH NO = 1 CONNECT BY NOCYCLE PRIOR NO = NO - 1" ).append("\n"); 
