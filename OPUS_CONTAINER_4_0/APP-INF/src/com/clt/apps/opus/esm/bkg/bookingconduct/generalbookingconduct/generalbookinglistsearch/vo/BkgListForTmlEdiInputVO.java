...
*@FileName : BkgListForTmlEdiInputVO.java
*@FileTitle : BkgListForTmlEdiInputVO
*Open Issues :
*Change history :
 ...
 */
public class BkgListForTmlEdiInputVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<BkgListForTmlEdiInputVO> models = new ArrayList<BkgListForTmlEdiInputVO>();
    ...
    public BkgListForTmlEdiInputVO() {
    }

    public BkgListForTmlEdiInputVO(String ibflag, String pagerows, String searchType, String bkgFromDt, String bkgToDt, String bkgOfcCd, String bkgStsCd, String ediSendStsCd, String ack, String vvd, String polCd, String slanCd, String bkgNo, String bkgStaff, String polYdCd, String dateType) {
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setEdiSendStsCd(JSPUtil.getParameter(request, prefix + "edi_send_sts_cd", ""));
	 ...
	 */
    public BkgListForTmlEdiInputVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgListForTmlEdiInputVO[]
	 */
    public BkgListForTmlEdiInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        BkgListForTmlEdiInputVO model = null;
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                model = new BkgListForTmlEdiInputVO();
                if (bkgOfcCd[i] != null)
        ...
        return getBkgListForTmlEdiInputVOs();
    }
	 ...
	 * @return BkgListForTmlEdiInputVO[]
	 */
    public BkgListForTmlEdiInputVO[] getBkgListForTmlEdiInputVOs() {
        BkgListForTmlEdiInputVO[] vos = (BkgListForTmlEdiInputVO[]) models.toArray(new BkgListForTmlEdiInputVO[models.size()]);
        return vos;
    }
