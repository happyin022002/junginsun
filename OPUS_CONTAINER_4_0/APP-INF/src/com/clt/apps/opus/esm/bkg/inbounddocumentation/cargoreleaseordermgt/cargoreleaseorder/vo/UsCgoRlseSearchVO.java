...
*@FileName : UsCgoRlseSearchVO.java
*@FileTitle : UsCgoRlseSearchVO
*Open Issues :
*Change history :
...
public class UsCgoRlseSearchVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsCgoRlseSearchVO> models = new ArrayList<UsCgoRlseSearchVO>();
	...
	public UsCgoRlseSearchVO() {}

	public UsCgoRlseSearchVO(String ibflag, String pagerows, String blNo, String vvd, String podCd, String delCd, String hubLocCd, String mrnTmlEdiSndCd, String frtCltFlg, String oblRdemFlg, String cstmsClrCd, String startDate, String startTime, String endDate, String endTime, String dtlBlNo) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("start_time", getStartTime());
		this.hashColumns.put("ibflag", getIbflag());
		this.hashColumns.put("frt_clt_flg", getFrtCltFlg());
		this.hashColumns.put("dtl_bl_no", getDtlBlNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("start_time", "startTime");
		this.hashFields.put("ibflag", "ibflag");
		this.hashFields.put("frt_clt_flg", "frtCltFlg");
		this.hashFields.put("dtl_bl_no", "dtlBlNo");
	 ...
	 * @param dtlBlNo
	 */
	public void setDtlBlNo(String dtlBlNo) {
		this.dtlBlNo = dtlBlNo;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setEndTime(JSPUtil.getParameter(request, "end_time", ""));
		setBlNo(JSPUtil.getParameter(request, "bl_no", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setVvd(JSPUtil.getParameter(request, "vvd", ""));
		setPodCd(JSPUtil.getParameter(request, "pod_cd", ""));
		setStartTime(JSPUtil.getParameter(request, "start_time", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setFrtCltFlg(JSPUtil.getParameter(request, "frt_clt_flg", ""));
		setDtlBlNo(JSPUtil.getParameter(request, "dtl_bl_no", ""));
	 ...
	 * @param request
	 * @return UsCgoRlseSearchVO[]
	 */
	public UsCgoRlseSearchVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsCgoRlseSearchVO[]
	 */
	public UsCgoRlseSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsCgoRlseSearchVO model = null;
		...
		try {
			...
			String[] startTime = (JSPUtil.getParameter(request, prefix	+ "start_time", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] frtCltFlg = (JSPUtil.getParameter(request, prefix	+ "frt_clt_flg", length));
			String[] dtlBlNo = (JSPUtil.getParameter(request, prefix	+ "dtl_bl_no", length));
			String[] hubLocCd = (JSPUtil.getParameter(request, prefix	+ "hub_loc_cd", length));
			
			for (int i = 0; i < length; i++) {
				model = new UsCgoRlseSearchVO();
				if (startDate[i] != null)
	 ...
	 * @return UsCgoRlseSearchVO[]
	 */
	public UsCgoRlseSearchVO[] getUsCgoRlseSearchVOs(){
		UsCgoRlseSearchVO[] vos = (UsCgoRlseSearchVO[])models.toArray(new UsCgoRlseSearchVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.startTime = this.startTime .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.frtCltFlg = this.frtCltFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.dtlBlNo = this.dtlBlNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
