...
*@FileName : StatusReportDBDAOSearchVgmAutoVermasEdiSupRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOSearchVgmAutoVermasEdiSupRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search VGM Auto VERMAS EDI SUP
	  * </pre>
	  */
	public StatusReportDBDAOSearchVgmAutoVermasEdiSupRSQL(){
		setQuery();
		...
		query.append("FileName : StatusReportDBDAOSearchVgmAutoVermasEdiSupRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                BKG_NO," ).append("\n"); 
		query.append("                NTC_KND_CD," ).append("\n"); 
		query.append("                ROW_NUMBER() OVER (PARTITION BY EDI_RECEIVE_ID, REF_CODE, EDI_SND_ID ORDER BY DECODE(NTC_KND_CD,'VC','1','VP','2','VT')) DUP_CHK" ).append("\n"); 
		...
		query.append("                    AND EDI_MSG_IND_CD = 31" ).append("\n"); 
		...
		query.append("                    AND MSG.EDI_MSG_TP_ID = 'VGM'" ).append("\n"); 
		query.append("                    AND MSG.MSG_TP_DESC = '1'" ).append("\n"); 
		query.append("                    AND EDI_MSG_IND_CD = 32" ).append("\n"); 
		...
		query.append("                    AND MSG.EDI_MSG_TP_ID = 'VGM'" ).append("\n"); 
		query.append("                    AND MSG.MSG_TP_DESC = '1'" ).append("\n"); 
		query.append("                    AND EDI_MSG_IND_CD = 33" ).append("\n"); 
		query.append("                    AND EXISTS (SELECT 'Y' " ).append("\n"); 
		query.append("                                  FROM BKG_VVD " ).append("\n"); 
		query.append("                                 WHERE BB.BKG_NO = BKG_NO " ).append("\n"); 
		query.append("                                   AND EY.PRNR_SUB_LNK_CD = POL_YD_CD " ).append("\n"); 
		query.append("                                   AND BB.POL_NOD_CD <> POL_YD_CD)" ).append("\n"); 
		query.append("             )" ).append("\n"); 
