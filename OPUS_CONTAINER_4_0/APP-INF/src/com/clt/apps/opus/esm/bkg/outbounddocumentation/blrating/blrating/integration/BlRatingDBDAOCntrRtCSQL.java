...
*@FileName : BlRatingDBDAOCntrRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOCntrRtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOCntrRtCSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOCntrRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[bkg_no]" ).append("\n"); 
		query.append(",	@[cntr_no]" ).append("\n"); 
		query.append(",	(select nvl(max(cntr_rt_seq),0)+1 from BKG_CNTR_RT where bkg_no=@[bkg_no] and cntr_no=@[cntr_no])" ).append("\n"); 
		query.append(",	@[mst_bkg_no]" ).append("\n"); 
		query.append(",	@[cntr_tpsz_cd]" ).append("\n"); 
		query.append(",	@[frt_term_cd]" ).append("\n"); 
		query.append(",	@[dp_seq]" ).append("\n"); 
