...
*@FileName : CntrMfInfoVO.java
*@FileTitle : CntrMfInfoVO
*Open Issues :
*Change history :
...
public class DubaiCntrMfInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DubaiCntrMfInfoVO> models = new ArrayList<DubaiCntrMfInfoVO>();
...
/**
	 ...
	 * @return CntrMfInfoVO[]
	 */
	public DubaiCntrMfInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntrMfInfoVO[]
	 */
	public DubaiCntrMfInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DubaiCntrMfInfoVO model = null;
	 ...
	 * @return CntrMfInfoVO[]
	 */
	public DubaiCntrMfInfoVO[] getCntrMfInfoVOs(){
		DubaiCntrMfInfoVO[] vos = (DubaiCntrMfInfoVO[])models.toArray(new DubaiCntrMfInfoVO[models.size()]);
		return vos;
	}
