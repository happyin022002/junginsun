...
public class NewZealandCstmsVvdRefNoCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	private Collection<NewZealandCstmsVvdRefNoCondVO> models = new ArrayList<NewZealandCstmsVvdRefNoCondVO>();
	...
	public NewZealandCstmsVvdRefNoCondVO() {}

	public NewZealandCstmsVvdRefNoCondVO(String ibflag, String pagerows, String eVpsEtaDt, String sVpsEtaDt, String vvdCd, String cvyRefNo, String slanCd, String vpsPortCd, String crrCd) {
	...
	public NewZealandCstmsVvdRefNoCondVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public NewZealandCstmsVvdRefNoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandCstmsVvdRefNoCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandCstmsVvdRefNoCondVO();
				if (sVpsEtaDt[i] != null)
		...
		return getNewZealandCstmsVvdRefNoCondVOs();
	}

	public NewZealandCstmsVvdRefNoCondVO[] getNewZealandCstmsVvdRefNoCondVOs(){
		NewZealandCstmsVvdRefNoCondVO[] vos = (NewZealandCstmsVvdRefNoCondVO[])models.toArray(new NewZealandCstmsVvdRefNoCondVO[models.size()]);
		return vos;
	}
