 ...
 *@FileName : ESM_PRI_2033HTMLAction.java
...
public class ESM_PRI_2033HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2033HTMLAction 객체를 생성
	 */
	public ESM_PRI_2033HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2033Event event = new EsmPri2033Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			vo
					.setPriRpScpGriActCustVOS((PriRpScpGriActCustVO[]) getVOs(request, PriRpScpGriActCustVO.class,
							"sheet4_"));
			vo.setPriRpScpGriRoutOrgPntVOS((PriRpScpGriRoutPntVO[]) getVOs(request, PriRpScpGriRoutPntVO.class,
					"sheet5_"));
			vo.setPriRpScpGriRoutOrgViaVOS((PriRpScpGriRoutViaVO[]) getVOs(request, PriRpScpGriRoutViaVO.class,
					"sheet6_"));
			vo.setPriRpScpGriRoutDestViaVOS((PriRpScpGriRoutViaVO[]) getVOs(request, PriRpScpGriRoutViaVO.class,
					"sheet7_"));
			vo.setPriRpScpGriRoutDestPntVOS((PriRpScpGriRoutPntVO[]) getVOs(request, PriRpScpGriRoutPntVO.class,
					"sheet8_"));
