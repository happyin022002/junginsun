...
*@FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI RP SCP GRP LOC DTL Guideline Copy 생성
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("LOC.GRP_LOC_DTL_SEQ," ).append("\n"); 
		...
		query.append("PRI_RG_GRP_LOC_DTL LOC" ).append("\n"); 
		query.append("" ).append("\n"); 
