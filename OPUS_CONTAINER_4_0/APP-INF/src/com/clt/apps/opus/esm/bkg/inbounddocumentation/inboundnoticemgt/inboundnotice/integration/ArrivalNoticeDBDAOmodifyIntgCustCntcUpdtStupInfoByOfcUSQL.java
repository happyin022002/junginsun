...
public class ArrivalNoticeDBDAOmodifyIntgCustCntcUpdtStupInfoByOfcUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       UPD_LOCL_DT  = GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,SYSDATE,GLOBALDATE_PKG.GET_LOCCD_FNC(@[ofc_cd]))," ).append("\n"); 
		query.append("       UPD_LOCL_GDT = GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,SYSDATE,'GMT')," ).append("\n"); 
