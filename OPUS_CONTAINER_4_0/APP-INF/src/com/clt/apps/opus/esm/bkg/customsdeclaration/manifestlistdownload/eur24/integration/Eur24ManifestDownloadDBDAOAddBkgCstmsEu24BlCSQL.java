...
*@FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24BlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBkgCstmsEu24BlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAOAddBkgCstmsEu24BlCSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBkgCstmsEu24BlCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24BlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("   VSL_CD,      SKD_VOY_NO,     SKD_DIR_CD, BL_NO,              CSTMS_PORT_CD,  CSTMS_CLPT_IND_SEQ" ).append("\n"); 
		query.append(" , BKG_POL_CD,  BKG_POD_CD,     POL_CD,     POL_CLPT_IND_SEQ,   POD_CD,         POD_CLPT_IND_SEQ,       DEL_CD" ).append("\n"); 
		...
		query.append(" , MVMT_REF_NO, MSG_SND_NO,    CSTMS_ESTM_ARR_DT" ).append("\n"); 
		query.append(")  " ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
		query.append("  X.VSL_CD,    X.SKD_VOY_NO,  X.SKD_DIR_CD,  X.BL_NO,      X.CSTMS_PORT_CD,		X.CSTMS_CLPT_IND_SEQ" ).append("\n"); 
		query.append(" ,BKG.POL_CD,  BKG.POD_CD,    VVD.POL_CD,   VVD.POL_CLPT_IND_SEQ,   VVD.POD_CD,     VVD.POD_CLPT_IND_SEQ,   BKG.DEL_CD  " ).append("\n"); 
		...
		query.append(" , VVD.POL_YD_CD, VVD.POD_YD_CD ,   DECODE(@[p_type], 'ENS', @[eu_1st_port_yd_cd], 'FI', VVD.POD_YD_CD)" ).append("\n"); 
		query.append(" , X.MVMT_REF_NO, X.MSG_SND_NO, TO_DATE(X.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD HH24:MI:SS') AS CSTMS_ESTM_ARR_DT" ).append("\n"); 
		...
		query.append("             , BKG_GET_TOKEN_FNC(COLUMN_VALUE,9) AS CSTMS_ESTM_ARR_DT" ).append("\n"); 
		query.append("             , BKG_GET_TOKEN_FNC(COLUMN_VALUE,10)AS CSTMS_CLPT_IND_SEQ" ).append("\n"); 
