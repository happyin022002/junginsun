...
*@FileName : QtaAdjustmentDBDAOSearchQtaEditPolPodPairAddRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaAdjustmentDBDAOSearchQtaEditPolPodPairAddRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public QtaAdjustmentDBDAOSearchQtaEditPolPodPairAddRSQL(){
		setQuery();
		...
		query.append("FileName : QtaAdjustmentDBDAOSearchQtaEditPolPodPairAddRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
