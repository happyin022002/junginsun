...
public class GeneralBookingReceiptDBDAOaddCargoClosingTimeCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                    FROM (SELECT ASCII(BKG_CUST_TP_CD) AS RNK, NTC_SET.ITM_SEQ" ).append("\n"); 
		...
		query.append("                          SELECT (SELECT ASCII(MAX(BKG_CUST_TP_CD))+1 FROM BKG_CUSTOMER WHERE BKG_NO=BK.BKG_NO), NTC_SET.ITM_SEQ" ).append("\n"); 
