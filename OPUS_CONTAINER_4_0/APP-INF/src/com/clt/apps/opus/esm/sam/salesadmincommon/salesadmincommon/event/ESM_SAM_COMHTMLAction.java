...
public class ESM_SAM_COMHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_COMHTMLAction 객체를 생성
	 */
	public ESM_SAM_COMHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSamComEvent event = new EsmSamComEvent();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScrNo(request.getParameter("scr_no"));
		}
		return  event;
	}
