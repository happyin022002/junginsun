...
*@FileName : ESM_BKG_0179HTMLAction.java
 ...
 * 
 * @author 
 * @see EsmBkg0179Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_0179HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0179HTMLAction 객체를 생성
	 */
	public ESM_BKG_0179HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0179Event event = new EsmBkg0179Event();
        log.debug("::CALL:: ESM_BKG_0179HTMLAction : " + command.getCommand());

        if(command.isCommand(FormCommand.SEARCH)) {
        	log.debug("------------>search");
        	event.setBlRemarkVO((BlRemarkVO)getVO(request, BlRemarkVO .class));
        	log.debug("------------>blremarkvo  "+event.getBlRemarkVO().getBkgNo());
        }
