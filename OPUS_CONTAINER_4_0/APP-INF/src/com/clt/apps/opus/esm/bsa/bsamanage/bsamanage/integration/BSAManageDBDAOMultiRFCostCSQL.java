...
*@FileName : BSAManageDBDAOMultiRFCostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOMultiRFCostCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSAManageDBDAOMultiRFCostCSQL
	  * </pre>
	  */
	public BSAManageDBDAOMultiRFCostCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOMultiRFCostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL BSA_MULTI_RF_SCG_PRC(" ).append("\n"); 
