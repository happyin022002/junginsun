...
*@FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab01RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search MonthlyQuotaInquiry139 List01
	  * </pre>
	  */
	public MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                     WHEN '1111' THEN SMR.BSA_LVL_1" ).append("\n"); 
		query.append("                     WHEN '0111' THEN SMR.BSA_LVL_2" ).append("\n"); 
		query.append("                     WHEN '0011' THEN SMR.BSA_LVL_3" ).append("\n"); 
		query.append("                     WHEN '0001' THEN SMR.BSA_LVL_4" ).append("\n"); 
		query.append("                     WHEN '0000' THEN SMR.BSA_LVL_5" ).append("\n"); 
		query.append("                  END BSA, " ).append("\n"); 
		query.append("                  CASE G_FLAG" ).append("\n"); 
		query.append("                     WHEN '1111' THEN SMR.VOYAGE_LVL_1" ).append("\n"); 
		query.append("                     WHEN '0111' THEN SMR.VOYAGE_LVL_2" ).append("\n"); 
		query.append("                     WHEN '0011' THEN SMR.VOYAGE_LVL_3" ).append("\n"); 
		query.append("                     WHEN '0001' THEN SMR.VOYAGE_LVL_4" ).append("\n"); 
		query.append("                     WHEN '0000' THEN SMR.VOYAGE_LVL_5" ).append("\n"); 
		...
		query.append("                    FROM  (" ).append("\n"); 
		query.append("                            SELECT " ).append("\n"); 
		query.append("                                 GROUPING(TGT_GRP_CD)||GROUPING(TRD_CD)||GROUPING(CONV_DIR_CD)||GROUPING(SUB_TRD_CD)AS G_FLAG," ).append("\n"); 
		query.append("                                 MIN(SMR.TGT_GRP_CD||SMR.TRD_CD||SMR.CONV_DIR_CD||SMR.SUB_TRD_CD) AS KEY," ).append("\n"); 
		query.append("                                 SMR.TGT_GRP_CD," ).append("\n"); 
		query.append("                                 SMR.TRD_CD,  " ).append("\n"); 
		...
		query.append("      GROUP BY SMR.SLEVEL, SMR.TGT_GRP_CD, SMR.TRD_CD, SMR.DIR_CD, SMR.SUB_TRD_CD, ITM.ROW_SEQ, ITM.TEXT, ITM.CODE  " ).append("\n"); 
		query.append("      ) SMR  " ).append("\n"); 
