...
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.integration.HongKongCustomsTransmissionDBDAO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongManifestTransmitVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchBkgQtyVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchBkgVvdVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchBlGeneralVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchCntrDangerVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchCntrDescVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchCntrDetailVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchCntrListVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchMarksDescVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchMsgHeaderVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchQtyVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchSentBlVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchSentVslVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.hongkong.vo.HongKongSearchVslGeneralVO;
 ...
 *  handling business logic of - OPUS-CustomsDeclaration<br>
 *
 * @author
 * @see
 * @since J2EE 1.4
 */
public class HongKongCustomsTransmissionBCImpl extends BasicCommandSupport implements HongKongCustomsTransmissionBC {

	// Database Access Object
	private transient HongKongCustomsTransmissionDBDAO dbDao = null;

	/**
	 * creating CustomsTransmissionBCImpl <br>
	 * creating CustomsTransmissionDBDAO<br>
	 */
		...
		try {
			...
			if (manifestTransmitVOs != null) {
				...
				for (int i = 0; i < manifestTransmitVOs.length; i++) {
					...
					if (bl_no.length() > 11)
						hongkongManifestTransmitVO.setBlNo(bl_no);
					if (i == 0) {
						// searching information about Vessel General for reporting to HongKong customs
						...
						// searching information about Manifest Container List for reporting to HongKong customs
					...
					//  searching information about Manifest Booking Qty  for reporting to HongKong customs
					...
					//searching B/L information which is transmitted to HongKong customs
					...
					// searching information about Manifest B/L General  for reporting to HongKong customs
					...
					if (hongKongSearchBlGeneralVOs != null) {
						...
						for (int j = 0; j < hongKongSearchBlGeneralVOs.size(); j++) {
							...
							flatFile.append("AMEND_BL:").append(hongKongSearchBlGeneralVO.getTmpstr2()).append("\n");

							// creating BL transmit history which is reported to HongKong customs
							...
							// searching information about Manifest Marks & Description  for reporting to HongKong customs
							...
							// ///
							// searching information about Manifest Container Detail  for reporting to HongKong customs
							...
							if (hongKongSearchCntrDetailVOs != null) {
								...
								for (int k = 0; k < hongKongSearchCntrDetailVOs.size(); k++) {
									...
									// searching information about Manifest Container Danger  for reporting to HongKong customs
									...
									// ///
									//  searching information about Manifest Container Description  for reporting to HongKong customs
							...
							// ////
							// searching information about Manifest Qty for reporting to HongKong customs
							...
							// searching information about  Manifest Booking VVD  for reporting to HongKong customs
			...
			//  creating VSL transmit history which is reported to HongKong customs
			hongkongManifestTransmitVO.setMfSndDt(command.searchLocalTime(account.getCnt_cd()+account.getOfc_cd().substring(0,3)));
			...
			sendFlatFileVO.setQueueNm(SubSystemConfigFactory.get("BKG.OPUSBKG_UBIZCOM_HKGMF.IBMMQ.QUEUE"));
