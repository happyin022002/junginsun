...
*@FileName : AGNCommCalculationDBDAOManageAGNCommMassCalListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommCalculationDBDAOManageAGNCommMassCalListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommCalculationDBDAOManageAGNCommMassCalListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommCalculationDBDAOManageAGNCommMassCalListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" TO_CHAR(SYSDATE, 'YYMMDDHHMISS') BAT_ITM_NM," ).append("\n"); 
