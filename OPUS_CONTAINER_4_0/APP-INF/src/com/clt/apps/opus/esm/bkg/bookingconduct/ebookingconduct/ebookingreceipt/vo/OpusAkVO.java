...
public class OpusAkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpusAkVO> models = new ArrayList<OpusAkVO>();
	 ...
	 * @return OpusAkVO[]
	 */
	public OpusAkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpusAkVO[]
	 */
	public OpusAkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpusAkVO model = null;
	 ...
	 * @return OpusAkVO[]
	 */
	public OpusAkVO[] getOpusAkVOs(){
		OpusAkVO[] vos = (OpusAkVO[])models.toArray(new OpusAkVO[models.size()]);
		return vos;
	}
