...
*@FileName : HoldNoticeDBDAOPrcExecLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class HoldNoticeDBDAOPrcExecLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public HoldNoticeDBDAOPrcExecLogCSQL(){
		setQuery();
		...
		query.append("FileName : HoldNoticeDBDAOPrcExecLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
