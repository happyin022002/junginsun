...
public class RfaCmdtListVO extends AbstractValueObject {
    ...
    public RfaCmdtListVO(String ibflag, String pagerows, String prcCmdtDefCd, String cmdtNm, String type, String cmdtCd, String svcScpCd, String repCmdtCd, String grpDesc, String rfaDesc) {
        this.ibflag = ibflag;
        this.cmdtCd = cmdtCd;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("grp_desc", getGrpDesc());
        this.hashColumns.put("rfa_desc", getRfaDesc());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("grp_desc", "grpDesc");
        this.hashFields.put("rfa_desc", "rfaDesc");
    ...
    public void setRfaDesc(String rfaDesc) {
        this.rfaDesc = rfaDesc;
    }

    public String getRfaDesc() {
        return this.rfaDesc;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setGrpDesc(JSPUtil.getParameter(request, prefix + "grp_desc", ""));
        setRfaDesc(JSPUtil.getParameter(request, prefix + "rfa_desc", ""));
    }
    ...
    public RfaCmdtListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] grpDesc = (JSPUtil.getParameter(request, prefix + "grp_desc", length));
	    	String[] rfaDesc = (JSPUtil.getParameter(request, prefix + "rfa_desc", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (grpDesc[i] != null) 
		    		model.setGrpDesc(grpDesc[i]);
				if (rfaDesc[i] != null) 
		    		model.setRfaDesc(rfaDesc[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.grpDesc = this.grpDesc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.rfaDesc = this.rfaDesc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
