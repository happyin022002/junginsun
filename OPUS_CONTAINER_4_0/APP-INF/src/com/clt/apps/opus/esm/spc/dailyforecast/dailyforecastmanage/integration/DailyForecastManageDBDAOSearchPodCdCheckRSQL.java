...
*@FileName : DailyForecastManageDBDAOSearchPodCdCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DailyForecastManageDBDAOSearchPodCdCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2016.03.30 CLPT_IND_SEQ = '1' 삭제
	  * </pre>
	  */
	public DailyForecastManageDBDAOSearchPodCdCheckRSQL(){
		setQuery();
		...
		query.append("FileName : DailyForecastManageDBDAOSearchPodCdCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(*),0,'N','Y') POD_CD_YN " ).append("\n"); 
		query.append("  FROM VSK_VSL_PORT_SKD " ).append("\n"); 
		query.append(" WHERE 1=1 " ).append("\n"); 
		query.append("       AND VSL_CD = @[vsl_cd] " ).append("\n"); 
		query.append("       AND SKD_VOY_NO = @[skd_voy_no] " ).append("\n"); 
		query.append("       AND SKD_DIR_CD = @[skd_dir_cd] " ).append("\n"); 
		query.append("       AND VPS_PORT_CD = SUBSTR(@[pod_yd_cd], 1, 5) " ).append("\n"); 
