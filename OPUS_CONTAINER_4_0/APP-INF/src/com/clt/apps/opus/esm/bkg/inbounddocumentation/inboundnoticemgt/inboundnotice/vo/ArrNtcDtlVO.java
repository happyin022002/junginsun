...
*@FileName : ArrNtcDtlVO.java
*@FileTitle : ArrNtcDtlVO
*Open Issues :
*Change history :
...
public class ArrNtcDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ArrNtcDtlVO> models = new ArrayList<ArrNtcDtlVO>();
	...
	public ArrNtcDtlVO(String ibflag, String pagerows, String bkgNo, String bkgCustTpCd, String custCntcTpCd, String faxNo, String faxTpCd, String faxSndDt, String faxSndUsrId, String faxChgDpFlg, String faxNtcSndId, String faxEvntFlg, String faxSndFlg, String faxNtcSndRsltCd, String ntcEml, String emlTpCd, String emlSndDt, String emlSndUsrId, String emlChgDpFlg, String emlNtcSndId, String emlEvntFlg, String emlSndFlg, String emlNtcSndRsltCd, String ntcEdiId, String ediSndDt, String ediSndUsrId, String ediNtcSndId, String ediAckCd, String ediAckDt, String creUsrId, String creDt, String updUsrId, String updDt) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setEmlEvntFlg(JSPUtil.getParameter(request, "eml_evnt_flg", ""));
		...
		setNtcEdiId(JSPUtil.getParameter(request, "ntc_edi_id", ""));
		setEdiAckDt(JSPUtil.getParameter(request, "edi_ack_dt", ""));
		setBkgCustTpCd(JSPUtil.getParameter(request, "bkg_cust_tp_cd", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setFaxChgDpFlg(JSPUtil.getParameter(request, "fax_chg_dp_flg", ""));
		setEdiNtcSndId(JSPUtil.getParameter(request, "edi_ntc_snd_id", ""));
		setEmlTpCd(JSPUtil.getParameter(request, "eml_tp_cd", ""));
		setEmlSndUsrId(JSPUtil.getParameter(request, "eml_snd_usr_id", ""));
		setEmlChgDpFlg(JSPUtil.getParameter(request, "eml_chg_dp_flg", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setBkgNo(JSPUtil.getParameter(request, "bkg_no", ""));
		setFaxNtcSndRsltCd(JSPUtil.getParameter(request, "fax_ntc_snd_rslt_cd", ""));
		setEdiAckCd(JSPUtil.getParameter(request, "edi_ack_cd", ""));
		setFaxNtcSndId(JSPUtil.getParameter(request, "fax_ntc_snd_id", ""));
		setFaxEvntFlg(JSPUtil.getParameter(request, "fax_evnt_flg", ""));
	 ...
	 * @return ArrNtcDtlVO[]
	 */
	public ArrNtcDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ArrNtcDtlVO[]
	 */
	public ArrNtcDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ArrNtcDtlVO model = null;
	 ...
	 * @return ArrNtcDtlVO[]
	 */
	public ArrNtcDtlVO[] getArrNtcDtlVOs(){
		ArrNtcDtlVO[] vos = (ArrNtcDtlVO[])models.toArray(new ArrNtcDtlVO[models.size()]);
		return vos;
	}
