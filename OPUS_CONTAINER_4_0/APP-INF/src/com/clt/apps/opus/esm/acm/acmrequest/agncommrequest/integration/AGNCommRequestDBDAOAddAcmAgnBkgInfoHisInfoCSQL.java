...
*@FileName : AGNCommRequestDBDAOAddAcmAgnBkgInfoHisInfoCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOAddAcmAgnBkgInfoHisInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAcmAgnBkgInfoHisInfo
	  * </pre>
	  */
	public AGNCommRequestDBDAOAddAcmAgnBkgInfoHisInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOAddAcmAgnBkgInfoHisInfoCSQL").append("\n");
		query.append("*/").append("\n");
	}
