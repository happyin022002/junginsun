...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.acm.acmaudit;

import java.util.List;

import com.clt.apps.opus.esm.acm.acmcalculation.ACMCalculationSC;
import com.clt.apps.opus.esm.acm.acmaudit.agncommaudit.basic.AGNCommAuditBC;
import com.clt.apps.opus.esm.acm.acmaudit.agncommaudit.basic.AGNCommAuditBCImpl;
import com.clt.apps.opus.esm.acm.acmaudit.agncommaudit.event.EsmAcm0008Event;
import com.clt.apps.opus.esm.acm.acmaudit.agncommaudit.integration.AGNCommAuditDBDAO;
import com.clt.apps.opus.esm.acm.acmaudit.agncommaudit.vo.AGNCommAuditVO;
import com.clt.apps.opus.esm.acm.acmaudit.facommaudit.basic.FACommAuditBC;
import com.clt.apps.opus.esm.acm.acmaudit.facommaudit.basic.FACommAuditBCImpl;
import com.clt.apps.opus.esm.acm.acmaudit.facommaudit.event.EsmAcm0028Event;
import com.clt.apps.opus.esm.acm.acmaudit.facommaudit.vo.FACCommListVO;
import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.basic.FFCmpnAuditBC;
import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.basic.FFCmpnAuditBCImpl;
import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.event.EsmAcm0027Event;
import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.event.EsmAcm0117Event;
...
import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.vo.FFCmpnDetailChargebyBlVO;
import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.vo.FFCmpnDetailHistorybyBlVO;
import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.vo.FFCmpnRateInfoVO;
import com.clt.apps.opus.esm.acm.acmaudit.otrcommaudit.basic.OTRCommAuditBC;
import com.clt.apps.opus.esm.acm.acmaudit.otrcommaudit.basic.OTRCommAuditBCImpl;
import com.clt.apps.opus.esm.acm.acmaudit.otrcommaudit.event.EsmAcm0015Event;
import com.clt.apps.opus.esm.acm.acmaudit.otrcommaudit.vo.OTRCommAuditVO;
import com.clt.apps.opus.esm.acm.acmaudit.spclcmpnaudit.basic.SPCLCmpnAuditBC;
import com.clt.apps.opus.esm.acm.acmaudit.spclcmpnaudit.basic.SPCLCmpnAuditBCImpl;
import com.clt.apps.opus.esm.acm.acmaudit.spclcmpnaudit.event.EsmAcm0029Event;
...
//					command.reCalculateFACAudit(facCommListVOs[i].getBkgNo(), event.getSignOnUserAccount());
					acmCalcSC.reCalculateFACComm(facCommListVOs[i].getBkgNo(), event.getSignOnUserAccount());
			}
		} catch(EventException ex) {
			throw new EventException(new ErrorHandler(ex).getMessage(), ex);
		} catch(Exception ex) {
...
//					command.reCalculateFFAudit(ffCommListVOs[i].getBkgNo(), event.getSignOnUserAccount());
					acmCalcSC.reCalculateFFComm(ffCommListVOs[i].getBkgNo(), event.getSignOnUserAccount());
			}
		} catch(EventException ex) {
			throw new EventException(new ErrorHandler(ex).getMessage(), ex);
		} catch(Exception ex) {
	...
	private EventResponse rejectAGNCommAudit(Event e) throws EventException {
		...
		try{
			begin();
			command.rejectAGNCommAudit(event.getAGNCommAuditVOs(), account);
			eventResponse.setUserMessage(new ErrorHandler("XXXXXXXXX").getUserMessage());
			commit();
		} catch(EventException ex) {
			rollback();
