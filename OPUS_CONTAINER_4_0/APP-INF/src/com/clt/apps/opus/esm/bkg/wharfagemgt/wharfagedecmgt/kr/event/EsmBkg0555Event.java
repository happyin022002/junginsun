...
public class EsmBkg0555Event extends EventSupport {
	...
	public KrWhfChgVO[] getKrWhfChgVOs2() {
		KrWhfChgVO[] rtnVOs = null;
		if (this.krWhfChgVOs2 != null) {
			rtnVOs = Arrays.copyOf(krWhfChgVOs2, krWhfChgVOs2.length);
		}
		return rtnVOs;
	}

	public void setKrWhfChgVOs2(KrWhfChgVO[] krWhfChgVOs2) {
		if (krWhfChgVOs2 != null) {
			KrWhfChgVO[] tmpVOs = Arrays.copyOf(krWhfChgVOs2, krWhfChgVOs2.length);
			this.krWhfChgVOs2 = tmpVOs;
		}
	}
