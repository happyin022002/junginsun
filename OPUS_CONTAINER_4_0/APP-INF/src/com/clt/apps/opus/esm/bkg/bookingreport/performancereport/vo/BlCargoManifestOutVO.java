...
public class BlCargoManifestOutVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		setHdEtaEtd(JSPUtil.getParameter(request, "hd_eta_etd", ""));
		setBkgCgoTpCd(JSPUtil.getParameter(request, "bkg_cgo_tp_cd", ""));
		setTotalLbs(JSPUtil.getParameter(request, "total_lbs", ""));
		setPrePostVvd(JSPUtil.getParameter(request, "pre_post_vvd", ""));
		setCa(JSPUtil.getParameter(request, "ca", ""));
		setOrderBy(JSPUtil.getParameter(request, "order_by", ""));
		setWgt2(JSPUtil.getParameter(request, "wgt2", ""));
		setSeqNo(JSPUtil.getParameter(request, "seq_no", ""));
		setWgt1(JSPUtil.getParameter(request, "wgt1", ""));
		setDelYdCd(JSPUtil.getParameter(request, "del_yd_cd", ""));
		setBlNo(JSPUtil.getParameter(request, "bl_no", ""));
		setGroupTitle(JSPUtil.getParameter(request, "group_title", ""));
		setGroupTotal(JSPUtil.getParameter(request, "group_total", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setPrePostPolCd(JSPUtil.getParameter(request, "pre_post_pol_cd", ""));
		setPolCd(JSPUtil.getParameter(request, "pol_cd", ""));
		setHdModeType(JSPUtil.getParameter(request, "hd_mode_type", ""));
		setHdPolPod(JSPUtil.getParameter(request, "hd_pol_pod", ""));
		setBb(JSPUtil.getParameter(request, "bb", ""));
		setHdPolPodCd(JSPUtil.getParameter(request, "hd_pol_pod_cd", ""));
		setSoNo(JSPUtil.getParameter(request, "so_no", ""));
		setDelCd(JSPUtil.getParameter(request, "del_cd", ""));
		setHeader(JSPUtil.getParameter(request, "header", ""));
		setPodCd(JSPUtil.getParameter(request, "pod_cd", ""));
		setGroupEtdEta(JSPUtil.getParameter(request, "group_etd_eta", ""));
		setBkgNo(JSPUtil.getParameter(request, "bkg_no", ""));
		setPrePostPodYdCd(JSPUtil.getParameter(request, "pre_post_pod_yd_cd", ""));
		setPrePostPodCd(JSPUtil.getParameter(request, "pre_post_pod_cd", ""));
		setOrderByTitle(JSPUtil.getParameter(request, "order_by_title", ""));
		setPorCd(JSPUtil.getParameter(request, "por_cd", ""));
		setHdEtaEtdCd(JSPUtil.getParameter(request, "hd_eta_etd_cd", ""));
		setLt(JSPUtil.getParameter(request, "lt", ""));
		setRf(JSPUtil.getParameter(request, "rf", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setDg(JSPUtil.getParameter(request, "dg", ""));
		setTotalPkg(JSPUtil.getParameter(request, "total_pkg", ""));
		setMeasQty(JSPUtil.getParameter(request, "meas_qty", ""));
		setTotalKgs(JSPUtil.getParameter(request, "total_kgs", ""));
		setBdr(JSPUtil.getParameter(request, "bdr", ""));
		setKgs(JSPUtil.getParameter(request, "kgs", ""));
		setHdVvdCd(JSPUtil.getParameter(request, "hd_vvd_cd", ""));
		setPodYdCd(JSPUtil.getParameter(request, "pod_yd_cd", ""));
		setMeasUtCd(JSPUtil.getParameter(request, "meas_ut_cd", ""));
		setPrePostPolYdCd(JSPUtil.getParameter(request, "pre_post_pol_yd_cd", ""));
		setRdCd2(JSPUtil.getParameter(request, "rd_cd2", ""));
		setRdCd1(JSPUtil.getParameter(request, "rd_cd1", ""));
		setAsCd(JSPUtil.getParameter(request, "as_cd", ""));
		setGroupPolPod(JSPUtil.getParameter(request, "group_pol_pod", ""));
		setPkg1(JSPUtil.getParameter(request, "pkg1", ""));
		setAw(JSPUtil.getParameter(request, "aw", ""));
		setPkg2(JSPUtil.getParameter(request, "pkg2", ""));
		setCbf(JSPUtil.getParameter(request, "cbf", ""));
		setEf(JSPUtil.getParameter(request, "ef", ""));
		setPolYdCd(JSPUtil.getParameter(request, "pol_yd_cd", ""));
		setCbm(JSPUtil.getParameter(request, "cbm", ""));
		setPrePost(JSPUtil.getParameter(request, "pre_post", ""));
		setLbs(JSPUtil.getParameter(request, "lbs", ""));
