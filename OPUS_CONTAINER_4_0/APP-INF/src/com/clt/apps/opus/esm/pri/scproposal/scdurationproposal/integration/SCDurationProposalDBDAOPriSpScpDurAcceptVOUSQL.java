...
*@FileName : SCDurationProposalDBDAOPriSpScpDurAcceptVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAOPriSpScpDurAcceptVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Scope Duration Allcept All,Cancel
	  * </pre>
	  */
	public SCDurationProposalDBDAOPriSpScpDurAcceptVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAOPriSpScpDurAcceptVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
