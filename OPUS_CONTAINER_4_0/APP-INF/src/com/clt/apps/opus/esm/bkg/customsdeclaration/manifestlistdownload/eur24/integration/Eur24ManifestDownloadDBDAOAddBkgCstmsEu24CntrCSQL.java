...
*@FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrCSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_CNTR" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("  ,CRE_USR_ID,  CRE_DT,       UPD_USR_ID,     UPD_DT,      POL_CD" ).append("\n"); 
		query.append(")  " ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
		query.append("  X.VSL_CD,     X.SKD_VOY_NO,  X.SKD_DIR_CD,  X.BL_NO,     X.CSTMS_PORT_CD, X.CNTR_NO" ).append("\n"); 
		query.append(" ,NULL,         BC.PCK_QTY,    BC.PCK_TP_CD,  BC.MEAS_QTY, BC.MEAS_UT_CD,   BC.CNTR_WGT, BC.WGT_UT_CD, BC.CNTR_TPSZ_CD, BD.CNTR_CMDT_DESC" ).append("\n"); 
		query.append(" ,@[cre_usr_id],SYSDATE,      @[cre_usr_id],  SYSDATE  ,   BKG.POL_CD        " ).append("\n"); 
