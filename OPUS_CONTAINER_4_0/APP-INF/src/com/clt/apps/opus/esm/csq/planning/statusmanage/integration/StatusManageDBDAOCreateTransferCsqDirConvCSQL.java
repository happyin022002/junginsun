...
*@FileName : StatusManageDBDAOCreateTransferCsqDirConvCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAOCreateTransferCsqDirConvCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Qta Transfer 시 연간 정보로 1Q CSQ_DIR_CONV 생성
	  * </pre>
	  */
	public StatusManageDBDAOCreateTransferCsqDirConvCSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAOCreateTransferCsqDirConvCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
