...
*@FileName : SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO pri_sg_ctrt_cluz (" ).append("\n"); 
