...
*@FileName : SCReportDBDAORsltMOTFilingRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAORsltMOTFilingRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCReportDBDAORsltMOTFilingRSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAORsltMOTFilingRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , CASE WHEN (A.CHG_CD = 'DOC' AND A.CURR_CD <> 'CNY') THEN TRUNC(" ).append("\n"); 
		query.append("            CASE WHEN DECODE( NVL((SELECT DISTINCT V_EX_RATE FROM TABLE( BKG_EXCH_RATE_PKG.GET_EXCH_RATE_FNC(A.BKG_NO, 'P', '') ) WHERE V_AR_CURR_CD = 'CNY' AND V_CURR_CD = A.CURR_CD), ''), '', -1,0,-1, 1) = 1 " ).append("\n"); 
		query.append("                      THEN (SELECT DISTINCT V_EX_RATE FROM TABLE( BKG_EXCH_RATE_PKG.GET_EXCH_RATE_FNC(A.BKG_NO, 'P', '') ) WHERE V_AR_CURR_CD = 'CNY' AND V_CURR_CD = A.CURR_CD) * A.MOT_FILE_CHG_AMT" ).append("\n"); 
		query.append("                 WHEN DECODE( NVL((SELECT ROUND(SAR_GET_GL_XCH_RT_FNC('1', (SELECT TO_CHAR(BT.RT_APLY_DT,'YYYYMMDD') FROM BKG_RATE WHERE BKG_NO = A.BKG_NO),A.CURR_CD,'CNY'),2) FROM DUAL), ''), '', -1,0,-1, 1) = 1 " ).append("\n"); 
		query.append("                      THEN (SELECT ROUND(SAR_GET_GL_XCH_RT_FNC('1', (SELECT TO_CHAR(RT_APLY_DT,'YYYYMMDD') FROM BKG_RATE WHERE BKG_NO = A.BKG_NO),A.CURR_CD,'CNY'),2) FROM DUAL) * A.MOT_FILE_CHG_AMT" ).append("\n"); 
		query.append("                 WHEN DECODE( NVL((SELECT ROUND(SAR_GET_GL_XCH_RT_FNC('1', (SELECT TO_CHAR(TO_DATE(SUBSTR(TO_CHAR(BT.RT_APLY_DT,'YYYYMMDD'),1,6)||'01','YYYYMMDD')-1,'YYYYMMDD') FROM BKG_RATE WHERE BKG_NO = A.BKG_NO),A.CURR_CD,'CNY'),2) FROM DUAL), ''), '', -1, 1) = 1 " ).append("\n"); 
		query.append("                      THEN (SELECT ROUND(SAR_GET_GL_XCH_RT_FNC('1', (SELECT TO_CHAR(TO_DATE(SUBSTR(TO_CHAR(BT.RT_APLY_DT,'YYYYMMDD'),1,6)||'01','YYYYMMDD')-1,'YYYYMMDD') FROM BKG_RATE WHERE BKG_NO = A.BKG_NO),A.CURR_CD,'CNY'),2) FROM DUAL) * A.MOT_FILE_CHG_AMT" ).append("\n"); 
		query.append("            ELSE A.MOT_FILE_CHG_AMT END) ELSE A.MOT_FILE_CHG_AMT" ).append("\n"); 
		...
		query.append("     --, A.MOT_FILE_CHG_AMT" ).append("\n"); 
		...
		query.append("             , B.SHPR_CNT_CD" ).append("\n"); 
		query.append("             , B.SHPR_SEQ" ).append("\n"); 
		query.append("             , A.FWRD_CNT_CD" ).append("\n"); 
		query.append("             , A.FWRD_CUST_SEQ" ).append("\n"); 
		query.append("          FROM (SELECT  " ).append("\n"); 
		query.append("                     A.BAT_EXE_DT" ).append("\n"); 
		...
		query.append("                 AND A.BAT_EXE_DT BETWEEN TO_DATE (@[fr_file_dt], 'YYYY-MM-DD' ) AND TO_DATE (@[to_file_dt], 'YYYY-MM-DD' ) ) A" ).append("\n"); 
		query.append("             , PRI_MOT_FILE_RT B" ).append("\n"); 
		query.append("             , PRI_MOT_FILE_RT_SCG_DTL C" ).append("\n"); 
		query.append("         WHERE A.BAT_EXE_DT                   = B.BAT_EXE_DT" ).append("\n"); 
		query.append("           AND A.CTRT_NO                      = B.CTRT_NO" ).append("\n"); 
		query.append("           AND A.CTRT_HLD_NM                  = B.CTRT_HLD_NM" ).append("\n"); 
		query.append("           AND NVL(A.ACT_CUST_NM,'1')         = NVL(B.ACT_CUST_NM,'1')" ).append("\n"); 
		query.append("           AND NVL(A.CNEE_NM  ,'1')           = NVL(B.CNEE_NM,'1')" ).append("\n"); 
		query.append("           AND NVL(A.MOT_FILE_LANE_CD,'1')    = NVL(B.MOT_FILE_LANE_CD,'1')" ).append("\n"); 
		query.append("           AND NVL(A.MOT_FILE_ORG_CD,'1')     = NVL(B.MOT_FILE_ORG_CD,'1')" ).append("\n"); 
		query.append("           AND NVL(A.MOT_FILE_DEST_CD,'1')    = NVL(B.MOT_FILE_DEST_CD,'1')" ).append("\n"); 
		query.append("           AND NVL(A.MOT_FILE_CNTR_TP_CD,'1') = NVL(B.MOT_FILE_CNTR_TP_CD,'1')" ).append("\n"); 
		query.append("           AND NVL(A.MOT_FILE_CMDT_TP_CD,'1') = NVL(B.MOT_FILE_CMDT_TP_CD,'1')" ).append("\n"); 
		query.append("           AND NVL(A.MOT_FILE_CNTR_SZ_CD,'1') = NVL(B.MOT_FILE_CNTR_SZ_CD,'1')" ).append("\n"); 
		query.append("           AND A.BAT_EXE_DT                   = C.BAT_EXE_DT" ).append("\n"); 
		query.append("           AND A.CHG_CD                       = C.CHG_CD" ).append("\n"); 
		query.append("           AND A.MOT_FILE_CHG_AMT             = C.MOT_FILE_CHG_AMT ) A      " ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(" WHERE A.CURR_CD = GCUR.CURR_CD" ).append("\n"); 
		...
		query.append("   AND A.CHG_CD = CHG.CHG_CD " ).append("\n"); 
		query.append("   AND A.BKG_NO = BD.BKG_NO" ).append("\n"); 
		query.append("   AND A.BKG_NO = BR.BKG_NO " ).append("\n"); 
		query.append("   AND A.CHG_CD = BR.CHG_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("        DISTINCT ROW_NUMBER () OVER ( ORDER BY T.BAT_EXE_DT, T.CTRT_NO) AS SEQ, T.*" ).append("\n"); 
		...
		query.append("         , CHG_INFO C" ).append("\n"); 
		query.append("         , CHG_RST_RMK X" ).append("\n"); 
