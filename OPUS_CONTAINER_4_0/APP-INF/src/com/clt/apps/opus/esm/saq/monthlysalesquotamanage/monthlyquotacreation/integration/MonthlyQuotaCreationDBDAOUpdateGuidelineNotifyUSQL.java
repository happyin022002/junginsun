...
*@FileName : MonthlyQuotaCreationDBDAOUpdateGuidelineNotifyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCreationDBDAOUpdateGuidelineNotifyUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 버전의 Guideline을 Notify 한다
	  * </pre>
	  */
	public MonthlyQuotaCreationDBDAOUpdateGuidelineNotifyUSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCreationDBDAOUpdateGuidelineNotifyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SET GLINE_STS_FLG = 'N' " ).append("\n"); 
