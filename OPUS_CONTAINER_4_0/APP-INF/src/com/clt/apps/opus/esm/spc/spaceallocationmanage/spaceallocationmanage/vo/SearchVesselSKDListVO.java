...
public class SearchVesselSKDListVO extends AbstractValueObject {
	...
	public SearchVesselSKDListVO(String ibflag, String pagerows, String callingSeq, String vessel, String voyageNo, String dirCd, String callingInd, String port, String ydCd, String slanCd, String vpsEtaDt, String vpsEtdDt, String turnPortIndCd, String skdCngStsCd) {
		this.port = port;
		this.vessel = vessel;
