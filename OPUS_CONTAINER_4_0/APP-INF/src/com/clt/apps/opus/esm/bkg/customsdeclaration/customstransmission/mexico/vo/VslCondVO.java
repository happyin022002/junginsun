...
public class VslCondVO extends CargoManifestCondForEdiVO {
	...
	public VslCondVO(String ibflag, String pagerows, String vvd, String podCd, String polCd, String totalBl, String searchFlg, String tmp1, String tmp2, String tmp3) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.tmp2 = tmp2;
		this.polCd = polCd;
