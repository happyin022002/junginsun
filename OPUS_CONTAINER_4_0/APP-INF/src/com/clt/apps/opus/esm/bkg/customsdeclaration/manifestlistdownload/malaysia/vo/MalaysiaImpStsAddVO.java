...
*@FileName : MalaysiaImpStsAddVO.java
*@FileTitle : MalaysiaImpStsAddVO
*Open Issues :
*Change history :
...
public class MalaysiaImpStsAddVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<MalaysiaImpStsAddVO> models = new ArrayList<MalaysiaImpStsAddVO>();
	 ...
	 * @param request
	 * @return MalaysiaImpStsAddVO[]
	 */
	public MalaysiaImpStsAddVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MalaysiaImpStsAddVO[]
	 */
	public MalaysiaImpStsAddVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MalaysiaImpStsAddVO model = null;
		...
		return getMalaysiaImpStsAddVOs();
	}
	 ...
	 * @return MalaysiaImpStsAddVO[]
	 */
	public MalaysiaImpStsAddVO[] getMalaysiaImpStsAddVOs(){
		MalaysiaImpStsAddVO[] vos = (MalaysiaImpStsAddVO[])models.toArray(new MalaysiaImpStsAddVO[models.size()]);
		return vos;
	}
