...
*@FileName : PerformanceReportDBDAORemoveReportTemplateBstVipList1DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAORemoveReportTemplateBstVipList1DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAORemoveReportTemplateBstVipList1DSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAORemoveReportTemplateBstVipList1DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_RPT_DFLT" ).append("\n"); 
