...
*@FileName : SCProposalMainDBDAORevertPriSpScpGohChgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpScpGohChgUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpScpGohChgUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpScpGohChgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , FNL_FRT_RT_AMT  = DECODE(@[prop_sts_cd], 'I', 0, PROP_FRT_RT_AMT) " ).append("\n"); 
