...
*@FileName : ESM_BKG_1022HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author
 * @see EsmBkg1022Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_1022HTMLAction extends HTMLActionSupport {
    ...
    /**
     * ESM_BKG_1022HTMLAction 객체를 생성
     */
    public ESM_BKG_1022HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg1022Event로 파싱하여 request에 셋팅<br>
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg1022Event event = new EsmBkg1022Event();
