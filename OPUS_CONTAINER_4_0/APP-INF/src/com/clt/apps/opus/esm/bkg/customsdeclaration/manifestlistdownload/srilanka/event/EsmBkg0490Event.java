...
public class EsmBkg0490Event extends EventSupport {
	...
	public SriLankaManifestListCondVO[] getSriLankaManifestListCondVOS() {
		SriLankaManifestListCondVO[] rtnVOs = null;
		if (this.sriLankaManifestListCondVOs != null) {
			rtnVOs = Arrays.copyOf(sriLankaManifestListCondVOs, sriLankaManifestListCondVOs.length);
		}
		return rtnVOs;
	}

	public void setSriLankaManifestListCondVOS(SriLankaManifestListCondVO[] sriLankaManifestListCondVOs) {
		if (sriLankaManifestListCondVOs != null) {
			SriLankaManifestListCondVO[] tmpVOs = Arrays.copyOf(sriLankaManifestListCondVOs, sriLankaManifestListCondVOs.length);
			this.sriLankaManifestListCondVOs = tmpVOs;
		}
	}

	public void setSriLankaManifestTransmitVOS(SriLankaManifestTransmitVO[] srilankaManifestTransmitVOs) {
		if (srilankaManifestTransmitVOs != null) {
			SriLankaManifestTransmitVO[] tmpVOs = Arrays.copyOf(srilankaManifestTransmitVOs, srilankaManifestTransmitVOs.length);
			this.sriLankaManifestTransmitVOs = tmpVOs;
		}
	}

	public SriLankaManifestTransmitVO[] getSrilankaManifestTransmitVOs() {
		SriLankaManifestTransmitVO[] rtnVOs = null;
		if (this.sriLankaManifestTransmitVOs != null) {
			rtnVOs = Arrays.copyOf(sriLankaManifestTransmitVOs, sriLankaManifestTransmitVOs.length);
		}
		return rtnVOs;
	}
