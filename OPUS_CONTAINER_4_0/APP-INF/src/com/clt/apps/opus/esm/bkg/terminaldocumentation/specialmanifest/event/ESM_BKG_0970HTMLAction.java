...
*@FileName : ESM_BKG_0970HTMLAction.java
 ...
 * @see EsmBkg0970Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_0970HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0970Event event = new EsmBkg0970Event();

		if(command.isCommand(FormCommand.SEARCH)) {

			event.setSendHistoryCondVO((SendHistoryCondVO)getVO(request, SendHistoryCondVO.class));
