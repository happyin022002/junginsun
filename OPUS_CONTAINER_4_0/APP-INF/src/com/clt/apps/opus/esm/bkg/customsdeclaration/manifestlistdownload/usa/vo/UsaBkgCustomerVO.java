...
*@FileName : UsaBkgCustomerVO.java
*@FileTitle : UsaBkgCustomerVO
*Open Issues :
*Change history :
 ...
 */
public class UsaBkgCustomerVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<UsaBkgCustomerVO> models = new ArrayList<UsaBkgCustomerVO>();
    ...
    public UsaBkgCustomerVO() {
    }

    public UsaBkgCustomerVO(String ibflag, String pagerows, String cntCd, String blNo, String bkgCustTpCd, String custSeq, String custCntCd, String custNm, String custAddr, String creUsrId, String updUsrId, String custCtyNm, String custSteCd, String cstmsDeclCntCd, String custZipId, String eurCstmsStNm, String ctyNm, String steCd) {
	 ...
	 * @param request
	 * @return UsaBkgCustomerVO[]
	 */
    public UsaBkgCustomerVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaBkgCustomerVO[]
	 */
    public UsaBkgCustomerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        UsaBkgCustomerVO model = null;
	 ...
	 * @return UsaBkgCustomerVO[]
	 */
    public UsaBkgCustomerVO[] getUsaBkgCustomerVOs() {
        UsaBkgCustomerVO[] vos = (UsaBkgCustomerVO[]) models.toArray(new UsaBkgCustomerVO[models.size()]);
        return vos;
    }
