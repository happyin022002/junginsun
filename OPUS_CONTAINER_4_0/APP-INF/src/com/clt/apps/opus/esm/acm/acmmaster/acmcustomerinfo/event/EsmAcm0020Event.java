...
public class EsmAcm0020Event extends EventSupport {
	...
	public FFCmpnExSettingVO[] getFFCmpnExSettingVOs() {
		FFCmpnExSettingVO[] rtnVOs = null;
		if (this.ffCmpnExSettingVOs != null) {
			rtnVOs = Arrays.copyOf(ffCmpnExSettingVOs, ffCmpnExSettingVOs.length);
		}
		return rtnVOs;
	}

	public void setFFCmpnExSettingVOs(FFCmpnExSettingVO[] ffCmpnExSettingVOs) {
		if(ffCmpnExSettingVOs != null){
			FFCmpnExSettingVO[] tmpVOs = Arrays.copyOf(ffCmpnExSettingVOs, ffCmpnExSettingVOs.length);
			this.ffCmpnExSettingVOs  = tmpVOs;
		}
	}
