...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGriCmdtVO Update
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RP_SCP_GRI_CMDT SET" ).append("\n"); 
