...
*@FileName : ESM_PRI_2041HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_PRI_2041HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_2041HTMLAction 객체를 생성
	 */
	public ESM_PRI_2041HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2041Event event = new EsmPri2041Event();
