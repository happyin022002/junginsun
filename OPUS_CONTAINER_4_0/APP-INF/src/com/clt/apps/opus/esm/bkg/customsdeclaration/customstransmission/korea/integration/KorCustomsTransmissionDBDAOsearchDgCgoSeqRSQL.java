...
*@FileName : KorCustomsTransmissionDBDAOsearchDgCgoSeqRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOsearchDgCgoSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CNTR 마다 MSN 동일하게 입력받은 Cargo SEQ + 1 하여 따로 저장(modifyDgCgoSeq)
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOsearchDgCgoSeqRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOsearchDgCgoSeqRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("SELECT DCGO_SEQ" ).append("\n");
