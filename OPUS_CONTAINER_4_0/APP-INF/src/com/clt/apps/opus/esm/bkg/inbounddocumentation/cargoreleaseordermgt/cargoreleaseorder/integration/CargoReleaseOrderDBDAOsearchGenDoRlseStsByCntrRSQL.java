...
*@FileName : CargoReleaseOrderDBDAOsearchGenDoRlseStsByCntrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchGenDoRlseStsByCntrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchGenDoRlseStsByCntrRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchGenDoRlseStsByCntrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , DOTL.EVNT_OFC_CD                          AS EVNT_OFC_CD" ).append("\n"); 
