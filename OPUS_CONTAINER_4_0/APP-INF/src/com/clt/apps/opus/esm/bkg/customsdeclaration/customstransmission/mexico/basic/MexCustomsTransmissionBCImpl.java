...
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.mexico.integration.MexCustomsTransmissionDBDAO;
 ...
 * @since J2EE 1.6
 */
public class MexCustomsTransmissionBCImpl extends BasicCommandSupport implements MexCustomsTransmissionBC {
...
//			String header = bookingUtilBC.searchCstmsEdiHeader(ConstantMgr.getCompanyCode(), "MEXCUS", "COPRAR");
			String header = bookingUtilBC.searchCstmsEdiHeaderNew("MX_MANIFEST");
