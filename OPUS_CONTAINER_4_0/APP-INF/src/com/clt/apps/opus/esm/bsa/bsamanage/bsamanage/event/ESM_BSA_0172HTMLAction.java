...
*@FileName : ESM_BSA_0172HTMLAction.java
...
public class ESM_BSA_0172HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BSA_0172HTMLAction 객체를 생성
	 */
	public ESM_BSA_0172HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBsa0172Event event = new EsmBsa0172Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST)||command.isCommand(FormCommand.SEARCHLIST02)||command.isCommand(FormCommand.SEARCHLIST03)) {
			...
			event.setBsaHighCubicRateSaveVOs((BsaHighCubicRateSaveVO[])getVOs(request,BsaHighCubicRateSaveVO.class,""));
		}
