...
*@FileName : PSAManifestDBDAOsearchComUserRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOsearchComUserRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSAManifestDBDAOsearchComUserRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOsearchComUserRSQL").append("\n");
		query.append("*/").append("\n");
	}
