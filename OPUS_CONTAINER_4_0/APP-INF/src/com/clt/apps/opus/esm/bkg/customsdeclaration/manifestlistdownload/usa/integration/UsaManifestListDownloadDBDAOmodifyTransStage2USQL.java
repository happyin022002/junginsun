...
public class UsaManifestListDownloadDBDAOmodifyTransStage2USQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		MF_SND_DT = DECODE(@[cstms_mf_tp_cd], 'MI', GLOBALDATE_PKG.TIME_CONV_FNC ('KRPUS', sysdate, 'USNYC'), MF_SND_DT)," ).append("\n"); 
		query.append("		AMDT_SND_DT = DECODE(@[cstms_mf_tp_cd], 'AI', GLOBALDATE_PKG.TIME_CONV_FNC ('KRPUS', sysdate, 'USNYC'), AMDT_SND_DT)" ).append("\n"); 
