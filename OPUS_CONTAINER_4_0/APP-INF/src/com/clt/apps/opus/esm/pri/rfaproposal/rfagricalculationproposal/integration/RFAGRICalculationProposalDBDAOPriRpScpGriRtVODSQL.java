...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriRtVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGriRtVO Delete
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriRtVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
