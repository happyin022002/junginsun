...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriCmdtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriCmdtVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_GRI_CMDT SET" ).append("\n"); 
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}