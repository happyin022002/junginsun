...
*@FileName : SearchInterfaceStatusDetailListVO.java
*@FileTitle : SearchInterfaceStatusDetailListVO
*Open Issues :
*Change history :
...
public class SearchInterfaceStatusDetailListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchInterfaceStatusDetailListVO> models = new ArrayList<SearchInterfaceStatusDetailListVO>();
	 ...
	 */
	public SearchInterfaceStatusDetailListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchInterfaceStatusDetailListVO[]
	 */
	public SearchInterfaceStatusDetailListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchInterfaceStatusDetailListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchInterfaceStatusDetailListVO();
		...
		return getSearchInterfaceStatusDetailListVOs();
	}
	 ...
	 * @return SearchInterfaceStatusDetailListVO[]
	 */
	public SearchInterfaceStatusDetailListVO[] getSearchInterfaceStatusDetailListVOs(){
		SearchInterfaceStatusDetailListVO[] vos = (SearchInterfaceStatusDetailListVO[])models.toArray(new SearchInterfaceStatusDetailListVO[models.size()]);
		return vos;
	}
