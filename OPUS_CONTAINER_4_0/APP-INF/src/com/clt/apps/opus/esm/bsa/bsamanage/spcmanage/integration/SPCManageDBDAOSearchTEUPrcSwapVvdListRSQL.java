...
public class SPCManageDBDAOSearchTEUPrcSwapVvdListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    ,NVL(SUM(CASE WHEN B1.BSA_OP_JB_CD = SUBSTR('${keys}', 4, 6) AND B1.CRR_CD = SUBSTR('${keys}', 1, 3) AND B1.CRR_BSA_CAPA <> 0 THEN B1.OP_CRR_PERF_AMT/B1.CRR_BSA_CAPA ELSE 0 END), 0) AS PCO_${keys}" ).append("\n"); 
