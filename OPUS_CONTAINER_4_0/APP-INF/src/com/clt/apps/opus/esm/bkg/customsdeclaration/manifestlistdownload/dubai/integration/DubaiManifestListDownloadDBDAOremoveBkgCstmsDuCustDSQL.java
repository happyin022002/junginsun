...
*@FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCustDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCustDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeBkgCstmsDuCust
	  * </pre>
	  */
	public DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCustDSQL(){
		setQuery();
		...
		query.append("FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCustDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM BKG_CSTMS_DU_CUST" ).append("\n"); 
