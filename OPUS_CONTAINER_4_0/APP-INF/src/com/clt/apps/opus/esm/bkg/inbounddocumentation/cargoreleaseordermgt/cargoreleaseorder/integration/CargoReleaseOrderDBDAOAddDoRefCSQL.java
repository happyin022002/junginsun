...
*@FileName : CargoReleaseOrderDBDAOAddDoRefCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOAddDoRefCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOAddDoRefCSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOAddDoRefCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_DO_REF ( BKG_NO" ).append("\n"); 
		...
		query.append("	     ,@[do_hld_flg]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("         ,NVL(@[info_cgo_flg],'Y')" ).append("\n"); 
		query.append("         ,@[ida_imp_gen_mf_no]" ).append("\n"); 
		query.append("         ,@[ida_cgor_ord_yr]" ).append("\n"); 
		query.append("         ,@[ida_cstms_asgn_line_no]" ).append("\n"); 
		query.append("         ,NVL(@[do_split_flg],'N')" ).append("\n"); 
		query.append("         ,@[cy_op_cd]" ).append("\n"); 
		query.append("         ,@[cre_usr_id]" ).append("\n"); 
