...
public class SCProposalMainDBDAORsltPropCustInfoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    ,DECODE(CUST.CNTR_CUST_TP_CD,'N','N','I') PRC_CTRT_CUST_TP_CD 	" ).append("\n"); 
		...
		query.append("    ,SREP.SREP_CD CTRT_CUST_SREP_CD                  					" ).append("\n"); 
		query.append("	,SREP.SREP_NM CTRT_CUST_SREP_NM										" ).append("\n"); 
		query.append("    ,SREP.OFC_CD CTRT_CUST_SLS_OFC_CD                					" ).append("\n"); 
		...
		query.append("	,CUST.NVOCC_BD_NO OTI_NO" ).append("\n"); 
