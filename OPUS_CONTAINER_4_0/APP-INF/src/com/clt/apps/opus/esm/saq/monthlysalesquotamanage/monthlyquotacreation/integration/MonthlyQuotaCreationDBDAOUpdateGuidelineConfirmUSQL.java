...
*@FileName : MonthlyQuotaCreationDBDAOUpdateGuidelineConfirmUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCreationDBDAOUpdateGuidelineConfirmUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 버전의 Guideline 을 Confirm 한다
	  * </pre>
	  */
	public MonthlyQuotaCreationDBDAOUpdateGuidelineConfirmUSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCreationDBDAOUpdateGuidelineConfirmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
