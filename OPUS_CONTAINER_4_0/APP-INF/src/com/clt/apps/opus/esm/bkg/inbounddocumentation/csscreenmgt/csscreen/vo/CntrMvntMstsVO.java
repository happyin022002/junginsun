...
public class CntrMvntMstsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntrMvntMstsVO> models = new ArrayList<CntrMvntMstsVO>();
	...
	public CntrMvntMstsVO() {}

	public CntrMvntMstsVO(String ibflag, String pagerows, String bkgNo, String cntrNo, String tpszCd, String lstEvent, String eventDt, String nodCd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("lst_event", getLstEvent());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("lst_event", "lstEvent");
	 ...
	 * @param lstEvent
	 */
	public void setLstEvent(String lstEvent) {
		this.lstEvent = lstEvent;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLstEvent(JSPUtil.getParameter(request, "lst_event", ""));
	 ...
	 * @return ActMvntVO[]
	 */
	public CntrMvntMstsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ActMvntVO[]
	 */
	public CntrMvntMstsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntrMvntMstsVO model = null;
		...
		try {
			...
			String[] lstEvent = (JSPUtil.getParameter(request, prefix	+ "lst_event", length));
	 ...
	 * @return ActMvntVO[]
	 */
	public CntrMvntMstsVO[] getActMvntVOs(){
		CntrMvntMstsVO[] vos = (CntrMvntMstsVO[])models.toArray(new CntrMvntMstsVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.lstEvent = this.lstEvent .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
