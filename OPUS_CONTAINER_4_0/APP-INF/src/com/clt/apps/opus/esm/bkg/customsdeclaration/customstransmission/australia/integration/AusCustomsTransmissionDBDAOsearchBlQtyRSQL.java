...
*@FileName : AusCustomsTransmissionDBDAOsearchBlQtyRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOsearchBlQtyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOsearchBlQtyRSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOsearchBlQtyRSQL").append("\n");
		query.append("*/").append("\n");
	}
