...
*@FileName : PSAManifestDBDAOSearchPSAIFInfoLastRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOSearchPSAIFInfoLastRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSAManifestDBDAOSearchPSAIFInfoLastRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOSearchPSAIFInfoLastRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("--AND     PB.BKG_SEQ          = (SELECT NVL(MAX(BKG_SEQ), 1)" ).append("\n");
		query.append("--                                 FROM BKG_CSTMS_PSA_BKG A" ).append("\n");
		query.append("--                                WHERE A.BKG_NO = PB.BKG_NO)" ).append("\n");
