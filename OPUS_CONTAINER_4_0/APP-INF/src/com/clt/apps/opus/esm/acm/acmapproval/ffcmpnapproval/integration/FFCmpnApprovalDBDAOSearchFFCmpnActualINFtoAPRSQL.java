...
*@FileName : FFCmpnApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCmpnApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FFCmpnApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL").append("\n");
		query.append("*/").append("\n");
	}
