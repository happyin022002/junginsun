...
*@FileName : GeneralBookingSearchDBDAOsearchEdi301CntrDgInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingSearchDBDAOsearchEdi301CntrDgInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchEdi301CntrDgInfo
	  * </pre>
	  */
	public GeneralBookingSearchDBDAOsearchEdi301CntrDgInfoRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingSearchDBDAOsearchEdi301CntrDgInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DG.CNTR_NO," ).append("\n"); 
		...
		query.append("	|| 'WGT_QTY:'               || CASE WHEN NVL(DG.GRS_WGT,0) <> 0 THEN DG.GRS_WGT" ).append("\n"); 
		...
		query.append("	|| 'NET_WGT_QTY:'           || DG.NET_WGT									|| CHR(10)" ).append("\n"); 
		query.append("	|| 'NET_WGT_TP:'            || DG.WGT_UT_CD									|| CHR(10)" ).append("\n"); 
		...
		query.append("	|| '}CNTR_TRO_DTL'															|| CHR(10)" ).append("\n"); 
		query.append("	|| '}CNTR_INFO'																CNTR_DG_INFO" ).append("\n"); 
		...
		query.append("   GROUP BY DG.CNTR_NO" ).append("\n"); 
