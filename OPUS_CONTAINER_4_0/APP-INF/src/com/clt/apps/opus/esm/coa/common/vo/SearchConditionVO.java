...
* 2010.10.29 김기종 
* 1.0 Creation
* 2011.01.26 최윤성 [CHM-201108537-01] fVopCd 필드 추가
=========================================================*/
...
public class SearchConditionVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String fFromDt = null;

    /* Column Info */
    private String fToDt = null;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("f_from_dt", getFFromDt());
        this.hashColumns.put("f_to_dt", getFToDt());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("f_from_dt", "fFromDt");
        this.hashFields.put("f_to_dt", "fToDt");
    ...
    public void setFFromDt(String fFromDt) {
        this.fFromDt = fFromDt;
    }

    public String getFFromDt() {
        return this.fFromDt;
    }

    public void setFToDt(String fToDt) {
        this.fToDt = fToDt;
    }

    public String getFToDt() {
        return this.fToDt;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setFFromDt(JSPUtil.getParameter(request, prefix + "f_from_dt", ""));
        setFToDt(JSPUtil.getParameter(request, prefix + "f_to_dt", ""));
	...
	*/
    public void unDataFormat() {
        ...
        this.fFromDt = this.fFromDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.fToDt = this.fToDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
