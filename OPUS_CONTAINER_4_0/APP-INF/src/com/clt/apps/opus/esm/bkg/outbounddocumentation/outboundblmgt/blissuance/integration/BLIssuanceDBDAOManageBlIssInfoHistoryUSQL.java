...
*@FileName : BLIssuanceDBDAOManageBlIssInfoHistoryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOManageBlIssInfoHistoryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * history테이블에 저장한다. BKG_BL_ISS_HIS
	  * </pre>
	  */
	public BLIssuanceDBDAOManageBlIssInfoHistoryUSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOManageBlIssInfoHistoryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
