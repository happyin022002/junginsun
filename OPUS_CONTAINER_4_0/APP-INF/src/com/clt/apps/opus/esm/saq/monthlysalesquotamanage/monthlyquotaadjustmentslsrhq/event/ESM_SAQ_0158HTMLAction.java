...
*@FileName : ESM_SAQ_0158HTMLAction.java
...
public class ESM_SAQ_0158HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0158HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0158HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0158Event event = new EsmSaq0158Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonQtaLodTgtVOs = saqMonQtaLodTgtVO.fromRequestGrid(request, event.getQuotaConditionVO(), "0158");
