...
*@FileName : MonthlyQuotaCfmAdjustmentDBDAOCheckAvgCostOfcCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCfmAdjustmentDBDAOCheckAvgCostOfcCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Check SAQ_AVG_COST_OFC Count
	  * </pre>
	  */
	public MonthlyQuotaCfmAdjustmentDBDAOCheckAvgCostOfcCntRSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCfmAdjustmentDBDAOCheckAvgCostOfcCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
