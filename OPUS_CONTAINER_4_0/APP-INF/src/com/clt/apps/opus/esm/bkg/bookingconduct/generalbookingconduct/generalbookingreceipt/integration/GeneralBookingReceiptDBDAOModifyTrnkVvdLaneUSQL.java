...
*@FileName : GeneralBookingReceiptDBDAOModifyTrnkVvdLaneUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingReceiptDBDAOModifyTrnkVvdLaneUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralBookingReceiptDBDAOModifyTrnkVvdLaneUSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingReceiptDBDAOModifyTrnkVvdLaneUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SLAN_CD = @[trnk_lane_cd]" ).append("\n"); 
