...
*@FileName : PlanningDBDAOCreateTransferCsqSctrLaneOfcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOCreateTransferCsqSctrLaneOfcCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [CSQ_SCTR_LANE_OFC] 데이터를 1Q로 복사한다.
	  * </pre>
	  */
	public PlanningDBDAOCreateTransferCsqSctrLaneOfcCSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOCreateTransferCsqSctrLaneOfcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
