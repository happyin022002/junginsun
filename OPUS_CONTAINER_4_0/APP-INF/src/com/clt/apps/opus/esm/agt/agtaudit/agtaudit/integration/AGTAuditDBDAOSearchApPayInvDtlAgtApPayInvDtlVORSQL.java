...
*@FileName : AGTAuditDBDAOSearchApPayInvDtlAgtApPayInvDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOSearchApPayInvDtlAgtApPayInvDtlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchApPayInvDtlAgtApPayInvDtlVO
	  * </pre>
	  */
	public AGTAuditDBDAOSearchApPayInvDtlAgtApPayInvDtlVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.agt.agtaudit.agtaudit.integration ").append("\n"); 
		query.append("FileName : AGTAuditDBDAOSearchApPayInvDtlAgtApPayInvDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
