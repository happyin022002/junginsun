...
*@FileName : KorBkgCntrVO.java
*@FileTitle : KorBkgCntrVO
*Open Issues :
*Change history :
...
public class KorBkgCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorBkgCntrVO> models = new ArrayList<KorBkgCntrVO>();
	...
	public KorBkgCntrVO(String ibflag, String pagerows, String bCntrNo, String bCntrtsCd, String bCntrSealNo1, String bCntrSealNo2, String bCntrPkgQty, String bCntrPkgCd, String bCntrWgtQty, String bCntrWgtTp, String bCntrMeaQty, String bCntrMeaTp, String bBbCgoFlg) {
	 ...
	 * @return KorBkgCntrVO[]
	 */
	public KorBkgCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorBkgCntrVO[]
	 */
	public KorBkgCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorBkgCntrVO model = null;
	 ...
	 * @return KorBkgCntrVO[]
	 */
	public KorBkgCntrVO[] getKorBkgCntrVOs(){
		KorBkgCntrVO[] vos = (KorBkgCntrVO[])models.toArray(new KorBkgCntrVO[models.size()]);
		return vos;
	}
