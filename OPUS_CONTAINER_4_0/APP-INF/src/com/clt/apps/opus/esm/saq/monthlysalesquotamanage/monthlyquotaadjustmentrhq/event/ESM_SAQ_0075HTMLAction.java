...
*@FileName : ESM_SAQ_0075HTMLAction.java
...
public class ESM_SAQ_0075HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0075HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0075HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0075Event event = new EsmSaq0075Event();
		SaqMonQtaRhqVO saqMonQtaRhqVO = new SaqMonQtaRhqVO();
		SaqMonQtaRhqVO[] saqMonQtaRhqVOs = null; 

		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setCondition((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
		}
			...
			event.setCondition((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonQtaRhqVOs = saqMonQtaRhqVO.fromRequestGrid(request, event.getCondition(), "0075");
			event.setSaqMonQtaRhqVOs(saqMonQtaRhqVOs);
		}
		...
		else if(command.isCommand(FormCommand.MODIFY08)) {
			event.setCondition((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
		}
