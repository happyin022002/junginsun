...
*@FileName : ESM_FMS_0077HTMLAction.java
...
public class ESM_FMS_0077HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0077HTMLAction 객체를 생성
	 */
	public ESM_FMS_0077HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0077Event event = new EsmFms0077Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setCarrNm(request.getParameter("carr_nm"));
		}
