...
*@FileName : RocsManifestListDownloadDBDAOremoveRocsBlInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestListDownloadDBDAOremoveRocsBlInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestListDownloadDBDAOremoveRocsBlInfoDSQL(){
		setQuery();
		...
		query.append("FileName : RocsManifestListDownloadDBDAOremoveRocsBlInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_RTM_BL" ).append("\n"); 
