...
*@FileName : SCNoteProposalDBDAOPropCpPriSpScpNoteCtntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPropCpPriSpScpNoteCtntCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_NOTE_CTNT
	  * </pre>
	  */
	public SCNoteProposalDBDAOPropCpPriSpScpNoteCtntCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPropCpPriSpScpNoteCtntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
