...
public class StatusReportSpecialCargoOutVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		setDestSvcRoute(JSPUtil.getParameter(request, "dest_svc_route", ""));
		...
		setPost3PolCd(JSPUtil.getParameter(request, "post_3_pol_cd", ""));
		...
		setRdTotalR4(JSPUtil.getParameter(request, "rd_total_r4", ""));
		setRdTotalR5(JSPUtil.getParameter(request, "rd_total_r5", ""));
		setSiFlg(JSPUtil.getParameter(request, "si_flg", ""));
		setRdTotalR2(JSPUtil.getParameter(request, "rd_total_r2", ""));
		...
		setPost3PodCd(JSPUtil.getParameter(request, "post_3_pod_cd", ""));
		setPost1PolCd(JSPUtil.getParameter(request, "post_1_pol_cd", ""));
		setPost1Vvd(JSPUtil.getParameter(request, "post_1_vvd", ""));
		setOvrRtLen(JSPUtil.getParameter(request, "ovr_rt_len", ""));
		setPodCd(JSPUtil.getParameter(request, "pod_cd", ""));
		setBkgNo(JSPUtil.getParameter(request, "bkg_no", ""));
		setRdTotalZ2(JSPUtil.getParameter(request, "rd_total_z2", ""));
		setRowSeq(JSPUtil.getParameter(request, "row_seq", ""));
		setRdTotalZ4(JSPUtil.getParameter(request, "rd_total_z4", ""));
		...
		setTotalTeu(JSPUtil.getParameter(request, "total_teu", ""));
		...
		setPre3PodCd(JSPUtil.getParameter(request, "pre_3_pod_cd", ""));
		...
		setRdTotalP4(JSPUtil.getParameter(request, "rd_total_p4", ""));
		setPckTpCd(JSPUtil.getParameter(request, "pck_tp_cd", ""));
		setF2(JSPUtil.getParameter(request, "f2", ""));
		setF5(JSPUtil.getParameter(request, "f5", ""));
		setRdTotalP2(JSPUtil.getParameter(request, "rd_total_p2", ""));
		setPost2PodCd(JSPUtil.getParameter(request, "post_2_pod_cd", ""));
		setF4(JSPUtil.getParameter(request, "f4", ""));
		setDgCntrSeq(JSPUtil.getParameter(request, "dg_cntr_seq", ""));
		setPre2PolCd(JSPUtil.getParameter(request, "pre_2_pol_cd", ""));
		setO2(JSPUtil.getParameter(request, "o2", ""));
		setO4(JSPUtil.getParameter(request, "o4", ""));
		setAntyName(JSPUtil.getParameter(request, "anty_name", ""));
		setTotalMea(JSPUtil.getParameter(request, "total_mea", ""));
		setShipper(JSPUtil.getParameter(request, "shipper", ""));
		setPre4PolCd(JSPUtil.getParameter(request, "pre_4_pol_cd", ""));
		setFdoTemp(JSPUtil.getParameter(request, "fdo_temp", ""));
		setOvrLfLen(JSPUtil.getParameter(request, "ovr_lf_len", ""));
		setRemarkDetail(JSPUtil.getParameter(request, "remark_detail", ""));
		setPost4PolCd(JSPUtil.getParameter(request, "post_4_pol_cd", ""));
		setHumidNo(JSPUtil.getParameter(request, "humid_no", ""));
		setSlanCd(JSPUtil.getParameter(request, "slan_cd", ""));
		setBstFlg(JSPUtil.getParameter(request, "bst_flg", ""));
		setCntrNo(JSPUtil.getParameter(request, "cntr_no", ""));
		setRdTotalQ2(JSPUtil.getParameter(request, "rd_total_q2", ""));
		setLastOrderby(JSPUtil.getParameter(request, "last_orderby", ""));
		setRdTotalQ4(JSPUtil.getParameter(request, "rd_total_q4", ""));
		...
		setPost1PodCd(JSPUtil.getParameter(request, "post_1_pod_cd", ""));
		setRemark(JSPUtil.getParameter(request, "remark", ""));
		setPre1Vvd(JSPUtil.getParameter(request, "pre_1_vvd", ""));
		setTotalBkg(JSPUtil.getParameter(request, "total_bkg", ""));
		setTel(JSPUtil.getParameter(request, "tel", ""));
		setRdTotalF2(JSPUtil.getParameter(request, "rd_total_f2", ""));
		setD5(JSPUtil.getParameter(request, "d5", ""));
		setD4(JSPUtil.getParameter(request, "d4", ""));
		setBlNo(JSPUtil.getParameter(request, "bl_no", ""));
		setPre4PodCd(JSPUtil.getParameter(request, "pre_4_pod_cd", ""));
		setD7(JSPUtil.getParameter(request, "d7", ""));
		setPre3PolCd(JSPUtil.getParameter(request, "pre_3_pol_cd", ""));
		...
		setPost4Vvd(JSPUtil.getParameter(request, "post_4_vvd", ""));
		setPre1PodCd(JSPUtil.getParameter(request, "pre_1_pod_cd", ""));
		setBbCmdt(JSPUtil.getParameter(request, "bb_cmdt", ""));
		setCustToOrdFlg(JSPUtil.getParameter(request, "cust_to_ord_flg", ""));
		setObSlsOfcCd(JSPUtil.getParameter(request, "ob_sls_ofc_cd", ""));
		setPost4PodCd(JSPUtil.getParameter(request, "post_4_pod_cd", ""));
		setCgoSeq(JSPUtil.getParameter(request, "cgo_seq", ""));
		setTotalFeu(JSPUtil.getParameter(request, "total_feu", ""));
		setConsigneeName(JSPUtil.getParameter(request, "consignee_name", ""));
		...
		setRdTotalO2(JSPUtil.getParameter(request, "rd_total_o2", ""));
		setCntrVentTpCd(JSPUtil.getParameter(request, "cntr_vent_tp_cd", ""));
		setRdTotalO4(JSPUtil.getParameter(request, "rd_total_o4", ""));
		setPre3Vvd(JSPUtil.getParameter(request, "pre_3_vvd", ""));
		setRdTotalF4(JSPUtil.getParameter(request, "rd_total_f4", ""));
		setNtfyName(JSPUtil.getParameter(request, "ntfy_name", ""));
		setRdTotalF5(JSPUtil.getParameter(request, "rd_total_f5", ""));
		setT4(JSPUtil.getParameter(request, "t4", ""));
		setTotalBl(JSPUtil.getParameter(request, "total_bl", ""));
		setPost3Vvd(JSPUtil.getParameter(request, "post_3_vvd", ""));
		setRfCmdt(JSPUtil.getParameter(request, "rf_cmdt", ""));
		...
		setDgCmdt(JSPUtil.getParameter(request, "dg_cmdt", ""));
		...
		setStowage(JSPUtil.getParameter(request, "stowage", ""));
		...
		setExptName(JSPUtil.getParameter(request, "expt_name", ""));
		setPckQty(JSPUtil.getParameter(request, "pck_qty", ""));
		setRcvTermCd(JSPUtil.getParameter(request, "rcv_term_cd", ""));
		setPre2Vvd(JSPUtil.getParameter(request, "pre_2_vvd", ""));
		setOrderbyTitle(JSPUtil.getParameter(request, "orderby_title", ""));
		setFfdr(JSPUtil.getParameter(request, "ffdr", ""));
		setOrgSvcRoute(JSPUtil.getParameter(request, "org_svc_route", ""));
		setRdTotalT2(JSPUtil.getParameter(request, "rd_total_t2", ""));
		setRdTotalT4(JSPUtil.getParameter(request, "rd_total_t4", ""));
		setPre2PodCd(JSPUtil.getParameter(request, "pre_2_pod_cd", ""));
		setRdTotalD4(JSPUtil.getParameter(request, "rd_total_d4", ""));
		setSocFlg(JSPUtil.getParameter(request, "soc_flg", ""));
		setRdTotalD5(JSPUtil.getParameter(request, "rd_total_d5", ""));
		setDeTermCd(JSPUtil.getParameter(request, "de_term_cd", ""));
		setAkrepCmdt(JSPUtil.getParameter(request, "akrep_cmdt", ""));
		setPre1PolCd(JSPUtil.getParameter(request, "pre_1_pol_cd", ""));
		setRdTotalD2(JSPUtil.getParameter(request, "rd_total_d2", ""));
		setVltgNo(JSPUtil.getParameter(request, "vltg_no", ""));
		setPost2Vvd(JSPUtil.getParameter(request, "post_2_vvd", ""));
		...
		setPre4Vvd(JSPUtil.getParameter(request, "pre_4_vvd", ""));
		setRdTotalD7(JSPUtil.getParameter(request, "rd_total_d7", ""));
		setHngrFlg(JSPUtil.getParameter(request, "hngr_flg", ""));
		setOrderbyCnt(JSPUtil.getParameter(request, "orderby_cnt", ""));
		setFfdrName(JSPUtil.getParameter(request, "ffdr_name", ""));
		setPrpShpNm(JSPUtil.getParameter(request, "prp_shp_nm", ""));
		setR2(JSPUtil.getParameter(request, "r2", ""));
		setPost2PolCd(JSPUtil.getParameter(request, "post_2_pol_cd", ""));
