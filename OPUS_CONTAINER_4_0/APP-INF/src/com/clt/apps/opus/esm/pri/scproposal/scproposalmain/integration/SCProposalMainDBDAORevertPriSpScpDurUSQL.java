...
*@FileName : SCProposalMainDBDAORevertPriSpScpDurUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpScpDurUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_SCP_DUR
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpScpDurUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpScpDurUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_DUR " ).append("\n"); 
