...
public class OpusMndVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpusMndVO> models = new ArrayList<OpusMndVO>();
	 ...
	 * @return OpusMndVO[]
	 */
	public OpusMndVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpusMndVO[]
	 */
	public OpusMndVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpusMndVO model = null;
	 ...
	 * @return OpusMndVO[]
	 */
	public OpusMndVO[] getOpusMndVOs(){
		OpusMndVO[] vos = (OpusMndVO[])models.toArray(new OpusMndVO[models.size()]);
		return vos;
	}
