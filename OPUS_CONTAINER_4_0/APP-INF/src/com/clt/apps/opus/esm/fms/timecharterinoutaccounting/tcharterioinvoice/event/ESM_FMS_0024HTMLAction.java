...
*@FileName : ESM_FMS_0024HTMLAction.java
...
public class ESM_FMS_0024HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0024HTMLAction 객체를 생성
	 */
	public ESM_FMS_0024HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0024Event event = new EsmFms0024Event();
