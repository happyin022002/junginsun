...
*@FileName : RFARateProposalDBDAOPriRpScpRtCmdtForExlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCmdtForExlVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT PRI_RP_SCP_RT_CMDT
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCmdtForExlVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCmdtForExlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ INDEX_DESC(A XPKPRI_RP_SCP_RT_CMDT) */" ).append("\n"); 
		query.append("                  CMDT_SEQ" ).append("\n"); 
