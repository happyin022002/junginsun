...
*@FileName : Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCustDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCustDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCustDSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCustDSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.eur24.integration").append("\n"); 
		query.append("FileName : Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24OBCustDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE BKG_CSTMS_EUR_IO_CUST" ).append("\n"); 
