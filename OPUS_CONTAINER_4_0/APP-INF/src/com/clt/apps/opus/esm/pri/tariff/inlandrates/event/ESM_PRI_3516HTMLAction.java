...
*@FileName : ESM_PRI_3516HTMLAction.java
...
public class ESM_PRI_3516HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3516HTMLAction 객체를 생성
	 */
	public ESM_PRI_3516HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3516Event event = new EsmPri3516Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setPriTrfInlndHistoryVO((PriTrfInlndHistoryVO)getVO(request, PriTrfInlndHistoryVO .class));
