...
*@FileName : PkupNtcCneeInfoVO.java
*@FileTitle : PkupNtcCneeInfoVO
*Open Issues :
*Change history :
...
public class PkupNtcCneeInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PkupNtcCneeInfoVO> models = new ArrayList<PkupNtcCneeInfoVO>();
	 ...
	 * @param request
	 * @return PkupNtcCneeInfoVO[]
	 */
	public PkupNtcCneeInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PkupNtcCneeInfoVO[]
	 */
	public PkupNtcCneeInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PkupNtcCneeInfoVO model = null;
	 ...
	 * @return PkupNtcCneeInfoVO[]
	 */
	public PkupNtcCneeInfoVO[] getPkupNtcCneeInfoVOs(){
		PkupNtcCneeInfoVO[] vos = (PkupNtcCneeInfoVO[])models.toArray(new PkupNtcCneeInfoVO[models.size()]);
		return vos;
	}
