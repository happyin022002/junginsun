...
*@FileName : SCProposalMainDBDAORevertPriSpCtrtPtyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpCtrtPtyUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_CTRT_PTY
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpCtrtPtyUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpCtrtPtyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_CTRT_PTY" ).append("\n"); 
