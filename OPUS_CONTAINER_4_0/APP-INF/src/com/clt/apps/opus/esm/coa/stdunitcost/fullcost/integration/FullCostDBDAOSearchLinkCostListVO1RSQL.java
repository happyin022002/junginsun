...
public class FullCostDBDAOSearchLinkCostListVO1RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           AND LNK_FM_NOD_CD = NVL(COA_LOC_FNC(@[f_from], DECODE(@[f_cost_loc_grp_cd], 'L','LCC', 'C','LOC', 'S','SCC', 'E','ECC', 'R','RCC', 'NOD')), @[f_from]) 	--20160303.ADD" ).append("\n"); 
		...
		query.append("GROUP BY B1.LNK_FM_NOD_CD, B1.LNK_TO_NOD_CD, B2.COST_ACT_GRP_CD, B2.STND_COST_CD, CUBE(B2.COA_COST_SRC_CD), B1.LOCL_CURR_CD" ).append("\n"); 
