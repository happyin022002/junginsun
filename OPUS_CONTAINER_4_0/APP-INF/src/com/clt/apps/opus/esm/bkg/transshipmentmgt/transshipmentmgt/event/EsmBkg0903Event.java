...
public class EsmBkg0903Event extends EventSupport {
	...
	public BkgTsRmkVO[] getBkgTsRmkVOs() {
		BkgTsRmkVO[] rtnVOs = null;
		if (this.bkgTsRmkVOs != null) {
			rtnVOs = Arrays.copyOf(bkgTsRmkVOs, bkgTsRmkVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setBkgTsRmkVOs(BkgTsRmkVO[] bkgTsRmkVOs) {
		if (bkgTsRmkVOs != null) {
			BkgTsRmkVO[] tmpVOs = Arrays.copyOf(bkgTsRmkVOs, bkgTsRmkVOs.length);
			this.bkgTsRmkVOs = tmpVOs;
		}
	}
