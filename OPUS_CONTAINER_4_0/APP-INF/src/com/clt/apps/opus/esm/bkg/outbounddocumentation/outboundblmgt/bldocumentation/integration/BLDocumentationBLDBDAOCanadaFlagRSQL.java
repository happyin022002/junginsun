...
*@FileName : BLDocumentationBLDBDAOCanadaFlagRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationBLDBDAOCanadaFlagRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLDocumentationBLDBDAOCanadaFlagRSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationBLDBDAOCanadaFlagRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM   BKG_VVD_HIS A" ).append("\n"); 
