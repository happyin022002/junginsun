...
*@FileName : TCharterIOContractDAOSearchAgreementRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOContractDAOSearchAgreementRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOSearchAgreementRSQL
	  * </pre>
	  */
	public TCharterIOContractDAOSearchAgreementRSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOContractDAOSearchAgreementRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("				DECODE(FLET_CTRT_TP_CD,'TI','T/C In','TO','T/C Out','Ownership') FLET_CTRT_TP_CD," ).append("\n"); 
		query.append("				VNDR_SEQ," ).append("\n"); 
		query.append("				CUST_CNT_CD," ).append("\n"); 
		query.append("				CUST_SEQ," ).append("\n"); 
		...
		query.append("				DECODE(FLET_CTRT_FACT_CD,'ACT','Actual','Pseudo') FLET_CTRT_FACT_CD," ).append("\n"); 
		...
		query.append("				TO_CHAR(VSL_DZND_CAPA,'FM99,999') AS VSL_DZND_CAPA," ).append("\n"); 
		query.append("				TO_CHAR(BSE_14TON_VSL_CAPA,'FM99,999') AS BSE_14TON_VSL_CAPA," ).append("\n"); 
		query.append("				TO_CHAR(DDWT_CGO_CAPA_QTY,'FM99,999,999') AS DDWT_CGO_CAPA_QTY," ).append("\n"); 
		query.append("				TO_CHAR(GRS_WGT,'FM999,999,999,999,999,999') AS GRS_WGT," ).append("\n"); 
		query.append("				TO_CHAR(NRT_WGT,'FM999,999') AS NRT_WGT," ).append("\n"); 
		query.append("				CHTR_PRD_OPT_CTNT," ).append("\n"); 
		query.append("				RDE_RNG_CTNT," ).append("\n"); 
		query.append("				RDE_NTC_CTNT," ).append("\n"); 
		query.append("				TO_CHAR(RF_CNTR_PLG_QTY,'FM999,999') AS RF_CNTR_PLG_QTY," ).append("\n"); 
		query.append("				DECODE(GR_FLG,'Y','Geared','G.Less') GR_FLG," ).append("\n"); 
		query.append("				TO_CHAR(SHP_SPD_QTY,'FM999,990.00') SHP_SPD_QTY," ).append("\n"); 
		query.append("				DECODE(FLET_GMT_LMT_CD,'L','LMT','GMT') FLET_GMT_LMT_CD," ).append("\n"); 
		query.append("				BOD_PORT_CD," ).append("\n"); 
		query.append("				BOR_PORT_CD" ).append("\n"); 
