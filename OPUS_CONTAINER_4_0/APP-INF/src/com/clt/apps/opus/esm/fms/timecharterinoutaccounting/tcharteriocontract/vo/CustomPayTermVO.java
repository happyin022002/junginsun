...
*@FileName : CustomPayTermVO.java
*@FileTitle : CustomPayTermVO
*Open Issues :
*Change history :
...
public class CustomPayTermVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomPayTermVO> models = new ArrayList<CustomPayTermVO>();
	 ...
	 * @return 
	 */
	public CustomPayTermVO() {}
	
	/**
	 * 생성자
	 * @param String ibflag, String pagerows, String fletCtrtNo, String effDt, String expDt, String ctrtPayTermCd, String creUsrId, String creDt, String updUsrId, String updDt, String oriEffDt, String oriExpDt
	 * @return 
	 */
	public CustomPayTermVO(String ibflag, String pagerows, String fletCtrtNo, String effDt, String expDt, String ctrtPayTermCd, String creUsrId, String creDt, String updUsrId, String updDt, String oriEffDt, String oriExpDt) {
		this.updDt = updDt;
	...
	public CustomPayTermVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomPayTermVO model = null;
		...
		return getCustomPayTermVOs();
	}

	public CustomPayTermVO[] getCustomPayTermVOs(){
		CustomPayTermVO[] vos = (CustomPayTermVO[])models.toArray(new CustomPayTermVO[models.size()]);
		return vos;
	}
