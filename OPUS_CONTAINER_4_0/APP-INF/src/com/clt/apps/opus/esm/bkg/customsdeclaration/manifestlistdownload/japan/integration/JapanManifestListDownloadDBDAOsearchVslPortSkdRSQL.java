...
public class JapanManifestListDownloadDBDAOsearchVslPortSkdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    MAX(S4.IB_CSSM_VOY_NO) CON_VVD" ).append("\n"); 
		...
		query.append("AND S3.CLPT_IND_SEQ   =  " ).append("\n"); 
		query.append("(SELECT MIN(P.CLPT_IND_SEQ) " ).append("\n"); 
		query.append("                                 FROM VSK_VSL_PORT_SKD P" ).append("\n"); 
		query.append("                                WHERE 1=1" ).append("\n"); 
		query.append("                                  AND P.VSL_CD = S3.VSL_CD" ).append("\n"); 
		query.append("                                  AND P.SKD_VOY_NO = S3.SKD_VOY_NO" ).append("\n"); 
		query.append("                                  AND P.SKD_DIR_CD = S3.SKD_DIR_CD" ).append("\n"); 
		query.append("                                  AND P.VPS_PORT_CD = S3.VPS_PORT_CD" ).append("\n"); 
