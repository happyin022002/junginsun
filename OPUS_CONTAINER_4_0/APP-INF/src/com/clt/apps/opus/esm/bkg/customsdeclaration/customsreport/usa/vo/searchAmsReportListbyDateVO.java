...
*@FileName : searchAmsReportListbyDateVO.java
*@FileTitle : searchAmsReportListbyDateVO
*Open Issues :
*Change history :
...
public class searchAmsReportListbyDateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<searchAmsReportListbyDateVO> models = new ArrayList<searchAmsReportListbyDateVO>();
	...
	public searchAmsReportListbyDateVO() {}

	public searchAmsReportListbyDateVO(String ibflag, String pagerows, String cntCd, String dspoCd, String mblNo, String amsFileNo, String filer, String mfStsCd, String cstmsMfTpCd, String podCd, String delCd, String hubLocCd, String cntrNo, String cntrPrtFlg, String cntrTpszCd, String frtCltFlg, String oblRdemFlg, String ibdTrspNo, String ibdTrspTpCd, String freeTrdZnFlg, String ibdTrspIssDt, String ibdTrspAcptDt, String ibdTrspArrDt, String ibdTrspArrAcptDt, String ibdTrspXptDt, String ibdTrspXptAcptDt, String rcvTermCd, String deTermCd, String arrDt, String scNo, String cstmsDspoNm, String polCd, String bkgNo, String vvd, String railCrrRefNo, String usaIbTrspNo, String pkupNo, String pkupReleased, String pkupDate, String cstmsClrCd, String rnum, String total, String bkgCustTpCd, String blCnt, String seq, String custNm) {
		this.total = total;
...
/**
	 ...
	 * @param request
	 * @return searchAmsReportListbyDateVO[]
	 */
	public searchAmsReportListbyDateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchAmsReportListbyDateVO[]
	 */
	public searchAmsReportListbyDateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		searchAmsReportListbyDateVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new searchAmsReportListbyDateVO();
				if (total[i] != null)
		...
		return getsearchAmsReportListbyDateVOs();
	}
	 ...
	 * @return searchAmsReportListbyDateVO[]
	 */
	public searchAmsReportListbyDateVO[] getsearchAmsReportListbyDateVOs(){
		searchAmsReportListbyDateVO[] vos = (searchAmsReportListbyDateVO[])models.toArray(new searchAmsReportListbyDateVO[models.size()]);
		return vos;
	}
