...
*@FileName : AusDgSendHistoryVO.java
*@FileTitle : AusDgSendHistoryVO
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
public class AusDgSendHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusDgSendHistoryVO> models = new ArrayList<AusDgSendHistoryVO>();
...
/**
	 ...
	 * @param request
	 * @return AusDgSendHistoryVO[]
	 */
	public AusDgSendHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusDgSendHistoryVO[]
	 */
	public AusDgSendHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusDgSendHistoryVO model = null;
	 ...
	 * @return AusDgSendHistoryVO[]
	 */
	public AusDgSendHistoryVO[] getAusDgSendHistoryVOs(){
		AusDgSendHistoryVO[] vos = (AusDgSendHistoryVO[])models.toArray(new AusDgSendHistoryVO[models.size()]);
		return vos;
	}
