...
*@FileName : SCProposalMainDBDAORevertPriSpScpTrspAddChgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpScpTrspAddChgUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpScpTrspAddChgUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpScpTrspAddChgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_TRSP_ADD_CHG" ).append("\n"); 
		query.append("   SET PRC_PROG_STS_CD = @[prop_sts_cd]" ).append("\n"); 
		...
		query.append("#if (${prop_sts_cd} == 'A')" ).append("\n"); 
