...
*@FileName : BookingMasterMgtDBDAOmodifyHrdCdgCtnt2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOmodifyHrdCdgCtnt2USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * HrdCdgCtnt 테이블에 정보를 update한다.
	  * </pre>
	  */
	public BookingMasterMgtDBDAOmodifyHrdCdgCtnt2USQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOmodifyHrdCdgCtnt2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
