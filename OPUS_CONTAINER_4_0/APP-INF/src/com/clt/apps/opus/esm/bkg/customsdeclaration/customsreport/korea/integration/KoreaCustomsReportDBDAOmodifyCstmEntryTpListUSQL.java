...
*@FileName : KoreaCustomsReportDBDAOmodifyCstmEntryTpListUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOmodifyCstmEntryTpListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOmodifyCstmEntryTpListUSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOmodifyCstmEntryTpListUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_CLR_ENTR_TP" ).append("\n");
		query.append("SET ENTR_NM   = @[entr_nm]" ).append("\n");
