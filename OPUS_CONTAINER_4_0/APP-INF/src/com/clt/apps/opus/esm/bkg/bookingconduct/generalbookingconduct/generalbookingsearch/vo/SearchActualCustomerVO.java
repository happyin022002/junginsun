...
public class SearchActualCustomerVO extends AbstractValueObject {
    ...
    public SearchActualCustomerVO(String ibflag, String pagerows, String custCntCd, String custSeq, String code, String custLglEngNm, String fromDt, String toDt, String scNo, String rfaNo, String bkgNo, String svcScpCd, String appDt, String caFlg) {
        this.toDt = toDt;
        this.rfaNo = rfaNo;
        this.bkgNo = bkgNo;
        this.fromDt = fromDt;
