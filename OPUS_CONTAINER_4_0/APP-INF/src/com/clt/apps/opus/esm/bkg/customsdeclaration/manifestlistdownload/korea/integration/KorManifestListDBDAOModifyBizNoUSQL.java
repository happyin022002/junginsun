...
*@FileName : KorManifestListDBDAOModifyBizNoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOModifyBizNoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOModifyBizNoUSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOModifyBizNoUSQL").append("\n");
		query.append("*/").append("\n");
	}
