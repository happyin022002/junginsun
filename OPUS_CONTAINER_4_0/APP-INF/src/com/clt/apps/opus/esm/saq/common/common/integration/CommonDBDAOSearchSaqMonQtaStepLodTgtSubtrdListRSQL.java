...
*@FileName : CommonDBDAOSearchSaqMonQtaStepLodTgtSubtrdListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqMonQtaStepLodTgtSubtrdListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchSaqMonQtaStepLodTgtSubtrdListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchSaqMonQtaStepLodTgtSubtrdListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SELECT '' AS CODE, 'ALL' AS TEXT FROM DUAL                   " ).append("\n"); 
		query.append("       UNION ALL                                                    " ).append("\n"); 
		query.append("       SELECT DISTINCT R.SUB_TRD_CD AS CODE, R.SUB_TRD_CD AS TEXT   " ).append("\n"); 
		...
		query.append("ORDER BY DECODE(TEXT, 'ALL','00',TEXT)  " ).append("\n"); 
