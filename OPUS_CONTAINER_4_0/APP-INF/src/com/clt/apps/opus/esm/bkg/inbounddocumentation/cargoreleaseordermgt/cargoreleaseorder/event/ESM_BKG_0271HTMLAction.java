...
*@FileName : ESM_BKG_0271HTMLAction.java
 ...
 * @author
 * @see EsmBkg0271Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_0271HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0272HTMLAction 객체를 생성
	 */
	public ESM_BKG_0271HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException 
	{
		...
		EsmBkg0271Event event = new EsmBkg0271Event();
		
		if(command.isCommand(FormCommand.SEARCH)) 
		{
			event.setBkgEuPinNoVO((BkgEuPinNoVO) getVO(request, BkgEuPinNoVO.class));
		}
