...
*@FileName : SearchBlListByPoNoVO.java
*@FileTitle : SearchBlListByPoNoVO
*Open Issues :
*Change history :
...
public class SearchBlListByPoNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBlListByPoNoVO> models = new ArrayList<SearchBlListByPoNoVO>();
	 ...
	 * @param request
	 * @return SearchBlListByPoNoVO[]
	 */
	public SearchBlListByPoNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBlListByPoNoVO[]
	 */
	public SearchBlListByPoNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBlListByPoNoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBlListByPoNoVO();
				if (corrRmk[i] != null)
		...
		return getSearchBlListByPoNoVOs();
	}
	 ...
	 * @return SearchBlListByPoNoVO[]
	 */
	public SearchBlListByPoNoVO[] getSearchBlListByPoNoVOs(){
		SearchBlListByPoNoVO[] vos = (SearchBlListByPoNoVO[])models.toArray(new SearchBlListByPoNoVO[models.size()]);
		return vos;
	}
