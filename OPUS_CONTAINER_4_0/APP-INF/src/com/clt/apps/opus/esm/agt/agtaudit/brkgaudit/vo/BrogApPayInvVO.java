...
*@FileName : BrogApPayInvVO.java
*@FileTitle : BrogApPayInvVO
*Open Issues :
*Change history :
...
public class BrogApPayInvVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BrogApPayInvVO> models = new ArrayList<BrogApPayInvVO>();
	...
	public BrogApPayInvVO() {}

	public BrogApPayInvVO(String ibflag, String pagerows, String invSubSysCd, String invOfcCd, String costOfcCd, String vndrSeq, String invEffDt, String invCurrCd, String invTtlAmt, String invRmk, String csrNo, String creUsrId, String creDt, String updUsrId, String updDt, String glDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public BrogApPayInvVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BrogApPayInvVO[]
	 */
	public BrogApPayInvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BrogApPayInvVO model = null;
	...
	public BrogApPayInvVO[] getBrogApPayInvVOs(){
		BrogApPayInvVO[] vos = (BrogApPayInvVO[])models.toArray(new BrogApPayInvVO[models.size()]);
		return vos;
	}
