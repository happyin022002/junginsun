...
*@FileName       : EsmSaq0088ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0088ViewAdapter extends ViewAdapter {

	public EsmSaq0088ViewAdapter() {
...
//					sbufXML.append("<TR LEVEL=\""+colValues.get("slevel")+"\" expand=\""+isExpand+"\" >\n");
					...
					sbufXML.append("<TD BGCOLOR=\""+bgColor[level-1]+"\" ><![CDATA["+ getNull(colValues.get("item")) +"]]></TD>\n");
...
//					sbufXML.append("<TR LEVEL=\""+colValues.get("slevel")+"\" expand=\""+isExpand+"\" >\n");
		...
		} else if( conditionVO.getChkCommand().equals("SEARCHLIST03") || conditionVO.getChkCommand().equals("SEARCHLIST13")) {
			...
			if(totCnt != 0) {
				for(int i=0;i<totCnt;i++){
					...
					isEndRow = (Integer.parseInt(SAQUtil.getNvl(colValues.get("row_seq"),"0")) == 6
...
//					} 				
					sbufXML.append("<TR>");
//					sbufXML.append("<TR LEVEL=\""+colValues.get("slevel")+"\" HAVE-CHILD=\""+((level==5 && isEndRow) ? "TRUE" : "FALSE")+"\" expand=\""+isExpand+"\" >\n");
					sbufXML.append("<TD BGCOLOR=\""+bgColor[level-1]+"\" ><![CDATA["+ dir_cd +"]]></TD>\n");
		...
		} else if( conditionVO.getChkCommand().equals("SEARCHLIST04") || conditionVO.getChkCommand().equals("SEARCHLIST14")) {
			...
			if(totCnt != 0) {
				for(int i=0;i<totCnt;i++){
					...
					isEndRow = (Integer.parseInt(SAQUtil.getNvl(colValues.get("row_seq"),"0")) == 10
							|| (colValues.get("item_text").equals(items[items.length-1]))
							? true : false);
					String sub_trd_cd = colValues.get("sub_trd_cd");
					String rlane_cd = colValues.get("rlane_cd");
...
//					}else if( aq_cd.toUpperCase().equals("TOTAL") ){
//						aq_image = "IMAGE=\"0\"";		
//					}else if( ofc_cd_1.toUpperCase().equals("TOTAL") ){
//						ofc_1_image = "IMAGE=\"0\"";		
//					}else if( ofc_cd_2.toUpperCase().equals("TOTAL") ){
//						//ofc_2_image = "IMAGE=\"0\"";		
//						log.debug("ofc_2_image =");
//					}
					sbufXML.append("<TR>");
//					sbufXML.append("<TR LEVEL=\""+colValues.get("slevel")+"\" HAVE-CHILD=\""+((level==5 && isEndRow) ? "TRUE" : "FALSE")+"\" expand=\""+isExpand+"\" >\n");
					sbufXML.append("<TD BGCOLOR=\""+bgColor[level-1]+"\"><![CDATA["+ sub_trd_cd +"]]></TD>\n");
		...
		} else if( conditionVO.getChkCommand().equals("SEARCHLIST05") || conditionVO.getChkCommand().equals("SEARCHLIST15")) {
...
//					}
					sbufXML.append("<TR>");
//					sbufXML.append("<TR LEVEL=\""+colValues.get("slevel")+"\" HAVE-CHILD=\""+((level==7 && isEndRow) ? "TRUE" : "FALSE")+"\" expand=\""+isExpand+"\" >\n");
