...
*@FileName : KorManifestListDBDAOaddCNTRCorrInfoCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOaddCNTRCorrInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CNTR Correction 정보를 Insert한다.
	  * </pre>
	  */
	public KorManifestListDBDAOaddCNTRCorrInfoCSQL(){
		setQuery();
		...
		params.put("crnt_dat_ctnt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : KorManifestListDBDAOaddCNTRCorrInfoCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("INTO BKG_CSTMS_KR_CNTR_CORR" ).append("\n");
		...
		query.append(", PRE_DAT_CTNT" ).append("\n");
		query.append(", CRNT_DAT_CTNT" ).append("\n");
		query.append(", KR_CSTMS_CORR_ID2" ).append("\n");
		query.append(", PRE_CNTR_NO" ).append("\n");
