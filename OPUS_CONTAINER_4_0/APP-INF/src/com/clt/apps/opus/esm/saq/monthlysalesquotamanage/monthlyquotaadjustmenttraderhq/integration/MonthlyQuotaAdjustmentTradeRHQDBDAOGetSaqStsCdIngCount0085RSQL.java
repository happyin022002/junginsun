...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetSaqStsCdIngCount0085RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOGetSaqStsCdIngCount0085RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOGetSaqStsCdIngCount0085RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetSaqStsCdIngCount0085RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
