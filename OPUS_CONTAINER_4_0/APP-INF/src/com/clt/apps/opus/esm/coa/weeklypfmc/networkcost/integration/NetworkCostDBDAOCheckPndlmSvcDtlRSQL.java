...
*@FileName : NetworkCostDBDAOCheckPndlmSvcDtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOCheckPndlmSvcDtlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOCheckPndlmSvcDtlRSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOCheckPndlmSvcDtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(SUM(CASE WHEN @[eff_fm_dt] BETWEEN EFF_FM_DT AND EFF_TO_DT" ).append("\n"); 
