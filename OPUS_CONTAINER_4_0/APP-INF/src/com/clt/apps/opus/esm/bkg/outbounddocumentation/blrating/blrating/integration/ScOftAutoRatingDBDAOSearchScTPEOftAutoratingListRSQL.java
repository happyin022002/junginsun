...
*@FileName : ScOftAutoRatingDBDAOSearchScTPEOftAutoratingListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScOftAutoRatingDBDAOSearchScTPEOftAutoratingListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchScTPEOftAutoratingList
	  * </pre>
	  */
	public ScOftAutoRatingDBDAOSearchScTPEOftAutoratingListRSQL(){
		setQuery();
		setQuery2();
		...
		query.append("FileName : ScOftAutoRatingDBDAOSearchScTPEOftAutoratingListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("				NVL(TO_DATE(@[rt_aply_dt], 'YYYY-MM-DD'), BR.RT_APLY_DT)		RT_APLY_DT		," ).append("\n"); 
		...
		query.append("AND			NVL(TO_DATE(@[rt_aply_dt], 'YYYY-MM-DD'), ( SELECT RT_APLY_DT FROM BKG_RATE A WHERE A.BKG_NO = BK.BKG_NO ))	BETWEEN SS.EFF_DT AND SS.EXP_DT" ).append("\n"); 
		...
		query.append("AND			SS.AMDT_SEQ			= SM.AMDT_SEQ" ).append("\n"); 
		query.append("AND			SS.SVC_SCP_CD		= BK.SVC_SCP_CD" ).append("\n"); 
		query.append("AND			NVL(TO_DATE(@[rt_aply_dt], 'YYYY-MM-DD'), ( SELECT RT_APLY_DT FROM BKG_RT_HIS A WHERE A.BKG_NO = BK.BKG_NO AND A.CORR_NO = BK.CORR_NO ))	BETWEEN SS.EFF_DT AND SS.EXP_DT" ).append("\n"); 
		query.append("AND			BK.BKG_NO				= @[bkg_no]	-- BKG No" ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     OA.PRC_CGO_TP_CD  IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     DA.PRC_CGO_TP_CD  IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		query.append("				SELECT  A.CONV_DR_TP" ).append("\n"); 
		query.append("				FROM		NC_P A" ).append("\n"); 
		query.append("				WHERE		A.BQ_SEQ 						= BQ.BQ_SEQ" ).append("\n"); 
		...
		query.append("								RD.DIR_CALL_FLG					RD_DIR_CALL_FLG					," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				AND			CM.PROP_NO		= CH.PROP_NO AND CM.AMDT_SEQ		= CH.AMDT_SEQ AND	CM.SVC_SCP_CD			= CH.SVC_SCP_CD AND	CM.GEN_SPCL_RT_TP_CD		= CH.GEN_SPCL_RT_TP_CD AND CM.CMDT_HDR_SEQ		= CH.CMDT_HDR_SEQ" ).append("\n"); 
		...
		query.append("				AND     RD.PROP_NO		= CR.PROP_NO AND RD.AMDT_SEQ		= CR.AMDT_SEQ AND RD.SVC_SCP_CD			= CR.SVC_SCP_CD AND RD.GEN_SPCL_RT_TP_CD		= CR.GEN_SPCL_RT_TP_CD AND RD.CMDT_HDR_SEQ		= CR.CMDT_HDR_SEQ AND RD.ROUT_SEQ			= CR.ROUT_SEQ" ).append("\n"); 
		query.append("				AND     OP.PROP_NO		= CR.PROP_NO AND OP.AMDT_SEQ		= CR.AMDT_SEQ AND OP.SVC_SCP_CD			= CR.SVC_SCP_CD AND OP.GEN_SPCL_RT_TP_CD		= CR.GEN_SPCL_RT_TP_CD AND OP.CMDT_HDR_SEQ		= CR.CMDT_HDR_SEQ AND OP.ROUT_SEQ			= CR.ROUT_SEQ AND OP.ORG_DEST_TP_CD			= 'O'" ).append("\n"); 
		query.append("				AND     DP.PROP_NO		= CR.PROP_NO AND DP.AMDT_SEQ		= CR.AMDT_SEQ AND DP.SVC_SCP_CD			= CR.SVC_SCP_CD AND DP.GEN_SPCL_RT_TP_CD		= CR.GEN_SPCL_RT_TP_CD AND DP.CMDT_HDR_SEQ		= CR.CMDT_HDR_SEQ AND DP.ROUT_SEQ			= CR.ROUT_SEQ AND DP.ORG_DEST_TP_CD			= 'D'" ).append("\n"); 
		query.append("				AND     OV.PROP_NO(+)	= CR.PROP_NO AND OV.AMDT_SEQ(+)	= CR.AMDT_SEQ AND OV.SVC_SCP_CD(+)	= CR.SVC_SCP_CD AND OV.GEN_SPCL_RT_TP_CD(+)	= CR.GEN_SPCL_RT_TP_CD AND OV.CMDT_HDR_SEQ(+)	= CR.CMDT_HDR_SEQ AND OV.ROUT_SEQ(+)	= CR.ROUT_SEQ AND OV.ORG_DEST_TP_CD(+)	= 'O'" ).append("\n"); 
		query.append("				AND     DV.PROP_NO(+)	= CR.PROP_NO AND DV.AMDT_SEQ(+)	= CR.AMDT_SEQ AND DV.SVC_SCP_CD(+)	= CR.SVC_SCP_CD AND DV.GEN_SPCL_RT_TP_CD(+)	= CR.GEN_SPCL_RT_TP_CD AND DV.CMDT_HDR_SEQ(+)	= CR.CMDT_HDR_SEQ AND DV.ROUT_SEQ(+)	= CR.ROUT_SEQ AND DV.ORG_DEST_TP_CD(+)	= 'D'" ).append("\n"); 
		query.append("				AND     RT.PROP_NO		= CR.PROP_NO AND RT.AMDT_SEQ		= CR.AMDT_SEQ AND RT.SVC_SCP_CD			= CR.SVC_SCP_CD AND RT.GEN_SPCL_RT_TP_CD		= CR.GEN_SPCL_RT_TP_CD AND RT.CMDT_HDR_SEQ		= CR.CMDT_HDR_SEQ AND RT.ROUT_SEQ			= CR.ROUT_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				/*******************************************************************************************" ).append("\n"); 
		...
		query.append("		        OR	RT.RAT_UT_CD	= 'BL'" ).append("\n"); 
		query.append("		        OR" ).append("\n"); 
		query.append("    		    (" ).append("\n"); 
		query.append("        				RT.RAT_UT_CD	IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		...
		query.append("				RT_RAS.FRT_RT_AMT          		RT_RAS_FRT_RT_AMT         ," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				RT_ARB.BKG_CONV_TP_CD      		RT_ARB_BKG_CONV_TP_CD     ," ).append("\n"); 
		query.append("				RT_ARB.NOTE_CONV_MAPG_ID   		RT_ARB_NOTE_CONV_MAPG_ID  ," ).append("\n"); 
		query.append("				RT_ARB.NOTE_CONV_SEQ       		RT_ARB_NOTE_CONV_SEQ      ," ).append("\n"); 
		query.append("				RT_ARB.NOTE_CONV_RULE_CD   		RT_ARB_NOTE_CONV_RULE_CD  ," ).append("\n"); 
		query.append("				RT_ARB.NOTE_CONV_TP_CD     		RT_ARB_NOTE_CONV_TP_CD    ," ).append("\n"); 
		query.append("				RT_ARB.RT_OP_CD            		RT_ARB_RT_OP_CD           ," ).append("\n"); 
		query.append("				RT_ARB.CURR_CD             		RT_ARB_CURR_CD            ," ).append("\n"); 
		query.append("				RT_ARB.FRT_RT_AMT          		RT_ARB_FRT_RT_AMT         ," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				NULL													RT_ADD_BKG_CONV_TP_CD     ," ).append("\n"); 
		query.append("				NULL													RT_ADD_NOTE_CONV_MAPG_ID  ," ).append("\n"); 
		query.append("				NULL													RT_ADD_NOTE_CONV_SEQ      ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB CARGO TYPE */" ).append("\n"); 
		query.append("AND			OA.PRC_CGO_TP_CD	IN ( OA_RAC.CONV_DR_TP, OA_RAC.CONV_DG_TP, OA_RAC.CONV_RF_TP, OA_RAC.CONV_AK_TP, OA_RAC.CONV_BB_TP )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		...
		query.append("AND			DECODE(RT_ARB.RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				NULL													RT_ARB_FRT_RT_AMT         ," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				RT_ADD.BKG_CONV_TP_CD      		RT_ADD_BKG_CONV_TP_CD     ," ).append("\n"); 
		query.append("				RT_ADD.NOTE_CONV_MAPG_ID   		RT_ADD_NOTE_CONV_MAPG_ID  ," ).append("\n"); 
		query.append("				RT_ADD.NOTE_CONV_SEQ       		RT_ADD_NOTE_CONV_SEQ      ," ).append("\n"); 
		query.append("				RT_ADD.NOTE_CONV_RULE_CD   		RT_ADD_NOTE_CONV_RULE_CD  ," ).append("\n"); 
		query.append("				RT_ADD.NOTE_CONV_TP_CD     		RT_ADD_NOTE_CONV_TP_CD    ," ).append("\n"); 
		query.append("				RT_ADD.RT_OP_CD            		RT_ADD_RT_OP_CD           ," ).append("\n"); 
		query.append("				RT_ADD.CURR_CD             		RT_ADD_CURR_CD            ," ).append("\n"); 
		query.append("				RT_ADD.FRT_RT_AMT          		RT_ADD_FRT_RT_AMT         ," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				NULL													OA_TYP_BKG_CONV_TP_CD     ," ).append("\n"); 
		query.append("				NULL													OA_TYP_NOTE_CONV_MAPG_ID  ," ).append("\n"); 
		query.append("				NULL													OA_TYP_NOTE_CONV_SEQ      ," ).append("\n"); 
	...
	public void setQuery2(){
		...
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB CARGO TYPE */" ).append("\n"); 
		query.append("AND			DA.PRC_CGO_TP_CD	IN ( DA_RAC.CONV_DR_TP, DA_RAC.CONV_DG_TP, DA_RAC.CONV_RF_TP, DA_RAC.CONV_AK_TP, DA_RAC.CONV_BB_TP )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		...
		query.append("AND			DECODE(RT_ADD.RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				CASE" ).append("\n"); 
		query.append("				WHEN RT_TYP_BKG_CONV_TP_CD = 'C' AND R.BQ_CTRT_CNTR_TPSZ_CD <> R.RAT_UT_CD THEN R.BQ_CTRT_CNTR_TPSZ_CD" ).append("\n"); 
		query.append("				ELSE R.RAT_UT_CD" ).append("\n"); 
		query.append("				END	RAT_UT_CD																					," ).append("\n"); 
		query.append("				CASE" ).append("\n"); 
		query.append("				WHEN RT_RAC_BKG_CONV_TP_CD = 'C' AND R.BQ_PRC_CGO_TP_CD <> R.PRC_CGO_TP_CD THEN R.BQ_PRC_CGO_TP_CD" ).append("\n"); 
		...
		query.append("				R.OI_FNL_FRT_RT_AMT					OI_FNL_FRT_RT_AMT					," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				R.DI_FNL_FRT_RT_AMT					DI_FNL_FRT_RT_AMT					," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				R.RT_RAP_BKG_CONV_TP_CD			RT_RAP_BKG_CONV_TP_CD			," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.RT_RAR_BKG_CONV_TP_CD     RT_RAR_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.RT_DOR_BKG_CONV_TP_CD     RT_DOR_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.RT_TYP_BKG_CONV_TP_CD     RT_TYP_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.RT_RAC_BKG_CONV_TP_CD     RT_RAC_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.RT_ARB_BKG_CONV_TP_CD     RT_ARB_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.RT_ADD_BKG_CONV_TP_CD     RT_ADD_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.OA_TYP_BKG_CONV_TP_CD     OA_TYP_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.OA_RAC_BKG_CONV_TP_CD     OA_RAC_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.DA_TYP_BKG_CONV_TP_CD     DA_TYP_BKG_CONV_TP_CD     ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				R.DA_RAC_BKG_CONV_TP_CD     DA_RAC_BKG_CONV_TP_CD     ," ).append("\n"); 
