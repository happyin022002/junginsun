...
*@FileName : BSAManageDBDAORemoveBSATableJO2DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveBSATableJO2DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAORemoveBSATableJO2DSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveBSATableJO2DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_JNT_OP_CRR_CAPA" ).append("\n"); 
