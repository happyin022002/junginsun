...
*@FileName : AGTAuditDBDAOAgtAgnCommdtlVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOAgtAgnCommdtlVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_comm_dtl update
	  * </pre>
	  */
	public AGTAuditDBDAOAgtAgnCommdtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOAgtAgnCommdtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
