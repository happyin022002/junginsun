...
*@FileName : SCPrefixDBDAOPriScPfxMapgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCPrefixDBDAOPriScPfxMapgVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCPrefixDBDAOPriScPfxMapgVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SC_PFX_MAPG (" ).append("\n"); 
		...
		query.append("FileName : SCPrefixDBDAOPriScPfxMapgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}