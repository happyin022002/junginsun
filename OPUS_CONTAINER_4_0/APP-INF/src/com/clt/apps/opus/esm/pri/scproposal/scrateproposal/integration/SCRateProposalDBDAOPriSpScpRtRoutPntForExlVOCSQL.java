...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutPntForExlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutPntForExlVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * create PRI_SP_SCP_RT_ROUT_PNT
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutPntForExlVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutPntForExlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[loc_grd_cnt_cd] AS LOC_GRD_CNT_CD" ).append("\n"); 
		query.append(",	@[loc_grd_cd] AS LOC_GRD_CD" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ INDEX_DESC(A XPKPRI_SP_SCP_RT_ROUT_PNT) */" ).append("\n"); 
		query.append("                  ROUT_PNT_SEQ" ).append("\n"); 
