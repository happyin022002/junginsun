...
*@FileName : ESM_BKG_0974HTMLAction.java
...
public class ESM_BKG_0974HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0974HTMLAction 객체를 생성
	 */
	public ESM_BKG_0974HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0974Event event = new EsmBkg0974Event();
		
		BkgBlNoVO[] bkgBlNoVOs = (BkgBlNoVO[])getVOs(request, BkgBlNoVO .class);
