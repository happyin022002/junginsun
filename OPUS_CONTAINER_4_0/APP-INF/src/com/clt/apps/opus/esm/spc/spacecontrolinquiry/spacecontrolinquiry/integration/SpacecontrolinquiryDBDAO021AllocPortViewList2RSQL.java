...
public class SpacecontrolinquiryDBDAO021AllocPortViewList2RSQL implements ISQLTemplate{
	...
	public SpacecontrolinquiryDBDAO021AllocPortViewList2RSQL(){
		...
		params.put("subtrade3",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("#if (${subtrade3} != '') " ).append("\n"); 
		query.append("                 AND M.SUB_TRD_CD = @[subtrade3]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("       AND B.CFM_TTL_QTY > 0" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if (${chkview} == 'P')" ).append("\n"); 
		query.append("           Z1.AREA AQ_CD," ).append("\n"); 
