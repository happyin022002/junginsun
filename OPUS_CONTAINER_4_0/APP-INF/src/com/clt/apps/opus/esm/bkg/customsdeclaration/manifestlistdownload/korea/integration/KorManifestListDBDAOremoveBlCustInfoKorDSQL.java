...
*@FileName : KorManifestListDBDAOremoveBlCustInfoKorDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOremoveBlCustInfoKorDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOremoveBlCustInfoKorDSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOremoveBlCustInfoKorDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_KR_CUST" ).append("\n"); 
		query.append("WHERE   (BKG_NO, CSTMS_DECL_TP_CD, BKG_CUST_TP_CD, DMST_PORT_CD, TRNS_SEQ) IN" ).append("\n"); 
		query.append("        (   SELECT  KC.BKG_NO,  KC.CSTMS_DECL_TP_CD, KC.BKG_CUST_TP_CD, KC.DMST_PORT_CD, MAX(KC.TRNS_SEQ)" ).append("\n"); 
		query.append("            FROM    BKG_CSTMS_KR_BL KT, BKG_CSTMS_KR_CUST KC" ).append("\n"); 
		...
		query.append("            AND ((@[in_type] = 'D' AND KT.KR_CSTMS_BND_CD IN ('A','B','C','M')) OR" ).append("\n"); 
		...
		query.append("GROUP BY KC.BKG_NO, KC.CSTMS_DECL_TP_CD, KC.DMST_PORT_CD, KC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("        )" ).append("\n"); 
