...
*@FileName : CsScreenDBDAOsearchPkupNtcCneeInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CsScreenDBDAOsearchPkupNtcCneeInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchPkupNtcCneeInfo
	  * </pre>
	  */
	public CsScreenDBDAOsearchPkupNtcCneeInfoRSQL(){
		setQuery();
		...
		query.append("FileName : CsScreenDBDAOsearchPkupNtcCneeInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
