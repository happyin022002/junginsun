...
*@FileName : KorImpPrtLocNmVO.java
*@FileTitle : KorImpPrtLocNmVO
*Open Issues :
*Change history :
...
public class KorImpPrtLocNmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorImpPrtLocNmVO> models = new ArrayList<KorImpPrtLocNmVO>();
	...
	public KorImpPrtLocNmVO() {}

	public KorImpPrtLocNmVO(String ibflag, String pagerows, String loc1Info, String loc2Info) {
	 ...
	 */
	public KorImpPrtLocNmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorImpPrtLocNmVO[]
	 */
	public KorImpPrtLocNmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorImpPrtLocNmVO model = null;
	 ...
	 * @return KorImpPrtLocNmVO[]
	 */
	public KorImpPrtLocNmVO[] getKorImpPrtLocNmVOs(){
		KorImpPrtLocNmVO[] vos = (KorImpPrtLocNmVO[])models.toArray(new KorImpPrtLocNmVO[models.size()]);
		return vos;
	}
