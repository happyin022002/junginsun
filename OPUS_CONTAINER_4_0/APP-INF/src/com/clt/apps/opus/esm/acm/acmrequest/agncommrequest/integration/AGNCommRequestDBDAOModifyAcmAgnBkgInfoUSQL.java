...
*@FileName : AGNCommRequestDBDAOModifyAcmAgnBkgInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOModifyAcmAgnBkgInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommRequestDBDAOModifyAcmAgnBkgInfoUSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOModifyAcmAgnBkgInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO ACM_AGN_BKG_INFO I1" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(")I2 ON (I1.BKG_NO = I2.BKG_NO )" ).append("\n"); 
