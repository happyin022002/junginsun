...
public class EBookingReceiptDBDAOSearchXterXptLicRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        , AES.AES_EXPT_CTNT			AES_EXPT_ID2" ).append("\n"); 
		...
		query.append("        , decode(nvl(CAED.B13A_CTNT1, 'x'), 'x', '',CAED.B13A_CTNT1)||decode(nvl(CAED.B13A_CTNT2, 'x'), 'x', '',CAED.B13A_CTNT2) B13A_CTNT2" ).append("\n"); 
