...
public class PSASpecialManifestDBDAOpsaSearchCntrCgoByCntrBaseRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       -- DECODE('SGSIN', NULL,BVD.TTL_PCK_DESC) AS OUTPKG_DESC," ).append("\n"); 
		query.append("       -- BVD.EUR_OUTR_PCK_DESC AS OUTPKG_DESC," ).append("\n"); 
		query.append("       BVD.TTL_PCK_DESC AS OUTPKG_DESC," ).append("\n"); 
		query.append("       DECODE(NULL, NULL, BVD.TTL_PCK_DESC) AS INPKG_DESC," ).append("\n"); 
		...
		query.append("       --BVD.MFAG_NO AS MFAG,    -- 위험물 긴급의료 조치표(MFAG:MEDICAL FIRST AID GUIDE FOR USE IN ACCIDENTS INVOLVING DANGEROUS GOODS)상의 식별 번호" ).append("\n"); 
		query.append("       '' AS ESPN," ).append("\n"); 
		query.append("       --BVD.XTD_STAY_PRMT_NO AS ESPN,    - ANTWERP세관에서 허가한 CARGO 신고 기간 연장 번호 예)080124-03-3101" ).append("\n"); 
