...
*@FileName       : ESM_SAQ_0014HTMLAction.java
*@FileTitle      : Target Group 관리
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class ESM_SAQ_0014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0014HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0014HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0014Event event = new EsmSaq0014Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSaqTgtGrpVOS((SaqTgtGrpVO[])getVOs(request, SaqTgtGrpVO .class,""));
		}
		
		//SEARCHLIST 의 경우 조건으로 받는 부분이 없기 때문에 아무 처리 없이 진행한다.
