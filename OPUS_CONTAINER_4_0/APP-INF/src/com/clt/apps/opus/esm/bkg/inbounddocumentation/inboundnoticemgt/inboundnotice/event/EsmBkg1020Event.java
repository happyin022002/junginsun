...
//	}
	...
	public BkgArrNtcWdVO[] getArrNtcWdVOs() {
		BkgArrNtcWdVO[] tmpVOs = null;
		if (this.arrNtcWdVOs != null) {
			tmpVOs = new BkgArrNtcWdVO[arrNtcWdVOs.length];
			System.arraycopy(arrNtcWdVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;		
	} 
...
//	}
	...
	public void setArrNtcWdVOs(BkgArrNtcWdVO[] arrNtcWdVOs) {
		if (arrNtcWdVOs != null) {
			BkgArrNtcWdVO[] tmpVOs = new BkgArrNtcWdVO[arrNtcWdVOs.length];
			System.arraycopy(arrNtcWdVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.arrNtcWdVOs = tmpVOs;
		}		
	} 
