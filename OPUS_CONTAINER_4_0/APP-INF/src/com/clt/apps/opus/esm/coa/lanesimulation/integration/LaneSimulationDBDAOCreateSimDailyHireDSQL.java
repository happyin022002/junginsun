...
*@FileName : LaneSimulationDBDAOCreateSimDailyHireDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOCreateSimDailyHireDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOCreateSimDailyHireDSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOCreateSimDailyHireDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM COA_SIM_DLY_HIR" ).append("\n"); 
