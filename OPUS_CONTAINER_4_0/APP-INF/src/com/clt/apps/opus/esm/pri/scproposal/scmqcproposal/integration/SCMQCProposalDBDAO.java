...
public class SCMQCProposalDBDAO extends DBDAOSupport {
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<RsltPriSpMqcHisVO> searchProposalMQCHistoryList(PriSpScpMqcVO priSpScpMqcVO) throws DAOException {
		DBRowSet dbRowset = null;
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<RsltPriSpMqcHisVO> searchProposalScopeMQCHistoryList(PriSpScpMqcVO priSpScpMqcVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltPriSpMqcHisVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<RsltPriSpSubMqcHisVO> searchProposalSubMQCHistoryList(PriSpScpMqcVO priSpScpMqcVO) throws DAOException {
		DBRowSet dbRowset = null;
