...
*@FileName : ACMSimulationDBDAOAddAcmSimCommTrspCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAddAcmSimCommTrspCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOAddAcmSimCommTrspCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAddAcmSimCommTrspCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(SIM_NO, BKG_NO, AGN_CD, IO_BND_CD, AC_TP_CD, AC_SEQ, AC_TRSP_SEQ, TRSP_MOD_CD, TRSP_DDCT_CD, FM_LOC_CD, TO_LOC_CD, TRSP_DDCT_AMT, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT)" ).append("\n"); 
		...
		query.append("AND B.LOC IN (SUBSTR (NOD_CD, 1, 5) , SUBSTR (TO_NOD_CD, 1, 5) ) " ).append("\n"); 
