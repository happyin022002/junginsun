...
*@FileName : CommonDBDAOAddSaqMonQtaLodTgtRmkCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOAddSaqMonQtaLodTgtRmkCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAQ_MON_QTA_LOD_TGT_RMK의 데이타 모델을 DB에 저장한다.
	  * </pre>
	  */
	public CommonDBDAOAddSaqMonQtaLodTgtRmkCSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOAddSaqMonQtaLodTgtRmkCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SAQ_MON_QTA_LOD_TGT_RMK (" ).append("\n"); 
