...
public class EsmAcm0029Event extends EventSupport {
	...
	public SPCLCmpnAuditVO[] getSpcLCmpnAuditVOs() {
		SPCLCmpnAuditVO[] rtnVOs = null;
		if (this.spcLCmpnAuditVOs != null) {
			rtnVOs = Arrays.copyOf(spcLCmpnAuditVOs, spcLCmpnAuditVOs.length);
		}
		return rtnVOs;
	}

	public void setSpcLCmpnAuditVOs(SPCLCmpnAuditVO[] spcLCmpnAuditVOs) {
		if(spcLCmpnAuditVOs != null){
			SPCLCmpnAuditVO[] tmpVOs = Arrays.copyOf(spcLCmpnAuditVOs, spcLCmpnAuditVOs.length);
			this.spcLCmpnAuditVOs  = tmpVOs;
		}
	}
