...
*@FileName : SpecialCargoReceiptDBDAOModifyBbRDTermUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOModifyBbRDTermUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOModifyBbRDTermUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOModifyBbRDTermUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	DE_TERM_CD = DECODE(@[de_term_cd], 'M', DE_TERM_CD, @[rcv_term_cd])" ).append("\n"); 
