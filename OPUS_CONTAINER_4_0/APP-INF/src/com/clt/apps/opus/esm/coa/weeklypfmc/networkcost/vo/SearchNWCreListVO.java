...
*@FileName : SearchNWCreListVO.java
*@FileTitle : SearchNWCreListVO
*Open Issues :
*Change history :
...
public class SearchNWCreListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchNWCreListVO> models = new ArrayList<SearchNWCreListVO>();
	...
	public SearchNWCreListVO() {}

	public SearchNWCreListVO(String ibflag, String pagerows, String stndCostCd, String stndCostNm, String vslOshpCd, String vopCd, String creStsCd, String creSlctFlg) {
	 ...
	 * @param request
	 * @return SearchNWCreListVO[]
	 */
	public SearchNWCreListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchNWCreListVO[]
	 */
	public SearchNWCreListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchNWCreListVO model = null;
	 ...
	 * @return SearchNWCreListVO[]
	 */
	public SearchNWCreListVO[] getSearchNWCreListVOs(){
		SearchNWCreListVO[] vos = (SearchNWCreListVO[])models.toArray(new SearchNWCreListVO[models.size()]);
		return vos;
	}
