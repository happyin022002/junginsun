...
*@FileName : BlRatingDBDAOSearchRateEtcInfo1RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOSearchRateEtcInfo1RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BlRatingDB DAO SearchRateEtcInfo1 RSQL.Query
	  * </pre>
	  */
	public BlRatingDBDAOSearchRateEtcInfo1RSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOSearchRateEtcInfo1RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("SELECT NVL(A1.EQ_SUBST_CNTR_TPSZ_CD, A1.CNTR_TPSZ_CD) AS CNTR_TPSZ_CD" ).append("\n"); 
