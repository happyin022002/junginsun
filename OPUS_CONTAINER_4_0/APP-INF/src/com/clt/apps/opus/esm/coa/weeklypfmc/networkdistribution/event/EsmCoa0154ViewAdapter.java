	    ...
	    if(totCnt > 0){
	    	try{
	            ...
	            for(int i=0; i<totCnt; i++){
	            	...
	            	strBuilder.append("  <TD><![CDATA["+JSPUtil.getNull((String)colValues.get("n2nd_fnl_co_bsa_capa"))+"]]></TD>");
	            	strBuilder.append("  <TD><![CDATA["+JSPUtil.getNull((String)colValues.get("co_bsa_capa"))+"]]></TD>");
	            	strBuilder.append("  <TD><![CDATA["+JSPUtil.getNull((String)colValues.get("co_bsa_rto"))+"]]></TD>");
