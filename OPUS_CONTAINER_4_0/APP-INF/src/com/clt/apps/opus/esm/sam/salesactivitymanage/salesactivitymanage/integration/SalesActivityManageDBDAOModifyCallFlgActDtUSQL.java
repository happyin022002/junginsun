...
*@FileName : SalesActivityManageDBDAOModifyCallFlgActDtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesActivityManageDBDAOModifyCallFlgActDtUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Sales Activity Report 값이 입력 되는 경우 Sales Activity Management 화면의 Call Report 값과 Actual Date 값 동기화
	  * </pre>
	  */
	public SalesActivityManageDBDAOModifyCallFlgActDtUSQL(){
		setQuery();
		...
		query.append("FileName : SalesActivityManageDBDAOModifyCallFlgActDtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET CALL_RPT_FLG = 'Y'" ).append("\n"); 
		query.append("  , SLS_ACT_ACT_DT = @[sls_act_act_dt]" ).append("\n"); 
