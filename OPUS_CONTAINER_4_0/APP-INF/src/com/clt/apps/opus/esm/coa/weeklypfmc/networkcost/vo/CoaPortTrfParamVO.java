...
*@FileName : CoaPortTrfParamVO.java
*@FileTitle : CoaPortTrfParamVO
*Open Issues :
*Change history :
...
public class CoaPortTrfParamVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaPortTrfParamVO> models = new ArrayList<CoaPortTrfParamVO>();
	...
	public CoaPortTrfParamVO() {}

	public CoaPortTrfParamVO(String ibflag, String pagerows, String port, String updDt, String loclCurrCd, String creDt, String cy, String cnlUsdAmt, String tmlCd, String portUsdAmt, String skdDirCd, String loclCnlAmt, String creUsrId, String slanCd, String costYrmon, String loclPortAmt, String vslClssCapa, String updUsrId, String uploadFlg) {
		this.port = port;
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("upload_flg", getUploadFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("upload_flg", "uploadFlg");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setUploadFlg(JSPUtil.getParameter(request, prefix + "upload_flg", ""));
		setCreDt(JSPUtil.getParameter(request, prefix + "cre_dt", ""));
		setCy(JSPUtil.getParameter(request, prefix + "cy", ""));
	 ...
	 * @param request
	 * @return CoaPortTrfParamVO[]
	 */
	public CoaPortTrfParamVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaPortTrfParamVO[]
	 */
	public CoaPortTrfParamVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaPortTrfParamVO model = null;
		...
		try {
			...
			String[] uploadFlg = (JSPUtil.getParameter(request, prefix	+ "upload_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (uploadFlg[i] != null)
					model.setUploadFlg(uploadFlg[i]);
				if (creDt[i] != null)
	 ...
	 * @return CoaPortTrfParamVO[]
	 */
	public CoaPortTrfParamVO[] getCoaPortTrfParamVOs(){
		CoaPortTrfParamVO[] vos = (CoaPortTrfParamVO[])models.toArray(new CoaPortTrfParamVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.uploadFlg = this.uploadFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
