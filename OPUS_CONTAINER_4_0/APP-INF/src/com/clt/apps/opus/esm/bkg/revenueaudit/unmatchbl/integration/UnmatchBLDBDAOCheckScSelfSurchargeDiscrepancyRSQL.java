...
*@FileName : UnmatchBLDBDAOCheckScSelfSurchargeDiscrepancyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckScSelfSurchargeDiscrepancyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UnmatchBLDBDAOCheckScSelfSurchargeDiscrepancyRSQL
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckScSelfSurchargeDiscrepancyRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckScSelfSurchargeDiscrepancyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        (" ).append("\n"); 
		query.append("        SELECT MAX(CNTR_PRT_FLG) " ).append("\n"); 
		query.append("        FROM BKG_CONTAINER" ).append("\n"); 
		query.append("        WHERE BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("        AND     @[ca_flg]     = 'N'" ).append("\n"); 
		query.append("        HAVING  MAX(CNTR_PRT_FLG) IS NOT NULL" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT MAX(CNTR_PRT_FLG)" ).append("\n"); 
		...
		query.append("                CASE" ).append("\n"); 
		query.append("                WHEN DECODE(CK.BL_FLG, 'Y', 'Y', 'N') = 'Y' THEN 1" ).append("\n"); 
		query.append("                ELSE SUM(BR.RAT_AS_QTY)" ).append("\n"); 
		query.append("                END RAT_AS_QTY  ," ).append("\n"); 
		query.append("                CASE" ).append("\n"); 
		query.append("                WHEN DECODE(CK.BL_FLG, 'Y', 'Y', 'N') = 'Y' THEN 'BL'" ).append("\n"); 
		query.append("                ELSE BR.RAT_UT_CD" ).append("\n"); 
		...
		query.append("                CASE" ).append("\n"); 
		query.append("                WHEN DECODE(CK.BL_FLG, 'Y', 'Y', 'N') = 'Y' THEN 'BL'" ).append("\n"); 
		query.append("                WHEN B.FLEX_HGT_FLG = 'Y' AND BR.RAT_UT_CD IN ('D4','D5','40') THEN 'FH'" ).append("\n"); 
		query.append("                ELSE BR.RAT_UT_CD" ).append("\n"); 
		query.append("                END RAT_UT_CD   ," ).append("\n"); 
		query.append("                BR.CURR_CD      ," ).append("\n"); 
		query.append("                SUM(BR.CHG_AMT) CHG_AMT" ).append("\n"); 
		...
		query.append("COVERED B/L 일 경우는 'DHF', 'NMS', 'CMS', 'ODF' 만 심사 대상으로 처리함." ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("* 심사제외대상" ).append("\n"); 
		query.append("1.TPW Scope - WSC" ).append("\n"); 
		query.append("2.ODF : S/C Conversion Table 중, ODF의 Application 정보가 “INCLUDE”, “NOT APPLICABLE”인 S/C" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT  RA.*  ," ).append("\n"); 
		query.append("        ( SELECT RA.CHG_AMT / XR.USD_LOCL_XCH_RT FROM XR WHERE XR.CURR_CD = RA.CURR_CD )  CHG_USD_AMT" ).append("\n"); 
		...
		query.append("                END RAT_UT_CD   ," ).append("\n"); 
		query.append("                RA.CURR_CD      ," ).append("\n"); 
		query.append("                RA.CHG_UT_AMT	," ).append("\n"); 
		query.append("                SUM(RA.CHG_AMT) CHG_AMT" ).append("\n"); 
		query.append("        FROM    BKG_REV_AUD_CHG_TMP RA  ," ).append("\n"); 
		query.append("                (" ).append("\n"); 
		query.append("                SELECT  CHG_CD      ," ).append("\n"); 
		...
		query.append("                OR  RA.CHG_CD IN ( 'DHF', 'NMS', 'CMS', 'ODF' )" ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("        AND     RA.CHG_CD         NOT IN (SELECT PC.NOTE_CONV_CHG_CD " ).append("\n"); 
		query.append("                			                FROM PRI_SP_HDR PH, PRI_SP_MN PM, PRI_SP_SCP_MN PS, PRI_SC_NOTE_CONV PC," ).append("\n"); 
		query.append("                    			                (SELECT BK.SC_NO, BK.SVC_SCP_CD, BR.RT_APLY_DT" ).append("\n"); 
		...
		query.append("                    			                UNION ALL" ).append("\n"); 
		query.append("                    			                SELECT BK.SC_NO, BK.SVC_SCP_CD, BR.RT_APLY_DT" ).append("\n"); 
		query.append("                    			                FROM BKG_BKG_HIS BK, BKG_RT_HIS BR" ).append("\n"); 
		query.append("                    			                WHERE BK.BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("                    			                AND BK.CORR_NO = 'TMP0000001'" ).append("\n"); 
		query.append("                    			                AND BK.BKG_NO = BR.BKG_NO" ).append("\n"); 
		query.append("                    			                AND BK.CORR_NO = BR.CORR_NO" ).append("\n"); 
		query.append("                    			                AND @[ca_flg] = 'Y') BK" ).append("\n"); 
		query.append("                			                WHERE PH.SC_NO = BK.SC_NO" ).append("\n"); 
		query.append("                			                AND PH.PROP_NO = PM.PROP_NO" ).append("\n"); 
		query.append("                			                AND PM.PROP_STS_CD = 'F'" ).append("\n"); 
		query.append("                			                AND PM.PROP_NO = PS.PROP_NO" ).append("\n"); 
		query.append("                			                AND PM.AMDT_SEQ = PS.AMDT_SEQ" ).append("\n"); 
		query.append("                			                AND PS.SVC_SCP_CD = BK.SVC_SCP_CD" ).append("\n"); 
		query.append("                			                AND BK.RT_APLY_DT BETWEEN PS.EFF_DT AND PS.EXP_DT" ).append("\n"); 
		query.append("                			                AND PS.PROP_NO = PC.PROP_NO" ).append("\n"); 
		query.append("                			                AND PS.AMDT_SEQ = PC.AMDT_SEQ" ).append("\n"); 
		query.append("                			                AND PS.SVC_SCP_CD = PC.SVC_SCP_CD" ).append("\n"); 
		query.append("                			                AND BK.RT_APLY_DT BETWEEN PC.EFF_DT AND PC.EXP_DT" ).append("\n"); 
		query.append("                			                AND PC.NOTE_CONV_CHG_CD = 'ODF'" ).append("\n"); 
		query.append("                			                AND PC.RT_APPL_TP_CD IN ('I','N')" ).append("\n"); 
		query.append("                			                UNION ALL" ).append("\n"); 
		...
		query.append("                			                AND B.SVC_SCP_CD = H.ATTR_CTNT3" ).append("\n"); 
		query.append("                			                AND @[ca_flg] = 'N'" ).append("\n"); 
		query.append("                			                UNION ALL" ).append("\n"); 
		query.append("                			                SELECT H.ATTR_CTNT1" ).append("\n"); 
		query.append("                			                FROM BKG_BKG_HIS B, BKG_HRD_CDG_CTNT H" ).append("\n"); 
		query.append("                			                WHERE B.BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("                			                AND H.HRD_CDG_ID = 'SUR_AUDIT_EXPT'" ).append("\n"); 
		...
		query.append("                			                WHERE B.BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("                			                AND H.HRD_CDG_ID = 'SUR_AUDIT_EXPT'" ).append("\n"); 
		query.append("                			                AND B.BKG_OFC_CD = H.ATTR_CTNT6" ).append("\n"); 
		query.append("                			                AND @[ca_flg] = 'N'" ).append("\n"); 
		query.append("                			                UNION ALL" ).append("\n"); 
		query.append("                			                SELECT H.ATTR_CTNT1" ).append("\n"); 
		query.append("                			                FROM BKG_BKG_HIS B, BKG_HRD_CDG_CTNT H" ).append("\n"); 
		...
		query.append("                CASE" ).append("\n"); 
		query.append("                WHEN DECODE(CK.BL_FLG, 'Y', 'Y', 'N') = 'Y' THEN 'BL'" ).append("\n"); 
		query.append("                WHEN B.FLEX_HGT_FLG = 'Y' AND RA.RAT_UT_CD IN ('D4','D5','40') THEN 'FH'" ).append("\n"); 
		query.append("                ELSE RA.RAT_UT_CD" ).append("\n"); 
		query.append("                END RAT_UT_CD   ," ).append("\n"); 
		query.append("                RA.CURR_CD      ," ).append("\n"); 
		query.append("                SUM(RA.CHG_AMT) CHG_AMT" ).append("\n"); 
		...
		query.append("                			OR	R2.CHG_CD IN (SELECT ATTR_CTNT1 FROM BKG_HRD_CDG_CTNT, BK WHERE HRD_CDG_ID = 'SUR_AUDIT_EXPT' AND ATTR_CTNT5 = BK.SC_NO)" ).append("\n"); 
		query.append("                			OR" ).append("\n"); 
		query.append("							(" ).append("\n"); 
		query.append("								        B2.CGO_CATE_CD  = R2.CGO_CATE_CD" ).append("\n"); 
		query.append("								AND     B2.RCV_TERM_CD  = R2.RCV_TERM_CD" ).append("\n"); 
		query.append("								AND     B2.DE_TERM_CD   = R2.DE_TERM_CD" ).append("\n"); 
		query.append("								AND     B2.RAT_AS_QTY   = R2.RAT_AS_QTY" ).append("\n"); 
		query.append("								AND     (" ).append("\n"); 
		query.append("                            				B2.RAT_UT_CD  = R2.RAT_UT_CD" ).append("\n"); 
		query.append("                        				OR  (" ).append("\n"); 
		query.append("                                			B2.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("                            				AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = B2.RAT_UT_CD )  = ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = R2.RAT_UT_CD )" ).append("\n"); 
		query.append("                            				)" ).append("\n"); 
		query.append("                        				OR  (" ).append("\n"); 
		query.append("                                			R2.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("                            				AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = R2.RAT_UT_CD )  = ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = B2.RAT_UT_CD )" ).append("\n"); 
		query.append("                            				)" ).append("\n"); 
		query.append("                        				)" ).append("\n"); 
		query.append("                				AND     (" ).append("\n"); 
		query.append("                				            ABS(B2.CHG_USD_AMT - R2.CHG_USD_AMT) <= 5" ).append("\n"); 
		query.append("                				        OR  (" ).append("\n"); 
		query.append("                				            R2.CHG_CD IN ( 'OIH', 'DIH' )" ).append("\n"); 
		...
		query.append("        AND CHG_CD NOT IN (SELECT ATTR_CTNT1 FROM BKG_HRD_CDG_CTNT, BK WHERE HRD_CDG_ID = 'SUR_AUDIT_EXPT' AND ATTR_CTNT5 = BK.SC_NO)" ).append("\n"); 
		query.append("        GROUP BY  OFT_CMB_SEQ" ).append("\n"); 
		...
		query.append("                AND     (" ).append("\n"); 
		query.append("                            BS.RAT_UT_CD  = RS.RAT_UT_CD" ).append("\n"); 
		query.append("                        OR  (" ).append("\n"); 
		query.append("                                BS.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("                            AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = BS.RAT_UT_CD )  " ).append("\n"); 
		query.append("                                = ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = RS.RAT_UT_CD )" ).append("\n"); 
		query.append("                            )" ).append("\n"); 
		query.append("                        OR  (" ).append("\n"); 
		query.append("                                RS.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("                            AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = RS.RAT_UT_CD ) " ).append("\n"); 
		query.append("                                = ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = BS.RAT_UT_CD )" ).append("\n"); 
		query.append("                            )" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		...
		query.append("                        CURR_CD       ," ).append("\n"); 
		query.append("                        CHG_UT_AMT    ," ).append("\n"); 
		query.append("                        BK.RT_BL_TP_CD," ).append("\n"); 
		query.append("                        BK.CNTR_PRT_FLG" ).append("\n"); 
		query.append("                FROM    R2, BK" ).append("\n"); 
		query.append("                WHERE   OFT_CMB_SEQ   NOT IN  (" ).append("\n"); 
		query.append("                                              SELECT  DISTINCT" ).append("\n"); 
		query.append("                                                      A.OFT_CMB_SEQ" ).append("\n"); 
		query.append("                                              FROM    (" ).append("\n"); 
		...
		query.append("                ON      B2.OFT_CMB_SEQ  = R2.OFT_CMB_SEQ" ).append("\n"); 
		query.append("                AND     B2.CHG_CD       = R2.CHG_CD" ).append("\n"); 
		query.append("                AND     B2.CURR_CD      = R2.CURR_CD" ).append("\n"); 
		query.append("                AND     B2.CGO_CATE_CD  = R2.CGO_CATE_CD" ).append("\n"); 
		query.append("				AND     B2.RCV_TERM_CD  = R2.RCV_TERM_CD" ).append("\n"); 
		query.append("				AND     B2.DE_TERM_CD   = R2.DE_TERM_CD" ).append("\n"); 
		query.append("				AND     (" ).append("\n"); 
		query.append("				            B2.CHG_UT_AMT   = R2.CHG_UT_AMT" ).append("\n"); 
		query.append("				            OR" ).append("\n"); 
		query.append("				            (R2.CHG_CD IN ( 'OIH', 'DIH' ) AND R2.CHG_UT_AMT = 0)" ).append("\n"); 
		query.append("				        )" ).append("\n"); 
		query.append("				AND     (" ).append("\n"); 
		query.append("				            B2.RAT_AS_QTY   = R2.RAT_AS_QTY" ).append("\n"); 
		query.append("				            OR" ).append("\n"); 
		query.append("				            (R2.RT_BL_TP_CD = 'N' AND R2.CNTR_PRT_FLG = 'Y')" ).append("\n"); 
		query.append("				        )" ).append("\n"); 
		query.append("				AND     (" ).append("\n"); 
		query.append("            				B2.RAT_UT_CD  = R2.RAT_UT_CD" ).append("\n"); 
		query.append("        				OR  (" ).append("\n"); 
		...
		query.append("UNION ALL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        SELECT  1 OFT_CMB_SEQ                      " ).append("\n"); 
		query.append("        FROM DUAL  " ).append("\n"); 
		...
		query.append("                                    FROM    (SELECT CHG_CD, CGO_CATE_CD, RCV_TERM_CD, DE_TERM_CD, RAT_UT_CD,SUM(RAT_AS_QTY) RAT_AS_QTY, SUM(CHG_USD_AMT) CHG_USD_AMT" ).append("\n"); 
		query.append("                                            FROM BR GROUP BY CHG_CD, CGO_CATE_CD, RCV_TERM_CD, DE_TERM_CD, RAT_UT_CD) BR" ).append("\n"); 
		...
		query.append("                                             OR  ( BR.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("                                                   AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = BR.RAT_UT_CD )  = ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = RA.RAT_UT_CD )" ).append("\n"); 
		query.append("                                                  )" ).append("\n"); 
		query.append("                                             OR  ( RA.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("                                                   AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = RA.RAT_UT_CD )  = ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = BR.RAT_UT_CD )" ).append("\n"); 
		query.append("                                                  )" ).append("\n"); 
		query.append("                                             )" ).append("\n"); 
		query.append("--                                    AND     BR.CURR_CD      = RA.CURR_CD" ).append("\n"); 
		query.append("--                                    AND     BR.CHG_UT_AMT   = RA.CHG_UT_AMT" ).append("\n"); 
		query.append("                                    AND     ABS(BR.CHG_USD_AMT - RA.CHG_USD_AMT) <= 5" ).append("\n"); 
		query.append("                                    UNION ALL" ).append("\n"); 
		query.append("                                    SELECT  'X'" ).append("\n"); 
		query.append("                                    FROM    (SEleCT CHG_CD, CGO_CATE_CD, RCV_TERM_CD, DE_TERM_CD,RAT_UT_CD, SUM(RAT_AS_QTY) RAT_AS_QTY, SUM(CHG_USD_AMT) CHG_USD_AMT" ).append("\n"); 
		query.append("                                            FROM RS GROUP BY CHG_CD, CGO_CATE_CD, RCV_TERM_CD, DE_TERM_CD, RAT_UT_CD) RS," ).append("\n"); 
		query.append("                                            (SEleCT CHG_CD, CGO_CATE_CD, RCV_TERM_CD, DE_TERM_CD, RAT_UT_CD, SUM(RAT_AS_QTY) RAT_AS_QTY, SUM(CHG_USD_AMT) CHG_USD_AMT" ).append("\n"); 
		query.append("                                            FROM BS GROUP BY CHG_CD, CGO_CATE_CD, RCV_TERM_CD, DE_TERM_CD, RAT_UT_CD) BS" ).append("\n"); 
		query.append("--                                    RS, BS" ).append("\n"); 
		query.append("                                    WHERE   RA.CHG_CD       = RS.CHG_CD" ).append("\n"); 
		query.append("                                    AND     RA.CGO_CATE_CD  = RS.CGO_CATE_CD" ).append("\n"); 
		query.append("                                    AND     RA.RCV_TERM_CD  = RS.RCV_TERM_CD" ).append("\n"); 
		query.append("                                    AND     RA.DE_TERM_CD   = RS.DE_TERM_CD" ).append("\n"); 
		query.append("                                    AND     RA.RAT_UT_CD    = RS.RAT_UT_CD" ).append("\n"); 
		query.append("--                                    AND     RA.CURR_CD      = RS.CURR_CD" ).append("\n"); 
		query.append("                                    AND     BS.CHG_CD       = RS.CHG_CD" ).append("\n"); 
		query.append("                                    AND     BS.CGO_CATE_CD  = RS.CGO_CATE_CD" ).append("\n"); 
		query.append("                                    AND     BS.RCV_TERM_CD  = RS.RCV_TERM_CD" ).append("\n"); 
		query.append("                                    AND     BS.DE_TERM_CD   = RS.DE_TERM_CD" ).append("\n"); 
