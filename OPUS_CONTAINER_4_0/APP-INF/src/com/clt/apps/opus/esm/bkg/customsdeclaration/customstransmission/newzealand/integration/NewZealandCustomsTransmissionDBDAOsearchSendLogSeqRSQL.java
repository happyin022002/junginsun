...
*@FileName : NewZealandCustomsTransmissionDBDAOsearchSendLogSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NewZealandCustomsTransmissionDBDAOsearchSendLogSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NewZealandCustomsTransmissionDBDAOsearchSendLogSeqRSQL(){
		setQuery();
		...
		query.append("FileName : NewZealandCustomsTransmissionDBDAOsearchSendLogSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MAX(LOG_SEQ), 0)" ).append("\n"); 
		query.append("  FROM BKG_CSTMS_NZL_SND_LOG" ).append("\n"); 
		query.append(" WHERE NZL_SND_LOG_ID = @[nzl_snd_log_id]" ).append("\n"); 
