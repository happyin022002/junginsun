...
public class EurManifestTransmitVO extends com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.vo.ManifestTransmitVO {
	...
	/* Column Info */
	private String ediPreview = null;
	/* Column Info */
	...
	public EurManifestTransmitVO(String ibflag, String pagerows, String pOriAmdCd, String porCd, String tvvdCd, String bkgStsCd, String blNo, String cntrCd, String polCd, String vvdCd, String receiverId, String cmdtCd, String bPodCd, String bkgSpeAk, String uvi, String bkgOfcCd, String bkgCgoTp, String bkgSpeBb, String searchPodCd, String bndCd, String delCd, String bkgSpeDg, String podCd, String ofcCd, String bkgNo, String bPolCd, String cmdtDesc, String bkgSpeRf, String callType, String ediPreview, String modeType, String polYdCd, String podYdCd) {
		this.tvvdCd = tvvdCd;
		this.porCd = porCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("edi_preview", getEdiPreview());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("edi_preview", "ediPreview");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setEdiPreview(JSPUtil.getParameter(request, prefix + "edi_preview", ""));
	...
	public EurManifestTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ediPreview = (JSPUtil.getParameter(request, prefix	+ "edi_preview", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ediPreview[i] != null)
					model.setEdiPreview(ediPreview[i]);
				if (cmdtCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.ediPreview = this.ediPreview .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
