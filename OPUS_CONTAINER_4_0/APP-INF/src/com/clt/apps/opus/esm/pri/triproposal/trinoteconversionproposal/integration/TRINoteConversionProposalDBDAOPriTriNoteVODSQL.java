...
*@FileName : TRINoteConversionProposalDBDAOPriTriNoteVODSQL.java
...
public class TRINoteConversionProposalDBDAOPriTriNoteVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRINoteConversionProposalDBDAOPriTriNoteVODSQL(){
		setQuery();
		...
		query.append("FileName : TRINoteConversionProposalDBDAOPriTriNoteVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_NOTE" ).append("\n"); 
