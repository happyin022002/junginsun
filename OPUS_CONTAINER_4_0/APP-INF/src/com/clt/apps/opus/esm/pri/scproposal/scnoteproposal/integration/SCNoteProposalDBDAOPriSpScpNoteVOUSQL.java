...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_NOTE SET" ).append("\n"); 
		query.append("NOTE_TIT_NM     		= NVL(@[note_tit_nm], NOTE_TIT_NM)" ).append("\n"); 
		query.append(",NOTE_CLSS_CD     		= NVL(@[note_clss_cd], NOTE_CLSS_CD)" ).append("\n"); 
