...
*@FileTitle      : 홈페이지에서 OBL 출력시 OPUS에 출력정보 업데이트
*@Author         : Jong-ho Kim
*Open Issues     :
*Change history  :
...
import com.clt.irep.opusws.WEB0040001Document;
import com.clt.irep.opusws.WEB0040001Document.WEB0040001;
import com.clt.irep.opusws.WEB0040001Document.WEB0040001.DataArea;
import com.clt.irep.opusws.WEB0040001Document.WEB0040001.DataArea.PrintInfoCollection;
import com.clt.irep.opusws.WEB0040001Document.WEB0040001.DataArea.PrintInfoCollection.PrintInfoRequest;
import com.clt.irep.opusws.WEB0040001Document.WEB0040001.DataArea.PrintInfoCollection.PrintInfoResponse;
...
targetNamespace="http://www.clt.com/integration/clt")

@SOAPBinding(style=SOAPBinding.Style.DOCUMENT,
 use=SOAPBinding.Use.LITERAL,
 parameterStyle=SOAPBinding.ParameterStyle.WRAPPED)

@WLHttpTransport(contextPath="/clt/webservices", serviceUri="/BKGWeb0040001WSProxy",
...
public class BKGWeb0040001WSProxy {
	...
	/**
	 * 홈페이지에서 OBL 출력시 OPUS에 출력정보 업데이트<br>
	 * 
	 * @author Jong-ho Kim
