...
public class EsmAcm0006Event extends EventSupport {
	...
	public AGNCommRequestVO[] getAGNCommRequestVOs() {
		AGNCommRequestVO[] rtnVOs = null;
		if (this.agnCommRequestVOs != null) {
			rtnVOs = Arrays.copyOf(agnCommRequestVOs, agnCommRequestVOs.length);
		}
		return rtnVOs;
	}

	public void setAGNCommRequestVOs(AGNCommRequestVO[] agnCommRequestVOs) {
		if(agnCommRequestVOs != null){
			AGNCommRequestVO[] tmpVOs = Arrays.copyOf(agnCommRequestVOs, agnCommRequestVOs.length);
			this.agnCommRequestVOs  = tmpVOs;
		}
	}
