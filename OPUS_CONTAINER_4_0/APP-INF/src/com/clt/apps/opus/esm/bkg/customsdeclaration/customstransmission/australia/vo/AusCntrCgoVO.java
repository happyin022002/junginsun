...
*@FileName : AusCntrCgoVO.java
*@FileTitle : AusCntrCgoVO
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
public class AusCntrCgoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusCntrCgoVO> models = new ArrayList<AusCntrCgoVO>();
...
/**
	 ...
	 * @return AusCntrCgoVO[]
	 */
	public AusCntrCgoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusCntrCgoVO[]
	 */
	public AusCntrCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusCntrCgoVO model = null;
	 ...
	 * @return AusCntrCgoVO[]
	 */
	public AusCntrCgoVO[] getAusCntrCgoVOs(){
		AusCntrCgoVO[] vos = (AusCntrCgoVO[])models.toArray(new AusCntrCgoVO[models.size()]);
		return vos;
	}
