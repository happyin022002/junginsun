...
*@FileName : RFAGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_RP_SCP_GRI_ROUT_VIA A" ).append("\n"); 
		query.append("WHERE PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("AND AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("AND SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
		query.append("AND GRI_GRP_SEQ = @[gri_grp_seq]" ).append("\n"); 
		query.append("AND ORG_DEST_TP_CD = 'D'" ).append("\n"); 
		query.append("ORDER BY DECODE(ROUT_VIA_PORT_TP_CD, 'C', '1', 'G', '2', 'L', '3'), ROUT_VIA_PORT_DEF_CD" ).append("\n"); 
