...
public class CaSummaryReportOutVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCntHlgC(JSPUtil.getParameter(request, "cnt_hlg_c", ""));
		setBlNo(JSPUtil.getParameter(request, "bl_no", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setCxlModiFlg(JSPUtil.getParameter(request, "cxl_modi_flg", ""));
		setPolCd(JSPUtil.getParameter(request, "pol_cd", ""));
		setCntHlgM(JSPUtil.getParameter(request, "cnt_hlg_m", ""));
		...
		setCntCaTtl(JSPUtil.getParameter(request, "cnt_ca_ttl", ""));
		...
		setCntClassN(JSPUtil.getParameter(request, "cnt_class_n", ""));
		setCntRsnA(JSPUtil.getParameter(request, "cnt_rsn_a", ""));
		setCntRsnC(JSPUtil.getParameter(request, "cnt_rsn_c", ""));
		setCntExempt(JSPUtil.getParameter(request, "cnt_exempt", ""));
		setCntClassE(JSPUtil.getParameter(request, "cnt_class_e", ""));
		setCorrOfcCd(JSPUtil.getParameter(request, "corr_ofc_cd", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setCaRsnCd(JSPUtil.getParameter(request, "ca_rsn_cd", ""));
		setCntRsnM(JSPUtil.getParameter(request, "cnt_rsn_m", ""));
		setBkgSplitModiFlg(JSPUtil.getParameter(request, "bkg_split_modi_flg", ""));
		setCntBlTtl(JSPUtil.getParameter(request, "cnt_bl_ttl", ""));
		setCntRsnR(JSPUtil.getParameter(request, "cnt_rsn_r", ""));
		setCorrNo(JSPUtil.getParameter(request, "corr_no", ""));
		setCntRsnG(JSPUtil.getParameter(request, "cnt_rsn_g", ""));
		setCntClassR(JSPUtil.getParameter(request, "cnt_class_r", ""));
		setCntKindA(JSPUtil.getParameter(request, "cnt_kind_a", ""));
		setCntKindB(JSPUtil.getParameter(request, "cnt_kind_b", ""));
		setCntKindC(JSPUtil.getParameter(request, "cnt_kind_c", ""));
		setDiffRmk(JSPUtil.getParameter(request, "diff_rmk", ""));
		setCntKindD(JSPUtil.getParameter(request, "cnt_kind_d", ""));
		setCntKindI(JSPUtil.getParameter(request, "cnt_kind_i", ""));
		setCntKindJ(JSPUtil.getParameter(request, "cnt_kind_j", ""));
		setCntKindK(JSPUtil.getParameter(request, "cnt_kind_k", ""));
		setCntKindE(JSPUtil.getParameter(request, "cnt_kind_e", ""));
		setCntKindF(JSPUtil.getParameter(request, "cnt_kind_f", ""));
		setCntKindG(JSPUtil.getParameter(request, "cnt_kind_g", ""));
		setCntKindH(JSPUtil.getParameter(request, "cnt_kind_h", ""));
		setRev(JSPUtil.getParameter(request, "rev", ""));
		setNonrev(JSPUtil.getParameter(request, "nonrev", ""));
		setExp(JSPUtil.getParameter(request, "exp", ""));
		setExp(JSPUtil.getParameter(request, "exemption", ""));
