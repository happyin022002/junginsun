...
public class EsmBkg0495ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		if (realColNms.length>10){
			...
			for(int i=0;i<realCnt;i++){
				...
				if (i+1 == realCnt){
					...
					if(colNextValues.get("disc").equals("D")){
						sNextVvdTmp = JSPUtil.getNull(colNextValues.get("nextvvd"));
					}else{
						sNextVvdTmp = JSPUtil.getNull(colNextValues.get("firstvvd"));
					}
				}
				
				colCnt = realColNms.length;
				if (colValues.get("disc").equals("D")){
					sVvdCd =JSPUtil.getNull(colValues.get("nextvvd"));
				}else{
					sVvdCd =JSPUtil.getNull(colValues.get("firstvvd"));
				}
			...
			sbufXML.append("  <TD><![CDATA[ ]]></TD>\n"); 
			sbufXML.append("  <TD><![CDATA["); sbufXML.append("Grand Weight"); sbufXML.append("]]></TD>\n");
			sbufXML.append("  <TD BGCOLOR=\"232, 231, 236\"><![CDATA["); sbufXML.append("Grand Weight"); sbufXML.append("]]></TD>\n"); 
			sbufXML.append("  <TD BGCOLOR=\"232, 231, 236\" Align=\"right\" DATA-FORMAT=\"dfNumber\"  BOLD=\"TRUE\" COLOR=\"251, 25, 1\"><![CDATA["); sbufXML.append(Math.round(fWgtSum/1000)); sbufXML.append("]]></TD>\n");
			sbufXML.append("  <TD BGCOLOR=\"232, 231, 236\" Align=\"right\" DATA-FORMAT=\"dfNumber\"  BOLD=\"TRUE\" COLOR=\"251, 25, 1\"><![CDATA["); sbufXML.append(Math.round(fWgtSum/1000)); sbufXML.append("]]></TD>\n");
