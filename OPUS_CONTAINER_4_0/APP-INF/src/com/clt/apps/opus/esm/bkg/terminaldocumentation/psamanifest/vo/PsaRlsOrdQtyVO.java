...
*@FileName : PsaRlsOrdQtyVO.java
*@FileTitle : PsaRlsOrdQtyVO
*Open Issues :
*Change history :
...
public class PsaRlsOrdQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<PsaRlsOrdQtyVO> models = new ArrayList<PsaRlsOrdQtyVO>();
	...
	public PsaRlsOrdQtyVO() {}

	public PsaRlsOrdQtyVO(String ibflag, String pagerows, String bkgNo, String bkgSeq, String psaSerNo, String subPsaSerNo) {
...
/**
	 ...
	 * @param request
	 * @return PsaRlsOrdQtyVO[]
	 */
	public PsaRlsOrdQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaRlsOrdQtyVO[]
	 */
	public PsaRlsOrdQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaRlsOrdQtyVO model = null;
	 ...
	 * @return PsaRlsOrdQtyVO[]
	 */
	public PsaRlsOrdQtyVO[] getPsaRlsOrdQtyVOs(){
		PsaRlsOrdQtyVO[] vos = (PsaRlsOrdQtyVO[])models.toArray(new PsaRlsOrdQtyVO[models.size()]);
		return vos;
	}
