...
*@FileName : SearchSpcScPortDownDetailListVO.java
*@FileTitle : SearchSpcScPortDownDetailListVO
*Open Issues :
*Change history :
...
public class SearchSpcScPortDownDetailListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSpcScPortDownDetailListVO> models = new ArrayList<SearchSpcScPortDownDetailListVO>();
	...
	public SearchSpcScPortDownDetailListVO() {}

	public SearchSpcScPortDownDetailListVO(String ibflag, String pagerows, String bsaSeq, String bsaFmDt, String trdCd, String rlaneCd, String dirCd, String vslSeq, String vslCd, String bsaOpCd, String bsaOpJbCd, String crrCd, String portSeq, String portCd, String portBsaCapa) {
	 ...
	 * @param request
	 * @return SearchSpcScPortDownDetailListVO[]
	 */
	public SearchSpcScPortDownDetailListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSpcScPortDownDetailListVO[]
	 */
	public SearchSpcScPortDownDetailListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSpcScPortDownDetailListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSpcScPortDownDetailListVO();
				if (bsaFmDt[i] != null)
		...
		return getSearchSpcScPortDownDetailListVOs();
	}
	 ...
	 * @return SearchSpcScPortDownDetailListVO[]
	 */
	public SearchSpcScPortDownDetailListVO[] getSearchSpcScPortDownDetailListVOs(){
		SearchSpcScPortDownDetailListVO[] vos = (SearchSpcScPortDownDetailListVO[])models.toArray(new SearchSpcScPortDownDetailListVO[models.size()]);
		return vos;
	}
