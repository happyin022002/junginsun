...
*@FileName : ESM_PRI_5001HTMLAction.java
...
public class ESM_PRI_5001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_5001HTMLAction 객체를 생성
	 */
	public ESM_PRI_5001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri5001Event event = new EsmPri5001Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriRcvDeTermMapgVOS((PriRcvDeTermMapgVO[])getVOs(request, PriRcvDeTermMapgVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setPriRcvDeTermMapgVO((PriRcvDeTermMapgVO)getVO(request, PriRcvDeTermMapgVO .class));
		}
