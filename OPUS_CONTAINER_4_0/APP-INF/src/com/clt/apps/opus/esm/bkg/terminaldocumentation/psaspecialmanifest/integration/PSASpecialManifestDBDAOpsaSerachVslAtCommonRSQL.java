...
*@FileName : PSASpecialManifestDBDAOpsaSerachVslAtCommonRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOpsaSerachVslAtCommonRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSASpecialManifestDBDAOpsaSerachVslAtCommonRSQL(){
		setQuery();
		...
		query.append("FileName : PSASpecialManifestDBDAOpsaSerachVslAtCommonRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
