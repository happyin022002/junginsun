...
*@FileName : CostStructureDBDAOAddUSAServiceModeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAOAddUSAServiceModeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostStructureDBDAOAddUSAServiceModeCSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAOAddUSAServiceModeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO COA_USA_SVC_MOD (" ).append("\n"); 
