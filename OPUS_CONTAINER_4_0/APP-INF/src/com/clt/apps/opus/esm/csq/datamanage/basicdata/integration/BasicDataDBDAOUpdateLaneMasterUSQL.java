...
public class BasicDataDBDAOUpdateLaneMasterUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("UPDATE CSQ_QTA_LANE_MGMT " ).append("\n"); 
		query.append("   SET CSQ_ACT_FLG  = DECODE(@[csq_act_flg],1,'Y','N') " ).append("\n"); 
		query.append("      ,IAS_SCTR_FLG = DECODE(@[ias_sctr_flg],1,'Y',0,'N','N') " ).append("\n"); 
