...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , T.NOTE_CTNT_SEQ		AS NOTE_CTNT_SEQ      " ).append("\n"); 
		query.append("	 , NULL					AS CHG_CD             " ).append("\n"); 
		query.append("	 , T.NOTE_CTNT			AS NOTE_CTNT          " ).append("\n"); 
		query.append("	 , T.NOTE_CONV_FLG		AS NOTE_CONV_FLG      " ).append("\n"); 
		query.append("	 , T.NOTE_CTNT_SEQ		AS DP_SEQ             " ).append("\n"); 
		query.append("	 , T.NOTE_CONV_MAPG_ID	AS NOTE_CONV_MAPG_ID  " ).append("\n"); 
		query.append("	 , NULL					AS NOTE_CHG_TP_CD     " ).append("\n"); 
