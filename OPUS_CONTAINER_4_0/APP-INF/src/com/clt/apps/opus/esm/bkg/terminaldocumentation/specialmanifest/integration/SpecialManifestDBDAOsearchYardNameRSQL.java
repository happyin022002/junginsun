...
*@FileName : SpecialManifestDBDAOsearchYardNameRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOsearchYardNameRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOsearchYardNameRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOsearchYardNameRSQL").append("\n");
		query.append("*/").append("\n");
	}
