...
*@FileName : JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpAwkCgoDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpAwkCgoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_TML_EDI_JP_AWK_CGO 테이블에서 잘못 나간 VVD BKG 정보 삭제
	  * </pre>
	  */
	public JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpAwkCgoDSQL(){
		setQuery();
		...
		query.append("FileName : JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpAwkCgoDSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_TML_EDI_JP_AWK_CGO" ).append("\n");
