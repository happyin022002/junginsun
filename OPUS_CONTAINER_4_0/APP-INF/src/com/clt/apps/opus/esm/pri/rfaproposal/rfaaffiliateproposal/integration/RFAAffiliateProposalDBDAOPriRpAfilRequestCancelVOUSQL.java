...
*@FileName : RFAAffiliateProposalDBDAOPriRpAfilRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAAffiliateProposalDBDAOPriRpAfilRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request Cancel 시 해당 회차의 데이터를 Init상태로 변경한다.
	  * </pre>
	  */
	public RFAAffiliateProposalDBDAOPriRpAfilRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAAffiliateProposalDBDAOPriRpAfilRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
