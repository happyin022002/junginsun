...
*@FileName : ESM_COA_4010HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 20150619
*@LastModifier : SJH
*@LastVersion : 1.0
* 2015.06.19 SJH
* 1.0 Creation
...
import com.clt.apps.opus.esm.coa.weeklypfmc.opmaster.event.EsmCoa4010Event;
 ...
 * @author Kim Ki Dae
 * @see EsmCoa4010Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_4010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * TESTHTMLAction 객체를 생성
	 */
	public ESM_COA_4010HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCoa4010Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa4010Event event = new EsmCoa4010Event();  	
