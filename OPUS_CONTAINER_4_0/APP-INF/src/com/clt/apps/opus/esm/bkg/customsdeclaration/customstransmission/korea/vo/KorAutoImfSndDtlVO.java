...
*@FileName : KorAutoImfSndDtlVO.java
*@FileTitle : KorAutoImfSndDtlVO
*Open Issues :
*Change history :
...
public class KorAutoImfSndDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorAutoImfSndDtlVO> models = new ArrayList<KorAutoImfSndDtlVO>();
	...
	public KorAutoImfSndDtlVO() {}

	public KorAutoImfSndDtlVO(String ibflag, String pagerows, String sndDt, String ofcCd, String fltFileRefNo, String usrId, String vvdCd, String polCd, String blNo, String subNo, String sndSeq, String ediSndMsg) {
		this.ofcCd = ofcCd;
		this.sndSeq = sndSeq;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return KorAutoImfSndDtlVO[]
	 */
	public KorAutoImfSndDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorAutoImfSndDtlVO[]
	 */
	public KorAutoImfSndDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorAutoImfSndDtlVO model = null;
	 ...
	 * @return KorAutoImfSndDtlVO[]
	 */
	public KorAutoImfSndDtlVO[] getKorAutoImfSndDtlVOs(){
		KorAutoImfSndDtlVO[] vos = (KorAutoImfSndDtlVO[])models.toArray(new KorAutoImfSndDtlVO[models.size()]);
		return vos;
	}
