...
*@FileName : RFAGuidelineMainDBDAOMaxGlineSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGuidelineMainDBDAOMaxGlineSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGuidelineMainDBDAOMaxGlineSeqRSQL(){
		setQuery();
		...
		query.append("FileName : RFAGuidelineMainDBDAOMaxGlineSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
