...
public class TCharterIOInvoiceDAOSearchCalOffhireInvoiceListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , 'OFF' AS FLET_ISS_TP_CD" ).append("\n"); 
		...
		query.append("                     , TRIM(TO_CHAR(HIR_RT_N1ST_AMT,'999,999,999,999,999,990.00')) AS ORI_INV_AMT" ).append("\n"); 
		...
		query.append("                                     , FO.OTR_EXPN_AMT * TO_NUMBER(PM.INV_USD_DYS) HIR_RT_N1ST_AMT" ).append("\n"); 
		query.append("                                     , DECODE(PM.FLET_OFFH_RSN_CD,'O',PM.TXT_OFF_HIRE, PM.TXT_DRY_DOCK) || ' ' || SUBSTR(PM.BUNKER_VVD,1,9) || ' ' || '(' || TO_CHAR(TO_DATE(PM.EFF_DT,'YYYYMMDD'),'YYYY-MM-DD HH24:MI') || ' ~ ' || TO_CHAR(TO_DATE(PM.EXP_DT,'YYYYMMDD'),'YYYY-MM-DD HH24:MI') || ')' AS INV_DESC" ).append("\n"); 
