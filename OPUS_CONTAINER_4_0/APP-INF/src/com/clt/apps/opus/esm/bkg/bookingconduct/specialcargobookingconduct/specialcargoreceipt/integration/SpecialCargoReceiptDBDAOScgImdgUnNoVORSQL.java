...
public class SpecialCargoReceiptDBDAOScgImdgUnNoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      AND ROWNUM =1 ) CRR_CD" ).append("\n"); 
		query.append(",	SEGR.IMDG_SEGR_GRP_NOS" ).append("\n"); 
		query.append(",	B1.IMDG_AMDT_NO" ).append("\n"); 
		query.append(",	B1.CFR_FLG" ).append("\n"); 
		query.append(",   B1.PRP_SHP_NM_VAR_RMK" ).append("\n"); 
		...
		query.append("AND B2.IMDG_SPCL_PROVI_NO(+) IN( 274,318)" ).append("\n"); 
		...
		query.append("AND DECODE(B1.CFR_FLG, 'Y', @[imdg_amdt_no], B1.IMDG_AMDT_NO) = @[imdg_amdt_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("AND B1.IMDG_UN_NO = SEGR.IMDG_UN_NO(+)" ).append("\n"); 
		query.append("#if(${imdg_un_no_seq} != '')" ).append("\n"); 
		query.append("AND B1.IMDG_UN_NO_SEQ = @[imdg_un_no_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
