...
*@FileName : BlRatingDBDAOcopyManualChgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOcopyManualChgCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOcopyManualChgCSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOcopyManualChgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("and auto_rat_cd = 'M'" ).append("\n"); 
