...
public class SearchSlipApprovalListVO extends AbstractValueObject {
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setSlipType(JSPUtil.getParameter(request, "slip_type", ""));
