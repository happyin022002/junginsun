...
public class KorManifestListDBDAOSearchCargoDescDNRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RPAD(REPLACE(NVL(CSTMS_DESC,' '),CHR(10),' '),50,' ') FROM BKG_BL_DOC
	  * </pre>
	  */
	...
	public void setQuery(){
		query.append("SELECT TRIM(REPLACE(NVL(SUBSTR(CSTMS_DESC,1,50),' '),CHR(10),' ')) DESC_CODE1," ).append("\n");
		query.append("TRIM(REPLACE(NVL(SUBSTR(CSTMS_DESC,51,150),' '),CHR(10),' ')) DESC_CODE2" ).append("\n");
