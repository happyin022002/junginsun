...
*@FileName : ACMSimulationDBDAORemoveAcmSimCommTrspDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAORemoveAcmSimCommTrspDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveAcmSimCommTrsp
	  * </pre>
	  */
	public ACMSimulationDBDAORemoveAcmSimCommTrspDSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAORemoveAcmSimCommTrspDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_SIM_COMM_TRSP" ).append("\n"); 
		...
		query.append("        FROM   ACM_SIM_COMM" ).append("\n"); 
