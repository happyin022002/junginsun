 ...
 *@FileName : ESM_SAQ_0179HTMLAction.java
...
public class ESM_SAQ_0179HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_SAQ_0179HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0179HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0179Event event = new EsmSaq0179Event();

		if (command.isCommand(FormCommand.SEARCHLIST01) || command.isCommand(FormCommand.SEARCHLIST02)  || command.isCommand(FormCommand.SEARCH01)) {
