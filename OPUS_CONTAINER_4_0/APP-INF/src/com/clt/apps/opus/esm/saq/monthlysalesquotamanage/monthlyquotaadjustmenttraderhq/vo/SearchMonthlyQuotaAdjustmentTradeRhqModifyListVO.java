...
*@FileName : SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO.java
*@FileTitle : SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO
*Open Issues :
*Change history :
...
public class SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO> models = new ArrayList<SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO>();
	...
	public SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO() {}

	public SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO(String ibflag, String pagerows, String subTrdCd, String laneGrp, String rhqCd, String grpSeq1, String load1, String gRpb1, String grpSeq2, String load2, String gRpb2, String grpSeq3, String load3, String gRpb3, String totBsa, String rlaneCd, String sprtGrpCd, String bsaGrpCd, String ctrtRhqCd, String bseMon, String trdCd) {
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[]
	 */
	public SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[]
	 */
	public SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO();
				if (grpSeq2[i] != null)
		...
		return getSearchMonthlyQuotaAdjustmentTradeRhqModifyListVOs();
	}
	 ...
	 * @return SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[]
	 */
	public SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[] getSearchMonthlyQuotaAdjustmentTradeRhqModifyListVOs(){
		SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[] vos = (SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[])models.toArray(new SearchMonthlyQuotaAdjustmentTradeRhqModifyListVO[models.size()]);
		return vos;
	}
