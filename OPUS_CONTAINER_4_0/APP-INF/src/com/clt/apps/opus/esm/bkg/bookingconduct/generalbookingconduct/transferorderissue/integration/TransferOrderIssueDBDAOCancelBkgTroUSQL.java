...
*@FileName : TransferOrderIssueDBDAOCancelBkgTroUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOCancelBkgTroUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TransferOrderIssueDB::CancelBkgTro
	  * </pre>
	  */
	public TransferOrderIssueDBDAOCancelBkgTroUSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAOCancelBkgTroUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
