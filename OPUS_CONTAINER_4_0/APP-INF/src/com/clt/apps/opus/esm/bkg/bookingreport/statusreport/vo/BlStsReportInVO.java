...
public class BlStsReportInVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBkgBlCd(JSPUtil.getParameter(request, "bkg_bl_cd", ""));
		setBlStsCd(JSPUtil.getParameter(request, "bl_sts_cd", ""));
		setCustNm(JSPUtil.getParameter(request, "cust_nm", ""));
		setBlTypeOri(JSPUtil.getParameter(request, "bl_type_ori", ""));
		setBkgBlNo(JSPUtil.getParameter(request, "bkg_bl_no", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setBlTypeWay(JSPUtil.getParameter(request, "bl_type_way", ""));
		...
		setByCd(JSPUtil.getParameter(request, "by_cd", ""));
		...
		setBlOfcCd(JSPUtil.getParameter(request, "bl_ofc_cd", ""));
		setStaffId(JSPUtil.getParameter(request, "staff_id", ""));
		setSalOfcCd(JSPUtil.getParameter(request, "sal_ofc_cd", ""));
		setDelCd(JSPUtil.getParameter(request, "del_cd", ""));
		setScRfaCd(JSPUtil.getParameter(request, "sc_rfa_cd", ""));
		setDuraOpt(JSPUtil.getParameter(request, "dura_opt", ""));
		setCustSeq(JSPUtil.getParameter(request, "cust_seq", ""));
		setOblRcvOfcCd(JSPUtil.getParameter(request, "obl_rcv_ofc_cd", ""));
		setOblOfcCd(JSPUtil.getParameter(request, "obl_ofc_cd", ""));
