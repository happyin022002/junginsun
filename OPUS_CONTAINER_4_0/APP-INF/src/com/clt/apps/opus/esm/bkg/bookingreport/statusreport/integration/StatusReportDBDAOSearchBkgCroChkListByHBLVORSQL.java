...
public class StatusReportDBDAOSearchBkgCroChkListByHBLVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("              ,CASE WHEN NVL(HBL.PCK_QTY,0) = NVL(CM_HBL.CM_PCK_HBL,0)  THEN  'Y'" ).append("\n"); 
		...
		query.append("                " ).append("\n"); 
		query.append("              ,CASE WHEN NVL(HBL.HBL_WGT,0)  = NVL(CM_HBL.CM_WGT_HBL,0)  THEN  'Y'" ).append("\n"); 
		...
		query.append("                            " ).append("\n"); 
		query.append("              ,CASE WHEN NVL(HBL.CMDT_MEAS_QTY,0) = NVL(CM_HBL.CM_MEAS_HBL,0)  THEN  'Y'" ).append("\n"); 
