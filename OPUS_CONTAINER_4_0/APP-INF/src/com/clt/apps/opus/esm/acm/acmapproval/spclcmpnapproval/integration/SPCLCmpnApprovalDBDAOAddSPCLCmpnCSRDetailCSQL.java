...
*@FileName : SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRDetailCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRDetailCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddSPCLCmpnCSRDetail
	  * </pre>
	  */
	public SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRDetailCSQL(){
		setQuery();
		...
		query.append("FileName : SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRDetailCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("       (CSR_NO, LINE_SEQ, LINE_NO, LINE_TP_LU_CD, INV_AMT, INV_DESC, INV_TAX_CD, " ).append("\n");
		query.append("        DTRB_COA_CO_CD, DTRB_COA_RGN_CD, DTRB_COA_CTR_CD, DTRB_COA_ACCT_CD, " ).append("\n");
		...
		query.append("        BKG_NO, CNTR_TPSZ_CD, ACT_VVD_CD, PLN_SCTR_DIV_CD, " ).append("\n");
		query.append("        SO_CRR_CD, YD_CD, FTU_USE_CTNT1, FTU_USE_CTNT2, FTU_USE_CTNT3, " ).append("\n");
		query.append("        FTU_USE_CTNT4, FTU_USE_CTNT5, CRE_DT, CRE_USR_ID, EAI_EVNT_DT) " ).append("\n");
		query.append("VALUES(@[csr_no], @[line_seq], @[line_no], @[line_tp_lu_cd], @[inv_amt], @[inv_desc], @[inv_tax_cd]" ).append("\n");
		query.append("        ,@[dtrb_coa_co_cd], @[dtrb_coa_rgn_cd], @[dtrb_coa_ctr_cd], @[dtrb_coa_acct_cd]" ).append("\n");
		query.append("        ,@[dtrb_coa_vvd_cd], @[dtrb_coa_inter_co_cd], @[dtrb_coa_ftu_n1st_cd], @[dtrb_coa_ftu_n2nd_cd]" ).append("\n");
		query.append("        ,@[attr_cate_nm], @[attr_ctnt1], @[attr_ctnt2], @[attr_ctnt3], @[attr_ctnt4], @[attr_ctnt5]" ).append("\n");
		query.append("        ,@[attr_ctnt6], @[attr_ctnt7], @[attr_ctnt8], @[attr_ctnt9], @[attr_ctnt10]" ).append("\n");
		...
		query.append("        ,@[bkg_no], @[cntr_tpsz_cd], @[act_vvd_cd], @[pln_sctr_div_cd]" ).append("\n");
		query.append("        ,@[so_crr_cd], @[yd_cd], @[ftu_use_ctnt1], @[ftu_use_ctnt2], @[ftu_use_ctnt3]" ).append("\n");
		query.append("        ,@[ftu_use_ctnt4], @[ftu_use_ctnt5], SYSDATE, @[cre_usr_id], SYSDATE)" ).append("\n");
