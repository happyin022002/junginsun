...
*@FileName : ESM_FMS_0086HTMLAction.java
...
public class ESM_FMS_0086HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0086HTMLAction 객체를 생성
	 */
	public ESM_FMS_0086HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0086Event event = new EsmFms0086Event();
