...
*@FileName : ESM_BKG_0443HTMLAction.java
...
public class ESM_BKG_0443HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0440HTMLAction 객체를 생성 
	 */
	public ESM_BKG_0443HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0443Event event = new EsmBkg0443Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setFrmCrnNumber(request.getParameter("frm_vsl_call_ref_no"));
			event.setRocsManifestListCondVO((RocsManifestListCondVO)manifestListCondVO);
		} else if(command.isCommand(FormCommand.MULTI)) { 
			event.setRocscrnVO((RocscrnVO) getVO(request, RocscrnVO.class));
