...
*@FileName : UI_PRI_0001_005HTMLAction.java
...
public class ESM_PRI_0001_05HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_PRI_0001_05HTMLAction 객체를 생성
	 */
	public ESM_PRI_0001_05HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri000105Event event = new EsmPri000105Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriSgGohChgVOS((PriSgGohChgVO[])getVOs(request, PriSgGohChgVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setPriSgGohChgVO((PriSgGohChgVO)getVO(request, PriSgGohChgVO .class));
		}else{
