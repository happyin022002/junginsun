...
*@FileName : DgSendDtlHistoryVO.java
*@FileTitle : DgSendDtlHistoryVO
*Open Issues :
*Change history :
...
public class DgSendDtlHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<DgSendDtlHistoryVO> models = new ArrayList<DgSendDtlHistoryVO>();
	...
	public DgSendDtlHistoryVO() {}

	public DgSendDtlHistoryVO(String ibflag, String pagerows, String eurEdiMsgTpId, String msgSndNo, String ediRspnSeq, String blNo, String cntrNo, String cntrCgoSeq, String dgBlRefNo, String dgItmRefNo, String creUsrId, String creDt, String updUsrId, String updDt, String keyVal) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDgBlRefNo(JSPUtil.getParameter(request, "dg_bl_ref_no", ""));
		setEdiRspnSeq(JSPUtil.getParameter(request, "edi_rspn_seq", ""));
		...
		setMsgSndNo(JSPUtil.getParameter(request, "msg_snd_no", ""));
		setDgItmRefNo(JSPUtil.getParameter(request, "dg_itm_ref_no", ""));
	 ...
	 * @param request
	 * @return DgSendDtlHistoryVO[]
	 */
	public DgSendDtlHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DgSendDtlHistoryVO[]
	 */
	public DgSendDtlHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DgSendDtlHistoryVO model = null;
	 ...
	 * @return DgSendDtlHistoryVO[]
	 */
	public DgSendDtlHistoryVO[] getDgSendDtlHistoryVOs(){
		DgSendDtlHistoryVO[] vos = (DgSendDtlHistoryVO[])models.toArray(new DgSendDtlHistoryVO[models.size()]);
		return vos;
	}
