...
public class UserSetupMgtDBDAOManageUserPrintSetup2USQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("INSERT ( USR_ID,    BL_PRN_TP_CD,    BL_PRN_CHG_TP_CD,    BL_PRN_CNTR_TP_CD,    BL_FACE_PRN_KNT,    BL_RIDR_PRN_KNT,    BL_FACE_PRN_DVC_NM,    BL_RIDR_PRN_DVC_NM,    CRE_USR_ID, CRE_DT,   UPD_USR_ID, UPD_DT )" ).append("\n"); 
		query.append("VALUES ( TB.USR_ID, TB.BL_PRN_TP_CD, TB.BL_PRN_CHG_TP_CD, TB.BL_PRN_CNTR_TP_CD, TB.BL_FACE_PRN_KNT, TB.BL_RIDR_PRN_KNT, TB.BL_FACE_PRN_DVC_NM, TB.BL_RIDR_PRN_DVC_NM, TB.USR_ID,     SYSDATE,  TB.USR_ID,  SYSDATE)" ).append("\n"); 
