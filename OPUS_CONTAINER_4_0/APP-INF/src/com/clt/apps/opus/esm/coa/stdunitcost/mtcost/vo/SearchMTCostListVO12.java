...
*@FileName : SearchMTCostListVO12.java
*@FileTitle : SearchMTCostListVO12
*Open Issues :
*Change history :
...
* 2010.02.16 임옥영 품질검토 결과 반영 Line No. 85 :  : shall be matched with size of parameter
=========================================================*/
...
public class SearchMTCostListVO12 extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCostListVO12> models = new ArrayList<SearchMTCostListVO12>();
	...
	/**
	 * SearchMTCostListVO12 생성자
	 */
	public SearchMTCostListVO12() {}
	 ...
	 */
	public SearchMTCostListVO12(String ibflag, String pagerows, String costYrmon, String fcntrEccCd, String cntrTpszCd, String eqStatus, String cntrImbalRto, String cntrImbalQty, String cntrIbQty, String cntrObQty) {
	 ...
	 */
	public SearchMTCostListVO12[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCostListVO12[]
	 */
	public SearchMTCostListVO12[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCostListVO12 model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMTCostListVO12();
		...
		return getSearchMTCostListVO12s();
	}
	 ...
	 * @return SearchMTCostListVO12[]
	 */
	public SearchMTCostListVO12[] getSearchMTCostListVO12s(){
		SearchMTCostListVO12[] vos = (SearchMTCostListVO12[])models.toArray(new SearchMTCostListVO12[models.size()]);
		return vos;
	}
