...
public class FFCmpnApprovalMasterVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("f_ap_ofc_cd", getFApOfcCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("f_ap_ofc_cd", "fApOfcCd");
	 ...
	 * @return fApOfcCd
	 */
	public String getFApOfcCd() {
		return this.fApOfcCd;
	}
	 ...
	 * @param fApOfcCd
	 */
	public void setFApOfcCd(String fApOfcCd) {
		this.fApOfcCd = fApOfcCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFApOfcCd(JSPUtil.getParameter(request, prefix + "f_ap_ofc_cd", ""));
	...
	public FFCmpnApprovalMasterVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] fApOfcCd = (JSPUtil.getParameter(request, prefix	+ "f_ap_ofc_cd", length));
	...
	*/
	public void unDataFormat(){
		...
		this.fApOfcCd = this.fApOfcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
