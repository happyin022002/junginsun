...
*@FileName : ESM_FMS_0078HTMLAction.java
 ...
 * @author JUNGYOONTAE
 * @see EsmFms0078Event 참조
 * @since J2EE 1.6
 */

public class ESM_FMS_0078HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0078HTMLAction 객체를 생성
	 */
	public ESM_FMS_0078HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0078Event event = new EsmFms0078Event();
