...
*@FileName : TaiwanSearchContainerVO.java
*@FileTitle : TaiwanSearchContainerVO
*Open Issues :
*Change history :
...
public class TaiwanSearchContainerVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TaiwanSearchContainerVO> models = new ArrayList<TaiwanSearchContainerVO>();
	...
	public TaiwanSearchContainerVO() {}
	 ...
	 * @param request
	 * @return TaiwanSearchContainerVO[]
	 */
	public TaiwanSearchContainerVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TaiwanSearchContainerVO[]
	 */
	public TaiwanSearchContainerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TaiwanSearchContainerVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TaiwanSearchContainerVO();
				if (ovrw[i] != null)
		...
		return getTaiwanSearchContainerVOs();
	}
	 ...
	 * @return TaiwanSearchContainerVO[]
	 */
	public TaiwanSearchContainerVO[] getTaiwanSearchContainerVOs(){
		TaiwanSearchContainerVO[] vos = (TaiwanSearchContainerVO[])models.toArray(new TaiwanSearchContainerVO[models.size()]);
		return vos;
	}
