...
*@FileName : CommonDBDAOSearchMonthlyQtaStatusInquiryTradeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchMonthlyQtaStatusInquiryTradeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchMonthlyQtaStatusInquiryTradeListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchMonthlyQtaStatusInquiryTradeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    SELECT 				" ).append("\n"); 
		query.append("	DISTINCT TRD_CD AS CODE,	" ).append("\n"); 
