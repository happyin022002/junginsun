...
*@FileName : KoreaCustomsReportDBDAOmodifyDiscCYCodeListUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOmodifyDiscCYCodeListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOmodifyDiscCYCodeListUSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOmodifyDiscCYCodeListUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_DCHG_LOC" ).append("\n");
		query.append("SET LOC_NM = @[loc_nm]" ).append("\n");
		query.append(", YD_CD = @[yd_cd]" ).append("\n");
		query.append(", EDO_TRSM_FLG = @[edo_trsm_flg]" ).append("\n");
