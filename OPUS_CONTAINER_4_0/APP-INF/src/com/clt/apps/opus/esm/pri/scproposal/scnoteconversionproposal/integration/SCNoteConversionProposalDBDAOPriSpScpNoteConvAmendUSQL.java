...
*@FileName : SCNoteConversionProposalDBDAOPriSpScpNoteConvAmendUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAOPriSpScpNoteConvAmendUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * amend시 conversion 날짜를 수정
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAOPriSpScpNoteConvAmendUSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteConversionProposalDBDAOPriSpScpNoteConvAmendUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   EFF_DT					= CASE WHEN EFF_DT > TO_DATE(@[eff_dt], 'YYYYMMDD') THEN EFF_DT ELSE TO_DATE(@[eff_dt], 'YYYYMMDD') END" ).append("\n"); 
		query.append("	 , EXP_DT					= CASE WHEN EXP_DT < TO_DATE(@[exp_dt], 'YYYYMMDD') THEN EXP_DT ELSE TO_DATE(@[exp_dt], 'YYYYMMDD') END" ).append("\n"); 
