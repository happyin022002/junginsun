...
public class PickUpNoticeDBDAOaddPkupNtcCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC, TO_DATE(@[exp_snd_dt],'YYYY-MM-DD HH24:MI:SS'), 'GMT')" ).append("\n"); 
		...
		query.append("AND A.OFC_CD = C.EQ_CTRL_OFC_CD" ).append("\n"); 
