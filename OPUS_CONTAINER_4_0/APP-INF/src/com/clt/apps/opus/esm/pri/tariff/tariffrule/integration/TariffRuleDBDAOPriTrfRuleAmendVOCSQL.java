...
*@FileName : TariffRuleDBDAOPriTrfRuleAmendVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffRuleDBDAOPriTrfRuleAmendVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff Rule Amend Insert
	  * </pre>
	  */
	public TariffRuleDBDAOPriTrfRuleAmendVOCSQL(){
		setQuery();
		...
		query.append("FileName : TariffRuleDBDAOPriTrfRuleAmendVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
