...
*@FileName : MonthlyQuotaCreationDBDAOUpdateConfirmUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCreationDBDAOUpdateConfirmUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaCreationDBDAOUpdateConfirmUSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCreationDBDAOUpdateConfirmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SET FCAST_TRNS_STS_CD = 'C' " ).append("\n"); 
