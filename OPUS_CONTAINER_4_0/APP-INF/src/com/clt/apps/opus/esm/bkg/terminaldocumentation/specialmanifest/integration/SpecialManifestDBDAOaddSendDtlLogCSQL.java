...
*@FileName : SpecialManifestDBDAOaddSendDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOaddSendDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOaddSendDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOaddSendDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_DG_EDI_RSPN (" ).append("\n");
