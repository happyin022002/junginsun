...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnCtrtRefCopyVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnCtrtRefCopyVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agt_Agn_Ctrt_Ref 테이블에 copy
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnCtrtRefCopyVOCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnCtrtRefCopyVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO AGT_AGN_CTRT_REF" ).append("\n"); 
		query.append("(" ).append("\n"); 
