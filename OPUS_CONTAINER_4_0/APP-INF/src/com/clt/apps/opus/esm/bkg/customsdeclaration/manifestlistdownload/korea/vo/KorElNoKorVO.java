...
public class KorElNoKorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorElNoKorVO> models = new ArrayList<KorElNoKorVO>();
	...
	public KorElNoKorVO(String ibflag, String pagerows, String bkgNo, String bkgNoSplit, String ktPort) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @return CreatorVO[]
	 */
	public KorElNoKorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreatorVO[]
	 */
	public KorElNoKorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorElNoKorVO model = null;
	 ...
	 * @return CreatorVO[]
	 */
	public KorElNoKorVO[] getCreatorVOs(){
		KorElNoKorVO[] vos = (KorElNoKorVO[])models.toArray(new KorElNoKorVO[models.size()]);
		return vos;
	}
