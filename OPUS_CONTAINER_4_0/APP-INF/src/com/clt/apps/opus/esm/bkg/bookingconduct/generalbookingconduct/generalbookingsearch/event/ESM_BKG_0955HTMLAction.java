...
public class ESM_BKG_0955HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		event.setSheetIdx(JSPUtil.getNullNoTrim(JSPUtil.getParameter(request, "sheet_idx".trim(), "")));
		event.setSheetRow(JSPUtil.getNullNoTrim(JSPUtil.getParameter(request, "sheet_row".trim(), "")));
