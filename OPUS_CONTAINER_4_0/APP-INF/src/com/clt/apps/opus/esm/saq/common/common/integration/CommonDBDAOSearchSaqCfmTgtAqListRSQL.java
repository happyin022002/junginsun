...
*@FileName : CommonDBDAOSearchSaqCfmTgtAqListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqCfmTgtAqListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAQ_MON_CFM_TGT_VVD의 Aq List 조회
	  * </pre>
	  */
	public CommonDBDAOSearchSaqCfmTgtAqListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchSaqCfmTgtAqListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("  SELECT DISTINCT AQ_CD AS TEXT,  " ).append("\n"); 
		query.append("                  AQ_CD AS CODE   " ).append("\n"); 
		...
		query.append("ORDER BY AQ_CD   " ).append("\n"); 
