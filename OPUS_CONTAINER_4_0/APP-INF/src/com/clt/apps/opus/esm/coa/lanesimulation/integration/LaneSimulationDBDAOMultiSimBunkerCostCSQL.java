...
*@FileName : LaneSimulationDBDAOMultiSimBunkerCostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimBunkerCostCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimBunkerCostCSQL(){
		setQuery();
		...
		params.put("foil_port_csm",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimBunkerCostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO COA_SIM_BNK_COST(" ).append("\n"); 
		...
		query.append(",FOIL_SAIL_CSM" ).append("\n"); 
		query.append(",FOIL_PORT_CSM" ).append("\n"); 
