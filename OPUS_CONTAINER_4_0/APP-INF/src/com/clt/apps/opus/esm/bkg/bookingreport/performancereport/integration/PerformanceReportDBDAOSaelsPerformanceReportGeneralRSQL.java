...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportGeneralRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportGeneralRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportGeneralRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportGeneralRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  TRIM(TO_CHAR(NVL(SUM(TEU) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(FEU) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_FEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(TTL) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_TTL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(VOID_TEU) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_VOID_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(VOID_FEU) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_VOID_FEU" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(GROSS) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_GROSS" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(NET) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(NON_NET) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_NON_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(MISC) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_MISC" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(NON_REV) OVER( PARTITION BY VVD),0) ,'999,999,999,990.99')) AS SUB_TOT_NON_REV" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* TOTAL */" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(TEU) OVER(),0) ,'999,999,999,990.99')) AS TOT_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(FEU) OVER(),0) ,'999,999,999,990.99')) AS TOT_FEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(TTL) OVER(),0) ,'999,999,999,990.99')) AS TOT_TTL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(VOID_TEU) OVER(),0) ,'999,999,999,990.99')) AS TOT_VOID_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(VOID_FEU) OVER(),0) ,'999,999,999,990.99')) AS TOT_VOID_FEU" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(GROSS) OVER(),0) ,'999,999,999,990.99')) AS TOT_GROSS" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(NET) OVER(),0) ,'999,999,999,990.99')) AS TOT_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(NON_NET) OVER(),0) ,'999,999,999,990.99')) AS TOT_NON_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(MISC) OVER(),0) ,'999,999,999,990.99')) AS TOT_MISC" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(NVL(SUM(NON_REV) OVER(),0) ,'999,999,999,990.99')) AS TOT_NON_REV" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("--,  Y.*" ).append("\n"); 
		query.append(", Y.VVD" ).append("\n"); 
		query.append(", Y.BKG_POD" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.TEU ,'999,999,999,990.99')) AS TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.FEU ,'999,999,999,990.99')) AS FEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.TTL ,'999,999,999,990.99')) AS TTL" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.VOID_TEU ,'999,999,999,990.99')) AS VOID_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.VOID_FEU ,'999,999,999,990.99')) AS VOID_FEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.NET,'999,999,999,990.99')) AS NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.NON_NET,'999,999,999,990.99')) AS NON_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.MISC,'999,999,999,990.99')) AS MISC" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.NON_REV,'999,999,999,990.99')) AS NON_REV" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(Y.GROSS,'999,999,999,990.99')) AS GROSS" ).append("\n"); 
		query.append(", Y.REP_KND" ).append("\n"); 
		query.append(", Y.GRP_BY" ).append("\n"); 
		...
		query.append("      ,TRIM(TO_CHAR((SALE.GROSS / TTL ) ,'999,999,999,990.99'))    AS TEU_GROSS" ).append("\n"); 
		query.append("      ,TRIM(TO_CHAR((SALE.GROSS / TTL*2 ) ,'999,999,999,990.99'))  AS FEU_GROSS" ).append("\n"); 
		query.append("      FROM" ).append("\n"); 
		query.append("      (" ).append("\n"); 
		query.append("SELECT BKG.VVD" ).append("\n"); 
		query.append("      ,BKG.BKG_POD" ).append("\n"); 
		...
		query.append(") Y" ).append("\n"); 
		query.append("ORDER BY VVD, BKG_POD" ).append("\n"); 
