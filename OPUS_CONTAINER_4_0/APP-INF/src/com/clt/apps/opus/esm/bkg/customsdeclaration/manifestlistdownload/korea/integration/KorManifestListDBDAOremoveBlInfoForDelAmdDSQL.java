...
*@FileName : KorManifestListDBDAOremoveBlInfoForDelAmdDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOremoveBlInfoForDelAmdDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOremoveBlInfoForDelAmdDSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOremoveBlInfoForDelAmdDSQL").append("\n");
		query.append("*/").append("\n");
	}
