...
*@FileName : KorMsnNoCondVO.java
*@FileTitle : KorMsnNoCondVO
*Open Issues :
*Change history :
...
public class KorMsnNoCondVO extends MsnNoCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<KorMsnNoCondVO> models = new ArrayList<KorMsnNoCondVO>();
	...
	public KorMsnNoCondVO() {}

	public KorMsnNoCondVO(String ibflag, String pagerows, String msnStartNum, String inVvd, String inPod, String tp, String fe, String blNo, String bkgNo, String hidden3, String pod, String msn) {
		this.inVvd = inVvd;
		this.inPod = inPod;
		this.bkgNo = bkgNo;
...
/**
	 ...
	 * @param request
	 * @return KorMsnNoCondVO[]
	 */
	public KorMsnNoCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMsnNoCondVO[]
	 */
	public KorMsnNoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMsnNoCondVO model = null;
	...
	public KorMsnNoCondVO[] getKorMsnNoCondVOs(){
		KorMsnNoCondVO[] vos = (KorMsnNoCondVO[])models.toArray(new KorMsnNoCondVO[models.size()]);
		return vos;
	}
