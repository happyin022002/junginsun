...
*@FileName : BSAManageDBDAORemoveBSATableJO4DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveBSATableJO4DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAORemoveBSATableJO4DSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveBSATableJO4DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_JNT_OP_BZC" ).append("\n"); 
