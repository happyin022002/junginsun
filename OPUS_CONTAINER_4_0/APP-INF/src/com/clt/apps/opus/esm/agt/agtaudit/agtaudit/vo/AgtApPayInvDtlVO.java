...
*@FileName : AgtApPayInvDtlVO.java
*@FileTitle : AgtApPayInvDtlVO
*Open Issues :
*Change history :
...
public class AgtApPayInvDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AgtApPayInvDtlVO> models = new ArrayList<AgtApPayInvDtlVO>();
	...
	public AgtApPayInvDtlVO() {}

	public AgtApPayInvDtlVO(String ibflag, String pagerows, String acctCd, String vslCd, String skdVoyCd, String skdDirCd, String revDirCd, String actVvdCd, String ydCd, String cntrTpszCd, String invAmt, String so20ftQty, String so40ftQty, String creUsrId, String creDt, String updUsrId, String updDt, String invDesc) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
...
/**
	 ...
	 * @param request
	 * @return AgtApPayInvDtlVO[]
	 */
	public AgtApPayInvDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AgtApPayInvDtlVO[]
	 */
	public AgtApPayInvDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AgtApPayInvDtlVO model = null;
	 ...
	 * @return AgtApPayInvDtlVO[]
	 */
	public AgtApPayInvDtlVO[] getAgtApPayInvDtlVOs(){
		AgtApPayInvDtlVO[] vos = (AgtApPayInvDtlVO[])models.toArray(new AgtApPayInvDtlVO[models.size()]);
		return vos;
	}
