...
*@FileName : SearchApVatSlipListVO.java
*@FileTitle : SearchApVatSlipListVO
*Open Issues :
*Change history :
...
public class SearchApVatSlipListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchApVatSlipListVO> models = new ArrayList<SearchApVatSlipListVO>();
	...
	public SearchApVatSlipListVO() {}

	public SearchApVatSlipListVO(String ibflag, String pagerows, String slpTpCd, String slpFuncCd, String slpOfcCd, String slpIssDt, String slpSerNo) {
	 ...
	 */
	public SearchApVatSlipListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchApVatSlipListVO[]
	 */
	public SearchApVatSlipListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchApVatSlipListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchApVatSlipListVO();
				if (slpFuncCd[i] != null)
		...
		return getSearchApVatSlipListVOs();
	}
	 ...
	 * @return SearchApVatSlipListVO[]
	 */
	public SearchApVatSlipListVO[] getSearchApVatSlipListVOs(){
		SearchApVatSlipListVO[] vos = (SearchApVatSlipListVO[])models.toArray(new SearchApVatSlipListVO[models.size()]);
		return vos;
	}
