...
*@FileName : KorEmpImfmodVO.java
*@FileTitle : KorEmpImfmodVO
*Open Issues :
*Change history :
...
public class KorEmpImfmodVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorEmpImfmodVO> models = new ArrayList<KorEmpImfmodVO>();
	...
	public KorEmpImfmodVO() {}

	public KorEmpImfmodVO(String ibflag, String pagerows, String flatData, String blNo, String polCd, String subNo, String usrNm, String cstmsBlNo, String trnsSeq, String dmstPortCd, String bkgNo, String cstmsDeclTpCd) {
		this.bkgNo = bkgNo;
...
/**
	 ...
	 */
	public KorEmpImfmodVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorEmpImfmodVO[]
	 */
	public KorEmpImfmodVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorEmpImfmodVO model = null;
	 ...
	 * @return KorEmpImfmodVO[]
	 */
	public KorEmpImfmodVO[] getKorEmpImfmodVOs(){
		KorEmpImfmodVO[] vos = (KorEmpImfmodVO[])models.toArray(new KorEmpImfmodVO[models.size()]);
		return vos;
	}
