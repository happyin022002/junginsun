...
*@FileName : ESM_BKG_0709HTMLAction.java
*@FileTitle : DG Split
*Open Issues :
*Change history :
...
public class ESM_BKG_0709HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0709HTMLAction 객체를 생성
	 */
	public ESM_BKG_0709HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0709Event event = new EsmBkg0709Event();
