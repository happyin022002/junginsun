...
*@FileName : PriRpAfilVO.java
*@FileTitle : PriRpAfilVO
*Open Issues :
*Change history :
...
public class PriRpAfilVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpAfilVO> models = new ArrayList<PriRpAfilVO>();
	 ...
	 * @return PriRpAfilVO[]
	 */
	public PriRpAfilVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpAfilVO[]
	 */
	public PriRpAfilVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpAfilVO model = null;
	...
	public PriRpAfilVO[] getPriRpAfilVOs(){
		PriRpAfilVO[] vos = (PriRpAfilVO[])models.toArray(new PriRpAfilVO[models.size()]);
		return vos;
	}
