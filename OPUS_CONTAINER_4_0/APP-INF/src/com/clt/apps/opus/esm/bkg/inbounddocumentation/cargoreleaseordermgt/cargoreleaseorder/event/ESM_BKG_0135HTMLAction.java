...
*@FileName : ESM_BKG_0135HTMLAction.java
...
public class ESM_BKG_0135HTMLAction extends HTMLActionSupport {
     ...
     */
    public ESM_BKG_0135HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg0135Event로 파싱하여 request에 셋팅<br>
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0135Event event = new EsmBkg0135Event();

        String rqstNo      = "";
        String tpCd        = "";

        log.debug("===================================");
        log.debug("    ESM_BKG_0135HTMLAction Start   " + request.getParameter("frm_edo_rqst_no"));
        log.debug("===================================");
