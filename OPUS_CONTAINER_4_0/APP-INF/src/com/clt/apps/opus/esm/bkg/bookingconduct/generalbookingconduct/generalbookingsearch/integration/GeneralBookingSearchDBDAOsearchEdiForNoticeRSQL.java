...
public class GeneralBookingSearchDBDAOsearchEdiForNoticeRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           AND INTG_CD_VAL_CTNT IN ('BK','BL','BT','CN','FC','IM')--,'EX'" ).append("\n"); 
		...
		query.append("                     , 'UN' AS REF_TP_CD" ).append("\n"); 
		query.append("                     , REF_CODE AS REF_CODE" ).append("\n"); 
		query.append("                     , EDI_ID.EDI_RECEIVE_ID" ).append("\n"); 
		query.append("                     , EDI_ID.GROUP_EDI_ID AS GROUP_EDI_ID" ).append("\n"); 
		query.append("                     , '' GROUP_NM" ).append("\n"); 
		query.append("                     , NTC.SND_USR_ID AS SENDER" ).append("\n"); 
		query.append("                     , (SELECT USR.USR_NM FROM COM_USER USR WHERE USR.USR_ID = NTC.SND_USR_ID) AS SENDER_NM" ).append("\n"); 
		query.append("                     , TO_CHAR(NTC.SND_RQST_DT, 'YYYY-MM-DD HH24:MI') AS SEND_DT" ).append("\n"); 
		query.append("                     , NTC.BKG_NTC_SND_RSLT_CD AS BKG_NTC_SND_RSLT_CD" ).append("\n"); 
		...
		query.append("                                                                              AND MST.XTER_RQST_VIA_CD <> 'WEB')) EDI_ID" ).append("\n"); 
		query.append("                       , BKG_NTC_HIS NTC" ).append("\n"); 
		query.append("                   WHERE EDI_ID.EDI_RECEIVE_ID = NTC.EDI_ID(+)" ).append("\n"); 
		query.append("                   AND 'E'  = NTC.NTC_VIA_CD(+)" ).append("\n"); 
		query.append("                   AND 'BK' = NTC.NTC_KND_CD(+)" ).append("\n"); 
		query.append("                   AND EDI_ID.BKG_NO  = NTC.BKG_NO(+)" ).append("\n"); 
		query.append("                   AND GROUP_EDI_ID = NTC.ESVC_GRP_CD(+)" ).append("\n"); 
		query.append("                   AND NVL(NTC.HIS_SEQ,1) =" ).append("\n"); 
		query.append("                       NVL2(NTC.HIS_SEQ,(SELECT MAX(HIS_SEQ)" ).append("\n"); 
		query.append("                                           FROM BKG_NTC_HIS" ).append("\n"); 
		...
		query.append("                 )" ).append("\n"); 
		query.append("           UNION " ).append("\n"); 
		query.append("           SELECT 'BK' NTC_KND_CD" ).append("\n"); 
		query.append("             ,'' REF_TP_CD" ).append("\n"); 
		query.append("             ,'' REF_CODE" ).append("\n"); 
		query.append("             ,EDI_RECEIVE_ID AS EDI_RECEIVE_ID" ).append("\n"); 
		query.append("             ,'' GROUP_EDI_ID" ).append("\n"); 
		query.append("             ,'' GROUP_NM" ).append("\n"); 
		query.append("             , NTC.SND_USR_ID AS SENDER" ).append("\n"); 
		query.append("             , (SELECT USR.USR_NM FROM COM_USER USR WHERE USR.USR_ID = NTC.SND_USR_ID) AS SENDER_NM" ).append("\n"); 
		...
		query.append("                                                     )" ).append("\n"); 
		query.append("                                              )MST, BKG_NTC_HIS NTC" ).append("\n"); 
		query.append("           " ).append("\n"); 
		...
		query.append("/* --deleting becuase export function is out of scope. 2015-08-10 by Hayley Burch" ).append("\n"); 
		query.append("         UNION" ).append("\n"); 
		query.append("        SELECT NTC_KND_CD" ).append("\n"); 
		query.append("             , REF_TP_CD" ).append("\n"); 
		query.append("             , REF_CODE" ).append("\n"); 
		...
		query.append("                          FROM BKG_NTC_HIS NTC, BKG_BOOKING BK" ).append("\n"); 
		...
		query.append("                           AND BK.POL_NOD_CD LIKE SUBSTR(EDI_YD.PRNR_SUB_LNK_CD, 1, 5)||'%'" ).append("\n"); 
		query.append("                           AND EDI_YD.PRNR_SUB_LNK_CD IS NOT NULL" ).append("\n"); 
		...
		query.append("                           AND EDI_YD.PRNR_SUB_LNK_DIV_CD = '1'--Yard" ).append("\n"); 
		query.append("                           AND NVL(NTC.HIS_SEQ,1) =" ).append("\n"); 
		query.append("                               NVL2(NTC.HIS_SEQ,(SELECT MAX(HIS_SEQ)" ).append("\n"); 
		query.append("                                                   FROM BKG_NTC_HIS" ).append("\n"); 
		query.append("                                                  WHERE BKG_NO     = NTC.BKG_NO" ).append("\n"); 
