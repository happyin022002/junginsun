...
*@FileName : ESM_BKG_066806HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_066806HTMLAction extends HTMLActionSupport {
     ...
     */
    public ESM_BKG_066806HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg066806Event event = new EsmBkg066806Event();
        ...
        log.debug("===================================");
        log.debug("    ESM_BKG_066806HTMLAction Start   ");
        log.debug("===================================");
