...
public class IndiaCustomsTransmissionDBDAOsearchBlListByVvdPolPodRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        ,DECODE(BCIB.BL_NO, BCIB.NVOCC_REF_NO, COM_ConstantMgr_PKG.COM_getScacCode_FNC()||BCIB.BL_NO, BCIB.NVOCC_REF_NO) NEW_BL_NO" ).append("\n");
		...
		query.append("        ,REPLACE( REPLACE( REPLACE(DECODE(BCIB.BL_NO, BCIB.NVOCC_REF_NO, DECODE(NVL(BB.CUST_TO_ORD_FLG,'N'), 'Y', SUBSTR(BC1.CUST_NM, 1, 35), SUBSTR(BC.CUST_NM, 1, 35)), C_BHC.CUST_NM ), CHR(10), ''), CHR(13), ''), CHR(10), '') C_CUST_NM" ).append("\n");
		query.append("" ).append("\n");
		query.append("        ,REPLACE( REPLACE(REPLACE(DECODE(BCIB.BL_NO, BCIB.NVOCC_REF_NO, DECODE(NVL(BB.CUST_TO_ORD_FLG,'N'), 'Y', REPLACE(SUBSTR(BC1.CUST_ADDR, 1, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(BC1.CUST_ADDR, 36, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(BC1.CUST_ADDR, 71, 35), CHR(10), '')," ).append("\n");
		query.append("                  REPLACE(SUBSTR(BC.CUST_ADDR, 1, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(BC.CUST_ADDR, 36, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(BC.CUST_ADDR, 71, 35), CHR(10), ''))," ).append("\n");
		query.append("                  REPLACE(SUBSTR(C_BHC.CUST_ADDR, 1, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(C_BHC.CUST_ADDR, 36, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(C_BHC.CUST_ADDR, 71, 35), CHR(10), '')), CHR(10), ''), CHR(13), ''), CHR(10), '') C_CUST_ADDR" ).append("\n");
		query.append("        " ).append("\n");
		query.append("        ,REPLACE( REPLACE( REPLACE(DECODE(BCIB.BL_NO, BCIB.NVOCC_REF_NO, DECODE(NVL(BB.CUST_TO_ORD_FLG,'N'), 'N', SUBSTR(BC1.CUST_NM, 1, 35), ''), N_BHC.CUST_NM ), CHR(10), ''), CHR(13), ''), CHR(10), '') N_CUST_NM" ).append("\n");
		query.append("        " ).append("\n");
		query.append("" ).append("\n");
		query.append("        ,REPLACE(  REPLACE(  REPLACE(DECODE(BCIB.BL_NO, BCIB.NVOCC_REF_NO, DECODE(NVL(BB.CUST_TO_ORD_FLG,'N'), 'N', REPLACE(SUBSTR(BC1.CUST_ADDR, 1, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(BC1.CUST_ADDR, 36, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(BC1.CUST_ADDR, 71, 35), CHR(10), '')," ).append("\n");
		query.append("                  ''||CHR(29)||''||CHR(29)||'')," ).append("\n");
		query.append("                  REPLACE(SUBSTR(N_BHC.CUST_ADDR, 1, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(N_BHC.CUST_ADDR, 36, 35), CHR(10), '')|| CHR(29)|| REPLACE(SUBSTR(N_BHC.CUST_ADDR, 71, 35), CHR(10), '')), CHR(10), ''), CHR(13), ''), CHR(10), '') N_CUST_ADDR" ).append("\n");
		query.append("" ).append("\n");
		...
		query.append("" ).append("\n");
		query.append("        ,DECODE(BCIB.POD_CD,'INMAA',DECODE(BCIB.BL_DECL_TP_CD,BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','2',1),BCIV.IDA_CFS_ID,BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','3',1),BCIB.POD_CD, BCIV.IDA_CFS_ID)," ).append("\n");
		query.append("                   'INNAH',DECODE(BCIB.BL_DECL_TP_CD,BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','2',1),BCIV.IDA_CFS_ID,BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','3',1),'',BCIV.IDA_CFS_ID),BCIV.IDA_CFS_ID) POD_CD_GUBUN" ).append("\n");
		query.append("" ).append("\n");
		...
		query.append("                " ).append("\n");
		query.append("                ,REPLACE(SUBSTR(BBMD.MK_DESC, 1, 300), CHR(10), '') MK_DESC" ).append("\n");
		query.append("" ).append("\n");
		query.append("                ,REPLACE(REPLACE(DECODE(BCIB.BL_NO, BCIB.NVOCC_REF_NO, SUBSTR(BBD.CSTMS_DESC, 1, 250), SUBSTR(BBMD.CMDT_DESC, 1, 250)), CHR(10), ''), CHR(13), '') CMDT_DESC" ).append("\n");
		query.append("" ).append("\n");
		query.append("                ,NVL(DG.IMDG_UN_NO, 'ZZZZZ') IMDG_UN_NO" ).append("\n");
		query.append("        " ).append("\n");
		query.append("                ,NVL(DG.IMDG_CLSS_CD, 'ZZZ') IMDG_CLSS_CD" ).append("\n");
		query.append("" ).append("\n");
		query.append("                ,DECODE(BCIB.POD_CD,'INMAA',BCIV.IBD_NO,'INNAH',DECODE(BCIB.BL_DECL_TP_CD,BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','3',1),BCIV.IBD_NO,''),BCIV.IBD_NO) IBD_NO" ).append("\n");
		query.append("" ).append("\n");
		query.append("                ,DECODE(BCIB.POD_CD,'INMAA','','INNAH',DECODE(BCIB.BL_DECL_TP_CD, BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','3',1),NVL(BCIB.TRNS_OPR_ID,BCIV.TRNS_OPR_ID),BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','4',1),NVL(BCIB.TRNS_OPR_ID,BCIV.TRNS_OPR_ID),''),NVL(BCIB.TRNS_OPR_ID,BCIV.TRNS_OPR_ID)) CRR_AGN_CD" ).append("\n");
		query.append("" ).append("\n");
		query.append("                ,DECODE(BCIB.BL_DECL_TP_CD, BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','3',1), BCIB.IDA_TRSP_CD, '') IDA_TRSP_CD" ).append("\n");
		query.append("" ).append("\n");
		query.append("                ,NVL(BCIV.IDA_MRN_LINE_OPR_ID, '') IDA_MRN_LINE_OPR_CD" ).append("\n");
		query.append("        " ).append("\n");
		query.append("                ,DECODE(BCIB.POD_CD,'INMAA',DECODE(BCIB.BL_DECL_TP_CD,BKG_GET_BKG_CTMS_CD_FNC('IN','ENTRY_TYPE_CD','2',1),BCIB.BD_AREA_CD,'')," ).append("\n");
