...
*@FileName : SCRateProposalDBDAOReorderRouteNoteDpSeqUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOReorderRouteNoteDpSeqUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOReorderRouteNoteDpSeqUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOReorderRouteNoteDpSeqUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                      ,NVL(S.SEQ_GAP, 0) + ROW_NUMBER() OVER(PARTITION BY A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ ORDER BY F.P_CNT, A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ, B.SORT_KEY, E.SORT_KEY, C.SORT_KEY, D.SORT_KEY, G.DIR_CALL_FLG DESC) AS NEW_NOTE_DP_SEQ" ).append("\n"); 
		query.append("                      ,F.P_CNT" ).append("\n"); 
		query.append("                  FROM PRI_SP_SCP_RT_CMDT_ROUT A" ).append("\n"); 
		query.append("                      ,(SELECT PROP_NO, (AMDT_SEQ + 1) AS AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, MAX(NOTE_DP_SEQ) AS SEQ_GAP" ).append("\n"); 
		query.append("                          FROM PRI_SP_SCP_RT_CMDT_ROUT" ).append("\n"); 
		query.append("                          WHERE PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("                           AND AMDT_SEQ = @[amdt_seq] - 1" ).append("\n"); 
		query.append("                           AND SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
		query.append("                         GROUP BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ) S" ).append("\n"); 
		...
		query.append("                        CONNECT BY PRIOR GEN_SPCL_RT_TP_CD = GEN_SPCL_RT_TP_CD" ).append("\n"); 
		query.append("                               AND PRIOR CMDT_HDR_SEQ = CMDT_HDR_SEQ" ).append("\n"); 
		query.append("                               AND PRIOR ROUT_SEQ = ROUT_SEQ" ).append("\n"); 
		query.append("                               AND PRIOR RN = RN - 1" ).append("\n"); 
		query.append("                         GROUP BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD) B" ).append("\n"); 
		query.append("                      ,(SELECT PROP_NO" ).append("\n"); 
		query.append("                              ,AMDT_SEQ" ).append("\n"); 
		query.append("                              ,SVC_SCP_CD" ).append("\n"); 
		query.append("                              ,GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                               AND PRIOR ROUT_SEQ = ROUT_SEQ" ).append("\n"); 
		query.append("                               AND PRIOR RN = RN - 1" ).append("\n"); 
		query.append("                         GROUP BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD) C" ).append("\n"); 
		query.append("                      ,(SELECT PROP_NO" ).append("\n"); 
		query.append("                              ,AMDT_SEQ" ).append("\n"); 
		query.append("                              ,SVC_SCP_CD" ).append("\n"); 
		query.append("                              ,GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                               AND PRIOR ROUT_SEQ = ROUT_SEQ" ).append("\n"); 
		query.append("                               AND PRIOR RN = RN - 1" ).append("\n"); 
		query.append("                         GROUP BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD) D" ).append("\n"); 
		query.append("                      ,(SELECT PROP_NO" ).append("\n"); 
		query.append("                              ,AMDT_SEQ" ).append("\n"); 
		query.append("                              ,SVC_SCP_CD" ).append("\n"); 
		query.append("                              ,GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                               AND PRIOR ROUT_SEQ = ROUT_SEQ" ).append("\n"); 
		query.append("                               AND PRIOR RN = RN - 1" ).append("\n"); 
		query.append("                         GROUP BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD) E" ).append("\n"); 
		query.append("                      ,(SELECT PROP_NO" ).append("\n"); 
		query.append("                              ,AMDT_SEQ" ).append("\n"); 
		query.append("                              ,SVC_SCP_CD" ).append("\n"); 
		query.append("                              ,GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                           AND CMDT_HDR_SEQ = @[cmdt_hdr_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("                         GROUP BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ) F" ).append("\n"); 
		...
		query.append("                   AND A.GEN_SPCL_RT_TP_CD = S.GEN_SPCL_RT_TP_CD(+)" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("               A.PROP_NO = T.PROP_NO(+)" ).append("\n"); 
		...
		query.append("   SET NOTE_DP_SEQ = DECODE(NVL(T.P_CNT, 0), 0, NEW_NOTE_DP_SEQ, NOTE_DP_SEQ)" ).append("\n"); 
