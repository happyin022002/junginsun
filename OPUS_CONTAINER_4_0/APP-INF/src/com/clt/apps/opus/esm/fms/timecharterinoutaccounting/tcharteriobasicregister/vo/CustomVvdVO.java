...
*@FileName : CustomVvdVO.java
*@FileTitle : CustomVvdVO
*Open Issues :
*Change history :
...
public class CustomVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomVvdVO> models = new ArrayList<CustomVvdVO>();
	...
	public CustomVvdVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String revDirCd, String revYrmon, String slanCd, String rlaneCd, String vstDt, String vedDt, String vvdCd, String creUsrId, String updUsrId) {
		this.vslCd = vslCd;
	 ...
	 * @return CustomVvdVO[]
	 */
	public CustomVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomVvdVO[]
	 */
	public CustomVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomVvdVO model = null;
	...
	public CustomVvdVO[] getCustomVvdVOs(){
		CustomVvdVO[] vos = (CustomVvdVO[])models.toArray(new CustomVvdVO[models.size()]);
		return vos;
	}
