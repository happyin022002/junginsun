 ...
 */
public class TmnlRcvIdVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<TmnlRcvIdVO> models = new ArrayList<TmnlRcvIdVO>();
    ...
    public TmnlRcvIdVO(String ibflag, String pagerows, String ediRcvId, String portCd, String ediId, String bracCd, String kind, String ediRefCd, String hostId, String ediSndrId) {
        this.bracCd = bracCd;
        this.ibflag = ibflag;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("host_id", getHostId());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("host_id", "hostId");
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setEdiRefCd(JSPUtil.getParameter(request, "edi_ref_cd", ""));
	 ...
	 * @return TmnlRcvIdVO[]
	 */
    public TmnlRcvIdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TmnlRcvIdVO[]
	 */
    public TmnlRcvIdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        TmnlRcvIdVO model = null;
        ...
        try {
            ...
            String[] hostId = (JSPUtil.getParameter(request, prefix + "host_id", length));
            String[] ediSndrId = (JSPUtil.getParameter(request, prefix + "edi_sndr_id", length));
	    	/* Add a field line, do not delete */
            for (int i = 0; i < length; i++) {
                model = new TmnlRcvIdVO();
                if (bracCd[i] != null)
	 ...
	 * @return TmnlRcvIdVO[]
	 */
    public TmnlRcvIdVO[] getTmnlRcvIdVOs() {
        TmnlRcvIdVO[] vos = (TmnlRcvIdVO[]) models.toArray(new TmnlRcvIdVO[models.size()]);
        return vos;
    }
	...
	*/
    public void unDataFormat() {
        ...
        this.hostId = this.hostId.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
