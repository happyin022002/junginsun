...
*@FileName : GeneralBookingSearchDBDAOsearchEdi301CntrInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingSearchDBDAOsearchEdi301CntrInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchEdi301CntrInfo
	  * </pre>
	  */
	public GeneralBookingSearchDBDAOsearchEdi301CntrInfoRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingSearchDBDAOsearchEdi301CntrInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	|| 'OB_HAUL_TP:'			|| CASE WHEN POL.CONTI_CD <> 'E' THEN DECODE(cntr.RCV_TERM_CD,'D','C','M')" ).append("\n"); 
		query.append("                                            ELSE NVL((SELECT ETRO.HLG_TP_CD FROM BKG_EUR_TRO ETRO WHERE ETRO.BKG_NO = BK.BKG_NO AND ETRO.IO_BND_CD = 'O' AND ETRO.CXL_FLG = 'N' AND ROWNUM = 1),DECODE(cntr.RCV_TERM_CD,'D','C','M')) " ).append("\n"); 
		query.append("                                            END	|| CHR(10)" ).append("\n"); 
		query.append("	|| 'IB_HAUL_TP:'			|| CASE WHEN POD.CONTI_CD <> 'E' THEN DECODE(cntr.DE_TERM_CD,'D','C','M')" ).append("\n"); 
		query.append("                                            ELSE NVL((SELECT ETRO.HLG_TP_CD FROM BKG_EUR_TRO ETRO WHERE ETRO.BKG_NO = BK.BKG_NO AND ETRO.IO_BND_CD = 'I' AND ETRO.CXL_FLG = 'N' AND ROWNUM = 1),DECODE(cntr.RCV_TERM_CD,'D','C','M'))" ).append("\n"); 
		query.append("                                            END	|| CHR(10)" ).append("\n"); 
		...
		query.append("	|| 'NET_WGT_QTY:'           || Cntr.CNTR_WGT								|| CHR(10)" ).append("\n"); 
		query.append("	|| 'NET_WGT_TP:'            || Cntr.WGT_UT_CD								|| CHR(10)" ).append("\n"); 
		...
		query.append("	|| 'RFDRY_IND:'				||DECODE(cntr.RD_CGO_FLG,'N','0','Y','1',CNTR.RD_CGO_FLG)|| CHR(10)" ).append("\n"); 
