...
*@FileName : CstPriSpScpTrspAddChgVO.java
*@FileTitle : CstPriSpScpTrspAddChgVO
*Open Issues :
*Change history :
...
public class CstPriSpScpTrspAddChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriSpScpTrspAddChgVO> models = new ArrayList<CstPriSpScpTrspAddChgVO>();
	 ...
	 */
	public CstPriSpScpTrspAddChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpScpTrspAddChgVO[]
	 */
	public CstPriSpScpTrspAddChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriSpScpTrspAddChgVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CstPriSpScpTrspAddChgVO();
				if (addChgSeq[i] != null)
		...
		return getCstPriSpScpTrspAddChgVOs();
	}
	...
	public CstPriSpScpTrspAddChgVO[] getCstPriSpScpTrspAddChgVOs(){
		CstPriSpScpTrspAddChgVO[] vos = (CstPriSpScpTrspAddChgVO[])models.toArray(new CstPriSpScpTrspAddChgVO[models.size()]);
		return vos;
	}
