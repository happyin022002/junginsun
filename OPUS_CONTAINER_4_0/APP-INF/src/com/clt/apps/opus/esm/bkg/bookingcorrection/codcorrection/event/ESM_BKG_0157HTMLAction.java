...
*@FileName : ESM_BKG_0157HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.bkg.bookingcorrection 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_BKG_0157HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0157HTMLAction 객체를 생성
	 */
	public ESM_BKG_0157HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0157Event event = new EsmBkg0157Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCodStsInputVO((CodStsInputVO)getVO(request, CodStsInputVO.class));
		}
