...
public class SCBoilerPlateGuidelineDBDAO extends DBDAOSupport {
     ...
     */
    @SuppressWarnings("unchecked")
    public int checkBoilerPlateGuidelineUse(PriSgBlplHdrVO priSgBlplHdrVO) throws DAOException {
        ...
        try{
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new SCBoilerPlateGuidelineDBDAOCheckBoilerPlateGuidelineUseRSQL(), param, velParam);
            if (dbRowset != null && dbRowset.getRowCount() > 0 && dbRowset.next()) {
                chk = dbRowset.getInt("CNT");
            }
