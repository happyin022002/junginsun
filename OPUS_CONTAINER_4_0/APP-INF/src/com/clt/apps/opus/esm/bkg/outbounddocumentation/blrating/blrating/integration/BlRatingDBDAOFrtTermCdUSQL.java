...
*@FileName : BlRatingDBDAOFrtTermCdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOFrtTermCdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOFrtTermCdUSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOFrtTermCdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",      FRT_TERM_PRN_FLG = NVL(@[frt_term_prn_flg],'Y')" ).append("\n"); 
