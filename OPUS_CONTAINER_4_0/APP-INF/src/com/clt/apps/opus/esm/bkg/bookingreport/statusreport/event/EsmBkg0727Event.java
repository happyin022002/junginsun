...
public class EsmBkg0727Event extends EventSupport {
	...
	public void setBdrBookingNoListVOS(BdrBookingNoListVO[] bdrBookingNoListVOs){
		if(bdrBookingNoListVOs != null){
			BdrBookingNoListVO[] tmpVOs = Arrays.copyOf(bdrBookingNoListVOs, bdrBookingNoListVOs.length);
			this.bdrBookingNoListVOs = tmpVOs;
		}
	}
	...
	public BdrBookingNoListVO[] getBdrBookingNoListVOS(){
		BdrBookingNoListVO[] rtnVOs = null;
		if(this.bdrBookingNoListVOs != null){
			rtnVOs= Arrays.copyOf(bdrBookingNoListVOs, bdrBookingNoListVOs.length);
		}
		return rtnVOs;
	}
