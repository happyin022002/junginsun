...
*@FileName : CustomOwnerVO.java
*@FileTitle : CustomOwnerVO
*Open Issues :
*Change history :
 ...
 * @author 윤세영
 * @since J2EE 1.5
 * @see ESM_FMS_0006HTMLAction
 */

public class CustomOwnerVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomOwnerVO> models = new ArrayList<CustomOwnerVO>();
	 ...
	 * @return 
	 */
	public CustomOwnerVO() {}
	
	/**
	 * 생성자
	 * @param String ibflag, String pagerows, String ownrSeq, String ownrNm, String fletOwnrTpCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt
	 * @return 
	 */
	public CustomOwnerVO(String ibflag, String pagerows, String ownrSeq, String ownrNm, String fletOwnrTpCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
	...
	public CustomOwnerVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CustomOwnerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomOwnerVO model = null;
		...
		return getCustomOwnerVOs();
	}

	public CustomOwnerVO[] getCustomOwnerVOs(){
		CustomOwnerVO[] vos = (CustomOwnerVO[])models.toArray(new CustomOwnerVO[models.size()]);
		return vos;
	}
