...
public class CLLCDLManifestDBDAOsearchCntrExportVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("WHERE 	A.vsl_cd				= SUBSTR(@[form_nyk_vvd],1,4) and" ).append("\n");
		query.append("A.skd_voy_no 			= SUBSTR(@[form_nyk_vvd],5,4) and" ).append("\n");
		query.append("A.skd_dir_cd    		= SUBSTR(@[form_nyk_vvd],9,1) and" ).append("\n");
