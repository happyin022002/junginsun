...
public class PickUpNoticeDBDAOsearchPkupNoMnlUpldListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                       ,H.EQ_CTRL_OFC_CD" ).append("\n"); 
		query.append("                       ,NVL(G.FRT_CLT_FLG, 'N') AS FRT_CLT_FLG" ).append("\n"); 
		query.append("                       ,NVL(G.OBL_RDEM_FLG, 'N') AS OBL_RDEM_FLG" ).append("\n"); 
		query.append("                       ,(CASE WHEN SUBSTR(D.POD_CD,1,2) = 'CA' THEN" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if (${fileup} == 'Y' || ${sch_tp_cd} == 'BL')" ).append("\n"); 
