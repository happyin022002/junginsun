 ...
 *@FileName : ESM_PRI_2077HTMLAction.java
...
public class ESM_PRI_2077HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri2077Event event = new EsmPri2077Event();
