...
*@FileName : SearchBlNtcHisVO.java
*@FileTitle : SearchBlNtcHisVO
*Open Issues :
*Change history :
...
public class SearchBlNtcHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBlNtcHisVO> models = new ArrayList<SearchBlNtcHisVO>();
	...
	public SearchBlNtcHisVO() {}

	public SearchBlNtcHisVO(String ibflag, String pagerows, String bkgNo, String ntcViaCd, String ntcKndCd) {
...
/**
	 ...
	 */
	public SearchBlNtcHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBlNtcHisVO[]
	 */
	public SearchBlNtcHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBlNtcHisVO model = null;
	 ...
	 * @return SearchBlNtcHisVO[]
	 */
	public SearchBlNtcHisVO[] getSearchBlNtcHisVOs(){
		SearchBlNtcHisVO[] vos = (SearchBlNtcHisVO[])models.toArray(new SearchBlNtcHisVO[models.size()]);
		return vos;
	}
