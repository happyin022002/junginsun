...
public class ContainerVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("ui_num", getUiNum());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("ui_num", "uiNum");
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setUiNum(JSPUtil.getParameter(request, prefix + "ui_num", ""));
    }
    ...
    public ContainerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] uiNum = (JSPUtil.getParameter(request, prefix + "ui_num", length));
	...
	*/
    public void unDataFormat() {
        ...
        this.uiNum = this.uiNum.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
