...
*@FileName : OTRCommRequestVO.java
*@FileTitle : OTRCommRequestVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.acm.acmrequest.otrcommrequest.vo;
...
public class OTRCommRequestVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<OTRCommRequestVO> models = new ArrayList<OTRCommRequestVO>();
	...
	/* Column Info */
	private String hidCommYrmon = null;
	/* Column Info */
	...
	public OTRCommRequestVO() {}

	public OTRCommRequestVO(String ibflag, String pagerows, String hidCommYrmon, String ofcCd, String xchRtDivLvl, String payXchRt, String usrId, String commYrmon, String commStndCostCd, String otrCommRmk, String vndrCntCd, String agnCd, String usrEml, String vvdChkYn, String bkgNo, String vndrSeq, String vndrLglEngNm, String acOccrInfoCd, String apCtrCd, String aplyDt, String vvd, String currCd, String payIfAmt, String usdAmt, String aproDt, String otrCommNo, String arOfcCd, String ioBndCd, String acTpCd, String acSeq, String acStsCd, String acProcDesc) {
		...
		this.hidCommYrmon = hidCommYrmon;
		this.vvd = vvd;
		this.ofcCd = ofcCd;
		this.bkgNo = bkgNo;
		this.usdAmt = usdAmt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("hid_comm_yrmon", getHidCommYrmon());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("hid_comm_yrmon", "hidCommYrmon");
	 ...
	 * @return hidCommYrmon
	 */
	public String getHidCommYrmon() {
		return this.hidCommYrmon;
	}
	 ...
	 * @param hidCommYrmon
	 */
	public void setHidCommYrmon(String hidCommYrmon) {
		this.hidCommYrmon = hidCommYrmon;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setHidCommYrmon(JSPUtil.getParameter(request, prefix + "hid_comm_yrmon", ""));
		...
		setVvdChkYn(JSPUtil.getParameter(request, prefix + "vvd_chk_yn", ""));
	 ...
	 */
	public OTRCommRequestVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OTRCommRequestVO[]
	 */
	public OTRCommRequestVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OTRCommRequestVO model = null;
		...
		try {
			...
			String[] hidCommYrmon = (JSPUtil.getParameter(request, prefix	+ "hid_comm_yrmon", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (hidCommYrmon[i] != null)
					model.setHidCommYrmon(hidCommYrmon[i]);
				if (vvd[i] != null)
					model.setVvd(vvd[i]);
				if (ofcCd[i] != null)
	...
	public OTRCommRequestVO[] getOTRCommRequestVOs(){
		OTRCommRequestVO[] vos = (OTRCommRequestVO[])models.toArray(new OTRCommRequestVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.hidCommYrmon = this.hidCommYrmon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
