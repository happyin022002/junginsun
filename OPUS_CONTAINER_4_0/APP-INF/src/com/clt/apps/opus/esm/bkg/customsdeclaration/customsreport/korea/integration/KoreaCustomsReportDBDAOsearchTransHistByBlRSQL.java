...
*@FileName : KoreaCustomsReportDBDAOsearchTransHistByBlRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchTransHistByBlRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * B/L을 이용하여 Transmit History 를 조회
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchTransHistByBlRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchTransHistByBlRSQL").append("\n");
		query.append("*/").append("\n");
	}
