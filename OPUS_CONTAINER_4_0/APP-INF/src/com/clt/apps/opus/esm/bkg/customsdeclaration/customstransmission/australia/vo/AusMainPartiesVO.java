...
*@FileName : AusMainPartiesVO.java
*@FileTitle : AusMainPartiesVO
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
public class AusMainPartiesVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusMainPartiesVO> models = new ArrayList<AusMainPartiesVO>();
	...
	public AusMainPartiesVO() {}

	public AusMainPartiesVO(String ibflag, String pagerows, String partyType, String partyId, String authorized, String address1, String address2, String address3, String address4, String address5, String contact, String phone, String fax, String ref1) {
	 ...
	 * @param request
	 * @return AusMainPartiesVO[]
	 */
	public AusMainPartiesVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusMainPartiesVO[]
	 */
	public AusMainPartiesVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusMainPartiesVO model = null;
	 ...
	 * @return AusMainPartiesVO[]
	 */
	public AusMainPartiesVO[] getAusMainPartiesVOs(){
		AusMainPartiesVO[] vos = (AusMainPartiesVO[])models.toArray(new AusMainPartiesVO[models.size()]);
		return vos;
	}
