...
*@FileName : OPMasterDBDAOMultiOmPortMngDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiOmPortMngDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiOmPortMngDSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiOmPortMngDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE EFF_FM_DT   = @[eff_fm_dt]    	--20150612.MOD	" ).append("\n"); 
