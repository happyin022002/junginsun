...
public class ESM_BKG_3012HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0926HTMLAction 객체를 생성
     */
    public ESM_BKG_3012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg3012Event event = new EsmBkg3012Event();
		
		if (command.isCommand(FormCommand.SEARCH)) {
			event.setPlaceOfIssueAssociationVO((PlaceOfIssueAssociationVO)getVO(request, PlaceOfIssueAssociationVO.class,""));
