...
*@FileName : KorCustomsTransmissionDBDAOmakeDiscHeadFlatFileRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeDiscHeadFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeDiscHeadFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeDiscHeadFlatFileRSQL").append("\n");
		query.append("*/").append("\n");
	}
