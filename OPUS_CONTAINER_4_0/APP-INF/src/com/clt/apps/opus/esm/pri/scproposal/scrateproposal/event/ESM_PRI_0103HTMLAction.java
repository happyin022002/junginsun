 ...
 *@FileName : ESM_PRI_0103HTMLAction.java
...
public class ESM_PRI_0103HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0103Event event = new EsmPri0103Event();
