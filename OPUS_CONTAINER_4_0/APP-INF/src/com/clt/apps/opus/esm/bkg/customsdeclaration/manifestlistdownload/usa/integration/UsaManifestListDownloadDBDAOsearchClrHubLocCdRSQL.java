...
public class UsaManifestListDownloadDBDAOsearchClrHubLocCdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT CLR.HUB_LOC_CD" ).append("\n"); 
		query.append("      ,CLR.CSTMS_CLR_TP_CD" ).append("\n"); 
		query.append("      ,CLR.IBD_TRSP_TP_CD AS IBD_TP_CD" ).append("\n"); 
		...
		query.append("   AND NVL(B.SC_NO, ' ')= DECODE(CLR.SC_NO, NULL, NVL(B.SC_NO, ' '), CLR.SC_NO) " ).append("\n"); 
