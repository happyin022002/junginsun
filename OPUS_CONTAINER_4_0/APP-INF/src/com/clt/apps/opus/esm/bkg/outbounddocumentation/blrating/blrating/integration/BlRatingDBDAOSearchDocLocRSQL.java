...
*@FileName : BlRatingDBDAOSearchDocLocRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOSearchDocLocRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOSearchDocLocRSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOSearchDocLocRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'DOC / XDO' AS CHARGE_CODE" ).append("\n"); 
