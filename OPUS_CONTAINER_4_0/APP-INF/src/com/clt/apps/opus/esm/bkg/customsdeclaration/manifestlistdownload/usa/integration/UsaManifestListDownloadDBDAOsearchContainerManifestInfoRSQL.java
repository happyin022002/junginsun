...
*@FileName : UsaManifestListDownloadDBDAOsearchContainerManifestInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaManifestListDownloadDBDAOsearchContainerManifestInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UsaContainerManifestInfoVO
	  * </pre>
	  */
	public UsaManifestListDownloadDBDAOsearchContainerManifestInfoRSQL(){
		setQuery();
		...
		query.append("FileName : UsaManifestListDownloadDBDAOsearchContainerManifestInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
