...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOCallMainSaqMonQtaAdjSmryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOCallMainSaqMonQtaAdjSmryCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOCallMainSaqMonQtaAdjSmryCSQL(){
		setQuery();
		...
		params.put("outParam",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOCallMainSaqMonQtaAdjSmryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL SAQ_MON_QTA_ADJ_CRE_PKG.MAIN_SAQ_MON_QTA_ADJ_SMRY(@[mqtaStepCd], @[bseYr], @[bseQtrCd], @[trdCd], @[dirCd], @[mQtaVerNo], @[userId], @[outParam])" ).append("\n"); 
