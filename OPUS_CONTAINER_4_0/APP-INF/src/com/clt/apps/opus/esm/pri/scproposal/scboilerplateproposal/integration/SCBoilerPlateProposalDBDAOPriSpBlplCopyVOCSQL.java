...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCopyVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCopyVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_blpl을 guideline에서 copy
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCopyVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCopyVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	BLPL_TIT_NM" ).append("\n"); 
		query.append(",	DENSE_RANK() OVER (ORDER BY DP_SEQ) DP_SEQ" ).append("\n"); 
		query.append(",	@[amdt_seq]" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
