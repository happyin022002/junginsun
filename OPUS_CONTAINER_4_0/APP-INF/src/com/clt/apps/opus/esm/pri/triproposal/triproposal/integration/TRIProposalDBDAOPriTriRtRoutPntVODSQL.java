...
*@FileName : TRIProposalDBDAOPriTriRtRoutPntVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtRoutPntVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_ROUT_PNT DELETE
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtRoutPntVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtRoutPntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT_ROUT_PNT" ).append("\n"); 
