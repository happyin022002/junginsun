...
*@FileName : EmlNtfcBlInfoVO.java
*@FileTitle : EmlNtfcBlInfoVO
*Open Issues :
*Change history :
 ...
 */
public class EmlNtfcBlInfoVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<EmlNtfcBlInfoVO> models = new ArrayList<EmlNtfcBlInfoVO>();
    ...
    public EmlNtfcBlInfoVO() {
    }

    public EmlNtfcBlInfoVO(String ibflag, String pagerows, String blNo, String vslCd, String skdVoyNo, String skdDirCd, String cstmsPolCd, String cstmsPodCd, String ofcEngNm, String shipper, String consignee, String cstmsAckProcRsltCd, String reason, String cntrNo, String emlType, String usrEml) {
        this.ibflag = ibflag;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("eml_type", getEmlType());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("eml_type", "emlType");
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setEmlType(JSPUtil.getParameter(request, prefix + "eml_type", ""));
	 ...
	 */
    public EmlNtfcBlInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EmlNtfcBlInfoVO[]
	 */
    public EmlNtfcBlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        EmlNtfcBlInfoVO model = null;
        ...
        try {
            ...
            String[] emlType = (JSPUtil.getParameter(request, prefix + "eml_type", length));
            String[] usrEml = (JSPUtil.getParameter(request, prefix + "usr_eml", length));
	    	/* Add a field line, do not delete */
            for (int i = 0; i < length; i++) {
                model = new EmlNtfcBlInfoVO();
                if (ibflag[i] != null)
	 ...
	 * @return EmlNtfcBlInfoVO[]
	 */
    public EmlNtfcBlInfoVO[] getEmlNtfcBlInfoVOs() {
        EmlNtfcBlInfoVO[] vos = (EmlNtfcBlInfoVO[]) models.toArray(new EmlNtfcBlInfoVO[models.size()]);
        return vos;
    }
    ...
    public void unDataFormat() {
        ...
        this.emlType = this.emlType.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
