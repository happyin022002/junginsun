...
*@FileName : BasicDataDBDAOCreatePfSkdGrpForSectorQtaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BasicDataDBDAOCreatePfSkdGrpForSectorQtaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * P/F SKD Group Mgmt for IAS Sector  Quarter 정보를 생성한다.
	  * 
	  * *History
	  * 2014.08.25 이혜민 펜들럼 노선일때 같은 PF SKD VER을 가진 노선이 2개 이상이 되어 CONNECT BY를 제대로 해주지 못해 쿼리 수정. 
	  * </pre>
	  */
	public BasicDataDBDAOCreatePfSkdGrpForSectorQtaCSQL(){
		setQuery();
		...
		query.append("FileName : BasicDataDBDAOCreatePfSkdGrpForSectorQtaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
