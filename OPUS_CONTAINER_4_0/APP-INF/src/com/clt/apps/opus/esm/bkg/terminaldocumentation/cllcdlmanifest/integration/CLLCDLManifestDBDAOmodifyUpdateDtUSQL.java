...
*@FileName : CLLCDLManifestDBDAOmodifyUpdateDtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CLLCDLManifestDBDAOmodifyUpdateDtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLLCDLManifestDBDAOmodifyUpdateDtUSQL(){
		setQuery();
		...
		query.append("FileName : CLLCDLManifestDBDAOmodifyUpdateDtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_TML_KR_CLL SET" ).append("\n"); 
