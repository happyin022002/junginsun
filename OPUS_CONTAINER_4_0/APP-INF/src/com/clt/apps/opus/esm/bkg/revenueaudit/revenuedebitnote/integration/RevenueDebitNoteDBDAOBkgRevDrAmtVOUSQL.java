...
*@FileName : RevenueDebitNoteDBDAOBkgRevDrAmtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RevenueDebitNoteDBDAOBkgRevDrAmtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOBkgRevDrAmtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RevenueDebitNoteDBDAOBkgRevDrAmtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_REV_DR_AMT SET " ).append("\n"); 
		query.append("	RDN_NO = @[rdn_no]" ).append("\n"); 
		query.append(",	RVIS_SEQ = @[rvis_seq]" ).append("\n"); 
		query.append(",	CURR_CD = @[curr_cd]" ).append("\n"); 
		query.append(",	DR_AMT = @[dr_amt]" ).append("\n"); 
