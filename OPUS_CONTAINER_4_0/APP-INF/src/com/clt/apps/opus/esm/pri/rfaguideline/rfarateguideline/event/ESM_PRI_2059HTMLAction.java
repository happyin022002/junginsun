 ...
 *@FileName : UI_PRI_2059HTMLAction.java
 *@FileTitle : UI_PRI_2059HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_2059HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2059HTMLAction 객체를 생성
	 */
	public ESM_PRI_2059HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2059Event event = new EsmPri2059Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
		    PriRgRtCmdtHdrVO vo = (PriRgRtCmdtHdrVO) getVO(request, PriRgRtCmdtHdrVO.class);
		    event.setPriRgRtCmdtHdrVO(vo);
			event.setRsltRfaRtListVerticalExcelVOS((RsltRfaRtListVerticalExcelVO[]) getVOs(request, RsltRfaRtListVerticalExcelVO.class, ""));
