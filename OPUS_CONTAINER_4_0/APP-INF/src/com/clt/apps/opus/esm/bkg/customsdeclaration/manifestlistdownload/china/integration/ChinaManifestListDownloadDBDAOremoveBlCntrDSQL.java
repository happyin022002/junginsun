...
*@FileName : ChinaManifestListDownloadDBDAOremoveBlCntrDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOremoveBlCntrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOremoveBlCntrDSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOremoveBlCntrDSQL").append("\n");
		query.append("*/").append("\n");
	}
