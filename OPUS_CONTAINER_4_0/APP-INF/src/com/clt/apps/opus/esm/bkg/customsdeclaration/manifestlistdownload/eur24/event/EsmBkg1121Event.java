...
public class EsmBkg1121Event extends EventSupport {
	...
	public Eu24ManifestTransmitOBVO[] getEu24ManifestTransmitOBVOs() {
		Eu24ManifestTransmitOBVO[] rtnVOs = null;
		if (eu24ManifestTransmitOBVOs != null)
			rtnVOs = Arrays.copyOf(eu24ManifestTransmitOBVOs, eu24ManifestTransmitOBVOs.length);
		return rtnVOs;
	}
	...
	public void setEu24ManifestTransmitOBVOs(Eu24ManifestTransmitOBVO[] eu24ManifestTransmitOBVOs) {
		if (eu24ManifestTransmitOBVOs != null)
			this.eu24ManifestTransmitOBVOs = Arrays.copyOf(eu24ManifestTransmitOBVOs, eu24ManifestTransmitOBVOs.length);
	}
