...
*@FileName : RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlStsListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlStsListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlStsListVORSQL
	  * </pre>
	  */
	public RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlStsListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlStsListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
