...
*@FileName : KoreaCustomsReportDBDAOsearchAmdRcvCdRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchAmdRcvCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchAmdRcvCdRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchAmdRcvCdRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(AMDT_RCVR_CD,'') AMDT_RCVR_CD" ).append("\n");
