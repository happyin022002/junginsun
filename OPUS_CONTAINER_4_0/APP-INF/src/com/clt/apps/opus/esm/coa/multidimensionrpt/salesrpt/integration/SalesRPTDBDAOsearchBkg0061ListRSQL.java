...
public class SalesRPTDBDAOsearchBkg0061ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("         AND (     A4.CNT = 0 AND A3.COP_STS_CD   NOT IN ('X','M','O')                OR  A4.CNT > 0 AND A3.COP_STS_CD   NOT IN ('M','O')                  ) " ).append("\n"); 
		...
		query.append("                              || NVL(D2.TRSP_MOD_CD, 'XX'     ) AS NOD                         FROM PRD_PROD_CTL_ACT_GRP_DTL D2, " ).append("\n"); 
		query.append("                             ( " ).append("\n"); 
		...
		query.append("                                      ,NVL(MAX(CNTR_SPCL_FLG), MAX(BKG_SPCL_FLG)) AS SPCL_FLG                                       ,MAX(BKG_SPCL_FLG) AS BKG_SPCL_FLG " ).append("\n"); 
		query.append("                                      ,SUM(ABS(CNTR_QTY)) + SUM(ABS(BKG_QTY)) AS QTY                                            FROM ( " ).append("\n"); 
		query.append("                                          SELECT BKG_NO " ).append("\n"); 
		query.append("                                                ,PCTL_NO " ).append("\n"); 
		query.append("                                                ,COP_NO " ).append("\n"); 
		query.append("                                                ,CNTR_TPSZ_CD " ).append("\n"); 
		query.append("                                                ,SUM(QTY) AS CNTR_QTY                                                  ,AWK_CGO_FLG||DCGO_FLG||RC_FLG||BB_CGO_FLG||SOC_FLG||RD_CGO_FLG AS CNTR_SPCL_FLG " ).append("\n"); 
		...
		query.append("                                                ,C2.QTY AS BKG_QTY                                                ,C1.AWK_CGO_FLG||C1.DCGO_FLG||C1.RC_FLG||C1.BB_CGO_FLG||C1.SOC_FLG||C1.RD_CGO_FLG AS BKG_SPCL_FLG " ).append("\n"); 
		query.append("                                                ,RCV_TERM_CD " ).append("\n"); 
		query.append("                                                ,DE_TERM_CD " ).append("\n"); 
		query.append("                                            FROM QTY C1 " ).append("\n"); 
		query.append("                                                ,(" ).append("\n"); 
		query.append("                                                                                                                                                        select b1.bkg_no " ).append("\n"); 
		query.append("                                                          ,decode(b1.flex_hgt_flg, 'Y', decode(b1.cntr_tpsz_cd,'D4', nvl(b2.cntr_tpsz_cd,b1.cntr_tpsz_cd)" ).append("\n"); 
		query.append("                                                                                                              ,'D5', nvl(b2.cntr_tpsz_cd,b1.cntr_tpsz_cd)" ).append("\n"); 
		query.append("                                                                                                              ,B1.CNTR_TPSZ_CD)" ).append("\n"); 
		query.append("                                                                                  , b1.cntr_tpsz_cd) cntr_tpsz_cd                                                           ,b1.qty - nvl(b2.qty,0) qty2" ).append("\n"); 
		query.append("                                                          ,decode(b1.flex_hgt_flg, 'Y', Decode(b1.cntr_tpsz_cD,'D4', nvl(b2.qty, b1.qty)" ).append("\n"); 
		query.append("                                                                                                              ,'D5', nvl(b2.qty, b1.qty)" ).append("\n"); 
		query.append("                                                                                                              ,b1.qty)" ).append("\n"); 
		query.append("                                                                                  , b1.qty) - nvl(b2.qty,0) qty" ).append("\n"); 
		query.append("                                                          " ).append("\n"); 
		query.append("                                                          ,'QTY'                  qty_class " ).append("\n"); 
		query.append("                                                   from   (select   bkg_no, cntr_tpsz_cd, flex_hgt_flg, sum(qty) qty from qty group by bkg_no, cntr_tpsz_cd, flex_hgt_flg) b1 " ).append("\n"); 
		query.append("                                                         ,(select   bkg_no, cntr_tpsz_cd, flex_hgt_flg, sum(qty) qty from cntr group by bkg_no, cntr_tpsz_cd, flex_hgt_flg) b2 " ).append("\n"); 
		query.append("                                                   where  b1.bkg_no = b2.bkg_no (+) " ).append("\n"); 
		query.append("                                                   and    decode(b1.flex_hgt_flg, 'Y', decode(b1.cntr_tpsz_cd,'D4', nvl(b2.cntr_tpsz_cd(+),b1.cntr_tpsz_cd)" ).append("\n"); 
		query.append("                                                                                                             ,'D5', nvl(b2.cntr_tpsz_cd(+),b1.cntr_tpsz_cd)" ).append("\n"); 
		query.append("                                                                                                             ,b1.cntr_tpsz_cd)" ).append("\n"); 
		...
		query.append("      , MAX(A1.SPCL_DG_CGO_FLG) SPCL_DG_CGO_FLG" ).append("\n"); 
		query.append("      , MAX(A1.SPCL_RC_FLG) SPCL_RC_FLG" ).append("\n"); 
		query.append("      , MAX(A1.SPCL_AWK_CGO_FLG) SPCL_AWK_CGO_FLG" ).append("\n"); 
		query.append("      , MAX(A1.SPCL_BB_CGO_FLG) SPCL_BB_CGO_FLG" ).append("\n"); 
		query.append("      , MAX(A2.SOC_FLG)                                                                             SOC_FLG" ).append("\n"); 
		query.append("      , MAX(A2.BKG_CGO_TP_CD) BKG_CGO_TP_CD" ).append("\n"); 
		...
		query.append("      , MAX(A2.CLT_OFC_CD) CLT_OFC_CD" ).append("\n"); 
		query.append("      , MAX(A2.SLS_OFC_CD) SLS_OFC_CD" ).append("\n"); 
		query.append("      , MAX(A2.SHIPPER) SHIPPER" ).append("\n"); 
		query.append("      , MAX(A2.IOC_CD) IOC_CD" ).append("\n"); 
		query.append("      , MAX(A2.VVD) VVD" ).append("\n"); 
		query.append("      , MAX(A2.BKG_DE_TERM_CD) BKG_DE_TERM_CD" ).append("\n"); 
		query.append("      , MAX(A2.BKG_RCV_TERM_CD) BKG_RCV_TERM_CD" ).append("\n"); 
		query.append("      , MAX(A2.REP_CMDT_CD) REP_CMDT_CD" ).append("\n"); 
		query.append("      , MAX(A2.SHPR_NM) SHPR_NM" ).append("\n"); 
		query.append("      , MAX(A2.RLANE_CD) RLANE_CD" ).append("\n"); 
		query.append("	  , NVL( A1.TTL_TZTM_HRS ,0) / 24  HRS" ).append("\n"); 
		query.append("      , MAX(A2.BKG_STS_CD) BKG_STS_CD" ).append("\n"); 
		query.append("      , MAX(A2.SLS_YRMON) SLS_YRMON" ).append("\n"); 
		query.append("      , MAX(A2.COST_YRMON) COST_YRMON" ).append("\n"); 
		query.append("      , MAX(A2.COST_WK) COST_WK" ).append("\n"); 
		query.append("      , SUM(A2.BKG_CGO_WGT) BKG_CGO_WGT" ).append("\n"); 
		query.append("      , MAX(A2.BKG_WGT_TP_CD) BKG_WGT_TP_CD" ).append("\n"); 
		...
		query.append("          , COA_LOC_FNC(A1.MTY_PKUP_YD_CD, 'ECC') " ).append("\n"); 
		query.append("          , A1.POR_CD" ).append("\n"); 
		query.append("          , A1.POL_CD" ).append("\n"); 
		query.append("          , A1.N1ST_TS_PORT_CD" ).append("\n"); 
		query.append("          , A1.N2ND_TS_PORT_CD" ).append("\n"); 
		...
		query.append("          , A1.POD_CD" ).append("\n"); 
		query.append("          , A1.DEL_CD" ).append("\n"); 
		query.append("          , COA_LOC_FNC(A1.MTY_RTN_YD_CD, 'ECC') " ).append("\n"); 
		query.append("          , A1.OB_ITCHG_CTNT" ).append("\n"); 
		query.append("          , A1.IB_ITCHG_CTNT" ).append("\n"); 
