...
*@FileName       : MonthlyTargetVVDManagementVO.java
*@FileTitle      : MonthlyTargetVVDManagementVO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
package com.clt.apps.opus.esm.saq.basicdatamanage.monthlytargetvvd.vo;
...
public class MonthlyTargetVVDManagementVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MonthlyTargetVVDManagementVO> models = new ArrayList<MonthlyTargetVVDManagementVO>();
	...
	public MonthlyTargetVVDManagementVO() {}

	public MonthlyTargetVVDManagementVO(String ibflag, String pagerows,  String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String vslCd, String skdVoyNo, String skdDirCd, String sprtGrpCd, String bsaGrpCd, String bseMon, String bseWk, String subTrdCd, String iocCd, String vvdSeq, String fnlBsaCapa, String strFnlBsaCapa, String lstLodgPortEtdDt, String updRmk, String lstLodgPortCd, String deltFlg, String tgtVvdStsCd) {
		this.iocCd = iocCd;
		this.vslCd = vslCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sts_text", getStsText());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sts_text", "stsText");
	...
	public void setStsText(String stsText) {
		this.stsText = stsText;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setStsText(JSPUtil.getParameter(request, "sts_text", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return MonthlyTargetVVDManagementVO[]
	 */
	public MonthlyTargetVVDManagementVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MonthlyTargetVVDManagementVO[]
	 */
	public MonthlyTargetVVDManagementVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MonthlyTargetVVDManagementVO model = null;
		...
		try {
			...
			String[] stsText = (JSPUtil.getParameter(request, prefix	+ "sts_text", length));
			
			for (int i = 0; i < length; i++) {
				model = new MonthlyTargetVVDManagementVO();
				if (iocCd[i] != null)
		...
		return getMonthlyTargetVVDManagementVOs();
	}
	 ...
	 * @return MonthlyTargetVVDManagementVO[]
	 */
	public MonthlyTargetVVDManagementVO[] getMonthlyTargetVVDManagementVOs(){
		MonthlyTargetVVDManagementVO[] vos = (MonthlyTargetVVDManagementVO[])models.toArray(new MonthlyTargetVVDManagementVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.stsText = this.stsText .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
