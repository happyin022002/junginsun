...
*@FileName : SpecialManifestDBDAOsearchDgInfoAtBkgDgTransitRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOsearchDgInfoAtBkgDgTransitRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOsearchDgInfoAtBkgDgTransitRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOsearchDgInfoAtBkgDgTransitRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("WITH POL_CD_LIST AS" ).append("\n"); 
		...
		query.append("                  )" ).append("\n"); 
		query.append("    )" ).append("\n"); 
		query.append(",POD_CD_LIST AS" ).append("\n"); 
		query.append("    (SELECT DISTINCT VPS_PORT_CD" ).append("\n"); 
		query.append("       FROM VSK_VSL_PORT_SKD" ).append("\n"); 
		query.append("      WHERE VSL_CD      = SUBSTR(@[vvd_cd], 1, 4)" ).append("\n"); 
		query.append("        AND SKD_VOY_NO  = SUBSTR(@[vvd_cd], 5, 4)" ).append("\n"); 
		...
		query.append("               DECODE(HIS.EUR_OUTR_PCK_DESC,NULL,NVL(BVD.OUT_N1ST_IMDG_PCK_DESC||' '||BVD.OUT_N1ST_IMDG_PCK_DESC,''),HIS.EUR_OUTR_PCK_DESC)" ).append("\n"); 
		...
		query.append("              ,CASE WHEN HIS.SPCL_CNTR_SEQ IS NOT NULL THEN HIS.SPCL_CNTR_SEQ -- SPCL_CNTR_SEQ of the latest Transit port history" ).append("\n"); 
		query.append("               ELSE BVD.SPCL_CNTR_SEQ" ).append("\n"); 
		query.append("               END AS SPCL_CNTR_SEQ" ).append("\n"); 
		query.append("              ,CASE WHEN HIS.SPCL_CGO_SEQ IS NOT NULL THEN HIS.SPCL_CGO_SEQ -- SPCL_CGO_SEQ of the latest Transit port history" ).append("\n"); 
		...
		query.append("                        SELECT --+ ORDERED USE_NL(POL BV)" ).append("\n"); 
		query.append("                               *" ).append("\n"); 
		query.append("                          FROM POL_CD_LIST POL" ).append("\n"); 
		query.append("                             , BKG_VVD BV" ).append("\n"); 
		query.append("                             , POD_CD_LIST POD" ).append("\n"); 
		query.append("                         WHERE 1=1" ).append("\n"); 
		query.append("                           AND BV.VSL_CD        =  SUBSTR(@[vvd_cd], 1, 4)" ).append("\n"); 
		query.append("                           AND BV.SKD_VOY_NO    =  SUBSTR(@[vvd_cd], 5, 4)" ).append("\n"); 
		query.append("                           AND BV.SKD_DIR_CD    =  SUBSTR(@[vvd_cd], 9, 1)" ).append("\n"); 
		query.append("                           AND BV.POL_CD        = POL.VPS_PORT_CD" ).append("\n"); 
		query.append("                           AND BV.POD_CD        = POD.VPS_PORT_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("                                      AND EUDG.CNTR_CGO_SEQ      = BDC.CNTR_CGO_SEQ" ).append("\n"); 
		query.append("                                  )" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                      ,SCG_IMDG_UN_NO SIUN" ).append("\n"); 
		query.append("                      ,POL_CD_LIST POL" ).append("\n"); 
		query.append("                      ,POD_CD_LIST POD" ).append("\n"); 
		query.append("                 WHERE 1=1" ).append("\n"); 
		...
		query.append("#if ( ${d_type} == 'T' )" ).append("\n"); 
		query.append("                   AND RQST.POL_CD  = POL.VPS_PORT_CD" ).append("\n"); 
		query.append("                   AND RQST.POD_CD  = POD.VPS_PORT_CD" ).append("\n"); 
		...
		query.append("                                      AND EUDG.CNTR_REF_NO       = CGO.CNTR_REF_NO" ).append("\n"); 
		query.append("                                      AND EUDG.CNTR_CGO_SEQ      = CGO.SPCL_CGO_SEQ" ).append("\n"); 
		query.append("                                  )" ).append("\n"); 
		...
		query.append("#if ( ${d_type} == 'T' )" ).append("\n"); 
		query.append("                          AND HIS.POL_CD = POL.VPS_PORT_CD" ).append("\n"); 
		query.append("                          AND HIS.POD_CD = POD.VPS_PORT_CD" ).append("\n"); 
		query.append("#elseif ( ${d_type} == 'D' )" ).append("\n"); 
		...
		query.append("                                 AND PORT_CD      = @[port_cd]" ).append("\n"); 
		query.append("                              )" ).append("\n"); 
		query.append("		   		  GROUP BY HIS.VSL_CD" ).append("\n"); 
		query.append("                   ,HIS.SKD_VOY_NO" ).append("\n"); 
		query.append("                   ,HIS.SKD_DIR_CD" ).append("\n"); 
		query.append("                   ,HIS.BL_NO" ).append("\n"); 
		query.append("                   ,HIS.CNTR_NO" ).append("\n"); 
		...
		query.append("--           AND BVD.CNTR_CGO_SEQ(+) = HIS.CNTR_CGO_SEQ" ).append("\n"); 
		query.append("           AND BVD.SPCL_CNTR_SEQ(+) = HIS.SPCL_CNTR_SEQ" ).append("\n"); 
		query.append("           AND BVD.SPCL_CGO_SEQ(+) = HIS.SPCL_CGO_SEQ" ).append("\n"); 
		query.append(" )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("WHERE 1=1 " ).append("\n"); 
