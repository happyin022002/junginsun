 ...
 *@FileName : ESM_BKG_0016HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0016HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0016HTMLAction 객체를 생성
	 */
	public ESM_BKG_0016HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0016Event event = new EsmBkg0016Event();
		if (command.isCommand(FormCommand.SEARCH))
		{
			// Vessel Information 조회
			event.setVesselCondVO((CndCstmsVesselInfoCondVO) getVO(request, CndCstmsVesselInfoCondVO.class));
		}
		else if (command.isCommand(FormCommand.MULTI))
		{
			// Vessel 정보수정
			event.setVesselInfoVOs((CndCstmsVesselInfoVO[]) getVOs(request, CndCstmsVesselInfoVO.class));
		}
