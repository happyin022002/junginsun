...
*@FileName : FFCmpnCSRHeaderVO.java
*@FileTitle : FFCmpnCSRHeaderVO
*Open Issues :
*Change history :
...
public class FFCmpnCSRHeaderVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<FFCmpnCSRHeaderVO> models = new ArrayList<FFCmpnCSRHeaderVO>();
...
/**
	 ...
	 */
	public FFCmpnCSRHeaderVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FFCmpnCSRHeaderVO[]
	 */
	public FFCmpnCSRHeaderVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FFCmpnCSRHeaderVO model = null;
	 ...
	 * @return FFCmpnCSRHeaderVO[]
	 */
	public FFCmpnCSRHeaderVO[] getFFCmpnCSRHeaderVOs(){
		FFCmpnCSRHeaderVO[] vos = (FFCmpnCSRHeaderVO[])models.toArray(new FFCmpnCSRHeaderVO[models.size()]);
		return vos;
	}
