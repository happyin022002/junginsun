...
*@FileName : SCRateGuidelineDBDAOPriSgRtCmdtHdrVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtCmdtHdrVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtCmdtHdrVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE pri_sg_rt_cmdt_hdr SET" ).append("\n"); 
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtCmdtHdrVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}