...
*@FileName : ESM_SAM_0010HTMLAction.java
...
public class ESM_SAM_0010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0004HTMLAction 객체를 생성 
	 */
	public ESM_SAM_0010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSam0010Event event = new EsmSam0010Event();
		if (command.isCommand(FormCommand.SEARCH)){
			SearchCustomerCodeGroupingVO vo = (SearchCustomerCodeGroupingVO)getVO(request, SearchCustomerCodeGroupingVO .class);
			event.setSearchCustomerCodeGroupingVO(vo);
		}
