...
*@FileName : BookingHistoryMgtDBDAOSearchHistNewBkgAwkCgoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingHistoryMgtDBDAOSearchHistNewBkgAwkCgoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingHistoryMgtDBDAOSearchHistNewBkgAwkCgoRSQL
	  * </pre>
	  */
	public BookingHistoryMgtDBDAOSearchHistNewBkgAwkCgoRSQL(){
		setQuery();
		...
		query.append("FileName : BookingHistoryMgtDBDAOSearchHistNewBkgAwkCgoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("' CM/'||TO_CHAR(NOW.OVR_VOID_SLT_QTY, '9999.0')||'FEU' CRNT_CTNT" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("FROM BKG_AWK_CGO_HIS NOW" ).append("\n"); 
		query.append("WHERE NOW.BKG_NO  = @[bkg_no]" ).append("\n"); 
		query.append("AND NOW.CORR_NO = 'TMP0000001'" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("FROM BKG_AWK_CGO NOW" ).append("\n"); 
		query.append("WHERE NOW.BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if ($field_list.size() > 0)" ).append("\n"); 
		query.append("AND (BKG_NO, AWK_CGO_SEQ) NOT IN (" ).append("\n"); 
