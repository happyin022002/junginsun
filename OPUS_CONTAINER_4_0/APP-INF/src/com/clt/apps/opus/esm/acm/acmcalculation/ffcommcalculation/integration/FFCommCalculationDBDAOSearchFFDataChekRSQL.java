...
*@FileName : FFCommCalculationDBDAOSearchFFDataChekRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOSearchFFDataChekRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOSearchFFDataChekRSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAOSearchFFDataChekRSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOSearchFFDataChekRSQL").append("\n");
		query.append("*/").append("\n");
	}
