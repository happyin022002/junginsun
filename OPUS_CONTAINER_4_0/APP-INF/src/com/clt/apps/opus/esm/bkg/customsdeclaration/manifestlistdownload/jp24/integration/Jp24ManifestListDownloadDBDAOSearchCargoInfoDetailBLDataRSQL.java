...
public class Jp24ManifestListDownloadDBDAOSearchCargoInfoDetailBLDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ' ' AS TAMR_RST," ).append("\n"); 
		...
		query.append("                       DECODE((SELECT /*+ INDEX_ASC(CP XPKMDM_CUST_CNTC_PNT) */" ).append("\n"); 
		query.append("                                      CP.INTL_PHN_NO||CP.PHN_NO" ).append("\n"); 
		query.append("                                 FROM MDM_CUST_CNTC_PNT CP" ).append("\n"); 
		query.append("                                WHERE SHPR.CUST_CNT_CD = CP.CUST_CNT_CD" ).append("\n"); 
		query.append("                                  AND SHPR.CUST_SEQ = CP.CUST_SEQ" ).append("\n"); 
		query.append("                                  AND CP.PHN_NO IS NOT NULL" ).append("\n"); 
		query.append("                                  AND ROWNUM = 1), NULL, 'N', 'Y') AS SHPR_PHN_NO," ).append("\n"); 
		...
		query.append("                                      CP.INTL_PHN_NO||CP.PHN_NO" ).append("\n"); 
		query.append("                                 FROM MDM_CUST_CNTC_PNT CP" ).append("\n"); 
		query.append("                                WHERE CNEE.CUST_CNT_CD = CP.CUST_CNT_CD" ).append("\n"); 
		query.append("                                  AND CNEE.CUST_SEQ = CP.CUST_SEQ" ).append("\n"); 
		query.append("                                  AND CP.PHN_NO IS NOT NULL" ).append("\n"); 
		query.append("                                  AND ROWNUM = 1), NULL, 'N', 'Y') AS CNEE_PHN_NO," ).append("\n"); 
		...
		query.append("                                      CP.INTL_PHN_NO||CP.PHN_NO" ).append("\n"); 
		query.append("                                 FROM MDM_CUST_CNTC_PNT CP" ).append("\n"); 
		query.append("                                WHERE NTFY.CUST_CNT_CD = CP.CUST_CNT_CD" ).append("\n"); 
		query.append("                                  AND NTFY.CUST_SEQ = CP.CUST_SEQ" ).append("\n"); 
		query.append("                                  AND CP.PHN_NO IS NOT NULL" ).append("\n"); 
		query.append("                                  AND ROWNUM = 1), NULL, 'N', 'Y') AS NTFY_PHN_NO," ).append("\n"); 
		...
		query.append("                         WHERE RCV.BKG_NO = BKG.BL_NO" ).append("\n"); 
		...
		query.append("                         WHERE BKG.BL_NO = SND.BL_NO(+)" ).append("\n"); 
		...
		query.append("                   AND BKG.BKG_CGO_TP_CD NOT IN ('P', 'R')" ).append("\n"); 
		query.append("                   AND BKG.BKG_NO = BMD.BKG_NO(+)" ).append("\n"); 
		query.append("                   AND BKG.BB_CGO_FLG = 'N'" ).append("\n"); 
		query.append("             )" ).append("\n"); 
		query.append("     )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(" WHERE 1 = 1" ).append("\n"); 
		...
		query.append("        MEAS_UT_CD = 'N' OR IMDG_CLS = 'N' OR UN_NO = 'N' OR CNTR_NO IS NULL)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
