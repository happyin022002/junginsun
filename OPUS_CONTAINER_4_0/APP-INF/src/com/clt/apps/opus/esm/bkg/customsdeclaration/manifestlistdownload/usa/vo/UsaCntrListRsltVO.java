...
*@FileName : UsaCntrListRsltVO.java
*@FileTitle : UsaCntrListRsltVO
*Open Issues :
*Change history :
...
public class UsaCntrListRsltVO extends ContainerListRsltVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaCntrListRsltVO> models = new ArrayList<UsaCntrListRsltVO>();
	
	/* Column Info */
	private String sealNo = null;
	/* Column Info */
	private String bakCntrNo = null;
	/* Column Info */
	...
	public UsaCntrListRsltVO() {}

	public UsaCntrListRsltVO(String ibflag, String pagerows, String blNo, String cntrNo, String bakCntrNo, String cntrTpszCd, String fullMtyCd, String ibdCntrStsCd, String sealNo, String sealNo2) {
		this.sealNo = sealNo;
		this.bakCntrNo = bakCntrNo;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("bak_cntr_no", getBakCntrNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("bak_cntr_no", "bakCntrNo");
	 ...
	 * @return bakCntrNo
	 */
	public String getBakCntrNo() {
		return this.bakCntrNo;
	}
	 ...
	 * @param bakCntrNo
	 */
	public void setBakCntrNo(String bakCntrNo) {
		this.bakCntrNo = bakCntrNo;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBakCntrNo(JSPUtil.getParameter(request, "bak_cntr_no", ""));
		setSealNo2(JSPUtil.getParameter(request, "seal_no2", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setCntrNo(JSPUtil.getParameter(request, "cntr_no", ""));
		setCntrTpszCd(JSPUtil.getParameter(request, "cntr_tpsz_cd", ""));
		setFullMtyCd(JSPUtil.getParameter(request, "full_mty_cd", ""));
		setIbdCntrStsCd(JSPUtil.getParameter(request, "ibd_cntr_sts_cd", ""));
	 ...
	 * @param request
	 * @return UsaCntrListRsltVO[]
	 */
	public UsaCntrListRsltVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaCntrListRsltVO[]
	 */
	public UsaCntrListRsltVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaCntrListRsltVO model = null;
		...
		try {
			...
			String[] bakCntrNo = (JSPUtil.getParameter(request, prefix	+ "bak_cntr_no", length));
			...
			for (int i = 0; i < length; i++) {
				model = new UsaCntrListRsltVO();
				if (sealNo[i] != null)
					model.setSealNo(sealNo[i]);
				if (bakCntrNo[i] != null)
					model.setBakCntrNo(bakCntrNo[i]);
				if (sealNo2[i] != null)
	 ...
	 * @return UsaCntrListRsltVO[]
	 */
	public UsaCntrListRsltVO[] getUsaCntrListRsltVOs(){
		UsaCntrListRsltVO[] vos = (UsaCntrListRsltVO[])models.toArray(new UsaCntrListRsltVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.bakCntrNo = this.bakCntrNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
