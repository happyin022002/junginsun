...
*@FileName : CndCstmsMfListCondVO.java
*@FileTitle : CndCstmsMfListCondVO
*Open Issues :
*Change history :
...
public class CndCstmsMfDtlListCondVO extends ManifestListCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<CndCstmsMfDtlListCondVO> models = new ArrayList<CndCstmsMfDtlListCondVO>();
	...
	public CndCstmsMfDtlListCondVO() {}

	public CndCstmsMfDtlListCondVO(String ibflag, String pagerows, String total, String vslCd, String bkgCgoTpCd, String skdVoyNo, String blNo, String skdDirCd, String podCd, String bkgNo, String polCd, String sheetId, String blNos, String pageNo, String customs, String clptSeq) {
		this.total = total;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return CndCstmsMfDtlListCondVO[]
	 */
	public CndCstmsMfDtlListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CndCstmsMfDtlListCondVO[]
	 */
	public CndCstmsMfDtlListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CndCstmsMfDtlListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CndCstmsMfDtlListCondVO();
				if (total[i] != null)
		...
		return getCndCstmsMfDtlListCondVOs();
	}
	 ...
	 * @return CndCstmsMfDtlListCondVO[]
	 */
	public CndCstmsMfDtlListCondVO[] getCndCstmsMfDtlListCondVOs(){
		CndCstmsMfDtlListCondVO[] vos = (CndCstmsMfDtlListCondVO[])models.toArray(new CndCstmsMfDtlListCondVO[models.size()]);
		return vos;
	}
