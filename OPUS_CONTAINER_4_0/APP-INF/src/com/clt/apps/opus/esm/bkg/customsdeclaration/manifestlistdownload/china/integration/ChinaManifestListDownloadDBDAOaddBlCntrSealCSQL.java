...
*@FileName : ChinaManifestListDownloadDBDAOaddBlCntrSealCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOaddBlCntrSealCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOaddBlCntrSealCSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOaddBlCntrSealCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append(",@[seal_no]" ).append("\n");
		query.append(",TRIM(@[seal_knd_cd])" ).append("\n");
		query.append(",TRIM(@[seal_pty_tp_cd])" ).append("\n");
		query.append(",TRIM(@[seal_pty_nm])" ).append("\n");
		query.append(",@[cre_usr_id]" ).append("\n");
