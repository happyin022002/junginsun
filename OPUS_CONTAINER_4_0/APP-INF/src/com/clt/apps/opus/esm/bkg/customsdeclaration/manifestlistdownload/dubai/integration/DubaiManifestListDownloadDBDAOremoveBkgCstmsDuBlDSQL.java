...
*@FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsDuBlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DubaiManifestListDownloadDBDAOremoveBkgCstmsDuBlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DubaiManifestListDownloadDBDAOremoveBkgCstmsDuBlDSQL(){
		setQuery();
		...
		query.append("FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsDuBlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM BKG_CSTMS_DU_BL" ).append("\n"); 
