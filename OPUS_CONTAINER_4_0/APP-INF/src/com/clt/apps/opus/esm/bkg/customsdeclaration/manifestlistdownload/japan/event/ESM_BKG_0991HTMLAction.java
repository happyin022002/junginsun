...
public class ESM_BKG_0991HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if (command.isCommand(FormCommand.MULTI)) {
			...
			JapanManifestTransmitVO[] japanManifestTransmitVOs = new JapanManifestTransmitVO[1];
			japanManifestTransmitVOs[0] = (JapanManifestTransmitVO) getVO(request, JapanManifestTransmitVO.class);
