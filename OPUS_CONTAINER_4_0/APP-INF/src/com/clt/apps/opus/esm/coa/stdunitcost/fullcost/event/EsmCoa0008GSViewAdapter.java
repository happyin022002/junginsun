...
*@FileName : EsmCoa0008GSViewAdapter.java
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0008GSViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0008GSViewAdapter(){
    	super();
    }
	    ...
	    try{
		    ...
		    if(totCnt > 0){
	            for(int i=0; i<totCnt; i++){
					...
					strBuilder.append(">");
					strBuilder.append("\n    <TD>"+JSPUtil.getNull((String)colValues.get("lnk_fm_nod_cd"))+"</TD>");
					strBuilder.append("\n    <TD>"+JSPUtil.getNull((String)colValues.get("lnk_to_nod_cd"))+"</TD>");
