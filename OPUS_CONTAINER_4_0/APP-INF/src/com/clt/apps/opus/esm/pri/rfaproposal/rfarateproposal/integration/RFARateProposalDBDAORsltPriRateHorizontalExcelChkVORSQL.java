...
*@FileName : RFARateProposalDBDAORsltPriRateHorizontalExcelChkVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltPriRateHorizontalExcelChkVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * check RFA validation for upload
	  * </pre>
	  */
	public RFARateProposalDBDAORsltPriRateHorizontalExcelChkVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltPriRateHorizontalExcelChkVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          FROM PRI_RP_SCP_GRP_LOC G" ).append("\n"); 
