...
*@FileName : ESM_PRI_3509HTMLAction.java
...
public class ESM_PRI_3509HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3509HTMLAction 객체를 생성
	 */
	public ESM_PRI_3509HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3509Event event = new EsmPri3509Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPriTrfRuleHistoryVO((PriTrfRuleHistoryVO)getVO(request, PriTrfRuleHistoryVO .class));
