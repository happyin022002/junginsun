...
public class ExternalFinderDBDAOSearchContractNoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                #end" ).append("\n"); 
		query.append("                #if(${cond_flag} != '' && ${cond_flag} == 'Y')" ).append("\n"); 
		query.append("                   AND TO_CHAR(SYSDATE,'YYYYMMDD') BETWEEN TO_CHAR(FC.EFF_DT,'YYYYMMDD') AND TO_CHAR(FC.EXP_DT,'YYYYMMDD')" ).append("\n"); 
		query.append("                #end" ).append("\n"); 
		query.append("                 ORDER BY FC.CRE_DT DESC " ).append("\n"); 
		query.append("                 ) A" ).append("\n"); 
		query.append("         ORDER BY " ).append("\n"); 
		query.append("				 #if(${order_priority} != '' && ${order_priority} == 'TO')" ).append("\n"); 
