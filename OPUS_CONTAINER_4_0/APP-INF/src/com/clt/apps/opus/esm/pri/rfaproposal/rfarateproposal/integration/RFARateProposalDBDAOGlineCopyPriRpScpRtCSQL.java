...
*@FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOGlineCopyPriRpScpRtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOGlineCopyPriRpScpRtCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD, B.GLINE_SEQ, B.CMDT_HDR_SEQ, B.ROUT_SEQ" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.RT_SEQ) AS RT_SEQ" ).append("\n"); 
		...
		query.append(", PRI_RG_RT B" ).append("\n"); 
		query.append("WHERE B.SVC_SCP_CD = A.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   B.GLINE_SEQ = A.GLINE_SEQ" ).append("\n"); 
		query.append("AND   B.CMDT_HDR_SEQ = A.OLD_CMDT_HDR_SEQ" ).append("\n"); 
