...
*@FileName : SearchManhourListVO.java
*@FileTitle : SearchManhourListVO
*Open Issues :
*Change history :
...
public class SearchManhourListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchManhourListVO> models = new ArrayList<SearchManhourListVO>();
	...
	public SearchManhourListVO() {}

	public SearchManhourListVO(String ibflag, String pagerows, String slpTpCd, String slpFuncCd, String slpTeamCd, String slpIssDt, String slpSerNo, String slpSeqNo, String manHrListSeq, String orgManHrListSeq, String manHrItmNm, String portCd, String mgrWrkAmt, String mbrWrkAmt, String agnWrkAmt, String currCd, String csrSlpFlg) {
		this.ibflag = ibflag;
	...
	public SearchManhourListVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public SearchManhourListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchManhourListVO model = null;
		...
		return getSearchManhourListVOs();
	}

	public SearchManhourListVO[] getSearchManhourListVOs(){
		SearchManhourListVO[] vos = (SearchManhourListVO[])models.toArray(new SearchManhourListVO[models.size()]);
		return vos;
	}
