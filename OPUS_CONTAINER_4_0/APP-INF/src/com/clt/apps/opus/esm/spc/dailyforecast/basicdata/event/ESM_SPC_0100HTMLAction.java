...
public class ESM_SPC_0100HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		else if(command.isCommand(FormCommand.SEARCH01)) { //lane,bd,oit,port 
			event.setSpcFcastOfcPolMapgVO((SpcFcastOfcPolMapgVO)getVO(request, SpcFcastOfcPolMapgVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH02)) { //rgn ofc 
			event.setSpcFcastOfcPolMapgVO((SpcFcastOfcPolMapgVO)getVO(request, SpcFcastOfcPolMapgVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH03)) { //vvd 
