...
*@FileName : RocsManifestListDownloadDBDAOmodifyCrnNoForCmUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestListDownloadDBDAOmodifyCrnNoForCmUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestListDownloadDBDAOmodifyCrnNoForCmUSQL(){
		setQuery();
		...
		query.append("FileName : RocsManifestListDownloadDBDAOmodifyCrnNoForCmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_RTM_CGO_MF SET " ).append("\n"); 
