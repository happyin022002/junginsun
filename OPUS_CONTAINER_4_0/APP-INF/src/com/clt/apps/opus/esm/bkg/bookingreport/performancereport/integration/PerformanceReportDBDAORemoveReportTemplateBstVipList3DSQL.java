...
*@FileName : PerformanceReportDBDAORemoveReportTemplateBstVipList3DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAORemoveReportTemplateBstVipList3DSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Report Template User Set Remove
	  * </pre>
	  */
	public PerformanceReportDBDAORemoveReportTemplateBstVipList3DSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAORemoveReportTemplateBstVipList3DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
