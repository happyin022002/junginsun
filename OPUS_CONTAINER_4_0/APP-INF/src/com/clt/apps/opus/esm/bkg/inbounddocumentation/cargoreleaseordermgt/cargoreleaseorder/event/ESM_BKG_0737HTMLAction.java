...
*@FileName       : ESM_BKG_0737HTMLAction.java
...
public class ESM_BKG_0737HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0737HTMLAction 객체를 생성
	 */
	public ESM_BKG_0737HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0737Event event = new EsmBkg0737Event();

		if(command.isCommand(FormCommand.MULTI01)) {
            event.setEdoEdiTrans((EdoEdiTransVO[])getVOs(request, EdoEdiTransVO.class));
		}
