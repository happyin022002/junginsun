...
*@FileName       : SearchMonthlyQuotaInquiry0049Tab02VO.java
*@FileTitle      : SearchMonthlyQuotaInquiry0049Tab02VO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiry0049Tab02VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiry0049Tab02VO> models = new ArrayList<SearchMonthlyQuotaInquiry0049Tab02VO>();
	...
	public SearchMonthlyQuotaInquiry0049Tab02VO() {}

	public SearchMonthlyQuotaInquiry0049Tab02VO(String ibflag, String pagerows, String key, String slevel, String dirCd, String subTrdCd, String rlaneCd, String convDirCd, String rowSeq, String itemText, String item, String val00, String val01, String val02, String val03) {
		this.val01 = val01;
		this.val02 = val02;
		this.val00 = val00;
		this.val03 = val03;
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiry0049Tab02VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab02VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiry0049Tab02VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab02VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiry0049Tab02VO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiry0049Tab02VO();
				if (val01[i] != null)
		...
		return getSearchMonthlyQuotaInquiry0049Tab02VOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiry0049Tab02VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab02VO[] getSearchMonthlyQuotaInquiry0049Tab02VOs(){
		SearchMonthlyQuotaInquiry0049Tab02VO[] vos = (SearchMonthlyQuotaInquiry0049Tab02VO[])models.toArray(new SearchMonthlyQuotaInquiry0049Tab02VO[models.size()]);
		return vos;
	}
