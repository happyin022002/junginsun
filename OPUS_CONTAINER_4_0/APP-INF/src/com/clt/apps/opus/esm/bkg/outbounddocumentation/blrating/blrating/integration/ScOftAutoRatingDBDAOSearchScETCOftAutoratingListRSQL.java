...
*@FileName : ScOftAutoRatingDBDAOSearchScETCOftAutoratingListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScOftAutoRatingDBDAOSearchScETCOftAutoratingListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchScETCOftAutoratingList
	  * </pre>
	  */
	public ScOftAutoRatingDBDAOSearchScETCOftAutoratingListRSQL(){
		setQuery();
		setQuery2();
		setQuery3();
		setQuery4();
		...
		query.append("FileName : ScOftAutoRatingDBDAOSearchScETCOftAutoratingListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("										)" ).append("\n"); 
		query.append(") ," ).append("\n"); 
		query.append("OI AS" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	ORIGIN IHC" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("COMMODITY, D.CALL, VIA 가 없음." ).append("\n"); 
		query.append("ZIP CODE 는 추가로 존재함. ( ZIP CODE 는 사용하지 않기로 결정 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT  BQ.BQ_SEQ 							," ).append("\n"); 
		query.append("				OI.ADD_CHG_SEQ					," ).append("\n"); 
		query.append("				OI.ROUT_PNT_LOC_TP_CD		," ).append("\n"); 
		query.append("				OI.ROUT_PNT_LOC_DEF_CD	," ).append("\n"); 
		query.append("				OI.BSE_PORT_TP_CD				," ).append("\n"); 
		query.append("				OI.BSE_PORT_DEF_CD			," ).append("\n"); 
		query.append("				OI.VIA_PORT_TP_CD				," ).append("\n"); 
		query.append("				OI.VIA_PORT_DEF_CD			," ).append("\n"); 
		query.append("				OI.DIR_CALL_FLG					," ).append("\n"); 
		query.append("				OI.RAT_UT_CD						," ).append("\n"); 
		query.append("				OI.PRC_CGO_TP_CD				," ).append("\n"); 
		query.append("				OI.PRC_TRSP_MOD_CD			," ).append("\n"); 
		query.append("				OI.RCV_DE_TERM_CD				," ).append("\n"); 
		query.append("				OI.PRC_CMDT_TP_CD				," ).append("\n"); 
		query.append("				OI.PRC_CMDT_DEF_CD			," ).append("\n"); 
		query.append("				OI.CURR_CD							," ).append("\n"); 
		query.append("				OI.FNL_FRT_RT_AMT				," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				DECODE(OI.RAT_UT_CD, BQ.CTRT_CNTR_TPSZ_CD, 100, 'BX', 80, 60)" ).append("\n"); 
		query.append("				 	- DECODE(OI.RAT_UT_CD, '20', 10, '40', 10, 'HC', 10, '45', 10, '53', 10, 0)" ).append("\n"); 
		query.append("				 	+ DECODE(OI.PRC_CGO_TP_CD, BQ.DR_TP, 2, BQ.DG_TP, 2, BQ.RF_TP, 2, BQ.AK_TP, 2, BQ.BB_TP, 2, 0)" ).append("\n"); 
		query.append("				 	- DECODE(BQ.CTRT_CNTR_TPSZ_CD||BQ.AK_TP||OI.PRC_CGO_TP_CD, 'D7AKDR', 1, 0)	RAT_UT_MTCH_PRIO" ).append("\n"); 
		query.append("						/* D7/AK 가 D7/DR 과 D7/AK 중에 D7/AK 가 먼저 선택 될 수 있도록 D7/AK 면서 DR 운임적인된 경우 -1 을 해준다. */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("FROM    BQ  ," ).append("\n"); 
		query.append("        PRI_SP_SCP_TRSP_ADD_CHG   OI" ).append("\n"); 
		query.append("WHERE   OI.PROP_NO                = BQ.PROP_NO" ).append("\n"); 
		query.append("AND     OI.AMDT_SEQ               = BQ.AMDT_SEQ" ).append("\n"); 
		query.append("AND     OI.SVC_SCP_CD             = BQ.SVC_SCP_CD" ).append("\n"); 
		query.append("AND     OI.ADD_CHG_TP_CD          = 'I'" ).append("\n"); 
		query.append("AND     OI.ORG_DEST_TP_CD         = 'O'" ).append("\n"); 
		query.append("AND			OI.SRC_INFO_CD						<> 'AD'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	1.	 ORIGIN IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( OI.ROUT_PNT_LOC_TP_CD, OI.ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     NVL(OI.RCV_DE_TERM_CD, '*') IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("								SELECT 'S' CONV_PRC_TERM_CD, 'Y' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		query.append("								SELECT 'S' CONV_PRC_TERM_CD, 'T' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		query.append("								SELECT 'S' CONV_PRC_TERM_CD, 'I' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		query.append("								SELECT 'S' CONV_PRC_TERM_CD, 'L' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		query.append("								SELECT 'S' CONV_PRC_TERM_CD, '*' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						OI.PRC_TRSP_MOD_CD	IS NULL" ).append("\n"); 
		query.append("				OR	BQ.ORG_TRNS_MOD_CD	IS NULL" ).append("\n"); 
		query.append("				OR	OI.PRC_TRSP_MOD_CD	= BQ.ORG_TRNS_MOD_CD" ).append("\n"); 
		query.append("				OR  (" ).append("\n"); 
		query.append("								OI.PRC_TRSP_MOD_CD	IN ( 'R', 'A' )" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< BASE PORT ( POL ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( OI.BSE_PORT_TP_CD, OI.BSE_PORT_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	3.	ORIGIN IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN IHC RATING UNIT >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						OI.RAT_UT_CD	IN" ).append("\n"); 
		query.append("						(" ).append("\n"); 
		...
		query.append("						OR" ).append("\n"); 
		query.append("						(" ).append("\n"); 
		query.append("								OI.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("            AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = OI.RAT_UT_CD ) IN" ).append("\n"); 
		query.append("            		(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN IHC CARGO TYPE >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     NVL(OI.PRC_CGO_TP_CD, '*')  IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("								UNION ALL" ).append("\n"); 
		query.append("								/* TAW 일 경우 FAK 고려함 */" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POR OR POL ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< VIA PORT ( POL OR PRE RELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("SELECT  BQ.BQ_SEQ 							," ).append("\n"); 
		query.append("				DI.ADD_CHG_SEQ					," ).append("\n"); 
		query.append("				DI.ROUT_PNT_LOC_TP_CD		," ).append("\n"); 
		query.append("				DI.ROUT_PNT_LOC_DEF_CD	," ).append("\n"); 
		query.append("				DI.BSE_PORT_TP_CD				," ).append("\n"); 
		query.append("				DI.BSE_PORT_DEF_CD			," ).append("\n"); 
		query.append("				DI.VIA_PORT_TP_CD				," ).append("\n"); 
		query.append("				DI.VIA_PORT_DEF_CD			," ).append("\n"); 
		query.append("				DI.DIR_CALL_FLG					," ).append("\n"); 
		query.append("				DI.RAT_UT_CD						," ).append("\n"); 
		query.append("				DI.PRC_CGO_TP_CD				," ).append("\n"); 
		query.append("				DI.PRC_TRSP_MOD_CD			," ).append("\n"); 
		query.append("				DI.RCV_DE_TERM_CD				," ).append("\n"); 
		query.append("				DI.PRC_CMDT_TP_CD				," ).append("\n"); 
		query.append("				DI.PRC_CMDT_DEF_CD			," ).append("\n"); 
		query.append("				DI.CURR_CD							," ).append("\n"); 
		query.append("				DI.FNL_FRT_RT_AMT				," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				DECODE(DI.RAT_UT_CD, BQ.CTRT_CNTR_TPSZ_CD, 100, 'BX', 80, 60)" ).append("\n"); 
		query.append("				 	- DECODE(DI.RAT_UT_CD, '20', 10, '40', 10, 'HC', 10, '45', 10, '53', 10, 0)" ).append("\n"); 
		query.append("				 	+ DECODE(DI.PRC_CGO_TP_CD, BQ.DR_TP, 2, BQ.DG_TP, 2, BQ.RF_TP, 2, BQ.AK_TP, 2, BQ.BB_TP, 2, 0)" ).append("\n"); 
		query.append("				 	- DECODE(BQ.CTRT_CNTR_TPSZ_CD||BQ.AK_TP||DI.PRC_CGO_TP_CD, 'D7AKDR', 1, 0)	RAT_UT_MTCH_PRIO" ).append("\n"); 
		query.append("						/* D7/AK 가 D7/DR 과 D7/AK 중에 D7/AK 가 먼저 선택 될 수 있도록 D7/AK 면서 DR 운임적인된 경우 -1 을 해준다. */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("FROM    BQ  ," ).append("\n"); 
		query.append("        PRI_SP_SCP_TRSP_ADD_CHG   DI" ).append("\n"); 
		query.append("WHERE   DI.PROP_NO                = BQ.PROP_NO" ).append("\n"); 
		query.append("AND     DI.AMDT_SEQ               = BQ.AMDT_SEQ" ).append("\n"); 
		query.append("AND     DI.SVC_SCP_CD             = BQ.SVC_SCP_CD" ).append("\n"); 
		query.append("AND     DI.ADD_CHG_TP_CD          = 'I'" ).append("\n"); 
		query.append("AND     DI.ORG_DEST_TP_CD         = 'D'" ).append("\n"); 
		query.append("AND			DI.SRC_INFO_CD						<> 'AD'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	1.	 DEST IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( DEL ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( DI.ROUT_PNT_LOC_TP_CD, DI.ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     NVL(DI.RCV_DE_TERM_CD, '*') IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		query.append("				SELECT  B.RCV_DE_TERM_CD" ).append("\n"); 
		query.append("				FROM		NC_P A	," ).append("\n"); 
		query.append("								(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						DI.PRC_TRSP_MOD_CD	IS NULL" ).append("\n"); 
		query.append("				OR	BQ.DEST_TRNS_MOD_CD	IS NULL" ).append("\n"); 
		query.append("				OR	DI.PRC_TRSP_MOD_CD	= BQ.DEST_TRNS_MOD_CD" ).append("\n"); 
		query.append("				OR  (" ).append("\n"); 
		query.append("								DI.PRC_TRSP_MOD_CD	IN ( 'R', 'A' )" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< BASE PORT ( POD ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( DI.BSE_PORT_TP_CD, DI.BSE_PORT_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	3.	DEST IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DEST IHC RATING UNIT >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						DI.RAT_UT_CD	IN" ).append("\n"); 
		query.append("						(" ).append("\n"); 
		query.append("						SELECT	'BX'" ).append("\n"); 
		query.append("						FROM		DUAL" ).append("\n"); 
		query.append("						UNION ALL" ).append("\n"); 
		...
		query.append("						OR" ).append("\n"); 
		query.append("						(" ).append("\n"); 
		query.append("								DI.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("            AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = DI.RAT_UT_CD ) IN" ).append("\n"); 
		query.append("            		(" ).append("\n"); 
		query.append("								SELECT  A.CONV_RAT_UT_SZ_CD" ).append("\n"); 
		query.append("								FROM		NC_P A" ).append("\n"); 
		query.append("								WHERE		A.BQ_SEQ 						= BQ.BQ_SEQ" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DEST IHC CARGO TYPE >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     NVL(DI.PRC_CGO_TP_CD, '*')  IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		query.append("				SELECT	'*'" ).append("\n"); 
		query.append("				FROM		DUAL" ).append("\n"); 
		query.append("				UNION ALL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( DEL OR POD ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< VIA PORT ( POD OR POST RELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				/*******************************************************************************************" ).append("\n"); 
		query.append("				< ORIGIN ( POR OR POL OR BASE PORT ) >" ).append("\n"); 
		query.append("				*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				/*******************************************************************************************" ).append("\n"); 
		query.append("				< ORIGIN VIA ( POL OR PRE RELAY ) >" ).append("\n"); 
		query.append("				*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				/*******************************************************************************************" ).append("\n"); 
		query.append("				< DESTIANTION VIA ( POD OR POST RELAY ) >" ).append("\n"); 
		query.append("				*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("				/*******************************************************************************************" ).append("\n"); 
		query.append("				< DESTINATION ( DEL OR POD OR BASE PORT ) >" ).append("\n"); 
		query.append("				*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				RT.OV_ROUT_VIA_PORT_DEF_CD		POL_CD										," ).append("\n"); 
		...
		query.append("				RT.OV_ROUT_VIA_PORT_DEF_CD		OV_ROUT_VIA_PORT_DEF_CD		," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN ( POR OR POL ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("						)" ).append("\n"); 
		query.append("				OR	(" ).append("\n"); 
		query.append("								BQ.POR_CD										= BQ.POL_CD" ).append("\n"); 
		query.append("						AND	NVL(RT.OP_RCV_DE_TERM_CD, '*') IN" ).append("\n"); 
		query.append("								(" ).append("\n"); 
		query.append("								SELECT  B.RCV_DE_TERM_CD" ).append("\n"); 
		query.append("								FROM		(" ).append("\n"); 
		...
		query.append("												SELECT 'S' CONV_PRC_TERM_CD, '*' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		query.append("												SELECT 'D' CONV_PRC_TERM_CD, 'D' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		query.append("												SELECT 'D' CONV_PRC_TERM_CD, 'Y' RCV_DE_TERM_CD FROM DUAL UNION ALL	-- 예외 적용" ).append("\n"); 
		query.append("												SELECT 'T' CONV_PRC_TERM_CD, 'T' RCV_DE_TERM_CD FROM DUAL UNION ALL" ).append("\n"); 
		query.append("												SELECT 'I' CONV_PRC_TERM_CD, 'I' RCV_DE_TERM_CD FROM DUAL" ).append("\n"); 
		query.append("												)	B" ).append("\n"); 
		query.append("								WHERE		B.CONV_PRC_TERM_CD	= RT_DOR.CONV_PRC_RCV_TERM_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DESTINATION VIA ( POD ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DESTINATION (DEL OR POD ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("						)" ).append("\n"); 
		query.append("				OR	(" ).append("\n"); 
		query.append("								BQ.DEL_CD										= BQ.POD_CD" ).append("\n"); 
		query.append("						AND	NVL(RT.DP_RCV_DE_TERM_CD, '*') IN" ).append("\n"); 
		query.append("								(" ).append("\n"); 
		query.append("								SELECT  B.RCV_DE_TERM_CD" ).append("\n"); 
		query.append("								FROM		(" ).append("\n"); 
	...
	public void setQuery2(){
		...
		query.append("				AND     GC.PRC_CMDT_DEF_CD  		= RT_RAP.CONV_CMDT_DEF_CD" ).append("\n"); 
		query.append("				UNION ALL" ).append("\n"); 
		query.append("				/* TAE 일 경우 FAK 고려함 */" ).append("\n"); 
		query.append("				SELECT	'C', CMDT_CD" ).append("\n"); 
		query.append("				FROM		MDM_COMMODITY" ).append("\n"); 
		query.append("				WHERE		REP_CMDT_CD		= '0000'" ).append("\n"); 
		query.append("				UNION ALL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DESTINATION VIA ( POD OR POST RELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("						RT.DV_ROUT_VIA_PORT_DEF_CD IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5. PATTERN #5 ( 1000 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'1000'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
		...
		query.append("				RT.ROUT_SEQ										RT_ROUT_SEQ								," ).append("\n"); 
		query.append("				RT.RT_SEQ											RT_RT_SEQ									," ).append("\n"); 
		query.append("				OI.ADD_CHG_SEQ								OI_ADD_CHG_SEQ						," ).append("\n"); 
		query.append("				0															OA_ADD_CHG_SEQ						," ).append("\n"); 
		query.append("				0															DA_ADD_CHG_SEQ						," ).append("\n"); 
		query.append("				0															DI_ADD_CHG_SEQ						," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				RT.CM_PRC_CMDT_TP_CD					CM_PRC_CMDT_TP_CD					," ).append("\n"); 
		query.append("				RT.CM_PRC_CMDT_DEF_CD					CM_PRC_CMDT_DEF_CD				," ).append("\n"); 
		query.append("				OI.ROUT_PNT_LOC_DEF_CD				POR_CD										," ).append("\n"); 
		query.append("				RT.OP_ROUT_PNT_LOC_DEF_CD			POL_CD										," ).append("\n"); 
		query.append("				RT.DV_ROUT_VIA_PORT_DEF_CD		POD_CD										," ).append("\n"); 
		query.append("				RT.DP_ROUT_PNT_LOC_DEF_CD			DEL_CD										," ).append("\n"); 
		query.append("				NULL													DIR_CALL_FLG							," ).append("\n"); 
		query.append("				OI.RCV_DE_TERM_CD							RCV_TERM_CD								," ).append("\n"); 
		query.append("				RT.DP_RCV_DE_TERM_CD					DE_TERM_CD								," ).append("\n"); 
		query.append("				RT.RAT_UT_CD									RAT_UT_CD									," ).append("\n"); 
		query.append("				RT.PRC_CGO_TP_CD							PRC_CGO_TP_CD							," ).append("\n"); 
		query.append("				RT.CURR_CD										CURR_CD										," ).append("\n"); 
		query.append("				OI.PRC_TRSP_MOD_CD						ORG_TRSP_MOD_CD						," ).append("\n"); 
		query.append("				RT.DP_PRC_TRSP_MOD_CD					DEST_TRSP_MOD_CD					," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				RT.OP_ROUT_PNT_LOC_DEF_CD			OP_ROUT_PNT_LOC_DEF_CD		," ).append("\n"); 
		query.append("				RT.OV_ROUT_VIA_PORT_DEF_CD		OV_ROUT_VIA_PORT_DEF_CD		," ).append("\n"); 
		...
		query.append("				RT.FNL_FRT_RT_AMT							RT_FNL_FRT_RT_AMT					," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				OI.ROUT_PNT_LOC_DEF_CD				OI_ROUT_PNT_LOC_DEF_CD		," ).append("\n"); 
		query.append("				OI.BSE_PORT_DEF_CD						OI_BSE_PORT_DEF_CD				," ).append("\n"); 
		query.append("				OI.VIA_PORT_DEF_CD						OI_VIA_PORT_DEF_CD				," ).append("\n"); 
		query.append("				OI.DIR_CALL_FLG								OI_DIR_CALL_FLG						," ).append("\n"); 
		query.append("				OI.RAT_UT_CD									OI_RAT_UT_CD							," ).append("\n"); 
		query.append("				OI.PRC_CGO_TP_CD							OI_PRC_CGO_TP_CD					," ).append("\n"); 
		query.append("				OI.PRC_TRSP_MOD_CD						OI_PRC_TRSP_MOD_CD				," ).append("\n"); 
		query.append("				OI.RCV_DE_TERM_CD							OI_RCV_DE_TERM_CD					," ).append("\n"); 
		query.append("				OI.PRC_CMDT_DEF_CD						OI_PRC_CMDT_DEF_CD				," ).append("\n"); 
		query.append("				OI.CURR_CD										OI_CURR_CD								," ).append("\n"); 
		query.append("				OI.FNL_FRT_RT_AMT							OI_FNL_FRT_RT_AMT					," ).append("\n"); 
		query.append("				OI.RAT_UT_MTCH_PRIO						OI_RAT_UT_MTCH_PRIO				," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				NULL													OA_ROUT_PNT_LOC_DEF_CD		," ).append("\n"); 
		query.append("				NULL													OA_BSE_PORT_DEF_CD				," ).append("\n"); 
		query.append("				NULL													OA_VIA_PORT_DEF_CD				," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("WHERE		RT.BQ_SEQ		=	BQ.BQ_SEQ" ).append("\n"); 
		query.append("AND			OI.BQ_SEQ		= BQ.BQ_SEQ" ).append("\n"); 
		query.append("AND			RT_RAP.BQ_SEQ	= RT.BQ_SEQ AND RT_RAP.NOTE_CONV_RULE_CD = 'RAP' AND ( RT_RAP.BKG_CONV_TP_CD = 'B' OR RT_RAP.NC_SEQ = RT.RAP_NC_SEQ )" ).append("\n"); 
		query.append("AND			RT_RAR.BQ_SEQ	= RT.BQ_SEQ AND RT_RAR.NOTE_CONV_RULE_CD = 'RAR' AND ( RT_RAR.BKG_CONV_TP_CD = 'B' OR RT_RAR.NC_SEQ = RT.RAR_NC_SEQ )" ).append("\n"); 
		query.append("AND			RT_DOR.BQ_SEQ	= RT.BQ_SEQ AND RT_DOR.NOTE_CONV_RULE_CD = 'DOR' AND ( RT_DOR.BKG_CONV_TP_CD = 'B' OR RT_DOR.NC_SEQ = RT.DOR_NC_SEQ )" ).append("\n"); 
		query.append("AND			RT_TYP.BQ_SEQ	= RT.BQ_SEQ AND RT_TYP.NOTE_CONV_RULE_CD = 'TYP' AND ( RT_TYP.BKG_CONV_TP_CD = 'B' OR RT_TYP.NC_SEQ = RT.TYP_NC_SEQ )" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("	(주의)" ).append("\n"); 
		query.append("	COMMODITY 나 RATING UNIT 등의 조건이 위의 OA, DA, RT 와 중복조건으로 보일 수 있으나," ).append("\n"); 
		query.append("	OA, DA, RT 는 CONVERSION 이 정확하게 적용한 것이 아니므로, 다시한번 정확하게 조건을 연결해야 한다." ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN ( POL ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( RT.OP_ROUT_PNT_LOC_TP_CD, RT.OP_ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DESTINATION ( DEL ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( RT.DP_ROUT_PNT_LOC_TP_CD, RT.DP_ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.2 ORIGIN IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.2.2 ORIGIN IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POR ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.2.3 ORIGIN IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								OI.RAT_UT_CD	= OA_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		query.append("		        OR	OI.RAT_UT_CD	= 'BX'" ).append("\n"); 
		query.append("		        OR" ).append("\n"); 
		query.append("    		    (" ).append("\n"); 
		query.append("        				OI.RAT_UT_CD	IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("       			AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = OI.RAT_UT_CD )	= OA_TYP.CONV_RAT_UT_SZ_CD" ).append("\n"); 
		query.append("        		)" ).append("\n"); 
		query.append("				)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB CARGO TYPE */" ).append("\n"); 
		query.append("AND			NVL(OI.PRC_CGO_TP_CD, '*')	IN ( '*', OA_RAC.CONV_DR_TP, OA_RAC.CONV_DG_TP, OA_RAC.CONV_RF_TP, OA_RAC.CONV_AK_TP, OA_RAC.CONV_BB_TP )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	5.2.4 ORIGIN IHC - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( ARB CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ARB_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( OIHC.BPORT = RATE.DEST ) */" ).append("\n"); 
		query.append("AND			NVL(RT.OP_RCV_DE_TERM_CD, '*' )	NOT IN ( 'D', 'S' )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			( RT.OP_ROUT_PNT_LOC_TP_CD, RT.OP_ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		query.append("				SELECT	OI.BSE_PORT_TP_CD, OI.BSE_PORT_DEF_CD" ).append("\n"); 
		query.append("				FROM		DUAL" ).append("\n"); 
		query.append("				UNION ALL" ).append("\n"); 
		query.append("				SELECT	'L', GL.LOC_CD" ).append("\n"); 
		query.append("				FROM		GL" ).append("\n"); 
		query.append("				WHERE		OI.BSE_PORT_TP_CD	= 'G'" ).append("\n"); 
		query.append("				AND		  GL.PRC_GRP_LOC_CD	= OI.BSE_PORT_DEF_CD" ).append("\n"); 
		query.append("				UNION ALL" ).append("\n"); 
		query.append("				SELECT	'G', GL.PRC_GRP_LOC_CD" ).append("\n"); 
		query.append("				FROM		GL" ).append("\n"); 
		query.append("				WHERE		OI.BSE_PORT_TP_CD	= 'L'" ).append("\n"); 
		query.append("				AND			GL.LOC_CD					= OI.BSE_PORT_DEF_CD" ).append("\n"); 
		query.append("				)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6. PATTERN #6 ( 1100 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'1100'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
		...
		query.append("				RT.CM_PRC_CMDT_DEF_CD					CM_PRC_CMDT_DEF_CD				," ).append("\n"); 
		query.append("				OI.ROUT_PNT_LOC_DEF_CD				POR_CD										," ).append("\n"); 
		query.append("				OA.ROUT_PNT_LOC_DEF_CD				POL_CD										," ).append("\n"); 
		query.append("				RT.DV_ROUT_VIA_PORT_DEF_CD		POD_CD										," ).append("\n"); 
		query.append("				RT.DP_ROUT_PNT_LOC_DEF_CD			DEL_CD										," ).append("\n"); 
		query.append("				OA.DIR_CALL_FLG								DIR_CALL_FLG							," ).append("\n"); 
		query.append("				OI.RCV_DE_TERM_CD							RCV_TERM_CD								," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("	(주의)" ).append("\n"); 
		query.append("	COMMODITY 나 RATING UNIT 등의 조건이 위의 OA, DA, RT 와 중복조건으로 보일 수 있으나," ).append("\n"); 
		query.append("	OA, DA, RT 는 CONVERSION 이 정확하게 적용한 것이 아니므로, 다시한번 정확하게 조건을 연결해야 한다." ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN VIA ( PRE RELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("						RT.OV_ROUT_VIA_PORT_DEF_CD IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.2 ORIGIN IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.2.2 ORIGIN IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POR ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.2.3 ORIGIN IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.3 ORIGIN ARB" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.3.1 ORIGIN ARB - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						OA.PRC_CMDT_DEF_CD	IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.3.2 ORIGIN ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POL ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( OA.ROUT_PNT_LOC_TP_CD, OA.ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< VIA PORT ( PRE RELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("        		OA.VIA_PORT_DEF_CD  IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.3.3 ORIGIN ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	6.3.4 ORIGIN ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( ARB CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ARB_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7. PATTERN #7 ( 1010 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'1010'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
		...
		query.append("				OI.ROUT_PNT_LOC_DEF_CD				POR_CD										," ).append("\n"); 
		query.append("				RT.OP_ROUT_PNT_LOC_DEF_CD			POL_CD										," ).append("\n"); 
		query.append("				RT.DP_ROUT_PNT_LOC_DEF_CD			POD_CD										," ).append("\n"); 
		query.append("				DA.ROUT_PNT_LOC_DEF_CD				DEL_CD										," ).append("\n"); 
		query.append("				DA.DIR_CALL_FLG								DIR_CALL_FLG							," ).append("\n"); 
		query.append("				OI.RCV_DE_TERM_CD							RCV_TERM_CD								," ).append("\n"); 
		query.append("				DA.RCV_DE_TERM_CD							DE_TERM_CD								," ).append("\n"); 
	...
	public void setQuery3(){
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("	(주의)" ).append("\n"); 
		query.append("	COMMODITY 나 RATING UNIT 등의 조건이 위의 OA, DA, RT 와 중복조건으로 보일 수 있으나," ).append("\n"); 
		query.append("	OA, DA, RT 는 CONVERSION 이 정확하게 적용한 것이 아니므로, 다시한번 정확하게 조건을 연결해야 한다." ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN ( POL ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DESTINATION VIA ( POD OR POST REALY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("						RT.DV_ROUT_VIA_PORT_DEF_CD IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.2 ORIGIN IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.2.2 ORIGIN IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POR ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.2.3 ORIGIN IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.2.4 ORIGIN ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( ARB CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ARB_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( DIHC.BPORT = RATE.DEST ) */" ).append("\n"); 
		query.append("AND			NVL(RT.OP_RCV_DE_TERM_CD, '*' )	NOT IN ( 'D', 'S' )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			( RT.OP_ROUT_PNT_LOC_TP_CD, RT.OP_ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.3.2 DEST ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< VIA PORT ( POD OR POST RELAY ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.2.3 DEST ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	7.2.4 DEST ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB JOIN ( ADD CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ADD_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8. PATTERN #8 ( 1110 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'1110'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("	(주의)" ).append("\n"); 
		query.append("	COMMODITY 나 RATING UNIT 등의 조건이 위의 OA, DA, RT 와 중복조건으로 보일 수 있으나," ).append("\n"); 
		query.append("	OA, DA, RT 는 CONVERSION 이 정확하게 적용한 것이 아니므로, 다시한번 정확하게 조건을 연결해야 한다." ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN VIA ( PRE PELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("						RT.OV_ROUT_VIA_PORT_DEF_CD IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.2 ORIGIN IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.2.2 ORIGIN IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POR ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.2.3 ORIGIN IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.3 ORIGIN ARB" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.3.1 ORIGIN ARB - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						OA.PRC_CMDT_DEF_CD	IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.3.2 ORIGIN ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POL ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.3.3 ORIGIN ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.3.4 ORIGIN ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( ARB CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ARB_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.4 DEST ARB" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.4.1 DEST ARB - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						DA.PRC_CMDT_DEF_CD	IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.4.2 DEST ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< VIA PORT ( POD OR POST RELAY ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.4.3 DEST ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	8.4.4 DEST ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB JOIN ( ADD CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ADD_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9. PATTERN #9 ( 0001 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'0001'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
		...
		query.append("				0															OA_ADD_CHG_SEQ						," ).append("\n"); 
		query.append("				0															DA_ADD_CHG_SEQ						," ).append("\n"); 
		query.append("				DI.ADD_CHG_SEQ								DI_ADD_CHG_SEQ						," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				RT.GEN_SPCL_RT_TP_CD					RT_GEN_SPCL_RT_TP_CD			," ).append("\n"); 
		query.append("				RT.CM_PRC_CMDT_TP_CD					CM_PRC_CMDT_TP_CD					," ).append("\n"); 
		query.append("				RT.CM_PRC_CMDT_DEF_CD					CM_PRC_CMDT_DEF_CD				," ).append("\n"); 
		...
		query.append("				RT.OV_ROUT_VIA_PORT_DEF_CD		POL_CD										," ).append("\n"); 
		query.append("				RT.DV_ROUT_VIA_PORT_DEF_CD		POD_CD										," ).append("\n"); 
		query.append("				DI.ROUT_PNT_LOC_DEF_CD				DEL_CD										," ).append("\n"); 
		query.append("				NULL													DIR_CALL_FLG							," ).append("\n"); 
		query.append("				RT.OP_RCV_DE_TERM_CD					RCV_TERM_CD								," ).append("\n"); 
		query.append("				DI.RCV_DE_TERM_CD							DE_TERM_CD								," ).append("\n"); 
		query.append("				RT.RAT_UT_CD									RAT_UT_CD									," ).append("\n"); 
		query.append("				RT.PRC_CGO_TP_CD							PRC_CGO_TP_CD							," ).append("\n"); 
		query.append("				RT.CURR_CD										CURR_CD										," ).append("\n"); 
		query.append("				RT.OP_PRC_TRSP_MOD_CD					ORG_TRSP_MOD_CD						," ).append("\n"); 
		query.append("				DI.PRC_TRSP_MOD_CD						DEST_TRSP_MOD_CD					," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				RT.OP_ROUT_PNT_LOC_DEF_CD			OP_ROUT_PNT_LOC_DEF_CD		," ).append("\n"); 
		query.append("				RT.OV_ROUT_VIA_PORT_DEF_CD		OV_ROUT_VIA_PORT_DEF_CD		," ).append("\n"); 
		query.append("				RT.DV_ROUT_VIA_PORT_DEF_CD		DV_ROUT_VIA_PORT_DEF_CD		," ).append("\n"); 
		...
		query.append("				NULL													DA_RAT_UT_MTCH_PRIO				," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				DI.ROUT_PNT_LOC_DEF_CD				DI_ROUT_PNT_LOC_DEF_CD		," ).append("\n"); 
		query.append("				DI.BSE_PORT_DEF_CD						DI_BSE_PORT_DEF_CD				," ).append("\n"); 
		query.append("				DI.VIA_PORT_DEF_CD						DI_VIA_PORT_DEF_CD				," ).append("\n"); 
		query.append("				DI.DIR_CALL_FLG								DI_DIR_CALL_FLG						," ).append("\n"); 
		query.append("				DI.RAT_UT_CD									DI_RAT_UT_CD							," ).append("\n"); 
		query.append("				DI.PRC_CGO_TP_CD							DI_PRC_CGO_TP_CD					," ).append("\n"); 
		query.append("				DI.PRC_TRSP_MOD_CD						DI_PRC_TRSP_MOD_CD				," ).append("\n"); 
		query.append("				DI.RCV_DE_TERM_CD							DI_RCV_DE_TERM_CD					," ).append("\n"); 
		query.append("				DI.PRC_CMDT_DEF_CD						DI_PRC_CMDT_DEF_CD				," ).append("\n"); 
		query.append("				DI.CURR_CD										DI_CURR_CD								," ).append("\n"); 
		query.append("				DI.FNL_FRT_RT_AMT							DI_FNL_FRT_RT_AMT					," ).append("\n"); 
		query.append("				DI.RAT_UT_MTCH_PRIO						DI_RAT_UT_MTCH_PRIO				," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				RT_RAP.BKG_CONV_TP_CD      		RT_RAP_BKG_CONV_TP_CD			," ).append("\n"); 
		query.append("				RT_RAP.NOTE_CONV_MAPG_ID   		RT_RAP_NOTE_CONV_MAPG_ID  ," ).append("\n"); 
		query.append("				RT_RAP.NOTE_CONV_SEQ       		RT_RAP_NOTE_CONV_SEQ      ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("WHERE		RT.BQ_SEQ		=	BQ.BQ_SEQ" ).append("\n"); 
		query.append("AND			DI.BQ_SEQ		= BQ.BQ_SEQ" ).append("\n"); 
		query.append("AND			RT_RAP.BQ_SEQ	= RT.BQ_SEQ AND RT_RAP.NOTE_CONV_RULE_CD = 'RAP' AND ( RT_RAP.BKG_CONV_TP_CD = 'B' OR RT_RAP.NC_SEQ = RT.RAP_NC_SEQ )" ).append("\n"); 
		query.append("AND			RT_RAR.BQ_SEQ	= RT.BQ_SEQ AND RT_RAR.NOTE_CONV_RULE_CD = 'RAR' AND ( RT_RAR.BKG_CONV_TP_CD = 'B' OR RT_RAR.NC_SEQ = RT.RAR_NC_SEQ )" ).append("\n"); 
		query.append("AND			RT_DOR.BQ_SEQ	= RT.BQ_SEQ AND RT_DOR.NOTE_CONV_RULE_CD = 'DOR' AND ( RT_DOR.BKG_CONV_TP_CD = 'B' OR RT_DOR.NC_SEQ = RT.DOR_NC_SEQ )" ).append("\n"); 
		query.append("AND			RT_TYP.BQ_SEQ	= RT.BQ_SEQ AND RT_TYP.NOTE_CONV_RULE_CD = 'TYP' AND ( RT_TYP.BKG_CONV_TP_CD = 'B' OR RT_TYP.NC_SEQ = RT.TYP_NC_SEQ )" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< COMMODITY >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN ( POR ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( RT.OP_ROUT_PNT_LOC_TP_CD, RT.OP_ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DESTINATION ( POD ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     ( RT.DP_ROUT_PNT_LOC_TP_CD, RT.DP_ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.2 DEST IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.2.2 DEST ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< BASE PORT ( POD ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.2.3 DEST ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								DI.RAT_UT_CD	= DA_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		query.append("		        OR	DI.RAT_UT_CD	= 'BX'" ).append("\n"); 
		query.append("		        OR" ).append("\n"); 
		query.append("    		    (" ).append("\n"); 
		query.append("        				DI.RAT_UT_CD	IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		query.append("       			AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = DI.RAT_UT_CD )	= DA_TYP.CONV_RAT_UT_SZ_CD" ).append("\n"); 
		query.append("        		)" ).append("\n"); 
		query.append("				)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB CARGO TYPE */" ).append("\n"); 
		query.append("AND			NVL(DI.PRC_CGO_TP_CD, '*')	IN ( '*', DA_RAC.CONV_DR_TP, DA_RAC.CONV_DG_TP, DA_RAC.CONV_RF_TP, DA_RAC.CONV_AK_TP, DA_RAC.CONV_BB_TP )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	9.2.4 DEST ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB JOIN ( ADD CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ADD_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("AND			( RT.DP_ROUT_PNT_LOC_TP_CD, RT.DP_ROUT_PNT_LOC_DEF_CD ) IN" ).append("\n"); 
		query.append("				(" ).append("\n"); 
		query.append("				SELECT	DI.BSE_PORT_TP_CD, DI.BSE_PORT_DEF_CD" ).append("\n"); 
		query.append("				FROM		DUAL" ).append("\n"); 
		query.append("				UNION ALL" ).append("\n"); 
		query.append("				SELECT	'L', GL.LOC_CD" ).append("\n"); 
		query.append("				FROM		GL" ).append("\n"); 
		query.append("				WHERE		DI.BSE_PORT_TP_CD	= 'G'" ).append("\n"); 
		query.append("				AND		  GL.PRC_GRP_LOC_CD	= DI.BSE_PORT_DEF_CD" ).append("\n"); 
		query.append("				UNION ALL" ).append("\n"); 
		query.append("				SELECT	'G', GL.PRC_GRP_LOC_CD" ).append("\n"); 
		query.append("				FROM		GL" ).append("\n"); 
		query.append("				WHERE		DI.BSE_PORT_TP_CD	= 'L'" ).append("\n"); 
		query.append("				AND			GL.LOC_CD					= DI.BSE_PORT_DEF_CD" ).append("\n"); 
		query.append("				)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10. PATTERN #10 ( 0101 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'0101'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< COMMODITY >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN VIA ( POL OR PRE RELAY ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.2 ORIGIN ARB" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.2.1 ORIGIN ARB - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						OA.PRC_CMDT_DEF_CD	IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.2.2 ORIGIN ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POR ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.2.3 ORIGIN ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.2.4 ORIGIN ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( ARB CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ARB_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.3 DEST IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.3.2 DEST ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< BASE PORT ( POD ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.3.3 DEST ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	10.3.4 DEST ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB JOIN ( ADD CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ADD_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11. PATTERN #11 ( 0011 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'0011'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
		...
		query.append("				RT.OP_ROUT_PNT_LOC_DEF_CD			POR_CD										," ).append("\n"); 
		query.append("				RT.OV_ROUT_VIA_PORT_DEF_CD		POL_CD										," ).append("\n"); 
		query.append("				DA.ROUT_PNT_LOC_DEF_CD				POD_CD										," ).append("\n"); 
		query.append("				DI.ROUT_PNT_LOC_DEF_CD				DEL_CD										," ).append("\n"); 
		query.append("				DA.DIR_CALL_FLG								DIR_CALL_FLG							," ).append("\n"); 
		query.append("				RT.OP_RCV_DE_TERM_CD					RCV_TERM_CD								," ).append("\n"); 
		query.append("				DI.RCV_DE_TERM_CD							DE_TERM_CD								," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< COMMODITY >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN ( POR ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DESTINATION VIA ( POST RELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("						RT.DV_ROUT_VIA_PORT_DEF_CD IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2 DEST ARB" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2.1 DEST ARB - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						DA.PRC_CMDT_DEF_CD	IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2.2 DEST ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DEST VIA PORT ( POST RELAY ) >" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("                DA.VIA_PORT_DEF_CD  IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2.3 DEST ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2.4 DEST ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB JOIN ( ADD CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ADD_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2 DEST IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2.2 DEST IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( DEL ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	11.2.3 DEST IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12. PATTERN #12 ( 0111 )" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT	'0111'												PRC_RT_MTCH_PATT_CD				," ).append("\n"); 
		query.append("				BQ.SC_NO											CTRT_NO										," ).append("\n"); 
		query.append("				BQ.PROP_NO										PROP_NO										," ).append("\n"); 
		query.append("				BQ.AMDT_SEQ										AMDT_SEQ									," ).append("\n"); 
		query.append("				BQ.SVC_SCP_CD									SVC_SCP_CD								," ).append("\n"); 
	...
	public void setQuery4(){
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.1 RATE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.1.1 RATE - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< COMMODITY >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.1.2 RATE - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< ORIGIN VIA ( POL OR PRE RELAY ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.1.3 RATE - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		query.append("								RT.RAT_UT_CD	= RT_TYP.CONV_RAT_UT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2 ORIGIN ARB" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2.1 ORIGIN ARB - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						OA.PRC_CMDT_DEF_CD	IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2.2 ORIGIN ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( POR ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2.3 ORIGIN ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2.4 ORIGIN ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* ORIGIN ARB JOIN ( ARB CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ARB_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.3 DEST ARB" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.3.1 DEST ARB - COMMODITY" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			(" ).append("\n"); 
		query.append("						DA.PRC_CMDT_DEF_CD	IS NULL" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.3.2 DEST ARB - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< DEST VIA PORT ( POST RELAY ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.3.3 DEST ARB - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.3.4 DEST ARB - JOIN" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB JOIN ( ADD CONV RULE ) */" ).append("\n"); 
		query.append("AND			DECODE(RT.ADD_RT_APPL_TP_CD, NULL, DECODE(RT.GEN_SPCL_RT_TP_CD, 'S', 'N', 'Y'), 'N', 'N', 'Y') = 'Y'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2 DEST IHC" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2.2 DEST IHC - ROUTE" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("< POINT ( DEL ) >" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		query.append("	12.2.3 DEST IHC - RATING UNIT" ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* DEST ARB RATING UNIT */" ).append("\n"); 
		query.append("AND     (" ).append("\n"); 
