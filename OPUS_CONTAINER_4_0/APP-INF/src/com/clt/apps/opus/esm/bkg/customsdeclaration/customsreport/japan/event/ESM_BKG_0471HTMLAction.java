...
*@FileName : ESM_BKG_0471HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0471HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0471HTMLAction 객체를 생성
	 */
	public ESM_BKG_0471HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0471Event event = new EsmBkg0471Event();
    	RcvHistCondVO rcvHistCondVO = new RcvHistCondVO();
    	ReceiveLogVO receiveLogVO = new ReceiveLogVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			rcvHistCondVO = (JapanRcvHistCondVO)getVO(request, JapanRcvHistCondVO.class);
			event.setJapanRcvHistCondVO((JapanRcvHistCondVO)rcvHistCondVO);
		} else if(command.isCommand(FormCommand.MODIFY)) {
			receiveLogVO = (JapanReceiveLogVO)getVO(request, JapanReceiveLogVO.class);
			event.setJapanReceiveLogVO((JapanReceiveLogVO)receiveLogVO);
		}
