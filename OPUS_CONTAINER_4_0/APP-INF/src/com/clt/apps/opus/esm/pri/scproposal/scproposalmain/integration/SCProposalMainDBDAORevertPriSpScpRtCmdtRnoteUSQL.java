...
*@FileName : SCProposalMainDBDAORevertPriSpScpRtCmdtRnoteUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpScpRtCmdtRnoteUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpScpRtCmdtRnoteUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpScpRtCmdtRnoteUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_RT_CMDT_RNOTE" ).append("\n"); 
