...
*@FileName : RocsRcvHistCondVO.java
*@FileTitle : RocsRcvHistCondVO
*Open Issues :
*Change history :
...
public class RocsRcvHistCondVO extends RcvHistCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsRcvHistCondVO> models = new ArrayList<RocsRcvHistCondVO>();
	...
	public RocsRcvHistCondVO() {}

	public RocsRcvHistCondVO(String ibflag, String pagerows, String msgType, String blNo, String vpsEtaStartDt, String vpsEtaEndDt, String dateGubun, String fromtime, String totime, String vslCd, String skdVoyNo, String skdDirCd, String polCd, String podCd) {
		this.vslCd = vslCd;
	 ...
	 */
	public RocsRcvHistCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsRcvHistCondVO[]
	 */
	public RocsRcvHistCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsRcvHistCondVO model = null;
	 ...
	 * @return RocsRcvHistCondVO[]
	 */
	public RocsRcvHistCondVO[] getRocsRcvHistCondVOs(){
		RocsRcvHistCondVO[] vos = (RocsRcvHistCondVO[])models.toArray(new RocsRcvHistCondVO[models.size()]);
		return vos;
	}
