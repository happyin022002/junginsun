...
*@FileName : ESM_BKG_0916HTMLAction.java
...
public class ESM_BKG_0916HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0916HTMLAction 객체를 생성
	 */
	public ESM_BKG_0916HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0916Event event = new EsmBkg0916Event();

		if(command.isCommand(FormCommand.MULTI)) {
			event.setCllRfAkCgoDetailVOS((CllRfAkCgoDetailVO[])getVOs(request, CllRfAkCgoDetailVO .class,""));
		}
