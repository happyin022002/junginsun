...
*@FileName : TransshipmentMgtDBDAOaddBkgVslDchgYdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransshipmentMgtDBDAOaddBkgVslDchgYdCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * bkg_vsl_dchg_yd에 insert한다.
	  * </pre>
	  */
	public TransshipmentMgtDBDAOaddBkgVslDchgYdCSQL(){
		setQuery();
		...
		query.append("FileName : TransshipmentMgtDBDAOaddBkgVslDchgYdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO bkg_vsl_dchg_yd (" ).append("\n"); 
		...
		query.append(",	@[skd_voy_no]" ).append("\n"); 
		query.append(",	@[skd_dir_cd]" ).append("\n"); 
		query.append(",	@[skd_call_seq]" ).append("\n"); 
