...
*@FileName : OTRCommAuditDBDAOAuditCancelOtrAGNCommAuditUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class OTRCommAuditDBDAOAuditCancelOtrAGNCommAuditUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AuditCancelOtrAGNCommAudit
	  * </pre>
	  */
	public OTRCommAuditDBDAOAuditCancelOtrAGNCommAuditUSQL(){
		setQuery();
		...
		query.append("/*").append("\n");
		query.append("Path : com.clt.apps.opus.esm.acm.acmaudit.otrcommaudit.integration").append("\n");
		query.append("FileName : OTRCommAuditDBDAOAuditCancelOtrAGNCommAuditUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("UPDATE ACM_AGN_OTR_COMM U" ).append("\n");
		query.append("SET" ).append("\n");
		query.append("(" ).append("\n");
		query.append("    U.AC_STS_CD," ).append("\n");
		...
		query.append("=" ).append("\n");
		query.append("(" ).append("\n");
		query.append("SELECT 'AR' AS AC_STS_CD," ).append("\n");
		...
		query.append(" WHERE A.OTR_COMM_NO = U.OTR_COMM_NO" ).append("\n");
		...
		query.append(")" ).append("\n");
		query.append("WHERE U.OTR_COMM_NO = @[otr_comm_no]" ).append("\n");
