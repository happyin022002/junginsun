...
*@FileName : ACMSimulationDBDAOAddAcmSimCommFxCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAddAcmSimCommFxCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOAddAcmSimCommFxCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAddAcmSimCommFxCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", ROUND( @[pay_fx_comm],2)                      AS PAY_CRNT_AMT" ).append("\n"); 
		query.append(", ROUND( @[pay_fx_comm],2) - @[ppd_pay_crnt_amt] AS PAY_IF_AMT" ).append("\n"); 
