...
*@FileName : BookingUtilDBDAOSearchPrdReplanCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingUtilDBDAOSearchPrdReplanCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingUtilDBDAOSearchPrdReplanCode
	  * </pre>
	  */
	public BookingUtilDBDAOSearchPrdReplanCodeRSQL(){
		setQuery();
		...
		query.append("FileName : BookingUtilDBDAOSearchPrdReplanCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
