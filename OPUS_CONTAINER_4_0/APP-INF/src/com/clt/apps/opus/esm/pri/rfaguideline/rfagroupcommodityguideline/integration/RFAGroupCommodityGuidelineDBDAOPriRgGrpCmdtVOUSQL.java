...
*@FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVOUSQL.java
...
public class RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RG_GRP_CMDT SET" ).append("\n"); 
