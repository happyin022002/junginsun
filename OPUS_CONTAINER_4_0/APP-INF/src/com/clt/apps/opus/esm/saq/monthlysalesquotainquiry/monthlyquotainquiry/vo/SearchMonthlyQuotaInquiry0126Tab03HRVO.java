...
*@FileName       : SearchMonthlyQuotaInquiry0126Tab03HRVO.java
*@FileTitle      : SearchMonthlyQuotaInquiry0126Tab03HRVO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiry0126Tab03HRVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiry0126Tab03HRVO> models = new ArrayList<SearchMonthlyQuotaInquiry0126Tab03HRVO>();
	...
	public SearchMonthlyQuotaInquiry0126Tab03HRVO() {}

	public SearchMonthlyQuotaInquiry0126Tab03HRVO(String ibflag, String pagerows, String key, String slevel, String dirCd, String rhqCd, String aqCd, String ofcCd, String subTrdCd, String rlaneCd, String convDirCd, String rowSeq, String itemText, String item, String val00, String val01, String val02, String val03) {
		this.val01 = val01;
		this.val02 = val02;
		this.val00 = val00;
		this.rhqCd = rhqCd;
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiry0126Tab03HRVO[]
	 */
	public SearchMonthlyQuotaInquiry0126Tab03HRVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiry0126Tab03HRVO[]
	 */
	public SearchMonthlyQuotaInquiry0126Tab03HRVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiry0126Tab03HRVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiry0126Tab03HRVO();
				if (val01[i] != null)
		...
		return getSearchMonthlyQuotaInquiry0126Tab03HRVOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiry0126Tab03HRVO[]
	 */
	public SearchMonthlyQuotaInquiry0126Tab03HRVO[] getSearchMonthlyQuotaInquiry0126Tab03HRVOs(){
		SearchMonthlyQuotaInquiry0126Tab03HRVO[] vos = (SearchMonthlyQuotaInquiry0126Tab03HRVO[])models.toArray(new SearchMonthlyQuotaInquiry0126Tab03HRVO[models.size()]);
		return vos;
	}
