...
*@FileName : BRKGAuditDBDAOModifyBRKGCommInfoAgtBrogCommDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BRKGAuditDBDAOModifyBRKGCommInfoAgtBrogCommDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyBRKGCommInfoAgtBrogComm
	  * </pre>
	  */
	public BRKGAuditDBDAOModifyBRKGCommInfoAgtBrogCommDSQL(){
		setQuery();
		...
		query.append("FileName : BRKGAuditDBDAOModifyBRKGCommInfoAgtBrogCommDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
