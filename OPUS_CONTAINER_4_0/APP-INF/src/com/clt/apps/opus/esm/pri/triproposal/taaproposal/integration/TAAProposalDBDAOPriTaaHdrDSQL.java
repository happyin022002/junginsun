...
*@FileName : TAAProposalDBDAOPriTaaHdrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TAAProposalDBDAOPriTaaHdrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TAAProposalDBDAOPriTaaHdrDSQL(){
		setQuery();
		...
		query.append("FileName : TAAProposalDBDAOPriTaaHdrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TAA_HDR" ).append("\n"); 
