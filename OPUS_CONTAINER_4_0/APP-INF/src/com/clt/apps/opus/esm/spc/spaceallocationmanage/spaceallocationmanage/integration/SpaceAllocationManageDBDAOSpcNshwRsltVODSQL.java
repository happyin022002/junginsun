...
*@FileName : SpaceAllocationManageDBDAOSpcNshwRsltVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOSpcNshwRsltVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOSpcNshwRsltVODSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOSpcNshwRsltVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM SPC_NSHW_RSLT" ).append("\n"); 
