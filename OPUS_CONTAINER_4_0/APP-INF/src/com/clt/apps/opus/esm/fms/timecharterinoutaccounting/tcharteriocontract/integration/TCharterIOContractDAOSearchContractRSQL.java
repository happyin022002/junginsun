...
public class TCharterIOContractDAOSearchContractRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				DECL_FLG," ).append("\n"); 
		query.append("				TO_CHAR(ACMM_RT_AMT,'FM999,999,999,990.00') ACMM_RT_AMT," ).append("\n"); 
		query.append("				TO_CHAR(FLET_BROG_RT_AMT,'FM999,999,999,990.00') FLET_BROG_RT_AMT," ).append("\n"); 
		query.append("				TO_CHAR(FLET_OLAY_COMM_RT_AMT,'FM999,999,999,990.00') FLET_OLAY_COMM_RT_AMT," ).append("\n"); 
		query.append("				TO_CHAR(OA_RSV_AMT,'FM999,999,999,990.00') OA_RSV_AMT," ).append("\n"); 
		query.append("				OA_RSV_CURR_CD," ).append("\n"); 
