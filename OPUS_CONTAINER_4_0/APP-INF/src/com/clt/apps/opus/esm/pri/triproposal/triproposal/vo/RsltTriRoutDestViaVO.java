...
*@FileName : RsltTriRoutDestViaVO.java
*@FileTitle : RsltTriRoutDestViaVO
*Open Issues :
*Change history :
...
public class RsltTriRoutDestViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltTriRoutDestViaVO> models = new ArrayList<RsltTriRoutDestViaVO>();
	...
	/* Column Info */
	private String routViaPortNm = null;
	/* Column Info */
	...
	public RsltTriRoutDestViaVO() {}

	public RsltTriRoutDestViaVO(String ibflag, String pagerows, String triPropNo, String orgDestTpCd, String routViaSeq, String routViaPortCd, String routViaPortNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		...
		this.routViaPortNm = routViaPortNm;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rout_via_port_nm", getRoutViaPortNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rout_via_port_nm", "routViaPortNm");
	...
	/**
	 * Column Info
	 * @return routViaPortNm
	 */
	public String getRoutViaPortNm() {
		return this.routViaPortNm;
	}
	 ...
	 * @param routViaPortNm
	 */
	public void setRoutViaPortNm(String routViaPortNm) {
		this.routViaPortNm = routViaPortNm;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRoutViaPortNm(JSPUtil.getParameter(request, "rout_via_port_nm", ""));
	 ...
	 * @param request
	 * @return RsltTriRoutDestViaVO[]
	 */
	public RsltTriRoutDestViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltTriRoutDestViaVO[]
	 */
	public RsltTriRoutDestViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltTriRoutDestViaVO model = null;
		...
		try {
			...
			String[] routViaPortNm = (JSPUtil.getParameter(request, prefix	+ "rout_via_port_nm", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			
			for (int i = 0; i < length; i++) {
				model = new RsltTriRoutDestViaVO();
				if (updDt[i] != null)
				...
				if (routViaPortNm[i] != null)
					model.setRoutViaPortNm(routViaPortNm[i]);
				if (updUsrId[i] != null)
		...
		return getRsltTriRoutDestViaVOs();
	}
	 ...
	 * @return RsltTriRoutDestViaVO[]
	 */
	public RsltTriRoutDestViaVO[] getRsltTriRoutDestViaVOs(){
		RsltTriRoutDestViaVO[] vos = (RsltTriRoutDestViaVO[])models.toArray(new RsltTriRoutDestViaVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.routViaPortNm = this.routViaPortNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
