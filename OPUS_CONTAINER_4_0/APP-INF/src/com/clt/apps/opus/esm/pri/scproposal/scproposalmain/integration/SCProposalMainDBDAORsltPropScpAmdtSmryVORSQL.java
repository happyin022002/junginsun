...
*@FileName : SCProposalMainDBDAORsltPropScpAmdtSmryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORsltPropScpAmdtSmryVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCProposalMainDBDAORsltPropScpAmdtSmryVORSQL
	  * </pre>
	  */
	public SCProposalMainDBDAORsltPropScpAmdtSmryVORSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORsltPropScpAmdtSmryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
