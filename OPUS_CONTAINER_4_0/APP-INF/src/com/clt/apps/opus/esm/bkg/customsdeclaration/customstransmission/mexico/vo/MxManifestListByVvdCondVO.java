...
*@FileName : MxManifestListByVvdCondVO.java
*@FileTitle : MxManifestListByVvdCondVO
*Open Issues :
*Change history :
...
public class MxManifestListByVvdCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MxManifestListByVvdCondVO> models = new ArrayList<MxManifestListByVvdCondVO>();
	...
	public MxManifestListByVvdCondVO() {}

	public MxManifestListByVvdCondVO(String ibflag, String pagerows, String vvd, String podCd, String polCd, String searchFlg, String tmp1, String tmp2, String tmp3) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.tmp2 = tmp2;
		this.polCd = polCd;
	 ...
	 * @param request
	 * @return MxManifestListByVvdCondVO[]
	 */
	public MxManifestListByVvdCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MxManifestListByVvdCondVO[]
	 */
	public MxManifestListByVvdCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MxManifestListByVvdCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MxManifestListByVvdCondVO();
				if (podCd[i] != null)
		...
		return getMxManifestListByVvdCondVOs();
	}
	 ...
	 * @return MxManifestListByVvdCondVO[]
	 */
	public MxManifestListByVvdCondVO[] getMxManifestListByVvdCondVOs(){
		MxManifestListByVvdCondVO[] vos = (MxManifestListByVvdCondVO[])models.toArray(new MxManifestListByVvdCondVO[models.size()]);
		return vos;
	}
