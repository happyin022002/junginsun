...
*@FileName : KorManifestListDBDAOSearchExportInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchExportInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchExportInfoRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchExportInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
