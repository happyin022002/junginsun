...
*@FileName : SearchCustomerCodeGroupingVO.java
*@FileTitle : SearchCustomerCodeGroupingVO
*Open Issues :
*Change history :
...
public class SearchCustomerCodeGroupingVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchCustomerCodeGroupingVO> models = new ArrayList<SearchCustomerCodeGroupingVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("str_cre_dt", getStrCreDt());
		...
		this.hashColumns.put("end_cre_dt", getEndCreDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("str_cre_dt", "strCreDt");
		...
		this.hashFields.put("end_cre_dt", "endCreDt");
	 ...
	 * @return endCreDt
	 */
	public String getEndCreDt() {
		return this.endCreDt;
	}
	 ...
	 * @param endCreDt
	 */
	public void setEndCreDt(String endCreDt) {
		this.endCreDt = endCreDt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setStrCreDt(JSPUtil.getParameter(request, prefix + "str_cre_dt", ""));
		...
		setEndCreDt(JSPUtil.getParameter(request, prefix + "end_cre_dt", ""));
	 ...
	 */
	public SearchCustomerCodeGroupingVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCustomerCodeGroupingVO[]
	 */
	public SearchCustomerCodeGroupingVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchCustomerCodeGroupingVO model = null;
		...
		try {
			...
			String[] strCreDt = (JSPUtil.getParameter(request, prefix	+ "str_cre_dt", length));
			...
			String[] endCreDt = (JSPUtil.getParameter(request, prefix	+ "end_cre_dt", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchCustomerCodeGroupingVO();
		...
		return getSearchCustomerCodeGroupingVOs();
	}
	...
	public SearchCustomerCodeGroupingVO[] getSearchCustomerCodeGroupingVOs(){
		SearchCustomerCodeGroupingVO[] vos = (SearchCustomerCodeGroupingVO[])models.toArray(new SearchCustomerCodeGroupingVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.strCreDt = this.strCreDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.endCreDt = this.endCreDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
