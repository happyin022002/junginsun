...
*@FileName : SCNoteConversionProposalDBDAOAdjNoteDurCasRNoteUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAOAdjNoteDurCasRNoteUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Route Note가 변경(AM, AD)되었을때 Conversion Duration을 이에 맞춰주는 작업
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAOAdjNoteDurCasRNoteUSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteConversionProposalDBDAOAdjNoteDurCasRNoteUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_SP_SCP_RT_CMDT_RNOTE N, PRI_SP_SCP_MN M" ).append("\n"); 
		...
		query.append("AND N.GEN_SPCL_RT_TP_CD = @[gen_spcl_rt_tp_cd]" ).append("\n"); 
		query.append("AND N.CMDT_HDR_SEQ = @[cmdt_hdr_seq]" ).append("\n"); 
		query.append("AND N.ROUT_SEQ = @[rout_seq]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("AND N.GEN_SPCL_RT_TP_CD = @[gen_spcl_rt_tp_cd]" ).append("\n"); 
		query.append("AND N.CMDT_HDR_SEQ = @[cmdt_hdr_seq]" ).append("\n"); 
		query.append("AND N.ROUT_SEQ = @[rout_seq]" ).append("\n"); 
		query.append("AND N.ROUT_NOTE_SEQ = @[rout_note_seq]" ).append("\n"); 
