...
*@FileName : KorManifestListDBDAOsearchCustExistCntRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchCustExistCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchCustExistCntRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchCustExistCntRSQL").append("\n");
		query.append("*/").append("\n");
	}
