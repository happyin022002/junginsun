 ...
 *@FileName : UI_PRI_0106HTMLAction.java
...
public class ESM_PRI_0106HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0106Event event = new EsmPri0106Event();
