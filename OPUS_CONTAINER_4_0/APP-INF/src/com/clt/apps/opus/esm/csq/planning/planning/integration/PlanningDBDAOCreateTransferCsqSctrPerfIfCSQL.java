...
*@FileName : PlanningDBDAOCreateTransferCsqSctrPerfIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOCreateTransferCsqSctrPerfIfCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [CSQ_SCTR_PERF_IF] 데이터를 1Q로 복사한다.
	  * </pre>
	  */
	public PlanningDBDAOCreateTransferCsqSctrPerfIfCSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOCreateTransferCsqSctrPerfIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CSQ_SCTR_PERF_IF(BSE_TP_CD, BSE_YR, BSE_QTR_CD, OFC_VW_CD, RLANE_CD, DIR_CD, RGN_OFC_CD, POL_CD, POD_CD, TRD_CD, SUB_TRD_CD, RHQ_CD, LOD_QTY, GRS_TTL_REV, PA_CM_UC_AMT, RA_CM_UC_AMT, POL_CALL_SEQ, POD_CALL_SEQ, APLY_FM_YRWK, APLY_TO_YRWK, DUR_WKS, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT )" ).append("\n"); 
		...
		query.append("  FROM CSQ_SCTR_PERF_IF" ).append("\n"); 
