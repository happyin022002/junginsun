...
*@FileName : CstmsClearInfoVO.java
*@FileTitle : CstmsClearInfoVO
*Open Issues :
*Change history :
...
public class CstmsClearInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstmsClearInfoVO> models = new ArrayList<CstmsClearInfoVO>();
	...
	public CstmsClearInfoVO() {}

	public CstmsClearInfoVO(String ibflag, String pagerows, String bkgNo, String cstmsClrCd, String evntOfcCd, String cstmsClrLstDt) {
	 ...
	 */
	public CstmsClearInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstmsClearInfoVO[]
	 */
	public CstmsClearInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstmsClearInfoVO model = null;
	 ...
	 * @return CstmsClearInfoVO[]
	 */
	public CstmsClearInfoVO[] getCstmsClearInfoVOs(){
		CstmsClearInfoVO[] vos = (CstmsClearInfoVO[])models.toArray(new CstmsClearInfoVO[models.size()]);
		return vos;
	}
