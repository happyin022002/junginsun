...
public class JapanTerminalTransmissionDBDAOsearchNewBkgInfoForVvdChkRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       DECODE(PKG.CSTMS_PCK_TP_CD, NULL, BL.PCK_TP_CD, PKG.CSTMS_PCK_TP_CD) PCK_TP_CD," ).append("\n"); 
		query.append("       DECODE(PKG.CSTMS_PCK_TP_CD, NULL, BL.PCK_TP_CD, PKG.CSTMS_PCK_TP_CD) TTL_PCK_TP_CD," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("  FROM BKG_TML_EDI_JP_BL BL," ).append("\n"); 
		query.append("       BKG_CSTMS_PCK_TP_CONV PKG" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(" WHERE 1=1" ).append("\n"); 
		query.append("   AND BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("   AND BKG_SKD_SEQ = 0" ).append("\n"); 
		query.append("   AND BL.PCK_TP_CD = PKG.PCK_TP_CD(+)" ).append("\n"); 
