...
*@FileName : CstmsCdConvSeqVO.java
*@FileTitle : CstmsCdConvSeqVO
*Open Issues :
*Change history :
 ...
 */
public class CstmsCdConvSeqVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<CstmsCdConvSeqVO> models = new ArrayList<CstmsCdConvSeqVO>();
	 ...
	 */
    public CstmsCdConvSeqVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstmsCdConvSeqVO[]
	 */
    public CstmsCdConvSeqVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        CstmsCdConvSeqVO model = null;
    ...
    public CstmsCdConvSeqVO[] getCstmsCdConvSeqVOs() {
        CstmsCdConvSeqVO[] vos = (CstmsCdConvSeqVO[]) models.toArray(new CstmsCdConvSeqVO[models.size()]);
        return vos;
    }
