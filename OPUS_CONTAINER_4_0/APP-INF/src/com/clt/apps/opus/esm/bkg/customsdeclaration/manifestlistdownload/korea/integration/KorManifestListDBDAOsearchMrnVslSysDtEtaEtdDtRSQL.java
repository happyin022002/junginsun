...
*@FileName : KorManifestListDBDAOsearchMrnVslSysDtEtaEtdDtRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchMrnVslSysDtEtaEtdDtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchMrnVslSysDtEtaEtdDtRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchMrnVslSysDtEtaEtdDtRSQL").append("\n");
		query.append("*/").append("\n");
	}
