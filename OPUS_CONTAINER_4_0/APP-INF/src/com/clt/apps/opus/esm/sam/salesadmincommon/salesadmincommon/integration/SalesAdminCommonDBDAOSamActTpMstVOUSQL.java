...
*@FileName : SalesAdminCommonDBDAOSamActTpMstVOUSQL.java
...
public class SalesAdminCommonDBDAOSamActTpMstVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SalesAdminCommonDBDAOSamActTpMstVOUSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.sam.salesadmincommon.salesadmincommon.integration").append("\n"); 
		query.append("FileName : SalesAdminCommonDBDAOSamActTpMstVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
