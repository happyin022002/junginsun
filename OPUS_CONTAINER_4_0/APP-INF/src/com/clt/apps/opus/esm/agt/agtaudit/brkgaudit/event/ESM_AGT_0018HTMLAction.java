...
public class ESM_AGT_0018HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI01)){
			event.setAPActualInterfaceMasterForBRKGVO((APActualInterfaceMasterForBRKGVO)getVO(request, APActualInterfaceMasterForBRKGVO .class));//setAPActualInterfaceMasterForBRKGVO((APActualInterfaceMasterForBRKGVO)getVO(request, APActualInterfaceMasterForBRKGVO .class));
			event.setAPActualInterfaceMasterForBRKGVOs((APActualInterfaceMasterForBRKGVO[])getVOs(request, APActualInterfaceMasterForBRKGVO .class, ""));//setAPActualInterfaceMasterForBRKGVOs((APActualInterfaceMasterForBRKGVO[])getVOs(request, APActualInterfaceMasterForBRKGVO .class, ""));
		}
