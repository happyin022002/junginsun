...
*@FileName : ESM_BSA_0023HTMLAction.java
 ...
 * @author Kim Ki Dae
 * @see EsmBsa0023Event 참조
 * @since J2EE 1.6
 */
public class ESM_BSA_0024HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * TESTHTMLAction 객체를 생성
	 */
	public ESM_BSA_0024HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("################# ESM_BSA_0024HTMLAction.perform() ############################[START]");
    	FormCommand command = FormCommand.fromRequest(request);
    	EsmBsa0024Event event = new EsmBsa0024Event();  		
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)
			...
			event.setBsaSlotInfoForSpcCntrSaveVOs((BsaSlotInfoForSpcCntrSaveVO[])getVOs(request, BsaSlotInfoForSpcCntrSaveVO.class));
		}else if(command.isCommand(FormCommand.MULTI02)){
			event.setSearchBsaConditionVO((SearchBsaConditionVO)getVO(request, SearchBsaConditionVO .class));
			event.setBsaSpcCtrlSwapVOs((BsaSpcCtrlSwapVO[])getVOs(request, BsaSpcCtrlSwapVO.class));
		}
				
		log.debug("################# ESM_BSA_0024HTMLAction.perform() ############################[END]");
