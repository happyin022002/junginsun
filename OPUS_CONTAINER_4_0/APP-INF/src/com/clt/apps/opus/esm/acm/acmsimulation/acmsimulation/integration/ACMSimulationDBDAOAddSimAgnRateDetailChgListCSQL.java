...
*@FileName : ACMSimulationDBDAOAddSimAgnRateDetailChgListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAddSimAgnRateDetailChgListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOAddSimAgnRateDetailChgListCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAddSimAgnRateDetailChgListCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_SIM_AGMT_DTL_CHG" ).append("\n");
