...
*@FileName : KrWharfageDecMgtDBDAOdeleteBkgCstmsLocDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOdeleteBkgCstmsLocDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOdeleteBkgCstmsLocDSQL(){
		setQuery();
		...
		query.append("FileName : KrWharfageDecMgtDBDAOdeleteBkgCstmsLocDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE BKG_CSTMS_LOC" ).append("\n"); 
