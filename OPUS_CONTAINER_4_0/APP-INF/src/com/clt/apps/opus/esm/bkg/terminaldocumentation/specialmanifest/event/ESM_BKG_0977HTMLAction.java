...
*@FileName : ESM_BKG_0977HTMLAction.java
*@FileTitle : Belgian Codes for Type of special UN numbers
*Open Issues :
*Change history :
 ...
 * @see EsmBkg0977Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_0977HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0977Event event = new EsmBkg0977Event();

		if(command.isCommand(FormCommand.SEARCH)) {

			event.setSpecialListCondVO((SpecialListCondVO)getVO(request, SpecialListCondVO.class));

		} else if(command.isCommand(FormCommand.MULTI)) {

			event.setSpecialListVO((SpecialListVO[])getVOs(request, SpecialListVO.class, "sheet1_"));
		}
