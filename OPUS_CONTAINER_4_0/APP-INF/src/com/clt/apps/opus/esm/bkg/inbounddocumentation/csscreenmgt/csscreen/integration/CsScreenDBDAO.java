...
import com.clt.apps.opus.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.integration.CargoReleaseOrderDBDAOAddDoHistoryCSQL;
...
import com.clt.apps.opus.esm.bkg.inbounddocumentation.csscreenmgt.csscreen.vo.BkgInfoVO;
...
import com.clt.apps.opus.esm.bkg.inbounddocumentation.csscreenmgt.csscreen.vo.PkupNtcBkgInfoVO;
...
/**
 *   CsScreenDAO <br>
 * - CsScreenMgt system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
 * @author
...
public class CsScreenDBDAO extends DBDAOSupport {
   ...
   return list;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<CntrPkupNtcInfoVO> searchUsCntrInfo(String bkgNo, String ofc_cd) throws DAOException {
