...
*@FileName : ESM_FMS_0084HTMLAction.java
...
public class ESM_FMS_0085HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0085HTMLAction 객체를 생성
	 */
	public ESM_FMS_0085HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0085Event event = new EsmFms0085Event();

		if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomEmailAddressVOS((CustomEmailAddressVO[])getVOs(request, CustomEmailAddressVO .class, ""));
		} 
