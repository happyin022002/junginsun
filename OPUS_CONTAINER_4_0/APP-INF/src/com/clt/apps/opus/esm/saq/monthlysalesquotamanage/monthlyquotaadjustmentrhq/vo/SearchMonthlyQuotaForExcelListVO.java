...
*@FileName : SearchMonthlyQuotaForExcelListVO.java
*@FileTitle : SearchMonthlyQuotaForExcelListVO
*Open Issues :
*Change history :
...
public class SearchMonthlyQuotaForExcelListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaForExcelListVO> models = new ArrayList<SearchMonthlyQuotaForExcelListVO>();
	...
	public SearchMonthlyQuotaForExcelListVO() {}

	public SearchMonthlyQuotaForExcelListVO(String ibflag, String pagerows, String rn, String editable, String mqtaStepCd, String bseYr, String bseQtrCd, String trdCd, String subTrdCd, String rlaneCd, String dirCd, String mqtaVerNo, String laneGrp, String bseMon, String polCd, String podCd, String voyage, String bsa, String aqCd, String rgnOfcCd, String unit, String lodQty, String grsRev, String grsRpbRev, String raCmUcAmt, String cmpb, String raOpfitUcAmt, String opb) {
		this.rn = rn;
		this.trdCd = trdCd;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCmpb(JSPUtil.getParameter(request, "cmpb", ""));
	 ...
	 */
	public SearchMonthlyQuotaForExcelListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaForExcelListVO[]
	 */
	public SearchMonthlyQuotaForExcelListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaForExcelListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaForExcelListVO();
				if (rn[i] != null)
					model.setRn(rn[i]);
				if (trdCd[i] != null)
		...
		return getSearchMonthlyQuotaForExcelListVOs();
	}
	...
	public SearchMonthlyQuotaForExcelListVO[] getSearchMonthlyQuotaForExcelListVOs(){
		SearchMonthlyQuotaForExcelListVO[] vos = (SearchMonthlyQuotaForExcelListVO[])models.toArray(new SearchMonthlyQuotaForExcelListVO[models.size()]);
		return vos;
	}
