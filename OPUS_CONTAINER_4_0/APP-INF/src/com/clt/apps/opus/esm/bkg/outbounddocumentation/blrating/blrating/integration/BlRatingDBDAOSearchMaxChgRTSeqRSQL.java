...
*@FileName : BlRatingDBDAOSearchMaxChgRTSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOSearchMaxChgRTSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_CHG_RT 의 MAX SEQ를 조회한다.
	  * </pre>
	  */
	public BlRatingDBDAOSearchMaxChgRTSeqRSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOSearchMaxChgRTSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
