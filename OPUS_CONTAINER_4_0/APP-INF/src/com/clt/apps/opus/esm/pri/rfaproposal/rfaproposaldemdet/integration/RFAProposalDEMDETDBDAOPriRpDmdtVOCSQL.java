...
*@FileName : RFAProposalDEMDETDBDAOPriRpDmdtVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalDEMDETDBDAOPriRpDmdtVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAProposalDEMDETDBDAOPriRpDmdtVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalDEMDETDBDAOPriRpDmdtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[acpt_usr_id]" ).append("\n"); 
		query.append(",	@[acpt_ofc_cd]" ).append("\n"); 
		query.append(",	TO_DATE(REPLACE(@[acpt_dt],'-',''), 'YYYYMMDD')" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
