...
*@FileName : SearchMTCostListVO4.java
*@FileTitle : SearchMTCostListVO4
*Open Issues :
*Change history :
...
public class SearchMTCostListVO4 extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCostListVO4> models = new ArrayList<SearchMTCostListVO4>();
	...
	/**
	 * SearchMTCostListVO4 생성자
	 */
	public SearchMTCostListVO4() {}
	 ...
	 */
	public SearchMTCostListVO4[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCostListVO4[]
	 */
	public SearchMTCostListVO4[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCostListVO4 model = null;
		...
		return getSearchMTCostListVO4s();
	}
	 ...
	 * @return SearchMTCostListVO4[]
	 */
	public SearchMTCostListVO4[] getSearchMTCostListVO4s(){
		SearchMTCostListVO4[] vos = (SearchMTCostListVO4[])models.toArray(new SearchMTCostListVO4[models.size()]);
		return vos;
	}
