...
*@FileName : OTRCommAuditDBDAOGetNewAudNoInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class OTRCommAuditDBDAOGetNewAudNoInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OTRCommAuditDBDAOGetNewAudNoInfoRSQL(){
		setQuery();
		...
		query.append("FileName : OTRCommAuditDBDAOGetNewAudNoInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
