...
*@FileName : ExternalFinderDAOTaxTypeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExternalFinderDAOTaxTypeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ExternalFinderDAOTaxTypeRSQL(){
		setQuery();
		...
		query.append("FileName : ExternalFinderDAOTaxTypeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
