...
*@FileName : BrCntrRfAkBrCgoInfoVO.java
*@FileTitle : BrCntrRfAkBrCgoInfoVO
*Open Issues :
*Change history :
 ...
 */
public class BrCntrRfAkBrCgoInfoVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<BrCntrRfAkBrCgoInfoVO> models = new ArrayList<BrCntrRfAkBrCgoInfoVO>();
    ...
    public BrCntrRfAkBrCgoInfoVO() {
    }

    public BrCntrRfAkBrCgoInfoVO(String ibflag, String pagerows, String cntrnbr, String punit, String pkg, String cntrWgtUnit, String cntrwgt, String cntrgwgt, String cntrtrw, String cntrtype, String sealnbr, String fmInd, String rfInd, String dgInd, String akInd, String bkInd, String measure, String ovwgt, String stwgReq, String mvmtRefNo, String temp, String tunit, String vent, String measQty, String measureUnit, String rdtype, String cmdtDesc, String cmdtCd, String rfRemark, String rfdryInd, String ovf, String ovr, String ovh, String ovlw, String ovrw, String ovwgtUnit, String voidSlot, String socind, String haulage, String bkwgt, String bkwgtu, String bkw, String bkh, String bkl, String cntrown, String cntrtrm, String cntrNo, String exsMrn, String exportMrn, String atb, String suplType, String cntrPrtFlg) {
        this.bkh = bkh;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("supl_type", getSuplType());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("supl_type", "suplType");
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setSuplType(JSPUtil.getParameter(request, prefix + "supl_type", ""));
	 ...
	 */
    public BrCntrRfAkBrCgoInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BrCntrRfAkBrCgoInfoVO[]
	 */
    public BrCntrRfAkBrCgoInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        BrCntrRfAkBrCgoInfoVO model = null;
        ...
        try {
            ...
            String[] suplType = (JSPUtil.getParameter(request, prefix + "supl_type", length));
            for (int i = 0; i < length; i++) {
                model = new BrCntrRfAkBrCgoInfoVO();
                if (bkh[i] != null)
                    model.setBkh(bkh[i]);
                if (cntrown[i] != null)
                ...
                if (atb[i] != null)
                    model.setAtb(atb[i]);
                if (suplType[i] != null)
                    model.setSuplType(suplType[i]);
                models.add(model);
            }
        } catch (Exception e) {
            return null;
        }
        return getBrCntrRfAkBrCgoInfoVOs();
    }
	 ...
	 * @return BrCntrRfAkBrCgoInfoVO[]
	 */
    public BrCntrRfAkBrCgoInfoVO[] getBrCntrRfAkBrCgoInfoVOs() {
        BrCntrRfAkBrCgoInfoVO[] vos = (BrCntrRfAkBrCgoInfoVO[]) models.toArray(new BrCntrRfAkBrCgoInfoVO[models.size()]);
        return vos;
    }
	...
	*/
    public void unDataFormat() {
        ...
        this.suplType = this.suplType.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
