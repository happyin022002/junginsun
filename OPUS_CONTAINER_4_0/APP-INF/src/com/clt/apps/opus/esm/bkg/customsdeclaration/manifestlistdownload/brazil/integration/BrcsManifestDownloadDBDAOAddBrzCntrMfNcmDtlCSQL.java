...
*@FileName : BrcsManifestDownloadDBDAOAddBrzCntrMfNcmDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BrcsManifestDownloadDBDAOAddBrzCntrMfNcmDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *  - BKG_CSTMS_BRZ_CNTR_MF_DTL 테이블 Insert
	  * </pre>
	  */
	public BrcsManifestDownloadDBDAOAddBrzCntrMfNcmDtlCSQL(){
		setQuery();
		...
		params.put("mf_dtl_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : BrcsManifestDownloadDBDAOAddBrzCntrMfNcmDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO BKG_CSTMS_BRZ_CNTR_MF_DTL" ).append("\n"); 
