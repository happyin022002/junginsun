...
*@FileName : EBookingReceiptDBDAOAddBkgXterRefCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOAddBkgXterRefCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOAddBkgXterRefCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOAddBkgXterRefCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_REF" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append(" (SELECT NVL(MAX(XTER_REF_SEQ), 0) + 1 " ).append("\n"); 
		query.append("   FROM BKG_XTER_REF" ).append("\n"); 
