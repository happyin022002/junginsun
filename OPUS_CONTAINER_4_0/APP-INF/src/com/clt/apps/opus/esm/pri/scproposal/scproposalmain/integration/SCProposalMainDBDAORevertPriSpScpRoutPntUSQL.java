...
*@FileName : SCProposalMainDBDAORevertPriSpScpRoutPntUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpScpRoutPntUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 상태값(prop_sts_cd)에 따라 file 취소(I) 또는 파일링(A)
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpScpRoutPntUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpScpRoutPntUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_ROUT_PNT" ).append("\n"); 
