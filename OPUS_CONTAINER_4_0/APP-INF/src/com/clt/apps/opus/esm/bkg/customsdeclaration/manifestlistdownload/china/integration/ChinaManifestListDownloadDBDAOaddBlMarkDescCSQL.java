...
*@FileName : ChinaManifestListDownloadDBDAOaddBlMarkDescCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOaddBlMarkDescCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOaddBlMarkDescCSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOaddBlMarkDescCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("CHN_BL_CLSS_CD," ).append("\n");
