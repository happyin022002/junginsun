...
*@FileName : ESM_COA_2003HTMLAction.java
...
public class ESM_COA_2003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_2003HTMLAction 객체를 생성
	 */
	public ESM_COA_2003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa2003Event event = new EsmCoa2003Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPnlRptItemVOS((PnlRptItemVO[])getVOs(request, PnlRptItemVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setPnlRptItemVO((PnlRptItemVO)getVO(request, PnlRptItemVO .class));
		}
