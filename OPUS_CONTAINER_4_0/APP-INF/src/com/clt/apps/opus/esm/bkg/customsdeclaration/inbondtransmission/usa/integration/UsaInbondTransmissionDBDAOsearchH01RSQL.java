...
*@FileName : UsaInbondTransmissionDBDAOsearchH01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInbondTransmissionDBDAOsearchH01RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * dwkim BL Arrival 통지 H01
	  * </pre>
	  */
	public UsaInbondTransmissionDBDAOsearchH01RSQL(){
		setQuery();
		...
		query.append("FileName : UsaInbondTransmissionDBDAOsearchH01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	COM_ConstantMgr_PKG.COM_getScacCode_FNC(),80,' ')||CHR(10)" ).append("\n"); 
