...
*@FileName : PSAManifestDBDAOSearchMarkInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOSearchMarkInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSAManifestDBDAOSearchMarkInfoRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOSearchMarkInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT    MD.MK_DESC MARK1" ).append("\n"); 
