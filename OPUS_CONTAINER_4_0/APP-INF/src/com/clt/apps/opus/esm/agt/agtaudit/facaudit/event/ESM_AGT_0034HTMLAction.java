...
*@FileName : ESM_AGT_034HTMLAction.java
 ...
 * @see EsmAgt0034Event , ESM_AGT_034EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_AGT_0034HTMLAction extends HTMLActionSupport {

	/**
	 * ESM_AGT_034HTMLAction 객체를 생성
	 */
	public ESM_AGT_0034HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_AGT_034Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0034Event event = new EsmAgt0034Event();

		HashMap hash = new HashMap();
		hash = Utils.requestToHashMap(request);
		event.setAttribute("fRequest", hash);
		
        event.setCommandClassName("AGTAuditSC");
