...
*@FileName : BLIssuanceDBDAOsearchDblEdiFnlEta31RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOsearchDblEdiFnlEta31RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLIssuanceDBDAOsearchDblEdiFnlEta31RSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOsearchDblEdiFnlEta31RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND VPS.VPS_PORT_CD = '1'" ).append("\n"); 
