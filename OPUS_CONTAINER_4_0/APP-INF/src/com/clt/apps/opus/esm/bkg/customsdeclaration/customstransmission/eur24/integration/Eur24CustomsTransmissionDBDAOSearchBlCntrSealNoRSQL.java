...
*@FileName : Eur24CustomsTransmissionDBDAOSearchBlCntrSealNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24CustomsTransmissionDBDAOSearchBlCntrSealNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24CustomsTransmissionDBDAOSearchBlCntrSealNoRSQL
	  * </pre>
	  */
	public Eur24CustomsTransmissionDBDAOSearchBlCntrSealNoRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24CustomsTransmissionDBDAOSearchBlCntrSealNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* Eur24BlCntrSealListVOs Eur24CustomsTransmissionDBDAOSearchBlCntrSealNo ( String blNo , String vslCd , String skdVoyNo , String skdDirCd , String cstmsPortCd, String cntrNo) */" ).append("\n"); 
