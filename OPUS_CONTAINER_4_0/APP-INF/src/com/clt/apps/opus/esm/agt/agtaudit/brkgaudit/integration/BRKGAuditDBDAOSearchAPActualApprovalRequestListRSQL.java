...
public class BRKGAuditDBDAOSearchAPActualApprovalRequestListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#if (${sts_option} != '')" ).append("\n"); 
		...
		query.append("#elseif (${sts_option} != '')" ).append("\n"); 
		...
		query.append("AND A.FRT_FWRD_CNT_CD||TO_CHAR(A.FRT_FWRD_SEQ,'FM000000')||A.VNDR_SEQ||A.AP_OFC_CD IN(${fwdr_vndrSeq_apOfcCd})" ).append("\n"); 
