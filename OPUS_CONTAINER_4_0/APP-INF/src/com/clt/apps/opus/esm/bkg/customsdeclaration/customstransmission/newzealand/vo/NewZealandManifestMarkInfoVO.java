...
*@FileName : NewZealandManifestMarkInfoVO.java
*@FileTitle : NewZealandManifestMarkInfoVO
*Open Issues :
*Change history :
...
public class NewZealandManifestMarkInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<NewZealandManifestMarkInfoVO> models = new ArrayList<NewZealandManifestMarkInfoVO>();
	...
	public NewZealandManifestMarkInfoVO() {}

	public NewZealandManifestMarkInfoVO(String ibflag, String pagerows, String mark1, String mark2, String mark3, String mark4, String mark5, String mark6, String mark7, String mark8, String mark9, String mark10) {
		this.mark4 = mark4;
		this.mark3 = mark3;
		this.mark2 = mark2;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return NewZealandManifestMarkInfoVO[]
	 */
	public NewZealandManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NewZealandManifestMarkInfoVO[]
	 */
	public NewZealandManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandManifestMarkInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandManifestMarkInfoVO();
				if (mark4[i] != null)
		...
		return getNewZealandManifestMarkInfoVOs();
	}
	 ...
	 * @return NewZealandManifestMarkInfoVO[]
	 */
	public NewZealandManifestMarkInfoVO[] getNewZealandManifestMarkInfoVOs(){
		NewZealandManifestMarkInfoVO[] vos = (NewZealandManifestMarkInfoVO[])models.toArray(new NewZealandManifestMarkInfoVO[models.size()]);
		return vos;
	}
