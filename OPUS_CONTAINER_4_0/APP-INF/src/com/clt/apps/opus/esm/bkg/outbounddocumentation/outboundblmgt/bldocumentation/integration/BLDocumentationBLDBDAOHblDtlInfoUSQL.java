...
*@FileName : BLDocumentationBLDBDAOHblDtlInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationBLDBDAOHblDtlInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLDocumentationBLDBDAOHblDtlInfoUSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationBLDBDAOHblDtlInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_HBL SET" ).append("\n"); 
