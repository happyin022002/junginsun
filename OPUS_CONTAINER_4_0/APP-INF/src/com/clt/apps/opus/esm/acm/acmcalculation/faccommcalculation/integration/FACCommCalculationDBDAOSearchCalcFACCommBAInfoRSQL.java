...
*@FileName : FACCommCalculationDBDAOSearchCalcFACCommBAInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FACCommCalculationDBDAOSearchCalcFACCommBAInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FACCommCalculationDBDAOSearchCalcFACCommBAInfoRSQL
	  * </pre>
	  */
	public FACCommCalculationDBDAOSearchCalcFACCommBAInfoRSQL(){
		setQuery();
		...
		query.append("FileName : FACCommCalculationDBDAOSearchCalcFACCommBAInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
