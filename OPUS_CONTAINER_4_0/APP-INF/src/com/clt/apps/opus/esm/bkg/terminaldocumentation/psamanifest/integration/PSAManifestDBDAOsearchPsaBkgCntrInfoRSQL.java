...
public class PSAManifestDBDAOsearchPsaBkgCntrInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , BS.STWG_CD AS SP_DTL" ).append("\n"); 
		...
		query.append("        BKG_STWG_CGO BS" ).append("\n"); 
		...
		query.append("  AND   CNTR.BKG_NO    = BS.BKG_NO(+)" ).append("\n"); 
		query.append("  AND   BS.STWG_SEQ(+) = 1   " ).append("\n"); 
