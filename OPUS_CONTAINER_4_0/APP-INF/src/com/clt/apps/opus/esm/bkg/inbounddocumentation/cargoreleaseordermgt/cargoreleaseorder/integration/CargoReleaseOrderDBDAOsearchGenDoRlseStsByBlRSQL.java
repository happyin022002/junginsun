...
*@FileName : CargoReleaseOrderDBDAOsearchGenDoRlseStsByBlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchGenDoRlseStsByBlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchGenDoRlseStsByBlRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchGenDoRlseStsByBlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
