...
*@FileName : AncsCstmsLogDtlCondVO.java
*@FileTitle : AncsCstmsLogDtlCondVO
*Open Issues :
*Change history :
...
public class AncsCstmsLogDtlCondVO extends CstmsLogDtlCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<AncsCstmsLogDtlCondVO> models = new ArrayList<AncsCstmsLogDtlCondVO>();
	...
	public AncsCstmsLogDtlCondVO() {}

	public AncsCstmsLogDtlCondVO(String ibflag, String pagerows, String msgTpCd, String rcvSndDivCd, String anrDeclNo, String refSeq) {
		this.refSeq = refSeq;
		this.ibflag = ibflag;
	 ...
	 */
	public AncsCstmsLogDtlCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AncsCstmsLogDtlCondVO[]
	 */
	public AncsCstmsLogDtlCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AncsCstmsLogDtlCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AncsCstmsLogDtlCondVO();
				if (refSeq[i] != null)
		...
		return getAncsCstmsLogDtlCondVOs();
	}
	 ...
	 * @return AncsCstmsLogDtlCondVO[]
	 */
	public AncsCstmsLogDtlCondVO[] getAncsCstmsLogDtlCondVOs(){
		AncsCstmsLogDtlCondVO[] vos = (AncsCstmsLogDtlCondVO[])models.toArray(new AncsCstmsLogDtlCondVO[models.size()]);
		return vos;
	}
