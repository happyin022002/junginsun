...
*@FileName : EsmSaq0161ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0161ViewAdapter extends ViewAdapter {

	public EsmSaq0161ViewAdapter() {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		EsmSaq0161Event event = (EsmSaq0161Event)listVO.getList(0);
