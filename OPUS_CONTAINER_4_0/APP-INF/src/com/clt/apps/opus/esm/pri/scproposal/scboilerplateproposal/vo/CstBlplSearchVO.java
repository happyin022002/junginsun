...
*@FileName : CstBlplSearchVO.java
*@FileTitle : CstBlplSearchVO
*Open Issues :
*Change history :
...
public class CstBlplSearchVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstBlplSearchVO> models = new ArrayList<CstBlplSearchVO>();
	...
	public CstBlplSearchVO() {}

	public CstBlplSearchVO(String ibflag, String pagerows, String propNo, String amdtSeq, String hdrEffDt, String blplHdrSeq) {
		this.ibflag = ibflag;
	 ...
	 */
	public CstBlplSearchVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstBlplSearchVO[]
	 */
	public CstBlplSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstBlplSearchVO model = null;
	 ...
	 * @return CstBlplSearchVO[]
	 */
	public CstBlplSearchVO[] getCstBlplSearchVOs(){
		CstBlplSearchVO[] vos = (CstBlplSearchVO[])models.toArray(new CstBlplSearchVO[models.size()]);
		return vos;
	}
