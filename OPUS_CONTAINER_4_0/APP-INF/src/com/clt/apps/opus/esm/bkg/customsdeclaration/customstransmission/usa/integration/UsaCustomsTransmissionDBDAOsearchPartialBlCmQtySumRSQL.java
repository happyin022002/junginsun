...
*@FileName : UsaCustomsTransmissionDBDAOsearchPartialBlCmQtySumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaCustomsTransmissionDBDAOsearchPartialBlCmQtySumRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaCustomsTransmissionDBDAOsearchPartialBlCmQtySumRSQL(){
		setQuery();
		...
		query.append("FileName : UsaCustomsTransmissionDBDAOsearchPartialBlCmQtySumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SUM(C.PCK_QTY) BL_CM_QTY" ).append("\n"); 
		...
		query.append("   AND C.CNTR_NO    LIKE @[in_cntr]||'%'" ).append("\n"); 
