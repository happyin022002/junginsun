...
*@FileName : SalesAdminCommonDBDAOAddActItemMstListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesAdminCommonDBDAOAddActItemMstListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * row add를 통한 새로 추가하는 insert 쿼리
	  * </pre>
	  */
	public SalesAdminCommonDBDAOAddActItemMstListCSQL(){
		setQuery();
		...
		query.append("FileName : SalesAdminCommonDBDAOAddActItemMstListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO sam_sls_act_tp_mst (" ).append("\n"); 
