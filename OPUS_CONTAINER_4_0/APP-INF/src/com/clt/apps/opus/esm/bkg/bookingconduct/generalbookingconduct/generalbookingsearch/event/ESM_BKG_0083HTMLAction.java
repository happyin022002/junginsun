...
*@FileName : ESM_BKG_0083HTMLAction.java
...
public class ESM_BKG_0083HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0083HTMLAction 객체를 생성
	 */
	public ESM_BKG_0083HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0083Event event = new EsmBkg0083Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setNodeListInputVO((NodeListInputVO)getVO(request, NodeListInputVO .class));
		}else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setLocationListInputVO((LocationListInputVO)getVO(request, LocationListInputVO .class));
		}
