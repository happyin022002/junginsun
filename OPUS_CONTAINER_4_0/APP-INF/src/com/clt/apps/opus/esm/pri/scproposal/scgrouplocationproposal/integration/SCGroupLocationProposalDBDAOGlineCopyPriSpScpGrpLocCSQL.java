...
*@FileName : SCGroupLocationProposalDBDAOGlineCopyPriSpScpGrpLocCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAOGlineCopyPriSpScpGrpLocCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_SP_SCP_GRP_LOC Insert
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAOGlineCopyPriSpScpGrpLocCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAOGlineCopyPriSpScpGrpLocCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY A.SVC_SCP_CD,A.GLINE_SEQ,A.GRP_LOC_SEQ,B.GRP_LOC_DTL_SEQ) AS SEQ" ).append("\n"); 
