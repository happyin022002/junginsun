...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCtntVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_blpl_ctnt delete
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCtntVODSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}