...
*@FileName : SalesAdminCommonDBDAOCheckCrCustomerCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesAdminCommonDBDAOCheckCrCustomerCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SalesAdminCommonDBDAOCheckCrCustomerCodeRSQL(){
		setQuery();
		...
		query.append("FileName : SalesAdminCommonDBDAOCheckCrCustomerCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
