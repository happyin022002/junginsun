...
*@FileName : KorEdiMsnVO.java
*@FileTitle : KorEdiMsnVO
*Open Issues :
*Change history :
...
public class KorEdiMsnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorEdiMsnVO> models = new ArrayList<KorEdiMsnVO>();
	...
	public KorEdiMsnVO(String ibflag, String pagerows, String userId, String mrnNo, String mrnChkNo, String vslCd, String skdVoyNo, String skdDirCd, String portCd) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 * @return KorMsnVO[]
	 */
	public KorEdiMsnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMsnVO[]
	 */
	public KorEdiMsnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorEdiMsnVO model = null;
	 ...
	 * @return KorMsnVO[]
	 */
	public KorEdiMsnVO[] getKorMsnVOs(){
		KorEdiMsnVO[] vos = (KorEdiMsnVO[])models.toArray(new KorEdiMsnVO[models.size()]);
		return vos;
	}
