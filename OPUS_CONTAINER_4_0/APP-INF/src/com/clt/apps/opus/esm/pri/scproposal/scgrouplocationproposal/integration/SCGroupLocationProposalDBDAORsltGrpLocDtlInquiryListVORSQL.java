...
*@FileName : SCGroupLocationProposalDBDAORsltGrpLocDtlInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAORsltGrpLocDtlInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RsltGrpLocDtlInquiryListVO
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAORsltGrpLocDtlInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAORsltGrpLocDtlInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("					  AND SVC_SCP_CD = M.SVC_SCP_CD )   " ).append("\n"); 
		...
		query.append(" ORDER BY A.LOC_CD, A.GRP_LOC_DTL_SEQ" ).append("\n"); 
