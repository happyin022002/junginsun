...
*@FileName : SearchMTCostListVO7.java
*@FileTitle : SearchMTCostListVO7
*Open Issues :
*Change history :
...
* Line No. 88 :  : shall be matched with name of parameter(fcntrEccCd vs ibflag)
* Line No. 88 :  : shall be matched with name of parameter(eqStatus vs pagerows)
* Line No. 88 :  : shall be matched with name of parameter(ibflag vs costYrmon)
* Line No. 88 :  : shall be matched with name of parameter(costYrmon vs fcntrEccCd)
* Line No. 88 :  : shall be matched with name of parameter(cntrImbalRto vs eqStatus)
* Line No. 88 :  : shall be matched with name of parameter(cntrIbQty vs cntrImbalRto)
* Line No. 88 :  : shall be matched with name of parameter(cntrObQty vs cntrImbalQty)
* Line No. 88 :  : shall be matched with name of parameter(cntrImbalQty vs cntrIbQty)
* Line No. 88 :  : shall be matched with name of parameter(pagerows vs cntrObQty)
...
public class SearchMTCostListVO7 extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCostListVO7> models = new ArrayList<SearchMTCostListVO7>();
	...
	/**
	 * SearchMTCostListVO7 생성자
	 */
	public SearchMTCostListVO7() {}
	 ...
	 */
	public SearchMTCostListVO7(String ibflag, String pagerows, String costYrmon, String fcntrEccCd, String cntrTpszCd, String eqStatus, String cntrImbalRto, String cntrImbalQty, String cntrIbQty, String cntrObQty) {
	 ...
	 */
	public SearchMTCostListVO7[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCostListVO7[]
	 */
	public SearchMTCostListVO7[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCostListVO7 model = null;
		...
		return getSearchMTCostListVO7s();
	}
	 ...
	 * @return SearchMTCostListVO7[]
	 */
	public SearchMTCostListVO7[] getSearchMTCostListVO7s(){
		SearchMTCostListVO7[] vos = (SearchMTCostListVO7[])models.toArray(new SearchMTCostListVO7[models.size()]);
		return vos;
	}
