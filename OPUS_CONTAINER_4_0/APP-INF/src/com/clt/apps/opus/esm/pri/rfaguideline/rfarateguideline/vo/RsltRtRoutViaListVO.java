...
*@FileName : RsltRtRoutViaListVO.java
*@FileTitle : RsltRtRoutViaListVO
*Open Issues :
*Change history :
...
public class RsltRtRoutViaListVO extends AbstractValueObject {
	...
	public RsltRtRoutViaListVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String cmdtHdrSeq, String routSeq, String orgDestTpCd, String routViaSeq, String routViaPortTpCd, String routViaPortDefCd, String routViaPortDefNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public RsltRtRoutViaListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		return getRsltRtRoutViaListVOs();
	}
	 ...
	 * @return RsltRtRoutViaListVO[]
	 */
	public RsltRtRoutViaListVO[] getRsltRtRoutViaListVOs(){
