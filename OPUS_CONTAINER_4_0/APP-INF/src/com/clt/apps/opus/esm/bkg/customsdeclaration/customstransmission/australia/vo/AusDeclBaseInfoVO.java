...
*@FileName : AusDeclBaseInfoVO.java
*@FileTitle : AusDeclBaseInfoVO
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
public class AusDeclBaseInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusDeclBaseInfoVO> models = new ArrayList<AusDeclBaseInfoVO>();
	...
	public AusDeclBaseInfoVO() {}

	public AusDeclBaseInfoVO(String ibflag, String pagerows, String docName, String declType, String handling, String status, String reason, String userRef, String oldUserRef, String firstUserRef, String secFileNbr, String ffRef) {
	 ...
	 */
	public AusDeclBaseInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusDeclBaseInfoVO[]
	 */
	public AusDeclBaseInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusDeclBaseInfoVO model = null;
	 ...
	 * @return AusDeclBaseInfoVO[]
	 */
	public AusDeclBaseInfoVO[] getAusDeclBaseInfoVOs(){
		AusDeclBaseInfoVO[] vos = (AusDeclBaseInfoVO[])models.toArray(new AusDeclBaseInfoVO[models.size()]);
		return vos;
	}
