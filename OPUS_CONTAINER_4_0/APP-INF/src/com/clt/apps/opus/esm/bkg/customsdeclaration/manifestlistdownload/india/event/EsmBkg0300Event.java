...
public class EsmBkg0300Event extends EventSupport {
	 ...
	 */
	public void setIndiaFormSettingDescVO(InPrintFromDetailVO indiaFormSettingDescVO) {
	...
	public InPrintFormModiVO[] getInPrintFormModiVOs() {
		InPrintFormModiVO[] rtnVOs = null;
		if (this.inPrintFormModiVOs != null) {
			rtnVOs = Arrays.copyOf(inPrintFormModiVOs, inPrintFormModiVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setInPrintFormModiVOs(InPrintFormModiVO[] inPrintFormModiVOs) {
		if (inPrintFormModiVOs != null) {
			InPrintFormModiVO[] tmpVOs = Arrays.copyOf(inPrintFormModiVOs, inPrintFormModiVOs.length);
			this.inPrintFormModiVOs = tmpVOs;
		}
	}
