...
*@FileName : ESM_SAQ_0161HTMLAction.java
...
public class ESM_SAQ_0161HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0161HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0161HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0161Event event = new EsmSaq0161Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {			
			...
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonQtaRhqVOs = saqMonQtaRhqVO.fromRequestGrid(request, event.getQuotaConditionVO());
