...
*@FileName : AncsManifestTransmitVO.java
*@FileTitle : AncsManifestTransmitVO
*Open Issues :
*Change history :
...
*    => BL Inquiry 화면에서 첫번째 Sheet 조회시 나온 데이타를 FlatFile 작성시 사용하자고 VO 생성
=========================================================*/
...
public class AncsManifestTransmitVO extends ManifestTransmitVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<AncsManifestTransmitVO> models = new ArrayList<AncsManifestTransmitVO>();
	...
	public AncsManifestTransmitVO() {}

	public AncsManifestTransmitVO(String ibflag, String pagerows, String svcRqstNo, String cneeAddr, String flatType, String blAck, String prevDocno, String cmPckQty, String blAck2, String anrMsgStsCd, String lloydCd, String cntrMfWgt, String blNo, String polCd, String cntrAck2, String cntrTpszCd, String wgtUtCd, String brthDesc, String cntrSeq, String cntrWgtUtCd, String cntrAck, String mfDesc, String vvdSeq, String cntrPckTpCd, String preRlyPortCd, String delCd, String msgTpCd, String rdTerm, String vvd, String podCd, String bkgNo, String ntfyName, String faxNo, String pstRlyPortCd, String declFlg, String cntrWgtQty, String porCd, String shprName, String bdrFlg, String msgSeq, String kind, String actWgtUtCd, String shprAddr, String cntrMfDesc, String cmCntrNo, String pckQty, String pckTpCd, String blLastEdi, String anrDeclNo, String blLastEdi2, String s3, String cntrLastEdi2, String cntrAnrMsgStsCd, String ntfyAddr, String s2, String s1, String actWgt, String ntfyEml, String cmPckTpCd, String cneeName, String cntrNo, String sequence, String cntrPckQty, String cntrLastEdi, String cntrFm, String mrnNo) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("flat_type", getFlatType());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("flat_type", "flatType");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFlatType(JSPUtil.getParameter(request, prefix + "flat_type", ""));
		...
		setS3(JSPUtil.getParameter(request, prefix + "s3", ""));
		...
		setS1(JSPUtil.getParameter(request, prefix + "s1", ""));
	 ...
	 * @param request
	 * @return AncsManifestTransmitVO[]
	 */
	public AncsManifestTransmitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AncsManifestTransmitVO[]
	 */
	public AncsManifestTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AncsManifestTransmitVO model = null;
		...
		try {
			...
			String[] flatType = (JSPUtil.getParameter(request, prefix	+ "flat_type", length));
			...
			String[] s3 = (JSPUtil.getParameter(request, prefix	+ "s3", length));
			...
			String[] s1 = (JSPUtil.getParameter(request, prefix	+ "s1", length));
			...
			for (int i = 0; i < length; i++) {
				model = new AncsManifestTransmitVO();
				if (svcRqstNo[i] != null)
					model.setSvcRqstNo(svcRqstNo[i]);
				if (cneeAddr[i] != null)
					model.setCneeAddr(cneeAddr[i]);
				if (flatType[i] != null)
					model.setFlatType(flatType[i]);
				if (blAck[i] != null)
		...
		return getAncsManifestTransmitVOs();
	}
	...
	public AncsManifestTransmitVO[] getAncsManifestTransmitVOs(){
		AncsManifestTransmitVO[] vos = (AncsManifestTransmitVO[])models.toArray(new AncsManifestTransmitVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.flatType = this.flatType .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.s3 = this.s3 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.s1 = this.s1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
