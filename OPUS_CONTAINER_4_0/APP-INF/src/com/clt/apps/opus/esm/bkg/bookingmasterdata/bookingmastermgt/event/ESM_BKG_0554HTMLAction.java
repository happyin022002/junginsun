...
*@FileName : ESM_BKG_0554HTMLAction.java
...
public class ESM_BKG_0554HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0554HTMLAction 객체를 생성
	 */
	public ESM_BKG_0554HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0554Event event = new EsmBkg0554Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgWarehouseVO((SearchWareHouseVO)getVO(request, SearchWareHouseVO .class));
		}
