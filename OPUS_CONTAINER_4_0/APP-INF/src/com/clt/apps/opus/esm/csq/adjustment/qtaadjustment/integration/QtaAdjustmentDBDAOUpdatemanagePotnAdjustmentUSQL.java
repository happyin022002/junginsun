...
public class QtaAdjustmentDBDAOUpdatemanagePotnAdjustmentUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("UPDATE CSQ_CFM_QTA_POTN_MGMT " ).append("\n"); 
		query.append("   SET LOD_POTN_RTO = @[lod_potn_rto] " ).append("\n"); 
		query.append("      ,REV_POTN_RTO = @[rev_potn_rto]" ).append("\n"); 
		query.append("      ,APLY_FM_YRWK = @[bse_yr]||@[aply_fm_yrwk] " ).append("\n"); 
		query.append("      ,APLY_TO_YRWK = @[bse_yr]||@[aply_to_yrwk] " ).append("\n"); 
		...
		query.append("  AND APLY_FM_YRWK  = @[bse_yr]||@[org_fm_yrwk]" ).append("\n"); 
		query.append("  AND APLY_TO_YRWK  = @[bse_yr]||@[org_to_yrwk]" ).append("\n"); 
