...
*@FileName : FACCommCalculationDBDAORemoveACMAgnCommChgDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FACCommCalculationDBDAORemoveACMAgnCommChgDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FACCommCalculationDBDAORemoveACMAgnCommChgDSQL
	  * </pre>
	  */
	public FACCommCalculationDBDAORemoveACMAgnCommChgDSQL(){
		setQuery();
		...
		query.append("FileName : FACCommCalculationDBDAORemoveACMAgnCommChgDSQL").append("\n");
		query.append("*/").append("\n");
	}
