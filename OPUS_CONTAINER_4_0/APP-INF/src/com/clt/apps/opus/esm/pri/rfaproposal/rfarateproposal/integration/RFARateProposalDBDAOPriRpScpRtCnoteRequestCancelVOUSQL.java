...
*@FileName : RFARateProposalDBDAOPriRpScpRtCnoteRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCnoteRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCnoteRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCnoteRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RP_SCP_RT_CNOTE SET" ).append("\n"); 
