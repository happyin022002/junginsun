...
*@FileName : EBookingReceiptDBDAOaddBkgXterRfCgoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterRfCgoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterRfCgoCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterRfCgoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_RF_CGO" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("(SELECT NVL(MAX(RC_SEQ), 0) + 1" ).append("\n"); 
