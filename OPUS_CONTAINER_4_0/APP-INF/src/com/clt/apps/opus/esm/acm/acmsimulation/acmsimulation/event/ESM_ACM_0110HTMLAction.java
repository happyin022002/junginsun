...
*@FileName : ESM_ACM_0110HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see EsmAcm0110Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0110HTMLAction 객체를 생성
	 */
	public ESM_ACM_0110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0110Event event = new EsmAcm0110Event();

		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH02)) {
			event.setSimulationNoVO((SimulationNoVO)getVO(request, SimulationNoVO.class));
		}
