...
public class JapanManifestListVslPortSkdVO extends AbstractValueObject {
	...
	public JapanManifestListVslPortSkdVO(String ibflag, String pagerows, String bkgCount, String polCd, String podCd, String vpsEtdDt, String vpsEtaDt, String bdrFlg, String bdrTime, String conVvd) {
		this.podCd = podCd;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setBdrTime(JSPUtil.getParameter(request, prefix + "bdr_time", ""));
