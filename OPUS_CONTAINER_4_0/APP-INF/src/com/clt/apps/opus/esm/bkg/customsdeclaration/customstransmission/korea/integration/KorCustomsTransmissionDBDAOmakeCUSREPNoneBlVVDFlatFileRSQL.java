...
*@FileName : KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  (SELECT DECODE(@[io_bnd_cd], 'I', IB_CSSM_VOY_NO, OB_CSSM_VOY_NO)" ).append("\n"); 
		query.append("     FROM VSK_VSL_PORT_SKD" ).append("\n"); 
		query.append("    WHERE VSL_CD = SUBSTR(@[vvd], 1, 4)" ).append("\n"); 
		query.append("      AND SKD_VOY_NO = SUBSTR(@[vvd], 5, 4)" ).append("\n"); 
		query.append("      AND SKD_DIR_CD = SUBSTR(@[vvd], 9, 1)" ).append("\n"); 
		query.append("      AND VPS_PORT_CD = DECODE(@[io_bnd_cd], 'I', @[pod_cd], @[pol_cd]))   ||'~'||  /* Cons Voy */ " ).append("\n"); 
		query.append("  TO_CHAR(SYSDATE,'yyyymmdd') ||'~'|| --/* Sending Date */" ).append("\n"); 
		query.append("  TO_CHAR(SYSDATE,'hh24miss') ||'~'|| --/* sending Time */" ).append("\n"); 
		...
		query.append("  TO_CHAR(TO_DATE(@[etd_dt], 'YYYY-MM-DD HH24MI'),'YYYYMMDDHH24MISS') ||'~'|| --/* ETD Date  */" ).append("\n"); 
		...
		query.append("  'NYK LINE(KOREA) CO., LTD' ||'~'|| --/* 선박대리점명  AGENCY1 */" ).append("\n"); 
		query.append("  '' ||'~'|| --/* 선박대리점명 AGENCY2*/" ).append("\n"); 
		query.append("  '' ||'~'|| --/* 선박대리점명 AGENCY3*/" ).append("\n"); 
		...
		query.append("                            , 'KRPUS', 'KM-C-0685'" ).append("\n"); 
		query.append("                            , 'KRKAN', 'KM-C-0685'" ).append("\n"); 
