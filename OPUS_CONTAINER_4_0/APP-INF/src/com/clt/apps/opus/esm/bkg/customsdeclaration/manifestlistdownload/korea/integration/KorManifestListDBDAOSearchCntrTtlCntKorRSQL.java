...
*@FileName : KorManifestListDBDAOSearchCntrTtlCntKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchCntrTtlCntKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchCntrTtlCntKorRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchCntrTtlCntKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
