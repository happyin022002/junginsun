...
*@FileName : RFARateProposalDBDAORsltPriRpScpRtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltPriRpScpRtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SELECT PRI_SP_SCP_RT
	  * </pre>
	  */
	public RFARateProposalDBDAORsltPriRpScpRtRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltPriRpScpRtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
