...
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.canada.vo.CndCstmsManifestDtlListVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.canada.vo.CndCstmsManifestListVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.canada.vo.CndCstmsRcvHisListCondVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.canada.vo.CndCstmsRcvHisVO;
...
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.canada.vo.CndCstmsSndHisVO;
...
/**
 * OPUS CndCustomsTransmissionDBDAO <br>
...
public class CndCustomsTransmissionDBDAO extends DBDAOSupport {
	...
	public List<CstmsManifestAmendmentVO> searchCndCstmsManifestAmendment(CndCstmsManifestAmendmentCondVO cndCstmsManifestAmendmentCondVO) throws DAOException {
		...
		try
		{
			...
			{
				// Vessel 스케줄 조회
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CndCustomsTransmissionDBDAOsearchMinClptSeqRSQL(), param, velParam);
				if (dbRowset.next())
				{
	...
	public List<CstmsManifestAmendmentVO> searchDelManifestAmendment(CndCstmsManifestAmendmentCondVO cndCstmsManifestAmendmentCondVO) throws DAOException {
		...
		try {
			...
			DBRowSet dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CndCustomsTransmissionDBDAOsearchDelManifestAmendmentRSQL(), param, velParam);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<CndCstmsSndLogDtlVO> searchCndCstmsSndLogDtl(CndCstmsSndLogDtlCondVO cndCstmsSndLogDtlCondVO)
			throws DAOException {
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
		DBRowSet dbRowset = null;
...
//			throw new DAOException(new ErrorHandler(ex).getMessage(), ex);
	...
	public CndCstmsBlByKeyVO searchCndCstmsBlByKey(String cstmsBatNo) {
		...
		try
		{
			...
			List list = (List) RowSetUtil.rowSetToVOs(dbRowset, CndCstmsBlByKeyVO.class);
			if (list.size() > 0)
			{
				cndCstmsBlByKeyVO = (CndCstmsBlByKeyVO) list.get(0);
			}
		}
//		catch (SQLException se)
//		{
...
//			throw new DAOException(new ErrorHandler(ex).getMessage(), ex);
	...
	public List<CndCstmsBlByKeyVO> searchBlForCrrBatNo(String crrBatNo) throws DAOException {
		...
		try
		{
			...
			dbRowset = new SQLExecuter("").executeQuery(
					(ISQLTemplate) new CndCustomsTransmissionDBDAOsearchBlForCrrBatNoRSQL(), param, null);
	...
	/**
	 * 1023화면, Vessel Stowage Plan VVD값을 입력할 때, Last Port을 조회한다 .<br>
	 *
	 * @param String vvd
	 * @return List<StiDetailCndVO>
	 * @throws DAOException
	...
	public List<StiDetailCndVO> searchLastForeignPort(String vvd) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CndCustomsTransmissionDBDAOsearchLastForeignPortRSQL(), param,velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, StiDetailCndVO.class);
		}
		catch (SQLException se)
		{
	...
	public List<StiDetailCndVO> searchCrnNo(String vvd, String vpsPortCd, String clptIndSeq) throws DAOException {
		...
		try{
				...
				velParam.put("vps_port_cd", vpsPortCd);
				param.put("clpt_ind_seq", clptIndSeq);
				velParam.put("clpt_ind_seq", clptIndSeq);
				
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CndCustomsTransmissionDBDAOsearchCrnNoRSQL(), param,velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, StiDetailCndVO.class);
		}
		catch (SQLException se)
		{
