...
*@FileName : ESM_ACM_0023HTMLAction.java
...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.acm.acmagreement.ffcmpnagreement.event;
...
public class ESM_ACM_0023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0023HTMLAction 객체를 생성
	 */
	public ESM_ACM_0023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0023Event event = new EsmAcm0023Event();

		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH11)) {
			event.setFfagreementVO((FFAgreementVO)getVO(request, FFAgreementVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setFfagreementVOs((FFAgreementVO[])getVOs(request, FFAgreementVO.class, ""));
