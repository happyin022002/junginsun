...
*@FileName : TransferOrderIssueDBDAOSearchTroSpclCgoSeqRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOSearchTroSpclCgoSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TransferOrderIssueDBDAOSearchTroSpclCgoSeqRSQL
	  * </pre>
	  */
	public TransferOrderIssueDBDAOSearchTroSpclCgoSeqRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("ORDER BY TRO_SEQ, SPCL_CGO_CD, SPCL_CGO_SEQ" ).append("\n");

		query.append("/*").append("\n");
		query.append("Path : com.clt.apps.opus.esm.bkg.bookingconduct.generalbookingconduct.transferorderissue.integration ").append("\n");
		query.append("FileName : TransferOrderIssueDBDAOSearchTroSpclCgoSeqRSQL").append("\n");
		query.append("*/").append("\n");
	}
}