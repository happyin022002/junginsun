...
*@FileName : RFAGuidelineMainDBDAOGlineCopyPriRgMnCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGuidelineMainDBDAOGlineCopyPriRgMnCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGuidelineMainDBDAOGlineCopyPriRgMnCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGuidelineMainDBDAOGlineCopyPriRgMnCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	TO_DATE(REPLACE(@[trgt_eff_dt],'-',''),'YYYYMMDD')" ).append("\n"); 
		query.append(",	TO_DATE(REPLACE(@[trgt_exp_dt],'-',''),'YYYYMMDD')" ).append("\n"); 
