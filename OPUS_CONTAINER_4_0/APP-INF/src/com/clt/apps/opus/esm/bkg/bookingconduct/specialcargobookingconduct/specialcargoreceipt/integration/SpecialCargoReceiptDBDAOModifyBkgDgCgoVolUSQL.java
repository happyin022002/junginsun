...
*@FileName : SpecialCargoReceiptDBDAOModifyBkgDgCgoVolUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOModifyBkgDgCgoVolUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 DG 의 volumn을 container 기준으로 update한다.
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOModifyBkgDgCgoVolUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOModifyBkgDgCgoVolUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO BKG_DG_CGO SPCL" ).append("\n"); 
