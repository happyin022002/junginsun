...
*@FileName : RFARateProposalDBDAOPriRpScpRtRoutViaForExlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtRoutViaForExlVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT PRI_SP_SCP_RT_ROUT_VIA
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtRoutViaForExlVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtRoutViaForExlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ INDEX_DESC(A XPKPRI_RP_SCP_RT_ROUT_VIA) */" ).append("\n"); 
		query.append("                  ROUT_VIA_SEQ" ).append("\n"); 
