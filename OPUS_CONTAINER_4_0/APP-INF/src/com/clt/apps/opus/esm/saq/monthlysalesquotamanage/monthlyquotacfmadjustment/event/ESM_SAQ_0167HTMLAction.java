...
*@FileName : ESM_SAQ_0167HTMLAction.java
...
public class ESM_SAQ_0167HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0167HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0167HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0167Event event = new EsmSaq0167Event();
		SaqMonCfmQtaOfcAddVO saqMonCfmQtaOfcAddVO = new SaqMonCfmQtaOfcAddVO();
		SaqMonCfmQtaOfcAddVO[] saqMonCfmQtaOfcAddVOs = null;
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonCfmQtaOfcAddVOs = saqMonCfmQtaOfcAddVO.fromRequestGrid(request, event.getQuotaConditionVO());
			event.setSaqMonCfmQtaOfcAddVOs(saqMonCfmQtaOfcAddVOs);
		}
