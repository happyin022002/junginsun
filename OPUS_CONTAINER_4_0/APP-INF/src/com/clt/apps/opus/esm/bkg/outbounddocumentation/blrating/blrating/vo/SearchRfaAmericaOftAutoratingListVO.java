...
*@FileName : SearchRfaAmericaOftAutoratingListVO.java
*@FileTitle : SearchRfaAmericaOftAutoratingListVO
*Open Issues :
*Change history :
...
public class SearchRfaAmericaOftAutoratingListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchRfaAmericaOftAutoratingListVO> models = new ArrayList<SearchRfaAmericaOftAutoratingListVO>();
	 ...
	 * @param request
	 * @return SearchRfaAmericaOftAutoratingListVO[]
	 */
	public SearchRfaAmericaOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchRfaAmericaOftAutoratingListVO[]
	 */
	public SearchRfaAmericaOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchRfaAmericaOftAutoratingListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchRfaAmericaOftAutoratingListVO();
				if (svcScpCd[i] != null)
		...
		return getSearchRfaAmericaOftAutoratingListVOs();
	}
	 ...
	 * @return SearchRfaAmericaOftAutoratingListVO[]
	 */
	public SearchRfaAmericaOftAutoratingListVO[] getSearchRfaAmericaOftAutoratingListVOs(){
		SearchRfaAmericaOftAutoratingListVO[] vos = (SearchRfaAmericaOftAutoratingListVO[])models.toArray(new SearchRfaAmericaOftAutoratingListVO[models.size()]);
		return vos;
	}
