...
*@FileName : BSAManageDBDAORemoveOpSlotCostList2DDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveOpSlotCostList2DDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAORemoveOpSlotCostList2DDSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveOpSlotCostList2DDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_OP_SLT_PRC" ).append("\n"); 
