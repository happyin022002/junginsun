...
public class BkgListForBkgReceiptVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String cctCng = null;

    /* Column Info */
    private String cargoCct = null;

    /* Column Info */
    private String cargoCctCng = null;
    ...
    public BkgListForBkgReceiptVO(String ibflag, String pagerows, String bkgNo, String status, String kind, String shipperCode, String shipperName, String ffCd, String fax, String eml, String cct, String docCct, String tvvd, String por, String eqOfc, String pol, String pod, String del, String bkgStaff, String contactPic, String faxResult, String faxErr, String faxDate, String emlResult, String emlErr, String emlDate, String remark, String cctMnl, String cctCng, String cargoCct, String cargoCctCng, String cargoCctMnl, String fullRtnYdCd, String ediHldFlg) {
        ...
        this.cctMnl = cctMnl;
        this.cctCng = cctCng;
        this.cargoCct = cargoCct;
        this.cargoCctCng = cargoCctCng;
        this.cargoCctMnl = cargoCctMnl;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("cct_mnl", getCctMnl());
        this.hashColumns.put("cct_cng", getCctCng());
        this.hashColumns.put("cargo_cct", getCargoCct());
        this.hashColumns.put("cargo_cct_cng", getCargoCctCng());
        this.hashColumns.put("cargo_cct_mnl", getCargoCctMnl());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("cct_mnl", "cctMnl");
        this.hashFields.put("cct_cng", "cctCng");
        this.hashFields.put("cargo_cct", "cargoCct");
        this.hashFields.put("cargo_cct_cng", "cargoCctCng");
        this.hashFields.put("cargo_cct_mnl", "cargoCctMnl");
	 ...
	 * @return cargoCct
	 */
    public String getCargoCct() {
        return this.cargoCct;
    }
	 ...
	 * @return cargoCctCng
	 */
    public String getCargoCctCng() {
        return this.cargoCctCng;
    }
	 ...
	 * @param cctCng
	 */
    public void setCctCng(String cctCng) {
        this.cctCng = cctCng;
    }
	 ...
	 * @param cargoCct
	 */
    public void setCargoCct(String cargoCct) {
        this.cargoCct = cargoCct;
    }
	 ...
	 * @param cargoCctCng
	 */
    public void setCargoCctCng(String cargoCctCng) {
        this.cargoCctCng = cargoCctCng;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setCctMnl(JSPUtil.getParameter(request, prefix + "cct_mnl", ""));
        setCctCng(JSPUtil.getParameter(request, prefix + "cct_cng", ""));
        setCargoCct(JSPUtil.getParameter(request, prefix + "cargo_cct", ""));
        setCargoCctCng(JSPUtil.getParameter(request, prefix + "cargo_cct_cng", ""));
        setCargoCctMnl(JSPUtil.getParameter(request, prefix + "cargo_cct_mnl", ""));
    ...
    public BkgListForBkgReceiptVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] cctMnl = (JSPUtil.getParameter(request, prefix + "cct_mnl", length));
            String[] cctCng = (JSPUtil.getParameter(request, prefix + "cct_cng", length));
            String[] cargoCct = (JSPUtil.getParameter(request, prefix + "cargo_cct", length));
            String[] cargoCctCng = (JSPUtil.getParameter(request, prefix + "cargo_cct_cng", length));
            String[] cargoCctMnl = (JSPUtil.getParameter(request, prefix + "cargo_cct_mnl", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cctMnl[i] != null)
                    model.setCctMnl(cctMnl[i]);
                if (cctCng[i] != null)
                    model.setCctCng(cctCng[i]);
                if (cargoCct[i] != null)
                    model.setCargoCct(cargoCct[i]);
                if (cargoCctCng[i] != null)
                    model.setCargoCctCng(cargoCctCng[i]);
                if (cargoCctMnl[i] != null)
                    model.setCargoCctMnl(cargoCctMnl[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.cctMnl = this.cctMnl.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.cctCng = this.cctCng.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.cargoCct = this.cargoCct.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.cargoCctCng = this.cargoCctCng.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.cargoCctMnl = this.cargoCctMnl.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
