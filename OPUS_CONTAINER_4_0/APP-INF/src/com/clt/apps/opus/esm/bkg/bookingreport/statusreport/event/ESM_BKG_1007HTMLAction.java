...
*@FileName : ESM_BKG_1007HTMLAction.java
...
public class ESM_BKG_1007HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_1007HTMLAction 객체를 생성
     */
    public ESM_BKG_1007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1007Event event = new EsmBkg1007Event();
		...
		if (command.isCommand(FormCommand.SEARCH)){ // Queue History 조회
			...
			event.setSrKndCd(JSPUtil.getParameter(request, "sr_knd_cd"));
			event.setSrHisSeq(JSPUtil.getParameter(request, "sr_his_seq"));
		}
