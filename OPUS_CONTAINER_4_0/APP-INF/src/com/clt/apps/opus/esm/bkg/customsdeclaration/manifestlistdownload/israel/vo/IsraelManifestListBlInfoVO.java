...
public class IsraelManifestListBlInfoVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("snd_time", getSndTime());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("snd_time", "sndTime");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCntrNo(JSPUtil.getParameter(request, prefix + "rcv_time", ""));
		setCntrNo(JSPUtil.getParameter(request, prefix + "snd_time", ""));
	}
	...
	public IsraelManifestListBlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sndTime = (JSPUtil.getParameter(request, prefix	+ "snd_time", length));
	...
	*/
	public void unDataFormat(){
		...
		this.sndTime = this.sndTime .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
