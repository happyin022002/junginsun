...
*@FileName       : ESM_CSQ_0056HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmCsq0056Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0056HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0056HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0056HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0056Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCsq0056Event event = new EsmCsq0056Event();

		if(command.isCommand(FormCommand.MULTI02)) {
			event.setSearchLaneOfficeListVOS((SearchLaneOfficeListVO[])getVOs(request, SearchLaneOfficeListVO .class,""));
			event.setCsqQtaLaneOfcVOS((CsqQtaLaneOfcVO[])getVOs(request, CsqQtaLaneOfcVO .class,""));
		} 
