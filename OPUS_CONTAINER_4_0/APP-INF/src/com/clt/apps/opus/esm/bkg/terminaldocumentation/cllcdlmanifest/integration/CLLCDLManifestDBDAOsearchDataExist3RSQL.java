...
*@FileName : CLLCDLManifestDBDAOsearchDataExist3RSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class CLLCDLManifestDBDAOsearchDataExist3RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLLCDLManifestDBDAOsearchDataExist3RSQL(){
		setQuery();
		...
		query.append("FileName : CLLCDLManifestDBDAOsearchDataExist3RSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("AND	CL_RCVSTS	= 'I'" ).append("\n");
