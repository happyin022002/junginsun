...
*@FileName : ESM_PRI_2049HTMLAction.java
...
public class ESM_PRI_2049HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_2049HTMLAction 객체를 생성
	 */
	public ESM_PRI_2049HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2049Event event = new EsmPri2049Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltRfaAproRqstRefVO((RsltRfaAproRqstRefVO)getVO(request, RsltRfaAproRqstRefVO.class));
		}
