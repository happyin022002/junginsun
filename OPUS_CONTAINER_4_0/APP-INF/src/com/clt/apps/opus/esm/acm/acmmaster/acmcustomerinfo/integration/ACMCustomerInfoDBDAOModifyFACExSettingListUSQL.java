...
*@FileName : ACMCustomerInfoDBDAOModifyFACExSettingListUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMCustomerInfoDBDAOModifyFACExSettingListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCustomerInfoDBDAOModifyFACExSettingListUSQL(){
		setQuery();
		...
		query.append("FileName : ACMCustomerInfoDBDAOModifyFACExSettingListUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("UPDATE ACM_FAC_EXCLU_SET" ).append("\n");
