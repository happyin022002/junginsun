...
*@FileName : ESM_BKG_0082HTMLAction.java
...
public class ESM_BKG_0082HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0082HTMLAction 객체를 생성
	 */
	public ESM_BKG_0082HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0082Event event = new EsmBkg0082Event();
		
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgMTPickupCYVO((BkgMTPickupCYVO)getVO(request, BkgMTPickupCYVO .class));
			event.setMdmYardVO((MdmYardVO)getVO(request, MdmYardVO .class));
			event.setSelectSheetYdCd(JSPUtil.getParameter(request, "selectSheetYdCd"));
