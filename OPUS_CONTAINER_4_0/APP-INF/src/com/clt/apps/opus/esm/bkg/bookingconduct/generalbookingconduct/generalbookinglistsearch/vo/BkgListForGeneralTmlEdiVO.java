...
public class BkgListForGeneralTmlEdiVO extends AbstractValueObject {
    ...
    public void fromRequest(HttpServletRequest request) {
        setUvi(JSPUtil.getParameter(request, "uvi", ""));
        setEtb(JSPUtil.getParameter(request, "etb", ""));
        setFirstVvd(JSPUtil.getParameter(request, "first_vvd", ""));
