...
public class BkgRfCgoVO extends AbstractValueObject {
	...
	private String snsCgoKndCd = null;
	private String oxgnRto = null;
	private String crbnDxdRto = null;
	...
	public BkgRfCgoVO(String ibflag, String pagerows, String cntrVolQty, String cbmPerHrQty, String bkgNo, String rcSeq, String cntrTpszCd, String cntrNo, String pckTpCd, String pckQty, String netWgt, String grsWgt, String wgtUtCd, String cmdtCd, String cmdtDesc, String fdoTemp, String cdoTemp, String cntrVentTpCd, String ventRto, String humidNo, String diffRmk, String rfDcgoSeq, String pwrSplCblFlg, String vltgNo, String ctrlAtmsFlg, String modiAtmsFlg, String humidCtrlFlg, String cntrDrnCd, String clngTpCd, String rqstDt, String rqstUsrId, String spclCgoAproCd, String creUsrId, String creDt, String updUsrId, String updDt, String porCd, String delCd, String rcvTermCd, String deTermCd, String cntrCgoSeq, String aplyNo, String snsCgoKndCd, String oxgnRto, String crbnDxdRto) {
		...
		this.snsCgoKndCd = snsCgoKndCd;
		this.oxgnRto = oxgnRto;
		this.crbnDxdRto = crbnDxdRto;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sns_cgo_knd_cd", getSnsCgoKndCd());
		this.hashColumns.put("oxgn_rto", getOxgnRto());
		this.hashColumns.put("crbn_dxd_rto", getCrbnDxdRto());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sns_cgo_knd_cd", "snsCgoKndCd");
		this.hashFields.put("oxgn_rto", "oxgnRto");
		this.hashFields.put("crbn_dxd_rto", "crbnDxdRto");
	...
	/**
	 * @return the snsCgoKndCd
	 */
	public String getSnsCgoKndCd() {
		return snsCgoKndCd;
	}

	/**
	 * @param snsCgoKndCd the snsCgoKndCd to set
	 */
	public void setSnsCgoKndCd(String snsCgoKndCd) {
		this.snsCgoKndCd = snsCgoKndCd;
	}
	 ...
	 * @return the oxgnRto
	 */
	public String getOxgnRto() {
		return oxgnRto;
	}

	/**
	 * @param oxgnRto the oxgnRto to set
	 */
	public void setOxgnRto(String oxgnRto) {
		this.oxgnRto = oxgnRto;
	}

	/**
	 * @return the crbnDxdRto
	 */
	public String getCrbnDxdRto() {
		return crbnDxdRto;
	}

	/**
	 * @param crbnDxdRto the crbnDxdRto to set
	 */
	public void setCrbnDxdRto(String crbnDxdRto) {
		this.crbnDxdRto = crbnDxdRto;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSnsCgoKndCd(JSPUtil.getParameter(request, prefix + "sns_cgo_kndCd", ""));
		setOxgnRto(JSPUtil.getParameter(request, prefix + "oxgn_rto", ""));
		setCrbnDxdRto(JSPUtil.getParameter(request, prefix + "crbn_dxd_rto", ""));
	}
	...
	public BkgRfCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] snsCgoKndCd = (JSPUtil.getParameter(request, prefix	+ "sns_cgo_knd_cd", length));
			String[] oxgnRto = (JSPUtil.getParameter(request, prefix	+ "oxgn_rto", length));
			String[] crbnDxdRto = (JSPUtil.getParameter(request, prefix	+ "crbn_dxd_rto", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (snsCgoKndCd[i] != null)
					model.setSnsCgoKndCd(snsCgoKndCd[i]);
				if (oxgnRto[i] != null)
					model.setOxgnRto(oxgnRto[i]);
				if (crbnDxdRto[i] != null)
					model.setCrbnDxdRto(crbnDxdRto[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.snsCgoKndCd = this.snsCgoKndCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.oxgnRto = this.oxgnRto .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.crbnDxdRto = this.crbnDxdRto .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
