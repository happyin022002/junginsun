 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0249HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0013HTMLAction 객체를 생성
	 */
	public ESM_BKG_0249HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0249Event event = new EsmBkg0249Event();
		if (command.isCommand(FormCommand.SEARCH))
		{
			// CRN 조회
			event.setCstmsVvdListCondVO((CstmsVvdListCondVO) getVO(request, CstmsVvdListCondVO.class));
		}
