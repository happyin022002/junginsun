...
*@FileName : ESM_ACM_0007HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see EsmAcm0007Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0007HTMLAction 객체를 생성
	 */
	public ESM_ACM_0007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0007Event event = new EsmAcm0007Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setChinaOfficeInfoVO((ChinaOfficeInfoVO)getVO(request, ChinaOfficeInfoVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setChinaOfficeInfoVOs((ChinaOfficeInfoVO[])getVOs(request, ChinaOfficeInfoVO.class, ""));
		}
