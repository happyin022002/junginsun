...
*@FileName : SpecialManifestDBDAOremoveDgHisListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOremoveDgHisListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOremoveDgHisListDSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOremoveDgHisListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_EUR_DG_HIS" ).append("\n"); 
