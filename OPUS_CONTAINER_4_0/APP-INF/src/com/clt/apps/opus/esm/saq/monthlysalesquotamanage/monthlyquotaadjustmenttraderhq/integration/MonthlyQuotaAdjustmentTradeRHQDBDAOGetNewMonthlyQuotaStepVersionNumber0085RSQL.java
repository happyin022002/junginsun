...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetNewMonthlyQuotaStepVersionNumber0085RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOGetNewMonthlyQuotaStepVersionNumber0085RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOGetNewMonthlyQuotaStepVersionNumber0085RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetNewMonthlyQuotaStepVersionNumber0085RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MIN(SUBSTR(MQTA_VER_NO, 1, LENGTH(MQTA_VER_NO)-2))" ).append("\n"); 
		query.append("           ||TO_CHAR(NVL(MAX(SUBSTR(MQTA_VER_NO," ).append("\n"); 
		query.append("               LENGTH(MQTA_VER_NO)-1)), 0)+1,'FM09')" ).append("\n"); 
		query.append("           AS NEW_VER_NO" ).append("\n"); 
