 ...
 *@FileName : ESM_PRI_0107HTMLAction.java
...
public class ESM_PRI_0107HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_0106HTMLAction 객체를 생성
	 */
	public ESM_PRI_0107HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0107Event event = new EsmPri0107Event();
