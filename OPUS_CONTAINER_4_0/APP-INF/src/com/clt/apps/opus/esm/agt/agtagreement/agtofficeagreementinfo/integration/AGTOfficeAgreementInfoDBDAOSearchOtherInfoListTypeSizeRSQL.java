...
*@FileName : AGTOfficeAgreementInfoDBDAOSearchOtherInfoListTypeSizeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOSearchOtherInfoListTypeSizeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchOtherInfoListTypeSize
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOSearchOtherInfoListTypeSizeRSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOSearchOtherInfoListTypeSizeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT" ).append("\n"); 
		query.append("DECODE (B.CNTR_TPSZ_CD, A.OTR_INFO_NO, '1', '0') AS CHECKBOX," ).append("\n"); 
		query.append("B.CNTR_TPSZ_CD," ).append("\n"); 
		query.append("B.CNTR_TPSZ_DESC" ).append("\n"); 
		query.append("FROM MDM_CNTR_TP_SZ B," ).append("\n"); 
		query.append("(     SELECT" ).append("\n"); 
		query.append("DISTINCT OTR_INFO_NO AS OTR_INFO_NO" ).append("\n"); 
		...
		query.append("AND OTR_REF_DIV_CD   = 'TPSZ'" ).append("\n"); 
		query.append("AND OTR_LVL_CD       = '1'" ).append("\n"); 
		query.append(") A" ).append("\n"); 
		query.append("WHERE B.CNTR_TPSZ_CD                = A.OTR_INFO_NO(+)" ).append("\n"); 
		query.append("AND NVL (B.DELT_FLG, 'N')         = 'N'" ).append("\n"); 
		query.append("ORDER BY B.CNTR_TPSZ_CD" ).append("\n"); 
