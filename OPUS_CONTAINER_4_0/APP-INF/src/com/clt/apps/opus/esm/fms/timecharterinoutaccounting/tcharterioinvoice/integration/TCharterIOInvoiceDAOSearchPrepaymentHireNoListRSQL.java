...
public class TCharterIOInvoiceDAOSearchPrepaymentHireNoListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       DECODE(FD.FLET_CURR_CHK_CD,'F',TRIM(TO_CHAR(FD.INV_AMT,'999,999,999,999,999,990.00')),NULL) INV_AMT," ).append("\n"); 
		query.append("       DECODE(FD.FLET_CURR_CHK_CD,'F',TRIM(TO_CHAR(FD.INV_AMT,'999,999,999,999,999,990.00')),NULL) ORI_INV_AMT," ).append("\n"); 
		query.append("	   DECODE(FD.FLET_CURR_CHK_CD,'F',TRIM(TO_CHAR(FD.INV_AMT,'999,999,999,999,999,990.00')),NULL) FIR_INV_AMT," ).append("\n"); 
		query.append("       DECODE(FD.FLET_CURR_CHK_CD,'S',FD.CURR_CD,NULL) CURR_CD2, " ).append("\n"); 
		query.append("       DECODE(FD.FLET_CURR_CHK_CD,'S',TRIM(TO_CHAR(FD.INV_AMT,'999,999,999,999,999,990.00')),NULL) INV_AMT2," ).append("\n"); 
		query.append("       DECODE(FD.FLET_CURR_CHK_CD,'S',TRIM(TO_CHAR(FD.INV_AMT,'999,999,999,999,999,990.00')),NULL) ORI_INV_AMT2," ).append("\n"); 
		query.append("       DECODE(FD.FLET_CURR_CHK_CD,'S',TRIM(TO_CHAR(FD.INV_AMT,'999,999,999,999,999,990.00')),NULL) FIR_INV_AMT2," ).append("\n"); 
