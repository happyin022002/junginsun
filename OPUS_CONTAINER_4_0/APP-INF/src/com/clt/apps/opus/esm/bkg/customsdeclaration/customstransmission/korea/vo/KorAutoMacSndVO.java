...
*@FileName : KorAutoMacSndVO.java
*@FileTitle : KorAutoMacSndVO
*Open Issues :
*Change history :
...
public class KorAutoMacSndVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorAutoMacSndVO> models = new ArrayList<KorAutoMacSndVO>();
	...
	public KorAutoMacSndVO() {}

	public KorAutoMacSndVO(String ibflag, String pagerows, String sndDt, String ofcCd, String fltFileRefNo, String usrId, String vvdCd, String polCd, String blNo, String subNo, String sndSeq, String ediSndMsg) {
		this.ofcCd = ofcCd;
		this.sndSeq = sndSeq;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return KorAutoMacSndVO[]
	 */
	public KorAutoMacSndVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorAutoMacSndVO[]
	 */
	public KorAutoMacSndVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorAutoMacSndVO model = null;
	 ...
	 * @return KorAutoMacSndVO[]
	 */
	public KorAutoMacSndVO[] getKorAutoMacSndVOs(){
		KorAutoMacSndVO[] vos = (KorAutoMacSndVO[])models.toArray(new KorAutoMacSndVO[models.size()]);
		return vos;
	}
