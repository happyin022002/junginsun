...
*@FileName : CostManageDBDAOCreateBasicCmcbForIasSectorCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostManageDBDAOCreateBasicCmcbForIasSectorCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Basic CMCB for IAS Sector Data를 생성한다.
	  * </pre>
	  */
	public CostManageDBDAOCreateBasicCmcbForIasSectorCSQL(){
		setQuery();
		...
		query.append("FileName : CostManageDBDAOCreateBasicCmcbForIasSectorCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
