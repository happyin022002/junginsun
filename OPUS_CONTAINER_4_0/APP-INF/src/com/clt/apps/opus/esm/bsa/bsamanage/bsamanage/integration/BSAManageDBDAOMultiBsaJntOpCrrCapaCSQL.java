...
*@FileName : BSAManageDBDAOMultiBsaJntOpCrrCapaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOMultiBsaJntOpCrrCapaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BsaJntOpCrrCapa Table  Insert/Update Quiry
	  * </pre>
	  */
	public BSAManageDBDAOMultiBsaJntOpCrrCapaCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOMultiBsaJntOpCrrCapaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BSA_JNT_OP_CRR_CAPA A" ).append("\n"); 
		...
		query.append("A.VOP_CD       = B.VOP_CD       AND" ).append("\n"); 
		query.append("A.VSL_CAPA     = B.VSL_CAPA     AND" ).append("\n"); 
		...
		query.append("SPC_CTRL_SLT_CAPA = @[crr_bsa_capa]," ).append("\n"); 
