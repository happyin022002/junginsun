...
*@FileName : TCharterIOConsultationDBDAOFmsSubletRevenueSlipsCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOFmsSubletRevenueSlipsCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Sublet Revenue Insert
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOFmsSubletRevenueSlipsCSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOConsultationDBDAOFmsSubletRevenueSlipsCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
