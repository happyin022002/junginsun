...
*@FileName : Jp24CustomsTransmissionDBDAOAddAdvJpSendLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Jp24CustomsTransmissionDBDAOAddAdvJpSendLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24CustomsTransmissionDBDAOAddAdvJpSendLogCSQL(){
		setQuery();
		...
		query.append("FileName : Jp24CustomsTransmissionDBDAOAddAdvJpSendLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
