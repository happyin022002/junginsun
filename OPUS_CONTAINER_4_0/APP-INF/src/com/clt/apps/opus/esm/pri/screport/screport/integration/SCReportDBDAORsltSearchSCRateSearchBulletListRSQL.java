...
*@FileName : SCReportDBDAORsltSearchSCRateSearchBulletListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAORsltSearchSCRateSearchBulletListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * rate search commodity group and actual customer
	  * </pre>
	  */
	public SCReportDBDAORsltSearchSCRateSearchBulletListRSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAORsltSearchSCRateSearchBulletListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND		SS.EFF_DT <= TO_DATE(@[exp_dt], 'YYYY-MM-DD')	-- Effective Date(To)-- 이 부분은 UI_PRI_0060 번 에서 사용된다.  UI_PRI_0108_02 에서는 INPUT 없음" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${eff_dt} != '') " ).append("\n"); 
		query.append("AND		SS.EXP_DT >= TO_DATE(@[eff_dt], 'YYYY-MM-DD')	-- Effective Date(From)-- 이 부분은 UI_PRI_0060 번 에서 사용된다.  UI_PRI_0108_02 에서는 INPUT 없음" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(") ," ).append("\n"); 
