...
*@FileName : ESM_FMS_0058HTMLAction.java
*@FileTitle : D/Dock Schedule Review/Print
*Open Issues :
*Change history :
...
public class ESM_FMS_0058HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0055HTMLAction 객체를 생성
	 */
	public ESM_FMS_0058HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0058Event event = new EsmFms0058Event();
