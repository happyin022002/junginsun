...
*@FileName : PkupNoRptEmlCtntVO.java
*@FileTitle : PkupNoRptEmlCtntVO
*Open Issues :
*Change history :
...
public class PkupNoRptEmlCtntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PkupNoRptEmlCtntVO> models = new ArrayList<PkupNoRptEmlCtntVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCol19(JSPUtil.getParameter(request, "col19", ""));
		...
		setCol14(JSPUtil.getParameter(request, "col14", ""));
		...
		setCol18(JSPUtil.getParameter(request, "col18", ""));
		setCol9(JSPUtil.getParameter(request, "col9", ""));
		setCol17(JSPUtil.getParameter(request, "col17", ""));
		setCol8(JSPUtil.getParameter(request, "col8", ""));
		setCol16(JSPUtil.getParameter(request, "col16", ""));
		setCol15(JSPUtil.getParameter(request, "col15", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setCol20(JSPUtil.getParameter(request, "col20", ""));
	 ...
	 */
	public PkupNoRptEmlCtntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PkupNoRptEmlCtntVO[]
	 */
	public PkupNoRptEmlCtntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PkupNoRptEmlCtntVO model = null;
	...
	public PkupNoRptEmlCtntVO[] getPkupNoRptEmlCtntVOs(){
		PkupNoRptEmlCtntVO[] vos = (PkupNoRptEmlCtntVO[])models.toArray(new PkupNoRptEmlCtntVO[models.size()]);
		return vos;
	}
