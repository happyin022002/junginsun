...
*@FileName : TCharterIOInvoiceDAORemovePrepaymentInvDtlsDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAORemovePrepaymentInvDtlsDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOInvoiceDAORemovePrepaymentInvDtlsDSQL
	  * </pre>
	  */
	public TCharterIOInvoiceDAORemovePrepaymentInvDtlsDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : TCharterIOInvoiceDAORemovePrepaymentInvDtlsDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}