...
*@FileName : EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndCSQL(){
		setQuery();
		...
		query.append("FileName : EurCustomsTransmissionDBDAOaddBkgCstmsEurDgSndCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO BKG_CSTMS_EUR_DG_SND" ).append("\n"); 
