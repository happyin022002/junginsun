...
*@FileName : ESM_BKG_1516HTMLAction.java
*@FileTitle : ESM_BKG_1516HTMLAction
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
/**
 * HTTP Parser<br>
 * - ESM_BKG_1516 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author KIM, Sang-Soo
 * @see EsmBkg1516Event 참조
 * @since J2EE 1.6
 */

public class ESM_BKG_1516HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1516HTMLAction 객체를 생성
	 */
	public ESM_BKG_1516HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmBkg1516Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1516Event event = new EsmBkg1516Event();
		...
		if (command.isCommand(FormCommand.SEARCH)) {    // RETRIEVE
			...
			event.setAusSearchCuscarVO((AusSearchCuscarVO)getVO(request, AusSearchCuscarVO.class));
			event.setAusResultCuscarVOs((AusResultCuscarVO[])getVOs(request, AusResultCuscarVO.class, "sheet2_"));
