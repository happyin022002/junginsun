...
*@FileName : ESM_BKG_0619HTMLAction.java
...
public class ESM_BKG_0619HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0619HTMLAction 객체를 생성
	 */
	public ESM_BKG_0619HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0619Event event = new EsmBkg0619Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setOutBdMovementStsListInVO((OutBdMovementStsListInVO)getVO(request, OutBdMovementStsListInVO .class));
		} else if(command.isCommand(FormCommand.COMMAND01)||command.isCommand(FormCommand.SEARCH04)) {
			event.setOutBdMovementStsListInVO((OutBdMovementStsListInVO)getVO(request, OutBdMovementStsListInVO .class));
		}
