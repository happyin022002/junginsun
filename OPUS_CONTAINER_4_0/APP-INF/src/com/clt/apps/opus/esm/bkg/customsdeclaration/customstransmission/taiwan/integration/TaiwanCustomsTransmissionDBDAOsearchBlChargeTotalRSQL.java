...
*@FileName : TaiwanCustomsTransmissionDBDAOsearchBlChargeTotalRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TaiwanCustomsTransmissionDBDAOsearchBlChargeTotalRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TaiwanCustomsTransmissionDBDAOsearchBlChargeTotalRSQL(){
		setQuery();
		...
		query.append("FileName : TaiwanCustomsTransmissionDBDAOsearchBlChargeTotalRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
