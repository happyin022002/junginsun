...
public class UsaSetupKeyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaSetupKeyVO> models = new ArrayList<UsaSetupKeyVO>();
	...
	public UsaSetupKeyVO() {}

	public UsaSetupKeyVO(String ibflag, String pagerows, String deltFlg, String updUsrId, String updDt, String cntCd, String cstmsDivId, String locCd, String frobFlg) {
		this.updDt = updDt;
		this.locCd = locCd;
		this.ibflag = ibflag;
	...
	public UsaSetupKeyVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public UsaSetupKeyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaSetupKeyVO model = null;
	...
	public UsaSetupKeyVO[] getSetupKeyVOs(){
		UsaSetupKeyVO[] vos = (UsaSetupKeyVO[])models.toArray(new UsaSetupKeyVO[models.size()]);
		return vos;
	}
