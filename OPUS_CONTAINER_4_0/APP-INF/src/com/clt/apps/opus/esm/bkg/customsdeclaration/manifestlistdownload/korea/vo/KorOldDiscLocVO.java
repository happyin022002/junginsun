...
*@FileName : KorOldDiscLocVO.java
*@FileTitle : KorOldDiscLocVO
*Open Issues :
*Change history :
...
public class KorOldDiscLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorOldDiscLocVO> models = new ArrayList<KorOldDiscLocVO>();
	...
	public KorOldDiscLocVO() {}

	public KorOldDiscLocVO(String ibflag, String pagerows, String oldMsnDiscloc) {
		this.ibflag = ibflag;
	 ...
	 */
	public KorOldDiscLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorOldDiscLocVO[]
	 */
	public KorOldDiscLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorOldDiscLocVO model = null;
	 ...
	 * @return KorOldDiscLocVO[]
	 */
	public KorOldDiscLocVO[] getKorOldDiscLocVOs(){
		KorOldDiscLocVO[] vos = (KorOldDiscLocVO[])models.toArray(new KorOldDiscLocVO[models.size()]);
		return vos;
	}
