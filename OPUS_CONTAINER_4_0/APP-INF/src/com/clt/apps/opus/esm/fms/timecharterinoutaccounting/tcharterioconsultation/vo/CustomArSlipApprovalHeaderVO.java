...
*@FileName : CustomArSlipApprovalHeaderVO.java
*@FileTitle : CustomArSlipApprovalHeaderVO
*Open Issues :
*Change history :
 ...
 */
public class CustomArSlipApprovalHeaderVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<CustomArSlipApprovalHeaderVO> models = new ArrayList<CustomArSlipApprovalHeaderVO>();
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("inv_rmk_enc", getInvRmkEnc());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("inv_rmk_enc", "invRmkEnc");
	 ...
	 * @return invRmkEnc
	 */
    public String getInvRmkEnc() {
        return this.invRmkEnc;
    }
	 ...
	 * @param invRmkEnc
	 */
    public void setInvRmkEnc(String invRmkEnc) {
        this.invRmkEnc = invRmkEnc;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setInvRmkEnc(JSPUtil.getParameter(request, "inv_rmk_enc", ""));
	 ...
	 * @param request
	 * @return CustomArSlipApprovalHeaderVO[]
	 */
    public CustomArSlipApprovalHeaderVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomArSlipApprovalHeaderVO[]
	 */
    public CustomArSlipApprovalHeaderVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        CustomArSlipApprovalHeaderVO model = null;
        ...
        try {
            ...
            String[] invRmkEnc = (JSPUtil.getParameter(request, prefix + "inv_rmk_enc", length));
            ...
            for (int i = 0; i < length; i++) {
                model = new CustomArSlipApprovalHeaderVO();
                if (vslCd[i] != null)
                ...
                if (invRmkEnc[i] != null)
                    model.setInvRmkEnc(invRmkEnc[i]);
        ...
        return getCustomArSlipApprovalHeaderVOs();
    }
	 ...
	 * @return CustomArSlipApprovalHeaderVO[]
	 */
    public CustomArSlipApprovalHeaderVO[] getCustomArSlipApprovalHeaderVOs() {
        CustomArSlipApprovalHeaderVO[] vos = (CustomArSlipApprovalHeaderVO[]) models.toArray(new CustomArSlipApprovalHeaderVO[models.size()]);
        return vos;
    }
	...
	*/
    public void unDataFormat() {
        ...
        this.invRmkEnc = this.invRmkEnc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
