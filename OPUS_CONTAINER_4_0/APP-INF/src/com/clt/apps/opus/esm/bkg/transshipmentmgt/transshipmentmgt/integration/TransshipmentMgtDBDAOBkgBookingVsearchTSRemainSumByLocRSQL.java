...
public class TransshipmentMgtDBDAOBkgBookingVsearchTSRemainSumByLocRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                , sum(decode(cntr.cntr_tpsz_cd, 'R4', 1, 'R5', 1, 0)) rf40 " ).append("\n"); 
		...
		query.append("    and (next_vvd.VSL_CD is not null or next_vvd.VSL_CD not in ('COXX', 'COYY', 'COZZ'))" ).append("\n"); 
		query.append("#elseif(${next_vvd} == 'N')" ).append("\n"); 
		query.append("    and (next_vvd.VSL_CD is null or next_vvd.VSL_CD in ('COXX', 'COYY', 'COZZ'))" ).append("\n"); 
		query.append("#end" ).append("\n"); 
