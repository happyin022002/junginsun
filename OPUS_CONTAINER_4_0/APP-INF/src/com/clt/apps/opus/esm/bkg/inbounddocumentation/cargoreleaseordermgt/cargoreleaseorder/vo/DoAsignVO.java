...
public class DoAsignVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DoAsignVO> models = new ArrayList<DoAsignVO>();
	 ...
	 * @return DoAsignVO[]
	 */
	public DoAsignVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DoAsignVO[]
	 */
	public DoAsignVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DoAsignVO model = null;
	 ...
	 * @return DoAsignVO[]
	 */
	public DoAsignVO[] getDoAsignVOs(){
		DoAsignVO[] vos = (DoAsignVO[])models.toArray(new DoAsignVO[models.size()]);
		return vos;
	}
