...
*@FileName : ESM_BKG_1052HTMLAction.java
...
public class ESM_BKG_1052HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0052HTMLAction 객체를 생성
	 */
	public ESM_BKG_1052HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1052Event event = new EsmBkg1052Event();
		if(command.isCommand(FormCommand.MULTI))
		{
			event.setBkgFullCntrRemarkVO((BkgFullCntrRemarkVO) getVO(request, BkgFullCntrRemarkVO.class));
		}
