...
public class ESM_BKG_3100HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0926HTMLAction 객체를 생성
     */
    public ESM_BKG_3100HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg3100Event event = new EsmBkg3100Event();
		...
		if (command.isCommand(FormCommand.SEARCH)) {
			event.setBlESignatureVO((BlESignatureVO)getVO(request, BlESignatureVO.class,""));
