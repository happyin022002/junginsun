...
*@FileName : AusCustomsTransmissionDBDAOaddCstmsAusSndLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOaddCstmsAusSndLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOaddCstmsAusSndLogCSQL(){
		setQuery();
		...
		params.put("aus_snd_log_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AusCustomsTransmissionDBDAOaddCstmsAusSndLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_AUS_SND_LOG" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("       (AUS_SND_LOG_ID," ).append("\n"); 
		...
		query.append("        MRN_NO,    -- SRN No.로 사용" ).append("\n"); 
		query.append("        MRN_CHK_NO,    -- SRN Ver.로 사용" ).append("\n"); 
		query.append("        CRE_USR_ID," ).append("\n"); 
		query.append("        CRE_DT," ).append("\n"); 
		query.append("        UPD_USR_ID," ).append("\n"); 
		query.append("        UPD_DT)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("VALUES (@[aus_snd_log_id]," ).append("\n"); 
		query.append("        @[edi_ref_id]||NVL(@[cntr_no], @[bl_no])," ).append("\n"); 
