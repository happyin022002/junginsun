...
*@FileName : SearchDailyForcastManageByVvdListVO.java
*@FileTitle : SearchDailyForcastManageByVvdListVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.spc.dailyforecast.basicdata.vo;
...
public class SearchDailyForcastManageByVvdListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchDailyForcastManageByVvdListVO> models = new ArrayList<SearchDailyForcastManageByVvdListVO>();
	...
	public SearchDailyForcastManageByVvdListVO() {}

	public SearchDailyForcastManageByVvdListVO(String ibflag, String pagerows, String repTrdCd, String repSubTrdCd, String rlaneCd, String dirCd, String iocTsCd, String vvd, String slsYrmon, String costWk, String slsAqCd, String slsOfcCd, String polCd1, String polCd2, String polCd3, String polCd4, String polCd5, String polCd6, String polCd7, String polCd8, String polCd9, String polCd10) {
	 ...
	 * @param request
	 * @return SearchDailyForcastManageByVvdListVO[]
	 */
	public SearchDailyForcastManageByVvdListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchDailyForcastManageByVvdListVO[]
	 */
	public SearchDailyForcastManageByVvdListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchDailyForcastManageByVvdListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchDailyForcastManageByVvdListVO();
				if (iocTsCd[i] != null)
		...
		return getSearchDailyForcastManageByVvdListVOs();
	}
	 ...
	 * @return SearchDailyForcastManageByVvdListVO[]
	 */
	public SearchDailyForcastManageByVvdListVO[] getSearchDailyForcastManageByVvdListVOs(){
		SearchDailyForcastManageByVvdListVO[] vos = (SearchDailyForcastManageByVvdListVO[])models.toArray(new SearchDailyForcastManageByVvdListVO[models.size()]);
		return vos;
	}
