...
public class CstPriRpAfilVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriRpAfilVO> models = new ArrayList<CstPriRpAfilVO>();
	...
	public CstPriRpAfilVO() {}

	public CstPriRpAfilVO(String ibflag, String pagerows, String prcProgStsCd, String acptUsrId, String acptOfcCd, String acptDt, String updUsrId, String updDt, String propNo, String amdtSeq, String stsCd, String effDt) {
		this.stsCd = stsCd;
		this.updDt = updDt;
	 ...
	 */
	public CstPriRpAfilVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpAfilVO[]
	 */
	public CstPriRpAfilVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriRpAfilVO model = null;
	 ...
	 * @return CstPriSpAfilVO[]
	 */
	public CstPriRpAfilVO[] getCstPriSpAfilVOs(){
		CstPriRpAfilVO[] vos = (CstPriRpAfilVO[])models.toArray(new CstPriRpAfilVO[models.size()]);
		return vos;
	}
