...
*@FileName : SCRateProposalDBDAOPriScNoteConvForExlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriScNoteConvForExlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 존재하는 Note Conversion 데이터를 Copy 하여 새로 생성한다.
	  * </pre>
	  */
	public SCRateProposalDBDAOPriScNoteConvForExlCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriScNoteConvForExlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   , (" ).append("\n"); 
		query.append("    SELECT C.PROP_NO, C.AMDT_SEQ, C.SVC_SCP_CD, C.GEN_SPCL_RT_TP_CD, C.CMDT_HDR_SEQ, C.CMDT_NOTE_SEQ, C.NOTE_CONV_MAPG_ID" ).append("\n"); 
		query.append("         , OLD.NOTE_CONV_MAPG_ID AS OLD_NOTE_CONV_MAPG_ID" ).append("\n"); 
		query.append("      FROM PRI_SP_SCP_RT_CNOTE C" ).append("\n"); 
		query.append("         , (  SELECT PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, CMDT_NOTE_SEQ, NOTE_CONV_MAPG_ID " ).append("\n"); 
		...
		query.append("      AND C.CMDT_NOTE_SEQ = OLD.CMDT_NOTE_SEQ" ).append("\n"); 
