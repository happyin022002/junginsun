...
*@FileName : UsaManifestListDownloadDBDAOremoveCMByBlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaManifestListDownloadDBDAOremoveCMByBlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaManifestListDownloadDBDAOremoveCMByBlDSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.usa.integration ").append("\n"); 
		query.append("FileName : UsaManifestListDownloadDBDAOremoveCMByBlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_ADV_CNTR_MF" ).append("\n"); 
