...
*@FileName : SCGOHChargeProposalDBDAOPriSpScpGohChgVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGOHChargeProposalDBDAOPriSpScpGohChgVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGOHChargeProposalDBDAOPriSpScpGohChgVODSQL(){
		setQuery();
		...
		query.append("FileName : SCGOHChargeProposalDBDAOPriSpScpGohChgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
