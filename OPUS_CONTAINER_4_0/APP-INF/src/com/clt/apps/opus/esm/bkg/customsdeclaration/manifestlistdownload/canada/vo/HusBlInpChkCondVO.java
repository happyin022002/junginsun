...
*@FileName : HusBlInpChkCondVO.java
*@FileTitle : HusBlInpChkCondVO
*Open Issues :
*Change history :
 ...
 */
public class HusBlInpChkCondVO extends HouseBlCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<HusBlInpChkCondVO> models = new ArrayList<HusBlInpChkCondVO>();
	...
	public HusBlInpChkCondVO() {}

	public HusBlInpChkCondVO(String ibflag, String pagerows, String vvd, String polCd, String podCd, String contiCd, String bkgOfcCd, String obSrepCd, String mblFiler, String errFlg) {
	 ...
	 * @param request
	 * @return HusBlInpChkCondVO[]
	 */
	public HusBlInpChkCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return HusBlInpChkCondVO[]
	 */
	public HusBlInpChkCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		HusBlInpChkCondVO model = null;
	 ...
	 * @return HusBlInpChkCondVO[]
	 */
	public HusBlInpChkCondVO[] getHusBlInpChkCondVOs(){
		HusBlInpChkCondVO[] vos = (HusBlInpChkCondVO[])models.toArray(new HusBlInpChkCondVO[models.size()]);
		return vos;
	}
