...
*@FileName       : EsmCsq0002ViewAdapter.java
 ...
 * @since CSQ USER
 */
public class EsmCsq0002ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
			...
			sbufXML.append("	<TD>" + getNull(colValues.get("lane_dir_cd"))     + "</TD>");
//			sbufXML.append("	<TD>" +  getNull(colValues.get("ias_sctr_flg"))	  + "</TD>");
			sbufXML.append("	<TD" + (trd_cd.equals("IAS")?"":" EDIT='FALSE' ") + ">"+ getNull(colValues.get("ias_sctr_flg"))+"</TD>");
			sbufXML.append("	<TD>" + getNull(colValues.get("csq_act_flg"))     + "</TD>");
			sbufXML.append("	<TD>" + getNull(colValues.get("bse_tp_cd"))     + "</TD>");
			sbufXML.append("	<TD></TD>");
