...
*@FileName : SpecialManifestDBDAOaddSendFlatFileLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOaddSendFlatFileLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOaddSendFlatFileLogCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOaddSendFlatFileLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_DG_SND_LOG (" ).append("\n");
		...
		query.append("FROM BKG_CSTMS_EUR_DG_SND_LOG" ).append("\n");
		query.append("WHERE EUR_EDI_MSG_TP_ID = @[eur_edi_msg_tp_id]" ).append("\n");
