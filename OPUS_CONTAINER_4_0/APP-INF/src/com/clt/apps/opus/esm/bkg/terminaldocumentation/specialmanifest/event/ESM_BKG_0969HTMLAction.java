 ...
 * @see EsmBkg0969Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_0969HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0969Event event = new EsmBkg0969Event();

		if(command.isCommand(FormCommand.SEARCH)) {

			event.setFwdrListCondVO((FwdrListCondVO) getVO(request, FwdrListCondVO.class));

		} else if(command.isCommand(FormCommand.MULTI)) {

			event.setFwdrListVO((FwdrListVO[])getVOs(request, FwdrListVO.class, "sheet1_"));
		}
