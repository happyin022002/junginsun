...
public class BasicDataDBDAOSearchBasicDataCreationListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        ,DECODE(A1.CSQ_LVL_CD, 1, 'RHQ', 'Office')       AS OFC_LVL" ).append("\n"); 
		...
		query.append("    FROM CSQ_PERF_IF A1" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("     AND A1.CSQ_LVL_CD  = @[f_ofc_lvl]" ).append("\n"); 
