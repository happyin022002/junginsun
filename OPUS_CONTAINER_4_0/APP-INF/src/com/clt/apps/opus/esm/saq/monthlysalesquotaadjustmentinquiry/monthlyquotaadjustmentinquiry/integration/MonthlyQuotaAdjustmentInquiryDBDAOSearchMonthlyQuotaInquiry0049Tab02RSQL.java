...
*@FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab02RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab02RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab02RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiry0049Tab02RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		        HDR.TGT_ORZ_CD = INP.TGT_ORZ_CD  " ).append("\n"); 
		query.append("		       AND HDR.DAT_CRE_STEP_CD = INP.DAT_CRE_STEP_CD  " ).append("\n"); 
		query.append("		       AND HDR.BSE_YR = INP.BSE_YR  " ).append("\n"); 
		query.append("		       AND HDR.BSE_QTR_CD = INP.BSE_QTR_CD  " ).append("\n"); 
		query.append("		       AND HDR.GLINE_VER_NO = INP.GLINE_VER_NO  " ).append("\n"); 
		...
		query.append("		                           AND   DIR_CD = SMR.DIR_CD) AS BSA_LVL_2," ).append("\n"); 
		query.append("		                          (SELECT SUM(BSA) " ).append("\n"); 
		query.append("		                           FROM  VVD " ).append("\n"); 
		query.append("		                           WHERE YRMON = SMR.YRMON" ).append("\n"); 
		...
		query.append("		                    FROM  (" ).append("\n"); 
		query.append("		                            SELECT" ).append("\n"); 
		query.append("		                                  GROUPING(DIR_CD)||GROUPING(SUB_TRD_CD)||GROUPING(RLANE_CD)AS G_FLAG," ).append("\n"); 
		query.append("		                                  MIN(SMR.DIR_CD||SMR.SUB_TRD_CD||DECODE(SMR.RLANE_CD,'RBCCO','ZZ',SUBSTR(SMR.RLANE_CD,-2))||SMR.RLANE_CD) AS KEY,                  " ).append("\n"); 
		...
		query.append("		                            FROM  (" ).append("\n"); 
		query.append("		                                    SELECT   /*+ PARALLEL(SMR,4) */ " ).append("\n"); 
		query.append("		                                         SMR.DIR_CD, " ).append("\n"); 
		query.append("		                                         SMR.SUB_TRD_CD,                                    " ).append("\n"); 
		query.append("		                                         SMR.RLANE_CD, " ).append("\n"); 
		...
		query.append("		                                           AND SMR.DAT_CRE_STEP_CD = HDR.DAT_CRE_STEP_CD " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		                                    GROUP BY SMR.DIR_CD, SMR.SUB_TRD_CD, SMR.RLANE_CD, SMR.BSE_YR||SMR.BSE_MON" ).append("\n"); 
		query.append("		                                  ) SMR " ).append("\n"); 
		query.append("		                            GROUP BY GROUPING SETS((YRMON), " ).append("\n"); 
		query.append("		                                                    (SMR.DIR_CD, YRMON), " ).append("\n"); 
		query.append("		                                                    (SMR.DIR_CD, SMR.SUB_TRD_CD, YRMON), " ).append("\n"); 
		query.append("		                                                    (SMR.DIR_CD, SMR.SUB_TRD_CD, SMR.RLANE_CD, YRMON))    " ).append("\n"); 
		query.append("		                          ) SMR    " ).append("\n"); 
		query.append("		                  ) SMR                                                                                " ).append("\n"); 
		query.append("		          ) SMR " ).append("\n"); 
		query.append("		          JOIN " ).append("\n"); 
