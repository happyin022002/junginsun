...
*@FileName : ChinaManifestListDownloadDBDAOmodifyBl2USQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOmodifyBl2USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOmodifyBl2USQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOmodifyBl2USQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("SET     MF_SND_DT	    = ( SELECT MF_SND_DT" ).append("\n");
