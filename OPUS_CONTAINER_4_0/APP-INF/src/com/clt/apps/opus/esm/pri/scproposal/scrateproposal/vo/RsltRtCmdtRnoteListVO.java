...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRoutNoteSeq(JSPUtil.getParameter(request, prefix + "rout_note_seq", ""));
	}
	...
	public RsltRtCmdtRnoteListVO[] getRsltRtCmdtRnoteListVOs(){
		RsltRtCmdtRnoteListVO[] vos = (RsltRtCmdtRnoteListVO[])models.toArray(new RsltRtCmdtRnoteListVO[models.size()]);
		return vos;
	}
