...
*@FileName : TransferOrderIssueDBDAOModifyTroPctlNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOModifyTroPctlNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * bkg_tro에 pctl_no를 update한다.
	  * </pre>
	  */
	public TransferOrderIssueDBDAOModifyTroPctlNoUSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAOModifyTroPctlNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
