...
*@FileName : KorManifestListDBDAOsearchBlCorrTransYRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchBlCorrTransYRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 세관전송된 B/L정보 및 Correction정보를 조회한다.
	  * </pre>
	  */
	public KorManifestListDBDAOsearchBlCorrTransYRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchBlCorrTransYRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append(", NVL(KC.KR_CSTMS_CORR_ID, DECODE(KT.KR_BL_AMDT_STS_CD, 'I', 'D', 'X', 'F', 'V', 'B', 'U', 'B', KT.KR_BL_AMDT_STS_CD)) KR_CSTMS_CORR_ID" ).append("\n");
		...
		query.append(", TRUNC(DECODE(NVL(KT.WGT_UT_CD,'   '),'LBS',ROUND(NVL(KT.CNTR_TTL_WGT,0)*0.4536,3),NVL(KT.CNTR_TTL_WGT,0)),2) CNTR_TTL_WGT" ).append("\n");
		...
		query.append(", DECODE(TO_NUMBER(NVL(KT.CSTMS_OFC_CTY_CD,'0')),0,DECODE(@[cstms_decl_tp_cd],'I',DECODE(KT.TS_POD_CD,'KRINC',20,'KRPUS',30,'KRKAN',62,'KRPTK',16,0),'T',DECODE(KT.TS_POD_CD,'KRINC',20,'KRPUS',30,'KRKAN',62,'KRPTK',16,0),DECODE(KT.TS_POL_CD,'KRINC',20,'KRPUS',30,'KRKAN',62,'KRPTK',16,0)),TO_NUMBER(NVL(KT.CSTMS_OFC_CTY_CD,'0'))) CSTMS_OFC_CTY_CD" ).append("\n");
		...
		query.append("ORDER BY SMT_AMD_NO DESC" ).append("\n");
