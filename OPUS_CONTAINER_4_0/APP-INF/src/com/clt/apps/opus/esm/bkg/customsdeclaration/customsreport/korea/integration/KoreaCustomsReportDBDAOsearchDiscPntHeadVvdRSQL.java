...
*@FileName : KoreaCustomsReportDBDAOsearchDiscPntHeadVvdRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchDiscPntHeadVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchDiscPntHeadVvdRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchDiscPntHeadVvdRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MRN_NO,' ') MRN_NO" ).append("\n");
		query.append(", NVL(MRN_CHK_NO,' ') MRN_CHK_NO" ).append("\n");
		...
		query.append(", NVL(IO_BND_CD,' ') IO_BND_CD" ).append("\n");
		query.append(", NVL(CO_NM,' ') CO_NM" ).append("\n");
