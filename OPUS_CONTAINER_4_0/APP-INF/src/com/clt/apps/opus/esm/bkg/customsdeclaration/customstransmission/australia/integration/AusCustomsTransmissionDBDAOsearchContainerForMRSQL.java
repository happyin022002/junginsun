...
*@FileName : AusCustomsTransmissionDBDAOsearchContainerForMRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOsearchContainerForMRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOsearchContainerForMRSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOsearchContainerForMRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("		NVL(BK.SOC_FLG,'') soc_ind," ).append("\n");
		...
		query.append("		R.HUMID_NO humidity," ).append("\n");
		query.append("		R.VENT_RTO vent," ).append("\n");
		...
		query.append("FROM BKG_CONTAINER C,BKG_RF_CGO R, BKG_AWK_CGO A, BKG_BOOKING BK, MDM_CNTR_TP_SZ B" ).append("\n");
