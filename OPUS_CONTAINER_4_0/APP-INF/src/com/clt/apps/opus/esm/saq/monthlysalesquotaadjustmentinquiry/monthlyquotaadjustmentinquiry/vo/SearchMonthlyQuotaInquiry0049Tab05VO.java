...
*@FileName       : SearchMonthlyQuotaInquiry0049Tab05VO.java
*@FileTitle      : SearchMonthlyQuotaInquiry0049Tab05VO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiry0049Tab05VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiry0049Tab05VO> models = new ArrayList<SearchMonthlyQuotaInquiry0049Tab05VO>();
	...
	public SearchMonthlyQuotaInquiry0049Tab05VO() {}

	public SearchMonthlyQuotaInquiry0049Tab05VO(String ibflag, String pagerows, String key, String slevel, String bseYr, String bseWk, String subTrdCd, String rlaneCd, String convDirCd, String vvdGrpCd, String vvdCd, String rhqCd, String aqCd, String ofcCd1, String ofcCd2, String rowSeq, String itemText, String item, String val) {
		this.val = val;
		this.ofcCd2 = ofcCd2;
		this.ofcCd1 = ofcCd1;
		this.rhqCd = rhqCd;
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiry0049Tab05VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab05VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiry0049Tab05VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab05VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiry0049Tab05VO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiry0049Tab05VO();
				if (val[i] != null)
					model.setVal(val[i]);
				if (ofcCd2[i] != null)
		...
		return getSearchMonthlyQuotaInquiry0049Tab05VOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiry0049Tab05VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab05VO[] getSearchMonthlyQuotaInquiry0049Tab05VOs(){
		SearchMonthlyQuotaInquiry0049Tab05VO[] vos = (SearchMonthlyQuotaInquiry0049Tab05VO[])models.toArray(new SearchMonthlyQuotaInquiry0049Tab05VO[models.size()]);
		return vos;
	}
