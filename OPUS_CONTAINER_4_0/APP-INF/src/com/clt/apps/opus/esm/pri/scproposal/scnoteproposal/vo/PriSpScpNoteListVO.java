...
*@FileName : PriSpScpNoteListVO.java
*@FileTitle : PriSpScpNoteListVO
*Open Issues :
*Change history :
...
public class PriSpScpNoteListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpNoteListVO> models = new ArrayList<PriSpScpNoteListVO>();
	 ...
	 */
	public PriSpScpNoteListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpNoteListVO[]
	 */
	public PriSpScpNoteListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpNoteListVO model = null;
	...
	public PriSpScpNoteListVO[] getPriSpScpNoteListVOs(){
		PriSpScpNoteListVO[] vos = (PriSpScpNoteListVO[])models.toArray(new PriSpScpNoteListVO[models.size()]);
		return vos;
	}
