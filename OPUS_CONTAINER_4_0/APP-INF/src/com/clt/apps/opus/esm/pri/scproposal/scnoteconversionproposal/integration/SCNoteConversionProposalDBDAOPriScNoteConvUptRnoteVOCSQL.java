...
*@FileName : SCNoteConversionProposalDBDAOPriScNoteConvUptRnoteVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAOPriScNoteConvUptRnoteVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAOPriScNoteConvUptRnoteVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteConversionProposalDBDAOPriScNoteConvUptRnoteVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        FROM PRI_SP_SCP_RT_CMDT_RNOTE NOTE" ).append("\n"); 
		query.append("            ,PRI_SP_SCP_RT_CMDT_RNOTE N_NOTE" ).append("\n"); 
		...
		query.append("        AND N_NOTE.ROUT_SEQ           = NOTE.ROUT_SEQ" ).append("\n"); 
		query.append("        AND N_NOTE.ROUT_NOTE_SEQ     = NOTE.ROUT_NOTE_SEQ" ).append("\n"); 
