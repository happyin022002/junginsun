...
*@FileName : CndCustomsTransmissionDBDAOmodifySendLogByCntrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndCustomsTransmissionDBDAOmodifySendLogByCntrUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 1023, BayPlan Transmission, BKG_CSTMS_ADV_STWG_CNTR 업데이트.
	  * </pre>
	  */
	public CndCustomsTransmissionDBDAOmodifySendLogByCntrUSQL(){
		setQuery();
		...
		query.append("FileName : CndCustomsTransmissionDBDAOmodifySendLogByCntrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	SND_DT = TO_DATE(TO_CHAR(NEW_TIME(SYS_EXTRACT_UTC(CURRENT_TIMESTAMP), 'GMT', 'EST'), 'YYYYMMDDHH24MISS'), 'YYYYMMDDHH24MISS')," ).append("\n"); 
		...
		query.append("    VVD_CD = @[hidden_vvd]" ).append("\n"); 
