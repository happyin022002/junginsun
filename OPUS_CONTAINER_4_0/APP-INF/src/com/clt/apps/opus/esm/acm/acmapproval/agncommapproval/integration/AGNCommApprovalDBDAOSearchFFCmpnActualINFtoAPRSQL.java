...
*@FileName : AGNCommApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchFFCmpnActualINFtoAP
	  * </pre>
	  */
	public AGNCommApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommApprovalDBDAOSearchFFCmpnActualINFtoAPRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
