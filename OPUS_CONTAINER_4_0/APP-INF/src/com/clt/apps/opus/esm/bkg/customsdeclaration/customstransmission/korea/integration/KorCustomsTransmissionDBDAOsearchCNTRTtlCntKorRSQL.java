...
*@FileName : KorCustomsTransmissionDBDAOsearchCNTRTtlCntKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOsearchCNTRTtlCntKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOsearchCNTRTtlCntKorRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOsearchCNTRTtlCntKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
