...
*@FileName       : EsmSaq0126ViewAdapter04.java
...
public class EsmSaq0126ViewAdapter04 extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		SearchMonthlyQuotaInquiry0126Tab04VO listVo = null; // 차후 루프문을 통해 결과리스트의 정보를 한 로우씩 입력할 결과VO를 세팅 
...
//		sbufXML.append("<DATA COLORDER='" + JSPUtil.convertStringArrayToString(changedColNms, "|") + "' COLSEPARATOR='" + DELIMITER + "' TOTAL='" + totCnt +"'>\n");
		...
		for(int j=0;j<realCnt;j++){ 
			...
			listVo = (SearchMonthlyQuotaInquiry0126Tab04VO) list.get(j); //list 에서 한 줄 씩 빼내서 결과vo에 입력
...
//					? true : false);
			...
			String ofc_cd_2 = listVo.getOfcCd2();
...
//			sbufXML.append("HAVE-CHILD=\"" + ((level==5 && isEndRow) ? "TRUE" : "FALSE") + "\" expand=\"" + isExpand + "\">");
			sbufXML.append("<TR>");
...
/*			sbufXML.append("<TD " + rlane_image + " bgColor=\"" + bgColor[level-1] + "\" " + fontColor + "><![CDATA[" + rlane_cd + "]]></TD>");
			...
			sbufXML.append("<TD " + ofc_1_image + " bgColor=\"" + bgColor[level-1] + "\"><![CDATA[" + ofc_cd_1 + "]]></TD>");*/
