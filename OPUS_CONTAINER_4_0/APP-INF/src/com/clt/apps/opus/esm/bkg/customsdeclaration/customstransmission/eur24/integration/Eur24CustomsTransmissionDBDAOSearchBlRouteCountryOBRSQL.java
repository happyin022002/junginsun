...
*@FileName : Eur24CustomsTransmissionDBDAOSearchBlRouteCountryOBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24CustomsTransmissionDBDAOSearchBlRouteCountryOBRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24CustomsTransmissionDBDAOSearchBlRouteCountryOBRSQL
	  * </pre>
	  */
	public Eur24CustomsTransmissionDBDAOSearchBlRouteCountryOBRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24CustomsTransmissionDBDAOSearchBlRouteCountryOBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/*  Eur24BlRouteCntListVOs Eur24CustomsTransmissionDBDAOSearchBlRouteCountryOB ( blNo) */" ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
		query.append("   " ).append("\n"); 
		query.append("    SUBSTR(VPS_PORT_CD,1,2) ROUTE_CNT" ).append("\n"); 
		query.append("    , MIN(CLPT_SEQ)" ).append("\n"); 
		query.append("    " ).append("\n"); 
		...
		query.append("   WHERE A.BND_TP_CD = 'O'" ).append("\n"); 
