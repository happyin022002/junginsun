...
public class TCharterIOConsultationDBDAOSearchSlipApprovalListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          FROM (SELECT FC.APRO_FLG" ).append("\n"); 
		...
		query.append("                                               AND Y.USE_FLG = 'Y'" ).append("\n"); 
		query.append("                                               AND Y.VSL_CD = X.VSL_CD" ).append("\n"); 
		query.append("                                            ) " ).append("\n"); 
		query.append("                            OR FC.SLP_TP_CD||FC.SLP_FUNC_CD||FC.SLP_OFC_CD||FC.SLP_ISS_DT||FC.SLP_SER_NO IN (" ).append("\n"); 
		query.append("                                    SELECT FS.SLP_TP_CD||FS.SLP_FUNC_CD||FS.SLP_OFC_CD||FS.SLP_ISS_DT||FS.SLP_SER_NO" ).append("\n"); 
		query.append("                                      FROM FMS_CSUL_SLP FS" ).append("\n"); 
		query.append("                                     WHERE 1=1" ).append("\n"); 
		query.append("                                       AND FS.VSL_CD IN (" ).append("\n"); 
		...
		query.append("                SELECT DISTINCT FC.APRO_FLG" ).append("\n"); 
		query.append("                     , FC.SLP_TP_CD || FC.SLP_FUNC_CD || FC.SLP_OFC_CD || FC.SLP_ISS_DT || FC.SLP_SER_NO CSR_NO" ).append("\n"); 
		query.append("                     , FC.SLP_TP_CD" ).append("\n"); 
		query.append("                     , TO_CHAR(FC.CRE_DT,'YYYYMMDD') CSR_DT" ).append("\n"); 
		query.append("                     , (SELECT USR_NM" ).append("\n"); 
