...
public class EsmBkg0917Event extends EventSupport {
	...
	public KorRcvHistVO[] getKorRcvHistVOs() {
		KorRcvHistVO[] rtnVOs = null;
		if (this.korRcvHistVOs != null) {
			rtnVOs = Arrays.copyOf(korRcvHistVOs, korRcvHistVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setKorRcvHistVOs(KorRcvHistVO[] korRcvHistVOs) {
		if (korRcvHistVOs != null) {
			KorRcvHistVO[] tmpVOs = Arrays.copyOf(korRcvHistVOs, korRcvHistVOs.length);
			this.korRcvHistVOs = tmpVOs;
		}
	}
