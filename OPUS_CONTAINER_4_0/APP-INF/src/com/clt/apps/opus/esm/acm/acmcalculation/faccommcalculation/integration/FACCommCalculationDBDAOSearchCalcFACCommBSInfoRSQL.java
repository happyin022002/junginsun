...
*@FileName : FACCommCalculationDBDAOSearchCalcFACCommBSInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FACCommCalculationDBDAOSearchCalcFACCommBSInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FACCommCalculationDBDAOSearchCalcFACCommBSInfoRSQL
	  * </pre>
	  */
	public FACCommCalculationDBDAOSearchCalcFACCommBSInfoRSQL(){
		setQuery();
		...
		query.append("FileName : FACCommCalculationDBDAOSearchCalcFACCommBSInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("   AND CHG_CD IN ( ${fac_chg_ctnt_div} ) " ).append("\n");
