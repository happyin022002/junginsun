...
*@FileName : SearchBasicCmcbCoaPfmcListListVO.java
*@FileTitle : SearchBasicCmcbCoaPfmcListListVO
*Open Issues :
*Change history :
...
public class SearchBasicCmcbCoaPfmcListListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBasicCmcbCoaPfmcListListVO> models = new ArrayList<SearchBasicCmcbCoaPfmcListListVO>();
	...
	public SearchBasicCmcbCoaPfmcListListVO() {}

	public SearchBasicCmcbCoaPfmcListListVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String trdCd, String subTrdCd, String rlaneCd, String dirCd, String rhqCd, String rgnOfcCd, String lodQty, String coaRaCmUcAmt, String coaPaCmUcAmt, String raCmUcAmt, String paCmUcAmt) {
		this.lodQty = lodQty;
		this.rhqCd = rhqCd;
...
/**
	 ...
	 * @param request
	 * @return SearchBasicCmcbCoaPfmcListListVO[]
	 */
	public SearchBasicCmcbCoaPfmcListListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBasicCmcbCoaPfmcListListVO[]
	 */
	public SearchBasicCmcbCoaPfmcListListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBasicCmcbCoaPfmcListListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBasicCmcbCoaPfmcListListVO();
				if (lodQty[i] != null)
		...
		return getSearchBasicCmcbCoaPfmcListListVOs();
	}
	 ...
	 * @return SearchBasicCmcbCoaPfmcListListVO[]
	 */
	public SearchBasicCmcbCoaPfmcListListVO[] getSearchBasicCmcbCoaPfmcListListVOs(){
		SearchBasicCmcbCoaPfmcListListVO[] vos = (SearchBasicCmcbCoaPfmcListListVO[])models.toArray(new SearchBasicCmcbCoaPfmcListListVO[models.size()]);
		return vos;
	}
