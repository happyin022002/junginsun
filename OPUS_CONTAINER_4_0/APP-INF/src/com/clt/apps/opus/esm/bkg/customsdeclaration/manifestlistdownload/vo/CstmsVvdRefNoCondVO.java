...
*@FileName : CstmsVvdRefNoCondVO.java
*@FileTitle : CstmsVvdRefNoCondVO
*Open Issues :
*Change history :
...
public class CstmsVvdRefNoCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	private Collection<CstmsVvdRefNoCondVO> models = new ArrayList<CstmsVvdRefNoCondVO>();
	...
	public CstmsVvdRefNoCondVO() {}

	public CstmsVvdRefNoCondVO(String ibflag, String pagerows, String eVpsEtaDt, String sVpsEtaDt, String vvdCd, String cvyRefNo, String slanCd, String vpsPortCd, String crrCd) {
	...
	public CstmsVvdRefNoCondVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CstmsVvdRefNoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstmsVvdRefNoCondVO model = null;
		...
		return getCstmsVvdRefNoCondVOs();
	}

	public CstmsVvdRefNoCondVO[] getCstmsVvdRefNoCondVOs(){
		CstmsVvdRefNoCondVO[] vos = (CstmsVvdRefNoCondVO[])models.toArray(new CstmsVvdRefNoCondVO[models.size()]);
		return vos;
	}
