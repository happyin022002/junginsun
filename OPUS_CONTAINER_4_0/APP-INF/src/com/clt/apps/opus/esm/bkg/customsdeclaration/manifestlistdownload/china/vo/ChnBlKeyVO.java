...
*@FileName : ChnBlKeyVO.java
*@FileTitle : ChnBlKeyVO
*Open Issues :
*Change history :
 ...
 * @author 
 * @since J2EE 1.6
 * @see com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.vo.BlKeyVO
 */

public class ChnBlKeyVO extends com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.vo.BlKeyVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<ChnBlKeyVO> models = new ArrayList<ChnBlKeyVO>();
	...
	public ChnBlKeyVO(String ibflag, String pagerows, String vvd, String vvd2, String bkgNo, String transMode, String bkgCgoTpCd, String locCd, String usrId, String blNo) {
		this.vvd = vvd;
		this.locCd = locCd;
...
/**
	 ...
	 * @return ChnBlKeyVO[]
	 */
	public ChnBlKeyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ChnBlKeyVO[]
	 */
	public ChnBlKeyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ChnBlKeyVO model = null;
	 ...
	 * @return ChnBlKeyVO[]
	 */
	public ChnBlKeyVO[] getChnBlKeyVOs(){
		ChnBlKeyVO[] vos = (ChnBlKeyVO[])models.toArray(new ChnBlKeyVO[models.size()]);
		return vos;
	}
