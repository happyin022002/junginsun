...
*@FileName : SriLankaManifestListCondVO.java
*@FileTitle : SriLankaManifestListCondVO
*Open Issues :
*Change history :
...
public class SriLankaManifestListCondVO extends ManifestListCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<SriLankaManifestListCondVO> models = new ArrayList<SriLankaManifestListCondVO>();
	...
	public SriLankaManifestListCondVO() {}

	public SriLankaManifestListCondVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String polCd, String podCd, String delCd, String bkgNo, String vslNm, String vslEngNm, String callPort, String pgno) {
		this.vslCd = vslCd;
		this.pgno = pgno;
		this.delCd = delCd;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPgno(JSPUtil.getParameter(request, "pgno", ""));
	 ...
	 */
	public SriLankaManifestListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SriLankaManifestListCondVO[]
	 */
	public SriLankaManifestListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SriLankaManifestListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SriLankaManifestListCondVO();
				if (vslCd[i] != null)
		...
		return getSriLankaManifestListCondVOs();
	}
	...
	public SriLankaManifestListCondVO[] getSriLankaManifestListCondVOs(){
		SriLankaManifestListCondVO[] vos = (SriLankaManifestListCondVO[])models.toArray(new SriLankaManifestListCondVO[models.size()]);
		return vos;
	}
