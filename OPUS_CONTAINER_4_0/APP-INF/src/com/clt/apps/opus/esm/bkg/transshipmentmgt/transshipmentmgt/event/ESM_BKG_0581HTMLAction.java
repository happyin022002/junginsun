...
//			BkgVslOopVO bkgVslOopVO3 = new BkgVslOopVO();
			...
			BkgVslOopVO bkgVslOopVO = new BkgVslOopVO();
			
			BkgVslOopVO[] bkgVslOopVOS = new BkgVslOopVO[ibflag.length*3];//M
			int idx=0;
			for(int i=0; i<ibflag.length;i++){
				if (oop1[i] != null && oop1[i].trim().length()>0){
					bkgVslOopVO.setIbflag(ibflag[i]);
				}else{
					bkgVslOopVO.setIbflag("D");
				}
				bkgVslOopVO.setVslCd(vsl_cd[i]);
				bkgVslOopVO.setOpCd(JSPUtil.getNull(oop1[i]));
				bkgVslOopVO.setOpSeq("1");
				bkgVslOopVOS[idx] = bkgVslOopVO;
				idx++;
				bkgVslOopVO = new BkgVslOopVO();
				...
				bkgVslOopVO.setVslCd(vsl_cd[i]);
				bkgVslOopVO.setOpCd(JSPUtil.getNull(oop2[i]));
				bkgVslOopVO.setOpSeq("2");
				bkgVslOopVOS[idx] = bkgVslOopVO;
				idx++;
				bkgVslOopVO = new BkgVslOopVO();
				...
				bkgVslOopVO.setVslCd(vsl_cd[i]);
				bkgVslOopVO.setOpCd(JSPUtil.getNull(oop3[i]));
				bkgVslOopVO.setOpSeq("3");
				bkgVslOopVOS[idx] = bkgVslOopVO;
				idx++;
				bkgVslOopVO = new BkgVslOopVO();
			}
