...
*@FileName : AvgAgencyCommissionDBDAORemoveAvgAgencyCommissionOfficeListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AvgAgencyCommissionDBDAORemoveAvgAgencyCommissionOfficeListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AvgAgencyCommissionDBDAORemoveAvgAgencyCommissionOfficeListDSQL(){
		setQuery();
		...
		query.append("FileName : AvgAgencyCommissionDBDAORemoveAvgAgencyCommissionOfficeListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
