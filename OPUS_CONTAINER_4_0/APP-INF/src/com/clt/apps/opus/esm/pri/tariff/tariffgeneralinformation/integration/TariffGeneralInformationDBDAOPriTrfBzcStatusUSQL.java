...
*@FileName : TariffGeneralInformationDBDAOPriTrfBzcStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffGeneralInformationDBDAOPriTrfBzcStatusUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff Basic Status 정보를 Update 한다.
	  * </pre>
	  */
	public TariffGeneralInformationDBDAOPriTrfBzcStatusUSQL(){
		setQuery();
		...
		query.append("FileName : TariffGeneralInformationDBDAOPriTrfBzcStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ,TRF_BZC_STS_CD = @[trf_bzc_sts_cd]       " ).append("\n"); 
