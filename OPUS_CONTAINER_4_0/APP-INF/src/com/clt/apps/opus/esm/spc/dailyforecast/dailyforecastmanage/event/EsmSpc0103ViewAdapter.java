	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) 
	{
		...
		if (rowCount > 0) {//3.1
			for(int i = 0; i < rowCount;i++){
				...
				sbufXML.append("<TD>"+list.get(i).getCtrtCustCntCd()+list.get(i).getCtrtCustSeq()+"</TD>\n");
				...
				sbufXML.append("<TD>"+list.get(i).getCtrtCustCntCd()+"</TD>\n");				
				sbufXML.append("<TD>"+list.get(i).getCtrtCustSeq()+"</TD>\n");				
				sbufXML.append("<TD>"+list.get(i).getFcastSeq()+"</TD>\n");
				sbufXML.append("<TD>"+list.get(i).getFcastCustTpCd()+"</TD>\n");
				sbufXML.append("</TR>\n");
