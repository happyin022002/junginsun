...
*@FileName : AncsManifestListDownloadDBDAOsearchAncsCstmsMfDtlListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsManifestListDownloadDBDAOsearchAncsCstmsMfDtlListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsManifestListDownloadDBDAOsearchAncsCstmsMfDtlListRSQL(){
		setQuery();
		...
		query.append("FileName : AncsManifestListDownloadDBDAOsearchAncsCstmsMfDtlListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      AND HIS.MSG_TP_CD = 'C' )SEQ," ).append("\n"); 
		...
		query.append("  AND BL.POD_CD  = @[pod]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("  " ).append("\n"); 
		query.append("#if (${is_cmdt} != 'o') " ).append("\n"); 
		query.append("	AND CM.CNTR_SEQ(+) = 1" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("ORDER BY BL.BKG_NO, BL.BL_NO, CNTR.CNTR_NO, BL.POL_CD" ).append("\n"); 
