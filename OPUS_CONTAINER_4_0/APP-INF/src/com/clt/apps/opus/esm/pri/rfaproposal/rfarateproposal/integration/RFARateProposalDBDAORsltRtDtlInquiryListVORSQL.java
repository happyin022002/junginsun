...
public class RFARateProposalDBDAORsltRtDtlInquiryListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,0 PRS_SCG_AMT" ).append("\n"); 
		query.append("      ,0 PRS_RESPB_CM_UC_AMT" ).append("\n"); 
		query.append("      ,0 PRS_RESPB_OPFIT_UC_AMT" ).append("\n"); 
		query.append("      ,0 PRS_RESPB_CMPB_AMT" ).append("\n"); 
		query.append("      ,0 PRS_GID_CMPB_AMT" ).append("\n"); 
		query.append("      ,0 PRS_RESPB_OPB_AMT" ).append("\n"); 
		query.append("      ,0 DIFF" ).append("\n"); 
		query.append("      ,0 PRS_PFIT_CM_UC_AMT" ).append("\n"); 
		query.append("      ,0 PRS_PFIT_CMPB_AMT" ).append("\n"); 
		query.append("      ,sysdate as PRS_UPD_DT" ).append("\n"); 
