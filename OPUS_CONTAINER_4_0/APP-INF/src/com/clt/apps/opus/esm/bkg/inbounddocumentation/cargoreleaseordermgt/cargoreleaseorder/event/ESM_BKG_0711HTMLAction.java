...
*@FileName : UI_BKG_0711HTMLAction.java
...
public class ESM_BKG_0711HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * UI_BKG_0711HTMLAction 객체를 생성
     */
    public ESM_BKG_0711HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0711Event event = new EsmBkg0711Event();

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setDoHisVO((DoHisVO)getVO(request, DoHisVO .class));
        }
