...
public class ArrivalNoticeDBDAOaddArrNtcDtlCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	@[fax_no]" ).append("\n"); 
		query.append(",	@[fax_tp_cd]" ).append("\n"); 
		query.append(",   GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,TO_DATE(sysdate, 'YYYY/MM/DD HH24MISS'),@[ofc_cd] )      -- Local Date" ).append("\n"); 
		query.append(",   GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,TO_DATE(sysdate, 'YYYY/MM/DD HH24MISS'),'GMT' ) -- GMT Date   " ).append("\n"); 
		query.append(",	@[fax_snd_usr_id]" ).append("\n"); 
		query.append(",	@[fax_ntc_snd_id]" ).append("\n"); 
		query.append(",	@[fax_snd_flg]" ).append("\n"); 
		query.append(",	@[fax_ntc_snd_rslt_cd]" ).append("\n"); 
