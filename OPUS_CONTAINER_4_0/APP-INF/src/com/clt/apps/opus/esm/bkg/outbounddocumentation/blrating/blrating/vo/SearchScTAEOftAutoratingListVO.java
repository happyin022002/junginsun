...
*@FileName : SearchScTAEOftAutoratingListVO.java
*@FileTitle : SearchScTAEOftAutoratingListVO
*Open Issues :
*Change history :
...
public class SearchScTAEOftAutoratingListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchScTAEOftAutoratingListVO> models = new ArrayList<SearchScTAEOftAutoratingListVO>();
	 ...
	 * @param request
	 * @return SearchScTAEOftAutoratingListVO[]
	 */
	public SearchScTAEOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchScTAEOftAutoratingListVO[]
	 */
	public SearchScTAEOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchScTAEOftAutoratingListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchScTAEOftAutoratingListVO();
		...
		return getSearchScTAEOftAutoratingListVOs();
	}
	 ...
	 * @return SearchScTAEOftAutoratingListVO[]
	 */
	public SearchScTAEOftAutoratingListVO[] getSearchScTAEOftAutoratingListVOs(){
		SearchScTAEOftAutoratingListVO[] vos = (SearchScTAEOftAutoratingListVO[])models.toArray(new SearchScTAEOftAutoratingListVO[models.size()]);
		return vos;
	}
