...
*@FileName : ChinaManifestListDownloadDBDAOremoveBlCntrListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOremoveBlCntrListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOremoveBlCntrListDSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOremoveBlCntrListDSQL").append("\n");
		query.append("*/").append("\n");
	}
