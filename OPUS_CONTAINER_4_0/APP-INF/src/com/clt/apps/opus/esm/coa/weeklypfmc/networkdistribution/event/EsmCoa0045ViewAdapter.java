	    ...
	    if(totCnt > 0){
	    	try{
	            ...
	            for(int i=0; i<totCnt; i++){
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("fnl_co_bsa_capa"))+"</TD>");
 
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("co_bsa_capa"))+"</TD>");
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("co_bsa_rto"))+"</TD>");
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_1_14"))+"</TD>");			//20150622.ADD
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_1_15"))+"</TD>");
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_2_14"))+"</TD>");			//20150622.ADD
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_2_15"))+"</TD>");
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_3_14"))+"</TD>");			//20150622.ADD
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_3_15"))+"</TD>");	
                    strBuilder.append("</TR>");  
	            }
	            //-------------------------------------------------------------------------------------------------
            } catch(Exception e){
