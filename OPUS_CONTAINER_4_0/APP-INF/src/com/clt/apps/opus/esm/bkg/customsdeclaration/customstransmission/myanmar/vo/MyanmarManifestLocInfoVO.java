...
*@FileName : MyanmarManifestLocInfoVO.java
*@FileTitle : MyanmarManifestLocInfoVO
*Open Issues :
*Change history :
...
public class MyanmarManifestLocInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MyanmarManifestLocInfoVO> models = new ArrayList<MyanmarManifestLocInfoVO>();
	...
	public MyanmarManifestLocInfoVO() {}

	public MyanmarManifestLocInfoVO(String ibflag, String pagerows, String seq, String locType, String locCd, String locNm, String locEta, String locEtd) {
		this.locEta = locEta;
		this.locCd = locCd;
		this.ibflag = ibflag;
		this.locEtd = locEtd;
...
/**
	 ...
	 * @param request
	 * @return MyanmarManifestLocInfoVO[]
	 */
	public MyanmarManifestLocInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MyanmarManifestLocInfoVO[]
	 */
	public MyanmarManifestLocInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MyanmarManifestLocInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MyanmarManifestLocInfoVO();
				if (locEta[i] != null)
		...
		return getMyanmarManifestLocInfoVOs();
	}
	 ...
	 * @return MyanmarManifestLocInfoVO[]
	 */
	public MyanmarManifestLocInfoVO[] getMyanmarManifestLocInfoVOs(){
		MyanmarManifestLocInfoVO[] vos = (MyanmarManifestLocInfoVO[])models.toArray(new MyanmarManifestLocInfoVO[models.size()]);
		return vos;
	}
