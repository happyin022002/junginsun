...
*@FileName : SCRateProposalDBDAOPriSpScpRtCmdtRnoteVOForExlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCmdtRnoteVOForExlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 신규 Rate 생성시, 기존에 존재하는 Route Note copy
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCmdtRnoteVOForExlCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCmdtRnoteVOForExlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
