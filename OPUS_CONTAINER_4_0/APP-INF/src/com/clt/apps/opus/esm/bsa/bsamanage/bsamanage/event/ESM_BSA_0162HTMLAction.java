...
*@FileName : ESM_BSA_0162HTMLAction.java
...
public class ESM_BSA_0162HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BSA_0162HTMLAction 객체를 생성
	 */
	public ESM_BSA_0162HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBsa0162Event event = new EsmBsa0162Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setSearchBsaConditionVO((SearchBsaConditionVO)getVO(request, SearchBsaConditionVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setBsaOverUsedSlotCostSaveVOS((BsaOverUsedSlotCostSaveVO[])getVOs(request,BsaOverUsedSlotCostSaveVO.class,""));
		}
