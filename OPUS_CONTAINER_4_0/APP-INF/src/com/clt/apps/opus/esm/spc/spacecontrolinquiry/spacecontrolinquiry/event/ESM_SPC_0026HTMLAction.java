...
*@FileName       : ESM_SPC_0026HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.spc.spacecontrolinquiry 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_SPC_0026HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0026HTMLAction 객체를 생성
	 */
	public ESM_SPC_0026HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0026Event event = new EsmSpc0026Event();
