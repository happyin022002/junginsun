...
*@FileName : SCGroupLocationProposalDBDAORsltGrpLocDtlListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAORsltGrpLocDtlListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAORsltGrpLocDtlListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAORsltGrpLocDtlListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    PRI_SP_SCP_GRP_LOC_DTL A  ," ).append("\n"); 
