...
*@FileName : ESM_ACM_0116HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.acm.acmhistory 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author KIM, Sang-Soo
 * @see EsmAcm0116Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0116HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0116HTMLAction 객체를 생성
	 */
	public ESM_ACM_0116HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmAcm0116Event event = new EsmAcm0116Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setCalcDtlHistoryVO((CalcDtlHistoryVO)getVO(request, CalcDtlHistoryVO.class));
		}
