...
public class SpecialCargoReceiptDBDAOBkgRfCgoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	DECODE(NVL(a.PWR_SPL_CBL_FLG,''), 'Y', '1', '0') AS PWR_SPL_CBL_FLG" ).append("\n"); 
		...
		query.append(",	a.SNS_CGO_KND_CD" ).append("\n"); 
		query.append(",	a.OXGN_RTO" ).append("\n"); 
		query.append(",	a.CRBN_DXD_RTO" ).append("\n"); 
		query.append("FROM BKG_RF_CGO_HIS a, BKG_BKG_HIS b" ).append("\n"); 
		...
		query.append(",	a.OXGN_RTO" ).append("\n"); 
		query.append(",	a.CRBN_DXD_RTO" ).append("\n"); 
		query.append("FROM BKG_RF_CGO a, BKG_BOOKING b" ).append("\n"); 
		query.append("WHERE	a.BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("AND		a.BKG_NO = b.BKG_NO" ).append("\n"); 
		query.append("ORDER BY A.RC_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
