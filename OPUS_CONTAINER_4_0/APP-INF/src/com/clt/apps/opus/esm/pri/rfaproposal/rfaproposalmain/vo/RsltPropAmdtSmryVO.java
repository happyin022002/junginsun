...
*@FileName : RsltPropAmdtSmryVO.java
*@FileTitle : RsltPropAmdtSmryVO
*Open Issues :
*Change history :
...
public class RsltPropAmdtSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPropAmdtSmryVO> models = new ArrayList<RsltPropAmdtSmryVO>();
	...
	public RsltPropAmdtSmryVO() {}

	public RsltPropAmdtSmryVO(String ibflag, String pagerows, String propNo, String amdtSeq, String propTermTpCd, String amdtFlg, String acptFlg) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return RsltPropAmdtSmryVO[]
	 */
	public RsltPropAmdtSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPropAmdtSmryVO[]
	 */
	public RsltPropAmdtSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPropAmdtSmryVO model = null;
		...
		try {
			...
			String[] propTermTpCd = (JSPUtil.getParameter(request, prefix	+ "prop_term_tp_cd", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			
			for (int i = 0; i < length; i++) {
				model = new RsltPropAmdtSmryVO();
				if (ibflag[i] != null)
	 ...
	 * @return RsltPropAmdtSmryVO[]
	 */
	public RsltPropAmdtSmryVO[] getRsltPropAmdtSmryVOs(){
		RsltPropAmdtSmryVO[] vos = (RsltPropAmdtSmryVO[])models.toArray(new RsltPropAmdtSmryVO[models.size()]);
		return vos;
	}
