...
*@FileName : SurchargeGroupCommodityDBDAOPriComGrpCmdtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeGroupCommodityDBDAOPriComGrpCmdtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SurchargeGroupCommodityDBDAOPriComGrpCmdtVODSQL(){
		setQuery();
		...
		query.append("FileName : SurchargeGroupCommodityDBDAOPriComGrpCmdtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_SCG_GRP_CMDT" ).append("\n"); 
