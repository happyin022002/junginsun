...
public class CargoReleaseOrderDBDAOSearchEdiSeanaccsHeaderRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        RPAD(NVL(TRIM('1ANYK'),' '),20,' ')||" ).append("\n"); 
		query.append("        RPAD(NVL(TRIM('NACCS'),' '),20,' ')||" ).append("\n"); 
		query.append("        RPAD(NVL(TRIM('DOR110'),' '),10)||" ).append("\n"); 
		query.append("        @[ref_number] ||CHR(10) STR_FLATFILE" ).append("\n"); 
