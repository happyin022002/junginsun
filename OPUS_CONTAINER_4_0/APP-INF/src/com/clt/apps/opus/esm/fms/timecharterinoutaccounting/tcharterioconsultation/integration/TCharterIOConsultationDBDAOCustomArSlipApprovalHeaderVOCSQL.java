...
*@FileName : TCharterIOConsultationDBDAOCustomArSlipApprovalHeaderVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOCustomArSlipApprovalHeaderVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOCustomArSlipApprovalHeaderVOCSQL(){
		setQuery();
		...
		params.put("log_upd_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TCharterIOConsultationDBDAOCustomArSlipApprovalHeaderVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,@[curr_cd]" ).append("\n"); 
		query.append("	,@[usr_id]" ).append("\n"); 
		query.append("	,TO_DATE(@[log_upd_dt],'yyyymmddhh24miss')" ).append("\n"); 
		query.append("	,@[iss_dt]" ).append("\n"); 
		query.append("	,@[slp_no]" ).append("\n"); 
		query.append("	,@[csr_offst_no]" ).append("\n"); 
		query.append("	,@[cre_usr_id]" ).append("\n"); 
