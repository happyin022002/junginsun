...
public class EsmBkg1508Event extends EventSupport {
	...
	public ChinaVslRgstVO[] getChinaVslRgstVOs() {
		ChinaVslRgstVO[] rtnVOs = null;
		if (this.chinaVslRgstVOs != null) {
			rtnVOs = Arrays.copyOf(chinaVslRgstVOs, chinaVslRgstVOs.length);
		}
		return rtnVOs;
	}

	public void setChinaVslRgstVOs(ChinaVslRgstVO[] chinaVslRgstVOs) {
		if (chinaVslRgstVOs != null) {
			ChinaVslRgstVO[] tmpVOs = Arrays.copyOf(chinaVslRgstVOs, chinaVslRgstVOs.length);
			this.chinaVslRgstVOs = tmpVOs;
		}
	}
