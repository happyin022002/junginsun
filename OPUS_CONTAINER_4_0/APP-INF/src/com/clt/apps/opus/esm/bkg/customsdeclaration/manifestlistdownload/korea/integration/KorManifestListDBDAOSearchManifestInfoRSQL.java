...
public class KorManifestListDBDAOSearchManifestInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  	  AND DECODE(@[in_bound],'O',DECODE(LENGTH(@[in_pol_tmnl]),7,A.POL_YD_CD,' '),' ') " ).append("\n"); 
		query.append("	  	= DECODE(@[in_bound],'O',DECODE(LENGTH(@[in_pol_tmnl]),7,@[in_pol_tmnl],' '),' ')" ).append("\n"); 
