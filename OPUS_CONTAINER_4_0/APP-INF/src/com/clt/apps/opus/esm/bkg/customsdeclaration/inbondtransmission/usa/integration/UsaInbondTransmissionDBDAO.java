...
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOaddCarrierBatchNoCSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchCarrierBatchNumberRSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchCstmsPortCd2RSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchCstmsPortCdRSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchHiHeader1RSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchMdmVslCntrRSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchMiEtaRSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchSndLogCountRSQL;
import com.clt.apps.opus.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchSndLogNextHisSeqRSQL;
...
public class UsaInbondTransmissionDBDAO extends DBDAOSupport {
	 ...
	 * @param usaInbondManifestListCondVO UsaInbondManifestListCondVO
	...
	public List<UsaInbondManifestListVO> searchInbondArrivalManifestList(UsaInbondManifestListCondVO usaInbondManifestListCondVO) throws DAOException {
		...
		try {
			...
			df.setTimeZone(tzInAmerica);
			String sDateInAmerica = df.format(date);

			if (list.size() > 0) {
				UsaInbondManifestListVO vo = list.get(0);
				vo.setUsdate(sDateInAmerica);
			}
	...
	/**
	 * Paperless MIB Generate 에서 해당 VVD, POD, HUB, DEL에 대해 Partial BL이 존재하는 지 여부조회.<br>
	 *
	 * @param lclMibCondVO LclMibCondVO
	 * @return String
	 * @throws DAOException
	 */
	 ...
	 * @param usaInbondManifestListVO UsaInbondManifestListVO
	 ...
	 *
	 * @param ClearanceTypeCondVO clearanceTypeCondVO
	 ...
	 *
	 * @param ClearanceTypeDetailVO clearanceTypeDetailVO
	 * @return int
	 * @exception DAOException
	 */
	...
	public String searchPodAmsCode(String locCd) throws DAOException {
		...
		try {
			...
			DBRowSet dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new UsaInbondTransmissionDBDAOsearchAmsCodeRSQL(), param, null);
	 ...
	 * @exception DAOException
	 */
	public String searchScNo(String inScNo) throws DAOException {
		Map<String, Object> param = new HashMap<String, Object>();
		try {
			param.put("sc_no", inScNo);
			DBRowSet dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new UsaACEInbondTransmissionDBDAOsearchScNoRSQL(), param, null);
			String outScNo = "";
			if (dbRowset.next()) outScNo = dbRowset.getString("PROP_NO");
			return outScNo;
		} catch(SQLException se) {
			throw new DAOException(new ErrorHandler(se).getMessage(), se);
		} catch(Exception ex) {
