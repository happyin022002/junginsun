...
*@FileName : SCTransportationAdditionalChargeProposalDBDAORsltAddChgInquiryListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCTransportationAdditionalChargeProposalDBDAORsltAddChgInquiryListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SC Arbitrary, IHC Inquiry List 조회
	  * </pre>
	  */
	public SCTransportationAdditionalChargeProposalDBDAORsltAddChgInquiryListRSQL(){
		setQuery();
		...
		query.append("FileName : SCTransportationAdditionalChargeProposalDBDAORsltAddChgInquiryListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
