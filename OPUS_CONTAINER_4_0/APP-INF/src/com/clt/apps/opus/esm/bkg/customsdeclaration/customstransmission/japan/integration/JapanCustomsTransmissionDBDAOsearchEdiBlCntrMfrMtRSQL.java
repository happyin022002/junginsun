...
*@FileName : JapanCustomsTransmissionDBDAOsearchEdiBlCntrMfrMtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanCustomsTransmissionDBDAOsearchEdiBlCntrMfrMtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanCustomsTransmissionDBDAOsearchEdiBlCntrMfrMtRSQL(){
		setQuery();
		...
		query.append("FileName : JapanCustomsTransmissionDBDAOsearchEdiBlCntrMfrMtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       '4  ' AS DATA07," ).append("\n"); 
		query.append("       --82.Container Size Code (2)" ).append("\n"); 
		query.append("       DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', '22', '3', '25', '4', '42', '5', '45', '6', '92', '7', '95', '8', '92', '9', '95', '95') AS DATA08," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("  FROM BKG_CSTMS_JP_BL_CNTR" ).append("\n"); 
		query.append("" ).append("\n"); 
