...
public class GeneralBookingReceiptDBDAOmodifyMemoSplitUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        , SPLIT_DT  = GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SYSDATE,BKG_COM_USER_LOC_FNC(@[usr_id]))" ).append("\n"); 
		query.append("		, SPLIT_GDT = GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SYSDATE,'GMT')" ).append("\n"); 
