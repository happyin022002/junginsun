...
*@FileName : SCProposalMainDBDAORevertPriSpAfilUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpAfilUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_AFIL
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpAfilUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpAfilUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_AFIL" ).append("\n"); 
