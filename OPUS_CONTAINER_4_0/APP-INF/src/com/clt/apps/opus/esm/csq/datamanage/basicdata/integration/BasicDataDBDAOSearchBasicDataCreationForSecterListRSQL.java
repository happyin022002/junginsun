...
public class BasicDataDBDAOSearchBasicDataCreationForSecterListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(NVL(A3.CSQ_MN_SCTR_FLG,'N'), 'Y', 'Main', 'N', 'Sector') CSQ_MN_SCTR_FLG" ).append("\n"); 
		...
		query.append("  FROM CSQ_SCTR_PERF_IF A1" ).append("\n"); 
		query.append("      ,CSQ_SCTR_PAIR_MGMT A3" ).append("\n"); 
