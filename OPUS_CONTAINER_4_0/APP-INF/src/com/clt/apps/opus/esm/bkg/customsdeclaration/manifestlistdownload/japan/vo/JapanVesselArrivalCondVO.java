...
*@FileName : JapanVesselArrivalCondVO.java
*@FileTitle : JapanVesselArrivalCondVO
*Open Issues :
*Change history :
...
public class JapanVesselArrivalCondVO extends VesselArrivalCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<JapanVesselArrivalCondVO> models = new ArrayList<JapanVesselArrivalCondVO>();
	...
	public JapanVesselArrivalCondVO() {}

	public JapanVesselArrivalCondVO(String ibflag, String pagerows, String inVvdCd, String inPodCd) {
		this.ibflag = ibflag;
	 ...
	 */
	public JapanVesselArrivalCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapanVesselArrivalCondVO[]
	 */
	public JapanVesselArrivalCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JapanVesselArrivalCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new JapanVesselArrivalCondVO();
				if (ibflag[i] != null)
		...
		return getJapanVesselArrivalCondVOs();
	}
	 ...
	 * @return JapanVesselArrivalCondVO[]
	 */
	public JapanVesselArrivalCondVO[] getJapanVesselArrivalCondVOs(){
		JapanVesselArrivalCondVO[] vos = (JapanVesselArrivalCondVO[])models.toArray(new JapanVesselArrivalCondVO[models.size()]);
		return vos;
	}
