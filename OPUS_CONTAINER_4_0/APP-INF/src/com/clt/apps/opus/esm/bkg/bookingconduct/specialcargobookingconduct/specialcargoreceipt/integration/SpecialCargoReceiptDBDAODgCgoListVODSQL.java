...
*@FileName : SpecialCargoReceiptDBDAODgCgoListVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAODgCgoListVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAODgCgoListVODSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAODgCgoListVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("DELETE FROM BKG_DG_CGO_HIS" ).append("\n"); 
