...
*@FileName : SCRateProposalDBDAOPropCpPriSpScpRtCmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPropCpPriSpScpRtCmdtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_RT_CMDT Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOPropCpPriSpScpRtCmdtCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPropCpPriSpScpRtCmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                          ORDER BY B.PROP_NO, B.AMDT_SEQ, B.SVC_SCP_CD, B.GEN_SPCL_RT_TP_CD, B.CMDT_HDR_SEQ, B.CMDT_SEQ) AS CMDT_SEQ" ).append("\n"); 
