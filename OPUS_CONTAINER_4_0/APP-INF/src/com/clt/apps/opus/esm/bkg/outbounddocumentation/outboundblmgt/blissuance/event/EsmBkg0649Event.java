...
public class EsmBkg0649Event extends EventSupport {
	...
	public BkgDocIssHisVO[] getBkgDocIssHisVOs() {
		BkgDocIssHisVO[] rtnVOs = null;
		if (this.bkgDocIssHisVOs != null) {
			rtnVOs = Arrays.copyOf(bkgDocIssHisVOs, bkgDocIssHisVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setBkgDocIssHisVOs(BkgDocIssHisVO[] bkgDocIssHisVOs) {
		if (bkgDocIssHisVOs != null) {
			BkgDocIssHisVO[] tmpVOs = Arrays.copyOf(bkgDocIssHisVOs, bkgDocIssHisVOs.length);
			this.bkgDocIssHisVOs = tmpVOs;
		}
	}

	public BkgDocIssRdemVO[] getBkgDocIssRdemVOs() {
		BkgDocIssRdemVO[] rtnVOs = null;
		if (this.bkgDocIssRdemVOs != null) {
			rtnVOs = Arrays.copyOf(bkgDocIssRdemVOs, bkgDocIssRdemVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setBkgDocIssRdemVOs(BkgDocIssRdemVO[] bkgDocIssRdemVOs) {
		if (bkgDocIssRdemVOs != null) {
			BkgDocIssRdemVO[] tmpVOs = Arrays.copyOf(bkgDocIssRdemVOs, bkgDocIssRdemVOs.length);
			this.bkgDocIssRdemVOs = tmpVOs;
		}
	}
