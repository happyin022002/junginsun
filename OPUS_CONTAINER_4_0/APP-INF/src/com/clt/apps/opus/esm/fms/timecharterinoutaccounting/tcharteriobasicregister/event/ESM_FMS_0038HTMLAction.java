...
public class ESM_FMS_0038HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0038HTMLAction 객체를 생성
	 */
	public ESM_FMS_0038HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0038Event event = new EsmFms0038Event();
		
		if (command.isCommand(FormCommand.SEARCH)) {
			event.setRevYrmonFrom(request.getParameter("rev_yrmon_from"));
			event.setRevYrmonTo(request.getParameter("rev_yrmon_to"));
