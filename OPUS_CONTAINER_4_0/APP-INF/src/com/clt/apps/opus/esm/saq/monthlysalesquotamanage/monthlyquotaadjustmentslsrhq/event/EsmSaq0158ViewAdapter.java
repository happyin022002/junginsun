...
*@FileName : EsmSaq0158ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0158ViewAdapter extends ViewAdapter {

	public EsmSaq0158ViewAdapter() {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		if(conditionVO.getChkCommand().equals("SEARCHLIST")){
			...
			List<SearchMonthlyQuotaAdjustmentSlsRhqModifyListVO> list01=  (List<SearchMonthlyQuotaAdjustmentSlsRhqModifyListVO>) listVO.getList(0);
			...
			for(int j=0; j<totCnt; j++){
				...
				SearchMonthlyQuotaAdjustmentSlsRhqModifyListVO colValues = list01.get(j);
				
				sbufXML.append("<TR>");
				sbufXML.append("	<TD BGCOLOR=\""+bgColor[1]+"\">"+colValues.getSubTrdCd()+"</TD>	");
				sbufXML.append("	<TD BGCOLOR=\""+bgColor[1]+"\">"+colValues.getLaneGrp()+"</TD>	");
				sbufXML.append("	<TD BGCOLOR=\""+bgColor[1]+"\">"+colValues.getPolCd()+"</TD>	");
				sbufXML.append("	<TD BGCOLOR=\""+bgColor[1]+"\">"+colValues.getPodCd()+"</TD>	");
				...
				sbufXML.append("	<TD BGCOLOR=\""+bgColor[1]+"\">"+colValues.getSlsRgnOfcCd()+"</TD>	");
