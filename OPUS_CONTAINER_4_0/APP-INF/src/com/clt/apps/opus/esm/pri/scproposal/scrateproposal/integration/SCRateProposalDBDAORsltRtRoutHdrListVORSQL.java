...
*@FileName : SCRateProposalDBDAORsltRtRoutHdrListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtRoutHdrListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtRoutHdrListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtRoutHdrListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,(NVL(B.UP_AC_CNT, 0) + NVL(C.UP_AC_CNT, 0) + NVL(D.UP_AC_CNT, 0) + NVL(E.UP_AC_CNT, 0) + NVL(F.UP_AC_CNT, 0) +" ).append("\n"); 
		query.append("       NVL(DECODE(G.PRC_PROG_STS_CD, NULL, 0, 'A', DECODE(G.AMDT_SEQ, G.N1ST_CMNC_AMDT_SEQ, 1, 0), 0), 0) + NVL(H.UP_AC_CNT, 0)) AS UP_AC_CNT" ).append("\n"); 
		query.append("      ,(NVL(B.UP_CNT, 0) + NVL(C.UP_CNT, 0) + NVL(D.UP_CNT, 0) + NVL(E.UP_CNT, 0) + NVL(F.UP_CNT, 0) +" ).append("\n"); 
		query.append("       NVL(DECODE(G.AMDT_SEQ, NULL, 0, G.N1ST_CMNC_AMDT_SEQ, 1, 0), 0) + NVL(H.UP_CNT, 0)) AS UP_CNT" ).append("\n"); 
		...
		query.append("                            NVL(DECODE(G.AMDT_SEQ, NULL, 0, G.N1ST_CMNC_AMDT_SEQ, 1, 0), 0) + NVL(H.UP_CNT, 0)" ).append("\n"); 
		query.append("                           ,0" ).append("\n"); 
		query.append("                           ,''" ).append("\n"); 
		query.append("                           ,'color:blue;')" ).append("\n"); 
