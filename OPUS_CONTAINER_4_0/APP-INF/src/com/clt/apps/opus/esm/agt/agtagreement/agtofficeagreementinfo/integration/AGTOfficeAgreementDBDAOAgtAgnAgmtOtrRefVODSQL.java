...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_otr_ref 테이블에 조건 데이터 삭제
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVODSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtOtrRefVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
