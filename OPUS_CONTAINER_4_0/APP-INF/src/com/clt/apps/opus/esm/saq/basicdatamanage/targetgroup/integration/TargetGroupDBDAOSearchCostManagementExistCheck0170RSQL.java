...
*@FileName : TargetGroupDBDAOSearchCostManagementExistCheck0170RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TargetGroupDBDAOSearchCostManagementExistCheck0170RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Description : Year/Month Set for Cost Management  Create Initial Data 버튼 활성화 유무
	  * </pre>
	  */
	public TargetGroupDBDAOSearchCostManagementExistCheck0170RSQL(){
		setQuery();
		...
		query.append("FileName : TargetGroupDBDAOSearchCostManagementExistCheck0170RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
