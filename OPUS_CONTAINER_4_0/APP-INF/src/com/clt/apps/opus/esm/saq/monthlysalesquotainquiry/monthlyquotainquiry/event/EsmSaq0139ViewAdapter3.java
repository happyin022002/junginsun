...
*@FileName       : EsmSaq0139ViewAdapter3.java
...
public class EsmSaq0139ViewAdapter3 extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		SearchMonthlyQuotaInquiry0139Tab03VO listVo = null; // 차후 루프문을 통해 결과리스트의 정보를 한 로우씩 입력할 결과VO를 세팅 
...
//		sbufXML.append("<DATA COLORDER='" + JSPUtil.convertStringArrayToString(changedColNms, "|") + "' COLSEPARATOR='" + DELIMITER + "' TOTAL='" + totCnt +"'>\n");
		...
		for(int j=0;j<realCnt;j++){ 
			listVo = (SearchMonthlyQuotaInquiry0139Tab03VO) list.get(j); //list 에서 한 줄 씩 빼내서 결과vo에 입력
