...
*@FileName : BookingMasterMgtDBDAOaddHrdCdgCtnt2CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOaddHrdCdgCtnt2CSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addHrdCdgCtnt 테이블에 정보를 insert한다.
	  * </pre>
	  */
	public BookingMasterMgtDBDAOaddHrdCdgCtnt2CSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOaddHrdCdgCtnt2CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
