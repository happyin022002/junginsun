...
*@FileName : BLDocumentationBLDBDAOInsertMndCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationBLDBDAOInsertMndCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLDocumentationBLDBDAOInsertMndCSQL(){
		setQuery();
		...
		params.put("mk_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : BLDocumentationBLDBDAOInsertMndCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
