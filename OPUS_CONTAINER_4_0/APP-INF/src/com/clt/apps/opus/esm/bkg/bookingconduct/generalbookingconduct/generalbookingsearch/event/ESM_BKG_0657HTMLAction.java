...
*@FileName : ESM_BKG_0657HTMLAction.java
...
public class ESM_BKG_0657HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0657HTMLAction 객체를 생성
	 */
	public ESM_BKG_0657HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0657Event event = new EsmBkg0657Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScListInputVO((ScListInputVO)getVO(request, ScListInputVO .class));
			...
			event.setUiId(request.getParameter("ui_id"));
		}
