...
public class MxChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MxChgVO> models = new ArrayList<MxChgVO>();
	...
	public MxChgVO(String ibflag, String pagerows, String fctype, String rate, String revenueton, String ppd, String cct, String currencycode, String exchrate, String tariff, String pertype, String rateofc) {
		this.ibflag = ibflag;
		this.rate = rate;
		this.tariff = tariff;
	 ...
	 * @return MxChgVO[]
	 */
	public MxChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MxChgVO[]
	 */
	public MxChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MxChgVO model = null;
	 ...
	 * @return MxChgVO[]
	 */
	public MxChgVO[] getMxChgVOs(){
		MxChgVO[] vos = (MxChgVO[])models.toArray(new MxChgVO[models.size()]);
		return vos;
	}
