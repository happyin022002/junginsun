...
*@FileName : EsmCoa0152GSViewAdapter.java
...
/**
 * EsmCoa0152GS 에 대한 ViewAdapter<br>
 *  EsmCoa0152GSViewAdapter 작성<br>
 *
 * @author 장영석
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmCoa0152GSViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0152GSViewAdapter(){
    	super();
    }
