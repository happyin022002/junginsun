 ...
 *@FileName : ESM_PRI_2072HTMLAction.java
...
public class ESM_PRI_2072HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2072Event event = new EsmPri2072Event();
