...
*@FileName : MonthlyTargetVVDDBDAOSearchTgtVVDStsCdCancel0040RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyTargetVVDDBDAOSearchTgtVVDStsCdCancel0040RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyTargetVVDDBDAOSearchTgtVVDStsCdCancel0040RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyTargetVVDDBDAOSearchTgtVVDStsCdCancel0040RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT TRD_CD,DIR_CD,TGT_VVD_STS_CD " ).append("\n"); 
		...
		query.append("    TGT_VVD_STS_CD <> 'C'  " ).append("\n"); 
		query.append("ORDER BY  TGT_VVD_STS_CD" ).append("\n"); 
