...
*@FileName : AncsManifestListDownloadDBDAOremoveBkgCstmsAnrNtfyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsManifestListDownloadDBDAOremoveBkgCstmsAnrNtfyDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsManifestListDownloadDBDAOremoveBkgCstmsAnrNtfyDSQL(){
		setQuery();
		...
		query.append("FileName : AncsManifestListDownloadDBDAOremoveBkgCstmsAnrNtfyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
