...
*@FileName : DailyForecastManageDBDAOSpcDlyFcastCust2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DailyForecastManageDBDAOSpcDlyFcastCust2USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPC_DLY_FCAST_CUST의 UPDATE DATE를 수정한다
	  * </pre>
	  */
	public DailyForecastManageDBDAOSpcDlyFcastCust2USQL(){
		setQuery();
		...
		query.append("FileName : DailyForecastManageDBDAOSpcDlyFcastCust2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND IOC_TS_CD   = @[ioc_cd]" ).append("\n"); 
