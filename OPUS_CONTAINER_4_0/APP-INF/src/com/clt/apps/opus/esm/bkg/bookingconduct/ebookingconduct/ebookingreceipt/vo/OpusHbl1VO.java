...
*@FileName : OpusHbl1VO.java
*@FileTitle : OpusHbl1VO
*Open Issues :
*Change history :
...
public class OpusHbl1VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpusHbl1VO> models = new ArrayList<OpusHbl1VO>();
	 ...
	 * @return OpusHbl1VO[]
	 */
	public OpusHbl1VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpusHbl1VO[]
	 */
	public OpusHbl1VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpusHbl1VO model = null;
	 ...
	 * @return OpusHbl1VO[]
	 */
	public OpusHbl1VO[] getOpusHbl1VOs(){
		OpusHbl1VO[] vos = (OpusHbl1VO[])models.toArray(new OpusHbl1VO[models.size()]);
		return vos;
	}
