...
*@FileName : FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintMasterListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintMasterListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchFFCmpnApprovalPrintMasterList
	  * </pre>
	  */
	public FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintMasterListRSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintMasterListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
