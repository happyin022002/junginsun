...
*@FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewOtrRefCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewOtrRefCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewOtrRefCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewOtrRefCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO AGT_AGN_OTR_REF" ).append("\n"); 
