...
*@FileName : RFARateGuidelineDBDAOPriRgRtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOPriRgRtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOPriRgRtVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOPriRgRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
