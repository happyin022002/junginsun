...
*@FileName : Eur24SendHistoryOBVO.java
*@FileTitle : Eur24SendHistoryOBVO
*Open Issues :
*Change history :
...
public class Eur24SendHistoryOBVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Eur24SendHistoryOBVO> models = new ArrayList<Eur24SendHistoryOBVO>();
...
/**
	 ...
	 * @param request
	 * @return Eur24SendHistoryOBVO[]
	 */
	public Eur24SendHistoryOBVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Eur24SendHistoryOBVO[]
	 */
	public Eur24SendHistoryOBVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Eur24SendHistoryOBVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Eur24SendHistoryOBVO();
				if (updDt[i] != null)
		...
		return getEur24SendHistoryOBVOs();
	}
	 ...
	 * @return Eur24SendHistoryOBVO[]
	 */
	public Eur24SendHistoryOBVO[] getEur24SendHistoryOBVOs(){
		Eur24SendHistoryOBVO[] vos = (Eur24SendHistoryOBVO[])models.toArray(new Eur24SendHistoryOBVO[models.size()]);
		return vos;
	}
