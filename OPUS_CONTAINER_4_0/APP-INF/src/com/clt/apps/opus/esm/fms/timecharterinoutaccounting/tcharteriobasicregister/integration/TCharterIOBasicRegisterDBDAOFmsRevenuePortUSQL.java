...
*@FileName : TCharterIOBasicRegisterDBDAOFmsRevenuePortUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOBasicRegisterDBDAOFmsRevenuePortUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Revenue Port Management Update
	  * </pre>
	  */
	public TCharterIOBasicRegisterDBDAOFmsRevenuePortUSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOBasicRegisterDBDAOFmsRevenuePortUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE FMS_BSE_PORT SET" ).append("\n"); 
		query.append("SLAN_CD = @[slan_cd]," ).append("\n"); 
		query.append("FLET_IOC_CD = @[flet_ioc_cd]," ).append("\n"); 
		query.append("ST_PORT_CD = @[st_port_cd]," ).append("\n"); 
		query.append("FNL_PORT_CD = @[fnl_port_cd]," ).append("\n"); 
