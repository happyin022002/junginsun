...
*@FileName       : EsmSaq0040ViewAdapter2.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0040ViewAdapter2 extends ViewAdapter{
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		log.debug("EsmSaq0040ViewAdapter2 makeDataTag start");
		...
		log.debug("EsmSaq0040ViewAdapter2 makeDataTag end");
