...
*@FileName : CstmsVvdListCondVO.java
*@FileTitle : CstmsVvdListCondVO
*Open Issues :
*Change history :
...
public class CstmsVvdListCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstmsVvdListCondVO> models = new ArrayList<CstmsVvdListCondVO>();
	...
	public CstmsVvdListCondVO() {}

	public CstmsVvdListCondVO(String ibflag, String pagerows, String eVpsEtaDt, String sVpsEtaDt, String vvdCd, String cvyRefNo, String slanCd, String vpsPortCd, String crrCd, String polCd) {
	...
	public CstmsVvdListCondVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CstmsVvdListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstmsVvdListCondVO model = null;
	...
	public CstmsVvdListCondVO[] getCstmsVvdListCondVOs(){
		CstmsVvdListCondVO[] vos = (CstmsVvdListCondVO[])models.toArray(new CstmsVvdListCondVO[models.size()]);
		return vos;
	}
