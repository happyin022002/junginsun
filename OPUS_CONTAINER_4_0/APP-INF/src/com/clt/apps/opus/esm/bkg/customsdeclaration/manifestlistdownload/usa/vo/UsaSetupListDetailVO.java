...
*@FileName : UsaSetupListDetailVO.java
*@FileTitle : UsaSetupListDetailVO
*Open Issues :
*Change history :
...
public class UsaSetupListDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaSetupListDetailVO> models = new ArrayList<UsaSetupListDetailVO>();
...
/**
	 ...
	 * @param request
	 * @return UsaSetupListDetailVO[]
	 */
	public UsaSetupListDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaSetupListDetailVO[]
	 */
	public UsaSetupListDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaSetupListDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsaSetupListDetailVO();
		...
		return getUsaSetupListDetailVOs();
	}
	 ...
	 * @return UsaSetupListDetailVO[]
	 */
	public UsaSetupListDetailVO[] getUsaSetupListDetailVOs(){
		UsaSetupListDetailVO[] vos = (UsaSetupListDetailVO[])models.toArray(new UsaSetupListDetailVO[models.size()]);
		return vos;
	}
