...
*@FileName : RsltRtRoutPntListVO.java
*@FileTitle : RsltRtRoutPntListVO
*Open Issues :
*Change history :
...
public class RsltRtRoutPntListVO extends AbstractValueObject {
	...
	public RsltRtRoutPntListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		return getRsltRtRoutPntListVOs();
	}
	 ...
	 * @return RsltRtRoutPntListVO[]
	 */
	public RsltRtRoutPntListVO[] getRsltRtRoutPntListVOs(){
