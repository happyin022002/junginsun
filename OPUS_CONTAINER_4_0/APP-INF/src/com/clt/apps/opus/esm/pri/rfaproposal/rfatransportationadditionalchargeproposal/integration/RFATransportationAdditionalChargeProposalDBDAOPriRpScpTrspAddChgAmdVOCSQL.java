...
*@FileName : RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgAmdVOCSQL
	  * </pre>
	  */
	public RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_RP_SCP_TRSP_ADD_CHG" ).append("\n"); 
