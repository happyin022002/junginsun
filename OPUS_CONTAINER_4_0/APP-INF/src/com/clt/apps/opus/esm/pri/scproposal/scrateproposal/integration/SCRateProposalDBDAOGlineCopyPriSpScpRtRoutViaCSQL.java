...
*@FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtRoutViaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOGlineCopyPriSpScpRtRoutViaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_SP_SCP_RT_ROUT_VIA Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOGlineCopyPriSpScpRtRoutViaCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtRoutViaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.ORG_DEST_TP_CD" ).append("\n"); 
		query.append("                          ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.ORG_DEST_TP_CD, B.ROUT_VIA_SEQ) AS ROUT_VIA_SEQ" ).append("\n"); 
		...
		query.append("    )" ).append("\n"); 
		query.append(") A" ).append("\n"); 
		query.append("   , PRI_SG_RT_ROUT_VIA B" ).append("\n"); 
		query.append("WHERE B.SVC_SCP_CD = A.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   B.GLINE_SEQ = A.GLINE_SEQ" ).append("\n"); 
		query.append("AND   B.PRC_CUST_TP_CD = A.PRC_CUST_TP_CD" ).append("\n"); 
		query.append("AND   B.CMDT_HDR_SEQ = A.OLD_CMDT_HDR_SEQ" ).append("\n"); 
