...
public class KorIbMtInfoVO extends AbstractValueObject {
	...
	public KorIbMtInfoVO(String ibflag, String pagerows, String inVsl, String inVoy, String inDir, String inEta, String inSeq, String inPort, String inTpCd, String inCBl, String inBkg, String inMsn, String inCgoTp) {
		this.inBkg = inBkg;
		this.inCBl = inCBl;
		this.inTpCd = inTpCd;
		this.inDir = inDir;
