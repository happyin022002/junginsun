...
*@FileName : CndManifestListDownloadDBDAOsearchHusBlInpChkListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndManifestListDownloadDBDAOsearchHusBlInpChkListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndManifestListDownloadDBDAOsearchHusBlInpChkListRSQL(){
		setQuery();
		...
		query.append("FileName : CndManifestListDownloadDBDAOsearchHusBlInpChkListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                      ,LPAD(B.CND_CSTMS_FILE_CD, 2, '0') AS MBL_FILER" ).append("\n"); 
		...
		query.append("                      ,LPAD(B.USA_CSTMS_FILE_CD, 2, '0') AS ETC_FILER" ).append("\n"); 
		...
		query.append("                   AND NVL(B.CND_CSTMS_FILE_CD, ' ') = @[mbl_filer]" ).append("\n"); 
		query.append("               #end" ).append("\n"); 
