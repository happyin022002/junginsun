...
*@FileName : RFARateGuidelineDBDAOPriRgRtCmdtVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOPriRgRtCmdtVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOPriRgRtCmdtVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOPriRgRtCmdtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
