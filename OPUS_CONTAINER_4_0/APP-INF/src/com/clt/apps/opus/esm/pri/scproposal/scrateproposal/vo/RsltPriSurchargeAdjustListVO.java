...
*@FileName : RsltPriSurchargeAdjustListVO.java
*@FileTitle : RsltPriSurchargeAdjustListVO
*Open Issues :
*Change history :
...
public class RsltPriSurchargeAdjustListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSurchargeAdjustListVO> models = new ArrayList<RsltPriSurchargeAdjustListVO>();
	...
	public RsltPriSurchargeAdjustListVO() {}

	public RsltPriSurchargeAdjustListVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String scgAdjSeq, String prcCmdtTpCd, String prcCmdtDefCd, String orgLocTpCd, String orgLocDefCd, String orgViaLocTpCd, String orgViaLocDefCd, String destViaLocTpCd, String destViaLocDefCd, String destLocTpCd, String destLocDefCd, String prcRcvTermCd, String prcDeTermCd, String bkgRatUtCd, String prcCgoTpCd, String chgCd, String currCd, String adjScgAmt, String adjScgUsdAmt, String creUsrId, String creDt, String updUsrId, String updDt, String chgNm, String rplcNoteCtnt) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setScgAdjSeq(JSPUtil.getParameter(request, prefix + "scg_adj_seq", ""));
		...
		setOrgLocTpCd(JSPUtil.getParameter(request, prefix + "org_loc_tp_cd", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setGenSpclRtTpCd(JSPUtil.getParameter(request, prefix + "gen_spcl_rt_tp_cd", ""));
		setOrgViaLocTpCd(JSPUtil.getParameter(request, prefix + "org_via_loc_tp_cd", ""));
		setDestViaLocTpCd(JSPUtil.getParameter(request, prefix + "dest_via_loc_tp_cd", ""));
		...
		setDestLocTpCd(JSPUtil.getParameter(request, prefix + "dest_loc_tp_cd", ""));
		setOrgViaLocDefCd(JSPUtil.getParameter(request, prefix + "org_via_loc_def_cd", ""));
		setOrgLocDefCd(JSPUtil.getParameter(request, prefix + "org_loc_def_cd", ""));
		setPrcRcvTermCd(JSPUtil.getParameter(request, prefix + "prc_rcv_term_cd", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setDestLocDefCd(JSPUtil.getParameter(request, prefix + "dest_loc_def_cd", ""));
		...
		setDestViaLocDefCd(JSPUtil.getParameter(request, prefix + "dest_via_loc_def_cd", ""));
	}
	 ...
	 */
	public RsltPriSurchargeAdjustListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSurchargeAdjustListVO[]
	 */
	public RsltPriSurchargeAdjustListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSurchargeAdjustListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSurchargeAdjustListVO();
				if (scgAdjSeq[i] != null)
		...
		return getRsltPriSurchargeAdjustListVOs();
	}
	...
	public RsltPriSurchargeAdjustListVO[] getRsltPriSurchargeAdjustListVOs(){
		RsltPriSurchargeAdjustListVO[] vos = (RsltPriSurchargeAdjustListVO[])models.toArray(new RsltPriSurchargeAdjustListVO[models.size()]);
		return vos;
	}
