...
*@FileName : KorCustomsTransmissionDBDAOmakeMACAMDAmdCntrFlatFileRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeMACAMDAmdCntrFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeMACAMDAmdCntrFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeMACAMDAmdCntrFlatFileRSQL").append("\n");
		query.append("*/").append("\n");
	}
