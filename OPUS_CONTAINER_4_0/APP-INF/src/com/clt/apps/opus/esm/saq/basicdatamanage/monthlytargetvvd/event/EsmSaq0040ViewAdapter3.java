...
*@FileName       : EsmSaq0040ViewAdapter3.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0040ViewAdapter3 extends ViewAdapter{
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		log.debug("EsmSaq0040ViewAdapter3 makeDataTag start");
		...
		for(int i=0; i<totCnt; i++){
			...
			sbufXML.append("	<TD>"+colValues.get("tgt_yr")+"</TD>	");
			...
			sbufXML.append("	<TD>"+Integer.parseInt(colValues.get("fnl_bsa_capa"))/Integer.parseInt(conditionVO.getUnit())+"</TD>	");
			sbufXML.append("	<TD>"+colValues.get("upd_rmk")+"</TD>	");
			sbufXML.append("</TR>\n");
		}
		sbufXML.append("</DATA>\n");
	
		log.debug("EsmSaq0040ViewAdapter3 makeDataTag end");
