...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportByEQRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportByEQRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportByEQRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportByEQRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD = 'D2' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'D2' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) D2" ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD = 'D4' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'D4' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		...
		query.append(" WHERE BKG.BKG_NO = CHG.BKG_NO(+) AND BKG.BKG_NO = RATE.BKG_NO(+)" ).append("\n"); 
		query.append(" GROUP BY BKG.VVD,BKG.POD_CD,BKG.SLAN_CD,BKG.POR_CD" ).append("\n"); 
