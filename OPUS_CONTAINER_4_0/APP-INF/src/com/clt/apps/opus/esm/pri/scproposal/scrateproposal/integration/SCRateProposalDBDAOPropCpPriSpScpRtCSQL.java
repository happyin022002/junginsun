...
*@FileName : SCRateProposalDBDAOPropCpPriSpScpRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPropCpPriSpScpRtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_RT Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOPropCpPriSpScpRtCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPropCpPriSpScpRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                          ORDER BY S.PROP_NO, S.AMDT_SEQ, S.SVC_SCP_CD, S.GEN_SPCL_RT_TP_CD, R.CMDT_HDR_SEQ, R.ROUT_SEQ, S.RT_SEQ) AS RT_SEQ" ).append("\n"); 
		...
		query.append("               WHERE PROP_NO = @[prop_no] AND AMDT_SEQ = @[amdt_seq]),'F',S.FNL_FRT_RT_AMT,S.PROP_FRT_RT_AMT) AS PROP_FRT_RT_AMT" ).append("\n"); 
		...
		query.append("    ,PRI_SP_SCP_RT S" ).append("\n"); 
