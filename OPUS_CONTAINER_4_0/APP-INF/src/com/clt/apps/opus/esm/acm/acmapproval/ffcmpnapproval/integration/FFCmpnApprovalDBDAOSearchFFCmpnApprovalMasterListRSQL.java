...
*@FileName : FFCmpnApprovalDBDAOSearchFFCmpnApprovalMasterListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCmpnApprovalDBDAOSearchFFCmpnApprovalMasterListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 
	  * 2016.05.19 박다은 [CSR:#13041] [Split - 2] Insert CSR Creation Date column in all CSR I/F screens
	  * </pre>
	  */
	public FFCmpnApprovalDBDAOSearchFFCmpnApprovalMasterListRSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnApprovalDBDAOSearchFFCmpnApprovalMasterListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   AND A.FF_CMPN_STS_CD = 'IF'" ).append("\n"); 
		query.append("	   AND A.FF_CMPN_RMK IN ( 'Interface Success!', 'Interface OK!')" ).append("\n"); 
