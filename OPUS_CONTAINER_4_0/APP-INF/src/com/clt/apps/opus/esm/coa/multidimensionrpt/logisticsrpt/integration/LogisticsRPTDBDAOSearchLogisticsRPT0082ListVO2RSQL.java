...
*@FileName : LogisticsRPTDBDAOSearchLogisticsRPT0082ListVO2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogisticsRPTDBDAOSearchLogisticsRPT0082ListVO2RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Logistics Exp.by Node&Link(ESM_COA_0082)조회2
	  * </pre>
	  */
	public LogisticsRPTDBDAOSearchLogisticsRPT0082ListVO2RSQL(){
		setQuery();
		...
		query.append("FileName : LogisticsRPTDBDAOSearchLogisticsRPT0082ListVO2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	        ,D2.N4TH_NOD_CD   /*,D2.P_REPORT*/" ).append("\n"); 
		...
		query.append("								  ,'51301091', D2.FCNTR_TRSP_FUEL_SCG_AMT -- 추가" ).append("\n"); 
		...
		query.append("				WHERE SGRP_COST_CD = 'CVTR')   /*FULL TRANS*/ D1" ).append("\n"); 
		query.append("                ,(SELECT   /*+ FULL(C3) PARALLEL(C3,4) */ --김봉갑 수석 튜닝 2010.05.07" ).append("\n"); 
		query.append("                          --C3.BKG_NO, C3.BKG_NO_SPLIT," ).append("\n"); 
