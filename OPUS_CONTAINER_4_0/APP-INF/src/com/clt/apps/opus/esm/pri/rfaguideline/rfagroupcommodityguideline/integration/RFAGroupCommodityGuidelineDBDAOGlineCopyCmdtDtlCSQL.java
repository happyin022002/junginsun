...
*@FileName : RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtDtlCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RG_GRP_CMDT_DTL (" ).append("\n"); 
		...
		query.append("ORDER BY A.SVC_SCP_CD, A.GLINE_SEQ, A.GRP_CMDT_SEQ, B.GRP_CMDT_DTL_SEQ) AS GRP_CMDT_DTL_SEQ" ).append("\n"); 
