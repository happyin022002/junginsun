...
*@FileName : PlanningDBDAOSearchQtaByHOResultRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOSearchQtaByHOResultRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Trade-Lane-Reversed Bound-RHQ별로 판매목표 Load 및 G.REV Portion을 Simulation
	  * </pre>
	  */
	public PlanningDBDAOSearchQtaByHOResultRSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOSearchQtaByHOResultRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,V.RHQ_QTY" ).append("\n"); 
		query.append("        ,V.RHQ_REV" ).append("\n"); 
		query.append("    FROM CSQ_DAT_RLT      	  R" ).append("\n"); 
		query.append("        ,CSQ_SIMULATION_RHQ_V V" ).append("\n"); 
