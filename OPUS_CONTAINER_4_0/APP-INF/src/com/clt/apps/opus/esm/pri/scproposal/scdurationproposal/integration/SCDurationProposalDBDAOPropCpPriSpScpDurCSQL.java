...
*@FileName : SCDurationProposalDBDAOPropCpPriSpScpDurCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAOPropCpPriSpScpDurCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_DUR Insert
	  * </pre>
	  */
	public SCDurationProposalDBDAOPropCpPriSpScpDurCSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAOPropCpPriSpScpDurCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
