...
*@FileName : StatusReportDBDAOupdateVgmWgtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOupdateVgmWgtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StatusReportDBDAOupdateVgmWgtUSQL(){
		setQuery();
		...
		params.put("vgm_wgt_upd_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : StatusReportDBDAOupdateVgmWgtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("VGM_WGT_UPD_DT = TO_DATE(@[vgm_wgt_upd_dt],'YYYY-MM-DD HH24:MI')," ).append("\n"); 
