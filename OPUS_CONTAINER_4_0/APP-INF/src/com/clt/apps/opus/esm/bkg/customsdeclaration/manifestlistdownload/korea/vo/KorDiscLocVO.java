...
*@FileName : KorDiscLocVO.java
*@FileTitle : KorDiscLocVO
*Open Issues :
*Change history :
...
public class KorDiscLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorDiscLocVO> models = new ArrayList<KorDiscLocVO>();
	...
	public KorDiscLocVO(String ibflag, String pagerows, String locNm, String otrDchgCd, String slanCd, String skdDirCd, String portCd) {
	 ...
	 * @return KorDiscLocVO[]
	 */
	public KorDiscLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDiscLocVO[]
	 */
	public KorDiscLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDiscLocVO model = null;
	 ...
	 * @return KorDiscLocVO[]
	 */
	public KorDiscLocVO[] getKorDiscLocVOs(){
		KorDiscLocVO[] vos = (KorDiscLocVO[])models.toArray(new KorDiscLocVO[models.size()]);
		return vos;
	}
