...
*@FileName : KorManifestListDBDAOModifyMrnNoKorUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOModifyMrnNoKorUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOModifyMrnNoKorUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : KorManifestListDBDAOModifyMrnNoKorUSQL").append("\n");
		query.append("*/").append("\n");
	}
}