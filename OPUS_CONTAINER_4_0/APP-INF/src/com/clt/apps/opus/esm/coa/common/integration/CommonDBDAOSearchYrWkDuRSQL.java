...
*@FileName : CommonDBDAOSearchYrWkDuRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchYrWkDuRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchYrWkDuRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchYrWkDuRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       AND COST_YR||COST_WK BETWEEN @[in_fm_wk] AND @[in_to_wk]" ).append("\n"); 
		query.append("   #elseif (${in_mon_or_wk} == 'M') " ).append("\n"); 
		query.append("       AND SUBSTR(SLS_FM_DT,1,6) BETWEEN @[in_fm_mon] AND @[in_to_mon]" ).append("\n"); 
