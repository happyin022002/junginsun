...
*@FileName : MalaysiaManifestListDownloadDBDAOaddImpStsSpclCgoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MalaysiaManifestListDownloadDBDAOaddImpStsSpclCgoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MalaysiaManifestListDownloadDBDAOaddImpStsSpclCgoCSQL(){
		setQuery();
		...
		query.append("FileName : MalaysiaManifestListDownloadDBDAOaddImpStsSpclCgoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_MY_IMP_STS_SPCL" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("         @[cgo_desc]," ).append("\n"); 
		query.append("         @[cmdt_desc]," ).append("\n"); 
		query.append("         NVL(@[ld_ins1], '  ')||NVL(@[ld_ins2], '  ')||NVL(@[ld_ins3], '  ')," ).append("\n"); 
		query.append("         @[dchg_ovr_sz_flg]," ).append("\n"); 
