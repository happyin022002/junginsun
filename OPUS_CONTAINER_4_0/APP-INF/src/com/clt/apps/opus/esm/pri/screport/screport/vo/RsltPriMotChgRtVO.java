 ...
 *@FileName : RsltPriMotChgRtVO.java
 *@FileTitle : RsltPriMotChgRtVO
 *Open Issues :
 *Change history :
 *@LastModifyDate : 2015.01.20
 *@LastModifier : jaewonLee
 *@LastVersion : 1.0
 * 2015.01.20 jaewonLee 
 * 1.0 Creation
=========================================================*/
 ...
 * @see	..
 */
public class RsltPriMotChgRtVO	extends	 AbstractValueObject {

	private	 static final long serialVersionUID = 1L;

	private	 Collection<RsltPriMotChgRtVO>  models =	new	ArrayList<RsltPriMotChgRtVO>();
	 ...
	 */
	public RsltPriMotChgRtVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return RsltPriMotChgRtVO[]
	 */
	public RsltPriMotChgRtVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		RsltPriMotChgRtVO model = null;
	 ...
	 * @return RsltPriMotChgRtVO[]
	 */
	public RsltPriMotChgRtVO[]	 getRsltPriMotChgRtVOs(){
		RsltPriMotChgRtVO[] vos = (RsltPriMotChgRtVO[])models.toArray(new	RsltPriMotChgRtVO[models.size()]);
		return vos;
	}
