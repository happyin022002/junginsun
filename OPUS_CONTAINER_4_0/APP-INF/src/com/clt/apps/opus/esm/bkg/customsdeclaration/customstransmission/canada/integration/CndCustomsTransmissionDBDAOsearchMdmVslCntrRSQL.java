...
*@FileName : CndCustomsTransmissionDBDAOsearchMdmVslCntrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndCustomsTransmissionDBDAOsearchMdmVslCntrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndCustomsTransmissionDBDAOsearchMdmVslCntrRSQL(){
		setQuery();
		...
		query.append("FileName : CndCustomsTransmissionDBDAOsearchMdmVslCntrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
