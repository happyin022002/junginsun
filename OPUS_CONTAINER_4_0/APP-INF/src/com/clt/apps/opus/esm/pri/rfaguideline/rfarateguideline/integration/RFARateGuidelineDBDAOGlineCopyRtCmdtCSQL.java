...
*@FileName : RFARateGuidelineDBDAOGlineCopyRtCmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOGlineCopyRtCmdtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOGlineCopyRtCmdtCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOGlineCopyRtCmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RG_RT_CMDT (" ).append("\n"); 
		...
		query.append("ORDER BY E.SVC_SCP_CD, E.GLINE_SEQ, E.CMDT_HDR_SEQ, D.CMDT_SEQ) AS CMDT_SEQ" ).append("\n"); 
