...
*@FileName : KorIbTransWhfVO.java
*@FileTitle : KorIbTransWhfVO
*Open Issues :
*Change history :
...
public class KorIbTransWhfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorIbTransWhfVO> models = new ArrayList<KorIbTransWhfVO>();
	...
	public KorIbTransWhfVO() {}

	public KorIbTransWhfVO(String ibflag, String pagerows, String transType, String transTypeChg, String bkgNo, String ktPort, String ktSeq, String inBound, String podTml, String kcdTp, String exptKcdTp) {
		this.ktSeq = ktSeq;
		this.bkgNo = bkgNo;
	 ...
	 */
	public KorIbTransWhfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorIbTransWhfVO[]
	 */
	public KorIbTransWhfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorIbTransWhfVO model = null;
	 ...
	 * @return KorIbTransWhfVO[]
	 */
	public KorIbTransWhfVO[] getKorIbTransWhfVOs(){
		KorIbTransWhfVO[] vos = (KorIbTransWhfVO[])models.toArray(new KorIbTransWhfVO[models.size()]);
		return vos;
	}
