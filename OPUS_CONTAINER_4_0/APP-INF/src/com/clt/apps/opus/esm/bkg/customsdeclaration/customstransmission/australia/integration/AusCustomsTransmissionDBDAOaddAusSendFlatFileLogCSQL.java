...
*@FileName : AusCustomsTransmissionDBDAOaddAusSendFlatFileLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOaddAusSendFlatFileLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOaddAusSendFlatFileLogCSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOaddAusSendFlatFileLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_AUS_DG_SND_LOG (" ).append("\n"); 
