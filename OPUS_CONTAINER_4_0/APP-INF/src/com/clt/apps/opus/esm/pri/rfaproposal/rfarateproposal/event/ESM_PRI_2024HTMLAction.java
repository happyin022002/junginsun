 ...
 *@FileName : ESM_PRI_2024HTMLAction.java
...
public class ESM_PRI_2024HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2024Event event = new EsmPri2024Event();
