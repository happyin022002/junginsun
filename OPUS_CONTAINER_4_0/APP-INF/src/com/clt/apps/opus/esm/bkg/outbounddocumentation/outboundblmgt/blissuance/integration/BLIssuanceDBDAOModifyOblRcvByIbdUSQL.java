...
public class BLIssuanceDBDAOModifyOblRcvByIbdUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                     , TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(), SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[obl_rdem_ofc_cd])), 'YYYYMMDDHH24MI')" ).append("\n"); 
		...
		query.append("     , OTR_DOC_RCV_DT     = NVL(OTR_DOC_RCV_DT    , GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(), SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[obl_rdem_ofc_cd])))" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		...
		query.append("     , IBD_DOC_RCV_DT     = nvl(IBD_DOC_RCV_DT    , GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(), SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[obl_rdem_ofc_cd])) )" ).append("\n"); 
