...
*@FileName : RocsManifestListDownloadDBDAOmodifyBlSeqUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestListDownloadDBDAOmodifyBlSeqUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestListDownloadDBDAOmodifyBlSeqUSQL(){
		setQuery();
		...
		params.put("ib_file_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : RocsManifestListDownloadDBDAOmodifyBlSeqUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET IB_FILE_SEQ				=	@[ib_file_seq]" ).append("\n"); 
