...
*@FileName : ESM_BKG_1004HTMLAction.java
 ...
 * @see EsmBkg1004Event 참조
 * @since J2EE 1.5
 */

public class ESM_BKG_1004HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_1004HTMLAction 객체를 생성
     */
    public ESM_BKG_1004HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg1004Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1004Event event = new EsmBkg1004Event();
		...
		if (command.isCommand(FormCommand.SEARCH)){
			...
			event.setInfoVO((DocsUserGroupCdVO) getVO(request, DocsUserGroupCdVO.class));
		}
