...
*@FileName : SCProposalMainDBDAORevertPriSpBlPlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpBlPlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_BLPL
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpBlPlUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpBlPlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_BLPL" ).append("\n"); 
