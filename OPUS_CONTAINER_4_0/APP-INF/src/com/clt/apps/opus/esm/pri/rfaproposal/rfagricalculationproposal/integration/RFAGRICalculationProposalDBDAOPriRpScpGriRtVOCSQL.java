...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRtVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriRtVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriRtVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RP_SCP_GRI_RT (" ).append("\n"); 
