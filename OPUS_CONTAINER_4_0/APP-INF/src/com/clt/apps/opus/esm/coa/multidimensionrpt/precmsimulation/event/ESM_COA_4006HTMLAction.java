...
*@FileName : ESM_COA_4006HTMLAction.java
...
public class ESM_COA_4006HTMLAction extends HTMLActionSupport { 

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_4006HTMLAction 객체를 생성
	 */
	public ESM_COA_4006HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);					//SJH.20150508.소스품질
		EsmCoa4006Event event = new EsmCoa4006Event();
		
		event.setTrfChgVOS((TrfChgVO[])getVOs(request, TrfChgVO .class,""));	//20160616.ADD
