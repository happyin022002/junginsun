...
*@FileName : Eur24ManifestDownloadDBDAOAddBlCntrOBCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBlCntrOBCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBlCntrOBCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBlCntrOBCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO BKG_CSTMS_EUR_IO_CNTR( BND_TP_CD, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, BL_NO, CSTMS_PORT_CD, CNTR_NO, FULL_MTY_CD, PCK_QTY, PCK_TP_CD, MEAS_QTY, MEAS_UT_CD, ACT_WGT, WGT_UT_CD, CNTR_TPSZ_CD, CMDT_DESC, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT )" ).append("\n"); 
