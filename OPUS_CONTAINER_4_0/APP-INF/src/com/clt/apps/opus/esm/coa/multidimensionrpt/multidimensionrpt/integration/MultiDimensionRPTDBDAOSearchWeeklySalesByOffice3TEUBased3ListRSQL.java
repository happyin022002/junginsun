...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		   ,25, 0 /*EQ Cost */" ).append("\n"); 
		query.append("		   ) AS AMT            " ).append("\n"); 
		query.append("	FROM ( " ).append("\n"); 
		...
		query.append("				           WHEN A3.STND_COST_CD IN ('43102011', '43102021', '43201011', '43207011') " ).append("\n"); 
		...
		query.append("				,NVL(SUM(CASE " ).append("\n"); 
		query.append("				           WHEN A3.STND_COST_CD IN ('43102011', '43102021') " ).append("\n"); 
		query.append("				           		THEN DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.CO_AMT,'O|BIZ', A2.CO_SLS_AMT,A2.ESTM_PL_AMT) " ).append("\n"); 
		query.append("				           ELSE 0 " ).append("\n"); 
		query.append("				        END " ).append("\n"); 
		query.append("				       ) " ).append("\n"); 
