...
*@FileName       : ESM_CSQ_0023HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmCsq0023Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0023HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0023HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0023Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCsq0023Event event = new EsmCsq0023Event();
