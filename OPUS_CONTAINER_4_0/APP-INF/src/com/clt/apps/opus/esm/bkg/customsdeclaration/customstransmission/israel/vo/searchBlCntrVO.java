...
*@FileName : searchBlCntrVO.java
*@FileTitle : searchBlCntrVO
*Open Issues :
*Change history :
...
public class searchBlCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<searchBlCntrVO> models = new ArrayList<searchBlCntrVO>();
...
/**
	 ...
	 * @param request
	 * @return searchBlCntrVO[]
	 */
	public searchBlCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchBlCntrVO[]
	 */
	public searchBlCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		searchBlCntrVO model = null;
	 ...
	 * @return searchBlCntrVO[]
	 */
	public searchBlCntrVO[] getsearchBlCntrVOs(){
		searchBlCntrVO[] vos = (searchBlCntrVO[])models.toArray(new searchBlCntrVO[models.size()]);
		return vos;
	}
