...
*@FileName : EsmSaq0162ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0162ViewAdapter extends ViewAdapter {

	public EsmSaq0162ViewAdapter() {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		if(conditionVO.getChkCommand().equals("SEARCHLIST")){
			...
			List<SearchMonthlyQuotaForExcelListVO> list=  (List<SearchMonthlyQuotaForExcelListVO>) listVO.getList(0);
			...
			for(int j=0; j<totCnt; j++){
				...
				SearchMonthlyQuotaForExcelListVO colValues = list.get(j);
