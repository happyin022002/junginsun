...
public class MailSendVO extends AbstractValueObject {
	...
	public MailSendVO(String ibflag, String pagerows, String sysCd, String tmplMrd, String batchFlg, String title, String contents, String tmplParam, String sndNm, String sndEml, String rcvEml, String crtUserId, String fileKey, String tmplMrdPdf, String ccEml, String bccRcvrEml) {
	...
	public MailSendVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] bccRcvrEml = (JSPUtil.getParameter(request, prefix	+ "bcc_rcvr_eml", length));
