...
*@FileName : TaiwanSearchBlChargeTotalVO.java
*@FileTitle : TaiwanSearchBlChargeTotalVO
*Open Issues :
*Change history :
...
public class TaiwanSearchBlChargeTotalVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TaiwanSearchBlChargeTotalVO> models = new ArrayList<TaiwanSearchBlChargeTotalVO>();
	...
	public TaiwanSearchBlChargeTotalVO() {}

	public TaiwanSearchBlChargeTotalVO(String ibflag, String pagerows, String ppdTotal, String cctTotal, String totalCur) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return TaiwanSearchBlChargeTotalVO[]
	 */
	public TaiwanSearchBlChargeTotalVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TaiwanSearchBlChargeTotalVO[]
	 */
	public TaiwanSearchBlChargeTotalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TaiwanSearchBlChargeTotalVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TaiwanSearchBlChargeTotalVO();
				if (ibflag[i] != null)
		...
		return getTaiwanSearchBlChargeTotalVOs();
	}
	 ...
	 * @return TaiwanSearchBlChargeTotalVO[]
	 */
	public TaiwanSearchBlChargeTotalVO[] getTaiwanSearchBlChargeTotalVOs(){
		TaiwanSearchBlChargeTotalVO[] vos = (TaiwanSearchBlChargeTotalVO[])models.toArray(new TaiwanSearchBlChargeTotalVO[models.size()]);
		return vos;
	}
