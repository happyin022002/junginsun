...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esm.agt.agtcalculation.brkgcalc.integration;
...
public class BRKGCalcDBDAO extends DBDAOSupport {
	...
	public HashMap searchBookingInfoforComm(HashMap<String, Serializable> bkgMap) throws DAOException {
		...
		// Booking 정보 조회 쿼리
		// 2007.06.18 BUDBS인경우도 BSLBA처리 CCT OFFICE 기준으로 DEL Office 로 checkup
		queryBkg.append("SELECT DISTINCT a.por_cd, b.rgn_cd por_rgn_cd, b.cnt_cd por_cnt_cd,    \n");
		queryBkg.append("         b.ste_cd por_ste_cd, b.sconti_cd por_sconti_cd,    \n");
		queryBkg.append("         b.conti_cd por_conti_cd, DECODE(a1.OFC_CD, 'BSLBA', a1.OFC_CD, DECODE(c.finc_ctrl_ofc_cd, 'GLWBA', c.finc_ctrl_ofc_cd, b.finc_ctrl_ofc_cd)) por_finc_ctrl_ofc_cd,    \n");
		queryBkg.append("         DECODE(a1.OFC_CD, 'BSLBA', f.ar_ofc_cd,  DECODE(c.finc_ctrl_ofc_cd, 'GLWBA', c1.ar_ofc_cd,  b1.ar_ofc_cd)) por_ar_ofc_cd,    \n");
		queryBkg.append("         DECODE(a1.OFC_CD, 'BSLBA', f.ap_ofc_cd,  DECODE(c.finc_ctrl_ofc_cd, 'GLWBA', c1.ap_ofc_cd,  b1.ap_ofc_cd)) por_ap_ofc_cd,    \n");
		queryBkg.append("         a.pol_cd, c.rgn_cd pol_rgn_cd, c.cnt_cd pol_cnt_cd,    \n");
		queryBkg.append("         c.ste_cd pol_ste_cd, c.sconti_cd pol_sconti_cd,    \n");
		queryBkg.append("         c.conti_cd pol_conti_cd, c.finc_ctrl_ofc_cd pol_finc_ctrl_ofc_cd,    \n");
		queryBkg.append("         c1.ar_ofc_cd pol_ar_ofc_cd, c1.ap_ofc_cd pol_ap_ofc_cd, a.pod_cd,    \n");
		queryBkg.append("         d.rgn_cd pod_rgn_cd, d.cnt_cd pod_cnt_cd, d.ste_cd pod_ste_cd,    \n");
		queryBkg.append("         d.sconti_cd pod_sconti_cd, d.conti_cd pod_conti_cd,    \n");
		queryBkg.append("         d.finc_ctrl_ofc_cd pod_finc_ctrl_ofc_cd, d1.ar_ofc_cd pod_ar_ofc_cd,    \n");
		queryBkg.append("         d1.ap_ofc_cd pod_ap_ofc_cd, a.del_cd, e.rgn_cd del_rgn_cd,    \n");
		queryBkg.append("         e.cnt_cd del_cnt_cd, e.ste_cd del_ste_cd, e.sconti_cd del_sconti_cd,    \n");
		queryBkg.append("         e.conti_cd del_conti_cd, DECODE(k.clt_ofc_cd, 'BUDBB', k.clt_ofc_cd, DECODE(d.finc_ctrl_ofc_cd, 'GLWBA', d.finc_ctrl_ofc_cd, 'BUDBB', d.finc_ctrl_ofc_cd, e.finc_ctrl_ofc_cd)) del_finc_ctrl_ofc_cd,    \n");
		queryBkg.append("         DECODE(k.clt_ofc_cd, 'BUDBB', k1.ar_ofc_cd, DECODE(d.finc_ctrl_ofc_cd, 'GLWBA', d1.ar_ofc_cd, 'BUDBB', d1.ar_ofc_cd, e1.ar_ofc_cd)) del_ar_ofc_cd,    \n");
		queryBkg.append("         DECODE(k.clt_ofc_cd, 'BUDBB', k1.ap_ofc_cd, DECODE(d.finc_ctrl_ofc_cd, 'GLWBA', d1.ap_ofc_cd, 'BUDBB', d1.ap_ofc_cd, e1.ap_ofc_cd)) del_ap_ofc_cd,    \n");
		queryBkg.append("         a.rcv_term_cd, a.de_term_cd, a.bkg_ofc_cd bkg_ofc_cd,    \n");
		queryBkg.append("         a1.OFC_CD bkg_finc_ctrl_ofc_cd, f.ar_ofc_cd bkg_ar_ofc_cd,     \n");
		
		// 2008.04.28-sunganj : bkg_ofc_cd의 loc_cd를 구하기 위해 추가
		queryBkg.append("         f.loc_cd bkg_ofc_loc_cd, \n ");
		
		queryBkg.append("         a.ob_sls_ofc_cd bkg_sls_ofc_cd, a.ob_sls_ofc_cd bkg_sls_finc_ctrl_ofc_cd,    \n");
		queryBkg.append("         g.ar_ofc_cd bkg_sls_ar_ofc_cd, a.bkg_sts_cd, decode(a.bkg_cgo_tp_cd,'B','F', 'R', 'F', 'F', 'F', 'M') bkg_cgo_tp_cd,    \n");
		queryBkg.append("         a.cmdt_cd, a.rep_cmdt_cd,    \n");
		queryBkg.append("         NVL (a.bl_no, ' ') bl_no,    \n");
		queryBkg.append("         NVL (a.dbl_bkg_flg, 'N') dbl_bkg_flg,    \n");
		queryBkg.append("         NVL (a.soc_flg, 'N') bkg_shpr_ownr_flg,     \n");
		queryBkg.append("         NVL (TO_CHAR (a.bkg_cre_dt, 'YYYYMMDD'), ' ') bkg_cre_dt,   \n");
		queryBkg.append("         DECODE (NVL (a.chn_agn_cd, ' '),    \n");
		queryBkg.append("                 ' ', ' ',    \n");
		queryBkg.append("                 SUBSTR (a.bkg_ofc_cd, 1, 3) || a.chn_agn_cd    \n");
		queryBkg.append("                ) bkg_ofc_agn_cd,    \n");
		queryBkg.append("         NVL (DCGO_FLG, 'N') spcl_dg_cgo_flg,    \n");
		queryBkg.append("         NVL (rc_flg, 'N') spcl_rc_flg,    \n");
		queryBkg.append("         NVL (awk_cgo_flg, 'N') spcl_awk_cgo_flg,    \n");
		queryBkg.append("         NVL (bb_cgo_flg, 'N') spcl_bb_cgo_flg,    \n");
		queryBkg.append("         NVL (a.pre_rly_port_cd, '*') pre_rly_port_cd,    \n");
		queryBkg.append("         NVL (a.pst_rly_port_cd, '*') pst_rly_port_cd,    \n");
		queryBkg.append("         NVL (k.clt_ofc_cd, '*')      bsl_del_ofc_cd,    \n");
		queryBkg.append("         DECODE(k.clt_ofc_cd, 'BSLBA', k1.ar_ofc_cd, k.clt_ofc_cd ) bsl_del_ar_ofc_cd,    \n");
		queryBkg.append("         DECODE(k.clt_ofc_cd, 'BSLBA', k1.ap_ofc_cd, k.clt_ofc_cd ) bsl_del_ap_ofc_cd,     \n");  
		queryBkg.append("         a.ctrt_ofc_cd, A.SC_NO, A.RFA_NO, A.SVC_SCP_CD AS BKG_SVC_SCP_CD, DECODE(A.SVC_SCP_CD, NULL,'1','0') AS SVC_SCP_CHECK, \n");  
		queryBkg.append("       ( \n");  
		queryBkg.append("             SELECT \n");  
		queryBkg.append("                    NVL (BBL.BL_CVRD_TP_CD, 'N') \n");  
		queryBkg.append("               FROM BKG_BL_DOC BBL \n");  
		queryBkg.append("              WHERE BBL.BKG_NO = A.BKG_NO \n");  
		queryBkg.append("                AND ROWNUM     = 1 \n");  
		queryBkg.append("       )  AS COVERED_CHECK \n");  
		queryBkg.append("    FROM bkg_booking a,    \n");
		queryBkg.append("         bkg_rate k,    \n");
		queryBkg.append("         mdm_location b,    \n");
		queryBkg.append("         mdm_location c,    \n");
		queryBkg.append("         mdm_location d,    \n");
		queryBkg.append("         mdm_location e,    \n");
		queryBkg.append("         mdm_organization f,    \n");
		queryBkg.append("         mdm_organization g,    \n");
		queryBkg.append("         mdm_organization b1,    \n");
		queryBkg.append("         mdm_organization c1,    \n");
		queryBkg.append("         mdm_organization d1,    \n");
		queryBkg.append("         mdm_organization e1,    \n");
		queryBkg.append("         mdm_location f1,    \n");
		queryBkg.append("         mdm_location g1,    \n");
		queryBkg.append("         mdm_organization k1,   \n");
		queryBkg.append("         mdm_organization a1   \n");
		queryBkg.append("   WHERE a.bkg_no = :bkg_no        \n");
		queryBkg.append("     AND a.bkg_no        = k.bkg_no(+)    \n");
		queryBkg.append("     AND NVL(k.clt_ofc_cd, '*')    in (k1.ofc_cd, '*')    \n");
//		queryBkg.append("     AND nvl(k1.delt_flg, 'N') = 'N'   \n");
		queryBkg.append("     AND a.por_cd = b.loc_cd    \n");
		queryBkg.append("     AND a.pol_cd = c.loc_cd    \n");
		queryBkg.append("     AND a.pod_cd = d.loc_cd    \n");
		queryBkg.append("     AND a.del_cd = e.loc_cd   \n");
		queryBkg.append("     AND a.bkg_ofc_cd = a1.ofc_cd(+)   \n");
		queryBkg.append("     and a1.ofc_cd = f.ofc_cd(+)      \n");
//		queryBkg.append("     AND nvl(f.delt_flg, 'N') = 'N'   \n");
		queryBkg.append("     AND a.ob_sls_ofc_cd = g.ofc_cd(+)   \n");
//		queryBkg.append("     AND nvl(g.delt_flg, 'N') = 'N'   \n");
		queryBkg.append("     AND b.finc_ctrl_ofc_cd = b1.ofc_cd(+)   \n");
//		queryBkg.append("     AND nvl(b1.delt_flg, 'N') = 'N'   \n");
		queryBkg.append("     AND c.finc_ctrl_ofc_cd = c1.ofc_cd(+)   \n");
//		queryBkg.append("     AND nvl(c1.delt_flg, 'N') = 'N'    \n");
		queryBkg.append("     AND d.finc_ctrl_ofc_cd = d1.ofc_cd(+)   \n");
//		queryBkg.append("     AND nvl(d1.delt_flg, 'N') = 'N'   \n");
		queryBkg.append("     AND e.finc_ctrl_ofc_cd = e1.ofc_cd(+)   \n");
//		queryBkg.append("     AND nvl(e1.delt_flg, 'N') = 'N'    \n");
		queryBkg.append("     AND f.loc_cd = f1.loc_cd(+)    \n");
		queryBkg.append("     AND g.loc_cd = g1.loc_cd(+)  \n");
	...
	public HashMap searchAGTSADate(HashMap bkgMap) throws DAOException
	{
		...
		suQueryStr01.append("       DECODE(a.vsl_pre_pst_cd, 'U', bb.finc_ctrl_ofc_cd, b.finc_ctrl_ofc_cd) finc_ctrl_ofc_cd,    \n");
		...
		suQueryStr01.append("   AND b.finc_ctrl_ofc_cd = g.OFC_CD(+)  \n");
		suQueryStr01.append("   AND NVL(g.delt_flg, 'N') = 'N'  \n");
		suQueryStr01.append("   AND bb.finc_ctrl_ofc_cd = gg.OFC_CD(+)  \n");
		...
		suQueryStr02.append("       DECODE(a.vsl_pre_pst_cd, 'U', b.finc_ctrl_ofc_cd, bb.finc_ctrl_ofc_cd) finc_ctrl_ofc_cd,   \n");
		...
		suQueryStr02.append("   AND b.finc_ctrl_ofc_cd = g.OFC_CD(+) \n");
		suQueryStr02.append("   AND NVL(g.delt_flg, 'N') = 'N' \n");
		suQueryStr02.append("   AND bb.finc_ctrl_ofc_cd = gg.OFC_CD(+) \n");
	...
	public HashMap searchBKGQTYInfo(HashMap bkgMap) throws DAOException
	{
		...
		// Booking QTY 조회 쿼리
		queryStr.append("    SELECT \n");
		queryStr.append("           NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', 0, OP_CNTR_QTY), 0)), 0) AS TEU, \n");
		queryStr.append("           NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', 0, DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', 0, OP_CNTR_QTY))), 0) AS FEU, \n");
		queryStr.append("           NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', OP_CNTR_QTY, 0)), 0)                                             AS REU, \n");
		queryStr.append("           NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', OP_CNTR_QTY, 0), 0)), 0) AS RTEU, \n");
		queryStr.append("           NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', 0, OP_CNTR_QTY), 0)), 0) AS RFEU, \n");
		queryStr.append("           NVL(SUM(OP_CNTR_QTY), 0) AS BOX \n");
...
//				return bkgMap;
	...
	public void createBKGMasterInfo(HashMap bkgMap) throws DAOException {
		...
		mergeQuery01.append("                                                   AND QTY.CNTR_TPSZ_CD \n");
		mergeQuery01.append("                                                NOT IN \n");
		mergeQuery01.append("                                                     ( \n");
		mergeQuery01.append("                                                       'Q2','Q4' \n");
		mergeQuery01.append("                                                     ) \n");
		mergeQuery01.append("                                          ) \n");
		...
		mergeQuery02.append("                      CUR.BKG_VOL_QTY, \n");
		mergeQuery02.append("                      CUR.BKG_REV, \n");
		mergeQuery02.append("                      CUR.BKG_OFT_REV, \n");
		...
		mergeQuery02.append("                           WHERE BKG_NO = ? \n");
		mergeQuery02.append("                    ) PRE \n");
		mergeQuery02.append("           FULL OUTER \n");
		mergeQuery02.append("                 JOIN \n");
		mergeQuery02.append("                    ( \n");
		mergeQuery02.append("                          SELECT \n");
		mergeQuery02.append("                                 QTY.BKG_NO, \n");
		mergeQuery02.append("                                 QTY.CNTR_TPSZ_CD, \n");
		mergeQuery02.append("                                 SUM (OP_CNTR_QTY) AS BKG_VOL_QTY, \n");
		mergeQuery02.append("                                 MAX (REV.BKG_REV) AS BKG_REV, \n");
		mergeQuery02.append("                                 MAX (REV.BKG_OFT_REV) AS BKG_OFT_REV \n");
		mergeQuery02.append("                            FROM BKG_QTY_DTL QTY, \n");
		mergeQuery02.append("                               ( \n");
		mergeQuery02.append("                                     SELECT \n");
		mergeQuery02.append("                                            QTY.CNTR_TPSZ_CD, \n");
		mergeQuery02.append("                                            SUM (DECODE (CHG.CHG_CD, 'OFT', 0, REV.CHG_AMT* XCH.USD_LOCL_XCH_RT)) \n");
		mergeQuery02.append("                                          + NVL (SUM (0), 0) \n");
		mergeQuery02.append("                                          + NVL (SUM (0), 0) \n");
		mergeQuery02.append("                                          + SUM (DECODE (REV.CHG_CD, 'OFT', REV.CHG_AMT * XCH.USD_LOCL_XCH_RT, 0)) \n");
		mergeQuery02.append("                                          + \n");
		mergeQuery02.append("                                          ( \n");
		mergeQuery02.append("                                          ( DECODE (SUBSTR (QTY.CNTR_TPSZ_CD,2,1), '2', MAX (TSA.TEU_REV_AMT), MAX (TSA.FEU_REV_AMT)) \n");
		mergeQuery02.append("                                          + MAX (BLA.BL_REV_AMT) \n");
		mergeQuery02.append("                                          ) \n");
		mergeQuery02.append("                                          * DECODE (MAX (EUR.TPSZ_RATE), 0, MAX (ALR.TPSZ_TOTAL), 0, MAX (EUR.TPSZ_RATE) / MAX (ALR.TPSZ_TOTAL)) \n");
		mergeQuery02.append("                                          ) AS BKG_REV, \n");
		mergeQuery02.append("                                            SUM (DECODE (REV.CHG_CD, 'OFT', REV.CHG_AMT * XCH.USD_LOCL_XCH_RT, 0)) AS BKG_OFT_REV \n");
		mergeQuery02.append("                                       FROM BKG_CHG_RT    REV, \n");
		mergeQuery02.append("                                            MDM_CHARGE    CHG, \n");
		mergeQuery02.append("                                            BKG_QTY_DTL   QTY, \n");
		mergeQuery02.append("                                            GL_MON_XCH_RT XCH, \n");
		mergeQuery02.append("                                          ( \n");
		mergeQuery02.append("                                                SELECT \n");
		mergeQuery02.append("                                                       NVL (SUM (DECODE (REV.RAT_UT_CD, '20', SUM (DECODE (REV.CHG_CD, 'OFT', 0, REV.CHG_AMT * XCH.USD_LOCL_XCH_RT)), 0)), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (DECODE (REV.RAT_UT_CD, '20', SUM (DECODE (REV.CHG_CD, 'OFT', REV.CHG_AMT * XCH.USD_LOCL_XCH_RT, 0)), 0)), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (DECODE (REV.RAT_UT_CD, '20', SUM (0), 0)), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (DECODE (REV.RAT_UT_CD, '20', SUM (0), 0)), 0) AS TEU_REV_AMT, \n");
		mergeQuery02.append("                                                       NVL (SUM (DECODE (REV.RAT_UT_CD, '20', SUM (DECODE (REV.CHG_CD, 'OFT', REV.CHG_AMT * XCH.USD_LOCL_XCH_RT, 0)), 0)), 0)     AS TEU_OFT_AMT, \n");
		mergeQuery02.append("                                                       NVL (SUM (DECODE (REV.RAT_UT_CD, '20', 0, SUM (DECODE (REV.CHG_CD, 'OFT', 0, REV.CHG_AMT*USD_LOCL_XCH_RT)))), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (DECODE (REV.RAT_UT_CD, '20', 0, SUM (DECODE (REV.CHG_CD, 'OFT', REV.CHG_AMT * XCH.USD_LOCL_XCH_RT, 0)))), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (DECODE (REV.RAT_UT_CD, '20', 0, SUM (0))), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (DECODE (REV.RAT_UT_CD, '20', 0, SUM (0))), 0)  AS FEU_REV_AMT, \n");
		mergeQuery02.append("                                                       NVL (SUM (DECODE (REV.RAT_UT_CD, '20', 0, SUM (DECODE (REV.CHG_CD, 'OFT', REV.CHG_AMT * XCH.USD_LOCL_XCH_RT, 0)))), 0)      AS FEU_OFT_AMT \n");
		mergeQuery02.append("                                                  FROM BKG_CHG_RT    REV, \n");
		mergeQuery02.append("                                                       MDM_CHARGE    CHG, \n");
		mergeQuery02.append("                                                       GL_MON_XCH_RT XCH \n");
		mergeQuery02.append("                                                 WHERE REV.BKG_NO                   = ? \n");
		mergeQuery02.append("                                                   AND REV.CHG_CD                   = CHG.CHG_CD \n");
		mergeQuery02.append("                                                   AND REV.RAT_UT_CD \n");
		mergeQuery02.append("                                                    IN \n");
		mergeQuery02.append("                                                     ( \n");
		mergeQuery02.append("                                                       '20', '40', '45' \n");
		mergeQuery02.append("                                                     ) \n");
		mergeQuery02.append("                                                   AND TO_CHAR(REV.CRE_DT,'YYYYMM') = XCH.ACCT_XCH_RT_YRMON \n");
		mergeQuery02.append("                                                   AND REV.CURR_CD                  = XCH.CURR_CD \n");
		mergeQuery02.append("                                              GROUP BY RAT_UT_CD \n");
		mergeQuery02.append("                                          ) TSA, \n");
		mergeQuery02.append("                                          ( \n");
		mergeQuery02.append("                                                SELECT \n");
		mergeQuery02.append("                                                       NVL (SUM (DECODE(REV.CHG_CD, 'OFT', 0, REV.CHG_AMT * XCH.USD_LOCL_XCH_RT)), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (DECODE (REV.CHG_CD, 'OFT', REV.CHG_AMT * XCH.USD_LOCL_XCH_RT, 0)), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (0), 0) \n");
		mergeQuery02.append("                                                     + NVL (SUM (0), 0) AS BL_REV_AMT \n");
		mergeQuery02.append("                                                  FROM BKG_CHG_RT    REV, \n");
		mergeQuery02.append("                                                       MDM_CHARGE    CHG, \n");
		mergeQuery02.append("                                                       GL_MON_XCH_RT XCH \n");
		mergeQuery02.append("                                                 WHERE REV.BKG_NO    = ? \n");
		...
		mergeQuery02.append("                                                     ( \n");
		mergeQuery02.append("                                                           SELECT '20' FROM DUAL UNION ALL \n");
		mergeQuery02.append("                                                           SELECT '40' FROM DUAL UNION ALL \n");
		mergeQuery02.append("                                                           SELECT '45' FROM DUAL UNION ALL \n");
		mergeQuery02.append("                                                           SELECT \n");
		mergeQuery02.append("                                                                  CNTR_TPSZ_CD \n");
		mergeQuery02.append("                                                             FROM BKG_QTY_DTL \n");
		mergeQuery02.append("                                                            WHERE BKG_NO = ? \n");
		mergeQuery02.append("                                                     ) \n");
		mergeQuery02.append("                                                   AND TO_CHAR (REV.CRE_DT, 'YYYYMM') = XCH.ACCT_XCH_RT_YRMON \n");
		mergeQuery02.append("                                                   AND REV.CURR_CD                    = XCH.CURR_CD \n");
		mergeQuery02.append("                                          ) BLA, \n");
		mergeQuery02.append("                                          ( \n");
		mergeQuery02.append("                                                SELECT \n");
		mergeQuery02.append("                                                       CNTR_TPSZ_CD, \n");
		mergeQuery02.append("                                                       SUM (DECODE (SUBSTR (CNTR_TPSZ_CD,2,1), '2', OP_CNTR_QTY, OP_CNTR_QTY*2)) AS TPSZ_RATE \n");
		mergeQuery02.append("                                                  FROM BKG_QTY_DTL \n");
		mergeQuery02.append("                                                 WHERE BKG_NO = ? \n");
		mergeQuery02.append("                                              GROUP BY BKG_NO, \n");
		mergeQuery02.append("                                                       CNTR_TPSZ_CD \n");
		mergeQuery02.append("                                          ) EUR, \n");
		mergeQuery02.append("                                          ( \n");
		mergeQuery02.append("                                                SELECT \n");
		mergeQuery02.append("                                                       SUM (DECODE (SUBSTR (CNTR_TPSZ_CD,2,1), '2', OP_CNTR_QTY, OP_CNTR_QTY*2)) AS TPSZ_TOTAL \n");
		mergeQuery02.append("                                                  FROM BKG_QTY_DTL \n");
		mergeQuery02.append("                                                 WHERE BKG_NO = ? \n");
		mergeQuery02.append("                                              GROUP BY BKG_NO \n");
		mergeQuery02.append("                                          ) ALR \n");
		mergeQuery02.append("                                      WHERE REV.BKG_NO                    = ? \n");
		mergeQuery02.append("                                        AND REV.CHG_CD                    = CHG.CHG_CD \n");
		mergeQuery02.append("                                        AND REV.BKG_NO                    = QTY.BKG_NO \n");
		mergeQuery02.append("                                        AND TO_CHAR(REV.CRE_DT, 'YYYYMM') = XCH.ACCT_XCH_RT_YRMON \n");
		mergeQuery02.append("                                        AND XCH.ACCT_XCH_RT_LVL           = '1' \n");
		mergeQuery02.append("                                        AND REV.CURR_CD                   = XCH.CURR_CD \n");
		mergeQuery02.append("                                        AND REV.RAT_UT_CD                 = QTY.CNTR_TPSZ_CD \n");
		mergeQuery02.append("                                        AND REV.RAT_UT_CD                 = EUR.CNTR_TPSZ_CD (+) \n");
		mergeQuery02.append("                                   GROUP BY REV.RAT_UT_CD, \n");
		mergeQuery02.append("                                            QTY.CNTR_TPSZ_CD \n");
		mergeQuery02.append("                               ) REV \n");
		mergeQuery02.append("                           WHERE QTY.BKG_NO       = ? \n");
		mergeQuery02.append("                             AND QTY.CNTR_TPSZ_CD = REV.CNTR_TPSZ_CD (+) \n");
		mergeQuery02.append("                        GROUP BY QTY.BKG_NO, \n");
		mergeQuery02.append("                                 QTY.CNTR_TPSZ_CD \n");
		...
		mergeQuery03.append("                             AND QTY.CNTR_TPSZ_CD \n");
		mergeQuery03.append("                          NOT IN \n");
		mergeQuery03.append("                               ( \n");
		mergeQuery03.append("                                 'Q2','Q4' \n");
		mergeQuery03.append("                               ) \n");
		mergeQuery03.append("                    ) \n");
		...
		mergeQuery03.append("           --;)----------------------------------------------------------------------------------------------- \n");
		mergeQuery03.append("           --;) POR, POL, POD, DEL의 정보를 서로 다른 경우의 수 256개(4^4,4의 네제곱)의 배열로 생성한다. \n");
		mergeQuery03.append("           --;) \n");
		mergeQuery03.append("           --;)----------------------------------------------------------------------------------------------- \n");
		mergeQuery03.append("                 CASE MOD (CEIL (ROWNUM/64)+256, 4) \n");
		mergeQuery03.append("                 WHEN 1 THEN '*' \n");
		mergeQuery03.append("                 WHEN 2 THEN POR.CNT_CD \n");
		mergeQuery03.append("                 WHEN 3 THEN POR.RGN_CD \n");
		mergeQuery03.append("                 ELSE POR.LOC_CD \n");
		mergeQuery03.append("                  END                                AS POR_DEF_CD, \n");
		mergeQuery03.append("                 CASE MOD (CEIL (ROWNUM/16)+256, 4) \n");
		mergeQuery03.append("                 WHEN 1 THEN '*' \n");
		mergeQuery03.append("                 WHEN 2 THEN POL.CNT_CD \n");
		mergeQuery03.append("                 WHEN 3 THEN POL.RGN_CD \n");
		mergeQuery03.append("                 ELSE POL.LOC_CD \n");
		mergeQuery03.append("                  END                                AS POL_DEF_CD, \n");
		mergeQuery03.append("                 CASE MOD (CEIL (ROWNUM/4 )+256, 4) \n");
		mergeQuery03.append("                 WHEN 1 THEN '*' \n");
		mergeQuery03.append("                 WHEN 2 THEN POD.CNT_CD \n");
		mergeQuery03.append("                 WHEN 3 THEN POD.RGN_CD \n");
		mergeQuery03.append("                 ELSE POD.LOC_CD \n");
		mergeQuery03.append("                  END                                AS POD_DEF_CD, \n");
		mergeQuery03.append("                 CASE MOD (ROWNUM+256, 4) \n");
		mergeQuery03.append("                 WHEN 1 THEN '*' \n");
		mergeQuery03.append("                 WHEN 2 THEN DEL.CNT_CD \n");
		mergeQuery03.append("                 WHEN 3 THEN DEL.RGN_CD \n");
		mergeQuery03.append("                 ELSE DEL.LOC_CD \n");
		mergeQuery03.append("                  END                                AS DEL_DEF_CD, \n");
		mergeQuery03.append("                 CASE \n");
		...
		mergeQuery03.append("                      ALL_OBJECTS    ODR \n");
		mergeQuery03.append("                WHERE BKG.BKG_NO     = RAT.BKG_NO \n");
		mergeQuery03.append("                  AND ROWNUM        <= 256 \n");
		...
		mergeQuery03.append("                  AND BKG.BKG_NO     = ? \n");
		mergeQuery03.append("           --------------------------------------------------------------------------------------------------------------------- \n");
		...
		mergeQuery03.append("                    ( \n");
		mergeQuery03.append("                 CASE \n");
		mergeQuery03.append("                 WHEN PRF.CHG_CD      = 'CFR' \n");
		mergeQuery03.append("                  AND ARR.RCV_TERM_CD = 'S' \n");
		mergeQuery03.append("                 THEN 'CFR' \n");
		mergeQuery03.append("                 WHEN PRF.CHG_CD      = 'CFD' \n");
		mergeQuery03.append("                  AND ARR.DE_TERM_CD  = 'S' \n");
		mergeQuery03.append("                 THEN 'CFD' \n");
		mergeQuery03.append("                 WHEN PRF.CHG_CD      = 'CFR' \n");
		mergeQuery03.append("                 THEN '*' \n");
		mergeQuery03.append("                 WHEN PRF.CHG_CD      = 'CFD' \n");
		mergeQuery03.append("                 THEN '*' \n");
...
//				}
			...
			if(bl_no.length() > 0) {
				...
				queryStr02.append("      WHEN BKG.BL_NO_TP <> '0' \n");
		...
		try {
			...
			if("BA".equals(brog_div_cd)) {
				...
				if( brog_rf_rt != 0 ) { // reu rate가 존재할 경우
					...
					queryStr.append("SELECT \n");
					queryStr.append("       NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', 0, OP_CNTR_QTY), 0)), 0) BROG_TEU_QTY, \n");
					queryStr.append("       NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', 0, DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', 0, OP_CNTR_QTY))), 0) BROG_FEU_QTY \n");
					queryStr.append("  FROM BKG_QUANTITY \n");
					queryStr.append(" WHERE BKG_NO \n");
					queryStr.append("        IN \n");
					queryStr.append("         ( \n");
					...
					queryStr.append("SELECT \n");
					queryStr.append("       NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', OP_CNTR_QTY, 0)), 0) BROG_TEU_QTY, \n");
					queryStr.append("       NVL(SUM(DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), '2', 0, OP_CNTR_QTY)), 0) BROG_FEU_QTY \n");
					queryStr.append("  FROM BKG_QUANTITY \n");
					queryStr.append(" WHERE BKG_NO \n");
					queryStr.append("        IN \n");
					queryStr.append("         ( \n");
	...
	public HashMap createBRKGTPSZCommInfo(HashMap bkgMap) throws DAOException {
		...
		try {
			...
			if("B".equals(brog_div_cd_1)) { // BL인 경우 
				...
				insertQuery.append("                 ELSE \n");
				insertQuery.append("                      CASE \n");
				insertQuery.append("                      WHEN SUBSTR (REV.BKG_VOL_QTY, 2, 1) = '2' \n");
...
//				insertQuery.append("                    ) AMT \n");
	...
	private HashMap<String, Serializable> getCustomer( Connection con, HashMap bkgMap) throws SQLException, Exception {
		...
		query.append("                             AND MCS.CNTR_CUST_TP_CD   = 'N' \n");
		query.append("                             AND ROWNUM                   = 1 \n");
...
//			this.createLog("===== ERROR AGT Actual - BKG_NO : "+ bkg_no +", BKG_NO_SPLIT : "+ bkg_no_split +", COMM_PROC_RSLT_RSN : "+ comm_proc_rslt_rsn);
	...
	private void createZeroSumComm ( Connection con, HashMap bkgMap) throws SQLException, Exception
	{
		...
		deleteQuery01.append("                   IN \n");
		deleteQuery01.append("                    ( \n");
		deleteQuery01.append("                      'CE', 'CS', 'CA', 'IC' \n");
		deleteQuery01.append("                    ) \n");
		...
		deleteQuery02.append("                   IN \n");
		deleteQuery02.append("                    ( \n");
		deleteQuery02.append("                      'CE', 'CS', 'CA', 'IC' \n");
		deleteQuery02.append("                    ) \n");
		...
		deleteQuery03.append("                   IN \n");
		deleteQuery03.append("                    ( \n");
		deleteQuery03.append("                      'CE', 'CS', 'CA', 'IC' \n");
		deleteQuery03.append("                    ) \n");
		...
		deleteQuery04.append("           'CE','CS','CA','IC' \n");
		deleteQuery04.append("         ) \n");
		...
		deleteQuery05.append("                   IN \n");
		deleteQuery05.append("                    ( \n");
		deleteQuery05.append("                      'CE', 'CS', 'CA', 'IC' \n");
		deleteQuery05.append("                    ) \n");
		...
		deleteQuery06.append("                   IN \n");
		deleteQuery06.append("                    ( \n");
		deleteQuery06.append("                      'CE', 'CS', 'CA', 'IC' \n");
		deleteQuery06.append("                    ) \n");
		...
		deleteQuery07.append("           'CE', 'CS', 'CA', 'IC' \n");
		deleteQuery07.append("         ) \n");
		...
		mergeQuery01.append("                                        ( \n");
		mergeQuery01.append("                                     CASE \n");
		mergeQuery01.append("                                     WHEN BKG.BL_NO_TP <> '0' \n");
		mergeQuery01.append("                                     THEN BK2.BL_NO_TP \n");
		mergeQuery01.append("                                     ELSE '0' \n");
		mergeQuery01.append("                                      END \n");
		mergeQuery01.append("                                        ) \n");
		...
		mergeQuery01.append("                            AND \n");
		mergeQuery01.append("                              ( \n");
		mergeQuery01.append("                              ( QTY.CNTR_TPSZ_CD NOT IN ('Q2','Q4') \n");
		mergeQuery01.append("                            AND AGN.AC_TP_CD = 'H' \n");
		mergeQuery01.append("                              ) \n");
		mergeQuery01.append("                             OR \n");
		mergeQuery01.append("                              ( QTY.CNTR_TPSZ_CD = QTY.CNTR_TPSZ_CD \n");
		mergeQuery01.append("                            AND AGN.AC_TP_CD <> 'H' \n");
		mergeQuery01.append("                              ) \n");
		mergeQuery01.append("                              ) \n");
		mergeQuery01.append("                       GROUP BY AGN.BKG_NO, \n");
		...
		mergeQuery02.append("                                        ( \n");
		mergeQuery02.append("                                     CASE \n");
		mergeQuery02.append("                                     WHEN BKG.BL_NO_TP <> '0' \n");
		mergeQuery02.append("                                     THEN BK2.BL_NO_TP \n");
		mergeQuery02.append("                                     ELSE '0' \n");
...
//				mergePs02.executeUpdate();
	...
	private void createBKGMaster( Connection con, HashMap bkgMap) throws SQLException, Exception
	{
		...
		query.append("                                                              AND QTY.CNTR_TPSZ_CD \n");
		query.append("                                                           NOT IN \n");
		query.append("                                                                ( \n");
		query.append("                                                                  'Q2','Q4' \n");
		query.append("                                                                ) \n");
		...
		query.append("                      TBL.REV_VVD_CD         = PSD.REV_VVD_CD, \n");
