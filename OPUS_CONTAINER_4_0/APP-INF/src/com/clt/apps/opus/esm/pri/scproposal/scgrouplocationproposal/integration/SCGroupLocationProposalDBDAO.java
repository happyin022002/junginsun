...
/**
 *  SCGroupLocationProposalDBDAO <br>
...
public class SCGroupLocationProposalDBDAO extends DBDAOSupport {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<RsltGrpLocDtlListVO> searchGroupLocationDetailHistoryList (PriSpScpGrpLocDtlVO priSpScpGrpLocDtlVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltGrpLocDtlListVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<RsltGrpLocListVO> searchGroupLocationHistoryList (PriSpScpGrpLocVO priSpScpGrpLocVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltGrpLocListVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
