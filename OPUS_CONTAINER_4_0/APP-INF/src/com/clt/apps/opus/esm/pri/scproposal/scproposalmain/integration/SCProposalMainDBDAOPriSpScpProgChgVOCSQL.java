...
*@FileName : SCProposalMainDBDAOPriSpScpProgChgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAOPriSpScpProgChgVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAOPriSpScpProgChgVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAOPriSpScpProgChgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT NVL(MAX(PROP_SCP_PROG_SEQ)+1,1) FROM PRI_SP_SCP_PROG" ).append("\n"); 
		...
		query.append("PRI_SP_SCP_PROG  A" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT MAX(PROP_SCP_PROG_SEQ) FROM PRI_SP_SCP_PROG" ).append("\n"); 
		query.append("WHERE PROP_NO = A.PROP_NO" ).append("\n"); 
		query.append("AND AMDT_SEQ = A.AMDT_SEQ" ).append("\n"); 
		query.append("AND SVC_SCP_CD = A.SVC_SCP_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
