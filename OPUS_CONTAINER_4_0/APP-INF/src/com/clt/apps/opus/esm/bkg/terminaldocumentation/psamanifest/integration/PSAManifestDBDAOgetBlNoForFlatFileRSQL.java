...
*@FileName : PSAManifestDBDAOgetBlNoForFlatFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOgetBlNoForFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSAManifestDBDAOgetBlNoForFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOgetBlNoForFlatFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
