...
public class VietnamCustomsTransmissionDBDAOAddCUSCARSndLogCSQL implements ISQLTemplate{
	...
	public VietnamCustomsTransmissionDBDAOAddCUSCARSndLogCSQL(){
		...
		params.put("to_skd_dir_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("to_vsl_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("to_skd_voy_no",new String[]{arrTmp[0],arrTmp[1]});
