...
public class ESM_BKG_1171HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1171HTMLAction 객체를 생성
	 */
	public ESM_BKG_1171HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1171Event event = new EsmBkg1171Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setVesselArrivalDetailVO((Eur24VesselFIArrivalNoticeDetailVO)getVO(request, Eur24VesselFIArrivalNoticeDetailVO.class));
		} 
			...
			Eur24VesselFIArrivalNoticeDetailVO[] vesselArrivalDetailVOs = (Eur24VesselFIArrivalNoticeDetailVO[])getVOs(request, Eur24VesselFIArrivalNoticeDetailVO.class, "");
			event.setVesselArrivalDetailVOS((Eur24VesselFIArrivalNoticeDetailVO[])vesselArrivalDetailVOs);
		}
