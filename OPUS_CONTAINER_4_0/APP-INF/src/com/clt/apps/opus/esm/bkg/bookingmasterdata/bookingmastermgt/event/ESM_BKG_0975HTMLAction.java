...
*@FileName : ESM_BKG_0975HTMLAction.java
...
public class ESM_BKG_0975HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0975HTMLAction 객체를 생성
	 */
	public ESM_BKG_0975HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("[START:: perform ESM_BKG_0975HTMLAction  ]=========="+request.getParameter("pagerows"));

    	FormCommand command = FormCommand.fromRequest(request);
		EsmBkg0975Event event = new EsmBkg0975Event();
		...
		log.debug("[END:: perform ESM_BKG_0975HTMLAction  ]==========");
