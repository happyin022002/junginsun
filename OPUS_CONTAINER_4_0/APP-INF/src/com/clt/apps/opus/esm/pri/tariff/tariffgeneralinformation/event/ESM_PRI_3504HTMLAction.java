...
*@FileName : ESM_PRI_3504HTMLAction.java
...
public class ESM_PRI_3504HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3504HTMLAction 객체를 생성
	 */
	public ESM_PRI_3504HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3504Event event = new EsmPri3504Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) { 
			event.setPriTrfBzcHistoryVO((PriTrfBzcHistoryVO)getVO(request, PriTrfBzcHistoryVO .class));
		}else if(command.isCommand(FormCommand.SEARCH02)) { 
			event.setPriTrfBzcHistoryAmendVO((PriTrfBzcHistoryAmendVO)getVO(request, PriTrfBzcHistoryAmendVO .class));
