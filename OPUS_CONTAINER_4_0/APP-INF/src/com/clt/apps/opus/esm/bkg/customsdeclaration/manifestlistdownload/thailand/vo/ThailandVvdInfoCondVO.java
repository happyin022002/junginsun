...
*@FileName : ThailandVvdInfoCondVO.java
*@FileTitle : ThailandVvdInfoCondVO
*Open Issues :
*Change history :
...
public class ThailandVvdInfoCondVO extends CstmsVvdInfoCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<ThailandVvdInfoCondVO> models = new ArrayList<ThailandVvdInfoCondVO>();
	...
	public ThailandVvdInfoCondVO() {}

	public ThailandVvdInfoCondVO(String ibflag, String pagerows, String trnkVvd, String feeder, String polCd, String podCd, String etaDt, String subtotal, String sVvd, String sDelCd, String sDelNodCd, String sPolCd) {
		this.podCd = podCd;
...
/**
	 ...
	 */
	public ThailandVvdInfoCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 */
	public ThailandVvdInfoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ThailandVvdInfoCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ThailandVvdInfoCondVO();
				if (podCd[i] != null)
		...
		return getThailandVvdInfoCondVOs();
	}
	 ...
	 * @return ThailandVvdInfoCondVO[]
	 */
	public ThailandVvdInfoCondVO[] getThailandVvdInfoCondVOs(){
		ThailandVvdInfoCondVO[] vos = (ThailandVvdInfoCondVO[])models.toArray(new ThailandVvdInfoCondVO[models.size()]);
		return vos;
	}
