...
*@FileName : JapanTerminalTransmissionDBDAOremoveVesselListJpBlUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class JapanTerminalTransmissionDBDAOremoveVesselListJpBlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_TML_EDI_JP_BL 에서 Delete flg 찍음
	  * </pre>
	  */
	public JapanTerminalTransmissionDBDAOremoveVesselListJpBlUSQL(){
		setQuery();
		...
		query.append("FileName : JapanTerminalTransmissionDBDAOremoveVesselListJpBlUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_TML_EDI_JP_BL " ).append("\n");
