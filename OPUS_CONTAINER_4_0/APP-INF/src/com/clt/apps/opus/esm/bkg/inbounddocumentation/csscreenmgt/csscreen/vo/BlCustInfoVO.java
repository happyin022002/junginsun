...
*@FileName : BlCustInfoVO.java
*@FileTitle : BlCustInfoVO
*Open Issues :
*Change history :
...
public class BlCustInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BlCustInfoVO> models = new ArrayList<BlCustInfoVO>();
	...
	public BlCustInfoVO(String ibflag, String pagerows, String bkgCustTpCd, String custCd, String custNm, String podCd, String delCd, String custCntCd, String custSeq, String custAddr,String pkupYdCd) {
		this.podCd = podCd;
		this.ibflag = ibflag;
		this.custNm = custNm;
		this.custCd = custCd;
	 ...
	 * @return BlCustInfoVO[]
	 */
	public BlCustInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BlCustInfoVO[]
	 */
	public BlCustInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BlCustInfoVO model = null;
	 ...
	 * @return BlCustInfoVO[]
	 */
	public BlCustInfoVO[] getBlCustInfoVOs(){
		BlCustInfoVO[] vos = (BlCustInfoVO[])models.toArray(new BlCustInfoVO[models.size()]);
		return vos;
	}
