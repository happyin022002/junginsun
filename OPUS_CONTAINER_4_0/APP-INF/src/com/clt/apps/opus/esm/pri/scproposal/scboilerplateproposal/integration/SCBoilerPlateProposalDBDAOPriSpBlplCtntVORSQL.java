...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCtntVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_blpl_ctnt select
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCtntVORSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
