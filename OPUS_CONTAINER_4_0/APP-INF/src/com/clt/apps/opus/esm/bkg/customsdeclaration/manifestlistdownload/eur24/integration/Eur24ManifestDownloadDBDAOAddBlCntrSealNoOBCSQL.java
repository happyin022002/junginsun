...
*@FileName : Eur24ManifestDownloadDBDAOAddBlCntrSealNoOBCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBlCntrSealNoOBCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBlCntrSealNoOBCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBlCntrSealNoOBCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("BKG_CSTMS_EUR_IO_SEAL_NO" ).append("\n"); 
		query.append("(   BND_TP_CD,  VSL_CD,     SKD_VOY_NO,     SKD_DIR_CD," ).append("\n"); 
		...
		query.append("'O',    SUBSTR(@[vvd], 1, 4),   SUBSTR(@[vvd], 5, 4),   SUBSTR(@[vvd], 9, 1)," ).append("\n"); 
		query.append("@[bl_no],             @[cstms_port_cd],       @[cntr_no]," ).append("\n"); 
		query.append("@[seal_no],       	@[seal_pty_tp_cd],      @[seal_pty_nm]," ).append("\n"); 
