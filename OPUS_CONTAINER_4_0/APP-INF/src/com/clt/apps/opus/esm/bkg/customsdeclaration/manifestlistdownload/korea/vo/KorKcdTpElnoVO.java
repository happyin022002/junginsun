...
*@FileName : KorKcdTpElnoVO.java
*@FileTitle : KorKcdTpElnoVO
*Open Issues :
*Change history :
...
public class KorKcdTpElnoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorKcdTpElnoVO> models = new ArrayList<KorKcdTpElnoVO>();
	...
	public KorKcdTpElnoVO() {}

	public KorKcdTpElnoVO(String ibflag, String pagerows, String oldCstmsDeclTpCd, String msnNo, String bkgNo, String blNo, String cstmsDeclTpCd, String portCd, String trnsSeq, String usrId) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return KorKcdTpCntrVO[]
	 */
	public KorKcdTpElnoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorKcdTpCntrVO[]
	 */
	public KorKcdTpElnoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorKcdTpElnoVO model = null;
	 ...
	 * @return KorKcdTpCntrVO[]
	 */
	public KorKcdTpElnoVO[] getKorKcdTpCntrVOs(){
		KorKcdTpElnoVO[] vos = (KorKcdTpElnoVO[])models.toArray(new KorKcdTpElnoVO[models.size()]);
		return vos;
	}
