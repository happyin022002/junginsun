...
*@FileName : MonthlyQuotaAdjustmentRHQDBDAOModifySaqMonQtaStepVerStatus0075RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentRHQDBDAOModifySaqMonQtaStepVerStatus0075RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentRHQDBDAOModifySaqMonQtaStepVerStatus0075RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentRHQDBDAOModifySaqMonQtaStepVerStatus0075RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,DRFT_CFM_GDT  = GLOBALDATE_PKG.TIME_CONV_OFC_FNC( COM_ConstantMgr_PKG.COM_getHeadOfficeCode_FNC() ,SYSDATE, 'GMT' )	--하드코딩 펑션으로 수정" ).append("\n"); 
		...
		query.append("AND    SAQ_STS_CD LIKE @[saq_sts_cd]||'%'" ).append("\n"); 
