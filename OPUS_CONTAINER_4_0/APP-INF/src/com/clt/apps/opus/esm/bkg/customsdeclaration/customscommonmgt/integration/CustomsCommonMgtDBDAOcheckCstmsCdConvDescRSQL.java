...
*@FileName : CustomsCommonMgtDBDAOcheckCstmsCdConvDescRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomsCommonMgtDBDAOcheckCstmsCdConvDescRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * checkCstmsCdConvDesc
	  * </pre>
	  */
	public CustomsCommonMgtDBDAOcheckCstmsCdConvDescRSQL(){
		setQuery();
		...
		query.append("FileName : CustomsCommonMgtDBDAOcheckCstmsCdConvDescRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
