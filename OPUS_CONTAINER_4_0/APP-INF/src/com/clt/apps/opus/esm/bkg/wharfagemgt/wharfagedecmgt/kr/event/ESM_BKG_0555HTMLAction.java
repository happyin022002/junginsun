 ...
 *@FileName : ESM_BKG_0555HTMLAction.java
 *@FileTitle : ESM_BKG_0555HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_0555HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0555HTMLAction 객체를 생성
	 */
	public ESM_BKG_0555HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0555Event event = new EsmBkg0555Event();

		if (command.isCommand(FormCommand.SEARCH)) {

			event.setKrWhfChgListCondVO( (KrWhfChgListCondVO)getVO(request, KrWhfChgListCondVO.class) );  
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setKrBkgWhfCfmVO( (KrBkgWhfCfmVO)getVO(request, KrBkgWhfCfmVO.class) );  
		}
