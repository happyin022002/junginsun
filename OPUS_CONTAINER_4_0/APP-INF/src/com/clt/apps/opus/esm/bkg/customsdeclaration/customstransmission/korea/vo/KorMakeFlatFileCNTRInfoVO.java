...
*@FileName : KorMakeFlatFileCNTRInfoVO.java
*@FileTitle : KorMakeFlatFileCNTRInfoVO
*Open Issues :
*Change history :
...
public class KorMakeFlatFileCNTRInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorMakeFlatFileCNTRInfoVO> models = new ArrayList<KorMakeFlatFileCNTRInfoVO>();
	...
	public KorMakeFlatFileCNTRInfoVO() {}

	public KorMakeFlatFileCNTRInfoVO(String ibflag, String pagerows, String cntrData, String bkgNo, String kcdTp, String ktPort) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
		this.kcdTp = kcdTp;
		this.ktPort = ktPort;
	 ...
	 * @param request
	 * @return KorMakeFlatFileCNTRInfoVO[]
	 */
	public KorMakeFlatFileCNTRInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMakeFlatFileCNTRInfoVO[]
	 */
	public KorMakeFlatFileCNTRInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMakeFlatFileCNTRInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new KorMakeFlatFileCNTRInfoVO();
				if (bkgNo[i] != null)
		...
		return getKorMakeFlatFileCNTRInfoVOs();
	}
	 ...
	 * @return KorMakeFlatFileCNTRInfoVO[]
	 */
	public KorMakeFlatFileCNTRInfoVO[] getKorMakeFlatFileCNTRInfoVOs(){
		KorMakeFlatFileCNTRInfoVO[] vos = (KorMakeFlatFileCNTRInfoVO[])models.toArray(new KorMakeFlatFileCNTRInfoVO[models.size()]);
		return vos;
	}
