...
import com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharterioinvoice.event.EsmFmsVMS0010001Event;
import com.clt.framework.component.message.ErrorHandler;
import com.clt.framework.core.layer.event.Event;
import com.clt.framework.core.layer.event.EventException;
import com.clt.framework.core.layer.event.EventResponse;
import com.clt.framework.support.controller.html.FormCommand;
import com.clt.irep.vms.VMS0010001Document;
import com.clt.irep.vms.VMS0010001Document.VMS0010001;
...
@WebService(name="TCharterIOInvoiceVMS0010001WSProxyPortType", serviceName="TCharterIOInvoiceVMS0010001WSProxy", targetNamespace="http://www.clt.com/integration/opus")
@SOAPBinding(style=SOAPBinding.Style.DOCUMENT,use=SOAPBinding.Use.LITERAL, parameterStyle=SOAPBinding.ParameterStyle.WRAPPED)
@WLHttpTransport(contextPath="/opuscntr/webservices", serviceUri="/TCharterIOInvoiceVMS0010001WSProxy", portName="TCharterIOInvoiceVMS0010001WSProxyPort")
