...
*@FileName : RFAProposalMainDBDAORsltPropMnScpListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAORsltPropMnScpListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAProposalMainDBDAORsltPropMnScpListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAORsltPropMnScpListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,DECODE (MN.PROP_SCP_SREP_CD, @[srep_cd], 'Y', 'N') REQ_USR_FLG" ).append("\n"); 
		query.append("      ,DECODE (AUTH.USR_ID, '', 'N', 'Y') APRO_USR_FLG" ).append("\n"); 
		...
		query.append("	  ,NVL((SELECT 'Y' FROM PRI_RP_SCP_MN A " ).append("\n"); 
		...
		query.append("AND AUTH.PRC_CTRT_TP_CD(+) = 'R'" ).append("\n"); 
