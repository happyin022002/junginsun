...
public class SCNoteConversionProposalDBDAOPriSpScpRtCnoteVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,FIRST_VALUE(DECODE(NOTE_CLSS_CD, 'G', 1, 'S', 2, 'D', 3, 'O', 4, 99)) OVER(PARTITION BY PROP_NO, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, CMDT_NOTE_SEQ ORDER BY AMDT_SEQ) AS N1ST_ORD_REF" ).append("\n"); 
