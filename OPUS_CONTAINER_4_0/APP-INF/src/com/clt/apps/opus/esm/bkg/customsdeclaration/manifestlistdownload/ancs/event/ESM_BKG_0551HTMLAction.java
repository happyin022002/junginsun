 ...
 *@FileName : ESM_BKG_0551HTMLAction.java
...
public class ESM_BKG_0551HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0551HTMLAction 객체를 생성
	 */
	public ESM_BKG_0551HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0551Event event = new EsmBkg0551Event();

		if (command.isCommand(FormCommand.SEARCH)||command.isCommand(FormCommand.MULTI05))
		{
			event.setAncsCstmsVvdListCondVO( (AncsCstmsVvdListCondVO)getVO(request, AncsCstmsVvdListCondVO.class) );  
		}
		else if (command.isCommand(FormCommand.SEARCH01))
		{
			event.setAncsCstmsVvdDtlListCondVO( (AncsCstmsVvdDtlListCondVO)getVO(request, AncsCstmsVvdDtlListCondVO.class) );  
		}
