...
public class SpcSlsRepCustMapgNewVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpcSlsRepCustMapgNewVO> models = new ArrayList<SpcSlsRepCustMapgNewVO>();
	 ...
	 */
	public SpcSlsRepCustMapgNewVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpcSlsRepCustMapgVO[]
	 */
	public SpcSlsRepCustMapgNewVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpcSlsRepCustMapgNewVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SpcSlsRepCustMapgNewVO();
				if (updDt[i] != null)
	...
	public SpcSlsRepCustMapgNewVO[] getSpcSlsRepCustMapgVOs(){
		SpcSlsRepCustMapgNewVO[] vos = (SpcSlsRepCustMapgNewVO[])models.toArray(new SpcSlsRepCustMapgNewVO[models.size()]);
		return vos;
	}
