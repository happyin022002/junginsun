...
/**
 * ESM_BKG_3002 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_BKG_3002HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author 김기종
 * @see ESM_BKG_3002HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmBkg3002Event extends EventSupport {
