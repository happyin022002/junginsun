...
public class EsmBkg0745Event extends EventSupport {
	...
	/**
	 * @param bkgCstmsCmdtVO
	 *            the bkgCstmsCmdtVO to set
	 */
	 ...
	 *            the brHsCdDetailVOs to set
	 */
	public void setBrHsCdDetailVOs(BrHsCdDetailVO[] brHsCdDetailVOs) {
		if (brHsCdDetailVOs != null)
			this.brHsCdDetailVOs = Arrays.copyOf(brHsCdDetailVOs, brHsCdDetailVOs.length);
	}
}