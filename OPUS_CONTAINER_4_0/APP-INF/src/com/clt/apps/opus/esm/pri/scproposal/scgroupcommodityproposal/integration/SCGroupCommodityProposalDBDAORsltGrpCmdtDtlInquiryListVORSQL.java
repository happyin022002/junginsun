...
*@FileName : SCGroupCommodityProposalDBDAORsltGrpCmdtDtlInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAORsltGrpCmdtDtlInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RsltGrpCmdtDtlInquiryListVO
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAORsltGrpCmdtDtlInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAORsltGrpCmdtDtlInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
