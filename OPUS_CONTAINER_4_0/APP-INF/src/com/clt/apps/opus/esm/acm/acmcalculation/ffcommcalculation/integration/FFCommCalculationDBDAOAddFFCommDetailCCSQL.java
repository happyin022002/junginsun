...
*@FileName : FFCommCalculationDBDAOAddFFCommDetailCCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOAddFFCommDetailCCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOAddFFCommDetailCCSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAOAddFFCommDetailCCSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOAddFFCommDetailCCSQL").append("\n");
		query.append("*/").append("\n");
	}
