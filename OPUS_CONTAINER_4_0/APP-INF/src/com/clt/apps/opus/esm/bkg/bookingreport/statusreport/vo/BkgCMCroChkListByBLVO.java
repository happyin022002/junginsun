...
public class BkgCMCroChkListByBLVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCMCroChkListByBLVO> models = new ArrayList<BkgCMCroChkListByBLVO>();
...
/**
	 ...
	 */
	public BkgCMCroChkListByBLVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCMCroChkListByBLVO[]
	 */
	public BkgCMCroChkListByBLVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCMCroChkListByBLVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgCMCroChkListByBLVO();
	 ...
	 * @return BkgCMCroChkListByBLVO[]
	 */
	public BkgCMCroChkListByBLVO[] getBkgCMCroChkListByBLVOs(){
		BkgCMCroChkListByBLVO[] vos = (BkgCMCroChkListByBLVO[])models.toArray(new BkgCMCroChkListByBLVO[models.size()]);
		return vos;
	}
