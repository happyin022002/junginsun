...
*@FileName : SearchRevenueVvdListVO.java
*@FileTitle : SearchRevenueVvdListVO
*Open Issues :
*Change history :
 ...
 */
public class SearchRevenueVvdListVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<SearchRevenueVvdListVO> models = new ArrayList<SearchRevenueVvdListVO>();
    ...
    public SearchRevenueVvdListVO() {
    }

    public SearchRevenueVvdListVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String revDirCd, String revYrmon, String slanCd, String rlaneCd, String vstDt, String vedDt, String vvdCd, String creUsrId, String updUsrId, String comVvdFlg) {
        this.vslCd = vslCd;
	 ...
	 */
    public SearchRevenueVvdListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchRevenueVvdListVO[]
	 */
    public SearchRevenueVvdListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        SearchRevenueVvdListVO model = null;
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                model = new SearchRevenueVvdListVO();
                if (vslCd[i] != null)
        ...
        return getSearchRevenueVvdListVOs();
    }
    ...
    public SearchRevenueVvdListVO[] getSearchRevenueVvdListVOs() {
        SearchRevenueVvdListVO[] vos = (SearchRevenueVvdListVO[]) models.toArray(new SearchRevenueVvdListVO[models.size()]);
        return vos;
    }
