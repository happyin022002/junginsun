...
*@FileName : VietnamManifestCustomerInfoVO.java
*@FileTitle : VietnamManifestCustomerInfoVO
*Open Issues :
*Change history :
...
public class VietnamManifestCustomerInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VietnamManifestCustomerInfoVO> models = new ArrayList<VietnamManifestCustomerInfoVO>();
	...
	public VietnamManifestCustomerInfoVO() {}

	public VietnamManifestCustomerInfoVO(String ibflag, String pagerows, String customerType, String customerCd, String customerNm1, String customerNm2, String customerAddr1, String customerAddr2, String customerAddr3, String contactNm, String contactTel, String contactFax, String contactEmail) {
...
/**
	 ...
	 * @param request
	 * @return VietnamManifestCustomerInfoVO[]
	 */
	public VietnamManifestCustomerInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VietnamManifestCustomerInfoVO[]
	 */
	public VietnamManifestCustomerInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VietnamManifestCustomerInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new VietnamManifestCustomerInfoVO();
		...
		return getVietnamManifestCustomerInfoVOs();
	}
	 ...
	 * @return VietnamManifestCustomerInfoVO[]
	 */
	public VietnamManifestCustomerInfoVO[] getVietnamManifestCustomerInfoVOs(){
		VietnamManifestCustomerInfoVO[] vos = (VietnamManifestCustomerInfoVO[])models.toArray(new VietnamManifestCustomerInfoVO[models.size()]);
		return vos;
	}
