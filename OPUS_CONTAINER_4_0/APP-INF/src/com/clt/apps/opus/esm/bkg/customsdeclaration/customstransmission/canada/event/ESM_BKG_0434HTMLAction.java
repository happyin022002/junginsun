 ...
 *@FileName : ESM_BKG_0434HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0434HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0434HTMLAction 객체를 생성
	 */
	public ESM_BKG_0434HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmBkg0434Event event = new EsmBkg0434Event();
		// Receive Log 조회
		event.setCstmsRcvLogDtlCondVO((CndCstmsRcvLogDtlCondVO) getVO(request, CndCstmsRcvLogDtlCondVO.class));
