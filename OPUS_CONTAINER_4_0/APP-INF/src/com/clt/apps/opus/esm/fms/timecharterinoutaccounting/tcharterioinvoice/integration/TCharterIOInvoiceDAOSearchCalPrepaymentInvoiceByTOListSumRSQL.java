...
*@FileName : TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTOListSumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTOListSumRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTOListSumRSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTOListSumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                             , ACCT_ITM_SEQ" ).append("\n"); 
		query.append("                             , '2' AS SORTKEY" ).append("\n"); 
		query.append("                          FROM (" ).append("\n"); 
		query.append("                                SELECT ACCT_ITM_NM" ).append("\n"); 
		query.append("                                     , ACCT_CD" ).append("\n"); 
		query.append("                                     , ACCT_ITM_SEQ" ).append("\n"); 
		...
		query.append("                             , INV_AMT2" ).append("\n"); 
		query.append("                             , ACCT_ITM_SEQ" ).append("\n"); 
		query.append("                             , '3' AS SORTKEY" ).append("\n"); 
		query.append("                          FROM (" ).append("\n"); 
		query.append("                                SELECT ACCT_ITM_NM" ).append("\n"); 
		query.append("                                     , ACCT_CD" ).append("\n"); 
		query.append("                                     , ACCT_ITM_SEQ" ).append("\n"); 
		...
		query.append("                " ).append("\n"); 
		query.append("                       )" ).append("\n"); 
		query.append("                 ORDER BY ACCT_ITM_NM ASC" ).append("\n"); 
