...
public class BkgHrdCdgCtntListCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgHrdCdgCtntListCondVO> models = new ArrayList<BkgHrdCdgCtntListCondVO>();
	 ...
	 */
	public BkgHrdCdgCtntListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgHrdCdgCtntListCondVO[]
	 */
	public BkgHrdCdgCtntListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgHrdCdgCtntListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgHrdCdgCtntListCondVO();
				if (updDt[i] != null)
		...
		return getBkgHrdCdgCtntListCondVOs();
	}
	 ...
	 * @return BkgHrdCdgCtntListCondVO[]
	 */
	public BkgHrdCdgCtntListCondVO[] getBkgHrdCdgCtntListCondVOs(){
		BkgHrdCdgCtntListCondVO[] vos = (BkgHrdCdgCtntListCondVO[])models.toArray(new BkgHrdCdgCtntListCondVO[models.size()]);
		return vos;
	}
