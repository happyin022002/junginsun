...
*@FileName : ESM_BKG_0617HTMLAction.java
...
public class ESM_BKG_0617HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0617HTMLAction 객체를 생성
	 */
	public ESM_BKG_0617HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0617Event event = new EsmBkg0617Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCllCdlCheckCondVO((CllCdlCheckCondVO)getVO(request, CllCdlCheckCondVO .class));
		}
