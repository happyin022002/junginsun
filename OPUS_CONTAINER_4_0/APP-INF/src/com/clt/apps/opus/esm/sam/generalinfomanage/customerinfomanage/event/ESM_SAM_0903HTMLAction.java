...
*@FileName : ESM_SAM_0903HTMLAction.java
...
public class ESM_SAM_0903HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0004HTMLAction 객체를 생성
	 */
	public ESM_SAM_0903HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSam0903Event event = new EsmSam0903Event();
