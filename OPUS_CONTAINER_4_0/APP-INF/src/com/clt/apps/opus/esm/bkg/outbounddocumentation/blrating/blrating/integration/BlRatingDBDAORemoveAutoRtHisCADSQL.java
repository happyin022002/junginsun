...
*@FileName : BlRatingDBDAORemoveAutoRtHisCADSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAORemoveAutoRtHisCADSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BlRatingDBDAORemoveAutoRtHisCA
	  * </pre>
	  */
	public BlRatingDBDAORemoveAutoRtHisCADSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAORemoveAutoRtHisCADSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
