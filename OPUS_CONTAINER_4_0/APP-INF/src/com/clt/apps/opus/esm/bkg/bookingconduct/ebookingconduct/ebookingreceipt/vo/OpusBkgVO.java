...
public class OpusBkgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpusBkgVO> models = new ArrayList<OpusBkgVO>();
...
/**
	 ...
	 * @return OpusBkgVO[]
	 */
	public OpusBkgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpusBkgVO[]
	 */
	public OpusBkgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpusBkgVO model = null;
	 ...
	 * @return OpusBkgVO[]
	 */
	public OpusBkgVO[] getOpusBkgVOs(){
		OpusBkgVO[] vos = (OpusBkgVO[])models.toArray(new OpusBkgVO[models.size()]);
		return vos;
	}
