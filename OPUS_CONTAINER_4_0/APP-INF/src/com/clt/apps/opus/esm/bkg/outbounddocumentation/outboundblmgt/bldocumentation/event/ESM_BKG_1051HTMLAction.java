...
*@FileName : ESM_BKG_1051HTMLAction.java
...
public class ESM_BKG_1051HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1051HTMLAction 객체를 생성
	 */
	public ESM_BKG_1051HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1051Event event = new EsmBkg1051Event();
		log.debug("***** ESM_BKG_1051HTMLAction : " + command.getCommand());
