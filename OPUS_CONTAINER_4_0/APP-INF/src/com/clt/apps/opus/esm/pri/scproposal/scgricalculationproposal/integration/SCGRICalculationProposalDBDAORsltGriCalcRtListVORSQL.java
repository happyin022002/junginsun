...
*@FileName : SCGRICalculationProposalDBDAORsltGriCalcRtListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAORsltGriCalcRtListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAORsltGriCalcRtListVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCGRICalculationProposalDBDAORsltGriCalcRtListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}