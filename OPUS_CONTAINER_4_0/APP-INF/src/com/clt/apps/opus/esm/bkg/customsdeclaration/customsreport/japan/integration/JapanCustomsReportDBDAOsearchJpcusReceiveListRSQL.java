...
public class JapanCustomsReportDBDAOsearchJpcusReceiveListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           AND JP_MSG_TP_ID IN ('CMF01', 'CMF03', 'CMF21', 'DMF', 'DOR', 'MFR', 'MFR21', 'BKR', 'BKC')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("           AND JP_MSG_TP_ID = @[jp_msg_tp_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${date_check}!= '')" ).append("\n"); 
		query.append("           AND RCV_DT BETWEEN TO_DATE(@[start_rcv_dt], 'YYYY-MM-DD HH24:MI') AND TO_DATE(@[end_rcv_dt], 'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
