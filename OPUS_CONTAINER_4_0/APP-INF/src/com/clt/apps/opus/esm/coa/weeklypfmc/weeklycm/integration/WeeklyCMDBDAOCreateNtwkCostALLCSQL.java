...
*@FileName : WeeklyCMDBDAOCreateNtwkCostALLCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOCreateNtwkCostALLCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateNtwkCostALL INSERT
	  * </pre>
	  */
	public WeeklyCMDBDAOCreateNtwkCostALLCSQL(){
		setQuery();
		...
		params.put("in_ind",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("in_mss_chk_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("in_log_lvl",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("in_all_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("in_stnd_cost_cd",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.coa.weeklypfmc.weeklycm.integration").append("\n"); 
		query.append("FileName : WeeklyCMDBDAOCreateNtwkCostALLCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL COA_CREATE_NTWK_COST_ALL_PRC" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append(",@[in_fm_step]      -- (1~6단계)" ).append("\n"); 
		query.append(",@[in_all_flg]      -- (Y or N)" ).append("\n"); 
		query.append(",@[in_ind]          -- 1단계수행시 꼭 필요 [COA,BSA 구분]" ).append("\n"); 
		query.append(",@[in_mss_chk_flg]  -- Y: 여러주일때, N: 한주일때" ).append("\n"); 
		...
		query.append(",@[in_stnd_cost_cd]" ).append("\n"); 
		query.append(",@[in_user_id]" ).append("\n"); 
		query.append(",@[in_log_lvl]" ).append("\n"); 
