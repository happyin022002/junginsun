...
*@FileName : RFARateProposalDBDAOPriRpScpRtCgoSpecRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCgoSpecRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_RP_SCP_RT_CGO_SPEC 테이블 조회
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCgoSpecRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCgoSpecRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
