...
*@FileName : RFARateGuidelineDBDAOLoadExcelCheckGrpLocRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOLoadExcelCheckGrpLocRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOLoadExcelCheckGrpLocRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOLoadExcelCheckGrpLocRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      OR ORG_DEST_TP_CD IN (@[etc1], 'B'))" ).append("\n"); 
