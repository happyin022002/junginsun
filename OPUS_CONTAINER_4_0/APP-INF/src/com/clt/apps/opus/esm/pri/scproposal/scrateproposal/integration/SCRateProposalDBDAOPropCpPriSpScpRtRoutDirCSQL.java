...
*@FileName : SCRateProposalDBDAOPropCpPriSpScpRtRoutDirCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPropCpPriSpScpRtRoutDirCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_RT_ROUT_DIR Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOPropCpPriSpScpRtRoutDirCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPropCpPriSpScpRtRoutDirCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , S.DIR_CALL_FLG" ).append("\n"); 
		...
		query.append("    ,PRI_SP_SCP_RT_ROUT_DIR S" ).append("\n"); 
