...
*@FileName : SearchMTCostListVO3.java
*@FileTitle : SearchMTCostListVO3
*Open Issues :
*Change history :
...
* 2010.02.16 임옥영 품질검토 결과 반영 Line No. 104 :  : shall be matched with size of parameter
=========================================================*/
...
public class SearchMTCostListVO3 extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCostListVO3> models = new ArrayList<SearchMTCostListVO3>();
	...
	/**
	 * SearchMTCostListVO3 생성자
	 */
	public SearchMTCostListVO3() {}
	 ...
	 * @paramString vol
	 * @paramString contiSteve
	 * @paramString contiTrans
	 * @paramString contiDays
	 * @paramString mvmtSteve
	 * @paramString mvmtTrans
	 * @paramString mvmtDays
	 * @paramString fCostYrmon
	 * @paramString fCntrTpszCd2
	 * @paramString fEccCd2
	 * @paramString fOriDest
	 */
	public SearchMTCostListVO3(String ibflag, String pagerows, String costYrmon, String fromEcc, String toEcc, String cntrTpszCd, String vol, String contiSteve, String contiTrans, String contiDays, String mvmtSteve, String mvmtTrans, String mvmtDays, String fCostYrmon, String fCntrTpszCd2, String fEccCd2, String fOriDest) {
	 ...
	 */
	public SearchMTCostListVO3[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCostListVO3[]
	 */
	public SearchMTCostListVO3[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCostListVO3 model = null;
		...
		return getSearchMTCostListVO3s();
	}
	 ...
	 * @return SearchMTCostListVO3[]
	 */
	public SearchMTCostListVO3[] getSearchMTCostListVO3s(){
		SearchMTCostListVO3[] vos = (SearchMTCostListVO3[])models.toArray(new SearchMTCostListVO3[models.size()]);
		return vos;
	}
