...
*@FileName : AGNCommAgreementDBDAOAddAgentRateDetailRoutHisListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateDetailRoutHisListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgentRateDetailRoutHisList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateDetailRoutHisListCSQL(){
		setQuery();
		...
		params.put("rout_lvl_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("agn_agmt_rout_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("rout_info_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateDetailRoutHisListCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_AGMT_DTL_ROUT_HIS" ).append("\n");
		...
		query.append("        AGN_AGMT_ROUT_SEQ," ).append("\n");
		query.append("        ROUT_REF_DIV_CD," ).append("\n");
		query.append("        ROUT_LVL_CD," ).append("\n");
