...
*@FileName : AusCustomsTransmissionDBDAOaddAusSendDtlLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOaddAusSendDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOaddAusSendDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOaddAusSendDtlLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_AUS_DG_EDI_RSPN (" ).append("\n"); 
