...
public class StatusReportOutVO extends AbstractValueObject {
	...
	private String custToOrdName = null;
	private String keyPolCd      = null;
	private String keyPodCd      = null;
	private String keyVslCd      = null;
	private String keySkdVoyNo  = null;
	private String keySkdDirCd  = null;
	private String vslCd         = null;
	private String skdVoyNo     = null;
	private String skdDirCd      = null;
	private String vdPolCd       = null;
	...
	public StatusReportOutVO(String ibflag, String pagerows, String bkgStsCd, String siFlg, String bkgNo, String shprName, String porCd, String rep, String teu, String bkgMeaQty, String pckTpCd, String dcgoFlg, String rcFlg, String fdGrdFlg, String itnFlg, String caedFlg, String bkgOfcCd, String ctrtOfcCd, String obSlsOfcCd, String remark, String scNo, String bdrFlg, String blNo, String cneeName, String delCd, String commodity, String feu, String bkgActwgtQty, String rcvTermCd, String deTermCd, String awkCgoFlg, String bbCgoFlg, String pc, String itnType, String caedType, String docUsrId, String ctrtSrepCd, String obSrepCd, String rfaNo, String trunkVvd, String orgTrnsSvcModCd, String destTrnsSvcModCd, String porNodCd, String fnlDestCd, String slanCd, String bkgCreDt, String cmdtCd, String polCd, String podCd, String shipper, String consignee, String ntfy, String ffdr, String pre1Vvd, String pre2Vvd, String pre3Vvd, String pre4Vvd, String post1Vvd, String post2Vvd, String post3Vvd, String post4Vvd, String pre1PolCd, String pre2PolCd, String pre3PolCd, String pre4PolCd, String pre1PodCd, String pre2PodCd, String pre3PodCd, String pre4PodCd, String bkgClzFlg, String ntfyName, String antyName, String ffdrName, String exptName, String hngrFlg, String socFlg, String eqSubstFlg, String rdCgoFlg, String trunkPol, String trunkPod, String hotDeFlg, String bkgCtrlOfcCd, String eqCtrlOfcCd, String cntrTpszCd, String cntrNo, String aesNo, String caedNo, String remarkDetail, String shpCallNo, String vslEngNm, String pckQty, String orderbyTitleSql, String orderbyTitle, String orderbyCnt, String lastOrderby, String orderby, String rowsPerPage, String currPage, String rnum, String contact, String tel, String actualPol, String actualPod, String totalBkg, String totalBl, String totalTeu, String totalFeu, String totalWgt, String totalMea, String rdTotalD2, String rdTotalQ4, String rdTotalD4, String rdTotalR2, String rdTotalD5, String rdTotalR4, String rdTotalD7, String rdTotalR5, String rdTotalF2, String rdTotalT2, String rdTotalF4, String rdTotalT4, String rdTotalF5, String rdTotalP2, String rdTotalO2, String rdTotalP4, String rdTotalO4, String rdTotalZ4, String rdTotalQ2, String rdTotalZ2, String frtTermCd, String cmdtNm, String interRmk, String taaNo, String cntcPsonEml, String sAddr, String cAddr, String nAddr, String cstmsDesc, String totalCnt, String actCustCode, String actCustName, String blckStwgCd, String chgInterRemark, String chgInterRemarkDetail, String chgTermCd, String chgXterRemark, String chgXterRemarkDetail, String delNodCd, String ofcTeamCd, String rateChkSts, String sailDt, String interRemark, String interRemarkDetail, String rdTotal, String post1PolCd, String post2PolCd, String post3PolCd, String post4PolCd, String post1PodCd, String post2PodCd, String post3PodCd, String post4PodCd, String custToOrdName, String keyPolCd, String keyPodCd, String keyVslCd, String keySkdVoyNo, String keySkdDirCd, String vslCd, String skdVoyNo, String skdDirCd, String vdPolCd, String orgSvcRoute, String destSvcRoute, String sortPrePol, String sortPrePod, String sortPostPol, String sortPostPod, String sortPreVvd, String sortPostVvd, String porEqOfc, String delEqOfc, String chinaAgentCd, String shipperCd, String consigneeCd, String actCustNm) {
		...
		this.custToOrdName = custToOrdName;
		this.keyPolCd      = keyPolCd     ;
		this.keyPodCd      = keyPodCd     ;
		this.keyVslCd      = keyVslCd     ;
		this.keySkdVoyNo   = keySkdVoyNo  ;
		this.keySkdDirCd   = keySkdDirCd  ;
		this.vslCd         = vslCd        ;
		this.skdVoyNo      = skdVoyNo     ;
		this.skdDirCd      = skdDirCd     ;
		this.vdPolCd       = vdPolCd      ;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rd_total",         getRdTotal      ());
		...
		this.hashColumns.put("cust_to_ord_name", getCustToOrdName());
		this.hashColumns.put("key_pol_cd",       getKeyPolCd     ());
		this.hashColumns.put("key_pod_cd",       getKeyPodCd     ());
		this.hashColumns.put("key_vsl_cd",       getKeyVslCd     ());
		this.hashColumns.put("key_skd_voy_no",   getKeySkdVoyNo  ());
		this.hashColumns.put("key_skd_dir_cd",   getKeySkdDirCd  ());
		this.hashColumns.put("vsl_cd",           getVslCd        ());
		this.hashColumns.put("skd_voy_no",       getSkdVoyNo     ());
		this.hashColumns.put("skd_dir_cd",       getSkdDirCd     ());
		this.hashColumns.put("vd_pol_cd",        getVdPolCd      ());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rd_total",         "rdTotal");
		...
		this.hashFields.put("cust_to_ord_name", "custToOrdName");
		this.hashFields.put("key_pol_cd",       "keyPolCd");
		this.hashFields.put("key_pod_cd",       "keyPodCd");
		this.hashFields.put("key_vsl_cd",       "keyVslCd");
		this.hashFields.put("key_skd_voy_no",   "keySkdVoyNo");
		this.hashFields.put("key_skd_dir_cd",   "keySkdDirCd");
		this.hashFields.put("vsl_cd",           "vslCd");
		this.hashFields.put("skd_voy_no",       "skdVoyNo");
		this.hashFields.put("skd_dir_cd",       "skdDirCd");
		this.hashFields.put("vd_pol_cd",        "vdPolCd");
	...
	public String getChgInterRemarkDetail() {
		return this.chgInterRemarkDetail;
	}
	...
	public String getChgXterRemarkDetail() {
		return this.chgXterRemarkDetail;
	}
	...
	public void setRdTotal(String rdTotal) {
		this.rdTotal = rdTotal;
	}
	...
	public String getCustToOrdName() {
		return custToOrdName;
	}

	public void setCustToOrdName(String custToOrdName) {
		this.custToOrdName = custToOrdName;
	}
	...
	public String getKeyPodCd() {
		return keyPodCd;
	}

	public void setKeyPodCd(String keyPodCd) {
		this.keyPodCd = keyPodCd;
	}

	public String getKeyVslCd() {
		return keyVslCd;
	}

	public void setKeyVslCd(String keyVslCd) {
		this.keyVslCd = keyVslCd;
	}

	public String getKeySkdVoyNo() {
		return keySkdVoyNo;
	}

	public void setKeySkdVoyNo(String keySkdVoyNo) {
		this.keySkdVoyNo = keySkdVoyNo;
	}

	public String getKeySkdDirCd() {
		return keySkdDirCd;
	}

	public void setKeySkdDirCd(String keySkdDirCd) {
		this.keySkdDirCd = keySkdDirCd;
	}
	...
	public String getVdPolCd() {
		return vdPolCd;
	}

	public void setVdPolCd(String vdPolCd) {
		this.vdPolCd = vdPolCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRdTotal      (JSPUtil.getParameter(request, prefix + "rd_total", ""));
		...
		setCustToOrdName(JSPUtil.getParameter(request, prefix + "cust_to_ord_name", ""));
		setKeyPolCd     (JSPUtil.getParameter(request, prefix + "key_pol_cd", ""));
		setKeyPodCd     (JSPUtil.getParameter(request, prefix + "key_pod_cd", ""));
		setKeyVslCd     (JSPUtil.getParameter(request, prefix + "key_vsl_cd", ""));
		setKeySkdVoyNo  (JSPUtil.getParameter(request, prefix + "key_skd_voy_no", ""));
		setKeySkdDirCd  (JSPUtil.getParameter(request, prefix + "key_skd_dir_cd", ""));
		setVslCd        (JSPUtil.getParameter(request, prefix + "vsl_cd", ""));
		setSkdVoyNo     (JSPUtil.getParameter(request, prefix + "skd_voy_no", ""));
		setSkdDirCd     (JSPUtil.getParameter(request, prefix + "skd_dir_cd", ""));
		setVdPolCd      (JSPUtil.getParameter(request, prefix + "vd_pol_cd", ""));
	...
	public StatusReportOutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] chgInterRemark = (JSPUtil.getParameter(request, prefix	+ "ch_inter_remark", length));
			String[] chgInterRemarkDetail = (JSPUtil.getParameter(request, prefix	+ "ch_inter_remark_detail", length));
			String[] chgTermCd = (JSPUtil.getParameter(request, prefix	+ "chg_term_cd", length));
			String[] chgXterRemark = (JSPUtil.getParameter(request, prefix	+ "ch_xter_remark", length));
			String[] chgXterRemarkDetail = (JSPUtil.getParameter(request, prefix	+ "ch_xter_remark_detail", length));
			...
			String[] interRemarkDetail = (JSPUtil.getParameter(request, prefix	+ "inter_remark_desc", length));
			String[] rdTotal       = (JSPUtil.getParameter(request, prefix + "rd_total", length));
			...
			String[] custToOrdName = (JSPUtil.getParameter(request, prefix + "cust_to_ord_name", length));
			String[] keyPolCd      = (JSPUtil.getParameter(request, prefix + "key_pol_cd", length));
			String[] keyPodCd      = (JSPUtil.getParameter(request, prefix + "key_pod_cd", length));
			String[] keyVslCd      = (JSPUtil.getParameter(request, prefix + "key_vsl_cd", length));
			String[] keySkdVoyNo   = (JSPUtil.getParameter(request, prefix + "key_skd_voy_no", length));
			String[] keySkdDirCd   = (JSPUtil.getParameter(request, prefix + "key_skd_dir_cd", length));
			String[] vslCd         = (JSPUtil.getParameter(request, prefix + "vsl_cd", length));
			String[] skdVoyNo      = (JSPUtil.getParameter(request, prefix + "skd_voy_no", length));
			String[] skdDirCd      = (JSPUtil.getParameter(request, prefix + "skd_dir_cd", length));
			String[] vdPolCd       = (JSPUtil.getParameter(request, prefix + "vd_pol_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (custToOrdName[i] != null)
				    model.setCustToOrdName(custToOrdName[i]);
				if (keyPolCd[i] != null)
				    model.setKeyPolCd(keyPolCd[i]);
				if (keyPodCd[i] != null)
				    model.setKeyPodCd(keyPodCd[i]);
				if (keyVslCd[i] != null)
				    model.setKeyVslCd(keyVslCd[i]);
				if (keySkdVoyNo[i] != null)
				    model.setKeySkdVoyNo(keySkdVoyNo[i]);
				if (keySkdDirCd[i] != null)
				    model.setKeySkdDirCd(keySkdDirCd[i]);
				if (vslCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.chgXterRemark = this.chgXterRemark .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.chgXterRemarkDetail = this.chgXterRemarkDetail .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.rdTotal      = this.rdTotal      .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.custToOrdName= this.custToOrdName.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.keyPolCd     = this.keyPolCd     .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.keyPodCd     = this.keyPodCd     .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.keyVslCd     = this.keyVslCd     .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.keySkdVoyNo  = this.keySkdVoyNo  .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.keySkdDirCd  = this.keySkdDirCd  .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.vslCd        = this.vslCd        .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.skdVoyNo     = this.skdVoyNo     .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.skdDirCd     = this.skdDirCd     .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.vdPolCd      = this.vdPolCd      .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
