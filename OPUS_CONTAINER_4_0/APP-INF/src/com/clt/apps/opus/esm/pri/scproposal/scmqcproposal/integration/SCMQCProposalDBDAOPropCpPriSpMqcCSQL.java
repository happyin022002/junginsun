...
*@FileName : SCMQCProposalDBDAOPropCpPriSpMqcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCMQCProposalDBDAOPropCpPriSpMqcCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Copy PRI_SP_MQC Insert
	  * </pre>
	  */
	public SCMQCProposalDBDAOPropCpPriSpMqcCSQL(){
		setQuery();
		...
		query.append("FileName : SCMQCProposalDBDAOPropCpPriSpMqcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE PROP_NO = @[prop_no] AND AMDT_SEQ = @[amdt_seq]),'F',FNL_MQC_QTY,PROP_MQC_QTY) AS PROP_MQC_QTY" ).append("\n"); 
