...
*@FileName : SCRoutePointProposalDBDAORsltRoutPntLocInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRoutePointProposalDBDAORsltRoutPntLocInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRoutePointProposalDBDAORsltRoutPntLocInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRoutePointProposalDBDAORsltRoutPntLocInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
