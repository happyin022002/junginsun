...
public class UsaCustomsTransmissionDBDAOaddCustomsResultCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",DECODE(NVL(@[isf_in_bl], 'Not Isf'), 'Not Isf', DECODE(@[cus_loc], 'HOUSE', 'H', DECODE(@[in_snp], COM_ConstantMgr_PKG.COM_getScacCode_FNC(), 'M', 'N')), NULL)" ).append("\n"); 
		...
		query.append(",@[crr_bat_no]" ).append("\n"); 
		query.append(",@[cstms_clr_cd]" ).append("\n"); 
		query.append(",DECODE(@[bl_no], @[in_nvobl], null, @[in_nvobl])" ).append("\n"); 
		query.append(")" ).append("\n"); 
