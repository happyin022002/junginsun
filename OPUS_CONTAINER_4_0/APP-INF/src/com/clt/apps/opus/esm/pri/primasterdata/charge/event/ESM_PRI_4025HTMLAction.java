...
*@FileName : ESM_PRI_4025HTMLAction.java
...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.pri.primasterdata.charge.event;
...
public class ESM_PRI_4025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_4025HTMLAction 객체를 생성
	 */
	public ESM_PRI_4025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri4025Event event = new EsmPri4025Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMdmChgVO((MdmChgVO)getVO(request, MdmChgVO .class));
		}
