...
public class CLLCDLManifestDBDAOsearchCllSpclStowRqstByPodRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      DECODE(CLL.STWG_CD, 'OBSG', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 0) OBSG_20," ).append("\n");
		query.append("      DECODE(CLL.STWG_CD, 'OBSG', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 0) OBSG_40," ).append("\n");
		query.append("      DECODE(CLL.STWG_CD, 'OBSG', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0,  1), 0) OBSG_40H," ).append("\n");
		query.append("      DECODE(CLL.STWG_CD, 'OBSG', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', 1, 0), 0) OBSG_45," ).append("\n");
