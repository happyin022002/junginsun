...
*@FileName : PriRpScpNoteListVO.java
*@FileTitle : PriRpScpNoteListVO
*Open Issues :
*Change history :
...
public class PriRpScpNoteListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpNoteListVO> models = new ArrayList<PriRpScpNoteListVO>();
	...
	public PriRpScpNoteListVO() {}

	public PriRpScpNoteListVO(String ibflag, String pagerows, String dpSeq, String noteChgTpCd, String amdtSeq, String svcScpCd, String creDt, String noteTitNm, String noteCtnt, String chgCd, String prcProgStsCd, String effDt, String noteClssCd, String noteTpCd, String expDt, String prcCustTpCd, String updUsrId, String updDt, String acptOfcCd, String acptDt, String srcInfoCd, String acptUsrId, String noteSeq, String noteConvFlg, String noteCtntSeq, String noteConvMapgId, String creUsrId, String n1stCmncAmdtSeq, String propNo, String conChk, String amendFunc) {
		this.dpSeq = dpSeq;
		this.noteChgTpCd = noteChgTpCd;
		this.amdtSeq = amdtSeq;
		this.svcScpCd = svcScpCd;
		this.amendFunc = amendFunc;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("amend_func", getAmendFunc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("amend_func", "amendFunc");
	 ...
	 * @return amendFunc
	 */
	public String getAmendFunc() {
		return this.amendFunc;
	}
	 ...
	 * @param amendFunc
	 */
	public void setAmendFunc(String amendFunc) {
		this.amendFunc = amendFunc;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAmendFunc(JSPUtil.getParameter(request, "amend_func", ""));
	 ...
	 */
	public PriRpScpNoteListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpNoteListVO[]
	 */
	public PriRpScpNoteListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpNoteListVO model = null;
		...
		try {
			...
			String[] amendFunc = (JSPUtil.getParameter(request, prefix	+ "amend_func", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (amendFunc[i] != null)
					model.setAmendFunc(amendFunc[i]);
				if (noteTitNm[i] != null)
	...
	public PriRpScpNoteListVO[] getPriRpScpNoteListVOs(){
		PriRpScpNoteListVO[] vos = (PriRpScpNoteListVO[])models.toArray(new PriRpScpNoteListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.amendFunc = this.amendFunc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
