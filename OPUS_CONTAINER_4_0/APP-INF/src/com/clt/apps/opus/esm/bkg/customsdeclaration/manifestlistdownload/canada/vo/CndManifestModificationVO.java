 ...
 *@FileName : CndManifestModificationVO.java
 *@FileTitle : CndManifestModificationVO
 *Open Issues :
 *Change history :
...
public class CndManifestModificationVO extends com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.vo.ManifestListDetailVO {

	private static final long serialVersionUID = 1L;

	private Collection<CndManifestModificationVO> models = new ArrayList<CndManifestModificationVO>();
	...
	public CndManifestModificationVO() {}

	public CndManifestModificationVO(String ibflag, String pagerows, String actWgt, String bdrFlg, String bkgCgoTpCd, String bkgDelCd, String bkgNo, String bkgPodCd, String bkgStsCd, String blNo, String blNos, String blType, String caIssDt, String caNo, String cneeAd, String cneeNm, String cntrMfNo, String cntCd, String cstmsMfTpCd, String cstmsTrsmStsCd, String ediFlg, String ediSndDt, String empFlg, String errCd, String filer, String hubLocCd, String ibdLocGdsDesc, String ifFlg, String mfStsCd, String ntfyAd, String ntfyNm, String pckQty, String pckTpCd, String podCd, String polCd, String shprAd, String shprNm, String skdDirCd, String skdVoyNo, String sndDt, String vslCd, String wgtUtCd) {
		this.vslCd = vslCd;
...
/**
	 ...
	 * @param request
	 * @return CndManifestModificationVO[]
	 */
	public CndManifestModificationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CndManifestModificationVO[]
	 */
	public CndManifestModificationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CndManifestModificationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CndManifestModificationVO();
				if (vslCd[i] != null)
		...
		return getCndManifestModificationVOs();
	}
	 ...
	 * @return CndManifestModificationVO[]
	 */
	public CndManifestModificationVO[] getCndManifestModificationVOs(){
		CndManifestModificationVO[] vos = (CndManifestModificationVO[])models.toArray(new CndManifestModificationVO[models.size()]);
		return vos;
	}
