...
public class EsmBkg0650Event extends EventSupport {
	...
	public void setTSRouteVOS(TSRouteVO[] tSRouteVOs){
		if (tSRouteVOs != null) {
			TSRouteVO[] tmpVOs = Arrays.copyOf(tSRouteVOs, tSRouteVOs .length);
			this. tSRouteVOs = tmpVOs;
		}
	}
	...
	public TSRouteVO[] getTSRouteVOS(){
		TSRouteVO[] tmpVOs = null;
		if (this. tSRouteVOs != null) {
			tmpVOs = Arrays.copyOf(tSRouteVOs, tSRouteVOs .length);
		}
		return tmpVOs;
	}
