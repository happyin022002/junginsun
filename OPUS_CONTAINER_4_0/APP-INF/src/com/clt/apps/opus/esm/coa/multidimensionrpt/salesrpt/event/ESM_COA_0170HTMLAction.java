...
*@FileName : ESM_COA_017HTMLAction.java
...
public class ESM_COA_0170HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_017HTMLAction 객체를 생성
	 */
	public ESM_COA_0170HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0170Event event = new EsmCoa0170Event();
