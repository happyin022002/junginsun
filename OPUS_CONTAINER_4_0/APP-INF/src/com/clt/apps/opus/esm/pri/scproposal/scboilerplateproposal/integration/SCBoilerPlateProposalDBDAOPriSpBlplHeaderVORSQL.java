...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplHeaderVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplHeaderVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * guide line header search
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplHeaderVORSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplHeaderVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
