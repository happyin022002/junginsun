...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOCreateMonthlyAdjustmentRhqRgnInfoA0085CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOCreateMonthlyAdjustmentRhqRgnInfoA0085CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOCreateMonthlyAdjustmentRhqRgnInfoA0085CSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOCreateMonthlyAdjustmentRhqRgnInfoA0085CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    @[ofcCd]||SUBSTR(@[glineVerNo], LENGTH(@[glineVerNo])-5)" ).append("\n"); 
		...
		query.append("    SUBSTR(@[glineVerNo],-6) AS QTA_MST_VER_NO," ).append("\n"); 
