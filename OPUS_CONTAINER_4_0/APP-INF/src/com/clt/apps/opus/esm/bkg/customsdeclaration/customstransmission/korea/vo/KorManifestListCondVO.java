...
public class KorManifestListCondVO extends ManifestListCondVO {
	...
	public KorManifestListCondVO(String ibflag, String pagerows, String vvd, String polCd, String podCd, String yardCd, String inType, String blNo, String ioBndCd, String userId) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.inType = inType;
		this.polCd = polCd;
