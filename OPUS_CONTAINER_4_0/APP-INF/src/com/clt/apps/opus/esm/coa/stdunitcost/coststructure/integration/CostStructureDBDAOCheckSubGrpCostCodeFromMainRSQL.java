...
*@FileName : CostStructureDBDAOCheckSubGrpCostCodeFromMainRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAOCheckSubGrpCostCodeFromMainRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Sub group code Check query for ESM_COA_2001
	  * </pre>
	  */
	public CostStructureDBDAOCheckSubGrpCostCodeFromMainRSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAOCheckSubGrpCostCodeFromMainRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
