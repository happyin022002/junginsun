...
*@FileName : SCRateProposalDBDAOPriSpScpRtDirectActVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtDirectActVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtDirectActVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_RT_ROUT_DIR SET" ).append("\n"); 
		...
		query.append(",	ACPT_DT 	= DECODE(@[acpt_dt],NULL,NULL,SYSDATE)" ).append("\n"); 
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtDirectActVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}