...
public class ACMSimulationDBDAOAddAcmSimCommChgCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(SIM_NO, BKG_NO, AGN_CD, IO_BND_CD, AC_TP_CD, AC_SEQ, AC_CHG_SEQ, REP_CHG_CD, CHG_CD, BKG_AGMT_UT_CD, CHG_DDCT_AMT, CURR_CD, CHG_DDCT_PAY_AMT, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("        FROM ACM_SIM_COMM_CHG_REF R, ACM_SIM_AGMT_DTL D, MDM_CHARGE M" ).append("\n"); 
		query.append("        , BKG_QUANTITY Q, BKG_BOOKING B, MDM_LOCATION MPOR, MDM_LOCATION MDEL--, ACM_SIM_AGMT_DTL_CHG C" ).append("\n"); 
