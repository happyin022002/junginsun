...
*@FileName : MTCostDBDAOSearchMTCostListVO10RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCostListVO10RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCostListVO10RSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCostListVO10RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
