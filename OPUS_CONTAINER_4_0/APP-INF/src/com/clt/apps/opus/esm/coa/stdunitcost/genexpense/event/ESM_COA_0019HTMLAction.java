...
public class ESM_COA_0019HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCoaDmdtN3rdPtyVOS((CoaDmdtN3rdPtyVO[])getVOs(request, CoaDmdtN3rdPtyVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCoaDmdtN3rdPtyVO((CoaDmdtN3rdPtyVO)getVO(request, CoaDmdtN3rdPtyVO .class));
		}
