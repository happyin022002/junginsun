...
*@FileName : NewZealandManifestSndLogVO.java
*@FileTitle : NewZealandManifestSndLogVO
*Open Issues :
*Change history :
...
public class NewZealandManifestSndLogVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<NewZealandManifestSndLogVO> models = new ArrayList<NewZealandManifestSndLogVO>();
	...
	/* Column Info */
	private String nzlSndLogId = null;
	/* Column Info */
	...
	public NewZealandManifestSndLogVO() {}

	public NewZealandManifestSndLogVO(String ibflag, String pagerows, String nzlSndLogId, String msgSndNo, String sndDt, String logSeq, String ofcCd, String vslCd, String skdVoyNo, String skdDirCd, String podCd, String logFlg, String logDt, String logGdt, String blNo, String doNo, String sndFlg, String msgRgstId, String cstmsRqstFlg, String polCd, String polYdCd, String porCd, String porYdCd, String otrNtfyYdCd, String rtnYdSeq, String ydSeq, String ediSndMsgCtnt, String rcvKeyDatCtnt, String delCd, String cntcPsonEml, String emlSndRsltFlg, String ediRefId, String mrnNo, String mrnChkNo, String cntrNo, String ediRcvMsgCtnt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.porCd = porCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("nzl_snd_log_id", getNzlSndLogId());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("nzl_snd_log_id", "nzlSndLogId");
	 ...
	 * @return nzlSndLogId
	 */
	public String getNzlSndLogId() {
		return this.nzlSndLogId;
	}
	 ...
	 * @param nzlSndLogId
	 */
	public void setNzlSndLogId(String nzlSndLogId) {
		this.nzlSndLogId = nzlSndLogId;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setNzlSndLogId(JSPUtil.getParameter(request, prefix + "nzl_snd_log_id", ""));
	 ...
	 * @param request
	 * @return NewZealandManifestSndLogVO[]
	 */
	public NewZealandManifestSndLogVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NewZealandManifestSndLogVO[]
	 */
	public NewZealandManifestSndLogVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandManifestSndLogVO model = null;
		...
		try {
			...
			String[] nzlSndLogId = (JSPUtil.getParameter(request, prefix	+ "nzl_snd_log_id", length));
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandManifestSndLogVO();
				if (porCd[i] != null)
				...
				if (nzlSndLogId[i] != null)
					model.setNzlSndLogId(nzlSndLogId[i]);
				if (cntrNo[i] != null)
		...
		return getNewZealandManifestSndLogVOs();
	}
	 ...
	 * @return NewZealandManifestSndLogVO[]
	 */
	public NewZealandManifestSndLogVO[] getNewZealandManifestSndLogVOs(){
		NewZealandManifestSndLogVO[] vos = (NewZealandManifestSndLogVO[])models.toArray(new NewZealandManifestSndLogVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.nzlSndLogId = this.nzlSndLogId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
