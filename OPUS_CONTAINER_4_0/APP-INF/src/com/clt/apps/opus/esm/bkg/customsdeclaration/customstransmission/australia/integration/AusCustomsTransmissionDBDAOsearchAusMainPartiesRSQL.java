...
*@FileName : AusCustomsTransmissionDBDAOsearchAusMainPartiesRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOsearchAusMainPartiesRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOsearchAusMainPartiesRSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOsearchAusMainPartiesRSQL").append("\n");
		query.append("*/").append("\n");
	}
