...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Table agt_agn_agmt Delete(delt_flag='Y' Update)
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtVODSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
