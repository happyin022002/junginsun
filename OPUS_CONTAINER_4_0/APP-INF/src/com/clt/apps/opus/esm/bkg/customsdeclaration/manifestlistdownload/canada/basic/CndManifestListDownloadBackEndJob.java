...
import com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.usa.basic.UsaManifestListDownloadBackEndJob;
...
//				}
				...
				if("ESM_BKG_0028".equals(manifestListDetailVOs[0].getPgmNo())
						&& !"".equals(paramVO.getHubLocCd()) )
				{
...
//				dbDao.addBkgCstmsAdvCust(listCust);
	 ...
	 * @param account 세션정보
	 */
	public void setManifestListDetailVO(ManifestListDetailVO[] manifestListDetailVOs, SignOnUserAccount account,
			CndManifestListDownloadDBDAO dbDao) {
