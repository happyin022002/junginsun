...
*@FileName : SearchSpclRepoCntrVO.java
*@FileTitle : SearchSpclRepoCntrVO
*Open Issues :
*Change history :
...
public class SearchSpclRepoCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSpclRepoCntrVO> models = new ArrayList<SearchSpclRepoCntrVO>();
	...
	public SearchSpclRepoCntrVO() {}

	public SearchSpclRepoCntrVO(String ibflag, String pagerows, String deltFlg, String seq, String cntrTpszCd, String spclCntrTpszCd, String repoFlg, String listBxDesc) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return SearchSpclRepoCntrVO[]
	 */
	public SearchSpclRepoCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSpclRepoCntrVO[]
	 */
	public SearchSpclRepoCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSpclRepoCntrVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSpclRepoCntrVO();
				if (ibflag[i] != null)
		...
		return getSearchSpclRepoCntrVOs();
	}
	 ...
	 * @return SearchSpclRepoCntrVO[]
	 */
	public SearchSpclRepoCntrVO[] getSearchSpclRepoCntrVOs(){
		SearchSpclRepoCntrVO[] vos = (SearchSpclRepoCntrVO[])models.toArray(new SearchSpclRepoCntrVO[models.size()]);
		return vos;
	}
