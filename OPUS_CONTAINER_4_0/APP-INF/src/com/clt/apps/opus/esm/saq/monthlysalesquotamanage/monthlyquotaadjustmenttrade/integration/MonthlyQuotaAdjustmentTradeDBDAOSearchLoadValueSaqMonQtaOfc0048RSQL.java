...
*@FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchLoadValueSaqMonQtaOfc0048RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeDBDAOSearchLoadValueSaqMonQtaOfc0048RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeDBDAOSearchLoadValueSaqMonQtaOfc0048RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchLoadValueSaqMonQtaOfc0048RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  	SUB_TRD_CD , SUM(LOD_QTY) LOD_QTY" ).append("\n"); 
		...
		query.append("	  AND BSE_MON = substr(@[targetMonth],-2)" ).append("\n"); 
