...
*@FileName : CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Inland setting이 되어있으면 Inland에도 CT 전송을 보내기 위해 snd ID와 Rcv ID 를 가져옴
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCtRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
