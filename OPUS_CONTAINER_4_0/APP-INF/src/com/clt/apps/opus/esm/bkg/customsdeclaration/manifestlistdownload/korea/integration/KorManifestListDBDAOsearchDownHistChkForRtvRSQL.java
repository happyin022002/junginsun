...
*@FileName : KorManifestListDBDAOsearchDownHistChkForRtvRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchDownHistChkForRtvRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchDownHistChkForRtvRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchDownHistChkForRtvRSQL").append("\n");
		query.append("*/").append("\n");
	}
