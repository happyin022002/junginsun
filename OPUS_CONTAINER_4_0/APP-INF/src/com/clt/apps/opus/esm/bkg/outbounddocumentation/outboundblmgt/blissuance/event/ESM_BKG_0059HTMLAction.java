...
public class ESM_BKG_0059HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0649HTMLAction 객체를 생성
	 */
	public ESM_BKG_0059HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0059Event event = new EsmBkg0059Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setBkg_no(bkg_no);
			event.setBl_no(bl_no);
			event.setDocRqstVOs((DocRqstVO[])getVOs(request, DocRqstVO.class,"sheet1_"));
		}
