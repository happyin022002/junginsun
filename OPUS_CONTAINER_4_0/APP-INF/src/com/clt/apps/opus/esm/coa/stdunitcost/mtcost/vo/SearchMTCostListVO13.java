...
*@FileName : SearchMTCostListVO13.java
*@FileTitle : SearchMTCostListVO13
*Open Issues :
*Change history :
...
* 2010.02.16 임옥영 품질검토 결과 반영 Line No. 117 :  : shall be matched with size of parameter
=========================================================*/
...
public class SearchMTCostListVO13 extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCostListVO13> models = new ArrayList<SearchMTCostListVO13>();
	...
	/**
	 * SearchMTCostListVO13 생성자
	 */
	public  SearchMTCostListVO13() {}
	 ...
	 */
	public SearchMTCostListVO13[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCostListVO13[]
	 */
	public SearchMTCostListVO13[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCostListVO13 model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMTCostListVO13();
		...
		return getSearchMTCostListVO13s();
	}
	 ...
	 * @return SearchMTCostListVO13[]
	 */
	public SearchMTCostListVO13[] getSearchMTCostListVO13s(){
		SearchMTCostListVO13[] vos = (SearchMTCostListVO13[])models.toArray(new SearchMTCostListVO13[models.size()]);
		return vos;
	}
