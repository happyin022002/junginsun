...
*@FileName : SPCManageDBDAORemovemultiBsaVvdPortDwnDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPCManageDBDAORemovemultiBsaVvdPortDwnDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Step Up/Down by VVD Delete 쿼리
	  * </pre>
	  */
	public SPCManageDBDAORemovemultiBsaVvdPortDwnDSQL(){
		setQuery();
		...
		query.append("FileName : SPCManageDBDAORemovemultiBsaVvdPortDwnDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_VVD_PORT_DWN" ).append("\n"); 
