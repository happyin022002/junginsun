...
public class EsmBkg1076Event extends EventSupport {
	...
	public SearchScOftAutoratingListVO[] getSearchScOftAutoratingListVOS() {SearchScOftAutoratingListVO[] rtnVOs = null;
		if (this.searchScOftAutoratingListVOS != null) {
			rtnVOs = Arrays.copyOf(searchScOftAutoratingListVOS,
					searchScOftAutoratingListVOS.length);
		}
		return rtnVOs;
	}
	...
	public void setSearchScOftAutoratingListVOS(SearchScOftAutoratingListVO[] searchScOftAutoratingListVOS) {
		if (searchScOftAutoratingListVOS != null) {
			SearchScOftAutoratingListVO[] tmpVOs = Arrays.copyOf(searchScOftAutoratingListVOS,
					searchScOftAutoratingListVOS.length);
