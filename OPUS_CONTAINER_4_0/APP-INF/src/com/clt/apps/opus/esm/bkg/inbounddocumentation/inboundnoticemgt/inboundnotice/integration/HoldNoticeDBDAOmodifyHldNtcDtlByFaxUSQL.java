...
*@FileName : HoldNoticeDBDAOmodifyHldNtcDtlByFaxUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class HoldNoticeDBDAOmodifyHldNtcDtlByFaxUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public HoldNoticeDBDAOmodifyHldNtcDtlByFaxUSQL(){
		setQuery();
		...
		query.append("FileName : HoldNoticeDBDAOmodifyHldNtcDtlByFaxUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[hld_fax_snd_usr_id]     AS HLD_FAX_SND_USR_ID" ).append("\n"); 
		...
		query.append(",FAX_TP_CD           = 'M' -- Manual" ).append("\n"); 
		query.append(",HLD_FAX_SND_DT      = NULL" ).append("\n"); 
		query.append(",HLD_FAX_SND_GDT      = NULL" ).append("\n"); 
		query.append(",HLD_FAX_SND_USR_ID  = B.HLD_FAX_SND_USR_ID" ).append("\n"); 
		query.append(",HLD_FAX_SND_ID      = NULL" ).append("\n"); 
		query.append(",HLD_FAX_SND_RSLT_CD = NULL" ).append("\n"); 
