...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList10RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList10RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_rout_ref 조회 하여 bkg_por_inp_term_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList10RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList10RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    ROUT_REF_DIV_CD = 'PORL'" ).append("\n"); 
