...
public class LicenseInfoListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<LicenseInfoListVO> models = new ArrayList<LicenseInfoListVO>();
	...
	public LicenseInfoListVO() {}

	public LicenseInfoListVO(String ibflag, String pagerows, String updUsrNm, String cntCd, String custSeq, String custLicNo, String creUsrId, String creDt, String updUsrId, String updDt, String custCd, String custNm) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setUpdDt(JSPUtil.getParameter(request, "upd_usr_nm", ""));
		setCntCd(JSPUtil.getParameter(request, "cnt_cd", ""));
		setCntCd(JSPUtil.getParameter(request, "cust_cd", ""));
		setCntCd(JSPUtil.getParameter(request, "cust_nm", ""));
	 ...
	 */
	public LicenseInfoListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsChnDeModDetailVO[]
	 */
	public LicenseInfoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LicenseInfoListVO model = null;
	 ...
	 * @return BkgCstmsChnDeModDetailVO[]
	 */
	public LicenseInfoListVO[] getLicenseInfoListVOs(){
		LicenseInfoListVO[] vos = (LicenseInfoListVO[])models.toArray(new LicenseInfoListVO[models.size()]);
		return vos;
	}
