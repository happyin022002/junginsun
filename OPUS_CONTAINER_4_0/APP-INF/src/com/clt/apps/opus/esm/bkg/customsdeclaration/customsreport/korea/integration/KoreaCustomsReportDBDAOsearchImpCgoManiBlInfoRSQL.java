...
public class KoreaCustomsReportDBDAOsearchImpCgoManiBlInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT DECODE(NVL(BKG.BL_NO,' '),' ',COM_ConstantMgr_PKG.COM_getScacCode_FNC()||NVL(BKG.BKG_NO,' '),COM_ConstantMgr_PKG.COM_getScacCode_FNC()||NVL(BKG.BL_NO,' '))||CHR(10)||SUBSTR(NVL(LOC.LOC_NM,' '),1,18) BL_NO" ).append("\n");
