...
*@FileName : SearchQuarterlyCurrnetQtaListVO.java
*@FileTitle : SearchQuarterlyCurrnetQtaListVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.csq.adjustment.qtainquiry.vo;
...
public class SearchQuarterlyCurrnetQtaListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchQuarterlyCurrnetQtaListVO> models = new ArrayList<SearchQuarterlyCurrnetQtaListVO>();
	...
	public SearchQuarterlyCurrnetQtaListVO() {}

	public SearchQuarterlyCurrnetQtaListVO(String ibflag, String pagerows, String bseYr, String bseQtrCd, String ofcVwCd, String rhqCd, String rgnOfcCd, String trdCd, String subTrdCd, String rlaneCd, String dirCd, String bseMon, String bseWk, String vvd, String fnlBsaCapa, String lodQty, String gRev, String grpb, String grpbDecimal, String paCmC, String raCmC, String paCm, String raCm, String paCmcb, String raCmcb, String paCmpb, String raCmpb) {
...
/**
	 ...
	 * @param request
	 * @return SearchQuarterlyCurrnetQtaListVO[]
	 */
	public SearchQuarterlyCurrnetQtaListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchQuarterlyCurrnetQtaListVO[]
	 */
	public SearchQuarterlyCurrnetQtaListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchQuarterlyCurrnetQtaListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchQuarterlyCurrnetQtaListVO();
				if (ofcVwCd[i] != null)
		...
		return getSearchQuarterlyCurrnetQtaListVOs();
	}
	 ...
	 * @return SearchQuarterlyCurrnetQtaListVO[]
	 */
	public SearchQuarterlyCurrnetQtaListVO[] getSearchQuarterlyCurrnetQtaListVOs(){
		SearchQuarterlyCurrnetQtaListVO[] vos = (SearchQuarterlyCurrnetQtaListVO[])models.toArray(new SearchQuarterlyCurrnetQtaListVO[models.size()]);
		return vos;
	}
