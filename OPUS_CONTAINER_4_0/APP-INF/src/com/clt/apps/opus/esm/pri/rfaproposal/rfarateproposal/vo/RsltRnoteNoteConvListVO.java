 ...
 *@FileName : RsltRnoteNoteConvListVO.java
 *@FileTitle : RsltRnoteNoteConvListVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class RsltRnoteNoteConvListVO	extends	 AbstractValueObject {

	private	 static final long serialVersionUID = 1L;

	private	 Collection<RsltRnoteNoteConvListVO>  models =	new	ArrayList<RsltRnoteNoteConvListVO>();
	...
	/**	Constructor	*/
	public RsltRnoteNoteConvListVO(){}

	public RsltRnoteNoteConvListVO(String ibflag,String pagerows,String bkgYdCd,String amdtSeq,String payTermCd,String svcScpCd,String noteConvSeq,String rtApplTpCd,String bkgDelTpCd,String effDt,String bkgSocFlg,String bkgHngrBarTpCd,String bkgTsPortTpCd,String bkgMaxCgoWgt,String bkgTsPortDefCd,String bkgCmdtDefCd,String bkgPodTpCd,String bkgCmdtTpCd,String rtOpCd,String bkgMinCgoWgt,String chgRuleDefCd,String noteConvMapgId,String bkgPolDefCd,String chgRuleTpCd,String bkgRatUtCd,String bkgDelDefCd,String bkgImdgClssCd,String currCd,String bkgPrcCgoTpCd,String bkgDirCallFlg,String bkgDelCntCd,String usrNm,String bkgSlanCd,String expDt,String bkgPolCntCd,String noteConvTpCd,String bkgPolTpCd,String updDt,String noteConvRuleCd,String bkgSkdDirCd,String bkgPorTpCd,String bkgPodDefCd,String noteConvChgCd,String bkgPorDefCd,String bkgSkdVoyNo,String propNo,String frtRtAmt,String bkgPorCntCd,String bkgPodCntCd,String bkgVvdCd,String bkgVslCd,String bkgCnlTzCd,String bkgEsvcTpCd)	{
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return RsltRnoteNoteConvListVO[]
	 */
	public RsltRnoteNoteConvListVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return RsltRnoteNoteConvListVO[]
	 */
	public RsltRnoteNoteConvListVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		RsltRnoteNoteConvListVO model = null;
		...
		try	{
			...
			for	(int i = 0;	i <	length;	i++) {
				model =	new	RsltRnoteNoteConvListVO();
				if ( ibflag[i] !=	null)
		...
		return getRsltRnoteNoteConvListVOs();
	}
	 ...
	 * @return RsltRnoteNoteConvListVO[]
	 */
	public RsltRnoteNoteConvListVO[]	 getRsltRnoteNoteConvListVOs(){
		RsltRnoteNoteConvListVO[] vos = (RsltRnoteNoteConvListVO[])models.toArray(new	RsltRnoteNoteConvListVO[models.size()]);
		return vos;
	}
