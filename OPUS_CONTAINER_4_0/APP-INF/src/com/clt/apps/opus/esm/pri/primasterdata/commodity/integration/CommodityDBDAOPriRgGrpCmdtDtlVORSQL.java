...
*@FileName : CommodityDBDAOPriRgGrpCmdtDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOPriRgGrpCmdtDtlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_rg_grp_cmdt_dtl 테이블 조회
	  * </pre>
	  */
	public CommodityDBDAOPriRgGrpCmdtDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOPriRgGrpCmdtDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
