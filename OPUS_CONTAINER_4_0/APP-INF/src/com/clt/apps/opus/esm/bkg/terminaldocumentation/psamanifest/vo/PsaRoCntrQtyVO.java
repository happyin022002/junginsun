...
*@FileName : PsaRoCntrQtyVO.java
*@FileTitle : PsaRoCntrQtyVO
*Open Issues :
*Change history :
...
public class PsaRoCntrQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<PsaRoCntrQtyVO> models = new ArrayList<PsaRoCntrQtyVO>();
	...
	public PsaRoCntrQtyVO() {}

	public PsaRoCntrQtyVO(String ibflag, String pagerows, String cntrQty, String bkgNo, String bkgSeq, String psaSerNo, String subPsaSerNo) {
...
/**
	 ...
	 * @param request
	 * @return PsaRoCntrQtyVO[]
	 */
	public PsaRoCntrQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaRoCntrQtyVO[]
	 */
	public PsaRoCntrQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaRoCntrQtyVO model = null;
	 ...
	 * @return PsaRoCntrQtyVO[]
	 */
	public PsaRoCntrQtyVO[] getPsaRoCntrQtyVOs(){
		PsaRoCntrQtyVO[] vos = (PsaRoCntrQtyVO[])models.toArray(new PsaRoCntrQtyVO[models.size()]);
		return vos;
	}
