...
*@FileName : KorObDgCgoVO.java
*@FileTitle : KorObDgCgoVO
*Open Issues :
*Change history :
...
public class KorObDgCgoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorObDgCgoVO> models = new ArrayList<KorObDgCgoVO>();
...
/**
	 ...
	 * @return KorObDgCgoVO[]
	 */
	public KorObDgCgoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorObDgCgoVO[]
	 */
	public KorObDgCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorObDgCgoVO model = null;
	...
	public KorObDgCgoVO[] getKorObDgCgoVOs(){
		KorObDgCgoVO[] vos = (KorObDgCgoVO[])models.toArray(new KorObDgCgoVO[models.size()]);
		return vos;
	}
