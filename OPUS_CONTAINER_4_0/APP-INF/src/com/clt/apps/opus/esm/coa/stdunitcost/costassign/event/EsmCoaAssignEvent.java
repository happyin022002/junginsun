...
public class EsmCoaAssignEvent extends EventSupport {
	...
	/**
	 * @return the coaBkgCostCalcVOs												//SJH.20150508.소스품질
	 */
	public CoaBkgCostCalcVO[] getCoaBkgCostCalcVOs() {
		CoaBkgCostCalcVO[] rtnVOs = null;
		if (this.coaBkgCostCalcVOs != null) {
			rtnVOs = Arrays.copyOf(coaBkgCostCalcVOs, coaBkgCostCalcVOs.length);
		}
		return rtnVOs;
	}

	/**
	 * @param coaBkgCostCalcVOs the coaBkgCostCalcVOs to set						//SJH.20150508.소스품질
	 */
	public void setCoaBkgCostCalcVOs(CoaBkgCostCalcVO[] coaBkgCostCalcVOs){
		if(coaBkgCostCalcVOs != null){
			CoaBkgCostCalcVO[] tmpVOs = Arrays.copyOf(coaBkgCostCalcVOs, coaBkgCostCalcVOs.length);
			this.coaBkgCostCalcVOs = tmpVOs;
		}
	}
