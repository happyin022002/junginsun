...
public class ESM_BKG_0703HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0703HTMLAction 객체를 생성
	 */
	public ESM_BKG_0703HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0703Event event = new EsmBkg0703Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
	    	...
	    	event.setTroMultiCancelFrustVOs((TroMultiCancelFrustVO[])getVOs(request, TroMultiCancelFrustVO.class));
	    	event.setBkgBlNoVO((BkgBlNoVO)getVO(request, BkgBlNoVO.class));
		}
