...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.integration.CLLCDLManifestDBDAO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestBkgQtyByCntrtsInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCllBkgVvdInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCllBlInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCllCdlForODCYVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCllCntrDescInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCllDgByCntrUnInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCllDgCntrInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCllQtyInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCntrDetailVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCntrInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestEdiTerminalInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestEtaEtdInfoVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestSearchVvdCdForRecieveInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestSpclCgoSumByPodDetailVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestSpclCgoTotalByPodDetailVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestStowDgInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestTbnTbxInfoVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CdlEdiDetailVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CdlEdiListForSplitVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CllCdlCntrInfoVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrTransmitBlInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrTransmitCntrBkgVvdInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrTransmitCntrDescInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrTransmitCntrDgInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrTransmitCntrInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrTransmitCntrQtyInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrTransmitCntrSpecialInfoVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.ExCntrVvdInfoVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.KorCllRtvOptionVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.KorCllSpclCgoContainerVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.KorCllSpclCgoDetailVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.SpclCgoEtcDetailVO;
...
import com.clt.syscommon.common.table.BkgCstmsTmlCllVO;
import com.clt.syscommon.common.table.BkgCstmsTmlEurVO;
 ...
 * - OPUS-TerminalDocumentation대한 비지니스 로직을 처리한다.<br>
 *
...
public class CLLCDLManifestBCImpl extends BasicCommandSupport implements CLLCDLManifestBC{
	...
	public List<KorCllDetailVO> searchKorCll(KorCllCondVO korCllCondVO) throws EventException{
		...
		String polCdPrint = "";
		String vpsETD = "";
		List<KorCllDetailVO> korCllDetailVOs = new ArrayList<KorCllDetailVO>();
		...
		try{
			...
			String inBlCllData = korCllCondVO.getInBlCllData();
			...
			String inPolCntCd = "";
			String bkgNoList = korCllCondVO.getBkgNoList();
			if(inPolCd.length() > 2)
			...
			String maxEdiSndDt = dbDao.searchKorCllFinalEdiDt(inVsl, inVoy, inDir, inPolCd, inPolYdCd, inCllType);
			
			if(inBlCllData.equals("CLL")){
				korCllDetailVOs = dbDao.searchKorCllList(inVsl, inVoy, inDir, inPolCd, inPolYdCd, inSortType, inBkgStsCd, inCntrCfmFlg, inCllType);
			}else if(inBlCllData.equals("BL")){		
...
//			}else{
				if(inCllType.equals("TS")){
					...
					korCllDetailVOs = dbDao.searchKorCllTsList(inVsl, inVoy, inDir, inPolCd, inPolYdCd, inBkgStsCd, inCntrCfmFlg, inSortType, inPolCntCd,bkgNoList);
				}else if(inCllType.equals("LOCAL")){
					//Container Loading List(Korea) Local Cargo Data를 조회한다.
					korCllDetailVOs = dbDao.searchKorCllLocalList(inVsl, inVoy,	inDir, inPolCd, inPolYdCd, inBkgStsCd, inCntrCfmFlg, inSortType, inPolCntCd,bkgNoList);
				...
				for(int i = 0; i < korCllDetailVOs.size(); i++){
					...
					if(!korCllDetailVO.getCllRmk3().equals("")){
						korCllDetailVO.setCllRmk1(korCllDetailVO.getCllRmk1()+"("+korCllDetailVO.getCllRmk3()+")");
					}
					/*if(inCllType.equals("TS")){
					...
					if(!awkNo.equals("")){
						if("INGU".equals(awkNo)){
							korCllDetailVO.setCllRmk2(awkNo);
						}else{
							if(korCllDetailVO.getCllRmk1()!=null && !"".equals(korCllDetailVO.getCllRmk1())){
								korCllDetailVO.setCllRmk1(korCllDetailVO.getCllRmk1() + " " + awkNo);
							}else{
						...
						//if(!bkgTempNo.equals(korCllDetailVO.getBkgNo())){
							...
							if(!bbExist.equals("")){
								korCllDetailVO.setCllRmk2(bbExist);
								korCllDetailVO.setKrTmlPrctId("");
							}
...
//			List<CLLCDLManifestSpclStowRqstByPodDetailVO> cLLCDLManifestSpclStowRqstByPodDetailVOs = null;
			List<KorCllLoadSumDetailVO> korCllLoadSumDetailVOs = null;
			List<KorCllSpclCgoSumDetailVO> korCllSpclCgoSumDetailVOs = null;
//			List<KorCllSpclStowRqstDetailVO> korCllSpclStowRqstDetailVOs = null;
//			List<KorCllSpclStowRqstDetail2VO> korCllSpclStowRqstDetail2VOs = null;
//			List<KorCllSpclStowRqstDetail3VO> korCllSpclStowRqstDetail3VOs = null;
...
//					korCllSpclStowRqstDetail3VOs = dbDao.searchSpclStowRqst3ByMlb(korCllCondVO);
				...
				korCllSumDetailVO.setCLLCDLManifestVslSkdInfoVOs(cLLCDLManifestVslSkdInfoVOs);
				if(korCllLoadSumDetailVOs!=null && korCllLoadSumDetailVOs.size() != 0)
					korCllSumDetailVO.setKorCllLoadSumDetailVOs(korCllLoadSumDetailVOs);
				if(korCllSpclCgoSumDetailVOs!=null && korCllSpclCgoSumDetailVOs.size() != 0)
...
//					korCllSumDetailVO.setKorCllSpclStowRqstDetail3VOs(korCllSpclStowRqstDetail3VOs);
	...
	public List<CllDetailVO> searchCll(CllCondVO cllCondVO) throws EventException{
		try{
			...
			cllDetailVOs = dbDao.searchCllList(cllCondVO.getInVvdCd(), cllCondVO.getInPolCd(),
					cllCondVO.getInLocalTs(), cllCondVO.getUpdUsrId());
	...
	public List<CllCdlCheckListDetailVO> searchCllCdlCheckList(CllCdlCheckCondVO cllCdlCheckCondVO)
		...
		try{
			...
			//CLL, CDL 테이블에 저장되어 있는 데이터와 비교할 OPUS 데이터를 조회한다.
	...
	public void manageCllForDownload(TerminalCllVO[] terminalCllVOs, SignOnUserAccount account) throws EventException{
		...
		TerminalCllVO partialCntrVO = null;
		try{
			if(terminalCllVOs.length > 0){
				...
				for(int i = 0; i < terminalCllVOs.length; i++){
					...
					terminalCllVO.setInIncludingType(terminalCllVOs[0].getInIncludingType());
					terminalCllVO.setInCntrMatch(terminalCllVOs[0].getInCntrMatch());

					if(!terminalCllVO.getBkgNo().equals("") && terminalCllVO.getBkgNo() != null){
						
						if("N".equals(terminalCllVO.getInIncludingType())){
							
							partialCntrVO = dbDao.searchPartialCntrData(terminalCllVO);
							if(partialCntrVO != null){
								terminalCllVO.setPrtInTeu(partialCntrVO.getPrtInTeu());
								terminalCllVO.setPrtInFeu(partialCntrVO.getPrtInFeu());
								terminalCllVO.setPrtInQty(partialCntrVO.getPrtInQty());
								terminalCllVO.setPrtPckQty(partialCntrVO.getPrtPckQty());
								terminalCllVO.setPrtPckTpCd(partialCntrVO.getPrtPckTpCd());
								terminalCllVO.setPrtCntrWgt(partialCntrVO.getPrtCntrWgt());
								terminalCllVO.setPrtCntrWgtUtCd(partialCntrVO.getPrtCntrWgtUtCd());
								terminalCllVO.setPrtDocActWgt(partialCntrVO.getPrtDocActWgt());
								terminalCllVO.setPrtDocWgtUtCd(partialCntrVO.getPrtDocWgtUtCd());
								terminalCllVO.setPrtMeasQty(partialCntrVO.getPrtMeasQty());
								terminalCllVO.setPrtMeasQtyUtCd(partialCntrVO.getPrtMeasQtyUtCd());
								terminalCllVO.setPrtDocMeasQty(partialCntrVO.getPrtDocMeasQty());
								terminalCllVO.setPrtDocMeasUtCd(partialCntrVO.getPrtDocMeasUtCd());
								terminalCllVO.setPrtVgmWgt(partialCntrVO.getPrtVgmWgt());
								terminalCllVO.setPrtVgmWgtUtCd(partialCntrVO.getPrtVgmWgtUtCd());
							}
						}
						...
						for(int j = 0; j < cLLCDLManifestCllDgByCntrUnInfoVOs.size(); j++){
							...
							bkgCstmsTmlCllDgCgoVO.setFlshPntCdoTemp(cLLCDLManifestCllDgByCntrUnInfoVO.getFlshPntCdoTemp().replace("'", "''"));
							bkgCstmsTmlCllDgCgoVO.setDgDesc(cLLCDLManifestCllDgByCntrUnInfoVO.getPrpShpNm().replace("'", "''"));
							bkgCstmsTmlCllDgCgoVO.setEmerCntcPhnNo(cLLCDLManifestCllDgByCntrUnInfoVO.getEmerCntcPhnNoCtnt().replace("'", "''"));
							bkgCstmsTmlCllDgCgoVO.setEmerCntcPsonNm(cLLCDLManifestCllDgByCntrUnInfoVO.getEmerCntcPsonNm().replace("'", "''"));
							...
							bkgCstmsTmlCllDgCgoVO.setAplyNo(cLLCDLManifestCllDgByCntrUnInfoVO.getAplyNo().replace("'", "''"));
							bkgCstmsTmlCllDgCgoVO.setDcgoRefNo(cLLCDLManifestCllDgByCntrUnInfoVO.getDcgoRefNo().replace("'", "''"));
		...
		try{
			...
			for(int i = 0; i < cllDetailVOs.length; i++){
				...
				if(cllDetailVOs[i].getIbflag().equals("I")){
					...
					bkgCstmsTmlCllVO.setVgmWgt(cllDetailVO.getVgmWgt());
					bkgCstmsTmlCllVO.setVgmWgtUtCd(cllDetailVO.getVgmWgtUtCd());
					...
					dbDao.removeCllDg(inVvdCd, inPolCd, cllDetailVO.getBkgNo2(), cllDetailVO.getCntrNo(), updUsrId);
					//Container Loading List Data를 삭제한다.
					dbDao.removeCllMain(inVvdCd, inPolCd, cllDetailVO.getBkgNo2(), cllDetailVO.getCntrNo(), updUsrId);
				}
			}
		}catch(DAOException ex){
			throw new EventException(new ErrorHandler("BKG06087", new String[]{}).getMessage(), ex);
...
//		List<CLLCDLManifestCntrDetailVO> cLLCDLManifestCntrDetailVOs = null;
		CLLCDLManifestCntrDetailVO cntrVO = null;
		String footer = "";
		String generalInfo = "";
//		String cntrNoList = "";
//		String cntrNoListTmp = "''";
//		StringBuffer cntrNoListBuffer=new StringBuffer();
		...
		try{
			...
			String inCllType = korCllCondVO.getInCllType();
			String inEdiMsgTp = korCllCondVO.getInEdiMsgTp();

			bkgUtil = new BookingUtil();

			header = bkgUtil.searchEdiHeader("NYKLE010", inRcvId, "COLDLT");
			...
			generalInfo = dbDao.searchGeneralInfo(inVslCd, inSkdVoyNo, inSkdDirCd, inPolCd, inPolYdCd, inRcvId, inEdiMsgTp, inKtmlCd,
					header.substring(71));

//			if(korCllModifyVOs != null && korCllModifyVOs.length > 0){
//				for(int i = 0; i < korCllModifyVOs.length; i++ ){
//					if("1".equalsIgnoreCase(korCllModifyVOs[i].getSelectRow())){
//						cntrNoListBuffer.append("'"+korCllModifyVOs[i].getCntrNo()+"',");
//					}
//				}
//			}
//			cntrNoListTmp = cntrNoListBuffer.toString();
//			int lastIndex = cntrNoListTmp.lastIndexOf(",");
//			if(lastIndex!=-1){
//				cntrNoList = cntrNoListTmp.substring(0, lastIndex);	
//			}
//			//Container Loading List(Korea) Container Detail 정보를 조회한다.
//			cLLCDLManifestCntrDetailVOs = dbDao.searchCntrDetail(cntrNoList, inVslCd, inSkdVoyNo, inSkdDirCd, inPolCd, inPolYdCd,
//					inRcvId,inCllType);
			...
			for(int i = 0; i < korCllModifyVOs.length; i++ ){
				if("1".equalsIgnoreCase(korCllModifyVOs[i].getSelectRow())){
					bkgNo = korCllModifyVOs[i].getBkgNo();
					cntrNo = korCllModifyVOs[i].getCntrNo();
					cntrVO = dbDao.searchCntrDetailVgm(inVslCd, inSkdVoyNo, inSkdDirCd, inPolCd, inPolYdCd, inRcvId, inCllType, bkgNo, cntrNo);
					realFlatFile.append(cntrVO.getCntrDetail());
					cnt++;
				}
			}
...
//			}
			...
			sendFlatFileVO.setQueueNm(SubSystemConfigFactory.get("BKG.OPUSBKG_UBIZCOM_CDL.IBMMQ.QUEUE"));
			...
			dbDao.modifyUpdateDt(inVslCd, inSkdVoyNo, inSkdDirCd, inPolCd, inCllType);
			...
			korCllRtvOptionVO.setInCllType(inCllType);
	...
	public String transmitCllCdlGate(CllCdlTransmitVO[] cllCdlTransmitVOs, SignOnUserAccount account) throws EventException{
		...
		try {
			// 2015-04-11 VVD/BL sup setup 구분 제거
	...
	public String transmitCllCdl(CllCdlTransmitVO[] cllCdlTransmitVOs, SignOnUserAccount account) throws EventException{
		...
		List<CllCdlCntrInfoVO> cntrSealInfoVOs = null;
		CllCdlCntrInfoVO vgmInfoVO = null;
		List<CllCdlCntrInfoVO> cntrSpclInstVOs = null;
				...
				if(inListType.equals("L")){
					...
					for(int i = 0; i < cllCdlTransmitVOs.length; i++){
						...
						for(int j = 0; j < cllCdlCntrInfoVOs.size(); j++){
							...
							//VGM 정보를 조회한다.
							vgmInfoVO = dbDao.searchCllVgmInfo(cllCdlCntrInfoVO);
							realFlatFile.append(vgmInfoVO.getCntrVgm());

							//Seal 정보를 조회한다.
							cntrSealInfoVOs = dbDao.searchCllCntrSealInfo(cllCdlCntrInfoVO);
							
							for(int k = 0; k < cntrSealInfoVOs.size(); k++)
								realFlatFile.append(cntrSealInfoVOs.get(k).getCntrSealInfo());

							//Special Instruction 정보를 조회한다.
							cntrSpclInstVOs = dbDao.searchCllCntrSpclInst(cllCdlCntrInfoVO);
							
							for(int k = 0; k < cntrSpclInstVOs.size(); k++)
								realFlatFile.append(cntrSpclInstVOs.get(k).getCntrSpclInst());
	...
	public String transmitCntrExportEdi(ExCntrTransmitCondVO exCntrTransmitCondVO, String rcvId, SignOnUserAccount account) throws EventException{
		...
		try{
			...
			bkgUtil = new BookingUtil();
			header = bkgUtil.searchEdiHeader("NYKS", rcvId, "ADEMAR");
	...
	public List<CllCdlCheckUsaVO> searchCllCdlCheckForUS(CllCdlCheckUsaCondVO cllCdlCheckUsaCondVO)
			throws EventException{
		try{
			//미주 터미널에 보낼 엑셀 형식의 데이터와 비교할 OPUS 데이터를 조회한다.
	...
	public String searchPrdBlckStwgListAsString() throws EventException{
		try{
			return dbDao.searchPrdBlckStwgListAsString();
		}catch(DAOException ex){
			throw new EventException(new ErrorHandler("BKG06086", new String[]{}).getMessage(), ex);
		}catch(Exception ex){
			throw new EventException(new ErrorHandler("BKG06086", new String[]{}).getMessage(), ex);
