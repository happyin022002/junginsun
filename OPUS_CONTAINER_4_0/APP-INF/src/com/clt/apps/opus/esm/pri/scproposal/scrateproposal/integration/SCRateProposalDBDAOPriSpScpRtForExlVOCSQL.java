...
*@FileName : SCRateProposalDBDAOPriSpScpRtForExlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtForExlVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * create PRI_SP_SCP_RT
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtForExlVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtForExlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ INDEX_DESC(A XPKPRI_SP_SCP_RT) */" ).append("\n"); 
		query.append("                  RT_SEQ" ).append("\n"); 
