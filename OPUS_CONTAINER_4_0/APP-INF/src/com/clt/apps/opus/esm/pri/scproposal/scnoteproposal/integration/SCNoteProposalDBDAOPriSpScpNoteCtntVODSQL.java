...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntVODSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_SP_SCP_NOTE_CTNT" ).append("\n"); 
