...
*@FileName       : EsmCsq0056ViewAdapter.java
 ...
 * @since CSQ USER
 */
public class EsmCsq0056ViewAdapter extends ViewAdapter {
    ...
    protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
        ...
        for(int i=0;i<realCnt;i++){
            ...
            act_flg        = getNull(colValues.get("csq_act_flg"));
			...
			sbufXML.append("<TR  EDIT='"+edit_flg+"'>");
