...
*@FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03Sub01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03Sub01RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search MonthlyQuotaInquiry0126 Tab03 Sub01
	  * </pre>
	  */
	public MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03Sub01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0126Tab03Sub01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT " ).append("\n"); 
		query.append("    6 AS sLevel, " ).append("\n"); 
		...
		query.append("                     vvd.sub_trd_cd = inp.sub_trd_cd 		" ).append("\n"); 
		query.append("        			 )														" ).append("\n"); 
