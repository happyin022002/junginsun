...
public class ZipCdListVO extends AbstractValueObject {
	...
	public ZipCdListVO(String ibflag, String pagerows, String cntCd, String zipCd, String ctyNm, String steNm, String zipDtlAddr, String evntUsrId, String usrNm, String evntOfcCd, String evntDt, String evntGdt, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg) {
		this.cntCd = cntCd;
		this.zipCd = zipCd;
		this.ctyNm = ctyNm;
		this.steNm = steNm;
