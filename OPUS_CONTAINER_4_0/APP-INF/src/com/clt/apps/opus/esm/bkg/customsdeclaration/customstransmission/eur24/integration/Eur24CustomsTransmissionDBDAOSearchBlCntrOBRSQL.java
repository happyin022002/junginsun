...
*@FileName : Eur24CustomsTransmissionDBDAOSearchBlCntrOBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24CustomsTransmissionDBDAOSearchBlCntrOBRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24CustomsTransmissionDBDAOSearchBlCntrOBRSQL
	  * </pre>
	  */
	public Eur24CustomsTransmissionDBDAOSearchBlCntrOBRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24CustomsTransmissionDBDAOSearchBlCntrOBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* Eur24BlCntrListVOs Eur24CustomsTransmissionDBDAOSearchBlCntrOB ( String blNo , String vslCd , String skdVoyNo , String skdDirCd , String cstmsPortCd) */" ).append("\n"); 
		...
		query.append("FROM BKG_CSTMS_EUR_IO_CNTR X" ).append("\n"); 
