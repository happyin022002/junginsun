...
*@FileName : AGNCommAgreementDBDAORemoveAgentRateDetailCntrListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAORemoveAgentRateDetailCntrListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAORemoveAgentRateDetailCntrListDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAORemoveAgentRateDetailCntrListDSQL").append("\n");
		query.append("*/").append("\n");
	}
