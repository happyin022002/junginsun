...
*@FileName : LocationDBDAORsltSpScpGrpLocListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAORsltSpScpGrpLocListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Proposal Group Location combo
	  * </pre>
	  */
	public LocationDBDAORsltSpScpGrpLocListVORSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAORsltSpScpGrpLocListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
