...
*@FileName : SalesAdminCommonDBDAOAddActItemMstListSCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesAdminCommonDBDAOAddActItemMstListSCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SalesAdminCommonDBDAOAddActItemMstListSCSQL(){
		setQuery();
		...
		query.append("FileName : SalesAdminCommonDBDAOAddActItemMstListSCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SAM_SLS_ACT_TP_DTL" ).append("\n"); 
		query.append("(" ).append("\n"); 
