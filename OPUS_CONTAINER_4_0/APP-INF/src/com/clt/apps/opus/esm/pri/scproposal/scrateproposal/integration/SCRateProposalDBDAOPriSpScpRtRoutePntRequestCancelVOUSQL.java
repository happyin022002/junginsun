...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutePntRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutePntRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutePntRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutePntRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_RT_ROUT_PNT SET" ).append("\n"); 
