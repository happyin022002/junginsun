...
*@FileName : MalaysiaManifestListDownloadDBDAOsearchImpStsInfoAddListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MalaysiaManifestListDownloadDBDAOsearchImpStsInfoAddListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MalaysiaManifestListDownloadDBDAOsearchImpStsInfoAddListRSQL(){
		setQuery();
		...
		query.append("FileName : MalaysiaManifestListDownloadDBDAOsearchImpStsInfoAddListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       CASE WHEN CNTR_WGT > 0 THEN" ).append("\n"); 
		...
		query.append("            ELSE" ).append("\n"); 
		query.append("              0" ).append("\n"); 
		query.append("       END AS VGM_WGT," ).append("\n"); 
		...
		query.append("--               B.POD_CD AS N2ND_POD_CD," ).append("\n"); 
