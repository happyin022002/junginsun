...
public class ACMReportDBDAOSearchCSRInquiryListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       MAX (CSR.RQST_USR_ID)   AS CRE_USR_ID," ).append("\n"); 
		query.append("       MAX (CSR.RQST_USR_NM)   AS CRE_USR_NM," ).append("\n"); 
		...
		query.append("           AND R.APRO_RQST_NO = D.APRO_RQST_NO) CSR  " ).append("\n"); 
		query.append(" WHERE AGN.CSR_NO = INH.CSR_NO" ).append("\n"); 
		query.append("   AND INH.CSR_NO = CSR.CSR_NO" ).append("\n"); 
