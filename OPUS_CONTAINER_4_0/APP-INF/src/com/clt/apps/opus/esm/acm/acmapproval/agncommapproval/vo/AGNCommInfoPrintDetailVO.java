...
*@FileName : AGNCommInfoPrintDetailVO.java
*@FileTitle : AGNCommInfoPrintDetailVO
*Open Issues :
*Change history :
...
public class AGNCommInfoPrintDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AGNCommInfoPrintDetailVO> models = new ArrayList<AGNCommInfoPrintDetailVO>();
	...
	public AGNCommInfoPrintDetailVO() {}

	public AGNCommInfoPrintDetailVO(String ibflag, String pagerows, String dtlChtAcct, String dtlGlDt, String dtlDesc, String dtlInvNo, String dtlCity, String dtlDebit, String dtlAcctNm, String dtlSeq, String dtlCredit, String hCsrNo) {
		this.hCsrNo = hCsrNo;
...
/**
	 ...
	 */
	public AGNCommInfoPrintDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AGNCommInfoPrintDetailVO[]
	 */
	public AGNCommInfoPrintDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AGNCommInfoPrintDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AGNCommInfoPrintDetailVO();
				if (hCsrNo[i] != null)
		...
		return getAGNCommInfoPrintDetailVOs();
	}
	...
	public AGNCommInfoPrintDetailVO[] getAGNCommInfoPrintDetailVOs(){
		AGNCommInfoPrintDetailVO[] vos = (AGNCommInfoPrintDetailVO[])models.toArray(new AGNCommInfoPrintDetailVO[models.size()]);
		return vos;
	}
