...
*@FileName : SCRateProposalDBDAORsltPriSpScpRtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPriSpScpRtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * search PRI_SP_SCP_RT
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriSpScpRtRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriSpScpRtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
