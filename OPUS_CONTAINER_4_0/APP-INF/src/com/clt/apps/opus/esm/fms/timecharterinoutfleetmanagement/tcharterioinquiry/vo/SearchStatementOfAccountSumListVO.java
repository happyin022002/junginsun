...
*@FileName : SearchStatementOfAccountSumListVO.java
*@FileTitle : SearchStatementOfAccountSumListVO
*Open Issues :
*Change history :
...
public class SearchStatementOfAccountSumListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchStatementOfAccountSumListVO> models = new ArrayList<SearchStatementOfAccountSumListVO>();
	...
	public SearchStatementOfAccountSumListVO() {}

	public SearchStatementOfAccountSumListVO(String ibflag, String pagerows, String itmNm, String hireNo, String acctDt, String acctDesc, String currCd1, String drAmt, String currCd2, String crAmt) {
		this.acctDt = acctDt;
		this.ibflag = ibflag;
		this.crAmt = crAmt;
		this.drAmt = drAmt;
	 ...
	 */
	public SearchStatementOfAccountSumListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchStatementOfAccountListVO[]
	 */
	public SearchStatementOfAccountSumListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchStatementOfAccountSumListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchStatementOfAccountSumListVO();
				if (acctDt[i] != null)
	 ...
	 * @return SearchStatementOfAccountListVO[]
	 */
	public SearchStatementOfAccountSumListVO[] getSearchStatementOfAccountListVOs(){
		SearchStatementOfAccountSumListVO[] vos = (SearchStatementOfAccountSumListVO[])models.toArray(new SearchStatementOfAccountSumListVO[models.size()]);
		return vos;
	}
