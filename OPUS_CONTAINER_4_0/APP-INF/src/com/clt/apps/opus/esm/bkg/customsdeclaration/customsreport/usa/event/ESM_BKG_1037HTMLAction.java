...
*@FileName : ESM_BKG_1037HTMLAction.java
...
public class ESM_BKG_1037HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0926HTMLAction 객체를 생성
     */
    public ESM_BKG_1037HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1037Event event = new EsmBkg1037Event();

		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01))
		{
			// Auth Setup 정보 조회
			event.setCondVO((AmsRailCondVO)getVO(request, AmsRailCondVO.class));
