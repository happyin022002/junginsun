...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * insert the history of PRI_SP_BLPL to PRI_SP_BLPL_MIG_HIS
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_BLPL_MIG_HIS (" ).append("\n"); 
