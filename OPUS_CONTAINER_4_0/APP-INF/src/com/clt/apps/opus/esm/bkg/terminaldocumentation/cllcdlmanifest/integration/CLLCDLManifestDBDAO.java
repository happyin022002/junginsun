...
import com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.usa.integration.UsaManifestListDownloadDBDAOsearchDownloadContainerListRSQL;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlBkgVvdInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlBlInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlChargeInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlChargeTotalInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlCntrDescInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlCstmsDescInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlDgCntrInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlMkDescInfoVO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestCdlQtyInfoVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestGateInDtInfoVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.CLLCDLManifestSpclStowRqstByPodDetailVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.KorCllCrossChkListVO;
...
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.KorCllSpclStowRqstDetail2VO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.KorCllSpclStowRqstDetail3VO;
import com.clt.apps.opus.esm.bkg.terminaldocumentation.cllcdlmanifest.vo.KorCllSpclStowRqstDetailVO;
...
/**
 * OPUS CLLCDLManifestDBDAO <br>
 * - OPUS-TerminalDocumentation system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 *
...
public class CLLCDLManifestDBDAO extends DBDAOSupport {
	...
	public List<KorCllDetailVO> searchKorCllList(String vslCd, String skdVoyNo, String skdDirCd, String polCd,
			String polYdCd, String sortType, String inBkgStsCd, String inCntrCfmFlg, String inCllType) throws DAOException {
		DBRowSet dbRowset = null;
	...
	public List<KorCllDetailVO> searchKorCllTsList(String vslCd, String skdVoyNo, String skdDirCd, String polCd,
			String polYdCd, String bkgStsCd, String cntrCfmFlg, String sortType, String inPolCntCd, String bkgNoList) throws DAOException {
		DBRowSet dbRowset = null;
		List<KorCllDetailVO> list = null;
	...
	public String searchGeneralInfo(String inVslCd, String inSkdVoyNo, String inSkdDirCd, String inPolCd,
			String inPolYdCd, String inRcvId, String inEdiMsgTp, String inKtmlCd, String flatfileRefNo) throws DAOException {
		DBRowSet dbRowset = null;
		...
		try {
			...
			param.put("in_edi_msg_tp", inEdiMsgTp);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<CLLCDLManifestCntrDetailVO>  searchCntrDetail(String cntrNoList, String inVslCd, String inSkdVoyNo, String inSkdDirCd,
			String inPolCd, String inPolYdCd, String inRcvId, String inCllType) throws DAOException {
		DBRowSet dbRowset = null;
//		String cntrDetail = "";
	 ...
	 * @param String bkgNo
	 * @param String cntrNo
	 * @return CLLCDLManifestCntrDetailVO
	 * @throws DAOException
	 * @throws Exception
	 */
	@SuppressWarnings("unchecked")
	public CLLCDLManifestCntrDetailVO  searchCntrDetailVgm(String inVslCd, String inSkdVoyNo, String inSkdDirCd,
			String inPolCd, String inPolYdCd, String inRcvId, String inCllType, String bkgNo, String cntrNo) throws DAOException {
		DBRowSet dbRowset = null;
//		String cntrDetail = "";
		List<CLLCDLManifestCntrDetailVO> list = null;
		CLLCDLManifestCntrDetailVO rsltVO = null;
		try {
			// query parameter
			Map<String, Object> param = new HashMap<String, Object>();
			param.put("in_vsl_cd", inVslCd);
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CLLCDLManifestDBDAOsearchCntrDetailForVGMRSQL(),
					param, velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, CLLCDLManifestCntrDetailVO.class);
			if (list != null && list.size() > 0) {
				rsltVO = (CLLCDLManifestCntrDetailVO) list.get(0);
			}
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<CllDetailVO> searchCllList(String vvdCd, String polCd, String localTs, String updUsrId)
			throws DAOException {
		DBRowSet dbRowset = null;
	...
	public int addKorCll(KorCllModifyVO korCllModifyVO) throws DAOException, Exception {
		...
		try {
			...
			result = sqlExe.executeUpdate((ISQLTemplate) new CLLCDLManifestDBDAOaddKorCllCSQL(), param, velParam, true);
	...
	public int addCllMainForDownload(TerminalCllVO terminalCllVO) throws DAOException, Exception {
		...
		try {
			...
			SQLExecuter sqlExe = new SQLExecuter("");
			result = sqlExe.executeUpdate((ISQLTemplate) new CLLCDLManifestDBDAOaddCllMainForDownloadCSQL(), param, velParam);
			if (result == Statement.EXECUTE_FAILED)
				throw new DAOException("Fail to update SQL");
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
	 ...
	 * @throws Exception
	 */
	public int modifyUpdateDt(String inVslCd, String inSkdVoyNo, String inSkdDirCd, String inPolCd, String inCllType)
		...
		try {
			...
			SQLExecuter sqlExe = new SQLExecuter("");
			result = sqlExe
					.executeUpdate((ISQLTemplate) new CLLCDLManifestDBDAOmodifyUpdateDtUSQL(), param, velParam, true);
			if (result == Statement.EXECUTE_FAILED)
				throw new DAOException("Fail to update SQL");
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
	 ...
	 * @throws DAOException
	 */
	public void removeCllDg(String vvdCd, String portCd, String bkgNo, String cntrNo, String usrId)
			throws DAOException, Exception {
		int result = 0;
		try {
			Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 * @throws DAOException
	 */
	public void removeCllMain(String vvdCd, String portCd, String bkgNo, String cntrNo, String usrId)
			throws DAOException, Exception {
		int result = 0;
		try {
			Map<String, Object> param = new HashMap<String, Object>();
	...
	public int addCdlEdiMain(CllCdlTransmitVO cllCdlTransmitVO) throws DAOException, Exception {
		...
		try {
			...
			log.info("############################");
			result = sqlExe.executeUpdate((ISQLTemplate) new CLLCDLManifestDBDAOaddCdlEdiMainCSQL(), param, null);
			if (result == Statement.EXECUTE_FAILED)
				throw new DAOException("Fail to update SQL");
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
	...
	public int addCdlEdiMnd() throws DAOException, Exception {
		...
		try {
			...
			//velParam.putAll(mapVO);
			SQLExecuter sqlExe = new SQLExecuter("");
			result = sqlExe.executeUpdate((ISQLTemplate) new CLLCDLManifestDBDAOaddCdlEdiMndCSQL(), param, velParam);
			if (result == Statement.EXECUTE_FAILED)
				throw new DAOException("Fail to update SQL");
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public String searchKorCllFinalEdiDt(String vslCd, String skdVoyNo, String skdDirCd, String polCd, String polYdCd, String inCllType) throws DAOException {
		DBRowSet dbRowset = null;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<CllCdlCntrInfoVO> searchCllCntrSealInfo(CllCdlCntrInfoVO cllCdlCntrInfoVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<CllCdlCntrInfoVO> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CLLCDLManifestDBDAOsearchCllCntrSealInfoRSQL(),
					param, velParam, true);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, CllCdlCntrInfoVO.class);
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
	...
	/**
	 * Container Special Instruction 정보를 조회한다.<br>
	 *
	 * @param CllCdlCntrInfoVO cllCdlCntrInfoVO
	 * @return List<CllCdlCntrInfoVO>
	 * @throws DAOException
	 */
	@SuppressWarnings("unchecked")
	public List<CllCdlCntrInfoVO> searchCllCntrSpclInst(CllCdlCntrInfoVO cllCdlCntrInfoVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<CllCdlCntrInfoVO> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CLLCDLManifestDBDAOsearchCllCntrSpclInstRSQL(),
					param, velParam, true);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, CllCdlCntrInfoVO.class);
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public String searchPrdBlckStwgListAsString() throws DAOException {
		DBRowSet dbRowset = null;
		String output_text = null;

		try {
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CLLCDLManifestDBDAOSearchPrdBlckStwgListAsStringRSQL(), null, null, true);
			if (dbRowset.next()) {
				output_text = dbRowset.getString("BLCK_STWG");
			} 
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	...
	/**
	 * Retrieve the summarized data for save the partial container as one row<br>
	 *
	 * @param TerminalCllVO terminalCllVO
	 ...
	 */
	@SuppressWarnings("unchecked")
	public TerminalCllVO searchPartialCntrData(TerminalCllVO terminalCllVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<TerminalCllVO> list = null;
		TerminalCllVO rsltVO = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CLLCDLManifestDBDAOSearchPartialCntrDataRSQL(), param, velParam, true);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, TerminalCllVO.class);
			
			if (list != null && list.size() > 0) {
				rsltVO = (TerminalCllVO) list.get(0);
			}
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	 ...
	 */
	@SuppressWarnings("unchecked")
	public CllCdlCntrInfoVO searchCllVgmInfo(CllCdlCntrInfoVO cllCdlCntrInfoVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<CllCdlCntrInfoVO> list = null;
		CllCdlCntrInfoVO rsltVO = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CLLCDLManifestDBDAOsearchCllVgmInfoRSQL(),
					param, velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, CllCdlCntrInfoVO.class);
			if (list != null && list.size() > 0) {
				rsltVO = (CllCdlCntrInfoVO) list.get(0);
			}
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
