...
public class CsScreenDBDAOsearchCntrInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("CASE WHEN (OVR_FWRD_LEN + OVR_BKWD_LEN +OVR_HGT + OVR_LF_LEN + OVR_RT_LEN) > 0  THEN 'OUT' -- arr_ntc 이 있을경우 pass" ).append("\n"); 
		query.append("ELSE 'IN' END IN_GA_FLG," ).append("\n"); 
