...
*@FileName : SCGuidelineMainDBDAOPriSgMnGlineMnCpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGuidelineMainDBDAOPriSgMnGlineMnCpCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGuidelineMainDBDAOPriSgMnGlineMnCpCSQL(){
		setQuery();
		...
		query.append("FileName : SCGuidelineMainDBDAOPriSgMnGlineMnCpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
