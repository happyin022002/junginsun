...
/**
 * ESM_SAQ_0181 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_SAQ_0181HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 * 
 * @author Han-su Kim
 * @see ESM_SAQ_0181HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmSaq0181Event extends EventSupport {

	private static final long serialVersionUID = 1L;

	public EsmSaq0181Event() {
	}
