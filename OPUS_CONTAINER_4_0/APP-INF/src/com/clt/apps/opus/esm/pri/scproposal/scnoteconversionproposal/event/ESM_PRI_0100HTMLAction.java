...
*@FileName : ESM_PRI_0100HTMLAction.java
...
public class ESM_PRI_0100HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0100HTMLAction 객체를 생성
	 */
	public ESM_PRI_0100HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0100Event event = new EsmPri0100Event();
		...
		if(command.isCommand(FormCommand.MULTI01)) {
			...
			event.setPriSpScpRtCnoteVO((PriSpScpRtCnoteVO)getVO(request, PriSpScpRtCnoteVO .class));
		}
