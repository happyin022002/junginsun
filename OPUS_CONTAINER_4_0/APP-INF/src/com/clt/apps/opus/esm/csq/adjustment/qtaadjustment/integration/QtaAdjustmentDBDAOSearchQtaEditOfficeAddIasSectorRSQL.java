...
public class QtaAdjustmentDBDAOSearchQtaEditOfficeAddIasSectorRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("AND A1.RHQ_CD||A1.RGN_OFC_CD||A1.POL_CD||A1.POD_CD NOT IN ( " ).append("\n"); 
		query.append("                                    SELECT DISTINCT RHQ_CD||RGN_OFC_CD||POL_CD||POD_CD" ).append("\n"); 
		...
		query.append("									#end" ).append("\n"); 
		query.append("                                    )" ).append("\n"); 
		query.append("ORDER BY RHQ_CD, RGN_OFC_CD, POL_CD, POD_CD" ).append("\n"); 
