...
*@FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOPriRpScpGrpLocAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAGroupLocationProposalDBPriRpScpGrpLocAmdVO
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOPriRpScpGrpLocAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	WHERE" ).append("\n"); 
		query.append("		PROP_NO 		= LOC.PROP_NO" ).append("\n"); 
