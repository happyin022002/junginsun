...
*@FileName : EsmFms0045ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmFms0045ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		if(prefix.equals("sheet1_")) {
			String[] realColNms = {"~~","to_inv_no","vvd_cd","csr_curr_cd","csr_amt","csr_desc","csr_no"};
		...
		} else if(prefix.equals("sheet2_")) {
			//String[] realColNms=getColHeader(vo);
			String[] realColNms = {"~~","acct_cd","cust_cnt_cd","cust_seq","ctr_cd","slp_loc_cd","eff_dt","csr_amt",
								   "~~","csr_desc","csr_desc1","csr_desc2","csr_desc3","csr_desc4","vvd_cd","to_inv_no"};
