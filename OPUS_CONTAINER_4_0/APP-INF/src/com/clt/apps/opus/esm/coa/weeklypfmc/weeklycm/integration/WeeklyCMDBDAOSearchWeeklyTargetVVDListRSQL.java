...
public class WeeklyCMDBDAOSearchWeeklyTargetVVDListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchWeeklyTargetVVDList SELECT
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("    AND A.IOC_CD   = B.IOC_CD" ).append("\n"); 
		query.append("    AND A.DIR_CD   = B.DIR_CD" ).append("\n"); 
		query.append("	AND NVL(TO_CHAR(A.N1ST_LODG_PORT_ETD_DT,'YYYYMMDD'),'19000101') BETWEEN NVL(B.LANE_APLY_FOM_DT,'19000101') AND NVL(B.LANE_APLY_TO_DT, '99991231')" ).append("\n"); 
