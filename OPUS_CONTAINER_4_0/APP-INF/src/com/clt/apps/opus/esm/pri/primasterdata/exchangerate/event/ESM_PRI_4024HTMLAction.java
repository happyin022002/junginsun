...
*@FileName : ESM_PRI_4024HTMLAction.java
...
public class ESM_PRI_4024HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_4024HTMLAction 객체를 생성
	 */
	public ESM_PRI_4024HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri4024Event event = new EsmPri4024Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCstGlMonXchRtVO((CstGlMonXchRtVO)getVO(request, CstGlMonXchRtVO .class));
		}
