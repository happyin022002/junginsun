...
public class GeneralBookingReceiptDBDAOAddBkgBookingCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	BKG_WT_CHK_FLG" ).append("\n"); 
		...
		query.append(",	@[bkg_ofc_cd]" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		query.append(",	(SELECT OFC_CD FROM MDM_SLS_REP WHERE UPPER(SREP_CD) = UPPER(@[ob_srep_cd]))" ).append("\n"); 
		...
		query.append(",	(select decode(CNTR_CUST_TP_CD, 'B', 'S', 'C') " ).append("\n"); 
		...
		query.append("         when length(@[bkg_no]) =  12 and 'Y' = (select 'Y' from bkg_chn_bkg_no_gen where bkg_no = @[bkg_no] and rownum = 1) " ).append("\n"); 
		query.append("			then 'Y'" ).append("\n"); 
		...
		query.append("         when length(@[bkg_no]) =  12 and 'Y' = (select 'Y' from bkg_chn_bkg_no_gen where bkg_no = @[bkg_no] and agn_flg = 'Y' and rownum = 1) " ).append("\n"); 
		query.append("			then (select chn_agn_cd from bkg_chn_bkg_no_gen where bkg_no = @[bkg_no] and agn_flg = 'Y' and rownum = 1) " ).append("\n"); 
		...
		query.append(",	@[mty_bkg_sts_cd]" ).append("\n"); 
		query.append(",	@[mty_split_aval_cd]" ).append("\n"); 
		query.append(",	(SELECT INTG_CD_VAL_CTNT FROM COM_INTG_CD_DTL WHERE 'CD01619' = INTG_CD_ID AND 1 = INTG_CD_VAL_DP_SEQ)" ).append("\n"); 
		query.append(",	@[xter_bkg_rqst_ref_no]" ).append("\n"); 
		...
		query.append(",	@[my_fwrd_cd]" ).append("\n"); 
		query.append(",	@[my_fwrd_vsl_desc]" ).append("\n"); 
		query.append(",	decode(@[bkg_pol_cd], @[pre_rly_port_cd], null, @[pre_rly_port_cd])" ).append("\n"); 
		query.append(",	decode(@[bkg_pod_cd], @[pst_rly_port_cd], null, @[pst_rly_port_cd])" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		...
		query.append(",	@[bkg_ctrl_pty_cust_cnt_cd]" ).append("\n"); 
		query.append(",	@[bkg_ctrl_pty_cust_seq]" ).append("\n"); 
		query.append(",	NVL(@[bkg_wt_chk_flg],'N')" ).append("\n"); 
		query.append(",	NVL(@[irr_bl_no_flg],'N')" ).append("\n"); 
		query.append(",	@[bkg_pty_cnt_cd]" ).append("\n"); 
		query.append(",	@[bkg_pty_cust_seq]" ).append("\n"); 
		query.append(",	SYSDATE" ).append("\n"); 
		query.append(")" ).append("\n"); 
