...
public class EsmBkg0335Event extends EventSupport {
	...
	public KorEntryTpCondVO[] getKorEntryTpCondVOs() {
		KorEntryTpCondVO[] rtnVOs = null;
		if (this.korEntryTpCondVOs != null) {
			rtnVOs = Arrays.copyOf(korEntryTpCondVOs, korEntryTpCondVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setKorEntryTpCondVOs(KorEntryTpCondVO[] korEntryTpCondVOs) {
		if (korEntryTpCondVOs != null) {
			KorEntryTpCondVO[] tmpVOs = Arrays.copyOf(korEntryTpCondVOs, korEntryTpCondVOs.length);
			this.korEntryTpCondVOs = tmpVOs;
		}
	}
