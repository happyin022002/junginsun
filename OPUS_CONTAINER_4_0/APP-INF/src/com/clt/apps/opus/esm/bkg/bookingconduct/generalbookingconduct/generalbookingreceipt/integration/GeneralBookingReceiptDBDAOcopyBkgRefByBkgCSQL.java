...
*@FileName : GeneralBookingReceiptDBDAOcopyBkgRefByBkgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingReceiptDBDAOcopyBkgRefByBkgCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralBookingReceiptDBDAOcopyBkgRefByBkgCSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingReceiptDBDAOcopyBkgRefByBkgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("and ref.cntr_no is null" ).append("\n"); 
