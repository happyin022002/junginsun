...
*@FileName : SCDurationProposalDBDAOPriSpDurAcceptVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAOPriSpDurAcceptVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Main duration Accept All
	  * </pre>
	  */
	public SCDurationProposalDBDAOPriSpDurAcceptVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAOPriSpDurAcceptVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
