...
*@FileName : MonthlyQuotaCreationDBDAOUpdateLaneAdjustUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCreationDBDAOUpdateLaneAdjustUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 버전의 Lane Adjust Data를 수정한다.
	  * </pre>
	  */
	public MonthlyQuotaCreationDBDAOUpdateLaneAdjustUSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCreationDBDAOUpdateLaneAdjustUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
