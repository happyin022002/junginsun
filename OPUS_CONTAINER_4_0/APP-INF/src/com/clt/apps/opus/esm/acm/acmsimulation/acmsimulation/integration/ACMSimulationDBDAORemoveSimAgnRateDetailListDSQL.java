...
*@FileName : ACMSimulationDBDAORemoveSimAgnRateDetailListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAORemoveSimAgnRateDetailListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAORemoveSimAgnRateDetailListDSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAORemoveSimAgnRateDetailListDSQL").append("\n");
		query.append("*/").append("\n");
	}
