...
*@FileName : Eur24ManifestDownloadDBDAOSearchBlCustInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOSearchBlCustInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_CSTMS_EUR_CUST table의 Customer정보를 VVD와 BL No.로 검색해 오는 SQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOSearchBlCustInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOSearchBlCustInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM BKG_CSTMS_EUR_CUST S, BKG_CSTMS_EUR_CUST F, BKG_CSTMS_EUR_CUST C, BKG_CSTMS_EUR_CUST N" ).append("\n"); 
