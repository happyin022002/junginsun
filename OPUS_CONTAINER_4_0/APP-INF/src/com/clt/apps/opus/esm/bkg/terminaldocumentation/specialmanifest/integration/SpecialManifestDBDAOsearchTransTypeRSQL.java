...
*@FileName : SpecialManifestDBDAOsearchTransTypeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOsearchTransTypeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOsearchTransTypeRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOsearchTransTypeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE A.ACK_RCV_STS_CD = 'A'" ).append("\n"); 
