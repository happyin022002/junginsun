...
public class SearchPrepaymentListByPaymentSlipVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String oriInvDesc = null;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("ori_inv_desc", getOriInvDesc());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("ori_inv_desc", "oriInvDesc");
    ...
    public void setOriInvDesc(String oriInvDesc) {
        this.oriInvDesc = oriInvDesc;
    }

    public String getOriInvDesc() {
        return this.oriInvDesc;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setOriInvDesc(JSPUtil.getParameter(request, prefix + "ori_inv_desc", ""));
    }
    ...
    public SearchPrepaymentListByPaymentSlipVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] oriInvDesc = (JSPUtil.getParameter(request, prefix + "ori_inv_desc", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (oriInvDesc[i] != null) 
		    		model.setOriInvDesc(oriInvDesc[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.oriInvDesc = this.oriInvDesc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
