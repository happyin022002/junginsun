...
*@FileName : KorCustomsTransmissionDBDAOsearchCntrNoKorListRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOsearchCntrNoKorListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOsearchCntrNoKorListRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOsearchCntrNoKorListRSQL").append("\n");
		query.append("*/").append("\n");
	}
