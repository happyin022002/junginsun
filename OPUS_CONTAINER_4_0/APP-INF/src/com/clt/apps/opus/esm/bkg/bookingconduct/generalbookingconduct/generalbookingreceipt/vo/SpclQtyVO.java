...
public class SpclQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpclQtyVO> models = new ArrayList<SpclQtyVO>();
	 ...
	 * @return SpclQtyVO[]
	 */
	public SpclQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpclQtyVO[]
	 */
	public SpclQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpclQtyVO model = null;
	 ...
	 * @return SpclQtyVO[]
	 */
	public SpclQtyVO[] getSpclQtyVOs(){
		SpclQtyVO[] vos = (SpclQtyVO[])models.toArray(new SpclQtyVO[models.size()]);
		return vos;
	}
