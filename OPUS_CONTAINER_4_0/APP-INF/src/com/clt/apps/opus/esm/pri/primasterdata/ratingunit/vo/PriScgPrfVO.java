...
public class PriScgPrfVO extends AbstractValueObject {
	...
	/* Column Info */
	private String cmlFdrUseFlg = null;
	/* Column Info */
	...
	public PriScgPrfVO(String ibflag, String pagerows, String svcScpCd, String chgCd, String fltPctTpCd, String pctBseCd, String subTrdUseFlg, String slanUseFlg, String porUseFlg, String polUseFlg, String podUseFlg, String delUseFlg, String imdgClssUseFlg, String tsPortUseFlg, String tmlUseFlg, String trnsModUseFlg, String usaSvcModUseFlg, String rcvDeTermUseFlg, String hngrBarUseFlg, String dirCallUseFlg, String cgoWgtUseFlg, String cmdtUseFlg, String griCmdtUseFlg, String cmlFdrUseFlg, String creUsrId, String updUsrId) {
		...
		this.cmlFdrUseFlg = cmlFdrUseFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cml_fdr_use_flg", getCmlFdrUseFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cml_fdr_use_flg", "cmlFdrUseFlg");
	 ...
	 * @return cmlFdrUseFlg
	 */
	public String getCmlFdrUseFlg() {
		return this.cmlFdrUseFlg;
	}
	 ...
	 * @param cmlFdrUseFlg
	 */
	public void setCmlFdrUseFlg(String cmlFdrUseFlg) {
		this.cmlFdrUseFlg = cmlFdrUseFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCmlFdrUseFlg(JSPUtil.getParameter(request, "cml_fdr_use_flg", ""));
	...
	public PriScgPrfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] podUseFlg = (JSPUtil.getParameter(request, prefix	+ "pod_use_flg".trim(), length));
			String[] porUseFlg = (JSPUtil.getParameter(request, prefix	+ "por_use_flg".trim(), length));
			String[] imdgClssUseFlg = (JSPUtil.getParameter(request, prefix	+ "imdg_clss_use_flg".trim(), length));
			String[] svcScpCd = (JSPUtil.getParameter(request, prefix	+ "svc_scp_cd".trim(), length));
			String[] chgCd = (JSPUtil.getParameter(request, prefix	+ "chg_cd".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			String[] usaSvcModUseFlg = (JSPUtil.getParameter(request, prefix	+ "usa_svc_mod_use_flg".trim(), length));
			String[] griCmdtUseFlg = (JSPUtil.getParameter(request, prefix	+ "gri_cmdt_use_flg".trim(), length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag".trim(), length));
			String[] rcvDeTermUseFlg = (JSPUtil.getParameter(request, prefix	+ "rcv_de_term_use_flg".trim(), length));
			String[] slanUseFlg = (JSPUtil.getParameter(request, prefix	+ "slan_use_flg".trim(), length));
			String[] tmlUseFlg = (JSPUtil.getParameter(request, prefix	+ "tml_use_flg".trim(), length));
			String[] polUseFlg = (JSPUtil.getParameter(request, prefix	+ "pol_use_flg".trim(), length));
			String[] cgoWgtUseFlg = (JSPUtil.getParameter(request, prefix	+ "cgo_wgt_use_flg".trim(), length));
			String[] tsPortUseFlg = (JSPUtil.getParameter(request, prefix	+ "ts_port_use_flg".trim(), length));
			String[] hngrBarUseFlg = (JSPUtil.getParameter(request, prefix	+ "hngr_bar_use_flg".trim(), length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id".trim(), length));
			String[] fltPctTpCd = (JSPUtil.getParameter(request, prefix	+ "flt_pct_tp_cd".trim(), length));
			String[] delUseFlg = (JSPUtil.getParameter(request, prefix	+ "del_use_flg".trim(), length));
			String[] cmlFdrUseFlg = (JSPUtil.getParameter(request, prefix	+ "cml_fdr_use_flg".trim(), length));
			String[] cmdtUseFlg = (JSPUtil.getParameter(request, prefix	+ "cmdt_use_flg".trim(), length));
			String[] trnsModUseFlg = (JSPUtil.getParameter(request, prefix	+ "trns_mod_use_flg".trim(), length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix	+ "cre_usr_id".trim(), length));
			String[] dirCallUseFlg = (JSPUtil.getParameter(request, prefix	+ "dir_call_use_flg".trim(), length));
			String[] subTrdUseFlg = (JSPUtil.getParameter(request, prefix	+ "sub_trd_use_flg".trim(), length));
			String[] pctBseCd = (JSPUtil.getParameter(request, prefix	+ "pct_bse_cd".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (cmlFdrUseFlg[i] != null)
					model.setCmlFdrUseFlg(cmlFdrUseFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.cmlFdrUseFlg = this.cmlFdrUseFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
