 ...
 *@FileName : ESM_PRI_0057_06HTMLAction.java
...
public class ESM_PRI_0057_06HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_0057_06HTMLAction 객체를 생성
	 */
	public ESM_PRI_0057_06HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri005706Event event = new EsmPri005706Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setIsConversion(request.getParameter("conv_chk"));
