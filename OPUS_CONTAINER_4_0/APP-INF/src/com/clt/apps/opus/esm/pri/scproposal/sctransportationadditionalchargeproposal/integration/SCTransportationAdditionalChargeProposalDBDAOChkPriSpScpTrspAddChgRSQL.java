...
public class SCTransportationAdditionalChargeProposalDBDAOChkPriSpScpTrspAddChgRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT ROUT_PNT_LOC_DEF_CD ||' - '|| BSE_PORT_DEF_CD ||' ('|| RAT_UT_CD ||')'" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${add_chg_note_ctnt} != '')" ).append("\n"); 
		query.append("   AND ADD_CHG_NOTE_CTNT = @[add_chg_note_ctnt]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND ADD_CHG_NOTE_CTNT IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
