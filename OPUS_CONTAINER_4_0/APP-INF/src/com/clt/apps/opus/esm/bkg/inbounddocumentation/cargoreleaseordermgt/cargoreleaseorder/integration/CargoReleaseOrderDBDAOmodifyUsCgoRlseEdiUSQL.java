...
public class CargoReleaseOrderDBDAOmodifyUsCgoRlseEdiUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       FRT_CLT_LST_DT	= DECODE(@[frt_clt_flg],FRT_CLT_FLG,FRT_CLT_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,SYSDATE,'USNYC'))," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${obl_rdem_flg} != '' )" ).append("\n"); 
		query.append("       OBL_RDEM_FLG	    = @[obl_rdem_flg]," ).append("\n"); 
		query.append("       OBL_RDEM_LST_DT	= DECODE(@[obl_rdem_flg],OBL_RDEM_FLG,OBL_RDEM_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,SYSDATE,'USNYC'))," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("       CSTMS_CLR_LST_DT	= (SELECT DECODE(@[cstms_clr_cd],CSTMS_CLR_CD,CSTMS_CLR_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,SYSDATE,'USNYC'))" ).append("\n"); 
		...
		query.append("                                     TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,SYSDATE,'USNYC'),'YYYYMMDDHH24MISS')))," ).append("\n"); 
