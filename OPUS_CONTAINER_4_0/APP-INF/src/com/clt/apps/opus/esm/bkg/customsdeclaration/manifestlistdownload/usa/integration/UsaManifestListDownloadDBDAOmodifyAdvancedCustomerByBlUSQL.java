...
*@FileName : UsaManifestListDownloadDBDAOmodifyAdvancedCustomerByBlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaManifestListDownloadDBDAOmodifyAdvancedCustomerByBlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyAdvancedCustomerByBl
	  * </pre>
	  */
	public UsaManifestListDownloadDBDAOmodifyAdvancedCustomerByBlUSQL(){
		setQuery();
		...
		query.append("FileName : UsaManifestListDownloadDBDAOmodifyAdvancedCustomerByBlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
