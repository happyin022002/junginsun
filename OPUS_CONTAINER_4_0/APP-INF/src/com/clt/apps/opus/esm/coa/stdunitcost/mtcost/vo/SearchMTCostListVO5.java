...
*@FileName : SearchMTCostListVO5.java
*@FileTitle : SearchMTCostListVO5
*Open Issues :
*Change history :
...
public class SearchMTCostListVO5 extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCostListVO5> models = new ArrayList<SearchMTCostListVO5>();
	...
	/**
	 * SearchMTCostListVO5 생성자
	 */
	public  SearchMTCostListVO5() {}
	 ...
	 */
	public SearchMTCostListVO5(String ibflag, String pagerows, String costYrmon, String fcntrEccCd, String cntrTpszCd, String eqStatus, String cntrImbalRto, String cntrImbalQty, String cntrIbQty, String cntrObQty) {
	 ...
	 */
	public SearchMTCostListVO5[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCostListVO5[]
	 */
	public SearchMTCostListVO5[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCostListVO5 model = null;
		...
		return getSearchMTCostListVO5s();
	}
	 ...
	 * @return SearchMTCostListVO5[]
	 */
	public SearchMTCostListVO5[] getSearchMTCostListVO5s(){
		SearchMTCostListVO5[] vos = (SearchMTCostListVO5[])models.toArray(new SearchMTCostListVO5[models.size()]);
		return vos;
	}
