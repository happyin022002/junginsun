...
*@FileName : SCNoteProposalDBDAOPriSpScpSpecNoteCtntListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpSpecNoteCtntListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpSpecNoteCtntListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpSpecNoteCtntListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("           )" ).append("\n"); 
		query.append("        )" ).append("\n"); 
		query.append("  ORDER BY FIRST_VALUE(A.DP_SEQ) OVER ( PARTITION BY A.NOTE_CTNT_SEQ ORDER BY A.AMDT_SEQ ), A.NOTE_CTNT_SEQ, A.AMDT_SEQ" ).append("\n"); 
