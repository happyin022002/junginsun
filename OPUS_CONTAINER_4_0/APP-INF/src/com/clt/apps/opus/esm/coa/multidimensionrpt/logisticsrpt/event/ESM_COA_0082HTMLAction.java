...
*@FileName : ESM_COA_0082HTMLAction.java
 ...
 * @see EsmCoa0082Event 참조
 * @since J2EE 1.6
 */

public class ESM_COA_0082HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0082HTMLAction 객체를 생성
	 */
	public ESM_COA_0082HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0082Event event = new EsmCoa0082Event();
