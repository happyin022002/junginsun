...
*@FileName : KorEmptyCorrInfoVO.java
*@FileTitle : KorEmptyCorrInfoVO
*Open Issues :
*Change history :
...
public class KorEmptyCorrInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorEmptyCorrInfoVO> models = new ArrayList<KorEmptyCorrInfoVO>();
	...
	public KorEmptyCorrInfoVO() {}

	public KorEmptyCorrInfoVO(String ibflag, String pagerows, String subNo, String bkgNo, String blNo, String corrCd, String corrReason, String usrId, String cltSeq, String portCd, String vvdCd, String cstmsBlNo) {
...
/**
	 ...
	 * @param request
	 * @return KorEmptyCorrInfoVO[]
	 */
	public KorEmptyCorrInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorEmptyCorrInfoVO[]
	 */
	public KorEmptyCorrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorEmptyCorrInfoVO model = null;
	 ...
	 * @return KorEmptyCorrInfoVO[]
	 */
	public KorEmptyCorrInfoVO[] getKorEmptyCorrInfoVOs(){
		KorEmptyCorrInfoVO[] vos = (KorEmptyCorrInfoVO[])models.toArray(new KorEmptyCorrInfoVO[models.size()]);
		return vos;
	}
