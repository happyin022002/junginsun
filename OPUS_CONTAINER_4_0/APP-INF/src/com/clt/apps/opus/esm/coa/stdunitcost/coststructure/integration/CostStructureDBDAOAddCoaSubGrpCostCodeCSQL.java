...
*@FileName : CostStructureDBDAOAddCoaSubGrpCostCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAOAddCoaSubGrpCostCodeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add Query for ESM_COA_2002
	  * </pre>
	  */
	public CostStructureDBDAOAddCoaSubGrpCostCodeCSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAOAddCoaSubGrpCostCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO COA_SUB_GRP_COST 	" ).append("\n"); 
		query.append("(" ).append("\n"); 
