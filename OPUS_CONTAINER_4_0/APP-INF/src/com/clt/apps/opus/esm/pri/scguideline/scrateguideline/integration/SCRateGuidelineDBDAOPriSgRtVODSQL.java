...
*@FileName : SCRateGuidelineDBDAOPriSgRtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtVODSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}