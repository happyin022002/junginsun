...
*@FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtRoutViaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOGlineCopyPriRpScpRtRoutViaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOGlineCopyPriRpScpRtRoutViaCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtRoutViaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.ORG_DEST_TP_CD, B.ROUT_VIA_SEQ) AS ROUT_VIA_SEQ" ).append("\n"); 
