...
public class KrWharfageDecMgtDBDAOsearchKrWhfDecEdiRtListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SELECT SUM(A.TTL_TON_QTY) VOL , UNLD_TP_CD IND, DECODE(@[whf_bnd_cd],'KRINC',DECODE(KR_WHF_DC_CD,'1','6','4','9',KR_WHF_DC_CD),KR_WHF_DC_CD) DC ," ).append("\n"); 
		...
		query.append("FROM BKG_KR_WHF_PORT_RT A, BKG_KR_WHF_VOL B" ).append("\n"); 
