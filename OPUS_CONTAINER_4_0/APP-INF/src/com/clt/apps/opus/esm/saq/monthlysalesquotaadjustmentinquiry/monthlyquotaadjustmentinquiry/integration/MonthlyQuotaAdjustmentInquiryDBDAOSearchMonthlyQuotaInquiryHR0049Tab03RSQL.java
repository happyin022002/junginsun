...
*@FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiryHR0049Tab03RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiryHR0049Tab03RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiryHR0049Tab03RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentInquiryDBDAOSearchMonthlyQuotaInquiryHR0049Tab03RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		                  CASE G_FLAG" ).append("\n"); 
		query.append("		                     WHEN '11111' THEN VOYAGE_LVL_1" ).append("\n"); 
		query.append("		                     WHEN '01111' THEN VOYAGE_LVL_2" ).append("\n"); 
		query.append("		                     WHEN '00111' THEN VOYAGE_LVL_2" ).append("\n"); 
		query.append("		                     WHEN '00011' THEN VOYAGE_LVL_2" ).append("\n"); 
		query.append("		                     WHEN '00001' THEN VOYAGE_LVL_5" ).append("\n"); 
		query.append("		                     WHEN '00000' THEN VOYAGE_LVL_6" ).append("\n"); 
		...
		query.append("		                                             AND    SUB_TRD_CD = SMR.SUB_TRD_CD)) AS VOYAGE_LVL_6," ).append("\n"); 
		query.append("		                          LOD," ).append("\n"); 
		query.append("		                          REV," ).append("\n"); 
		query.append("		                          CM," ).append("\n"); 
		query.append("		                          RA_CM," ).append("\n"); 
		...
		query.append("		                    FROM  (   " ).append("\n"); 
		query.append("		                            SELECT  " ).append("\n"); 
		query.append("		                                 GROUPING(DIR_CD)||GROUPING(RHQ_CD)||GROUPING(AQ_CD)||GROUPING(OFC_CD)||GROUPING(SUB_TRD_CD)AS G_FLAG," ).append("\n"); 
		query.append("		                                 MIN(SMR.DIR_CD||SMR.RHQ_CD||SMR.AQ_CD||SMR.OFC_CD||SMR.SUB_TRD_CD) AS KEY, " ).append("\n"); 
		query.append("		                                 SMR.DIR_CD, " ).append("\n"); 
		...
		query.append("							  AND SMR.DIR_CD = HDR.DIR_CD" ).append("\n"); 
		query.append("							  AND SMR.DAT_CRE_STEP_CD = '03'" ).append("\n"); 
		query.append("		                                    GROUP BY SMR.DIR_CD, SMR.RHQ_CD, NVL(SMR.AQ_CD, '  '), SMR.RGN_OFC_CD, SMR.SUB_TRD_CD, SMR.BSE_YR||SMR.BSE_MON" ).append("\n"); 
		...
		query.append("		                                                    (SMR.DIR_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.OFC_CD, SMR.YRMON)," ).append("\n"); 
		query.append("		                                                    (SMR.DIR_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.OFC_CD, SMR.SUB_TRD_CD, SMR.YRMON))    " ).append("\n"); 
		query.append("		                          ) SMR                             " ).append("\n"); 
		query.append("		                  ) SMR                                                                                   " ).append("\n"); 
		query.append("		          ) SMR " ).append("\n"); 
		query.append("		          JOIN " ).append("\n"); 
		...
		query.append("		          TMP_INPUT_PARAMS INP" ).append("\n"); 
		query.append("		          ON 1 = 1          " ).append("\n"); 
		query.append("		      GROUP BY SMR.SLEVEL, SMR.DIR_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.OFC_CD, SMR.SUB_TRD_CD, ITM.ROW_SEQ, ITM.TEXT, ITM.CODE " ).append("\n"); 
		query.append("		      ) SMR " ).append("\n"); 
