 ...
 *@FileName : ESM_BKG_1010HTMLAction.java
 *@FileTitle : ESM_BKG_1010HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_1010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1010HTMLAction 객체를 생성
	 */
	public ESM_BKG_1010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1010Event event = new EsmBkg1010Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			
			event.setKrWhfDecChkListCondVO( (KrWhfDecChkListCondVO)getVO(request, KrWhfDecChkListCondVO.class) );  
		} 		
