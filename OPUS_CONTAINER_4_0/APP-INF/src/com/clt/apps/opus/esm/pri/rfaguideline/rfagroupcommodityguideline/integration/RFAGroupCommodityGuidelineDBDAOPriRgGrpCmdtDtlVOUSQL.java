...
*@FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVOUSQL.java
...
public class RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RG_GRP_CMDT_DTL SET" ).append("\n"); 
