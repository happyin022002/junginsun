...
public class SchCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SchCustVO> models = new ArrayList<SchCustVO>();
	...
	public SchCustVO(String ibflag, String pagerows, String propOfcCd, String custCntCd, String custSeq) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return SchCustVO[]
	 */
	public SchCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SchCustVO[]
	 */
	public SchCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SchCustVO model = null;
	 ...
	 * @return SchCustVO[]
	 */
	public SchCustVO[] getSchCustVOs(){
		SchCustVO[] vos = (SchCustVO[])models.toArray(new SchCustVO[models.size()]);
		return vos;
	}
