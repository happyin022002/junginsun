 ...
 *@FileName : ESM_PRI_2078HTMLAction.java
...
public class ESM_PRI_2078HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri2078Event event = new EsmPri2078Event();
