...
*@FileName : SearchSetForm059ListVO.java
*@FileTitle : SearchSetForm059ListVO
*Open Issues :
*Change history :
...
public class SearchSetForm059ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSetForm059ListVO> models = new ArrayList<SearchSetForm059ListVO>();
	...
	public SearchSetForm059ListVO() {}

	public SearchSetForm059ListVO(String ibflag, String pagerows, String slctItmFomSeq, String slctItmFomDesc, String rptItmCd, String rptItmColNm, String rptItmDesc) {
	 ...
	 * @param request
	 * @return SearchSetForm059ListVO[]
	 */
	public SearchSetForm059ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSetForm059ListVO[]
	 */
	public SearchSetForm059ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSetForm059ListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSetForm059ListVO();
		...
		return getSearchSetForm059ListVOs();
	}
	 ...
	 * @return SearchSetForm059ListVO[]
	 */
	public SearchSetForm059ListVO[] getSearchSetForm059ListVOs(){
		SearchSetForm059ListVO[] vos = (SearchSetForm059ListVO[])models.toArray(new SearchSetForm059ListVO[models.size()]);
		return vos;
	}
