...
*@FileName : HongKongSearchBlGeneralVO.java
*@FileTitle : HongKongSearchBlGeneralVO
*Open Issues :
*Change history :
...
public class HongKongSearchBlGeneralVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<HongKongSearchBlGeneralVO> models = new ArrayList<HongKongSearchBlGeneralVO>();
	...
	public HongKongSearchBlGeneralVO() {}

	public HongKongSearchBlGeneralVO(String ibflag, String pagerows, String blNo, String polCd, String podCd, String porCd, String delCd, String blrly, String blplace, String bldate, String shpr1, String shpr2, String shpr3, String shpr4, String shpr5, String cnee1, String cnee2, String cnee3, String cnee4, String cnee5, String ntfy1, String ntfy2, String ntfy3, String ntfy4, String ntfy5, String ntfy21, String ntfy22, String ntfy23, String ntfy24, String ntfy25, String ffwd1, String ffwd2, String ffwd3, String ffwd4, String ffwd5, String expo1, String expo2, String expo3, String expo4, String expo5, String blcopy, String blorg, String blpkg, String blpkgu, String blwgt, String blwgtu, String blmea, String blmeau, String blqty, String rdtype, String hot, String frt, String cargotype, String commodity, String remark, String ausQuar, String bkgnbr, String rgnBkgnbr, String tsInd, String loh, String tmpstr2, String bkgcgotp, String bkgspedg, String bkgsperf, String bkgspeak, String bkgspebb, String bkgsperd, String cmdtcd, String cmdtNm, String mfSndDt) {
		this.remark = remark;
		this.ntfy25 = ntfy25;
		this.ntfy21 = ntfy21;
		this.blpkgu = blpkgu;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tmpstr2", getTmpstr2());
		...
		this.hashColumns.put("blqty", getBlqty());
		...
		this.hashColumns.put("frt", getFrt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tmpstr2", "tmpstr2");
		...
		this.hashFields.put("blqty", "blqty");
	 ...
	 * @param tmpstr2
	 */
	public void setTmpstr2(String tmpstr2) {
		this.tmpstr2 = tmpstr2;
	}
	 ...
	 * @param blqty
	 */
	public void setBlqty(String blqty) {
		this.blqty = blqty;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBlmeau(JSPUtil.getParameter(request, "blmeau", ""));
		...
		setTmpstr2(JSPUtil.getParameter(request, "tmpstr2", ""));
		...
		setBlqty(JSPUtil.getParameter(request, "blqty", ""));
		...
		setFrt(JSPUtil.getParameter(request, "frt", ""));
		...
		setBlwgtu(JSPUtil.getParameter(request, "blwgtu", ""));
	 ...
	 * @param request
	 * @return HongKongSearchBlGeneralVO[]
	 */
	public HongKongSearchBlGeneralVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return HongKongSearchBlGeneralVO[]
	 */
	public HongKongSearchBlGeneralVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		HongKongSearchBlGeneralVO model = null;
		...
		try {
			...
			String[] tmpstr2 = (JSPUtil.getParameter(request, prefix	+ "tmpstr2", length));
			...
			String[] loh = (JSPUtil.getParameter(request, prefix	+ "loh", length));
			...
			String[] hot = (JSPUtil.getParameter(request, prefix	+ "hot", length));
			...
			String[] blqty = (JSPUtil.getParameter(request, prefix	+ "blqty", length));
			...
			String[] frt = (JSPUtil.getParameter(request, prefix	+ "frt", length));
			...
			for (int i = 0; i < length; i++) {
				model = new HongKongSearchBlGeneralVO();
				if (remark[i] != null)
		...
		return getHongKongSearchBlGeneralVOs();
	}
	 ...
	 * @return HongKongSearchBlGeneralVO[]
	 */
	public HongKongSearchBlGeneralVO[] getHongKongSearchBlGeneralVOs(){
		HongKongSearchBlGeneralVO[] vos = (HongKongSearchBlGeneralVO[])models.toArray(new HongKongSearchBlGeneralVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tmpstr2 = this.tmpstr2 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.loh = this.loh .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.hot = this.hot .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.blqty = this.blqty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
