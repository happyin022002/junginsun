...
public class UsBlInfosVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsBlInfosVO> models = new ArrayList<UsBlInfosVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFrtCltOfcCd(JSPUtil.getParameter(request, "frt_clt_ofc_cd", ""));
	 ...
	 * @return BlInfosVO[]
	 */
	public UsBlInfosVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BlInfosVO[]
	 */
	public UsBlInfosVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsBlInfosVO model = null;
	 ...
	 * @return BlInfosVO[]
	 */
	public UsBlInfosVO[] getBlInfosVOs(){
		UsBlInfosVO[] vos = (UsBlInfosVO[])models.toArray(new UsBlInfosVO[models.size()]);
		return vos;
	}
