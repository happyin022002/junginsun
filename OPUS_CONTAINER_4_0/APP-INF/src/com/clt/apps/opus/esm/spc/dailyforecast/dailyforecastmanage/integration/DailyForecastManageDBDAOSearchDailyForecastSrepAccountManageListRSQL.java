...
public class DailyForecastManageDBDAOSearchDailyForecastSrepAccountManageListRSQL implements ISQLTemplate{
	...
	public DailyForecastManageDBDAOSearchDailyForecastSrepAccountManageListRSQL(){
		...
		params.put("fcastCustTpCd",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("       T.FCAST_SEQ," ).append("\n"); 
		...
		query.append("		 WHERE MC.CUST_CNT_CD = T.CTRT_CUST_CNT_CD " ).append("\n"); 
		query.append("		   AND MC.CUST_SEQ = T.CTRT_CUST_SEQ) AS CTRT_CUST_NM" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("   #if (${fcastCustTpCd} != 'A') " ).append("\n"); 
		query.append("   AND T.FCAST_CUST_TP_CD = @[fcastCustTpCd]" ).append("\n"); 
