...
public class BkgXterTroVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String eurTroCntrTpszCd = null;
    ...
    public BkgXterTroVO(String ibflag, String pagerows, String troSeq, String ownrTrkFlg, String actShprNm, String cntcPsonNm, String cntcPhnNo, String cntcMphnNo, String dorPstNo, String actShprAddr, String diffRmk, String isEur, String eurTroCntrTpszCd) {
        this.ibflag = ibflag;
        ...
        this.eurTroCntrTpszCd = eurTroCntrTpszCd;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("eur_tro_cntr_tpsz_cd", getEurTroCntrTpszCd());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("eur_tro_cntr_tpsz_cd", "eurTroCntrTpszCd");
    ...
    public void setEurTroCntrTpszCd(String eurTroCntrTpszCd) {
        this.eurTroCntrTpszCd = eurTroCntrTpszCd;
    }

    public String getEurTroCntrTpszCd() {
        return this.eurTroCntrTpszCd;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setIsEur(JSPUtil.getParameter(request, "is_eur", ""));
        ...
        setEurTroCntrTpszCd(JSPUtil.getParameter(request, "eur_tro_cntr_tpsz_cd", ""));
    }
    ...
    public BkgXterTroVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] eurTroCntrTpszCd = (JSPUtil.getParameter(request, prefix + "eur_tro_cntr_tpsz_cd", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (eurTroCntrTpszCd[i] != null) 
		    		model.setEurTroCntrTpszCd(eurTroCntrTpszCd[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.eurTroCntrTpszCd = this.eurTroCntrTpszCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
