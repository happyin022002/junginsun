...
*@FileName       : ESM_CSQ_0215HTMLAction.java
 ...
 * @author CSQ USER
 * @see EsmCsq0215Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0215HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0215HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0215HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0215Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCsq0215Event event = new EsmCsq0215Event();


    	if(command.isCommand(FormCommand.MULTI01)) {
			event.setCsqQtaLodRevForSectorAddListVOs((SearchQtaLoadRevForSectorAddListVO[])getVOs(request, SearchQtaLoadRevForSectorAddListVO .class,""));
		}
