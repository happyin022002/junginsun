...
*@FileName : ESM_BKG_0478HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0478HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0478HTMLAction 객체를 생성
	 */
	public ESM_BKG_0478HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0478Event event = new EsmBkg0478Event();
    	SendLogCondVO sendLogCondVO = new SendLogCondVO();
    	if(command.isCommand(FormCommand.SEARCH)) {
    		sendLogCondVO = (JapanSendLogCondVO)getVO(request, JapanSendLogCondVO.class);
			event.setJapanSendLogCondVO((JapanSendLogCondVO)sendLogCondVO);
		}
