...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntAutoAcceptUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCtntAutoAcceptUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_blpl_ctnt 에 대해 자동 승인 and  cancel
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCtntAutoAcceptUSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntAutoAcceptUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
