...
*@FileName : ESM_SAM_0005HTMLAction.java
...
public class ESM_SAM_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0005HTMLAction 객체를 생성
	 */
	public ESM_SAM_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSam0005Event event = new EsmSam0005Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSamCustSRepVO((SamCustSRepVO)getVO(request, SamCustSRepVO.class));
