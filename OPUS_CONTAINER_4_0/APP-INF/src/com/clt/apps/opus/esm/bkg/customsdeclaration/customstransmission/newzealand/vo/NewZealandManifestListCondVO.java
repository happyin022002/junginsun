...
public class NewZealandManifestListCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<NewZealandManifestListCondVO> models = new ArrayList<NewZealandManifestListCondVO>();
...
/**
	 ...
	 * @param request
	 * @return NewZealandManifestListCondVO[]
	 */
	public NewZealandManifestListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NewZealandManifestListCondVO[]
	 */
	public NewZealandManifestListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandManifestListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandManifestListCondVO();
				if (sMode[i] != null)
		...
		return getNewZealandManifestListCondVOs();
	}
	 ...
	 * @return NewZealandManifestListCondVO[]
	 */
	public NewZealandManifestListCondVO[] getNewZealandManifestListCondVOs(){
		NewZealandManifestListCondVO[] vos = (NewZealandManifestListCondVO[])models.toArray(new NewZealandManifestListCondVO[models.size()]);
		return vos;
	}
