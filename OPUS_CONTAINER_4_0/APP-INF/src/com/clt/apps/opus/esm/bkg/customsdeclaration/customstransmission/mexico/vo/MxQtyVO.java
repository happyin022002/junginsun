...
public class MxQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MxQtyVO> models = new ArrayList<MxQtyVO>();
	...
	public MxQtyVO(String ibflag, String pagerows, String hantype, String count) {
		this.ibflag = ibflag;
		this.count = count;
	 ...
	 * @return MxQtyVO[]
	 */
	public MxQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MxQtyVO[]
	 */
	public MxQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MxQtyVO model = null;
	 ...
	 * @return MxQtyVO[]
	 */
	public MxQtyVO[] getMxQtyVOs(){
		MxQtyVO[] vos = (MxQtyVO[])models.toArray(new MxQtyVO[models.size()]);
		return vos;
	}
