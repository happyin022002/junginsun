...
*@FileName : SCRoutePointProposalDBDAORsltRoutPntLocListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRoutePointProposalDBDAORsltRoutPntLocListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRoutePointProposalDBDAORsltRoutPntLocListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRoutePointProposalDBDAORsltRoutPntLocListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
