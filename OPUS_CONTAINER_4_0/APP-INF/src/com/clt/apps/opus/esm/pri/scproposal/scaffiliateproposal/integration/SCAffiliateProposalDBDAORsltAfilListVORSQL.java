...
*@FileName : SCAffiliateProposalDBDAORsltAfilListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCAffiliateProposalDBDAORsltAfilListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Amd History Affiliate List
	  * </pre>
	  */
	public SCAffiliateProposalDBDAORsltAfilListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCAffiliateProposalDBDAORsltAfilListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--AND A.AMDT_SEQ           = A.N1ST_CMNC_AMDT_SEQ -- Amend 된거만 히스토리 조회" ).append("\n"); 
		query.append("AND EXISTS (SELECT 1 " ).append("\n"); 
		query.append("	          FROM PRI_SP_AFIL" ).append("\n"); 
		query.append("		     WHERE PROP_NO  		  = A.PROP_NO" ).append("\n"); 
		query.append("		       AND AFIL_SEQ 		  = A.AFIL_SEQ" ).append("\n"); 
