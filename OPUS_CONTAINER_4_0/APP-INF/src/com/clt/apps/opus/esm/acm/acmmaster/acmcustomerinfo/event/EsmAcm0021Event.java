...
public class EsmAcm0021Event extends EventSupport {
	...
	public FACExSettingVO[] getFACExSettingVOs() {
		FACExSettingVO[] rtnVOs = null;
		if (this.facExSettingVOs != null) {
			rtnVOs = Arrays.copyOf(facExSettingVOs, facExSettingVOs.length);
		}
		return rtnVOs;
	}

	public void setFACExSettingVOs(FACExSettingVO[] facExSettingVOs) {
		if(facExSettingVOs != null){
			FACExSettingVO[] tmpVOs = Arrays.copyOf(facExSettingVOs, facExSettingVOs.length);
			this.facExSettingVOs  = tmpVOs;
		}
	}
