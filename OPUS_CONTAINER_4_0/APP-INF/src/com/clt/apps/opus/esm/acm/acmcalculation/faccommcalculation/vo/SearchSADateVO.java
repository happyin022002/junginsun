...
*@FileName : SearchSADateVO.java
*@FileTitle : SearchSADateVO
*Open Issues :
*Change history :
...
public class SearchSADateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<SearchSADateVO> models = new ArrayList<SearchSADateVO>();
...
/**
	 ...
	 */
	public SearchSADateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSADateVO[]
	 */
	public SearchSADateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSADateVO model = null;
	 ...
	 * @return SearchSADateVO[]
	 */
	public SearchSADateVO[] getSearchSADateVOs(){
		SearchSADateVO[] vos = (SearchSADateVO[])models.toArray(new SearchSADateVO[models.size()]);
		return vos;
	}
