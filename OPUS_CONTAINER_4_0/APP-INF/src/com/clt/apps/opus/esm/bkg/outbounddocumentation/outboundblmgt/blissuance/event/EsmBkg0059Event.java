...
public class EsmBkg0059Event extends EventSupport {
	...
	public DocRqstVO[] getDocRqstVOs() {
		DocRqstVO[] rtnVOs = null;
		if (this.docRqstVOs != null) {
			rtnVOs = Arrays.copyOf(docRqstVOs, docRqstVOs.length);
		}
		return rtnVOs;
	}
	public void setDocRqstVOs(DocRqstVO[] docRqstVOs) {
		if (docRqstVOs != null) {
			DocRqstVO[] tmpVOs = Arrays.copyOf(docRqstVOs, docRqstVOs.length);
			this.docRqstVOs = tmpVOs;
		}
	}
