...
*@FileName : ACMSimulationDBDAOAaddAgmtCopyDetailChgListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAaddAgmtCopyDetailChgListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOAaddAgmtCopyDetailChgListCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAaddAgmtCopyDetailChgListCSQL").append("\n");
		query.append("*/").append("\n");
	}
