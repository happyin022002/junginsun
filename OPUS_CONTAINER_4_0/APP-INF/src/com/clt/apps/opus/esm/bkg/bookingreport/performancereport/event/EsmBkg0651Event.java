...
public class EsmBkg0651Event extends EventSupport {
	...
	public void setBlCaDetailListVOS(BlCaDetailListVO[] blCaDetailListVOs){
		if(blCaDetailListVOs != null){
			BlCaDetailListVO[] tmpVOs = Arrays.copyOf(blCaDetailListVOs, blCaDetailListVOs.length);
			this.blCaDetailListVOs = tmpVOs;
		}
	}
	...
	public BlCaDetailListVO[] getBlCaDetailListVOS(){
		BlCaDetailListVO[] rtnVOs = null;
		if(this.blCaDetailListVOs != null){
			rtnVOs= Arrays.copyOf(blCaDetailListVOs, blCaDetailListVOs.length);
		}
		return rtnVOs;
	}
