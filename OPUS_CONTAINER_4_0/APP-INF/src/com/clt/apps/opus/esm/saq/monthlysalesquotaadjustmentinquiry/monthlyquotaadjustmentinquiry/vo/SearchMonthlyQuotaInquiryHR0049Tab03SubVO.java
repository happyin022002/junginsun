...
*@FileName       : SearchMonthlyQuotaInquiryHR0049Tab03SubVO.java
*@FileTitle      : SearchMonthlyQuotaInquiryHR0049Tab03SubVO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiryHR0049Tab03SubVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiryHR0049Tab03SubVO> models = new ArrayList<SearchMonthlyQuotaInquiryHR0049Tab03SubVO>();
	...
	public SearchMonthlyQuotaInquiryHR0049Tab03SubVO() {}

	public SearchMonthlyQuotaInquiryHR0049Tab03SubVO(String ibflag, String pagerows, String slevel, String dirCd, String rhqCd, String aqCd, String ofcCd, String subTrdCd, String rlaneCd, String convDirCd, String rowSeq, String itemText, String item, String val00, String val01, String val02, String val03) {
		this.val01 = val01;
		this.val02 = val02;
		this.val00 = val00;
		this.rhqCd = rhqCd;
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiryHR0049Tab03SubVO[]
	 */
	public SearchMonthlyQuotaInquiryHR0049Tab03SubVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiryHR0049Tab03SubVO[]
	 */
	public SearchMonthlyQuotaInquiryHR0049Tab03SubVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiryHR0049Tab03SubVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiryHR0049Tab03SubVO();
				if (val01[i] != null)
		...
		return getSearchMonthlyQuotaInquiryHR0049Tab03SubVOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiryHR0049Tab03SubVO[]
	 */
	public SearchMonthlyQuotaInquiryHR0049Tab03SubVO[] getSearchMonthlyQuotaInquiryHR0049Tab03SubVOs(){
		SearchMonthlyQuotaInquiryHR0049Tab03SubVO[] vos = (SearchMonthlyQuotaInquiryHR0049Tab03SubVO[])models.toArray(new SearchMonthlyQuotaInquiryHR0049Tab03SubVO[models.size()]);
		return vos;
	}
