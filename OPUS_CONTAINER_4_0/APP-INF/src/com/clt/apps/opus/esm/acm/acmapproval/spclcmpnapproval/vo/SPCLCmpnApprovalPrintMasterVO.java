...
*@FileName : SPCLCmpnApprovalPrintMasterVO.java
*@FileTitle : SPCLCmpnApprovalPrintMasterVO
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalPrintMasterVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<SPCLCmpnApprovalPrintMasterVO> models = new ArrayList<SPCLCmpnApprovalPrintMasterVO>();
...
/**
	 ...
	 */
	public SPCLCmpnApprovalPrintMasterVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SPCLCmpnApprovalPrintMasterVO[]
	 */
	public SPCLCmpnApprovalPrintMasterVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SPCLCmpnApprovalPrintMasterVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SPCLCmpnApprovalPrintMasterVO();
				if (hdrAmt[i] != null)
		...
		return getSPCLCmpnApprovalPrintMasterVOs();
	}
	...
	public SPCLCmpnApprovalPrintMasterVO[] getSPCLCmpnApprovalPrintMasterVOs(){
		SPCLCmpnApprovalPrintMasterVO[] vos = (SPCLCmpnApprovalPrintMasterVO[])models.toArray(new SPCLCmpnApprovalPrintMasterVO[models.size()]);
		return vos;
	}
