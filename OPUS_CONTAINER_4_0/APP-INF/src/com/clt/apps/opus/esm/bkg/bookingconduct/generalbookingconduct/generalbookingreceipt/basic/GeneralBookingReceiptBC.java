...
public interface GeneralBookingReceiptBC {
	...
	/**
	 * Allocation Status瑜� manage�븳�떎.<br>
	 * 
	 * @param BkgBlNoVO bkgblNoVO
	 * @param SignOnUserAccount account
	...
	/**
	 * EXPORT REFERENCES瑜� 議고쉶�븳�떎.(BY CNTR)
	 * @param ExportReferencesVO exportReferencesVO
	 * @return List<ExportReferencesVO>
	 * @exception EventException
	 */
	...
	/**
	 * eBooking S/I�뿉�꽌 BKG�쑝濡� �뾽濡쒕뱶�맂 Customer Name & Address�쓽 Overlfow �뿬遺�瑜� 議고쉶�븳�떎.
	 *
	...
	/**
	 * Booking cutomer tab�뿉�꽌 cleared�븳 customer �젙蹂대�� �뾽�뜲�씠�듃 �븳�떎.
	 *
	 * @param XterCustOvflwFlgStatusVO xterCustOvflwFlgStatusVO
	...
	/**
	 * CTM에서 Container 가 attach 되는 경우 Vol=1 인 경우에 해당하는 BKG_REFERENCE 중에 UCR 의 cntr_no를 업데이트함.
	 * @param BkgRefDtlVO bkgRefDtlVO
	 * @param String usrId
	 * @throws EventException
	 */
