...
public class ESM_BKG_0125HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0125Event event = new EsmBkg0125Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			
			event.setKrWhfBlChkListCondVO( (KrWhfBlChkListCondVO)getVO(request, KrWhfBlChkListCondVO.class) );  
		} 		
