...
public class TransshipmentMgtDBDAOsearchTSListBy1st2ndVVDListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("select decode(nvl(rmk.ts_rmk, 'null'), 'null', '0', '1') rmk" ).append("\n"); 
		...
		query.append("		, vvd1.vsl_cd||vvd1.skd_voy_no||vvd1.skd_dir_cd firstvvd " ).append("\n"); 
		query.append("		, to_char(skd1.vps_etb_dt,'yyyy-mm-dd') firstetb" ).append("\n"); 
		query.append("		, vvd2.slan_cd nextlane" ).append("\n"); 
		query.append("        , vvd2.vsl_cd||vvd2.skd_voy_no||vvd2.skd_dir_cd nextvvd   " ).append("\n"); 
		...
		query.append("		            WHERE CNTR.CNTR_TPSZ_CD = TPSZ.CNTR_TPSZ_CD)), 0) wgt" ).append("\n"); 
		...
		query.append("       , vvd2.pod_yd_cd" ).append("\n"); 
