...
*@FileName : EsmBkg1516Event.java
*@FileTitle : EsmBkg1516Event
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
/**
 * ESM_BKG_1516에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_BKG_1516HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author KIM, Sang-Soo
 * @see ESM_BKG_1516HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmBkg1516Event extends EventSupport {
