...
*@FileName : SCRateProposalDBDAORsltRsltPriSpScpRtCmdtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRsltPriSpScpRtCmdtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SELECT PRI_SP_SCP_RT_CMDT
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRsltPriSpScpRtCmdtRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRsltPriSpScpRtCmdtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
