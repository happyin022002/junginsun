...
*@FileName : UnmatchBLDBDAOCheckTaaEffectiveDateDiscrepancyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckTaaEffectiveDateDiscrepancyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * checkTaaEffectiveDateDiscrepancy
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckTaaEffectiveDateDiscrepancyRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckTaaEffectiveDateDiscrepancyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
