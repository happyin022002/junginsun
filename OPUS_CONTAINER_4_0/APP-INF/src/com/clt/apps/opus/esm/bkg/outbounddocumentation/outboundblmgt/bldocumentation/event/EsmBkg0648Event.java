...
public class EsmBkg0648Event extends EventSupport {
	...
	public BlCopyInVO[] getBlCopyIns(){
		BlCopyInVO[] rtnVOs = null;
		if(this.blCopyIns != null){
			rtnVOs = Arrays.copyOf(blCopyIns, blCopyIns.length);
		}
		return rtnVOs;
	}
	...
	public void setBlCopyIns(BlCopyInVO[] blCopyIns){
		if(blCopyIns != null){
			BlCopyInVO[] tmpVOs = Arrays.copyOf(blCopyIns, blCopyIns.length);
			this.blCopyIns = tmpVOs;
		}
	}
