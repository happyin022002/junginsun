...
public class CndCustomsReportDBDAOsearchCndAdviceNotesRSQL implements ISQLTemplate{
	...
	public CndCustomsReportDBDAOsearchCndAdviceNotesRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.bkg.customsdeclaration.customsreport.canada.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("       ,(SELECT TO_CHAR(HIS.SND_DT, 'YYYY-MM-DD HH24:MI') " ).append("\n"); 
		query.append("           FROM BKG_NTC_HIS HIS" ).append("\n"); 
		query.append("           WHERE HIS.BKG_NO = A.BKG_NO" ).append("\n"); 
		query.append("             AND HIS.NTC_VIA_CD ='F'" ).append("\n"); 
		query.append("             AND HIS.HIS_SEQ = (SELECT MAX(B.HIS_SEQ)" ).append("\n"); 
		query.append("                                  FROM BKG_NTC_HIS B " ).append("\n"); 
		query.append("                                 WHERE B.BKG_NO = HIS.BKG_NO" ).append("\n"); 
		query.append("                                   AND B.NTC_VIA_CD ='F'" ).append("\n"); 
		query.append("                                   AND B.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("                                   AND B.BKG_CUST_TP_CD = HIS.BKG_CUST_TP_CD)" ).append("\n"); 
		query.append("             AND HIS.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("             AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("          ) AS FAX_SND_DT" ).append("\n"); 
		...
		query.append("            FROM BKG_NTC_HIS HIS" ).append("\n"); 
		query.append("           WHERE HIS.BKG_NO = A.BKG_NO" ).append("\n"); 
		query.append("             AND HIS.NTC_VIA_CD ='M'" ).append("\n"); 
		query.append("             AND HIS.HIS_SEQ = (SELECT MAX(B.HIS_SEQ)" ).append("\n"); 
		query.append("                                  FROM BKG_NTC_HIS B " ).append("\n"); 
		query.append("                                 WHERE B.BKG_NO = HIS.BKG_NO" ).append("\n"); 
		query.append("                                   AND B.NTC_VIA_CD ='M'" ).append("\n"); 
		query.append("                                   AND B.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("                                   AND B.BKG_CUST_TP_CD = HIS.BKG_CUST_TP_CD)" ).append("\n"); 
		query.append("             AND HIS.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("             AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		...
		query.append("        , (SELECT HIS.SND_USR_ID " ).append("\n"); 
		query.append("            FROM BKG_NTC_HIS HIS" ).append("\n"); 
		query.append("           WHERE HIS.BKG_NO = A.BKG_NO" ).append("\n"); 
		query.append("             AND HIS.NTC_VIA_CD ='F'" ).append("\n"); 
		query.append("             AND HIS.HIS_SEQ = (SELECT MAX(B.HIS_SEQ)" ).append("\n"); 
		...
		query.append("             AND HIS.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("             AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("          ) AS FAX_SND_USR_ID" ).append("\n"); 
		...
		query.append("             AND HIS.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("             AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("          ) AS EML_SND_USR_ID" ).append("\n"); 
		...
		query.append("           WHERE USR_ID = (SELECT HIS.SND_USR_ID " ).append("\n"); 
		query.append("                             FROM BKG_NTC_HIS HIS" ).append("\n"); 
		query.append("                            WHERE HIS.BKG_NO = A.BKG_NO" ).append("\n"); 
		query.append("                              AND HIS.NTC_VIA_CD ='F'" ).append("\n"); 
		query.append("                              AND HIS.HIS_SEQ = (SELECT MAX(B.HIS_SEQ)" ).append("\n"); 
		...
		query.append("                              AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("                              )" ).append("\n"); 
		query.append("         ) AS FAX_SND_USR_NM" ).append("\n"); 
		query.append("       ,(SELECT USR_NM" ).append("\n"); 
		query.append("            FROM COM_USER" ).append("\n"); 
		query.append("           WHERE USR_ID = (SELECT HIS.SND_USR_ID " ).append("\n"); 
		query.append("                             FROM BKG_NTC_HIS HIS" ).append("\n"); 
		...
		query.append("             			      AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("          					)" ).append("\n"); 
		query.append("          ) AS EML_SND_USR_NM  " ).append("\n"); 
		...
		query.append("      , (SELECT HIS.BKG_NTC_SND_RSLT_CD " ).append("\n"); 
		query.append("            FROM BKG_NTC_HIS HIS" ).append("\n"); 
		query.append("           WHERE HIS.BKG_NO = A.BKG_NO" ).append("\n"); 
		query.append("             AND HIS.NTC_VIA_CD ='F'" ).append("\n"); 
		query.append("             AND HIS.HIS_SEQ = (SELECT MAX(B.HIS_SEQ)" ).append("\n"); 
		...
		query.append("             AND HIS.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("             AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("          ) AS FAX_PROC_STS_CD" ).append("\n"); 
		query.append("       , (SELECT HIS.BKG_NTC_SND_RSLT_CD " ).append("\n"); 
		query.append("            FROM BKG_NTC_HIS HIS" ).append("\n"); 
		query.append("           WHERE HIS.BKG_NO = A.BKG_NO" ).append("\n"); 
		query.append("             AND HIS.NTC_VIA_CD ='M'" ).append("\n"); 
		...
		query.append("             AND HIS.NTC_KND_CD ='AV'" ).append("\n"); 
		query.append("             AND HIS.BKG_CUST_TP_CD = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("          ) AS EML_PROC_STS_CD" ).append("\n"); 
		...
		query.append("       ,ROW_NUMBER() OVER(PARTITION BY A.BL_NO, BC.BKG_CUST_TP_CD ORDER BY A.BL_NO, FAX.HIS_SEQ DESC, EML.HIS_SEQ DESC) AS RNUM" ).append("\n"); 
		query.append("  FROM  (" ).append("\n"); 
		...
		query.append("   AND  C.BKG_CUST_TP_CD        = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = D1.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  D1.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  D1.CUST_CNTC_TP_CD(+)   = 'C1'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = D2.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  D2.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  D2.CUST_CNTC_TP_CD(+)   = 'C2'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = D3.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  D3.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  D3.CUST_CNTC_TP_CD(+)   = 'B1'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = D4.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  D4.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  D4.CUST_CNTC_TP_CD(+)   = 'B2'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = D5.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  D5.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  D5.CUST_CNTC_TP_CD(+)   = 'AN'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = E1.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  E1.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  E1.CUST_CNTC_TP_CD(+)   = 'C1'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = E2.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  E2.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  E2.CUST_CNTC_TP_CD(+)   = 'C2'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = E3.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  E3.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  E3.CUST_CNTC_TP_CD(+)   = 'B1'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = E4.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  E4.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		query.append("   AND  E4.CUST_CNTC_TP_CD(+)   = 'B2'" ).append("\n"); 
		query.append("   AND  BC.BKG_NO                = E5.BKG_NO(+)" ).append("\n"); 
		query.append("   AND  E5.BKG_CUST_TP_CD(+)    = BC.BKG_CUST_TP_CD" ).append("\n"); 
		...
		query.append("   AND BC.BKG_CUST_TP_CD IN ('C', 'N')" ).append("\n"); 
		query.append("   AND ( (BKG.SAM_CNEE_NTFY_FLG = 'N'" ).append("\n"); 
		query.append("           AND BKG.CUST_TO_ORD_FLG = 'N' -- Consignee, Notify둘다 생성" ).append("\n"); 
		query.append("           )" ).append("\n"); 
		query.append("          OR (BKG.SAM_CNEE_NTFY_FLG = 'Y'  -- Notify는 Consignee와 같으므로 Consignee만 생성" ).append("\n"); 
		query.append("               AND BC.BKG_CUST_TP_CD = 'C'" ).append("\n"); 
		query.append("              )" ).append("\n"); 
		query.append("           OR (BKG.CUST_TO_ORD_FLG = 'Y'    -- Notify에게 연락하므로 Notify만 생성" ).append("\n"); 
		query.append("                AND BC.BKG_CUST_TP_CD = 'N'" ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("          )" ).append("\n"); 
