...
*@FileName : KorCntrInfoCondVO.java
*@FileTitle : KorCntrInfoCondVO
*Open Issues :
*Change history :
...
public class KorCntrInfoCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorCntrInfoCondVO> models = new ArrayList<KorCntrInfoCondVO>();
	...
	public KorCntrInfoCondVO() {}

	public KorCntrInfoCondVO(String ibflag, String pagerows, String bkgNo, String cstmsDeclTpCd, String portCd, String trnsSeq, String cBlNo) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return KorCntrInfoCondVO[]
	 */
	public KorCntrInfoCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCntrInfoCondVO[]
	 */
	public KorCntrInfoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCntrInfoCondVO model = null;
	 ...
	 * @return KorCntrInfoCondVO[]
	 */
	public KorCntrInfoCondVO[] getKorCntrInfoCondVOs(){
		KorCntrInfoCondVO[] vos = (KorCntrInfoCondVO[])models.toArray(new KorCntrInfoCondVO[models.size()]);
		return vos;
	}
