...
*@FileName : CODCorrectionDBDAOCODEmailSendRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CODCorrectionDBDAOCODEmailSendRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CODCorrectionDBDAOCODEmailSendRSQL(){
		setQuery();
		...
		query.append("FileName : CODCorrectionDBDAOCODEmailSendRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("						AND 		PIC.LANE_PIC_TP_CD = 'I'                          " ).append("\n"); 
		query.append("                        )" ).append("\n"); 
