...
*@FileName       : ESM_CSQ_0204HTMLAction.java
 ...
 * @author CSQ USER
 * @see EsmCsq0204Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0204HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_CSQ_0204HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0204HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0204Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCsq0204Event event = new EsmCsq0204Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
			event.setCsqSctrLaneOfcVOS((CsqSctrLaneOfcVO[])getVOs(request, CsqSctrLaneOfcVO .class));
