...
public class RocsManifestListDownloadDBDAOsearchBlCountRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("'BKG' ttl,NVL(SUM(DECODE(DECODE(vvd.BDR_FLG,null,0,1),0,0,1)),0) BL_COUNT" ).append("\n"); 
		...
		query.append("AND bdr.POL_CLPT_IND_SEQ(+) = VVD.POL_CLPT_IND_SEQ" ).append("\n"); 
		query.append("AND SKD.CLPT_IND_SEQ = VVD.POL_CLPT_IND_SEQ(+)" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT 'ROCS' ttl,count(*)  BL_COUNT" ).append("\n"); 
		...
		query.append("FROM   BKG_CSTMS_RTM_CNTR CNTR, BKG_CSTMS_RTM_CGO_MF CMD" ).append("\n"); 
