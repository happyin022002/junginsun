...
*@FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailCntrHisListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgmtCopyDetailCntrHisListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgmtCopyDetailCntrHisList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgmtCopyDetailCntrHisListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailCntrHisListCSQL").append("\n");
		query.append("*/").append("\n");
	}
