...
*@FileName : TransferOrderIssueDBDAOmodifyEurTroPctlNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOmodifyEurTroPctlNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * eur tro에 pctlNo를 update한다.
	  * </pre>
	  */
	public TransferOrderIssueDBDAOmodifyEurTroPctlNoUSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAOmodifyEurTroPctlNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
