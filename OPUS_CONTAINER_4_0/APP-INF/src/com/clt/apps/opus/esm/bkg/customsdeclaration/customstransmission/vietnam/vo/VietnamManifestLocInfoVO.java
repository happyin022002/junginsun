...
*@FileName : VietnamManifestLocInfoVO.java
*@FileTitle : VietnamManifestLocInfoVO
*Open Issues :
*Change history :
...
public class VietnamManifestLocInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VietnamManifestLocInfoVO> models = new ArrayList<VietnamManifestLocInfoVO>();
	...
	public VietnamManifestLocInfoVO() {}

	public VietnamManifestLocInfoVO(String ibflag, String pagerows, String seq, String locType, String locCd, String locNm, String locEta, String locEtd) {
		this.locEta = locEta;
		this.locCd = locCd;
		this.ibflag = ibflag;
		this.locEtd = locEtd;
...
/**
	 ...
	 * @param request
	 * @return VietnamManifestLocInfoVO[]
	 */
	public VietnamManifestLocInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VietnamManifestLocInfoVO[]
	 */
	public VietnamManifestLocInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VietnamManifestLocInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new VietnamManifestLocInfoVO();
				if (locEta[i] != null)
		...
		return getVietnamManifestLocInfoVOs();
	}
	 ...
	 * @return VietnamManifestLocInfoVO[]
	 */
	public VietnamManifestLocInfoVO[] getVietnamManifestLocInfoVOs(){
		VietnamManifestLocInfoVO[] vos = (VietnamManifestLocInfoVO[])models.toArray(new VietnamManifestLocInfoVO[models.size()]);
		return vos;
	}
