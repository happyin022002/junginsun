...
*@FileName : BSAManageDBDAOSearchRFCostListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOSearchRFCostListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSAManageDBDAOSearchRFCostListRSQL
	  * </pre>
	  */
	public BSAManageDBDAOSearchRFCostListRSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOSearchRFCostListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      MAX(A.RF_SCG_SLT_PRC_SEQ) OVER(PARTITION BY A.TRD_CD||A.RLANE_CD||A.DIR_CD||A.BSA_SLT_COST_TP_CD) MAXSEQ, " ).append("\n"); 
		query.append("      A.TRD_CD, " ).append("\n"); 
		query.append("      A.RLANE_CD, " ).append("\n"); 
		query.append("      A.DIR_CD, " ).append("\n"); 
		query.append("      A.RT_TEU_FLG, " ).append("\n"); 
		query.append("      A.BSA_SLT_COST_TP_CD, " ).append("\n"); 
		query.append("      A.RF_SCG_SLT_PRC_SEQ, " ).append("\n"); 
		...
		query.append("FROM    BSA_RF_SCG_MST     A " ).append("\n"); 
		query.append("       ,BSA_RF_SCG_SLT_PRC B " ).append("\n"); 
		query.append("WHERE   " ).append("\n"); 
		query.append("      A.BSA_SLT_COST_TP_CD  = B.BSA_SLT_COST_TP_CD  " ).append("\n"); 
		query.append("  AND A.TRD_CD				= B.TRD_CD" ).append("\n"); 
		query.append("  AND A.RLANE_CD			= B.RLANE_CD" ).append("\n"); 
		query.append("  AND A.DIR_CD				= B.DIR_CD" ).append("\n"); 
		query.append("  AND A.RF_SCG_SLT_PRC_SEQ  = B.RF_SCG_SLT_PRC_SEQ " ).append("\n"); 
		query.append("  AND A.BSA_SLT_COST_TP_CD 	= @[rdotype] " ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append("  AND A.BSA_SLT_PRC_TO_DT 	>= @[txtsdate] " ).append("\n"); 
		query.append("  AND A.DELT_FLG 			= 'N'  /*Legacy전환 요건 협의결과 요청사항(JOO vs BSA)*/" ).append("\n"); 
