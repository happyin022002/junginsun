...
*@FileName : SCMQCProposalDBDAOPriSpMqcAcceptVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCMQCProposalDBDAOPriSpMqcAcceptVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCMQCProposalDBDAOPriSpMqcAcceptVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCMQCProposalDBDAOPriSpMqcAcceptVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_MQC MQC SET " ).append("\n"); 
		...
		query.append("			 			  	  AND MN.AMDT_SEQ = MQC.AMDT_SEQ ),'R', COFFR_MQC_QTY,PROP_MQC_QTY )" ).append("\n"); 
