...
public class ArrivalNoticeDBDAOsearchArrNtcMatchCustListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                    OR BCST.VAL_CD <> 'X' -- is null or not Auto-Cancel" ).append("\n"); 
		query.append("                   )" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		query.append("            LEFT OUTER JOIN MDM_CUSTOMER MCST ON  -- (customer와 join이 안되어도 데이터 나타나야 함" ).append("\n"); 
