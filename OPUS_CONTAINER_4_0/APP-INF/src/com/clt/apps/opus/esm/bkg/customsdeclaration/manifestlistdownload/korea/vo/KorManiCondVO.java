...
*@FileName : KorManiCondVO.java
*@FileTitle : KorManiCondVO
*Open Issues :
*Change history :
...
public class KorManiCondVO extends ManiCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<KorManiCondVO> models = new ArrayList<KorManiCondVO>();
	...
	public KorManiCondVO() {}

	public KorManiCondVO(String ibflag, String pagerows, String userId, String mrnNo, String mrnChkNo, String vslCd, String skdVoyNo, String skdDirCd, String portCd) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 */
	public KorManiCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorManifestMFTTransmitVO[]
	 */
	public KorManiCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorManiCondVO model = null;
	 ...
	 * @return KorManifestMFTTransmitVO[]
	 */
	public KorManiCondVO[] getKorManifestMFTTransmitVOs(){
		KorManiCondVO[] vos = (KorManiCondVO[])models.toArray(new KorManiCondVO[models.size()]);
		return vos;
	}
