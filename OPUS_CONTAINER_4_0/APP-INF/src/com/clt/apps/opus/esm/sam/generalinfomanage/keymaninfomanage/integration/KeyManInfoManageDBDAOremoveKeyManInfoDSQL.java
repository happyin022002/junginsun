...
*@FileName : KeyManInfoManageDBDAOremoveKeyManInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KeyManInfoManageDBDAOremoveKeyManInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KeyManInfoManageDBDAOremoveKeyManInfoDSQL(){
		setQuery();
		...
		query.append("FileName : KeyManInfoManageDBDAOremoveKeyManInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SAM_CUST_KMAN_INFO" ).append("\n"); 
