...
*@FileName : AGTAuditDBDAOAGTCommTobeApprovedConfirmUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOAGTCommTobeApprovedConfirmUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTAuditDBDAOAGTCommTobeApprovedConfirmUSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOAGTCommTobeApprovedConfirmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND	((@[scn_id]	= 'AGTCOMM'	AND	AC_TP_CD <>	'T') OR	(@[scn_id] = 'OTHER' AND AC_TP_CD =	'T')) --scnId" ).append("\n"); 
