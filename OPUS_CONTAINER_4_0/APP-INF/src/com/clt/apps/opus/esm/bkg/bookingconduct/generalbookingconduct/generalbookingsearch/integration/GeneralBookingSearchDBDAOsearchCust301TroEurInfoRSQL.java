...
public class GeneralBookingSearchDBDAOsearchCust301TroEurInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	|| 'TRM_INSTRUCTION:'	||replace(nvl(tro.SPCL_INSTR_RMK, ' '), chr(10), ' ')|| CHR(10)" ).append("\n"); 
		...
		query.append("	|| 'TRD_ADDR:'			||replace(nvl(dtl.DOR_ADDR,' '),chr(10),' ')|| CHR(10)" ).append("\n"); 
		...
		query.append("    || 'TRD_DOOR_DT_GTM:'	||to_char(GLOBALDATE_PKG.TIME_CONV_FNC(dtl.LOC_CD,dtl.ARR_DT,'GMT'), 'RRRRMMDDHH24MI') || CHR(10)" ).append("\n"); 
		...
		query.append("    || 'TRD_EMAIL:'			||DTL.CNTC_EML										|| CHR(10)" ).append("\n"); 
