...
*@FileName : SearchMTCostListVO11.java
*@FileTitle : SearchMTCostListVO11
*Open Issues :
*Change history :
...
* 2010.02.16 임옥영 품질검토 결과 반영 Line No. 113 :  : shall be matched with size of parameter
=========================================================*/
...
public class SearchMTCostListVO11 extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCostListVO11> models = new ArrayList<SearchMTCostListVO11>();
	...
	/**
	 * SearchMTCostListVO11 생성자
	 */
	public SearchMTCostListVO11() {}
	 ...
	 */
	public SearchMTCostListVO11[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCostListVO11[]
	 */
	public SearchMTCostListVO11[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCostListVO11 model = null;
		...
		try {
			...
			String[] s_lccCd = (JSPUtil.getParameter(request, prefix	+ "lcc_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMTCostListVO11();
		...
		return getSearchMTCostListVO11s();
	}
	 ...
	 * @return SearchMTCostListVO11[]
	 */
	public SearchMTCostListVO11[] getSearchMTCostListVO11s(){
		SearchMTCostListVO11[] vos = (SearchMTCostListVO11[])models.toArray(new SearchMTCostListVO11[models.size()]);
		return vos;
	}
