...
*@FileName : UsCntrSoDtlInfosVO.java
*@FileTitle : UsCntrSoDtlInfosVO
*Open Issues :
*Change history :
...
public class UsCntrSoDtlInfosVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsCntrSoDtlInfosVO> models = new ArrayList<UsCntrSoDtlInfosVO>();
	...
	public UsCntrSoDtlInfosVO() {}

	public UsCntrSoDtlInfosVO(String usrNm, String ibflag, String pagerows, String cntrNo, String spCode, String spName, String spTelNo, String costMode, String nodCd, String stsCd, String ofcCd, String usrId, String soNo, String soDate, String woNo, String woDate) {
		this.spName = spName;
		this.soNo = soNo;
		this.woDate = woDate;
	 ...
	 * @param request
	 * @return UsCntrSoDtlInfosVO[]
	 */
	public UsCntrSoDtlInfosVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsCntrSoDtlInfosVO[]
	 */
	public UsCntrSoDtlInfosVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsCntrSoDtlInfosVO model = null;
	 ...
	 * @return UsCntrSoDtlInfosVO[]
	 */
	public UsCntrSoDtlInfosVO[] getUsCntrSoDtlInfosVOs(){
		UsCntrSoDtlInfosVO[] vos = (UsCntrSoDtlInfosVO[])models.toArray(new UsCntrSoDtlInfosVO[models.size()]);
		return vos;
	}
