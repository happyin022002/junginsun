...
public class EurCustomsTransmissionDBDAOsearchVslEtcInfoVslRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ,NVL(E.LOC_CD, A.POL_CD) BLPOL1" ).append("\n"); 
		query.append("       ,E.LOC_CD||SUBSTR(A.POL_YD_CD,6,2) POL_YD" ).append("\n"); 
		query.append("	   ,E.LOC_NM POL_FULLNAME1" ).append("\n"); 
		query.append("	   ,NVL(F.LOC_CD, A.POD_CD) BLPOD1" ).append("\n"); 
		query.append("       ,F.LOC_CD||SUBSTR(A.POD_YD_CD,6,2) POD_YD" ).append("\n"); 
		...
		query.append("   AND A.POD_CLPT_IND_SEQ           =  C.CLPT_IND_SEQ(+)" ).append("\n"); 
