...
public class StatusReportDBDAOBkgCMPrintListinVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,NVL(B.CNTR_MF_WGT,0) CNTR_MF_WGT" ).append("\n"); 
		query.append("      ,NVL(B.MEAS_QTY,0) MEAS_QTY" ).append("\n"); 
		...
		query.append("      ,REPLACE(B.CNTR_MF_GDS_DESC,CHR(10),' ') CNTR_MF_GDS_DESC" ).append("\n"); 
		query.append("      ,REPLACE(B.CNTR_MF_MK_DESC,CHR(10),' ') CNTR_MF_MK_DESC" ).append("\n"); 
		...
		query.append("	  ,REPLACE(E.CUST_NM,CHR(10),' ') CUST_NM" ).append("\n"); 
