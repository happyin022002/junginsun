...
public class SpaceControlInquiryDBDAOSearchSpaceControlLFSummaryDownRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("						   AND (A4.N2ND_PRNT_OFC_CD = 'SHAAS' " ).append("\n"); 
		...
		query.append("#if (${rhq} != '')" ).append("\n"); 
		query.append("	#if (${rhq} == 'SHAAS')" ).append("\n"); 
		query.append("	                       AND ((A4.N2ND_PRNT_OFC_CD='SHAAS' AND " ).append("\n"); 
		query.append("	                            'A' = ( SELECT SPC_CONTI_CONV_FNC(L.CONTI_CD, SUBSTR(A1.RLANE_CD,1,3), A1.DIR_CD)" ).append("\n"); 
		...
		query.append("                               OR A4.N2ND_PRNT_OFC_CD='SINWA'                                                           " ).append("\n"); 
		query.append("                               )" ).append("\n"); 
		query.append("	#else" ).append("\n"); 
