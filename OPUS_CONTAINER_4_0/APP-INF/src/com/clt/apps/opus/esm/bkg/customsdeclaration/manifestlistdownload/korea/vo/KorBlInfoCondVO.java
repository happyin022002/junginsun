...
public class KorBlInfoCondVO extends BlInfoCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<KorBlInfoCondVO> models = new ArrayList<KorBlInfoCondVO>();
	...
	public KorBlInfoCondVO() {}

	public KorBlInfoCondVO(String ibflag, String pagerows, String blNo, String ioBndCd, String polCd, String podCd, String vvd, String mrnNo, String cstmsDeclTpCd, String portCd, String bkgNo) {
		this.vvd = vvd;
		this.podCd = podCd;
		this.polCd = polCd;
		this.ibflag = ibflag;
	 ...
	 */
	public KorBlInfoCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorBlInfoCondVO[]
	 */
	public KorBlInfoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorBlInfoCondVO model = null;
	 ...
	 * @return KorBlInfoCondVO[]
	 */
	public KorBlInfoCondVO[] getKorBlInfoCondVOs(){
		KorBlInfoCondVO[] vos = (KorBlInfoCondVO[])models.toArray(new KorBlInfoCondVO[models.size()]);
		return vos;
	}
