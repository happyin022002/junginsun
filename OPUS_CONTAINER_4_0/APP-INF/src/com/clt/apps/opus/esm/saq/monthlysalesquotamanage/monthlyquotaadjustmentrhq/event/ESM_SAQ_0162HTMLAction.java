...
*@FileName : ESM_SAQ_0162HTMLAction.java
*@FileTitle : Monthly Sales Quota Adjustment RHQ - Office Add
*Open Issues :
*Change history :
...
public class ESM_SAQ_0162HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0162HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0162HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0162Event event = new EsmSaq0162Event();
		SaqMonQtaOfcAddVO saqMonQtaOfcAddVO = new SaqMonQtaOfcAddVO();
		SaqMonQtaOfcAddVO[] saqMonQtaOfcAddVOs = null;
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonQtaOfcAddVOs = saqMonQtaOfcAddVO.fromRequestGrid(request, event.getQuotaConditionVO());
			event.setSaqMonQtaOfcAddVOs(saqMonQtaOfcAddVOs);
		}
