...
*@FileName : MonthlyQuotaCfmAdjustmentDBDAOUpdateSaqMonCfmQtaB0165USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCfmAdjustmentDBDAOUpdateSaqMonCfmQtaB0165USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaCfmAdjustmentDBDAOUpdateSaqMonCfmQtaB0165USQL(){
		setQuery();
		...
		params.put("ra_opfit_uc_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MonthlyQuotaCfmAdjustmentDBDAOUpdateSaqMonCfmQtaB0165USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        RA_OPFIT_UC_AMT  = @[ra_opfit_uc_amt]      ," ).append("\n"); 
