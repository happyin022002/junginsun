...
*@FileName : BookingMasterMgtDBDAOSearchWareHouseVOUSQL.java
...
public class BookingMasterMgtDBDAOSearchWareHouseVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingMasterMgtDBDAOSearchWareHouseVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE bkg_warehouse SET" ).append("\n"); 
		query.append("cnt_cd = @[cnt_cd]" ).append("\n"); 
		query.append(",	wh_cd = @[wh_cd]" ).append("\n"); 
		query.append(",	wh_nm = @[wh_nm]" ).append("\n"); 
		query.append(",	wh_addr = @[wh_addr]" ).append("\n"); 
		...
		query.append(",	pson_nm = @[pson_nm]" ).append("\n"); 
		...
		query.append("FileName : BookingMasterMgtDBDAOSearchWareHouseVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}