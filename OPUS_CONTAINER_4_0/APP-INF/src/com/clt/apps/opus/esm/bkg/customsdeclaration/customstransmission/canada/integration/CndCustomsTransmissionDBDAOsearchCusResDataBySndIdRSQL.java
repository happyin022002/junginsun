...
*@FileName : CndCustomsTransmissionDBDAOsearchCusResDataBySndIdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndCustomsTransmissionDBDAOsearchCusResDataBySndIdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndCustomsTransmissionDBDAOsearchCusResDataBySndIdRSQL(){
		setQuery();
		...
		query.append("FileName : CndCustomsTransmissionDBDAOsearchCusResDataBySndIdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
