...
*@FileName : SpeckalCargoReceiptDBDAOsearchUnNoInoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpeckalCargoReceiptDBDAOsearchUnNoInoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpeckalCargoReceiptDBDAOsearchUnNoInoRSQL(){
		setQuery();
		...
		query.append("FileName : SpeckalCargoReceiptDBDAOsearchUnNoInoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
