...
*@FileName : SearchBlListByHblNoVO.java
*@FileTitle : SearchBlListByHblNoVO
*Open Issues :
*Change history :
...
public class SearchBlListByHblNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBlListByHblNoVO> models = new ArrayList<SearchBlListByHblNoVO>();
	 ...
	 * @param request
	 * @return SearchBlListByHblNoVO[]
	 */
	public SearchBlListByHblNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBlListByHblNoVO[]
	 */
	public SearchBlListByHblNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBlListByHblNoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBlListByHblNoVO();
				if (corrRmk[i] != null)
		...
		return getSearchBlListByHblNoVOs();
	}
	 ...
	 * @return SearchBlListByHblNoVO[]
	 */
	public SearchBlListByHblNoVO[] getSearchBlListByHblNoVOs(){
		SearchBlListByHblNoVO[] vos = (SearchBlListByHblNoVO[])models.toArray(new SearchBlListByHblNoVO[models.size()]);
		return vos;
	}
