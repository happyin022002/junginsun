...
*@FileName : AncsManiestListDownloadDBDAOaddBkgCstmsNtfyAddrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsManifestListDownloadDBDAOaddBkgCstmsNtfyAddrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsManifestListDownloadDBDAOaddBkgCstmsNtfyAddrCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_NTFY_ADDR (" ).append("\n"); 
		...
		query.append(",UPD_USR_ID --SESSION ID" ).append("\n"); 
		query.append(",UPD_OFC_CD --SESSION OFC CD" ).append("\n"); 
		query.append(",CRE_USR_ID --SESSION ID" ).append("\n"); 
		query.append(",CRE_OFC_CD --SESSION OFC CD" ).append("\n"); 
		query.append(",UPD_DT" ).append("\n"); 
		query.append(",CRE_DT" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("VALUES(" ).append("\n"); 
		query.append("( SELECT NVL(MAX(ADDR_SEQ),0) + 1 FROM BKG_CSTMS_NTFY_ADDR )" ).append("\n"); 
		query.append(",@[key_addr]" ).append("\n"); 
		query.append(",@[cust_addr1]" ).append("\n"); 
		query.append(",@[cust_addr2]" ).append("\n"); 
		query.append(",@[cust_addr3]" ).append("\n"); 
		...
		query.append("FileName : AncsManiestListDownloadDBDAOaddBkgCstmsNtfyAddrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}