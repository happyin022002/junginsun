...
*@FileName : ChinaManifestListDownloadDBDAOremoveBlCntrAkListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOremoveBlCntrAkListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOremoveBlCntrAkListDSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOremoveBlCntrAkListDSQL").append("\n");
		query.append("*/").append("\n");
	}
