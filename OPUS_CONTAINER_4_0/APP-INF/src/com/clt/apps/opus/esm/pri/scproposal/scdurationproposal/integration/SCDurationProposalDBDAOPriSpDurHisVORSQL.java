...
*@FileName : SCDurationProposalDBDAOPriSpDurHisVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAOPriSpDurHisVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * duration amend history
	  * </pre>
	  */
	public SCDurationProposalDBDAOPriSpDurHisVORSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAOPriSpDurHisVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    PRI_SP_DUR 		A  ," ).append("\n"); 
		...
		query.append("            AND  NOT EXISTS ( SELECT 'X' FROM PRI_SP_DUR B" ).append("\n"); 
		query.append("                               WHERE " ).append("\n"); 
		...
		query.append("AND 1 = (SELECT 1 FROM PRI_SP_DUR " ).append("\n"); 
