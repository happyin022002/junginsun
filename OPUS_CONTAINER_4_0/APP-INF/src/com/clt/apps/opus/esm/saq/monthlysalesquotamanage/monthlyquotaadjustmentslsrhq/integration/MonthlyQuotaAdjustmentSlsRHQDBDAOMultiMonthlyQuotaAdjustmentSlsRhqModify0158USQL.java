...
*@FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOMultiMonthlyQuotaAdjustmentSlsRhqModify0158USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentSlsRHQDBDAOMultiMonthlyQuotaAdjustmentSlsRhqModify0158USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAQ_MON_QTA_LOD_TGT의 지정된 ibflag 값에 따라 DB에 반영한다.(추가, 수정, 삭제)
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentSlsRHQDBDAOMultiMonthlyQuotaAdjustmentSlsRhqModify0158USQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOMultiMonthlyQuotaAdjustmentSlsRhqModify0158USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SAQ_MON_QTA_LOD_TGT SET" ).append("\n"); 
		...
		query.append("    SLS_RGN_OFC_CD = @[sls_rgn_ofc_cd] AND" ).append("\n"); 
		query.append("    RLANE_CD = @[rlane_cd] AND" ).append("\n"); 
		query.append("    POL_CD = @[pol_cd] AND" ).append("\n"); 
