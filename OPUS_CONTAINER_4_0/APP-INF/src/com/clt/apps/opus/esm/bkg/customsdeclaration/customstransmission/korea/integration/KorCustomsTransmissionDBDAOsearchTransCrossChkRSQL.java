...
public class KorCustomsTransmissionDBDAOsearchTransCrossChkRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", DECODE(CRR_CD, COM_ConstantMgr_PKG.COM_getCompanyCode_FNC(), CUST_OPR_CD,NULL) CUST_OPR_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(", (SELECT NVL(SUM(DECODE(NVL(OPR_CD, COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()), COM_ConstantMgr_PKG.COM_getCompanyCode_FNC(), '1', '0')), '1')" ).append("\n"); 
		query.append("FROM BAY_PLAN Y" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND Y.VSL_CD = SUBSTR(X.VVD, 1, 4)" ).append("\n"); 
		query.append("AND Y.VOY_NO = SUBSTR(X.VVD, 5, 4)" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("WHERE (NVL(PORT_DIV, ' ') <> 'X' or (CUST_OPR_QTY = 0  and crr_cd = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()))" ).append("\n"); 
