...
public class EmptyReleaseOrderDBDAOMtyRlseOrdDetailOutRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        ,TO_CHAR(NVL(EDI.SND_RQST_DT, EDI.SND_DT), 'YYYY-MM-DD HH24:MI') AS EDI_SND_DT" ).append("\n"); 
		query.append("        ,NVL(FAX.NTC_FAX_NO, YAR.FAX_NO) AS NTC_FAX_NO" ).append("\n"); 
		query.append("        --,TO_CHAR(NVL(FSI.XPT_DT,NVL(FSI.UPD_DT,FAX.SND_RQST_DT)), 'YYYY-MM-DD HH24:MI') AS FAX_SND_DT" ).append("\n"); 
		query.append("        ,TO_CHAR(NVL (FAX.SND_RQST_DT,NVL(FSI.XPT_DT,FSI.UPD_DT)),'yyyy-mm-dd hh24:mi') AS FAX_SND_DT" ).append("\n"); 
		...
		query.append("        --,TO_CHAR(NVL(ESI.EML_DT,EML.SND_RQST_DT), 'YYYY-MM-DD HH24:MI') AS EML_SND_DT" ).append("\n"); 
		query.append("        ,TO_CHAR(NVL (EML.SND_RQST_DT,ESI.EML_DT),'yyyy-mm-dd hh24:mi') AS EML_SND_DT" ).append("\n"); 
		query.append("        ,(SELECT INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("          FROM   COM_INTG_CD_DTL" ).append("\n"); 
		query.append("          WHERE  'CD02396' = INTG_CD_ID" ).append("\n"); 
		query.append("          AND    INTG_CD_VAL_CTNT =" ).append("\n"); 
