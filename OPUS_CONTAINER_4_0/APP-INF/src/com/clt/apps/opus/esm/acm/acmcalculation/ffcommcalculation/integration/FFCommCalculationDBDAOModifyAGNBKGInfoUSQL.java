...
public class FFCommCalculationDBDAOModifyAGNBKGInfoUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                       WHEN DOC.BL_CVRD_TP_CD = 'B'" ).append("\n"); 
		query.append("                       THEN 1" ).append("\n"); 
		query.append("                       WHEN DOC.BL_CVRD_TP_CD = 'C'" ).append("\n"); 
		query.append("                       THEN 1" ).append("\n"); 
		...
		query.append("               (" ).append("\n"); 
		query.append("                     SELECT" ).append("\n"); 
		query.append("                            LAN.REP_TRD_CD" ).append("\n"); 
		query.append("                       FROM MDM_REV_LANE LAN" ).append("\n"); 
		query.append("                      WHERE LAN.RLANE_CD" ).append("\n"); 
		query.append("                          =" ).append("\n"); 
		query.append("                       CASE" ).append("\n"); 
		query.append("                            COA_RANK_INFO_FNC" ).append("\n"); 
		query.append("                          (" ).append("\n"); 
		query.append("                            NVL (ACM_GET_RLANE_FNC (VV1.SLAN_CD, VV1.POL_CD, VV1.POD_CD), 'RBCCO'),                                 -- N1ST_RLANE_CD" ).append("\n"); 
		...
		query.append("                            CASE" ).append("\n"); 
		query.append("                            WHEN ACM_GET_CONTI_FNC (POL1.LOC_CD, NVL (ACM_GET_RLANE_FNC (VV1.SLAN_CD, VV1.POL_CD, VV1.POD_CD), 'RBCCO'))" ).append("\n"); 
		...
		query.append("                            CASE" ).append("\n"); 
		query.append("                            WHEN ACM_GET_CONTI_FNC (POL2.LOC_CD, ACM_GET_RLANE_FNC (VV2.SLAN_CD, VV2.POL_CD, VV2.POD_CD))" ).append("\n"); 
		...
		query.append("                            CASE" ).append("\n"); 
		query.append("                            WHEN ACM_GET_CONTI_FNC (POL3.LOC_CD, ACM_GET_RLANE_FNC (VV3.SLAN_CD, VV3.POL_CD, VV3.POD_CD))" ).append("\n"); 
		...
		query.append("                            CASE" ).append("\n"); 
		query.append("                            WHEN ACM_GET_CONTI_FNC (POL4.LOC_CD, ACM_GET_RLANE_FNC (VV4.SLAN_CD, VV4.POL_CD, VV4.POD_CD))" ).append("\n"); 
		...
		query.append("               (" ).append("\n"); 
		query.append("            CASE 'RBCCO'" ).append("\n"); 
		query.append("            WHEN ACM_GET_RLANE_FNC (VV1.SLAN_CD, VV1.POL_CD, VV1.POD_CD)" ).append("\n"); 
		query.append("            THEN 'CFDR'||TO_CHAR (SYSDATE, 'YYMM')||'EE'" ).append("\n"); 
		query.append("             END" ).append("\n"); 
		query.append("               ," ).append("\n"); 
		query.append("                 VV1.VSL_CD" ).append("\n"); 
		query.append("              || VV1.SKD_VOY_NO" ).append("\n"); 
		...
		query.append("               (" ).append("\n"); 
		query.append("            CASE 'RBCCO'" ).append("\n"); 
		query.append("            WHEN ACM_GET_RLANE_FNC (VV2.SLAN_CD, VV2.POL_CD, VV2.POD_CD)" ).append("\n"); 
		query.append("            THEN 'CFDR'||TO_CHAR (SYSDATE, 'YYMM')||'EE'" ).append("\n"); 
		query.append("             END" ).append("\n"); 
		query.append("               ," ).append("\n"); 
		query.append("                 VV2.VSL_CD" ).append("\n"); 
		query.append("              || VV2.SKD_VOY_NO" ).append("\n"); 
		...
		query.append("               (" ).append("\n"); 
		query.append("            CASE 'RBCCO'" ).append("\n"); 
		query.append("            WHEN ACM_GET_RLANE_FNC (VV3.SLAN_CD, VV3.POL_CD, VV3.POD_CD)" ).append("\n"); 
		query.append("            THEN 'CFDR'||TO_CHAR (SYSDATE, 'YYMM')||'EE'" ).append("\n"); 
		query.append("             END" ).append("\n"); 
		query.append("               ," ).append("\n"); 
		query.append("                 VV3.VSL_CD" ).append("\n"); 
		query.append("              || VV3.SKD_VOY_NO" ).append("\n"); 
		...
		query.append("               (" ).append("\n"); 
		query.append("            CASE 'RBCCO'" ).append("\n"); 
		query.append("            WHEN ACM_GET_RLANE_FNC (VV4.SLAN_CD, VV4.POL_CD, VV4.POD_CD)" ).append("\n"); 
		query.append("            THEN 'CFDR'||TO_CHAR (SYSDATE, 'YYMM')||'EE'" ).append("\n"); 
		query.append("             END" ).append("\n"); 
		query.append("               ," ).append("\n"); 
		query.append("                 VV4.VSL_CD" ).append("\n"); 
		query.append("              || VV4.SKD_VOY_NO" ).append("\n"); 
		...
		query.append("                 BKG.SLAN_CD                                                                                             -- TRUNK의 RLANE_CD ( TRUNK의 SLAN_CD(3자리) + POL의 CONTI(1자리) + POD의 CONTI(1자리) )" ).append("\n"); 
		query.append("              || POL.CONTI_CD" ).append("\n"); 
		query.append("              || POD.CONTI_CD                                                                                                  AS TRNK_RLANE_CD," ).append("\n"); 
		...
		query.append("                       CASE" ).append("\n"); 
		query.append("                       WHEN BKG.BKG_STS_CD = 'X'" ).append("\n"); 
		query.append("                       THEN 'BKG Canceled'" ).append("\n"); 
		query.append("                       WHEN DOC.BL_CVRD_TP_CD = 'B'" ).append("\n"); 
		query.append("                       THEN 'BL No['||BKG.BL_NO||'] is CO-BIZ BL!'" ).append("\n"); 
		query.append("                       WHEN DOC.BL_CVRD_TP_CD = 'C'" ).append("\n"); 
		query.append("                       THEN 'BL No['||BKG.BL_NO||'] is Covered BL!'" ).append("\n"); 
		...
		query.append("             AND VV1.VSL_PRE_PST_CD" ).append("\n"); 
		...
		query.append("               (" ).append("\n"); 
		query.append("            CASE" ).append("\n"); 
		query.append("            WHEN VV2.VSL_PRE_PST_CD (+) = 'T'" ).append("\n"); 
		query.append("             AND VV1.VSL_SEQ < NVL" ).append("\n"); 
		query.append("               (" ).append("\n"); 
		query.append("               (" ).append("\n"); 
		query.append("                     SELECT" ).append("\n"); 
		query.append("                            MAX (VV0.VSL_SEQ)" ).append("\n"); 
		query.append("                       FROM BKG_VVD VV0" ).append("\n"); 
		query.append("                      WHERE VV0.VSL_PRE_PST_CD = 'S'" ).append("\n"); 
		query.append("                        AND VV0.BKG_NO         = BKG.BKG_NO" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		...
		query.append("            WHEN VV2.VSL_PRE_PST_CD (+) = 'T'" ).append("\n"); 
		query.append("            THEN 'S'" ).append("\n"); 
		query.append("            WHEN VV2.VSL_PRE_PST_CD (+) = 'S'" ).append("\n"); 
		query.append("            THEN 'S'" ).append("\n"); 
		query.append("            WHEN VV2.VSL_PRE_PST_CD (+) = 'U'" ).append("\n"); 
		query.append("             AND VV2.VSL_SEQ (+)        = '1'" ).append("\n"); 
		...
		query.append("             END" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		query.append("             AND VV2.VSL_PRE_PST_CD" ).append("\n"); 
		query.append("               =" ).append("\n"); 
		query.append("               (" ).append("\n"); 
		query.append("            CASE" ).append("\n"); 
		query.append("            WHEN VV3.VSL_PRE_PST_CD (+) = 'S'" ).append("\n"); 
		query.append("            THEN 'S'" ).append("\n"); 
		query.append("            WHEN VV3.VSL_PRE_PST_CD (+) = 'T'" ).append("\n"); 
		query.append("            THEN 'S'" ).append("\n"); 
		query.append("            WHEN VV3.VSL_PRE_PST_CD (+) = 'U'" ).append("\n"); 
		query.append("             AND VV3.VSL_SEQ (+)        = '1'" ).append("\n"); 
		query.append("            THEN 'T'" ).append("\n"); 
		query.append("            WHEN VV3.VSL_PRE_PST_CD (+) = 'U'" ).append("\n"); 
		query.append("             AND VV3.VSL_SEQ (+)       <> '1'" ).append("\n"); 
		query.append("            THEN 'U'" ).append("\n"); 
		...
		query.append("             END" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		query.append("             AND VV3.VSL_PRE_PST_CD" ).append("\n"); 
		query.append("               =" ).append("\n"); 
		query.append("               (" ).append("\n"); 
		query.append("            CASE" ).append("\n"); 
		query.append("            WHEN VV4.VSL_PRE_PST_CD (+) = 'T'" ).append("\n"); 
		query.append("            THEN 'S'" ).append("\n"); 
		query.append("            WHEN VV4.VSL_PRE_PST_CD (+) = 'U'" ).append("\n"); 
		query.append("             AND VV4.VSL_SEQ (+)        = '1'" ).append("\n"); 
		query.append("            THEN 'T'" ).append("\n"); 
		query.append("            WHEN VV4.VSL_PRE_PST_CD (+) = 'U'" ).append("\n"); 
		query.append("             AND VV4.VSL_SEQ (+)       <> '1'" ).append("\n"); 
		query.append("            THEN 'U'" ).append("\n"); 
		...
		query.append("             END" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		query.append("             AND VV2.VSL_SEQ" ).append("\n"); 
		query.append("               =" ).append("\n"); 
		query.append("               (" ).append("\n"); 
		query.append("            CASE" ).append("\n"); 
		query.append("            WHEN VV3.VSL_PRE_PST_CD (+) = 'S'" ).append("\n"); 
		query.append("            THEN VV3.VSL_SEQ (+) - 1" ).append("\n"); 
		query.append("            WHEN VV3.VSL_PRE_PST_CD (+) = 'U'" ).append("\n"); 
		query.append("            THEN VV3.VSL_SEQ (+) - 1" ).append("\n"); 
		query.append("            ELSE VV2.VSL_SEQ" ).append("\n"); 
		query.append("             END" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		query.append("             AND VV3.VSL_SEQ" ).append("\n"); 
		query.append("               =" ).append("\n"); 
		query.append("               (" ).append("\n"); 
		query.append("            CASE" ).append("\n"); 
		query.append("            WHEN VV4.VSL_PRE_PST_CD (+) = 'S'" ).append("\n"); 
		query.append("            THEN VV4.VSL_SEQ (+) - 1" ).append("\n"); 
		query.append("            WHEN VV4.VSL_PRE_PST_CD (+) = 'U'" ).append("\n"); 
		query.append("            THEN VV4.VSL_SEQ (+) - 1" ).append("\n"); 
		...
		query.append("                    ,TBL.REV_VVD_CD                    = CASE WHEN PSD.WDR_CHK = 1 AND PSD.TRNK_VSL_CD IN ('HJXX', 'HJYY', 'HJZZ') THEN 'CNTC'||TO_CHAR (SYSDATE, 'YYMM')||'MM'  ELSE PSD.REV_VVD_CD END       " ).append("\n"); 
		...
		query.append("                      ,CASE WHEN PSD.WDR_CHK = 1 AND PSD.TRNK_VSL_CD IN ('HJXX', 'HJYY', 'HJZZ') THEN 'CNTC'||TO_CHAR (SYSDATE, 'YYMM')||'MM'  ELSE PSD.REV_VVD_CD END" ).append("\n"); 
