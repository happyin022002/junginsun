...
public class TRIProposalDBDAOCheckTRIRateDupRSQL implements ISQLTemplate{
	...
	public TRIProposalDBDAOCheckTRIRateDupRSQL(){
		...
		params.put("srch_note_ctnt",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("      ,(SELECT T.TRI_PROP_NO, T.AMDT_SEQ, T.EFF_DT, T.EXP_DT, T.RAT_UT_CD, T.PRC_CGO_TP_CD, T.CURR_CD, T.PROP_STS_CD, T.NOTE_CTNT" ).append("\n"); 
		...
		query.append("   AND F.NOTE_CTNT = @[srch_note_ctnt]" ).append("\n"); 
