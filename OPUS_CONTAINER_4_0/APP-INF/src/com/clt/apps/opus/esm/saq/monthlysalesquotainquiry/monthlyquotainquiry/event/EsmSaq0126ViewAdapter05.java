...
*@FileName       : EsmSaq0126ViewAdapter05.java
...
public class EsmSaq0126ViewAdapter05 extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		SearchMonthlyQuotaInquiry0126Tab05VO listVo = null; // 차후 루프문을 통해 결과리스트의 정보를 한 로우씩 입력할 결과VO를 세팅 
...
//			sbufXML.append("<TR LEVEL= \"" + listVo.getSlevel() + "\" HAVE-CHILD=\"" + ((level==7 && isEndRow) ? "TRUE" : "FALSE") + "\" expand=\"" + isExpand + "\">");
			sbufXML.append("<TR>");
			sbufXML.append("<TD bgColor= \"" + bgColor[colorIdx] + "\"><![CDATA[" + bse_wk + "]]></TD>");
//			sbufXML.append("<TD " + sub_trd_image + " bgColor= \"" + bgColor[colorIdx] + "\"><![CDATA[" + sub_trd_cd + "]]></TD>");
			sbufXML.append("<TD bgColor= \"" + bgColor[colorIdx] + "\"><![CDATA[" + sub_trd_cd + "]]></TD>");
//			sbufXML.append("<TD " + rlane_image + " bgColor= \"" + bgColor[colorIdx] + "\" " + fontColor + "><![CDATA[" + rlane_cd + "]]></TD>");
...
//			sbufXML.append("<TD " + aq_image + " bgColor= \"" + bgColor[colorIdx] + "\"><![CDATA[" + aq_cd + "]]></TD>");
			sbufXML.append("<TD bgColor= \"" + bgColor[colorIdx] + "\"><![CDATA[" + aq_cd + "]]></TD>");
//			sbufXML.append("<TD " + ofc_1_image + " bgColor= \"" + bgColor[colorIdx] + "\"><![CDATA[" + ofc_cd_1 + "]]></TD>");
