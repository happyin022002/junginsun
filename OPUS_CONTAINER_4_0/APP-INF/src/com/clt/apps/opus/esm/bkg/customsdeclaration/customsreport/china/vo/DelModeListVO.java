...
*@FileName : DelModeListVO.java
*@FileTitle : DelModeListVO
*Open Issues :
*Change history :
...
public class DelModeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<DelModeListVO> models = new ArrayList<DelModeListVO>();
	...
	public DelModeListVO() {}

	public DelModeListVO(String ibflag, String pagerows, String podCd, String areaNm, String delCd, String trspModCd, String diffRmk) {
		this.podCd = podCd;
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return DelModeListVO[]
	 */
	public DelModeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DelModeListVO[]
	 */
	public DelModeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DelModeListVO model = null;
	 ...
	 * @return DelModeListVO[]
	 */
	public DelModeListVO[] getDelModeListVOs(){
		DelModeListVO[] vos = (DelModeListVO[])models.toArray(new DelModeListVO[models.size()]);
		return vos;
	}
