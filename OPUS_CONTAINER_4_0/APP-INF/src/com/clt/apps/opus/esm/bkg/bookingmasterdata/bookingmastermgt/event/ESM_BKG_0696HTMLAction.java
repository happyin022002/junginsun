...
*@FileName : ESM_BKG_0696HTMLAction.java
...
public class ESM_BKG_0696HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0696HTMLAction 객체를 생성
	 */
	public ESM_BKG_0696HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0696Event event = new EsmBkg0696Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMdmPckTpVO((MdmPckTpVO)getVO(request, MdmPckTpVO .class));
		}
