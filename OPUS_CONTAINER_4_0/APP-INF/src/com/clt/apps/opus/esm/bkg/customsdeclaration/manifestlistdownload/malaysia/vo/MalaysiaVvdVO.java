...
*@FileName : MalaysiaVvdVO.java
*@FileTitle : MalaysiaVvdVO
*Open Issues :
*Change history :
...
public class MalaysiaVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<MalaysiaVvdVO> models = new ArrayList<MalaysiaVvdVO>();
	...
	public MalaysiaVvdVO() {}

	public MalaysiaVvdVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String psaVslNm, String psaVoyDirCd, String userId, String vslNm, String portCd, String etbDt1, String etbDt2) {
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("psa_voy_dir_cd", getMalaysiaVoyDirCd());
	 ...
	 * @return psaVoyDirCd
	 */
	public String getMalaysiaVoyDirCd() {
	 ...
	 * @param psaVoyDirCd
	 */
	public void setMalaysiaVoyDirCd(String psaVoyDirCd) {
		this.psaVoyDirCd = psaVoyDirCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		setMalaysiaVoyDirCd(JSPUtil.getParameter(request, "psa_voy_dir_cd", ""));
	 ...
	 */
	public MalaysiaVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MalaysiaVvdVO[]
	 */
	public MalaysiaVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MalaysiaVvdVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MalaysiaVvdVO();
				if (psaVoyDirCd[i] != null)
					model.setMalaysiaVoyDirCd(psaVoyDirCd[i]);
				if (vslCd[i] != null)
	...
	public MalaysiaVvdVO[] getMalaysiaVvdVOs(){
		MalaysiaVvdVO[] vos = (MalaysiaVvdVO[])models.toArray(new MalaysiaVvdVO[models.size()]);
		return vos;
	}
