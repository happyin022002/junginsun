...
public class PerformanceReportDBDAOCaIssueDateOutVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",REPLACE(D.BKG_CORR_RMK,CHR(10), ' ') BKG_CORR_RMK" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("   FROM BKG_CORRECTION D, BKG_BOOKING B, BKG_CSTMS_ADV_BL C, BKG_VVD A    " ).append("\n"); 
		...
		query.append("      ,REPLACE(COR.BKG_CORR_RMK,CHR(10), ' ') BKG_CORR_RMK" ).append("\n"); 
