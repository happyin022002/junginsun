...
public class SriLankaSearchVesselArrivalVO extends AbstractValueObject {
	...
	public SriLankaSearchVesselArrivalVO(String ibflag, String pagerows, String fileName, String vslFullname, String voyageCode, String arvlDt, String arvlTm, String deptDt, String deptTm, String captNm, String vslflg, String deptPort, String arvlPort, String shpAgt, String shpAgt2) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setArvlTm(JSPUtil.getParameter(request, "arvl_tm", ""));
		setDeptPort(JSPUtil.getParameter(request, "dept_port", ""));
		setVslflg(JSPUtil.getParameter(request, "vslflg", ""));
		setShpAgt(JSPUtil.getParameter(request, "shp_agt", ""));
		setVoyageCode(JSPUtil.getParameter(request, "voyage_code", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setDeptDt(JSPUtil.getParameter(request, "dept_dt", ""));
		setCaptNm(JSPUtil.getParameter(request, "capt_nm", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setArvlDt(JSPUtil.getParameter(request, "arvl_dt", ""));
		setFileName(JSPUtil.getParameter(request, "file_name", ""));
		setShpAgt2(JSPUtil.getParameter(request, "shp_agt2", ""));
		setArvlPort(JSPUtil.getParameter(request, "arvl_port", ""));
		setDeptTm(JSPUtil.getParameter(request, "dept_tm", ""));
	}
