...
*@FileName : RFADurationProposalDBDAOAtempVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFADurationProposalDBDAOAtempVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFADurationProposalDBDAOAtempVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.pri.rfaproposal.rfadurationproposal.integration ").append("\n"); 
		query.append("FileName : RFADurationProposalDBDAOAtempVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("'' SCP_ACCEPT" ).append("\n"); 
		query.append("FROM PRI_RP_SCP_DUR" ).append("\n"); 
		query.append("/*CstScpDurVO*/" ).append("\n"); 
