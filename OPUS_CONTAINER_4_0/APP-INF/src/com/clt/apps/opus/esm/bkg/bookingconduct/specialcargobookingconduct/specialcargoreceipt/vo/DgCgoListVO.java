...
public class DgCgoListVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ref_type", getRefType());
		this.hashColumns.put("ref_name", getRefName());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ref_type", "refType");
		this.hashFields.put("ref_name", "refName");
	...
	/**
	 * @param erapNo the erapNo to set
	 */
	...
	/**
	 * @param erapCntcNo the erapCntcNo to set
	 */
	...
	/**
	 * @param erapAproRefNo the erapAproRefNo to set
	 */
	...
	/**
	 * @return the imdgUnNoSpclProviCtnt
	 */
	...
	/**
	 * @param imdgUnNoSpclProviCtnt the imdgUnNoSpclProviCtnt to set
	 */
	...
	/**
	 * @return the emerCntcPntCtnt
	 */
	public String getEmerCntcPntCtnt() {
		return emerCntcPntCtnt;
	}

	/**
	 * @param emerCntcPntCtnt the emerCntcPntCtnt to set
	 */
	...
	/**
	 * @param imdgLmtQtyDesc the imdgLmtQtyDesc to set
	 */
	...
	/**
	 * @param imdgExptQtyDesc the imdgExptQtyDesc to set
	 */
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRefType(JSPUtil.getParameter(request, prefix + "ref_type", ""));
		setRefName(JSPUtil.getParameter(request, prefix + "ref_name", ""));
		setImdgUnNoSpclProviCtnt(JSPUtil.getParameter(request, prefix + "imdg_un_no_spcl_provi_ctnt", ""));
		setEmerCntcPntCtnt(JSPUtil.getParameter(request, prefix + "emer_cntc_pnt_ctnt", ""));
	...
	public DgCgoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] refType = (JSPUtil.getParameter(request, prefix	+ "ref_type", length));
			String[] refName = (JSPUtil.getParameter(request, prefix	+ "ref_name", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (refType[i] != null)
					model.setRefType(refType[i]);
				if (refName[i] != null)
					model.setRefName(refName[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.refType = this.refType .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.refName = this.refName .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
