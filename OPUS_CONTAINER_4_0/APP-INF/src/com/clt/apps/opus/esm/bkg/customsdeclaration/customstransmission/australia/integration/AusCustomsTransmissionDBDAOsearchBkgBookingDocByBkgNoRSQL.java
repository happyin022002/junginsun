...
*@FileName : AusCustomsTransmissionDBDAOsearchBkgBookingDocByBkgNoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOsearchBkgBookingDocByBkgNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOsearchBkgBookingDocByBkgNoRSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOsearchBkgBookingDocByBkgNoRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("       DECODE(BKG.DE_TERM_CD, 'S', 'P', 'F') AS FP_IND," ).append("\n");
		query.append("       (SELECT COUNT(*)" ).append("\n");
		query.append("          FROM BKG_CONTAINER CNTR" ).append("\n");
		query.append("         WHERE BKG.BKG_NO = CNTR.BKG_NO) AS TOT_CNTR," ).append("\n");
		query.append("       DOC.PCK_QTY," ).append("\n");
		query.append("       DECODE(RATE.FRT_TERM_CD, 'P', 'PO', 'CC') AS PRE_FLG" ).append("\n");
		query.append("" ).append("\n");
