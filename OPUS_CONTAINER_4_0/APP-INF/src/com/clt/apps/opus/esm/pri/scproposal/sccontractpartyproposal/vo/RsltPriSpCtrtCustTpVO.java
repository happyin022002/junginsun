...
*@FileName : PriSpCtrtCustTpVO.java
*@FileTitle : PriSpCtrtCustTpVO
*Open Issues :
*Change history :
...
public class RsltPriSpCtrtCustTpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpCtrtCustTpVO> models = new ArrayList<RsltPriSpCtrtCustTpVO>();
	...
	public RsltPriSpCtrtCustTpVO() {}

	public RsltPriSpCtrtCustTpVO(String ibflag, String pagerows, String propNo, String amdtSeq, String prcCtrtPtyTpCd, String prcCtrtCustTpCd, String n1stCmncAmdtSeq, String effDt, String expDt, String srcInfoCd, String srcInfoNm, String prcProgStsCd, String prcProgStsNm, String acptUsrId, String acptOfcCd, String acptUsrNm, String acptDt) {
		this.acptDt = acptDt;
	 ...
	 */
	public RsltPriSpCtrtCustTpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpCtrtCustTpVO[]
	 */
	public RsltPriSpCtrtCustTpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpCtrtCustTpVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSpCtrtCustTpVO();
				if (acptDt[i] != null)
	 ...
	 * @return PriSpCtrtCustTpVO[]
	 */
	public RsltPriSpCtrtCustTpVO[] getPriSpCtrtCustTpVOs(){
		RsltPriSpCtrtCustTpVO[] vos = (RsltPriSpCtrtCustTpVO[])models.toArray(new RsltPriSpCtrtCustTpVO[models.size()]);
		return vos;
	}
