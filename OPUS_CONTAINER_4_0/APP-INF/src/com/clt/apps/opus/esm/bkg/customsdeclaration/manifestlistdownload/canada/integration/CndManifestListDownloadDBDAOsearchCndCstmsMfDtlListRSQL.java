...
public class CndManifestListDownloadDBDAOsearchCndCstmsMfDtlListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   AND  SKD.CLPT_IND_SEQ = (SELECT /*+ INDEX_DESC(P XPKVSK_VSL_PORT_SKD) */ P.CLPT_IND_SEQ" ).append("\n"); 
		query.append("                                        FROM VSK_VSL_PORT_SKD P" ).append("\n"); 
		query.append("                                       WHERE 1=1" ).append("\n"); 
		query.append("                                         AND P.VSL_CD = TB.VSL_CD" ).append("\n"); 
		query.append("                                         AND P.SKD_VOY_NO = TB.SKD_VOY_NO" ).append("\n"); 
		query.append("                                         AND P.SKD_DIR_CD = TB.SKD_DIR_CD" ).append("\n"); 
		query.append("                                         AND P.VPS_PORT_CD = TB.POD_CD" ).append("\n"); 
