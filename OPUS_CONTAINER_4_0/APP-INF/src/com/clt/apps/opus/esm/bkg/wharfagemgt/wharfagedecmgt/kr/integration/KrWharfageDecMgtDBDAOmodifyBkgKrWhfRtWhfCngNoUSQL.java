...
*@FileName : KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtWhfCngNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtWhfCngNoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtWhfCngNoUSQL(){
		setQuery();
		...
		query.append("FileName : KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtWhfCngNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET D.WHF_NTC_NO = @[whf_ntc_no]," ).append("\n"); 
		query.append("D.WHF_DECL_DT = SYSDATE," ).append("\n"); 
		query.append("D.UPD_USR_ID = 'TES_PUSBS'," ).append("\n"); 
