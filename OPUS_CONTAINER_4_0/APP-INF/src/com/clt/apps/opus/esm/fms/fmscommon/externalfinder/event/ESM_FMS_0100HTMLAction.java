...
*@FileName : ESM_FMS_0100HTMLAction.java
...
public class ESM_FMS_0100HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0100HTMLAction 객체를 생성
	 */
	public ESM_FMS_0100HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0100Event event = new EsmFms0100Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			String codeTp = (String) request.getParameter("ppt_nm");
			event.setCodeTp(codeTp);

		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setOtherCodeListVOS((OtherCodeListVO[]) getVOs(request, OtherCodeListVO.class,"sheet1_"));
		}
