...
*@FileName : SearchFFRevLanebndInfoVO.java
*@FileTitle : SearchFFRevLanebndInfoVO
*Open Issues :
*Change history :
...
public class SearchFFRevLanebndInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<SearchFFRevLanebndInfoVO> models = new ArrayList<SearchFFRevLanebndInfoVO>();
	...
	public SearchFFRevLanebndInfoVO() {}

	public SearchFFRevLanebndInfoVO(String ibflag, String pagerows, String bkgNo, String estmIocDivCd, String rlaneCd, String revVvdCd, String commRlaneCd) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public SearchFFRevLanebndInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchFFRevLanebndInfoVO[]
	 */
	public SearchFFRevLanebndInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchFFRevLanebndInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchFFRevLanebndInfoVO();
				if (bkgNo[i] != null)
		...
		return getSearchFFRevLanebndInfoVOs();
	}
	 ...
	 * @return SearchFFRevLanebndInfoVO[]
	 */
	public SearchFFRevLanebndInfoVO[] getSearchFFRevLanebndInfoVOs(){
		SearchFFRevLanebndInfoVO[] vos = (SearchFFRevLanebndInfoVO[])models.toArray(new SearchFFRevLanebndInfoVO[models.size()]);
		return vos;
	}
