...
*@FileName       : ESM_SAQ_0116HTMLAction.java
 ...
 *
 * @author byyoo
 * @see EsmSaq0116Event , ESM_SAQ_116EventResponse 참조
 * @since J2EE 1.4
 */

public class ESM_SAQ_0116HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_SAQ_0116HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0116HTMLAction() {}
	
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_SAQ_116Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0116Event event = new EsmSaq0116Event();
