...
public class UsaCustomsTransmissionDBDAOsearchIsf5SF50RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    SELECT DECODE(SUBSTR(IT.POD_CD,1,2), 'US', L2.LOC_AMS_PORT_CD, L1.LOC_AMS_PORT_CD) AS FPOD" ).append("\n"); 
		...
		query.append("          ,MDM_LOCATION L1 --POD" ).append("\n"); 
		query.append("          ,MDM_LOCATION L2 --DEL" ).append("\n"); 
		...
		query.append("       AND IT.POD_CD = L1.LOC_CD(+)" ).append("\n"); 
