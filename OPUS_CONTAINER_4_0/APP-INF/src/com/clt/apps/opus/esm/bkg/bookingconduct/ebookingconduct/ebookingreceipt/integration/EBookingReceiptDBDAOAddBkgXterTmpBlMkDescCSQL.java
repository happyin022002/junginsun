...
*@FileName : EBookingReceiptDBDAOAddBkgXterTmpBlMkDescCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOAddBkgXterTmpBlMkDescCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_XTER_TMP_BL_MK_DESC INSERT
	  * </pre>
	  */
	public EBookingReceiptDBDAOAddBkgXterTmpBlMkDescCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOAddBkgXterTmpBlMkDescCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_TMP_BL_MK_DESC" ).append("\n"); 
		query.append("(" ).append("\n"); 
