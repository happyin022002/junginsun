...
*@FileName : SearchMonthlySlsRep0173List01VO.java
*@FileTitle : SearchMonthlySlsRep0173List01VO
*Open Issues :
*Change history :
...
public class SearchMonthlySlsRep0173List01VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlySlsRep0173List01VO> models = new ArrayList<SearchMonthlySlsRep0173List01VO>();
	...
	/* Column Info */
	private String srepCdRevised = null;
	...
	/* Column Info */
	private String srepNmRevised = null;
	/* Column Info */
	...
	public SearchMonthlySlsRep0173List01VO() {}

	public SearchMonthlySlsRep0173List01VO(String ibflag, String pagerows, String seq, String mqtaRlseVerNo, String bseYr, String bseQtrCd, String qtaTgtCd, String trdCd, String dirCd, String subTrdCd, String rlaneCd, String vvd, String vslCd, String skdVoyNo, String skdDirCd, String laneGrp, String bseMon, String bseWk, String bsa, String rgnOfcCd, String ofcCd, String srepCd, String srepNm, String srepCdRevised, String srepNmRevised, String rhqCd, String aqCd, String unit, String lodQty, String grsRev, String grsRpbRev, String cmAmt, String cmUcAmt, String raCmAmt, String raCmUcAmt, String raOpfitAmt, String raOpfitUcAmt, String opfitUcAmt, String fullStvgUcAmt, String fullTrspUcAmt, String mtyStvgUcAmt, String mtyTrspUcAmt, String cntrFxUcAmt, String chssFxUcAmt, String agnCommUtAmt, String bizActUcAmt, String sltMgmtUcAmt, String ownVolActUcAmt, String stpUcAmt, String eqHldUcAmt, String eqRepoUcAmt, String eqSimUcAmt, String saqMiscRevAmt, String remark) {
		this.vslCd = vslCd;
		this.remark = remark;
		...
		this.srepCdRevised = srepCdRevised;
		this.ibflag = ibflag;
		...
		this.srepNmRevised = srepNmRevised;
		this.aqCd = aqCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("srep_cd_revised", getSrepCdRevised());
		...
		this.hashColumns.put("srep_nm_revised", getSrepNmRevised());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("srep_cd_revised", "srepCdRevised");
		...
		this.hashFields.put("srep_nm_revised", "srepNmRevised");
	...
	/**
	 * Column Info
	 * @return srepCdRevised
	 */
	public String getSrepCdRevised() {
		return this.srepCdRevised;
	}
	...
	/**
	 * Column Info
	 * @return srepNmRevised
	 */
	public String getSrepNmRevised() {
		return this.srepNmRevised;
	}
	 ...
	 * @param srepCdRevised
	 */
	public void setSrepCdRevised(String srepCdRevised) {
		this.srepCdRevised = srepCdRevised;
	}
	 ...
	 * @param srepNmRevised
	 */
	public void setSrepNmRevised(String srepNmRevised) {
		this.srepNmRevised = srepNmRevised;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSrepCdRevised(JSPUtil.getParameter(request, "srep_cd_revised", ""));
		...
		setSrepNmRevised(JSPUtil.getParameter(request, "srep_nm_revised", ""));
	 ...
	 * @param request
	 * @return SearchMonthlySlsRep0173List01VO[]
	 */
	public SearchMonthlySlsRep0173List01VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlySlsRep0173List01VO[]
	 */
	public SearchMonthlySlsRep0173List01VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlySlsRep0173List01VO model = null;
		...
		try {
			...
			String[] srepCdRevised = (JSPUtil.getParameter(request, prefix	+ "srep_cd_revised", length));
			...
			String[] srepNmRevised = (JSPUtil.getParameter(request, prefix	+ "srep_nm_revised", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlySlsRep0173List01VO();
				if (vslCd[i] != null)
				...
				if (srepCdRevised[i] != null)
					model.setSrepCdRevised(srepCdRevised[i]);
				if (ibflag[i] != null)
				...
				if (srepNmRevised[i] != null)
					model.setSrepNmRevised(srepNmRevised[i]);
				if (aqCd[i] != null)
		...
		return getSearchMonthlySlsRep0173List01VOs();
	}
	 ...
	 * @return SearchMonthlySlsRep0173List01VO[]
	 */
	public SearchMonthlySlsRep0173List01VO[] getSearchMonthlySlsRep0173List01VOs(){
		SearchMonthlySlsRep0173List01VO[] vos = (SearchMonthlySlsRep0173List01VO[])models.toArray(new SearchMonthlySlsRep0173List01VO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.srepCdRevised = this.srepCdRevised .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.srepNmRevised = this.srepNmRevised .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
