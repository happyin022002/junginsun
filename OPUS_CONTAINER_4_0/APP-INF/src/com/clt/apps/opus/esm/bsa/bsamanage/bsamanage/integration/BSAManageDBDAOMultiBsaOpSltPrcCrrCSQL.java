...
*@FileName : BSAManageDBDAOMultiBsaOpSltPrcCrrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOMultiBsaOpSltPrcCrrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MERGE INTO bsa_op_slt_prc_crr
	  * </pre>
	  */
	public BSAManageDBDAOMultiBsaOpSltPrcCrrCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOMultiBsaOpSltPrcCrrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BSA_OP_SLT_PRC_CRR A " ).append("\n"); 
