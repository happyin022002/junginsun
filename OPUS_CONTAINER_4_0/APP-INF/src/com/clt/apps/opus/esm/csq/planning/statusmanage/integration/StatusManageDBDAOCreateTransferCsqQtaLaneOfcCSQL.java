...
*@FileName : StatusManageDBDAOCreateTransferCsqQtaLaneOfcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAOCreateTransferCsqQtaLaneOfcCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Qta Transfer 시 연간 정보로 1Q CSQ_QTA_LANE_OFC 생성
	  * </pre>
	  */
	public StatusManageDBDAOCreateTransferCsqQtaLaneOfcCSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAOCreateTransferCsqQtaLaneOfcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
