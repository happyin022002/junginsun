...
*@FileName : AvgAgencyCommissionDBDAOMergeAvgAgencyCommissionOfficeListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AvgAgencyCommissionDBDAOMergeAvgAgencyCommissionOfficeListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AvgAgencyCommissionDBDAOMergeAvgAgencyCommissionOfficeListCSQL(){
		setQuery();
		...
		query.append("FileName : AvgAgencyCommissionDBDAOMergeAvgAgencyCommissionOfficeListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO ACM_COMM_OFC_UT_COST A" ).append("\n"); 
