...
*@FileName : BLIssuanceDBDAOsearchDblEdiMrnNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOsearchDblEdiMrnNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLIssuanceDBDAOsearchDblEdiMrnNoRSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOsearchDblEdiMrnNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'MRN_NO:' || MRN.MRN_NO || MRN.MRN_CHK_NO || CHR(10)" ).append("\n"); 
