...
*@FileName : JapanManifestTransmitForReVO.java
*@FileTitle : JapanManifestTransmitForReVO
*Open Issues :
*Change history :
...
public class JapanManifestTransmitForReVO extends ManifestTransmitVO {

	private static final long serialVersionUID = 1L;

	private Collection<JapanManifestTransmitForReVO> models = new ArrayList<JapanManifestTransmitForReVO>();
	...
	public JapanManifestTransmitForReVO() {}

	public JapanManifestTransmitForReVO(String ibflag, String pagerows, String jpSndLogId, String sndDt, String sndDt2, String ofcCd, String updUsrId, String vvdCd, String podCd, String logFlg, String logDt, String logDt2, String logSeq, String blNo) {
		this.sndDt2 = sndDt2;
		this.sndDt = sndDt;
		this.blNo = blNo;
	 ...
	 */
	public JapanManifestTransmitForReVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapanManifestTransmitForReVO[]
	 */
	public JapanManifestTransmitForReVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JapanManifestTransmitForReVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new JapanManifestTransmitForReVO();
				if (sndDt2[i] != null)
		...
		return getJapanManifestTransmitForReVOs();
	}
	 ...
	 * @return JapanManifestTransmitForReVO[]
	 */
	public JapanManifestTransmitForReVO[] getJapanManifestTransmitForReVOs(){
		JapanManifestTransmitForReVO[] vos = (JapanManifestTransmitForReVO[])models.toArray(new JapanManifestTransmitForReVO[models.size()]);
		return vos;
	}
