...
*@FileName : ESM_BKG_1520HTMLAction.java
*@FileTitle :
*Open Issues :
*Change history :
*@LastModifyDate :
 ...
 * @see EsmBkg1520Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_1520HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_FMS_1520HTMLAction 객체를 생성
	 */
	public ESM_BKG_1520HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1520Event event = new EsmBkg1520Event();
		...
		if (command.isCommand(FormCommand.SEARCH02) ) {
			...
			event.setAusDgEdiVOs((AusDgEdiVO[]) getVOs(request, AusDgEdiVO.class));
