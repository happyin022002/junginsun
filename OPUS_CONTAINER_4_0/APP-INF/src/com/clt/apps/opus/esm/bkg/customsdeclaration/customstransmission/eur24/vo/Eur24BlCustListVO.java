...
public class Eur24BlCustListVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String blPtAgAtlas = null;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("bl_pt_ag_ind", getBlPtAgInd());
        ...
        this.hashColumns.put("bl_pt_ag_atlas", getBlPtAgAtlas());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("bl_pt_ag_ind", "blPtAgInd");
        ...
        this.hashFields.put("bl_pt_ag_atlas", "blPtAgAtlas");
	 ...
	 * @return blPtAgInd
	 */
    public String getBlPtAgInd() {
        return this.blPtAgInd;
    }
	 ...
	 * @param blPtCntCd
	 */
    public void setBlPtAgInd(String blPtAgInd) {
        this.blPtAgInd = blPtAgInd;
    }
    ...
    public void setBlPtAgAtlas(String blPtAgAtlas) {
        this.blPtAgAtlas = blPtAgAtlas;
    }

    public String getBlPtAgAtlas() {
        return this.blPtAgAtlas;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setBlPtAgInd(JSPUtil.getParameter(request, prefix + "bl_pt_ag_ind", ""));
        ...
        setBlPtAgAtlas(JSPUtil.getParameter(request, prefix + "bl_pt_ag_atlas", ""));
    }
    ...
    public Eur24BlCustListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] blPtAgInd = (JSPUtil.getParameter(request, prefix + "bl_pt_ag_ind", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (blPtAgInd[i] != null)
                    model.setBlPtAgInd(blPtAgInd[i]);
                if (blNo[i] != null)
	...
	*/
    public void unDataFormat() {
        ...
        this.blPtAgInd = this.blPtAgInd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.blPtAgAtlas = this.blPtAgAtlas.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
