...
*@FileName : RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[gline_seq]," ).append("\n"); 
		query.append("@[grp_loc_seq]," ).append("\n"); 
		query.append("NVL((SELECT /*+ INDEX_DESC(a XPKPRI_RG_GRP_LOC_DTL) */" ).append("\n"); 
		query.append("GRP_LOC_DTL_SEQ" ).append("\n"); 
