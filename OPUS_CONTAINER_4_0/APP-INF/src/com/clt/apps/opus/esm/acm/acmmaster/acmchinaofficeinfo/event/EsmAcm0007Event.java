...
public class EsmAcm0007Event extends EventSupport {
	...
	public ChinaOfficeInfoVO[] getChinaOfficeInfoVOs() {
		ChinaOfficeInfoVO[] rtnVOs = null;
		if (this.chinaOfficeInfoVOs != null) {
			rtnVOs = Arrays.copyOf(chinaOfficeInfoVOs, chinaOfficeInfoVOs.length);
		}
		return rtnVOs;
	}

	public void setChinaOfficeInfoVOs(ChinaOfficeInfoVO[] chinaOfficeInfoVOs) {
		if(chinaOfficeInfoVOs != null){
			ChinaOfficeInfoVO[] tmpVOs = Arrays.copyOf(chinaOfficeInfoVOs, chinaOfficeInfoVOs.length);
			this.chinaOfficeInfoVOs  = tmpVOs;
		}
	}
}