...
*@FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTrade0048List01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTrade0048List01RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MonthlyQuotaAdjustmentTrade 조정을 위한 조회
	  * 2011.02.15 김종준 [T-선사] YEARLY QTA 부분 삭제
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTrade0048List01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTrade0048List01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	GROUP BY GROUPING SETS ((VVD.SUB_TRD_CD,VVD.RLANE_CD,VVD.SPRT_GRP_CD,VVD.BSA_GRP_CD))" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		...
		query.append("	SUBSTR(TRD.LANE_GRP, 0,7) AS LANE_GRP01, SUBSTR(TRD.LANE_GRP, 8) AS LANE_GRP02," ).append("\n"); 
		...
		query.append("	MIN(TRD.GRP_SEQ) AS GRP_SEQ, --hidden" ).append("\n"); 
		...
		query.append("	'04', DECODE(UNI.TOT_BSA, 0, '', (UNI.TOT_LOD/UNI.TOT_BSA)*100)," ).append("\n"); 
		...
		query.append("	MIN(CASE WHEN UNI.GUBUN = 'FORECAST' AND UNI.BSE_MON = SUBSTR(TGT_YR_MON,5,2) THEN" ).append("\n"); 
		query.append("	ROUND(DECODE( ITM.CODE," ).append("\n"); 
		query.append("	'01', UNI.TOT_BSA," ).append("\n"); 
		query.append("	'02', UNI.TOT_VOY," ).append("\n"); 
		query.append("	'03', UNI.TOT_LOD/UNI.TOT_VOY," ).append("\n"); 
		query.append("	'04', DECODE(UNI.TOT_BSA, 0, '',(UNI.TOT_LOD/UNI.TOT_VOY/UNI.TOT_BSA)*100)," ).append("\n"); 
		...
		query.append("	" ).append("\n"); 
		query.append("	MIN(CASE WHEN UNI.GUBUN = 'MODEL' AND UNI.BSE_MON = SUBSTR(TGT_YR_MON,5,2) THEN" ).append("\n"); 
		query.append("	ROUND(DECODE( ITM.CODE," ).append("\n"); 
		query.append("	'01', UNI.TOT_BSA," ).append("\n"); 
		query.append("	'02', UNI.TOT_VOY," ).append("\n"); 
		query.append("	'03', UNI.TOT_LOD/UNI.TOT_VOY," ).append("\n"); 
		...
		query.append("	ROUND(DECODE( ITM.CODE," ).append("\n"); 
		query.append("	'01', TRD.TOT_BSA," ).append("\n"); 
		query.append("	'02', TRD.TOT_VOY," ).append("\n"); 
		query.append("	'03', TRD.TOT_LOD," ).append("\n"); 
		query.append("	'04', DECODE(TRD.TOT_BSA, 0, '',(TRD.TOT_LOD/TRD.TOT_BSA)*100)," ).append("\n"); 
		...
		query.append("	DECODE( UNI.TOT_LOD, 0, 0," ).append("\n"); 
		query.append("	ROUND(DECODE( ITM.CODE," ).append("\n"); 
		query.append("	'01', UNI.TOT_BSA," ).append("\n"); 
		query.append("	'02', UNI.TOT_VOY," ).append("\n"); 
		query.append("	'03', UNI.TOT_LOD," ).append("\n"); 
		...
		query.append("	MIN(CASE WHEN INP.SAQ_STS_CD != 'DR' AND TRD.GUBUN = 'TRADE' THEN TRD.TOT_LOD" ).append("\n"); 
		query.append("	WHEN INP.SAQ_STS_CD = 'DR' AND TRD.GUBUN = 'FINAL' THEN TRD.TOT_LOD" ).append("\n"); 
		query.append("	END) AS TOT_LOD," ).append("\n"); 
		query.append("	MIN(CASE WHEN INP.SAQ_STS_CD != 'DR' AND TRD.GUBUN = 'TRADE' THEN TRD.TOT_RPB" ).append("\n"); 
		query.append("	WHEN INP.SAQ_STS_CD = 'DR' AND TRD.GUBUN = 'FINAL' THEN TRD.TOT_RPB" ).append("\n"); 
		query.append("	END) AS TOT_RPB," ).append("\n"); 
		query.append("	MIN(DECODE (TRD.GUBUN , 'TRADE', TRD.CM_UC_AMT)) AS CM_UC_AMT," ).append("\n"); 
		query.append("	MIN(DECODE (TRD.GUBUN , 'TRADE', TRD.OPFIT_UC_AMT)) AS OPFIT_UC_AMT," ).append("\n"); 
		query.append("	MIN(DECODE (TRD.GUBUN , 'TRADE', TRD.RA_CM_UC_AMT)) AS RA_CM_UC_AMT," ).append("\n"); 
		query.append("	MIN(DECODE (TRD.GUBUN , 'TRADE', TRD.RA_OPFIT_UC_AMT)) AS RA_OPFIT_UC_AMT," ).append("\n"); 
		query.append("	MIN(DECODE (TRD.GUBUN , 'TRADE', TRD.TOT_BSA)) AS TOT_BSA," ).append("\n"); 
		query.append("	MIN(DECODE (TRD.GUBUN , 'TRADE', TRD.LOW_QTY)) AS LOW_QTY" ).append("\n"); 
		...
		query.append("		DECODE(MIN(TRD.MQTA_STEP_CD), '01','TRADE', '02','RHQ', '03','FINAL') AS GUBUN," ).append("\n"); 
		query.append("		TRD.BSE_MON AS BSE_MON," ).append("\n"); 
		query.append("		TRD.SUB_TRD_CD," ).append("\n"); 
		query.append("		MIN(TRD.RLANE_CD) AS RLANE_CD,  --hidden" ).append("\n"); 
		query.append("		MIN(TRD.SPRT_GRP_CD) AS SPRT_GRP_CD,  --hidden" ).append("\n"); 
		query.append("		MIN(TRD.BSA_GRP_CD) AS BSA_GRP_CD,  --hidden" ).append("\n"); 
		query.append("		RANK() OVER (PARTITION BY SUBSTR(VVD.LANE_GRP,0,7) ORDER BY SUBSTR(VVD.LANE_GRP,8)) AS GRP_SEQ," ).append("\n"); 
		query.append("		VVD.LANE_GRP AS LANE_GRP," ).append("\n"); 
		query.append("		DECODE(GROUPING(TRD.CTRT_RHQ_CD), 1," ).append("\n"); 
		query.append("		'TOTAL', (TRD.CTRT_RHQ_CD)) AS RHQ_CD," ).append("\n"); 
		query.append("		MIN(VVD.TOT_BSA) AS TOT_BSA ," ).append("\n"); 
		...
		query.append("		SUM((TRD.GRS_RPB_REV-TRD.RA_CM_UC_AMT)*TRD.LOD_QTY) AS TOT_RA_CM," ).append("\n"); 
		query.append("		DECODE(SUM(TRD.LOD_QTY), 0, 0," ).append("\n"); 
		query.append("		SUM((TRD.GRS_RPB_REV-TRD.CM_UC_AMT)*TRD.LOD_QTY)/SUM(TRD.LOD_QTY)" ).append("\n"); 
		query.append("		) AS TOT_CMB," ).append("\n"); 
		query.append("		DECODE(SUM(TRD.LOD_QTY), 0, 0," ).append("\n"); 
		query.append("		SUM((TRD.GRS_RPB_REV-TRD.RA_CM_UC_AMT)*TRD.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("		/SUM(TRD.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("		) AS TOT_RA_CMB," ).append("\n"); 
		query.append("		SUM((TRD.GRS_RPB_REV-TRD.OPFIT_UC_AMT)*TRD.LOD_QTY) AS TOT_OP," ).append("\n"); 
		query.append("		SUM((TRD.GRS_RPB_REV-TRD.RA_OPFIT_UC_AMT)*TRD.LOD_QTY) AS TOT_RA_OP," ).append("\n"); 
		query.append("		DECODE(SUM(TRD.LOD_QTY), 0, 0," ).append("\n"); 
		...
		query.append("		DECODE(SUM(TRD.LOD_QTY), 0, 0," ).append("\n"); 
		query.append("		SUM((TRD.GRS_RPB_REV-TRD.RA_OPFIT_UC_AMT)*TRD.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("		/SUM(TRD.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("		) AS TOT_RA_OPB," ).append("\n"); 
		query.append("		SUM(TRD.CM_UC_AMT) AS CM_UC_AMT," ).append("\n"); 
		query.append("		SUM(TRD.OPFIT_UC_AMT) AS OPFIT_UC_AMT," ).append("\n"); 
		query.append("		SUM(TRD.RA_CM_UC_AMT) AS RA_CM_UC_AMT," ).append("\n"); 
		query.append("		SUM(TRD.RA_OPFIT_UC_AMT) AS RA_OPFIT_UC_AMT," ).append("\n"); 
		query.append("		NVL(MIN(LOD.LOW_QTY), 0) AS LOW_QTY" ).append("\n"); 
		...
		query.append("	AND    ((VER.MQTA_STEP_CD = '01' AND VER.MQTA_VER_NO = INP.MQTA_VER_NO)" ).append("\n"); 
		query.append("	OR (VER.MQTA_STEP_CD = '03' AND VER.MQTA_VER_NO = INP.MQTA_VER_NO)" ).append("\n"); 
		...
		query.append("	" ).append("\n"); 
		query.append("	GROUP BY GROUPING SETS ((TRD.MQTA_STEP_CD,TRD.BSE_MON,TRD.SUB_TRD_CD,VVD.LANE_GRP)," ).append("\n"); 
		query.append("	(TRD.MQTA_STEP_CD,TRD.BSE_MON,TRD.SUB_TRD_CD,VVD.LANE_GRP,  TRD.CTRT_RHQ_CD )" ).append("\n"); 
		query.append("	)" ).append("\n"); 
		...
		query.append("			ADJ.LANE_GRP AS LANE_GRP," ).append("\n"); 
		query.append("			QTA.RHQ_CD," ).append("\n"); 
		query.append("			MIN(VVD.TOT_BSA/VVD.TOT_VOY) AS TOT_BSA," ).append("\n"); 
		query.append("			MIN(VVD.TOT_VOY) AS TOT_VOY," ).append("\n"); 
		query.append("			SUM(QTA.TOT_LOD/VVD.TOT_VOY) AS TOT_LOD," ).append("\n"); 
		query.append("			SUM(QTA.TOT_REV/VVD.TOT_VOY) AS TOT_REV," ).append("\n"); 
		query.append("			SUM((QTA.TOT_REV/VVD.TOT_VOY)/(QTA.TOT_LOD/VVD.TOT_VOY)) AS TOT_RPB," ).append("\n"); 
		query.append("			SUM(QTA.TOT_CM/VVD.TOT_VOY) AS TOT_CM," ).append("\n"); 
		query.append("			SUM(QTA.TOT_RA_CM/VVD.TOT_VOY) AS TOT_RA_CM," ).append("\n"); 
		query.append("			SUM((QTA.TOT_CM/VVD.TOT_VOY)/(QTA.TOT_LOD/VVD.TOT_VOY)) AS TOT_CMB," ).append("\n"); 
		query.append("			SUM((QTA.TOT_RA_CM/VVD.TOT_VOY)/(QTA.TOT_LOD/VVD.TOT_VOY)) AS TOT_RA_CMB," ).append("\n"); 
		query.append("			SUM(QTA.TOT_OP/VVD.TOT_VOY) AS TOT_OP," ).append("\n"); 
		query.append("			SUM(QTA.TOT_RA_OP/VVD.TOT_VOY) AS TOT_RA_OP," ).append("\n"); 
		query.append("			SUM((QTA.TOT_OP/VVD.TOT_VOY)/(QTA.TOT_LOD/VVD.TOT_VOY)) AS TOT_OPB," ).append("\n"); 
		query.append("			SUM((QTA.TOT_RA_OP/VVD.TOT_VOY)/(QTA.TOT_LOD/VVD.TOT_VOY)) AS TOT_RA_OPB" ).append("\n"); 
		...
		query.append("					VVD.SUB_TRD_CD," ).append("\n"); 
		query.append("					QTA.RLANE_CD," ).append("\n"); 
		query.append("					DECODE(GROUPING(QTA.RHQ_CD), 1, 'TOTAL', QTA.RHQ_CD) AS RHQ_CD," ).append("\n"); 
		...
		query.append("				GROUP BY GROUPING SETS((NVL(DIR.CONV_DIR_CD, QTA.DIR_CD), QTA.BSE_MON, VVD.SUB_TRD_CD, QTA.RLANE_CD, QTA.RHQ_CD)" ).append("\n"); 
		...
		query.append("			GROUP BY QTA.BSE_MON,QTA.SUB_TRD_CD,ADJ.LANE_GRP,QTA.RHQ_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("			(VVD.RLANE_CD||'-'||VVD.SPRT_GRP_CD||VVD.BSA_GRP_CD) AS LANE_GRP," ).append("\n"); 
		query.append("			DECODE(GROUPING(MRS.CTRT_RHQ_CD), 1," ).append("\n"); 
		query.append("			'TOTAL', MRS.CTRT_RHQ_CD) AS RHQ_CD," ).append("\n"); 
		query.append("			MIN(VVD.FNL_BSA_CAPA) AS TOT_BSA," ).append("\n"); 
		query.append("			COUNT(DISTINCT VVD.VSL_CD||VVD.SKD_VOY_NO||VVD.SKD_DIR_CD) AS TOT_VOY," ).append("\n"); 
		...
		query.append("		GROUP BY GROUPING SETS ((MRS.SUB_TRD_CD, VVD.RLANE_CD, VVD.SPRT_GRP_CD, VVD.BSA_GRP_CD)," ).append("\n"); 
		query.append("		(MRS.SUB_TRD_CD, VVD.RLANE_CD, VVD.SPRT_GRP_CD, VVD.BSA_GRP_CD, MRS.CTRT_RHQ_CD" ).append("\n"); 
		query.append("		))" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("	UNION ALL" ).append("\n"); 
		query.append("	" ).append("\n"); 
		...
		query.append("			VVD.LANE_GRP AS LANE_GRP," ).append("\n"); 
		query.append("			DECODE(GROUPING(RHQ.CTRT_RHQ_CD), 1," ).append("\n"); 
		query.append("			'TOTAL', (RHQ.CTRT_RHQ_CD)) AS RHQ_CD," ).append("\n"); 
		query.append("			MIN(VVD.TOT_BSA) AS TOT_BSA ," ).append("\n"); 
		query.append("			MIN(VVD.TOT_VOY) AS TOT_VOY ," ).append("\n"); 
		...
		query.append("			) AS TOT_CMB," ).append("\n"); 
		query.append("			DECODE(SUM(RHQ.LOD_QTY), 0, 0," ).append("\n"); 
		query.append("			SUM((RHQ.GRS_RPB_REV-RHQ.RA_CM_UC_AMT)*RHQ.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("			/SUM(RHQ.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("			) AS TOT_RA_CMB," ).append("\n"); 
		...
		query.append("			) AS TOT_OPB," ).append("\n"); 
		query.append("			DECODE(SUM(RHQ.LOD_QTY), 0, 0," ).append("\n"); 
		query.append("			SUM((RHQ.GRS_RPB_REV-RHQ.RA_OPFIT_UC_AMT)*RHQ.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("			/SUM(RHQ.LOD_QTY*VVD.TOT_VOY)" ).append("\n"); 
		query.append("			) AS TOT_RA_OPB" ).append("\n"); 
		query.append("		FROM   TMP_INPUT_PARMAS INP," ).append("\n"); 
		query.append("		TMP_MON_TGT_VVD_ADJ VVD," ).append("\n"); 
		...
		query.append("		GROUP BY GROUPING SETS ((RHQ.SUB_TRD_CD,VVD.LANE_GRP)," ).append("\n"); 
		query.append("		(RHQ.SUB_TRD_CD,VVD.LANE_GRP, RHQ.CTRT_RHQ_CD" ).append("\n"); 
		query.append("		))" ).append("\n"); 
		...
		query.append("		AND    NOT (TRD.RHQ_CD != 'TOTAL' AND ITM.ROW_SEQ IN ('01', '04'))" ).append("\n"); 
		query.append("		GROUP BY TRD.SUB_TRD_CD, TRD.LANE_GRP, TRD.RHQ_CD, ITM.CODE, ITM.TEXT, ITM.ROW_SEQ, DIR.DIR_CD" ).append("\n"); 
		query.append("		ORDER BY KEY, LANE_GRP, DECODE(RHQ_CD, 'TOTAL', '0', RHQ_CD),ITM.ROW_SEQ" ).append("\n"); 
