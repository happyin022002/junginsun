...
*@FileName : ESM_BKG_0278HTMLAction.java
...
public class ESM_BKG_0278HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0278HTMLAction 객체를 생성
	 */
	public ESM_BKG_0278HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0278Event event = new EsmBkg0278Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setGrpBlPrtInVO((GrpBlPrtInVO)getVO(request, GrpBlPrtInVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setGrpBlPrtInVO((GrpBlPrtInVO)getVO(request, GrpBlPrtInVO .class));
			event.setGrpBlPrtVOs((GrpBlPrtVO[])getVOs(request, GrpBlPrtVO.class, "t2sheet1_"));
		}
