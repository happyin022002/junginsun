...
*@FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03Sub01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03Sub01RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search MonthlyQuotaInquiry139 List03 Sub01
	  * </pre>
	  */
	public MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03Sub01RSQL(){
		setQuery();
		...
		params.put("targetGrpChild",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("tradeChild",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("dirCdChild",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03Sub01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        @[targetGrpChild] AS TGT_GRP_CD," ).append("\n"); 
		query.append("        @[tradeChild] AS TRD_CD," ).append("\n"); 
		query.append("        @[dirCdChild] AS DIR_CD," ).append("\n"); 
		query.append("        @[rhqCd] AS RHQ_CD," ).append("\n"); 
		query.append("        NVL(@[ctrtAqCd], '  ') AS AQ_CD	" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("            SMR.CONV_DIR_CD = INP.DIR_CD AND" ).append("\n"); 
		query.append("            SMR.RHQ_CD = INP.RHQ_CD AND" ).append("\n"); 
		query.append("            SMR.QTA_TGT_CD = 'Q' AND" ).append("\n"); 
		query.append("            NVL(SMR.AQ_CD, '  ') = INP.AQ_CD" ).append("\n"); 
		query.append("         )" ).append("\n"); 
		query.append("         JOIN" ).append("\n"); 
		query.append("         	SAQ_MON_CFM_TGT_VVD VVD" ).append("\n"); 
		query.append("         ON	" ).append("\n"); 
		...
		query.append("                VVD.CONV_DIR_CD = INP.DIR_CD" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		query.append("            JOIN" ).append("\n"); 
		...
		query.append("          SLEVEL," ).append("\n"); 
		query.append("          MIN(SMR.TGT_GRP_CD) AS TGT_GRP_CD," ).append("\n"); 
		...
		query.append("          MIN(SMR.AQ_CD) AS AQ_CD," ).append("\n"); 
		query.append("          OFC_CD," ).append("\n"); 
		query.append("          CASE SLEVEL" ).append("\n"); 
		query.append("            WHEN 7 THEN 'TOTAL'" ).append("\n"); 
		query.append("            ELSE SUB_TRD_CD" ).append("\n"); 
		query.append("          END SUB_TRD_CD," ).append("\n"); 
		query.append("          CASE SLEVEL" ).append("\n"); 
		query.append("            WHEN 7 THEN ''" ).append("\n"); 
		query.append("            WHEN 8 THEN 'TOTAL'" ).append("\n"); 
		query.append("            ELSE RLANE_CD" ).append("\n"); 
		...
		query.append("                     WHEN '011' THEN 7" ).append("\n"); 
		query.append("                     WHEN '001' THEN 8" ).append("\n"); 
		query.append("                     WHEN '000' THEN 9" ).append("\n"); 
		...
		query.append("                  CASE G_FLAG" ).append("\n"); 
		query.append("                     WHEN '011' THEN VOYAGE_LVL_7" ).append("\n"); 
		query.append("                     WHEN '001' THEN VOYAGE_LVL_8" ).append("\n"); 
		query.append("                     WHEN '000' THEN VOYAGE_LVL_9" ).append("\n"); 
		...
		query.append("                                                         AND    OFC_CD = SMR.OFC_CD)) AS VOYAGE_LVL_7," ).append("\n"); 
		query.append("                          (SELECT SUM(VOYAGE) " ).append("\n"); 
		query.append("                           FROM  VVD " ).append("\n"); 
		query.append("                           WHERE YRMON = SMR.YRMON" ).append("\n"); 
		query.append("                           AND   TRD_CD = SMR.TRD_CD " ).append("\n"); 
		...
		query.append("                                              AND    RHQ_CD = SMR.RHQ_CD" ).append("\n"); 
		query.append("                                              AND    AQ_CD = SMR.AQ_CD" ).append("\n"); 
		query.append("                                              AND    OFC_CD = SMR.OFC_CD" ).append("\n"); 
		query.append("                                              AND    SUB_TRD_CD = SMR.SUB_TRD_CD)) AS VOYAGE_LVL_8," ).append("\n"); 
		query.append("                          (SELECT SUM(VOYAGE)" ).append("\n"); 
		query.append("                           FROM  VVD" ).append("\n"); 
		query.append("                           WHERE YRMON = SMR.YRMON	" ).append("\n"); 
		query.append("                           AND   TRD_CD = SMR.TRD_CD" ).append("\n"); 
		query.append("                           AND   CONV_DIR_CD = SMR.CONV_DIR_CD " ).append("\n"); 
		query.append("                           AND   SUB_TRD_CD = SMR.SUB_TRD_CD" ).append("\n"); 
		query.append("                           AND   RLANE_CD = (SELECT DISTINCT RLANE_CD" ).append("\n"); 
		query.append("                                              FROM   MAP" ).append("\n"); 
		query.append("                                              WHERE  YRMON = SMR.YRMON" ).append("\n"); 
		query.append("                                              AND    TRD_CD = SMR.TRD_CD" ).append("\n"); 
		query.append("                                              AND    DIR_CD = SMR.DIR_CD " ).append("\n"); 
		...
		query.append("                                              AND    OFC_CD = SMR.OFC_CD" ).append("\n"); 
		query.append("                                              AND    SUB_TRD_CD = SMR.SUB_TRD_CD" ).append("\n"); 
		query.append("                                              AND    RLANE_CD = SMR.RLANE_CD)) AS VOYAGE_LVL_9,	" ).append("\n"); 
		query.append("                          LOD," ).append("\n"); 
		query.append("                          REV," ).append("\n"); 
		query.append("                          CM," ).append("\n"); 
		query.append("                          RA_CM," ).append("\n"); 
		...
		query.append("                    FROM  (  " ).append("\n"); 
		query.append("                            SELECT" ).append("\n"); 
		query.append("                                 GROUPING(SMR.OFC_CD)||GROUPING(SMR.SUB_TRD_CD)||GROUPING(SMR.RLANE_CD) AS G_FLAG,	" ).append("\n"); 
		query.append("                                 MIN(SMR.OFC_CD||SMR.SUB_TRD_CD||SMR.RLANE_CD) AS KEY, " ).append("\n"); 
		query.append("                                 MIN(SMR.TGT_GRP_CD) AS TGT_GRP_CD," ).append("\n"); 
		query.append("                                 MIN(SMR.TRD_CD) AS TRD_CD, " ).append("\n"); 
		query.append("                                 MIN(SMR.DIR_CD) AS DIR_CD," ).append("\n"); 
		...
		query.append("                            FROM  ( " ).append("\n"); 
		query.append("                                    SELECT " ).append("\n"); 
		query.append("                                         MIN(INP.TGT_GRP_CD) AS TGT_GRP_CD,	" ).append("\n"); 
		query.append("                                         MIN(SMR.TRD_CD) AS TRD_CD," ).append("\n"); 
		query.append("                                         MIN(SMR.DIR_CD) AS DIR_CD," ).append("\n"); 
		query.append("                                         MIN(SMR.CONV_DIR_CD) AS CONV_DIR_CD, " ).append("\n"); 
		query.append("                                         MIN(SMR.RHQ_CD) AS RHQ_CD," ).append("\n"); 
		...
		query.append("                                            SMR.CONV_DIR_CD = INP.DIR_CD AND " ).append("\n"); 
		query.append("                                            SMR.RHQ_CD = INP.RHQ_CD AND" ).append("\n"); 
		query.append("         								    SMR.QTA_TGT_CD = @[selType]	AND" ).append("\n"); 
		query.append("                                            NVL(SMR.AQ_CD, '  ') = INP.AQ_CD " ).append("\n"); 
		query.append("                                         )   																	" ).append("\n"); 
		query.append("         								JOIN" ).append("\n"); 
		query.append("         									SAQ_MON_CFM_TGT_VVD VVD" ).append("\n"); 
		...
		query.append("         								)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                     GROUP BY SMR.RGN_OFC_CD, VVD.SUB_TRD_CD, SMR.RLANE_CD, SMR.BSE_YR||SMR.BSE_MON		" ).append("\n"); 
		query.append("                                  ) SMR 	" ).append("\n"); 
		query.append("                            GROUP BY GROUPING SETS  ((SMR.OFC_CD, SMR.YRMON),	" ).append("\n"); 
		query.append("                                                     (SMR.OFC_CD, SMR.SUB_TRD_CD, SMR.YRMON)," ).append("\n"); 
		query.append("                                                     (SMR.OFC_CD, SMR.SUB_TRD_CD, SMR.RLANE_CD, SMR.YRMON))" ).append("\n"); 
		query.append("                          ) SMR" ).append("\n"); 
		query.append("                  ) SMR " ).append("\n"); 
		query.append("          ) SMR   " ).append("\n"); 
		query.append("          JOIN " ).append("\n"); 
		...
		query.append("          ON 1 = 1" ).append("\n"); 
		query.append("      GROUP BY SMR.SLEVEL, SMR.OFC_CD, SMR.SUB_TRD_CD, SMR.RLANE_CD, ITM.ROW_SEQ, ITM.TEXT, ITM.CODE  		" ).append("\n"); 
		query.append("      ) SMR   " ).append("\n"); 
		query.append("    ,     (" ).append("\n"); 
		query.append("          SELECT" ).append("\n"); 
		...
		query.append("             AND DIR.TRD_CD LIKE 'AES'||'${trade}%'									" ).append("\n"); 
