...
*@FileName : BookingHistoryMgtDBDAOsearchCntrFinalConfirmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingHistoryMgtDBDAOsearchCntrFinalConfirmRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 bkg의 container final confirm 관련 마지막 상태가 confirm인지 relase인지 조회한다.
	  * </pre>
	  */
	public BookingHistoryMgtDBDAOsearchCntrFinalConfirmRSQL(){
		setQuery();
		...
		query.append("FileName : BookingHistoryMgtDBDAOsearchCntrFinalConfirmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
