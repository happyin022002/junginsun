...
*@FileName : HongKongSearchCntrDangerVO.java
*@FileTitle : HongKongSearchCntrDangerVO
*Open Issues :
*Change history :
...
public class HongKongSearchCntrDangerVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<HongKongSearchCntrDangerVO> models = new ArrayList<HongKongSearchCntrDangerVO>();
	...
	/* Column Info */
	private String descnm = null;
	/* Column Info */
	private String mfag2 = null;
	/* Column Info */
	private String mfag1 = null;
	/* Column Info */
	private String pkgunit = null;
	/* Column Info */
	...
	public HongKongSearchCntrDangerVO() {}

	public HongKongSearchCntrDangerVO(String ibflag, String pagerows, String unnbr, String imdgClssCd, String descnm, String phone, String page, String flshTemp, String flshUnit, String dgRemark, String emsno, String psacls, String pkggrp, String mfag1, String mfag2, String marPoll, String labelCd, String labelDesc, String pkg, String pkgunit, String nwgt, String gwgt, String mea, String hazCont, String stwg, String label) {
		this.phone = phone;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("descnm", getDescnm());
		this.hashColumns.put("mfag2", getMfag2());
		this.hashColumns.put("mfag1", getMfag1());
		this.hashColumns.put("pkgunit", getPkgunit());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("descnm", "descnm");
		this.hashFields.put("mfag2", "mfag2");
		this.hashFields.put("mfag1", "mfag1");
		this.hashFields.put("pkgunit", "pkgunit");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDescnm(JSPUtil.getParameter(request, "descnm", ""));
		setMfag2(JSPUtil.getParameter(request, "mfag2", ""));
		setMfag1(JSPUtil.getParameter(request, "mfag1", ""));
		setPkgunit(JSPUtil.getParameter(request, "pkgunit", ""));
	 ...
	 * @param request
	 * @return HongKongSearchCntrDangerVO[]
	 */
	public HongKongSearchCntrDangerVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return HongKongSearchCntrDangerVO[]
	 */
	public HongKongSearchCntrDangerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		HongKongSearchCntrDangerVO model = null;
		...
		try {
			...
			String[] descnm = (JSPUtil.getParameter(request, prefix	+ "descnm", length));
			...
			String[] pkgunit = (JSPUtil.getParameter(request, prefix	+ "pkgunit", length));
			...
			for (int i = 0; i < length; i++) {
				model = new HongKongSearchCntrDangerVO();
				if (phone[i] != null)
				...
				if (descnm[i] != null)
					model.setDescnm(descnm[i]);
				if (mfag2[i] != null)
					model.setMfag2(mfag2[i]);
				if (mfag1[i] != null)
					model.setMfag1(mfag1[i]);
				if (pkgunit[i] != null)
					model.setPkgunit(pkgunit[i]);
				if (dgRemark[i] != null)
		...
		return getHongKongSearchCntrDangerVOs();
	}
	 ...
	 * @return HongKongSearchCntrDangerVO[]
	 */
	public HongKongSearchCntrDangerVO[] getHongKongSearchCntrDangerVOs(){
		HongKongSearchCntrDangerVO[] vos = (HongKongSearchCntrDangerVO[])models.toArray(new HongKongSearchCntrDangerVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.descnm = this.descnm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.pkgunit = this.pkgunit .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
