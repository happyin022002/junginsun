...
*@FileName : KorCustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL").append("\n");
		query.append("*/").append("\n");
	}
