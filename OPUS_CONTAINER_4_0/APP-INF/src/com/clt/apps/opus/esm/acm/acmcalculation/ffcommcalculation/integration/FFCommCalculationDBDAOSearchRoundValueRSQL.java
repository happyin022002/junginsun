...
*@FileName : FFCommCalculationDBDAOSearchRoundValueRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOSearchRoundValueRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FFCommCalculationDBDAOSearchRoundValueRSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOSearchRoundValueRSQL").append("\n");
		query.append("*/").append("\n");
	}
