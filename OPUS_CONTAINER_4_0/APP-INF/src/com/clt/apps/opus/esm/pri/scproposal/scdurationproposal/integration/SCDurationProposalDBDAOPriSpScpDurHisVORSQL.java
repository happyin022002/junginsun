...
*@FileName : SCDurationProposalDBDAOPriSpScpDurHisVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAOPriSpScpDurHisVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCDurationProposalDBDAOPriSpScpDurHisVORSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAOPriSpScpDurHisVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND 1 = (SELECT 1 FROM PRI_SP_SCP_DUR " ).append("\n"); 
