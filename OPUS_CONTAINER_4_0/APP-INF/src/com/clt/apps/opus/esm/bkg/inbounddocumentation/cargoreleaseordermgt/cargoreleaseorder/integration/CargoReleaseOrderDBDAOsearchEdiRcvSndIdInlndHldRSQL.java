...
*@FileName : CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndHldRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndHldRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * inland 지역에 세관에서 6H전송받았을 때 Snd ID, Rcv ID 를 가져옴
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndHldRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndHldRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'PA' AS EDI_MSG_ID, C.RCVR_TRD_PRNR_ID AS EDI_RCV_ID, C.SNDR_TRD_PRNR_ID AS EDI_SND_ID" ).append("\n"); 
