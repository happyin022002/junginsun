...
*@FileName : Jp24CustomsTransmissionDBDAOSearchCstmsEmlListRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Jp24CustomsTransmissionDBDAOSearchCstmsEmlListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24CustomsTransmissionDBDAOSearchCstmsEmlListRSQL(){
		setQuery();
		...
		query.append("FileName : Jp24CustomsTransmissionDBDAOSearchCstmsEmlListRSQL").append("\n");
		query.append("*/").append("\n");
	}
