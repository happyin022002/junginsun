...
*@FileName : ESM_BKG_0770HTMLAction.java
...
public class ESM_BKG_0770HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0770HTMLAction 객체를 생성
	 */
	public ESM_BKG_0770HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0770Event event = new EsmBkg0770Event();
        log.debug("::CALL::> ESM_BKG_0770_HTMLAction - " + command.getCommand());
