...
*@FileName : ESM_COA_0140HTMLAction.java
...
public class ESM_COA_0140HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0140HTMLAction 객체를 생성
	 */
	public ESM_COA_0140HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0140Event event = new EsmCoa0140Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCoaTrnsTermCalcVOS((CoaTrnsTermCalcVO[])getVOs(request, CoaTrnsTermCalcVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setSearchCostStructure0140ListVO((SearchCostStructure0140ListVO)getVO(request, SearchCostStructure0140ListVO .class));
