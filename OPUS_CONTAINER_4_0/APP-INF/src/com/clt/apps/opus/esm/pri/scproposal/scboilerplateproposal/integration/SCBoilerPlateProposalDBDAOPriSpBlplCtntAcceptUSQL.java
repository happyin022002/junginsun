...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntAcceptUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCtntAcceptUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_blpl_ctnt all accept and cancel
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCtntAcceptUSQL(){
		setQuery();
		...
		params.put("amdt_seq_accept",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntAcceptUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_BLPL_CTNT SET" ).append("\n"); 
		...
		query.append("AND	AMDT_SEQ 		= @[amdt_seq_accept]" ).append("\n"); 
		...
		query.append("AND N1ST_CMNC_AMDT_SEQ = @[amdt_seq_accept]" ).append("\n"); 
