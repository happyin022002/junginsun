...
*@FileName : AusSearchBlCharegeVO.java
*@FileTitle : AusSearchBlCharegeVO
*Open Issues :
*Change history :
...
public class AusSearchBlCharegeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AusSearchBlCharegeVO> models = new ArrayList<AusSearchBlCharegeVO>();
	...
	public AusSearchBlCharegeVO() {}

	public AusSearchBlCharegeVO(String ibflag, String pagerows, String fctype, String rate, String revenueton, String ppd, String cct, String currencycode, String tariff, String pertype) {
		this.ibflag = ibflag;
		this.rate = rate;
		this.tariff = tariff;
	 ...
	 * @param request
	 * @return AusSearchBlCharegeVO[]
	 */
	public AusSearchBlCharegeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusSearchBlCharegeVO[]
	 */
	public AusSearchBlCharegeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusSearchBlCharegeVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AusSearchBlCharegeVO();
				if (ibflag[i] != null)
		...
		return getAusSearchBlCharegeVOs();
	}
	 ...
	 * @return AusSearchBlCharegeVO[]
	 */
	public AusSearchBlCharegeVO[] getAusSearchBlCharegeVOs(){
		AusSearchBlCharegeVO[] vos = (AusSearchBlCharegeVO[])models.toArray(new AusSearchBlCharegeVO[models.size()]);
		return vos;
	}
