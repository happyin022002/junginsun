...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutPntAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutPntAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCRateProposalDBDAOPriSpScpRtRoutPntAmdVOCSQL
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutPntAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutPntAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_SP_SCP_RT_ROUT_PNT PNT" ).append("\n"); 
		...
		query.append("AND GEN_SPCL_RT_TP_CD   = PNT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
