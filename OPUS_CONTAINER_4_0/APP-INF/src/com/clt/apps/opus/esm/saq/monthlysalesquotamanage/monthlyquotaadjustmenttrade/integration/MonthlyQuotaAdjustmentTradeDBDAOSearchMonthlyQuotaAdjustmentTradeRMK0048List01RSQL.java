...
*@FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTradeRMK0048List01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTradeRMK0048List01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTradeRMK0048List01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeDBDAOSearchMonthlyQuotaAdjustmentTradeRMK0048List01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         SAQ_STS_CD," ).append("\n"); 
		query.append("         RMK_CRE_GDT    ," ).append("\n"); 
		query.append("         RANK()  OVER ( PARTITION BY RLANE_CD,SPRT_GRP_CD,BSA_GRP_CD,CTRT_RHQ_CD ORDER BY RMK_CRE_GDT DESC) RNK" ).append("\n"); 
		query.append("      FROM (" ).append("\n"); 
		query.append("         SELECT" ).append("\n"); 
		query.append("             MQTA_STEP_CD ," ).append("\n"); 
		query.append("             BSE_YR       ," ).append("\n"); 
		...
		query.append("             RMK.CTRT_RHQ_CD  ," ).append("\n"); 
		...
		query.append("               SAQ_MON_QTA_TRD_RMK RMK" ).append("\n"); 
