...
*@FileName : AustraliaManifestListDownloadDBDAOsearchAusSendHistoryByCntrNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AustraliaManifestListDownloadDBDAOsearchAusSendHistoryByCntrNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AustraliaManifestListDownloadDBDAOsearchAusSendHistoryByCntrNoRSQL(){
		setQuery();
		...
		query.append("FileName : AustraliaManifestListDownloadDBDAOsearchAusSendHistoryByCntrNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MSG_SND_NO," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${snd_dt_from} != '' && ${snd_dt_to} != '')" ).append("\n"); 
		query.append("   AND SND_DT BETWEEN TO_DATE(REPLACE(@[snd_dt_from], '-', ''), 'YYYYMMDD') AND TO_DATE(REPLACE(@[snd_dt_to], '-', ''), 'YYYYMMDD') + 1" ).append("\n"); 
		query.append("#end" ).append("\n"); 
