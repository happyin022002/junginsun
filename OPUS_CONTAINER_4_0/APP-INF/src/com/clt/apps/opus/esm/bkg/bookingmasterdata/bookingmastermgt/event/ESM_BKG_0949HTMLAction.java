...
*@FileName : ESM_BKG_0949HTMLAction.java
...
public class ESM_BKG_0949HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0949HTMLAction 객체를 생성
	 */
	public ESM_BKG_0949HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0949Event event = new EsmBkg0949Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgdocClzSetVOS((BkgdocClzSetVO[])getVOs(request, BkgdocClzSetVO .class,"sheet1_"));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgdocClzSetListVO((BkgdocClzSetListVO)getVO(request, BkgdocClzSetListVO .class));
		}
