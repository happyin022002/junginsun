...
*@FileName : SCGuidelineMainDBDAOCheckCmdtHdrHasChildRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGuidelineMainDBDAOCheckCmdtHdrHasChildRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGuidelineMainDBDAOCheckCmdtHdrHasChildRSQL(){
		setQuery();
		...
		query.append("FileName : SCGuidelineMainDBDAOCheckCmdtHdrHasChildRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_SG_RT_CMDT_ROUT S" ).append("\n"); 
		query.append("WHERE A.SVC_SCP_CD = S.SVC_SCP_CD" ).append("\n"); 
		query.append("AND A.GLINE_SEQ = S.GLINE_SEQ" ).append("\n"); 
		query.append("AND A.PRC_CUST_TP_CD = S.PRC_CUST_TP_CD" ).append("\n"); 
