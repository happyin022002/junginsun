...
*@FileName : BSAManageDBDAORemoveMultiBsaJntOpPortDwnDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveMultiBsaJntOpPortDwnDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BSA_0026 화면의 BsaJntOpPortDwn DELETE
	  * </pre>
	  */
	public BSAManageDBDAORemoveMultiBsaJntOpPortDwnDSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveMultiBsaJntOpPortDwnDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_JNT_OP_PORT_DWN" ).append("\n"); 
