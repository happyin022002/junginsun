...
public class TCharterIOConsultationDBDAOAddPaymentSlipDetailsCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2014.08.20 NYK Modify MVM-* 붙는 부분은 한진부서코드이므로 NULL 처리 함.
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("    @[flet_src_tp_cd]," ).append("\n"); 
		query.append("	DECODE(@[acct_cd],'511351',NULL,NULL)," ).append("\n"); 
		...
		query.append("    DECODE(@[acct_cd],'111431',TO_CHAR(SYSDATE,'YYMM'),NULL)," ).append("\n"); 
		query.append("	DECODE(@[acct_cd],'111431',@[slp_ser_no],NULL),	" ).append("\n"); 
		query.append("	DECODE(@[acct_cd],'111431',LPAD(@[seq_no],4,'0'),NULL)," ).append("\n"); 
		query.append("    CASE WHEN @[acct_cd] != '511351' AND @[acct_cd] != '111431' THEN DECODE(@[key_number],NULL,NULL,@[key_number])" ).append("\n"); 
