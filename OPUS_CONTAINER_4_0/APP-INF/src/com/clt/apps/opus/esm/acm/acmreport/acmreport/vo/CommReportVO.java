...
*@FileName : CommReportVO.java
*@FileTitle : CommReportVO
*Open Issues :
*Change history :
...
public class CommReportVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<CommReportVO> models = new ArrayList<CommReportVO>();
	...
	/* Column Info */
	private String reportItem = null;
	/* Column Info */
	...
	public CommReportVO(String ibflag, String pagerows, String reportItem, String arOfcCd, String agnCd, String bkgOfcCd, String obSlsOfcCd, String stsOption, String fmDt, String toDt, String sTrdCd, String sRlaneCd, String sDirCd, String blNo, String bkgNo, String ioBndCd, String commVvd, String sailArrDt, String porCd, String polCd, String podCd, String delCd, String teuFeu, String facAmt, String comI, String comIi, String brokerageAmt, String chfAmt, String tsAmt, String trAmt, String socAmt, String crossAmt, String docAmt, String ddctAmt, String usdAmt, String currCd, String calcDt, String rqstDt, String aproDt, String ifDt, String ppdFrtAmt, String cltFrtAmt, String ppdOtrAmt, String cltOtrAmt, String netAmt, String grossAmt, String pymtAmt, String ffCd, String ffName, String ffAddr, String broAddr1, String broAddr2, String broAddr3, String broAddr4, String broAddr5, String broAddr6, String panCode, String trdCd, String rlaneCd, String dirCd, String teu, String feu, String audNo, String csfAmt, String rcsfAmt, String cntrTpszCd, String cntrNo) {
		this.ifDt = ifDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("report_item", getReportItem());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("report_item", "reportItem");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setReportItem(JSPUtil.getParameter(request, prefix + "report_item", ""));
	 ...
	 * @return CommReportVO[]
	 */
	public CommReportVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CommReportVO[]
	 */
	public CommReportVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CommReportVO model = null;
		...
		try {
			...
			String[] reportItem = (JSPUtil.getParameter(request, prefix	+ "report_item", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (reportItem[i] != null)
					model.setReportItem(reportItem[i]);
				if (ppdFrtAmt[i] != null)
	 ...
	 * @return CommReportVO[]
	 */
	public CommReportVO[] getCommReportVOs(){
		CommReportVO[] vos = (CommReportVO[])models.toArray(new CommReportVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.reportItem = this.reportItem .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
