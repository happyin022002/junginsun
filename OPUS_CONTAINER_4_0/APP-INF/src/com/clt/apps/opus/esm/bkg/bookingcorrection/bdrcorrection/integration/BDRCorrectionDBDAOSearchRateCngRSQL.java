...
*@FileName : BDRCorrectionDBDAOSearchRateCngRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BDRCorrectionDBDAOSearchRateCngRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BDRCorrectionDBDAOSearchRateCngRSQL
	  * </pre>
	  */
	public BDRCorrectionDBDAOSearchRateCngRSQL(){
		setQuery();
		...
		query.append("FileName : BDRCorrectionDBDAOSearchRateCngRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
