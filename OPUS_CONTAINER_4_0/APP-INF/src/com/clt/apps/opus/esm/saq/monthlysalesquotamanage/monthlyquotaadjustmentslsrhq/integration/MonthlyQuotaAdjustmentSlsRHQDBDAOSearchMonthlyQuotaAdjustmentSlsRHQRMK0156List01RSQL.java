...
*@FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyQuotaAdjustmentSlsRHQRMK0156List01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyQuotaAdjustmentSlsRHQRMK0156List01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyQuotaAdjustmentSlsRHQRMK0156List01RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentSlsRHQDBDAOSearchMonthlyQuotaAdjustmentSlsRHQRMK0156List01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         SAQ_STS_CD," ).append("\n"); 
		query.append("         RMK_CRE_GDT    ," ).append("\n"); 
		query.append("         RANK()  OVER ( PARTITION BY RLANE_CD,SPRT_GRP_CD,BSA_GRP_CD,POL_CD,POD_CD,SLS_RGN_OFC_CD ORDER BY RMK_CRE_GDT DESC) RNK" ).append("\n"); 
		query.append("      FROM (" ).append("\n"); 
		query.append("         SELECT" ).append("\n"); 
		query.append("             MQTA_STEP_CD ," ).append("\n"); 
		query.append("             BSE_YR       ," ).append("\n"); 
		...
		query.append("             CRE_OFC_CD   ," ).append("\n"); 
		query.append("             CMT_CTNT     ," ).append("\n"); 
		query.append("             TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('GMT', RMK_CRE_GDT, @[ofcCd] ), 'yyyy.mm.dd hh24:mi:ss') AS RMK_CRE_GDT," ).append("\n"); 
		query.append("             SAQ_STS_CD" ).append("\n"); 
		query.append("         FROM   SAQ_MON_QTA_LOD_TGT_RMK" ).append("\n"); 
		...
		query.append("             RMK.SLS_RGN_OFC_CD  ," ).append("\n"); 
		query.append("             RMK.POL_CD ," ).append("\n"); 
		query.append("             RMK.POD_CD ," ).append("\n"); 
		...
		query.append("               SAQ_MON_QTA_LOD_TGT_RMK RMK" ).append("\n"); 
