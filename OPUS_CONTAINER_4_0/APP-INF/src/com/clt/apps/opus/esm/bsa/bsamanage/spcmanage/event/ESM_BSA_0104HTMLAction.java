...
*@FileName : ESM_BSA_0104HTMLAction.java
...
public class ESM_BSA_0104HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BSA_0104HTMLAction 객체를 생성
	 */
	public ESM_BSA_0104HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBsa0104Event event = new EsmBsa0104Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)||command.isCommand(FormCommand.SEARCHLIST02)) {
			...
			event.setBsaSpcSlotInfoByVvdSaveVOs((BsaSpcSlotInfoByVvdSaveVO[])getVOs(request, BsaSpcSlotInfoByVvdSaveVO.class));
