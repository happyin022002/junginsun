...
*@FileName : KorManifestListDBDAOsearchCustCntRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchCustCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchCustCntRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchCustCntRSQL").append("\n");
		query.append("*/").append("\n");
	}
