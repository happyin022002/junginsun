...
public class CLLCDLManifestDBDAOaddCllMainForDownloadCSQL implements ISQLTemplate{
	...
	public CLLCDLManifestDBDAOaddCllMainForDownloadCSQL(){
		...
		params.put("prt_vgm_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_meas_qty_ut_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_in_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_cntr_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_doc_meas_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_doc_wgt_ut_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_vgm_wgt_ut_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_pck_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_meas_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_pck_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_doc_meas_ut_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_cntr_wgt_ut_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_doc_act_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("prt_in_teu",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("					BKG_TOKEN_NL_FNC(BCS.CUST_NM,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCS.CUST_NM,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCS.CUST_ADDR,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCS.CUST_ADDR,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCS.CUST_ADDR,3,'')," ).append("\n"); 
		query.append("					NVL(BCC.CUST_CNT_CD,' ')," ).append("\n"); 
		query.append("					BCC.CUST_SEQ," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCC.CUST_NM,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCC.CUST_NM,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCC.CUST_ADDR,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCC.CUST_ADDR,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCC.CUST_ADDR,3,'')," ).append("\n"); 
		query.append("					NVL(BCN.CUST_CNT_CD,' ')," ).append("\n"); 
		query.append("					BCN.CUST_SEQ," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCN.CUST_NM,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCN.CUST_NM,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCN.CUST_ADDR,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCN.CUST_ADDR,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCN.CUST_ADDR,3,'')," ).append("\n"); 
		query.append("					NVL(BCA.CUST_CNT_CD,' ')," ).append("\n"); 
		query.append("					BCA.CUST_SEQ," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCA.CUST_NM,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCA.CUST_NM,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCA.CUST_NM,3,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCA.CUST_NM,4,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCA.CUST_NM,5,'')," ).append("\n"); 
		query.append("					NVL(BCF.CUST_CNT_CD,' ')," ).append("\n"); 
		query.append("					BCF.CUST_SEQ," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCF.CUST_NM,1,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCF.CUST_NM,2,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCF.CUST_NM,3,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCF.CUST_NM,4,'')," ).append("\n"); 
		query.append("					BKG_TOKEN_NL_FNC(BCF.CUST_NM,5,'')," ).append("\n"); 
		query.append("					@[cntr_tpsz_cd]," ).append("\n"); 
		...
		query.append("					NVL(NVL(@[prt_pck_tp_cd],C.PCK_TP_CD),' ')," ).append("\n"); 
		query.append("					NVL(NVL(@[prt_pck_qty],C.PCK_QTY), 0)," ).append("\n"); 
		query.append("					NVL(NVL(@[prt_vgm_wgt],C.VGM_WGT), 0)," ).append("\n"); 
		query.append("					NVL(NVL(@[prt_vgm_wgt_ut_cd],C.VGM_WGT_UT_CD), ' ')," ).append("\n"); 
		query.append("					DECODE(NVL(@[prt_cntr_wgt_ut_cd],C.WGT_UT_CD), NULL, NVL(@[prt_doc_wgt_ut_cd],DOC.WGT_UT_CD), NVL(@[prt_cntr_wgt_ut_cd],C.WGT_UT_CD))," ).append("\n"); 
		query.append("					DECODE(NVL(NVL(@[prt_cntr_wgt],C.CNTR_WGT),0), 0, ROUND(NVL(@[prt_doc_act_wgt],DOC.ACT_WGT) / NVL(@[prt_in_qty],@[in_qty]), 0), ROUND(NVL(@[prt_cntr_wgt],C.CNTR_WGT),0))," ).append("\n"); 
		query.append("					DECODE(NVL(@[prt_cntr_wgt_ut_cd],C.WGT_UT_CD), NULL, NVL(@[prt_doc_wgt_ut_cd],DOC.WGT_UT_CD), NVL(@[prt_cntr_wgt_ut_cd],C.WGT_UT_CD))," ).append("\n"); 
		query.append("					" ).append("\n"); 
		query.append("					ROUND(" ).append("\n"); 
		query.append("					(DECODE(NVL(NVL(@[prt_cntr_wgt],C.CNTR_WGT),0),0,ROUND(nvl(NVL(@[prt_doc_act_wgt],DOC.ACT_WGT),0) * decode(substr(NVL(C.CNTR_TPSZ_CD,@[cntr_tpsz_cd]),2,1),'2',1,2) / NVL((SELECT SUM(DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'2',1,2)) FROM BKG_CONTAINER BC WHERE BC.BKG_NO = C.BKG_NO),1)),NVL(@[prt_cntr_wgt],C.CNTR_WGT))" ).append("\n"); 
		query.append("					+ DECODE(NVL(DECODE(NVL(KKK.SPEC_TARE_WGT, 0), 0, DECODE(NVL(KKK.MDM_CNTR_TPSZ_TARE_WGT, 0), 0, DECODE(KKK.O_CNTR_TPSZ_CD, 'T2', 3600, 'T4', 5200, 0), KKK.MDM_CNTR_TPSZ_TARE_WGT), KKK.SPEC_TARE_WGT  ),0),0,(SELECT CNTR_TPSZ_TARE_WGT FROM MDM_CNTR_TP_SZ WHERE CNTR_TPSZ_CD = @[cntr_tpsz_cd]), NVL(DECODE(NVL(KKK.SPEC_TARE_WGT, 0), 0, DECODE(NVL(KKK.MDM_CNTR_TPSZ_TARE_WGT, 0), 0, DECODE(KKK.O_CNTR_TPSZ_CD, 'T2', 3600, 'T4', 5200, 0), KKK.MDM_CNTR_TPSZ_TARE_WGT), KKK.SPEC_TARE_WGT  ),0))) * DECODE(NVL(NVL(@[prt_cntr_wgt_ut_cd],C.WGT_UT_CD), ' '), 'LBS',0.4536,1),2)," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("					DECODE(NVL(@[prt_meas_qty_ut_cd],C.MEAS_UT_CD), NULL, NVL(@[prt_doc_meas_ut_cd],DOC.MEAS_UT_CD), NVL(@[prt_meas_qty_ut_cd],C.MEAS_UT_CD))," ).append("\n"); 
		query.append("					DECODE(NVL(@[prt_meas_qty],C.MEAS_QTY),NULL,ROUND(NVL(@[prt_doc_meas_qty],DOC.MEAS_QTY) / NVL(@[prt_in_qty],@[in_qty]), 0),NVL(@[prt_meas_qty],C.MEAS_QTY))," ).append("\n"); 
		...
		query.append("					   AND CNTR_NO = C.CNTR_NO ) CNTR_SEAL_NO," ).append("\n"); 
		...
		query.append("					NVL(NVL(@[prt_in_teu],@[in_teu]),0)," ).append("\n"); 
		query.append("					NVL(NVL(@[prt_in_teu],@[in_feu]),0)," ).append("\n"); 
		query.append("					NVL(C.RC_FLG,'N')," ).append("\n"); 
		query.append("					NVL(C.DCGO_FLG,'0')," ).append("\n"); 
		query.append("					NVL(C.AWK_CGO_FLG,'N')," ).append("\n"); 
		query.append("					NVL(C.BB_CGO_FLG,'N')," ).append("\n"); 
		query.append("					DECODE(SUBSTR(C.CNTR_TPSZ_CD,1,1),'R',NVL(C.RD_CGO_FLG,'N'),'N'),--tank reefer 는 Y, Y 들어감" ).append("\n"); 
		query.append("					substr(Translate(NVL(R.DIFF_RMK,' '),chr(10),' '),1,50)," ).append("\n"); 
		query.append("        			substr(Translate(NVL(B.XTER_RMK,' '),chr(10),' '),1,200)," ).append("\n"); 
