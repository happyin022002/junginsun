 ...
 *@FileName : ESM_PRI_0114HTMLAction.java
...
public class ESM_PRI_0114HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0114Event event = new EsmPri0114Event();
