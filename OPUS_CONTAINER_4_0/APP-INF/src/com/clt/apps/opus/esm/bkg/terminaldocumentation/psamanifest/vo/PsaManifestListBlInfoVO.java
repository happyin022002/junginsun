...
*@FileName : PsaManifestListBlInfoVO.java
*@FileTitle : PsaManifestListBlInfoVO
*Open Issues :
*Change history :
...
public class PsaManifestListBlInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsaManifestListBlInfoVO> models = new ArrayList<PsaManifestListBlInfoVO>();
	...
	public PsaManifestListBlInfoVO() {}

	public PsaManifestListBlInfoVO(String ibflag, String pagerows, String bkgNo, String vslCd, String skdVoyNo, String skdDirCd, String blNo, String polCd, String podCd, String delCd, String pckQty, String cstmsPckTpCd, String actWgt, String wgtUtCd, String measQty, String measUtCd, String cstmsDesc, String tsInd, String usrId) {
		this.vslCd = vslCd;
		this.delCd = delCd;
...
/**
	 ...
	 * @param request
	 * @return PsaManifestListBlInfoVO[]
	 */
	public PsaManifestListBlInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaManifestListBlInfoVO[]
	 */
	public PsaManifestListBlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaManifestListBlInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PsaManifestListBlInfoVO();
				if (vslCd[i] != null)
		...
		return getPsaManifestListBlInfoVOs();
	}
	 ...
	 * @return PsaManifestListBlInfoVO[]
	 */
	public PsaManifestListBlInfoVO[] getPsaManifestListBlInfoVOs(){
		PsaManifestListBlInfoVO[] vos = (PsaManifestListBlInfoVO[])models.toArray(new PsaManifestListBlInfoVO[models.size()]);
		return vos;
	}
