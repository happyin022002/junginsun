...
*@FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplVODSQL.java
...
public class SCBoilerPlateGuidelineDBDAOPriSgBlplVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOPriSgBlplVODSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from pri_sg_blpl" ).append("\n"); 
