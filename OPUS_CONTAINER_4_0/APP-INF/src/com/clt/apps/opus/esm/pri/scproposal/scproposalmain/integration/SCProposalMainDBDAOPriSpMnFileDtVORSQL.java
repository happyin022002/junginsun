...
public class SCProposalMainDBDAOPriSpMnFileDtVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT MAX(TO_CHAR(FILE_DT, 'YYYYMMDD')) LAST_FILE_DT" ).append("\n"); 
		query.append("      ,TO_CHAR(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[prop_ofc_cd]),  'YYYYMMDD') FILE_DT" ).append("\n"); 
		query.append("      ,TO_CHAR(SYSDATE, 'YYYYMMDD') SYS_DT" ).append("\n"); 
		query.append("      ,MAX(TO_CHAR(EFF_DT, 'YYYYMMDD')) PRE_EFF_DT" ).append("\n"); 
