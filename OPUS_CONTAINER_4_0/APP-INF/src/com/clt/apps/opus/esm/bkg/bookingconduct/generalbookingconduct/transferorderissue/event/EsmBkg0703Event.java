...
public class EsmBkg0703Event extends EventSupport {
	...
	public TroMultiCancelFrustVO[] getTroMultiCancelFrustVOs() {
		TroMultiCancelFrustVO[] tmpVOs = null;
		if (this. troMultiCancelFrustVOs != null) {
			tmpVOs = Arrays.copyOf(troMultiCancelFrustVOs, troMultiCancelFrustVOs .length);
		}
		return tmpVOs;
	}
	/**
	 ...
	 */
	public void setTroMultiCancelFrustVOs(TroMultiCancelFrustVO[] troMultiCancelFrustVOs) {
		if (troMultiCancelFrustVOs != null) {
			TroMultiCancelFrustVO[] tmpVOs = Arrays.copyOf(troMultiCancelFrustVOs, troMultiCancelFrustVOs .length);
			this. troMultiCancelFrustVOs = tmpVOs;
		}
	}
	/**
	 * @return the ioBndCd
