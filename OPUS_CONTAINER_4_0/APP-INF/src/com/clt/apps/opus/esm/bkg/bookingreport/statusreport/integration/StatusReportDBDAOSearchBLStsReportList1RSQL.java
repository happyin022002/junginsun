...
public class StatusReportDBDAOSearchBLStsReportList1RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			/* 2015.07.27 수정 */" ).append("\n"); 
		query.append("            , NVL(BKG_GET_TOKEN_FNC(ZZ.SAR,1),'N') AS PPD_ORG" ).append("\n"); 
		query.append("            , BKG_GET_TOKEN_FNC(ZZ.SAR,2) AS PPD_ORG2" ).append("\n"); 
		query.append("            , NVL(BKG_GET_TOKEN_FNC(ZZ.SAR,5),'N') AS PPD_3RD" ).append("\n"); 
		query.append("            , BKG_GET_TOKEN_FNC(ZZ.SAR,6) AS PPD_3RD2" ).append("\n"); 
		query.append("            , NVL(BKG_GET_TOKEN_FNC(ZZ.SAR,3),'N') AS CCT_DEST" ).append("\n"); 
		query.append("            , BKG_GET_TOKEN_FNC(ZZ.SAR,4) AS CCT_DEST2" ).append("\n"); 
		query.append("            , NVL(BKG_GET_TOKEN_FNC(ZZ.SAR,7),'N') AS CCT_3RD" ).append("\n"); 
		query.append("            , BKG_GET_TOKEN_FNC(ZZ.SAR,8) AS CCT_3RD2" ).append("\n"); 
		...
		query.append("		     ( SELECT REPLACE(CUST_NM,chr(10),' ')" ).append("\n"); 
		...
		query.append("			/* 2015.07.27 수정 */" ).append("\n"); 
		query.append("			, BKG_GET_SAR_OTS_FNC(Y.BKG_NO) SAR" ).append("\n"); 
		query.append("		    FROM ( SELECT   " ).append("\n"); 
		...
		query.append("                            NVL(ISS.BL_ISS_TP_CD,'B')                  AS IR_BL_TYPE," ).append("\n"); 
		...
		query.append("							NVL((SELECT 'Y' FROM BKG_INET_BL_PRN_AUTH WHERE BKG_NO = BK.BKG_NO AND N1ST_PRN_DT IS NOT NULL AND DELT_FLG = 'N' AND ROWNUM = 1),NVL(ISS.OBL_PRN_FLG,'N')) BL_PRINT," ).append("\n"); 
		...
		query.append("                                    WHERE BI.BKG_NO = BK.BKG_NO " ).append("\n"); 
		query.append("                                    AND BI.BL_RDY_OFC_CD IS NOT NULL" ).append("\n"); 
		query.append("                                    AND BI.BL_RDY_USR_ID IS NOT NULL" ).append("\n"); 
		query.append("                                    AND BI.BL_RDY_DT IS NOT NULL),'N') AS BDI_COMPLETE," ).append("\n"); 
		...
		query.append("								AND DOC_TP.BKG_DOC_PROC_TP_CD  = 'OBLRED'" ).append("\n"); 
		query.append("								" ).append("\n"); 
		query.append("								#if(${dura_from_dt} != '')" ).append("\n"); 
		query.append("									AND DOC_SKD.EVNT_DT >= TO_DATE(@[dura_from_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append("								#end" ).append("\n"); 
		...
		query.append("                                    AND BI.BL_RDY_OFC_CD IS NOT NULL" ).append("\n"); 
		query.append("                                    AND BI.BL_RDY_USR_ID IS NOT NULL" ).append("\n"); 
		query.append("                                    AND BI.BL_RDY_DT IS NOT NULL),'N') ='Y'" ).append("\n"); 
		query.append("  						#end" ).append("\n"); 
		query.append("                        " ).append("\n"); 
		...
		query.append("                                    AND BI.BL_RDY_OFC_CD IS NOT NULL" ).append("\n"); 
		query.append("                                    AND BI.BL_RDY_USR_ID IS NOT NULL" ).append("\n"); 
		query.append("                                    AND BI.BL_RDY_DT IS NOT NULL),'N') ='N'" ).append("\n"); 
		query.append("  						#end" ).append("\n"); 
		query.append("						" ).append("\n"); 
		query.append("						/* 2015.07.16 수정 */" ).append("\n"); 
		query.append("" ).append("\n"); 
