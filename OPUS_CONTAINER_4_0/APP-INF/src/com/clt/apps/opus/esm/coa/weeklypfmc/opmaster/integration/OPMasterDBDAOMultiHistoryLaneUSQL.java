...
*@FileName : OPMasterDBDAOMultiHistoryLaneUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistoryLaneUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistoryLaneUSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistoryLaneUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_LANE_TP_HIS SET" ).append("\n"); 
		query.append("    VSL_LANE_TP_CD   = @[vsl_lane_tp_cd]" ).append("\n"); 
		query.append("   ,STUP_FLG         = DECODE(@[stup_flg], '1', 'Y', 'N')" ).append("\n"); 
		query.append("   ,VVD_CD           = @[vvd_cd]" ).append("\n"); 
		query.append("   ,LANE_APLY_FM_DT  = @[lane_aply_fm_dt]" ).append("\n"); 
		query.append("   ,LANE_APLY_TO_DT  = @[lane_aply_to_dt]" ).append("\n"); 
		...
		query.append("   AND LANE_SEQ = @[lane_seq]" ).append("\n"); 
