...
public class UsCgoRlseBkbcFocVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("muti_snd", getMultiSnd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("muti_snd", "multiSnd");
	 ...
	 * @return multiSnd
	 */
	public String getMultiSnd() {
		return this.multiSnd;
	}	
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMultiSnd(JSPUtil.getParameter(request, "muti_snd", ""));
	...
	public UsCgoRlseBkbcFocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] multiSnd = (JSPUtil.getParameter(request, prefix	+ "muti_snd", length));
	...
	*/
	public void unDataFormat(){
		...
		this.multiSnd = this.multiSnd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
