...
*@FileName : SalesRepInfoManageDAOSearchPrmyKeyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesRepInfoManageDAOSearchPrmyKeyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SalesRepInfoManageDAOSearchPrmyKeyRSQL(){
		setQuery();
		...
		query.append("FileName : SalesRepInfoManageDAOSearchPrmyKeyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CUST_CNT_CD,SREP_CD,CUST_SEQ,SREP_PRMRY_FLG AS FLG" ).append("\n"); 
