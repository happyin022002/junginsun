...
*@FileName : ESM_FMS_0004HTMLAction.java
...
public class ESM_FMS_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0004HTMLAction 객체를 생성
	 */
	public ESM_FMS_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0004Event event = new EsmFms0004Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchVendorCustomerVOS((SearchVendorCustomerVO[])getVOs(request, SearchVendorCustomerVO .class,""));
		}
