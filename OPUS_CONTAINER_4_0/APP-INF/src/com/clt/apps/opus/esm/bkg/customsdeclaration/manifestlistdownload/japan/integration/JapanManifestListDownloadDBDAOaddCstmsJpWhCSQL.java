...
*@FileName : JapanManifestListDownloadDBDAOaddCstmsJpWhCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOaddCstmsJpWhCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOaddCstmsJpWhCSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOaddCstmsJpWhCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_JP_WH" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("VALUES (@[yd_cd]," ).append("\n"); 
		query.append("        @[cstms_cd]," ).append("\n"); 
		query.append("        @[wh_nm]," ).append("\n"); 
