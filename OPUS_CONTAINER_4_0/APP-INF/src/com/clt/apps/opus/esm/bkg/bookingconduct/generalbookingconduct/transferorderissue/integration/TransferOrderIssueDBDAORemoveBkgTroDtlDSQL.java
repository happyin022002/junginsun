...
*@FileName : TransferOrderIssueDBDAORemoveBkgTroDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAORemoveBkgTroDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TransferOrderIssueDB::RemoveBkgTroDtl
	  * </pre>
	  */
	public TransferOrderIssueDBDAORemoveBkgTroDtlDSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAORemoveBkgTroDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_TRO_DTL" ).append("\n"); 
		query.append("WHERE	BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("AND	IO_BND_CD = @[io_bnd_cd]" ).append("\n"); 
		query.append("#if (${rtn_tro_flg} != '') " ).append("\n"); 
