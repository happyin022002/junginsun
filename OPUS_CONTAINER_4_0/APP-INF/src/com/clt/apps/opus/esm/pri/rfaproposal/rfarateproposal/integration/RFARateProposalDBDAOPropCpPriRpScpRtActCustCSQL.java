...
*@FileName : RFARateProposalDBDAOPropCpPriRpScpRtActCustCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPropCpPriRpScpRtActCustCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_RP_SCP_RT_ACT_CUST Insert
	  * </pre>
	  */
	public RFARateProposalDBDAOPropCpPriRpScpRtActCustCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPropCpPriRpScpRtActCustCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY B.PROP_NO, B.AMDT_SEQ, B.SVC_SCP_CD, B.CMDT_HDR_SEQ, B.ACT_CUST_SEQ) AS ACT_CUST_SEQ" ).append("\n"); 
