...
*@FileName : EBookingReceiptDBDAOSearchBkgXterRcvMsgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOSearchBkgXterRcvMsgRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EBookingReceiptDBDAOSearchBkgXterRcvMsgRSQL
	  * </pre>
	  */
	public EBookingReceiptDBDAOSearchBkgXterRcvMsgRSQL(){
		setQuery();
		...
		params.put("xml_and_edi_msg_desc",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : EBookingReceiptDBDAOSearchBkgXterRcvMsgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , XTER_SNDR_ID AS MSG_TYPE" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${xml_and_edi_msg_desc} != '')" ).append("\n"); 
		query.append("  AND XML_AND_EDI_MSG_DESC LIKE '%'||@[xml_and_edi_msg_desc]||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
