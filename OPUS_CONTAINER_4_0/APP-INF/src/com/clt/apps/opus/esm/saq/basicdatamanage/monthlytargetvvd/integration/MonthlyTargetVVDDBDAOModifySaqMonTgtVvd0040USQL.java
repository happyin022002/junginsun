...
*@FileName : MonthlyTargetVVDDBDAOModifySaqMonTgtVvd0040USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyTargetVVDDBDAOModifySaqMonTgtVvd0040USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyTargetVVDDBDAOModifySaqMonTgtVvd0040USQL(){
		setQuery();
		...
		query.append("FileName : MonthlyTargetVVDDBDAOModifySaqMonTgtVvd0040USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    BSE_QTR_CD = @[quarter]" ).append("\n"); 
