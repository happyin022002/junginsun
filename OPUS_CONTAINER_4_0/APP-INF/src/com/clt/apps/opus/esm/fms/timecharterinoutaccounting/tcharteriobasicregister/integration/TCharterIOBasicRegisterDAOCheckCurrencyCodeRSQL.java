...
*@FileName : TCharterIOBasicRegisterDAOCheckCurrencyCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOBasicRegisterDAOCheckCurrencyCodeRSQL implements ISQLTemplate{
	...
	public TCharterIOBasicRegisterDAOCheckCurrencyCodeRSQL(){
		...
		query.append("FileName : TCharterIOBasicRegisterDAOCheckCurrencyCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE CURR_CD = UPPER(@[curr_cd])" ).append("\n"); 
