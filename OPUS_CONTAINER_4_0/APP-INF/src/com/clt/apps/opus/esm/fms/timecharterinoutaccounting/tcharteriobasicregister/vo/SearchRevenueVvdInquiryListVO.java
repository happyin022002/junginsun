...
*@FileName : SearchRevenueVvdInquiryListVO.java
*@FileTitle : SearchRevenueVvdInquiryListVO
*Open Issues :
*Change history :
...
public class SearchRevenueVvdInquiryListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchRevenueVvdInquiryListVO> models = new ArrayList<SearchRevenueVvdInquiryListVO>();
	...
	public SearchRevenueVvdInquiryListVO() {}

	public SearchRevenueVvdInquiryListVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String revDirCd, String revYrmon, String slanCd, String rlaneCd, String vstDt, String vedDt, String vvdCd) {
		this.vstDt = vstDt;
	 ...
	 */
	public SearchRevenueVvdInquiryListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchRevenueVvdInquiryListVO[]
	 */
	public SearchRevenueVvdInquiryListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchRevenueVvdInquiryListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchRevenueVvdInquiryListVO();
				if (vstDt[i] != null)
		...
		return getSearchRevenueVvdInquiryListVOs();
	}
	 ...
	 * @return SearchRevenueVvdInquiryListVO[]
	 */
	public SearchRevenueVvdInquiryListVO[] getSearchRevenueVvdInquiryListVOs(){
		SearchRevenueVvdInquiryListVO[] vos = (SearchRevenueVvdInquiryListVO[])models.toArray(new SearchRevenueVvdInquiryListVO[models.size()]);
		return vos;
	}
