...
*@FileName : EBookingReceiptDBDAOaddBkgXterAesCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterAesCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterAesCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterAesCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_AES" ).append("\n"); 
		query.append("(" ).append("\n"); 
