...
*@FileName : BSAManageDBDAOAddMultiBsaJntOpBzcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOAddMultiBsaJntOpBzcCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BsaJntOpBzc Table Insert Quiry
	  * </pre>
	  */
	public BSAManageDBDAOAddMultiBsaJntOpBzcCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOAddMultiBsaJntOpBzcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BSA_JNT_OP_BZC (" ).append("\n"); 
