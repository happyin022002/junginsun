...
*@FileName : ESM_BKG_0650HTMLAction.java
...
public class ESM_BKG_0650HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0650HTMLAction 객체를 생성
	 */
	public ESM_BKG_0650HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0650Event event = new EsmBkg0650Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgBlNoVO((BkgBlNoVO)getVO(request, BkgBlNoVO .class));
			event.setCodRqstSeq(request.getParameter("cod_rqst_seq"));
			event.setOpCd(request.getParameter("op_cd"));
		}
