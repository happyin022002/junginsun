...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.acm.acmagreement.agncommagreement.event;
...
public class EsmAcm0001Event extends EventSupport {
	...
	public AgentRateMasterVO[] getAgentRateMasterVOs() {
		AgentRateMasterVO[] rtnVOs = null;
		if (this.agentRateMasterVOs != null) {
			rtnVOs = Arrays.copyOf(agentRateMasterVOs, agentRateMasterVOs.length);
		}
		return rtnVOs;
	}

	public void setAgentRateMasterVOs(AgentRateMasterVO[] agentRateMasterVOs) {
		if(agentRateMasterVOs != null){
			AgentRateMasterVO[] tmpVOs = Arrays.copyOf(agentRateMasterVOs, agentRateMasterVOs.length);
			this.agentRateMasterVOs  = tmpVOs;
		}
	}

	public AgentRateDetailVO[] getAgentRateDetailVOs() {
		AgentRateDetailVO[] rtnVOs = null;
		if (this.agentRateDetailVOs != null) {
			rtnVOs  = Arrays.copyOf(agentRateDetailVOs, agentRateDetailVOs.length);
		}
		return rtnVOs;
	}

	public void setAgentRateDetailVOs(AgentRateDetailVO[] agentRateDetailVOs) {
		if(agentRateDetailVOs != null){
			AgentRateDetailVO[] tmpVOs = Arrays.copyOf(agentRateDetailVOs, agentRateDetailVOs.length);
			this.agentRateDetailVOs  = tmpVOs;
		}
	}
