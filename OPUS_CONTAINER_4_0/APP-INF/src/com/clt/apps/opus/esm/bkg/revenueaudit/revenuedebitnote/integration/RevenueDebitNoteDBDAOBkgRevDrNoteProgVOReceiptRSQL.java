...
*@FileName : RevenueDebitNoteDBDAOBkgRevDrNoteProgVOReceiptRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RevenueDebitNoteDBDAOBkgRevDrNoteProgVOReceiptRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOBkgRevDrNoteProgVOReceiptRSQL(){
		setQuery();
		...
		query.append("FileName : RevenueDebitNoteDBDAOBkgRevDrNoteProgVOReceiptRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND     RDN_STS_CD IN ( 'CR', 'RR', 'AC' )" ).append("\n"); 
