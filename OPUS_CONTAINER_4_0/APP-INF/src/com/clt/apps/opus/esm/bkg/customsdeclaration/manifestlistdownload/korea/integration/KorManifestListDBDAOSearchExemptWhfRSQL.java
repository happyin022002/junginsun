...
*@FileName : KorManifestListDBDAOSearchExemptWhfRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchExemptWhfRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchExemptWhfRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchExemptWhfRSQL").append("\n");
		query.append("*/").append("\n");
	}
