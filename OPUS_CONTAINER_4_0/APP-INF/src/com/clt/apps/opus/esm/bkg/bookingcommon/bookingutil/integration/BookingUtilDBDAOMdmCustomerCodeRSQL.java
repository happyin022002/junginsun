...
*@FileName : BookingUtilDBDAOMdmCustomerCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingUtilDBDAOMdmCustomerCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingUtilDBDAOMdmCustomerCodeRSQL(){
		setQuery();
		...
		query.append("FileName : BookingUtilDBDAOMdmCustomerCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${cntr_cust_tp_cd} != '') " ).append("\n"); 
		query.append("AND CNTR_CUST_TP_CD <> @[cntr_cust_tp_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${fwrd_cnt_cd} != '') " ).append("\n"); 
		query.append("AND CUST_CNT_CD = SUBSTR(@[fwrd_cnt_cd], 1, 2)" ).append("\n"); 
		query.append("AND CUST_SEQ = SUBSTR(@[fwrd_cnt_cd], 3, 8)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(" " ).append("\n"); 
