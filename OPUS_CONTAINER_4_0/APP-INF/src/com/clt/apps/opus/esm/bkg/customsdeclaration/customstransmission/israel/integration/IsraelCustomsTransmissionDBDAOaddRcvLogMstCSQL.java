...
*@FileName : IsraelCustomsTransmissionDBDAOaddRcvLogMstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IsraelCustomsTransmissionDBDAOaddRcvLogMstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IsraelCustomsTransmissionDBDAOaddRcvLogMstCSQL(){
		setQuery();
		...
		query.append("FileName : IsraelCustomsTransmissionDBDAOaddRcvLogMstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_IB_RCV" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("    CNT_CD," ).append("\n"); 
		query.append("    EDI_RCV_DT,         EDI_RCV_SEQ, " ).append("\n"); 
		query.append("    EDI_MSG_TP_ID,      EDI_SND_MSG_NM,  MSG_RCV_NO,      VSL_CD,           SKD_VOY_NO," ).append("\n"); 
		query.append("    SKD_DIR_CD,         CSTMS_PORT_CD,   BL_NO,           ACK_KND_ID,       EUR_ACK_RCV_STS_CD," ).append("\n"); 
