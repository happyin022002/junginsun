...
*@FileName : SCRateProposalDBDAOPropCpPriSpScpRtCmdtRoutCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPropCpPriSpScpRtCmdtRoutCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_RT_CMDT_ROUT Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOPropCpPriSpScpRtCmdtRoutCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPropCpPriSpScpRtCmdtRoutCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
