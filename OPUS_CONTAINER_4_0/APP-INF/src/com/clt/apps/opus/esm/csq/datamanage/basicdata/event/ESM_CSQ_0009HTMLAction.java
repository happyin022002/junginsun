...
*@FileName       : ESM_CSQ_0009HTMLAction.java
 ...
 * @author CSQ USER
 * @see EsmCsq0009Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0009HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_CSQ_0009HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0009HTMLAction() {}
	
	/**
	 * HTML DOM 객체의 Value 를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0009Event로 파싱하여 request 에 셋팅<br>
	 * @param request HttpServletRequest HttpRequest
	 * @return Event Event interfac e를 구현한 객체
	 * @exception HTMLActionException
	 */
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		
		FormCommand command = FormCommand.fromRequest(request);
		EsmCsq0009Event event = new EsmCsq0009Event();
