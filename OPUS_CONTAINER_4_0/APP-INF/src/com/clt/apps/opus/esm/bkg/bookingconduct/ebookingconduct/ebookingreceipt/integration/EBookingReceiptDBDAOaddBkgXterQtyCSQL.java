...
*@FileName : EBookingReceiptDBDAOaddBkgXterQtyCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterQtyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterQtyCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_QTY" ).append("\n");
		query.append("(" ).append("\n");
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterQtyCSQL").append("\n");
		query.append("*/").append("\n");
	}
}