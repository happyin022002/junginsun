...
*@FileName : RFARateProposalDBDAOReorderRouteNoteDpSeqMergeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOReorderRouteNoteDpSeqMergeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOReorderRouteNoteDpSeqMergeUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOReorderRouteNoteDpSeqMergeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   SET A.NOTE_DP_SEQ = DECODE(T.P_CNT, 0, T.NEW_NOTE_DP_SEQ, A.NOTE_DP_SEQ)" ).append("\n"); 
		query.append("" ).append("\n"); 
