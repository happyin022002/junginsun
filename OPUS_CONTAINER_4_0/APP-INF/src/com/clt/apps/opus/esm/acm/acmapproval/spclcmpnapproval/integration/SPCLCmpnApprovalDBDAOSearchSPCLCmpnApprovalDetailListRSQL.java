...
public class SPCLCmpnApprovalDBDAOSearchSPCLCmpnApprovalDetailListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           ROUND(A.IF_AMT,2)                                   AS IF_AMT," ).append("\n"); 
		query.append("           A.CURR_CD                                           AS CURR_CD," ).append("\n"); 
		query.append("           ROUND(A.PAY_IF_AMT,2)                               AS PAY_IF_AMT," ).append("\n"); 
		...
		query.append("       AND 1 = (SELECT COUNT(*) FROM AP_INV_HDR WHERE CSR_NO = @[csr_no] AND IF_FLG = 'Y')" ).append("\n"); 
		query.append("       AND A.CSR_NO           = @[csr_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("           ROUND(SUM(A.PAY_IF_AMT * NVL(A.INV_TAX_RT, 0) / 100), 2) AS PAY_IF_AMT," ).append("\n"); 
