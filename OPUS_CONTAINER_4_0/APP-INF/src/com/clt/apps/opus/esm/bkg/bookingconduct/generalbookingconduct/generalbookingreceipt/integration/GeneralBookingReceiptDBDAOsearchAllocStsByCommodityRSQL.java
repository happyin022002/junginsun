...
*@FileName : GeneralBookingReceiptDBDAOsearchAllocStsByCommodityRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingReceiptDBDAOsearchAllocStsByCommodityRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Commodity의 Allocation Status를 조회한다
	  * </pre>
	  */
	public GeneralBookingReceiptDBDAOsearchAllocStsByCommodityRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingReceiptDBDAOsearchAllocStsByCommodityRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    SELECT ALOC.CMDT_CD" ).append("\n"); 
		...
		query.append("     WHERE ALOC.ALOC_USE_FLG   = 'Y'" ).append("\n"); 
		query.append("       AND ALOC.BKG_ALOC_TP_CD = 'M'" ).append("\n"); 
