...
*@FileName : PSAManifestDBDAOmodifyPsaBkgRlsOrdSerialNoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOmodifyPsaBkgRlsOrdSerialNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSA Release Order테이블의 Serial No에 add_seq의 값을 더하여 UPDATE
	  * </pre>
	  */
	public PSAManifestDBDAOmodifyPsaBkgRlsOrdSerialNoUSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOmodifyPsaBkgRlsOrdSerialNoUSQL").append("\n");
		query.append("*/").append("\n");
	}
