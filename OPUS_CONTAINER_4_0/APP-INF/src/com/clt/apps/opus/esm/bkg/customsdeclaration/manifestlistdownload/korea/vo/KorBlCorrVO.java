...
*@FileName : KorBlCorrVO.java
*@FileTitle : KorBlCorrVO
*Open Issues :
*Change history :
...
public class KorBlCorrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorBlCorrVO> models = new ArrayList<KorBlCorrVO>();
	...
	public KorBlCorrVO(String ibflag, String pagerows, String userId, String subNo, String trnsSeq, String krCstmsCorrId, String corrRsn, String crntCtnt1, String crntCtnt2, String crntCtnt3, String crntCtnt4, String preCtnt1, String preCtnt2, String preCtnt3, String preCtnt4, String portCd) {
	 ...
	 * @return KorBlCorrVO[]
	 */
	public KorBlCorrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorBlCorrVO[]
	 */
	public KorBlCorrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorBlCorrVO model = null;
	 ...
	 * @return KorBlCorrVO[]
	 */
	public KorBlCorrVO[] getKorBlCorrVOs(){
		KorBlCorrVO[] vos = (KorBlCorrVO[])models.toArray(new KorBlCorrVO[models.size()]);
		return vos;
	}
