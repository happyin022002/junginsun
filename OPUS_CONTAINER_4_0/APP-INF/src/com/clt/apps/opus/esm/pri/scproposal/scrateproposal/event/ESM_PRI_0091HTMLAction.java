...
public class ESM_PRI_0091HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0091Event event = new EsmPri0091Event();

		if (command.isCommand(FormCommand.MODIFY01)) {
			event.setPriSpScpRtCnoteVOS((PriSpScpRtCnoteVO[]) getVOs(request, PriSpScpRtCnoteVO.class, ""));
