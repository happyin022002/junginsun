...
import com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharteriocontract.event.ESM_FMS_0001HTMLAction;

/**
 * OPUS-ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 * - OPUS-각 테이블의 vo정보를 담는다.
 *
 * @author jungyoontae
