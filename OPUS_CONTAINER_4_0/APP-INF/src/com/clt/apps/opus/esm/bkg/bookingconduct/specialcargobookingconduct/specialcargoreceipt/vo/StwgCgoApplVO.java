...
public class StwgCgoApplVO {

    private static final long serialVersionUID = 1L;

    private Collection<StwgCgoApplVO> models = new ArrayList<StwgCgoApplVO>();
    ...
    /* Column Info */
    private List<StwgBkgInfoVO> stwgBkgInfo = null;    
    /* Column Info */
    ...
    /* Column Info */
    private StwgAproInfoVO stwgAproInfo = null;
    /* Column Info */
    private BkgStwgCgoVO[] bkgStwgCgoVOs = null;
    
    
	public StwgCgoApplVO() {}
	 ...
	 * @return the awkAproInfo
	 */
	public StwgAproInfoVO getStwgAproInfo() {
		return stwgAproInfo;
	}
	 ...
	 * @param list the awkAproInfo to set
	 */
	public void setstwgAproInfo(StwgAproInfoVO stwgAproInfo) {
		this.stwgAproInfo = stwgAproInfo;
	}
	...
	public List<StwgBkgInfoVO> getStwgBkgInfo() {
		return stwgBkgInfo;
	}

	public void setStwgBkgInfo(List<StwgBkgInfoVO> stwgBkgInfo) {
		this.stwgBkgInfo = stwgBkgInfo;
	}
