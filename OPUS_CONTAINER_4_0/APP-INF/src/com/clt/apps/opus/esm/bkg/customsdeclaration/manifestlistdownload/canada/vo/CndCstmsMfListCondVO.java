...
public class CndCstmsMfListCondVO extends ManifestListCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<CndCstmsMfListCondVO> models = new ArrayList<CndCstmsMfListCondVO>();
	...
	public CndCstmsMfListCondVO() {}

	public CndCstmsMfListCondVO(String ibflag, String pagerows, String total, String vslCd, String bkgCgoTpCd, String skdVoyNo, String blNo, String skdDirCd, String podCd, String bkgNo, String polCd, String sheetId, String blNos, String pageNo, String customs, String clptSeq, String updUsrId, String cntCd) {
		this.total = total;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return CndCstmsMfListCondVO[]
	 */
	public CndCstmsMfListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CndCstmsMfListCondVO[]
	 */
	public CndCstmsMfListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CndCstmsMfListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CndCstmsMfListCondVO();
				if (total[i] != null)
		...
		return getCndCstmsMfListCondVOs();
	}
	 ...
	 * @return CndCstmsMfListCondVO[]
	 */
	public CndCstmsMfListCondVO[] getCndCstmsMfListCondVOs(){
		CndCstmsMfListCondVO[] vos = (CndCstmsMfListCondVO[])models.toArray(new CndCstmsMfListCondVO[models.size()]);
		return vos;
	}
