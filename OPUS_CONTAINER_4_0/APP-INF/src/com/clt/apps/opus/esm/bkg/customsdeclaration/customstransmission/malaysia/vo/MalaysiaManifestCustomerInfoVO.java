...
*@FileName : MalaysiaManifestCustomerInfoVO.java
*@FileTitle : MalaysiaManifestCustomerInfoVO
*Open Issues :
*Change history :
...
public class MalaysiaManifestCustomerInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MalaysiaManifestCustomerInfoVO> models = new ArrayList<MalaysiaManifestCustomerInfoVO>();
	...
	public MalaysiaManifestCustomerInfoVO() {}

	public MalaysiaManifestCustomerInfoVO(String ibflag, String pagerows, String customerType, String customerCd, String customerNm1, String customerNm2, String customerAddr1, String customerAddr2, String customerAddr3, String contactNm, String contactTel, String contactFax, String contactEmail) {
...
/**
	 ...
	 * @param request
	 * @return MalaysiaManifestCustomerInfoVO[]
	 */
	public MalaysiaManifestCustomerInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MalaysiaManifestCustomerInfoVO[]
	 */
	public MalaysiaManifestCustomerInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MalaysiaManifestCustomerInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MalaysiaManifestCustomerInfoVO();
		...
		return getMalaysiaManifestCustomerInfoVOs();
	}
	 ...
	 * @return MalaysiaManifestCustomerInfoVO[]
	 */
	public MalaysiaManifestCustomerInfoVO[] getMalaysiaManifestCustomerInfoVOs(){
		MalaysiaManifestCustomerInfoVO[] vos = (MalaysiaManifestCustomerInfoVO[])models.toArray(new MalaysiaManifestCustomerInfoVO[models.size()]);
		return vos;
	}
