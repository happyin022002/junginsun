...
*@FileTitle : Booking Status Report DANGEROUS
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmBkg010303ViewAdapter extends ViewAdapter {
...
//	                boolean isSave = isSaveCommand(event);
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("prp_shp_nm"))          .append("]]></TD>\n"); // Substance
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("imdg_un_no"))          .append("]]></TD>\n"); // UN No    
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("imdg_pck_grp_cd"))     .append("]]></TD>\n"); // Pack Grp 
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("net_wgt"))             .append("]]></TD>\n"); // WGT(KGS) 
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("grs_wgt"))             .append("]]></TD>\n"); // WGT(KGS) 
//			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("meas_qty"))            .append("]]></TD>\n"); // MEA(CBM) 
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("emer_cntc_phn_no_ctnt")) .append("]]></TD>\n"); // Contact Point
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("imdg_clss_cd"))          .append("]]></TD>\n"); // Class        
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("flsh_pnt_cdo_temp"))     .append("]]></TD>\n"); // F/Point      
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("net_wgt"))               .append("]]></TD>\n"); // Net          
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("grs_wgt"))               .append("]]></TD>\n"); // Gross        
//			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("meas_qty"))              .append("]]></TD>\n"); // MEA(CBM)     
