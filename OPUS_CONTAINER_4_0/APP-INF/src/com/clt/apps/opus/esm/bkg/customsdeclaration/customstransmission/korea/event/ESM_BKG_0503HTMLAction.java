 ...
 * @since J2EE 1.4
 **/
public class ESM_BKG_0503HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**************************************************************************
	 * ESM_BKG_0329HTMLAction 객체를 생성
	 **************************************************************************/
	public ESM_BKG_0503HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0503Event event = new EsmBkg0503Event();

		if (command.isCommand(FormCommand.SEARCH)) {


			event.setKorTransCrossChkCondVO((KorTransCrossChkCondVO) getVO(request, KorTransCrossChkCondVO.class));
