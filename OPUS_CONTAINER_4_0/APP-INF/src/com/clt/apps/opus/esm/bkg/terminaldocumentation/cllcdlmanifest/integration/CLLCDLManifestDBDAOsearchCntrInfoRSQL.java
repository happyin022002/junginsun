...
public class CLLCDLManifestDBDAOsearchCntrInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	BKG_TOKEN_NL_FNC(BCS.CUST_NM,1,'') SHPR_NM1," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCS.CUST_NM,2,'') SHPR_NM2, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCS.CUST_ADDR,1,'') SHPR_NM3," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCS.CUST_ADDR,2,'') SHPR_NM4, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCS.CUST_ADDR,3,'') SHPR_NM5," ).append("\n"); 
		query.append("	NVL(BCC.CUST_CNT_CD,' ') CNEE_CNT_CD, " ).append("\n"); 
		query.append("	BCC.CUST_SEQ CNEE_SEQ, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCC.CUST_NM,1,'') CNEE_NM1," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCC.CUST_NM,2,'') CNEE_NM2, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCC.CUST_ADDR,1,'') CNEE_NM3," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCC.CUST_ADDR,2,'') CNEE_NM4, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCC.CUST_ADDR,3,'') CNEE_NM5," ).append("\n"); 
		query.append("	NVL(BCN.CUST_CNT_CD,' ') NTFY_CNT_CD, " ).append("\n"); 
		query.append("	BCN.CUST_SEQ NTFY_SEQ, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCN.CUST_NM,1,'') NTFY_NM1," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCN.CUST_NM,2,'') NTFY_NM2, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCN.CUST_ADDR,1,'') NTFY_NM3," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCN.CUST_ADDR,2,'') NTFY_NM4, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCN.CUST_ADDR,3,'') NTFY_NM5," ).append("\n"); 
		query.append("	NVL(BCA.CUST_CNT_CD,' ') ANTFY_CNT_CD, " ).append("\n"); 
		query.append("	BCA.CUST_SEQ ANTFY_SEQ, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCA.CUST_NM,1,'') ANTFY_NM1," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCA.CUST_NM,2,'') ANTFY_NM2, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCA.CUST_NM,3,'') ANTFY_NM3," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCA.CUST_NM,4,'') ANTFY_NM4, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCA.CUST_NM,5,'') ANTFY_NM5," ).append("\n"); 
		query.append("	NVL(BCF.CUST_CNT_CD,' ') FF_CNT_CD, " ).append("\n"); 
		query.append("	BCF.CUST_SEQ FF_CUST_SEQ, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCF.CUST_NM,1,'') FF_NM1," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCF.CUST_NM,2,'') FF_NM2, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCF.CUST_NM,3,'') FF_NM3," ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCF.CUST_NM,4,'') FF_NM4, " ).append("\n"); 
		query.append("	BKG_TOKEN_NL_FNC(BCF.CUST_NM,5,'') FF_NM5," ).append("\n"); 
		...
		query.append("	substr(Translate(NVL(R.DIFF_RMK,' '),chr(10),' '),1,50) BL_RMK" ).append("\n"); 
