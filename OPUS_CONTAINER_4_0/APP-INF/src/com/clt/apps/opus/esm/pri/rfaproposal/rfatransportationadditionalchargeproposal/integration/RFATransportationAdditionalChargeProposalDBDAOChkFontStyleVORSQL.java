...
*@FileName : RFATransportationAdditionalChargeProposalDBDAOChkFontStyleVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFATransportationAdditionalChargeProposalDBDAOChkFontStyleVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * origin과 destination의 글자 폰트 스타일을 조회한다.
	  * </pre>
	  */
	public RFATransportationAdditionalChargeProposalDBDAOChkFontStyleVORSQL(){
		setQuery();
		...
		query.append("FileName : RFATransportationAdditionalChargeProposalDBDAOChkFontStyleVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            WHEN ORG_AMDT_CNT > 0 AND ORG_AMDT_CNT <> ORG_ACPT_CNT AND AMDT_SEQ > 0 THEN 'red'" ).append("\n"); 
		...
		query.append("            WHEN DEST_AMDT_CNT > 0 AND DEST_AMDT_CNT <> DEST_ACPT_CNT AND AMDT_SEQ > 0 THEN 'red'" ).append("\n"); 
