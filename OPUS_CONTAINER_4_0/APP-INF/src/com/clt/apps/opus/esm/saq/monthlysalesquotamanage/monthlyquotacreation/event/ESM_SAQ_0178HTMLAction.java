...
*@FileName : ESM_SAQ_0178HTMLAction.java
*@FileTitle : COA I/F Creation - popup
*Open Issues :
*Change history :
...
public class ESM_SAQ_0178HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0178HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0178HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0178Event event = new EsmSaq0178Event();
		
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setBaseDataFromCoaListVO((BaseDataFromCoaListVO)getVO(request, BaseDataFromCoaListVO.class));
		}
