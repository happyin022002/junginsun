...
*@FileName : BookingMasterMgtDAOSearchChinaAgentCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDAOSearchChinaAgentCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingMasterMgtDAOSearchChinaAgentCodeCSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDAOSearchChinaAgentCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[cust_cnt_cd]" ).append("\n"); 
		query.append(",	@[cust_seq]" ).append("\n"); 
		query.append(",	DECODE(@[auto_dp_chk_flg],'1','Y','0','N',@[auto_dp_chk_flg])" ).append("\n"); 
		query.append(",	@[agn_eml]" ).append("\n"); 
		query.append(",	@[ofc_cd]" ).append("\n"); 
		query.append(",	@[finc_ofc_cd]" ).append("\n"); 
		query.append(",	@[ar_ofc_cd]" ).append("\n"); 
