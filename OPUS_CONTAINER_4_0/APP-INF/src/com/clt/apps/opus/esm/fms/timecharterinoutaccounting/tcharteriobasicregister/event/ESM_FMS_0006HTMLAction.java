...
*@FileName : ESM_FMS_0006HTMLAction.java
...
public class ESM_FMS_0006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0006HTMLAction 객체를 생성
	 */
	public ESM_FMS_0006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0006Event event = new EsmFms0006Event();
		...
		if (command.isCommand(FormCommand.SEARCH02)) {
			...
			event.setCustomOwnerVOS((CustomOwnerVO[])getVOs(request, CustomOwnerVO .class,""));
		}
