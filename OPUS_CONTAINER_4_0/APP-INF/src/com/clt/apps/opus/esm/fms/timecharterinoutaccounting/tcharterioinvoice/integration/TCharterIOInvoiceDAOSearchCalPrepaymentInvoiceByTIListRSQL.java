...
*@FileName : TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTIListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTIListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTIListRSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInvoiceDAOSearchCalPrepaymentInvoiceByTIListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("SELECT A.ACCT_ITM_NM" ).append("\n"); 
		query.append("     , A.ACCT_CD" ).append("\n"); 
		query.append("     , A.CURR_CD" ).append("\n"); 
		query.append("     , A.INV_AMT" ).append("\n"); 
		query.append("     , A.ORI_INV_AMT" ).append("\n"); 
		query.append("     , A.CURR_CD2" ).append("\n"); 
		query.append("     , A.INV_AMT2" ).append("\n"); 
		query.append("     , A.ORI_INV_AMT2" ).append("\n"); 
		...
		query.append("     , A.SORTKEY AS SORT_KEY" ).append("\n"); 
		query.append("     , A.INV_USD_DYS" ).append("\n"); 
		...
		query.append("                             , INV_DESC" ).append("\n"); 
		query.append("                             , FLET_CTRT_NO" ).append("\n"); 
		query.append("                             , NOW_HIRE_EFF_DT AS EFF_DT" ).append("\n"); 
		query.append("                             , NOW_HIRE_EXP_DT AS EXP_DT" ).append("\n"); 
		query.append("                          FROM (" ).append("\n"); 
		...
		query.append("                                     , NOW_HIRE_EFF_DT" ).append("\n"); 
		query.append("                                     , NOW_HIRE_EXP_DT" ).append("\n"); 
		...
		query.append("                                             , PM.PRE_INV_DESC || ' ' || PM.HIR_CURR_N1ST_CD || ' ' || '(' || TO_CHAR(TO_DATE(PM.NOW_HIRE_EFF_DT,'YYYYMMDDHH24MI'),'YYYY-MM-DD HH24:MI') || ' ~ ' || TO_CHAR(TO_DATE(PM.NOW_HIRE_EXP_DT,'YYYYMMDDHH24MI'),'YYYY-MM-DD HH24:MI') || ')' AS INV_DESC" ).append("\n"); 
		...
		query.append("                                 GROUP BY HIR_CURR_N1ST_CD, INV_DESC" ).append("\n"); 
		query.append("                                     , NOW_HIRE_EFF_DT" ).append("\n"); 
		query.append("                                     , NOW_HIRE_EXP_DT" ).append("\n"); 
		query.append("                                 UNION ALL" ).append("\n"); 
		query.append("                                SELECT MIN(ACCT_ITM_NM) ACCT_ITM_NM" ).append("\n"); 
		...
		query.append("                                             , PM.PRE_INV_DESC || ' ' || PM.HIR_CURR_N2ND_CD || ' ' || '(' || TO_CHAR(TO_DATE(PM.NOW_HIRE_EFF_DT,'YYYYMMDDHH24MI'),'YYYY-MM-DD HH24:MI') || ' ~ ' || TO_CHAR(TO_DATE(PM.NOW_HIRE_EXP_DT,'YYYYMMDDHH24MI'),'YYYY-MM-DD HH24:MI') || ')' AS INV_DESC" ).append("\n"); 
		query.append("                                             , AC.ACCT_ITM_SEQ" ).append("\n"); 
		...
		query.append("                                       )" ).append("\n"); 
		query.append("                                 WHERE HIR_RT_N1ST_AMT != 0" ).append("\n"); 
		query.append("                                 GROUP BY HIR_CURR_N2ND_CD , INV_DESC" ).append("\n"); 
		query.append("                                     , NOW_HIRE_EFF_DT" ).append("\n"); 
		query.append("                                     , NOW_HIRE_EXP_DT" ).append("\n"); 
		query.append("                                )" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		...
		query.append("                     , TRIM(TO_CHAR(HIR_RT_N1ST_AMT,'999,999,999,999,999,990.00')) AS INV_AMT" ).append("\n"); 
		query.append("                     , TRIM(TO_CHAR(HIR_RT_N1ST_AMT,'999,999,999,999,999,990.00')) ORI_INV_AMT" ).append("\n"); 
		query.append("                     , HIR_CURR_N2ND_CD AS CURR_CD2" ).append("\n"); 
		query.append("                     , TRIM(TO_CHAR(HIR_RT_N2ND_AMT,'999,999,999,999,999,990.00')) AS INV_AMT" ).append("\n"); 
		query.append("                     , TRIM(TO_CHAR(HIR_RT_N2ND_AMT,'999,999,999,999,999,990.00')) ORI_INV_AMT" ).append("\n"); 
		query.append("                     , INV_DESC" ).append("\n"); 
		query.append("                     , FLET_CTRT_NO" ).append("\n"); 
		...
		query.append("                                     , PM.PRE_INV_DESC || ' ' || FO.CURR_CD || ' ' || '(' || TO_CHAR(TO_DATE(PM.ORI_EFF_DT,'YYYYMMDDHH24MI'),'YYYY-MM-DD HH24:MI') || ' ~ ' || TO_CHAR(TO_DATE(PM.ORI_EXP_DT,'YYYYMMDDHH24MI'),'YYYY-MM-DD HH24:MI') || ')' AS INV_DESC" ).append("\n"); 
		...
		query.append("                                   " ).append("\n"); 
		query.append("                 /*--4. TI : Brokerage Due to Charter In : 512641 start*/" ).append("\n"); 
		query.append("                 UNION ALL" ).append("\n"); 
		query.append("                 SELECT ACCT_ITM_NM" ).append("\n"); 
		query.append("                     , ACCT_CD" ).append("\n"); 
		query.append("                     , ACCT_ITM_SEQ" ).append("\n"); 
		...
		query.append("                 /*--4. TI : Brokerage Due to Charter In : 512641 e n d*/ " ).append("\n"); 
		query.append("                                        " ).append("\n"); 
		query.append("                       " ).append("\n"); 
		query.append("                       " ).append("\n"); 
		query.append("                )" ).append("\n"); 
