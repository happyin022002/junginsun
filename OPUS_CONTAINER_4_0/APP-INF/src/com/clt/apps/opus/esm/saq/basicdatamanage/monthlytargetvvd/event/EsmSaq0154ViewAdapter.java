...
*@FileName       : EsmSaq0154ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmSaq0154ViewAdapter extends ViewAdapter{
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		log.debug("EsmSaq0154ViewAdapter makeDataTag start");

		ReturnVO listVO = (ReturnVO)vos.get(0);
		QuotaConditionVO conditionVO = (QuotaConditionVO) listVO.getList(1);
		List<MonthlyTargetVVDInquiryVO> list01=  (List<MonthlyTargetVVDInquiryVO>) listVO.getList(0);

		int totCnt = list01.size();
		int unit = 1; //소스 품질 수정 요청건 0 --> 1
		...
		log.debug("EsmSaq0154ViewAdapter makeDataTag end");
