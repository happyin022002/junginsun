...
*@FileName       : ESM_SAQ_0040HTMLAction.java
...
public class ESM_SAQ_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0040HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0040Event event = new EsmSaq0040Event();
		

		if (command.isCommand(FormCommand.MULTI)) {
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			event.setSaqMonTgtVvdVOS((SaqMonTgtVvdVO[])getVOs(request, SaqMonTgtVvdVO .class));
		}else{
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
		}
