...
public class ChinaCustomsTransmissionDBDAOsearchManifestDetailListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ,COM_ConstantMgr_PKG.COM_getScacCode_FNC()||BL.BL_NO AS BL  /*BL*/" ).append("\n");
		...
		query.append("       ,REPLACE(REPLACE(CM.CSTMS_DESC,CHR(10),' '),CHR(9),' ') AS CSTMS_DESC" ).append("\n");
		query.append("       ,'' AS CN_CMDT            /*Chinese_commodity*/" ).append("\n");
		query.append("       ,'' AS HS_CD              /*HS_code*/" ).append("\n");
		query.append("       ,COM_ConstantMgr_PKG.COM_getCompanyCode_FNC() AS CNTR_OPT        /*CNTR_OPERATOR*/" ).append("\n");
		...
		query.append("ORDER BY COM_ConstantMgr_PKG.COM_getScacCode_FNC()||BL.BL_NO, CT.CNTR_NO" ).append("\n");
