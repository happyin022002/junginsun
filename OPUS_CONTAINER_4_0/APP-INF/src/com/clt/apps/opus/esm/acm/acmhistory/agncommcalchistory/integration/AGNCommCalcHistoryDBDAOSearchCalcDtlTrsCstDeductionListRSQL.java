...
*@FileName : AGNCommCalcHistoryDBDAOSearchCalcDtlTrsCstDeductionListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommCalcHistoryDBDAOSearchCalcDtlTrsCstDeductionListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommCalcHistoryDBDAOSearchCalcDtlTrsCstDeductionListRSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommCalcHistoryDBDAOSearchCalcDtlTrsCstDeductionListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM (SELECT CSD.COA_COST_SRC_CD," ).append("\n"); 
		...
		query.append("                  FROM ACM_AGN_COMM_TRSP_HIS" ).append("\n"); 
		...
		query.append("                   AND CALC_NO = @[calc_no]) TRD" ).append("\n"); 
		...
		query.append("                                                WHEN CHG_CD IN ('OIH', 'OHC') THEN 'HO'" ).append("\n"); 
		query.append("                                                WHEN CHG_CD IN ('DIH', 'DHC') THEN 'HD'" ).append("\n"); 
		query.append("                                             END" ).append("\n"); 
		query.append("                                        FROM BKG_CHG_RT CHG" ).append("\n"); 
		query.append("                                       WHERE CHG.BKG_NO = TRD.BKG_NO" ).append("\n"); 
		query.append("                                         AND CHG.CHG_CD IN ('OAR', 'DAR', 'OIH', 'DIH', 'OHC', 'DHC'))" ).append("\n"); 
		query.append("       )" ).append("\n"); 
