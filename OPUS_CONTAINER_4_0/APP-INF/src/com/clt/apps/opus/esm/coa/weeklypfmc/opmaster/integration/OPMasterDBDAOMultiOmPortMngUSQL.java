...
*@FileName : OPMasterDBDAOMultiOmPortMngUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiOmPortMngUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiOmPortMngUSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiOmPortMngUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_MON_VVD_PORT_EXPT" ).append("\n"); 
		query.append("   SET EFF_TO_DT  = @[eff_to_dt]    	--20150612.MOD	" ).append("\n"); 
		query.append("      ,UPD_USR_ID = @[upd_usr_id]" ).append("\n"); 
		query.append("      ,UPD_DT     = SYSDATE" ).append("\n"); 
		query.append("WHERE EFF_FM_DT  = @[eff_fm_dt]" ).append("\n"); 
