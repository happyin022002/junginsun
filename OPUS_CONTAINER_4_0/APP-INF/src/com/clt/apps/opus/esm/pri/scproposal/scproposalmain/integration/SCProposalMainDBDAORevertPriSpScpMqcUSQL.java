...
*@FileName : SCProposalMainDBDAORevertPriSpScpMqcUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpScpMqcUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_SCP_MQC
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpScpMqcUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpScpMqcUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_MQC " ).append("\n"); 
		query.append("   SET PRC_PROG_STS_CD   = DECODE(@[prop_sts_cd], 'I', 'I', 'A')  " ).append("\n"); 
		query.append("     , FNL_MQC_QTY       = DECODE(@[prop_sts_cd], 'I', 0, PROP_SCP_MQC_QTY) " ).append("\n"); 
