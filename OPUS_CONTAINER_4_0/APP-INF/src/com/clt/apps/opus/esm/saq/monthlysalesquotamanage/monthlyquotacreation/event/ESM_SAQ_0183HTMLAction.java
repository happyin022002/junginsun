 ...
 *@FileName : ESM_SAQ_0183HTMLAction.java
...
public class ESM_SAQ_0183HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_SAQ_0183HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0183HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0183Event event = new EsmSaq0183Event();
