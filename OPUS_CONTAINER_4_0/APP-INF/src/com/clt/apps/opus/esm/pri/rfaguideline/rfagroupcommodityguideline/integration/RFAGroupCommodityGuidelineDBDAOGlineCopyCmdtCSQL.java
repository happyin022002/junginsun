...
*@FileName : RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityGuidelineDBDAOGlineCopyCmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY SVC_SCP_CD, GLINE_SEQ, GRP_CMDT_SEQ) AS GRP_CMDT_SEQ" ).append("\n"); 
		query.append(", PRC_GRP_CMDT_CD" ).append("\n"); 
		query.append(", PRC_GRP_CMDT_DESC" ).append("\n"); 
