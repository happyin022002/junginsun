...
*@FileName : NewZealandManifestCustomerInfoVO.java
*@FileTitle : NewZealandManifestCustomerInfoVO
*Open Issues :
*Change history :
...
public class NewZealandManifestCustomerInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<NewZealandManifestCustomerInfoVO> models = new ArrayList<NewZealandManifestCustomerInfoVO>();
	...
	public NewZealandManifestCustomerInfoVO() {}

	public NewZealandManifestCustomerInfoVO(String ibflag, String pagerows, String customerType, String customerCd, String customerNm1, String customerNm2, String customerAddr1, String customerAddr2, String customerAddr3, String contactNm, String contactTel, String contactFax, String contactEmail) {
...
/**
	 ...
	 * @param request
	 * @return NewZealandManifestCustomerInfoVO[]
	 */
	public NewZealandManifestCustomerInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NewZealandManifestCustomerInfoVO[]
	 */
	public NewZealandManifestCustomerInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandManifestCustomerInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandManifestCustomerInfoVO();
		...
		return getNewZealandManifestCustomerInfoVOs();
	}
	 ...
	 * @return NewZealandManifestCustomerInfoVO[]
	 */
	public NewZealandManifestCustomerInfoVO[] getNewZealandManifestCustomerInfoVOs(){
		NewZealandManifestCustomerInfoVO[] vos = (NewZealandManifestCustomerInfoVO[])models.toArray(new NewZealandManifestCustomerInfoVO[models.size()]);
		return vos;
	}
