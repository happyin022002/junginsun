...
*@FileName : SCProposalMainDBDAORevertPriSpCtrtCustTpUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpCtrtCustTpUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File 및 Cancel PRI_SP_CTRT_CUST_TP
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpCtrtCustTpUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpCtrtCustTpUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_CTRT_CUST_TP" ).append("\n"); 
