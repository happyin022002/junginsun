...
*@FileName : JapanMfrCntrModificationVO.java
*@FileTitle : JapanMfrCntrModificationVO
*Open Issues :
*Change history :
 ...
 * @author
 * @since J2EE 1.6
 * @see MfrCntrModificationVO
 */

public class JapanMfrCntrModificationVO extends MfrCntrModificationVO {

	private static final long serialVersionUID = 1L;

	private Collection<JapanMfrCntrModificationVO> models = new ArrayList<JapanMfrCntrModificationVO>();
	...
	public JapanMfrCntrModificationVO() {}

	public JapanMfrCntrModificationVO(String ibflag, String pagerows, String blNo, String cntrNo, String cntrTpszCd, String cntrSealNo, String value1, String prtFlg, String rcvTermCd, String deTermCd, String fullMtyCd, String jpCntrOwnrCd, String creUsrId, String updUsrId) {
		this.blNo = blNo;
	 ...
	 * @param request
	 * @return JapanMfrCntrModificationVO[]
	 */
	public JapanMfrCntrModificationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapanMfrCntrModificationVO[]
	 */
	public JapanMfrCntrModificationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JapanMfrCntrModificationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new JapanMfrCntrModificationVO();
				if (blNo[i] != null)
		...
		return getJapanMfrCntrModificationVOs();
	}
	...
	public JapanMfrCntrModificationVO[] getJapanMfrCntrModificationVOs(){
		JapanMfrCntrModificationVO[] vos = (JapanMfrCntrModificationVO[])models.toArray(new JapanMfrCntrModificationVO[models.size()]);
		return vos;
	}
