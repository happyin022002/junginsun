...
*@FileName : RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_RP_SCP_GRP_CMDT_DTL Insert
	  * </pre>
	  */
	public RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtDtlCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",PRI_RP_SCP_GRP_CMDT_DTL B" ).append("\n"); 
