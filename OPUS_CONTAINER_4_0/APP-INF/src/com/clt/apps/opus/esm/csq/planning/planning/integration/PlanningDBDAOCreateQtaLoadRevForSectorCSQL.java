...
public class PlanningDBDAOCreateQtaLoadRevForSectorCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,NVL(C2.LOD_QTY,0) AS LOD_QTY" ).append("\n"); 
		query.append("      ,ROUND(DECODE(NVL(C2.LOD_QTY,0), 0, 0, C2.GRS_TTL_REV/C2.LOD_QTY)) AS GRS_RPB_REV" ).append("\n"); 
		query.append("      ,NVL(C2.LOD_QTY,0) AS LOD_QTY" ).append("\n"); 
		query.append("      ,ROUND(DECODE(NVL(C2.LOD_QTY,0), 0, 0, C2.GRS_TTL_REV/C2.LOD_QTY)) AS GRS_RPB_REV" ).append("\n"); 
		...
		query.append("      ,CSQ_SCTR_PERF_IF C2" ).append("\n"); 
		query.append("      ,(" ).append("\n"); 
		...
		query.append("                           AND S1.TRD_CD       = @[f_trd_cd]" ).append("\n"); 
