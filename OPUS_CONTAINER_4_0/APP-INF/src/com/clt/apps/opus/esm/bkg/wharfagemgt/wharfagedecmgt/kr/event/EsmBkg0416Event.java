...
public class EsmBkg0416Event extends EventSupport {
	...
	public KrWhfBerthCdVO[] getKrWhfBerthCdVOs2() {
		KrWhfBerthCdVO[] rtnVOs = null;
		if (this.krWhfBerthCdVOs2 != null) {
			rtnVOs = Arrays.copyOf(krWhfBerthCdVOs2, krWhfBerthCdVOs2.length);
		}
		return rtnVOs;
	}

	public void setKrWhfBerthCdVOs2(KrWhfBerthCdVO[] krWhfBerthCdVOs2) {
		if (krWhfBerthCdVOs2 != null) {
			KrWhfBerthCdVO[] tmpVOs = Arrays.copyOf(krWhfBerthCdVOs2, krWhfBerthCdVOs2.length);
			this.krWhfBerthCdVOs2 = tmpVOs;
		}
	}
