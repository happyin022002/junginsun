...
*@FileName : BATManagementDBDAOSearchBatchManagementListRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class BATManagementDBDAOSearchBatchManagementListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BATManagementDBDAOSearchBatchManagementListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n");
		query.append("Path : com.clt.apps.opus.esm.acm.acmrequest.batmanagement.integration").append("\n");
		query.append("FileName : BATManagementDBDAOSearchBatchManagementListRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("    AND   BAT_FLG    NOT IN ('Z','X' ) -- Z : 중복실행 방지 Flag, X : BDR Update Flag" ).append("\n");
