...
public class SriLankaSearchVesselVpsVO extends AbstractValueObject {
	...
	public SriLankaSearchVesselVpsVO(String ibflag, String pagerows, String vpsEtaDt, String vpsEtaDtTime, String arrivalPortCd, String shippingAgent, String localAgent) {
	...
	public void fromRequest(HttpServletRequest request) {
		setShippingAgent(JSPUtil.getParameter(request, "shipping_agent", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setArrivalPortCd(JSPUtil.getParameter(request, "arrival_port_cd", ""));
		setLocalAgent(JSPUtil.getParameter(request, "local_agent", ""));
