...
*@FileName : ESM_BKG_0697HTMLAction.java
...
public class ESM_BKG_0697HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0697HTMLAction 객체를 생성
	 */
	public ESM_BKG_0697HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0697Event event = new EsmBkg0697Event();
        log.debug("##### CALL:ESM_BKG_0697HTMLAction - " + command.getCommand());
