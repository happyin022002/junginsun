...
*@FileName : BlRatingDBDAOCallBkgModiIssOfcPrcUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOCallBkgModiIssOfcPrcUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOCallBkgModiIssOfcPrcUSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOCallBkgModiIssOfcPrcUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL BKG_MODI_CHG_OFC_PKG.BKG_MODI_ISS_OFC_PRC(@[in_bkg_no],@[in_ca_flg],@[out_result])" ).append("\n"); 
