...
*@FileName : SriLankaSearchRegistNoVO.java
*@FileTitle : SriLankaSearchRegistNoVO
*Open Issues :
*Change history :
...
public class SriLankaSearchRegistNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SriLankaSearchRegistNoVO> models = new ArrayList<SriLankaSearchRegistNoVO>();
	...
	public SriLankaSearchRegistNoVO() {}

	public SriLankaSearchRegistNoVO(String ibflag, String pagerows, String vslAuthNo, String vslRgstNo) {
		this.ibflag = ibflag;
	 ...
	 */
	public SriLankaSearchRegistNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SriLankaSearchRegistNoVO[]
	 */
	public SriLankaSearchRegistNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SriLankaSearchRegistNoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SriLankaSearchRegistNoVO();
				if (ibflag[i] != null)
		...
		return getSriLankaSearchRegistNoVOs();
	}
	 ...
	 * @return SriLankaSearchRegistNoVO[]
	 */
	public SriLankaSearchRegistNoVO[] getSriLankaSearchRegistNoVOs(){
		SriLankaSearchRegistNoVO[] vos = (SriLankaSearchRegistNoVO[])models.toArray(new SriLankaSearchRegistNoVO[models.size()]);
		return vos;
	}
