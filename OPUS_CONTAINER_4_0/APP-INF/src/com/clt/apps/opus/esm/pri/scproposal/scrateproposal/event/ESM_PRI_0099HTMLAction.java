 ...
 *@FileName : ESM_PRI_0099HTMLAction.java
 *@FileTitle : ESM_PRI_0099HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_0099HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0099Event event = new EsmPri0099Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			PriSpScpRtCmdtHdrVO vo = (PriSpScpRtCmdtHdrVO) getVO(request, PriSpScpRtCmdtHdrVO.class);
			vo.setN1stCmncAmdtSeq(request.getParameter("eff_dt"));
			event.setPriSpScpRtCmdtHdrVO(vo);
			event.setRsltRtListHorizontalExcelVOS((RsltRtListHorizontalExcelVO[]) getVOs(request, RsltRtListHorizontalExcelVO.class, ""));
