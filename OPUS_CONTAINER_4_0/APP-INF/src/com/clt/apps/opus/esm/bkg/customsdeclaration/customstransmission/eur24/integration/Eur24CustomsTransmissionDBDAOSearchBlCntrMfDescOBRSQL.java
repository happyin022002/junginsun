...
*@FileName : Eur24CustomsTransmissionDBDAOSearchBlCntrMfDescOBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24CustomsTransmissionDBDAOSearchBlCntrMfDescOBRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24CustomsTransmissionDBDAOSearchBlCntrMfDescOBRSQL
	  * </pre>
	  */
	public Eur24CustomsTransmissionDBDAOSearchBlCntrMfDescOBRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24CustomsTransmissionDBDAOSearchBlCntrMfDescOBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
