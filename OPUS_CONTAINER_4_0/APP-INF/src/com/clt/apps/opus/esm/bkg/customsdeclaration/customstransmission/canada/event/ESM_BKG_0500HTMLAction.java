 ...
 *@FileName : ESM_BKG_0500HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0500HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0500HTMLAction 객체를 생성
	 */
	public ESM_BKG_0500HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0500Event event = new EsmBkg0500Event();
		if (command.isCommand(FormCommand.SEARCH))
		{
			...
			event.setCstmsSndHisListCondVO(condVO);
		}
