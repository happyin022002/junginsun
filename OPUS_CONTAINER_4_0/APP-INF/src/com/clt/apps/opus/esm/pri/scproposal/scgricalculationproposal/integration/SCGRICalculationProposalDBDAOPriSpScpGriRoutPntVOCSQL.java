...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutPntVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriRoutPntVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriRoutPntVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutPntVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}