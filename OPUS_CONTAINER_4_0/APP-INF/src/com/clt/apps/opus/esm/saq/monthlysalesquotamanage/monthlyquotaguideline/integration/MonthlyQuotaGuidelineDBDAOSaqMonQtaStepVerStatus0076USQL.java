...
*@FileName : MonthlyQuotaGuidelineDBDAOSaqMonQtaStepVerStatus0076USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaGuidelineDBDAOSaqMonQtaStepVerStatus0076USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAQ_MON_QTA_STEP_VER	Update
	  * </pre>
	  */
	public MonthlyQuotaGuidelineDBDAOSaqMonQtaStepVerStatus0076USQL(){
		setQuery();
		...
		params.put("newstscd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MonthlyQuotaGuidelineDBDAOSaqMonQtaStepVerStatus0076USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET     SAQ_STS_CD  = @[newstscd]," ).append("\n"); 
		query.append("        UPD_USR_ID  = @[user_id] ," ).append("\n"); 
		query.append("        UPD_DT      = SYSDATE" ).append("\n"); 
		query.append("WHERE   MQTA_STEP_CD LIKE @[mqtastepcd]||'%'" ).append("\n"); 
		...
		query.append("AND     SAQ_STS_CD      = @[stscd]" ).append("\n"); 
