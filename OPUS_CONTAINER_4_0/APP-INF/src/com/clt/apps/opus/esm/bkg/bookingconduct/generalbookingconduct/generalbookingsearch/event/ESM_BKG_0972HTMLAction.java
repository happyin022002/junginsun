...
*@FileName : ESM_BKG_0972HTMLAction.java
...
public class ESM_BKG_0972HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0972HTMLAction 객체를 생성
	 */
	public ESM_BKG_0972HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0972Event event = new EsmBkg0972Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgBlNoVO((BkgBlNoVO)getVO(request, BkgBlNoVO .class));
		}else if(command.isCommand(FormCommand.SEARCH02)) {
			String blck_stwg_cd = request.getParameter("blckStwgCd");
			BkgBookingVO vo = new BkgBookingVO();
			vo.setBlckStwgCd(blck_stwg_cd);
			event.setBkgBookingVO(vo);
