...
*@FileName : ESM_BKG_0019HTMLAction.java
...
public class ESM_BKG_0019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0019HTMLAction 객체를 생성
	 */
	public ESM_BKG_0019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0019Event event = new EsmBkg0019Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVskVslPortSkdConditionVO((VskVslPortSkdConditionVO)getVO(request, VskVslPortSkdConditionVO .class));
		}
