...
*@FileName : FACCommCalculationDBDAOSearchFACDataChekRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FACCommCalculationDBDAOSearchFACDataChekRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FACCommCalculationDBDAOSearchFACDataChekRSQL
	  * </pre>
	  */
	public FACCommCalculationDBDAOSearchFACDataChekRSQL(){
		setQuery();
		...
		query.append("FileName : FACCommCalculationDBDAOSearchFACDataChekRSQL").append("\n");
		query.append("*/").append("\n");
	}
