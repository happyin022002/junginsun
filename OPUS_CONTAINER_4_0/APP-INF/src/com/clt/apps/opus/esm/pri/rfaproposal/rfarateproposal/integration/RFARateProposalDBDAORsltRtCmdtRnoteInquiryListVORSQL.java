...
*@FileName : RFARateProposalDBDAORsltRtCmdtRnoteInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRtCmdtRnoteInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRtCmdtRnoteInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRtCmdtRnoteInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY ROUT_NOTE_SEQ" ).append("\n"); 
