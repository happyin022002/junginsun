...
public class DoRefVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DoRefVO> models = new ArrayList<DoRefVO>();
	 ...
	 * @return DoRefVO[]
	 */
	public DoRefVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DoRefVO[]
	 */
	public DoRefVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DoRefVO model = null;
	...
	public DoRefVO[] getDoRefVOs(){
		DoRefVO[] vos = (DoRefVO[])models.toArray(new DoRefVO[models.size()]);
		return vos;
	}
