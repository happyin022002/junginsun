...
*@FileName : TAAProposalDBDAOPriTaaTriListVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TAAProposalDBDAOPriTaaTriListVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TAA_TRI_LIST 데이터 등록
	  * </pre>
	  */
	public TAAProposalDBDAOPriTaaTriListVOCSQL(){
		setQuery();
		...
		query.append("FileName : TAAProposalDBDAOPriTaaTriListVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
