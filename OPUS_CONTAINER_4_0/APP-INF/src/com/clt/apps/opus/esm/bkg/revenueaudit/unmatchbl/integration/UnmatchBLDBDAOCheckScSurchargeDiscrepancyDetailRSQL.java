...
*@FileName : UnmatchBLDBDAOCheckScSurchargeDiscrepancyDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckScSurchargeDiscrepancyDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UnmatchBLDBDAOCheckScSurchargeDiscrepancyDetailRSQL
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckScSurchargeDiscrepancyDetailRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckScSurchargeDiscrepancyDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
