...
*@FileName : DailyForecastManageDBDAOSpcFileImptCustMapgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DailyForecastManageDBDAOSpcFileImptCustMapgCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * File Import Save를 수행한다.
	  * 
	  * 2016.04.11  rlane_cd = @[rlane_cd] 추가
	  * </pre>
	  */
	public DailyForecastManageDBDAOSpcFileImptCustMapgCSQL(){
		setQuery();
		...
		query.append("FileName : DailyForecastManageDBDAOSpcFileImptCustMapgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     --20160203.ADD" ).append("\n"); 
		query.append("     ,(SELECT NVL(MAX(FCAST_SEQ),0)+1" ).append("\n"); 
		query.append("         FROM SPC_SLS_REP_CUST_MAPG" ).append("\n"); 
		query.append("        WHERE 1=1" ).append("\n"); 
		query.append("          AND SREP_CD = NVL(@[srep_usr_id],SR.SREP_CD)" ).append("\n"); 
		query.append("          AND TRD_CD = C.TRD_CD" ).append("\n"); 
		query.append("          AND SUB_TRD_CD = C.SUB_TRD_CD" ).append("\n"); 
		query.append("          AND RLANE_CD  = NVL(P.RLANE_CD, C.RLANE_CD) " ).append("\n"); 
		query.append("          AND DIR_CD  = C.DIR_CD" ).append("\n"); 
