...
*@FileName : ESM_BKG_029204HTMLAction.java
...
public class ESM_BKG_029204HTMLAction extends HTMLActionSupport {
     ...
     */
    public ESM_BKG_029204HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg029204Event event = new EsmBkg029204Event();
        ...
        log.debug("===================================");
        log.debug("    ESM_BKG_029204HTMLAction Start   ");
        log.debug("===================================");
