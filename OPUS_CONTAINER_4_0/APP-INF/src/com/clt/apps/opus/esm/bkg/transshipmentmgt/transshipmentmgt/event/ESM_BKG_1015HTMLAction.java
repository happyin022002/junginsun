...
*@FileName : ESM_BKG_1015HTMLAction.java
...
public class ESM_BKG_1015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1015HTMLAction 객체를 생성
	 */
	public ESM_BKG_1015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1015Event event = new EsmBkg1015Event();

		if(command.isCommand(FormCommand.DEFAULT)) {
			event.setFormerTrnkFlg(JSPUtil.getParameter(request, "formerTrnkFlg"));
			event.setNextTrnkFlg(JSPUtil.getParameter(request, "nextTrnkFlg"));
		} 
