...
*@FileName : RocsSearchCntrListVO.java
*@FileTitle : RocsSearchCntrListVO
*Open Issues :
*Change history :
...
public class RocsSearchCntrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsSearchCntrListVO> models = new ArrayList<RocsSearchCntrListVO>();
	...
	public RocsSearchCntrListVO() {}

	public RocsSearchCntrListVO(String ibflag, String pagerows, String cntrNo,
			String cntrSealNo, String cntrTpszCd, String isoCntrTpszCd, String cntrTpszDesc,
			String pckQty, String pckTpCd, String pckDesc, String cntrMfWgt, String cntrWgtUtCd, 
			String t1DocCd, String vslCallRefNo, String bkgNo,String bkgNoSplit) {
	 ...
	 */
	public RocsSearchCntrListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsSearchCntrListVO[]
	 */
	public RocsSearchCntrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsSearchCntrListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RocsSearchCntrListVO();
		...
		return getRocsSearchCntrListVOs();
	}
	 ...
	 * @return RocsSearchCntrListVO[]
	 */
	public RocsSearchCntrListVO[] getRocsSearchCntrListVOs(){
		RocsSearchCntrListVO[] vos = (RocsSearchCntrListVO[])models.toArray(new RocsSearchCntrListVO[models.size()]);
		return vos;
	}
