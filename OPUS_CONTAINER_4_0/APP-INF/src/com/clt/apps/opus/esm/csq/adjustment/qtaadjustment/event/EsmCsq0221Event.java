...
/**
 * ESM_CSQ_0221 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_CSQ_0221HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author CSQ USER
 * @see ESM_CSQ_0221HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmCsq0221Event extends EventSupport {

	private static final long serialVersionUID = 1L;

	public EsmCsq0221Event(){}
