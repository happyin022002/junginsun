...
*@FileName : SCProposalMainDBDAORevertPriSpScpRtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORevertPriSpScpRtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAORevertPriSpScpRtUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORevertPriSpScpRtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , FNL_FRT_RT_AMT  = DECODE(@[prop_sts_cd], 'I', NULL, PROP_FRT_RT_AMT) " ).append("\n"); 
