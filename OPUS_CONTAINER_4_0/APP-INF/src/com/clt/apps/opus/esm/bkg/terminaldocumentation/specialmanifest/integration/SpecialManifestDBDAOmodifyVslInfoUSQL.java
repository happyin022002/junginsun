...
*@FileName : SpecialManifestDBDAOmodifyVslInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOmodifyVslInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSL 정보를 업데이트한다. (barge에 한해서)
	  * </pre>
	  */
	public SpecialManifestDBDAOmodifyVslInfoUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOmodifyVslInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_EUR_DG_VSL_SKD" ).append("\n"); 
		query.append("   SET BRTH_YD_CD        = @[brth_yd_cd]" ).append("\n"); 
		...
		query.append("      ,EUR_VSL_ID        = @[vsl_cd]" ).append("\n"); 
