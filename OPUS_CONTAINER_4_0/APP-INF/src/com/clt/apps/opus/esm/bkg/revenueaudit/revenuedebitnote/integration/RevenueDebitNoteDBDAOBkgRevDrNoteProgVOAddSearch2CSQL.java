...
public class RevenueDebitNoteDBDAOBkgRevDrNoteProgVOAddSearch2CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOBkgRevDrNoteProgVOAddSearch2CSQL(){
		setQuery();
