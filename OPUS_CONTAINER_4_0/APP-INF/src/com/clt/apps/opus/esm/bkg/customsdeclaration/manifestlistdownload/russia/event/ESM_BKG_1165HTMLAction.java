...
*@FileName : ESM_BKG_1165HTMLAction.java
*@FileTitle : ESM_BKG-1165
*Open Issues :
*Change history :
...
public class ESM_BKG_1165HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1165HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1165HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1165Event event = new EsmBkg1165Event();
