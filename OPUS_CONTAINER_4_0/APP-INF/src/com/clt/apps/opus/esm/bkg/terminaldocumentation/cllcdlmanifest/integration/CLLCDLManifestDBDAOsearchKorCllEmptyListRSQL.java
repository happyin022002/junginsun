...
public class CLLCDLManifestDBDAOsearchKorCllEmptyListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		BKG_CNTR_SEAL_NO BCSN," ).append("\n"); 
		...
		query.append("		MDM_COMMODITY  MDMC" ).append("\n"); 
		...
		query.append("	AND #end BB.BKG_CGO_TP_CD IN ('R','P') " ).append("\n"); 
		...
		query.append("order by CNTR_NO #end #if (${in_sort_type} == '7' ) order by TO_NUMBER(BL_WGT,'99990') #end) T" ).append("\n"); 
