...
*@FileName : BlRatingDBDAOModifyChgRateMasterUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOModifyChgRateMasterUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOModifyChgRateMasterUSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOModifyChgRateMasterUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    RT_BL_TP_CD = 'N'" ).append("\n"); 
		query.append(" WHERE   " ).append("\n"); 
		query.append("	BKG_NO IN  " ).append("\n"); 
		query.append("	(" ).append("\n"); 
		query.append("	select BKG_NO from  BKG_BL_DOC  WHERE  MST_CVRD_BL_NO =  CASE WHEN LENGTH(@[bl_no])>=12 THEN SUBSTR(@[bl_no],0,12)" ).append("\n"); 
