...
public class IndiaCustomsTransmissionDBDAOsearchCntrListByVvdPodMtRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SUBSTR(BCIV.CALL_SGN_NO, 1, 7) CALL_SGN_NO" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append(", 'INNAH', DECODE(BC.CNTR_TPSZ_CD,    BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','1',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','1',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','2',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','2',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','3',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','3',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','4',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','4',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','5',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','5',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','6',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','6',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','7',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','7',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','8',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','8',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','9',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','9',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','10',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','10',2)," ).append("\n"); 
		query.append("BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','11',1), BKG_GET_BKG_CTMS_CD_FNC('IN','MANI_LOC2_CNTR_TPSZ','11',2)" ).append("\n"); 
		query.append(")" ).append("\n"); 
