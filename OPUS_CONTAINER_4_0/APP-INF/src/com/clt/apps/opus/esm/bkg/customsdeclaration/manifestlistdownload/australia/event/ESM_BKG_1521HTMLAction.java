...
*@FileName : ESM_BKG_1521HTMLAction.java
 ...
 * @see EsmBkg1521Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_1521HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1521Event event = new EsmBkg1521Event();

		if(command.isCommand(FormCommand.SEARCH)) {

			event.setAusSendHistoryCondVO((AusSendHistoryCondVO)getVO(request, AusSendHistoryCondVO.class));
