...
*@FileName : CustomerInfoManageDBDAORemoveCustCoverInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerInfoManageDBDAORemoveCustCoverInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomerInfoManageDBDAORemoveCustCoverInfoUSQL(){
		setQuery();
		...
		query.append("FileName : CustomerInfoManageDBDAORemoveCustCoverInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
