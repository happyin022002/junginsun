...
*@FileName : SCRateProposalDBDAOLoadExcelCheckGrpCmdtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOLoadExcelCheckGrpCmdtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOLoadExcelCheckGrpCmdtRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOLoadExcelCheckGrpCmdtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("-- WHERE PROP_NO = " ).append("\n"); 
		query.append("--   AND AMDT_SEQ = " ).append("\n"); 
		query.append("--   AND SVC_SCP_CD = " ).append("\n"); 
		query.append("--   AND PRC_GRP_CMDT_CD = " ).append("\n"); 
