...
*@FileName : TaiwanSearchBlVvdVO.java
*@FileTitle : TaiwanSearchBlVvdVO
*Open Issues :
*Change history :
...
public class TaiwanSearchBlVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TaiwanSearchBlVvdVO> models = new ArrayList<TaiwanSearchBlVvdVO>();
	...
	public TaiwanSearchBlVvdVO() {}

	public TaiwanSearchBlVvdVO(String ibflag, String pagerows, String bvvd, String bpol, String bpod) {
		this.bvvd = bvvd;
		this.ibflag = ibflag;
		this.bpol = bpol;
		this.bpod = bpod;
	 ...
	 * @param request
	 * @return TaiwanSearchBlVvdVO[]
	 */
	public TaiwanSearchBlVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TaiwanSearchBlVvdVO[]
	 */
	public TaiwanSearchBlVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TaiwanSearchBlVvdVO model = null;
		...
		return getTaiwanSearchBlVvdVOs();
	}
	 ...
	 * @return TaiwanSearchBlVvdVO[]
	 */
	public TaiwanSearchBlVvdVO[] getTaiwanSearchBlVvdVOs(){
		TaiwanSearchBlVvdVO[] vos = (TaiwanSearchBlVvdVO[])models.toArray(new TaiwanSearchBlVvdVO[models.size()]);
		return vos;
	}
