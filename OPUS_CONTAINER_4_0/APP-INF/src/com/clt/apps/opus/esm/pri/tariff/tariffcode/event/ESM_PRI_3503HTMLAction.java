...
*@FileName : ESM_PRI_3503HTMLAction.java
...
public class ESM_PRI_3503HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3503HTMLAction 객체를 생성
	 */
	public ESM_PRI_3503HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3503Event event = new EsmPri3503Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) { 
			event.setSearchTariffCodeALLVO((SearchTariffCodeALLVO)getVO(request, SearchTariffCodeALLVO .class));
		}
		return  event;
	}
