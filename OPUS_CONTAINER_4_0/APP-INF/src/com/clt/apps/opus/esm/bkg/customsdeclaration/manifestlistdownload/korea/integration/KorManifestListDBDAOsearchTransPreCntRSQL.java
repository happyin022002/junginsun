...
*@FileName : KorManifestListDBDAOsearchTransPreCntRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchTransPreCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchTransPreCntRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchTransPreCntRSQL").append("\n");
		query.append("*/").append("\n");
	}
