...
*@FileName : RsltPriComGrpCmdtDtlVO.java
*@FileTitle : RsltPriComGrpCmdtDtlVO
*Open Issues :
*Change history :
...
public class RsltPriScgGrpCmdtDtlVO extends AbstractValueObject {
	...
	public RsltPriScgGrpCmdtDtlVO(String ibflag, String pagerows, String svcScpCd, String chgCd, String scgGrpCmdtSeq, String scgGrpCmdtDtlSeq, String cmdtCd, String effDt, String expDt, String creUsrId, String creDt, String updUsrId, String updDt, String cmdtDes) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCmdtDes(JSPUtil.getParameter(request, "cmdt_des", ""));
	...
	public RsltPriScgGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cmdtDes = (JSPUtil.getParameter(request, prefix	+ "cmdt_des".trim(), length));
		...
		return getRsltPriComGrpCmdtDtlVOs();
	}
	 ...
	 * @return RsltPriComGrpCmdtDtlVO[]
	 */
	public RsltPriScgGrpCmdtDtlVO[] getRsltPriComGrpCmdtDtlVOs(){
