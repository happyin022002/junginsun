...
*@FileName : OTRCommAuditDBDAOSearchAGNCommAuditConfirmNoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class OTRCommAuditDBDAOSearchAGNCommAuditConfirmNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OTRCommAuditDBDAOSearchAGNCommAuditConfirmNoRSQL(){
		setQuery();
		...
		query.append("FileName : OTRCommAuditDBDAOSearchAGNCommAuditConfirmNoRSQL").append("\n");
		query.append("*/").append("\n");
	}
