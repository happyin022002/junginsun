...
*@FileName : KorKcdTpCntrVO.java
*@FileTitle : KorKcdTpCntrVO
*Open Issues :
*Change history :
...
public class KorKcdTpCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorKcdTpCntrVO> models = new ArrayList<KorKcdTpCntrVO>();
	...
	public KorKcdTpCntrVO() {}

	public KorKcdTpCntrVO(String ibflag, String pagerows, String oldCstmsDeclTpCd, String msnNo, String bkgNo, String blNo, String cstmsDeclTpCd, String portCd, String trnsSeq, String usrId) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public KorKcdTpCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorKcdTpCntrVO[]
	 */
	public KorKcdTpCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorKcdTpCntrVO model = null;
	 ...
	 * @return KorKcdTpCntrVO[]
	 */
	public KorKcdTpCntrVO[] getKorKcdTpCntrVOs(){
		KorKcdTpCntrVO[] vos = (KorKcdTpCntrVO[])models.toArray(new KorKcdTpCntrVO[models.size()]);
		return vos;
	}
