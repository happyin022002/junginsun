...
public class JapanCustomsReportDBDAOsearchJpcusSendListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("  FROM (SELECT JP_SND_LOG_ID," ).append("\n"); 
		query.append("               SND_DT," ).append("\n"); 
		query.append("               SND_DT2," ).append("\n"); 
		query.append("               OFC_CD," ).append("\n"); 
		query.append("               UPD_USR_ID," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("          FROM (SELECT JP_SND_LOG_ID," ).append("\n"); 
		query.append("                       TO_CHAR(SND_DT, 'YYYY-MM-DD') AS SND_DT," ).append("\n"); 
		query.append("                       TO_CHAR(SND_DT, 'HH24:MI:SS') AS SND_DT2," ).append("\n"); 
		query.append("                       OFC_CD," ).append("\n"); 
		query.append("                       UPD_USR_ID," ).append("\n"); 
		query.append("                       NVL(VSL_CD, ' ')||NVL(SKD_VOY_NO, ' ')||NVL(SKD_DIR_CD, ' ') AS VVD_CD," ).append("\n"); 
		query.append("                       POD_CD," ).append("\n"); 
		query.append("                       DECODE(LOG_FLG, 'Y', 'NACCS', '') AS LOG_FLG," ).append("\n"); 
		query.append("                       TO_CHAR(LOG_DT, 'YYYY-MM-DD') AS LOG_DT," ).append("\n"); 
		query.append("                       TO_CHAR(LOG_DT, 'HH24:MI') AS LOG_DT2," ).append("\n"); 
		query.append("                       LOG_SEQ," ).append("\n"); 
		query.append("                       NVL(BL_NO, ' ') AS BL_NO" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                   AND SND_DT BETWEEN TO_DATE(@[start_snd_dt], 'YYYY-MM-DD HH24:MI') AND TO_DATE(@[end_snd_dt], 'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                SELECT DOR.FLT_FILE_REF_NO," ).append("\n"); 
		query.append("                       TO_CHAR(DOR.EDI_EVNT_DT, 'YYYY-MM-DD') AS SND_DT," ).append("\n"); 
		query.append("                       TO_CHAR(DOR.EDI_EVNT_DT, 'HH24:MI:SS') AS SND_DT2," ).append("\n"); 
		...
		query.append("                       ' ' AS LOG_FLG," ).append("\n"); 
		query.append("                       ' ' AS LOG_DT," ).append("\n"); 
		query.append("                       ' ' AS LOG_DT2," ).append("\n"); 
		query.append("                       DOR.EDI_SND_SEQ AS LOG_SEQ," ).append("\n"); 
		...
		query.append("#if (${date_check} != '')" ).append("\n"); 
		query.append("                   AND DOR.EDI_EVNT_DT BETWEEN TO_DATE(@[start_snd_dt], 'YYYY-MM-DD HH24:MI') AND TO_DATE(@[end_snd_dt], 'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
