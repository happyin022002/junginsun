...
public class CargoReleaseOrderDBDAOSearchEdiSeanaccsBlInfoByTransRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT RPAD(DECODE(NVL(BKGM.BL_NO,' '),' ',' ',COM_ConstantMgr_PKG.COM_getScacCode_FNC||BKGM.BL_NO),35,' ')||CHR(13)||CHR(10)||" ).append("\n"); 
		query.append("       RPAD(NVL(NVL('', ''),' '),10,' ')||CHR(13)||CHR(10)||                																																																																													" ).append("\n"); 
