...
public class BLIssuanceDBDAOsearchDblEdiChgByTraxRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND (N3PTY_RCV_OFC_CD = 'SHAAS'" ).append("\n"); 
		query.append("OR N3PTY_RCV_OFC_CD = 'SHAHQ'))" ).append("\n"); 
		query.append("OR (N3PTY_CUST_CNT_CD = 'SG'" ).append("\n"); 
		query.append("AND N3PTY_RCV_OFC_CD = 'SINBB'" ).append("\n"); 
		query.append("AND (N3PTY_CUST_SEQ = 260" ).append("\n"); 
		query.append("OR N3PTY_CUST_SEQ = 11029)))" ).append("\n"); 
		...
		query.append("OR (CLT_PAYR_CNT_CD = 'SG' AND CLT_PAYR_CUST_SEQ IN (260, 11029)" ).append("\n"); 
		query.append("AND CLT_OFC_CD IN ('SHAHQ', 'SHAAS', 'SINBB'))" ).append("\n"); 
		query.append("OR (PPD_PAYR_CNT_CD = 'SG'" ).append("\n"); 
		query.append("AND PPD_RCV_OFC_CD = 'SINBB'" ).append("\n"); 
		query.append("AND PPD_PAYR_CUST_SEQ IN (260, 11029)))" ).append("\n"); 
