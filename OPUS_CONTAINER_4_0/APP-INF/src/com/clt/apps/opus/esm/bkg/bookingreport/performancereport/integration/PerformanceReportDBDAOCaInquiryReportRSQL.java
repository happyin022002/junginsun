...
public class PerformanceReportDBDAOCaInquiryReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				where  (VSL_CD,SKD_VOY_NO,SKD_DIR_CD,VPS_PORT_CD, CLPT_IND_SEQ) = " ).append("\n"); 
		query.append("					   (select VVD.VSL_CD,VVD.SKD_VOY_NO,VVD.SKD_DIR_CD,VVD.POD_CD, POD_CLPT_IND_SEQ " ).append("\n"); 
