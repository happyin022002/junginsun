...
*@FileName : AGNCommApprovalDBDAOModifyACMApprovalRequesttoEPUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommApprovalDBDAOModifyACMApprovalRequesttoEPUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyACMApprovalRequesttoEP
	  * </pre>
	  */
	public AGNCommApprovalDBDAOModifyACMApprovalRequesttoEPUSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommApprovalDBDAOModifyACMApprovalRequesttoEPUSQL").append("\n");
		query.append("*/").append("\n");
	}
