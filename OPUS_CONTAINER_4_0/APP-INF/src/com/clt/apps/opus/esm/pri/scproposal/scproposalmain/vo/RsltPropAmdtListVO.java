...
*@FileName : RsltPropAmdtListVO.java
*@FileTitle : RsltPropAmdtListVO
*Open Issues :
*Change history :
...
public class RsltPropAmdtListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPropAmdtListVO> models = new ArrayList<RsltPropAmdtListVO>();
	...
	public RsltPropAmdtListVO() {}

	public RsltPropAmdtListVO(String ibflag, String pagerows, String scNo, String propNo, String amdtSeq, String ctrtEffDt, String ctrtExpDt, String effDt) {
		this.effDt = effDt;
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return RsltPropAmdtListVO[]
	 */
	public RsltPropAmdtListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPropAmdtListVO[]
	 */
	public RsltPropAmdtListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPropAmdtListVO model = null;
	 ...
	 * @return RsltPropAmdtListVO[]
	 */
	public RsltPropAmdtListVO[] getRsltPropAmdtListVOs(){
		RsltPropAmdtListVO[] vos = (RsltPropAmdtListVO[])models.toArray(new RsltPropAmdtListVO[models.size()]);
		return vos;
	}
