...
*@FileName : CommonDBDAOSearchMonthlyQuotaSlsRHQRemarkListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchMonthlyQuotaSlsRHQRemarkListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOSearchMonthlyQuotaSlsRHQRemarkListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchMonthlyQuotaSlsRHQRemarkListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   RMK.SLS_RGN_OFC_CD = @[rgn_ofc_cd]                                        " ).append("\n"); 
		query.append("AND   RMK.BSE_MON       = @[bse_mon]                                         " ).append("\n"); 
		query.append("AND   RMK.POL_CD        = @[pol_cd]                                         " ).append("\n"); 
		query.append("AND   RMK.POD_CD        = @[pod_cd]                                         " ).append("\n"); 
