...
*@FileName : BSAManageDBDAOModifySpcJoCompanyBsaCapaUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifySpcJoCompanyBsaCapaUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySpcJoCompanyBsaCapa
	  * </pre>
	  */
	public BSAManageDBDAOModifySpcJoCompanyBsaCapaUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifySpcJoCompanyBsaCapaUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" SET    (A.CRR_BSA_CAPA,A.SPC_CTRL_SLT_CAPA) = (SELECT NVL(SUM(B.FNL_CO_BSA_CAPA),0), " ).append("\n"); 
		query.append("                                                       NVL(SUM(B.FNL_CO_BSA_CAPA),0)" ).append("\n"); 
