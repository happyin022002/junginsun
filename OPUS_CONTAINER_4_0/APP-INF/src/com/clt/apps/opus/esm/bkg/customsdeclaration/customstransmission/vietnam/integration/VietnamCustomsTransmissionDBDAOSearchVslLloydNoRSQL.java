...
*@FileName : VietnamCustomsTransmissionDBDAOSearchVslLloydNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VietnamCustomsTransmissionDBDAOSearchVslLloydNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VietnamCustomsTransmissionDBDAOSearchVslLloydNoRSQL(){
		setQuery();
		...
		query.append("FileName : VietnamCustomsTransmissionDBDAOSearchVslLloydNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
