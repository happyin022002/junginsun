...
*@FileName : LocationListVO.java
*@FileTitle : LocationListVO
*Open Issues :
*Change history :
...
public class LocationListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<LocationListVO> models = new ArrayList<LocationListVO>();
	...
	public LocationListVO(String ibflag, String pagerows, String locCd, String locNm, String rgnCd, String locState, String hubLocCd, String unLocIndCd, String unLocCd, String locChrCd, String sccCd, String lccCd, String eccCd, String rccCd, String cntCd, String slsOfcCd, String eqCtrlOfcCd) {
		this.rgnCd = rgnCd;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLocState(JSPUtil.getParameter(request, "loc_state", ""));
	 ...
	 */
	public LocationListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LocationListVO[]
	 */
	public LocationListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LocationListVO model = null;
	...
	public LocationListVO[] getLocationListVOs(){
		LocationListVO[] vos = (LocationListVO[])models.toArray(new LocationListVO[models.size()]);
		return vos;
	}
