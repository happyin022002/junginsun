...
*@FileName : RFAGroupLocationGuidelineDBDAORsltPriRgGrpLocDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationGuidelineDBDAORsltPriRgGrpLocDtlVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationGuidelineDBDAORsltPriRgGrpLocDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationGuidelineDBDAORsltPriRgGrpLocDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_RG_GRP_LOC_DTL A, MDM_LOCATION B" ).append("\n"); 
