...
*@FileName : ACMSimulationDBDAOSearchAGNCommSimulationListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOSearchAGNCommSimulationListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOSearchAGNCommSimulationListRSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOSearchAGNCommSimulationListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("       SUM(DECODE(SIGN(INSTR('GKHNRSC', A.AC_TP_CD)), 1, A.PPD_AMT, 0)) AS PPD_AMT," ).append("\n"); 
		...
		query.append("       SUM(DECODE(SIGN(INSTR('GKHNRSC', A.AC_TP_CD)), 1, A.IF_AMT, 0)) AS USD_AMT," ).append("\n"); 
		query.append("       MAX(PAY_XCH_RT) AS PAY_XCH_RT," ).append("\n"); 
		query.append("       A.CURR_CD," ).append("\n"); 
		query.append("       SUM(DECODE(SIGN(INSTR('GKHNRSC', A.AC_TP_CD)), 1, PAY_IF_AMT, 0)) AS PAY_IF_AMT," ).append("\n"); 
