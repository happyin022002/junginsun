...
*@FileName : BLIssuanceDBDAOsearchDblEdiMain11RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOsearchDblEdiMain11RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLIssuanceDBDAOsearchDblEdiMain11RSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOsearchDblEdiMain11RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   'VSL_VOY_NO:'|| BK.SKD_VOY_NO || CHR(10) ||" ).append("\n"); 
		...
		query.append("	   'VSL_CONSORTIUM_VOY_NO:'|| (SELECT VSK.OB_CSSM_VOY_NO FROM BKG_BOOKING B, BKG_VVD VVD, VSK_VSL_PORT_SKD VSK" ).append("\n"); 
		...
		query.append("	   'VSL_LOCAL_CODE:'||BK.VSL_CD||CHR(10)||" ).append("\n"); 
		query.append("       'BLNBR:' || BK.BL_NO || CHR(10)|| " ).append("\n"); 
		query.append("       'BLPOL:' || DECODE(BK.POL_CD,'KRPUS',DECODE(BK.POL_NOD_CD,'KRPUSHN','KRPNC','KRPUSYN','KRPNC', BK.POL_CD), BK.POL_CD) || CHR(10) || " ).append("\n"); 
		query.append("       'POL_AMS:' || POL.LOC_AMS_PORT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'POL_FULLNAME:' || BL.POL_NM || CHR(10) || " ).append("\n"); 
		query.append("	   'POL_STAT_CD:' || POL.STE_CD || CHR(10) ||" ).append("\n"); 
		query.append("       'BLPOD:' || DECODE(BK.POD_CD,'KRPUS',DECODE(BK.POD_NOD_CD,'KRPUSHN','KRPNC','KRPUSYN','KRPNC', BK.POD_CD), BK.POD_CD) || CHR(10) || " ).append("\n"); 
		query.append("       'POD_AMS:' || POD.LOC_AMS_PORT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'POD_FULLNAME:' || POD.LOC_NM || CHR(10) || " ).append("\n"); 
		query.append("	   'POD_STAT_CD:' || POD.STE_CD || CHR(10) ||" ).append("\n"); 
		query.append("       'BLPOR:' || DECODE(BK.POR_CD,'KRPUS',DECODE(BK.POR_NOD_CD,'KRPUSHN','KRPNC','KRPUSYN','KRPNC', BK.POR_CD), BK.POR_CD) || CHR(10) || " ).append("\n"); 
		query.append("       'POR_AMS:' || POR.LOC_AMS_PORT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'POR_FULLNAME:' || POR.LOC_NM || CHR(10) || " ).append("\n"); 
		query.append("	   'POR_STAT_CD:' || POR.STE_CD || CHR(10) ||" ).append("\n"); 
		query.append("       'BLDEL:' || DECODE(BK.DEL_CD,'KRPUS',DECODE(BK.DEL_NOD_CD,'KRPUSHN','KRPNC','KRPUSYN','KRPNC', BK.DEL_CD), BK.DEL_CD) || CHR(10) || " ).append("\n"); 
		query.append("       'DEL_AMS:' || DEL.LOC_AMS_PORT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'DEL_FULLNAME:' || DEL.LOC_NM || CHR(10) || " ).append("\n"); 
		query.append("	   'DEL_STAT_CD:' || DEL.STE_CD || CHR(10) ||" ).append("\n"); 
		query.append("	   'BLFDEST:' || BK.DEL_CD || CHR(10) ||" ).append("\n"); 
		query.append("	   'FDEST_AMS:' || DEL.LOC_AMS_PORT_CD || CHR(10) || " ).append("\n"); 
		query.append("	   'FDEST_FULLNAME:' || DEL.LOC_NM || CHR(10) || " ).append("\n"); 
		query.append("	   'FDEST_STAT_CD:' || DEL.STE_CD || CHR(10) ||" ).append("\n"); 
		query.append("       'BLRLY:' || @[pre_rly_port_cd] || CHR(10) || " ).append("\n"); 
		query.append("       'RLY_AMS:' || RLY.LOC_AMS_PORT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'RLY_FULLNAME:' || RLY.LOC_NM || CHR(10) || " ).append("\n"); 
		query.append("       'RLY_STAT_CD:' || RLY.STE_CD || CHR(10) || " ).append("\n"); 
		query.append("       'BLRLY2:' || @[pst_rly_port_cd] || CHR(10) || " ).append("\n"); 
		query.append("       'RLY_AMS2:' || RLY2.LOC_AMS_PORT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'RLY_FULLNAME2:' || RLY2.LOC_NM || CHR(10) || " ).append("\n"); 
		query.append("       'RLY2_STAT_CD:' || RLY2.STE_CD || CHR(10) || " ).append("\n"); 
		...
		query.append("       'ANFCD1:' || AN.CUST_CNT_CD||AN.CUST_SEQ || CHR(10) || " ).append("\n"); 
		query.append("       'FWCD1:' || FW.CUST_CNT_CD||FW.CUST_SEQ || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR1:' || BKG_TOKEN_NL_FNC(SH.CUST_NM, 1, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR2:' || BKG_TOKEN_NL_FNC(SH.CUST_NM, 2, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR3:' || DECODE(SH.ADDR_PRN_FLG, 'Y', BKG_TOKEN_NL_FNC(SH.CUST_ADDR, 1, '*:')) || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR4:' || DECODE(SH.ADDR_PRN_FLG, 'Y', BKG_TOKEN_NL_FNC(SH.CUST_ADDR, 2, '*:')) || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR5:' || DECODE(SH.ADDR_PRN_FLG, 'Y', BKG_TOKEN_NL_FNC(SH.CUST_ADDR, 3, '*:')) || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR_CITY_NM:' || BKG_TOKEN_NL_FNC(SH.CUST_CTY_NM, 0, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR_STAT_CD:' || SH.CUST_STE_CD || CHR(10) || " ).append("\n"); 
		query.append("       'SHPR_ZIP_CD:' ||  BKG_TOKEN_NL_FNC(SH.CUST_ZIP_ID, 0, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'SHPR_CNT_CD:' || SH.CSTMS_DECL_CNT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'SH_IND:' || CHR(10) || " ).append("\n"); 
		query.append("       'CNEE1:' || BKG_TOKEN_NL_FNC(CN.CUST_NM, 1, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'CNEE2:' || BKG_TOKEN_NL_FNC(CN.CUST_NM, 2, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'CNEE3:' || BKG_TOKEN_NL_FNC(CN.CUST_ADDR, 1, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'CNEE4:' || BKG_TOKEN_NL_FNC(CN.CUST_ADDR, 2, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'CNEE5:' || BKG_TOKEN_NL_FNC(CN.CUST_ADDR, 3, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'CNEE_CITY_NM:' || BKG_TOKEN_NL_FNC(CN.CUST_CTY_NM, 0, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'CNEE_STAT_CD:' || CN.CUST_STE_CD || CHR(10) || " ).append("\n"); 
		query.append("       'CNEE_ZIP_CD:' || BKG_TOKEN_NL_FNC(CN.CUST_ZIP_ID, 0, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'CNEE_CNT_CD:' || CN.CSTMS_DECL_CNT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'CN_IND:' || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY1:' || BKG_TOKEN_NL_FNC(NF.CUST_NM, 1, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY2:' || BKG_TOKEN_NL_FNC(NF.CUST_NM, 2, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY3:' || BKG_TOKEN_NL_FNC(NF.CUST_ADDR, 1, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'NTFY4:' || BKG_TOKEN_NL_FNC(NF.CUST_ADDR, 2, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'NTFY5:' || BKG_TOKEN_NL_FNC(NF.CUST_ADDR, 3, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'NTFY6:' || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY_CITY_NM:' || BKG_TOKEN_NL_FNC(NF.CUST_CTY_NM, 0, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY_STAT_CD:' || NF.CUST_STE_CD || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY_ZIP_CD:' || BKG_TOKEN_NL_FNC(NF.CUST_ZIP_ID, 0, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'NTFY_CNT_CD:' || NF.CSTMS_DECL_CNT_CD || CHR(10) || " ).append("\n"); 
		query.append("       'NF_IND:' || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY21:' || BKG_TOKEN_NL_FNC(AN.CUST_NM, 1, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY22:' || BKG_TOKEN_NL_FNC(AN.CUST_NM, 2, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY23:' || BKG_TOKEN_NL_FNC(AN.CUST_NM, 3, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY24:' || BKG_TOKEN_NL_FNC(AN.CUST_NM, 4, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY25:' || BKG_TOKEN_NL_FNC(AN.CUST_NM, 5, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY2_CITY_NM:' || BKG_TOKEN_NL_FNC(AN.CUST_CTY_NM, 0, '*:') || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY2_STAT_CD:' ||AN.CUST_STE_CD || CHR(10) || " ).append("\n"); 
		query.append("       'NTFY2_ZIP_CD:' ||  BKG_TOKEN_NL_FNC(AN.CUST_ZIP_ID, 0, '*:') || CHR(10) ||" ).append("\n"); 
		query.append("       'NTFY2_CNT_CD:' || AN.CSTMS_DECL_CNT_CD || CHR(10) || " ).append("\n"); 
