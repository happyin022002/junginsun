...
public class CargoReleaseOrderDBDAOSearchJapDorEdiHistoryByCancelRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC(@[ofc_cd]) ),'YYYYMMDD HH24MISS') AS SND_RQST_DT" ).append("\n"); 
		query.append("     , '1'                     AS SND_RTY_KNT" ).append("\n"); 
		query.append("     , TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC,sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC(@[ofc_cd]) ),'YYYYMMDD HH24MISS') AS SND_DT" ).append("\n"); 
