...
*@FileName : SitProDgInfoVO.java
*@FileTitle : SitProDgInfoVO
*Open Issues :
*Change history :
...
public class SitProDgInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SitProDgInfoVO> models = new ArrayList<SitProDgInfoVO>();
	...
	public SitProDgInfoVO() {}

	public SitProDgInfoVO(String ibflag, String pagerows, String unnbr, String class1, String dgDesc, String contactNm, String phone, String page, String flshTemp, String flshUnit, String dgRemark, String emsno, String psacls, String pkggrp, String mfag1, String mfag2, String marPoll, String labelCd, String labelDesc, String dPkg, String dPkgunit, String nwgt, String nwgtUnit, String gwgt, String gwgtUnit, String mea, String meaUnit, String hazCont, String stwg, String label) {
		this.phone = phone;
...
/**
	 ...
	 */
	public SitProDgInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SitProDgInfoVO[]
	 */
	public SitProDgInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SitProDgInfoVO model = null;
	 ...
	 * @return SitProDgInfoVO[]
	 */
	public SitProDgInfoVO[] getSitProDgInfoVOs(){
		SitProDgInfoVO[] vos = (SitProDgInfoVO[])models.toArray(new SitProDgInfoVO[models.size()]);
		return vos;
	}
