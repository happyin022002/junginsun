 ...
 *@FileName : UI_PRI_0097HTMLAction.java
 *@FileTitle : ESM_PRI_0097HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_0097HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0097Event event = new EsmPri0097Event();

		if (command.isCommand(FormCommand.MODIFY01)) {
			event.setPriSpScpRtCmdtRnoteVOS((PriSpScpRtCmdtRnoteVO[]) getVOs(request, PriSpScpRtCmdtRnoteVO.class, ""));
