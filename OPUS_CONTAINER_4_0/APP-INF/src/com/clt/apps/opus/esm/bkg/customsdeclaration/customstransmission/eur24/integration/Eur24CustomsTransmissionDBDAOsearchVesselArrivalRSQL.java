...
public class Eur24CustomsTransmissionDBDAOsearchVesselArrivalRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	   ELSE DECODE(CONV.ATTR_CTNT1, NULL, TO_CHAR(VSK.INIT_ETA_DT, 'YYYYMMDDHH24') ||'0000'" ).append("\n"); 
		query.append("                                        , TO_CHAR(VSK.INIT_ETA_DT, 'YYYYMMDD') || CONV.ATTR_CTNT3)" ).append("\n"); 
		...
		query.append("                 " ).append("\n"); 
		query.append("                 ELSE " ).append("\n"); 
		query.append("                	  DECODE(CONV.ATTR_CTNT1, NULL, TO_CHAR(VSK.INIT_ETA_DT, 'YYYYMMDDHH24') || '0000'" ).append("\n"); 
		query.append("                                                  , TO_CHAR(VSK.INIT_ETA_DT, 'YYYYMMDD') || CONV.ATTR_CTNT3)" ).append("\n"); 
		query.append("        	END" ).append("\n"); 
