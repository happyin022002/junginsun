...
*@FileName : FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintDetailListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintDetailListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchFFCmpnApprovalPrintDetailList
	  * </pre>
	  */
	public FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintDetailListRSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnApprovalDBDAOSearchFFCmpnApprovalPrintDetailListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
