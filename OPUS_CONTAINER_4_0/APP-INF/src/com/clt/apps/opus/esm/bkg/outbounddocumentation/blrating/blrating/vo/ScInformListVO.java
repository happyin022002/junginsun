...
*@FileName : ScInformListVO.java
*@FileTitle : ScInformListVO
*Open Issues :
*Change history :
...
public class ScInformListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<ScInformListVO> models = new ArrayList<ScInformListVO>();
	...
	public ScInformListVO() {}

	public ScInformListVO(String ibflag, String pagerows, String pt, String commodityDescription, String por, String pol, String pod, String del, String dCall, String rd, String per, String cgoTp, String cur, String amount, String transMode, String qTy, String dtl, String ntV, String nt) {
		this.nt = nt;
	 ...
	 * @param request
	 * @return ScInformListVO[]
	 */
	public ScInformListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScInformListVO[]
	 */
	public ScInformListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScInformListVO model = null;
	 ...
	 * @return ScInformListVO[]
	 */
	public ScInformListVO[] getScInformListVOs(){
		ScInformListVO[] vos = (ScInformListVO[])models.toArray(new ScInformListVO[models.size()]);
		return vos;
	}
