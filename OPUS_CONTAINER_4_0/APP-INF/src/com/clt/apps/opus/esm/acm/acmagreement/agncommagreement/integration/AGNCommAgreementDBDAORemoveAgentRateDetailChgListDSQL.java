...
*@FileName : AGNCommAgreementDBDAORemoveAgentRateDetailChgListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAORemoveAgentRateDetailChgListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAORemoveAgentRateDetailChgListDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAORemoveAgentRateDetailChgListDSQL").append("\n");
		query.append("*/").append("\n");
	}
