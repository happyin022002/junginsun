...
public class CndCustomsReportDBDAOsearchACIMonitorRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",SUM(DECODE(RHQ,'SHAAS',NVL(CMS_SMC_AMT+CMS_SMC_AMT2,0),0)) OVER() AS TOTAL_SHAAS_ENS" ).append("\n"); 
		query.append(",SUM(DECODE(RHQ,'NYCNA',NVL(CMS_SMC_AMT+CMS_SMC_AMT2,0),0)) OVER() AS TOTAL_NYCNA_ENS" ).append("\n"); 
		query.append(",SUM(DECODE(RHQ,'HAMUR',NVL(CMS_SMC_AMT+CMS_SMC_AMT2,0),0)) OVER() AS TOTAL_HAMUR_ENS" ).append("\n"); 
		query.append(",SUM(DECODE(RHQ,'SINWA',NVL(CMS_SMC_AMT+CMS_SMC_AMT2,0),0)) OVER() AS TOTAL_SINWA_ENS" ).append("\n"); 
		query.append(",SUM(NVL(MCF_AMT,0)) OVER()         AS TOTAL_MCF_AMT" ).append("\n"); 
		query.append(",SUM(DECODE(RHQ,'SHAAS',NVL(MCF_AMT,0),0)) OVER() AS TOTAL_SHAAS_MCF" ).append("\n"); 
		query.append(",SUM(DECODE(RHQ,'NYCNA',NVL(MCF_AMT,0),0)) OVER() AS TOTAL_NYCNA_MCF" ).append("\n"); 
		query.append(",SUM(DECODE(RHQ,'HAMUR',NVL(MCF_AMT,0),0)) OVER() AS TOTAL_HAMUR_MCF" ).append("\n"); 
		query.append(",SUM(DECODE(RHQ,'SINWA',NVL(MCF_AMT,0),0)) OVER() AS TOTAL_SINWA_MCF" ).append("\n"); 
		...
		query.append("        AND BCR_ENS.CHG_CD(+)  = 'CMS'" ).append("\n"); 
		query.append("        AND BCR_ENS2.CHG_CD(+) = 'SMC'                 " ).append("\n"); 
