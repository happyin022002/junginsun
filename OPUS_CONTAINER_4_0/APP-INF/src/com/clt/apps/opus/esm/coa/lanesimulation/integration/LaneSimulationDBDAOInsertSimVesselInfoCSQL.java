...
*@FileName : LaneSimulationDBDAOInsertSimVesselInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOInsertSimVesselInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOInsertSimVesselInfoCSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOInsertSimVesselInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SIM_DT,SIM_NO, SECT_NO, VSL_CD, SIM_DIV_CD," ).append("\n"); 
		query.append("VSL_CLSS_CAPA, VOP_CD, VSL_CAPA, BSA_CAPA, FNL_HJS_BSA_CAPA," ).append("\n"); 
		query.append("LDF_RTO, HJS_BFR_BSA_CAPA," ).append("\n"); 
		query.append("OTR_CRR_BSA_CAPA1, OTR_CRR_BSA_CAPA2, OTR_CRR_BSA_CAPA3, OTR_CRR_BSA_CAPA4, OTR_CRR_BSA_CAPA5," ).append("\n"); 
		query.append("SUB_LSE_CAPA1, SUB_LSE_CAPA2, SUB_LSE_CAPA3, SUB_LSE_CAPA4, SUB_LSE_CAPA5," ).append("\n"); 
		query.append("SUB_CHTR_CAPA1, SUB_CHTR_CAPA2, SUB_CHTR_CAPA3, SUB_CHTR_CAPA4, SUB_CHTR_CAPA5," ).append("\n"); 
		query.append("CRE_USR_ID, CRE_DT,UPD_USR_ID, UPD_DT)" ).append("\n"); 
		query.append("VALUES (@[sim_dt],@[sim_no],@[sect_no],@[vsl_cd],@[sim_div_cd]," ).append("\n"); 
		query.append("@[vsl_clss_capa],@[vop_cd],@[vsl_capa],@[bsa_capa],@[fnl_hjs_bsa_capa]," ).append("\n"); 
		query.append("@[ldf_rto],@[hjs_bfr_bsa_capa]," ).append("\n"); 
		query.append("@[otr_crr_bsa_capa1],@[otr_crr_bsa_capa2],@[otr_crr_bsa_capa3],@[otr_crr_bsa_capa4]," ).append("\n"); 
