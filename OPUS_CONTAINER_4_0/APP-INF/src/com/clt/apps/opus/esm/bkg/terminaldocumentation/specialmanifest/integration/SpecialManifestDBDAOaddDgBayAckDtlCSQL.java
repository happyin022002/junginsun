...
*@FileName : SpecialManifestDBDAOaddDgBayAckDtlCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOaddDgBayAckDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BAPLIE 수신 DETAIL 정보 저장
	  * </pre>
	  */
	public SpecialManifestDBDAOaddDgBayAckDtlCSQL(){
		setQuery();
		...
		params.put("eur_dg_full_mty_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : SpecialManifestDBDAOaddDgBayAckDtlCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_DG_BAY_DTL (" ).append("\n");
		...
		query.append(",	@[cell_psn_no]" ).append("\n");
		query.append(",	@[grs_wgt]" ).append("\n");
		query.append(",	DECODE(@[cntr_wgt_ut_cd], 'KGM', 'KGS', @[cntr_wgt_ut_cd])" ).append("\n");
		query.append(",	@[iso_cntr_tpsz_cd]" ).append("\n");
		query.append(",	@[pol_cd]" ).append("\n");
		query.append(",	@[pod_cd]" ).append("\n");
		query.append(",	@[del_cd]" ).append("\n");
