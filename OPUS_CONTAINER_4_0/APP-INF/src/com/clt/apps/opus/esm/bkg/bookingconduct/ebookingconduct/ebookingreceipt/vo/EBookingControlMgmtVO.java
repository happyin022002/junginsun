...
public class EBookingControlMgmtVO extends AbstractValueObject {
	...
	public EBookingControlMgmtVO(String ibflag, String pagerows, String rowNum, String xterRqstAcptCd, String rqstDt, String bkgUpldStsCd, String mdfyXterRqstNo, String xterRqstNo, String xterRqstSeq, String xterBkgRqstStsCd, String shNm, String vvd, String xterPorCd, String xterDelCd, String delivery, String frtTerm, String teu, String feu, String estWgt, String bkgNo, String cnNm, String vslEngNm, String hndlOfcCd, String docTpCd, String xterRqstViaCd, String xterPolCd, String xterPodCd, String rqstDepDt, String skdVoyNo, String poNo, String cntcEml, String ofcCd, String upldUsrId, String upldUsrNm, String upldDt, String xterSndrId, String vslCd, String bkgStsCd, String snaccsSplitNo, String rqstFromDt, String rqstToDt, String chnAgnCd, String polCd, String reject, String confirm, String scNo, String rfaNo, String podCd, String bkgPodCd, String sumTeu, String sumFeu, String sumTtl, String sumWgt, String sumUld, String sumUnu) {
		this.vslCd = vslCd;
		this.sumUld = sumUld;
...
/**
	...
	public EBookingControlMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sumUld = (JSPUtil.getParameter(request, prefix	+ "sum_uld", length));
			String[] xterPodCd = (JSPUtil.getParameter(request, prefix	+ "xter_pod_cd", length));
			String[] sumFeu = (JSPUtil.getParameter(request, prefix	+ "sum_feu", length));
			...
			String[] sumTtl = (JSPUtil.getParameter(request, prefix	+ "sum_ttl", length));
			String[] scNo = (JSPUtil.getParameter(request, prefix	+ "sc_no", length));
			String[] sumWgt = (JSPUtil.getParameter(request, prefix	+ "sum_wgt", length));
			...
			String[] estWgt = (JSPUtil.getParameter(request, prefix	+ "est_wgt", length));
			...
			String[] reject = (JSPUtil.getParameter(request, prefix	+ "reject", length));
			String[] bkgStsCd = (JSPUtil.getParameter(request, prefix	+ "bkg_sts_cd", length));
			String[] sumTeu = (JSPUtil.getParameter(request, prefix	+ "sum_teu", length));
			...
			String[] sumUnu = (JSPUtil.getParameter(request, prefix	+ "sum_unu", length));
			...
			String[] mdfyXterRqstNo = (JSPUtil.getParameter(request, prefix	+ "mdfy_xter_rqst_no", length));
			...
			String[] confirm = (JSPUtil.getParameter(request, prefix	+ "confirm", length));
