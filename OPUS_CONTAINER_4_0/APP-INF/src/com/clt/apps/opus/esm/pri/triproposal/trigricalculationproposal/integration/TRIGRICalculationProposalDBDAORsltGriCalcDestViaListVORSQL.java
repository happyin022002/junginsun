...
*@FileName : TRIGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
