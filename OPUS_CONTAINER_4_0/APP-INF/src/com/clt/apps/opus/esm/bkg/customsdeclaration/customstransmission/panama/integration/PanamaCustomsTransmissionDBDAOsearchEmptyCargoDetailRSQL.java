...
*@FileName : PanamaCustomsTransmissionDBDAOsearchEmptyCargoDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PanamaCustomsTransmissionDBDAOsearchEmptyCargoDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PanamaCustomsTransmissionDBDAOsearchEmptyCargoDetailRSQL(){
		setQuery();
		...
		query.append("FileName : PanamaCustomsTransmissionDBDAOsearchEmptyCargoDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM OPF_BAY_PLN_LDIS F," ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		...
		query.append("X_CNTRTS_CD," ).append("\n"); 
		query.append("DECODE(SIGN(F.VSL_TR_NO - 80), 0, 'A', 1, 'A', 'B')" ).append("\n"); 
		query.append(")" ).append("\n"); 
