...
*@FileName : BLIssuanceDBDAOSearchBlCompleteRcvEmlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOSearchBlCompleteRcvEmlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BLIssueanceDBDAOSearchBlCompleteRcvEml
	  * </pre>
	  */
	public BLIssuanceDBDAOSearchBlCompleteRcvEmlVORSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOSearchBlCompleteRcvEmlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    AND   UI.RDY_FO_PRF_FLG = 'Y'" ).append("\n"); 
