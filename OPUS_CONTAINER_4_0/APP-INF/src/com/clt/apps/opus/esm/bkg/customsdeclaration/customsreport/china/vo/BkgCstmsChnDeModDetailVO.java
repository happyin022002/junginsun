...
public class BkgCstmsChnDeModDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<BkgCstmsChnDeModDetailVO> models = new ArrayList<BkgCstmsChnDeModDetailVO>();
	...
	public BkgCstmsChnDeModDetailVO() {}

	public BkgCstmsChnDeModDetailVO(String ibflag, String pagerows, String podCd, String areaNm, String delCd, String trspModCd, String diffRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.podCd = podCd;
	 ...
	 */
	public BkgCstmsChnDeModDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsChnDeModDetailVO[]
	 */
	public BkgCstmsChnDeModDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsChnDeModDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgCstmsChnDeModDetailVO();
				if (updDt[i] != null)
	...
	public BkgCstmsChnDeModDetailVO[] getBkgCstmsChnDeModDetailVOs(){
		BkgCstmsChnDeModDetailVO[] vos = (BkgCstmsChnDeModDetailVO[])models.toArray(new BkgCstmsChnDeModDetailVO[models.size()]);
		return vos;
	}
