...
*@FileName : ESM_BKG_0707HTMLAction.java
...
public class ESM_BKG_0707HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0707HTMLAction 객체를 생성
	 */
	public ESM_BKG_0707HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0707Event event = new EsmBkg0707Event();
		log.debug("::CALL:: ESM_BKG_0707HTMLAction : " + command.getCommand());
