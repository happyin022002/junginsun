...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * insert PRI_SP_SCP_NOTE_CTNT_MIG_HIS
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_SCP_NOTE_CTNT_MIG_HIS " ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("   AND DECODE(@[note_ctnt_seq], NULL, 1, A.NOTE_CTNT_SEQ) = DECODE(@[note_ctnt_seq], NULL, 1, @[note_ctnt_seq])" ).append("\n"); 
