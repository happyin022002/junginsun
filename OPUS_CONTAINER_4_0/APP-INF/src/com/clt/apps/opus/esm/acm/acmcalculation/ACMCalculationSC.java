...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.acm.acmcalculation;

import java.util.List;

import com.clt.apps.opus.esm.acm.acmcalculation.agncommcalculation.basic.AGNCommCalculationBC;
import com.clt.apps.opus.esm.acm.acmcalculation.agncommcalculation.basic.AGNCommCalculationBCImpl;
import com.clt.apps.opus.esm.acm.acmcalculation.agncommcalculation.event.EsmAcm0012Event;
import com.clt.apps.opus.esm.acm.acmcalculation.agncommcalculation.event.EsmAcm0036Event;
import com.clt.apps.opus.esm.acm.acmcalculation.agncommcalculation.event.EsmAcm9999Event;
import com.clt.apps.opus.esm.acm.acmcalculation.agncommcalculation.integration.AGNCommCalculationDBDAO;
...
import com.clt.apps.opus.esm.acm.acmcalculation.ffcommcalculation.basic.FFCommCalculationBC;
...
/**
 * OPUS-ACMCalculation Business Logic ServiceCommand<br>
 * - OPUS-ACMCalculation에 대한 비지니스 트랜잭션을 처리한다.
 *
 * @author KIM, Sang-Soo
...
public class ACMCalculationSC extends ServiceCommandSupport {
	 ...
	 * OPUS-ACMCalculation system 업무에서 발생하는 모든 이벤트의 분기처리<br>
	 *
	 * @param e Event
...
//			eventResponse.setCustomData("rowset", command.searchAGNCommMassCalExcel(event.getAGNCommMassCalVO()));
	...
	public void reCalculateFACComm(String bkg_no, SignOnUserAccount account) throws EventException {
        ...
        try {
        	...
        	else if(!bfFacStsCd.equals(afFacStsCd) || !bfCrntAmt.equals(afCrntAmt)){
		...
		try{
			...
			for(int i=0; i<bkgCalculationVOs.length; i++) {
				if (event.getBkgCalculationVO().getChkCommCmpn().equals("Y")) {
					begin();
					com.clt.apps.opus.esm.acm.acmrequest.agncommrequest.basic.AGNCommRequestBC requestCommand =
						new com.clt.apps.opus.esm.acm.acmrequest.agncommrequest.basic.AGNCommRequestBCImpl();
