...
*@FileName : BSAManageDBDAOModifyMultiBsaSltChtrPortDwnUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifyMultiBsaSltChtrPortDwnUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BSA_0026 화면의 Bsa_Slt_Chtr_Port_Dwn UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOModifyMultiBsaSltChtrPortDwnUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifyMultiBsaSltChtrPortDwnUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BSA_SLT_CHTR_PORT_DWN" ).append("\n"); 
