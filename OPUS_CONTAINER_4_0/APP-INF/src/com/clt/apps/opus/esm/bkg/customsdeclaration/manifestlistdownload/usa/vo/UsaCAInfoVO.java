...
*@FileName : UsaCAInfoVO.java
*@FileTitle : UsaCAInfoVO
*Open Issues :
*Change history :
...
public class UsaCAInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaCAInfoVO> models = new ArrayList<UsaCAInfoVO>();
	...
	public UsaCAInfoVO(String ibflag, String pagerows, String caNo, String caIssDt) {
	 ...
	 * @return UsaCAInfoVO[]
	 */
	public UsaCAInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaCAInfoVO[]
	 */
	public UsaCAInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaCAInfoVO model = null;
	 ...
	 * @return UsaCAInfoVO[]
	 */
	public UsaCAInfoVO[] getUsaCAInfoVOs(){
		UsaCAInfoVO[] vos = (UsaCAInfoVO[])models.toArray(new UsaCAInfoVO[models.size()]);
		return vos;
	}
