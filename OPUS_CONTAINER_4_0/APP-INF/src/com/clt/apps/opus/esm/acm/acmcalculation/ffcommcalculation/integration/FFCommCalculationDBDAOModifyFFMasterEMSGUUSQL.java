...
*@FileName : FFCommCalculationDBDAOModifyFFMasterEMSGUUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOModifyFFMasterEMSGUUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOModifyFFMasterEMSGUUSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAOModifyFFMasterEMSGUUSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOModifyFFMasterEMSGUUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("              AND B.FF_CMPN_SEQ = TO_NUMBER(@[ff_cmpn_seq]) " ).append("\n");
		...
		query.append("   AND A.FF_CMPN_SEQ = TO_NUMBER(@[ff_cmpn_seq])" ).append("\n");
