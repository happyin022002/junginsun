	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) 
	{
		...
		if( listVO.getEventCommand().equals("SEARCHLIST")){	//2.1
			...
			for(int i=0;i<rowCount;i++){
				...
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk1ComQty()    	+"]]></TD>");
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk1ComWgt()    	+"]]></TD>");
				...
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk2ComQty()   	+"]]></TD>");
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk2ComWgt()   	+"]]></TD>");
				...
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk3ComQty()   	+"]]></TD>");
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk3ComWgt()   	+"]]></TD>");
				...
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk4ComQty()   	+"]]></TD>");
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk4ComWgt()   	+"]]></TD>");
				...
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk5ComQty()   	+"]]></TD>");
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getWk5ComWgt()   	+"]]></TD>");
				...
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getGtlComQty()   +"]]></TD>");
				sbufXML.append("	<TD DATA-ALIGN=\"daRight\"><![CDATA["+ colValues.getGtlComWgt()   +"]]></TD>");
