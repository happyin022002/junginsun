...
*@FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search MonthlyQuotaInquiry139 List03
	  * </pre>
	  */
	public MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaInquiryDBDAOSearchMonthlyQuotaInquiry0139Tab03RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            SMR.CONV_DIR_CD LIKE INP.DIR_CD||'%'  											" ).append("\n"); 
		query.append("         )" ).append("\n"); 
		query.append("         JOIN" ).append("\n"); 
		...
		query.append("--      WHEN SLEVEL = 6 THEN 'TOTAL' 												" ).append("\n"); 
		query.append("--      ELSE '' 												" ).append("\n"); 
		...
		query.append("                     WHEN '111111' THEN 1												" ).append("\n"); 
		query.append("                     WHEN '011111' THEN 2												" ).append("\n"); 
		query.append("                     WHEN '001111' THEN 3												" ).append("\n"); 
		query.append("                     WHEN '000111' THEN 4												" ).append("\n"); 
		query.append("                     WHEN '000011' THEN 5												" ).append("\n"); 
		query.append("                     WHEN '000001' THEN 6												" ).append("\n"); 
		query.append("                     WHEN '000000' THEN 7												" ).append("\n"); 
		...
		query.append("                  CASE G_FLAG												" ).append("\n"); 
		query.append("                     WHEN '111111' THEN VOYAGE_LVL_1" ).append("\n"); 
		query.append("                     WHEN '011111' THEN VOYAGE_LVL_2" ).append("\n"); 
		query.append("                     WHEN '001111' THEN VOYAGE_LVL_3" ).append("\n"); 
		query.append("                     WHEN '000111' THEN VOYAGE_LVL_4" ).append("\n"); 
		query.append("                     WHEN '000011' THEN VOYAGE_LVL_4" ).append("\n"); 
		query.append("                     WHEN '000001' THEN VOYAGE_LVL_4" ).append("\n"); 
		query.append("                     WHEN '000000' THEN VOYAGE_LVL_4" ).append("\n"); 
		...
		query.append("                    FROM  (    												" ).append("\n"); 
		query.append("                            SELECT												" ).append("\n"); 
		query.append("                                 GROUPING(TGT_GRP_CD)||GROUPING(TRD_CD)||GROUPING(CONV_DIR_CD)||GROUPING(RHQ_CD)||GROUPING(AQ_CD)||GROUPING(OFC_CD) AS G_FLAG," ).append("\n"); 
		query.append("                                 MIN(SMR.TGT_GRP_CD||SMR.TRD_CD||SMR.CONV_DIR_CD||SMR.RHQ_CD) AS KEY," ).append("\n"); 
		...
		query.append("                            FROM  (    												" ).append("\n"); 
		query.append("                                    SELECT 												" ).append("\n"); 
		query.append("                                         MIN((SELECT DISTINCT SAQ_TGT_GRP_CD" ).append("\n"); 
		query.append("                                              FROM  TMP_INPUT_PARAMS			" ).append("\n"); 
		query.append("                                              WHERE TRD_CD = SMR.TRD_CD)) AS TGT_GRP_CD," ).append("\n"); 
		query.append("                                         SMR.TRD_CD, " ).append("\n"); 
		query.append("                                         SMR.DIR_CD, " ).append("\n"); 
		...
		query.append("         								)				" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                    GROUP BY SMR.TRD_CD, SMR.DIR_CD, SMR.CONV_DIR_CD, SMR.RHQ_CD, NVL(SMR.AQ_CD, '  '), SMR.RGN_OFC_CD, SMR.BSE_YR||SMR.BSE_MON												" ).append("\n"); 
		...
		query.append("                                                    (SMR.TGT_GRP_CD, SMR.TRD_CD, SMR.CONV_DIR_CD, SMR.RHQ_CD, SMR.YRMON), " ).append("\n"); 
		query.append("                                                    (SMR.TGT_GRP_CD, SMR.TRD_CD, SMR.CONV_DIR_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.YRMON)," ).append("\n"); 
		query.append("                                                    (SMR.TGT_GRP_CD, SMR.TRD_CD, SMR.CONV_DIR_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.OFC_CD, SMR.YRMON)" ).append("\n"); 
		query.append("                                                   )" ).append("\n"); 
		query.append("                          ) SMR" ).append("\n"); 
		query.append("                  ) SMR" ).append("\n"); 
		query.append("          ) SMR                        												" ).append("\n"); 
		...
		query.append("      GROUP BY SMR.SLEVEL, SMR.TGT_GRP_CD, SMR.TRD_CD, SMR.DIR_CD, SMR.RHQ_CD, SMR.AQ_CD, SMR.OFC_CD, ITM.ROW_SEQ, ITM.TEXT, ITM.CODE 		" ).append("\n"); 
		query.append("      ) SMR  												" ).append("\n"); 
