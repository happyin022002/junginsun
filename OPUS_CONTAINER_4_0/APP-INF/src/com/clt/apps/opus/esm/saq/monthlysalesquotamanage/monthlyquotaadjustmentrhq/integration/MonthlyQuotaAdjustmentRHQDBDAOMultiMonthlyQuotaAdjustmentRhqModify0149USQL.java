...
*@FileName : MonthlyQuotaAdjustmentRHQDBDAOMultiMonthlyQuotaAdjustmentRhqModify0149USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentRHQDBDAOMultiMonthlyQuotaAdjustmentRhqModify0149USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAQ_MON_QTA_RHQ의 지정된 ibflag 값에 따라 DB에 반영한다.(추가, 수정, 삭제)
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentRHQDBDAOMultiMonthlyQuotaAdjustmentRhqModify0149USQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentRHQDBDAOMultiMonthlyQuotaAdjustmentRhqModify0149USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SAQ_MON_QTA_RHQ SET" ).append("\n"); 
		...
		query.append("    CTRT_RGN_OFC_CD = @[ctrt_rgn_ofc_cd] AND" ).append("\n"); 
