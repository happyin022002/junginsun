...
*@FileName : KorManifestListDBDAOSearchMaxSeqVVDYardRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchMaxSeqVVDYardRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchMaxSeqVVDYardRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchMaxSeqVVDYardRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND NVL(PORT_TML_CD,' ') = DECODE(@[in_bound],'I',DECODE(LENGTH(@[pod_tml]),7,@[pod_tml],' '),DECODE(LENGTH(@[pol_tml]),7,@[pol_tml],' '))" ).append("\n"); 
		query.append("   " ).append("\n"); 
