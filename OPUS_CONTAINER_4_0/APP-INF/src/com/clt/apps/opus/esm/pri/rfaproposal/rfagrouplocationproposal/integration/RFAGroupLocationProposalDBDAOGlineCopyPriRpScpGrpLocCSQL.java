...
*@FileName : RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_RP_SCP_GRP_LOC Insert
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
