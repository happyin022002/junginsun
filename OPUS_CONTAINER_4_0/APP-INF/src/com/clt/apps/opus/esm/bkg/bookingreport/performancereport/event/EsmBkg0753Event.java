...
public class EsmBkg0753Event extends EventSupport {
	...
	public void setVesselVVDListVOS(VesselVVDListVO[] vesselVVDListVOs){
		if(vesselVVDListVOs != null){
			VesselVVDListVO[] tmpVOs = Arrays.copyOf(vesselVVDListVOs, vesselVVDListVOs.length);
			this.vesselVVDListVOs = tmpVOs;
		}
	}
	...
	public VesselVVDListVO[] getVesselVVDListVOS(){
		VesselVVDListVO[] rtnVOs = null;
		if(this.vesselVVDListVOs != null){
			rtnVOs= Arrays.copyOf(vesselVVDListVOs, vesselVVDListVOs.length);
		}
		return rtnVOs;
	}
