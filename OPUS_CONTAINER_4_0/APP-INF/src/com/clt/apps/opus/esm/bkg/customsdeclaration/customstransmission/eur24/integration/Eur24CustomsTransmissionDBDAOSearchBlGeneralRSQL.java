...
public class Eur24CustomsTransmissionDBDAOSearchBlGeneralRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append(",(SELECT CUST_TO_ORD_FLG FROM BKG_BOOKING WHERE BL_NO = Z.BL_NO) AS CUST_TO_ORD_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                    " ).append("\n"); 
		query.append("                    ELSE " ).append("\n"); 
		query.append("                         DECODE(CONV.ATTR_CTNT1, NULL, TO_CHAR(SKD2.INIT_ETA_DT,'yyyymmddhh24')||'0000'" ).append("\n"); 
		query.append("                                                     , TO_CHAR(SKD2.INIT_ETA_DT,'yyyymmdd')||CONV.ATTR_CTNT3)" ).append("\n"); 
		query.append("               END" ).append("\n"); 
		...
		query.append("                    " ).append("\n"); 
		query.append("                    ELSE " ).append("\n"); 
		query.append("                         TO_CHAR(SKD2.INIT_ETA_DT,'yyyymmddhh24miss') " ).append("\n"); 
		query.append("               END" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("   , (SELECT /*+ INDEX(K XAK4VSK_VSL_PORT_SKD) */ " ).append("\n"); 
		query.append("             DECODE(CONV.ATTR_CTNT1, NULL, TO_CHAR(INIT_ETA_DT,'yyyymmddhh24')||'0000'" ).append("\n"); 
		query.append("                                         , TO_CHAR(INIT_ETA_DT,'yyyymmdd')||CONV.ATTR_CTNT3)" ).append("\n"); 
		query.append("        FROM VSK_VSL_PORT_SKD K" ).append("\n"); 
		query.append("       WHERE K.VSL_CD = SKD2.VSL_CD" ).append("\n"); 
		query.append("         AND K.SKD_VOY_NO = SKD2.SKD_VOY_NO" ).append("\n"); 
		query.append("         AND K.SKD_DIR_CD = SKD2.SKD_DIR_CD" ).append("\n"); 
		...
		query.append("   , BKG.CUST_TO_ORD_FLG AS CUST_TO_ORD_FLG" ).append("\n"); 
		...
		query.append("   , DECODE((SELECT FRT_TERM_CD FROM BKG_RATE WHERE 1=1 AND BKG_NO = BKG.BKG_NO), 'P', 'H', 'Z') AS PAYMENT_CD /* 71 */" ).append("\n"); 
