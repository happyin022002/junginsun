...
*@FileName : MonthlyQuotaCfmAdjustmentDBDAODeleteSaqMonCfmQta0167DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCfmAdjustmentDBDAODeleteSaqMonCfmQta0167DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaCfmAdjustmentDBDAODeleteSaqMonCfmQta0167DSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaCfmAdjustmentDBDAODeleteSaqMonCfmQta0167DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SAQ_MON_CFM_QTA" ).append("\n"); 
		...
		query.append("    AND POL_CD           = '00000'" ).append("\n"); 
		query.append("    AND POD_CD           = '00000'" ).append("\n"); 
