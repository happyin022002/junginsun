...
*@FileName : BSAManageDBDAORemoveOpSlotCostList1DDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveOpSlotCostList1DDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * bsa_op_slt_prc_crr 삭제
	  * </pre>
	  */
	public BSAManageDBDAORemoveOpSlotCostList1DDSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveOpSlotCostList1DDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_OP_SLT_PRC_CRR" ).append("\n"); 
