...
public class BookingHistoryMgtDBDAOSearchHistBkgQtyDtlRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                  decode(OLD.EQ_SUBST_CNTR_TPSZ_CD, NOW.EQ_SUBST_CNTR_TPSZ_CD, '', '/SUB:'||OLD.EQ_SUBST_CNTR_TPSZ_CD)" ).append("\n"); 
		query.append("                  ||'/SOC:'||OLD.SOC_FLG PRE_CTNT" ).append("\n"); 
		...
		query.append("                  decode(OLD.EQ_SUBST_CNTR_TPSZ_CD, NOW.EQ_SUBST_CNTR_TPSZ_CD, '', '/SUB:'||NOW.EQ_SUBST_CNTR_TPSZ_CD)" ).append("\n"); 
		query.append("                  ||'/SOC:'||NOW.SOC_FLG CRNT_CTNT" ).append("\n"); 
