...
public class EsmAcm0004Event extends EventSupport {
	...
	public FinanceOfficeInfoVO[] getFinanceOfficeInfoVOs() {
		FinanceOfficeInfoVO[] rtnVOs = null;
		if (this.financeOfficeInfoVOs != null) {
			rtnVOs = Arrays.copyOf(financeOfficeInfoVOs, financeOfficeInfoVOs.length);
		}
		return rtnVOs;
	}

	public void setFinanceOfficeInfoVOs(FinanceOfficeInfoVO[] financeOfficeInfoVOs) {
		if(financeOfficeInfoVOs != null){
			FinanceOfficeInfoVO[] tmpVOs = Arrays.copyOf(financeOfficeInfoVOs, financeOfficeInfoVOs.length);
			this.financeOfficeInfoVOs  = tmpVOs;
		}
	}
