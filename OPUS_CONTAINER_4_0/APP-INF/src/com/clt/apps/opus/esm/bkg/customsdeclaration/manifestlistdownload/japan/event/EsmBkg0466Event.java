...
public class EsmBkg0466Event extends EventSupport {
	...
	public void setJapDorEdiTransVOs(JapDorEdiTransVO[] japDorEdiTransVOs) {
		if (japDorEdiTransVOs != null) {
			JapDorEdiTransVO[] tmpVOs = Arrays.copyOf(japDorEdiTransVOs, japDorEdiTransVOs.length);
			this.japDorEdiTransVOs = tmpVOs;
		}
	}

	public JapDorEdiTransVO[] getJapDorEdiTransVOs() {
		JapDorEdiTransVO[] rtnVOs = null;
		if (this.japDorEdiTransVOs != null) {
			rtnVOs = Arrays.copyOf(japDorEdiTransVOs, japDorEdiTransVOs.length);
		}
		return rtnVOs;
	}
}
