...
*@FileName : ESM_BKG_0458HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0458HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0458HTMLAction 객체를 생성
	 */
	public ESM_BKG_0458HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0458Event event = new EsmBkg0458Event();
    	ManifestListCondVO manifestListCondVO = new ManifestListCondVO();
    	JapanMfrMndContainerVO japanMfrMndContainerVO = new JapanMfrMndContainerVO();
    	JapanMfrMndCondVO japanMfrMndCondVO = null;
    	JapanMfrMndModificationVO[] japanMfrMndModificationVOs = null;
    	if(command.isCommand(FormCommand.SEARCH)) {
			...
			japanMfrMndCondVO = (JapanMfrMndCondVO)getVO(request, JapanMfrMndCondVO.class);
			japanMfrMndModificationVOs = (JapanMfrMndModificationVO[])getVOs(request, JapanMfrMndModificationVO.class);
			japanMfrMndContainerVO.setJapanMfrMndCondVO(japanMfrMndCondVO);
			japanMfrMndContainerVO.setJapanMfrMndModificationVOs(japanMfrMndModificationVOs);
			event.setMfrMndModificationVO((MfrMndModificationVO)japanMfrMndContainerVO);
