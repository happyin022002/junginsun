...
*@FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI SP SCP GRP LOC DTL 생성   
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocDtlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[acpt_usr_id]," ).append("\n"); 
		query.append("@[acpt_ofc_cd]," ).append("\n"); 
		query.append("TO_DATE(@[acpt_dt], 'YYYYMMDD')," ).append("\n"); 
		query.append("@[cre_usr_id]," ).append("\n"); 
