...
*@FileName : BLIssuanceDBDAORemoveSurrenderInfoHistoryDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAORemoveSurrenderInfoHistoryDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveSurrenderInfoHistory
	  * </pre>
	  */
	public BLIssuanceDBDAORemoveSurrenderInfoHistoryDSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAORemoveSurrenderInfoHistoryDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
