 ...
 *@FileName : ESM_PRI_0006HTMLAction.java
...
public class ESM_PRI_0006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_0006HTMLAction 객체를 생성
	 */
	public ESM_PRI_0006HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0006Event event = new EsmPri0006Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setPriSgMnVO((PriSgMnVO) getVO(request, PriSgMnVO.class));
		} else if (command.isCommand(FormCommand.MULTI01)) {
			event.setGlineMnCpVO((GlineMnCpVO) getVO(request, GlineMnCpVO.class));
		}
