...
public class JapanTerminalTransmissionDBDAOsearchRfCgoforNewBkgInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       RC.CBM_PER_HR_QTY," ).append("\n"); 
		...
		query.append("           AND COM.INTG_CD_VAL_CTNT=RC.VENT_RTO) AS SNACCS_TML_EDI_VENT_RTO_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("   AND RC.BKG_NO = BV.BKG_NO" ).append("\n"); 
