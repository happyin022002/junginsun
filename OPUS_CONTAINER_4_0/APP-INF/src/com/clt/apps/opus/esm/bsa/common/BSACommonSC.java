...
import com.clt.apps.opus.esm.bsa.common.event.CommonEvent;
...
/**
 * 1. 기능 : BSA Business Logic ServiceCommand<br> 
 * 2. 처리 개요 :<p>
 *  - BSA에 대한 비지니스 트랜잭션을 처리한다.<br>
 * 3. 주의사항 :<p>
 * ===================================<br>
