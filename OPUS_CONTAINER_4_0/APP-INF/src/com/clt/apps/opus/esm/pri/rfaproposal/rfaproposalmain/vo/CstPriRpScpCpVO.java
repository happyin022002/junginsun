...
*@FileName : CstPriRpScpCpVO.java
*@FileTitle : CstPriRpScpCpVO
*Open Issues :
*Change history :
...
public class CstPriRpScpCpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriRpScpCpVO> models = new ArrayList<CstPriRpScpCpVO>();
	...
	/* Column Info */
	private String blpl = null;
	/* Page Number */
	private String pagerows = null;
	/* Column Info */
	private String afil = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("blpl", getBlpl());
		this.hashColumns.put("pagerows", getPagerows());
		this.hashColumns.put("afil", getAfil());
		...
		this.hashColumns.put("nw_prop_no", getNwPropNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("blpl", "blpl");
		this.hashFields.put("pagerows", "pagerows");
		this.hashFields.put("afil", "afil");
		...
		this.hashFields.put("nw_prop_no", "nwPropNo");
	 ...
	 * @return nwPropNo
	 */
	public String getNwPropNo() {
		return this.nwPropNo;
	}
	 ...
	 * @param blpl
	 */
	public void setBlpl(String blpl) {
		this.blpl = blpl;
	}
	 ...
	 * @param nwPropNo
	 */
	public void setNwPropNo(String nwPropNo) {
		this.nwPropNo = nwPropNo;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBlpl(JSPUtil.getParameter(request, "blpl", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setAfil(JSPUtil.getParameter(request, "afil", ""));
		...
		setNwPropNo(JSPUtil.getParameter(request, "nw_prop_no", ""));
	 ...
	 * @param request
	 * @return CstPriRpScpCpVO[]
	 */
	public CstPriRpScpCpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriRpScpCpVO[]
	 */
	public CstPriRpScpCpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriRpScpCpVO model = null;
		...
		try {
			...
			String[] blpl = (JSPUtil.getParameter(request, prefix	+ "blpl".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			String[] afil = (JSPUtil.getParameter(request, prefix	+ "afil".trim(), length));
			...
			String[] nwPropNo = (JSPUtil.getParameter(request, prefix	+ "nw_prop_no".trim(), length));
			String[] oriArb = (JSPUtil.getParameter(request, prefix	+ "ori_arb".trim(), length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new CstPriRpScpCpVO();
				if (ihc[i] != null)
					model.setIhc(ihc[i]);
				if (scp[i] != null)
					model.setScp(scp[i]);
				...
				if (org[i] != null)
					model.setOrg(org[i]);
				if (blpl[i] != null)
					model.setBlpl(blpl[i]);
				if (pagerows[i] != null)
					model.setPagerows(pagerows[i]);
				if (afil[i] != null)
					model.setAfil(afil[i]);
				if (grpLoc[i] != null)
	 ...
	 * @return CstPriRpScpCpVO[]
	 */
	public CstPriRpScpCpVO[] getCstPriRpScpCpVOs(){
		CstPriRpScpCpVO[] vos = (CstPriRpScpCpVO[])models.toArray(new CstPriRpScpCpVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.blpl = this.blpl .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.pagerows = this.pagerows .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.afil = this.afil .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.nwPropNo = this.nwPropNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
