...
*@FileName : SPCLCmpnApprovalPrintDetailVO.java
*@FileTitle : SPCLCmpnApprovalPrintDetailVO
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalPrintDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<SPCLCmpnApprovalPrintDetailVO> models = new ArrayList<SPCLCmpnApprovalPrintDetailVO>();
	...
	public SPCLCmpnApprovalPrintDetailVO() {}

	public SPCLCmpnApprovalPrintDetailVO(String ibflag, String pagerows, String csrNo, String dtlSeq, String dtlChtAcct, String dtlAcctNm, String dtlGlDt, String dtlCity, String dtlInvNo, String dtlDesc, String dtlDebit, String dtlCredit) {
...
/**
	 ...
	 */
	public SPCLCmpnApprovalPrintDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SPCLCmpnApprovalPrintDetailVO[]
	 */
	public SPCLCmpnApprovalPrintDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SPCLCmpnApprovalPrintDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SPCLCmpnApprovalPrintDetailVO();
		...
		return getSPCLCmpnApprovalPrintDetailVOs();
	}
	...
	public SPCLCmpnApprovalPrintDetailVO[] getSPCLCmpnApprovalPrintDetailVOs(){
		SPCLCmpnApprovalPrintDetailVO[] vos = (SPCLCmpnApprovalPrintDetailVO[])models.toArray(new SPCLCmpnApprovalPrintDetailVO[models.size()]);
		return vos;
	}
