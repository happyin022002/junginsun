...
*@FileName : TRIProposalDBDAOPriTriRtVOCofferUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtVOCofferUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtVOCofferUSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtVOCofferUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	COFFR_FRT_RT_AMT = DECODE(@[prop_sts_cd], 'R', COFFR_FRT_RT_AMT, 'Q', NULL)" ).append("\n"); 
