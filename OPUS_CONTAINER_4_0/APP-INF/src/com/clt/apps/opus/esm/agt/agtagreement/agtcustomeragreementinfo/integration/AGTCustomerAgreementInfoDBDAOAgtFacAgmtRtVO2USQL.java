...
*@FileName : AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtVO2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtVO2USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_fac_agmt_rt 테이블의 comm_proc_rslt_rsn(Remarks)만 수정한다.
	  * </pre>
	  */
	public AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtVO2USQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtVO2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET    COMM_PROC_RSLT_RSN = @[comm_proc_rslt_rsn]," ).append("\n"); 
