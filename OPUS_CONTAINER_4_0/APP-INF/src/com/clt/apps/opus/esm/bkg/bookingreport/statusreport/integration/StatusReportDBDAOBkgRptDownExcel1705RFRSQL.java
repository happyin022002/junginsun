...
*@FileName : StatusReportDBDAOBkgRptDownExcel1705RFRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOBkgRptDownExcel1705RFRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BkgRptDownExcel1705RF
	  * </pre>
	  */
	public StatusReportDBDAOBkgRptDownExcel1705RFRSQL(){
		setQuery();
		...
		query.append("FileName : StatusReportDBDAOBkgRptDownExcel1705RFRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,'RF Info' AS	APRO_REF_NO" ).append("\n"); 
		query.append("        ,'RF Info' AS	APRO_STS" ).append("\n"); 
		query.append("        ,'RF Info' AS	RC_RE_SEQ" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_CMDT_CD" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_CMDT_DESC" ).append("\n"); 
		query.append("        ,'RF Info' AS	CDO_TEMP" ).append("\n"); 
		query.append("        ,'RF Info' AS	FDO_TEMP" ).append("\n"); 
		query.append("        ,'RF Info' AS	VENT_RTO" ).append("\n"); 
		query.append("        ,'RF Info' AS	CNTR_VENT_TP_CD" ).append("\n"); 
		query.append("        ,'RF Info' AS	NATURE" ).append("\n"); 
		query.append("        ,'RF Info' AS	HUMID_NO" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_PCK_QTY" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_PCK_CD" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_PCK_DESC" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_GRS_WGT" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_GRS_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_NET_WGT" ).append("\n"); 
		query.append("        ,'RF Info' AS	RF_NET_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'RF Info' AS	CTRL_ATMS_FLG" ).append("\n"); 
		query.append("        ,'RF Info' AS	MODI_ATMS_FLG" ).append("\n"); 
		query.append("        ,'RF Info' AS	HUMID_CTRL_FLG" ).append("\n"); 
		query.append("        ,'RF Info' AS	CNTR_DRN_CD" ).append("\n"); 
		query.append("        ,'RF Info' AS	PWR_SPL_CBL_FLG" ).append("\n"); 
		query.append("        ,'RF Info' AS	DIFF_RMK" ).append("\n"); 
		query.append("        ,'' AS RC_SEQ--for ORDER BY" ).append("\n"); 
		...
		query.append("        ,'Approval Reference No.' AS	APRO_REF_NO" ).append("\n"); 
		query.append("        ,'Approval Status' AS	APRO_STS" ).append("\n"); 
		query.append("        ,'Cargo Detail for Container Sequence' AS	RC_RE_SEQ" ).append("\n"); 
		query.append("        ,'Commodity Code' AS	RF_CMDT_CD" ).append("\n"); 
		query.append("        ,'Commodity Name' AS	RF_CMDT_DESC" ).append("\n"); 
		query.append("        ,'Reefer Temperature (C)' AS	CDO_TEMP" ).append("\n"); 
		query.append("        ,'Reefer Temperature (F)' AS	FDO_TEMP" ).append("\n"); 
		query.append("        ,'Ventilation' AS	VENT_RTO" ).append("\n"); 
		query.append("        ,'Ventilation Unit' AS	CNTR_VENT_TP_CD" ).append("\n"); 
		query.append("        ,'Nature' AS	NATURE" ).append("\n"); 
		query.append("        ,'Humidity (%)' AS	HUMID_NO" ).append("\n"); 
		query.append("        ,'Package Quantity' AS	RF_PCK_QTY" ).append("\n"); 
		query.append("        ,'Package Code' AS	RF_PCK_CD" ).append("\n"); 
		query.append("        ,'Package Description' AS	RF_PCK_DESC" ).append("\n"); 
		query.append("        ,'Gross Weight' AS	RF_GRS_WGT" ).append("\n"); 
		query.append("        ,'Gross Weight Unit' AS	RF_GRS_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'Net Weight' AS	RF_NET_WGT" ).append("\n"); 
		query.append("        ,'Net Weight Unit' AS	RF_NET_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'CA (Control Atmosphere)' AS	CTRL_ATMS_FLG" ).append("\n"); 
		query.append("        ,'MA (Modified CA)' AS	MODI_ATMS_FLG" ).append("\n"); 
		query.append("        ,'Humidity Control (HM)' AS	HUMID_CTRL_FLG" ).append("\n"); 
		query.append("        ,'Drainage Holes Open/Closed (RF)' AS	CNTR_DRN_CD" ).append("\n"); 
		query.append("        ,'Genset (RF)' AS	PWR_SPL_CBL_FLG" ).append("\n"); 
		query.append("        ,'Remarks' AS	DIFF_RMK" ).append("\n"); 
		query.append("        ,'' AS RC_SEQ--for ORDER BY" ).append("\n"); 
		query.append("    FROM DUAL" ).append("\n"); 
		query.append("    UNION ALL" ).append("\n"); 
		query.append("    " ).append("\n"); 
		...
		query.append("    -- RF Info" ).append("\n"); 
		query.append("    -----------------------------------------------------------" ).append("\n"); 
		query.append("         , (SELECT APRO_REF_NO " ).append("\n"); 
		query.append("              FROM SCG_APRO_RQST RQST, SCG_AUTHORIZATION AUTH " ).append("\n"); 
		query.append("             WHERE RF.BKG_NO      = RQST.BKG_NO" ).append("\n"); 
		query.append("               AND RF.BKG_NO      = AUTH.BKG_NO(+)" ).append("\n"); 
		query.append("               AND RF.RC_SEQ = AUTH.RC_SEQ(+)" ).append("\n"); 
		...
		query.append("               AND RQST.SPCL_CGO_CATE_CD = 'RF'" ).append("\n"); 
		...
		query.append("               AND INTG_CD_VAL_CTNT = RF.SPCL_CGO_APRO_CD) APRO_STS" ).append("\n"); 
		query.append("         , TO_CHAR(ROW_NUMBER() OVER (PARTITION BY RF.BKG_NO ORDER BY RC_SEQ)) RC_RE_SEQ" ).append("\n"); 
		query.append("         , DECODE(SUBSTR(RF.CMDT_CD,1,1),0,'''','')||RF.CMDT_CD AS RF_CMDT_CD" ).append("\n"); 
		query.append("         , (SELECT CMDT_NM FROM MDM_COMMODITY CMDT WHERE CMDT.CMDT_CD = RF.CMDT_CD) RF_CMDT_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(RF.CDO_TEMP) CDO_TEMP" ).append("\n"); 
		query.append("         , TO_CHAR(RF.FDO_TEMP) FDO_TEMP" ).append("\n"); 
		query.append("         , DECODE(CNTR_VENT_TP_CD,'P',TO_CHAR(RF.VENT_RTO),TO_CHAR(CBM_PER_HR_QTY)) VENT_RTO" ).append("\n"); 
		query.append("         , DECODE(CNTR_VENT_TP_CD,'P','% Open','C','CMH') CNTR_VENT_TP_CD" ).append("\n"); 
		query.append("         , (SELECT INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD02095' AND INTG_CD_VAL_CTNT = RF.CLNG_TP_CD) NATURE" ).append("\n"); 
		query.append("         , TO_CHAR(RF.HUMID_NO) HUMID_NO" ).append("\n"); 
		query.append("         , TO_CHAR(RF.PCK_QTY) RF_PCK_QTY" ).append("\n"); 
		query.append("         , RF.PCK_TP_CD RF_PCK_CD" ).append("\n"); 
		query.append("         , (SELECT PCK_NM FROM MDM_PCK_TP PCK WHERE RF.PCK_TP_CD = PCK.PCK_CD) RF_PCK_DESC" ).append("\n"); 
		query.append("         , TO_CHAR(RF.GRS_WGT,'999,999,999,990.99') RF_GRS_WGT" ).append("\n"); 
		query.append("         , RF.WGT_UT_CD RF_GRS_WGT_UT_CD" ).append("\n"); 
		query.append("         , TO_CHAR(RF.NET_WGT,'999,999,999,990.99') RF_NET_WGT" ).append("\n"); 
		query.append("         , RF.WGT_UT_CD RF_NET_WGT_UT_CD" ).append("\n"); 
		query.append("         , RF.CTRL_ATMS_FLG" ).append("\n"); 
		query.append("         , RF.MODI_ATMS_FLG" ).append("\n"); 
		query.append("         , RF.HUMID_CTRL_FLG" ).append("\n"); 
		query.append("         , (SELECT INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD01588' AND INTG_CD_VAL_CTNT = RF.CNTR_DRN_CD) CNTR_DRN_CD" ).append("\n"); 
		query.append("         , RF.PWR_SPL_CBL_FLG" ).append("\n"); 
		query.append("         , REPLACE(REPLACE(REPLACE(RF.DIFF_RMK,CHR(10),' '),CHR(9),' '),CHR(34),'') DIFF_RMK" ).append("\n"); 
		query.append("         , TO_CHAR(RF.RC_SEQ) AS RC_SEQ--for ORDER BY" ).append("\n"); 
		...
		query.append("ORDER BY TEMP, BKG_NO, TO_NUMBER(RC_SEQ)" ).append("\n"); 
		query.append("#else" ).append("\n"); 
