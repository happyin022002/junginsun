...
*@FileName : KorDoEdiEventVO.java
*@FileTitle : KorDoEdiEventVO
*Open Issues :
*Change history :
...
public class KorDoEdiEventVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorDoEdiEventVO> models = new ArrayList<KorDoEdiEventVO>();
	...
	public KorDoEdiEventVO() {}

	public KorDoEdiEventVO(String ibflag, String pagerows, String bkgNo, String doType, String selfTrnsFlg) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return KorDoEdiEventVO[]
	 */
	public KorDoEdiEventVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDoEdiEventVO[]
	 */
	public KorDoEdiEventVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDoEdiEventVO model = null;
	 ...
	 * @return KorDoEdiEventVO[]
	 */
	public KorDoEdiEventVO[] getKorDoEdiEventVOs(){
		KorDoEdiEventVO[] vos = (KorDoEdiEventVO[])models.toArray(new KorDoEdiEventVO[models.size()]);
		return vos;
	}
