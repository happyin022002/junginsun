...
*@FileName : MonthlyQuotaCreationDBDAOUpdateGuidelineUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaCreationDBDAOUpdateGuidelineUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaCreationDBDAOUpdateGuidelineUSQL(){
		setQuery();
		...
		params.put("gline_cm_amt",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.saq.monthlysalesquotamanage.monthlyquotacreation.integration").append("\n"); 
		query.append("FileName : MonthlyQuotaCreationDBDAOUpdateGuidelineUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO SAQ_MON_INIT_GLINE " ).append("\n"); 
		...
		query.append("         , GLINE_CM_AMT = @[gline_cm_amt] * 1000 " ).append("\n"); 
