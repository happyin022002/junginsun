...
*@FileName : SpecialManifestDBDAOsearchDeclBaseInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOsearchDeclBaseInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOsearchDeclBaseInfoRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOsearchDeclBaseInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append(",NVL(@[anr_role_div_cd], 'DA') DECL_TYPE" ).append("\n");
		query.append(",A.EUR_DG_DECL_TP_CD HANDLING" ).append("\n");
		query.append(",(" ).append("\n");
		...
		query.append("BKG_CSTMS_EUR_DG A" ).append("\n");
		query.append("" ).append("\n");
