...
*@FileName : TRIProposalDBDAORsltTriRoutDestViaVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAORsltTriRoutDestViaVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRI Destination Via. 조회
	  * </pre>
	  */
	public TRIProposalDBDAORsltTriRoutDestViaVORSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAORsltTriRoutDestViaVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
