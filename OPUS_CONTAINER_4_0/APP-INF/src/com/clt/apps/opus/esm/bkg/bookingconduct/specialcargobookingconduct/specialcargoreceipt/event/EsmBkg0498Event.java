...
public class EsmBkg0498Event extends EventSupport {
	...
	public RfCgoApplVO[] getRfCgoApplVOs() {
		RfCgoApplVO[] rtnVOs = null;
		if (this.rfCgoApplVOs != null) {
			rtnVOs = Arrays.copyOf(rfCgoApplVOs, rfCgoApplVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setRfCgoApplVOs(RfCgoApplVO[] rfCgoApplVOs) {
		if(rfCgoApplVOs != null){
			RfCgoApplVO[] tmpVOs = Arrays.copyOf(rfCgoApplVOs, rfCgoApplVOs.length);
			this.rfCgoApplVOs = tmpVOs;
		}
	}
	...
	public RfBkgInfoVO[] getRfBkgInfoVOs() {
		RfBkgInfoVO[] rtnVOs = null;
		if (this.rfBkgInfoVOs != null) {
			rtnVOs = Arrays.copyOf(rfBkgInfoVOs, rfBkgInfoVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setRfBkgInfoVOs(RfBkgInfoVO[] rfBkgInfoVOs) {
		if(rfBkgInfoVOs != null){
			RfBkgInfoVO[] tmpVOs = Arrays.copyOf(rfBkgInfoVOs, rfBkgInfoVOs.length);
			this.rfBkgInfoVOs = tmpVOs;
		}
	}
	...
	public RfAproInfoVO[] getRfAproInfoVOs() {
		RfAproInfoVO[] rtnVOs = null;
		if (this.rfAproInfoVOs != null) {
			rtnVOs = Arrays.copyOf(rfAproInfoVOs, rfAproInfoVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setRfAproInfoVOs(RfAproInfoVO[] rfAproInfoVOs) {
		if(rfAproInfoVOs != null){
			RfAproInfoVO[] tmpVOs = Arrays.copyOf(rfAproInfoVOs, rfAproInfoVOs.length);
			this.rfAproInfoVOs = tmpVOs;
		}
	}
