...
*@FileName : TRIProposalDBDAOPriTriRtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT" ).append("\n"); 
