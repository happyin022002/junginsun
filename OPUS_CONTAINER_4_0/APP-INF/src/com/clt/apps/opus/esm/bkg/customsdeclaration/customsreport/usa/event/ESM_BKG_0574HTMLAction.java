...
*@FileName : ESM_BKG_0574HTMLAction.java
*@FileTitle : Auto NVOCC Filing Status
*Open Issues :
*Change history :
...
public class ESM_BKG_0574HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0926HTMLAction 객체를 생성
     */
    public ESM_BKG_0574HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0574Event event = new EsmBkg0574Event();

		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01))
		{
			// Auth Setup 정보 조회
			event.setCondVO((ScacReportCondVO)getVO(request, ScacReportCondVO.class));
		}
