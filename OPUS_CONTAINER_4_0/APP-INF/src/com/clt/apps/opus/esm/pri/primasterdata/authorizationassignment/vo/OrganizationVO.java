...
public class OrganizationVO extends AbstractValueObject {
	...
	public OrganizationVO(String ibflag, String pagerows, String lvl, String prntOfcCd, String ofcCd, String ofcEngNm,String byPath, String typeFlg, String haveChild) {
		this.ofcCd = ofcCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("by_path", getByPath());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("by_path", "byPath");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setByPath(JSPUtil.getParameter(request, "by_path", ""));
	...
	public OrganizationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] byPath = (JSPUtil.getParameter(request, prefix	+ "by_path".trim(), length));
	...
	*/
	public void unDataFormat(){
		...
		this.byPath = this.byPath .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
