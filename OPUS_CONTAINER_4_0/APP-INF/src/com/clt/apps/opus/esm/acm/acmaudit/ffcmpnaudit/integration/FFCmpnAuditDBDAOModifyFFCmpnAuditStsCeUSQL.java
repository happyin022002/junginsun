...
*@FileName : FFCmpnAuditDBDAOModifyFFCmpnAuditStsCeUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCmpnAuditDBDAOModifyFFCmpnAuditStsCeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyFFCmpnAuditStsCe
	  * </pre>
	  */
	public FFCmpnAuditDBDAOModifyFFCmpnAuditStsCeUSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnAuditDBDAOModifyFFCmpnAuditStsCeUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("	       FF_CMPN_STS_CD  = @[ff_cmpn_sts_cd],		" ).append("\n");
