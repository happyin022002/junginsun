...
*@FileName : CargoReleaseOrderDBDAOSearchRelredInfoYardCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOSearchRelredInfoYardCdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * COREOR와 같이 나가는 RELRED 의 EDI set up 정보를 가져옴
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOSearchRelredInfoYardCdRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOSearchRelredInfoYardCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE A.EDI_MSG_IND_CD IN ('1', '2', '21')  -- Full Cargo Indicator (0 : Null, 1 : FO, 2 : FOC)" ).append("\n"); 
		query.append(" AND A.MSG_TP_DESC='1'" ).append("\n"); 
		query.append(" AND A.EDI_MSG_TP_ID='RELRED'  -- EDI Message Type. ex) 301, COPARN, COPRAR" ).append("\n"); 
