...
public class UsaCustomsReportDBDAOsearchBaplieMonitorRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("AND NVL(A.PLAN_TYPE, 'XX')=  NVL ( ( SELECT  /*+ INDEX(BB XPKBAY_PLAN) */" ).append("\n"); 
		query.append("				PLAN_TYPE  FROM BAY_PLAN BB" ).append("\n"); 
		...
		query.append("      AND VC.CRR_CD = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()" ).append("\n"); 
