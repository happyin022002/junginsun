...
*@FileName : BSAManageDBDAOCreateSpcJoPortDownDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOCreateSpcJoPortDownDetailCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateSpcJoPortDownDetail INSERT
	  * </pre>
	  */
	public BSAManageDBDAOCreateSpcJoPortDownDetailCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOCreateSpcJoPortDownDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        --DECODE(B.BSA_OP_JB_CD,'007',DECODE(B.CRR_CD,COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,B.CRR_BSA_CAPA,0), '009', B.CRR_BSA_CAPA, 0), " ).append("\n"); 
		query.append("        DECODE(B.BSA_OP_JB_CD,'007',B.CRR_BSA_CAPA,'009',B.CRR_BSA_CAPA, 0), 		--20150825.MOD" ).append("\n"); 
		query.append("        @[cre_usr_id], " ).append("\n"); 
		...
		query.append("        (" ).append("\n"); 
		query.append("         /* trade, RLane, Bound 에서 사용하는 Port들을 조회한다. */" ).append("\n"); 
		...
		query.append("            AND Z.VSL_LANE_TP_CD                            = 'JO'" ).append("\n"); 
		...
		query.append("    AND B.BSA_OP_JB_CD = DECODE(@[bsa_op_jb_cd], '016', '009', @[bsa_op_jb_cd])" ).append("\n"); 
