...
*@FileName : SearchKorEdiHistoryVO.java
*@FileTitle : SearchKorEdiHistoryVO
*Open Issues :
*Change history :
...
public class SearchKorEdiHistoryVO extends AbstractValueObject {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3712627009789069615L;

	private Collection<SearchKorEdiHistoryVO> models = new ArrayList<SearchKorEdiHistoryVO>();
	 ...
	 * @param request
	 * @return SearchKorEdiHistoryVO[]
	 */
	public SearchKorEdiHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchKorEdiHistoryVO[]
	 */
	public SearchKorEdiHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchKorEdiHistoryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchKorEdiHistoryVO();
		...
		return getSearchKorEdiHistoryVOs();
	}
	 ...
	 * @return SearchKorEdiHistoryVO[]
	 */
	public SearchKorEdiHistoryVO[] getSearchKorEdiHistoryVOs(){
		SearchKorEdiHistoryVO[] vos = (SearchKorEdiHistoryVO[])models.toArray(new SearchKorEdiHistoryVO[models.size()]);
		return vos;
	}
