...
*@FileName : BSAManageDBDAOBsaJntOpBzcSeqnoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOBsaJntOpBzcSeqnoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BsaJntOpBzcSeqno SELECT
	  * </pre>
	  */
	public BSAManageDBDAOBsaJntOpBzcSeqnoRSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOBsaJntOpBzcSeqnoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
