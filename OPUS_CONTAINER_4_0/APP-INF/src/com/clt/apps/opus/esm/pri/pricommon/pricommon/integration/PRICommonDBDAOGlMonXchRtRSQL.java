...
*@FileName : PRICommonDBDAOGlMonXchRtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAOGlMonXchRtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * gl_mon_xch_rt US 환율로 환산
	  * </pre>
	  */
	public PRICommonDBDAOGlMonXchRtRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : PRICommonDBDAOGlMonXchRtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}