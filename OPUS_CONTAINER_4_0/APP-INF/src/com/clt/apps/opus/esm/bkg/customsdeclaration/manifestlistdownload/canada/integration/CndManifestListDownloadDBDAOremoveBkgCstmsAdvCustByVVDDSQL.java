...
*@FileName : CndManifestListDownloadDBDAOremoveBkgCstmsAdvCustByVVDDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndManifestListDownloadDBDAOremoveBkgCstmsAdvCustByVVDDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndManifestListDownloadDBDAOremoveBkgCstmsAdvCustByVVDDSQL(){
		setQuery();
		...
		query.append("FileName : CndManifestListDownloadDBDAOremoveBkgCstmsAdvCustByVVDDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
