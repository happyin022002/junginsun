...
*@FileName : NewZealandManifestListVslInfoVO.java
*@FileTitle : NewZealandManifestListVslInfoVO
*Open Issues :
*Change history :
...
public class NewZealandManifestListVslInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<NewZealandManifestListVslInfoVO> models = new ArrayList<NewZealandManifestListVslInfoVO>();
	...
	public NewZealandManifestListVslInfoVO() {}

	public NewZealandManifestListVslInfoVO(String ibflag, String pagerows, String vslLloydNo, String vslCallsign, String vslNationCd, String issueDate, String vslName) {
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public NewZealandManifestListVslInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NewZealandManifestListVslInfoVO[]
	 */
	public NewZealandManifestListVslInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandManifestListVslInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandManifestListVslInfoVO();
				if (ibflag[i] != null)
		...
		return getNewZealandManifestListVslInfoVOs();
	}
	 ...
	 * @return NewZealandManifestListVslInfoVO[]
	 */
	public NewZealandManifestListVslInfoVO[] getNewZealandManifestListVslInfoVOs(){
		NewZealandManifestListVslInfoVO[] vos = (NewZealandManifestListVslInfoVO[])models.toArray(new NewZealandManifestListVslInfoVO[models.size()]);
		return vos;
	}
