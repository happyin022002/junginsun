...
*@FileName : SubGrpCostCodeVO.java
*@FileTitle : SubGrpCostCodeVO
*Open Issues :
*Change history :
...
public class SubGrpCostCodeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SubGrpCostCodeVO> models = new ArrayList<SubGrpCostCodeVO>();
	...
	public SubGrpCostCodeVO() {}

	public SubGrpCostCodeVO(String ibflag, String pagerows, String mgrpCostCd, String sgrpCostCd, String sgrpCostCdDesc, String creUsrId, String creDt, String updUsrId, String updDt, String stndCostTpCd, String mgrpCostCdDesc) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public SubGrpCostCodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SubGrpCostCodeVO[]
	 */
	public SubGrpCostCodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SubGrpCostCodeVO model = null;
	...
	public SubGrpCostCodeVO[] getSubGrpCostCodeVOs(){
		SubGrpCostCodeVO[] vos = (SubGrpCostCodeVO[])models.toArray(new SubGrpCostCodeVO[models.size()]);
		return vos;
	}
