...
*@FileName : StatusReportDBDAOBkgRptDownExcel1705BBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOBkgRptDownExcel1705BBRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BkgRptDownExcel1705BB
	  * </pre>
	  */
	public StatusReportDBDAOBkgRptDownExcel1705BBRSQL(){
		setQuery();
		...
		query.append("FileName : StatusReportDBDAOBkgRptDownExcel1705BBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,'BB Info' AS	APRO_REF_NO" ).append("\n"); 
		query.append("        ,'BB Info' AS	APRO_STS" ).append("\n"); 
		query.append("        ,'BB Info' AS	DIM_LEN" ).append("\n"); 
		query.append("        ,'BB Info' AS	DIM_WDT" ).append("\n"); 
		query.append("        ,'BB Info' AS	DIM_HGT" ).append("\n"); 
		query.append("        ,'BB Info' AS	BB_GRS_WGT" ).append("\n"); 
		query.append("        ,'BB Info' AS	BB_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'BB Info' AS	BB_TTL_GRS_WGT" ).append("\n"); 
		query.append("        ,'BB Info' AS	BB_TTL_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'BB Info' AS	OVR_VOID_SLT_QTY" ).append("\n"); 
		query.append("        ,'BB Info' AS	SLNG_PNT_FLG" ).append("\n"); 
		query.append("        ,'BB Info' AS	GRAV_CTR_DESC" ).append("\n"); 
		query.append("        ,'BB Info' AS	PCK_DTL_DESC" ).append("\n"); 
		query.append("        ,'BB Info' AS	CGO_LODG_MZD_CD" ).append("\n"); 
		query.append("        ,'BB Info' AS	CGO_LODG_MZD_DESC" ).append("\n"); 
		query.append("        ,'BB Info' AS	SCR_DNG_CTNT" ).append("\n"); 
		query.append("        ,'BB Info' AS	SPCL_RQST_DESC" ).append("\n"); 
		query.append("        ,'BB Info' AS	DIFF_RMK" ).append("\n"); 
		query.append("        ,'' AS BB_CGO_SEQ--for ORDER BY" ).append("\n"); 
		...
		query.append("        ,'Cargo Information: Length' AS	DIM_LEN" ).append("\n"); 
		query.append("        ,'Cargo Information: Width' AS	DIM_WDT" ).append("\n"); 
		query.append("        ,'Cargo Information: Height' AS	DIM_HGT" ).append("\n"); 
		query.append("        ,'Cargo Information: Grs Weight' AS	BB_GRS_WGT" ).append("\n"); 
		query.append("        ,'Cargo Information: Unit' AS	BB_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'Total Weight' AS	BB_TTL_GRS_WGT" ).append("\n"); 
		query.append("        ,'Total Weight Unit' AS	BB_TTL_WGT_UT_CD" ).append("\n"); 
		query.append("        ,'Void Space (FEU)' AS	OVR_VOID_SLT_QTY" ).append("\n"); 
		query.append("        ,'Sling Point' AS	SLNG_PNT_FLG" ).append("\n"); 
		query.append("        ,'Center of Gravity' AS	GRAV_CTR_DESC" ).append("\n"); 
		query.append("        ,'Cargo Packing Details' AS	PCK_DTL_DESC" ).append("\n"); 
		query.append("        ,'Loading Method Code' AS	CGO_LODG_MZD_CD" ).append("\n"); 
		query.append("        ,'Loading Method Description' AS	CGO_LODG_MZD_DESC" ).append("\n"); 
		query.append("        ,'Secure & Dunnage' AS	SCR_DNG_CTNT" ).append("\n"); 
		query.append("        ,'Special Request' AS	SPCL_RQST_DESC" ).append("\n"); 
		...
		query.append("         , DECODE(NVL(BKG_JOIN_FNC(CURSOR(SELECT CUST_REF_NO_CTNT" ).append("\n"); 
		...
		query.append("                                                      ),','),''),'','N','Y') AS XPT_DECL_RCV" ).append("\n"); 
		...
		query.append("         , DECODE(BK.DE_TERM_CD, 'D', 'C', 'M') AS IB_HLG" ).append("\n"); 
		...
		query.append("         , TO_CHAR(BL.PCK_QTY) PCK_QTY" ).append("\n"); 
		query.append("         , (SELECT PCK_NM FROM MDM_PCK_TP PCK WHERE BL.PCK_TP_CD = PCK.PCK_CD) PCK_DESC" ).append("\n"); 
		...
		query.append("    -- BB Info" ).append("\n"); 
		query.append("    -----------------------------------------------------------" ).append("\n"); 
		query.append("         , (SELECT APRO_REF_NO " ).append("\n"); 
		query.append("              FROM SCG_APRO_RQST RQST, SCG_AUTHORIZATION AUTH " ).append("\n"); 
		query.append("             WHERE BB.BKG_NO      = RQST.BKG_NO" ).append("\n"); 
		query.append("               AND BB.BKG_NO      = AUTH.BKG_NO(+)" ).append("\n"); 
		query.append("               AND BB.BB_CGO_SEQ = AUTH.BB_CGO_SEQ(+)" ).append("\n"); 
		...
		query.append("               AND RQST.SPCL_CGO_CATE_CD = 'BB'" ).append("\n"); 
		...
		query.append("               AND INTG_CD_VAL_CTNT = BB.SPCL_CGO_APRO_CD) APRO_STS" ).append("\n"); 
		query.append("         , TO_CHAR(BB.DIM_LEN,'999,999,999,990.99') DIM_LEN" ).append("\n"); 
		query.append("         , TO_CHAR(BB.DIM_WDT,'999,999,999,990.99') DIM_WDT" ).append("\n"); 
		query.append("         , TO_CHAR(BB.DIM_HGT,'999,999,999,990.99') DIM_HGT" ).append("\n"); 
		query.append("         , TO_CHAR(BB.GRS_WGT,'999,999,999,990.99') BB_GRS_WGT" ).append("\n"); 
		query.append("         , BB.WGT_UT_CD BB_WGT_UT_CD" ).append("\n"); 
		query.append("         , TO_CHAR(SUM(BB.GRS_WGT) OVER (PARTITION BY BB.BKG_NO),'999,999,999,990.99') BB_TTL_GRS_WGT" ).append("\n"); 
		query.append("         , BB.WGT_UT_CD BB_TTL_WGT_UT_CD" ).append("\n"); 
		query.append("         , TO_CHAR(BK.OVR_VOID_SLT_QTY) OVR_VOID_SLT_QTY" ).append("\n"); 
		query.append("         , BB.SLNG_PNT_FLG" ).append("\n"); 
		query.append("         , REPLACE(REPLACE(REPLACE(BB.GRAV_CTR_DESC,CHR(10),' '),CHR(9),' '),CHR(34),'') GRAV_CTR_DESC" ).append("\n"); 
		query.append("         , BB.PCK_DTL_DESC" ).append("\n"); 
		query.append("         , BB.CGO_LODG_MZD_CD" ).append("\n"); 
		query.append("         , (SELECT INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("              FROM COM_INTG_CD_DTL " ).append("\n"); 
		query.append("             WHERE INTG_CD_ID = 'CD01582'" ).append("\n"); 
		query.append("               AND INTG_CD_VAL_CTNT = BB.CGO_LODG_MZD_CD) CGO_LODG_MZD_DESC" ).append("\n"); 
		query.append("         , BB.SCR_DNG_CTNT" ).append("\n"); 
		query.append("         , BB.SPCL_RQST_DESC" ).append("\n"); 
		query.append("         , REPLACE(REPLACE(REPLACE(BB.DIFF_RMK,CHR(10),' '),CHR(9),' '),CHR(34),'') DIFF_RMK" ).append("\n"); 
		query.append("         , TO_CHAR(BB.BB_CGO_SEQ) BB_CGO_SEQ--for ORDER BY" ).append("\n"); 
		...
		query.append("ORDER BY TEMP, BKG_NO, TO_NUMBER(BB_CGO_SEQ)" ).append("\n"); 
		query.append("#else" ).append("\n"); 
