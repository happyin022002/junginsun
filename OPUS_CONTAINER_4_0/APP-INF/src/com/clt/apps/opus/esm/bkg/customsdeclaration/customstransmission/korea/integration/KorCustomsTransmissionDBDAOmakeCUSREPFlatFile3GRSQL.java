...
*@FileName : KorCustomsTransmissionDBDAOmakeCUSREPFlatFile3GRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeCUSREPFlatFile3GRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeCUSREPFlatFile3GRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeCUSREPFlatFile3GRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            AND VPS_PORT_CD = DECODE(@[io_bnd_cd], 'I', @[pod_cd], @[pol_cd])" ).append("\n"); 
		query.append("            AND CLPT_IND_SEQ = 1)   ||'~'||  /* Cons Voy */ " ).append("\n"); 
		...
		query.append("		TO_CHAR(TO_DATE(@[etd_dt], 'YYYY-MM-DD HH24:MI'),'YYYYMMDDHH24MI')	||'~'||	/*	ETD Date		*/" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("		TO_CHAR(TO_DATE(@[etd_dt], 'YYYY-MM-DD HH24:MI'),'yymmdd')	||'~'||	/*	ETD Date		*/" ).append("\n"); 
		...
		query.append("		'NYK LINE(KOREA) CO., LTD' ||'~'||	/*	선박대리점명	*/" ).append("\n"); 
