...
*@FileName : BrcsCustomsTransmissionDBDAOsearchDangerCgoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BrcsCustomsTransmissionDBDAOsearchDangerCgoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BrcsCustomsTransmissionDBDAOsearchDangerCgoRSQL(){
		setQuery();
		...
		query.append("FileName : BrcsCustomsTransmissionDBDAOsearchDangerCgoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
