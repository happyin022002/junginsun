...
public class SurchargeDBDAOPriScgRtRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    , ROW_NUMBER() OVER (ORDER BY A.POR_DEF_CD, A.POL_DEF_CD, A.POD_DEF_CD, A.DEL_DEF_CD, A.SVC_SCP_CD, A.CHG_CD, A.SCG_SEQ) NO" ).append("\n"); 
		query.append("  FROM (" ).append("\n"); 
		...
		query.append("ORDER BY A.POR_DEF_CD, A.POL_DEF_CD, A.POD_DEF_CD, A.DEL_DEF_CD, A.SVC_SCP_CD, A.CHG_CD, A.SCG_SEQ" ).append("\n"); 
		query.append(") " ).append("\n"); 
