...
*@FileName : UserSetupMgtDBDAOBkgXterSrchSetVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAOBkgXterSrchSetVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserSetupMgtDBDAOBkgXterSrchSetVOCSQL(){
		setQuery();
		...
		query.append("FileName : UserSetupMgtDBDAOBkgXterSrchSetVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO bkg_xter_srch_set (" ).append("\n"); 
		...
		query.append("	decode(@[set_slct_flg],1,'Y','N')" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		query.append(",	sysdate" ).append("\n"); 
		query.append(",	@[upd_usr_id]" ).append("\n"); 
		query.append(",	sysdate" ).append("\n"); 
		query.append(",	@[usr_id]" ).append("\n"); 
		query.append(",	nvl((select /*+ index_desc(bkg_xter_srch_set XPKBKG_XTER_SRCH_SET)  */" ).append("\n"); 
		query.append("             set_sub_seq" ).append("\n"); 
		...
		query.append(",	@[bkg_cust_tp_cd]" ).append("\n"); 
		query.append(",	@[cust_cnt_cd]" ).append("\n"); 
		query.append(",	decode(@[cust_seq], 0, null, @[cust_seq])" ).append("\n"); 
		query.append(",	@[cust_nm]" ).append("\n"); 
		query.append(",	@[srep_cd]" ).append("\n"); 
		query.append(",	@[chn_agn_cd]" ).append("\n"); 
