...
*@FileName : ESM_BKG_1056HTMLAction.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ESM_BKG_1056HTMLAction extends HTMLActionSupport
{
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1056HTMLAction 객체를 생성
	 */
	public ESM_BKG_1056HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException
	{
		...
		EsmBkg1056Event event = new EsmBkg1056Event();
		if(command.isCommand(FormCommand.SEARCH))
		{
			event.setEntryTp(request.getParameter("entryTp"));
		}
		else if(command.isCommand(FormCommand.MULTI))
		{
			event.setKorCllSppVOs((KorCllSppVO[]) getVOs(request, KorCllSppVO.class));
		}
		return  event;
	}
