...
public class EsmAcm0028Event extends EventSupport {
	...
	public FACCommListVO[] getFacCommListVOs() {
		FACCommListVO[] rtnVOs = null;
		if (this.facCommListVOs != null) {
			rtnVOs = Arrays.copyOf(facCommListVOs, facCommListVOs.length);
		}
		return rtnVOs;
	}

	public void setFacCommListVOs(FACCommListVO[] facCommListVOs) {
		if(facCommListVOs != null){
			FACCommListVO[] tmpVOs = Arrays.copyOf(facCommListVOs, facCommListVOs.length);
			this.facCommListVOs  = tmpVOs;
		}
	}
