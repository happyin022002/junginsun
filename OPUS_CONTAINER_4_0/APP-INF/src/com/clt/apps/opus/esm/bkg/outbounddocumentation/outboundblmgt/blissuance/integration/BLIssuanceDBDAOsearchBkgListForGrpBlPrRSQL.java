...
public class BLIssuanceDBDAOsearchBkgListForGrpBlPrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (''!=${vvd_pol_local} && ''!=${vvd_pol_cd})" ).append("\n"); 
		query.append("   AND B.POL_CD = V1.POL_CD" ).append("\n"); 
		query.append("#elseif (''!=${vvd_pol_ts} && ''!=${vvd_pol_cd})" ).append("\n"); 
		query.append("   AND B.POL_CD <> V1.POL_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (''!=${vvd_pod_local} && ''!=${vvd_pod_cd})" ).append("\n"); 
		query.append("   AND B.POD_CD = V1.POD_CD" ).append("\n"); 
		query.append("#elseif (''!=${vvd_pod_ts} && ''!=${vvd_pod_cd})" ).append("\n"); 
		query.append("   AND B.POD_CD <> V1.POD_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("        'Y'=B.HOT_DE_FLG OR" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("   AND DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		...
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END))))))) LIKE @[vvd_pre_vvd]||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (''!=${vvd_pre_pol})" ).append("\n"); 
		query.append("   AND DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POL_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POL_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POL_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POL_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'T'=V1.VSL_PRE_PST_CD THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'T'=V1.VSL_PRE_PST_CD THEN V1.POL_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POL_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POD_CD END,B.POL_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POL_CD END," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POL_CD END))))))) LIKE @[vvd_pre_pol]||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (''!=${vvd_post_vvd})" ).append("\n"); 
		query.append("   AND DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'T'=V1.VSL_PRE_PST_CD THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              B.VSL_CD||B.SKD_VOY_NO||B.SKD_DIR_CD," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.VSL_CD||V1.SKD_VOY_NO||V1.SKD_DIR_CD END))))))) LIKE @[vvd_post_vvd]||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (''!=${vvd_post_pod})" ).append("\n"); 
		query.append("   AND DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POD_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POD_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POD_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'U'=V1.VSL_PRE_PST_CD AND '1'=VSL_SEQ THEN V1.POD_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'T'=V1.VSL_PRE_PST_CD THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'T'=V1.VSL_PRE_PST_CD THEN V1.POD_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '4'=VSL_SEQ THEN V1.POD_CD END," ).append("\n"); 
		query.append("       DECODE(CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POL_CD END,B.POD_CD," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '3'=VSL_SEQ THEN V1.POD_CD END," ).append("\n"); 
		query.append("              CASE WHEN 'S'=V1.VSL_PRE_PST_CD AND '2'=VSL_SEQ THEN V1.POD_CD END))))))) LIKE @[vvd_post_pod]||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("       BKG_RATE T3," ).append("\n"); 
