...
*@FileName : SCDurationProposalDBDAOCstRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAOCstRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 자동으로 accept한 데이터를 Request cancel시 accept이전 상태로 돌린다.
	  * </pre>
	  */
	public SCDurationProposalDBDAOCstRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAOCstRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_DUR" ).append("\n"); 
		query.append("SET ACPT_USR_ID = @[acpt_usr_id]" ).append("\n"); 
