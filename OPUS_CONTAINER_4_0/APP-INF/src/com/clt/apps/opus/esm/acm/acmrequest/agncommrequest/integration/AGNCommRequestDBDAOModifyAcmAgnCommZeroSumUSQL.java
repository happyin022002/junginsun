...
*@FileName : AGNCommRequestDBDAOModifyAcmAgnCommZeroSumUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOModifyAcmAgnCommZeroSumUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyAcmAgnCommZeroSum
	  * </pre>
	  */
	public AGNCommRequestDBDAOModifyAcmAgnCommZeroSumUSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOModifyAcmAgnCommZeroSumUSQL").append("\n");
		query.append("*/").append("\n");
	}
