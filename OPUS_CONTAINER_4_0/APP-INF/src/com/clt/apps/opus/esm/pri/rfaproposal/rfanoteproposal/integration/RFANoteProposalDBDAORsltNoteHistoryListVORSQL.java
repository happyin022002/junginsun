...
*@FileName : RFANoteProposalDBDAORsltNoteHistoryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteProposalDBDAORsltNoteHistoryListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * special note title history 조회
	  * </pre>
	  */
	public RFANoteProposalDBDAORsltNoteHistoryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFANoteProposalDBDAORsltNoteHistoryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("   AND A.PROP_NO		= DTL.PROP_NO" ).append("\n"); 
		query.append("   AND A.AMDT_SEQ		= DTL.AMDT_SEQ" ).append("\n"); 
		query.append("   AND A.SVC_SCP_CD		= DTL.SVC_SCP_CD" ).append("\n"); 
		query.append("   AND A.NOTE_SEQ		= DTL.NOTE_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
