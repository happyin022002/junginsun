...
*@FileName : FACommAgreementDBDAORejectFACAgreementListUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FACommAgreementDBDAORejectFACAgreementListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ACM_FAC_AGMT에 Reject 관련 정보를 업데이트한다.
	  * </pre>
	  */
	public FACommAgreementDBDAORejectFACAgreementListUSQL(){
		setQuery();
		...
		query.append("FileName : FACommAgreementDBDAORejectFACAgreementListUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("SET FAC_STS_CD   = 'RE', " ).append("\n");
