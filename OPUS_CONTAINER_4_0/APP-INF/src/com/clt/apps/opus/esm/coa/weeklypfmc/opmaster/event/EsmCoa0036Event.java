...
public class EsmCoa0036Event extends EventSupport {
	...
	public void setCoaLaneRgstVOs(CoaLaneRgstVO[] coaLaneRgstVOs){
		if(coaLaneRgstVOs != null){
			CoaLaneRgstVO[] tmpVOs = Arrays.copyOf(coaLaneRgstVOs, coaLaneRgstVOs.length);
			this.coaLaneRgstVOs = tmpVOs;
		}
	}
	/** ValueObject Array Getter - Create/Update/Delete */					//SJH.20150508.소스품질
	public CoaLaneRgstVO[] getCoaLaneRgstVOs(){
		CoaLaneRgstVO[] rtnVOs = null;
		if (this.coaLaneRgstVOs != null) {
			rtnVOs = Arrays.copyOf(coaLaneRgstVOs, coaLaneRgstVOs.length);
		}
		return rtnVOs;
	}
