...
public class SCBoilerPlateProposalDBDAO extends DBDAOSupport {
    ...
    /**
     *  PRI_SP_BLPL 해당 Amend Seq 해당하는 모든 데이터를 PRI_SP_BLPL_MIG_HIS에 넣습니다.<br>
     * 
     * @param PriSpMnVO vo
     * @exception DAOException
     */
    public void addProposalTitleMigHis (PriSpMnVO vo) throws DAOException, Exception {
        // query parameter
        Map<String, Object> param = new HashMap<String, Object>();
        // velocity parameter
        Map<String, Object> velParam = new HashMap<String, Object>();
        try {
            ...
            SQLExecuter sqlExe = new SQLExecuter("");
            int result = sqlExe.executeUpdate((ISQLTemplate) new SCBoilerPlateProposalDBDAOPriSpBlplVOMigHisCSQL(), param, velParam);
            if (result == Statement.EXECUTE_FAILED) {
                throw new DAOException("Fail to insert SQL");
            }			
    ...
    /**
     *  PRI_SP_BLPL_CTNT 해당 Amend Seq 해당하는 모든 데이터를 PRI_SP_BLPL_CTNT_MIG_HIS에 넣습니다.<br>
     * 
     * @param PriSpMnVO vo
     * @exception DAOException
     */
    public void addProposalCtntMigHis (PriSpMnVO vo) throws DAOException, Exception {
        // query parameter
        Map<String, Object> param = new HashMap<String, Object>();
        // velocity parameter
        Map<String, Object> velParam = new HashMap<String, Object>();
        try {
            ...
            SQLExecuter sqlExe = new SQLExecuter("");
            int result = sqlExe.executeUpdate((ISQLTemplate) new SCBoilerPlateProposalDBDAOPriSpBlplCtntVOMigHisCSQL(), param, velParam);
            if (result == Statement.EXECUTE_FAILED) {
                throw new DAOException("Fail to insert SQL");
            }		
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<RsltPriSpBlplCtntVO> searchBoilerPlateDetailHistoryList(PriSpBlplCtntVO priSpBlplCtntVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltPriSpBlplCtntVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<RsltPriSpBlplVO> searchBoilerPlateHistoryList(CstBlplSearchVO cstBlplSearchVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltPriSpBlplVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	...
	/**
	 * Boiler Plate Content 히스토리 저장.<br>
	 * 
	 * @param List<PriSpBlplVO> delModels
	 * @exception DAOException
	 */
	public void addHistoryBoilerPlateDetailS(List<PriSpBlplVO> delModels) throws DAOException,Exception {
		try {
			SQLExecuter sqlExe = new SQLExecuter("");
			int insCnt[] = null;
			if(delModels.size() > 0){
				insCnt = sqlExe.executeBatch((ISQLTemplate)new SCBoilerPlateProposalDBDAOPriSpBlplCtntHistoryCSQL(), delModels,null);
				for(int i = 0; i < insCnt.length; i++){
					if(insCnt[i]== Statement.EXECUTE_FAILED)
						throw new DAOException("Fail to insert No"+ i + " SQL");
				}
	...
	/**
	 * Boiler Plate Title 히스토리 저장.<br>
	 * 
	 * @param List<PriSpBlplVO> delModels
	 * @exception DAOException
	 */
	public void addHistoryBoilerPlateS(List<PriSpBlplVO> delModels) throws DAOException,Exception {
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		try {
			SQLExecuter sqlExe = new SQLExecuter("");
			int insCnt[] = null;
			if(delModels.size() > 0){
				insCnt = sqlExe.executeBatch((ISQLTemplate)new SCBoilerPlateProposalDBDAOPriSpBlplHistoryCSQL(), delModels,velParam);
				for(int i = 0; i < insCnt.length; i++){
					if(insCnt[i]== Statement.EXECUTE_FAILED)
						throw new DAOException("Fail to insert No"+ i + " SQL");
				}
