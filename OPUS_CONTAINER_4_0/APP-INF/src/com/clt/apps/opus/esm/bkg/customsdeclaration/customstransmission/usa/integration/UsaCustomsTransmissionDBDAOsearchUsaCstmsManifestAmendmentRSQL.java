...
*@FileName : UsaCustomsTransmissionDBDAOsearchUsaCstmsManifestAmendmentRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaCustomsTransmissionDBDAOsearchUsaCstmsManifestAmendmentRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaCustomsTransmissionDBDAOsearchUsaCstmsManifestAmendmentRSQL(){
		setQuery();
		...
		query.append("FileName : UsaCustomsTransmissionDBDAOsearchUsaCstmsManifestAmendmentRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                              )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                          AND	VVD.POD_CD IN" ).append("\n"); 
		...
		query.append("                                        AND	nvl(skd_cng_sts_cd, ' ') <> 'S') ) )" ).append("\n"); 
		query.append("                                        --AND SUBSTR(VVD.POL_CD, 1, 2) <> 'US'--POL이 US일 때는 제외" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                                       WHEN BL.AMDT_SND_DT IS NOT NULL" ).append("\n"); 
		query.append("                                            THEN BL.AMDT_SND_DT" ).append("\n"); 
		query.append("                                       WHEN BL.MF_SND_DT IS NOT NULL" ).append("\n"); 
		query.append("                                            THEN BL.MF_SND_DT" ).append("\n"); 
		query.append("                                  END" ).append("\n"); 
		...
		query.append("                   AND VSL.CLPT_IND_SEQ = (SELECT /*+ INDEX_DESC(P XPKVSK_VSL_PORT_SKD) */ P.CLPT_IND_SEQ" ).append("\n"); 
		query.append("                                             FROM VSK_VSL_PORT_SKD P" ).append("\n"); 
		query.append("                                            WHERE 1=1" ).append("\n"); 
		query.append("                                              AND P.VSL_CD = VSL.VSL_CD" ).append("\n"); 
		query.append("                                              AND P.SKD_VOY_NO = VSL.SKD_VOY_NO" ).append("\n"); 
		query.append("                                              AND P.SKD_DIR_CD = VSL.SKD_DIR_CD" ).append("\n"); 
		query.append("                                              AND P.VPS_PORT_CD = BKG.POD_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND SKD_POD.VPS_PORT_CD||LPAD(SKD_POD.CLPT_IND_SEQ, 2, 0) = (SELECT /*+ INDEX_ASC(P XAK4VSK_VSL_PORT_SKD) */ p.VPS_PORT_CD||LPAD(P.CLPT_IND_SEQ, 2, 0)" ).append("\n"); 
		query.append("                                             FROM VSK_VSL_PORT_SKD P" ).append("\n"); 
		query.append("                                            WHERE 1=1" ).append("\n"); 
		query.append("                                              AND P.VSL_CD      = SKD_POD.VSL_CD" ).append("\n"); 
		query.append("                                              AND P.SKD_VOY_NO  = SKD_POD.SKD_VOY_NO" ).append("\n"); 
		query.append("                                              AND P.SKD_DIR_CD  = SKD_POD.SKD_DIR_CD" ).append("\n"); 
		query.append("                                              and SUBSTR(p.VPS_PORT_CD,1,2)	IN('US', (SELECT ATTR_CTNT1 FROM BKG_CSTMS_CD_CONV_CTNT" ).append("\n"); 
		query.append("                                                                 WHERE CNT_cD = 'US'" ).append("\n"); 
		query.append("                                                                   AND CSTMS_DIV_ID = 'US_CNT_CD_LIST'))" ).append("\n"); 
		query.append("                                              AND NVL(P.SKD_CNG_STS_CD, 'X') <> 'S'" ).append("\n"); 
		query.append("                                              and rownum = 1)" ).append("\n"); 
