...
*@FileName : SCProposalMainDBDAOPriSpScpAmdtSmryAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAOPriSpScpAmdtSmryAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCProposalMainDBDAOPriSpScpAmdtSmryAmdVOCSQL
	  * </pre>
	  */
	public SCProposalMainDBDAOPriSpScpAmdtSmryAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAOPriSpScpAmdtSmryAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_SP_SCP_AMDT_SMRY" ).append("\n"); 
