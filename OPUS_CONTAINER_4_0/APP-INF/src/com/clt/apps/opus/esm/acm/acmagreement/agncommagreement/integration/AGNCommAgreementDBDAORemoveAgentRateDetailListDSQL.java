...
*@FileName : AGNCommAgreementDBDAORemoveAgentRateDetailListDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAORemoveAgentRateDetailListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAORemoveAgentRateDetailListDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAORemoveAgentRateDetailListDSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_AGN_AGMT_DTL" ).append("\n");
