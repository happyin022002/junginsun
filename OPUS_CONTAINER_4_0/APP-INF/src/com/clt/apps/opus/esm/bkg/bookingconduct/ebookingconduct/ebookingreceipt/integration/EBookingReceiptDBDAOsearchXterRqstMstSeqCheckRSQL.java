...
*@FileName : EBookingReceiptDBDAOsearchXterRqstMstSeqCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOsearchXterRqstMstSeqCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchXterRqstMstSeqCheck
	  * </pre>
	  */
	public EBookingReceiptDBDAOsearchXterRqstMstSeqCheckRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOsearchXterRqstMstSeqCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND 	MST.ACT_CUST_REF_NO = @[xter_rqst_no]" ).append("\n"); 
		...
		query.append("                           AND HCC.ATTR_CTNT2 = @[xter_sndr_id]" ).append("\n"); 
