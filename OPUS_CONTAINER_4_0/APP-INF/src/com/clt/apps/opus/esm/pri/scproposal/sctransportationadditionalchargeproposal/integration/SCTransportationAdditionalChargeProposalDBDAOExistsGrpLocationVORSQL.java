...
*@FileName : SCTransportationAdditionalChargeProposalDBDAOExistsGrpLocationVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCTransportationAdditionalChargeProposalDBDAOExistsGrpLocationVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Group Location 존재 유무를 조회한다.
	  * </pre>
	  */
	public SCTransportationAdditionalChargeProposalDBDAOExistsGrpLocationVORSQL(){
		setQuery();
		...
		query.append("FileName : SCTransportationAdditionalChargeProposalDBDAOExistsGrpLocationVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT   PRC_GRP_LOC_DESC CD" ).append("\n"); 
