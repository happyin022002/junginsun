...
*@FileName : AGTCustomerAgreementInfoDBDAOMdmRegionCountVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerAgreementInfoDBDAOMdmRegionCountVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCustomerAgreementInfoDBDAOMdmRegionCountVORSQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerAgreementInfoDBDAOMdmRegionCountVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
