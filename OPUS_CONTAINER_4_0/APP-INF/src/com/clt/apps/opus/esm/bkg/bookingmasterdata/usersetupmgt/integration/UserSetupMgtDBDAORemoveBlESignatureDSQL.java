...
*@FileName : UserSetupMgtDBDAORemoveBlESignatureDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAORemoveBlESignatureDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserSetupMgtDBDAORemoveBlESignatureDSQL(){
		setQuery();
		...
		query.append("FileName : UserSetupMgtDBDAORemoveBlESignatureDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_BL_ESIG" ).append("\n"); 
