...
*@FileName : TRIProposalDBDAORsltTriRoutDestPntVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAORsltTriRoutDestPntVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRI Destination Point 조회
	  * </pre>
	  */
	public TRIProposalDBDAORsltTriRoutDestPntVORSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAORsltTriRoutDestPntVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE LOC_CD = A.ROUT_PNT_LOC_CD" ).append("\n"); 
		...
		query.append("ORDER BY ROUT_PNT_LOC_CD, RCV_DE_TERM_CD, PRC_TRSP_MOD_CD" ).append("\n"); 
