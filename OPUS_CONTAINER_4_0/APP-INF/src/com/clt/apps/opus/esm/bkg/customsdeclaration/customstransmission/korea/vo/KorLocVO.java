...
public class KorLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorLocVO> models = new ArrayList<KorLocVO>();
	...
	public KorLocVO(String ibflag, String pagerows, String unPodLoc) {
		this.ibflag = ibflag;
	 ...
	 * @return KorLocVO[]
	 */
	public KorLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorLocVO[]
	 */
	public KorLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorLocVO model = null;
	 ...
	 * @return KorLocVO[]
	 */
	public KorLocVO[] getKorLocVOs(){
		KorLocVO[] vos = (KorLocVO[])models.toArray(new KorLocVO[models.size()]);
		return vos;
	}
