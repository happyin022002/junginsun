...
*@FileName : CODCorrectionDBDAOrejectCodRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CODCorrectionDBDAOrejectCodRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 COD 요청 건에 대해서 거절 상태로 update한다.
	  * </pre>
	  */
	public CODCorrectionDBDAOrejectCodRqstUSQL(){
		setQuery();
		...
		query.append("FileName : CODCorrectionDBDAOrejectCodRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	COD_STS_CD = 'N'" ).append("\n"); 
