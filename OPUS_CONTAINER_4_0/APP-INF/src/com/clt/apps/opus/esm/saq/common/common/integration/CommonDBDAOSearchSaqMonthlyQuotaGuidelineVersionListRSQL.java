...
*@FileName : CommonDBDAOSearchSaqMonthlyQuotaGuidelineVersionListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchSaqMonthlyQuotaGuidelineVersionListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSaqTagetGroupTradeList 목록 조회
	  * </pre>
	  */
	public CommonDBDAOSearchSaqMonthlyQuotaGuidelineVersionListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchSaqMonthlyQuotaGuidelineVersionListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
