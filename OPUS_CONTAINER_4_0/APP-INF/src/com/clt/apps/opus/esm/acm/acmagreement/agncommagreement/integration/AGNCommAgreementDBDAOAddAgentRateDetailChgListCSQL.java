...
*@FileName : AGNCommAgreementDBDAOAddAgentRateDetailChgListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateDetailChgListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateDetailChgListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateDetailChgListCSQL").append("\n");
		query.append("*/").append("\n");
	}
