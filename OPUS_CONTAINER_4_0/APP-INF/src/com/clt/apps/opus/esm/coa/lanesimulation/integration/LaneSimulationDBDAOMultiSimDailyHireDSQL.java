...
*@FileName : LaneSimulationDBDAOMultiSimDailyHireDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimDailyHireDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimDailyHireDSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimDailyHireDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
