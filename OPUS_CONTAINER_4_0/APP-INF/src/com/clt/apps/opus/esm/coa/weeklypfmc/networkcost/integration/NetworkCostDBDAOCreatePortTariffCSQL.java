...
public class NetworkCostDBDAOCreatePortTariffCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("INSERT INTO COA_PORT_TRF(" ).append("\n"); 
		...
		query.append("    ,NVL(D1.LOCL_PORT_AMT, DECODE(D2.COST_CD, '511101', D2.LCL_COST,0))   LOCL_PORT_AMT" ).append("\n"); 
		query.append("    ,NVL(D1.LOCL_CNL_AMT, DECODE(D2.COST_CD, '53102000', D2.LCL_COST,0))    LOCL_CNL_AMT" ).append("\n"); 
		query.append("    ,NVL(D1.PORT_USD_AMT, DECODE(D2.COST_CD, '511101', D2.USD_COST,0))    PORT_USD_AMT" ).append("\n"); 
		...
		query.append("  FROM COA_PORT_TRF D1" ).append("\n"); 
		query.append("      ,(" ).append("\n"); 
		...
		query.append("                                  ,COA_VSL_RGST A3" ).append("\n"); 
		...
		query.append("                                   --SJH.20150116.MOD : EGSUZ  -> EGSCA, PAPAC  -> PAPCA" ).append("\n"); 
		query.append("                                   AND A1.IOC_CD           = DECODE(A2.LOC_CD, 'PAPCA', 'O', 'EGSCA', 'O', A1.IOC_CD)" ).append("\n"); 
		...
		query.append("                                   AND NVL(A5.VT_ADD_CALL_FLG,'N') <> 'Y'					--20150819.ADD" ).append("\n"); 
		...
		query.append("                                   ---AND A3.VOP_CD    = '000'" ).append("\n"); 
		...
		query.append("                                  ,TML_CD" ).append("\n"); 
		query.append("                              FROM COA_PORT_TRF" ).append("\n"); 
		query.append("#if (${f_yrtype} == 'W')" ).append("\n"); 
		...
		query.append("                                       ,'EGSCA', '53102000'																										--SJH.20150116.MOD : EGSUZ  -> EGSCA" ).append("\n"); 
		query.append("                                       ,'PAPCA', '53102000'																										--SJH.20150116.MOD : PAPAC  -> PAPCA" ).append("\n"); 
		query.append("                                       ,DECODE(SUBSTR(A1.PORT_COST_CD, 1, 4), '5119', '53102000', '511101')" ).append("\n"); 
