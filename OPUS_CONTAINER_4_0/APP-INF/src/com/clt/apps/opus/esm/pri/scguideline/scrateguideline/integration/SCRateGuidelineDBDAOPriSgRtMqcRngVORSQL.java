...
*@FileName : SCRateGuidelineDBDAOPriSgRtMqcRngVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtMqcRngVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtMqcRngVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtMqcRngVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
