...
*@FileName : JapanManifestListDownloadDBDAOaddJpcusVslSkdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOaddJpcusVslSkdCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOaddJpcusVslSkdCSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOaddJpcusVslSkdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("VALUES (@[call_sgn_no]," ).append("\n"); 
		query.append("        @[vsl_cd]," ).append("\n"); 
		query.append("        @[skd_voy_no]," ).append("\n"); 
		query.append("        @[skd_dir_cd]," ).append("\n"); 
		query.append("        @[pod_cd]," ).append("\n"); 
