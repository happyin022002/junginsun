...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntMigHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntMigHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * insert PRI_SP_SCP_NOTE_CTNT_MIG_HIS about demdet for note
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntMigHisCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntMigHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , PRI_SP_SCP_NOTE B" ).append("\n"); 
		...
		query.append("   AND B.NOTE_CLSS_CD = 'D'" ).append("\n"); 
