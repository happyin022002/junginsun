...
*@FileName : KorManifestListDBDAOmodifyBlAmdInfoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOmodifyBlAmdInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Edit B/L로 접근하여 정보를 수정한다.
	  * </pre>
	  */
	public KorManifestListDBDAOmodifyBlAmdInfoUSQL(){
		setQuery();
		...
		params.put("cstms_fwrd_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : KorManifestListDBDAOmodifyBlAmdInfoUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("   SET POR_CD            =   @[por_cd]" ).append("\n");
		...
		query.append("     , CSTMS_FWRD_ID     =   NVL(@[cstms_fwrd_id],' ')" ).append("\n");
		...
		query.append("     , BL_MEAS_UT_CD     =   @[meas_ut_cd]" ).append("\n");
		...
		query.append("     , FRT_FWRD_CD       =   @[frt_fwrd_cd]" ).append("\n");
		query.append("     , CSTMS_OFC_CTY_CD  =   TO_CHAR(NVL(@[cstms_ofc_cty_cd],0),'FM000')" ).append("\n");
		query.append("     , KR_CSTMS_DEPT_CD  =   TO_CHAR(NVL(@[kr_cstms_dept_cd],0),'FM00')" ).append("\n");
		query.append("     , CMDT_CD           =   @[cmdt_cd]" ).append("\n");
		query.append("     , KR_MEAS_UT_CD     =   @[kr_meas_ut_cd]" ).append("\n");
		query.append("     , BIZ_RGST_NO       =   @[biz_no]" ).append("\n");
		query.append("     , BB_CGO_WGT        =   @[bb_cgo_wgt]" ).append("\n");
		query.append("     , BB_CGO_MEAS_QTY   =   @[bb_cgo_meas_qty]" ).append("\n");
		query.append("     , CGO_TRSP_CD       =   @[cgo_spec]" ).append("\n");
		query.append("     , CSTMS_DECL_TP_CD  =   @[cstms_decl_tp_cd]" ).append("\n");
		query.append(" WHERE BKG_NO            =   @[bkg_no]" ).append("\n");
		query.append("   AND ( DECODE(@[old_cstms_decl_tp_cd],'I',CSTMS_DECL_TP_CD,'T',CSTMS_DECL_TP_CD) IN ('I','T') OR   /* 수정 */" ).append("\n");
