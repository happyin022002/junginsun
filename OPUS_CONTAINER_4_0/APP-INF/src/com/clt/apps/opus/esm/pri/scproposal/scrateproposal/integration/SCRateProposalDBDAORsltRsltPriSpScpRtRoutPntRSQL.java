...
*@FileName : SCRateProposalDBDAORsltRsltPriSpScpRtRoutPntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRsltPriSpScpRtRoutPntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SELECT PRI_SP_SCP_RT_ROUT_PNT
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRsltPriSpScpRtRoutPntRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRsltPriSpScpRtRoutPntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
