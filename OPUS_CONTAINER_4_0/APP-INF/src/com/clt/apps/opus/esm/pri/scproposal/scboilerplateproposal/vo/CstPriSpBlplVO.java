...
*@FileName : CstPriSpBlplVO.java
*@FileTitle : CstPriSpBlplVO
*Open Issues :
*Change history :
...
public class CstPriSpBlplVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriSpBlplVO> models = new ArrayList<CstPriSpBlplVO>();
	...
	public CstPriSpBlplVO() {}

	public CstPriSpBlplVO(String ibflag, String pagerows, String prcProgStsCd, String acptUsrId, String acptOfcCd, String acptDt, String updUsrId, String updDt, String propNo, String amdtSeqAccept, String stsCd, String effDt) {
		this.stsCd = stsCd;
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAmdtSeqAccept(JSPUtil.getParameter(request, "amdt_seq_accept", ""));
	 ...
	 */
	public CstPriSpBlplVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpBlplVO[]
	 */
	public CstPriSpBlplVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriSpBlplVO model = null;
	 ...
	 * @return CstPriSpBlplVO[]
	 */
	public CstPriSpBlplVO[] getCstPriSpBlplVOs(){
		CstPriSpBlplVO[] vos = (CstPriSpBlplVO[])models.toArray(new CstPriSpBlplVO[models.size()]);
		return vos;
	}
