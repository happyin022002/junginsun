 ...
 *@FileName : ESM_BKG_0233HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0233HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0233HTMLAction 객체를 생성
	 */
	public ESM_BKG_0233HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0233Event event = new EsmBkg0233Event();
		...
		{
			// Transmit.
			UsaEDADetailVO[] usaEDADetailVOs = (UsaEDADetailVO[]) getVOs(request, UsaEDADetailVO.class);
			event.setUsaEDADetailVOs(usaEDADetailVOs);
			//event.setUsaEDADetailVOs((UsaEDADetailVO[]) getVOs(request, UsaEDADetailVO.class));
		}
