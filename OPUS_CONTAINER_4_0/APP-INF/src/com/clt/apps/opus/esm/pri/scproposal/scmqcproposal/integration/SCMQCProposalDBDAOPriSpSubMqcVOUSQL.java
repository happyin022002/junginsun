...
*@FileName : SCMQCProposalDBDAOPriSpSubMqcVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCMQCProposalDBDAOPriSpSubMqcVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_sub_mqc update
	  * </pre>
	  */
	public SCMQCProposalDBDAOPriSpSubMqcVOUSQL(){
		setQuery();
		...
		params.put("sub_mqc_ctnt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : SCMQCProposalDBDAOPriSpSubMqcVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SUB_MQC SET " ).append("\n"); 
		query.append("	SUB_MQC_CTNT = @[sub_mqc_ctnt]" ).append("\n"); 
