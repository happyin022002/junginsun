...
*@FileName : RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_RP_SCP_GRP_CMDT Insert
	  * </pre>
	  */
	public RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityProposalDBDAOPropCpPriRpScpGrpCmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
