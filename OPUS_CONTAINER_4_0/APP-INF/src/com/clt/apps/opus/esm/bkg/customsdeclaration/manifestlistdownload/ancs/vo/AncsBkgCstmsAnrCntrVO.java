...
*@FileName : AncsBkgCstmsAnrCntrVO.java
*@FileTitle : AncsBkgCstmsAnrCntrVO
*Open Issues :
*Change history :
...
public class AncsBkgCstmsAnrCntrVO extends BkgCstmsAnrCntrVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<AncsBkgCstmsAnrCntrVO> models = new ArrayList<AncsBkgCstmsAnrCntrVO>();
	...
	public AncsBkgCstmsAnrCntrVO() {}

	public AncsBkgCstmsAnrCntrVO(String ibflag, String pagerows, String anrMsgStsCd, String updUsrId, String anrDeclNo, String msgTpCd, String refSeq, String rcv, String sndSts) {
		this.refSeq = refSeq;
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRcv(JSPUtil.getParameter(request, "snd_sts", ""));
	}
	 ...
	 */
	public AncsBkgCstmsAnrCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AncsCstmsAnrBlVO[]
	 */
	public AncsBkgCstmsAnrCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AncsBkgCstmsAnrCntrVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AncsBkgCstmsAnrCntrVO();
				if (refSeq[i] != null)
	 ...
	 * @return AncsCstmsAnrBlVO[]
	 */
	public AncsBkgCstmsAnrCntrVO[] getAncsCstmsAnrBlVOs(){
		AncsBkgCstmsAnrCntrVO[] vos = (AncsBkgCstmsAnrCntrVO[])models.toArray(new AncsBkgCstmsAnrCntrVO[models.size()]);
		return vos;
	}
