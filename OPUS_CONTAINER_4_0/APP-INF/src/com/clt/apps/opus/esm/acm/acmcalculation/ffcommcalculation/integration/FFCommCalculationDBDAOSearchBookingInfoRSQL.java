...
*@FileName : FFCommCalculationDBDAOSearchBookingInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOSearchBookingInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FFCommCalculationDBDAOSearchBookingInfoRSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOSearchBookingInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  DISTINCT BKG.POR_CD, 				" ).append("\n"); 
		...
		query.append("      WHEN BKG.BKG_OFC_CD = 'BSLBA' 				" ).append("\n"); 
		query.append("      THEN 'BSLBA' 				" ).append("\n"); 
		query.append("      WHEN POL.FINC_CTRL_OFC_CD = 'GLWBA' 				" ).append("\n"); 
		query.append("      THEN 'GLWBA' 				" ).append("\n"); 
		query.append("      ELSE POR.FINC_CTRL_OFC_CD 				" ).append("\n"); 
		query.append("       END                                                 AS POR_FINC_CTRL_OFC_CD, 				" ).append("\n"); 
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN BKG.BKG_OFC_CD = 'BSLBA' 				" ).append("\n"); 
		query.append("      THEN OBK.AR_OFC_CD 				" ).append("\n"); 
		query.append("      WHEN POL.FINC_CTRL_OFC_CD = 'GLWBA' 				" ).append("\n"); 
		query.append("      THEN OOL.AR_OFC_CD 				" ).append("\n"); 
		query.append("      ELSE OOR.AR_OFC_CD 				" ).append("\n"); 
		query.append("       END                                                 AS POR_AR_OFC_CD, 				" ).append("\n"); 
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN BKG.BKG_OFC_CD = 'BSLBA' 				" ).append("\n"); 
		query.append("      THEN OBK.AP_OFC_CD 				" ).append("\n"); 
		query.append("      WHEN POL.FINC_CTRL_OFC_CD = 'GLWBA' 				" ).append("\n"); 
		query.append("      THEN OOL.AP_OFC_CD 				" ).append("\n"); 
		...
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN BRT.CLT_OFC_CD = 'BUDBB' 				" ).append("\n"); 
		query.append("       AND POD.LOC_CD 				" ).append("\n"); 
		query.append("        IN 				" ).append("\n"); 
		query.append("         ( 				" ).append("\n"); 
		query.append("           'DEHAM', 'NLRTM', 'SIKOP' 				" ).append("\n"); 
		query.append("         ) 				" ).append("\n"); 
		query.append("      THEN 'BUDBB' 				" ).append("\n"); 
		query.append("      WHEN POD.FINC_CTRL_OFC_CD = 'GLWBA' 				" ).append("\n"); 
		query.append("      THEN 'GLWBA' 				" ).append("\n"); 
		query.append("      WHEN POD.FINC_CTRL_OFC_CD = 'BUDBB' 				" ).append("\n"); 
		query.append("      THEN 'BUDBB' 				" ).append("\n"); 
		query.append("      ELSE DEL.FINC_CTRL_OFC_CD 				" ).append("\n"); 
		query.append("       END                                                 AS DEL_FINC_CTRL_OFC_CD, 				" ).append("\n"); 
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN ORT.OFC_CD = 'BUDBB' 				" ).append("\n"); 
		query.append("       AND POD.LOC_CD 				" ).append("\n"); 
		query.append("        IN 				" ).append("\n"); 
		query.append("         ( 				" ).append("\n"); 
		query.append("           'DEHAM', 'NLRTM', 'SIKOP' 				" ).append("\n"); 
		query.append("         ) 				" ).append("\n"); 
		query.append("      THEN ORT.AR_OFC_CD 				" ).append("\n"); 
		query.append("      WHEN POD.FINC_CTRL_OFC_CD = 'GLWBA' 				" ).append("\n"); 
		query.append("      THEN OOD.AR_OFC_CD 				" ).append("\n"); 
		query.append("      WHEN POD.FINC_CTRL_OFC_CD = 'BUDBB' 				" ).append("\n"); 
		query.append("      THEN OOD.AR_OFC_CD 				" ).append("\n"); 
		...
		query.append("           'DEHAM', 'NLRTM', 'SIKOP' 				" ).append("\n"); 
		query.append("         ) 				" ).append("\n"); 
		query.append("      THEN ORT.AP_OFC_CD 				" ).append("\n"); 
		query.append("      WHEN POD.FINC_CTRL_OFC_CD = 'GLWBA' 				" ).append("\n"); 
		query.append("      THEN OOD.AP_OFC_CD 				" ).append("\n"); 
		query.append("      WHEN POD.FINC_CTRL_OFC_CD = 'BUDBB' 				" ).append("\n"); 
		query.append("      THEN OOD.AP_OFC_CD 				" ).append("\n"); 
		...
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN BKG.BKG_CGO_TP_CD = 'B' 				" ).append("\n"); 
		query.append("        OR BKG.BKG_CGO_TP_CD = 'R' 				" ).append("\n"); 
		query.append("        OR BKG.BKG_CGO_TP_CD = 'F' 				" ).append("\n"); 
		...
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN NVL (BKG.CHN_AGN_CD, ' ') = ' ' 				" ).append("\n"); 
		...
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN BRT.CLT_OFC_CD = 'BSLBA' 				" ).append("\n"); 
		query.append("      THEN ORT.AR_OFC_CD 				" ).append("\n"); 
		...
		query.append("      CASE 				" ).append("\n"); 
		query.append("      WHEN BKG.SVC_SCP_CD IS NULL 				" ).append("\n"); 
		query.append("      THEN '1' 				" ).append("\n"); 
		query.append("      ELSE '0' 				" ).append("\n"); 
		query.append("       END                                                 AS SVC_SCP_CHECK, 				" ).append("\n"); 
		query.append("         ( 				" ).append("\n"); 
		query.append("               SELECT 				" ).append("\n"); 
		query.append("                      NVL (BBL.BL_CVRD_TP_CD, 'N') 				" ).append("\n"); 
		...
		query.append("           (SELECT 	" ).append("\n"); 
		query.append("               CST.BKG_NO," ).append("\n"); 
		query.append("               CST.SHPR_CNT_CD, 										" ).append("\n"); 
		query.append("               CST.SHPR_CUST_SEQ, 	" ).append("\n"); 
		query.append("			   CST.FF_CNT_CD AS BKG_FF_CNT_CD, 										" ).append("\n"); 
		query.append("               CST.FF_SEQ AS BKG_FF_SEQ, 									" ).append("\n"); 
		query.append("               CST.FF_CNT_CD, 										" ).append("\n"); 
		query.append("               CST.FF_SEQ, 										" ).append("\n"); 
		query.append("          CASE 										" ).append("\n"); 
		query.append("          WHEN CST.FMC_NO IS NOT NULL 										" ).append("\n"); 
		query.append("          THEN CST.FMC_NO 										" ).append("\n"); 
		query.append("          WHEN CST.FMC_NO_MDM IS NOT NULL 										" ).append("\n"); 
		query.append("          THEN CST.FMC_NO_MDM 										" ).append("\n"); 
		query.append("          ELSE CST.FMC_NO_PREV										" ).append("\n"); 
		query.append("           END                                                           AS FMC_NO, 										" ).append("\n"); 
		query.append("          CASE 										" ).append("\n"); 
		query.append("          WHEN TRIM (CST.FMC_NO)      IS NOT NULL 										" ).append("\n"); 
		query.append("            OR TRIM (CST.FMC_NO_MDM)  IS NOT NULL 										" ).append("\n"); 
		query.append("            OR TRIM (CST.FMC_NO_PREV) IS NOT NULL 										" ).append("\n"); 
		query.append("          THEN '0' 										" ).append("\n"); 
		query.append("          ELSE '1' 										" ).append("\n"); 
		query.append("           END                                                           AS FF_FMC_CHECK_FLAG," ).append("\n"); 
		query.append("               CST.MDM_CUST_TP_CD, 										" ).append("\n"); 
		...
		query.append("                          NVL (TO_CHAR (BC2.CUST_SEQ, 'FM000000'), '*')  AS FF_SEQ, 										" ).append("\n"); 
		query.append("                        ( 										" ).append("\n"); 
		query.append("                              SELECT 										" ).append("\n"); 
		query.append("                                     SUBSTR(MAX (CUST_REF_NO_CTNT),1,19) 										" ).append("\n"); 
		...
		query.append("                        ( 										" ).append("\n"); 
		query.append("                              SELECT 										" ).append("\n"); 
		query.append("                                     MCS.FRT_FWRD_FMC_NO 										" ).append("\n"); 
		...
		query.append("                                 AND MCS.CNTR_CUST_TP_CD = 'N' 										" ).append("\n"); 
		query.append("                                 AND ROWNUM                   = 1 										" ).append("\n"); 
		query.append("                        )                                                AS FMC_NO_MDM, 										" ).append("\n"); 
		query.append("                        ( 										" ).append("\n"); 
		query.append("                              SELECT 										" ).append("\n"); 
		query.append("                                     INF.FMC_NO 										" ).append("\n"); 
		...
		query.append("                        ( 										" ).append("\n"); 
		query.append("                              SELECT 										" ).append("\n"); 
		query.append("                                     MCS.CNTR_CUST_TP_CD 										" ).append("\n"); 
		query.append("                                FROM MDM_CUSTOMER MCS 										" ).append("\n"); 
		query.append("                               WHERE MCS.CUST_CNT_CD          = BC2.CUST_CNT_CD 										" ).append("\n"); 
		query.append("                                 AND MCS.CUST_SEQ             = BC2.CUST_SEQ 																			" ).append("\n"); 
		query.append("                                 AND ROWNUM                   = 1 										" ).append("\n"); 
		query.append("                        )                                                AS MDM_CUST_TP_CD, 										" ).append("\n"); 
		query.append("                          NVL(BC2.REF_NO, '*')                           AS REFERENCE_NO, 										" ).append("\n"); 
		query.append("                     CASE BCS.CUST_CNT_CD||BCS.CUST_SEQ 										" ).append("\n"); 
		query.append("                     WHEN BC2.CUST_CNT_CD||BC2.CUST_SEQ 										" ).append("\n"); 
		query.append("                     THEN 1 										" ).append("\n"); 
		query.append("                     ELSE 0 										" ).append("\n"); 
		query.append("                      END                                                AS SH_FF_CHECK_FLAG, 										" ).append("\n"); 
		query.append("                     CASE 										" ).append("\n"); 
		query.append("                     WHEN LTRIM (BC2.CUST_CNT_CD) IS NULL 										" ).append("\n"); 
		query.append("                     THEN 1 										" ).append("\n"); 
		query.append("                     ELSE 0 										" ).append("\n"); 
