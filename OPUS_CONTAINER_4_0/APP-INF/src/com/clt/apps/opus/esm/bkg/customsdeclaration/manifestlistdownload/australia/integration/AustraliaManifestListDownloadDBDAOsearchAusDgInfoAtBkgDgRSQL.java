...
*@FileName : AustraliaManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AustraliaManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AustraliaManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL(){
		setQuery();
		...
		query.append("FileName : AustraliaManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SUM(SEQ) OVER (ORDER BY T1.BL_NO, T1.POL_CD, T1.POD_CD, T1.CNTR_NO) SEQ" ).append("\n"); 
		...
		query.append("                FROM BKG_CSTMS_AUS_DG_SND A" ).append("\n"); 
		query.append("                    ,BKG_CSTMS_AUS_DG_EDI_RSPN B" ).append("\n"); 
		...
		query.append("                AND   A.AUS_SND_LOG_ID ='IFD'" ).append("\n"); 
		query.append("                AND   A.AUS_SND_LOG_ID = B.AUS_SND_LOG_ID" ).append("\n"); 
		...
		query.append("                                            AND   A.AUS_SND_LOG_ID = B.AUS_SND_LOG_ID" ).append("\n"); 
		query.append("                                            AND   A.MSG_SND_NO = B.MSG_SND_NO" ).append("\n"); 
		query.append("                                            GROUP BY A.AUS_SND_LOG_ID, B.BL_NO" ).append("\n"); 
		query.append("                                            )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
