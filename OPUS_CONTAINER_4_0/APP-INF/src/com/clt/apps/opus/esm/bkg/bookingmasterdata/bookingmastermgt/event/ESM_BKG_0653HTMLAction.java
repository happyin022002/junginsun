...
*@FileName : ESM_BKG_0653HTMLAction.java
...
public class ESM_BKG_0653HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0653HTMLAction 객체를 생성
	 */
	public ESM_BKG_0653HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0653Event event = new EsmBkg0653Event();
