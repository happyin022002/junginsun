...
*@FileName : KorBkgCstmsVvdSmryVO.java
*@FileTitle : KorBkgCstmsVvdSmryVO
*Open Issues :
*Change history :
...
public class KorBkgCstmsVvdSmryVO extends AbstractValueObject {
	...
	public KorBkgCstmsVvdSmryVO(String ibflag, String pagerows, String bondAreaCode, String bound, String createdtype, String etaDt, String etdDt, String intChk, String inBound, String inChgComp, String inChgMeth, String inChgPort, String inDelLog, String inPod, String inPol, String inType, String inVvd, String ioBndCd, String jointCnt, String kvBg, String kvBondAreaCode, String kvCallKnt, String kvCbm, String kvCnslBlKnt, String kvCstmsDchgCd, String kvDchgMzdCd, String kvEtaDt, String kvEtdDt, String kvFDate, String kvIntChkCallKnt, String kvIoBndCd, String kvIoBndCdI, String kvIoBndCdO, String kvIoTmlLocCd, String kvJoCrrKnt, String kvKgs, String kvMfSndDd, String kvMfSndDt, String kvMfSndTt, String kvMrnNo, String kvMrnPort, String kvMstBlKnt, String kvMtyBlKnt, String kvNykc, String kvPliMrnPort, String kvPortCd, String kvPortCdLo, String kvRpliMrnPort, String kvSeq, String kvSpace, String kvSvBlSCnt, String kvTransChkCnt, String kvTransPreCnt, String kvTtlFullKnt, String kvTtlLc45ftQty, String kvTtlLcFeuQty, String kvTtlLcTeuQty, String kvTtlMeasQty, String kvTtlMty45ftQty, String kvTtlMtyFeuQty, String kvTtlMtyKnt, String kvTtlMtyTeuQty, String kvTtlPckQty, String kvTtlTs45ftQty, String kvTtlTsFeuQty, String kvTtlTsTeuQty, String kvTtlWgt, String kvTDate, String kvVslCallSgn, String kvVslCntCd, String kvVslNm, String kvVvdCd, String kvVvdSeq, String maxSeq, String mrnChkNo, String mrnNo, String mrnPort, String mrnType, String newMrnChkNo, String newMrnNo, String obDeclTpCd, String obType, String oldCnt, String oldMrnChkNo, String oldMrnNo, String oldSndChk, String podLoc, String podTml, String polLoc, String polTml, String svBlCCnt, String svBlECnt, String svBlMCnt, String svBlSCnt, String svCntrECnt, String svCntrFCnt, String svMeaQty, String svPkgQty, String svTotLcCntr20, String svTotLcCntr40, String svTotLcCntr45, String svTotMtCntr20, String svTotMtCntr40, String svTotMtCntr45, String svTotTsCntr20, String svTotTsCntr40, String svTotTsCntr45, String svWgtQty, String transChkCnt, String transPreCnt, String username, String vslCallSign, String vslCd, String vslEngNm, String vslFlag, String vvdCd, String vvdPodTmnlCd, String vvdPolTmnlCd, String vvdSeq) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("kv_nykc", getKvNykc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("kv_nykc", "kvNykc");
	 ...
	 * @param kvNykc
	 */
	public void setKvNykc(String kvNykc) {
		this.kvNykc = kvNykc;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setKvPliMrnPort(JSPUtil.getParameter(request, prefix + "kv_pli_mrn_port", ""));
		setInVvd(JSPUtil.getParameter(request, prefix + "in_vvd", ""));
		setInPod(JSPUtil.getParameter(request, prefix + "in_pod", ""));
		setKvTtlMtyTeuQty(JSPUtil.getParameter(request, prefix + "kv_ttl_mty_teu_qty", ""));
		setEtaDt(JSPUtil.getParameter(request, prefix + "eta_dt", ""));
		setKvPortCd(JSPUtil.getParameter(request, prefix + "kv_port_cd", ""));
		setKvMrnNo(JSPUtil.getParameter(request, prefix + "kv_mrn_no", ""));
		setSvTotLcCntr40(JSPUtil.getParameter(request, prefix + "sv_tot_lc_cntr_40", ""));
		setInPol(JSPUtil.getParameter(request, prefix + "in_pol", ""));
		setSvTotLcCntr45(JSPUtil.getParameter(request, prefix + "sv_tot_lc_cntr_45", ""));
		setKvMfSndDt(JSPUtil.getParameter(request, prefix + "kv_mf_snd_dt", ""));
		setKvSpace(JSPUtil.getParameter(request, prefix + "kv_space", ""));
		setKvTransChkCnt(JSPUtil.getParameter(request, prefix + "kv_trans_chk_cnt", ""));
		setSvPkgQty(JSPUtil.getParameter(request, prefix + "sv_pkg_qty", ""));
		setKvMrnPort(JSPUtil.getParameter(request, prefix + "kv_mrn_port", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setKvIoBndCdI(JSPUtil.getParameter(request, prefix + "kv_io_bnd_cd_i", ""));
		setUsername(JSPUtil.getParameter(request, prefix + "username", ""));
		setInType(JSPUtil.getParameter(request, prefix + "in_type", ""));
		setVvdCd(JSPUtil.getParameter(request, prefix + "vvd_cd", ""));
		setKvTransPreCnt(JSPUtil.getParameter(request, prefix + "kv_trans_pre_cnt", ""));
		setKvIoBndCdO(JSPUtil.getParameter(request, prefix + "kv_io_bnd_cd_o", ""));
		setKvCnslBlKnt(JSPUtil.getParameter(request, prefix + "kv_cnsl_bl_knt", ""));
		setOldMrnChkNo(JSPUtil.getParameter(request, prefix + "old_mrn_chk_no", ""));
		setKvIntChkCallKnt(JSPUtil.getParameter(request, prefix + "kv_int_chk_call_knt", ""));
		setVvdSeq(JSPUtil.getParameter(request, prefix + "vvd_seq", ""));
		setKvMfSndDd(JSPUtil.getParameter(request, prefix + "kv_mf_snd_dd", ""));
		setInChgPort(JSPUtil.getParameter(request, prefix + "in_chg_port", ""));
		setKvBondAreaCode(JSPUtil.getParameter(request, prefix + "kv_bond_area_code", ""));
		...
		setKvTtlPckQty(JSPUtil.getParameter(request, prefix + "kv_ttl_pck_qty", ""));
		setJointCnt(JSPUtil.getParameter(request, prefix + "joint_cnt", ""));
		setKvVvdSeq(JSPUtil.getParameter(request, prefix + "kv_vvd_seq", ""));
		setVslCallSign(JSPUtil.getParameter(request, prefix + "vsl_call_sign", ""));
		setKvDchgMzdCd(JSPUtil.getParameter(request, prefix + "kv_dchg_mzd_cd", ""));
		setSvBlCCnt(JSPUtil.getParameter(request, prefix + "sv_bl_c_cnt", ""));
		setKvEtaDt(JSPUtil.getParameter(request, prefix + "kv_eta_dt", ""));
		setMaxSeq(JSPUtil.getParameter(request, prefix + "max_seq", ""));
		setSvTotMtCntr45(JSPUtil.getParameter(request, prefix + "sv_tot_mt_cntr_45", ""));
		setNewMrnNo(JSPUtil.getParameter(request, prefix + "new_mrn_no", ""));
		setKvSeq(JSPUtil.getParameter(request, prefix + "kv_seq", ""));
		setKvMfSndTt(JSPUtil.getParameter(request, prefix + "kv_mf_snd_tt", ""));
		setKvTtlTs45ftQty(JSPUtil.getParameter(request, prefix + "kv_ttl_ts_45ft_qty", ""));
		setKvIoTmlLocCd(JSPUtil.getParameter(request, prefix + "kv_io_tml_loc_cd", ""));
		setSvTotMtCntr40(JSPUtil.getParameter(request, prefix + "sv_tot_mt_cntr_40", ""));
		setKvMtyBlKnt(JSPUtil.getParameter(request, prefix + "kv_mty_bl_knt", ""));
		setOldMrnNo(JSPUtil.getParameter(request, prefix + "old_mrn_no", ""));
		setKvIoBndCd(JSPUtil.getParameter(request, prefix + "kv_io_bnd_cd", ""));
		setSvTotLcCntr20(JSPUtil.getParameter(request, prefix + "sv_tot_lc_cntr_20", ""));
		setKvVvdCd(JSPUtil.getParameter(request, prefix + "kv_vvd_cd", ""));
		setKvTtlMtyFeuQty(JSPUtil.getParameter(request, prefix + "kv_ttl_mty_feu_qty", ""));
		setKvTtlMty45ftQty(JSPUtil.getParameter(request, prefix + "kv_ttl_mty_45ft_qty", ""));
		setIntChk(JSPUtil.getParameter(request, prefix + "int_chk", ""));
		setSvBlSCnt(JSPUtil.getParameter(request, prefix + "sv_bl_s_cnt", ""));
		setSvMeaQty(JSPUtil.getParameter(request, prefix + "sv_mea_qty", ""));
		setSvCntrECnt(JSPUtil.getParameter(request, prefix + "sv_cntr_e_cnt", ""));
		setKvFDate(JSPUtil.getParameter(request, prefix + "kv_f_date", ""));
		setVvdPolTmnlCd(JSPUtil.getParameter(request, prefix + "vvd_pol_tmnl_cd", ""));
		setKvCstmsDchgCd(JSPUtil.getParameter(request, prefix + "kv_cstms_dchg_cd", ""));
		setEtdDt(JSPUtil.getParameter(request, prefix + "etd_dt", ""));
		setKvTtlMeasQty(JSPUtil.getParameter(request, prefix + "kv_ttl_meas_qty", ""));
		setSvBlMCnt(JSPUtil.getParameter(request, prefix + "sv_bl_m_cnt", ""));
		setKvVslCallSgn(JSPUtil.getParameter(request, prefix + "kv_vsl_call_sgn", ""));
		setKvTtlMtyKnt(JSPUtil.getParameter(request, prefix + "kv_ttl_mty_knt", ""));
		setPodTml(JSPUtil.getParameter(request, prefix + "pod_tml", ""));
		setNewMrnChkNo(JSPUtil.getParameter(request, prefix + "new_mrn_chk_no", ""));
		setBound(JSPUtil.getParameter(request, prefix + "bound", ""));
		setKvTtlFullKnt(JSPUtil.getParameter(request, prefix + "kv_ttl_full_knt", ""));
		setVslCd(JSPUtil.getParameter(request, prefix + "vsl_cd", ""));
		setSvBlECnt(JSPUtil.getParameter(request, prefix + "sv_bl_e_cnt", ""));
		setKvCallKnt(JSPUtil.getParameter(request, prefix + "kv_call_knt", ""));
		setVslFlag(JSPUtil.getParameter(request, prefix + "vsl_flag", ""));
		setInBound(JSPUtil.getParameter(request, prefix + "in_bound", ""));
		setOldCnt(JSPUtil.getParameter(request, prefix + "old_cnt", ""));
		setKvMstBlKnt(JSPUtil.getParameter(request, prefix + "kv_mst_bl_knt", ""));
		setMrnNo(JSPUtil.getParameter(request, prefix + "mrn_no", ""));
		setKvJoCrrKnt(JSPUtil.getParameter(request, prefix + "kv_jo_crr_knt", ""));
		setKvTtlTsFeuQty(JSPUtil.getParameter(request, prefix + "kv_ttl_ts_feu_qty", ""));
		setKvCbm(JSPUtil.getParameter(request, prefix + "kv_cbm", ""));
		setKvTtlLc45ftQty(JSPUtil.getParameter(request, prefix + "kv_ttl_lc_45ft_qty", ""));
		setTransChkCnt(JSPUtil.getParameter(request, prefix + "trans_chk_cnt", ""));
		setKvPortCdLo(JSPUtil.getParameter(request, prefix + "kv_port_cd_lo", ""));
		setKvVslCntCd(JSPUtil.getParameter(request, prefix + "kv_vsl_cnt_cd", ""));
		setTransPreCnt(JSPUtil.getParameter(request, prefix + "trans_pre_cnt", ""));
		setKvVslNm(JSPUtil.getParameter(request, prefix + "kv_vsl_nm", ""));
		setSvTotTsCntr40(JSPUtil.getParameter(request, prefix + "sv_tot_ts_cntr_40", ""));
		setOldSndChk(JSPUtil.getParameter(request, prefix + "old_snd_chk", ""));
		setKvTDate(JSPUtil.getParameter(request, prefix + "kv_t_date", ""));
		setMrnChkNo(JSPUtil.getParameter(request, prefix + "mrn_chk_no", ""));
		setSvTotTsCntr45(JSPUtil.getParameter(request, prefix + "sv_tot_ts_cntr_45", ""));
		setInDelLog(JSPUtil.getParameter(request, prefix + "in_del_log", ""));
		setInChgMeth(JSPUtil.getParameter(request, prefix + "in_chg_meth", ""));
		setKvEtdDt(JSPUtil.getParameter(request, prefix + "kv_etd_dt", ""));
		setSvWgtQty(JSPUtil.getParameter(request, prefix + "sv_wgt_qty", ""));
		setKvTtlLcTeuQty(JSPUtil.getParameter(request, prefix + "kv_ttl_lc_teu_qty", ""));
		setObType(JSPUtil.getParameter(request, prefix + "ob_type", ""));
		setKvBg(JSPUtil.getParameter(request, prefix + "kv_bg", ""));
		setPolLoc(JSPUtil.getParameter(request, prefix + "pol_loc", ""));
		setKvSvBlSCnt(JSPUtil.getParameter(request, prefix + "kv_sv_bl_s_cnt", ""));
		setPolTml(JSPUtil.getParameter(request, prefix + "pol_tml", ""));
		setMrnPort(JSPUtil.getParameter(request, prefix + "mrn_port", ""));
		setMrnType(JSPUtil.getParameter(request, prefix + "mrn_type", ""));
		setCreatedtype(JSPUtil.getParameter(request, prefix + "createdtype", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setKvKgs(JSPUtil.getParameter(request, prefix + "kv_kgs", ""));
		setVslEngNm(JSPUtil.getParameter(request, prefix + "vsl_eng_nm", ""));
		setSvCntrFCnt(JSPUtil.getParameter(request, prefix + "sv_cntr_f_cnt", ""));
		setSvTotTsCntr20(JSPUtil.getParameter(request, prefix + "sv_tot_ts_cntr_20", ""));
		setInChgComp(JSPUtil.getParameter(request, prefix + "in_chg_comp", ""));
		setSvTotMtCntr20(JSPUtil.getParameter(request, prefix + "sv_tot_mt_cntr_20", ""));
		setKvRpliMrnPort(JSPUtil.getParameter(request, prefix + "kv_rpli_mrn_port", ""));
		setIoBndCd(JSPUtil.getParameter(request, prefix + "io_bnd_cd", ""));
		setKvNykc(JSPUtil.getParameter(request, prefix + "kv_nykc", ""));
		setKvTtlWgt(JSPUtil.getParameter(request, prefix + "kv_ttl_wgt", ""));
		setKvTtlLcFeuQty(JSPUtil.getParameter(request, prefix + "kv_ttl_lc_feu_qty", ""));
		setKvTtlTsTeuQty(JSPUtil.getParameter(request, prefix + "kv_ttl_ts_teu_qty", ""));
		setObDeclTpCd(JSPUtil.getParameter(request, prefix + "ob_decl_tp_cd", ""));
	}
	...
	public KorBkgCstmsVvdSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] kvNykc = (JSPUtil.getParameter(request, prefix	+ "kv_nykc", length));
		...
		return getKorBkgCstmsVvdSmryVOs();
	}
	 ...
	 * @return KorBkgCstmsVvdSmryVO[]
	 */
	public KorBkgCstmsVvdSmryVO[] getKorBkgCstmsVvdSmryVOs(){
	...
	*/
	public void unDataFormat(){
		...
		this.kvNykc = this.kvNykc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
