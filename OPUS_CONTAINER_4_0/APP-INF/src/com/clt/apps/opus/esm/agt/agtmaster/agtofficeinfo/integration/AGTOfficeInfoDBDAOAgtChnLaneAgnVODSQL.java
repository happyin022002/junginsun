...
*@FileName : AGTOfficeInfoDBDAOAgtChnLaneAgnVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeInfoDBDAOAgtChnLaneAgnVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTOfficeInfoDBDAOAgtChnLaneAgnVODSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeInfoDBDAOAgtChnLaneAgnVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
