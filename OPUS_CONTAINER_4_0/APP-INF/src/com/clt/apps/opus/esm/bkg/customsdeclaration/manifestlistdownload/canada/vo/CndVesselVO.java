...
*@FileName : CndVesselVO.java
*@FileTitle : CndVesselVO
*Open Issues :
*Change history :
...
public class CndVesselVO extends VesselVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<CndVesselVO> models = new ArrayList<CndVesselVO>();
	...
	public CndVesselVO(String ibflag, String pagerows, String vslCd, String lloydNo, String vslRgstCntCd, String vslEngNm, String rgstPortCd, String rgstNo, String rgstDt, String grsRgstTongWgt, String netRgstTongWgt, String dwtWgt, String crwKnt, String callSgnNo, String loaLen, String vslSftCstruCertiExpDt, String vslSftRdoCertiExpDt, String vslSftEqCertiExpDt, String vslLodLineCertiExpDt, String vslDeratCertiExpDt, String crrCd, String updUsrId) {
	 ...
	 * @return CndVesselVO[]
	 */
	public CndVesselVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CndVesselVO[]
	 */
	public CndVesselVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CndVesselVO model = null;
	 ...
	 * @return CndVesselVO[]
	 */
	public CndVesselVO[] getCndVesselVOs(){
		CndVesselVO[] vos = (CndVesselVO[])models.toArray(new CndVesselVO[models.size()]);
		return vos;
	}
