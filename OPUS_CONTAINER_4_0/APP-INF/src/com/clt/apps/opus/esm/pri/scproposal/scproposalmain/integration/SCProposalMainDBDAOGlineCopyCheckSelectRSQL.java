...
public class SCProposalMainDBDAOGlineCopyCheckSelectRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , DECODE(OL.OLD_CMDT_CHK,1,0,SIGN(NVL(CM.CMDT_CHK,0))) AS CMDT_CHK" ).append("\n"); 
		query.append("     , DECODE(OL.OLD_CMDT_CHK,1,0,SIGN(NVL(CT.CMDT_TPW_CHK,0))) AS CMDT_TPW_CHK" ).append("\n"); 
