...
*@FileName : EurCustomsTransmissionDBDAOsearchBkgQtyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurCustomsTransmissionDBDAOsearchBkgQtyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurCustomsTransmissionDBDAOsearchBkgQtyRSQL(){
		setQuery();
		...
		query.append("FileName : EurCustomsTransmissionDBDAOsearchBkgQtyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
