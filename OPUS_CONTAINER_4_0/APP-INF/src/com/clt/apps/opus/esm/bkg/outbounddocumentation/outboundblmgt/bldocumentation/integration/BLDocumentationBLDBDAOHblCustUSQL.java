...
*@FileName : BLDocumentationBLDBDAOHblCustUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationBLDBDAOHblCustUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLDocumentationBLDBDAOHblCustUSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationBLDBDAOHblCustUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
