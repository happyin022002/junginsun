...
*@FileName : FwrdRefVvdVO.java
*@FileTitle : FwrdRefVvdVO
*Open Issues :
*Change history :
...
public class FwrdRefVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FwrdRefVvdVO> models = new ArrayList<FwrdRefVvdVO>();
	...
	public FwrdRefVvdVO(String ibflag, String pagerows, String bkgNo, String myFwrdRefCd, String myFwrdVslDesc) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMyFwrdRefCd(JSPUtil.getParameter(request, "my_fwrd_ref_cd", ""));
	 ...
	 * @return FwrdRefVvdVO[]
	 */
	public FwrdRefVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FwrdRefVvdVO[]
	 */
	public FwrdRefVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FwrdRefVvdVO model = null;
	...
	public FwrdRefVvdVO[] getFwrdRefVvdVOs(){
		FwrdRefVvdVO[] vos = (FwrdRefVvdVO[])models.toArray(new FwrdRefVvdVO[models.size()]);
		return vos;
	}
