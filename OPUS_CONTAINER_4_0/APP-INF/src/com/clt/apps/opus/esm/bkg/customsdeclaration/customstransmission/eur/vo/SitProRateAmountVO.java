...
*@FileName : SitProRateAmountVO.java
*@FileTitle : SitProRateAmountVO
*Open Issues :
*Change history :
...
public class SitProRateAmountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SitProRateAmountVO> models = new ArrayList<SitProRateAmountVO>();
	...
	public SitProRateAmountVO() {}

	public SitProRateAmountVO(String ibflag, String pagerows, String fctype, String rate, String revenueton, String ppd, String cct, String currencycode, String exchrate, String tariff, String pertype, String rateofc, String thrPayer) {
		this.ibflag = ibflag;
		this.rate = rate;
		this.tariff = tariff;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("thr_payer", getThrPayer());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("thr_payer", "thrPayer");
	 ...
	 * @return thrPayer
	 */
	public String getThrPayer() {
		return this.thrPayer;
	}
	 ...
	 * @param thrPayer
	 */
	public void setThrPayer(String thrPayer){
		this.thrPayer = thrPayer;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setThrPayer(JSPUtil.getParameter(request, "thr_payer", ""));
	 ...
	 * @param request
	 * @return SitProRateAmountVO[]
	 */
	public SitProRateAmountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SitProRateAmountVO[]
	 */
	public SitProRateAmountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SitProRateAmountVO model = null;
		...
		try {
			...
			String[] thrPayer = (JSPUtil.getParameter(request, prefix	+ "thr_payer", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			
			for (int i = 0; i < length; i++) {
				model = new SitProRateAmountVO();
				if (ibflag[i] != null)
	 ...
	 * @return SitProRateAmountVO[]
	 */
	public SitProRateAmountVO[] getSitProRateAmountVOs(){
		SitProRateAmountVO[] vos = (SitProRateAmountVO[])models.toArray(new SitProRateAmountVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.thrPayer = this.thrPayer .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
