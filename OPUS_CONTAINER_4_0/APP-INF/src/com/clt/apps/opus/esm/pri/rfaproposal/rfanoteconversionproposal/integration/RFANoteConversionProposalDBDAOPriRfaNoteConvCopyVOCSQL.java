...
*@FileName : RFANoteConversionProposalDBDAOPriRfaNoteConvCopyVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteConversionProposalDBDAOPriRfaNoteConvCopyVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFANoteConversionProposalDBDAOPriRfaNoteConvCopyVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFANoteConversionProposalDBDAOPriRfaNoteConvCopyVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RFA_NOTE_CONV_CPY" ).append("\n"); 
		query.append("(" ).append("\n"); 
