...
public class ESM_PRI_0026HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0026Event event = new EsmPri0026Event();

		if (command.isCommand(FormCommand.MODIFY01)) {
			event.setPriSpScpRtCmdtVOS((PriSpScpRtCmdtVO[]) getVOs(request, PriSpScpRtCmdtVO.class, ""));
