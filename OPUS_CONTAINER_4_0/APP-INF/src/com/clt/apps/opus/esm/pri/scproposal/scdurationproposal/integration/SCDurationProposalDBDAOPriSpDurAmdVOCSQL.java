...
*@FileName : SCDurationProposalDBDAOPriSpDurAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAOPriSpDurAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCDurationProposalDBPriSpDurAmdVO
	  * </pre>
	  */
	public SCDurationProposalDBDAOPriSpDurAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAOPriSpDurAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_SP_DUR" ).append("\n"); 
