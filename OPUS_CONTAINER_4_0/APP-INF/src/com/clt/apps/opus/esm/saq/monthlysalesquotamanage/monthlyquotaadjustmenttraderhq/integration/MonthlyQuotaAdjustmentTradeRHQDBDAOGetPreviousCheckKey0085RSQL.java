...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetPreviousCheckKey0085RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOGetPreviousCheckKey0085RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MonthlyQuotaAdjustmentTradeRHQ의 데이타를 조회하기 위한 mqta_mdl_ver_no, sls_fcast_pub_no 값을 조회한다.
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOGetPreviousCheckKey0085RSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOGetPreviousCheckKey0085RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
