...
*@FileName : SCGRICalculationProposalDBDAORsltGriCalcOrgPntListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAORsltGriCalcOrgPntListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAORsltGriCalcOrgPntListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAORsltGriCalcOrgPntListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
