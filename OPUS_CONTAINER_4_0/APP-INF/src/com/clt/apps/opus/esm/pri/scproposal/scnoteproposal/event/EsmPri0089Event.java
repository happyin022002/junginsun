...
public class EsmPri0089Event extends EventSupport {
	...
	public void setRsltCtrtCluzListVOS(RsltCtrtCluzListVO[] rsltCtrtCluzListVOs){
		if (rsltCtrtCluzListVOs != null) {
			RsltCtrtCluzListVO[] tmpVOs = new RsltCtrtCluzListVO[rsltCtrtCluzListVOs.length];
			System.arraycopy(rsltCtrtCluzListVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.rsltCtrtCluzListVOs = tmpVOs;
		}
	}
	...
	public RsltCtrtCluzListVO[] getRsltCtrtCluzListVOS(){
		RsltCtrtCluzListVO[] tmpVOs = null;
		if (this.rsltCtrtCluzListVOs != null) {
			tmpVOs = new RsltCtrtCluzListVO[rsltCtrtCluzListVOs.length];
			System.arraycopy(rsltCtrtCluzListVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
