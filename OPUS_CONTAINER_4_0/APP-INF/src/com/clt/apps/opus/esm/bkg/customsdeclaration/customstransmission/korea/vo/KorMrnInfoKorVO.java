...
public class KorMrnInfoKorVO extends AbstractValueObject {
	...
	public KorMrnInfoKorVO(String ibflag, String pagerows, String mrnNo, String mrnChkNo, String ioBndCd, String vvdSeq, String vvd, String polCd, String podCd, String podTml, String inType) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.inType = inType;
		this.polCd = polCd;
