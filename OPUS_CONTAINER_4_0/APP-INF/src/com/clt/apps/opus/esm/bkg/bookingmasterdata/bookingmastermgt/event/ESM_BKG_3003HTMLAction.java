...
*@FileName : ESM_BKG_3003HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class ESM_BKG_3003HTMLAction  extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_3003HTMLAction 객체를 생성
	 */
	public ESM_BKG_3003HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmBkg3003Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg3003Event event = new EsmBkg3003Event();
