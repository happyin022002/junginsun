...
*@FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrSealCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrSealCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrSealCSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrSealCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CntrSealCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_SEAL_NO" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("  X.VSL_CD,         X.SKD_VOY_NO,       X.SKD_DIR_CD,   X.BL_NO,         X.CSTMS_PORT_CD,    X.CNTR_NO, SN.CNTR_SEAL_SEQ" ).append("\n"); 
