...
*@FileName : AusCustomsTransmissionDBDAOsearchCntrBaseInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOsearchCntrBaseInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOsearchCntrBaseInfoRSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOsearchCntrBaseInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       BVD.BL_NO AS BL_NO," ).append("\n"); 
		query.append("       BVD.BKG_NO AS BKG_NO," ).append("\n"); 
		...
		query.append("       BVD.BKG_NO AS B_BKG_ID," ).append("\n"); 
		...
		query.append("       BVD.BKG_POL_CD AS POL_BKG_LOC," ).append("\n"); 
		query.append("       (SELECT LOC_NM" ).append("\n"); 
		query.append("          FROM MDM_LOCATION" ).append("\n"); 
		query.append("         WHERE LOC_CD = BVD.BKG_POL_CD) POL_BKG_LOC_DESC," ).append("\n"); 
		query.append("       'POD' AS POD_BKG_LOC_TYPE," ).append("\n"); 
		query.append("       BVD.BKG_POD_CD AS POD_BKG_LOC," ).append("\n"); 
		query.append("       (SELECT LOC_NM" ).append("\n"); 
		query.append("          FROM MDM_LOCATION" ).append("\n"); 
		query.append("         WHERE LOC_CD = BVD.BKG_POD_CD) POD_BKG_LOC_DESC," ).append("\n"); 
		query.append("       @[usr_id] AS USR_ID" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("  FROM (SELECT DECODE(LAG(BK.BL_NO) OVER(ORDER BY BK.BL_NO, BV.POL_CD, BV.POD_CD, BDC.CNTR_NO), BK.BL_NO, 0, 1) AS SEQ," ).append("\n"); 
		query.append("               COUNT(DISTINCT BDC.CNTR_NO) OVER() AS CNTR_CNT," ).append("\n"); 
		query.append("               BV.BKG_NO," ).append("\n"); 
		query.append("               BK.BL_NO," ).append("\n"); 
		query.append("               BV.POL_CD AS VVD_POL_CD," ).append("\n"); 
		query.append("               BV.POD_CD AS VVD_POD_CD," ).append("\n"); 
