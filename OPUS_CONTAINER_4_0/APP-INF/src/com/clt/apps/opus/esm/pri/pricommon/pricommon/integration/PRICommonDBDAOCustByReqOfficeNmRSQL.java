...
*@FileName : PRICommonDBDAOCustByReqOfficeNmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAOCustByReqOfficeNmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PRICommonDBDAOCustByReqOfficeNmRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAOCustByReqOfficeNmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE  SREP_CD = @[etc1]" ).append("\n"); 
