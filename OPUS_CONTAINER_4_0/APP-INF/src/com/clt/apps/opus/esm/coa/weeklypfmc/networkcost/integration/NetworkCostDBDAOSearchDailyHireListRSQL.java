...
public class NetworkCostDBDAOSearchDailyHireListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   ,VSL_CLSS_CAPA		VSL_CLSS_CAPA	--20151201.ADD" ).append("\n"); 
		query.append("   ,STND_LDB_CAPA		STND_LDB_CAPA	--20151201.ADD" ).append("\n"); 
		...
		query.append("           , C3.VSL_CLSS_CAPA			--20151201.ADD" ).append("\n"); 
		query.append("           , C3.STND_LDB_CAPA			--20151201.ADD" ).append("\n"); 
		...
		query.append("                   , B2.VSL_CLSS_CAPA		--20151201.ADD" ).append("\n"); 
		query.append("                   , B2.STND_LDB_CAPA		--20151201.ADD" ).append("\n"); 
		...
		query.append("                          ,A1.STND_LDB_CAPA  STND_LDB_CAPA			--20151201.ADD" ).append("\n"); 
