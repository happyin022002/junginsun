...
public class BDRCorrectionDBDAOSearchCaChargeRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SELECT BKG_NO, CORR_NO, CHG_CD, RAT_UT_CD, RAT_AS_QTY, CURR_CD, SUM(CHG_UT_AMT) AS CHG_UT_AMT, SUM(CHG_AMT) AS CHG_AMT,FRT_TERM_CD, N3PTY_RCV_OFC_CD" ).append("\n"); 
		...
		query.append("GROUP BY BKG_NO, CORR_NO, CHG_CD, RAT_UT_CD, RAT_AS_QTY, CURR_CD, FRT_TERM_CD, N3PTY_RCV_OFC_CD" ).append("\n"); 
		...
		query.append("and corr_no = @[ca_no]" ).append("\n"); 
		query.append("AND FRT_INCL_XCLD_DIV_CD       = 'N'" ).append("\n"); 
		query.append("GROUP BY BKG_NO, CORR_NO, CHG_CD, RAT_UT_CD, RAT_AS_QTY, CURR_CD, FRT_TERM_CD, N3PTY_RCV_OFC_CD) new" ).append("\n"); 
