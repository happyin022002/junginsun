 ...
 *@FileName : RsltPriSgGrpLocVO.java
 *@FileTitle : RsltPriSgGrpLocVO
 *Open Issues :
 *Change history :
...
package com.clt.apps.opus.esm.pri.scguideline.scgrouplocationguideline.vo;
...
public class RsltPriSgGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<RsltPriSgGrpLocVO> models = new ArrayList<RsltPriSgGrpLocVO>();
	...
	public RsltPriSgGrpLocVO() {
	}

	public RsltPriSgGrpLocVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String grpLocSeq,
			String prcGrpLocCd, String prcGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
	...
	public RsltPriSgGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public RsltPriSgGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSgGrpLocVO model = null;
		...
		return getRsltPriSgGrpLocVOs();
	}

	public RsltPriSgGrpLocVO[] getRsltPriSgGrpLocVOs() {
		RsltPriSgGrpLocVO[] vos = (RsltPriSgGrpLocVO[]) models.toArray(new RsltPriSgGrpLocVO[models.size()]);
		return vos;
	}
