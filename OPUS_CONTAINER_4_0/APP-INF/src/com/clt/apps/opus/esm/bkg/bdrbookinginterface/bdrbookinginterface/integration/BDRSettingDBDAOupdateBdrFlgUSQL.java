...
public class BDRSettingDBDAOupdateBdrFlgUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       TRNK_AUTO_BDR_DT = GLOBALDATE_PKG.TIME_CONV_FNC(COM_CONSTANTMGR_PKG.COM_GETBASELOCATIONCODE_FNC(),SYSDATE-1,POL_CD)," ).append("\n"); 
		query.append("       #elseif ('FDR'==${upd_cd})" ).append("\n"); 
		query.append("       FDR_BDR_FLG = 'Y'," ).append("\n"); 
		query.append("	   FDR_AUTO_BDR_FLG = 'Y',		" ).append("\n"); 
		query.append("       FDR_AUTO_BDR_DT = GLOBALDATE_PKG.TIME_CONV_FNC(COM_CONSTANTMGR_PKG.COM_GETBASELOCATIONCODE_FNC(),SYSDATE-1,POL_CD)," ).append("\n"); 
