...
public class RejectEdiCustVO extends AbstractValueObject {
	...
	/* Column Info */
	private String ibcsAddr4 = null;
	/* Column Info */
	private String ibcsAddr5 = null;
	/* Column Info */
	private String unLocCd = null;
	/* Column Info */
	private String prnrCustCd = null;
	/* Column Info */
	...
	public RejectEdiCustVO(String ibflag, String pagerows, String ibcsTp, String ibcsNm1, String ibcsNm2, String ibcsAddr1, String ibcsAddr2, String ibcsAddr3, String ibcsCNm1, String ibcsCNm2, String cntCd, String custCd, String ibcsCustLoc, String ibcsStreet, String ibcsLocCd, String ibcsLocNm, String ibcsZipCd, String ibcsCTp, String ibcsCTel, String ibcsCFax, String ibcsCEmail, String ibcsAddr4, String ibcsAddr5, String unLocCd, String prnrCustCd, String prnrRefNo, String steCd) {
		...
		this.ibcsAddr4 = ibcsAddr4;
		this.ibcsAddr5 = ibcsAddr5;
		this.unLocCd = unLocCd;
		this.prnrCustCd = prnrCustCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ibcs_addr4", getIbcsAddr4());
		this.hashColumns.put("ibcs_addr5", getIbcsAddr5());
		this.hashColumns.put("un_loc_cd", getUnLocCd());
		this.hashColumns.put("prnr_cust_cd", getPrnrCustCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ibcs_addr4", "ibcsAddr4");
		this.hashFields.put("ibcs_addr5", "ibcsAddr5");
		this.hashFields.put("un_loc_cd", "unLocCd");
		this.hashFields.put("prnr_cust_cd", "prnrCustCd");
	 ...
	 * @return ibcsAddr4
	 */
	public String getIbcsAddr4() {
		return this.ibcsAddr4;
	}
	 ...
	 * @return ibcsAddr5
	 */
	public String getIbcsAddr5() {
		return this.ibcsAddr5;
	}
	 ...
	 * @return prnrCustCd
	 */
	public String getPrnrCustCd() {
		return this.prnrCustCd;
	}
	 ...
	 * @param ibcsAddr4
	 */
	public void setIbcsAddr4(String ibcsAddr4) {
		this.ibcsAddr4 = ibcsAddr4;
	}
	 ...
	 * @param ibcsAddr5
	 */
	public void setIbcsAddr5(String ibcsAddr5) {
		this.ibcsAddr5 = ibcsAddr5;
	}
	 ...
	 * @param prnrCustCd
	 */
	public void setPrnrCustCd(String prnrCustCd) {
		this.prnrCustCd = prnrCustCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIbcsAddr4(JSPUtil.getParameter(request, "ibcs_addr4", ""));
		setIbcsAddr5(JSPUtil.getParameter(request, "ibcs_addr5", ""));
		setUnLocCd(JSPUtil.getParameter(request, "un_loc_cd", ""));
		setPrnrCustCd(JSPUtil.getParameter(request, "prnr_cust_cd", ""));
		setPrnrRefNo(JSPUtil.getParameter(request, "prnr_ref_no", ""));
	...
	public RejectEdiCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ibcsAddr4 = (JSPUtil.getParameter(request, prefix	+ "ibcs_addr4", length));
			String[] ibcsAddr5 = (JSPUtil.getParameter(request, prefix	+ "ibcs_addr5", length));
			String[] unLocCd = (JSPUtil.getParameter(request, prefix	+ "un_loc_cd", length));
			String[] prnrCustCd = (JSPUtil.getParameter(request, prefix	+ "prnr_cust_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ibcsAddr4[i] != null)
					model.setIbcsAddr4(ibcsAddr4[i]);
				if (ibcsAddr5[i] != null)
					model.setIbcsAddr5(ibcsAddr5[i]);
				if (unLocCd[i] != null)
					model.setUnLocCd(unLocCd[i]);
				if (prnrCustCd[i] != null)
					model.setPrnrCustCd(prnrCustCd[i]);
				if (prnrRefNo[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.ibcsAddr4 = this.ibcsAddr4 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibcsAddr5 = this.ibcsAddr5 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.unLocCd = this.unLocCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.prnrCustCd = this.prnrCustCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
