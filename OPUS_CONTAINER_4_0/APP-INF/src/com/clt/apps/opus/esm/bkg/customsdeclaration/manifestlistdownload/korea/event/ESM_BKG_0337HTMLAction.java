...
*@FileName : ESM_BKG_0337HTMLAction.java
*@FileTitle : ESM_BKG_0337HTMLAction
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0337HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 2792293631096541043L;

	public ESM_BKG_0337HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		// EVENT 생성
		EsmBkg0337Event event = new EsmBkg0337Event();

		// COMMAND 구분에 따른 처리
		if (command.isCommand(FormCommand.SEARCH)) {
			// 조회의 경우 처리
			KorMsnCreateVO korMrnInfoVO = (KorMsnCreateVO)getVO(request, KorMsnCreateVO.class);
			event.setKorMrnInfoVO(korMrnInfoVO);
