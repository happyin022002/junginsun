 ...
 *@FileName : ESM_SAQ_0184HTMLAction.java
...
public class ESM_SAQ_0184HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_SAQ_0184HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0184HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0184Event event = new EsmSaq0184Event();
