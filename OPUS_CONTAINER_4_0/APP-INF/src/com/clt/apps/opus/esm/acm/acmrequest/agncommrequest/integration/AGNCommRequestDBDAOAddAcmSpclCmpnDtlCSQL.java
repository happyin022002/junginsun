...
public class AGNCommRequestDBDAOAddAcmSpclCmpnDtlCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(BKG_NO, SPCL_OFC_CD, SPCL_CMPN_SEQ, CNTR_TPSZ_CD, BKG_VOL_QTY, IF_DTRB_AMT, CURR_CD, PAY_IF_DTRB_AMT, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT)" ).append("\n"); 
		...
		query.append(",ROUND(ROUND(C.IF_AMT     * (Q.IND/Q.TTL),2)* C.PAY_XCH_RT,3)  AS PAY_IF_DTRB_AMT" ).append("\n"); 
