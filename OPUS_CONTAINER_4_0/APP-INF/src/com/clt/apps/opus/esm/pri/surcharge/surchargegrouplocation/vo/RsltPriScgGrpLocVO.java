...
*@FileName : RsltPriScgGrpLocVO.java
*@FileTitle : RsltPriScgGrpLocVO
*Open Issues :
*Change history :
...
public class RsltPriScgGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriScgGrpLocVO> models = new ArrayList<RsltPriScgGrpLocVO>();
	...
	public RsltPriScgGrpLocVO() {}

	public RsltPriScgGrpLocVO(String ibflag, String pagerows, String svcScpCd, String chgCd, String grpLocSeq, String scgGrpLocCd, String scgGrpLocDesc, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 */
	public RsltPriScgGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriScgGrpLocVO[]
	 */
	public RsltPriScgGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriScgGrpLocVO model = null;
	 ...
	 * @return RsltPriScgGrpLocVO[]
	 */
	public RsltPriScgGrpLocVO[] getRsltPriScgGrpLocVOs(){
		RsltPriScgGrpLocVO[] vos = (RsltPriScgGrpLocVO[])models.toArray(new RsltPriScgGrpLocVO[models.size()]);
		return vos;
	}
