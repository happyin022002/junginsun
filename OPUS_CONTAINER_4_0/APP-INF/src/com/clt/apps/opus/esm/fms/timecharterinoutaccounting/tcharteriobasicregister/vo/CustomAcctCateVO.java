...
public class CustomAcctCateVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String chkAddress = null;

    /* Column Info */
    private String chkBrokerage = null;

    /* Column Info */
    private String prevAddress = null;

    /* Column Info */
    private String prevBrokerage = null;

    /* Column Info */
    private String chkHire = null;

    /* Column Info */
    private String prevHire = null;

    /* Column Info */
    private String chkHireRevenue = null;

    /* Column Info */
    private String prevHireRevenue = null;
	 ...
	 * @return 
	 */
    public CustomAcctCateVO(String ibflag, String pagerows, String acctCd, String acctEngNm, String acctItmSeq, String acctItmNm, String chkOtherExp, String chkCharterer, String chkOwner, String chkPrepaymentp, String chkPrepayments, String chkManualSlip, String chkOffHire, String chkVvdRequired, String chkBodborIf, String prevOtherExp, String prevCharterer, String prevOwner, String prevPrepaymentp, String prevPrepayments, String prevManualSlip, String prevOffHire, String prevVvdRequired, String prevBodborIf, String fletAcctCateCd, String creUsrId, String updUsrId, String chkAddress, String chkBrokerage, String prevAddress, String prevBrokerage, String chkHire, String prevHire, String chkHireRevenue, String prevHireRevenue) {
        ...
        this.chkBrokerage = chkBrokerage;
        this.prevAddress = prevAddress;
        this.prevBrokerage = prevBrokerage;
        this.chkHire = chkHire;
        this.prevHire = prevHire;
        this.chkHireRevenue = chkHireRevenue;
        this.prevHireRevenue = prevHireRevenue;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("chk_address", getChkAddress());
        this.hashColumns.put("chk_brokerage", getChkBrokerage());
        this.hashColumns.put("prev_address", getPrevAddress());
        this.hashColumns.put("prev_brokerage", getPrevBrokerage());
        this.hashColumns.put("chk_hire", getChkHire());
        this.hashColumns.put("prev_hire", getPrevHire());
        this.hashColumns.put("chk_hire_revenue", getChkHireRevenue());
        this.hashColumns.put("prev_hire_revenue", getPrevHireRevenue());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("chk_address", "chkAddress");
        this.hashFields.put("chk_brokerage", "chkBrokerage");
        this.hashFields.put("prev_address", "prevAddress");
        this.hashFields.put("prev_brokerage", "prevBrokerage");
        this.hashFields.put("chk_hire", "chkHire");
        this.hashFields.put("prev_hire", "prevHire");
        this.hashFields.put("chk_hire_revenue", "chkHireRevenue");
        this.hashFields.put("prev_hire_revenue", "prevHireRevenue");
    ...
    public void setChkBrokerage(String chkBrokerage) {
        this.chkBrokerage = chkBrokerage;
    }

    public String getChkBrokerage() {
        return this.chkBrokerage;
    }
    ...
    public void setPrevBrokerage(String prevBrokerage) {
        this.prevBrokerage = prevBrokerage;
    }

    public String getPrevBrokerage() {
        return this.prevBrokerage;
    }

    public void setChkHire(String chkHire) {
        this.chkHire = chkHire;
    }

    public String getChkHire() {
        return this.chkHire;
    }

    public void setPrevHire(String prevHire) {
        this.prevHire = prevHire;
    }

    public String getPrevHire() {
        return this.prevHire;
    }

    public void setChkHireRevenue(String chkHireRevenue) {
        this.chkHireRevenue = chkHireRevenue;
    }

    public String getChkHireRevenue() {
        return this.chkHireRevenue;
    }

    public void setPrevHireRevenue(String prevHireRevenue) {
        this.prevHireRevenue = prevHireRevenue;
    }

    public String getPrevHireRevenue() {
        return this.prevHireRevenue;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        setChkOffHire(JSPUtil.getParameter(request, prefix + "chk_off_hire", ""));
        setAcctCd(JSPUtil.getParameter(request, prefix + "acct_cd", ""));
        setChkCharterer(JSPUtil.getParameter(request, prefix + "chk_charterer", ""));
        setChkPrepayments(JSPUtil.getParameter(request, prefix + "chk_prepayments", ""));
        setAcctItmSeq(JSPUtil.getParameter(request, prefix + "acct_itm_seq", ""));
        setUpdUsrId(JSPUtil.getParameter(request, prefix + "upd_usr_id", ""));
        setChkPrepaymentp(JSPUtil.getParameter(request, prefix + "chk_prepaymentp", ""));
        setPrevOtherExp(JSPUtil.getParameter(request, prefix + "prev_other_exp", ""));
        setPrevVvdRequired(JSPUtil.getParameter(request, prefix + "prev_vvd_required", ""));
        setChkVvdRequired(JSPUtil.getParameter(request, prefix + "chk_vvd_required", ""));
        setChkBodborIf(JSPUtil.getParameter(request, prefix + "chk_bodbor_if", ""));
        setPrevPrepayments(JSPUtil.getParameter(request, prefix + "prev_prepayments", ""));
        setChkOtherExp(JSPUtil.getParameter(request, prefix + "chk_other_exp", ""));
        setFletAcctCateCd(JSPUtil.getParameter(request, prefix + "flet_acct_cate_cd", ""));
        setPrevOwner(JSPUtil.getParameter(request, prefix + "prev_owner", ""));
        setChkOwner(JSPUtil.getParameter(request, prefix + "chk_owner", ""));
        setPrevPrepaymentp(JSPUtil.getParameter(request, prefix + "prev_prepaymentp", ""));
        setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
        setPrevManualSlip(JSPUtil.getParameter(request, prefix + "prev_manual_slip", ""));
        setPrevOffHire(JSPUtil.getParameter(request, prefix + "prev_off_hire", ""));
        setPrevCharterer(JSPUtil.getParameter(request, prefix + "prev_charterer", ""));
        setPrevBodborIf(JSPUtil.getParameter(request, prefix + "prev_bodbor_if", ""));
        setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
        setChkManualSlip(JSPUtil.getParameter(request, prefix + "chk_manual_slip", ""));
        ...
        setChkAddress(JSPUtil.getParameter(request, prefix + "chk_address", ""));
        setChkBrokerage(JSPUtil.getParameter(request, prefix + "chk_brokerage", ""));
        setPrevAddress(JSPUtil.getParameter(request, prefix + "prev_address", ""));
        setPrevBrokerage(JSPUtil.getParameter(request, prefix + "prev_brokerage", ""));
        setChkHire(JSPUtil.getParameter(request, prefix + "chk_hire", ""));
        setPrevHire(JSPUtil.getParameter(request, prefix + "prev_hire", ""));
        setChkHireRevenue(JSPUtil.getParameter(request, prefix + "chk_hire_revenue", ""));
        setPrevHireRevenue(JSPUtil.getParameter(request, prefix + "prev_hire_revenue", ""));
    }
    ...
    public CustomAcctCateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] chkAddress = (JSPUtil.getParameter(request, prefix + "chk_address", length));
            String[] chkBrokerage = (JSPUtil.getParameter(request, prefix + "chk_brokerage", length));
            String[] prevAddress = (JSPUtil.getParameter(request, prefix + "prev_address", length));
            String[] prevBrokerage = (JSPUtil.getParameter(request, prefix + "prev_brokerage", length));
            String[] chkHire = (JSPUtil.getParameter(request, prefix + "chk_hire", length));
            String[] prevHire = (JSPUtil.getParameter(request, prefix + "prev_hire", length));
            String[] chkHireRevenue = (JSPUtil.getParameter(request, prefix + "chk_hire_revenue", length));
	    	String[] prevHireRevenue = (JSPUtil.getParameter(request, prefix + "prev_hire_revenue", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (chkAddress[i] != null)
                    model.setChkAddress(chkAddress[i]);
                if (chkBrokerage[i] != null)
                    model.setChkBrokerage(chkBrokerage[i]);
                if (prevAddress[i] != null)
                    model.setPrevAddress(prevAddress[i]);
                if (prevBrokerage[i] != null)
                    model.setPrevBrokerage(prevBrokerage[i]);
                if (chkHire[i] != null)
                    model.setChkHire(chkHire[i]);
                if (prevHire[i] != null)
                    model.setPrevHire(prevHire[i]);
                if (chkHireRevenue[i] != null) 
		    		model.setChkHireRevenue(chkHireRevenue[i]);
				if (prevHireRevenue[i] != null) 
		    		model.setPrevHireRevenue(prevHireRevenue[i]);
