...
public class BLIssuanceDBDAOManageBlReIssueUSQL implements ISQLTemplate{
	...
	public BLIssuanceDBDAOManageBlReIssueUSQL(){
		...
		params.put("iss_cxl_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("	   CRE_DT, UPD_USR_ID, UPD_DT, ISS_CXL_FLG)" ).append("\n"); 
		...
		query.append("	   @[riss_flg], @[bl_riss_rsn_cd], @[riss_rsn], " ).append("\n"); 
		query.append("	   @[riss_cfm_flg], @[riss_rdem_flg], @[cre_usr_id], " ).append("\n"); 
		query.append("	   sysdate, @[upd_usr_id], sysdate, NVL(@[iss_cxl_flg],'N')" ).append("\n"); 
		query.append("	)" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("		,ISS_CXL_FLG	 = NVL(@[iss_cxl_flg],'N')" ).append("\n"); 
