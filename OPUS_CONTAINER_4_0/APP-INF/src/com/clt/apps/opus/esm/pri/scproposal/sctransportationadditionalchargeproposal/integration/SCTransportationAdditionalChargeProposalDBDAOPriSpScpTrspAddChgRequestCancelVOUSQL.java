...
*@FileName : SCTransportationAdditionalChargeProposalDBDAOPriSpScpTrspAddChgRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCTransportationAdditionalChargeProposalDBDAOPriSpScpTrspAddChgRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCTransportationAdditionalChargeProposalDBDAOPriSpScpTrspAddChgRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCTransportationAdditionalChargeProposalDBDAOPriSpScpTrspAddChgRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
