...
*@FileName : ESM_BKG_0229_09HTMLAction.java
...
public class ESM_BKG_0229_09HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0229_09HTMLAction 객체를 생성
	 */
	public ESM_BKG_0229_09HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg022909Event event = new EsmBkg022909Event();
		...
		{
			// AWK
			OpusAkVO[] opusAkVO = (OpusAkVO[]) getVOs(request, OpusAkVO.class, "t9sheet1_");
			int iMaxAwkSeq = 0;
			int iDataCnt = 0;
			...
			event.setBkgAwkCgoVOs(bkgAwkCgoVO);
		}
