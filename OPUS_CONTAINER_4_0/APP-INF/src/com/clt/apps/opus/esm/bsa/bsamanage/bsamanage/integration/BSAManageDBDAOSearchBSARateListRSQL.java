...
public class BSAManageDBDAOSearchBSARateListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      RANK() OVER (ORDER BY A.TRD_CD||A.RLANE_CD||A.DIR_CD||A.CNTR_TPSZ_CD||A.VOP_CD) GRP,					--20150820.MOD" ).append("\n"); 
		query.append("      MAX(A.BSA_SEQ) OVER(PARTITION BY A.TRD_CD||A.RLANE_CD||A.DIR_CD||A.CNTR_TPSZ_CD||A.VOP_CD) MAXSEQ,  	--20150820.MOD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("GROUP BY --20150820.MOD" ).append("\n"); 
		query.append("       A.TRD_CD, " ).append("\n"); 
		query.append("       A.RLANE_CD, " ).append("\n"); 
		query.append("       A.DIR_CD, " ).append("\n"); 
		query.append("       A.CNTR_TPSZ_CD, " ).append("\n"); 
