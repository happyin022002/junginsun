...
*@FileName : UnmatchBLDBDAOCheckTaaSelfSurchargeDiscrepancyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckTaaSelfSurchargeDiscrepancyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UnmatchBLDBDAOCheckTaaSelfSurchargeDiscrepancyRSQL
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckTaaSelfSurchargeDiscrepancyRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckTaaSelfSurchargeDiscrepancyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                      (" ).append("\n"); 
		query.append("                          CHG_CD      IN ( 'OIH', 'DIH' )" ).append("\n"); 
		...
		query.append("                                    AND     (" ).append("\n"); 
		query.append("                                                BR.RAT_UT_CD  = RA.RAT_UT_CD" ).append("\n"); 
		query.append("                                            OR  (" ).append("\n"); 
		query.append("                                                    BR.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
		...
		query.append("                                                  )" ).append("\n"); 
		query.append("                                            OR  (" ).append("\n"); 
		query.append("                                                    RA.RAT_UT_CD  IN ( '20', '40', 'HC', '45', '53' )" ).append("\n"); 
