...
*@FileName : ESM_BKG_0498HTMLAction.java
...
public class ESM_BKG_0498HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0498HTMLAction 객체를 생성
	 */
	public ESM_BKG_0498HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0498Event event = new EsmBkg0498Event();
        log.debug("::CALL::> ESM_BKG_0498_HTMLAction - " + command.getCommand());
        ...
        if(command.isCommand(FormCommand.DEFAULT)) {
        	...
        	BkgRfCgoVO[] bkgRfCgoVOs 	= (BkgRfCgoVO[])getVOs(request, BkgRfCgoVO .class,"sheet1_");
        	        	
        	String bkgNo = JSPUtil.getParameter(request, "bkg_no");
        	String rfChkFlg = JSPUtil.getParameter(request, "rf_chk_flg");
			
        	event.setBkgNo(bkgNo);
        	event.setBkgRfCgoVOs(bkgRfCgoVOs);
        	event.setRfChkFlg(rfChkFlg);
			...
			log.debug("event.setSpclReqInVOs=============="+event.getSpclReqInVOs());
