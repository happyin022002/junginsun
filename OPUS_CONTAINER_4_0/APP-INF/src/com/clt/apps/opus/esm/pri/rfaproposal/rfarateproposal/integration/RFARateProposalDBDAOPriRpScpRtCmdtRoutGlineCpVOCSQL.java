...
*@FileName : RFARateProposalDBDAOPriRpScpRtCmdtRoutGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCmdtRoutGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCmdtRoutGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCmdtRoutGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT C.SVC_SCP_CD, C.GLINE_SEQ, C.CMDT_HDR_SEQ, C.ROUT_SEQ" ).append("\n"); 
