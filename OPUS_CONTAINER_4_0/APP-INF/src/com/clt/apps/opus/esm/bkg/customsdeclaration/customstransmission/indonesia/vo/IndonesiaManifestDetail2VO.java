...
public class IndonesiaManifestDetail2VO extends AbstractValueObject {
	...
	public IndonesiaManifestDetail2VO(String ibflag, String pagerows, String shprCustNm, String cneeCustAddr, String ntfyCustAddr, String cmdtDesc, String cneeCustNm, String shprCustAddr, String ntfyCustNm, String mkDesc) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCneeCustAddr(JSPUtil.getParameter(request, prefix + "cnee_cust_addr", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setNtfyCustAddr(JSPUtil.getParameter(request, prefix + "ntfy_cust_addr", ""));
		setCneeCustNm(JSPUtil.getParameter(request, prefix + "cnee_cust_nm", ""));
		setCmdtDesc(JSPUtil.getParameter(request, prefix + "cmdt_desc", ""));
		setShprCustAddr(JSPUtil.getParameter(request, prefix + "shpr_cust_addr", ""));
