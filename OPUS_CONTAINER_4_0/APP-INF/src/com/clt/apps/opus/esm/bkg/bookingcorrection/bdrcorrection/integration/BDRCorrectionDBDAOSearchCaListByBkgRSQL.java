...
*@FileName : BDRCorrectionDBDAOSearchCaListByBkgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BDRCorrectionDBDAOSearchCaListByBkgRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BDRCorrectionDBDAOSearchCaListByBkgRSQL
	  * </pre>
	  */
	public BDRCorrectionDBDAOSearchCaListByBkgRSQL(){
		setQuery();
		...
		query.append("FileName : BDRCorrectionDBDAOSearchCaListByBkgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("DECODE(BC.RAT_FLG,  'Y', 'R', 'N') as RAT_FLG," ).append("\n"); 
		query.append("DECODE(BC.EXPN_FLG, 'Y', 'E', '') as EXPN_FLG," ).append("\n"); 
		query.append("DECODE(BC.DOC_PERF_EXPT_CD, NULL, 'N', '', 'N', 'Y') as DOC_PERF_EXPT_CD," ).append("\n"); 
		...
		query.append("BC.CORR_USR_ID" ).append("\n"); 
