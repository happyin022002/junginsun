...
public class ShipperVO extends AbstractValueObject {
	...
	public ShipperVO(String ibflag, String pagerows, String custCntCd, String custSeq, String modiCustCntCd, String modiCustSeq, String custLglEngNm, String cntrCustTpCd, String ofcCd) {
		this.ofcCd = ofcCd;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCntrCustTpCd(JSPUtil.getParameter(request, "cntr_cust_tp_cd", ""));
