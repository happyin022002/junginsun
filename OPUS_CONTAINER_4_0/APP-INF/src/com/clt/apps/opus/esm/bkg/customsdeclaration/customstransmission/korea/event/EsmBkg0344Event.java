...
public class EsmBkg0344Event extends EventSupport {
	...
	public KorEmpAmdManiVO[] getKorEmpAmdManiVOs() {
		KorEmpAmdManiVO[] rtnVOs = null;
		if (this.korEmpAmdManiVOs != null) {
			rtnVOs = Arrays.copyOf(korEmpAmdManiVOs, korEmpAmdManiVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setKorEmpAmdManiVOs(KorEmpAmdManiVO[] korEmpAmdManiVOs) {
		if (korEmpAmdManiVOs != null) {
			KorEmpAmdManiVO[] tmpVOs = Arrays.copyOf(korEmpAmdManiVOs, korEmpAmdManiVOs.length);
			this.korEmpAmdManiVOs = tmpVOs;
		}
	}
	 ...
	 */
	public void setKorCancelManifestTransmitVO(KorCancelManifestTransmitVO korCancelManifestTransmitVO) {
	 ...
	 */
	public void setKorAmendManifestTransmitVO(KorAmendManifestTransmitVO korAmendManifestTransmitVO) {
	 ...
	 */
	public void setKorDischManifestTransmitVO(KorDischManifestTransmitVO korDischManifestTransmitVO) {
	 ...
	 */
	public void setKorVslInfoNManifestCondVO(KorVslInfoNManifestCondVO korVslInfoNManifestCondVO) {
