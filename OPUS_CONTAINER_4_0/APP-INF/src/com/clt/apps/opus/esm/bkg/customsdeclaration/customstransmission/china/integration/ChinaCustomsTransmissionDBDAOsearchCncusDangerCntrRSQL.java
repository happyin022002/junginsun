...
public class ChinaCustomsTransmissionDBDAOsearchCncusDangerCntrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT IMDG_CLSS_CD AS CLSS," ).append("\n"); 
		query.append("       IMDG_PG_NO AS PAGE," ).append("\n"); 
		query.append("       IMDG_UN_NO AS UNDGNO," ).append("\n"); 
		query.append("       IMDG_SUBS_RSK_LBL_CD AS LABEL," ).append("\n"); 
		query.append("       FLSH_PNT_CDO_TEMP AS FLASH_POINT," ).append("\n"); 
		query.append("       EMS_NO," ).append("\n"); 
		query.append("       CNTC_PSON_NM AS CONTACT_NAME," ).append("\n"); 
		query.append("       CNTC_PSON_TELCM_NO AS CONTACT_TEL" ).append("\n"); 
		query.append("" ).append("\n"); 
