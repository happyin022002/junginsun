...
*@FileName : OpusCntrVO.java
*@FileTitle : OpusCntrVO
*Open Issues :
*Change history :
...
public class OpusCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpusCntrVO> models = new ArrayList<OpusCntrVO>();
	...
	public OpusCntrVO(String ibflag, String pagerows, String bkgNo, String cntrNo, String cntrTpszCd, String cntrPrtFlg, String sealNo1, String pckQty, String pckTpCd, String cntrWgt, String wgtUtCd, String measQty, String measUtCd, String poNo, String cntrCfmFlg, String cntrNoOld) {
	 ...
	 * @return OpusCntrVO[]
	 */
	public OpusCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpusCntrVO[]
	 */
	public OpusCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpusCntrVO model = null;
	 ...
	 * @return OpusCntrVO[]
	 */
	public OpusCntrVO[] getOpusCntrVOs(){
		OpusCntrVO[] vos = (OpusCntrVO[])models.toArray(new OpusCntrVO[models.size()]);
		return vos;
	}
