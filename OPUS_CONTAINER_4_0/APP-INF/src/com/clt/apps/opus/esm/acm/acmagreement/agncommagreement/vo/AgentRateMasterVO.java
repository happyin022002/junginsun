...
*@FileName : AgentRateMasterVO.java
*@FileTitle : AgentRateMasterVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.acm.acmagreement.agncommagreement.vo;
...
public class AgentRateMasterVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<AgentRateMasterVO> models = new ArrayList<AgentRateMasterVO>();
	...
	public AgentRateMasterVO() {}

	public AgentRateMasterVO(String ibflag, String pagerows, String agmtHisNo, String newAgmtNo, String dateErrChk, String agnAgmtNo, String agmtFmDtCd, String agmtFmDt, String agmtToDtCd, String agmtToDt, String agnAgmtRmk, String updDtLcl, String updDtGmt, String usrId, String deltFlg, String agnCd) {
...
/**
	 ...
	 */
	public AgentRateMasterVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AgentRateMasterVO[]
	 */
	public AgentRateMasterVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AgentRateMasterVO model = null;
	...
	public AgentRateMasterVO[] getAgentRateMasterVOs(){
		AgentRateMasterVO[] vos = (AgentRateMasterVO[])models.toArray(new AgentRateMasterVO[models.size()]);
		return vos;
	}
