...
*@FileName : KorUNLocVO.java
*@FileTitle : KorUNLocVO
*Open Issues :
*Change history :
...
public class KorUNLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<KorUNLocVO> models = new ArrayList<KorUNLocVO>();
	...
	public KorUNLocVO(String ibflag, String pagerows, String polUn, String podUn) {
		this.polUn = polUn;
		this.ibflag = ibflag;
		this.podUn = podUn;
	 ...
	 * @return KorUNLocVO[]
	 */
	public KorUNLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorUNLocVO[]
	 */
	public KorUNLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorUNLocVO model = null;
	 ...
	 * @return KorUNLocVO[]
	 */
	public KorUNLocVO[] getKorUNLocVOs(){
		KorUNLocVO[] vos = (KorUNLocVO[])models.toArray(new KorUNLocVO[models.size()]);
		return vos;
	}
