...
*@FileName : RFAProposalMainDBDAOPriRpScpMnProgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriRpScpMnProgVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriRpScpMnProgVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriRpScpMnProgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
