...
*@FileName : ESM_BKG_1191HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_1191HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1191HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1191HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1191Event event = new EsmBkg1191Event();
		if (command.isCommand(FormCommand.SEARCH)) {
			// Retrieve
			event.setBkgCstmsArgSndLogVO((BkgCstmsArgSndLogVO)getVO(request, BkgCstmsArgSndLogVO.class));
		}
