...
import com.clt.syscommon.common.table.BkgCstmsAnrBlVO;
import com.clt.syscommon.common.table.BkgCstmsAnrCmdtVO;
import com.clt.syscommon.common.table.BkgCstmsAnrCntrVO;
import com.clt.syscommon.common.table.BkgCstmsAnrEdiHisVO;
import com.clt.syscommon.common.table.BkgCstmsAnrNtfyVO;
import com.clt.syscommon.common.table.BkgCstmsAnrVvdVO;
...
import com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.ancs.vo.AncsCstmsBlInfoVO;
...
import com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.ancs.vo.AncsCstmsEdiHisInfoCondVO;
import com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.ancs.vo.AncsCstmsMfDtl2VO;
...
/**
 * OPUS AncsManifestListDownloadDBDAO <br>
...
public class AncsManifestListDownloadDBDAO extends DBDAOSupport {
	...
	public List<CstmsVvdVO> searchAncsCstmsVvdList(
			AncsCstmsVvdListCondVO ancsCstmsVvdListCondVO , SignOnUserAccount account) throws DAOException {
		DBRowSet dbRowset = null;
		List<CstmsVvdVO> list = null;
		ancsCstmsVvdListCondVO.setUpdUsrId(account.getUsr_id());
...
//					mapVO.put("upd_ofc_cd", ancsCstmsModiVO.getUpdOfcCd());
	 ...
	 * @throws DAOException
	 */
	public void deleteCstmsAnrBl(AncsCstmsVvdListCondVO ancsCstmsVvdListCondVO) throws DAOException {
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();

		try {
			if (ancsCstmsVvdListCondVO != null) {
				Map<String, String> mapVO = ancsCstmsVvdListCondVO.getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
			}
			
            SQLExecuter sqlExe = new SQLExecuter("");
            int result = sqlExe.executeUpdate((ISQLTemplate)new AncsManifestListDownloadDBDAOremoveBkgCstmsAnrBlVvdDSQL(), param, velParam);
	 ...
	 * @throws DAOException
	 */
	public void deleteCstmsAnrNtfy(AncsCstmsVvdListCondVO ancsCstmsVvdListCondVO) throws DAOException {
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
            ...
            SQLExecuter sqlExe = new SQLExecuter("");
            int result = sqlExe.executeUpdate((ISQLTemplate)new AncsManifestListDownloadDBDAOremoveBkgCstmsAnrNtfyVvdDSQL(), param, velParam);
            if(result == Statement.EXECUTE_FAILED) throw new DAOException("Fail to delete SQL");
        }catch(SQLException se){
            log.error(se.getMessage(),se);
            throw new DAOException(new ErrorHandler(se).getMessage(), se);
	...
	public void deleteCstmsAnrCntr(AncsCstmsVvdListCondVO ancsCstmsVvdListCondVO) throws DAOException {
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
            ...
            SQLExecuter sqlExe = new SQLExecuter("");
            int result = sqlExe.executeUpdate((ISQLTemplate)new AncsManifestListDownloadDBDAOremoveBkgCstmsAnrCntrVvdDSQL(), param, velParam);
            if(result == Statement.EXECUTE_FAILED) throw new DAOException("Fail to delete SQL");
        }catch(SQLException se){
            log.error(se.getMessage(),se);
            throw new DAOException(new ErrorHandler(se).getMessage(), se);
	 ...
	 * @throws DAOException
	 */
	public void deleteCstmsAnrCmdt(AncsCstmsVvdListCondVO ancsCstmsVvdListCondVO) throws DAOException {
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
            ...
            SQLExecuter sqlExe = new SQLExecuter("");
            int result = sqlExe.executeUpdate((ISQLTemplate)new AncsManifestListDownloadDBDAOremoveBkgCstmsAnrCmdtVvdDSQL(), param, velParam);
            if(result == Statement.EXECUTE_FAILED) throw new DAOException("Fail to delete SQL");
        }catch(SQLException se){
            log.error(se.getMessage(),se);
            throw new DAOException(new ErrorHandler(se).getMessage(), se);
	...
	public List<AncsCstmsCmdtVO> searchAncsCstmsCmdt(
		...
		try {
			Map<String, String> mapVO = ancsCstmsBlCondVO.getColumnValues();
			mapVO.put("vvd", ancsCstmsBlCondVO.getVvd());
			mapVO.put("bkg_no", ancsCstmsBlCondVO.getBkgNo());
			param.putAll(mapVO);
			velParam.putAll(mapVO);

			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new AncsManifestListDownloadDBDAOsearchAncsCstmsCmdtRSQL(), param, velParam);
			ancsCstmsCmdtVOs = (List) RowSetUtil.rowSetToVOs(dbRowset, AncsCstmsCmdtVO.class);
	 ...
	 * 
	 */
	public void removeBkgCstmsAnrCmdt(List<BkgCstmsAnrCmdtVO> bkgCstmsAnrCmdtVOs) throws DAOException {
		try {
			SQLExecuter sqlExe = new SQLExecuter("");

			int delCnt[] = sqlExe.executeBatch((ISQLTemplate) new AncsManifestListDownloadDBDAOremoveBkgCstmsAnrCmdtDSQL(), bkgCstmsAnrCmdtVOs, null);
	 ...
	 * @throws DAOException
	 */
	public void modifyBkgCstmsAnrCmdt(List<BkgCstmsAnrCmdtVO> bkgCstmsAnrCmdtVOs) throws DAOException {
		try {
			SQLExecuter sqlExe = new SQLExecuter("");

			int insCnt[] = sqlExe.executeBatch((ISQLTemplate) new AncsManifestListDownloadDBDAOmodifyBkgCstmsAnrCmdtUSQL(), bkgCstmsAnrCmdtVOs, null);
	...
	/**
	 * 다운로드 전에 BL 테이블의 VVD_SEQ값을 BL_LOG 테이블로 update
	 * 
	 * @param AncsManifestModificationVO ancsCstmsModiVO
	 * @throws DAOException
	 */
	
	public void modifyBlLogAncsCstmsArtNo(AncsManifestModificationVO ancsCstmsModiVO) throws DAOException {
		try {
			String sDaoGbn = ancsCstmsModiVO.getDaoGbn();
			Map<String, Object> param = new HashMap<String, Object>();
			Map<String, Object> velParam = new HashMap<String, Object>();
			...
			if ("blno".equals(sDaoGbn)) {
				...
				if (!sBkgNo.equals("") || sBkgNo != null) {
					...
					velParam.putAll(mapVO);
					param.putAll(mapVO);
					new SQLExecuter("").executeUpdate((ISQLTemplate) new AncsManifestListDownloadDBDAOmodifySelectBkgCstmsAnrBl2USQL(),param, velParam);
				}
			} else {
				String vvd = ancsCstmsModiVO.getVvd();
				if (!vvd.equals("") || vvd != null) {
					...
					velParam.putAll(mapVO);
					param.putAll(mapVO);
					new SQLExecuter("").executeUpdate((ISQLTemplate) new AncsManifestListDownloadDBDAOmodifySelectBkgCstmsAnrBl1USQL(),param, velParam);
				}
			}
		} catch (SQLException se) {
			throw new DAOException(new ErrorHandler(se).getMessage());
