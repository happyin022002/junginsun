...
*@FileName : BDRCorrectionDBDAOCopyBkgCorrectionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BDRCorrectionDBDAOCopyBkgCorrectionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BDRCorrectionDBDAOCopyBkgCorrectionCSQL
	  * </pre>
	  */
	public BDRCorrectionDBDAOCopyBkgCorrectionCSQL(){
		setQuery();
		...
		query.append("FileName : BDRCorrectionDBDAOCopyBkgCorrectionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", NVL(BKG_CMB_MODI_FLG, 'N')" ).append("\n"); 
