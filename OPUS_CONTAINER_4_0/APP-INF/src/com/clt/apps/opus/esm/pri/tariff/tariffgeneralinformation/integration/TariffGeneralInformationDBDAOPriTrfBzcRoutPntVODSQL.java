...
*@FileName : TariffGeneralInformationDBDAOPriTrfBzcRoutPntVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffGeneralInformationDBDAOPriTrfBzcRoutPntVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TariffGeneralInformationDBDAOPriTrfBzcRoutPntVODSQL(){
		setQuery();
		...
		query.append("FileName : TariffGeneralInformationDBDAOPriTrfBzcRoutPntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
