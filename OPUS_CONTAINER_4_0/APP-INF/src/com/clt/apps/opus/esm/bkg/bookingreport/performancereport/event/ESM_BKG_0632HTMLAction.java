...
*@FileName : ESM_BKG_0632HTMLAction.java
...
public class ESM_BKG_0632HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0632HTMLAction 객체를 생성
	 */
	public ESM_BKG_0632HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0632Event event = new EsmBkg0632Event();
		
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSaelsPerformanceReportInVO((SaelsPerformanceReportInVO)getVO(request, SaelsPerformanceReportInVO .class));
