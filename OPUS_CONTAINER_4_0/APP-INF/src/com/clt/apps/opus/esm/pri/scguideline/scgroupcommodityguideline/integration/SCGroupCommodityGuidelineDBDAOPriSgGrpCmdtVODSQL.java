...
*@FileName : SCGroupCommodityGuidelineDBDAOPriSgGrpCmdtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityGuidelineDBDAOPriSgGrpCmdtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupCommodityGuidelineDBDAOPriSgGrpCmdtVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_SG_GRP_CMDT" ).append("\n"); 
		...
		query.append("FileName : SCGroupCommodityGuidelineDBDAOPriSgGrpCmdtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}