...
*@FileName : SCReportDBDAORsltMOTFilingLogWithBkgListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAORsltMOTFilingLogWithBkgListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * retrieve filing log with booking number
	  * </pre>
	  */
	public SCReportDBDAORsltMOTFilingLogWithBkgListRSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAORsltMOTFilingLogWithBkgListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(")" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("        ROW_NUMBER () OVER ( PARTITION BY T.BAT_EXE_DT ORDER BY T.BKG_NO) AS SEQ, T.*" ).append("\n"); 
		...
		query.append("ORDER BY T.BAT_EXE_DT, T.BKG_NO, T.CTRT_NO, T.BKG_SHPR_NM, T.BKG_CNEE_NM" ).append("\n"); 
