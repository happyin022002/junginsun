...
*@FileName : NetworkCostDBDAOPndlmSvcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOPndlmSvcCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOPndlmSvcCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOPndlmSvcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO COA_PNDLM_SVC B1 " ).append("\n"); 
