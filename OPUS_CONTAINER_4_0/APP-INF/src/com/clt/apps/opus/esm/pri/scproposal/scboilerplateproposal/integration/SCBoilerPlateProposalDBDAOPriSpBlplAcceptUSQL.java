...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplAcceptUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplAcceptUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * all accept and cancel
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplAcceptUSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplAcceptUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
