...
*@FileName : BasicDataDBDAOCreateAddPfSkdGrpForSectorYrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BasicDataDBDAOCreateAddPfSkdGrpForSectorYrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * P/F SKD Group Mgmt for IAS Sector  Year 정보를 추가생성한다.
	  * </pre>
	  */
	public BasicDataDBDAOCreateAddPfSkdGrpForSectorYrCSQL(){
		setQuery();
		...
		query.append("FileName : BasicDataDBDAOCreateAddPfSkdGrpForSectorYrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                             ,CSQ_QTA_TGT_VVD_IF A2" ).append("\n"); 
		...
		query.append("    ) C1, CSQ_SCTR_PF_GRP C2" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
