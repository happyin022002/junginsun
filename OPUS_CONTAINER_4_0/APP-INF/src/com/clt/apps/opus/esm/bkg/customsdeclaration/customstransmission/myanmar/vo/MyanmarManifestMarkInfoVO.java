...
*@FileName : MyanmarManifestMarkInfoVO.java
*@FileTitle : MyanmarManifestMarkInfoVO
*Open Issues :
*Change history :
...
public class MyanmarManifestMarkInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MyanmarManifestMarkInfoVO> models = new ArrayList<MyanmarManifestMarkInfoVO>();
	...
	public MyanmarManifestMarkInfoVO() {}

	public MyanmarManifestMarkInfoVO(String ibflag, String pagerows, String mark1, String mark2, String mark3, String mark4, String mark5, String mark6, String mark7, String mark8, String mark9, String mark10) {
		this.mark10 = mark10;
		this.mark9 = mark9;
		this.mark8 = mark8;
		this.mark7 = mark7;
...
/**
	 ...
	 */
	public MyanmarManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MyanmarManifestMarkInfoVO[]
	 */
	public MyanmarManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MyanmarManifestMarkInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MyanmarManifestMarkInfoVO();
				if (mark10[i] != null)
		...
		return getMyanmarManifestMarkInfoVOs();
	}
	 ...
	 * @return MyanmarManifestMarkInfoVO[]
	 */
	public MyanmarManifestMarkInfoVO[] getMyanmarManifestMarkInfoVOs(){
		MyanmarManifestMarkInfoVO[] vos = (MyanmarManifestMarkInfoVO[])models.toArray(new MyanmarManifestMarkInfoVO[models.size()]);
		return vos;
	}
