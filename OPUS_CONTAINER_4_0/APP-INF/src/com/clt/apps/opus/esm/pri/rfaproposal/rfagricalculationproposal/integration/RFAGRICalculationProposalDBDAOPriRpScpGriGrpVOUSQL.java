...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriGrpVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriGrpVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriGrpVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriGrpVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RP_SCP_GRI_GRP SET" ).append("\n"); 
