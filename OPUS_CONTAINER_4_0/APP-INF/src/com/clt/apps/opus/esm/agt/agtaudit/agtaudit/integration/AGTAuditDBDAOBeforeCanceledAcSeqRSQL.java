...
*@FileName : AGTAuditDBDAOBeforeCanceledAcSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOBeforeCanceledAcSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTAuditDBDAOBeforeCanceledAcSeqRSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOBeforeCanceledAcSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("( 'CE','CS','CA','IC'" ).append("\n"); 
		query.append(")" ).append("\n"); 
