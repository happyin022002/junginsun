...
public class StatusReportDBDAOBkgCMPrintListin2VORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,REPLACE(B.CNTC_PSON_NM,CHR(10),' ') CNTC_PSON_NM" ).append("\n"); 
		query.append("      ,REPLACE(B.CNTC_PSON_FAX_NO,CHR(10),' ') CNTC_PSON_FAX_NO" ).append("\n"); 
		query.append("      ,B.BKG_CNTC_PSON_TP_CD" ).append("\n"); 
		query.append("      ,C.CNTR_NO" ).append("\n"); 
		query.append("      ,C.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("      ,REPLACE(E.CNTR_MF_GDS_DESC,CHR(10),' ') CNTR_MF_GDS_DESC" ).append("\n"); 
		query.append("      ,NVL(E.PCK_QTY,0) AS PCK_QTY" ).append("\n"); 
		query.append("      ,NVL(E.CNTR_MF_WGT,0) AS ACT_WGT" ).append("\n"); 
		query.append("      ,NVL(E.MEAS_QTY,0) AS MEAS_QTY" ).append("\n"); 
		query.append("      ,BKG_JOIN_FNC(CURSOR( SELECT XPT_LIC_NO FROM BKG_XPT_IMP_LIC WHERE BKG_NO = C.BKG_NO)) XPT_LIC_NO" ).append("\n"); 
		query.append("      ,REPLACE(H.CUST_NM,CHR(10),' ') CUST_NM" ).append("\n"); 
