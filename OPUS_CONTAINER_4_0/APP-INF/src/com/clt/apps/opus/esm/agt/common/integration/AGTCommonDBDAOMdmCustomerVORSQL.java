...
*@FileName : AGTCommonDBDAOMdmCustomerVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCommonDBDAOMdmCustomerVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCommonDBDAOMdmCustomerVORSQL(){
		setQuery();
		...
		query.append("FileName : AGTCommonDBDAOMdmCustomerVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
