...
public class KorCustomsTransmissionDBDAOsearchAmdTransmitDataListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("UNION ALL" ).append("\n");
		query.append("SELECT  KB.BL_NO , ' ',' ', DECODE(KRC.KR_CSTMS_CORR_ID,'D','-','F','B/L삭제')" ).append("\n");
		query.append(",DECODE(KRC.KR_CSTMS_CORR_ID,'D','B/L추가','F','-'), ' ', ' ', ' ',  ' ',  ' ',  ' ',  ' ', MAX(TO_CHAR(KRC.AMDT_SND_DT,'YYYYMMDD'))" ).append("\n");
		...
		query.append("AND   KRC.PORT_CD          =   KB.DMST_PORT_CD" ).append("\n");
		query.append("AND   KRC.CSTMS_BL_NO      =   KB.CSTMS_BL_NO" ).append("\n");
		query.append("GROUP BY KB.BL_NO , ' ',' ', DECODE(KRC.KR_CSTMS_CORR_ID,'D','-','F','B/L삭제'),DECODE(KRC.KR_CSTMS_CORR_ID,'D','B/L추가','F','-')" ).append("\n");
		query.append("HAVING DECODE(KRC.KR_CSTMS_CORR_ID,'D','-','F','B/L삭제') IS NOT NULL" ).append("\n");
		query.append("UNION ALL" ).append("\n");
		...
		query.append(", DECODE(KEC.KR_CSTMS_CORR_ID,'A','목록없음','D',KEC.XPT_LIC_NO,'X',KEC.PRE_XPT_LIC_NO)" ).append("\n");
		query.append(", DECODE(KEC.KR_CSTMS_CORR_ID,'A',KEC.XPT_LIC_NO,'D','목록없음','X',KE.XPT_LIC_NO)" ).append("\n");
		query.append(", ' '" ).append("\n");
		query.append(", ' '" ).append("\n");
		query.append(", ' '" ).append("\n");
		query.append(", ' '" ).append("\n");
		...
		query.append("HAVING DECODE(KEC.KR_CSTMS_CORR_ID,'A','목록없음','D',KEC.XPT_LIC_NO,'X',KEC.PRE_XPT_LIC_NO) IS NOT NULL  )" ).append("\n");
