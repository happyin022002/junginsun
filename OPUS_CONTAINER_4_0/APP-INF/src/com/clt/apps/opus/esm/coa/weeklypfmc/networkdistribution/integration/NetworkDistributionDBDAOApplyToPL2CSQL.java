...
*@FileName : NetworkDistributionDBDAOApplyToPL2CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOApplyToPL2CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkDistributionDBDAOApplyToPL2CSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOApplyToPL2CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              ,DECODE(NO,1,'BSA00000',2,'43102011',3,'43102021')AS STND_COST_CD" ).append("\n"); 
		query.append("              ,'XXXX'                                           AS CNTR_TPSZ_CD" ).append("\n"); 
		query.append("              ,SUM(DECODE(NO,1,FNL_CO_BSA_CAPA,2,SPC_INCOME,3,SPC_OP_INCOME)) AS ESTM_PL_AMT" ).append("\n"); 
		...
		query.append("                      ,nvl(B.INCM_BZC_CHTR_OP_AMT,0)+nvl(B.INCM_SUB_CHTR_OP_AMT,0)+nvl(B.INCM_CRS_CHTR_OP_AMT,0) AS SPC_OP_INCOME" ).append("\n"); 
		...
		query.append("                    WHERE CPY_NO BETWEEN 1 AND 3)" ).append("\n"); 
		...
		query.append("                ,DECODE(NO,1,'BSA00000',2,'43102011',3,'43102021')" ).append("\n"); 
		...
		query.append("             ,A.CO_SLS_AMT = 0" ).append("\n"); 
