...
*@FileName : MalaysiaManifestListDownloadDBDAOsearchImpStsSpclCgoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MalaysiaManifestListDownloadDBDAOsearchImpStsSpclCgoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MalaysiaManifestListDownloadDBDAOsearchImpStsSpclCgoRSQL(){
		setQuery();
		...
		query.append("FileName : MalaysiaManifestListDownloadDBDAOsearchImpStsSpclCgoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("  FROM BKG_CSTMS_MY_IMP_STS_SPCL PISS," ).append("\n"); 
