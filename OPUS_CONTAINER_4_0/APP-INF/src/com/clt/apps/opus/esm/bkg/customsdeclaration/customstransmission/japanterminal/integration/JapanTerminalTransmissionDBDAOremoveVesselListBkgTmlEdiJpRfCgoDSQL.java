...
*@FileName : JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpRfCgoDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpRfCgoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_TML_EDI_JP_RF_CGO 테이블에서 잘못 나간 VVD BKG 정보를 삭제
	  * </pre>
	  */
	public JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpRfCgoDSQL(){
		setQuery();
		...
		query.append("FileName : JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpRfCgoDSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_TML_EDI_JP_RF_CGO" ).append("\n");
