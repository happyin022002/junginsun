...
*@FileName : ESM_SAQ_0176HTMLAction.java
...
* 2010-05-04 Lee Sang Yong : CHM-201003671 new F/W 전환작업
=========================================================*/
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.saq.monthlysalesquotaadjustmenttrade 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_SAQ_0176HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0176HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0176HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0176Event event = new EsmSaq0176Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonQtaTrdVOs = saqMonQtaTrdVO.fromRequestGrid(request, event.getQuotaConditionVO(), "0176");
