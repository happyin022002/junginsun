...
/**
 * esm_bkg_0573 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_BKG_0573HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kyoung Jong Yun
 * @see ESM_BKG_0573HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmBkg0573Event extends EventSupport {
