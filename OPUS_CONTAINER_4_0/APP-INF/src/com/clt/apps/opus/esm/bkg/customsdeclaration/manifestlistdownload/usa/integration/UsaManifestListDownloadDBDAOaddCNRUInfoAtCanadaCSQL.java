...
*@FileName : UsaManifestListDownloadDBDAOaddCNRUInfoAtCanadaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaManifestListDownloadDBDAOaddCNRUInfoAtCanadaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaManifestListDownloadDBDAOaddCNRUInfoAtCanadaCSQL(){
		setQuery();
		...
		query.append("FileName : UsaManifestListDownloadDBDAOaddCNRUInfoAtCanadaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("	CNT_CD, BL_NO, CNTR_NO, RAIL_CRR_REF_NO, USA_IB_TRSP_NO, CRE_USR_ID, UPD_USR_ID" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("VALUES" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("	'CA', substr(@[in_hjbl], 5, 12), TRIM(@[in_cntr]),  @[in_snp] || @[in_nvobl], TRIM(@[icr_et_no]), 'SYSTEM', 'SYSTEM'" ).append("\n"); 
		query.append(")" ).append("\n"); 
