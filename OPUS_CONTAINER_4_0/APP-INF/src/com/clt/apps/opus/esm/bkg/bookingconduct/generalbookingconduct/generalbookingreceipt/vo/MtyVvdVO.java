...
public class MtyVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyVvdVO> models = new ArrayList<MtyVvdVO>();
	...
	public MtyVvdVO(String ibflag, String pagerows, String podCd, String podYdCd, String polCd, String polYdCd, String skdDirCd, String skdVoyNo, String vslCd, String vslPrePstCd, String vslSeq, String polClptIndSeq, String podClptIndSeq) {
		this.vslCd = vslCd;
	 ...
	 * @return MtyVvdVO[]
	 */
	public MtyVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyVvdVO[]
	 */
	public MtyVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyVvdVO model = null;
	...
	public MtyVvdVO[] getMtyVvdVOs(){
		MtyVvdVO[] vos = (MtyVvdVO[])models.toArray(new MtyVvdVO[models.size()]);
		return vos;
	}
