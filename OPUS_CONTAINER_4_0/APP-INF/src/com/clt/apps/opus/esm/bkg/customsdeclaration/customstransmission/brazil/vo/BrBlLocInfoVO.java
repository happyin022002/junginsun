...
public class BrBlLocInfoVO extends AbstractValueObject {
	...
	/* Column Info */
	private String transhipInd = null;
	/* Column Info */
	private String inoutInd = null;	
	/* Column Info */
	...
	/* Column Info */
	private String euEntryOfcName = null;
	/* Column Info */
	...
	public BrBlLocInfoVO(String ibflag, String pagerows, String blnbr, String blpol, String blpolName, String blpodName, String blporName, String bldelName, String blpod, String blpor, String bldel, String blwgt, String blmea, String remark, String inCmdtCd, String inCmdtDesc, String commodity, String blpolNode, String blpodNode, String euEntryOfc, String euEntryOfcName, String euPodOfc, String partLoad, String pofeEta, String transitInd, String transhipInd, String inoutInd, String polAms, String polFullname, String podAms, String podFullname, String porAms, String porFullname, String delAms, String delFullname, String blrly, String rlyAms, String rlyFullname, String blplace, String bldate, String shprcn, String shprcd, String shpr1, String shpr2, String shpr3, String shpr4, String shpr5, String cneecn, String cneecd, String cnee1, String cnee2, String cnee3, String cnee4, String cnee5, String ntfycn, String ntfycd, String ntfy1, String ntfy2, String ntfy3, String ntfy4, String ntfy5, String ntfy2cn, String ntfy2nm, String ntfy21, String ntfy22, String ntfy23, String ntfy24, String ntfy25, String ffwdcn, String ffwdcd, String ffwd1, String ffwd2, String ffwd3, String ffwd4, String ffwd5, String expocn, String expocd, String expo1, String expo2, String expo3, String expo4, String expo5, String blcopy, String blpkg, String blpkgu, String trunkVvd, String blWgtUnit, String blMeaUnit, String rdtype, String cargotype, String blcmd, String blrepcmdcd, String ausQuar, String tmpCol1, String tmpCol2, String tmpCol3, String tmpCol4, String bkgnbr, String rgnBkgnbr, String ppdofc, String cctofc, String thdofc, String scno, String rfano, String custrefNum, String eqrel, String eqpickdt, String eqrtn, String inBlNo, String inBkgNo, String inBkgCgoTpCd, String inDcgoFlg, String inRcFlg, String inAwkCgoFlg, String inBbCgoFlg, String inRdCgoFlg, String brDuv, String brMid, String waybillInd, String fclLcl, String onboard, String tsInd, String exInd, String ioType) {
		...
		this.euEntryOfcName = euEntryOfcName;
		this.ppdofc = ppdofc;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tranship_ind", getTranshipInd());
		this.hashColumns.put("inout_ind", getInoutInd());
		...
		this.hashColumns.put("eu_entry_ofc_name", getEuEntryOfcName());
		...
		this.hashColumns.put("blpol_name", getBlpolName());
		this.hashColumns.put("blpod_name", getBlpodName());
		this.hashColumns.put("blpor_name", getBlporName());
		this.hashColumns.put("bldel_name", getBldelName());
		...
		this.hashColumns.put("fcl_lcl", getFclLcl());
		this.hashColumns.put("onboard", getOnboard());
		this.hashColumns.put("tsInd", getTsInd());
		this.hashColumns.put("exInd", getExInd());
		this.hashColumns.put("ioType", getIoType());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tranship_ind", "transhipInd");
		this.hashFields.put("inout_ind", "inoutInd");
		...
		this.hashFields.put("eu_entry_ofc_name", "euEntryOfcName");
		...
		this.hashFields.put("blpol_name", "blpolName");
		this.hashFields.put("blpod_name", "blpodName");
		this.hashFields.put("blpor_name", "blporName");
		this.hashFields.put("bldel_name", "bldelName");
		...
		this.hashFields.put("fcl_lcl", "fclLcl");
	 ...
	 * @return transhipInd
	 */
	public String getTranshipInd() {
		return this.transhipInd;
	}
	...
	/**
	 * Column Info
	 * @return euEntryOfcName
	 */
	public String getEuEntryOfcName() {
		return this.euEntryOfcName;
	}
	 ...
	 * @param transhipInd
	 */
	public void setTranshipInd(String transhipInd) {
		this.transhipInd = transhipInd;
	}
	...
	/**
	 * Column Info
	 * @param euEntryOfcName
	 */
	public void setEuEntryOfcName(String euEntryOfcName) {
		this.euEntryOfcName = euEntryOfcName;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTranshipInd(JSPUtil.getParameter(request, prefix + "tranship_ind", ""));
		setInoutInd(JSPUtil.getParameter(request, prefix + "inout_ind", ""));
		...
		setEuEntryOfcName(JSPUtil.getParameter(request, prefix + "eu_entry_ofc_name", ""));
		...
		setBlpolName(JSPUtil.getParameter(request, prefix + "blpol_name", ""));
		setBlpodName(JSPUtil.getParameter(request, prefix + "blpod_name", ""));
		setBlporName(JSPUtil.getParameter(request, prefix + "blpor_name", ""));
		setBldelName(JSPUtil.getParameter(request, prefix + "bldel_name", ""));
		...
		setFclLcl(JSPUtil.getParameter(request, prefix + "fcl_lcl", ""));
	...
	public BrBlLocInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] transhipInd = (JSPUtil.getParameter(request, prefix	+ "tranship_ind", length));
			String[] inoutInd = (JSPUtil.getParameter(request, prefix	+ "inout_ind", length));
			...
			String[] euEntryOfcName = (JSPUtil.getParameter(request, prefix	+ "eu_entry_ofc_name", length));
			...
			String[] blpolName = (JSPUtil.getParameter(request, prefix	+ "blpo1_name", length));
			String[] blpodName = (JSPUtil.getParameter(request, prefix	+ "blpod_name", length));
			String[] blporName = (JSPUtil.getParameter(request, prefix	+ "blpor_name", length));
			String[] bldelName = (JSPUtil.getParameter(request, prefix	+ "bldel_name", length));
			...
			String[] fclLcl = (JSPUtil.getParameter(request, prefix	+ "fcl_lcl", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (transhipInd[i] != null)
					model.setTranshipInd(transhipInd[i]);
				if (inoutInd[i] != null)
					model.setInoutInd(inoutInd[i]);				
				if (tmpCol4[i] != null)
				...
				if (euEntryOfcName[i] != null)
					model.setEuEntryOfcName(euEntryOfcName[i]);
				if (ppdofc[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.transhipInd = this.transhipInd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.inoutInd = this.inoutInd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.euEntryOfcName = this.euEntryOfcName .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.fclLcl = this.fclLcl .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
