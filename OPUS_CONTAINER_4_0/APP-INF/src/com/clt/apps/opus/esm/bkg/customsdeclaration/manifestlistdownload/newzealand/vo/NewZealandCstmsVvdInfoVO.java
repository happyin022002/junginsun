...
public class NewZealandCstmsVvdInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<NewZealandCstmsVvdInfoVO> models = new ArrayList<NewZealandCstmsVvdInfoVO>();
	...
	public NewZealandCstmsVvdInfoVO() {}

	public NewZealandCstmsVvdInfoVO(String ibflag, String pagerows, String slanCd, String vslCd, String skdVoyNo, String skdDirCd, String vvdCd, String crrCd, String vpsPortCd, String vpsEtaDt, String cvyRefNo, String updUsrId, String isCrnNo, String capNm, String etaDt, String uiNm, String checkFlag, String updCrn, String preCrr) {
		this.vslCd = vslCd;
		this.preCrr = preCrr;
		this.etaDt = etaDt;
...
/**
	 ...
	 */
	public NewZealandCstmsVvdInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @param request
	 * @param prefix
	 * @return NewZealandCstmsVvdInfoVO[]
	 */
	public NewZealandCstmsVvdInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NewZealandCstmsVvdInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new NewZealandCstmsVvdInfoVO();
				if (vslCd[i] != null)
		...
		return getNewZealandCstmsVvdInfoVOs();
	}
	...
	public NewZealandCstmsVvdInfoVO[] getNewZealandCstmsVvdInfoVOs(){
		NewZealandCstmsVvdInfoVO[] vos = (NewZealandCstmsVvdInfoVO[])models.toArray(new NewZealandCstmsVvdInfoVO[models.size()]);
		return vos;
	}
