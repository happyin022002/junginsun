...
*@FileName       : ESM_SAQ_0154HTMLAction.java
...
public class ESM_SAQ_0154HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0154HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0154HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0154Event event = new EsmSaq0154Event();

		if(command.isCommand(FormCommand.SEARCHLIST02)) {
			event.setMonthlyTargetVVDInquiryConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
		}
		return  event;
	}
