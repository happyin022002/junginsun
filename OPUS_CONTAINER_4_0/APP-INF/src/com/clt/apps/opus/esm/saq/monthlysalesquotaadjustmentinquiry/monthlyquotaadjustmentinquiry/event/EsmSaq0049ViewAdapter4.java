...
*@FileName       : EsmSaq0049ViewAdapter4.java
 ...
 * @since J2EE 1.5
 */
	public class EsmSaq0049ViewAdapter4 extends ViewAdapter {

		public EsmSaq0049ViewAdapter4() {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		//QuotaConditionVO conditionVO = null; //소스 품질 대상 수정
		QuotaConditionVO conditionVO = new QuotaConditionVO(); //소스 품질 대상 수정
		List<SearchMonthlyQuotaInquiry0049Tab04VO> volist = null;
		int realCnt = 0;
		ReturnVO returnVO = (ReturnVO)vos.get(0);		
		if (returnVO !=null) {
		    volist = (List<SearchMonthlyQuotaInquiry0049Tab04VO>)returnVO.getList(0);
...
//		String isExpand = "";
		...
		if( formcommand.isCommand(FormCommand.SEARCHLIST04)){	//2.1
