 ...
 * @since J2EE 1.6
 */
public class EsmCoa0072ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmCoa0072ViewAdapter2(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmCoa0072ViewAdapter2 ########### [START]");
		...
		log.debug("########### EsmCoa0072ViewAdapter2 ########### [END]");        
