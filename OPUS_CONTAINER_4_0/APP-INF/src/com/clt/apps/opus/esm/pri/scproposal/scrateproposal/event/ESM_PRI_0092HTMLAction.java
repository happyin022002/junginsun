 ...
 *@FileName : ESM_PRI_0092HTMLAction.java
...
public class ESM_PRI_0092HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0092Event event = new EsmPri0092Event();
