...
public class EsmBkg1071Event extends EventSupport {
	...
	public MultiNtcHisVO[] getMultiNtcHisVOs() {
		MultiNtcHisVO[] rtnVOs = null;
		if (this.multiNtcHisVOs != null) {
			rtnVOs = Arrays.copyOf(multiNtcHisVOs, multiNtcHisVOs.length);
		}
		return rtnVOs;
	}
	public void setMultiNtcHisVOs(MultiNtcHisVO[] multiNtcHisVOs) {
		if (multiNtcHisVOs != null) {
			MultiNtcHisVO[] tmpVOs = Arrays.copyOf(multiNtcHisVOs, multiNtcHisVOs.length);
			this.multiNtcHisVOs = tmpVOs;
		}
	}
