...
*@FileName : UI_BKG_0169HTMLAction.java
...
public class ESM_BKG_0169HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * UI_BKG_0169HTMLAction 객체를 생성
     */
    public ESM_BKG_0169HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0169Event event = new EsmBkg0169Event();

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setVgmHistoryVO((VgmHistoryVO)getVO(request, VgmHistoryVO .class));
        }
