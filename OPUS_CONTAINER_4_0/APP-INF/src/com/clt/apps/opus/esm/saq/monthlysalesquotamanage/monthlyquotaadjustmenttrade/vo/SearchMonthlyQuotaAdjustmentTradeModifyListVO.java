...
*@FileName : SearchMonthlyQuotaAdjustmentTradeModifyListVO.java
*@FileTitle : SearchMonthlyQuotaAdjustmentTradeModifyListVO
*Open Issues :
*Change history :
...
public class SearchMonthlyQuotaAdjustmentTradeModifyListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaAdjustmentTradeModifyListVO> models = new ArrayList<SearchMonthlyQuotaAdjustmentTradeModifyListVO>();
	 ...
	 */
	public SearchMonthlyQuotaAdjustmentTradeModifyListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaAdjustmentTradeModifyListVO[]
	 */
	public SearchMonthlyQuotaAdjustmentTradeModifyListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaAdjustmentTradeModifyListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaAdjustmentTradeModifyListVO();
				if (grpSeq2[i] != null)
		...
		return getSearchMonthlyQuotaAdjustmentTradeModifyListVOs();
	}
	...
	public SearchMonthlyQuotaAdjustmentTradeModifyListVO[] getSearchMonthlyQuotaAdjustmentTradeModifyListVOs(){
		SearchMonthlyQuotaAdjustmentTradeModifyListVO[] vos = (SearchMonthlyQuotaAdjustmentTradeModifyListVO[])models.toArray(new SearchMonthlyQuotaAdjustmentTradeModifyListVO[models.size()]);
		return vos;
	}
