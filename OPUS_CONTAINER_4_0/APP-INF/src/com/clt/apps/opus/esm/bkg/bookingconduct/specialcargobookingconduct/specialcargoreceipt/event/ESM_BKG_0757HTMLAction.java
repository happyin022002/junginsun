...
*@FileName : ESM_BKG_0757HTMLAction.java
...
public class ESM_BKG_0757HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0757HTMLAction 객체를 생성
	 */
	public ESM_BKG_0757HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0757Event event = new EsmBkg0757Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setAwkCgoApplVO((AwkCgoApplVO)getVO(request, AwkCgoApplVO .class));
		}
