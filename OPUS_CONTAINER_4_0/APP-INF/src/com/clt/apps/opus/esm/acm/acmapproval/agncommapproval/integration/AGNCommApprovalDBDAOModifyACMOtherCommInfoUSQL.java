...
*@FileName : AGNCommApprovalDBDAOModifyACMOtherCommInfoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommApprovalDBDAOModifyACMOtherCommInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyACMOtherCommInfo
	  * </pre>
	  */
	public AGNCommApprovalDBDAOModifyACMOtherCommInfoUSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommApprovalDBDAOModifyACMOtherCommInfoUSQL").append("\n");
		query.append("*/").append("\n");
	}
