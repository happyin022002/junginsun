...
public class KorCllRtvOptionVO extends AbstractValueObject {
	...
	public KorCllRtvOptionVO(String ibflag, String pagerows, String cntrListNo, String fnlEdiSndFlg, String ediHdrRmk, String deltFlg, String vslCd, String skdVoyNo, String skdDirCd, String polCd, String creUsrId, String updUsrId, String polYdCd, String inCllType) {
		this.vslCd = vslCd;
