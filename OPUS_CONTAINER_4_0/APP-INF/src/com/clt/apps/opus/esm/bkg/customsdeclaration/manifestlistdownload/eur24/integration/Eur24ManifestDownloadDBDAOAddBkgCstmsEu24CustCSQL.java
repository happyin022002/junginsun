...
*@FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CustCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CustCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CustCSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CustCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24CustCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_CUST" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append(" , CUST_CNT_CD,       CUST_SEQ,         POL_CD" ).append("\n"); 
		query.append(")  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
		query.append("    X.VSL_CD,         X.SKD_VOY_NO,     X.SKD_DIR_CD,    X.BL_NO,          X.CSTMS_PORT_CD, X.BKG_CUST_TP_CD" ).append("\n"); 
		...
		query.append(" , CUST_CNT_CD,       CUST_SEQ,         BKG.POL_CD" ).append("\n"); 
