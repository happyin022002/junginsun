...
*@FileName : ESM_BKG_1525HTMLAction.java
*@FileTitle : ESM_BKG_1525HTMLAction
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
/**
 * ESM_BKG_1525 의 HTML Action Class
 *
 * @author
 * @see HTMLActionSupport
 * @since J2EE 1.6
 */
public class ESM_BKG_1525HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	public ESM_BKG_1525HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1525Event event = new EsmBkg1525Event();
