...
*@FileName : SCGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_SP_SCP_GRI_ROUT_PNT A" ).append("\n"); 
