...
public class BSAManageDBDAOAddSpcScPortDwnCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ,DECODE(B.BSA_OP_JB_CD, '007',DECODE(B.CRR_CD, COM_ConstantMgr_PKG.COM_getCompanyCode_FNC,A.CO_FNL_BSA_CAPA, 0), 0) AS PORT_BSA_CAPA" ).append("\n"); 
		query.append("       ,@[cre_usr_id] ," ).append("\n"); 
		...
		query.append("               ,COA_MON_VVD_PORT_OP_DYS Y" ).append("\n"); 
