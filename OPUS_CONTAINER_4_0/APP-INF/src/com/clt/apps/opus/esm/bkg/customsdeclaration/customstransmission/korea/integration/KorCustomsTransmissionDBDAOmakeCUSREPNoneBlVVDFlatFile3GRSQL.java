...
*@FileName : KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFile3GRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFile3GRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFile3GRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeCUSREPNoneBlVVDFlatFile3GRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
