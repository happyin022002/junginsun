...
*@FileName : RFAGuidelineMainDBDAORsltGlineScpEffDtListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGuidelineMainDBDAORsltGlineScpEffDtListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGuidelineMainDBDAORsltGlineScpEffDtListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGuidelineMainDBDAORsltGlineScpEffDtListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND (@[eff_dt] IS NULL OR TO_CHAR(EFF_DT, 'YYYY') = @[eff_dt])" ).append("\n"); 
