...
*@FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteVORSQL.java
...
public class SCBasicStandardNoteGuidelineDAOPriSgStndNoteVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBasicStandardNoteGuidelineDAOPriSgStndNoteVORSQL(){
		setQuery();
		...
		query.append("FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
