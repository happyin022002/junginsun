...
public class BlRatingDBDAOSearchChargeRemarkRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	,(SELECT RT_INTER_RMK FROM BKG_RT_HIS WHERE BKG_NO = BL.BKG_NO AND CORR_NO = BL.CORR_NO) INTER_RMK" ).append("\n"); 
		query.append("	,(SELECT DIFF_RMK FROM BKG_RT_HIS WHERE BKG_NO =BL.BKG_NO AND CORR_NO = BL.CORR_NO ) DIFF_RMK" ).append("\n"); 
		...
		query.append("    AND BL.CORR_NO = RT.CORR_NO(+)" ).append("\n"); 
