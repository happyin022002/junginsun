...
*@FileName : ESM_FMS_0069HTMLAction.java
...
public class ESM_FMS_0069HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0069HTMLAction 객체를 생성
	 */
	public ESM_FMS_0069HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0069Event event = new EsmFms0069Event();
		
		if (command.isCommand(FormCommand.SEARCH01)) {
			//event.setAcctCd(request.getParameter("acct_cd"));
			event.setCustomAcctItmVO((CustomAcctItmVO)getVO(request, CustomAcctItmVO .class,""));

		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomAcctItmVOS((CustomAcctItmVO[])getVOs(request, CustomAcctItmVO .class,""));
		}
