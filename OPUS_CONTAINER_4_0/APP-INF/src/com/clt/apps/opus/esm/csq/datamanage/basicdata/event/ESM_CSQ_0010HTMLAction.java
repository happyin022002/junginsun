...
*@FileName       : ESM_CSQ_0010HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmCsq0010Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0010HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0010HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0010Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCsq0010Event event = new EsmCsq0010Event();
		...
		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH02)) {
			...
			event.setCsqQtaTgtVvdVOS((CsqQtaTgtVvdVO[])getVOs(request, CsqQtaTgtVvdVO .class,""));
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
