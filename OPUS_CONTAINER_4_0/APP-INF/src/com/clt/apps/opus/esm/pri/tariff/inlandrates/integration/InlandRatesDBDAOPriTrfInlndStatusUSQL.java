...
*@FileName : InlandRatesDBDAOPriTrfInlndStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRatesDBDAOPriTrfInlndStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRatesDBDAOPriTrfInlndStatusUSQL(){
		setQuery();
		...
		query.append("FileName : InlandRatesDBDAOPriTrfInlndStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , TRF_INLND_STS_CD		= NVL(@[trf_inlnd_sts_cd], TRF_INLND_STS_CD)" ).append("\n"); 
