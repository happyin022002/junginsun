...
*@FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOSearchSaqMonQtaStepTrdLane0085ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MonthlyQuotaAdjustmentTradeRHQDBDAOSearchSaqMonQtaStepTrdLane0085ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MonthlyQuotaAdjustmentTradeRHQDBDAOSearchSaqMonQtaStepTrdLane0085ListRSQL(){
		setQuery();
		...
		query.append("FileName : MonthlyQuotaAdjustmentTradeRHQDBDAOSearchSaqMonQtaStepTrdLane0085ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   R.BSE_QTR_CD = @[bse_quarter]" ).append("\n"); 
