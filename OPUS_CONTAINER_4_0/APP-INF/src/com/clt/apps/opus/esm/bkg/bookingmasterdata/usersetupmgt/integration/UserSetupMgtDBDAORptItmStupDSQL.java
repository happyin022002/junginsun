...
*@FileName : UserSetupMgtDBDAORptItmStupDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAORptItmStupDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserSetupMgtDBDAORptItmStupDSQL(){
		setQuery();
		...
		query.append("FileName : UserSetupMgtDBDAORptItmStupDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_RPT_ITM_STUP" ).append("\n"); 
