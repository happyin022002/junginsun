...
public class EsmBkg0083Event extends EventSupport {
	...
	public void setNodeListVOS(NodeListVO[] nodeListVOs){
		if (nodeListVOs != null) {
			NodeListVO[] tmpVOs = Arrays.copyOf(nodeListVOs, nodeListVOs .length);
			this. nodeListVOs = tmpVOs;
		}
	}
	...
	public NodeListVO[] getNodeListVOs(){
		NodeListVO[] tmpVOs = null;
		if (this. nodeListVOs != null) {
			tmpVOs = Arrays.copyOf(nodeListVOs, nodeListVOs .length);
		}
		return tmpVOs;
	}
