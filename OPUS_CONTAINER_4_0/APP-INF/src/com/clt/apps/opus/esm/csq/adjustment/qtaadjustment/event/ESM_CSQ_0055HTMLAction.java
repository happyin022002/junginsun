...
*@FileName       : ESM_CSQ_0055HTMLAction.java
*@FileTitle      : QTA Edit
*Open Issues     :
*Change history  :
 ...
 * @author JEONGMIN CHO
 * @see EsmCsq0055Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0055HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0055HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0055HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0055Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCsq0055Event event = new EsmCsq0055Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
			event.setCsqCfmQtaVOS((CsqCfmQtaVO[])getVOs(request, CsqCfmQtaVO .class,""));
