...
*@FileName : SpecialCargoReceiptDBDAOcopyAkCgoBySplitCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOcopyAkCgoBySplitCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOcopyAkCgoBySplitCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOcopyAkCgoBySplitCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("from bkg_awk_cgo spcl" ).append("\n"); 
