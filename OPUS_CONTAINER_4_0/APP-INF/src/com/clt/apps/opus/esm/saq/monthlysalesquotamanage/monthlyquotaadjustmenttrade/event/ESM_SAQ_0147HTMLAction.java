...
*@FileName : ESM_SAQ_0147HTMLAction.java
...
public class ESM_SAQ_0147HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAQ_0147HTMLAction 객체를 생성
	 */
	public ESM_SAQ_0147HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSaq0147Event event = new EsmSaq0147Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setQuotaConditionVO((QuotaConditionVO)getVO(request, QuotaConditionVO .class));
			saqMonQtaTrdVOs = saqMonQtaTrdVO.fromRequestGrid(request, event.getQuotaConditionVO(), "0147");
