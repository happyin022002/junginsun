...
public class TCharterIOContractDAOFmsPayTermCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOFmsPayTermCSQL
	  * </pre>
	  */
	public TCharterIOContractDAOFmsPayTermCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("insert into fms_pay_term (" ).append("\n"); 
		...
		query.append("FileName : TCharterIOContractDAOFmsPayTermCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}