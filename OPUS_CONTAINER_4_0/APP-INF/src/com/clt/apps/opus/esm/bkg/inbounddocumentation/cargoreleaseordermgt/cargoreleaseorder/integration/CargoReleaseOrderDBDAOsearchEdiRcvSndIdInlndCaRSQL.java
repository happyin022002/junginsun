...
*@FileName : CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCaRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCaRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Inland setting이 되어있을 때 Inland에도 CA전송을 하기위해 SND ID와 RCV ID 가져옴
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCaRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchEdiRcvSndIdInlndCaRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
