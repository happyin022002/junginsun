...
*@FileName : BSAManageDBDAOModifyCarrierRegisterJO1CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifyCarrierRegisterJO1CSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyCarrierRegisterJO1 INSERT
	  * </pre>
	  */
	public BSAManageDBDAOModifyCarrierRegisterJO1CSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifyCarrierRegisterJO1CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                VSL_CAPA, " ).append("\n"); 
		query.append("                BSA_OP_JB_CD" ).append("\n"); 
		query.append("         FROM   BSA_JNT_OP_CRR_CAPA" ).append("\n"); 
		query.append("         WHERE  BSA_OP_CD     = @[bsa_op_cd]" ).append("\n"); 
		query.append("         AND   (BSA_OP_JB_CD  = @[bsa_op_jb_cd] OR (BSA_OP_JB_CD BETWEEN '006' AND '022'))" ).append("\n"); 
		query.append("         GROUP BY BSA_SEQ, " ).append("\n"); 
		query.append("                  TRD_CD, " ).append("\n"); 
		query.append("                  RLANE_CD, " ).append("\n"); 
		query.append("                  DIR_CD, " ).append("\n"); 
		query.append("                  VOP_CD, " ).append("\n"); 
