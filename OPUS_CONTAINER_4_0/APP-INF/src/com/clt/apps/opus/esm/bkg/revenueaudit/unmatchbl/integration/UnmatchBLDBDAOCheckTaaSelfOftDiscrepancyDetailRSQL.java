...
*@FileName : UnmatchBLDBDAOCheckTaaSelfOftDiscrepancyDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckTaaSelfOftDiscrepancyDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UnmatchBLDBDAOCheckTaaSelfOftDiscrepancyDetailRSQL
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckTaaSelfOftDiscrepancyDetailRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckTaaSelfOftDiscrepancyDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
