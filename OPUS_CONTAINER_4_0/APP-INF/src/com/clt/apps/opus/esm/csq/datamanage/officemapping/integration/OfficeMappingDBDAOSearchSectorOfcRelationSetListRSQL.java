...
public class OfficeMappingDBDAOSearchSectorOfcRelationSetListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,A1.CSQ_ACT_FLG CSQ_ACT_FLG " ).append("\n"); 
		query.append("      ,NVL(A4.CSQ_MN_SCTR_FLG, 'N') CSQ_MN_SCTR_FLG" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY A1.TRD_CD, A1.SUB_TRD_CD, A1.RLANE_CD, A1.DIR_CD, A1.RHQ_CD, A1.RGN_OFC_CD, POL_CALL_SEQ ,POD_CALL_SEQ" ).append("\n"); 
