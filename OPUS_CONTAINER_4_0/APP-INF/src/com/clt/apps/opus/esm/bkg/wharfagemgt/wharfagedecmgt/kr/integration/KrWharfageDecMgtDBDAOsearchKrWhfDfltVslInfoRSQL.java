...
public class KrWharfageDecMgtDBDAOsearchKrWhfDfltVslInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    SUBSTR(A.KR_VSL_CALL_SGN_CD,1,6) AS VSL_CALL_SGN_CD," ).append("\n"); 
		...
		query.append("    ,DECODE(SUBSTR(@[io_bnd_cd], 1, 1), 'O', ATTR_CTNT4, ATTR_CTNT3) AS WHF_RT" ).append("\n"); 
