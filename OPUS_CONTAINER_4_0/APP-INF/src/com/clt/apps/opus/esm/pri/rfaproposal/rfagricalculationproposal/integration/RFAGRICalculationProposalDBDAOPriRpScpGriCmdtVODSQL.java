...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGriCmdtVO Delete
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriCmdtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
