...
*@FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVOUSQL.java
...
public class SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("update pri_sg_blpl_ctnt set" ).append("\n"); 
		query.append("blpl_hdr_seq = @[blpl_hdr_seq]," ).append("\n"); 
		query.append("blpl_seq = @[blpl_seq]," ).append("\n"); 
		query.append("blpl_ctnt_seq = @[blpl_ctnt_seq]," ).append("\n"); 
		query.append("blpl_ctnt = @[blpl_ctnt]," ).append("\n"); 
		...
		query.append("and	blpl_ctnt_seq = @[blpl_ctnt_seq]" ).append("\n"); 
