...
*@FileName : OTRCommAuditDBDAORejectOtrAGNCommAuditUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class OTRCommAuditDBDAORejectOtrAGNCommAuditUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RejectOtrAGNCommAudit
	  * </pre>
	  */
	public OTRCommAuditDBDAORejectOtrAGNCommAuditUSQL(){
		setQuery();
		...
		query.append("FileName : OTRCommAuditDBDAORejectOtrAGNCommAuditUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("=" ).append("\n");
		query.append("(" ).append("\n");
		query.append("SELECT 'RR' AS AC_STS_CD," ).append("\n");
