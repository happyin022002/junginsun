...
*@FileName : SCGroupCommodityProposalDBDAORsltRtApplyListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAORsltRtApplyListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCGroupCommodityProposalDBDAORsltRtApplyListVORSQL
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAORsltRtApplyListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAORsltRtApplyListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM" ).append("\n"); 
		query.append("PRI_SP_SCP_RT_CMDT" ).append("\n"); 
		...
		query.append("PRC_CMDT_DEF_CD CMDT_CD" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("PRI_SP_SCP_GRI_CMDT" ).append("\n"); 
		query.append("WHERE" ).append("\n"); 
		query.append("PROP_NO 			= @[prop_no]" ).append("\n"); 
		query.append("AND AMDT_SEQ 			= @[amdt_seq]" ).append("\n"); 
		query.append("AND SVC_SCP_CD 			= @[svc_scp_cd]" ).append("\n"); 
