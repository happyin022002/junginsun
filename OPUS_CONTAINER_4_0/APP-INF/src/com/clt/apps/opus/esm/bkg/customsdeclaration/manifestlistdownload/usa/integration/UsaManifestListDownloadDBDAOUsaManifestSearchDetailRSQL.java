...
public class UsaManifestListDownloadDBDAOUsaManifestSearchDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("					   --DECODE(A.FULL_MTY_CD, 'M', 'E', 'E', 'E', 'F') FULL_MTY_CD," ).append("\n"); 
		query.append("					   A.FULL_MTY_CD FULL_MTY_CD," ).append("\n"); 
		...
		query.append("	)" ).append("\n"); 
		query.append("  #else" ).append("\n"); 
		query.append("    AND (SHPR_NM = 'N' OR SHPR_AD = 'N' OR CNEE_NM = 'N' OR CNEE_AD = 'N' OR NTFY_NM = 'N' OR NTFY_AD = 'N')" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
