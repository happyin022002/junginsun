 ...
 *@FileName : ESM_PRI_2084HTMLAction.java
...
public class ESM_PRI_2084HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2084Event event = new EsmPri2084Event();
