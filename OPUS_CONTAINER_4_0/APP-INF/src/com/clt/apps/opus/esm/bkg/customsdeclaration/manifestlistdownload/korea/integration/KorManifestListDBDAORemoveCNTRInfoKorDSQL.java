...
*@FileName : KorManifestListDBDAORemoveCNTRInfoKorDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAORemoveCNTRInfoKorDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAORemoveCNTRInfoKorDSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAORemoveCNTRInfoKorDSQL").append("\n");
		query.append("*/").append("\n");
	}
