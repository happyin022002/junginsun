...
*@FileName : FFCmpnApprovalDBDAOSearchFFCmpnCSRDetailVVDLVLFLGCheckRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class FFCmpnApprovalDBDAOSearchFFCmpnCSRDetailVVDLVLFLGCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchFFCmpnCSRDetailVVDLVLFLGCheck
	  * </pre>
	  */
	public FFCmpnApprovalDBDAOSearchFFCmpnCSRDetailVVDLVLFLGCheckRSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnApprovalDBDAOSearchFFCmpnCSRDetailVVDLVLFLGCheckRSQL").append("\n");
		query.append("*/").append("\n");
	}
