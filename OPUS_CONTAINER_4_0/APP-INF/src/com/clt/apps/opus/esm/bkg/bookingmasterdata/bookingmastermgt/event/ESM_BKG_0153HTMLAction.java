...
*@FileName : ESM_BKG_0153HTMLAction.java
...
public class ESM_BKG_0153HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0153HTMLAction 객체를 생성
	 */
	public ESM_BKG_0153HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0153Event event = new EsmBkg0153Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchChinaAgentCodeVOS((BkgChinaAgentVO[])getVOs(request, BkgChinaAgentVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchChinaAgentCodeVO((BkgChinaAgentVO)getVO(request, BkgChinaAgentVO .class));
		}
