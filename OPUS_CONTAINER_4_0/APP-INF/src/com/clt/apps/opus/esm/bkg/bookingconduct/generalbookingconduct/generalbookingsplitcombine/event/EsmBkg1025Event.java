...
public class EsmBkg1025Event extends EventSupport {
	...
	public TroSplitVO[] getTroSplitVOs() {
		TroSplitVO[] tmpVOs = null;
		if (this. troSplitVOs != null) {
			tmpVOs = Arrays.copyOf(troSplitVOs, troSplitVOs .length);
		}
		return tmpVOs;
	}
	...
	public void setTroSplitVOs(TroSplitVO[] troSplitVOs) {
		if (troSplitVOs != null) {
			TroSplitVO[] tmpVOs = Arrays.copyOf(troSplitVOs, troSplitVOs .length);
			this. troSplitVOs = tmpVOs;
		}
	}
