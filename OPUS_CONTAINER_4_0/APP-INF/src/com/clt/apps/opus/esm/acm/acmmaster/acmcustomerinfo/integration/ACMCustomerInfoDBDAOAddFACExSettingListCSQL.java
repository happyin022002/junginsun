...
*@FileName : ACMCustomerInfoDBDAOAddFACExSettingListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMCustomerInfoDBDAOAddFACExSettingListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCustomerInfoDBDAOAddFACExSettingListCSQL(){
		setQuery();
		...
		query.append("FileName : ACMCustomerInfoDBDAOAddFACExSettingListCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_FAC_EXCLU_SET" ).append("\n");
		...
		query.append("" ).append("\n");
		query.append("VALUES (@[fac_ofc_cd]," ).append("\n");
		query.append("        SUBSTR(@[ff_cnt_seq], 1, 2)," ).append("\n");
		query.append("        TO_NUMBER(SUBSTR(@[ff_cnt_seq], 3))," ).append("\n");
		query.append("        SUBSTR(@[shpr_cnt_seq], 1, 2)," ).append("\n");
		query.append("        TO_NUMBER(SUBSTR(@[shpr_cnt_seq], 3))," ).append("\n");
