...
*@FileName : RocsManifestListDownloadDBDAOremoveRocsCntrInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestListDownloadDBDAOremoveRocsCntrInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestListDownloadDBDAOremoveRocsCntrInfoDSQL(){
		setQuery();
		...
		query.append("FileName : RocsManifestListDownloadDBDAOremoveRocsCntrInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_RTM_CNTR" ).append("\n"); 
