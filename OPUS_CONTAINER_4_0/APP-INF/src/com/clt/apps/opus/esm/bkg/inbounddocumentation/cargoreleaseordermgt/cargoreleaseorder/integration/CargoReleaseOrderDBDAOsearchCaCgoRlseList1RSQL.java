...
*@FileName : CargoReleaseOrderDBDAOsearchCaCgoRlseList1RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchCaCgoRlseList1RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CargoReleaseOrderDBDAOsearchCaCgoRlseList1RSQL
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchCaCgoRlseList1RSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchCaCgoRlseList1RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		       NVL(P.VSL_CD||P.SKD_VOY_NO||P.SKD_DIR_CD, N.VSL_CD||N.SKD_VOY_NO||N.SKD_DIR_CD) AS VVD_CD," ).append("\n"); 
		query.append("		       NVL(P.POD_CD, N.CSTMS_PORT_CD) AS POD_CD," ).append("\n"); 
		query.append("		       NVL(P.DEL_CD, N.DEL_CD) AS DEL_CD," ).append("\n"); 
		...
		query.append("		 WHERE N.CNT_CD = 'CA'" ).append("\n"); 
		query.append("		   AND M.BL_NO  = N.BL_NO" ).append("\n"); 
		query.append("		   AND O.CNT_CD = 'CA'" ).append("\n"); 
		...
		query.append("	           MAX(T.PCK_QTY)," ).append("\n"); 
		...
		query.append("  		       MAX(D.MRN_TML_EDI_SND_CD) TML_SND," ).append("\n"); 
		query.append("		       MAX(TO_CHAR(D.MRN_TML_EDI_LST_SND_DT,'DDMonRR HH24:MI','NLS_DATE_LANGUAGE=ENGLISH')) TML_LAST_DT," ).append("\n"); 
		query.append("               ''," ).append("\n"); 
		query.append("               MAX(S.CUST_NM) CUST_NM," ).append("\n"); 
		...
		query.append("               BKG_BL_DOC       T" ).append("\n"); 
		...
		query.append("           AND C.BKG_NO     = T.BKG_NO(+)" ).append("\n"); 
