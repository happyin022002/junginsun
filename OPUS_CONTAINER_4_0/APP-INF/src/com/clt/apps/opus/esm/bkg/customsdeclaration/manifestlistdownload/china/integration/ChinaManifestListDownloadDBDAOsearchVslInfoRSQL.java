...
*@FileName : ChinaManifestListDownloadDBDAOsearchVslInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOsearchVslInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOsearchVslInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOsearchVslInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("VPS3.VPS_PORT_CD NEXT_PORT," ).append("\n");
