...
*@FileName : KorManifestListDBDAOsearchSubNoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchSubNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchSubNoRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchSubNoRSQL").append("\n");
		query.append("*/").append("\n");
	}
