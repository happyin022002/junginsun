...
public class DblEdiVO { 
    ...
    private String dblEdiRefNo = null;
    ...
    /**
     * @return the dblEdiRefNo
     */
    public String getDblEdiRefNo() {
        return dblEdiRefNo;
    }
    
    /**
     * @param dblEdiRefNo the dblEdiRefNo to set
     */
    public void setDblEdiRefNo(String dblEdiRefNo) {
        this.dblEdiRefNo = dblEdiRefNo;
    }
