...
*@FileName : ESM_PRI_2042HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.pri.rfareport 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_PRI_2042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_2042HTMLAction 객체를 생성
	 */
	public ESM_PRI_2042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2042Event event = new EsmPri2042Event();

		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRsltSearchRFARateSearchListVO((RsltSearchRFARateSearchListVO)getVO(request, RsltSearchRFARateSearchListVO.class));
		}
