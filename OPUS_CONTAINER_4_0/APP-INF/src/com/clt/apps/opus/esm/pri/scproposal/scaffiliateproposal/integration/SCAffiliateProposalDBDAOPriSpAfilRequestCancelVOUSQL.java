...
*@FileName : SCAffiliateProposalDBDAOPriSpAfilRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCAffiliateProposalDBDAOPriSpAfilRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCAffiliateProposalDBDAOPriSpAfilRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCAffiliateProposalDBDAOPriSpAfilRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
