...
*@FileName : BLIssuanceDBDAOModifyOblRcvByUsCgoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOModifyOblRcvByUsCgoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLIssuanceDBDAOModifyOblRcvByUsCgoUSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOModifyOblRcvByUsCgoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                                                        TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SYSDATE,BKG_COM_USER_LOC_FNC(@[usr_id])),'YYYYMMDDHH24MISS')))," ).append("\n"); 
