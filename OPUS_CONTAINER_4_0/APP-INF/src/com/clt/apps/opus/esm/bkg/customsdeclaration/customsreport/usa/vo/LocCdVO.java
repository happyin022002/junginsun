...
public class LocCdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<LocCdVO> models = new ArrayList<LocCdVO>();
	...
	public LocCdVO(String ibflag, String pagerows, String locAmsPortCd) {
	 ...
	 * @return LocCdVO[]
	 */
	public LocCdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LocCdVO[]
	 */
	public LocCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LocCdVO model = null;
	 ...
	 * @return LocCdVO[]
	 */
	public LocCdVO[] getLocCdVOs(){
		LocCdVO[] vos = (LocCdVO[])models.toArray(new LocCdVO[models.size()]);
		return vos;
	}
