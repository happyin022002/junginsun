...
public class EurCmVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String dPunitDesc = null;
    ...
    public EurCmVO(String ibflag, String pagerows, String dCmdt, String dPunit, String dPkg, String dWgt, String dMeas, String dDesc, String dMark, String mfItmNo, String dHtsCd, String dHsCd, String dNcmCd, String dPunitDesc) {
        this.dMark = dMark;
        this.dHtsCd = dHtsCd;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("d_punit_desc", getDPunitDesc());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("d_punit_desc", "dPunitDesc");
    ...
    public void setDPunitDesc(String dPunitDesc) {
        this.dPunitDesc = dPunitDesc;
    }

    public String getDPunitDesc() {
        return this.dPunitDesc;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setDPunitDesc(JSPUtil.getParameter(request, prefix + "d_punit_desc", ""));
    }
	...
	*/
    public void unDataFormat() {
        ...
        this.dPunitDesc = this.dPunitDesc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
