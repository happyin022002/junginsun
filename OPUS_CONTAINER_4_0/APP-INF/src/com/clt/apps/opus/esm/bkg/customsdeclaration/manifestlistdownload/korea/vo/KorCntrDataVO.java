...
public class KorCntrDataVO extends AbstractValueObject {
	...
	public KorCntrDataVO(String ibflag, String pagerows, String inType, String ioBndCd, String podCd, String podTml, String polCd, String polTml, String portCd, String vvd) {
		this.vvd = vvd;
		this.podCd = podCd;
		this.polCd = polCd;
		this.inType = inType;
...
/**
	 ...
	 * @return KorCntrDataVO[]
	 */
	public KorCntrDataVO[] getKorCntrDataVOs(){
