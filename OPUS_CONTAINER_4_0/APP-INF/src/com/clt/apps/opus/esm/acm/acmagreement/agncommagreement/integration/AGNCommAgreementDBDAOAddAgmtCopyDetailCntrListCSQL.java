...
*@FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailCntrListCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgmtCopyDetailCntrListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgmtCopyDetailCntrList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgmtCopyDetailCntrListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailCntrListCSQL").append("\n");
		query.append("*/").append("\n");
	}
