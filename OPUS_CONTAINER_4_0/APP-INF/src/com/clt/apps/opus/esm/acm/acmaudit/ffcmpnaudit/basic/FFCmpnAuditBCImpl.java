...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.basic;

import java.util.ArrayList;
import java.util.List;

import com.clt.apps.opus.esm.acm.acmaudit.ffcmpnaudit.integration.FFCmpnAuditDBDAO;
...
public class FFCmpnAuditBCImpl extends BasicCommandSupport implements FFCmpnAuditBC {
	...
	public List<FFCmpnAuditVO> searchFFCmpnAudit(FFCmpnAuditVO ffcmpnAuditVO) throws EventException {
		try {
			String apOfcCdTmp = ffcmpnAuditVO.getFApOfcCd();
			if(apOfcCdTmp != null && !apOfcCdTmp.equals(""))
			{
				apOfcCdTmp = "'" + apOfcCdTmp.replaceAll(",", "','") + "'"; 
				ffcmpnAuditVO.setFApOfcCd(apOfcCdTmp);
			}
