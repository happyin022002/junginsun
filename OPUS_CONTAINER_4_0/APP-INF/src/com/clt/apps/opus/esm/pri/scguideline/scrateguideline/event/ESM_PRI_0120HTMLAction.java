 ...
 *@FileName : ESM_PRI_0120HTMLAction.java
 *@FileTitle : ESM_PRI_0120HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_0120HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_0120HTMLAction 객체를 생성
	 */
	public ESM_PRI_0120HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0120Event event = new EsmPri0120Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			PriSgRtCmdtHdrVO vo = (PriSgRtCmdtHdrVO) getVO(request, PriSgRtCmdtHdrVO.class);
			event.setPriSgRtCmdtHdrVO(vo);
			event.setRsltRtListExcelVOS((RsltRtListExcelVO[]) getVOs(request, RsltRtListExcelVO.class, ""));
