...
*@FileName : ESM_COA_0114HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author Kim Ki Dae
 * @see EsmCoa0114Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_0114HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0114HTMLAction 객체를 생성
	 */
	public ESM_COA_0114HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0114Event event = new EsmCoa0114Event();  		
