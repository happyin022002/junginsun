...
*@FileName : ESM_BKG_0756HTMLAction.java
...
public class ESM_BKG_0756HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0756HTMLAction 객체를 생성
	 */
	public ESM_BKG_0756HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0756Event event = new EsmBkg0756Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgAwkDimVO((BkgAwkDimVO)getVO(request, BkgAwkDimVO .class));
		}
