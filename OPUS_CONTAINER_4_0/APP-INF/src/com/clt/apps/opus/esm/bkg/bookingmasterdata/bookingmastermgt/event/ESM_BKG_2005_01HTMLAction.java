	 ...
	 *@FileName : ESM_BKG_2005_01HTMLAction.java
...
public class ESM_BKG_2005_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_2005_SEQHTMLAction 객체를 생성
	 */
	public ESM_BKG_2005_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg200501Event event = new EsmBkg200501Event();

		HrdCdgCtnt2VO hrdCdgCtnt2VO = new HrdCdgCtnt2VO();
		hrdCdgCtnt2VO.fromRequest(request);
		if(command.isCommand(FormCommand.MULTI)) {
			
			event.setHrdCdgCtnt2VO(hrdCdgCtnt2VO);
			event.setHrdCdgCtnt2VOs((HrdCdgCtnt2VO[])getVOs(request, HrdCdgCtnt2VO.class,""));
		}
