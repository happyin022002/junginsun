...
*@FileName : SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRINFtoAPRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRINFtoAPRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSPCLCmpnCSRINFtoAP
	  * </pre>
	  */
	public SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRINFtoAPRSQL(){
		setQuery();
		...
		query.append("FileName : SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRINFtoAPRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("SELECT 'FNS008-0003' AS LIF_ID," ).append("\n");
		...
		query.append("WHERE A.CSR_NO = @[csr_no]--'08SNYCNA12052210033'" ).append("\n");
