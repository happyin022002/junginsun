...
public class SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowSubOfficeListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                           (R.TRD_CD, R.RLANE_CD, R.VSL_CD, R.SKD_VOY_NO, R.SKD_DIR_CD, R.COST_YR, R.COST_WK, R.SLS_OFC_CD)," ).append("\n"); 
		query.append("                           (R.TRD_CD, R.RLANE_CD, R.VSL_CD, R.SKD_VOY_NO, R.SKD_DIR_CD, R.COST_YR, R.COST_WK)," ).append("\n"); 
		query.append("                           (R.TRD_CD, R.RLANE_CD)," ).append("\n"); 
		query.append("                           (R.TRD_CD)" ).append("\n"); 
		query.append("                         )" ).append("\n"); 
		query.append(")" ).append("\n"); 
