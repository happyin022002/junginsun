...
public class EsmAcm0023Event extends EventSupport {
	...
	public FFAgreementVO[] getFfagreementVOs() {
		FFAgreementVO[] rtnVOs = null;
		if (this.ffagreementVOs != null) {
			rtnVOs = Arrays.copyOf(ffagreementVOs, ffagreementVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setFfagreementVOs(FFAgreementVO[] ffagreementVOs) {
		if(ffagreementVOs != null){
			FFAgreementVO[] tmpVOs = Arrays.copyOf(ffagreementVOs, ffagreementVOs.length);
			this.ffagreementVOs  = tmpVOs;
		}
	}
