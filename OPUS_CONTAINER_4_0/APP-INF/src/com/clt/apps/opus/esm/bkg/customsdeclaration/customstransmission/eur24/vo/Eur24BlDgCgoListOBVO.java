...
*@FileName : Eur24BlDgCgoListOBVO.java
*@FileTitle : Eur24BlDgCgoListOBVO
*Open Issues :
*Change history :
...
public class Eur24BlDgCgoListOBVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Eur24BlDgCgoListOBVO> models = new ArrayList<Eur24BlDgCgoListOBVO>();
...
/**
	 ...
	 * @param request
	 * @return Eur24BlDgCgoListOBVO[]
	 */
	public Eur24BlDgCgoListOBVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Eur24BlDgCgoListOBVO[]
	 */
	public Eur24BlDgCgoListOBVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Eur24BlDgCgoListOBVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Eur24BlDgCgoListOBVO();
				if (vslCd[i] != null)
		...
		return getEur24BlDgCgoListOBVOs();
	}
	 ...
	 * @return Eur24BlDgCgoListOBVO[]
	 */
	public Eur24BlDgCgoListOBVO[] getEur24BlDgCgoListOBVOs(){
		Eur24BlDgCgoListOBVO[] vos = (Eur24BlDgCgoListOBVO[])models.toArray(new Eur24BlDgCgoListOBVO[models.size()]);
		return vos;
	}
