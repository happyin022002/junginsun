...
*@FileName : RocsSearchBlListVO.java
*@FileTitle : RocsSearchBlListVO
*Open Issues :
*Change history :
...
public class RocsSearchBlListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsSearchBlListVO> models = new ArrayList<RocsSearchBlListVO>();
	...
	public RocsSearchBlListVO() {}

	public RocsSearchBlListVO(String ibflag, String pagerows, String kind, String blNo, String blNo2, String cntrNo, String bkgCgoTpCd, String porCd, String polCd, String podCd, String delCd, String preRlyPortCd, String pstRlyPortCd, String pckQty, String pckTpCd, String cntrMfWgt, String cntrWgtUtCd, String t1DocCd, String bdrFlg, String cntrMfDesc, String ntfyAddr, String ediSndStsCd, String sndUsrId, String mfSndDt, String rtmReMsgStsCd, String reMsgDt, String datCfmFlg, String cstmsDeclUsrId, String blDatCfmDt, String bkgNo, String frmCrnNumber, String blTpCd, String bigoKind) {
		this.porCd = porCd;
	 ...
	 */
	public RocsSearchBlListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsSearchBlListVO[]
	 */
	public RocsSearchBlListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsSearchBlListVO model = null;
	 ...
	 * @return RocsSearchBlListVO[]
	 */
	public RocsSearchBlListVO[] getRocsSearchBlListVOs(){
		RocsSearchBlListVO[] vos = (RocsSearchBlListVO[])models.toArray(new RocsSearchBlListVO[models.size()]);
		return vos;
	}
