...
*@FileName : UsaCustomsReportDBDAOsearchUsLastForeignPortRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaCustomsReportDBDAOsearchUsLastForeignPortRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaCustomsReportDBDAOsearchUsLastForeignPortRSQL(){
		setQuery();
		...
		query.append("FileName : UsaCustomsReportDBDAOsearchUsLastForeignPortRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
