...
*@FileName : ESM_FMS_0059HTMLAction.java
...
public class ESM_FMS_0059HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0059HTMLAction 객체를 생성
	 */
	public ESM_FMS_0059HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0059Event event = new EsmFms0059Event();

		if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomShpYdVOS((CustomShpYdVO[])getVOs(request, CustomShpYdVO .class,""));
		}
