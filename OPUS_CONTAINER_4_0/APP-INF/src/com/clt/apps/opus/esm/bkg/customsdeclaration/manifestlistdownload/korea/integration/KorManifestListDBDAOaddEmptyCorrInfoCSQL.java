...
*@FileName : KorManifestListDBDAOaddEmptyCorrInfoCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOaddEmptyCorrInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOaddEmptyCorrInfoCSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOaddEmptyCorrInfoCSQL").append("\n");
		query.append("*/").append("\n");
	}
