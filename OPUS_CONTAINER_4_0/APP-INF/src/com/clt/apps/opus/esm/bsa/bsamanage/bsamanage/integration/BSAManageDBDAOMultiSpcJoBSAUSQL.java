...
*@FileName : BSAManageDBDAOMultiSpcJoBSAUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOMultiSpcJoBSAUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiSpcJoBSA UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOMultiSpcJoBSAUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOMultiSpcJoBSAUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BSA_JNT_OP_CRR_CAPA" ).append("\n"); 
		query.append("SET SPC_CTRL_SLT_CAPA = @[spc_ctrl_slt_capa]" ).append("\n"); 
		query.append("#if(${bsa_op_jb_cd} != '007')" ).append("\n"); 
