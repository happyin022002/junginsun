...
*@FileName : AGNCommApprovalDBDAOModifyFFCmpnInfoFailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommApprovalDBDAOModifyFFCmpnInfoFailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyFFCmpnInfoFail
	  * </pre>
	  */
	public AGNCommApprovalDBDAOModifyFFCmpnInfoFailUSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommApprovalDBDAOModifyFFCmpnInfoFailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET FF_CMPN_STS_CD = 'CM', " ).append("\n"); 
		query.append("       FF_CMPN_RMK = 'Interface FAIL!', " ).append("\n"); 
