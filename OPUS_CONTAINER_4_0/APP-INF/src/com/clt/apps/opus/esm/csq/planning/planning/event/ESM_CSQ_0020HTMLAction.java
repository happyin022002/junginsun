...
*@FileName       : ESM_CSQ_0020HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmCsq0020Event 참조
 * @since J2EE 1.6
 */

public class ESM_CSQ_0020HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_CSQ_0020HTMLAction 객체를 생성
	 */
	public ESM_CSQ_0020HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCsq0020Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCsq0020Event event = new EsmCsq0020Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
			event.setCsqQtaLodRevVOS((CsqQtaLodRevVO[])getVOs(request, CsqQtaLodRevVO .class,""));
