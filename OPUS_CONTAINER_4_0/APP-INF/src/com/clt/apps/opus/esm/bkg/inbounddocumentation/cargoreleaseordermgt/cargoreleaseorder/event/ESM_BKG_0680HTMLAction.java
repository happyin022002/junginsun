...
public class ESM_BKG_0680HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        log.debug("===================================");
        log.debug("    ESM_BKG_0680HTMLAction Start   ");
        log.debug("===================================");
        ...
        *****************************************************************/
        ...
        if(command.isCommand(FormCommand.SEARCH)) {
            ...
            if (null != bkgDoRefVOs) {
            	...
            	idaDoRlse.setDoSplitFlg(bkgDoRefVOs[0].getDoSplitFlg());  
            	idaDoRlse.setDoHldFlg(bkgDoRefVOs[0].getDoHldFlg()); 
	    	...
	    	log.debug("===================================");
	    	log.debug("    D/O Release 내역을 삭제 처리한다. Cancel  ");
	    	log.debug("===================================");
            ...
            String splitFlg = request.getParameter("split_flg");
...
//            DoCancelVO doCancel = new DoCancelVO();
            ...
            if ("Y".equals(splitFlg)) {
                event.setdoCntrRlseSts((EuDoCntrRlseStsVO[])getVOs(request, EuDoCntrRlseStsVO.class,"cntrRlseSts_"));

                doNo = event.getdoCntrRlseSts()[0].getDoNo();
            } else {
                event.setEuDoRlseSts((EuDoRlseStsVO[])getVOs(request, EuDoRlseStsVO.class,"doRlseSts_"));
