...
*@FileName       : SearchMonthlyQuotaInquiry0049Tab04VO.java
*@FileTitle      : SearchMonthlyQuotaInquiry0049Tab04VO
*Open Issues     :
*Change history  :
*@LastModifyDate : 
*@LastModifier   : 
...
public class SearchMonthlyQuotaInquiry0049Tab04VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMonthlyQuotaInquiry0049Tab04VO> models = new ArrayList<SearchMonthlyQuotaInquiry0049Tab04VO>();
	...
	public SearchMonthlyQuotaInquiry0049Tab04VO() {}

	public SearchMonthlyQuotaInquiry0049Tab04VO(String ibflag, String pagerows, String key, String slevel, String subTrdCd, String rlaneCd, String convDirCd, String rhqCd, String aqCd, String ofcCd1, String ofcCd2, String rowSeq, String itemText, String item, String val00, String val01, String val02, String val03) {
		this.val01 = val01;
		this.ofcCd2 = ofcCd2;
		this.val02 = val02;
		this.ofcCd1 = ofcCd1;
	 ...
	 * @param request
	 * @return SearchMonthlyQuotaInquiry0049Tab04VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab04VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMonthlyQuotaInquiry0049Tab04VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab04VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMonthlyQuotaInquiry0049Tab04VO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMonthlyQuotaInquiry0049Tab04VO();
				if (val01[i] != null)
		...
		return getSearchMonthlyQuotaInquiry0049Tab04VOs();
	}
	 ...
	 * @return SearchMonthlyQuotaInquiry0049Tab04VO[]
	 */
	public SearchMonthlyQuotaInquiry0049Tab04VO[] getSearchMonthlyQuotaInquiry0049Tab04VOs(){
		SearchMonthlyQuotaInquiry0049Tab04VO[] vos = (SearchMonthlyQuotaInquiry0049Tab04VO[])models.toArray(new SearchMonthlyQuotaInquiry0049Tab04VO[models.size()]);
		return vos;
	}
