...
*@FileName : AGTAuditDBDAOBeforeCanceledAcSeqDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOBeforeCanceledAcSeqDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTAuditDBDAOBeforeCanceledAcSeqDSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOBeforeCanceledAcSeqDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
