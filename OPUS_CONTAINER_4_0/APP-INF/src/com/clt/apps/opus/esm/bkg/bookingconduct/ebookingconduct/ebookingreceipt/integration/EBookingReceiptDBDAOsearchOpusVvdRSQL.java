...
*@FileName : EBookingReceiptDBDAOsearchOpusVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOsearchOpusVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOsearchOpusVvdRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOsearchOpusVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
