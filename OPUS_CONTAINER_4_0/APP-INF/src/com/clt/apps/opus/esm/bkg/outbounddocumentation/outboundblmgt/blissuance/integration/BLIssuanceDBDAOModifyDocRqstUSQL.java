...
public class BLIssuanceDBDAOModifyDocRqstUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		,OBL_PPD_KNT	= @[obl_ppd_knt]" ).append("\n"); 
		query.append("		,OBL_CLT_KNT	= @[obl_clt_knt]" ).append("\n"); 
		...
		query.append("		,NON_NEGO_PPD_KNT	= @[non_nego_ppd_knt]" ).append("\n"); 
		query.append("		,NON_NEGO_CLT_KNT	= @[non_nego_clt_knt]" ).append("\n"); 
		query.append("		,CPY_TTL_KNT		= @[cpy_ttl_knt]" ).append("\n"); 
		query.append("		,RQST_ISS_PLC_NM	= UPPER(@[rqst_iss_plc_nm])" ).append("\n"); 
