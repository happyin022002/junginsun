...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriActCustVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriActCustVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGriActCustVO Update
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriActCustVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriActCustVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RP_SCP_GRI_ACT_CUST SET" ).append("\n"); 
