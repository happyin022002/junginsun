...
*@FileName : AccountReceivableEDISendDBDAOSearchDblEdiSndr2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchDblEdiSndr2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchDblEdiSndr2RSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchDblEdiSndr2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        FROM   (SELECT DISTINCT NVL (EDI_SND_ID, 'OPUSBKG') EY_EDISND_ID" ).append("\n"); 
