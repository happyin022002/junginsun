...
*@FileName : JointOperationAccrualCreationDBDAOEstmActRsltVOByVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationAccrualCreationDBDAOEstmActRsltVOByVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationAccrualCreationDBDAOEstmActRsltVOByVvdRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationAccrualCreationDBDAOEstmActRsltVOByVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
