...
*@FileName : ARInvoiceCustomerMgtDBDAOsearchCustomerCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOsearchCustomerCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOsearchCustomerCntRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOsearchCustomerCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("and b.locl_nm like @[cust_nm] || '%'" ).append("\n"); 
