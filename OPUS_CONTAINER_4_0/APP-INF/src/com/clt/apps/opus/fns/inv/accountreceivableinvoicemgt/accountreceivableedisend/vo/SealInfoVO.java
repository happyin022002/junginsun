...
*@FileName : SealInfoVO.java
*@FileTitle : SealInfoVO
*Open Issues :
*Change history :
...
public class SealInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SealInfoVO> models = new ArrayList<SealInfoVO>();
	...
	public SealInfoVO(String ibflag, String pagerows, String cntrSealNo, String sealPtyTpCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return SealInfoVO[]
	 */
	public SealInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SealInfoVO[]
	 */
	public SealInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SealInfoVO model = null;
	 ...
	 * @return SealInfoVO[]
	 */
	public SealInfoVO[] getSealInfoVOs(){
		SealInfoVO[] vos = (SealInfoVO[])models.toArray(new SealInfoVO[models.size()]);
		return vos;
	}
