...
*@FileName : FNS_JOO_0085HTMLAction.java
...
public class FNS_JOO_0085HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0085HTMLAction 객체를 생성
	 */
	public FNS_JOO_0085HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0085Event event = new FnsJoo0085Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCusBzcAgmtVOS((CusBzcAgmtVO[])getVOs(request, CusBzcAgmtVO .class,"sheet1_"));
		}else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCusBzcAgmtVO((CusBzcAgmtVO)getVO(request, CusBzcAgmtVO .class));
