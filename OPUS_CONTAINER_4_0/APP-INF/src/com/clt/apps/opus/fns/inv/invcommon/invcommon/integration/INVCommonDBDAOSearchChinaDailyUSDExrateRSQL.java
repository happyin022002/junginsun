...
*@FileName : INVCommonDBDAOSearchChinaDailyUSDExrateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class INVCommonDBDAOSearchChinaDailyUSDExrateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public INVCommonDBDAOSearchChinaDailyUSDExrateRSQL(){
		setQuery();
		...
		query.append("FileName : INVCommonDBDAOSearchChinaDailyUSDExrateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      INV_CUST_AND_DLY_XCH_RT B" ).append("\n"); 
