...
*@FileName : GeneralARInvoiceMasterDataMgtDBDAOsearchSCCustomerNameRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceMasterDataMgtDBDAOsearchSCCustomerNameRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchSCCustomerName
	  * </pre>
	  */
	public GeneralARInvoiceMasterDataMgtDBDAOsearchSCCustomerNameRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceMasterDataMgtDBDAOsearchSCCustomerNameRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM PRI_SP_CTRT_PTY A, " ).append("\n"); 
		query.append("       MDM_CUSTOMER M" ).append("\n"); 
		query.append(" WHERE A.CUST_CNT_CD = M.CUST_CNT_CD" ).append("\n"); 
		query.append("   AND A.CUST_SEQ    = M.CUST_SEQ" ).append("\n"); 
		...
		query.append("        FROM PRI_SP_CTRT_PTY C, PRI_SP_HDR D" ).append("\n"); 
