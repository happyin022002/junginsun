...
*@FileName : JointOperationAccrualCreationDBDAORemJooEstmActRsltListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationAccrualCreationDBDAORemJooEstmActRsltListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * JOO_ESTM_ACT_RSLT List Delete
	  * </pre>
	  */
	public JointOperationAccrualCreationDBDAORemJooEstmActRsltListDSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationAccrualCreationDBDAORemJooEstmActRsltListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM JOO_ESTM_ACT_RSLT A" ).append("\n"); 
		...
		query.append("   AND A.ESTM_ACT_SEQ   = @[estm_act_seq]" ).append("\n"); 
