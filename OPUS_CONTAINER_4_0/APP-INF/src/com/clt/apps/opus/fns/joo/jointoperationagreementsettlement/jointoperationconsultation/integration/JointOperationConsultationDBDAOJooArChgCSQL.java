...
*@FileName : JointOperationConsultationDBDAOJooArChgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOJooArChgCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * JOO_AR_CHG테이블에 INSERT한다.
	  * </pre>
	  */
	public JointOperationConsultationDBDAOJooArChgCSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOJooArChgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
