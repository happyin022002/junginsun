...
*@FileName : ARInvoiceCorrectionDBDAOSearchInvNoByIfNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCorrectionDBDAOSearchInvNoByIfNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search Inv No By IfNo
	  * </pre>
	  */
	public ARInvoiceCorrectionDBDAOSearchInvNoByIfNoRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCorrectionDBDAOSearchInvNoByIfNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
