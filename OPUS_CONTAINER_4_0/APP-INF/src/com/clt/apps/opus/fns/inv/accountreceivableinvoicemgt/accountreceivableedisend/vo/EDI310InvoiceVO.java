 ...
 *@FileName : EDI310InvoiceVO.java
 *@FileTitle : EDI310InvoiceVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class EDI310InvoiceVO	extends	 AbstractValueObject
{

	private	 static final long serialVersionUID = 1L;

	private	 Collection<EDI310InvoiceVO>  models =	new	ArrayList<EDI310InvoiceVO>();
	...
	/**	Constructor	*/
	public EDI310InvoiceVO(){}

	public EDI310InvoiceVO(String porCd,String vslCd,String currCd,String custNm,String blNoSeq,String invTtlLoclAmt,String svcScpCd,String trfRtAmt,String chgSeq,String blNo,String sailArrDt,String chgCd,String pagerows,String rfaNo,String polCd,String ibflag,String scNo,String arIfNo,String chgAmt,String actCustCntCd,String ediHdrSeq,String ediSndFlg,String invDt,String perTpCd,String loclCurrCd,String actCustSeq,String trnkVvdCd,String delCd,String skdVoyNo,String ioBndCd,String ediTpCd,String arOfcCd,String skdDirCd,String podCd,String invNo,String bkgNo,String slanCd,String blSeq,String cntrNo,String bdrIndFlg,String revTpSrcCd,String ratAsCntrQty,String ediSndDt,String custCd,String mergeChk,String sourceCd,String selChk,String cnmvCycNo)	{
		this.porCd  = porCd ;
		this.vslCd  = vslCd ;
		this.currCd  = currCd ;
		this.custNm  = custNm ;
		this.blNoSeq  = blNoSeq ;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("bl_no_seq", getBlNoSeq());		
	...
	public  HashMap<String, String>  getFieldNames(){
		...
		this.hashFields.put("bl_no_seq", "blNoSeq");
 ...
 //	Getters	and	Setters
	...
	* @param  blNoSeq
	*/
	public void	setBlNoSeq( String	blNoSeq ) {
		this.blNoSeq =	blNoSeq;
	}
	...
	*/
	...
	public void	fromRequest(HttpServletRequest request,	String prefix) {
		...
		setBlNoSeq(JSPUtil.getParameter(request,	prefix + "bl_no_seq", ""));
	 ...
	 * @param request
	 * @return EDI310InvoiceVO[]
	 */
	public EDI310InvoiceVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return EDI310InvoiceVO[]
	 */
	public EDI310InvoiceVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		EDI310InvoiceVO model = null;
		...
		try	{
				...
				String[] blNoSeq =	(JSPUtil.getParameter(request, prefix +	"bl_no_seq".trim(),	length));
				...
				String[] mergeChk =	(JSPUtil.getParameter(request, prefix +	"merge_chk".trim(),	length));
				String[] sourceCd =	(JSPUtil.getParameter(request, prefix +	"source_cd".trim(),	length));
				String[] selChk =	(JSPUtil.getParameter(request, prefix +	"sel_chk".trim(),	length));
				String[] cnmvCycNo =	(JSPUtil.getParameter(request, prefix +	"cnmv_cyc_no".trim(),	length));
				for	(int i = 0;	i <	length;	i++) {
					model =	new	EDI310InvoiceVO();
						if ( porCd[i] !=	null)
	...
	public EDI310InvoiceVO[]	 getEDI310InvoiceVOs(){
		EDI310InvoiceVO[] vos = (EDI310InvoiceVO[])models.toArray(new	EDI310InvoiceVO[models.size()]);
		return vos;
		}
	...
	*/
	public void	unDataFormat(){
		...
		this.blNoSeq =	this.blNoSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
