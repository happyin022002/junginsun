...
*@FileName : FNS_INV_0107HTMLAction.java
...
public class FNS_INV_0107HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0107HTMLAction 객체를 생성
	 */
	public FNS_INV_0107HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	FnsInv0107Event event = new FnsInv0107Event();

    	VVDExrateDateHisVO paramVO = (VVDExrateDateHisVO)getVO(request, VVDExrateDateHisVO.class);
    	
		event.setVvdExrateDateHisVO(paramVO);
