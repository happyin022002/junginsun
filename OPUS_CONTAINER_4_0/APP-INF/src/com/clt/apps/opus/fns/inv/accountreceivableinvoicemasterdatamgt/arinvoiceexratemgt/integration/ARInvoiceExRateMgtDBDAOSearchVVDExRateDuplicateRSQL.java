...
*@FileName : ARInvoiceExRateMgtDBDAOSearchVVDExRateDuplicateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOSearchVVDExRateDuplicateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOSearchVVDExRateDuplicateRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOSearchVVDExRateDuplicateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
