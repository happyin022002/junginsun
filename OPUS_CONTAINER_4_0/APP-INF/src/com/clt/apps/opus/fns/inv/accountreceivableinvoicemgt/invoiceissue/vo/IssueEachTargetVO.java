...
public class IssueEachTargetVO extends AbstractValueObject {
	...
	/* Column Info */
	private String invIssSglFlg = null;
	/* Column Info */
	...
	public IssueEachTargetVO(String ibflag, String pagerows, String invNo, String ofcCd, String currCd, String arIfNo, String chgSeq, String arIfSerNo, String invIssSglFlg) {
		this.invNo = invNo;
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
		this.currCd = currCd;
		this.invIssSglFlg = invIssSglFlg;
		this.arIfNo = arIfNo;
		this.chgSeq = chgSeq;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inv_iss_sgl_flg", getInvIssSglFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inv_iss_sgl_flg", "invIssSglFlg");
	 ...
	 * @return invIssSglFlg
	 */
	public String getInvIssSglFlg() {
		return this.invIssSglFlg;
	}
	 ...
	 * @param invIssSglFlg
	 */
	public void setInvIssSglFlg(String invIssSglFlg) {
		this.invIssSglFlg = invIssSglFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInvIssSglFlg(JSPUtil.getParameter(request, "inv_iss_sgl_flg", ""));
	...
	public IssueEachTargetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] invIssSglFlg = (JSPUtil.getParameter(request, prefix	+ "inv_iss_sgl_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (invIssSglFlg[i] != null)
					model.setInvIssSglFlg(invIssSglFlg[i]);
				if (arIfNo[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.invIssSglFlg = this.invIssSglFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
