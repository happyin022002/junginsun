...
*@FileName : InvEDICntrVO.java
*@FileTitle : InvEDICntrVO
*Open Issues :
*Change history :
...
public class InvEDICntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvEDICntrVO> models = new ArrayList<InvEDICntrVO>();
	...
	public InvEDICntrVO(String ibflag, String pagerows, String ediHdrSeq, String cntrSeq, String cntrNo, String cntrTpszCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return InvEDICntrVO[]
	 */
	public InvEDICntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvEDICntrVO[]
	 */
	public InvEDICntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvEDICntrVO model = null;
	 ...
	 * @return InvEDICntrVO[]
	 */
	public InvEDICntrVO[] getInvEDICntrVOs(){
		InvEDICntrVO[] vos = (InvEDICntrVO[])models.toArray(new InvEDICntrVO[models.size()]);
		return vos;
	}
