...
public class CarrierSettlementProcessDBDAOCreOusRdrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          -- 2010.03.25 WEIGHT PER TEU 는 EXPENSE일지라고 OWN가 아니 해당 선사 것을 가져온다." ).append("\n"); 
		...
		query.append("ORDER  BY 1 DESC, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, REV_DIR_CD, IOC_CD, SCONTI_CD, FM_PORT_CD, TO_PORT_CD, STL_SEQ" ).append("\n"); 
