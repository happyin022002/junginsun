...
*@FileName : CarrierSettlementProcessDBDAOSearchCntrStandardFormatPreviousReportRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOSearchCntrStandardFormatPreviousReportRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOSearchCntrStandardFormatPreviousReportRSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAOSearchCntrStandardFormatPreviousReportRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       , V_VVD N /*현재 VVD 만 보기 위해서 조인함.*/" ).append("\n"); 
		query.append(" WHERE 1=1" ).append("\n"); 
		...
		query.append("   AND P.VSL_CD         = N.VSL_CD" ).append("\n"); 
		query.append("   AND P.SKD_VOY_NO     = N.SKD_VOY_NO" ).append("\n"); 
		query.append("   AND P.SKD_DIR_CD     = N.SKD_DIR_CD" ).append("\n"); 
