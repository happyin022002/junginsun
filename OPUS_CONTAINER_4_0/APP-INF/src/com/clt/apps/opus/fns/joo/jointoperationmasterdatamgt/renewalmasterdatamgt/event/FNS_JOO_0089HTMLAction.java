...
public class FNS_JOO_0089HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		event.setMstConditionVO((MstConditionVO)getVO(request, MstConditionVO.class));

		if(command.isCommand(FormCommand.MULTI)) {			
			FinancialAffairsMtxVO[] revenueFinancialAffairsMtxVO = (FinancialAffairsMtxVO[])getVOs(request, FinancialAffairsMtxVO.class,"sheet1_");
			FinancialAffairsMtxVO[] expenseFinancialAffairsMtxVO = (FinancialAffairsMtxVO[])getVOs(request, FinancialAffairsMtxVO.class,"sheet2_");
			
			event.setFinancialAffairsMtxGrpVO(revenueFinancialAffairsMtxVO, "R");
			event.setFinancialAffairsMtxGrpVO(expenseFinancialAffairsMtxVO, "E");
