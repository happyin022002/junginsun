...
*@FileName : AccountReceivableInvoiceMigrationDBDAOsearchInvArIfMainRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOsearchInvArIfMainRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AccountReceivableInvoiceMigrationDBDAOsearchInvArIfMainRSQL
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOsearchInvArIfMainRSQL(){
		setQuery();
		...
		params.put("to_src_if_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("fm_src_if_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOsearchInvArIfMainRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   I.OTS_PAY_CD," ).append("\n"); 
		query.append("   I.INV_DT" ).append("\n"); 
		query.append("FROM MIGADM.MIG_INV_AR_IF_MN I" ).append("\n"); 
		query.append("WHERE NVL(BL_INV_IF_FLG, 'N') = 'N'" ).append("\n"); 
		query.append("#if (${ofc_cd} != '') " ).append("\n"); 
		query.append("  AND OFC_CD = @[ofc_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${fm_src_if_seq} != '')" ).append("\n"); 
		query.append("  AND SRC_IF_SEQ >= @[fm_src_if_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${to_src_if_seq} != '')" ).append("\n"); 
		query.append("  AND SRC_IF_SEQ <= @[to_src_if_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
