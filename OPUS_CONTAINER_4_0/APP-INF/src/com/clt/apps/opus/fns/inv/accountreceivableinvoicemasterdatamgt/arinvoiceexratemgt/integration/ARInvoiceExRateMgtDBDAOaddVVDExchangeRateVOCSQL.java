...
*@FileName : ARInvoiceExRateMgtDBDAOaddVVDExchangeRateVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOaddVVDExchangeRateVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INV_VVD_XCH_RT
	  * [] ARInvoiceExRateMgtDBDAO::addVVDExchangeRate ( vvdExrateVos )
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOaddVVDExchangeRateVOCSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOaddVVDExchangeRateVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
