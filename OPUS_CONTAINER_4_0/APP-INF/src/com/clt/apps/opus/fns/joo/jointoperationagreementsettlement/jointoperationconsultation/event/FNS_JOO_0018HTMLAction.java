...
*@FileName : FNS_JOO_0018HTMLAction.java
...
public class FNS_JOO_0018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0018HTMLAction 객체를 생성
	 */
	public FNS_JOO_0018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0018Event event = new FnsJoo0018Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			JooTaxDtlVO[] jooTaxDtlVOs = (JooTaxDtlVO[])getVOs(request, JooTaxDtlVO.class, "sheet1_");
			JooTaxVO   [] jooTaxVOs    = (JooTaxVO[])   getVOs(request, JooTaxVO.class   , "sheet2_");

			event.setJooTaxVO(jooTaxVOs[0]);
			event.setJooTaxDtlVOs(jooTaxDtlVOs);
		}
