...
*@FileName : RenewalMasterDataMgtDBDAORemoveAuthorityCarrierDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalMasterDataMgtDBDAORemoveAuthorityCarrierDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Authority Carrier Delete
	  * </pre>
	  */
	public RenewalMasterDataMgtDBDAORemoveAuthorityCarrierDSQL(){
		setQuery();
		...
		query.append("FileName : RenewalMasterDataMgtDBDAORemoveAuthorityCarrierDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
