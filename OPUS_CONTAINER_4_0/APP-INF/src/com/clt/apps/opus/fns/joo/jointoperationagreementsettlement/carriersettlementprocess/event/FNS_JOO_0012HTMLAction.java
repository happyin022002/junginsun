...
*@FileName : FNS_JOO_0012HTMLAction.java
*@FileTitle : Other
*Open Issues :
*Change history :
...
public class FNS_JOO_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0012HTMLAction 객체를 생성
	 */
	public FNS_JOO_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0012Event event = new FnsJoo0012Event();
