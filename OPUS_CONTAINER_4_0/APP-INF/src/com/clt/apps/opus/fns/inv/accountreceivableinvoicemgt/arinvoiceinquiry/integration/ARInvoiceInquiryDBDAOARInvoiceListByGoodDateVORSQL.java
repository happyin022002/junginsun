...
public class ARInvoiceInquiryDBDAOARInvoiceListByGoodDateVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  DECODE(A.INV_CLR_FLG, 'Y', 'SYS CLEAR', NVL(A.INV_NO, DECODE(G.DMDT_AR_INV_ISS_FLG, 'N', A.INV_SRC_NO, DECODE(G.N3PTY_BIL_AR_INV_FLG, 'N', A.INV_SRC_NO, DECODE(G.TML_INV_ISS_FLG, 'N', A.INV_SRC_NO, NULL))))) INV_NO," ).append("\n"); 
		...
		query.append("  NVL(A.OTS_PAY_CD, 'N') AS OTS_PAY_CD, -- Including Migration Data" ).append("\n"); 
