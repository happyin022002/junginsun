...
*@FileName : ARInvoiceExRateMgtDBDAOSearch3rdExRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOSearch3rdExRateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOSearch3rdExRateRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOSearch3rdExRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
