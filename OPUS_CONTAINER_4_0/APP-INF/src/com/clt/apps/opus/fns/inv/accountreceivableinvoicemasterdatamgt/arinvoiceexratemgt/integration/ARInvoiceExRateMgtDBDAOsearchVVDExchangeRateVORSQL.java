...
*@FileName : ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [] ARInvoiceExRateMgtDBDAO::searchVVDExchangeRate ( vvdExrateVos )
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateVORSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
