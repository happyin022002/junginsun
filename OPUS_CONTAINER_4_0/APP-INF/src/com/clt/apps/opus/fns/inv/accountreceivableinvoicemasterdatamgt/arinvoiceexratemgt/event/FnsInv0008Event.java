...
public class FnsInv0008Event extends EventSupport {
	...
	/** Table Value Object 조회 조건 및 단건 처리  */
	private ExRateHistoryVO exRateHistoryVO = null;
	
	/** Table Value Object Multi Data 처리 */
	private ExRateHistoryVO[] exRateHistoryVOs = null;	
	
	private String pageType = null;	
	
	private String callPageName = null;
	...
	public ExRateHistoryVO getExRateHistoryVO() {
		return exRateHistoryVO;
	}

	public void setExRateHistoryVO(ExRateHistoryVO exRateHistoryVO) {
		this.exRateHistoryVO = exRateHistoryVO;
	}

	public ExRateHistoryVO[] getExRateHistoryVOs() {
		ExRateHistoryVO[] rtnVOs = null;
		if (this.exRateHistoryVOs != null) {
			rtnVOs = new ExRateHistoryVO[exRateHistoryVOs.length];
			System.arraycopy(exRateHistoryVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}

	public void setExRateHistoryVOs(ExRateHistoryVO[] exRateHistoryVOs) {
		if (exRateHistoryVOs != null) {
			ExRateHistoryVO[] tmpVOs = new ExRateHistoryVO[exRateHistoryVOs.length];
			System.arraycopy(exRateHistoryVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.exRateHistoryVOs = tmpVOs;
		}
	}
