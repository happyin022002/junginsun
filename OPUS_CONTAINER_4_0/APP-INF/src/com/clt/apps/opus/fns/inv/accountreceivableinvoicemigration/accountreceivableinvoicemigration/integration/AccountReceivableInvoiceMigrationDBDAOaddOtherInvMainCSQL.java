...
*@FileName : AccountReceivableInvoiceMigrationDBDAOaddOtherInvMainCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOaddOtherInvMainCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AccountReceivableInvoiceMigrationDBDAOaddOtherInvMainCSQL
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOaddOtherInvMainCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOaddOtherInvMainCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[whf_decl_ofc_cd]	" ).append("\n"); 
		query.append(",@[whf_mrn_no]	" ).append("\n"); 
		query.append(",(SELECT DECODE(@[locl_curr_cd], 'USD', 1, ROUND(INV_XCH_RT / USD_XCH_RT, 6))" ).append("\n"); 
		query.append("  FROM OPUSADM_TMP.INV_AR_CHG" ).append("\n"); 
		...
		query.append("        FROM (SELECT A.CURR_CD, SUM(ROUND(A.CHG_AMT*A.INV_XCH_RT,B.DP_PRCS_KNT)) INV_TTL_LOCL_AMT" ).append("\n"); 
		query.append("                FROM OPUSADM_TMP.INV_AR_CHG A, MDM_CURRENCY B" ).append("\n"); 
		...
		query.append(",@[clr_dt]	" ).append("\n"); 
		query.append(",@[acct_cd]	 -- 90" ).append("\n"); 
		query.append(",DECODE(@[bl_inv_cfm_dt],'','',(SELECT NVL((SELECT MAX(IF_SEQ) FROM OPUSADM_TMP.INV_AR_MN WHERE BL_SRC_NO = @[bl_src_no]), 0) + 1 FROM DUAL))" ).append("\n"); 
		...
		query.append(",@[ots_pay_cd]" ).append("\n"); 
		query.append(",@[org_inv_no]" ).append("\n"); 
		query.append(",(SELECT DECODE(CURR_CD, @[locl_curr_cd], @[locl_curr_cd], 'USD', 'USD', @[locl_curr_cd])" ).append("\n"); 
		query.append("  FROM OPUSADM_TMP.INV_AR_CHG" ).append("\n"); 
		query.append("  WHERE AR_IF_NO = @[ar_if_no]" ).append("\n"); 
		query.append("  AND ROWNUM = 1)" ).append("\n"); 
		query.append(",(SELECT DECODE(CURR_CD, @[locl_curr_cd], @[locl_curr_cd], 'USD', 'USD', @[locl_curr_cd])" ).append("\n"); 
		...
		query.append("  WHERE AR_IF_NO = @[ar_if_no]" ).append("\n"); 
		query.append("  AND ROWNUM = 1)" ).append("\n"); 
		query.append(",(SELECT DECODE(@[locl_curr_cd], 'USD', 1, ROUND(USD_XCH_RT / INV_XCH_RT, 6))" ).append("\n"); 
		query.append("  FROM OPUSADM_TMP.INV_AR_CHG" ).append("\n"); 
		query.append("  WHERE AR_IF_NO = @[ar_if_no]" ).append("\n"); 
		query.append("  AND ROWNUM = 1)" ).append("\n"); 
		query.append(")" ).append("\n"); 
