...
*@FileName : AccountReceivableInvoiceMigrationDBDAOAddInvChargeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOAddInvChargeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOAddInvChargeCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOAddInvChargeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",(SELECT DECODE(INV_CURR_CD, LOCL_CURR_CD, NVL(@[inv_xch_rt], 0), NVL(@[usd_xch_rt], 0)) FROM OPUSADM_TMP.INV_AR_MN WHERE AR_IF_NO = @[ar_if_no])" ).append("\n"); 
		query.append(")" ).append("\n"); 
