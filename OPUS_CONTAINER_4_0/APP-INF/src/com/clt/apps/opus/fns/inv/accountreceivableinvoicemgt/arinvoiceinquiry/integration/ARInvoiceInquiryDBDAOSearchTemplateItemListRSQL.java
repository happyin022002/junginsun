...
*@FileName : ARInvoiceInquiryDBDAOSearchTemplateItemListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceInquiryDBDAOSearchTemplateItemListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceInquiryDBDAOSearchTemplateItemListRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceInquiryDBDAOSearchTemplateItemListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
