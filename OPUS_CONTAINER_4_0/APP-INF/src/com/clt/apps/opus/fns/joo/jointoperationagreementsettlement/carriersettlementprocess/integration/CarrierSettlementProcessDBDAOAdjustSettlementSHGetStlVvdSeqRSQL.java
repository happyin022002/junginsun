...
*@FileName : CarrierSettlementProcessDBDAOAdjustSettlementSHGetStlVvdSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOAdjustSettlementSHGetStlVvdSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Adjustment에서 새로 생성될 STL_VVD_SEQ를 조회한다.
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOAdjustSettlementSHGetStlVvdSeqRSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAOAdjustSettlementSHGetStlVvdSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
