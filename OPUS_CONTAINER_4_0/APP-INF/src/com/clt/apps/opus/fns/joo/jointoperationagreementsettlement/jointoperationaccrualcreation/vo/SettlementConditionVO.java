...
public class SettlementConditionVO extends AbstractValueObject {
    ...
    public SettlementConditionVO(String ibflag, String reDivrCd, String exeYrmon, String joCrrCd, String trdCd, String rlaneCd, String revYrmonFr, String revYrmonTo, String ofcCd, String creFlg, String pageNo, String pagerows, String usrId, String vvd, String joStlItmCds, String joStlItmCd, String voyDaysCd, String chkInclude, String joStlItmFlg) {
        this.creFlg = creFlg;
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setVoyDaysCd(JSPUtil.getParameter(request, prefix + "voy_days_cd", ""));
        setChkInclude(JSPUtil.getParameter(request, prefix + "chk_include", ""));
        setJoStlItmFlg(JSPUtil.getParameter(request, prefix + "jo_stl_itm_flg", ""));
    }
