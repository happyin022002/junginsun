...
public class ARInvoiceInquiryDBDAOARInvoiceChargeByBLNoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  SAR_GET_FMT_MASK_FNC(LOCL_CURR_CD,LOCAL_TOTAL) LOCAL_TOTAL," ).append("\n"); 
		...
		query.append("      SUM(SAR_GET_CUR_AMT_FNC(A.LOCL_CURR_CD,B.CHG_AMT*B.INV_XCH_RT)) LOCAL_TOTAL," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("    GROUP BY B.CHG_CD, B.MF_DIV_CD, B.TRF_RT_AMT, DECODE(B.PER_TP_CD, 'PC', TO_CHAR(B.CHG_SEQ), B.PER_TP_CD), B.PER_TP_CD, B.CURR_CD, D.DP_PRCS_KNT, B.INV_XCH_RT, A.LOCL_CURR_CD, E.DP_PRCS_KNT)" ).append("\n"); 
