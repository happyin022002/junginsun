...
*@FileName : JointOperationConsultationDBDAOSlipDelByCsrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOSlipDelByCsrDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CSR_NO로 JOO_SLIP 데이터 삭제한다.
	  * </pre>
	  */
	public JointOperationConsultationDBDAOSlipDelByCsrDSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOSlipDelByCsrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE JOO_SLIP" ).append("\n"); 
