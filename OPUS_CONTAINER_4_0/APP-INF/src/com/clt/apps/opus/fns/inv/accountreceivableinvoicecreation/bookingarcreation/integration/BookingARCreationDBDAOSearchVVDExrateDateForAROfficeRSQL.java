...
*@FileName : BookingARCreationDBDAOSearchVVDExrateDateForAROfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOSearchVVDExrateDateForAROfficeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search VVD Exrate Date For AR Office
	  * </pre>
	  */
	public BookingARCreationDBDAOSearchVVDExrateDateForAROfficeRSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOSearchVVDExrateDateForAROfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT XCH_RT_DT" ).append("\n"); 
