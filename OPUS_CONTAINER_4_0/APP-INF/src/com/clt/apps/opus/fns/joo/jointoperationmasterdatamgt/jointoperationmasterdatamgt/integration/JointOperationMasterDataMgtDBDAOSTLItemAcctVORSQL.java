...
public class JointOperationMasterDataMgtDBDAOSTLItemAcctVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(A.JO_AUTO_CRE_FLG,'Y','1','0') AS JO_AUTO_CRE_FLG" ).append("\n"); 
		query.append("      ,DECODE(A.JO_MNL_CRE_FLG,'Y','1','0') AS JO_MNL_CRE_FLG" ).append("\n"); 
		...
		query.append("      A.ORD_SEQ, A.JO_STL_ITM_CD ASC, 5, 3 DESC" ).append("\n"); 
