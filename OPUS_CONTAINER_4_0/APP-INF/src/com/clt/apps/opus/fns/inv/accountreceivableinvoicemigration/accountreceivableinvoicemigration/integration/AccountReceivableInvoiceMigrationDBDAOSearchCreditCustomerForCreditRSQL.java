...
*@FileName : AccountReceivableInvoiceMigrationDBDAOSearchCreditCustomerForCreditRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOSearchCreditCustomerForCreditRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search Credit Customer For Credit
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOSearchCreditCustomerForCreditRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOSearchCreditCustomerForCreditRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
