...
*@FileName : BookingARCreationBackEndDBDAOModifyOTSHeaderINVExrateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOModifyOTSHeaderINVExrateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOModifyOTSHeaderINVExrateUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOModifyOTSHeaderINVExrateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET INV_LOCL_XCH_RT = DECODE(INV_CURR_CD, OFC_CURR_CD, 1, NVL(@[inv_xch_rt], 0)), " ).append("\n"); 
