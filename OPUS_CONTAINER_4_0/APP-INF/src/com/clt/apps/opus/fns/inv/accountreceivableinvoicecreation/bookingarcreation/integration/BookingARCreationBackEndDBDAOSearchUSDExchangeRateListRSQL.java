...
*@FileName : BookingARCreationBackEndDBDAOSearchUSDExchangeRateListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOSearchUSDExchangeRateListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOSearchUSDExchangeRateListRSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOSearchUSDExchangeRateListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE MN.LOCL_CURR_CD = DECODE(@[locl_curr_cd], 'USD', @[chg_curr_cd], @[locl_curr_cd])" ).append("\n"); 
		...
		query.append("				(MN.INV_ISS_FLG = 'N' OR " ).append("\n"); 
		query.append("					-- (MN.REV_SRC_CD IN ('DM','DT') AND OFC.DMDT_AR_INV_ISS_FLG = 'N') OR" ).append("\n"); 
		query.append("					MN.INV_CLR_FLG = 'Y' OR" ).append("\n"); 
		query.append("					NVL(MN.USD_XCH_RT,0) = 0 OR NVL(MN.INV_LOCL_XCH_RT,0) = 0 OR NVL(MN.INV_USD_XCH_RT,0) = 0" ).append("\n"); 
		query.append("				)" ).append("\n"); 
		query.append("			) " ).append("\n"); 
