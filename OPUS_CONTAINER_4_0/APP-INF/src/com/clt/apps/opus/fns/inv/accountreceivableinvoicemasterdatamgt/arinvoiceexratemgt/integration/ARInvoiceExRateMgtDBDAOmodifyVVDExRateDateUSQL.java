...
*@FileName : ARInvoiceExRateMgtDBDAOmodifyVVDExRateDateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOmodifyVVDExRateDateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INV_VVD_XCH_RT_DT
	  * [] ARInvoiceExRateMgtDBDAO::modifyVVDExRateDate ( vvdExrateVos )
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOmodifyVVDExRateDateUSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOmodifyVVDExRateDateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE INV_VVD_XCH_RT_DT SET " ).append("\n"); 
		query.append("	XCH_RT_DT = @[xch_rt_dt]" ).append("\n"); 
		query.append(",   CNG_RMK = @[cng_rmk]" ).append("\n"); 
