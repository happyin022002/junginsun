...
*@FileName : JooFileUploadDBDAOFileUploadListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooFileUploadDBDAOFileUploadListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooFileUploadDBDAOFileUploadListCSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.fns.joo.joocommon.joofileupload.integration").append("\n"); 
		query.append("FileName : JooFileUploadDBDAOFileUploadListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO JOO_CNTC_MBR_ATCH_FILE" ).append("\n"); 
