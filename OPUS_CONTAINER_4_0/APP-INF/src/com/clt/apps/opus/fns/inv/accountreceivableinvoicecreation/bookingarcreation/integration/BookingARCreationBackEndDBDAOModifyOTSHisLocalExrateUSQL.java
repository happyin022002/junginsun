...
*@FileName : BookingARCreationBackEndDBDAOModifyOTSHisLocalExrateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOModifyOTSHisLocalExrateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify OTS History Local Exrate
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOModifyOTSHisLocalExrateUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOModifyOTSHisLocalExrateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
