...
*@FileName : JointOperationMasterDataMgtDAOAddAuthorityOfficeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationMasterDataMgtDAOAddAuthorityOfficeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationMasterDataMgtDAOAddAuthorityOfficeCSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationMasterDataMgtDAOAddAuthorityOfficeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO JOO_CRR_AUTH" ).append("\n"); 
