...
*@FileName : CmdtInfoVO.java
*@FileTitle : CmdtInfoVO
*Open Issues :
*Change history :
...
public class CmdtInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CmdtInfoVO> models = new ArrayList<CmdtInfoVO>();
	...
	public CmdtInfoVO(String ibflag, String pagerows, String cntrMfSeq, String cntrMfGdsDesc, String pckQty, String pckTpCd, String cntrMfWgt, String wgtUtCd, String measQty, String measUtCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return CmdtInfoVO[]
	 */
	public CmdtInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CmdtInfoVO[]
	 */
	public CmdtInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CmdtInfoVO model = null;
	 ...
	 * @return CmdtInfoVO[]
	 */
	public CmdtInfoVO[] getCmdtInfoVOs(){
		CmdtInfoVO[] vos = (CmdtInfoVO[])models.toArray(new CmdtInfoVO[models.size()]);
		return vos;
	}
