...
*@FileName : ARInvoiceExRateMgtDBDAORemoveVVDExchangeRateVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAORemoveVVDExchangeRateVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ARInvoiceExRateMgtDBDAO::removeVVDExchangeRate ( vvdExrateVos )
	  * INV_VVD_XCH_RT  테이블에 delete
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAORemoveVVDExchangeRateVODSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAORemoveVVDExchangeRateVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM INV_VVD_XCH_RT" ).append("\n"); 
