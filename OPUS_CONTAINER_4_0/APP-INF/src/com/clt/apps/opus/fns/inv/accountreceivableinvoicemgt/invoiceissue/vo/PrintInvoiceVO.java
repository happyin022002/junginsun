...
public class PrintInvoiceVO extends AbstractValueObject {
	...
	public PrintInvoiceVO(String ibflag, String pagerows, String flag, String fInv, String tInv, String issOfcCd, String issueGubn, String invs, String userOfc, String userId, String otsSmryCd, String prevFlg, String gotoFlg) {
		this.ibflag = ibflag;
		this.flag = flag;
