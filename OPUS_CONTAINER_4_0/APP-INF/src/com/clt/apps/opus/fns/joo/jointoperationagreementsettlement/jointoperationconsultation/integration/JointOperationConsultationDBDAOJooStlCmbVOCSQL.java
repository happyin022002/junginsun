...
*@FileName : JointOperationConsultationDBDAOJooStlCmbVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOJooStlCmbVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * JOO_STL_CMB 에 INSERT한다.
	  * </pre>
	  */
	public JointOperationConsultationDBDAOJooStlCmbVOCSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOJooStlCmbVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO JOO_STL_CMB (" ).append("\n"); 
		...
		query.append(",   RJCT_CMB_FLG" ).append("\n"); 
		...
		query.append(",	@[slp_iss_dt]" ).append("\n"); 
		query.append(",	@[slp_ser_no]" ).append("\n"); 
		query.append(",   NVL(@[rvs_cmb_flg],'N')" ).append("\n"); 
		query.append(",   NVL(@[rjct_cmb_flg],'N')" ).append("\n"); 
