...
*@FileName : BookingARCreationDBDAOAddExchangeRateTempCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOAddExchangeRateTempCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT INV_XCH_RT_TMP
	  * </pre>
	  */
	public BookingARCreationDBDAOAddExchangeRateTempCSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOAddExchangeRateTempCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_XCH_RT_TMP (" ).append("\n"); 
