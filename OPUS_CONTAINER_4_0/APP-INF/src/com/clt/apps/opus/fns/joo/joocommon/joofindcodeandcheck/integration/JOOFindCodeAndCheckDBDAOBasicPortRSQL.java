...
*@FileName : JOOFindCodeAndCheckDBDAOBasicPortRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOFindCodeAndCheckDBDAOBasicPortRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOOFindCodeAndCheckDBDAOBasicPortRSQL(){
		setQuery();
		...
		query.append("FileName : JOOFindCodeAndCheckDBDAOBasicPortRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE  B.SLAN_CD         = SUBSTR(C.RLANE_CD,1,3)" ).append("\n"); 
		...
		query.append("AND    C.VSL_CD          = SUBSTR(@[super_cd2],1,4)" ).append("\n"); 
		query.append("AND    C.SKD_VOY_NO      = SUBSTR(@[super_cd2],5,4)" ).append("\n"); 
		query.append("AND    C.SKD_DIR_CD      = SUBSTR(@[super_cd2],9,1)" ).append("\n"); 
		query.append("AND    C.RLANE_CD        = @[super_cd1]" ).append("\n"); 
		...
		query.append("		SELECT" ).append("\n"); 
		query.append("		       N1ST_STL_BZC_PORT_CD AS PORT_CD" ).append("\n"); 
		...
		query.append("		SELECT" ).append("\n"); 
		query.append("		       N2ND_STL_BZC_PORT_CD AS PORT_CD" ).append("\n"); 
		query.append("		FROM   JOO_STL_BSS_PORT A" ).append("\n"); 
		query.append("		WHERE  A.JO_CRR_CD  = @[code]" ).append("\n"); 
		query.append("		AND    A.RLANE_CD   = @[super_cd1]" ).append("\n"); 
		query.append("#if (${name} == 'R')" ).append("\n"); 
		...
		query.append("		AND    A.SKD_DIR_CD = SUBSTR(@[super_cd2],9,1)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("		AND    A.N2ND_STL_BZC_PORT_CD IS NOT NULL" ).append("\n"); 
		query.append("		UNION ALL" ).append("\n"); 
		query.append("		SELECT" ).append("\n"); 
		query.append("		       N3RD_STL_BZC_PORT_CD AS PORT_CD" ).append("\n"); 
		query.append("		FROM   JOO_STL_BSS_PORT A" ).append("\n"); 
		query.append("		WHERE  A.JO_CRR_CD  = @[code]" ).append("\n"); 
		query.append("		AND    A.RLANE_CD   = @[super_cd1]" ).append("\n"); 
		query.append("#if (${name} == 'R')" ).append("\n"); 
		...
		query.append("		AND    A.SKD_DIR_CD = SUBSTR(@[super_cd2],9,1)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("		AND    A.N3RD_STL_BZC_PORT_CD IS NOT NULL" ).append("\n"); 
