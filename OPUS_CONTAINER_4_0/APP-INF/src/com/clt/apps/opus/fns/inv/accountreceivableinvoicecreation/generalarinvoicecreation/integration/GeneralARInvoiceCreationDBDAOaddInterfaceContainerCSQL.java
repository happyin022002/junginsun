...
*@FileName : GeneralARInvoiceCreationDBDAOaddInterfaceContainerCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceCreationDBDAOaddInterfaceContainerCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralARInvoiceCreationDBDAOaddInterfaceContainerCSQL
	  * </pre>
	  */
	public GeneralARInvoiceCreationDBDAOaddInterfaceContainerCSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceCreationDBDAOaddInterfaceContainerCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_AR_IF_CNTR(" ).append("\n"); 
		...
		query.append("@[src_if_dt]" ).append("\n"); 
		query.append(", @[src_if_seq]" ).append("\n"); 
		query.append(", (SELECT NVL(MAX(CNTR_SEQ) + 1, 1)" ).append("\n"); 
