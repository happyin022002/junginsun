...
*@FileName : FNS_INV_0035HTMLAction.java
...
public class FNS_INV_0035HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0035HTMLAction 객체를 생성
	 */
	public FNS_INV_0035HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0035Event event = new FnsInv0035Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
//			event.setInvArIssVO((InvArIssVO)getVO(request, InvArIssVO .class));
			String pageType = request.getParameter("pagetype");
			String ofcCd = request.getParameter("iss_ofc_cd");
			...
			event.setIssMain((InvIssMainVO)getVO(request, InvIssMainVO .class));
		}
