...
*@FileName : FNS_INV_0059HTMLAction.java
...
public class FNS_INV_0059HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0059HTMLAction 객체를 생성
	 */
	public FNS_INV_0059HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0059Event event = new FnsInv0059Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFaxEmailSentDateVO((FaxEmailSentDateVO)getVO(request, FaxEmailSentDateVO .class));
		}
