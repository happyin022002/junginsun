...
import com.clt.apps.opus.fns.joo.jointoperationmasterdatamgt.jointoperationmasterdatamgt.event.FNS_JOO_0002HTMLAction;
...
public class FnsJoo0082Event extends EventSupport {
	...
	public FileUploadListVO[] getFileUploadListVOs() {
		...
		if (this.fileUploadListVOs != null) {
			tmpVOs = new FileUploadListVO[fileUploadListVOs.length];
