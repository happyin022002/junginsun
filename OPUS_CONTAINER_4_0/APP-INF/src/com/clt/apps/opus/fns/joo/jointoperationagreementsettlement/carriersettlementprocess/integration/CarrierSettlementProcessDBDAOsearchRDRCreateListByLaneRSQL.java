...
public class CarrierSettlementProcessDBDAOsearchRDRCreateListByLaneRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",VSL_CD,VOY_NO" ).append("\n"); 
		query.append(",DIR_CD,CLPT_SEQ" ).append("\n"); 
		query.append(",PORT_CD" ).append("\n"); 
		query.append(",TO_CHAR(VPS_ETD_DT,'YYYYMMDDHH24MI') AS VPS_ETD_DT" ).append("\n"); 
		query.append(",SKD_CNG_STS_CD" ).append("\n"); 
		query.append(",REGION,H_YN  pagerows" ).append("\n"); 
		query.append(",TO_CHAR(UPDATE_TIME,'YYYYMMDDHH24MI') AS UPDATE_TIME" ).append("\n"); 
