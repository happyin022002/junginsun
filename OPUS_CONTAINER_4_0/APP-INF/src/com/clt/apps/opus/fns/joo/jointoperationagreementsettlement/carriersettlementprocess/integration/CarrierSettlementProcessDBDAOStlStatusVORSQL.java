...
public class CarrierSettlementProcessDBDAOStlStatusVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                     ,SUM(DECODE(C.RE_DIVR_CD,'R', DECODE(C.LOCL_CURR_CD,'USD',C.STL_LOCL_AMT" ).append("\n"); 
		query.append("                                                         ,(ROUND(PSO_CONV_CURR_USD_FNC(C.LOCL_CURR_CD, NVL(C.STL_LOCL_AMT,0)" ).append("\n"); 
		...
		query.append("                                                               AND V.RLANE_CD = C.RLANE_CD),1),3))),0)) AS R_JOO_CMB_AMT" ).append("\n"); 
		query.append("                    ,SUM(DECODE(C.RE_DIVR_CD,'E',DECODE(C.LOCL_CURR_CD,'USD',C.STL_LOCL_AMT" ).append("\n"); 
		query.append("                                                     , (ROUND(PSO_CONV_CURR_USD_FNC(C.LOCL_CURR_CD, NVL(C.STL_LOCL_AMT,0)" ).append("\n"); 
		query.append("                                                     , (SELECT MAX(V.REV_YRMON)" ).append("\n"); 
		query.append("                                                          FROM AR_MST_REV_VVD V" ).append("\n"); 
		query.append("                                                         WHERE V.VSL_CD = C.VSL_CD" ).append("\n"); 
		query.append("                                                           AND V.SKD_VOY_NO = C.SKD_VOY_NO" ).append("\n"); 
		query.append("                                                           AND V.SKD_DIR_CD = C.SKD_DIR_CD" ).append("\n"); 
		query.append("                                                           AND V.RLANE_CD = C.RLANE_CD),1),3))),0)) AS E_JOO_CMB_AMT" ).append("\n"); 
		...
		query.append("#end " ).append("\n"); 
		query.append("#if (${ofc_cd} != '')" ).append("\n"); 
		query.append("               AND    (C.JO_CRR_CD, C.RLANE_CD) IN (" ).append("\n"); 
		query.append("                SELECT C.JO_CRR_CD" ).append("\n"); 
		query.append("                     , C.RLANE_CD" ).append("\n"); 
		query.append("                  FROM JOO_CRR_AUTH C" ).append("\n"); 
		query.append("                 WHERE 1=1" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		query.append("               AND NVL(E.SLP_OFC_CD, NVL(U.LST_LGIN_OFC_CD,U.OFC_CD)) = @[ofc_cd]" ).append("\n"); 
		query.append("#end        " ).append("\n"); 
		...
		query.append("                     ,SUM(DECODE(A.RE_DIVR_CD,'R',DECODE(C.CSR_LOCL_CURR_CD,'USD',C.CSR_LOCL_AMT" ).append("\n"); 
		query.append("                                                         ,(ROUND(PSO_CONV_CURR_USD_FNC(C.CSR_LOCL_CURR_CD, NVL(C.CSR_LOCL_AMT,0)" ).append("\n"); 
		query.append("                                                         ,(SELECT MAX(V.REV_YRMON)" ).append("\n"); 
		query.append("                                                              FROM AR_MST_REV_VVD V" ).append("\n"); 
		query.append("                                                             WHERE V.VSL_CD = C.VSL_CD" ).append("\n"); 
		query.append("                                                               AND V.SKD_VOY_NO = C.SKD_VOY_NO" ).append("\n"); 
		query.append("                                                               AND V.SKD_DIR_CD = C.SKD_DIR_CD" ).append("\n"); 
		query.append("                                                               AND V.RLANE_CD = C.RLANE_CD),1),3))),0)) AS R_JOO_SLP_AMT" ).append("\n"); 
		query.append("                     ,SUM(DECODE(A.RE_DIVR_CD,'E',DECODE(C.CSR_LOCL_CURR_CD,'USD',C.CSR_LOCL_AMT" ).append("\n"); 
		query.append("                                                         ,(ROUND(PSO_CONV_CURR_USD_FNC(C.CSR_LOCL_CURR_CD, NVL(C.CSR_LOCL_AMT,0)" ).append("\n"); 
		query.append("                                                         ,(SELECT MAX(V.REV_YRMON)" ).append("\n"); 
		query.append("                                                              FROM AR_MST_REV_VVD V" ).append("\n"); 
		query.append("                                                             WHERE V.VSL_CD = C.VSL_CD" ).append("\n"); 
		query.append("                                                               AND V.SKD_VOY_NO = C.SKD_VOY_NO" ).append("\n"); 
		query.append("                                                               AND V.SKD_DIR_CD = C.SKD_DIR_CD" ).append("\n"); 
		query.append("                                                               AND V.RLANE_CD = C.RLANE_CD),1),3))),0)) AS E_JOO_SLP_AMT" ).append("\n"); 
		...
		query.append("               AND    B.CRE_USR_ID  = U.USR_ID(+)" ).append("\n"); 
		query.append("#if (${trd_cd} != '')" ).append("\n"); 
		...
		query.append("#end " ).append("\n"); 
		query.append("#if (${ofc_cd} != '')" ).append("\n"); 
		query.append("               AND    (D.JO_CRR_CD, D.RLANE_CD) IN (" ).append("\n"); 
		query.append("                SELECT C.JO_CRR_CD" ).append("\n"); 
		query.append("                     , C.RLANE_CD" ).append("\n"); 
		query.append("                  FROM JOO_CRR_AUTH C" ).append("\n"); 
		query.append("                 WHERE 1=1" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		query.append("               AND NVL(B.SLP_OFC_CD, NVL(U.LST_LGIN_OFC_CD,U.OFC_CD)) = @[ofc_cd]" ).append("\n"); 
		query.append("#end        " ).append("\n"); 
		query.append("               GROUP  BY" ).append("\n"); 
		query.append("                      D.ACCT_YRMON" ).append("\n"); 
		query.append("                     ,D.JO_CRR_CD" ).append("\n"); 
		...
		query.append("		" ).append("\n"); 
		query.append("		 /*2015.07.08 OPR NYK ADD*/" ).append("\n"); 
		...
		query.append("                ,SUM(CASE WHEN C.BSA_OP_JB_CD IN ('001','002','004') THEN C.OP_CRR_PERF_AMT ELSE 0 END) AS R_COA_BSA_AMT" ).append("\n"); 
		query.append("                ,SUM(CASE WHEN C.BSA_OP_JB_CD IN ('000','003','005') THEN C.OP_CRR_PERF_AMT ELSE 0 END) AS E_COA_BSA_AMT" ).append("\n"); 
		query.append("           FROM COA_MON_VVD      A," ).append("\n"); 
		query.append("                BSA_VVD_CRR_PERF C" ).append("\n"); 
		query.append("          WHERE A.VSL_CD      = C.VSL_CD" ).append("\n"); 
		query.append("            AND A.SKD_VOY_NO  = C.SKD_VOY_NO" ).append("\n"); 
		...
		query.append("#end        " ).append("\n"); 
		query.append("#if (${jo_stl_itm_cd} != '')" ).append("\n"); 
		query.append("            AND 'OPR'         = @[jo_stl_itm_cd]" ).append("\n"); 
		query.append("#end        " ).append("\n"); 
		query.append("            AND A.DELT_FLG    = 'N'" ).append("\n"); 
		query.append("          GROUP BY" ).append("\n"); 
		query.append("                 A.COST_YRMON" ).append("\n"); 
		...
		query.append("                ,A.DIR_CD" ).append("\n"); 
		query.append("         HAVING SUM(C.CRR_BSA_CAPA) <> 0" ).append("\n"); 
		query.append("         AND    SUM(C.OP_CRR_PERF_AMT) <> 0" ).append("\n"); 
