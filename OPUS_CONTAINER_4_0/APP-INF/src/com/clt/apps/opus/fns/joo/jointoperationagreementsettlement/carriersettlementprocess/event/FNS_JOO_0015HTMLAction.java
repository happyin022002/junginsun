...
*@FileName : FNS_JOO_0015HTMLAction.java
...
public class FNS_JOO_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0015HTMLAction 객체를 생성
	 */
	public FNS_JOO_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0015Event event = new FnsJoo0015Event();
        ...
        if(command.isCommand(FormCommand.SEARCH02)) {
            event.setStlConditionVO( (StlConditionVO)getVO(request, StlConditionVO .class)   );
        }
