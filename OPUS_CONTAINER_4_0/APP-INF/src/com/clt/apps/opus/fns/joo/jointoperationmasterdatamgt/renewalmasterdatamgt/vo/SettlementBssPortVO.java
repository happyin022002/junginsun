...
public class SettlementBssPortVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SettlementBssPortVO> models = new ArrayList<SettlementBssPortVO>();
	 ...
	 * @return StlBssPortVO[]
	 */
	public SettlementBssPortVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StlBssPortVO[]
	 */
	public SettlementBssPortVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SettlementBssPortVO model = null;
	 ...
	 * @return StlBssPortVO[]
	 */
	public SettlementBssPortVO[] getStlBssPortVOs(){
		SettlementBssPortVO[] vos = (SettlementBssPortVO[])models.toArray(new SettlementBssPortVO[models.size()]);
		return vos;
	}
