...
public class InvEmlVO {
	...
	/* Column Info */
	private String ofcSprtEmlInvFlg = null;
	/* Column Info */
	private String custSprtEmlInvFlg = null;
	...
	public InvEmlVO(Mail mail, String custEml, String vvd, String custCd, String invNo, String emlSndNo, String blSrcNo, String invSeq, String ofcCd, String portCd, String attach, String attachView, String attach2, String attachView2, String rdType, String blSrcNoTitle, String ofcSprtEmlInvFlg, String custSprtEmlInvFlg  ) {
		//this.mail = mail;
		...
		this.ofcSprtEmlInvFlg = ofcSprtEmlInvFlg;
		this.custSprtEmlInvFlg = custSprtEmlInvFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ofcSprtEmlInvFlg", getOfcSprtEmlInvFlg());
		this.hashColumns.put("custSprtEmlInvFlg", getCustSprtEmlInvFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ofc_sprt_eml_inv_flg", "ofcSprtEmlInvFlg");
		this.hashFields.put("cust_sprt_eml_inv_flg", "custSprtEmlInvFlg");
	...
	public String getOfcSprtEmlInvFlg() {
		return ofcSprtEmlInvFlg;
	}

	public void setOfcSprtEmlInvFlg(String ofcSprtEmlInvFlg) {
		this.ofcSprtEmlInvFlg = ofcSprtEmlInvFlg;
	}

	public String getCustSprtEmlInvFlg() {
		return custSprtEmlInvFlg;
	}

	public void setCustSprtEmlInvFlg(String custSprtEmlInvFlg) {
		this.custSprtEmlInvFlg = custSprtEmlInvFlg;
	}
