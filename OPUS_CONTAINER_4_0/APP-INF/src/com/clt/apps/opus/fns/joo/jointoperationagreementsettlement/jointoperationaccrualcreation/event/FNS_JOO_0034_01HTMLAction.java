...
*@FileName : FNS_JOO_0034_01HTMLAction.java
...
public class FNS_JOO_0034_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0034_01HTMLAction 객체를 생성
	 */
	public FNS_JOO_0034_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo003401Event event = new FnsJoo003401Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
	        event.setYearMm(  JSPUtil.getParameter(request, "acct_yrmon", "")  );
		}
