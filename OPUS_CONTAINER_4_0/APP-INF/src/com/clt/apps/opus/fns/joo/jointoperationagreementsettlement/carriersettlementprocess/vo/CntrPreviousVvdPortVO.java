...
*@FileName : SearchPreviousVvdPortVO.java
*@FileTitle : SearchPreviousVvdPortVO
*Open Issues :
*Change history :
 ...
 */
public class CntrPreviousVvdPortVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<CntrPreviousVvdPortVO> models = new ArrayList<CntrPreviousVvdPortVO>();
    ...
    public CntrPreviousVvdPortVO() {
    }

    public CntrPreviousVvdPortVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String vpsPortCd, String clptSeq, String clptIndSeq, String vpsEtdDt, String turnSkdVoyNo, String turnSkdDirCd, String turnClptIndSeq, String lstClptIndSeq) {
        this.ibflag = ibflag;
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("lst_clpt_ind_seq", "lstClptIndSeq");
	 ...
	 * @param request
	 * @return SearchPreviousVvdPortVO[]
	 */
    public CntrPreviousVvdPortVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchPreviousVvdPortVO[]
	 */
    public CntrPreviousVvdPortVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        CntrPreviousVvdPortVO model = null;
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                model = new CntrPreviousVvdPortVO();
                if (ibflag[i] != null)
        ...
        return getSearchPreviousVvdPortVOs();
    }
	 ...
	 * @return SearchPreviousVvdPortVO[]
	 */
    public CntrPreviousVvdPortVO[] getSearchPreviousVvdPortVOs() {
        CntrPreviousVvdPortVO[] vos = (CntrPreviousVvdPortVO[]) models.toArray(new CntrPreviousVvdPortVO[models.size()]);
        return vos;
    }
