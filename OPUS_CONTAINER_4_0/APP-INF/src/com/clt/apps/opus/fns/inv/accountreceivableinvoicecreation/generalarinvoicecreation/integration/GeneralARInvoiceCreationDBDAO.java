...
import com.clt.apps.opus.fns.inv.accountreceivableinvoicecreation.bookingarcreation.integration.BookingARCreationDBDAOCheckAccountRateExistRSQL;
...
import com.clt.apps.opus.fns.inv.accountreceivableinvoicecreation.generalarinvoicecreation.vo.CntrTypeSizeVO;
...
import com.clt.apps.opus.fns.inv.accountreceivableinvoicecreation.generalarinvoicecreation.vo.InvIssueFlagVO;
...
/**
 * GeneralARInvoiceCreationDBDAO <br>
...
public class GeneralARInvoiceCreationDBDAO extends DBDAOSupport {	
	 ...
	 * GeneralARInvoiceCreationDBDAO를 생성한다.<br>
	 */
	...
	/**
	 * MDM_CHARGE table 에서 CO_CHG_ACCT_CD 조회<br>
	 * 
	 * @param String chgCd
	 * @return String
	 * @exception DAOException
	...
	public String searchAccountCdFromCharge(String chgCd) throws DAOException {
		...
		try{
	    	...
	    	if(dbRowset.next()) {
	    		coChgAcctCd = dbRowset.getString(1);
	    	}
	...
	*/
	...
	/**
	 * BKG_BOOKING table 에서 svc_scp_cd 조회<br>
	 * 
	 * @param String bkgNo
	 * @return String
	 * @exception DAOException
	 */
	public String searchBKGSvcScp(String bkgNo) throws DAOException {
		DBRowSet dbRowset = null;
		String svcScpCd = "";
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try{
			...
			dbRowset = new SQLExecuter(dataSource).executeQuery((ISQLTemplate)new GeneralARInvoiceCreationDBDAOSearchBKGSvcScpRSQL(), param, velParam);
	    	if(dbRowset.next()) {
	    		svcScpCd = dbRowset.getString(1);
	    	}
