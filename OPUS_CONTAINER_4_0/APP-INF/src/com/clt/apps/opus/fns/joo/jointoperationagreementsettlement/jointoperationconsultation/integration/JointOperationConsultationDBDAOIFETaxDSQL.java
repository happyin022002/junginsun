...
*@FileName : JointOperationConsultationDBDAOIFETaxDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOIFETaxDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ERP I/F Error 시 JOO_TAX삭제
	  * </pre>
	  */
	public JointOperationConsultationDBDAOIFETaxDSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOIFETaxDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE JOO_TAX A" ).append("\n"); 
