...
*@FileName : ARInvoiceExRateMgtDBDAOaddVVDExRateDateCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOaddVVDExRateDateCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INV_VVD_XCH_RT_DT
	  * [] ARInvoiceExRateMgtDBDAO::addVVDExRateDate ( vvdExrateVos )
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOaddVVDExRateDateCSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOaddVVDExRateDateCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_VVD_XCH_RT_DT (" ).append("\n"); 
