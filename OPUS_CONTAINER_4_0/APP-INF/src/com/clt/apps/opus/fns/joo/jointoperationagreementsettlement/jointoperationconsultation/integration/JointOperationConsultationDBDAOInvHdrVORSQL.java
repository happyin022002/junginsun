...
public class JointOperationConsultationDBDAOInvHdrVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AP Invoice 조회
	  * [2015.02.13] AR AP Offset > Invoices 변경 
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("       DECODE(A.EVID_TP_CD,'E3',TO_CHAR(B.ISS_DT, 'YYYYMMDD'), TO_CHAR(A.CRE_DT, 'YYYYMMDD')) AS INV_DT," ).append("\n"); 
		...
		query.append("       DECODE(A.EVID_TP_CD,'E3','TAX', 'Invoices') AS ATTR_CATE_NM," ).append("\n"); 
		...
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS ATTR_CTNT6," ).append("\n"); 
		...
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS GLO_ATTR_CTNT3 ," ).append("\n"); 
		query.append("       NULL AS GLO_ATTR_CTNT4 ," ).append("\n"); 
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS GLO_ATTR_CTNT5 ," ).append("\n"); 
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS GLO_ATTR_CTNT6 ," ).append("\n"); 
		query.append("       NULL AS GLO_ATTR_CTNT7 ," ).append("\n"); 
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS GLO_ATTR_CTNT8 ," ).append("\n"); 
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS GLO_ATTR_CTNT9 ," ).append("\n"); 
		query.append("       NULL AS GLO_ATTR_CTNT10," ).append("\n"); 
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS GLO_ATTR_CTNT11," ).append("\n"); 
		query.append("       DECODE(A.EVID_TP_CD,'E3',0, NULL) AS GLO_ATTR_CTNT12," ).append("\n"); 
		...
		query.append("       CASE WHEN A.VNDR_SEQ IS NOT NULL " ).append("\n"); 
		query.append("            THEN (SELECT M.PAY_MZD_CD " ).append("\n"); 
		query.append("                    FROM MDM_VENDOR M " ).append("\n"); 
		query.append("                   WHERE M.VNDR_SEQ = A.VNDR_SEQ " ).append("\n"); 
		...
		query.append("               DECODE(A.CSR_LOCL_AMT,0,'ZERO PAYMENT','INTERNAL PAYMENT')" ).append("\n"); 
		...
		query.append("       DECODE(A.EVID_TP_CD,'E3','Y','N') AS TAX_DECL_FLG    ," ).append("\n"); 
