...
public class ARInvoiceInquiryDBDAOARInvoiceChargeSumByBLNoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  SAR_GET_FMT_MASK_FNC(B.CURR_CD,SUM(B.CHG_AMT)) CHG_AMT," ).append("\n"); 
		query.append("  B.INV_XCH_RT," ).append("\n"); 
		query.append("  A.LOCL_CURR_CD," ).append("\n"); 
		query.append("  CASE WHEN SUM(B.CHG_AMT) = 0 THEN 0 ELSE SUM(SAR_GET_CUR_AMT_FNC(A.LOCL_CURR_CD,B.CHG_AMT*B.INV_XCH_RT)) END LOCAL_TOTAL," ).append("\n"); 
