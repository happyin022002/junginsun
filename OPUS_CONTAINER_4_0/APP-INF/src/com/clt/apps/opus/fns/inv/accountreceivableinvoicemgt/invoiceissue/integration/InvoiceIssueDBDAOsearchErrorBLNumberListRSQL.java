...
*@FileName : InvoiceIssueDBDAOsearchErrorBLNumberListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueDBDAOsearchErrorBLNumberListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InvoiceIssueDBDAOsearchErrorBLNumberListRSQL
	  * </pre>
	  */
	public InvoiceIssueDBDAOsearchErrorBLNumberListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueDBDAOsearchErrorBLNumberListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT A.BL_SRC_NO BL_SRC_NO" ).append("\n"); 
		...
		query.append("OR A.AR_IF_NO IN ( SELECT AR_IF_NO" ).append("\n"); 
		query.append("FROM INV_AR_MN" ).append("\n"); 
		query.append("WHERE AR_IF_NO = A.AR_IF_NO" ).append("\n"); 
		query.append("AND USD_XCH_RT = 0 )" ).append("\n"); 
		query.append("OR A.REV_TP_CD||A.REV_SRC_CD||A.ACT_CUST_CNT_CD||A.ACT_CUST_SEQ  IN (SELECT 'MTH@'" ).append("\n"); 
