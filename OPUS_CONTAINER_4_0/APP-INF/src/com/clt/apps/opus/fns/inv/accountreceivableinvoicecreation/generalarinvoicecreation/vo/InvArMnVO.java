...
public class InvArMnVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("co_ref_no", getCoRefNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("co_ref_no", "coRefNo");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCoRefNo(JSPUtil.getParameter(request, "co_ref_no", ""));
	...
	public InvArMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] invSvcScpCd = (JSPUtil.getParameter(request, prefix	+ "inv_svc_scp_cd", length));
			...
			String[] invVvdCxlCd = (JSPUtil.getParameter(request, prefix	+ "inv_vvd_cxl_cd", length));
			...
			String[] clrStsFlg = (JSPUtil.getParameter(request, prefix	+ "clr_sts_flg", length));
			...
			String[] clrDt = (JSPUtil.getParameter(request, prefix	+ "clr_dt", length));
			...
			String[] arCtyCd = (JSPUtil.getParameter(request, prefix	+ "ar_cty_cd", length));
			String[] invCustCntCd = (JSPUtil.getParameter(request, prefix	+ "inv_cust_cnt_cd", length));
			String[] scNo = (JSPUtil.getParameter(request, prefix	+ "sc_no", length));
			String[] invOrgOfcCd = (JSPUtil.getParameter(request, prefix	+ "inv_org_ofc_cd", length));
			...
			String[] coRefNo = (JSPUtil.getParameter(request, prefix	+ "co_ref_no", length));
			...
			String[] whfDeclApIfDt = (JSPUtil.getParameter(request, prefix	+ "whf_decl_ap_if_dt", length));
	...
	*/
	public void unDataFormat(){
		...
		this.coRefNo = this.coRefNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
