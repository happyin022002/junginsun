...
*@FileName : ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [] ARInvoiceExRateMgtDBDAO::searchVVDExchangeRateList ( searchVVDExRateVOs )
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateListVORSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOsearchVVDExchangeRateListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  A.INV_XCH_RT INV_XCH_RT_ORI," ).append("\n"); 
		query.append("  A.IVS_XCH_RT IVS_XCH_RT_ORI," ).append("\n"); 
		query.append("  '' OPT_TYPE," ).append("\n"); 
