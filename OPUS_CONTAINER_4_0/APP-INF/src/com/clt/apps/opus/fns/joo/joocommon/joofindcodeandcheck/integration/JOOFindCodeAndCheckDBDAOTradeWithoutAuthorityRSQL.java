...
*@FileName : JOOFindCodeAndCheckDBDAOTradeWithoutAuthorityRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOFindCodeAndCheckDBDAOTradeWithoutAuthorityRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOOFindCodeAndCheckDBDAOTradeWithoutAuthorityRSQL(){
		setQuery();
		...
		query.append("FileName : JOOFindCodeAndCheckDBDAOTradeWithoutAuthorityRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
