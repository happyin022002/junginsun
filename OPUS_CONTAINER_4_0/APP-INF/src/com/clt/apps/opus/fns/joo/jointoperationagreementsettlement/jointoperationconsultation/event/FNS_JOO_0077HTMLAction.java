...
*@FileName : FNS_JOO_0077HTMLAction.java
...
import com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.jointoperationconsultation.vo.ArDataInqVO;
...
public class FNS_JOO_0077HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0077HTMLAction 객체를 생성
	 */
	public FNS_JOO_0077HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0077Event event = new FnsJoo0077Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setArDataInqVO((ArDataInqVO)getVO(request, ArDataInqVO .class));
		}
