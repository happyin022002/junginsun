...
*@FileName : RenewalMasterDataMgtDBDAOModifyAuthorityCarrierUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalMasterDataMgtDBDAOModifyAuthorityCarrierUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Authority Carrier Update
	  * </pre>
	  */
	public RenewalMasterDataMgtDBDAOModifyAuthorityCarrierUSQL(){
		setQuery();
		...
		query.append("FileName : RenewalMasterDataMgtDBDAOModifyAuthorityCarrierUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE JOO_CRR_AUTH" ).append("\n"); 
		query.append("   SET JO_CRR_AUTH_CD   = @[jo_crr_auth_cd]" ).append("\n"); 
