...
import com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.jointoperationconsultation.vo.TaxGrpVO;
...
public class FnsJoo0018Event extends EventSupport {
	...
	public TaxGrpVO[] getTaxGrpVOS(){
		TaxGrpVO[] tmpVOs = null;
		if (this.taxGrpVOs != null) {
			tmpVOs = new TaxGrpVO[taxGrpVOs.length];
			System.arraycopy(taxGrpVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
