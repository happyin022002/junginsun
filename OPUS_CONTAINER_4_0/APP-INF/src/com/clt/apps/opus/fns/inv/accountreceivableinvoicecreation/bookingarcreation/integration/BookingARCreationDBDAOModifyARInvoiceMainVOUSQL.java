...
public class BookingARCreationDBDAOModifyARInvoiceMainVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#if (${co_stf_ctnt} != '') " ).append("\n"); 
		query.append(",	CO_STF_CTNT = @[co_stf_ctnt]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append(",	INV_LOCL_XCH_RT = NVL(@[inv_locl_xch_rt], NVL(INV_LOCL_XCH_RT, 0))" ).append("\n"); 
		query.append(",	INV_USD_XCH_RT = NVL(@[inv_usd_xch_rt], NVL(INV_USD_XCH_RT, 0))" ).append("\n"); 
