...
*@FileName : FNS_JOO_0087HTMLAction.java
...
public class FNS_JOO_0087HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0084HTMLAction 객체를 생성
	 */
	public FNS_JOO_0087HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0087Event event = new FnsJoo0087Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setCntrConversionAndOptionVOs((CntrConversionAndOptionVO[])getVOs(request, CntrConversionAndOptionVO.class, "sheet1_"));
			event.setCntrConversionConditionVO((CntrConversionConditionVO)getVO(request, CntrConversionConditionVO .class));
		}
		return  event;
	}
