...
*@FileName : RenewalMasterDataMgtDBDAOAddAuthorityCarrierCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalMasterDataMgtDBDAOAddAuthorityCarrierCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RenewalMasterDataMgtDBDAOAddAuthorityCarrierCSQL(){
		setQuery();
		...
		query.append("FileName : RenewalMasterDataMgtDBDAOAddAuthorityCarrierCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO JOO_CRR_AUTH ( " ).append("\n"); 
