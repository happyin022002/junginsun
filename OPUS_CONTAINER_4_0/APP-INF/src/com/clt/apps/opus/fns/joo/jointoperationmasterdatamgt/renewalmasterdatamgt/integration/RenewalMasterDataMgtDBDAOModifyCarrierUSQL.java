...
*@FileName : RenewalMasterDataMgtDBDAOModifyCarrierUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalMasterDataMgtDBDAOModifyCarrierUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RenewalMasterDataMgtDBDAOModifyCarrierUSQL(){
		setQuery();
		...
		query.append("FileName : RenewalMasterDataMgtDBDAOModifyCarrierUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE JOO_CARRIER" ).append("\n"); 
		...
		query.append("     , JO_STL_OPT_CD    = NVL(@[jo_stl_opt_cd],'Z')" ).append("\n"); 
