...
public class CarrierSettlementProcessDBDAOCreRfTdrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       AND   A.RF_SCG_STL_TP_CD = @[rf_scg_stl_tp_cd]" ).append("\n"); 
		...
		query.append("ORDER BY IBFLAG DESC, SKD_DIR_CD, VSL_CD, SKD_VOY_NO, REV_DIR_CD, STL_CMB_SEQ, STL_SEQ_20, FM_PORT_CD, TO_PORT_CD" ).append("\n"); 
