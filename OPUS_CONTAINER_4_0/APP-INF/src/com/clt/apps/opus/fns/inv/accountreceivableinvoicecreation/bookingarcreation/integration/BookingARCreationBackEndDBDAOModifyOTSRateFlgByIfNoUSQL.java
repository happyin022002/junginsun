...
*@FileName : BookingARCreationBackEndDBDAOModifyOTSRateFlgByIfNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOModifyOTSRateFlgByIfNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify OTS Rate Flg By IfNo
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOModifyOTSRateFlgByIfNoUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOModifyOTSRateFlgByIfNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
