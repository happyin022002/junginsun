...
*@FileName : FNS_INV_0076HTMLAction.java
...
public class FNS_INV_0076HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0076HTMLAction 객체를 생성
	 */
	public FNS_INV_0076HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0076Event event = new FnsInv0076Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInvRevAcctCdVO((InvRevAcctCdVO)getVO(request, InvRevAcctCdVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setInvRevAcctCdVOS((InvRevAcctCdVO[])getVOs(request, InvRevAcctCdVO .class,""));
		}
