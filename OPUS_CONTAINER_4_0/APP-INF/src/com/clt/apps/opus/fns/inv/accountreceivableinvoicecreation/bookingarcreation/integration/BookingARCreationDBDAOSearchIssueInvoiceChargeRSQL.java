...
*@FileName : BookingARCreationDBDAOSearchIssueInvoiceChargeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOSearchIssueInvoiceChargeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingARCreationDBDAOSearchIssueInvoiceChargeRSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOSearchIssueInvoiceChargeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , ABS(SUM(CASE WHEN A.CHG_AMT > 0 THEN A.RAT_AS_CNTR_QTY ELSE A.RAT_AS_CNTR_QTY * (-1) END)) RAT_AS_CNTR_QTY" ).append("\n"); 
