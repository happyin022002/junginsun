...
*@FileName : BookingARCreationBackEndDBDAOModifyOTSUSDExrateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOModifyOTSUSDExrateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify OTS USD Exrate
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOModifyOTSUSDExrateUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOModifyOTSUSDExrateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET USD_XCH_RT = NVL(@[inv_xch_rt], 0), " ).append("\n"); 
		query.append("	   BAL_USD_AMT = ROUND((BAL_AMT * NVL(@[inv_xch_rt], 0)), 2), " ).append("\n"); 
		...
		query.append("AND BL_CURR_CD = @[chg_curr_cd] " ).append("\n"); 
		query.append("AND (INV_NO = '**********' OR (INV_NO <> '**********' AND NVL(USD_XCH_RT, 0) = 0))" ).append("\n"); 
