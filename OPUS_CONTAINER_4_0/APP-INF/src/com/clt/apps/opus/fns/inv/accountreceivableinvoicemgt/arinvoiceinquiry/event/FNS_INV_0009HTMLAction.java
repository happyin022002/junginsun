...
*@FileName : FNS_INV_0009HTMLAction.java
...
public class FNS_INV_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0009HTMLAction 객체를 생성
	 */
	public FNS_INV_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0009Event event = new FnsInv0009Event();
		
		// 조회버튼 클릭시 조회이벤트
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setARInvoiceInputByBLNoVO((ARInvoiceInputByBLNoVO)getVO(request, ARInvoiceInputByBLNoVO .class));
		}
		// popup 조회시 AR Office 조회
