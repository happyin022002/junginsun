...
public class SlipProcessVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("chk_csr_flg", getChkCsrFlg());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("chk_csr_flg", "chkCsrFlg");
    ...
    public void setChkCsrFlg(String chkCsrFlg) {
        this.chkCsrFlg = chkCsrFlg;
    }

    public String getChkCsrFlg() {
        return this.chkCsrFlg;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setFinJoStlItmCd(JSPUtil.getParameter(request, prefix + "fin_jo_stl_itm_cd", ""));
        ...
        setTotAmount(JSPUtil.getParameter(request, prefix + "tot_amount", ""));
        ...
        setCustVndrRgstNo(JSPUtil.getParameter(request, prefix + "cust_vndr_rgst_no", ""));
        setChkLocCd(JSPUtil.getParameter(request, prefix + "chk_loc_cd", ""));
        setCustVndrKorNm(JSPUtil.getParameter(request, prefix + "cust_vndr_kor_nm", ""));
        setIssuerId(JSPUtil.getParameter(request, prefix + "issuer_id", ""));
        ...
        setKeyNo(JSPUtil.getParameter(request, prefix + "key_no", ""));
        setStlSeq(JSPUtil.getParameter(request, prefix + "stl_seq", ""));
        setDrCrCd(JSPUtil.getParameter(request, prefix + "dr_cr_cd", ""));
        setRqstDt(JSPUtil.getParameter(request, prefix + "rqst_dt", ""));
        setIssuerNm(JSPUtil.getParameter(request, prefix + "issuer_nm", ""));
        ...
        setChkCsrFlg(JSPUtil.getParameter(request, prefix + "chk_csr_flg", ""));
    ...
    public SlipProcessVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] chkCsrFlg = (JSPUtil.getParameter(request, prefix + "chk_csr_flg", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (chkCsrFlg[i] != null)
                    model.setChkCsrFlg(chkCsrFlg[i]);
                if (issDt[i] != null)
	...
	*/
    public void unDataFormat() {
        ...
        this.chkCsrFlg = this.chkCsrFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
