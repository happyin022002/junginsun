...
public class CsrVO extends AbstractValueObject {
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setEvidTpNm(JSPUtil.getParameter(request, prefix + "evid_tp_nm", ""));
        setEffDt(JSPUtil.getParameter(request, prefix + "eff_dt", ""));
        setEffDtFr(JSPUtil.getParameter(request, prefix + "eff_dt_fr", ""));
        ...
        setDdctDesc(JSPUtil.getParameter(request, prefix + "ddct_desc", ""));
        setSlpIssInterCoCd(JSPUtil.getParameter(request, prefix + "slp_iss_inter_co_cd", ""));
        ...
        setLglEngNm(JSPUtil.getParameter(request, prefix + "lgl_eng_nm", ""));
        ...
        setDdctLoclAmt(JSPUtil.getParameter(request, prefix + "ddct_locl_amt", ""));
        setDdctFlg(JSPUtil.getParameter(request, prefix + "ddct_flg", ""));
        ...
        setEffDtTo(JSPUtil.getParameter(request, prefix + "eff_dt_to", ""));
        setCxlDesc(JSPUtil.getParameter(request, prefix + "cxl_desc", ""));
        setOrgSlpIssDt(JSPUtil.getParameter(request, prefix + "org_slp_iss_dt", ""));
        setSlpIssRgnCd(JSPUtil.getParameter(request, prefix + "slp_iss_rgn_cd", ""));
        setRqstLoclAmt(JSPUtil.getParameter(request, prefix + "rqst_locl_amt", ""));
        ...
        setRjctCsrFlg(JSPUtil.getParameter(request, prefix + "rjct_csr_flg", ""));
        ...
        setRvsCsrFlg(JSPUtil.getParameter(request, prefix + "rvs_csr_flg", ""));
        setCsrOffstNo(JSPUtil.getParameter(request, prefix + "csr_offst_no", ""));
        setSlpIssOfcCd(JSPUtil.getParameter(request, prefix + "slp_iss_ofc_cd", ""));
