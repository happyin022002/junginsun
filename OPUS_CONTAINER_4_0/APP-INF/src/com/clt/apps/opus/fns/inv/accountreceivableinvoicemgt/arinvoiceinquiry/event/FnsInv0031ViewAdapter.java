 ...
 *@FileName : FnsInv0031ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class FnsInv0031ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"", "no", "good_date", "io_bnd_cd", "vvd", "bl_src_no","curr_cd", "chg_amt", "inv_no", 
				"", "no", "customer", "type", "sail_arr_dt", "ar_if_no", "inv_xch_rt", "lcl_amt", "upd_usr_id"};
