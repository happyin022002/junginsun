...
*@FileName : JOOFindCodeAndCheckDBDAOEstmTradeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOFindCodeAndCheckDBDAOEstmTradeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * JOO_ESTM_ACT_RSLT에서 trade코드 조회
	  * </pre>
	  */
	public JOOFindCodeAndCheckDBDAOEstmTradeRSQL(){
		setQuery();
		...
		query.append("FileName : JOOFindCodeAndCheckDBDAOEstmTradeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
