...
public class JointOperationMasterDataMgtDBDAOJooBzcAgmtUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ,CGO_TON_WGT          = @[cgo_ton_wgt]         " ).append("\n"); 
		query.append("       ,JO_TON_WGT_RND_RT    = @[jo_ton_wgt_rnd_rt]   " ).append("\n"); 
		query.append("       ,JO_40FT_GNTE_QTY     = @[jo_40ft_gnte_qty]    " ).append("\n"); 
		query.append("       ,JO_40FT_TEU_QTY      = @[jo_40ft_teu_qty]     " ).append("\n"); 
		query.append("       ,JO_40FT_RND_RT       = @[jo_40ft_rnd_rt]      " ).append("\n"); 
		query.append("       ,JO_20FT_GNTE_QTY     = @[jo_20ft_gnte_qty]    " ).append("\n"); 
		query.append("       ,JO_20FT_TEU_QTY      = @[jo_20ft_teu_qty]     " ).append("\n"); 
		query.append("       ,JO_20FT_RND_RT       = @[jo_20ft_rnd_rt]      " ).append("\n"); 
		query.append("       ,JO_45FT_GNTE_QTY     = @[jo_45ft_gnte_qty]    " ).append("\n"); 
		query.append("       ,JO_45FT_TEU_QTY      = @[jo_45ft_teu_qty]     " ).append("\n"); 
		query.append("       ,JO_45FT_RND_RT       = @[jo_45ft_rnd_rt]      " ).append("\n"); 
		query.append("       ,JO_RF_GNTE_OCN_QTY   = @[jo_rf_gnte_ocn_qty]  " ).append("\n"); 
		query.append("       ,JO_RF_GNTE_INTER_QTY = @[jo_rf_gnte_inter_qty]" ).append("\n"); 
