...
*@FileName : RenewalMasterDataMgtDBDAORemoveStlBssPortDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalMasterDataMgtDBDAORemoveStlBssPortDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Settlement Bss Port Delete
	  * </pre>
	  */
	public RenewalMasterDataMgtDBDAORemoveStlBssPortDSQL(){
		setQuery();
		...
		query.append("FileName : RenewalMasterDataMgtDBDAORemoveStlBssPortDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
