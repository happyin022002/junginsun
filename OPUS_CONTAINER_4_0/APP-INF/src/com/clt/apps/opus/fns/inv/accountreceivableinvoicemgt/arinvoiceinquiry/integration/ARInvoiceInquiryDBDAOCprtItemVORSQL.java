...
*@FileName : ARInvoiceInquiryDBDAOCprtItemVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceInquiryDBDAOCprtItemVORSQL implements ISQLTemplate{
