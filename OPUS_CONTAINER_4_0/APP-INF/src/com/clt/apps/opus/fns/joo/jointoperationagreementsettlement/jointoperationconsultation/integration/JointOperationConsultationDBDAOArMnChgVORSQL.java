...
public class JointOperationConsultationDBDAOArMnChgVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ,F.AR_CURR_CD AS AR_CURR_CD" ).append("\n"); 
		...
		query.append("       ,B.SLP_TP_CD||B.SLP_FUNC_CD||B.SLP_OFC_CD||B.SLP_ISS_DT||B.SLP_SER_NO AS SLP_NO" ).append("\n"); 
		...
		query.append("       ,DECODE(B.JO_STL_ITM_CD, NULL, '', 'S/H', 'JOP', 'OUS', 'JOU', 'OPR', 'JOR', 'JSC') AS JO_REV_TP_CD" ).append("\n"); 
