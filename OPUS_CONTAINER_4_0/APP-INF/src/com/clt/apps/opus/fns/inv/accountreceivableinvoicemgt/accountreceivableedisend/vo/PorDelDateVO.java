...
*@FileName : PorDelDateVO.java
*@FileTitle : PorDelDateVO
*Open Issues :
*Change history :
...
public class PorDelDateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PorDelDateVO> models = new ArrayList<PorDelDateVO>();
	...
	public PorDelDateVO(String ibflag, String pagerows, String estmDt, String actDt) {
		this.ibflag = ibflag;
		this.actDt = actDt;
		this.estmDt = estmDt;
...
/**
	 ...
	 * @return PorDelDateVO[]
	 */
	public PorDelDateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PorDelDateVO[]
	 */
	public PorDelDateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PorDelDateVO model = null;
	 ...
	 * @return PorDelDateVO[]
	 */
	public PorDelDateVO[] getPorDelDateVOs(){
		PorDelDateVO[] vos = (PorDelDateVO[])models.toArray(new PorDelDateVO[models.size()]);
		return vos;
	}
