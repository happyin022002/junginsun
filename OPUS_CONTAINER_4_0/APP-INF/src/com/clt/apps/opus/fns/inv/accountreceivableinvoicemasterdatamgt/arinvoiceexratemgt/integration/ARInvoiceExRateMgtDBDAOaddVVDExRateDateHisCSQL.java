...
*@FileName : ARInvoiceExRateMgtDBDAOaddVVDExRateDateHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceExRateMgtDBDAOaddVVDExRateDateHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INV_VVD_XCH_RT_DT_HIS
	  * [] ARInvoiceExRateMgtDBDAO::addVVDExRateDateHis ( vvdExrateHisVos )
	  * </pre>
	  */
	public ARInvoiceExRateMgtDBDAOaddVVDExRateDateHisCSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceExRateMgtDBDAOaddVVDExRateDateHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_VVD_XCH_RT_DT_HIS (" ).append("\n"); 
		...
		query.append(",   @[cng_rmk]" ).append("\n"); 
		query.append(",   @[op_sts_nm]" ).append("\n"); 
		query.append(",   GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[ar_ofc_cd]) -- loc_cre_dt" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
