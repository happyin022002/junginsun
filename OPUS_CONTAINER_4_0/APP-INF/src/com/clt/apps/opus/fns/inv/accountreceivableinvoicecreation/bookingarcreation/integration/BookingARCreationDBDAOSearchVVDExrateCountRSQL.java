...
*@FileName : BookingARCreationDBDAOSearchVVDExrateCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOSearchVVDExrateCountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search VVD Exrate Count
	  * </pre>
	  */
	public BookingARCreationDBDAOSearchVVDExrateCountRSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOSearchVVDExrateCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
