...
*@FileName : AccountReceivableEDISendDBDAOSearchPolPodEstimateDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchPolPodEstimateDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search Pol Pod Estimate Date
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchPolPodEstimateDateRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchPolPodEstimateDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(DECODE(@[cng_indiv_cd], 'O', B.VPS_ETD_DT, B.VPS_ETA_DT), NULL, TO_CHAR(B.VPS_ETB_DT, 'YYYYMMDDHH24MI'), TO_CHAR(DECODE(@[cng_indiv_cd], 'O', B.VPS_ETD_DT, B.VPS_ETA_DT),'YYYYMMDDHH24MI')) ESTM_DT" ).append("\n"); 
