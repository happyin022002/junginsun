...
*@FileName : AccountReceivableEDISendDBDAOAddInvoiceEDIContainerCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOAddInvoiceEDIContainerCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add Invoice EDI Container
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOAddInvoiceEDIContainerCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOAddInvoiceEDIContainerCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_EDI_CNTR" ).append("\n"); 
		query.append("(" ).append("\n"); 
