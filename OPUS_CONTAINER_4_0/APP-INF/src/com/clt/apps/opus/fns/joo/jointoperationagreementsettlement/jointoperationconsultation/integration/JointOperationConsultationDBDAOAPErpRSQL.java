...
public class JointOperationConsultationDBDAOAPErpRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("where  a.csr_no  = B.SLP_TP_CD||B.SLP_FUNC_CD||B.SLP_OFC_CD||B.SLP_ISS_DT||B.SLP_SER_NO" ).append("\n"); 
		...
		query.append("and    b.cre_dt between @[iss_dt_fr] and @[iss_dt_to]" ).append("\n"); 
		query.append("#elseif(${dt_flg} == '1')" ).append("\n"); 
		query.append("and    b.gl_dt between @[iss_dt_fr] and @[iss_dt_to]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
