...
public class FNS_INV_0100HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			String etdDtFm = request.getParameter("etd_dt2_fm").trim();
			String etdDtTo = request.getParameter("etd_dt2_to").trim();
			...
			searchVVDPortVO.setEtdaDtFm(etdDtFm);
			searchVVDPortVO.setEtdaDtTo(etdDtTo);
