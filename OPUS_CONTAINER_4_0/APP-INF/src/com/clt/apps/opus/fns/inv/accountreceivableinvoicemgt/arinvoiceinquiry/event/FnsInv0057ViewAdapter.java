 ...
 *@FileName : FnsInv0057ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class FnsInv0057ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"", "ar_ofc_cd", "vvd", "ar_if_no", "pol_cd", "pod_cd", "sail_arr_dt", "inv_lcl", "inv_usd", "due_dt", "due_dt", "dp_prcs_knt", "cr_amt",
				"", "", "io_bnd_cd", "bl_src_no", "bkg_teu_qty", "bkg_feu_qty", "", "", "", "over", "type", "", ""};
