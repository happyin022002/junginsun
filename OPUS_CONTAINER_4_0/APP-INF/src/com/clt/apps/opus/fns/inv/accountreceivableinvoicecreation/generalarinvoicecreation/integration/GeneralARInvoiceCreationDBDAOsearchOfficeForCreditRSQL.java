...
*@FileName : GeneralARInvoiceCreationDBDAOsearchOfficeForCreditRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceCreationDBDAOsearchOfficeForCreditRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralARInvoiceCreationDBDAOsearchOfficeForCreditRSQL
	  * </pre>
	  */
	public GeneralARInvoiceCreationDBDAOsearchOfficeForCreditRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceCreationDBDAOsearchOfficeForCreditRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
