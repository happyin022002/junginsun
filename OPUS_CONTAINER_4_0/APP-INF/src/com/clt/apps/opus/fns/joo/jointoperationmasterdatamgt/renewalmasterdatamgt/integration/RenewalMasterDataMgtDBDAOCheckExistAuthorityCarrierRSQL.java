...
*@FileName : RenewalMasterDataMgtDBDAOCheckExistAuthorityCarrierRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalMasterDataMgtDBDAOCheckExistAuthorityCarrierRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Authority Carrier 존재 체크
	  * </pre>
	  */
	public RenewalMasterDataMgtDBDAOCheckExistAuthorityCarrierRSQL(){
		setQuery();
		...
		query.append("FileName : RenewalMasterDataMgtDBDAOCheckExistAuthorityCarrierRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
