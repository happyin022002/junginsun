...
*@FileName : AccountReceivableInvoiceMigrationDBDAOsearchSailingDateByVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOsearchSailingDateByVvdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AccountReceivableInvoiceMigrationDBDAOsearchSailingDateByVvdRSQL
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOsearchSailingDateByVvdRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOsearchSailingDateByVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
