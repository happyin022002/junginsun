...
*@FileName : ARInvoiceCorrectionDBDAOSearchEffectiveDateVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCorrectionDBDAOSearchEffectiveDateVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [] ARInvoiceCorrectionDBDAO::searchEffectiveDate ( ofcCd , sailingDt )  
	  * INV_0016
	  * </pre>
	  */
	public ARInvoiceCorrectionDBDAOSearchEffectiveDateVORSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCorrectionDBDAOSearchEffectiveDateVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
