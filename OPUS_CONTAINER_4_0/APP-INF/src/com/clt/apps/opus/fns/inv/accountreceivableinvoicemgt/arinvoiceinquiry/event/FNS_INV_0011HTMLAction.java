...
*@FileName : FNS_INV_0011HTMLAction.java
...
public class FNS_INV_0011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0011HTMLAction 객체를 생성
	 */
	public FNS_INV_0011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0011Event event = new FnsInv0011Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setIfNo(request.getParameter("ar_if_no"));
			event.setOffice(request.getParameter("office"));
