...
*@FileName : FNS_INV_0116HTMLAction.java
...
public class FNS_INV_0116HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0116HTMLAction 객체를 생성
	 */
	public FNS_INV_0116HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0116Event event = new FnsInv0116Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTransDataComparisonReportInputVO((TransDataComparisonReportInputVO)getVO(request, TransDataComparisonReportInputVO .class));
		}
