...
*@FileName : TransDataComparisonReportInputVO.java
*@FileTitle : TransDataComparisonReportInputVO
*Open Issues :
*Change history :
...
public class TransDataComparisonReportInputVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TransDataComparisonReportInputVO> models = new ArrayList<TransDataComparisonReportInputVO>();
	...
	public TransDataComparisonReportInputVO() {}

	public TransDataComparisonReportInputVO(String ibflag, String pagerows, String dateOption, String fromDate, String toDate, String ifNo, String ifFlag, String arHdQtrOfcCd, String arOfcCd, String blNo, String invNo, String revTpCd, String revSrcCd) {
		this.ifNo = ifNo;
...
/**
	 ...
	 */
	public TransDataComparisonReportInputVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TransDataComparisonReportInputVO[]
	 */
	public TransDataComparisonReportInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TransDataComparisonReportInputVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TransDataComparisonReportInputVO();
				if (ifNo[i] != null)
		...
		return getTransDataComparisonReportInputVOs();
	}
	 ...
	 * @return TransDataComparisonReportInputVO[]
	 */
	public TransDataComparisonReportInputVO[] getTransDataComparisonReportInputVOs(){
		TransDataComparisonReportInputVO[] vos = (TransDataComparisonReportInputVO[])models.toArray(new TransDataComparisonReportInputVO[models.size()]);
		return vos;
	}
