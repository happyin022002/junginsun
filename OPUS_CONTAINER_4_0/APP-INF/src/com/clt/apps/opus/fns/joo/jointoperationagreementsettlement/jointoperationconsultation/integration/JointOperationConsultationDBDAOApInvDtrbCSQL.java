...
*@FileName : JointOperationConsultationDBDAOApInvDtrbCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOApInvDtrbCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AP_INV_DTRB 테이블에 INSERT
	  * </pre>
	  */
	public JointOperationConsultationDBDAOApInvDtrbCSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOApInvDtrbCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
