...
public class ARInvoiceCorrectionDBDAOSearchManualInterfaceRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  AND ((MN.INV_BAT_CD = 'Y' AND  MN.INV_AR_IF_CD ='E')" ).append("\n"); 
		query.append("  OR (MN.INV_BAT_CD = 'N' AND  MN.INV_AR_IF_CD = 'N'))" ).append("\n"); 
		query.append("#if (${fm_if_dt} !=''&&${to_if_dt}!='')" ).append("\n"); 
		query.append("  AND MN.SRC_IF_DT BETWEEN REPLACE(@[fm_if_dt],'-','') and REPLACE(@[to_if_dt],'-','')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("   AND (MN.BKG_NO, BKG_TMS) IN ( SELECT BKG_NO, MAX(BKG_TMS)" ).append("\n"); 
		...
		query.append("      ,MN.INV_AR_IF_CD" ).append("\n"); 
		query.append("	  ,MN.AR_IF_ERR_RSN" ).append("\n"); 
		query.append("	  ,MN.BKG_TMS" ).append("\n"); 
		query.append("ORDER BY MN.BKG_TMS DESC" ).append("\n"); 
