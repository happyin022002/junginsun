...
*@FileName : FNS_INV_9999HTMLAction.java
...
public class FNS_INV_9999HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_9999HTMLAction 객체를 생성
	 */
	public FNS_INV_9999HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv9999Event event = new FnsInv9999Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
    		...
    		event.setSrcIfSeq(request.getParameter("src_if_seq"));
