...
*@FileName : AccountReceivableInvoiceMigrationDBDAOModifyInvTotalLocalAmountUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOModifyInvTotalLocalAmountUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify Inv Total Local Amount
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOModifyInvTotalLocalAmountUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOModifyInvTotalLocalAmountUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE OPUSADM_TMP.INV_AR_MN" ).append("\n"); 
		...
		query.append("                                      FROM OPUSADM_TMP.INV_AR_CHG A," ).append("\n"); 
		query.append("                                           OPUSADM_TMP.INV_AR_MN B," ).append("\n"); 
