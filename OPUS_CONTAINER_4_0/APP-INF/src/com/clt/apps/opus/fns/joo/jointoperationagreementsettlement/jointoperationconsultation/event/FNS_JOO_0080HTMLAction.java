...
*@FileName : FNS_JOO_0080HTMLAction.java
...
public class FNS_JOO_0080HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0080HTMLAction 객체를 생성
	 */
	public FNS_JOO_0080HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0080Event event = new FnsJoo0080Event();

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCHLIST01)) {
