...
*@FileName : JooFileUploadDBDAOFileUploadListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooFileUploadDBDAOFileUploadListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooFileUploadDBDAOFileUploadListUSQL(){
		setQuery();
		...
		query.append("FileName : JooFileUploadDBDAOFileUploadListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE JOO_CNTC_MBR_ATCH_FILE" ).append("\n"); 
