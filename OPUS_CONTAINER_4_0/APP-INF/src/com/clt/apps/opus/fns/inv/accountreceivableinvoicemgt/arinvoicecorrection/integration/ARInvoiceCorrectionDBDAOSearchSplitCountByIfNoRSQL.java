...
*@FileName : ARInvoiceCorrectionDBDAOSearchSplitCountByIfNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCorrectionDBDAOSearchSplitCountByIfNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search Split Count By If No
	  * </pre>
	  */
	public ARInvoiceCorrectionDBDAOSearchSplitCountByIfNoRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCorrectionDBDAOSearchSplitCountByIfNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
