...
*@FileName : RenewalConsultationDBDAORemoveInvoiceDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalConsultationDBDAORemoveInvoiceDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RenewalConsultationDBDAORemoveInvoiceDSQL(){
		setQuery();
		...
		query.append("FileName : RenewalConsultationDBDAORemoveInvoiceDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND INV.JO_CRR_CD    = @[jo_crr_cd]" ).append("\n"); 
