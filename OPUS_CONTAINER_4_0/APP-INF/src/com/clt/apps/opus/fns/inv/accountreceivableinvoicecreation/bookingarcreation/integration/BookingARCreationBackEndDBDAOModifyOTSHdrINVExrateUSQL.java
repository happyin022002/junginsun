...
*@FileName : BookingARCreationBackEndDBDAOModifyOTSHdrINVExrateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOModifyOTSHdrINVExrateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify OTS Hdr INV Exrate
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOModifyOTSHdrINVExrateUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOModifyOTSHdrINVExrateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET INV_LOCL_XCH_RT = DECODE(INV_CURR_CD, OFC_CURR_CD, 1, NVL(@[usd_xch_rt], 0)), " ).append("\n"); 
