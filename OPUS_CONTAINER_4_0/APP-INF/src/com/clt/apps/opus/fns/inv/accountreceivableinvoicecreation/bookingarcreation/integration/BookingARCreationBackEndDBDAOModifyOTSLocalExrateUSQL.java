...
*@FileName : BookingARCreationBackEndDBDAOModifyOTSLocalExrateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOModifyOTSLocalExrateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify OTS Local Exrate
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOModifyOTSLocalExrateUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOModifyOTSLocalExrateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
