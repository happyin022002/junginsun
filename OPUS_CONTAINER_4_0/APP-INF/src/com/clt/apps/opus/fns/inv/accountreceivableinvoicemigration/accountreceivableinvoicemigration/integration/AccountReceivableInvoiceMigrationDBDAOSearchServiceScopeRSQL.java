...
*@FileName : AccountReceivableInvoiceMigrationDBDAOSearchServiceScopeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOSearchServiceScopeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOSearchServiceScopeRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOSearchServiceScopeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
