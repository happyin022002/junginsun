...
*@FileName : FNS_JOO_0050HTMLAction.java
...
public class FNS_JOO_0050HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0050HTMLAction 객체를 생성
	 */
	public FNS_JOO_0050HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0050Event event = new FnsJoo0050Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
            event.setStlConditionVO( (StlConditionVO)getVO(request, StlConditionVO .class));
		}else if (command.isCommand(FormCommand.MULTI)) {
			event.setStlStatusVOs((StlStatusVO[])getVOs(request, StlStatusVO.class, "sheet1_"));
		}
