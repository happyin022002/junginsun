...
*@FileName : ARInvoiceCorrectionDBDAOSearchInvoiceNoByIfNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCorrectionDBDAOSearchInvoiceNoByIfNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCorrectionDBDAOSearchInvoiceNoByIfNoRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCorrectionDBDAOSearchInvoiceNoByIfNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
