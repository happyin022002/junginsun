...
*@FileName : FNS_JOO_0009HTMLAction.java
...
public class FNS_JOO_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0009HTMLAction 객체를 생성
	 */
	public FNS_JOO_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0009Event event = new FnsJoo0009Event();
		...
		else if(command.isCommand(FormCommand.SEARCHLIST04)||command.isCommand(FormCommand.SEARCHLIST05)) { //2015.08.12 Add
			String curRow = request.getParameter("cur_row");
			if (curRow == null || "".equals(curRow)){
				return event;
			}
