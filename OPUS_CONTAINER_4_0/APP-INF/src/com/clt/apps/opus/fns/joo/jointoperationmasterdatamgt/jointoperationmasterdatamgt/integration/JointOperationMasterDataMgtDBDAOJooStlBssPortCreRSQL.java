...
public class JointOperationMasterDataMgtDBDAOJooStlBssPortCreRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , A.JO_STL_ITM_CD" ).append("\n"); 
		query.append("     , M.VSL_SLAN_DIR_CD AS SKD_DIR_CD" ).append("\n"); 
		query.append("     , M.VSL_SLAN_DIR_SEQ AS SEQ" ).append("\n"); 
		...
		query.append("   AND M.VSL_SLAN_CD = SUBSTR(@[rlane_cd],1,3)" ).append("\n"); 
		...
		query.append(" ORDER BY A.SEQ, A.ORD_SEQ, A.JO_STL_ITM_CD" ).append("\n"); 
