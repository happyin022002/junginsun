...
*@FileName : GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConvVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConvVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConvVOUSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConvVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND		CO_CD_CTNT	= @[co_cd_ctnt]" ).append("\n"); 
