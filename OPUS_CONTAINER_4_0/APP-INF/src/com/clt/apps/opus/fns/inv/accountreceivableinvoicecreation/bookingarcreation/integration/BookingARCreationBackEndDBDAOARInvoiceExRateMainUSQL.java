...
*@FileName : BookingARCreationBackEndDBDAOARInvoiceExRateMainUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOARInvoiceExRateMainUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOARInvoiceExRateMainUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOARInvoiceExRateMainUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                              FROM (SELECT A.CURR_CD, SUM(ROUND(CHG_AMT * INV_XCH_RT,C.DP_PRCS_KNT)) CURR_LOCL_AMT" ).append("\n"); 
