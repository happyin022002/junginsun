...
public class BookingARCreationDBDAOaddInvArAmtCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(AR_IF_NO, AR_IF_SER_NO, TJ_SRC_NM, CURR_CD, INV_AMT, INV_ERP_IF_STS_CD, ERP_IF_DT," ).append("\n"); 
		query.append(" CRE_DT, CRE_USR_ID, UPD_DT, UPD_USR_ID)" ).append("\n"); 
		query.append("(select AA.ar_if_no, rownum, tj_src_nm, curr_cd, inv_amt, 'Y', TO_CHAR(SYSDATE, 'YYYYMMDD')," ).append("\n"); 
