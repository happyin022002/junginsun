...
*@FileName : FNS_JOO_0041HTMLAction.java
...
public class FNS_JOO_0041HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0041HTMLAction 객체를 생성
	 */
	public FNS_JOO_0041HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0041Event event = new FnsJoo0041Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setSlotXchPartnerVO((SlotXchPartnerVO)getVO(request, SlotXchPartnerVO .class));
		}
