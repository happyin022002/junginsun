...
*@FileName : RenewalConsultationDBDAORemoveInvoiceDetailDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RenewalConsultationDBDAORemoveInvoiceDetailDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RenewalConsultationDBDAORemoveInvoiceDetailDSQL(){
		setQuery();
		...
		query.append("FileName : RenewalConsultationDBDAORemoveInvoiceDetailDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND DTL.VSL_CD       = @[vsl_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${skd_voy_no}!='')" ).append("\n"); 
		query.append("   AND DTL.SKD_VOY_NO   = @[skd_voy_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${skd_dir_cd}!='')" ).append("\n"); 
		query.append("   AND DTL.SKD_DIR_CD   = @[skd_dir_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${rev_dir_cd}!='')" ).append("\n"); 
		query.append("   AND DTL.REV_DIR_CD   = @[rev_dir_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${rev_yrmon}!='')" ).append("\n"); 
		query.append("   AND DTL.REV_YRMON    = @[rev_yrmon]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${stl_vvd_seq}!='')" ).append("\n"); 
		query.append("   AND DTL.STL_VVD_SEQ  = TO_NUMBER(@[stl_vvd_seq])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
