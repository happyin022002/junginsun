...
public class InvArMnVO	extends	 AbstractValueObject
{
	...
	public InvArMnVO(String svcScpCd,String invCoaRevDirCd,String cxlFlg,String usdXchRt,String whfDeclNo,String pagerows,String invCoaAcctCd,String invVvdCxlCd,String destTrnsSvcModCd,String xchRtUsdTpCd,String slsOfcCd,String mstBlNo,String invCoaRgnCd,String updUsrId,String znIocCd,String skdVoyNo,String invCoaCtrCd,String revVslCd,String podCd,String whfDeclVoyNo,String blInvCfmDt,String bkgNo,String siRefNo,String erpIfGlDt,String acctXchRtYrmon,String trnkVslCd,String trnkSkdVoyNo,String ediSndDt,String invTtlLoclAmt,String whfDeclOfcCd,String clrStsFlg,String bkgFeuQty,String erpIfOfcCd,String arIfNo,String whfDeclVslCd,String acctCd,String actCustCntCd,String dueDt,String cgoMeasQty,String crTermDys,String blInvIfDt,String blSrcNo,String revSkdDirCd,String whfMrnNo,String glEffDt,String invCoaSkdDirCd,String actCustSeq,String revTpCd,String arOfcCd,String invSplitCd,String invSrcNo,String apArOffstNo,String slanCd,String invRmk,String clrDt,String invDeltDivCd,String frtFwrdCntCd,String xchRtDt,String vslCd,String taxXchRt,String ifSeq,String rlaneCd,String srepCd,String blNo,String sailArrDt,String invCoaCoCd,String polCd,String arCtyCd,String invCustCntCd,String scNo,String invOrgOfcCd,String vvdTrnsFlg,String invCoaVoyNo,String cgoWgt,String revSkdVoyNo,String bkgCorrNo,String xchRtN3rdTpCd,String loclCurrCd,String delCd,String frtFwrdCustSeq,String coStfCtnt,String whfDeclDirCd,String custCrFlg,String sailDt,String creUsrId,String bkgTeuQty,String porCd,String whfDeclCfmDt,String arTaxIndCd,String creDt,String rfaNo,String trnkSkdDirCd,String revDirCd,String ibflag,String revSrcCd,String invCoaInterCoCd,String updDt,String invCoaVslCd,String bkgCorrDt,String arInvSrcCd,String invRefNo,String invCustSeq,String slpNo,String ioBndCd,String skdDirCd,String trspRqstOrdFlg,String blTpCd,String obrdDt,String bkgRefNo,String whfDeclApIfDt,String obrdCd,String custNm,String custRgstNo,String crCurrcd,String crAmt,String ibCrTermDys,String obCrTermDys,String crCltOfcCd,String bkgSeq,String whfNtcNo,String deltFlg,String invIssFlg,String invClrFlg,String csrNo,String whfFlg,String ctrtOfcCd,String invNo,String issDt,String invSvcScpCd,String oldArIfNo,String invCurrCd,String n3rdFlg,String bfrInvCurrCd,String otsPayCd,String orgInvNo,String invLoclXchRt,String invUsdXchRt)	{
 ...
 //	Getters	and	Setters
	...
	*/
	...
	public void	fromRequest(HttpServletRequest request,	String prefix) {
		...
		setInvCoaRevDirCd(JSPUtil.getParameter(request,	prefix + "inv_coa_rev_dir_cd", ""));
		...
		setInvVvdCxlCd(JSPUtil.getParameter(request,	prefix + "inv_vvd_cxl_cd", ""));
		...
		setClrStsFlg(JSPUtil.getParameter(request,	prefix + "clr_sts_flg", ""));
		...
		setInvCoaSkdDirCd(JSPUtil.getParameter(request,	prefix + "inv_coa_skd_dir_cd", ""));
		...
		setClrDt(JSPUtil.getParameter(request,	prefix + "clr_dt", ""));
		...
		setTaxXchRt(JSPUtil.getParameter(request,	prefix + "tax_xch_rt", ""));
		...
		setInvCoaCoCd(JSPUtil.getParameter(request,	prefix + "inv_coa_co_cd", ""));
		setPolCd(JSPUtil.getParameter(request,	prefix + "pol_cd", ""));
		setArCtyCd(JSPUtil.getParameter(request,	prefix + "ar_cty_cd", ""));
		setInvCustCntCd(JSPUtil.getParameter(request,	prefix + "inv_cust_cnt_cd", ""));
		setScNo(JSPUtil.getParameter(request,	prefix + "sc_no", ""));
		setInvOrgOfcCd(JSPUtil.getParameter(request,	prefix + "inv_org_ofc_cd", ""));
		setVvdTrnsFlg(JSPUtil.getParameter(request,	prefix + "vvd_trns_flg", ""));
		setInvCoaVoyNo(JSPUtil.getParameter(request,	prefix + "inv_coa_voy_no", ""));
		...
		setInvCoaInterCoCd(JSPUtil.getParameter(request,	prefix + "inv_coa_inter_co_cd", ""));
		setUpdDt(JSPUtil.getParameter(request,	prefix + "upd_dt", ""));
		setInvCoaVslCd(JSPUtil.getParameter(request,	prefix + "inv_coa_vsl_cd", ""));
		setBkgCorrDt(JSPUtil.getParameter(request,	prefix + "bkg_corr_dt", ""));
		setArInvSrcCd(JSPUtil.getParameter(request,	prefix + "ar_inv_src_cd", ""));
		...
		setTrspRqstOrdFlg(JSPUtil.getParameter(request,	prefix + "trsp_rqst_ord_flg", ""));
		...
		setWhfDeclApIfDt(JSPUtil.getParameter(request,	prefix + "whf_decl_ap_if_dt", ""));
	...
	public InvArMnVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				...
				String[] whfNtcNo =	(JSPUtil.getParameter(request, prefix +	"whf_ntc_no".trim(),	length));
				...
				String[] whfFlg =	(JSPUtil.getParameter(request, prefix +	"whf_flg".trim(),	length));
				...
				String[] n3rdFlg =	(JSPUtil.getParameter(request, prefix +	"n3rd_flg".trim(),	length));
