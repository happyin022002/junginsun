...
public class McsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<McsVO> models = new ArrayList<McsVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sub_sum_nm", getSubSumNm());
		...
		this.hashColumns.put("title_gb", getTitleGb());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sub_sum_nm", "subSumNm");
		...
		this.hashFields.put("title_gb", "titleGb");
	 ...
	 * @return subSumNm
	 */
	public String getSubSumNm() {
		return this.subSumNm;
	}
	 ...
	 * @param subSumNm
	 */
	public void setSubSumNm(String subSumNm) {
		this.subSumNm = subSumNm;
	}
	 ...
	 * @param titleGb
	 */
	public void setTitleGb(String titleGb) {
		this.titleGb = titleGb;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSubSumNm(JSPUtil.getParameter(request, prefix + "sub_sum_nm", ""));
		...
		setJoStlItmCdNm(JSPUtil.getParameter(request, prefix + "jo_stl_itm_cd_nm", ""));
		...
		setTitleGb(JSPUtil.getParameter(request, prefix + "title_gb", ""));
	 ...
	 * @return McsVO[]
	 */
	public McsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return McsVO[]
	 */
	public McsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		McsVO model = null;
		...
		try {
			...
			String[] subSumNm = (JSPUtil.getParameter(request, prefix	+ "sub_sum_nm", length));
			...
			String[] titleGb = (JSPUtil.getParameter(request, prefix	+ "title_gb", length));
	 ...
	 * @return McsVO[]
	 */
	public McsVO[] getMcsVOs(){
		McsVO[] vos = (McsVO[])models.toArray(new McsVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.subSumNm = this.subSumNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.titleGb = this.titleGb .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
