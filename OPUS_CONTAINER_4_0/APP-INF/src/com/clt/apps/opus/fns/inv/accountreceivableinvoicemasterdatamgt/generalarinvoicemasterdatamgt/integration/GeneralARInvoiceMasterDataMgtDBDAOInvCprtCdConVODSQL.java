...
*@FileName : GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConVODSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceMasterDataMgtDBDAOInvCprtCdConVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
