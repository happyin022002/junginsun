...
*@FileName : AccountReceivableInvoiceMigrationDBDAOSearchInvArAmountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOSearchInvArAmountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search Inv Ar Amount
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOSearchInvArAmountRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOSearchInvArAmountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
