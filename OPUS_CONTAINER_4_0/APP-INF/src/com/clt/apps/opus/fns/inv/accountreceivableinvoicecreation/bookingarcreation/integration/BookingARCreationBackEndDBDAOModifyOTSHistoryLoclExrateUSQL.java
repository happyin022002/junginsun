...
*@FileName : BookingARCreationBackEndDBDAOModifyOTSHistoryLoclExrateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationBackEndDBDAOModifyOTSHistoryLoclExrateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify OTS History Locl Exrate
	  * </pre>
	  */
	public BookingARCreationBackEndDBDAOModifyOTSHistoryLoclExrateUSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationBackEndDBDAOModifyOTSHistoryLoclExrateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
