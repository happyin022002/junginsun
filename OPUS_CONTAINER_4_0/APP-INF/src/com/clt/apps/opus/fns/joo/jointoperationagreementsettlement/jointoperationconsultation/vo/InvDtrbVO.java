...
public class InvDtrbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvDtrbVO> models = new ArrayList<InvDtrbVO>();
	 ...
	 * @return InvDtrbVO[]
	 */
	public InvDtrbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvDtrbVO[]
	 */
	public InvDtrbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvDtrbVO model = null;
	 ...
	 * @return InvDtrbVO[]
	 */
	public InvDtrbVO[] getInvDtrbVOs(){
		InvDtrbVO[] vos = (InvDtrbVO[])models.toArray(new InvDtrbVO[models.size()]);
		return vos;
	}
