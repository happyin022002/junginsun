...
*@FileName : AccountReceivableEDISendDBDAOSearchLocationInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchLocationInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchLocationInfoRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchLocationInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       , DECODE(LENGTH(LOC_AMS_PORT_CD), 4, 'D', 5, 'K') QUALIFIER" ).append("\n"); 
