...
*@FileName : BookingARCreationDBDAOsearchInvRevTpSrcCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOsearchInvRevTpSrcCdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingARCreationDBDAOsearchInvRevTpSrcCdRSQL
	  * </pre>
	  */
	public BookingARCreationDBDAOsearchInvRevTpSrcCdRSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOsearchInvRevTpSrcCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
