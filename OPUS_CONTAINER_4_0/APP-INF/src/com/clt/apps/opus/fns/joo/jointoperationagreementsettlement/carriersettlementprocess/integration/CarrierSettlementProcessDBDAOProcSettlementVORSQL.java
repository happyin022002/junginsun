...
*@FileName : CarrierSettlementProcessDBDAOProcSettlementVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOProcSettlementVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/H, OUS(RDR,TDR),OTH, W/R, P/B 
	  * 2015.04.21 : Sort 현형 유지
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOProcSettlementVORSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAOProcSettlementVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , DECODE(A.IOC_CD,'O',A.FM_PORT_CD,NULL) AS DEP_PORT_CD" ).append("\n"); 
		query.append("      , DECODE(A.IOC_CD,'O',NULL,A.FM_PORT_CD) AS FM_PORT_CD" ).append("\n"); 
		...
		query.append("ORDER BY A.VSL_CD, A.SKD_VOY_NO, A.SKD_DIR_CD, A.REV_DIR_CD, A.IOC_CD, A.SCONTI_CD, A.FM_PORT_CD, A.TO_PORT_CD, A.STL_SEQ, A.JO_STL_JB_CD, A.ST_DT" ).append("\n"); 
		query.append("--ORDER BY A.SKD_DIR_CD, A.ETA_DT, A.VSL_CD, A.SKD_VOY_NO, A.REV_DIR_CD, A.JO_STL_JB_CD, A.ST_DT" ).append("\n"); 
