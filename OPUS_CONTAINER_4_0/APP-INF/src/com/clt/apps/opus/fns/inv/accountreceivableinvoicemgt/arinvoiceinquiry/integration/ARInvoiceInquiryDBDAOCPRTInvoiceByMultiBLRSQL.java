...
*@FileName : ARInvoiceInquiryDBDAOCPRTInvoiceByMultiBLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceInquiryDBDAOCPRTInvoiceByMultiBLRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceInquiryDBDAOCPRTInvoiceByMultiBLRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceInquiryDBDAOCPRTInvoiceByMultiBLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	#if($key == 'INV004' || $key == 'INV008' || $key == 'INV068' || $key == 'INV080' ||" ).append("\n"); 
		query.append("        $key == 'INV074' || $key == 'INV075' || $key == 'INV102' || $key == 'INV106' || $key == 'INV107' || $key == 'INV112')" ).append("\n"); 
		query.append("	,MAX($key) $key	" ).append("\n"); 
		query.append("	#elseif($key == 'INV047'|| $key == 'INV062'|| $key == 'INV064'|| $key == 'INV066'|| $key == 'INV067'||$key == 'INV131'|| $key == 'INV141')" ).append("\n"); 
		query.append("	,MAX($key) $key	" ).append("\n"); 
		...
		query.append("          AND   CO1.CO_CD_CTNT = MN5.DEL_CD" ).append("\n"); 
		...
		query.append("          AND CO2.CO_CD_CTNT = MN5.RCV_TERM_CD" ).append("\n"); 
		...
		query.append("          AND CO2.CO_CD_CTNT = MN5.DE_TERM_CD" ).append("\n"); 
		query.append("          AND CO2.SC_NO = NVL(MN5.SC_NO, 'X')" ).append("\n"); 
		...
		query.append("          AND   CO2.CO_CD_CTNT = MN5.CNTR_TPSZ_CD " ).append("\n"); 
		query.append("          AND   CO2.SC_NO  = NVL(MN5.SC_NO,'X') " ).append("\n"); 
		...
		query.append("        ,(SELECT DECODE(MN5.FRT_TERM_CD, 'C',W.FRT_CLT_FLG,  MIN(NVL(OT.OTS_STL_FLG,'N'))) FROM BKG_OUTSTANDING OT" ).append("\n"); 
		...
		query.append("          AND  CO3.CO_CD_CTNT =MN5.CHG_CD" ).append("\n"); 
		...
		query.append("          AND  CO4.CO_CD_CTNT = MN5.CMDT_CD" ).append("\n"); 
		...
		query.append("        ,(SELECT TO_CHAR(SUBSTR(S.MK_DESC, 1 ,4000)) FROM BKG_BL_MK_DESC S WHERE S.BKG_NO = MN5.BKG_NO AND S.MK_SEQ=1) AS INV079" ).append("\n"); 
		...
		query.append("        ,'' AS CHG001, '' AS CHG002, '' AS CHG003, '' AS CHG004 ,'' AS CHG005 ,'' AS CHG999" ).append("\n"); 
		query.append("FROM    " ).append("\n"); 
		query.append("(       " ).append("\n"); 
		...
		query.append("        ,MN4.FRT_TERM_CD, CNTR.CNTR_NO, CNTR.CNMV_CYC_NO, CNTR.CNMV_YR, CNTR.MEAS_QTY, CNTR.CNTR_PRT_FLG" ).append("\n"); 
		...
		query.append("        ,(SELECT  DECODE(CNTR.CNTR_TPSZ_CD, 'D7','45',SUBSTR(SZ.CNTR_SZ_DESC, 1, 2)) FROM MDM_CNTR_SZ SZ,MDM_CNTR_TP_SZ TP" ).append("\n"); 
		...
		query.append("        --,SUM(CHG3.CHG_AMT) AS CNTR_SUM" ).append("\n"); 
		query.append("        ,(SELECT NVL(SUM(CR.CHG_AMT),0)  " ).append("\n"); 
		query.append("          FROM  BKG_CNTR_RT CR " ).append("\n"); 
		query.append("          WHERE CR.BKG_NO = MN4.BKG_NO AND CR.CNTR_NO = CNTR.CNTR_NO" ).append("\n"); 
		...
		query.append("        ,'HJSC' AS SCAC_CD   " ).append("\n"); 
		...
		query.append("         ,CHG.CURR_CD       ,MN2.RT_APLY_DT    ,MN2.COP_DEL_ETA  ,MN2.VSK_DEL_ETA, CHG.FRT_TERM_CD" ).append("\n"); 
		...
		query.append("AND   'N'         = CHG4.FRT_INCL_XCLD_DIV_CD (+)" ).append("\n"); 
		...
		query.append("ORDER BY MN5.BKG_NO ,MN5.FRT_TERM_CD, MN5.GRP_CUR,MN5.CHG_CD ,MN5.CNTR_NO " ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("GROUP BY" ).append("\n"); 
		...
		query.append("        $key == 'INV074' || $key == 'INV075' || $key == 'INV112'|| $key == 'INV141')" ).append("\n"); 
		query.append("	,''" ).append("\n"); 
