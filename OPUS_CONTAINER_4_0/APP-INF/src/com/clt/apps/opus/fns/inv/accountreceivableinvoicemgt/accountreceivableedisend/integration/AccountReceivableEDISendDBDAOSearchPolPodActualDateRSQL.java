...
*@FileName : AccountReceivableEDISendDBDAOSearchPolPodActualDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchPolPodActualDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search Pol Pod Actual Date
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchPolPodActualDateRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchPolPodActualDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(DECODE(@[cng_indiv_cd], 'O', B.ACT_DEP_DT, B.ACT_ARR_DT),'YYYYMMDDHH24MI') ACT_DT" ).append("\n"); 
		query.append("FROM   BKG_VVD A,  VSK_ACT_PORT_SKD B," ).append("\n"); 
		...
		query.append("	   FROM   BKG_VVD BV , VSK_ACT_PORT_SKD VPS" ).append("\n"); 
