...
*@FileName : FNS_JOO_0036HTMLAction.java
...
public class FNS_JOO_0036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0036HTMLAction 객체를 생성
	 */
	public FNS_JOO_0036HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0036Event event = new FnsJoo0036Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMcsStatusVO((McsStatusVO)getVO(request, McsStatusVO .class));
		}else if(command.isCommand(FormCommand.MULTI)){
			event.setMcsStatusVOS((McsStatusVO[])getVOs(request, McsStatusVO .class,"sheet1_"));
		}
