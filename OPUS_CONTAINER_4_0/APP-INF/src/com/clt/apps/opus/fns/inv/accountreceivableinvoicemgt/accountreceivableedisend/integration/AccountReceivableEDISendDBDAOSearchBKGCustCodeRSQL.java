...
*@FileName : AccountReceivableEDISendDBDAOSearchBKGCustCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchBKGCustCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchBKGCustCodeRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchBKGCustCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CUST_CNT_CD||CUST_SEQ AS BKG_CUST" ).append("\n"); 
