...
*@FileName : AccountReceivableInvoiceMigrationDBDAOSearchVVDUSDExrateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOSearchVVDUSDExrateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search VVD USD Exrate
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOSearchVVDUSDExrateRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOSearchVVDUSDExrateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       OPUSADM_TMP.INV_VVD_XCH_RT B" ).append("\n"); 
		...
		query.append("AND    A.VSL_CD = @[vsl]" ).append("\n"); 
