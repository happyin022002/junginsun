...
public class CoaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaVO> models = new ArrayList<CoaVO>();
	...
	public CoaVO(String ibflag, String pagerows, String invCoaCoCd, String invCoaRgnCd, String invCoaCtrCd) {
		this.ibflag = ibflag;
	 ...
	 * @return CoaVO[]
	 */
	public CoaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaVO[]
	 */
	public CoaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaVO model = null;
	 ...
	 * @return CoaVO[]
	 */
	public CoaVO[] getCoaVOs(){
		CoaVO[] vos = (CoaVO[])models.toArray(new CoaVO[models.size()]);
		return vos;
	}
