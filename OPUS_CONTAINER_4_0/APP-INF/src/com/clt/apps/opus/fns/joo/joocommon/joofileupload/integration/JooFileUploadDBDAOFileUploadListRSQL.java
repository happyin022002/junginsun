...
*@FileName : JooFileUploadDBDAOFileUploadListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooFileUploadDBDAOFileUploadListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooFileUploadDBDAOFileUploadListRSQL(){
		setQuery();
		...
		query.append("FileName : JooFileUploadDBDAOFileUploadListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM JOO_CNTC_MBR_ATCH_FILE" ).append("\n"); 
