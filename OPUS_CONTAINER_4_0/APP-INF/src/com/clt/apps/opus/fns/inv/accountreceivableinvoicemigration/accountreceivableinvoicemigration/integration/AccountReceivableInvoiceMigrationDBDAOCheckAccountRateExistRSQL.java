...
*@FileName : AccountReceivableInvoiceMigrationDBDAOCheckAccountRateExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableInvoiceMigrationDBDAOCheckAccountRateExistRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Check Account Rate Exist
	  * </pre>
	  */
	public AccountReceivableInvoiceMigrationDBDAOCheckAccountRateExistRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableInvoiceMigrationDBDAOCheckAccountRateExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
