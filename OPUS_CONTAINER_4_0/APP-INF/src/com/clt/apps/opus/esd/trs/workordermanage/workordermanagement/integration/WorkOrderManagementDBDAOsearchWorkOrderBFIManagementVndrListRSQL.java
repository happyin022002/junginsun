...
*@FileName : WorkOrderManagementDBDAOsearchWorkOrderBFIManagementVndrListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderManagementDBDAOsearchWorkOrderBFIManagementVndrListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * search WorkOrderBFIManagement vendor list
	  * </pre>
	  */
	public WorkOrderManagementDBDAOsearchWorkOrderBFIManagementVndrListRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderManagementDBDAOsearchWorkOrderBFIManagementVndrListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT WO_VNDR_SEQ AS VNDR_SEQ FROM (" ).append("\n"); 
