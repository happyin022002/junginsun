...
public class YardManageDBDAOSearchYardDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", n1st_vndr_cnt_cd || n1st_vndr_seq yard_operator1" ).append("\n"); 
		...
		query.append(", n2nd_vndr_cnt_cd || n2nd_vndr_seq yard_operator2" ).append("\n"); 
		query.append(", (SELECT vndr_lgl_eng_nm FROM mdm_vendor" ).append("\n"); 
		query.append("WHERE vndr_seq = n2nd_vndr_seq) operator2_name" ).append("\n"); 
		query.append(", n3rd_vndr_cnt_cd || n3rd_vndr_seq yard_operator3" ).append("\n"); 
		query.append(", (SELECT vndr_lgl_eng_nm FROM mdm_vendor" ).append("\n"); 
