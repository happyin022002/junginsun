...
*@FileName : ESD_TPB_801HTMLAction.java
...
public class ESD_TPB_0801HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_801HTMLAction 객체를 생성
	 */
	public ESD_TPB_0801HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0801Event event = new EsdTpb0801Event();
		/** Parameter가 필요할 경우 개발자 설정 start*/

		/** Parameter가 필요할 경우 개발자 설정 end*/
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchTPBDuplicationListVOs((SearchTPBDuplicationListVO[])getVOs(request, SearchTPBDuplicationListVO .class,""));
		} else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchTPBDuplicationListVO((SearchTPBDuplicationListVO)getVO(request, SearchTPBDuplicationListVO .class));
		}
