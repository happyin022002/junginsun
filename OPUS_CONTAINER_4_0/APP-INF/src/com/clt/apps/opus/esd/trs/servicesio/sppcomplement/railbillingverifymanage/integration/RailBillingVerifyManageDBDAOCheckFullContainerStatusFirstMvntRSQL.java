...
*@FileName : RailBillingVerifyManageDBDAOCheckFullContainerStatusFirstMvntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailBillingVerifyManageDBDAOCheckFullContainerStatusFirstMvntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Container Movement 정보 CHECK
	  * </pre>
	  */
	public RailBillingVerifyManageDBDAOCheckFullContainerStatusFirstMvntRSQL(){
		setQuery();
		...
		query.append("FileName : RailBillingVerifyManageDBDAOCheckFullContainerStatusFirstMvntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("MVMT_STS_CD IS_CORRECT_ENTN" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("WHERE NO = 2" ).append("\n"); 
