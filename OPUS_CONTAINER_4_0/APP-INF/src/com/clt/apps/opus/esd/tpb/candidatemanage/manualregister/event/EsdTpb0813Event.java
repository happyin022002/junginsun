...
public class EsdTpb0813Event extends EventSupport {
	...
	public SearchTPBOfficeListVO[] getSearchTPBOfficeListVOs() {
		SearchTPBOfficeListVO[] rtnVOs = null;
		if (this.searchTPBOfficeListVOs != null) {
			rtnVOs = Arrays.copyOf(searchTPBOfficeListVOs, searchTPBOfficeListVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setSearchTPBOfficeListVOs(SearchTPBOfficeListVO[] searchTPBOfficeListVOs){
		if(searchTPBOfficeListVOs != null){
			SearchTPBOfficeListVO[] tmpVOs = Arrays.copyOf(searchTPBOfficeListVOs, searchTPBOfficeListVOs.length);
			this.searchTPBOfficeListVOs = tmpVOs;
		}
	}
