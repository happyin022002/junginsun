...
*@FileName : ConstraintManageDBDAORemoveHubConstraintDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintManageDBDAORemoveHubConstraintDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ConstraintManageDBDAORemoveHubConstraint
	  * </pre>
	  */
	public ConstraintManageDBDAORemoveHubConstraintDSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintManageDBDAORemoveHubConstraintDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PRD_HUB_LOC_CNST_MGMT" ).append("\n"); 
