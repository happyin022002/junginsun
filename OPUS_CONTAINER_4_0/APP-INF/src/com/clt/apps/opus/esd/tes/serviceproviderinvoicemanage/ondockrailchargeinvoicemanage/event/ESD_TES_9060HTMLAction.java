...
*@FileName : ESD_TES_906HTMLAction.java
 ...
 *
 * @author byungheeyoo
 * @see EsdTes9060Event , ESD_TES_906EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_9060HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TES_906HTMLAction 객체를 생성
	 */
	public ESD_TES_9060HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_906Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes9060Event event = new EsdTes9060Event(); 
