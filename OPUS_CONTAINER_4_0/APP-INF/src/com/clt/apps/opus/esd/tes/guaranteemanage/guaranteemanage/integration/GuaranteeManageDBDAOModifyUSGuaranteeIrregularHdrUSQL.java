...
*@FileName : GuaranteeManageDBDAOModifyUSGuaranteeIrregularHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GuaranteeManageDBDAOModifyUSGuaranteeIrregularHdrUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Irregular Header Save 할 때 Guarantee Header Info Save
	  * </pre>
	  */
	public GuaranteeManageDBDAOModifyUSGuaranteeIrregularHdrUSQL(){
		setQuery();
		...
		query.append("FileName : GuaranteeManageDBDAOModifyUSGuaranteeIrregularHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
