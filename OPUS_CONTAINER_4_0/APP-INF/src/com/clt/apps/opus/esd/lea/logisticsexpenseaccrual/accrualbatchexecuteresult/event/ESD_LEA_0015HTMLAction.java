...
*@FileName : ESD_LEA_0015HTMLAction.java
...
public class ESD_LEA_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0015HTMLAction 객체를 생성
	 */
	public ESD_LEA_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0015Event event = new EsdLea0015Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchResultInvoiceInquiryVO((SearchAccrualBatchResultInvoiceInquiryVO)getVO(request, SearchAccrualBatchResultInvoiceInquiryVO .class));
		}
