...
*@FileName : SearchPerCsInfoSubVO.java
*@FileTitle : SearchPerCsInfoSubVO
*Open Issues :
*Change history :
...
public class SearchPerCsInfoSubVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchPerCsInfoSubVO> models = new ArrayList<SearchPerCsInfoSubVO>();
	...
	public SearchPerCsInfoSubVO() {}

	public SearchPerCsInfoSubVO(String ibflag, String pagerows, String csGrpId, String tpId, String csDesc, String custCd, String ediSts) {
		this.ediSts = ediSts;
		this.ibflag = ibflag;
		this.csDesc = csDesc;
		this.custCd = custCd;
	 ...
	 * @param request
	 * @return SearchPerCsInfoSubVO[]
	 */
	public SearchPerCsInfoSubVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchPerCsInfoSubVO[]
	 */
	public SearchPerCsInfoSubVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchPerCsInfoSubVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchPerCsInfoSubVO();
				if (ediSts[i] != null)
		...
		return getSearchPerCsInfoSubVOs();
	}
	 ...
	 * @return SearchPerCsInfoSubVO[]
	 */
	public SearchPerCsInfoSubVO[] getSearchPerCsInfoSubVOs(){
		SearchPerCsInfoSubVO[] vos = (SearchPerCsInfoSubVO[])models.toArray(new SearchPerCsInfoSubVO[models.size()]);
		return vos;
	}
