...
*@FileName : OutstandinggroupManageDBDAOModifyTPBModificationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OutstandinggroupManageDBDAOModifyTPBModificationUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyTPBModification
	  * </pre>
	  */
	public OutstandinggroupManageDBDAOModifyTPBModificationUSQL(){
		setQuery();
		...
		params.put("n3pty_no_dp_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bl_no_all",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bkg_no_all",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : OutstandinggroupManageDBDAOModifyTPBModificationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL TPB_MODIFY_OTS_DTL_PRC(" ).append("\n"); 
		...
		query.append(",@[bkg_no_all]" ).append("\n"); 
		query.append(",@[bl_no_all]" ).append("\n"); 
