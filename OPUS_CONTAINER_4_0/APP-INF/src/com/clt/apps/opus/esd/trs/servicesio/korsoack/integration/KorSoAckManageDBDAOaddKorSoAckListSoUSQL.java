...
*@FileName : KorSoAckManageDBDAOaddKorSoAckListSoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorSoAckManageDBDAOaddKorSoAckListSoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRS_TRSP_SVC_ORD테이블 update
	  * </pre>
	  */
	public KorSoAckManageDBDAOaddKorSoAckListSoUSQL(){
		setQuery();
		...
		query.append("FileName : KorSoAckManageDBDAOaddKorSoAckListSoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", EDI_RCV_RSLT_DT		= GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[edi_rcv_rslt_dt])" ).append("\n"); 
		query.append(", EDI_RCV_RSLT_MSG		= TRIM( REPLACE(@[edi_rcv_rslt_msg],  CHR(13)||CHR(10), ' '))" ).append("\n"); 
		query.append(", EDI_RCV_PURP_CD		= @[edi_rcv_purp_cd]" ).append("\n"); 
