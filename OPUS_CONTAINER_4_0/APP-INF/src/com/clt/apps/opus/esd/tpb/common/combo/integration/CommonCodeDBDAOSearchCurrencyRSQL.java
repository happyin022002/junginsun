...
public class CommonCodeDBDAOSearchCurrencyRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT  INTG_CD_VAL_DP_DESC AS BIL_CURR_CD" ).append("\n"); 
		query.append("      , INTG_CD_VAL_DP_DESC AS BIL_CURR_CD1" ).append("\n"); 
		query.append("  FROM  COM_INTG_CD_DTL" ).append("\n"); 
		query.append(" WHERE  INTG_CD_ID = 'CD01382'" ).append("\n"); 
