...
*@FileName : USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd4SPPUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd4SPPUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPP에서 SO 상태를 SO 마스터 테이블에 수정 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd4SPPUSQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd4SPPUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
