...
import com.clt.apps.opus.esd.trs.servicesio.sppcomplement.worejectmanage.event.WorkOrderRejectList;
...
//	public WorkOrderRejectList[] getWorkOrderRejectList() {	
//		return workOrderRejectList;	
//	}
	public WorkOrderRejectList[] getWorkOrderRejectList() {
		WorkOrderRejectList[] rtnList = null;
		if(this.workOrderRejectList != null){
			rtnList = Arrays.copyOf(workOrderRejectList, workOrderRejectList.length);
		}
		return rtnList;	
	}
...
//	}
	public void setWorkOrderRejectList(WorkOrderRejectList[] workOrderRejectList) {
		if(workOrderRejectList != null){
			WorkOrderRejectList[] tmpList = Arrays.copyOf(workOrderRejectList, workOrderRejectList.length);
			this.workOrderRejectList = tmpList;
		}
	}
