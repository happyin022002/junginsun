...
*@FileName : WorkOrderCCManageDBDAOSearchEmlInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderCCManageDBDAOSearchEmlInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderCCManageDBDAOSearchEmlInfoRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderCCManageDBDAOSearchEmlInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT WO_EML" ).append("\n"); 
