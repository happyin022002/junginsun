...
public class EsdTpb0130Event extends EventSupport {
	...
	public void setSearchProcessListVOS(SearchProcessListVO[] searchProcessListVOs){
		if(searchProcessListVOs != null){
			SearchProcessListVO[] tmpVOs = Arrays.copyOf(searchProcessListVOs, searchProcessListVOs.length);
			this.searchProcessListVOs = tmpVOs;
		}
	}
	...
	public SearchProcessListVO[] getSearchProcessListVOS(){
		SearchProcessListVO[] rtnVOs = null;
		if (this.searchProcessListVOs != null) {
			rtnVOs = Arrays.copyOf(searchProcessListVOs, searchProcessListVOs.length);
		}
		return rtnVOs;
	}
