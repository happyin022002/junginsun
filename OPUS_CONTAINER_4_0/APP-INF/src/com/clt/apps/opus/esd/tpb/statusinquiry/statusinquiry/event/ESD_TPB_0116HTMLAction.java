...
public class ESD_TPB_0116HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0116HTMLAction 객체를 생성
	 */
	public ESD_TPB_0116HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0116Event event = new EsdTpb0116Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchStatusByTPBVOS((SearchStatusByTPBVO[])getVOs(request, SearchStatusByTPBVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchStatusByTPBVO((SearchStatusByTPBVO)getVO(request, SearchStatusByTPBVO .class));
		}
