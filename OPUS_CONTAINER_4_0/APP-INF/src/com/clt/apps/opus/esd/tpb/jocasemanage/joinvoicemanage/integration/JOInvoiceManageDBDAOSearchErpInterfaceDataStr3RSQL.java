...
*@FileName : JOInvoiceManageDBDAOSearchErpInterfaceDataStr3RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOInvoiceManageDBDAOSearchErpInterfaceDataStr3RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOInvoiceManageDBDAOSearchErpInterfaceDataStr3RSQL(){
		setQuery();
		...
		query.append("FileName : JOInvoiceManageDBDAOSearchErpInterfaceDataStr3RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
