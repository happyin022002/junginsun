...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.sce.visibilitymanage.edi214Receive.basic;
...
import com.clt.apps.opus.esd.sce.visibilitymanage.edi214Receive.integration.Edi214ReceiveDBDAO;
import com.clt.apps.opus.esd.sce.visibilitymanage.edi214Receive.vo.SearchActualDateInfoVO;
import com.clt.apps.opus.esd.trs.common.usa214cntrtrackingmanage.basic.USA214CntrTrackingManageBC;
import com.clt.apps.opus.esd.trs.common.usa214cntrtrackingmanage.basic.USA214CntrTrackingManageBCImpl;
...
/**
 * SCEM EDI 214 Message
 * - SCEM EDI 214 Message에 대한 비지니스 로직에 대한 인터페이스
 *
 * @author Yoonjung Lee
