...
*@FileName : InvoiceAuditDBDAOSearchInvoiceImportWoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceAuditDBDAOSearchInvoiceImportWoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * W/O번호로 S/O, W/O, Container정보를 조회
	  * </pre>
	  */
	public InvoiceAuditDBDAOSearchInvoiceImportWoRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceAuditDBDAOSearchInvoiceImportWoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND A.EQ_NO				LIKE CASE WHEN LENGTH(@[eq_no]) >= 10 THEN SUBSTR(@[eq_no], 0, 10) || '%' END              " ).append("\n"); 
