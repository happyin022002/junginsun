...
*@FileName : SearchOceanRouteDelListVO.java
*@FileTitle : SearchOceanRouteDelListVO
*Open Issues :
*Change history :
...
public class SearchOceanRouteDelListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOceanRouteDelListVO> models = new ArrayList<SearchOceanRouteDelListVO>();
	 ...
	 * @param request
	 * @return SearchOceanRouteDelListVO[]
	 */
	public SearchOceanRouteDelListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOceanRouteDelListVO[]
	 */
	public SearchOceanRouteDelListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOceanRouteDelListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOceanRouteDelListVO();
				if (cUser[i] != null)
		...
		return getSearchOceanRouteDelListVOs();
	}
	 ...
	 * @return SearchOceanRouteDelListVO[]
	 */
	public SearchOceanRouteDelListVO[] getSearchOceanRouteDelListVOs(){
		SearchOceanRouteDelListVO[] vos = (SearchOceanRouteDelListVO[])models.toArray(new SearchOceanRouteDelListVO[models.size()]);
		return vos;
	}
