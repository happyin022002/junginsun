...
public class OceanRouteManageDBDAOSearchOceanRouteMultiCreationRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("					      AND B.SKD_DIR_CD   = TG.N1ST_SKD_DIR_CD  " ).append("\n"); 
		query.append("                          AND TG.TS_IND_CD   = 'D'  " ).append("\n"); 
		query.append("                          AND TG.N1ST_LANE_FDR_FLG = 'N'  " ).append("\n"); 
		query.append("                          AND TG.UPD_IND_CD  = 'D') " ).append("\n"); 
		...
		query.append("				  AND C.SKD_DIR_CD   = TG.N1ST_SKD_DIR_CD    " ).append("\n"); 
		query.append("                  AND TG.TS_IND_CD   = 'D'  " ).append("\n"); 
		query.append("                  AND TG.N1ST_LANE_FDR_FLG = 'N'  " ).append("\n"); 
		query.append("                  AND TG.UPD_IND_CD  = 'D')" ).append("\n"); 
		...
		query.append("WHERE TG.UPD_IND_CD(+) NOT IN ('D', 'N', 'O') " ).append("\n"); 
