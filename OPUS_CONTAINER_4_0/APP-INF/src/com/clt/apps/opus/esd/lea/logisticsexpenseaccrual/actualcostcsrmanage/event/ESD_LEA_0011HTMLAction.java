...
*@FileName : ESD_LEA_0011HTMLAction.java
...
public class ESD_LEA_0011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0011HTMLAction 객체를 생성
	 */
	public ESD_LEA_0011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0011Event event = new EsdLea0011Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchRVVDChangeActualCostCSRListVO((SearchRVVDChangeActualCostCSRListVO)getVO(request, SearchRVVDChangeActualCostCSRListVO .class));
		}
