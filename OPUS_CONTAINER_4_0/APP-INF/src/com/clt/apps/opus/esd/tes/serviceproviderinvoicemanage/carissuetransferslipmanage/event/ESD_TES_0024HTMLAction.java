...
*@FileName : ESD_TES_0024HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 *
 * @author jongbaemoon
 * @see EsdTes0024Event , ESD_TES_024EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0024HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TES_0024HTMLAction 객체를 생성
	 */
	public ESD_TES_0024HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsdTes0024Event 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("\n ESD_TES_0024HTMLAction =========================   \n");

		EsdTes0024Event event = new EsdTes0024Event();
		...
		event.setApInvDtrbVO((ApInvDtrbVO)getVO(request, ApInvDtrbVO.class));
...
//        tes_tml_so_hdrs					= TES_TML_SO_HDR.fromRequestGrid(request, "");
//        
