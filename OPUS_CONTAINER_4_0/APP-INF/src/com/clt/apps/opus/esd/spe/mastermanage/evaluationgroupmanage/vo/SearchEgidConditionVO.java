...
*@FileName : SearchEgidConditionVO.java
*@FileTitle : SearchEgidConditionVO
*Open Issues :
*Change history :
...
public class SearchEgidConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEgidConditionVO> models = new ArrayList<SearchEgidConditionVO>();
	...
	public SearchEgidConditionVO() {}

	public SearchEgidConditionVO(String ibflag, String pagerows, String egId, String egRhqCd, String egCtyCd, String svcCateCd) {
		this.ibflag = ibflag;
	 ...
	 */
	public SearchEgidConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEgidConditionVO[]
	 */
	public SearchEgidConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEgidConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchEgidConditionVO();
				if (ibflag[i] != null)
		...
		return getSearchEgidConditionVOs();
	}
	 ...
	 * @return SearchEgidConditionVO[]
	 */
	public SearchEgidConditionVO[] getSearchEgidConditionVOs(){
		SearchEgidConditionVO[] vos = (SearchEgidConditionVO[])models.toArray(new SearchEgidConditionVO[models.size()]);
		return vos;
	}
