...
public class Edi315SendDBDAOSearchCurrVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", nvl(decode(mv.LLOYD_NO, 'T.B.N.', 'TBN', LLOYD_NO), ' ')  lloyd_cd" ).append("\n"); 
		...
		query.append("('OC' = BOUND and nod_cd like  substr(@[org_nod],1,5)||'%' and STND_EDI_STS_CD like decode( @[edi_sts], 'VE', 'VA%', @[edi_sts]||'%'))" ).append("\n"); 
		query.append("or" ).append("\n"); 
