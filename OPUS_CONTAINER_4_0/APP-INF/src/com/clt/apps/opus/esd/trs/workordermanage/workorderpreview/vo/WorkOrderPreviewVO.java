...
package com.clt.apps.opus.esd.trs.workordermanage.workorderpreview.vo;
...
public class WorkOrderPreviewVO extends AbstractValueObject {
	...
	/* Column Info */
	private String draftFlg = null;
	/* Column Info */
	private String joItemRef = null;
	...
	public WorkOrderPreviewVO(String ibflag, String pagerows, String contiCd, String woPrvGrpSeq, String woIssNo, String woFmtTpCd, String woVndrSeq, String woIssStsCd, String trspWoOfcCtyCd, String trspWoSeq, String rdCgo, String woPrnUseFlg, String woEmlUseFlg, String woFaxUseFlg,
			String woEdiUseFlg, String woDtlUseFlg, String interUseFlg, String rtDpUseFlg, String cmdtDpUseFlg, String preDisUseFlg, String woRmk, String woN1stEml, String woN2ndEml, String woN3rdEml, String woN1stFaxNo, String woN2ndFaxNo, String woN3rdFaxNo, String ediLoc,
			String ediTrspSoOfcCtyCd, String ediTrspSoSeq, String ediTrspWoOfcCtyCd, String ediTrspWoSeq, String ediWoIssKnt, String ediWoIssStsCd, String ediVndrSeq, String trspCrrModCd, String trspCostDtlModCd, String ediEqNo, String ediRcvrNm, String scgGrpSeq, String faxNo01, String faxNo02,
			String faxNo03, String faxSysCd, String faxAppCd, String faxBatchInd, String faxTitle, String faxParam, String faxRcvInfo, String emlNo01, String emlNo02, String emlNo03, String emailTitle, String emailContents, String woCxlFlg, String fltFileNo, String woCntcPsonNm, String soCreOfcCd,
			String ediFltCd, String trspBndCd, String fmNodCd, String toNodCd, String draftFlg, String joItemRef) {
	...
	public HashMap<String, String> getColumnValues() {
		...
		this.hashColumns.put("draft_flg", getDraftFlg());
		this.hashColumns.put("jo_item_ref", getJoItemRef());
	...
	public HashMap<String, String> getFieldNames() {
		...
		this.hashFields.put("draft_flg", "draftFlg");
		this.hashFields.put("jo_item_ref", "joItemRef");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDraftFlg(JSPUtil.getParameter(request, "draft_flg", ""));
		setJoItemRef(JSPUtil.getParameter(request, "jo_item_ref", ""));
	}
	...
	public WorkOrderPreviewVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] draftFlg = (JSPUtil.getParameter(request, prefix + "draft_flg", length));
			String[] joItemRef = (JSPUtil.getParameter(request, prefix + "jo_item_ref", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (draftFlg[i] != null)
					model.setDraftFlg(draftFlg[i]);
				if (joItemRef[i] != null)
					model.setJoItemRef(joItemRef[i]);
				models.add(model);
			}
	...
	public void unDataFormat() {
		...
		this.draftFlg = this.draftFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.joItemRef = this.joItemRef.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
