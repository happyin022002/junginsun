...
public class SearchInvoiceInquirySecondExcelFormVO extends AbstractValueObject {
	...
	public SearchInvoiceInquirySecondExcelFormVO(String ibflag, String pagerows, String ifSysKndCd, String ifSysKndNm, String trspInvAudStsCd, String trspInvAudStsNm, String invHldFlg, String invNo, String invVndrSeq, String invVndrNm, String trspWoOfcCtyCdSeq, String vndrSeq, String vndrNm,
			String trspSoOfcCtyCdSeq, String eqNo, String eqTpszCd, String currCd, String bzcAmt, String negoAmt, String fuelScgAmt, String etcAddAmt, String woTotAmt, String invXchRt, String trspInvCalcLgcTpCd, String trspInvCalcLgcTpNm, String invCurrCd, String invBzcAmt, String invEtcAddAmt,
			String invTotAmt, String invVatAmt, String invWhldTaxAmt, String invGttlAmt, String invIssDt, String invRcvDt, String payDt, String glDt, String updDt, String csrNo, String invPayMzdCd, String invChkTrnsNo, String invRmk, String creOfcCd, String creUsrId, String refInvNo,
			String invAdjBzcAmt) {
		this.payDt = payDt;
		this.glDt = glDt;
		this.currCd = currCd;
