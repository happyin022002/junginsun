...
*@FileName : ExceptionDataDBDAOSearchExptDetailList3RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExceptionDataDBDAOSearchExptDetailList3RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ExceptionDataDBDAOSearchExptDetailList3RSQL(){
		setQuery();
		...
		query.append("FileName : ExceptionDataDBDAOSearchExptDetailList3RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    TP.EXPT_TP_CD = @[f_expt_tp]" ).append("\n"); 
