...
public class EmptyReleaseRedeliveryOrderMgtDBDAOSearchIssuedReleaseListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("         REGEXP_REPLACE(SUBSTR(S.CUST_NM, 1, 50), '[' || CHR(92) || CHR(13) || CHR(10) || CHR(34) || CHR(9) || ']', ' ') AS SHPR," ).append("\n"); 
		query.append("         REGEXP_REPLACE(SUBSTR(C.CUST_NM, 1, 50), '[' || CHR(92) || CHR(13) || CHR(10) || CHR(34) || CHR(9) || ']', ' ') AS CNEE," ).append("\n"); 
		query.append("	     REGEXP_REPLACE(SUBSTR(N.CUST_NM, 1, 50), '[' || CHR(92) || CHR(13) || CHR(10) || CHR(34) || CHR(9) || ']', ' ') AS NTFY, " ).append("\n"); 
		...
		query.append("   WHERE STK.SO_OFC_CTY_CD = ORD.TRSP_SO_OFC_CTY_CD(+)" ).append("\n"); 
		...
		query.append("--     AND DECODE(ORD.CGO_TP_CD, 'F', ORD.TRSP_BND_CD, 'X') = DECODE(ORD.CGO_TP_CD, 'F', 'O', 'X')" ).append("\n"); 
		...
		query.append("         STK.SO_OFC_CTY_CD," ).append("\n"); 
		query.append("         STK.SO_SEQ," ).append("\n"); 
