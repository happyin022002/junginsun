...
*@FileName : InlandRouteManageUsaDBDAOInlandRouteUSDetRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageUsaDBDAOInlandRouteUSDetRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * inland route us detail
	  * </pre>
	  */
	public InlandRouteManageUsaDBDAOInlandRouteUSDetRSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageUsaDBDAOInlandRouteUSDetRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		PRD_GET_INLND_DTL_AGMT_RT_FNC(a.trsp_mod_cd, a.vndr_seq, a.rail_crr_tp_cd, a.pctl_io_bnd_cd, a.lnk_org_nod_cd, a.lnk_dest_nod_cd, a.trsp_agmt_ofc_cty_cd, a.trsp_agmt_seq ) r	" ).append("\n"); 
		query.append("	FROM (" ).append("\n"); 
		query.append("		SELECT    m.rout_org_nod_cd, m.rout_dest_nod_cd, m.rout_seq, m.prio_seq, m.pctl_io_bnd_cd," ).append("\n"); 
		...
		query.append("			  m.inlnd_rout_inv_bil_patt_cd, DECODE(m.rout_pln_cd,'N','',m.rout_pln_cd) rout_pln_cd, " ).append("\n"); 
		...
		query.append("			    WHEN SUBSTR (d.lnk_org_nod_cd, 1, 2) IN ('US', 'CA' ) AND SUBSTR (d.lnk_dest_nod_cd, 1, 2) IN ('US', 'CA' ) AND d.trsp_mod_cd = 'RD' THEN 'T' " ).append("\n"); 
		...
		query.append("			  decode(trim(m.wrs_full_cmdt_cd),'','','Y' ) wrs_full_cmdt, m.wrs_full_cmdt_cd, m.wrs_mty_cmdt_cd, " ).append("\n"); 
		query.append("			  m.inlnd_rout_bkg_flg,a.trsp_agmt_ofc_cty_cd, a.trsp_agmt_seq," ).append("\n"); 
		query.append("			  a.trsp_agmt_ofc_cty_cd||a.trsp_agmt_seq as agmt_no,  a.agmt_ref_no" ).append("\n"); 
