 ...
 *@FileName : ESD_PRD_0035HTMLAction.java
 ...
 *
 * @author kimyoungchul
 * @see EsdPrd0035Event , ESD_PRD_035EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_PRD_0035HTMLAction extends HTMLActionSupport{
	private static final long serialVersionUID = 1L;

	/**
	 * ESD_PRD_0035HTMLAction 객체를 생성
	 */
	public ESD_PRD_0035HTMLAction(){
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_PRD_035Event로 파싱하여 request에 셋팅<br>
	 *
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException{
		EsdPrd0035Event event = new EsdPrd0035Event();
		...
		event.setPolContCd(request.getParameter("pol_cont_cd"));
		event.setPodContCd(request.getParameter("pod_cont_cd"));
