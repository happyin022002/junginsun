...
public class Edi315SendEAIDAO extends EAIDAOSupport{
     ...
     * 
     * Live Queue : OPUSSCE_UDEVCOM_315
     * Test Queue : OPUSSCE_T_UDEVCOM_315
     * @param str String
     * @return String
     * @throws Exception 
     */
    public String sendEDIMQ(String str) throws Exception 
    {
		...
		String target       =  SubSystemConfigFactory.get("SCE.OPUSSCE_T_UDEVCOM_315.IBMMQ.URL");
		String transfertype =  SubSystemConfigFactory.get("SCE.OPUSSCE_T_UDEVCOM_315.IBMMQ.TRANSFERTYPE");
		String channel      =  SubSystemConfigFactory.get("SCE.OPUSSCE_T_UDEVCOM_315.IBMMQ.CHANNEL");
		String factory      =  SubSystemConfigFactory.get("SCE.OPUSSCE_T_UDEVCOM_315.IBMMQ.FACTORY");
		String queue        =  SubSystemConfigFactory.get("SCE.OPUSSCE_T_UDEVCOM_315.IBMMQ.QUEUE");
		String targetclient =  SubSystemConfigFactory.get("SCE.OPUSSCE_T_UDEVCOM_315.IBMMQ.TARGETCLIENT");
