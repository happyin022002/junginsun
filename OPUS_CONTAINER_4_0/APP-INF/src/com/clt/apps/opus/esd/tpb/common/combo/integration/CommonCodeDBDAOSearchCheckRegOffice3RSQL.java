...
*@FileName : CommonCodeDBDAOSearchCheckRegOffice3RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonCodeDBDAOSearchCheckRegOffice3RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CommonCodeDBDAO SearchCheckRegOffice3
	  * </pre>
	  */
	public CommonCodeDBDAOSearchCheckRegOffice3RSQL(){
		setQuery();
		...
		query.append("FileName : CommonCodeDBDAOSearchCheckRegOffice3RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
