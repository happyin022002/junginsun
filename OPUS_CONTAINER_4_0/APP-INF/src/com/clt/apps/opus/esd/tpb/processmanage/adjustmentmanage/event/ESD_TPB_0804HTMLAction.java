...
*@FileName : ESD_TPB_0804HTMLAction.java
...
public class ESD_TPB_0804HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0804HTMLAction 객체를 생성
	 */
	public ESD_TPB_0804HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0804Event event = new EsdTpb0804Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchROCToOfficeListVO((SearchROCToOfficeListVO)getVO(request, SearchROCToOfficeListVO .class));
		}
