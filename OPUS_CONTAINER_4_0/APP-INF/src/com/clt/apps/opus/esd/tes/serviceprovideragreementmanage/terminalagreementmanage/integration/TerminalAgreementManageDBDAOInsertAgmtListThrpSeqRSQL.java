...
*@FileName : TerminalAgreementManageDBDAOInsertAgmtListThrpSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertAgmtListThrpSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertAgmtListThrpSeqRSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertAgmtListThrpSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	NVL(MAX(thrp_seq), 1) + 1 MAX_THRP_SEQ" ).append("\n"); 
