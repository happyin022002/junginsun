...
*@FileName : ESD_TES_2005HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esd.tes.serviceproviderguaranteemanage 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESD_TES_2005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TES_2005HTMLAction 객체를 생성
	 */
	public ESD_TES_2005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes2005Event event = new EsdTes2005Event();
