...
*@FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisVVVDUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisVVVDUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateTrsSvcOrdBkgChmHisVVVD
	  * </pre>
	  */
	public WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisVVVDUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisVVVDUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
