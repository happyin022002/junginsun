...
*@FileName : InvoiceAuditDBDAOConfirmInvoiceAuditThirdPartyIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceAuditDBDAOConfirmInvoiceAuditThirdPartyIfCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/O가 3rd Party Billing 대상일 경우 3rd I/F 테이블에 입력
	  * </pre>
	  */
	public InvoiceAuditDBDAOConfirmInvoiceAuditThirdPartyIfCSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceAuditDBDAOConfirmInvoiceAuditThirdPartyIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("CASE WHEN SVC_ORD.N3PTY_CUST_CNT_CD IS NOT NULL THEN 'C'" ).append("\n"); 
		...
		query.append("WHERE SVC_ORD.TRSP_SO_OFC_CTY_CD	= @[trsp_so_ofc_cty_cd]" ).append("\n"); 
