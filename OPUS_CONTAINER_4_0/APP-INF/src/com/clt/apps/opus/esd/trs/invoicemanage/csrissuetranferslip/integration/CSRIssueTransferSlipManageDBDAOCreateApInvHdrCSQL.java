...
public class CSRIssueTransferSlipManageDBDAOCreateApInvHdrCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("						,	(SELECT GEN_PAY_TERM_CD FROM MDM_VENDOR WHERE VNDR_SEQ  = @[VNDR_NO])       					-- vndr_term_nm <-- VNDR_SEQ" ).append("\n"); 
		...
		query.append("						,	(SELECT PAY_MZD_CD FROM MDM_VENDOR WHERE VNDR_SEQ = @[VNDR_NO])									-- pay_mzd_lu_cd" ).append("\n"); 
