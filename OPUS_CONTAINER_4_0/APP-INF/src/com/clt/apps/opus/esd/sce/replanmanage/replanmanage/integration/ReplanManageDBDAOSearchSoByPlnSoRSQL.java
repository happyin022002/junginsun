...
*@FileName : ReplanManageDBDAOSearchSoByPlnSoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReplanManageDBDAOSearchSoByPlnSoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * cop_no 와 cost_act_grp_seq 로 so 정보를 찾는다
	  * </pre>
	  */
	public ReplanManageDBDAOSearchSoByPlnSoRSQL(){
		setQuery();
		...
		query.append("FileName : ReplanManageDBDAOSearchSoByPlnSoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
