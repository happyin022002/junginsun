...
*@FileName : InvoiceRefundVO.java
*@FileTitle : InvoiceRefundVO
*Open Issues :
*Change history :
...
public class InvoiceRefundVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvoiceRefundVO> models = new ArrayList<InvoiceRefundVO>();
	 ...
	 * @param request
	 * @return InvoiceRefundVO[]
	 */
	public InvoiceRefundVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvoiceRefundVO[]
	 */
	public InvoiceRefundVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvoiceRefundVO model = null;
	 ...
	 * @return InvoiceRefundVO[]
	 */
	public InvoiceRefundVO[] getInvoiceRefundVOs(){
		InvoiceRefundVO[] vos = (InvoiceRefundVO[])models.toArray(new InvoiceRefundVO[models.size()]);
		return vos;
	}
