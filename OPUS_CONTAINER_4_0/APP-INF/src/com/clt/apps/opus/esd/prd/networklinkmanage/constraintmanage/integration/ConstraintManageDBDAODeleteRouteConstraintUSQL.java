...
*@FileName : ConstraintManageDBDAODeleteRouteConstraintUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintManageDBDAODeleteRouteConstraintUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DeleteRouteConstraint
	  * </pre>
	  */
	public ConstraintManageDBDAODeleteRouteConstraintUSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintManageDBDAODeleteRouteConstraintUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND ROUT_CNST_SEQ = @[s_rout_seq]" ).append("\n"); 
