...
public class ESD_PRD_0081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_PRD_0081HTMLAction 객체를 생성
	 */
	public ESD_PRD_0081HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdPrd0081Event event = new EsdPrd0081Event();
		event.setAttribute("pgmNo", request.getServletPath().substring(1,13));
		log.debug("\n\n ESD_PRD_0081HTMLAction-------------------------------------------------------");
		log.debug("\n\n f_cmf:");
