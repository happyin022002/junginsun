...
*@FileName : BkgCopManageDBDAOSearchBkgBookingRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOSearchBkgBookingRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * bkg_booking table 정보를 조회한다.
	  * </pre>
	  */
	public BkgCopManageDBDAOSearchBkgBookingRSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOSearchBkgBookingRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("IB_DEL_DE_GDT           ," ).append("\n"); 
		query.append("BKG_CRE_GDT             ," ).append("\n"); 
		query.append("BKG_CXL_GDT             ," ).append("\n"); 
		query.append("SPLIT_GDT               ," ).append("\n"); 
		query.append("TAA_NO					," ).append("\n"); 
		query.append("BKG_PTY_CUST_CNT_CD AS BKG_PTY_CNT_CD			," ).append("\n"); 
