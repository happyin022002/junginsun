...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOAddStorageInvoiceContainerListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOAddStorageInvoiceContainerListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddStorageInvoiceContainerList
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOAddStorageInvoiceContainerListCSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOAddStorageInvoiceContainerListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
