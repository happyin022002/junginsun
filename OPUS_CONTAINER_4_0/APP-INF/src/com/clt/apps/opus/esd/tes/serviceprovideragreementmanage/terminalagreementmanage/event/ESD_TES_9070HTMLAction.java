 ...
 * @author yOng hO lEE
 * @see EsdTes9070Event 참조
 * @since J2EE 1.6
 */
public class ESD_TES_9070HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_9070HTMLAction 객체를 생성
	 */
	public ESD_TES_9070HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_907Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTes9070Event	event	= new EsdTes9070Event();
