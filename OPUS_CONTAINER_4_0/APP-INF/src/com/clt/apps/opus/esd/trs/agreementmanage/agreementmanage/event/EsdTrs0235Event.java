...
public class EsdTrs0235Event extends EventSupport {
	...
	private String fmTrspCostModCd     = null;
	private String fmTrspBndCd         = null;
	...
	public String getFmTrspCostModCd() {
		return fmTrspCostModCd;
	}

	public void setFmTrspCostModCd(String fmTrspCostModCd) {
		this.fmTrspCostModCd = fmTrspCostModCd;
	}

	public String getFmTrspBndCd() {
		return fmTrspBndCd;
	}

	public void setFmTrspBndCd(String fmTrspBndCd) {
		this.fmTrspBndCd = fmTrspBndCd;
	}
