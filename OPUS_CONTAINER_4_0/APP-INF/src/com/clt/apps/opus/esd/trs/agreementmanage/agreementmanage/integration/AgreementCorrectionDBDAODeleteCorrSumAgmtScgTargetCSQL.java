...
*@FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * reement Rate아래의 모든 Rate를 삭제하기전 Surcharge 삭제대상을 History테이블에 입력한다.
	  * </pre>
	  */
	public AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetCSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
