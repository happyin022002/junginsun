...
*@FileName : SearchOceanRouteConditionVO.java
*@FileTitle : SearchOceanRouteConditionVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esd.prd.networklinkmanage.oceanrouteconditionmanage.vo;
...
public class SearchOceanRouteConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOceanRouteConditionVO> models = new ArrayList<SearchOceanRouteConditionVO>();
	...
	public SearchOceanRouteConditionVO() {}

	public SearchOceanRouteConditionVO(String ibflag, String pagerows, String portCd, String vslSlanCd, String skdDirCd, String crrCd, String tmlCd, String ydNm, String creDt, String updDt, String updUsrId, String iPortCd, String iVslSlanCd, String iCrrCd, String iTmlCd, String maxSeq, String creOfcCd, String creUsrId) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("i_tml_cd", getITmlCd());
		...
		this.hashColumns.put("i_crr_cd", getICrrCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("i_tml_cd", "iTmlCd");
		...
		this.hashFields.put("i_crr_cd", "iCrrCd");
	 ...
	 * @param iTmlCd
	 */
	public void setITmlCd(String iTmlCd) {
		this.iTmlCd = iTmlCd;
	}
	 ...
	 * @param iCrrCd
	 */
	public void setICrrCd(String iCrrCd) {
		this.iCrrCd = iCrrCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setITmlCd(JSPUtil.getParameter(request, "i_tml_cd", ""));
		...
		setICrrCd(JSPUtil.getParameter(request, "i_crr_cd", ""));
	 ...
	 */
	public SearchOceanRouteConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOceanRouteConditionVO[]
	 */
	public SearchOceanRouteConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOceanRouteConditionVO model = null;
		...
		try {
			...
			String[] iTmlCd = (JSPUtil.getParameter(request, prefix	+ "i_tml_cd", length));
			...
			String[] iCrrCd = (JSPUtil.getParameter(request, prefix	+ "i_crr_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOceanRouteConditionVO();
				if (updDt[i] != null)
					model.setUpdDt(updDt[i]);
				if (iVslSlanCd[i] != null)
					model.setIVslSlanCd(iVslSlanCd[i]);
				if (iTmlCd[i] != null)
					model.setITmlCd(iTmlCd[i]);
				if (creDt[i] != null)
		...
		return getSearchOceanRouteConditionVOs();
	}
	...
	public SearchOceanRouteConditionVO[] getSearchOceanRouteConditionVOs(){
		SearchOceanRouteConditionVO[] vos = (SearchOceanRouteConditionVO[])models.toArray(new SearchOceanRouteConditionVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.iTmlCd = this.iTmlCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.iCrrCd = this.iCrrCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
