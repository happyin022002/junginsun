...
*@FileName : ESD_LEA_0902HTMLAction.java
...
public class ESD_LEA_0902HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0902HTMLAction 객체를 생성
	 */
	public ESD_LEA_0902HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0902Event event = new EsdLea0902Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualRevenueVVDCodeListVO((SearchAccrualRevenueVVDCodeListVO)getVO(request, SearchAccrualRevenueVVDCodeListVO .class));
		}
