...
public class ESD_TRS_0921HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		String  trsp_agmt_ofc_cty_cd = request.getParameter("trsp_agmt_ofc_cty_cd");
		String  trsp_agmt_seq = request.getParameter("trsp_agmt_seq");
		String  rvn_mpt_cntr = request.getParameter("rvn_mpt_cntr");
		...
		event.setTrspAgmtOfcCtyCd(trsp_agmt_ofc_cty_cd);
		event.setTrspAgmtSeq(trsp_agmt_seq);
		event.setRvnMptCntr(rvn_mpt_cntr);
