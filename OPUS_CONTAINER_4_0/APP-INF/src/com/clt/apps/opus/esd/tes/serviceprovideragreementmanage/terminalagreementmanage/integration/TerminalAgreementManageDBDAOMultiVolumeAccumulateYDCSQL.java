...
*@FileName : TerminalAgreementManageDBDAOMultiVolumeAccumulateYDCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOMultiVolumeAccumulateYDCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TES_TML_SO_ACCM_YD  Insert or Update
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOMultiVolumeAccumulateYDCSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOMultiVolumeAccumulateYDCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("             , @[accm_seq] " ).append("\n"); 
		query.append("             , " ).append("\n"); 
		query.append("               (SELECT NVL(MAX(ACCM_DTL_SEQ), 0) + 1 " ).append("\n"); 
