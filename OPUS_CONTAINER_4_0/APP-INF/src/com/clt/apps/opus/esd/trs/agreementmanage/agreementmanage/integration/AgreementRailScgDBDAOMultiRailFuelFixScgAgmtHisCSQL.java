...
*@FileName : AgreementRailScgDBDAOMultiRailFuelFixScgAgmtHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementRailScgDBDAOMultiRailFuelFixScgAgmtHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * US RAIL Surcharge 화면의 US RAIL Agreement Fuel, Fixed Surcharge History 저장(Update, Delete시)
	  * </pre>
	  */
	public AgreementRailScgDBDAOMultiRailFuelFixScgAgmtHisCSQL(){
		setQuery();
		...
		query.append("FileName : AgreementRailScgDBDAOMultiRailFuelFixScgAgmtHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TRS_AGMT_RAIL_SCG_RT_HIS (" ).append("\n"); 
