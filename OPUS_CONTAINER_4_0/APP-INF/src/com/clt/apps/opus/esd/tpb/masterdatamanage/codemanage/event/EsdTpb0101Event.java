...
public class EsdTpb0101Event extends EventSupport {
	...
	public void setSearchCodeListVOS(SearchCodeListVO[] searchCodeListVOs){
		if(searchCodeListVOs != null){
			SearchCodeListVO[] tmpVOs = Arrays.copyOf(searchCodeListVOs, searchCodeListVOs.length);
			this.searchCodeListVOs = tmpVOs;
		}
	}
	...
	public SearchCodeListVO[] getSearchCodeListVOS(){
		SearchCodeListVO[] rtnVOs = null;
		if (this.searchCodeListVOs != null) {
			rtnVOs = Arrays.copyOf(searchCodeListVOs, searchCodeListVOs.length);
		}
		return rtnVOs;
	}
