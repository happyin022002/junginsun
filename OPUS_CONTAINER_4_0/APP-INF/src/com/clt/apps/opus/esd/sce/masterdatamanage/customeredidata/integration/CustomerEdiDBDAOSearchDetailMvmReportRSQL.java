...
public class CustomerEdiDBDAOSearchDetailMvmReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",t.gmt_dt1, t.gmt_dt2, t.rbtn , t.cop_no , '' flag,t.ts_port, t.rail" ).append("\n"); 
		...
		query.append("where cop_no = t.cop_no and t.edi_sts_cd = dtl.stnd_edi_sts_cd) dtl_nod_cd" ).append("\n"); 
		query.append("from (" ).append("\n"); 
		query.append("select L.vvd, L.bkg_no, L.bl_no, L.cntr_no, L.por_cd, L.pol_cd, L.pod_cd, L.del_cd, ''" ).append("\n"); 
		query.append(",L.EDI_STS_CD, L.edi_sub_sts_cd,L.edi_snd_knt, L.act_dt1, L.act_dt2, L.nod_cd, L.cre_dt1, L.cre_dt2" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",L.gmt_dt1, L.gmt_dt2" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",decode(L.edi_snd_knt,null,'9',case when L.max_edi_snd_knt= L.edi_snd_knt then '0' else '9' end) rbtn,L.cop_no , ''   ,L.ts_port, L.rail  ,rownum no" ).append("\n"); 
		query.append(",L.flt_file_ref_no" ).append("\n"); 
		query.append("from (  select DISTINCT dtl.vvd,dtl.bkg_no, dtl.cntr_no, dtl.por_cd, dtl.pol_cd, dtl.pod_cd, dtl.del_cd,''" ).append("\n"); 
		query.append(",dtl.EDI_STS_CD, dtl.edi_sub_sts_cd, dtl.edi_snd_knt, dtl.act_dt1, dtl.act_dt2, nod_cd, dtl.cre_dt1, dtl.cre_dt2, '0'" ).append("\n"); 
		query.append(",dtl.cop_no, dtl.bl_no, sts.edi_sts_seq sort_seq, dtl.act_dt1||dtl.act_dt2 sort_dt, max_edi_snd_knt" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",dtl.gmt_dt1, dtl.gmt_dt2  , dtl.ts_port, dtl.rail" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", dtl.flt_file_ref_no" ).append("\n"); 
		query.append("from ( select   vvd, a.bkg_no, a.cntr_no, por_cd, pol_cd, pod_cd, del_cd,'' flg, a.EDI_STS_CD, r.edi_snd_knt" ).append("\n"); 
		query.append(",to_char(r.act_dt,'yyyymmdd') act_dt1, to_char(r.act_dt,'hh24miss') act_dt2, r.nod_cd" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", to_char(r.upd_dt,'yyyymmdd') cre_dt1, to_char(r.upd_dt,'hh24miss') cre_dt2, a.cop_no , a.bl_no, r.act_dt, a.edi_sub_sts_cd	, a.ts_port, a.rail" ).append("\n"); 
		...
		query.append("and VPS_ETD_DT BETWEEN TO_DATE(@[poletddate1_hidden], 'YYYYMMDD' ) AND TO_DATE(@[poletddate1_hidden], 'YYYYMMDD' ) + 0.9999" ).append("\n"); 
		...
		query.append(",r.edi_snd_knt, r.act_dt, r.nod_cd" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",r.upd_dt, a.cop_no, a.bl_no" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",r.gmt_dt ,a.ts_port, a.rail, r.flt_file_ref_no" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(") dtl," ).append("\n"); 
		query.append("EDI_CGO_STND_STS sts" ).append("\n"); 
		query.append("where sts.EDI_STND_STS_CD = dtl.edi_sts_cd and sts.edi_sts_seq < 800" ).append("\n"); 
		query.append("order by vvd, bkg_no, cntr_no, sort_seq, max_edi_snd_knt, dtl.edi_snd_knt" ).append("\n"); 
