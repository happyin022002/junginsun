...
public class COPHistoryDBDAOSearchCOPHistoryRSQL implements ISQLTemplate{
	...
	public COPHistoryDBDAOSearchCOPHistoryRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esd.sce.copreport.cophsitory.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append(", DECODE(h.cntr_no	, 'COMU0000000', '', h.cntr_no) AS cntr_no" ).append("\n"); 
		query.append(", h.bkg_no" ).append("\n"); 
		query.append(", (SELECT d.BKG_EVNT_TP_DESC FROM SCE_BKG_EVNT_DESC d WHERE d.BKG_EVNT_TP_CD = h.BKG_EVNT_TP_CD)event" ).append("\n"); 
