...
*@FileName : OceanRouteConditionManageDBDAOCheckDupRhqLinkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteConditionManageDBDAOCheckDupRhqLinkRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OceanRouteConditionManageDBDAOCheckDupRhqLinkRSQL
	  * </pre>
	  */
	public OceanRouteConditionManageDBDAOCheckDupRhqLinkRSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteConditionManageDBDAOCheckDupRhqLinkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
