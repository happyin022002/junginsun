...
public class CARIssueTransferSlipManageDBDAOCheckMissingLaneCode01RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		(SELECT DECODE(@[cnt_cd],'KR',SUM(ROUND((CSR_AMT/RATE)*FTU_USE_CTNT2)),SUM(DECODE(CURR,'JPY',ROUND((CSR_AMT/RATE)*FTU_USE_CTNT2)," ).append("\n"); 
		...
		query.append("                                                                                                     ROUND((CSR_AMT/RATE)*FTU_USE_CTNT2,2))))" ).append("\n"); 
