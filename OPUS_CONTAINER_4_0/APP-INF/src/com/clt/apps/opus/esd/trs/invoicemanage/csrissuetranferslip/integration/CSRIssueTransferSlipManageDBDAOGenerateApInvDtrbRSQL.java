...
public class CSRIssueTransferSlipManageDBDAOGenerateApInvDtrbRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,CASE WHEN TRSP_SO_TP_CD = 'O' AND EQ_KND_CD = 'U' AND CGO_TP_CD = 'F' AND REF_BKG_NO IS NOT NULL AND (SELECT B.BKG_STS_CD FROM BKG_BOOKING B WHERE B.BKG_NO = REF_BKG_NO) <> 'X' THEN REF_BKG_NO" ).append("\n"); 
		...
		query.append("          FROM (SELECT @[CSR_NO] CSR_NO" ).append("\n"); 
		...
		query.append("                      ,CGO_TP_CD" ).append("\n"); 
		query.append("                      ,EQ_KND_CD" ).append("\n"); 
		query.append("                  FROM (SELECT CASE NVL((SELECT DP_PRCS_KNT FROM MDM_CURRENCY WHERE CURR_CD = @[CURR_CD] AND NVL(DELT_FLG, 'N') = 'N'), 0)" ).append("\n"); 
		query.append("                                 WHEN 0 THEN" ).append("\n"); 
		query.append("                                  CASE" ).append("\n"); 
		query.append("                                    WHEN SVC_ORD.TRSP_INV_CALC_LGC_TP_CD = 'TM' THEN SUM(ROUND(((NVL(SVC_ORD.BZC_AMT, 0) + NVL(SVC_ORD.NEGO_AMT, 0)) * NVL(SVC_ORD.INV_XCH_RT, 1)), 0) + NVL(SVC_ORD.CSR_BZC_CORR_AMT, 0) + NVL(SVC_ORD.INV_ADJ_BZC_AMT, 0))" ).append("\n"); 
		query.append("                                    WHEN SVC_ORD.TRSP_INV_CALC_LGC_TP_CD = 'DV' THEN SUM(ROUND(((NVL(SVC_ORD.BZC_AMT, 0) + NVL(SVC_ORD.NEGO_AMT, 0)) / NVL(SVC_ORD.INV_XCH_RT, 1)), 0) + NVL(SVC_ORD.CSR_BZC_CORR_AMT, 0) + NVL(SVC_ORD.INV_ADJ_BZC_AMT, 0))" ).append("\n"); 
		query.append("                                    ELSE SUM(ROUND((NVL(SVC_ORD.BZC_AMT, 0) + NVL(SVC_ORD.NEGO_AMT, 0)), 0) + NVL(SVC_ORD.CSR_BZC_CORR_AMT, 0) + NVL(SVC_ORD.INV_ADJ_BZC_AMT, 0))" ).append("\n"); 
		query.append("                                  END" ).append("\n"); 
		query.append("                                 ELSE" ).append("\n"); 
		query.append("                                  CASE" ).append("\n"); 
		query.append("                                    WHEN SVC_ORD.TRSP_INV_CALC_LGC_TP_CD = 'TM' THEN SUM(ROUND(((NVL(SVC_ORD.BZC_AMT, 0) + NVL(SVC_ORD.NEGO_AMT, 0)) * NVL(SVC_ORD.INV_XCH_RT, 1)), 2) + NVL(SVC_ORD.CSR_BZC_CORR_AMT, 0) + NVL(SVC_ORD.INV_ADJ_BZC_AMT, 0))" ).append("\n"); 
		query.append("                                    WHEN SVC_ORD.TRSP_INV_CALC_LGC_TP_CD = 'DV' THEN SUM(ROUND(((NVL(SVC_ORD.BZC_AMT, 0) + NVL(SVC_ORD.NEGO_AMT, 0)) / NVL(SVC_ORD.INV_XCH_RT, 1)), 2) + NVL(SVC_ORD.CSR_BZC_CORR_AMT, 0) + NVL(SVC_ORD.INV_ADJ_BZC_AMT, 0))" ).append("\n"); 
		query.append("                                    ELSE SUM(ROUND((NVL(SVC_ORD.BZC_AMT, 0) + NVL(SVC_ORD.NEGO_AMT, 0)), 2) + NVL(SVC_ORD.CSR_BZC_CORR_AMT, 0) + NVL(SVC_ORD.INV_ADJ_BZC_AMT, 0))" ).append("\n"); 
		query.append("                                  END" ).append("\n"); 
		...
		query.append("                              ,(SELECT A.LOC_CD FROM MDM_ORGANIZATION A WHERE A.OFC_CD = SVC_ORD.CRE_OFC_CD) ATTR_CTNT3" ).append("\n"); 
		query.append("                              ,NULL ATTR_CTNT4" ).append("\n"); 
		query.append("                              ,NULL ATTR_CTNT5" ).append("\n"); 
		query.append("                              ,(SELECT SAC_TRUNK_VVD_RLANE_FNC(SVC_ORD.BKG_NO) FROM DUAL) ATTR_CTNT6" ).append("\n"); 
		query.append("                              ,(SELECT SAC_TRUNK_VVD_TRD_FNC(SVC_ORD.BKG_NO) FROM DUAL) ATTR_CTNT7" ).append("\n"); 
		query.append("                              ,NULL ATTR_CTNT8" ).append("\n"); 
		query.append("                              ,NULL ATTR_CTNT9" ).append("\n"); 
		query.append("                              ,NULL ATTR_CTNT10" ).append("\n"); 
		query.append("                              ,TO_CHAR(NVL(NVL(SVC_ORD.DOR_NOD_PLN_DT, SVC_ORD.WO_EXE_DT), INV_WRK.LOCL_CRE_DT), 'YYYYMMDD') ATTR_CTNT11" ).append("\n"); 
		query.append("                              ,NVL(SUBSTR(SVC_ORD.FM_NOD_CD, 1, 5), (SELECT A.LOC_CD FROM MDM_ORGANIZATION A WHERE A.OFC_CD = SVC_ORD.CRE_OFC_CD)) ATTR_CTNT12" ).append("\n"); 
		query.append("                              ,NULL ATTR_CTNT13" ).append("\n"); 
		query.append("                              ,SVC_ORD.SLAN_CD ATTR_CTNT14" ).append("\n"); 
		query.append("                              ,NULL ATTR_CTNT15" ).append("\n"); 
		query.append("                              ,SVC_ORD.BKG_NO" ).append("\n"); 
		...
		query.append("                                 ,TO_CHAR(NVL(NVL(SVC_ORD.DOR_NOD_PLN_DT, SVC_ORD.WO_EXE_DT), INV_WRK.LOCL_CRE_DT), 'YYYYMMDD')" ).append("\n"); 
		query.append("                                 ,TO_CHAR(SVC_ORD.N1ST_NOD_PLN_DT, 'YYYYMMDD')" ).append("\n"); 
		...
		query.append("								 ,DECODE(SVC_ORD.BKG_NO, NULL, 'CNTC' || TO_CHAR(WRK_ORD.LOCL_CRE_DT, 'YYMM') || 'MM', SVC_ORD.FINC_VSL_CD || SVC_ORD.FINC_SKD_VOY_NO || SVC_ORD.SKD_DIR_CD || SVC_ORD.FINC_SKD_DIR_CD)" ).append("\n"); 
		query.append("                                 ,NVL(SUBS_CO_CD, '00')" ).append("\n"); 
		query.append("                                 ,LGS_CST.ACCT_CD" ).append("\n"); 
		query.append("                                 ,SVC_ORD.INV_NO" ).append("\n"); 
		query.append("                                 ,TO_CHAR(INV_WRK.INV_ISS_DT, 'YYYYMMDD')" ).append("\n"); 
		...
		query.append("                      ,NULL ATTR_CTNT4" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT5" ).append("\n"); 
		query.append("                      ,(SELECT SAC_TRUNK_VVD_RLANE_FNC(BKG_NO) FROM DUAL) ATTR_CTNT6" ).append("\n"); 
		query.append("                      ,(SELECT SAC_TRUNK_VVD_TRD_FNC(BKG_NO) FROM DUAL) ATTR_CTNT7" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT8" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT9" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT10" ).append("\n"); 
		query.append("                      ,ATTR_CTNT11" ).append("\n"); 
		...
		query.append("                  FROM (SELECT NVL(INV_DTL.INV_BZC_AMT, 0) - NVL(INV_DTL.FUEL_SCG_AMT, 0) CSR_AMT" ).append("\n"); 
		query.append("                              ,ACCT_NM.ACCT_ENG_NM INV_DESC" ).append("\n"); 
		query.append("                              ,FINC_RGN_CD DTRB_COA_RGN_CD" ).append("\n"); 
		query.append("                              ,AP_CTR_CD DTRB_COA_CTR_CD" ).append("\n"); 
		...
		query.append("                              ,TO_CHAR(NVL(SVC_ORD.WO_ISS_DT, INV_WRK.INV_ISS_DT), 'YYYYMMDD') ATTR_CTNT11" ).append("\n"); 
		query.append("                              ,NVL(SUBSTR(SVC_ORD.FM_NOD_CD, 1, 5), MDM_ORG.LOC_CD) ATTR_CTNT12" ).append("\n"); 
		query.append("                              ,SVC_ORD.SLAN_CD ATTR_CTNT14" ).append("\n"); 
		query.append("                              ,SVC_ORD.BKG_NO BKG_NO" ).append("\n"); 
		query.append("                              ,SVC_ORD.EQ_TPSZ_CD CNTR_TPSZ_CD" ).append("\n"); 
		...
		query.append("                           AND NVL(INV_HLD_FLG, 'N') = 'N'" ).append("\n"); 
		query.append("                           AND INV_WRK.DELT_FLG = 'N'" ).append("\n"); 
		query.append("                           AND 'JP' <> NVL(@[CNT_CD], ' ')" ).append("\n"); 
		query.append("                         GROUP BY INV_WRK.INV_VAT_AMT" ).append("\n"); 
		query.append("                                 ,MDM_ORG.FINC_RGN_CD" ).append("\n"); 
		query.append("                                 ,MDM_ORG.AP_CTR_CD" ).append("\n"); 
		query.append("                                 ,MDM_VNDR.SUBS_CO_CD" ).append("\n"); 
		query.append("                                 ,INV_WRK.INV_NO" ).append("\n"); 
		query.append("                                 ,TO_CHAR(INV_WRK.INV_ISS_DT, 'YYYYMMDD')" ).append("\n"); 
		...
		query.append("                              ,@[LINE_NO] LINE_NO" ).append("\n"); 
		query.append("                              ,'ITEM' LINE_TP_LU_CD" ).append("\n"); 
		query.append("                              ,DECODE(SIGN(INV_WRK.INV_WHLD_TAX_AMT), 0, 0, -(INV_WRK.INV_WHLD_TAX_AMT)) CSR_AMT" ).append("\n"); 
		...
		query.append("                                 ,INV_WRK.INV_NO" ).append("\n"); 
		query.append("                                 ,TO_CHAR(INV_WRK.INV_ISS_DT, 'YYYYMMDD')" ).append("\n"); 
		query.append("                                 ,MDM_ORG.LOC_CD) A" ).append("\n"); 
		...
		query.append("                      ,@[LINE_NO] LINE_NO" ).append("\n"); 
		query.append("                      ,'ITEM' LINE_TP_LU_CD" ).append("\n"); 
		query.append("                      ,CASE	NVL((SELECT DP_PRCS_KNT FROM MDM_CURRENCY WHERE CURR_CD = @[CURR_CD] AND NVL(DELT_FLG, 'N') = 'N'), 0) " ).append("\n"); 
		query.append("							WHEN 0 THEN ROUND(NVL(SVC_ORD.AMT, 0)) " ).append("\n"); 
		...
		query.append("                      ,AP_CTR_CD DTRB_COA_CTR_CD" ).append("\n"); 
		query.append("                      ,SVC_ORD.ACCT_CD DTRB_COA_ACCT_CD" ).append("\n"); 
		query.append("                      ,'CNTC' || SVC_ORD.CNCT || 'MM' DTRB_COA_VVD_CD" ).append("\n"); 
		query.append("                      ,NVL(SUBS_CO_CD, '00') DTRB_COA_INTER_CO_CD" ).append("\n"); 
		query.append("                      ,'000000' DTRB_COA_FTU_N1ST_CD" ).append("\n"); 
		query.append("                      ,'000000' DTRB_COA_FTU_N2ND_CD" ).append("\n"); 
		query.append("                      ,SVC_ORD.ACCT_CD ATTR_CATE_NM" ).append("\n"); 
		...
		query.append("                      ,NULL ATTR_CTNT9" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT10" ).append("\n"); 
		query.append("                      ,TO_CHAR(NVL(SVC_ORD.HNDL_PRD_FM_DT, INV_WRK.INV_ISS_DT), 'YYYYMMDD') ATTR_CTNT11" ).append("\n"); 
		query.append("                      ,(SELECT A.LOC_CD FROM MDM_ORGANIZATION A WHERE SVC_ORD.CRE_OFC_CD = A.OFC_CD) ATTR_CTNT12" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT13" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT14" ).append("\n"); 
		query.append("                      ,NULL ATTR_CTNT15" ).append("\n"); 
		query.append("                      ,'' BKG_NO" ).append("\n"); 
		query.append("                      ,SVC_ORD.EQ_TPSZ_CD CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                      ,'CNTC' || SVC_ORD.CNCT || 'MM' ACT_VVD_CD" ).append("\n"); 
		query.append("                      ,'C' PLN_SCTR_DIV_CD" ).append("\n"); 
		query.append("                      ,NULL SO_CRR_CD" ).append("\n"); 
		query.append("                      ,NULL YD_CD" ).append("\n"); 
		query.append("                      ,SVC_ORD.LGS_COST_CD FTU_USE_CTNT1" ).append("\n"); 
		...
		query.append("                  FROM TRS_TRSP_INV_WRK INV_WRK" ).append("\n"); 
		query.append("                      ,MDM_ACCOUNT ACCT_NM" ).append("\n"); 
		query.append("                      ,(SELECT CNCT" ).append("\n"); 
		query.append("                              ,CASE	WHEN TRSP_COST_DTL_MOD_CD IN ('ER', 'CN', 'CF') THEN '512362'" ).append("\n"); 
		query.append("                                 	ELSE '512361'" ).append("\n"); 
		query.append("                               END ACCT_CD" ).append("\n"); 
		query.append("                              ,'TR' " ).append("\n"); 
		query.append("								|| CASE WHEN TRSP_COST_DTL_MOD_CD IN ('ER', 'CN', 'CF') THEN 'MX' ELSE 'FX' END " ).append("\n"); 
		query.append("								|| DECODE(TRSP_CRR_MOD_CD, 'TR', 'RT', 'RW', 'WR', 'TW', 'WT', TRSP_CRR_MOD_CD) LGS_COST_CD" ).append("\n"); 
		query.append("                              ,INV_NO" ).append("\n"); 
		query.append("                              ,INV_VNDR_SEQ" ).append("\n"); 
		query.append("                              ,EQ_TPSZ_CD" ).append("\n"); 
		query.append("                              ,MIN(HNDL_PRD_FM_DT) HNDL_PRD_FM_DT" ).append("\n"); 
		query.append("                              ,SUM(TRSP_RFND_QTY) CNT" ).append("\n"); 
		query.append("                              ,SUM(AMT) AMT" ).append("\n"); 
		query.append("                              ,CRE_OFC_CD" ).append("\n"); 
		query.append("                          FROM (SELECT CNCT" ).append("\n"); 
		...
		query.append("                                      ,DECODE(BASIS_AXLE_NO, 0, AMT + NVL(CSR_RFND_CORR_AMT, 0), AMT) AMT" ).append("\n"); 
		query.append("                                      ,CRE_OFC_CD" ).append("\n"); 
		query.append("                                      ,TRSP_COST_DTL_MOD_CD" ).append("\n"); 
		query.append("                                      ,TRSP_CRR_MOD_CD" ).append("\n"); 
		query.append("                                  FROM (SELECT BASIS_AXLE_NO" ).append("\n"); 
		query.append("                                              ,TO_CHAR(ADD_MONTHS(HNDL_PRD_FM_DT, BASIS_AXLE_NO), 'YYMM') CNCT" ).append("\n"); 
		query.append("                                              ,HNDL_PRD_FM_DT" ).append("\n"); 
		query.append("                                              ,HNDL_PRD_TO_DT" ).append("\n"); 
		query.append("                                              ,INV_NO" ).append("\n"); 
		query.append("                                              ,INV_VNDR_SEQ" ).append("\n"); 
		query.append("                                              ,EQ_TPSZ_CD" ).append("\n"); 
		query.append("                                              ,TRSP_RFND_QTY" ).append("\n"); 
		query.append("                                              ,TRSP_RFND_INV_AMT / RFND_MON_KNT AMT" ).append("\n"); 
		query.append("                                              ,CSR_RFND_CORR_AMT" ).append("\n"); 
		query.append("                                              ,CRE_OFC_CD" ).append("\n"); 
		query.append("                                              ,TRSP_COST_DTL_MOD_CD" ).append("\n"); 
		query.append("                                              ,TRSP_CRR_MOD_CD" ).append("\n"); 
		query.append("                                          FROM (SELECT TO_NUMBER(CEIL(MONTHS_BETWEEN(TO_DATE(TO_CHAR(HNDL_PRD_TO_DT, 'YYYYMM'), 'YYYYMM'), TO_DATE(TO_CHAR(HNDL_PRD_FM_DT, 'YYYYMM'), 'YYYYMM')))) + 1 RFND_MON_KNT" ).append("\n"); 
		query.append("                                                      ,HNDL_PRD_FM_DT" ).append("\n"); 
		query.append("                                                      ,HNDL_PRD_TO_DT" ).append("\n"); 
		query.append("                                                      ,INV_NO" ).append("\n"); 
		query.append("                                                      ,INV_VNDR_SEQ" ).append("\n"); 
		query.append("                                                      ,EQ_TPSZ_CD" ).append("\n"); 
		query.append("                                                      ,TRSP_RFND_QTY" ).append("\n"); 
		query.append("                                                      ,TRSP_RFND_INV_AMT TRSP_RFND_INV_AMT" ).append("\n"); 
		query.append("                                                      ,CSR_RFND_CORR_AMT" ).append("\n"); 
		query.append("                                                      ,CRE_OFC_CD" ).append("\n"); 
		query.append("                                                      ,TRSP_COST_DTL_MOD_CD" ).append("\n"); 
		query.append("                                                      ,TRSP_CRR_MOD_CD" ).append("\n"); 
		...
		query.append("                                                   AND INV_VNDR_SEQ = @[INV_VNDR_SEQ]) REFD" ).append("\n"); 
		query.append("                                              ,(SELECT CPY_NO BASIS_AXLE_NO FROM COM_CPY_NO WHERE CPY_NO < 50) A" ).append("\n"); 
		query.append("                                         WHERE BASIS_AXLE_NO < RFND_MON_KNT)) SVC_ORD" ).append("\n"); 
		query.append("                         GROUP BY CNCT" ).append("\n"); 
		query.append("                                 ,INV_NO" ).append("\n"); 
		query.append("                                 ,INV_VNDR_SEQ" ).append("\n"); 
		query.append("                                 ,EQ_TPSZ_CD" ).append("\n"); 
		query.append("                                 ,CRE_OFC_CD" ).append("\n"); 
		query.append("                                 ,TRSP_COST_DTL_MOD_CD" ).append("\n"); 
		query.append("                                 ,TRSP_CRR_MOD_CD) SVC_ORD" ).append("\n"); 
		query.append("                      ,MDM_ORGANIZATION MDM_ORG" ).append("\n"); 
		query.append("                      ,MDM_VENDOR MDM_VNDR" ).append("\n"); 
		query.append("                 WHERE ACCT_NM.ACCT_CD = SVC_ORD.ACCT_CD" ).append("\n"); 
		query.append("                   AND INV_WRK.INV_NO = SVC_ORD.INV_NO" ).append("\n"); 
		...
		query.append("                              ,@[LINE_NO] LINE_NO" ).append("\n"); 
		query.append("                              ,'ITEM' LINE_TP_LU_CD" ).append("\n"); 
		query.append("                              ,INV_WRK.INV_WHLD_TAX_AMT * (-1) * (-1) CSR_AMT" ).append("\n"); 
		query.append("                              ,'WITHHOLDING TAX' INV_DESC" ).append("\n"); 
		query.append("                              ,'' INV_TAX_CD" ).append("\n"); 
		query.append("                              ,'01' DTRB_COA_CO_CD" ).append("\n"); 
		query.append("                              ,MDM_ORG.FINC_RGN_CD DTRB_COA_RGN_CD" ).append("\n"); 
		...
		query.append("                      ,@[LINE_NO] LINE_NO" ).append("\n"); 
		query.append("                      ,'ITEM' LINE_TP_LU_CD" ).append("\n"); 
		query.append("                      ,CASE NVL((SELECT DP_PRCS_KNT FROM MDM_CURRENCY WHERE CURR_CD = @[CURR_CD]  AND NVL(DELT_FLG, 'N') = 'N'), 0) WHEN 0 THEN ROUND(NVL(SVC_ORD.AMT, 0)) ELSE ROUND(NVL(SVC_ORD.AMT, 0), 2) END CSR_AMT" ).append("\n"); 
		query.append("                      ,ACCT_NM.ACCT_ENG_NM INV_DESC" ).append("\n"); 
		query.append("                      ,'' INV_TAX_CD" ).append("\n"); 
		query.append("                      ,'01' DTRB_COA_CO_CD" ).append("\n"); 
		query.append("                      ,FINC_RGN_CD DTRB_COA_RGN_CD" ).append("\n"); 
		...
		query.append("                         GROUP BY INV_NO" ).append("\n"); 
		query.append("                                 ,INV_VNDR_SEQ" ).append("\n"); 
		query.append("                                 ,CRE_OFC_CD) SVC_ORD" ).append("\n"); 
		query.append("                      ,MDM_ORGANIZATION MDM_ORG" ).append("\n"); 
		query.append("                      ,MDM_VENDOR MDM_VNDR" ).append("\n"); 
		query.append("                 WHERE ACCT_NM.ACCT_CD = SVC_ORD.ACCT_CD" ).append("\n"); 
		query.append("                   AND INV_WRK.INV_NO = SVC_ORD.INV_NO" ).append("\n"); 
		...
		query.append("                      ,NULL CGO_TP_CD" ).append("\n"); 
		query.append("                      ,NULL EQ_KND_CD" ).append("\n"); 
		query.append("                  FROM (SELECT NVL(INV_DTL.FUEL_SCG_AMT, 0) CSR_AMT" ).append("\n"); 
