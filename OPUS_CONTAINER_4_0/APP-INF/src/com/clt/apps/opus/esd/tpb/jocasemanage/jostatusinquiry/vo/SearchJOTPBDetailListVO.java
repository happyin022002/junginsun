...
*@FileName : SearchJOTPBDetailListVO.java
*@FileTitle : SearchJOTPBDetailListVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esd.tpb.jocasemanage.jostatusinquiry.vo;
...
public class SearchJOTPBDetailListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchJOTPBDetailListVO> models = new ArrayList<SearchJOTPBDetailListVO>();
	 ...
	 */
	public SearchJOTPBDetailListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchJOTPBDetailListVO[]
	 */
	public SearchJOTPBDetailListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchJOTPBDetailListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchJOTPBDetailListVO();
				if (ifDt[i] != null)
		...
		return getSearchJOTpbDetailListVOs();
	}
	...
	public SearchJOTPBDetailListVO[] getSearchJOTpbDetailListVOs(){
		SearchJOTPBDetailListVO[] vos = (SearchJOTPBDetailListVO[])models.toArray(new SearchJOTPBDetailListVO[models.size()]);
		return vos;
	}
