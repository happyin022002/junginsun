...
*@FileName : CSRIssueTransferSlipManageDBDAOSearchApInvIfForEAIInterfaceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOSearchApInvIfForEAIInterfaceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CSR 결재시 I/F를 위해 eai에 던져주는 DATA
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOSearchApInvIfForEAIInterfaceRSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOSearchApInvIfForEAIInterfaceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("'ESDTRSXXX'||TO_CHAR(sysdate, 'yyyymmdd')  as AP_PGM_NO," ).append("\n"); 
		query.append("B.LINE_NO+B.LINE_SEQ as INV_SEQ," ).append("\n"); 
