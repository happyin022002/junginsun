...
*@FileName : AgreementCorrectionDBDAOSearchCorrRateAgmtTotRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAOSearchCorrRateAgmtTotRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Rate 총계 조회
	  * </pre>
	  */
	public AgreementCorrectionDBDAOSearchCorrRateAgmtTotRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAOSearchCorrRateAgmtTotRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
