...
public class InvoiceAuditDBDAOConfirmInvoiceAuditUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,CRE_USR_ID          = DECODE(@[if_sys_knd_cd], 'W', @[FORM_CRE_USR_ID], CRE_USR_ID)" ).append("\n"); 
		query.append("      ,CRE_DT              = DECODE(@[if_sys_knd_cd], 'W', GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[FORM_USR_OFC_CD]), CRE_DT )" ).append("\n"); 
