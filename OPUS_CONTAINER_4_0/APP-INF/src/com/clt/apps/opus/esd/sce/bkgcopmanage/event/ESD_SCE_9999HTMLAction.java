...
*@FileName : ESD_SCE_9999HTMLAction.java
...
public class ESD_SCE_9999HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SCE_9999HTMLAction 객체를 생성
	 */
	public ESD_SCE_9999HTMLAction() {}
...
//		String userId = account.getUsr_id();     
		...
		EsdSce9999Event event = new EsdSce9999Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setSceCopHdrVOS((SceCopHdrVO[])getVOs(request, SceCopHdrVO.class));
			
			event.setSceActTmlIfDtlVOs((SceActTmlRtvVO[])getVOs(request, SceActTmlRtvVO.class));
