...
*@FileName : TESCommonDBDAOSearchAgmtCostCodeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESCommonDBDAOSearchAgmtCostCodeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESCommonDBDAOSearchAgmtCostCodeListRSQL(){
		setQuery();
		...
		query.append("FileName : TESCommonDBDAOSearchAgmtCostCodeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COST_CODE --, COST_CODE COST_CODE_TXT" ).append("\n"); 
