...
public class AdjustmentManageDBDAOSearchWriteOffInquiryRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   AND (A.STL_RQST_OFC_CD IN ( SELECT DISTINCT OFC_CD" ).append("\n"); 
		query.append("                                 FROM TPB_HNDL_OFC" ).append("\n"); 
		query.append("                                WHERE 1=1 AND DELT_FLG = 'N'" ).append("\n"); 
		query.append("                               #if(${s_user_ofc_cd} == ${head_ofc_cd})" ).append("\n"); 
		query.append("                                  AND (RHQ_CD = @[s_if_rhq_cd] OR OFC_CD = @[s_if_ofc_cd] OR N3PTY_CTRL_OFC_CD = @[s_if_ctrl_cd])" ).append("\n"); 
		query.append("                                   OR RHQ_CD = (SELECT OFC_CD FROM TPB_HNDL_OFC WHERE N3PTY_OFC_TP_CD = 'R'  AND DELT_FLG = 'N' AND OFC_CD = @[s_user_ofc_cd])" ).append("\n"); 
		query.append("                               #end " ).append("\n"); 
		query.append("							  )" ).append("\n"); 
		query.append("    OR A.STL_RQST_OFC_CD = @[s_if_ofc_cd] ) -- ROC Out All" ).append("\n"); 
		query.append("   AND A.STL_RQST_OFC_CD IN ( SELECT DISTINCT OFC_CD" ).append("\n"); 
		query.append("                                FROM TPB_HNDL_OFC" ).append("\n"); 
		query.append("                               WHERE 1=1  AND DELT_FLG = 'N'" ).append("\n"); 
		query.append("                              #if(${s_user_ofc_cd} == ${head_ofc_cd})" ).append("\n"); 
		...
		query.append("   --(G.OFC_CD IN ( SELECT OFC_CD FROM TP ) OR G.OFC_CD = @[s_if_ofc_cd]) -- ROC In All " ).append("\n"); 
		query.append("   AND G.OFC_CD IN ( SELECT DISTINCT OFC_CD" ).append("\n"); 
		query.append("                       FROM TPB_HNDL_OFC" ).append("\n"); 
		query.append("                      WHERE 1=1 AND DELT_FLG = 'N'" ).append("\n"); 
		query.append("                     #if(${s_user_ofc_cd} == ${head_ofc_cd})" ).append("\n"); 
		query.append("                        AND (RHQ_CD = @[s_if_rhq_cd] OR OFC_CD = @[s_if_ofc_cd] OR N3PTY_CTRL_OFC_CD = @[s_if_ctrl_cd])" ).append("\n"); 
		...
		query.append("		#if (${s_date_flag_i} == 'OL' || ${s_date_flag_i} == 'OA' || ${s_date_flag_i} == 'OR')" ).append("\n"); 
		query.append("			AND A.STL_RQST_OFC_CD IN (SELECT OFC_CD FROM TPB_HNDL_OFC WHERE N3PTY_CTRL_OFC_CD = @[s_if_ctrl_cd] AND DELT_FLG = 'N')" ).append("\n"); 
		query.append("		#elseif (${s_date_flag_i} == 'IL' || ${s_date_flag_i} == 'IA' || ${s_date_flag_i} == 'IR')" ).append("\n"); 
		query.append("			AND A.STL_TO_CLT_CNG_OFC_CD IN (SELECT OFC_CD FROM TPB_HNDL_OFC WHERE N3PTY_CTRL_OFC_CD = @[s_if_ctrl_cd] AND DELT_FLG = 'N')" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	#if (${s_if_rhq_cd} != '')" ).append("\n"); 
		query.append("		#if (${s_date_flag_i} == 'OL' || ${s_date_flag_i} == 'OA' || ${s_date_flag_i} == 'OR')" ).append("\n"); 
		query.append("			AND A.STL_RQST_OFC_CD IN (SELECT OFC_CD FROM TPB_HNDL_OFC WHERE RHQ_CD = @[s_if_rhq_cd] AND DELT_FLG = 'N')" ).append("\n"); 
		query.append("		#elseif (${s_date_flag_i} == 'IL' || ${s_date_flag_i} == 'IA' || ${s_date_flag_i} == 'IR')" ).append("\n"); 
		query.append("			AND A.STL_TO_CLT_CNG_OFC_CD IN (SELECT OFC_CD FROM TPB_HNDL_OFC WHERE RHQ_CD = @[s_if_rhq_cd] AND DELT_FLG = 'N')" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
