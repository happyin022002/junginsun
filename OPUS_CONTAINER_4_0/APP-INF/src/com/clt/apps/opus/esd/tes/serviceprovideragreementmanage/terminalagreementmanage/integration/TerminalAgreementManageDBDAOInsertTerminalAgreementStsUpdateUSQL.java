...
*@FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementStsUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertTerminalAgreementStsUpdateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertTerminalAgreementStsUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementStsUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("tml_agmt_sts_cd = 'Y'" ).append("\n"); 
