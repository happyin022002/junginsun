...
*@FileName : TESCommonDBDAOSearchInvoiceDupYNRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESCommonDBDAOSearchInvoiceDupYNRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice Duplication YN
	  * </pre>
	  */
	public TESCommonDBDAOSearchInvoiceDupYNRSQL(){
		setQuery();
		...
		query.append("FileName : TESCommonDBDAOSearchInvoiceDupYNRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(B.ATTR_CTNT1), 0, 'N', 'Y') AS INV_DUP_YN " ).append("\n"); 
