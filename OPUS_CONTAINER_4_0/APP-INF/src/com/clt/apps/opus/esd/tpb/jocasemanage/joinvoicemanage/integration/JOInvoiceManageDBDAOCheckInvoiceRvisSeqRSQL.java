...
*@FileName : JOInvoiceManageDBDAOCheckInvoiceRvisSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOInvoiceManageDBDAOCheckInvoiceRvisSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TPB_INV_RVIS 테이블 N3PTY_INV_RVIS_SEQ 컬럼 정보 Validation Check
	  * </pre>
	  */
	public JOInvoiceManageDBDAOCheckInvoiceRvisSeqRSQL(){
		setQuery();
		...
		query.append("FileName : JOInvoiceManageDBDAOCheckInvoiceRvisSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
