...
import com.clt.apps.opus.esd.tes.serviceproviderinvoicemanage.offdockcyinvoicemanage.integration.OffdockCYInvoiceManageDBDAOSearchOffdockCYTableMaxSeqRSQL;
...
public class MarineTerminalStorageInvoiceManageDBDAO extends DBDAOSupport {
	 ...
	 * @throws DAOException
	 */
	public DBRowSet calStorageInvoiceCost(TesTmlSoHdrVO model, String agmtCostYN) throws DAOException {
		DBRowSet dbRowset = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
...
//	}
	...
	/**
	 * 9142 Search CNTR TYPE CD List<br>
	 * 
