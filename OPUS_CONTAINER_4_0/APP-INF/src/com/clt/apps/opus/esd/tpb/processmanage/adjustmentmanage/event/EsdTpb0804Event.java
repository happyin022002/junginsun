...
public class EsdTpb0804Event extends EventSupport {
	...
	public SearchROCToOfficeListVO[] getSearchROCToOfficeListVOs() {
		SearchROCToOfficeListVO[] rtnVOs = null;
		if (this.searchROCToOfficeListVOs != null) {
			rtnVOs = Arrays.copyOf(searchROCToOfficeListVOs, searchROCToOfficeListVOs.length);
		}
		return rtnVOs;
	}

	public void setSearchROCToOfficeListVOs(SearchROCToOfficeListVO[] searchROCToOfficeListVOs){
		if(searchROCToOfficeListVOs != null){
			SearchROCToOfficeListVO[] tmpVOs = Arrays.copyOf(searchROCToOfficeListVOs, searchROCToOfficeListVOs.length);
			this.searchROCToOfficeListVOs = tmpVOs;
		}
	}
