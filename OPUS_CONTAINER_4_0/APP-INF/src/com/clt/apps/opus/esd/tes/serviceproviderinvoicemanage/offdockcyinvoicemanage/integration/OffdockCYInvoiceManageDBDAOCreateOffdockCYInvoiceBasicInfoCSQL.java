...
*@FileName : OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceBasicInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceBasicInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateOffdockCYInvoiceBasicInfo
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceBasicInfoCSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceBasicInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TML_ODCK_FLG		  ," ).append("\n"); 
		...
		query.append(", @[vat_amt]" ).append("\n"); 
		query.append(", @[ttl_calc_amt]" ).append("\n"); 
		query.append(", SUBSTR(REPLACE(@[fm_prd_dt],'-'),0,8)" ).append("\n"); 
		query.append(", @[hld_flg]" ).append("\n"); 
		query.append(", @[hld_rmk]" ).append("\n"); 
		query.append(", SUBSTR(REPLACE(@[to_prd_dt],'-'),0,8)" ).append("\n"); 
		query.append(", @[tml_inv_tp_cd]" ).append("\n"); 
		query.append(", @[tml_cost_grp_cd]" ).append("\n"); 
		query.append(", @[tml_calc_ind_cd]" ).append("\n"); 
		query.append(", @[sto_dys_ind_cd]" ).append("\n"); 
