...
*@FileName : ESD_TRS_935HTMLAction.java
...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.trs.common.refercargodetailinquiry.event;
 ...
 * - Parsing 한 정보를 Event로 변환, request에 담아 ESD_TRS_0935SC로 실행요청<br>
 * - ESD_TRS_0935SC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 *
 * @author juhyun
 * @see EsdTrs0935Event 참조
 * @since J2EE 1.4
 */
public class ESD_TRS_0935HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESD_TRS_935HTMLAction 객체를 생성
	 */
	public ESD_TRS_0935HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TRS_935Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0935Event event = new EsdTrs0935Event();
