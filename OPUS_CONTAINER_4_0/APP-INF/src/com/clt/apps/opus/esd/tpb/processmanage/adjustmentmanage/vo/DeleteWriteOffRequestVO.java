...
public class DeleteWriteOffRequestVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DeleteWriteOffRequestVO> models = new ArrayList<DeleteWriteOffRequestVO>();
	...
	public DeleteWriteOffRequestVO() {}

	public DeleteWriteOffRequestVO(String ibflag, String pagerows, String sN3ptyNo, String n3ptyNo, String sUserOfcCd, String sUserId) {
		this.ibflag = ibflag;
	 ...
	 */
	public DeleteWriteOffRequestVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DeleteResponsibleOfficeChangeRequestVO[]
	 */
	public DeleteWriteOffRequestVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DeleteWriteOffRequestVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new DeleteWriteOffRequestVO();
				if (ibflag[i] != null)
	 ...
	 * @return DeleteResponsibleOfficeChangeRequestVO[]
	 */
	public DeleteWriteOffRequestVO[] getDeleteResponsibleOfficeChangeRequestVOs(){
		DeleteWriteOffRequestVO[] vos = (DeleteWriteOffRequestVO[])models.toArray(new DeleteWriteOffRequestVO[models.size()]);
		return vos;
	}
