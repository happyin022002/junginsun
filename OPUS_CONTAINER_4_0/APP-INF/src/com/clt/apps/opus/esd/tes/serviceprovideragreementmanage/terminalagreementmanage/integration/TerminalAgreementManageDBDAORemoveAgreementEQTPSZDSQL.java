...
*@FileName : TerminalAgreementManageDBDAORemoveAgreementEQTPSZDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAORemoveAgreementEQTPSZDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAORemoveAgreementEQTPSZDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAORemoveAgreementEQTPSZDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM  TES_TML_AGMT_EQ_TP_SZ " ).append("\n"); 
