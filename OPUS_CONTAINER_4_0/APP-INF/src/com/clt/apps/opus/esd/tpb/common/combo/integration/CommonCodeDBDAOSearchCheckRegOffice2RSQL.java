...
*@FileName : CommonCodeDBDAOSearchCheckRegOffice2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonCodeDBDAOSearchCheckRegOffice2RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CommonCodeDBDAO.SearchCheckRegOffice2
	  * </pre>
	  */
	public CommonCodeDBDAOSearchCheckRegOffice2RSQL(){
		setQuery();
		...
		query.append("FileName : CommonCodeDBDAOSearchCheckRegOffice2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("#if (${s_n3pty_ofc_tp_cd} == 'G' || ${s_n3pty_ofc_tp_cd} == 'T')" ).append("\n"); 
