...
package com.clt.apps.opus.esd.sce.edi324send.basic;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import com.clt.apps.opus.esd.sce.edi324send.integration.Edi324SendDBDAO;
import com.clt.apps.opus.esd.sce.edi324send.integration.Edi324SendEAIDAO;
...
import com.clt.syscommon.common.table.SceEdi324SndRsltVO;
...
//				log.debug("====EDI_SND_ID ===" + edi_snd_id+ "\n");
			...
			//	sceEdi324SndRslt.setEdiSndId(edi_snd_id);
				...
				// 2015-02-09 추가
				sceEdi324SndRslt.setDestYdNm(detail_info[23]); // DESTINATION YARD NAME
      		    ...
      		    for (int j = 0 ; j <sceEdi324SndrsltVo.size() ; j++ ){
             	  if (list1.get(m).getVslCd().equals(sceEdi324SndrsltVo.get(j).getVslCd()) 
					  ...
					  cntr_info = cntr_info + "{CNTR_INFO " +  CHR10
						...
						+ "DSTNAME:"      	  + sceEdi324SndrsltVo.get(j).getDestYdNm() 		+ CHR10
...
//					+ "HANJIN"	+ CHR10					;
    ...
    private HashMap<String,String> getSNDSEQ() throws EventException{
		try {
			...
			//REFERENCE NUMBER 변경 IGKIM 20150114  SCE_FLT_FILE_NO_GEN_SEQ1
