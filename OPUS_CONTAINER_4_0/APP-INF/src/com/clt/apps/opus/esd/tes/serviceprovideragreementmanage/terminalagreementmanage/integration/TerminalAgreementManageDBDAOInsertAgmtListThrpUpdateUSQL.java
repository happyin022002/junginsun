...
*@FileName : TerminalAgreementManageDBDAOInsertAgmtListThrpUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertAgmtListThrpUpdateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Throughput Cost Update
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertAgmtListThrpUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertAgmtListThrpUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE	TES_TML_AGMT_DTL SET" ).append("\n"); 
		query.append("thrp_cost_cd_flg	= 'Y'" ).append("\n"); 
