...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.trs.servicesio.sppcomplement.railbillingverifymanage.basic;
...
import com.clt.apps.opus.esd.trs.servicesio.sppcomplement.railbillingverifymanage.integration.RailBillingVerifyManageDBDAO;
		    ...
		    // WRS MTY Railbilling 일 경우	
				...
				for(Iterator itr2 = models2.iterator();	itr2.hasNext();) {
					...
					if ( railbillingverifyList.getErr_msg_cd() != null &&  railbillingverifyList.getErr_msg_cd().equals( "TRS00050") ) {
						...
						eqr_overplan_al =  command.inlandWrsTrsSOIF(currdt, eqr_fmnd, eqr_tond, "R", eqr_tpsz, 1,repo_pln_id,pln_yrwk, ref_id);
