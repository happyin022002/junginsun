...
*@FileName : ESD_TES_905HTMLAction.java
 ...
 *
 * @author byungheeyoo
 * @see EsdTes9050Event 참조
 * @since J2EE 1.4
 */
public class ESD_TES_9050HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_905HTMLAction 객체를 생성
	 */
	public ESD_TES_9050HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_9050Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes9050Event event = new EsdTes9050Event();
