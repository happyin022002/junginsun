...
*@FileName : WorkOrderManagementDBDAOModifyWorkOrderExecuteDateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderManagementDBDAOModifyWorkOrderExecuteDateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyWorkOrderExecuteDate
	  * </pre>
	  */
	public WorkOrderManagementDBDAOModifyWorkOrderExecuteDateUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderManagementDBDAOModifyWorkOrderExecuteDateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		SO.WO_EXE_DT       	= (CASE WHEN SO.TRSP_SO_TP_CD = 'Y' AND SO.TRSP_COST_DTL_MOD_CD <> 'DR' AND @[node_cd] = SO.FM_NOD_CD AND @[mvmt_sts_cd] IN ('EN','TN','OP','ID') THEN TO_DATE(@[wo_exe_dt], 'YYYYMMDDHH24MI')" ).append("\n"); 
		...
		query.append("							   END) ," ).append("\n"); 
		query.append("		SO.TRS_SUB_STS_CD  	= (CASE WHEN @[mvmt_sts_cd] IN ('EN','TN','OP','ID') AND @[node_cd] = SO.FM_NOD_CD THEN 'ST'" ).append("\n"); 
