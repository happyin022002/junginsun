...
*@FileName : OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagSearchRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagSearchRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateOffdockDetailN3rdFlagSearch
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagSearchRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagSearchRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
