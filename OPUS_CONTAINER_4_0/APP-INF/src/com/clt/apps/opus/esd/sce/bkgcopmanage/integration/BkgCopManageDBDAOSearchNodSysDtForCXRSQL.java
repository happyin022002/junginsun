...
public class BkgCopManageDBDAOSearchNodSysDtForCXRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("TO_CHAR( GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(), sysdate, substr(NOD_CD,1,5)), 'YYYYMMDDHH24MISS' ) AS ACT_DT" ).append("\n"); 
