...
public class IrregularManageDBDAOSearchIrregularHdrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		, TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC((SELECT OFC_CD FROM TABLE (COM_OfficeCodeMgr_PKG.COM_getOfficeCodeList_FNC('000001', 'TES'))), IH.CRE_DT, IH.OFC_CD), 'YYYY-MM-DD') CRE_DT" ).append("\n"); 
		query.append("		, IH.UPD_USR_ID" ).append("\n"); 
		query.append("		, TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC((SELECT OFC_CD FROM TABLE (COM_OfficeCodeMgr_PKG.COM_getOfficeCodeList_FNC('000001', 'TES'))), IH.UPD_DT, IH.OFC_CD), 'YYYY-MM-DD') UPD_DT" ).append("\n"); 
		query.append("		, GH.DEPT_NO" ).append("\n"); 
		query.append("		, NVL(GH.DMY_FLG,'N') AS DMY_FLG" ).append("\n"); 
