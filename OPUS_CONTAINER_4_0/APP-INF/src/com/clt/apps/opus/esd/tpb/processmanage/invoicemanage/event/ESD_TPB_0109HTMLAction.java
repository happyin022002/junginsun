...
*@FileName : ESD_TPB_0109HTMLAction.java
...
public class ESD_TPB_0109HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0109HTMLAction 객체를 생성
	 */
	public ESD_TPB_0109HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0109Event event = new EsdTpb0109Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchInvoiceSettingVOS((SearchInvoiceSettingVO[])getVOs(request, SearchInvoiceSettingVO .class,""));
		}
