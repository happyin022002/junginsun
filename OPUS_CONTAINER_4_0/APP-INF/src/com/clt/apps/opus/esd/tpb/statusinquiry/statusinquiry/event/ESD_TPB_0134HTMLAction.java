...
*@FileName : ESD_TPB_0116HTMLAction.java
...
public class ESD_TPB_0134HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0134HTMLAction 객체를 생성
	 */
	public ESD_TPB_0134HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0134Event event = new EsdTpb0134Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchStatusByTPBBKGVOS((SearchStatusByTPBBKGVO[])getVOs(request, SearchStatusByTPBBKGVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchStatusByTPBBKGVO((SearchStatusByTPBBKGVO)getVO(request, SearchStatusByTPBBKGVO .class));
		}
