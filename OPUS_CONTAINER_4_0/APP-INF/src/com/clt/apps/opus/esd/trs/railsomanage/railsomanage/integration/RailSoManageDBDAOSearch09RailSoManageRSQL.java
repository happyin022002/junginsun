...
public class RailSoManageDBDAOSearch09RailSoManageRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    SUBSTR(Z.REF_NO, 1, LENGTH(Z.REF_NO)-2) REF_NO," ).append("\n"); 
		query.append("   (SELECT CASE WHEN MIN(ORD.CRE_DT) + 15 >= SYSDATE THEN  'Y' END" ).append("\n"); 
		query.append("	  FROM TRS_TRSP_RAIL_BIL_ORD ORD" ).append("\n"); 
		query.append("	 WHERE ((ORD.EQ_NO = X.CNTR_NO AND ORD.CGO_TP_CD = 'F' AND ORD.TRSP_BND_CD = 'O') OR (ORD.EQ_NO = X.CNTR_NO AND ORD.CGO_TP_CD = 'M'))" ).append("\n"); 
		...
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 1, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) ||" ).append("\n"); 
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 2, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) ||" ).append("\n"); 
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 3, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) ||" ).append("\n"); 
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 4, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) ||" ).append("\n"); 
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 5, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) ||" ).append("\n"); 
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 6, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) ||" ).append("\n"); 
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 7, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) ||" ).append("\n"); 
		query.append("            MAX( DECODE( DTL.TRSP_MOD_CD, 'RD', DECODE( DTL.ROUT_DTL_SEQ, 8, NVL( AGMT.AGMT_REF_NO, 'N/A')||' / ' ) ) ) REF_NO" ).append("\n"); 
		query.append("    	FROM " ).append("\n"); 
		...
		query.append("		AND   DTL.TRSP_AGMT_OFC_CTY_CD = AGMT.TRSP_AGMT_OFC_CTY_CD(+)" ).append("\n"); 
		query.append("		AND   DTL.TRSP_AGMT_SEQ =AGMT.TRSP_AGMT_SEQ(+)" ).append("\n"); 
		...
		query.append("	Z.INLND_ROUT_RMK, " ).append("\n"); 
		query.append("	NVL(Z.ROUT_DTL_SEQ, 0) ROUT_DTL_SEQ," ).append("\n"); 
		query.append("    SUBSTR(Z.REF_NO, 1, LENGTH(Z.REF_NO)-2) AGMT_REF_NO," ).append("\n"); 
		query.append("   (SELECT CASE WHEN MIN(ORD.CRE_DT) + 15 >= SYSDATE THEN  'Y' END" ).append("\n"); 
		query.append("	  FROM TRS_TRSP_RAIL_BIL_ORD ORD" ).append("\n"); 
		query.append("	 WHERE ((ORD.EQ_NO = X.CNTR_NO AND ORD.CGO_TP_CD = 'F' AND ORD.TRSP_BND_CD = 'O') OR (ORD.EQ_NO = X.CNTR_NO AND ORD.CGO_TP_CD = 'M'))" ).append("\n"); 
		query.append("		 AND NVL(ORD.DELT_FLG, 'N') = 'N'" ).append("\n"); 
