...
*@FileName : ESD_TES_0079HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 *
 * @author jongbaemoon
 * @see EsdTes0079Event , ESD_TES_079EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0079HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TES_079HTMLAction 객체를 생성
	 */
	public ESD_TES_0079HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_079Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes0079Event event = new EsdTes0079Event();		
