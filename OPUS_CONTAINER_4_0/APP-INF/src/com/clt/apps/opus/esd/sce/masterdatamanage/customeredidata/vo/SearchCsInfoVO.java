...
*@FileName : SearchCsInfoVO.java
*@FileTitle : SearchCsInfoVO
*Open Issues :
*Change history :
...
public class SearchCsInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchCsInfoVO> models = new ArrayList<SearchCsInfoVO>();
	...
	public SearchCsInfoVO() {}

	public SearchCsInfoVO(String ibflag, String pagerows, String csGrpId, String tpId, String csDesc, String ediSts) {
		this.ediSts = ediSts;
		this.ibflag = ibflag;
		this.csDesc = csDesc;
		this.tpId = tpId;
	 ...
	 * @param request
	 * @return SearchCsInfoVO[]
	 */
	public SearchCsInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCsInfoVO[]
	 */
	public SearchCsInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchCsInfoVO model = null;
	 ...
	 * @return SearchCsInfoVO[]
	 */
	public SearchCsInfoVO[] getSearchCsInfoVOs(){
		SearchCsInfoVO[] vos = (SearchCsInfoVO[])models.toArray(new SearchCsInfoVO[models.size()]);
		return vos;
	}
