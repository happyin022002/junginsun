...
public class EsdTrs0046Event extends EventSupport {
	...
	public TrsTrspRailInvWrkVO[] getTrsTrspRailInvWrkVOs() {
		TrsTrspRailInvWrkVO[] rtnVOs = null;
		if (this.trsTrspRailInvWrkVOs != null) {
			rtnVOs = Arrays.copyOf(this.trsTrspRailInvWrkVOs, this.trsTrspRailInvWrkVOs.length);
		} // end if
		return rtnVOs;
	}
	public void setTrsTrspRailInvWrkVOs(TrsTrspRailInvWrkVO[] trsTrspRailInvWrkVOs) {
		if (trsTrspRailInvWrkVOs != null) {
			TrsTrspRailInvWrkVO[] tmpVOs = Arrays.copyOf(trsTrspRailInvWrkVOs, trsTrspRailInvWrkVOs.length);
			this.trsTrspRailInvWrkVOs = tmpVOs;
		} // end if
	}
