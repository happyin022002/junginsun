...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.trs.common.actualcustomerpopup.event;
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esd.trs.othersomanage 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
