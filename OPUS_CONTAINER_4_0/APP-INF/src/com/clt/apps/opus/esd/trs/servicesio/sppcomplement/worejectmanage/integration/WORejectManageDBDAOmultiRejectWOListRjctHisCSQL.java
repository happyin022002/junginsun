...
*@FileName : WORejectManageDBDAOmultiRejectWOListRjctHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WORejectManageDBDAOmultiRejectWOListRjctHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WORejectManageDBDAOmultiRejectWOListRjctHisCSQL(){
		setQuery();
		...
		query.append("FileName : WORejectManageDBDAOmultiRejectWOListRjctHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
