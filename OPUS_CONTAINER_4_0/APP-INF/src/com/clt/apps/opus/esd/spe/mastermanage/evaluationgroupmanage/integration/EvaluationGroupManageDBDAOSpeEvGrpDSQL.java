...
*@FileName : EvaluationGroupManageDBDAOSpeEvGrpDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EvaluationGroupManageDBDAOSpeEvGrpDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPE_EV_GRP DELETE 쿼리
	  * </pre>
	  */
	public EvaluationGroupManageDBDAOSpeEvGrpDSQL(){
		setQuery();
		...
		query.append("FileName : EvaluationGroupManageDBDAOSpeEvGrpDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SPE_EV_GRP" ).append("\n"); 
