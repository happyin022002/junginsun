...
public class ContinentVO extends AbstractValueObject {
	...
	public ContinentVO(String ibflag, String pagerows, String contiCode, String contiName) {
		this.ibflag = ibflag;
		this.contiName = contiName;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("conti_name", getContiName());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("conti_name", "contiName");
	 ...
	 * @param contiName
	 */
	public void setContiName(String contiName) {
		this.contiName = contiName;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setContiName(JSPUtil.getParameter(request, "conti_name", ""));
	...
	public ContinentVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] contiName = (JSPUtil.getParameter(request, prefix	+ "conti_name", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (contiName[i] != null)
					model.setContiName(contiName[i]);
				if (contiCode[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.contiName = this.contiName .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
