...
public class OceanRouteManageDBDAOSearchOceanLaneRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT FM_PORT_CD POLX" ).append("\n"); 
		query.append("      ,TO_PORT_CD PODX" ).append("\n"); 
		query.append("      ,VSL_SLAN_CD LANEX" ).append("\n"); 
		query.append("      ,SKD_DIR_CD DIRX" ).append("\n"); 
		query.append("      ,'N' FDR_FLGX" ).append("\n"); 
		query.append("      ,(SELECT DECODE(VSL_SVC_TP_CD, 'O', 'C', VSL_SVC_TP_CD)" ).append("\n"); 
		query.append("          FROM MDM_VSL_SVC_LANE" ).append("\n"); 
		query.append("         WHERE VSL_SLAN_CD = A.VSL_SLAN_CD) SVC_TPX" ).append("\n"); 
		query.append("      ,TZTM_HRS TTX" ).append("\n"); 
		query.append("      ,FM_PORT_ETB_DY_CD POLXETB" ).append("\n"); 
		query.append("      ,TO_PORT_ETB_DY_CD PODXETB" ).append("\n"); 
		...
		query.append("   AND DECODE(@[dir], NULL, 'ALL', SKD_DIR_CD) = DECODE(@[dir], NULL, 'ALL', @[dir])" ).append("\n"); 
		query.append("   AND DELT_FLG <> 'Y'" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT LNK_ORG_LOC_CD POLX" ).append("\n"); 
		query.append("      ,LNK_DEST_LOC_CD POLX" ).append("\n"); 
		query.append("      ,VSL_SLAN_CD POLX" ).append("\n"); 
		query.append("      ,SKD_DIR_CD DIRX" ).append("\n"); 
		query.append("      ,'Y' FDR_FLGX" ).append("\n"); 
		query.append("      ,(SELECT DECODE(VSL_SVC_TP_CD, 'O', 'C', VSL_SVC_TP_CD)" ).append("\n"); 
		query.append("          FROM MDM_VSL_SVC_LANE" ).append("\n"); 
		query.append("         WHERE VSL_SLAN_CD = A.VSL_SLAN_CD) SVC_TPX" ).append("\n"); 
		query.append("      ,TZTM_HRS TTX" ).append("\n"); 
		query.append("      ,' ' POLXETB" ).append("\n"); 
		query.append("      ,' ' PODXETB" ).append("\n"); 
