...
public class RailSoManageDBDAOSearchRailSoCorrectionTargetListBkgUpdByDateRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    MAX(NVL(TMP.BKG_RCVDE_TERM_CD, DECODE(TMP.TRSP_BND_CD , 'I', TMP.BKG_DE_TERM_CD, 'O', TMP.BKG_RCV_TERM_CD) )) BKG_RCVDE_TERM_CD," ).append("\n"); 
		...
		query.append("    CASE WHEN MAX(NVL(TMP.TRUNKVVD, 'N/A')) = MAX(NVL(BKG_VVD, 'N/A')) THEN 'N' ELSE 'Y'  END UNMATCH_VVD," ).append("\n"); 
		query.append("    CASE WHEN MAX(NVL(TMP.POD_CD, 'N/A')) = MAX(NVL(TMP.BKG_POD_CD, 'N/A')) THEN 'N'  ELSE 'Y'  END UNMATCH_POD," ).append("\n"); 
