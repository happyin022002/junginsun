package com.clt.apps.opus.esd.tpb.candidatemanage.manualregister.vo;
...
public class SearchManualRegisterListVO {
	private static final long serialVersionUID = 1L;
	
	private Collection<SearchManualRegisterListVO> models = new ArrayList<SearchManualRegisterListVO>();
	...
	public SearchManualRegisterListVO() {}

	public SearchManualRegisterListVO(String ibflag, String pagerows, String n3ptyOfcTpCd, String ofcCd, String sOfcCd, String rhqCd, String n3ptyCtrlOfcCd, String n3ptyOfcCd, String n3ptyArOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public SearchManualRegisterListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchManualRegisterListVO[]
	 */
	public SearchManualRegisterListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchManualRegisterListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchManualRegisterListVO();
				if (updDt[i] != null)
		...
		return getSearchManualRegisterListVOs();
	}
	...
	public SearchManualRegisterListVO[] getSearchManualRegisterListVOs(){
		SearchManualRegisterListVO[] vos = (SearchManualRegisterListVO[])models.toArray(new SearchManualRegisterListVO[models.size()]);
		return vos;
	}
