...
public class MarineTerminalInvoiceManageDBDAOCalculateTerminalInvoiceCostRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ROUND(INV_AMT*(INV_XCH_RT),2) INV_AMT," ).append("\n"); 
		query.append("       ROUND(INV_AMT*(INV_XCH_RT),2) CALC_AMT," ).append("\n"); 
		...
		query.append("FROM ( SELECT COST_CODE, CNTR_TPSZ_CD, CNTR_STY_CD, IO_BND_CD, DCGO_CLSS_CD, RC_FLG, AWK_CGO_FLG, TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD, FM_TIER, TO_TIER," ).append("\n"); 
		...
		query.append("              ROUND((SELECT USD_LOCL_XCH_RT FROM GL_MON_XCH_RT WHERE ACCT_XCH_RT_YRMON = SUBSTR(REPLACE(@[atb_dt],'-'),1,6) AND CURR_CD =@[curr_cd])/(select USD_LOCL_XCH_RT from GL_MON_XCH_RT where ACCT_XCH_RT_YRMON = SUBSTR(REPLACE(@[atb_dt],'-'),1,6) and CURR_CD = CURR),4) INV_XCH_RT" ).append("\n"); 
		query.append("	   FROM ( SELECT COST_CODE, Q.CNTR_TPSZ_CD, Q.CNTR_STY_CD, Q.IO_BND_CD, Q.DCGO_CLSS_CD, TML_WRK_DY_CD, Q.IOC_CD, Q.LANE_CD, Q.SUB_TRD_CD, Q.TML_TRNS_MOD_CD, Q.RC_FLG, Q.AWK_CGO_FLG, ACCM, CAL_VOL," ).append("\n"); 
		...
		query.append("					   ACCM_CHK" ).append("\n"); 
		query.append("			  FROM ( SELECT COST_CODE, CNTR_TPSZ_CD, CNTR_STY_CD, IO_BND_CD, DCGO_CLSS_CD, TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD, RC_FLG, AWK_CGO_FLG, ACCM, CAL_VOL, CHK_TO_QTY," ).append("\n"); 
		query.append("							DECODE(ACCM+CAL_VOL,CHK_TO_QTY,ACCM,LAG(CHK_TO_QTY) OVER (PARTITION BY ACCM_CHK --COST_CODE, CNTR_TPSZ_CD, IO_BND_CD, DCGO_CLSS_CD," ).append("\n"); 
		...
		query.append("									ORDER BY COST_CODE, CNTR_TPSZ_CD, IO_BND_CD, DCGO_CLSS_CD,TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD)) CHK_FM_QTY," ).append("\n"); 
		query.append("							VSL_CD, SKD_VOY_NO, SKD_DIR_CD, ATB_DT, CTY, SEQ, NO, ACCM_CHK" ).append("\n"); 
		query.append("					 FROM ( SELECT COST_CODE, CNTR_TPSZ_CD, CNTR_STY_CD, IO_BND_CD, DCGO_CLSS_CD, TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD, RC_FLG, AWK_CGO_FLG, ACCM, CAL_VOL," ).append("\n"); 
		...
		query.append("												ORDER BY COST_CODE, CNTR_TPSZ_CD, IO_BND_CD, DCGO_CLSS_CD, TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD" ).append("\n"); 
		...
		query.append("							 DECODE(I.HO,0,I.TML_WRK_DY_CD,'HO') TML_WRK_DY_CD, TML_WRK_DY_CD TML_WRK_DY_CD2, I.IOC_CD, I.LANE_CD, I.SUB_TRD_CD, --I.WRK_DT," ).append("\n"); 
		query.append("							 DECODE(D.TML_TRNS_MOD_CD,'S','S',I.TML_TRNS_MOD_CD) TML_TRNS_MOD_CD," ).append("\n"); 
		...
		query.append("										  IOC_CD, " ).append("\n"); 
		query.append("                                          --DECODE(SUBSTR(C.COST_CODE,1,2),'TM','','SV',DECODE(SUBSTR(C.COST_CODE,1,4),'SVSS','','SVLD',DECODE(C.COST_CODE,'SVLDBB','',LANE_CD),LANE_CD),LANE_CD) LANE_CD," ).append("\n"); 
		query.append("                                          LANE_CD," ).append("\n"); 
		query.append("                                          DECODE(SUBSTR(C.COST_CODE,1,2),'SV',SUB_TRD_CD,'TP',SUB_TRD_CD,'') SUB_TRD_CD," ).append("\n"); 
		query.append("                                          COUNT(DISTINCT CNTR_NO) CAL_VOL," ).append("\n"); 
		query.append("										  SUM(DECODE(L.CNTR_TPSZ_CD,'D7',1,0))*2.25+" ).append("\n"); 
		...
		query.append("										  SUM(DECODE(L.CNTR_TPSZ_CD,'D7',0,'D8',0,'D9',0,'DW',0,'DX',0," ).append("\n"); 
		...
		query.append("								   AND    DECODE(NVL(C.TML_TRNS_MOD_CD,'S'),'S','N',C.TML_TRNS_MOD_CD) = DECODE(NVL(C.TML_TRNS_MOD_CD,'S'),'S','N'," ).append("\n"); 
		query.append("                                                                                                                                (SELECT DECODE((SELECT NVL('X','N')" ).append("\n"); 
		query.append("                                                                    															 FROM   TES_TML_AGMT_DTL" ).append("\n"); 
		query.append("                                                                    															 WHERE  TML_AGMT_OFC_CTY_CD = C.CTY" ).append("\n"); 
		query.append("                                                                    															 AND    TML_AGMT_SEQ        = C.SEQ" ).append("\n"); 
		query.append("                                                                    															 AND    TML_AGMT_VER_NO     = C.NO" ).append("\n"); 
		...
		query.append("											IOC_CD, " ).append("\n"); 
		query.append("                                            --DECODE(SUBSTR(C.COST_CODE,1,2),'TM','','SV',DECODE(SUBSTR(C.COST_CODE,1,4),'SVSS','','SVLD',DECODE(C.COST_CODE,'SVLDBB','',LANE_CD),LANE_CD),LANE_CD), " ).append("\n"); 
		query.append("                                            LANE_CD," ).append("\n"); 
		query.append("                                            DECODE(SUBSTR(C.COST_CODE,1,2),'SV',SUB_TRD_CD,'TP',SUB_TRD_CD,'')," ).append("\n"); 
		query.append("                                            CTY, SEQ, NO, L.VSL_CD, L.SKD_VOY_NO, L.SKD_DIR_CD, L.ATB_DT," ).append("\n"); 
		...
		query.append("                     AND    NVL(D.SUB_TRD_CD,'N') = DECODE(NVL(D.SUB_TRD_CD,'N'),'N','N','S','S'," ).append("\n"); 
		query.append("											( SELECT DECODE((SELECT NVL('X','N')" ).append("\n"); 
		query.append("															 FROM   TES_TML_AGMT_DTL" ).append("\n"); 
		...
		query.append("															 AND    SUB_TRD_CD = I.SUB_TRD_CD" ).append("\n"); 
		query.append("															 AND    ROWNUM = 1),'X',I.SUB_TRD_CD,'O')" ).append("\n"); 
		query.append("											  FROM DUAL ))" ).append("\n"); 
		...
		query.append("															 AND    TML_AGMT_VER_NO     = I.NO" ).append("\n"); 
		query.append("															 AND    LANE_CD = I.LANE_CD" ).append("\n"); 
		query.append("															 AND    LGS_COST_CD = I.COST_CODE" ).append("\n"); 
		...
		query.append("					 AND    NVL(D.TML_TRNS_MOD_CD,'S') = DECODE(NVL(D.TML_TRNS_MOD_CD,'S'),'S','S'," ).append("\n"); 
		query.append("                                                                                                    (SELECT DECODE((SELECT NVL('X','N')" ).append("\n"); 
		query.append("                                        															 FROM   TES_TML_AGMT_DTL" ).append("\n"); 
		query.append("                                        															 WHERE  TML_AGMT_OFC_CTY_CD = I.CTY" ).append("\n"); 
		query.append("                                        															 AND    TML_AGMT_SEQ        = I.SEQ" ).append("\n"); 
		query.append("                                        															 AND    TML_AGMT_VER_NO     = I.NO" ).append("\n"); 
		query.append("                                        															 AND    TML_TRNS_MOD_CD     = I.TML_TRNS_MOD_CD" ).append("\n"); 
		query.append("                                        															 AND    ROWNUM = 1),'X',I.TML_TRNS_MOD_CD,'O')" ).append("\n"); 
		query.append("                                        											                 FROM DUAL ))" ).append("\n"); 
		...
		query.append("			  AND    DECODE(T.TML_CNTR_STY_CD,'','X',Q.CNTR_STY_CD) = DECODE(T.TML_CNTR_STY_CD,'','X',T.TML_CNTR_STY_CD) -- 2015.04.08 TMNDTS F/M별 구분 위해 추가" ).append("\n"); 
		...
		query.append("              AND    NVL(T.SUB_TRD_CD,'N') = DECODE(NVL(T.SUB_TRD_CD,'N'),'N','N','S','S'," ).append("\n"); 
		query.append("											( SELECT DECODE((SELECT NVL('X','N')" ).append("\n"); 
		query.append("															 FROM   TES_TML_AGMT_DTL" ).append("\n"); 
		...
		query.append("															 AND    SUB_TRD_CD = Q.SUB_TRD_CD" ).append("\n"); 
		query.append("															 AND    ROWNUM = 1),'X',Q.SUB_TRD_CD,'O')" ).append("\n"); 
		query.append("											  FROM DUAL ))" ).append("\n"); 
		...
		query.append("															 AND    TML_AGMT_VER_NO     = Q.NO" ).append("\n"); 
		query.append("															 AND    LANE_CD = Q.LANE_CD" ).append("\n"); 
		query.append("															 AND    LGS_COST_CD = Q.COST_CODE" ).append("\n"); 
		...
		query.append("			  AND    NVL(T.TML_TRNS_MOD_CD,'N') = DECODE(NVL(T.TML_TRNS_MOD_CD,'N'),'N','N','S','S'," ).append("\n"); 
		query.append("                                                                                                    (SELECT DECODE((SELECT NVL('X','N')" ).append("\n"); 
		query.append("                                        															 FROM   TES_TML_AGMT_DTL" ).append("\n"); 
		query.append("                                        															 WHERE  TML_AGMT_OFC_CTY_CD = Q.CTY" ).append("\n"); 
		query.append("                                        															 AND    TML_AGMT_SEQ        = Q.SEQ" ).append("\n"); 
		query.append("                                        															 AND    TML_AGMT_VER_NO     = Q.NO" ).append("\n"); 
		query.append("                                        															 AND    TML_TRNS_MOD_CD     = Q.TML_TRNS_MOD_CD" ).append("\n"); 
		query.append("                                        															 AND    ROWNUM = 1),'X',Q.TML_TRNS_MOD_CD,'O')" ).append("\n"); 
		query.append("                                        											                 FROM DUAL ))" ).append("\n"); 
		...
		query.append("										'C',DECODE(SUBSTR(Q.CNTR_TPSZ_CD,1,1)," ).append("\n"); 
		query.append("												   'R',DECODE(Q.RC_FLG     ,'N',DECODE(Q.CNTR_STY_CD, 'M', Q.CNTR_TPSZ_CD,'D'||SUBSTR(Q.CNTR_TPSZ_CD,2,1)),Q.CNTR_TPSZ_CD)," ).append("\n"); 
		query.append("                                                   'T',DECODE(Q.RC_FLG     ,'N',Q.CNTR_TPSZ_CD,'R'||SUBSTR(Q.CNTR_TPSZ_CD,2,1))," ).append("\n"); 
		query.append("												   'O',DECODE(Q.AWK_CGO_FLG,'N',DECODE(Q.CNTR_STY_CD, 'M', Q.CNTR_TPSZ_CD,'D'||SUBSTR(Q.CNTR_TPSZ_CD,2,1)),Q.CNTR_TPSZ_CD)," ).append("\n"); 
		query.append("												   'F',DECODE(Q.AWK_CGO_FLG,'N',DECODE(Q.CNTR_STY_CD, 'M', Q.CNTR_TPSZ_CD,'D'||SUBSTR(Q.CNTR_TPSZ_CD,2,1)),Q.CNTR_TPSZ_CD)," ).append("\n"); 
		query.append("												   'P',DECODE(Q.AWK_CGO_FLG,'N',DECODE(Q.CNTR_STY_CD, 'M', Q.CNTR_TPSZ_CD,'D'||SUBSTR(Q.CNTR_TPSZ_CD,2,1)),Q.CNTR_TPSZ_CD)," ).append("\n"); 
		query.append("												   'A',DECODE(Q.AWK_CGO_FLG,'N',DECODE(Q.CNTR_STY_CD, 'M', Q.CNTR_TPSZ_CD,'D'||SUBSTR(Q.CNTR_TPSZ_CD,2,1)),Q.CNTR_TPSZ_CD)," ).append("\n"); 
		query.append("												   'S',DECODE(Q.AWK_CGO_FLG,'N',DECODE(Q.CNTR_STY_CD, 'M', Q.CNTR_TPSZ_CD,'D'||SUBSTR(Q.CNTR_TPSZ_CD,2,1)),Q.CNTR_TPSZ_CD)," ).append("\n"); 
		...
		query.append("	   SELECT COST_CODE, CNTR_TPSZ_CD, CNTR_STY_CD, IO_BND_CD, DCGO_CLSS_CD, RC_FLG, AWK_CGO_FLG, TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD, FM_TIER, TO_TIER," ).append("\n"); 
		query.append("			  DECODE(ACCM_CHK,'Y',(TO_QTY - FM_QTY)+1,CAL_VOL) CALC_VOL_QTY, DECODE(ACCM_CHK,'Y',(TO_QTY - FM_QTY)+1,CAL_VOL) RVIS_VOL_QTY, VOL_TR_UT_CD, CTRT_RT," ).append("\n"); 
		...
		query.append("					   ACCM_CHK" ).append("\n"); 
		query.append("			  FROM ( SELECT COST_CODE, CNTR_TPSZ_CD, CNTR_STY_CD, IO_BND_CD, DCGO_CLSS_CD, TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD, RC_FLG, AWK_CGO_FLG, ACCM, CAL_VOL, CHK_TO_QTY," ).append("\n"); 
		query.append("					  DECODE(ACCM+CAL_VOL,CHK_TO_QTY,ACCM,LAG(CHK_TO_QTY) OVER (PARTITION BY ACCM_CHK --COST_CODE, CNTR_TPSZ_CD, IO_BND_CD, DCGO_CLSS_CD, TML_WRK_DY_CD," ).append("\n"); 
		...
		query.append("																			  TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD)) CHK_FM_QTY," ).append("\n"); 
		query.append("					  VSL_CD, SKD_VOY_NO, SKD_DIR_CD, ATB_DT, CTY, SEQ, NO, ACCM_CHK" ).append("\n"); 
		query.append("					 FROM ( SELECT COST_CODE, CNTR_TPSZ_CD, CNTR_STY_CD, IO_BND_CD, DCGO_CLSS_CD, TML_WRK_DY_CD, IOC_CD, LANE_CD, SUB_TRD_CD, TML_TRNS_MOD_CD, RC_FLG, AWK_CGO_FLG, ACCM, CAL_VOL," ).append("\n"); 
		query.append("						   SUM(CAL_VOL) OVER (PARTITION BY ACCM_CHK --COST_CODE, CNTR_TPSZ_CD, IO_BND_CD, DCGO_CLSS_CD, TML_WRK_DY_CD, IOC_CD, LANE_CD, TML_TRNS_MOD_CD," ).append("\n"); 
		query.append("															 --ACCM, CAL_VOL, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, ATB_DT, CTY, SEQ, NO" ).append("\n"); 
		...
		query.append("                                            LANE_CD," ).append("\n"); 
		query.append("                                            DECODE(SUBSTR(C.COST_CODE,1,2),'SV',SUB_TRD_CD,'TP',SUB_TRD_CD,''),  " ).append("\n"); 
		query.append("                                            CTY, SEQ, NO, L.VSL_CD, L.SKD_VOY_NO, L.SKD_DIR_CD," ).append("\n"); 
		...
		query.append("					  FROM ( SELECT DECODE(L.LOCL_TS_IND_CD," ).append("\n"); 
		query.append("												  'T', DECODE(L.CNTR_STY_CD," ).append("\n"); 
		query.append("																   'F',DECODE(C.TML_CNTR_STY_CD,'F',C.COST_CODE,DECODE(SUBSTR(C.COST_CODE,5,2),'TS',C.COST_CODE))," ).append("\n"); 
		query.append("																	   DECODE(C.TML_CNTR_STY_CD,'M',C.COST_CODE,DECODE(SUBSTR(C.COST_CODE,5,2),'TM',C.COST_CODE)))," ).append("\n"); 
		query.append("													   DECODE(L.CNTR_STY_CD," ).append("\n"); 
		query.append("																   'F',DECODE(SUBSTR(C.COST_CODE,5,2),'FL',C.COST_CODE)," ).append("\n"); 
		query.append("																	   DECODE(SUBSTR(C.COST_CODE,5,2),'MT',C.COST_CODE))) COST_CODE," ).append("\n"); 
		query.append("--		 TM 비용 Auto Calculation위해 삭제한부분" ).append("\n"); 
		...
		query.append("--		                                          DECODE(L.CNTR_STY_CD,'F',DECODE(SUBSTR(C.COST_CODE,5,2),'FL',C.COST_CODE)," ).append("\n"); 
		query.append("--		                                          DECODE(SUBSTR(C.COST_CODE,5,2),'MT',C.COST_CODE))) COST_CODE," ).append("\n"); 
		query.append("										  CNTR_TPSZ_CD, CNTR_STY_CD, C.TML_CNTR_STY_CD, IO_BND_CD, L.DCGO_CLSS_CD, --L.WRK_DT," ).append("\n"); 
		query.append("										  DECODE(TO_CHAR(L.WRK_DT,'D'),7,'SA',1,'SU','WD') TML_WRK_DY_CD," ).append("\n"); 
		query.append("--		                                          DECODE(TO_CHAR(L.WRK_DT,'DY'),'SAT','SA','SUN','SU','WD') TML_WRK_DY_CD," ).append("\n"); 
		query.append("										  MAX(( SELECT COUNT(*)" ).append("\n"); 
		query.append("											FROM   DMT_HOLIDAY" ).append("\n"); 
		...
		query.append("--		                                               DECODE(SUBSTR(C.COST_CODE,5,2),'MT',C.COST_CODE))) ) ACCM," ).append("\n"); 
		query.append("/* 2008-06-20 : 김기영 부장님의 요청으로 TS/TM 구분에도 F/M 기준으로 변경  */" ).append("\n"); 
		query.append("											AND    LGS_COST_CD = DECODE(L.LOCL_TS_IND_CD,'T',DECODE(L.CNTR_STY_CD,'F',DECODE(C.TML_CNTR_STY_CD,'F',C.COST_CODE,DECODE(SUBSTR(C.COST_CODE,5,2),'TS',C.COST_CODE))," ).append("\n"); 
		query.append("																													  DECODE(C.TML_CNTR_STY_CD,'M',C.COST_CODE,DECODE(SUBSTR(C.COST_CODE,5,2),'TM',C.COST_CODE)))," ).append("\n"); 
		query.append("																							 DECODE(L.CNTR_STY_CD,'F',DECODE(SUBSTR(C.COST_CODE,5,2),'FL',C.COST_CODE)," ).append("\n"); 
		query.append("																													  DECODE(SUBSTR(C.COST_CODE,5,2),'MT',C.COST_CODE)))  ) ACCM," ).append("\n"); 
		query.append("										  ( SELECT TML_ACCM_UT_CD" ).append("\n"); 
		...
		query.append("								   FROM   TES_TML_SO_CNTR_LIST L," ).append("\n"); 
		query.append("										  ( SELECT DISTINCT DECODE(1,0,C.LGS_COST_CD,DECODE(C.LGS_COST_CD,CD,TP,C.LGS_COST_CD)) COST_CODE," ).append("\n"); 
		query.append("												   CTY, SEQ, NO, NVL(D.TML_TRNS_MOD_CD,'S') TML_TRNS_MOD_CD, D.TML_CNTR_STY_CD" ).append("\n"); 
		query.append("											FROM ( SELECT COUNT(T.LGS_COST_CD) CNT," ).append("\n"); 
		query.append("														  T.LGS_COST_CD TP," ).append("\n"); 
		query.append("														  T.THRP_LGS_COST_CD CD," ).append("\n"); 
		query.append("														  H.TML_AGMT_OFC_CTY_CD CTY," ).append("\n"); 
		...
		query.append("--		                                   AND    ( NVL(L.CNTR_STY_CD,'N') <> 'M' OR NVL(LOCL_TS_IND_CD,'N') <> 'T' )" ).append("\n"); 
		query.append("--TM 비용 Auto Calculation을 위해 추가한 부분" ).append("\n"); 
		query.append("								   AND    DECODE(LOCL_TS_IND_CD,'T', DECODE(L.CNTR_STY_CD,'F','TS',(DECODE(C.TML_CNTR_STY_CD,'M','TS','TM')))" ).append("\n"); 
		query.append("																 , DECODE(L.CNTR_STY_CD,'F','FL','MT')) = SUBSTR(C.COST_CODE,5,2)" ).append("\n"); 
		query.append("                                   AND    DECODE(C.TML_CNTR_STY_CD,'','X',L.CNTR_STY_CD) = DECODE(C.TML_CNTR_STY_CD,'','X',C.TML_CNTR_STY_CD)	" ).append("\n"); 
		query.append("--TM 비용 Auto Calculation을 위해 삭제한 부분" ).append("\n"); 
		query.append("--		                                   AND    DECODE(LOCL_TS_IND_CD,'T','TS',DECODE(CNTR_STY_CD,'F','FL','MT')) = SUBSTR(C.COST_CODE,5,2)" ).append("\n"); 
		query.append("								   AND    DECODE(NVL(C.TML_TRNS_MOD_CD,'S'),'S','N',C.TML_TRNS_MOD_CD) = DECODE(NVL(C.TML_TRNS_MOD_CD,'S'),'S','N',L.TML_TRNS_MOD_CD)" ).append("\n"); 
		query.append("								   GROUP BY C.COST_CODE, CNTR_TPSZ_CD, CNTR_STY_CD, LOCL_TS_IND_CD, IO_BND_CD, L.DCGO_CLSS_CD," ).append("\n"); 
		...
		query.append(" 										    DECODE(SUBSTR(C.COST_CODE,1,2),'SV',SUB_TRD_CD,'TP',SUB_TRD_CD,''),  " ).append("\n"); 
		query.append("                                            CTY, SEQ, NO, L.VSL_CD, L.SKD_VOY_NO, L.SKD_DIR_CD," ).append("\n"); 
		query.append("											L.ATB_DT, DECODE(C.TML_TRNS_MOD_CD,'S','S',L.TML_TRNS_MOD_CD), L.RC_FLG, L.AWK_CGO_FLG, C.TML_CNTR_STY_CD) I," ).append("\n"); 
		query.append("							TES_TML_AGMT_DTL D" ).append("\n"); 
		query.append("					 WHERE  I.CTY = D.TML_AGMT_OFC_CTY_CD" ).append("\n"); 
		query.append("					 AND    I.SEQ = D.TML_AGMT_SEQ" ).append("\n"); 
		query.append("					 AND    I.NO  = D.TML_AGMT_VER_NO" ).append("\n"); 
		...
		query.append("							or SUBSTR(I.COST_CODE,1,4)||'TS' = DECODE(D.THRP_COST_CD_FLG,'Y',D.THRP_LGS_COST_CD,D.LGS_COST_CD)) -- 2015.04.08 TMNDTS F/M 구분 위해 추가" ).append("\n"); 
		query.append(" 					 AND    DECODE(D.TML_CNTR_STY_CD,'','X','M',D.TML_CNTR_STY_CD) = DECODE(D.TML_CNTR_STY_CD,'','X','M','M')   -- 2015.04.08 TMNDTS F/M 구분 위해 추가" ).append("\n"); 
		query.append("--		TM 비용 Auto Calculation을 위해 삭제한 부분" ).append("\n"); 
		query.append("--		                     AND    SUBSTR(I.COST_CODE,1,4)||'MT' = DECODE(D.THRP_COST_CD_FLG,'Y',D.THRP_LGS_COST_CD,D.LGS_COST_CD)" ).append("\n"); 
		query.append("					 AND    I.COST_CODE = D.LGS_COST_CD(+)" ).append("\n"); 
		query.append("					 AND    NVL(D.THRP_COST_CD_FLG,'N') <> 'Y'" ).append("\n"); 
		...
		query.append("					 OR SUBSTR(Q.COST_CODE,1,4)||'TS' = DECODE(T.THRP_COST_CD_FLG,'Y',T.THRP_LGS_COST_CD,T.LGS_COST_CD)) -- 2015.04.08 TMNDTS F/M 구분 위해 추가" ).append("\n"); 
		query.append("              AND    Q.CNTR_STY_CD = 'M'    -- 2015.04.08 TMNDTS F/M 구분 위해 추가" ).append("\n"); 
		query.append("			  AND    NVL(T.TML_CNTR_STY_CD,'M') = Q.CNTR_STY_CD -- 2015.04.08 TMNDTS F/M 구분 위해 추가" ).append("\n"); 
		query.append("--		              AND    SUBSTR(Q.COST_CODE,1,4)||'MT' = DECODE(T.THRP_COST_CD_FLG,'Y',T.THRP_LGS_COST_CD,T.LGS_COST_CD)" ).append("\n"); 
		query.append("			  AND    Q.COST_CODE = T.LGS_COST_CD(+)" ).append("\n"); 
		query.append("			  AND    NVL(T.THRP_COST_CD_FLG,'N') <> 'Y'" ).append("\n"); 
		query.append("			  AND    NVL(T.IO_BND_CD,'N')  = DECODE(NVL(T.IO_BND_CD,'N'),'N','N','S','S',Q.IO_BND_CD)" ).append("\n"); 
