...
public class CustomerEdiDBDAOSearchPerCsInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", MAX(STS.EDI_STS_SEQ)EDI_STS_SEQ" ).append("\n"); 
		...
		query.append("GROUP BY grp.edi_grp_cd,grp.cust_trd_prnr_id, grp.edi_grp_desc ,cgo.edi_stnd_sts_cd, CGO.CUST_EDI_STS_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(") A" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("ORDER BY  EDI_STS_SEQ" ).append("\n"); 
		query.append(")" ).append("\n"); 
