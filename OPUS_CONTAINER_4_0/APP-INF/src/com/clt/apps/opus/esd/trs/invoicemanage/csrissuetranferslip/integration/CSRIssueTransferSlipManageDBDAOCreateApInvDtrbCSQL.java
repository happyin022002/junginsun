...
*@FileName : CSRIssueTransferSlipManageDBDAOCreateApInvDtrbCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOCreateApInvDtrbCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AP Detail 테이블에 자료 입력
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOCreateApInvDtrbCSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOCreateApInvDtrbCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,@[attr_ctnt12]                   " ).append("\n"); 
		query.append("		,@[attr_ctnt13]                   " ).append("\n"); 
		query.append("		,DECODE(@[dtrb_coa_vvd_cd], '0000000000', 'COM', NVL(" ).append("\n"); 
		query.append("			(" ).append("\n"); 
		query.append("				SELECT A.SLAN_CD " ).append("\n"); 
		query.append("				FROM AR_MST_REV_VVD A " ).append("\n"); 
		query.append("				WHERE A.VSL_CD 			= substr(@[dtrb_coa_vvd_cd], 1, 4)" ).append("\n"); 
		query.append("				AND   A.SKD_VOY_NO 		= substr(@[dtrb_coa_vvd_cd], 5, 4)" ).append("\n"); 
		query.append("				AND   A.SKD_DIR_CD 		= substr(@[dtrb_coa_vvd_cd], 9, 1)" ).append("\n"); 
		query.append("				AND   A.RLANE_DIR_CD 	= substr(@[dtrb_coa_vvd_cd], 10, 1)		" ).append("\n"); 
