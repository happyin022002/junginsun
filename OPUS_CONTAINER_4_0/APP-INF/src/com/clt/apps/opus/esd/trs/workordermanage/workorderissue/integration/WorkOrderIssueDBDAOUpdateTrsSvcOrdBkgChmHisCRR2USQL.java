...
*@FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCRR2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCRR2USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateTrsSvcOrdBkgChmHisCRR2
	  * </pre>
	  */
	public WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCRR2USQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCRR2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET STL_FLG = @[stl_flg] " ).append("\n"); 
