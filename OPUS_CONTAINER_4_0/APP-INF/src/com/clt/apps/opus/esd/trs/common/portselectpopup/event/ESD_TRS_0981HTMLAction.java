 ...
 * @since J2EE 1.4
 */
public class ESD_TRS_0981HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VSK_GLO_HTMLAction 객체를 생성
	 */
	public ESD_TRS_0981HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs0981Event event = new EsdTrs0981Event();
    	
    	String op = request.getParameter("op");
		event.setOp(op);
    	
   		if(command.isCommand(FormCommand.SEARCH)) {
   			event.setPortVO((PortVO)getVO(request, PortVO.class));
