...
*@FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYContainerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOSearchOffdockCYContainerListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOffdockCYContainerList
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOSearchOffdockCYContainerListRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYContainerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
