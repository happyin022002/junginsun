...
import com.clt.apps.opus.esd.tes.serviceproviderinvoicemanage.ondockrailchargeinvoicemanage.integration.OndockRailChargeInvoiceManageDBDAO;
 ...
 *
 * @author parkyeonjin
 * @see ESD_TES_064EventResponse,OndockRailChargeInvoiceManageBC each DAO class reference
 * @since J2EE 1.4
 */
...
//	// Database Access Object
	...
	/**
	 * OndockRailChargeInvoiceManageBCImpl object creation<br>
	 * OndockRailChargeInvoiceManageDBDAO creation<br>
	 */
...
//		ArrayList<DBRowSet> 	arrList 		= new ArrayList<DBRowSet>();
		...
		String tpszCode = "";
		String costCode = "";
		StringBuffer tpszCodeBuf = new StringBuffer();
		StringBuffer costCodeBuf = new StringBuffer();
...
//					tpszCode = tpszCode + cntrTypeSizeRowSet.getString("cntr_tpsz_cd")+"|";
					tpszCodeBuf.append("|").append(cntrTypeSizeRowSet.getString("cntr_tpsz_cd"));
				}
			}
			
			tpszCode = tpszCodeBuf.toString();
...
//					costCode = costCode + costCodeRowSet.getString("lgs_cost_cd")+"|";
					costCodeBuf.append("|").append(costCodeRowSet.getString("lgs_cost_cd"));
				}
			}
			costCode = costCodeBuf.toString();
...
log.debug("tesFileImpTmpVOs======>"+tesFileImpTmpVOs);
	...
	/**
	 * ContainerList Verify Event Process<br>
	 * OndockRailChargeInvoiceManage ContainerList Verify  Event Process verifyOndockRailChargeContainerList <br>
	 *
	 * @param e EsdTes9130Event
	...
	/**
	 * ContainerList Verify Event Process<br>
	 * OndockRailChargeInvoiceManage ContainerList Verify  Event Process createOndockRailChargeContainerList<br>
	 *
	 * @param e EsdTes9130Event
	 * @return EventResponse EventResponse
	 * @exception EventException
...
//	/**
//	 * ContainerList Verify Delete<br>
//	 * OndockRailChargeInvoiceManage ContainerList Verify  Event Process<br>
//	 *
//	 * @param e EsdTes9130Event
//	 * @return EventResponse ESD_TES_913EventResponse
...
//	}
	 ...
	 * OndockRailChargeInvoiceManage event OndockRailChargeContainerList Multi Event Process<br>
	 *
	 * @param e EsdTes0064Event
	 * @return EventResponse EventResponse
	 * @exception EventException
...
log.debug("tesTmlSoCntrListVOs[i].getIbflag()===>"+tesTmlSoCntrListVOs[i].getIbflag());
	...
	public EventResponse multiOnDockTerminalInvoiceDBVerify(Event e) throws EventException{
		...
		if(log.isDebugEnabled())log.debug("\n==========OndockRailChargeInvoiceManageBCImpl    multiOnDockTerminalInvoiceDBVerify() ============");
	 ...
	 * OndockRailChargeInvoiceManage event OndockRailChargeContainerList retrieve event process
	 *
	 * @param e EsdTes0064Event
	 * @return EventResponse EventResponse
	 * @exception EventException
	...
	public EventResponse searchOndockRailChargeCostCalculationList(Event e) throws EventException {
		...
		try {
			if(event.getOndockRailChargeInvoiceCommonVO().getCostCalcMode().equals("R")){ //cost calculation mode (R : 기존저장된 calc list read)
				...
				rowSet=dbDao.searchOndockRailChargeCostCalculationListNew(event, agmtCostYN);
			}
	 ...
	 * OndockRailChargeInvoiceManage searchOnDockChargeInvoiceCostCalcComboCodeList retrieve event process
	 *
	 * @param e EsdTes0064Event
	 * @return  EventResponse GeneralEventResponse
	 * @exception EventException
...
//					tpszCode = tpszCode + cntrTypeSizeRowSet.getString("cntr_tpsz_cd")+"|";
			...
			if(costCodeRowSet !=null && costCodeRowSet.getRowCount()>0){
				while(costCodeRowSet.next()){
//					costCode = costCode + costCodeRowSet.getString("lgs_cost_cd")+"|";
					costCodeBuf.append(costCodeRowSet.getString("lgs_cost_cd")).append("|");
				}
			}
			costCode = costCodeBuf.toString();
	 ...
	 * ESD_TES_0064 InvoiceDetail Multi Event Process<br>
	 *
...
//			if(log.isDebugEnabled())log.debug("OndockRailChargeInvoiceManageBCImpl getTempN3ptyLists size   			:	" + event.getTempN3ptyIfs().size());
	...
	public EventResponse searchDBCheckOnDockTerminalInvoice(Event e) throws EventException {
		...
		if(log.isDebugEnabled())log.debug("\n==========OndockRailChargeInvoiceManageBCImpl    searchDBCheckOnDockTerminalInvoice() ============");
...
//	 * OndockRailChargeInvoiceManageDBDAO TerminalInvoiceN3rdPartyIF LIST retrieve event process
//	 *
//	 * @param e EsdTes0064Event
...
//	 * OndockRailChargeInvoiceManageDBDAO TML_SO_RVIS_LIST retrieve event process
//	 *
//	 * @param e EsdTes0064Event
//	 * @return response EventResponse
//	 * @exception EventException
...
log.debug("ondockRailChargeInvoiceCommonVOs[i].getRvisIndFlg()=====>"+ondockRailChargeInvoiceCommonVOs[i].getRvisIndFlg());	
	...
	/**
	 * Revised Vol List retrieve event process
	 * OndockRailChargeInvoiceManageDBDAO Revised Vol List retrieve event process
	 *
	 * @param e ESD_TES_9031Event
	 * @return  EventResponse GeneralEventResponse
	 * @exception EventException
	...
	/**
	 * Revised Vol List retrieve event process
	 * OndockRailChargeInvoiceManage Revised Vol List retrieve event process
	 *
	 ...
	 * OndockRailChargeInvoiceManage TerminalInvoiceN3ptyAutoCntrList retrieve event process
	 *
	...
	public EventResponse searchTerminalInvoiceN3ptyAutoCntrList(Event e) throws EventException {
		...
		try {
			if("A".equals(event.getTesTmlSoDtlVO().getCalcTpCd())){
				rowSet = dbDao.searchTerminalInvoiceRevisedVolume(event.getTesTmlSoCntrListVO(), event.getTesTmlSoDtlVO());
			}else if("M".equals(event.getTesTmlSoDtlVO().getCalcTpCd())){
				rowSet = dbDao.searchTerminalInvoiceRevisedVolumeTPB(event.getTesTmlSoCntrListVO(), event.getTesTmlSoDtlVO());
			}
...
//		HashMap<String, String> etcData			= new HashMap<String, String>();
	 ...
	 * OndockRailChargeInvoiceManage TerminalInvoiceN3ptyManualCntrList retrieve event process
	 *
	 * @param e EsdTes9231Event
	 * @return EventResponse GeneralEventResponse
	 * @exception EventException
	...
	/**
	 * retrieve event process
	 * OndockRailCharge Container List retrieve retrieve event process
	 *
	...
	/**
	 * retrieve event process
	 * OndockRailCharge Container List retireve Container List(Coincidency/Discrepancy) retrieve event process
	 *
	 * @param e EsdTes0068Event
	 * @return EventResponse GeneralEventResponse
	 * @exception EventException
	...
	public EventResponse searchOndockRailChargeContainerList2(Event e) throws EventException {
		//DBResultSet for Data Transmission ArrayList
		EsdTes0068Event event=(EsdTes0068Event)e;
		GeneralEventResponse	eventResponse	= new GeneralEventResponse();
...
//		DBRowSet[] rowSetArr = new DBRowSet[3];
		...
		if(log.isDebugEnabled()) log.debug("\n\n================OndockRailChargeInvoiceManageBCImpl :::::: searchOndockRailChargeContainerList3()======================\n");
		if(log.isDebugEnabled())log.debug("\n\n============event.getParams => "+event.getTesTmlSoHdrVO());
		try{
			arrList.add(dbDao.searchOndockRailChargeContainerList2(event.getTesTmlSoHdrVO(),"CO"));
			arrList.add(dbDao.searchOndockRailChargeContainerList2(event.getTesTmlSoHdrVO(),"DC"));
...
//			throw new SQLException(se.getMessage());
	...
	/**
	 * InvoiceDetail Multi Event Process<br>
	 * ESD_TES_9231 InvoiceDetail Multi Event Process<br>
	 *
	 * @param e EsdTes0064Event
	 * @return EventResponse EventResponse
	 * @exception EventException
...
log.debug("tesN3rdPtyIfVOs[i].getIbflag()==>"+tesN3rdPtyIfVOs[i].getIbflag());
	 ...
	 * OndockRailChargeInvoiceManage Clearing object by the end of work scenario<br>
	 */
	public void doEnd() {
		dbDao = null;
	}
