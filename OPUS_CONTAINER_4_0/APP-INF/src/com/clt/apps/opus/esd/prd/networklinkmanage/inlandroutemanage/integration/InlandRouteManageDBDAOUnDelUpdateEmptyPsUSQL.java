...
*@FileName : InlandRouteManageDBDAOUnDelUpdateEmptyPsUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOUnDelUpdateEmptyPsUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRouteManageDBDAOUnDelUpdateEmptyPsUSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageDBDAOUnDelUpdateEmptyPsUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
