...
*@FileName : ManualInputDBDAOModifyActivityGroupUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualInputDBDAOModifyActivityGroupUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ManualInputDBDAOModifyActivityGroupUSQL(){
		setQuery();
		...
		query.append("FileName : ManualInputDBDAOModifyActivityGroupUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCE_ACT_GRP" ).append("\n"); 
		query.append("SET COP_DTL_GRP_CD = @[cop_dtl_grp_cd]" ).append("\n"); 
