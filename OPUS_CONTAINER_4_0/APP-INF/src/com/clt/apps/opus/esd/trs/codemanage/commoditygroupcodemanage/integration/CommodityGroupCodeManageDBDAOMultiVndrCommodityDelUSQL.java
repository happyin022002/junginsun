...
public class CommodityGroupCodeManageDBDAOMultiVndrCommodityDelUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommodityGroupCodeManageDBDAOMultiVndrCommodityDelUSQL(){
		setQuery();
