...
public class EsdTrs0002Event extends EventSupport {
	private static final long serialVersionUID = 4109778770855893524L;
	...
	public void setSingleTransportationVO(SingleTransportationVO singleTransportationVO) {
	...
	public String getScScreenId() {
		return scScreenId;
	}

	public void setScScreenId(String scScreenId) {
		this.scScreenId = scScreenId;
	}
