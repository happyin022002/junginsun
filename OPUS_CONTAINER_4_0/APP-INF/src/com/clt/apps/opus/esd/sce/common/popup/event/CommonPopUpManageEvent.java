...
import com.clt.apps.opus.esd.sce.common.popup.vo.ComMailManagementConditionVO;
...
public class CommonPopUpManageEvent extends EventSupport {
	...
	public ComVvdManagementConditionVO[] getComVvdManagementConditionVOs() {
		ComVvdManagementConditionVO[] rtnVOs = null;
		if (this.comVvdManagementConditionVOs != null) {
			rtnVOs = Arrays.copyOf(comVvdManagementConditionVOs, comVvdManagementConditionVOs.length);
		}
		return rtnVOs;
	}

	public void setComVvdManagementConditionVOs(ComVvdManagementConditionVO[] comVvdManagementConditionVOs) {
		if(comVvdManagementConditionVOs != null){
			ComVvdManagementConditionVO[] tmpVOs = Arrays.copyOf(comVvdManagementConditionVOs, comVvdManagementConditionVOs.length);
			this.comVvdManagementConditionVOs = tmpVOs;
		}
	}
	...
	public void setComVvdManagementVOS(ComVvdManagementVO[] comVvdManagementVOs){
		if(comVvdManagementVOs != null){
			ComVvdManagementVO[] tmpVOs = Arrays.copyOf(comVvdManagementVOs, comVvdManagementVOs.length);
			this.comVvdManagementVOs = tmpVOs;
		}
	}
	...
	public ComVvdManagementVO[] getComVvdManagementVOS(){
		ComVvdManagementVO[] rtnVOs = null;
		if (this.comVvdManagementVOs != null) {
			rtnVOs = Arrays.copyOf(comVvdManagementVOs, comVvdManagementVOs.length);
		}
		return rtnVOs;
	}
