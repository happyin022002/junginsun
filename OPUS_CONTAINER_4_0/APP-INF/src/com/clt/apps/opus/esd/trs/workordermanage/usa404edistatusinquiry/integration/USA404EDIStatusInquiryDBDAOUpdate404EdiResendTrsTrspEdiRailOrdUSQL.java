...
*@FileName : USA404EDIStatusInquiryDBDAOUpdate404EdiResendTrsTrspEdiRailOrdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOUpdate404EdiResendTrsTrspEdiRailOrdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOUpdate404EdiResendTrsTrspEdiRailOrdUSQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOUpdate404EdiResendTrsTrspEdiRailOrdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", X.BKG_NO			  			= (	SELECT" ).append("\n"); 
		query.append("XX.BKG_NO" ).append("\n"); 
		query.append("FROM   TRS_TRSP_RAIL_BIL_ORD  XX" ).append("\n"); 
		query.append("WHERE  XX.TRSP_SO_OFC_CTY_CD  = X.TRSP_SO_OFC_CTY_CD" ).append("\n"); 
		query.append("AND    XX.TRSP_SO_SEQ         = X.TRSP_SO_SEQ" ).append("\n"); 
		query.append("AND    XX.BIL_ISS_KNT         = X.BIL_ISS_KNT" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("WHERE X.TRSP_SO_OFC_CTY_CD = @[trsp_so_ofc_cty_cd]" ).append("\n"); 
		query.append("AND   X.TRSP_SO_SEQ = @[trsp_so_seq]" ).append("\n"); 
		query.append("AND   X.BIL_ISS_KNT = @[bil_iss_knt]" ).append("\n"); 
