...
*@FileName : OffdockCYInvoiceManageDBDAOCalOffdockCYInvoiceCost2TMNLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOCalOffdockCYInvoiceCost2TMNLRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CalOffdockCYInvoiceCost2TMNL
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOCalOffdockCYInvoiceCost2TMNLRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOCalOffdockCYInvoiceCost2TMNLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" AND    DECODE(L.CNTR_STY_CD,'F',DECODE(L.LOCL_TS_IND_CD,'L','TMNDFL','TMNDTS'),DECODE(L.LOCL_TS_IND_CD,'T','TMNDTS','TMNDMT')) = ND.LGS_COST_CD" ).append("\n"); 
		...
		query.append(" AND    NVL(DECODE(ND.TML_CNTR_STY_CD,'S',L.CNTR_STY_CD,ND.TML_CNTR_STY_CD),L.CNTR_STY_CD) = NVL(L.CNTR_STY_CD,'X')" ).append("\n"); 
		...
		query.append("                    GROUP BY VRFY_RSLT_IND_CD, TML_SO_OFC_CTY_CD, TML_SO_SEQ, TML_SO_CNTR_LIST_SEQ, CNTR_STY_CD, CNTR_TPSZ_CD, DCGO_CLSS_CD," ).append("\n"); 
		query.append("                             INV_GATE_OUT_DT, DECODE(TO_CHAR(INV_GATE_OUT_DT,'D'),7,'SA',1,'SU','WD')," ).append("\n"); 
		query.append("                             IO_BND_CD, RC_FLG, AWK_CGO_FLG, TML_TRNS_MOD_CD, DCGO_CLSS_CD, LOCL_TS_IND_CD" ).append("\n"); 
		query.append("                             ) ) L, " ).append("\n"); 
		query.append("        TES_TML_AGMT_HDR H," ).append("\n"); 
		...
		query.append("SELECT DISTINCT 'I' IBFLAG, 'A' CALC_TP_CD, 'TM' CALC_COST_GRP_CD," ).append("\n"); 
		query.append("       S.LGS_COST_CD, S.CNTR_TPSZ_CD, S.DCGO_CLSS_CD DCGO_IND_CD, S.VOL_TR_UT_CD," ).append("\n"); 
		query.append("       DECODE(S.THC,'T',S.CALC_VOL_QTY,S.CALC_VOL_QTY) CALC_VOL_QTY," ).append("\n"); 
		query.append("       DECODE(S.THC,'T',S.CALC_VOL_QTY,S.CALC_VOL_QTY) RVIS_VOL_QTY," ).append("\n"); 
		query.append("       DECODE(S.THC,'T',S.CTRT_RT,S.CTRT_RT)*2 CTRT_RT," ).append("\n"); 
		query.append("       DECODE(S.THC,'T',S.CALC_VOL_QTY,S.CALC_VOL_QTY)*(DECODE(S.THC,'T',S.CTRT_RT,S.CTRT_RT)*2) INV_AMT," ).append("\n"); 
		query.append("       DECODE(S.THC,'T',S.CALC_VOL_QTY,S.CALC_VOL_QTY)*(DECODE(S.THC,'T',S.CTRT_RT,S.CTRT_RT)*2) CALC_AMT," ).append("\n"); 
		query.append("       D.ACCT_CD, S.TML_AGMT_OFC_CTY_CD, S.TML_AGMT_SEQ, S.TML_AGMT_VER_NO, S.CURR_CHK, CURR_CD, INV_XCH_RT," ).append("\n"); 
		query.append("       DECODE(S.RC_FLG,'Y','Y','N') RC_FLG, S.TML_TRNS_MOD_CD" ).append("\n"); 
		query.append("FROM ( SELECT DECODE(L.CNTR_STY_CD,'F',DECODE(L.LOCL_TS_IND_CD,'L','SVSSFL','SVSSTS'),DECODE(L.LOCL_TS_IND_CD,'T','SVSSTM','SVSSMT')) LGS_COST_CD," ).append("\n"); 
		query.append("        L.CNTR_TPSZ_CD, NVL(L.DCGO_CLSS_CD,'N') DCGO_CLSS_CD," ).append("\n"); 
		query.append("        SUM(DECODE(@[tml_calc_ind_cd],'TP',DECODE(L.INV_GATE_OUT_DT,NULL,0,1),1)) CALC_VOL_QTY," ).append("\n"); 
		query.append("        SUM(DECODE(@[tml_calc_ind_cd],'TP',DECODE(L.INV_GATE_OUT_DT,NULL,0,1),1)) RVIS_VOL_QTY," ).append("\n"); 
		query.append("        GD.TML_AGMT_VOL_UT_CD VOL_TR_UT_CD, NVL(GD.THC_TP_CD,'T') THC," ).append("\n"); 
		...
		query.append("        SUM(DECODE(@[tml_calc_ind_cd],'TP',DECODE(L.INV_GATE_OUT_DT,NULL,0,1),1)) *" ).append("\n"); 
		query.append("        DECODE(GD.TML_AGMT_VOL_UT_CD,'C',GC.AGMT_RT,GD.AGMT_UT_RT) INV_AMT," ).append("\n"); 
		query.append("        H.TML_AGMT_OFC_CTY_CD, H.TML_AGMT_SEQ, H.TML_AGMT_VER_NO, L.TML_TRNS_MOD_CD, L.RC_FLG, GD.CURR_CD, DECODE(@[curr_cd],GD.CURR_CD,'Y','N') CURR_CHK," ).append("\n"); 
		query.append("        ROUND((SELECT USD_LOCL_XCH_RT FROM GL_MON_XCH_RT WHERE ACCT_XCH_RT_YRMON = SUBSTR(REPLACE(@[to_prd_dt],'-'),1,6) AND CURR_CD =@[curr_cd])/(select USD_LOCL_XCH_RT from GL_MON_XCH_RT where ACCT_XCH_RT_YRMON = SUBSTR(REPLACE(@[to_prd_dt],'-'),1,6) and CURR_CD = GD.CURR_CD),4) INV_XCH_RT" ).append("\n"); 
		query.append(" FROM   (SELECT VRFY_RSLT_IND_CD, TML_SO_OFC_CTY_CD, TML_SO_SEQ, CNTR_STY_CD, CNTR_TPSZ_CD, DCGO_CLSS_CD, " ).append("\n"); 
		query.append("                INV_GATE_OUT_DT, DECODE(HO,0,WRK_DY,'HO') TML_WRK_DY_CD, IO_BND_CD, RC_FLG, AWK_CGO_FLG, TML_TRNS_MOD_CD, LOCL_TS_IND_CD" ).append("\n"); 
		query.append("           FROM (SELECT VRFY_RSLT_IND_CD, TML_SO_OFC_CTY_CD, TML_SO_SEQ, TML_SO_CNTR_LIST_SEQ, CNTR_STY_CD, CNTR_TPSZ_CD, DCGO_CLSS_CD, " ).append("\n"); 
		query.append("                        INV_GATE_OUT_DT, DECODE(TO_CHAR(INV_GATE_OUT_DT,'D'),7,'SA',1,'SU','WD') WRK_DY," ).append("\n"); 
		...
		query.append(" AND    H.TML_AGMT_SEQ        = GD.TML_AGMT_SEQ(+)" ).append("\n"); 
		query.append(" AND    H.TML_AGMT_VER_NO     = GD.TML_AGMT_VER_NO(+)" ).append("\n"); 
		query.append(" AND    DECODE(L.CNTR_STY_CD,'F',DECODE(L.LOCL_TS_IND_CD,'L','SVSSFL','SVSSTS'),DECODE(L.LOCL_TS_IND_CD,'T','SVSSTM','SVSSMT')) = GD.LGS_COST_CD" ).append("\n"); 
		query.append(" AND    GD.TML_AGMT_TP_CD      = 'T'" ).append("\n"); 
		query.append(" AND    GD.AUTO_CALC_FLG       = 'Y'" ).append("\n"); 
		query.append("-- AND    NVL(GD.THC_TP_CD,'T')  = 'G'" ).append("\n"); 
		query.append(" AND    NVL(GD.IO_BND_CD,'N')  = DECODE(NVL(GD.IO_BND_CD,'N'),'N','N','S','S',L.IO_BND_CD)" ).append("\n"); 
		...
		query.append("        L.CNTR_TPSZ_CD, L.DCGO_CLSS_CD, GD.TML_AGMT_VOL_UT_CD, NVL(GD.THC_TP_CD,'T')," ).append("\n"); 
		query.append("        DECODE(GD.TML_AGMT_VOL_UT_CD,'C',GC.AGMT_RT,GD.AGMT_UT_RT)," ).append("\n"); 
		query.append("        H.TML_AGMT_OFC_CTY_CD, H.TML_AGMT_SEQ, H.TML_AGMT_VER_NO, L.TML_TRNS_MOD_CD, L.RC_FLG, GD.CURR_CD, DECODE(@[curr_cd],GD.CURR_CD,'Y','N')" ).append("\n"); 
		query.append("        ) S, TES_LGS_COST D" ).append("\n"); 
		query.append("WHERE   S.LGS_COST_CD = D.LGS_COST_CD(+)" ).append("\n"); 
		query.append("ORDER BY LGS_COST_CD ASC, CNTR_TPSZ_CD ASC, DCGO_IND_CD ASC" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${agmt_cost_yn} == 'Y') " ).append("\n"); 
