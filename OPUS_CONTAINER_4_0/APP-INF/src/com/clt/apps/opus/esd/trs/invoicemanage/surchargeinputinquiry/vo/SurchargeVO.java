...
package com.clt.apps.opus.esd.trs.invoicemanage.surchargeinputinquiry.vo;
...
public class SurchargeVO extends AbstractValueObject {
	...
	/* Column Info */
	private String orgScgAmt = null;
	/* Column Info */
	private String scgDtlSeq = null;
	...
	public SurchargeVO(String ibflag, String pagerows, String uniqueCd, String trspSoOfcCtyCd, String trspSoSeq, String lgsCostCd, String scgAmt, String chssMgstTpszCd, String dryRunRlblPtyTpCd, String fneCuzDesc, String fumgCostTpCd, String mgstTpszCd, String inspRfPtiCstmsTpCd, String lftgKnt,
			String lftgCuzDesc, String stopLocNodCd, String grsWgt, String incrtDt, String sclStopPlcNodCd, String obBkgNo, String otrRmk, String invScgAmt, String invChssMgstTpszCd, String invDryRunRlblPtyTpCd, String invFneCuzDesc, String invFumgCostTpCd, String invMgstTpszCd,
			String invInspRfPtiCstmsTpCd, String invLftgKnt, String invLftgCuzDesc, String invStopLocNodCd, String invGrsWgt, String invIncrtDt, String invSclStopPlcNodCd, String invObBkgNo, String invOtrRmk, String n3ptyBilFlg, String custCntCd, String custSeq, String n3ptyVndrSeq,
			String n3ptyOfcCd, String n3ptyAmt, String n3ptyDesc, String creOfcCd, String stoDys, String wtHrs, String invStoDys, String invWtHrs, String loclCreDt, String loclUpdDt, String incurDt, String chssNo, String creUsrId, String creDt, String updUsrId, String updDt, String invIncurDt,
			String invChssNo, String fuelRto, String trspAgmtOfcCtyCd, String trspAgmtSeq, String trspAgmtRtTpSerNo, String trspAgmtScgNodSeq, String trspAgmtScgRtSeq,
			String comScgKndCd, String comScgSeq, String currCd, String orgScgAmt, String scgDtlSeq) {
		...
		this.currCd = currCd;
		this.orgScgAmt = orgScgAmt;
		this.scgDtlSeq = scgDtlSeq;
	}
	...
	public HashMap<String, String> getColumnValues() {
		...
		this.hashColumns.put("org_scg_amt", getOrgScgAmt());
		this.hashColumns.put("scg_dtl_seq", getScgDtlSeq());
	...
	public HashMap<String, String> getFieldNames() {
		...
		this.hashFields.put("org_scg_amt", "orgScgAmt");
		this.hashFields.put("scg_dtl_seq", "scgDtlSeq");
	...
	public String getOrgScgAmt() {
		return orgScgAmt;
	}

	public void setOrgScgAmt(String orgScgAmt) {
		this.orgScgAmt = orgScgAmt;
	}

	public String getScgDtlSeq() {
		return scgDtlSeq;
	}

	public void setScgDtlSeq(String scgDtlSeq) {
		this.scgDtlSeq = scgDtlSeq;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOrgScgAmt(JSPUtil.getParameter(request, prefix + "org_scg_amt", ""));
		setScgDtlSeq(JSPUtil.getParameter(request, prefix + "scg_dtl_seq", ""));
	}
	...
	public SurchargeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] orgScgAmt = (JSPUtil.getParameter(request, prefix + "org_scg_amt", length));
			String[] scgDtlSeq = (JSPUtil.getParameter(request, prefix + "scg_dtl_seq", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (orgScgAmt[i] != null)
					model.setOrgScgAmt(orgScgAmt[i]);
				if (scgDtlSeq[i] != null)
					model.setScgDtlSeq(scgDtlSeq[i]);
	...
	public void unDataFormat() {
		...
		this.orgScgAmt = this.orgScgAmt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.scgDtlSeq = this.scgDtlSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
