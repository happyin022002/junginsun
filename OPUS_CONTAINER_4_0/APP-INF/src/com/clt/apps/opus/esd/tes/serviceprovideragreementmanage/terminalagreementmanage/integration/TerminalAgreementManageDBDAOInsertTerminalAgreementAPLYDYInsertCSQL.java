...
*@FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementAPLYDYInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertTerminalAgreementAPLYDYInsertCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TMNL Agmt Aply Dy정보 생성
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertTerminalAgreementAPLYDYInsertCSQL(){
		setQuery();
		...
		params.put("sat_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("sun_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("tml_rt_dy_aply_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("wkdy_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("hol_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementAPLYDYInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
