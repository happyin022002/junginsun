...
*@FileName : InvoiceManageDBDAOSearchOtsGrpInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManageDBDAOSearchOtsGrpInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceManageDBDAOSearchOtsGrpInfoRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceManageDBDAOSearchOtsGrpInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    COUNT(DISTINCT N3PTY_EXPN_TP_CD) AS LENGTH_N3PTY_EXPN_TP_CD," ).append("\n"); 
