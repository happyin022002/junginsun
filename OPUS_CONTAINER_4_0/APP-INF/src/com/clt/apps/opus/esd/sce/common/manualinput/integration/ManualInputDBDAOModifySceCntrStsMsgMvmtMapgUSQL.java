...
*@FileName : ManualInputDBDAOModifySceCntrStsMsgMvmtMapgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualInputDBDAOModifySceCntrStsMsgMvmtMapgUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySceCntrStsMsgMvmtMapg
	  * </pre>
	  */
	public ManualInputDBDAOModifySceCntrStsMsgMvmtMapgUSQL(){
		setQuery();
		...
		params.put("csm_desc",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ManualInputDBDAOModifySceCntrStsMsgMvmtMapgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCE_CNTR_STS_MSG_MVMT_MAPG" ).append("\n"); 
		query.append("   SET STND_EDI_STS_CD = @[stnd_edi_sts_cd]," ).append("\n"); 
		query.append("       CSM_DESC = @[csm_desc]," ).append("\n"); 
		query.append("       EFF_FM_DT = @[eff_fm_dt]," ).append("\n"); 
		query.append("       EFF_TO_DT = @[eff_to_dt]," ).append("\n"); 
