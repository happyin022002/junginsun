...
*@FileName : ESD_TPB_0130HTMLAction.java
...
* 2009-10-12 Jong-Geon Byeon	1.1 Renewal Migration
=========================================================*/
...
public class ESD_TPB_0130HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0130HTMLAction 객체를 생성
	 */
	public ESD_TPB_0130HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0130Event event = new EsdTpb0130Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchProcessListVOS((SearchProcessListVO[])getVOs(request, SearchProcessListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchProcessListVO((SearchProcessListVO)getVO(request, SearchProcessListVO .class));
		}
