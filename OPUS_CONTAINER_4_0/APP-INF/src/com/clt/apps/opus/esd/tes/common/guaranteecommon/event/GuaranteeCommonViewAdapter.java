...
*@FileName : GuaranteeCommonViewAdapter.java
*@FileTitle : GuaranteeCommon 관리
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class GuaranteeCommonViewAdapter extends ViewAdapter{
	
    public GuaranteeCommonViewAdapter()
    {
