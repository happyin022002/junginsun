 ...
 *
 * @author byungheeyoo
 * @see EsdTes9075Event , ESD_TES_907_3_2EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_9075HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_907_3_2HTMLAction 객체를 생성
	 */
	public ESD_TES_9075HTMLAction() {
		log.debug("\n\n  constr - ESD_TES_907_3_2HTMLAction  \n\n");
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_907_3_2Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsdTes9075Event event = new EsdTes9075Event();
