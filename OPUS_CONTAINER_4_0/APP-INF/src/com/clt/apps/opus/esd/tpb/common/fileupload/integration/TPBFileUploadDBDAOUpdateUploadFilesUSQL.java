...
*@FileName : TPBFileUploadDBDAOUpdateUploadFilesUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TPBFileUploadDBDAOUpdateUploadFilesUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TPBFileUploadDBDAOUpdateUploadFilesUSQL(){
		setQuery();
		...
		query.append("FileName : TPBFileUploadDBDAOUpdateUploadFilesUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET file_lgc_nm = @[file_lgc_nm]," ).append("\n"); 
		query.append("       file_phys_nm = @[file_phys_nm], " ).append("\n"); 
