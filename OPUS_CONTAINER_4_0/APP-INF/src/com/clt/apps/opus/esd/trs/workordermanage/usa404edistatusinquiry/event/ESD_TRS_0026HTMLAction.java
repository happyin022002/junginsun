...
*@FileName : ESD_TRS_0026HTMLAction.java
 ...
 * - Parsing 한 정보를 Event로 변환, request에 담아 ESD_TRS_0026SC로 실행요청<br>
 * - ESD_TRS_0026SC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 *
 * @author Kildong_hong
 * @see EsdTrs0026Event , ESD_TRS_0026EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TRS_0026HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESD_TRS_0026HTMLAction 객체를 생성
	 */
	public ESD_TRS_0026HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TRS_0026Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0026Event event = new EsdTrs0026Event();
	    if (command.isCommand(FormCommand.SEARCH)) {
	    	...
	    	event.setTrsTrspRailBilVndrSetVOs((TrsTrspRailBilVndrSetVO[])getVOs(request, TrsTrspRailBilVndrSetVO.class));
	    }
