...
*@FileName : SearchBookingInfoVO.java
*@FileTitle : SearchBookingInfoVO
*Open Issues :
*Change history :
...
public class SearchBookingInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBookingInfoVO> models = new ArrayList<SearchBookingInfoVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dbl_iss_dt", getDblIssDt());
		...
		this.hashColumns.put("niv_iss_dt", getNivIssDt());
		...
		this.hashColumns.put("ani_iss_dt", getAniIssDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dbl_iss_dt", "dblIssDt");
		...
		this.hashFields.put("niv_iss_dt", "nivIssDt");
		...
		this.hashFields.put("ani_iss_dt", "aniIssDt");
	 ...
	 * @return dblIssDt
	 */
	public String getDblIssDt() {
		return this.dblIssDt;
	}
	 ...
	 * @return nivIssDt
	 */
	public String getNivIssDt() {
		return this.nivIssDt;
	}
	 ...
	 * @return aniIssDt
	 */
	public String getAniIssDt() {
		return this.aniIssDt;
	}
	 ...
	 * @param dblIssDt
	 */
	public void setDblIssDt(String dblIssDt) {
		this.dblIssDt = dblIssDt;
	}
	 ...
	 * @param nivIssDt
	 */
	public void setNivIssDt(String nivIssDt) {
		this.nivIssDt = nivIssDt;
	}
	 ...
	 * @param aniIssDt
	 */
	public void setAniIssDt(String aniIssDt) {
		this.aniIssDt = aniIssDt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDblIssDt(JSPUtil.getParameter(request, "dbl_iss_dt", ""));
		...
		setNivIssDt(JSPUtil.getParameter(request, "niv_iss_dt", ""));
		...
		setAniIssDt(JSPUtil.getParameter(request, "ani_iss_dt", ""));
	 ...
	 * @param request
	 * @return SearchBookingInfoVO[]
	 */
	public SearchBookingInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBookingInfoVO[]
	 */
	public SearchBookingInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBookingInfoVO model = null;
		...
		try {
			...
			String[] dblIssDt = (JSPUtil.getParameter(request, prefix	+ "dbl_iss_dt", length));
			...
			String[] nivIssDt = (JSPUtil.getParameter(request, prefix	+ "niv_iss_dt", length));
			...
			String[] aniIssDt = (JSPUtil.getParameter(request, prefix	+ "ani_iss_dt", length));
		...
		return getSearchBookingInfoVOs();
	}
	 ...
	 * @return SearchBookingInfoVO[]
	 */
	public SearchBookingInfoVO[] getSearchBookingInfoVOs(){
		SearchBookingInfoVO[] vos = (SearchBookingInfoVO[])models.toArray(new SearchBookingInfoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.dblIssDt = this.dblIssDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.nivIssDt = this.nivIssDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.aniIssDt = this.aniIssDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
