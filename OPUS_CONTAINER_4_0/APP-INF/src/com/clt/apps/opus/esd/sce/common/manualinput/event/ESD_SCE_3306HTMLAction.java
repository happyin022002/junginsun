 ...
 * @since J2EE 1.6
 */
public class ESD_SCE_3306HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_2003HTMLAction 객체를 생성
	 */
	public ESD_SCE_3306HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce3306Event event = new EsdSce3306Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFrmSplcCd(JSPUtil.getParameter(request, "frm_splc_cd"));
			event.setFrmSplcVndrNm(JSPUtil.getParameter(request, "frm_splc_vndr_nm"));
			event.setFrmYdCd(JSPUtil.getParameter(request, "frm_yd_cd"));
			event.setSceRailSplcVO((SceRailSplcVO)getVO(request, SceRailSplcVO .class));
			...
			event.setSceRailSplcVOs((SceRailSplcVO[])getVOs(request, SceRailSplcVO .class));
		}
