...
*@FileName : OndockRailChargeInvoiceManageDBDAOUpdateOnDockRvisVolUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OndockRailChargeInvoiceManageDBDAOUpdateOnDockRvisVolUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OndockRailChargeInvoiceManageDBDAOUpdateOnDockRvisVolUSQL(){
		setQuery();
		...
		query.append("FileName : OndockRailChargeInvoiceManageDBDAOUpdateOnDockRvisVolUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INV_AMT = @[rvis_vol_qty] * @[ctrt_rt]" ).append("\n"); 
