...
*@FileName : JOInvoiceManageDBDAOModifyInvoiceRvisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOInvoiceManageDBDAOModifyInvoiceRvisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOInvoiceManageDBDAOModifyInvoiceRvisCSQL(){
		setQuery();
		...
		params.put("s_clt_agn_rmk",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : JOInvoiceManageDBDAOModifyInvoiceRvisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL TPB_INV_RVIS_PKG.UPD_INV_RVIS(" ).append("\n"); 
		...
		query.append(", @[s_clt_agn_rmk]" ).append("\n"); 
		query.append(", @[s_ida_tax_seq]" ).append("\n"); 
