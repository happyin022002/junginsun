...
*@FileName : SingleTransportationSOManageDBDAOCyDoorCombineSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SingleTransportationSOManageDBDAOCyDoorCombineSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SingleTransportationSOManageDBDAOCyDoorCombineSeqRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esd.trs.cydoorsomanage.singletransportationsomanage.integration").append("\n"); 
		query.append("FileName : SingleTransportationSOManageDBDAOCyDoorCombineSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
