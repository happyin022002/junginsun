...
*@FileName : ESD_TES_925_2Event.java
...
/**
 * ESD_TES_925_2 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESD_TES_925_2HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.4
 */
public class EsdTes9252Event extends EventSupport {
	private TesN3rdPtyIfVO tesN3rdPtyIfVO = null;

	public EsdTes9252Event(){}

	public String getEventName() {
		return "EsdTes9252Event";
	}
...
/*	public EsdTes9252Event(TES_N3RD_PTY_IF tes_n3rd_pty_if) {
		this.tes_n3rd_pty_if = tes_n3rd_pty_if;
    }

	public EsdTes9252Event(TES_N3RD_PTY_IF tes_n3rd_pty_if, Collection tes_n3rd_pty_ifs) {
		this.tes_n3rd_pty_if = tes_n3rd_pty_if;
