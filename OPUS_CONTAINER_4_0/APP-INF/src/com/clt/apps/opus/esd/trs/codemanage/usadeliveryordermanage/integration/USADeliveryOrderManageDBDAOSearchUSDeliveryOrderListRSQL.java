...
public class USADeliveryOrderManageDBDAOSearchUSDeliveryOrderListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  Y.IF_SYS_KND_CD," ).append("\n"); 
		...
		query.append("                  AND PU.BKG_REF_TP_CD = 'CTPO' ), CHR(13)||CHR(10), ',') AS PO_No," ).append("\n"); 
		...
		query.append("      A.MTY_RTN_YD_CD MTY_RTN_CY," ).append("\n"); 
		...
		query.append("	  B.IF_SYS_KND_CD," ).append("\n"); 
