...
*@FileName : SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListUsAsiaCreateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListUsAsiaCreateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSingleTransportationSOCandidatesListUsAsiaCreate
	  * </pre>
	  */
	public SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListUsAsiaCreateRSQL(){
		setQuery();
		...
		query.append("FileName : SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListUsAsiaCreateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , (SELECT SUBSTR(COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD00286', B.TRSP_SO_STS_CD), 1, 64) FROM DUAL) TRSP_SO_STS_NM" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("      AND NVL2(@[stop_off_flg], NVL2(C.STOP_OFF_LOC_CD, 'Y', 'N'), 'X') =  NVL(@[stop_off_flg], 'X')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    #if ($arr_so_office.size() > 0) " ).append("\n"); 
		...
		query.append("    AND ((AA.TRSP_COST_DTL_MOD_CD = 'CY' AND AA.EQ_NO <> 'COMU0000000')  OR (AA.TRSP_COST_DTL_MOD_CD = 'DR'))" ).append("\n"); 
		query.append("    AND TRO_SEQ IS NULL" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("    AND (" ).append("\n"); 
		query.append("          (AA.TRSP_COST_DTL_MOD_CD = 'CY' AND DECODE(@[ui_conti_cd], 'A', DECODE(AA.PCTL_IO_BND_CD, 'O', '00000000000', 'T', '00000000000', AA.EQ_NO), AA.EQ_NO) <> 'COMU0000000')  OR " ).append("\n"); 
		query.append("          (AA.PCTL_IO_BND_CD = 'I' AND (AA.TRSP_COST_DTL_MOD_CD = 'DR' AND (AA.TRO_SEQ IS NOT NULL OR (AA.PCTL_IO_BND_CD = 'I' AND AA.POD_CONTI_CD = 'M') OR AA.FM_LOC_CONTI_CD = 'A')) AND AA.EQ_NO <> 'COMU0000000') OR" ).append("\n"); 
		...
		query.append("    AND (SELECT DTL.DOR_PST_NO" ).append("\n"); 
		query.append("           FROM BKG_TRO DTL" ).append("\n"); 
