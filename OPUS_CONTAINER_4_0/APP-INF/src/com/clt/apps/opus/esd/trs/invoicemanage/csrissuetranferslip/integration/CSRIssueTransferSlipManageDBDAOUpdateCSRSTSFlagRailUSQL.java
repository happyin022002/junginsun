...
*@FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRSTSFlagRailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOUpdateCSRSTSFlagRailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateCSRSTSFlagRail
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOUpdateCSRSTSFlagRailUSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRSTSFlagRailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET		WRK.TRSP_INV_AUD_STS_CD 	= @[TRSP_INV_AUD_STS_CD]" ).append("\n"); 
