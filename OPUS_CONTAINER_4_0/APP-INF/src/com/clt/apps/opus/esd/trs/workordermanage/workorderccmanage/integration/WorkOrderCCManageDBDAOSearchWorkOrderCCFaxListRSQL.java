...
public class WorkOrderCCManageDBDAOSearchWorkOrderCCFaxListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",   DECODE(E.WO_FAX_NO, NULL, '0', '1' ) TRS_CHK_ORG" ).append("\n"); 
		...
		query.append("AND M.INTL_FAX_NO = REGEXP_SUBSTR(E.WO_FAX_NO(+), '[^-]+', 1, 1)" ).append("\n"); 
		query.append("AND M.FAX_NO = SUBSTR(E.WO_FAX_NO(+), INSTR(E.WO_FAX_NO(+), '-', 1, 2))" ).append("\n"); 
