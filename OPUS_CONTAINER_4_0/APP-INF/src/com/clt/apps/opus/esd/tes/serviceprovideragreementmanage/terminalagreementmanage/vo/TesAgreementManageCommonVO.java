...
public class TesAgreementManageCommonVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tonne_rate", getTonneRate());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tonne_rate", "tonneRate");
	 ...
	 * @return tonneRate
	 */
	public String getTonneRate() {
		return this.tonneRate;
	}
	 ...
	 * @param tonneRate
	 */
	public void setTonneRate(String tonneRate) {
		this.tonneRate = tonneRate;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTonneRate(JSPUtil.getParameter(request, prefix + "tonne_rate", ""));
	...
	public TesAgreementManageCommonVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] tonneRate = (JSPUtil.getParameter(request, prefix	+ "tonne_rate", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (tonneRate[i] != null)
					model.setTonneRate(tonneRate[i]);
				if (r2[i] != null)
					model.setR2(r2[i]);
				if (t2Fd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.tonneRate = this.tonneRate .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
