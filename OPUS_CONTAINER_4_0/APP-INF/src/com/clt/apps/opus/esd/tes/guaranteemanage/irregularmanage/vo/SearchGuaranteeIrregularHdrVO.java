...
*@FileName : SearchGuaranteeIrregularHdrVO.java
*@FileTitle : SearchGuaranteeIrregularHdrVO
*Open Issues :
*Change history :
...
public class SearchGuaranteeIrregularHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchGuaranteeIrregularHdrVO> models = new ArrayList<SearchGuaranteeIrregularHdrVO>();
	 ...
	 * @param request
	 * @return SearchGuaranteeIrregularHdrVO[]
	 */
	public SearchGuaranteeIrregularHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchGuaranteeIrregularHdrVO[]
	 */
	public SearchGuaranteeIrregularHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchGuaranteeIrregularHdrVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchGuaranteeIrregularHdrVO();
				if (currCd[i] != null)
		...
		return getSearchGuaranteeIrregularHdrVOs();
	}
	 ...
	 * @return SearchGuaranteeIrregularHdrVO[]
	 */
	public SearchGuaranteeIrregularHdrVO[] getSearchGuaranteeIrregularHdrVOs(){
		SearchGuaranteeIrregularHdrVO[] vos = (SearchGuaranteeIrregularHdrVO[])models.toArray(new SearchGuaranteeIrregularHdrVO[models.size()]);
		return vos;
	}
