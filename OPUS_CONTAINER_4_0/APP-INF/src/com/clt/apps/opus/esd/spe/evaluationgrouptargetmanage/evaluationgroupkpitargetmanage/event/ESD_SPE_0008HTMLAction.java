...
*@FileName : ESD_SPE_0008HTMLAction.java
...
public class ESD_SPE_0008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SPE_0008HTMLAction 객체를 생성
	 */
	public ESD_SPE_0008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSpe0008Event event = new EsdSpe0008Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSpeEvGrpKpiTgtRtoVOS((SpeEvGrpKpiTgtRtoVO[])getVOs(request, SpeEvGrpKpiTgtRtoVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchEGKpiTargetConditionVO((SearchEGKpiTargetConditionVO)getVO(request, SearchEGKpiTargetConditionVO .class));
		}
