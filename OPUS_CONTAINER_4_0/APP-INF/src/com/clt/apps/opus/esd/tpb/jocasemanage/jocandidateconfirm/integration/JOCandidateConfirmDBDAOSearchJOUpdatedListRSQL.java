...
*@FileName : JOCandidateConfirmDBDAOSearchJOUpdatedListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOCandidateConfirmDBDAOSearchJOUpdatedListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOCandidateConfirmDBDAOSearchJOUpdatedListRSQL(){
		setQuery();
		...
		query.append("FileName : JOCandidateConfirmDBDAOSearchJOUpdatedListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       WHEN 'V' THEN TO_CHAR(A.VNDR_SEQ)" ).append("\n"); 
		query.append("       WHEN 'C' THEN A.CUST_CNT_CD||A.CUST_SEQ" ).append("\n"); 
