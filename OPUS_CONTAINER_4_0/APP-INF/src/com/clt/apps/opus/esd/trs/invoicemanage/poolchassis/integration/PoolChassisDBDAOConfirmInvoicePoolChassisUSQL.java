...
*@FileName : PoolChassisDBDAOConfirmInvoicePoolChassisUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PoolChassisDBDAOConfirmInvoicePoolChassisUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice 상태를 Confirm 상태로 변경
	  * </pre>
	  */
	public PoolChassisDBDAOConfirmInvoicePoolChassisUSQL(){
		setQuery();
		...
		query.append("FileName : PoolChassisDBDAOConfirmInvoicePoolChassisUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,INV_CFM_DT          = GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(CRE_OFC_CD)" ).append("\n"); 
