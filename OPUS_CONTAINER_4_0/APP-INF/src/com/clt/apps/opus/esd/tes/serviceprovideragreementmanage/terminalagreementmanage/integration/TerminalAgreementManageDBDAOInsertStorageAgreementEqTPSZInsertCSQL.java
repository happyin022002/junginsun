...
*@FileName : TerminalAgreementManageDBDAOInsertStorageAgreementEqTPSZInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertStorageAgreementEqTPSZInsertCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertStorageAgreementEqTPSZInsertCSQL(){
		setQuery();
		...
		params.put("eq_aply_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertStorageAgreementEqTPSZInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TES_TML_AGMT_EQ_TP_SZ (" ).append("\n"); 
		...
		query.append("		, eq_aply_tp_cd" ).append("\n"); 
