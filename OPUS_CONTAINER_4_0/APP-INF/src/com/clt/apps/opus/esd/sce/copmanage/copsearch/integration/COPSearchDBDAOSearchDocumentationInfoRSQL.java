...
public class COPSearchDBDAOSearchDocumentationInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", (SELECT MIN(NVL(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(), cre_dt, BKG_COM_USER_LOC_FNC(cre_usr_id)), cre_dt)) cre_dt FROM BKG_CHG_RT WHERE BKG_NO  = bb.bkg_no ) ofc_date" ).append("\n"); 
