...
public class MarineTerminalInvoiceCommonVO extends AbstractValueObject {
	...
	/* Column Info */
	private String rvisInsFlg = null;
	/* Column Info */
	...
	public MarineTerminalInvoiceCommonVO(String ibflag, String pagerows, String tmpIfAmt, String rvisCalcCostGrpCd, String tempLgsCostCd, String vvdType, String rvisCntrTpszCd, String revisedvolSum, String tmpCostCd, String rvisDiv, String fmTp, String rvisRmk, String rvisTmlSoRvisListSeq, String vvdSkdDirCd, String vvdSkdVoyNo2, String vvdSkdVoyNo, String tmlSoDtlSeq, String rvisLgsCostCd, String tmpCtrtRt, String reverifyYn, String deleteMode, String rvisRhndRsnCd, String tmpInvXchRt, String costCalcFlg, String invDateType, String delIfSeq, String vvd2, String rvisTmlSoDtlSeq, String rvisTmlSoSeq, String rvisTmlSoOfcCtyCd, String tsTp, String rvisLoclCreDt, String rvisCntrNo, String tmlSoSeq, String rvisGateInFlg, String rvisCreDt, String revisedvolMinus, String tmpDtlSeq, String allTp, String costCode, String rvisCreUsrId, String fileImportYn, String rvisIndFlg, String vvdVslCd, String cntrStyCode, String rvisLoclUpdDt, String rvisUpdDt, String rvisTmlInvTpCd, String delCntrSeq, String flgYn, String tmpCalcVolQty, String woNo, String rvisBkgNo, String rvisCntrStyCd, String rvisVslCd, String tmpRvisVolQty, String srcOfc, String ioBndCd2, String rvisInvGateOutDt, String rvisGateOutFlg, String rvisSkdVoyNo, String rvisTmlRvisTpCd, String rvisCuzCntrNo, String rvisUpdUsrId, String rvisTmlSoCntrListSeq, String rvisInvGateInDt, String atbDt2, String rvisSkdDirCd, String tmlSoOfcCtyCd, String rvisInsFlg) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rvis_ins_flg", getRvisInsFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rvis_ins_flg", "rvisInsFlg");
	 ...
	 * @return rvisInsFlg
	 */
	public String getRvisInsFlg() {
		return this.rvisInsFlg;
	}
	 ...
	 * @param rvisInsFlg
	 */
	public void setRvisInsFlg(String rvisInsFlg) {
		this.rvisInsFlg = rvisInsFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRvisInsFlg(JSPUtil.getParameter(request, prefix + "rvis_ins_flg", ""));
	...
	public MarineTerminalInvoiceCommonVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] rvisInsFlg = (JSPUtil.getParameter(request, prefix	+ "rvis_ins_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (rvisInsFlg[i] != null)
					model.setRvisInsFlg(rvisInsFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.rvisInsFlg = this.rvisInsFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
