...
*@FileName : AgreementCorrectionDBDAOManageAgmtAttachFileListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAOManageAgmtAttachFileListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRS_AGMT_IMG_STO에서 ROW를 삭제하는 SQL
	  * </pre>
	  */
	public AgreementCorrectionDBDAOManageAgmtAttachFileListDSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAOManageAgmtAttachFileListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM TRS_AGMT_IMG_STO" ).append("\n"); 
