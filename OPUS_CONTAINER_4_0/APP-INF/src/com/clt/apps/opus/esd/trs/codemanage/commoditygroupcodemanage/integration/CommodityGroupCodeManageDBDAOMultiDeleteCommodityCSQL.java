...
*@FileName : CommodityGroupCodeManageDAOMultiDeleteCommodityCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityGroupCodeManageDBDAOMultiDeleteCommodityCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rail VENDOR 별 GROUP COMMODITY 재 정의하여 입력
	  * </pre>
	  */
	public CommodityGroupCodeManageDBDAOMultiDeleteCommodityCSQL(){
		setQuery();
		...
		query.append("FileName : CommodityGroupCodeManageDAOMultiDeleteCommodityCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
