...
public class LocationDetail implements java.io.Serializable {
	...
	public YardDetail[] getYardDetailList() {
		YardDetail[] rtnList = null;
		if(this.yardDetailList != null){
			rtnList = Arrays.copyOf(yardDetailList, yardDetailList.length);
		}
		return rtnList;
	}
	/**
	...
	public void setYardDetailList(YardDetail[] yardDetailList) {
		if(yardDetailList != null){
			YardDetail[] tmpList = Arrays.copyOf(yardDetailList, yardDetailList.length);
			this.yardDetailList = tmpList;
		}
	}
