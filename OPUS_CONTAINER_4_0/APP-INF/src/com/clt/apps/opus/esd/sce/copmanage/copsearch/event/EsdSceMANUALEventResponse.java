...
public class EsdSceMANUALEventResponse extends EventResponseSupport {
	 ...
	 */
	public EsdSceMANUALEventResponse() {
	}
	 ...
	 * @param rowSet ���� ���� ���
	 */
	public EsdSceMANUALEventResponse(DBRowSet rowSet) {
		this.rowSet = rowSet;
	}
	 ...
	 * @param successFlag �����
	 */
	public EsdSceMANUALEventResponse(DBRowSet rowSet, String successFlag) {
		this.rowSet=rowSet;
	...
	public String toString() {
		return "EsdSceMANUALEventResponse";
	}
