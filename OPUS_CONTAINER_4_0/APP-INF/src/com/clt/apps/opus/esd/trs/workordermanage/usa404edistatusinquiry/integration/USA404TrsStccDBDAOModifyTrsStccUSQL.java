...
*@FileName : USA404TrsStccDBDAOModifyTrsStccUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404TrsStccDBDAOModifyTrsStccUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public USA404TrsStccDBDAOModifyTrsStccUSQL(){
		setQuery();
		...
		query.append("FileName : USA404TrsStccDBDAOModifyTrsStccUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TRS_STCC" ).append("\n"); 
		query.append("   SET UN_CMDT_CD = @[un_cmdt_cd]" ).append("\n"); 
		query.append("      ,IMDG_UN_NO_SEQ = @[imdg_un_no_seq]" ).append("\n"); 
		query.append("      ,HZD_MTRL_CLSS_CD = @[hzd_mtrl_clss_cd]" ).append("\n"); 
		query.append("      ,PCK_GRP_CD = @[pck_grp_cd]" ).append("\n"); 
		query.append("      ,PCK_GRP_VAL_CD = @[pck_grp_val_cd]" ).append("\n"); 
