...
*@FileName : TerminalAgreementManageDBDAODeleteAgreement_modifyDelete02DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAODeleteAgreement_modifyDelete02DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAODeleteAgreement_modifyDelete02DSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAODeleteAgreement_modifyDelete02DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE TES_TML_AGMT_APLY_DY" ).append("\n"); 
