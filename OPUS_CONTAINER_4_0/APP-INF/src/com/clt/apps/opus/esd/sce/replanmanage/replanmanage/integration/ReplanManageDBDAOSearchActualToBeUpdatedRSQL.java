...
public class ReplanManageDBDAOSearchActualToBeUpdatedRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   ACT_RCV_DT AS ACT_RCV_DT, " ).append("\n"); 
		query.append("   ACT_RCV_NO AS ACT_RCV_NO," ).append("\n"); 
		query.append("   CNTR_NO CNTR_NO," ).append("\n"); 
		query.append("   COP_NO COP_NO," ).append("\n"); 
		query.append("   ACT_DT ACT_DT," ).append("\n"); 
		query.append("   ACT_STS_MAPG_CD ACT_STS_MAPG_CD ," ).append("\n"); 
		query.append("   COP_DTL_SEQ  COP_DTL_SEQ ," ).append("\n"); 
		...
		query.append("   EDI_SND_RSLT_FLG EDI_SND_RSLT_FLG," ).append("\n"); 
		query.append("   USR_ID USR_ID," ).append("\n"); 
		query.append("   ACT_UMCH_TP_CD ACT_UMCH_TP_CD ," ).append("\n"); 
		query.append("   CLPT_IND_SEQ CLPT_IND_SEQ," ).append("\n"); 
		query.append("   ACT_DAT_RCV_DT  ACT_DAT_RCV_DT," ).append("\n"); 
		...
		query.append("              RANK() OVER (PARTITION BY ACT_STS_MAPG_CD, NOD_CD" ).append("\n"); 
		query.append("                ORDER BY ACT_RCV_NO DESC) AS RNK," ).append("\n"); 
		...
		query.append("        WHERE COP_NO = @[cop_no]" ).append("\n"); 
		query.append("          AND COP_STS_CD NOT IN ('X','O') ) V," ).append("\n"); 
		...
		query.append("      AND AD.ACT_UMCH_TP_CD NOT IN ('00','XX')" ).append("\n"); 
		...
		query.append("    WHERE RNK =  1" ).append("\n"); 
		query.append("    )" ).append("\n"); 
		query.append("    ORDER BY ACT_RCV_NO" ).append("\n"); 
