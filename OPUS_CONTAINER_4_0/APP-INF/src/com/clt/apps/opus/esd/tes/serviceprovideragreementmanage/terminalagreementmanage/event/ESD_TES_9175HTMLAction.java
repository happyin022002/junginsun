...
*@FileName : ESD_TES_9175HTMLAction.java
 ...
 * @author yOng hO lEE
 * @see EsdTes9175Event 참조
 * @since J2EE 1.6
 */
public class ESD_TES_9175HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_9175HTMLAction 객체를 생성
	 */
	public ESD_TES_9175HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes9175Event	event	= new EsdTes9175Event();
