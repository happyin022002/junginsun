...
*@FileName : EvaluationGroupManageDBDAOSpeEvGrpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EvaluationGroupManageDBDAOSpeEvGrpCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EvaluationGroupManageDBDAOSpeEvGrpCSQL(){
		setQuery();
		...
		query.append("FileName : EvaluationGroupManageDBDAOSpeEvGrpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SPE_EV_GRP (" ).append("\n"); 
		...
		query.append("EG_PIC_USR_ID," ).append("\n"); 
		...
		query.append("@[eg_id_seq]," ).append("\n"); 
		query.append("@[eg_rhq_cd]," ).append("\n"); 
		query.append("UPPER(@[eg_cty_cd])," ).append("\n"); 
		query.append("DECODE(@[svc_cate_cd],'Truck','TR',	 'Rail','RL',	  'ODCY','CY', 'Terminal','TM',	 'Water','WT', 'EQ M&R','EQ')," ).append("\n"); 
		query.append("@[eg_pic_usr_id]," ).append("\n"); 
		query.append("@[cre_usr_id]," ).append("\n"); 
