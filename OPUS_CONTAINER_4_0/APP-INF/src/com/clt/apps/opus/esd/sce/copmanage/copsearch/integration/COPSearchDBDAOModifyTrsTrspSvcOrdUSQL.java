...
*@FileName : COPSearchDBDAOUpdateTrsTrspSvcOrdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class COPSearchDBDAOModifyTrsTrspSvcOrdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public COPSearchDBDAOModifyTrsTrspSvcOrdUSQL(){
		setQuery();
		...
		query.append("FileName : COPSearchDBDAOUpdateTrsTrspSvcOrdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
