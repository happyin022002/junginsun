...
*@FileName : CommonCodeDBDAOSearchIsTPBOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonCodeDBDAOSearchIsTPBOfficeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonCodeDBDAOSearchIsTPBOfficeRSQL(){
		SetQuery();
		...
		query.append("FileName : CommonCodeDBDAOSearchIsTPBOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void SetQuery(){
		query.append("SELECT DECODE( SIGN(COUNT(0)), 1, 'Y', 'N') AS is_tpboffice" ).append("\n");
