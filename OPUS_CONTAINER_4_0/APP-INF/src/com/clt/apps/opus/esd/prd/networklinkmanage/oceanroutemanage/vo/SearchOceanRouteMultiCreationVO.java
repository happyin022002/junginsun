...
*@FileName : SearchOceanRouteMultiCreationVO.java
*@FileTitle : SearchOceanRouteMultiCreationVO
*Open Issues :
*Change history :
...
public class SearchOceanRouteMultiCreationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOceanRouteMultiCreationVO> models = new ArrayList<SearchOceanRouteMultiCreationVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tot_tt_st", getTotTtSt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tot_tt_st", "totTtSt");
	 ...
	 * @param totTtSt
	 */
	public void setTotTtSt(String totTtSt) {
		this.totTtSt = totTtSt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTotTtSt(JSPUtil.getParameter(request, "tot_tt_st", ""));
		setLinkValidFlg(JSPUtil.getParameter(request, "link_valid_flg", ""));
	}
	 ...
	 */
	public SearchOceanRouteMultiCreationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOceanRouteMultiCreationVO[]
	 */
	public SearchOceanRouteMultiCreationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOceanRouteMultiCreationVO model = null;
		...
		try {
			...
			String[] totTtSt = (JSPUtil.getParameter(request, prefix	+ "tot_tt_st", length));
			String[] linkValidFlg = (JSPUtil.getParameter(request, prefix	+ "link_valid_flg", length));
			
			
			for (int i = 0; i < length; i++) {
				model = new SearchOceanRouteMultiCreationVO();
				if (p1[i] != null)
					model.setP1(p1[i]);
				if (fmtTotTt[i] != null)
		...
		return getSearchOceanRouteMultiCreationVOs();
	}
	...
	public SearchOceanRouteMultiCreationVO[] getSearchOceanRouteMultiCreationVOs(){
		SearchOceanRouteMultiCreationVO[] vos = (SearchOceanRouteMultiCreationVO[])models.toArray(new SearchOceanRouteMultiCreationVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.totTtSt = this.totTtSt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
