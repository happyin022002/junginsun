...
* 2009-11-19 Sun, CHOI      1.2 Renewal Migration
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esd.tpb.codemanage 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class CommonCodeHTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		event.setAttribute("row", JSPUtil.getParameter(request, "row"));
		}
