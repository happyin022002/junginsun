...
*@FileName : MarineTerminalInvoiceManageDBDAORemoveTerminalInvoiceRvisListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAORemoveTerminalInvoiceRvisListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAORemoveTerminalInvoiceRvisListDSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAORemoveTerminalInvoiceRvisListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
