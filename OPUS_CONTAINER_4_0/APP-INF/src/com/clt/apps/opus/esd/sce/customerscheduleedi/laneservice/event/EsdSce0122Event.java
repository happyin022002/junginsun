...
public class EsdSce0122Event extends EventSupport {
	...
	public SearchLaneServiceVO[] getSearchLaneServiceVOs() {
		SearchLaneServiceVO[] rtnVOs = null;
		if (this.laneServiceVOs != null) {
			rtnVOs = Arrays.copyOf(laneServiceVOs, laneServiceVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setSearchLaneServiceVOs(SearchLaneServiceVO[] laneServiceVOs) {
		if(laneServiceVOs != null){
			SearchLaneServiceVO[] tmpVOs = Arrays.copyOf(laneServiceVOs, laneServiceVOs.length);
			this.laneServiceVOs = tmpVOs;
		}
	}
