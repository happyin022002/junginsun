...
*@FileName : WorkOrderPreviewDBDAOSearchWorkOrderNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOSearchWorkOrderNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOSearchWorkOrderNoRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOSearchWorkOrderNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TMP.TRSP_WO_OFC_CTY_CD || TMP.TRSP_WO_SEQ WO_NM" ).append("\n"); 
