 ...
 * @since J2EE 1.4
 */
public class EsdTrs0979Event extends EventSupport {
	...
	/** ESD_TRS_906Event */
	public EsdTrs0979Event(){}

	/** ESD_TRS_906Event 
	 * 
	 * @param mdmYd
	 */
	public EsdTrs0979Event(COM_USER mdmYd) {
		this.mdmYd = mdmYd;
    }
	 ...
	 * @param mdmYds
	 */
	public EsdTrs0979Event(COM_USER mdmYd, Collection mdmYds) {
		this.mdmYd = mdmYd;
		this.mdmYds = mdmYds;
    }
