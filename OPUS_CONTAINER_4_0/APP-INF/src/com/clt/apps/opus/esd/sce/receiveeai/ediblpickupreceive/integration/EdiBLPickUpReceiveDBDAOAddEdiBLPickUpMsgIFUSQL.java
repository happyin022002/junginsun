...
*@FileName : EdiBLPickUpReceiveDBDAOAddEdiBLPickUpMsgIFUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EdiBLPickUpReceiveDBDAOAddEdiBLPickUpMsgIFUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EdiBLPickUpReceiveDBDAOAddEdiBLPickUpMsgIFUSQL(){
		setQuery();
		...
		params.put("BKG_NBR",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : EdiBLPickUpReceiveDBDAOAddEdiBLPickUpMsgIFUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		     USING ( SELECT TO_DATE(@[SYS_DT], 'yyyy/mm/dd HH24:MI:SS') iEVNT_DT, @[CNTR_NBR] iEQ_NO,@[EVENT_STS] iEDI_STS_CD, " ).append("\n"); 
		query.append("                       @[YARD_CD] iNOD_CD, @[BL_NBR] iBL_EDI_322_NO, @[PICK_NBR] iPKUP_EDI_322_NO,                                                           " ).append("\n"); 
		query.append("		 			    sysdate iCRE_DT,sysdate iUPD_DT, 'SYSTEM' iCRE_USR_ID, 'SYSTEM' iUPD_USR_ID  FROM DUAL ) S	                                                    " ).append("\n"); 
		...
		query.append("		 				    D.BL_EDI_322_NO, D.PKUP_EDI_322_NO" ).append("\n"); 
		...
		query.append("		 		 S.iBL_EDI_322_NO, S.iPKUP_EDI_322_NO" ).append("\n"); 
