...
public class OceanRouteConditionManageDBDAO extends DBDAOSupport {
	private static final long serialVersionUID = -311526002549008593L;
	...
	/**
	 * OceanRouteConditionManageDBDAO's searchCallingTmlMtxExptList ★2009-09-17 kim kwijin생성
	 * 
	 * @param vo
	 * @return
	 * @throws DAOException
	...
	/**
	 * oceanRouteCondiInsert ★2009-09-16 kim kwijin생성
	 * 
	 * @param insModels
	 * @return
	 * @throws DAOException
	...
	/**
	 * oceanRouteCondiUpdate ★2009-09-16 kim kwijin생성
	 * 
	 * @param insModels
	 * @return
	 * @throws DAOException
	...
	/**
	 * oceanRouteCondiDelete ★2009-09-16 kim kwijin생성
	 * 
	 * @param insModels
	 * @return
	 * @throws DAOException
	...
	/**
	 * oceanRouteCondiHistoryAdd ★2009-09-16 kim kwijin생성
	 * 
	 * @param insModels
	 * @return
	 * @throws DAOException
	...
	/**
	 * oceanRouteCondiHistoryMax ★2009-09-16 kim kwijin생성
	 * 
	 * @param vo
	 * @return
	 * @throws DAOException
	...
	/**
	 * OceanRouteConditionManageDBDAO's searchEmbargoManageList ★2009-09-18 kim kwijin생성
	 * 
	 * @param vo
	 * @return
	 * @throws DAOException
	...
	/**
	 * insertEmbargo ★2009-09-18 kim kwijin생성
	 * 
	 * @param models
	 * @return
	 * @throws DAOException
	...
	/**
	 * updateEmbargo ★2009-09-18 kim kwijin생성
	 * 
	 * @param models
	 * @return
	 * @throws DAOException
	...
	/**
	 * deleteEmbargo ★2009-09-18 kim kwijin생성
	 * 
	 * @param models
	 * @return
	 * @throws DAOException
	...
	/**
	 * mergeCallingTmlMtxExpt ★2009-09-17 kim kwijin생성
	 * 
	 * @param vo
	 * @return
	 * @throws DAOException
	...
	/**
	 * deleteCallingTmlMtxExpt ★2009-09-17 kim kwijin생성
	 * 
	 * @param delModels
	 * @return
	 * @throws DAOException
	 ...
	 * @throws DAOException
	 */
	public int checkDupOceanLink(SearchOceanRouteConditionVO searchOceanRouteConditionVO) throws DAOException {
		DBRowSet dbRowset = null;
		int retVal = 0;
		try {
			Map<String, Object> param = new HashMap<String, Object>();
			if (searchOceanRouteConditionVO != null) {
				Map<String, String> mapVO = searchOceanRouteConditionVO.getColumnValues();
				param.putAll(mapVO);
			}
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new OceanRouteConditionManageDBDAOCheckDupTmlMtxRSQL(), param, null);
			if (dbRowset.next()) {
