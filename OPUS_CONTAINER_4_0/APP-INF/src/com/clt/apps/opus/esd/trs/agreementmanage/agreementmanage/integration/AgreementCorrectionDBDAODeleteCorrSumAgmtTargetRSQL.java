...
*@FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtTargetRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAODeleteCorrSumAgmtTargetRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Rate아래의 모든 Rate를 삭제하기전 삭제대상을 조회한다.
	  * </pre>
	  */
	public AgreementCorrectionDBDAODeleteCorrSumAgmtTargetRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtTargetRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
