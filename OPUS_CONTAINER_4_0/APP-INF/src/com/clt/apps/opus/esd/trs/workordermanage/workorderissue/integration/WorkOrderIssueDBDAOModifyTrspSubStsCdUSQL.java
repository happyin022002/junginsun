...
*@FileName : WorkOrderIssueDBDAOModifyTrspSubStsCdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderIssueDBDAOModifyTrspSubStsCdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderIssueDBDAOModifyTrspSubStsCdUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderIssueDBDAOModifyTrspSubStsCdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,trs_sub_sts_cd = @[trs_sub_sts_cd]" ).append("\n"); 
