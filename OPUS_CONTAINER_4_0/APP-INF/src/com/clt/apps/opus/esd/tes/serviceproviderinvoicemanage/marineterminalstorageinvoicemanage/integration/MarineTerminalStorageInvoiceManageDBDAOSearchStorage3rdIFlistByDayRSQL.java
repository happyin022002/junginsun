...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByDayRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByDayRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByDayRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByDayRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("T.BKG_NO, T.BL_NO, T.FINC_VSL_CD, T.FINC_SKD_VOY_NO," ).append("\n"); 
