...
*@FileName : RailInvoiceauditDBDAOVerifyInvoiceFileImportVndrSetListForMultiSoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailInvoiceauditDBDAOVerifyInvoiceFileImportVndrSetListForMultiSoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RailInvoiceauditDBDAOVerifyInvoiceFileImportVndrSetListForMultiSo
	  * </pre>
	  */
	public RailInvoiceauditDBDAOVerifyInvoiceFileImportVndrSetListForMultiSoRSQL(){
		setQuery();
		...
		query.append("FileName : RailInvoiceauditDBDAOVerifyInvoiceFileImportVndrSetListForMultiSoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  LISTAGG(INV_NO, ',') WITHIN GROUP(ORDER BY INV_NO) INV_NO     " ).append("\n"); 
		...
		query.append("	    , CASE WHEN TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(Z.CURR_CD, SUM(TOT_AMT)) = TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(@[currency], @[invBilAmt]) THEN 'C'																	 " ).append("\n"); 
		...
		query.append("	AND     B.INV_VNDR_SEQ              IS NOT NULL										 " ).append("\n"); 
		...
		query.append(") " ).append("\n"); 
		query.append("WHERE FM_NOD_CD = NVL(@[fm_nod_cd], FM_NOD_CD)" ).append("\n"); 
		query.append("AND   TO_NOD_CD = NVL(@[to_nod_cd], TO_NOD_CD)" ).append("\n"); 
