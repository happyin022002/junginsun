...
public class InvoiceAuditDBDAOSearchTruckInvoiceFileImportRSQL implements ISQLTemplate{
	...
	public InvoiceAuditDBDAOSearchTruckInvoiceFileImportRSQL(){
		...
		params.put("ref_inv_no",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(" ,	( NVL(A.BZC_AMT,0) + NVL(A.NEGO_AMT,0) + NVL(A.FUEL_SCG_AMT,0) + NVL(A.ETC_ADD_AMT,0)) AS INV_BZC_AMT 		 		" ).append("\n"); 
		...
		query.append(" ,  (CASE WHEN A.TRSP_SO_TP_CD = 'Y' THEN NVL(TO_CHAR(A.ORG_GATE_OUT_DT, 'YYYY-MM-DD HH24:MI:SS'),TO_CHAR(A.DEST_GATE_IN_DT, 'YYYY-MM-DD HH24:MI:SS')) ELSE TO_CHAR(A.WO_EXE_DT, 'YYYY-MM-DD HH24:MI:SS') END) COP_EXE_DT								" ).append("\n"); 
		...
		query.append(" , @[ref_inv_no] REF_INV_NO	" ).append("\n"); 
