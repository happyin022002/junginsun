...
public class AvailabilityDBDAOsearchAvailabilityPeriodListRSQL implements ISQLTemplate{
	...
	public AvailabilityDBDAOsearchAvailabilityPeriodListRSQL(){
		...
		params.put("r_cgor_cstms_acpt_re_ind_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("#if (${r_cgor_cstms_acpt_re_ind_flg} != '')" ).append("\n"); 
		query.append("and (d.CSTMS_CLR_CD = @[r_cgor_cstms_acpt_re_ind_flg] or f.CSTMS_CLR_CD = @[r_cgor_cstms_acpt_re_ind_flg])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
