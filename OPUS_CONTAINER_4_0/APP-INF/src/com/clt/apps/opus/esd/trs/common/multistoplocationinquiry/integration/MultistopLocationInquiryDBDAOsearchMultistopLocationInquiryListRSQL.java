...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esd.trs.common.multistoplocationinquiry.integration;
...
public class MultistopLocationInquiryDBDAOsearchMultistopLocationInquiryListRSQL implements ISQLTemplate{
	...
	public MultistopLocationInquiryDBDAOsearchMultistopLocationInquiryListRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esd.trs.common.multistoplocationinquiry.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append(" ,	TRIM(SUBSTR(B.DOR_ADDR , 1,50))	||' '||								 " ).append("\n"); 
		query.append(" 	TRIM(SUBSTR(B.DOR_ADDR ,51,50))	||' '||								 " ).append("\n"); 
		query.append(" 	TRIM(SUBSTR(B.DOR_ADDR ,101,50))	||' '||								 " ).append("\n"); 
		query.append(" 	TRIM(SUBSTR(B.DOR_ADDR ,151,50))		AS DOR_ADDR						 " ).append("\n"); 
