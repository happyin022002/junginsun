...
public class DOFChgColInqmanageDBDAOSearchDofChgColListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND    BTR.CRE_OFC_CD = @[ctrl_ofc_cd]" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("AND BTR.HLG_TP_CD                    = 'M'" ).append("\n"); 
		...
		query.append("AND   MAIN.CUST_CNT_CD||MAIN.CUST_SEQ = @[cust_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
