...
//	}
	public RailBillingVerifyList[] getRailBillingVerifyList() {
		RailBillingVerifyList[] rtnVOs = null;
		if(this.railBillingVerifyList != null){
			rtnVOs = Arrays.copyOf(railBillingVerifyList,railBillingVerifyList.length);
		}
		return rtnVOs;	
	}
...
//	}	
	public void setRailBillingVerifyList(RailBillingVerifyList[] railBillingVerifyList) {
		if(railBillingVerifyList != null){
			RailBillingVerifyList[] tmpVOs = Arrays.copyOf(railBillingVerifyList,railBillingVerifyList.length);
			this.railBillingVerifyList = tmpVOs;			
		}
	}
