...
public class CustomerEdiDBDAOSearchEdiSummaryReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("select '' flag,m.vvd,m.bkg_no,m.bl_no ,m.cntr_no, m.por_cd, m.pol_cd, m.pod_cd, m.del_cd, m.cop_no , m.ts_port, m.rail" ).append("\n"); 
		...
		query.append("select '' ,l.vvd,l.bkg_no,l.bl_no ,l.cntr_no, l.por_cd, l.pol_cd, l.pod_cd, l.del_cd, l.cop_no , l.ts_port, l.rail ,rownum no" ).append("\n"); 
		query.append("#if(${edi_sts} !='')" ).append("\n"); 
		query.append("#foreach($ele1 in ${edi_sts})" ).append("\n"); 
		...
		query.append(",cntr_no, por_cd, pol_cd, pod_cd, del_cd, cop_no   , ts_port, rail" ).append("\n"); 
		query.append("#if(${edi_sts} !='')" ).append("\n"); 
		query.append("#foreach($ele1 in ${edi_sts})" ).append("\n"); 
		...
		query.append(", d.act_dt ,a.cop_no, a.bl_no, d.edi_grp_cd , a.ts_port, a.rail" ).append("\n"); 
		query.append(", d.EDI_SND_KNt knt, d.max_edi_snd_knt m_knt,  a.cust_edi_sts_cd , rownum no" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("( SELECT" ).append("\n"); 
		query.append("DISTINCT  vvd, hb.bkg_no, cntr_no, hb.por_cd, hb.pol_cd, hb.pod_cd, hb.del_cd, cop_no, ts_port, rail, hb.bl_no," ).append("\n"); 
		query.append("cgo.EDI_STND_STS_CD a_edi_sts_cd, e.edi_grp_cd aaa  ,cgo.CUST_EDI_STS_CD  cust_edi_sts_cd" ).append("\n"); 
