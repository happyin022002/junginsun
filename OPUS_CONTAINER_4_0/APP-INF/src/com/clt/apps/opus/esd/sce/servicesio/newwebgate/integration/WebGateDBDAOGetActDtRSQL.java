...
*@FileName : WebGateDBDAOGetActDtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WebGateDBDAOGetActDtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WebGateDBDAOGetActDtRSQL(){
		setQuery();
		...
		query.append("FileName : WebGateDBDAOGetActDtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
