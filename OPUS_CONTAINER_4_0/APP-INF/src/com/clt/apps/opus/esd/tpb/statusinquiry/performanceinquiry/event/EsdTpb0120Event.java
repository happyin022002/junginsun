...
public class EsdTpb0120Event extends EventSupport {
	...
	public SearchNonTPBListVO[] getSearchNonTPBListVOs() {
		SearchNonTPBListVO[] rtnVOs = null;
		if (this.searchNonTPBListVOs != null) {
			rtnVOs = Arrays.copyOf(searchNonTPBListVOs, searchNonTPBListVOs.length);
		}
		return rtnVOs;
	}

	public void setSearchNonTPBListVOs(SearchNonTPBListVO[] searchNonTPBListVOs){
		if(searchNonTPBListVOs != null){
			SearchNonTPBListVO[] tmpVOs = Arrays.copyOf(searchNonTPBListVOs, searchNonTPBListVOs.length);
			this.searchNonTPBListVOs = tmpVOs;
		}
	}
