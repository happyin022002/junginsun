...
*@FileName : USA404EDIStatusInquiryDBDAOInsert404EdiRailOrdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOInsert404EdiRailOrdCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 404 Edi에 대한 정보 W/O 테이블에 추가 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOInsert404EdiRailOrdCSQL(){
		setQuery();
		...
		params.put("mtc_edi_ind_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOInsert404EdiRailOrdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" DECODE(@[cgo_tp_cd], 'M', @[inter_rmk], '')," ).append("\n"); 
		query.append(" @[spcl_instr_rmk]," ).append("\n"); 
