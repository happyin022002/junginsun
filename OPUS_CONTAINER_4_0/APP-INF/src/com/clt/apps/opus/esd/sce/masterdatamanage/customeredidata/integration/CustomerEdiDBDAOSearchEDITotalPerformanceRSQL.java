...
public class CustomerEdiDBDAOSearchEDITotalPerformanceRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("select '1' day , ''" ).append("\n"); 
		...
		query.append(", nvl(max(CASE WHEN edi_sts_cd = '$ele1'" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("THEN diff_1" ).append("\n"); 
		query.append("ELSE NULL" ).append("\n"); 
		query.append("END ),0)    $ele1$uline" ).append("\n"); 
		...
		query.append("select tar_1.a edi_group, tar_1.b edi_sts_cd, tar_1.c edi_cust_cd," ).append("\n"); 
		query.append("sum(tar_1.AA1) over(partition by tar_1.b, tar_1.c) ||'/'|| ccc diff_1" ).append("\n"); 
		query.append("from (" ).append("\n"); 
		query.append("select /*+ NO_QUERY_TRANSFORMATION */    tar.a A,  tar.b B,  tar.c C," ).append("\n"); 
		query.append("case when tar.diff = 0 or tar.diff = 1 then 1 else 0 end  aa1," ).append("\n"); 
		query.append("tar.diff diff" ).append("\n"); 
		query.append(",sum(tar.tt_cnt) over(partition by tar.b||tar.c) ccc" ).append("\n"); 
		query.append("from (" ).append("\n"); 
		query.append("select  a.aaa a, a_edi_sts_cd b,a_cust_edi_sts_cd c,a.bkg_no," ).append("\n"); 
		query.append("a.cntr_no , d.act_dt SND_DT, TOL_ROW, 1 tt_cnt," ).append("\n"); 
		query.append("case when (d.act_dt is null) or" ).append("\n"); 
		query.append("--T/S 가 없는 Shipment" ).append("\n"); 
		query.append("(ts_chk is null  and a_edi_sts_cd in ('VAT','UVT','AET','VDT')) or" ).append("\n"); 
		query.append("--O/B 구간 Rail이 아닌 Shipment" ).append("\n"); 
		query.append("(substr(rail_chk, 1, 1) <> 'I'  and a_edi_sts_cd in ('ALO','RLO','ARO','URO','FOTRDO','FOTRARN')) or" ).append("\n"); 
		query.append("--I/B 구간 Rail이 아닌 Shipment" ).append("\n"); 
		query.append("(substr(rail_chk, 2, 1) <> 'I' and  a_edi_sts_cd in ('ARN','RLN','ARN','URN','FITRARN','FITRDO','AVN','ACN','AFN','AON','NT')) or" ).append("\n"); 
		query.append("--I/B 구간 Rail Shipment" ).append("\n"); 
		query.append("(substr(rail_chk, 2, 1) = 'I' and  a_edi_sts_cd in ('AVL','ACL','AFL','AOL')) or" ).append("\n"); 
		query.append("--DEL이 ‘US’가 아닌 것" ).append("\n"); 
		query.append("(substr(del_cd, 1, 2) <> 'US' and  a_edi_sts_cd in ('CT','CC','CU','HR','PA','PQ','AVN','AVL','ACN','ACL')) or" ).append("\n"); 
		query.append("--DEL이 ‘CA,MX’가 아닌 것" ).append("\n"); 
		query.append("(substr(del_cd, 1, 2) <> 'CA' and substr(del_cd, 1, 2) <> 'MX' and a_edi_sts_cd in ('OB','AFN','AFL','AON','AOL')) or" ).append("\n"); 
		query.append("--DEL이 ‘US,CA,MX’가 아닌 것" ).append("\n"); 
		query.append("(substr(del_cd, 1, 2) <> 'US' and substr(del_cd, 1, 2) <> 'CA' and substr(del_cd, 1, 2) <> 'MX' and a_edi_sts_cd in ('NFT','FTR'))" ).append("\n"); 
		query.append("then  'EXP' else 'N/A' end t_cnt," ).append("\n"); 
		query.append("trunc(abs(nvl(d.GMT_DT  - d.act_dt, 0))) diff" ).append("\n"); 
		query.append("from   (" ).append("\n"); 
		query.append("select" ).append("\n"); 
		query.append("d.EDI_GRP_CD, d.bkg_no,  d.cntr_no, d.EDI_STS_CD, d.EDI_SUB_STS_CD," ).append("\n"); 
		query.append("d.act_dt, d.gmt_dt, d.edi_snd_knt EDI_SND_KNt, '1' TOL_ROW" ).append("\n"); 
		query.append("from SCE_EDI_SND_RSLT   d" ).append("\n"); 
		query.append("/*repeat-s1*/" ).append("\n"); 
		...
		query.append("/*repeat-e1*/" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT /*+ USE_CONCAT */ DISTINCT vvd, hb.bkg_no," ).append("\n"); 
		query.append("cntr_no,	hb.por_cd,	 hb.pol_cd,  hb.pod_cd, hb.del_cd,  cop_no," ).append("\n"); 
		query.append("cgo.EDI_STND_STS_CD a_edi_sts_cd," ).append("\n"); 
		query.append("cgo.CUST_EDI_STS_CD a_cust_edi_sts_cd, e.edi_grp_cd aaa, rail_chk, ts_chk" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		...
		query.append(") tar" ).append("\n"); 
		query.append("where t_cnt = 'N/A')  tar_1" ).append("\n"); 
		query.append(") final" ).append("\n"); 
		query.append("/*repeat-e2*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*----------------------------------------------------------------------------------------------------------------Day1*/" ).append("\n"); 
		query.append("union all" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#set($ediStsCount = 0)" ).append("\n"); 
		query.append("select '2' day , ''" ).append("\n"); 
		query.append("#if(${edi_sts} !='' && ${cust_cd} !='') /* condition No1 */" ).append("\n"); 
		query.append("#set($uline = \"_\")" ).append("\n"); 
		query.append("#set($fVelocityCount = 1)" ).append("\n"); 
		query.append("#foreach($ele1 in ${edi_sts})" ).append("\n"); 
		...
		query.append("from (" ).append("\n"); 
		query.append("select /*+ NO_QUERY_TRANSFORMATION */    tar.a A,  tar.b B,  tar.c C," ).append("\n"); 
		query.append("case when tar.diff = 2 then 1 else 0 end  aa1," ).append("\n"); 
		query.append("tar.diff diff" ).append("\n"); 
		query.append(",sum(tar.tt_cnt) over(partition by tar.b||tar.c) ccc" ).append("\n"); 
		query.append("from (" ).append("\n"); 
		query.append("select  a.aaa a, a_edi_sts_cd b,a_cust_edi_sts_cd c,a.bkg_no," ).append("\n"); 
		...
		query.append("where t_cnt = 'N/A')  tar_1" ).append("\n"); 
		query.append(") final" ).append("\n"); 
		query.append("/*repeat-e*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*----------------------------------------------------------------------------------------------------------------Day2*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("union all" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#set($ediStsCount = 0)" ).append("\n"); 
		query.append("select '3' day , ''" ).append("\n"); 
		query.append("#if(${edi_sts} !='' && ${cust_cd} !='') /* condition No1 */" ).append("\n"); 
		query.append("#set($uline = \"_\")" ).append("\n"); 
		query.append("#set($fVelocityCount = 1)" ).append("\n"); 
		query.append("#foreach($ele1 in ${edi_sts})" ).append("\n"); 
		...
		query.append("from (" ).append("\n"); 
		query.append("select /*+ NO_QUERY_TRANSFORMATION */    tar.a A,  tar.b B,  tar.c C," ).append("\n"); 
		query.append("case when tar.diff = 3 then 1 else 0 end  aa1," ).append("\n"); 
		query.append("tar.diff diff" ).append("\n"); 
		query.append(",sum(tar.tt_cnt) over(partition by tar.b||tar.c) ccc" ).append("\n"); 
		query.append("from (" ).append("\n"); 
		query.append("select  a.aaa a, a_edi_sts_cd b,a_cust_edi_sts_cd c,a.bkg_no," ).append("\n"); 
		...
		query.append("/*repeat-e*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*----------------------------------------------------------------------------------------------------------------Day3*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("union all" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#set($ediStsCount = 0)" ).append("\n"); 
		query.append("select 'etc' day , ''" ).append("\n"); 
		query.append("#if(${edi_sts} !='' && ${cust_cd} !='') /* condition No1 */" ).append("\n"); 
		query.append("#set($uline = \"_\")" ).append("\n"); 
		query.append("#set($fVelocityCount = 1)" ).append("\n"); 
		query.append("#foreach($ele1 in ${edi_sts})" ).append("\n"); 
