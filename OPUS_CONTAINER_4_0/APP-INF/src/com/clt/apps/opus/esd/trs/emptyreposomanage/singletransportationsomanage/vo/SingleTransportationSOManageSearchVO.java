...
public class SingleTransportationSOManageSearchVO extends AbstractValueObject {
	...
	/* Column Info */
	private String selKindPre = null;
	...
	public SingleTransportationSOManageSearchVO(String ibflag, String pagerows, String hidFrmreqdate, String hidToreqdate, String frmReqdate, String toReqdate, String selKind, String ctrlSoOffice, String chkOffice, String frmNode, String frmYard, String toNode, String toYard, String cntrType, String cntrSize, String referenceNo, String cntrNo, String bkgNo, String hidRefId, String hidFmNodCd, String hidToNodCd, String hidFmYardCd, String hidToYardCd, 
			String hidEqTpszCd, String hidTrspCostModCd, String hidTrspCrrModCd, String hidCntrNo, String hidCntrTpszCd, String ctrlOfcCd, String ctrlUserId, String trspSoEqKind, String eqNoVerify, String frmNodeVerify, String oldOfcCd, String cbstatus, String searchFmNode, String searchToNode, String selKindPre) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sel_kind_pre", getSelKindPre());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sel_kind_prd", "selKindPre");
	 ...
	 * @param selKindPre
	 */
	public void setSelKindPre(String selKindPre) {
		this.selKindPre = selKindPre;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSearchFmNode(JSPUtil.getParameter(request, "search_fm_node", ""));
		setSearchToNode(JSPUtil.getParameter(request, "search_to_node", ""));
		setBkgNo(JSPUtil.getParameter(request, "bkg_no", ""));
		setSelKindPre(JSPUtil.getParameter(request, "sel_kind_pre", ""));
	}
	...
	public SingleTransportationSOManageSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] selKindPre = (JSPUtil.getParameter(request, prefix	+ "sel_kind_pre", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (selKindPre[i] != null)
					model.setSelKindPre(selKindPre[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.selKindPre = this.selKindPre .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
