...
*@FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCWWTUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCWWTUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateTrsSvcOrdBkgChmHisCWWT
	  * </pre>
	  */
	public WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCWWTUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisCWWTUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET CNTR_WGT = @[cntr_wgt] " ).append("\n"); 
