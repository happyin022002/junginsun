...
*@FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisATA2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisATA2USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateTrsSvcOrdBkgChmHisATA2
	  * </pre>
	  */
	public WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisATA2USQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderIssueDBDAOUpdateTrsSvcOrdBkgChmHisATA2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET LOD_REF_NO = @[lod_ref_no] " ).append("\n"); 
