...
*@FileName : SurchargeInputInquiryDBDAOsearchSurchargeInputInquirySumByAgreementRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeInputInquiryDBDAOsearchSurchargeInputInquirySumByAgreementRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchSurchargeInputInquirySumByAgreement
	  * </pre>
	  */
	public SurchargeInputInquiryDBDAOsearchSurchargeInputInquirySumByAgreementRSQL(){
		setQuery();
		...
		query.append("FileName : SurchargeInputInquiryDBDAOsearchSurchargeInputInquirySumByAgreementRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT ROUND(SUM(SCG_AMT), 2) AS ETC_ADD_AMT" ).append("\n"); 
		...
		query.append("                D.ETC_ADD_AMT * (SELECT ROUND((X1.USD_LOCL_XCH_RT / X2.USD_LOCL_XCH_RT),6) AS RATE" ).append("\n"); 
		query.append("                                   FROM GL_MON_XCH_RT X1" ).append("\n"); 
		query.append("                                      , GL_MON_XCH_RT X2" ).append("\n"); 
		query.append("                                  WHERE X1.ACCT_XCH_RT_YRMON = SUBSTR(REPLACE(@[cre_dt],'-',''),1,6) -- S/O Creation Date" ).append("\n"); 
		query.append("                                    AND X1.ACCT_XCH_RT_LVL = '1'" ).append("\n"); 
		query.append("                                    AND X1.CURR_CD = @[po_local_curr_cd] -- BZC Currency" ).append("\n"); 
		query.append("                                    AND X2.ACCT_XCH_RT_YRMON = SUBSTR(REPLACE(@[cre_dt],'-',''),1,6) -- S/O Creation Date" ).append("\n"); 
		...
		query.append("                                ) " ).append("\n"); 
		query.append("                AS SCG_AMT," ).append("\n"); 
		query.append("                D.ETC_ADD_AMT AS ORG_SCG_AMT," ).append("\n"); 
		query.append("                D.TRSP_AGMT_SCG_RT_SEQ," ).append("\n"); 
		...
		query.append("                                CASE" ).append("\n"); 
		query.append("                                  WHEN @[trsp_cost_dtl_mod_cd] = 'DR' THEN" ).append("\n"); 
		query.append("                                   NVL(C.TRSP_RND_RT, C.TRSP_ONE_WY_RT)" ).append("\n"); 
		...
		query.append("                   AND A.CGO_TP_CD              = DECODE(@[cgo_tp_cd], 'F', 'F', 'C', 'F', 'M', 'M')" ).append("\n"); 
		...
		query.append("                  FROM (" ).append("\n"); 
		query.append("                         SELECT COM_SCG_KND_CD, ONE_WY_RT, RND_RT" ).append("\n"); 
		query.append("                               ,NVL(RT_TP_CD, 'F') RT_TP_CD, CURR_CD" ).append("\n"); 
		...
		query.append("                   		    AND (SCC_CD = SUBSTR(@[fm_nod_cd], 1, 5) OR" ).append("\n"); 
		query.append("		                         LCC_CD          IN (SELECT DISTINCT LCC_CD" ).append("\n"); 
		query.append("        		                                       FROM MDM_EQ_ORZ_CHT" ).append("\n"); 
		query.append("                		                              WHERE DELT_FLG = 'N'" ).append("\n"); 
		query.append("                        	                            AND SCC_CD = SUBSTR(@[fm_nod_cd], 1, 5)) OR" ).append("\n"); 
		query.append("		                          RCC_CD          IN (SELECT DISTINCT RCC_CD" ).append("\n"); 
		query.append("        		                                        FROM MDM_EQ_ORZ_CHT" ).append("\n"); 
		query.append("                		                               WHERE DELT_FLG = 'N'" ).append("\n"); 
		query.append("                        	                             AND SCC_CD = SUBSTR(@[fm_nod_cd], 1, 5))" ).append("\n"); 
		query.append("                            	)" ).append("\n"); 
		query.append("#if (${cgo_tp_cd} != '')" ).append("\n"); 
		query.append("                            AND CGO_TP_CD        = DECODE(@[cgo_tp_cd], 'F', 'F', 'C', 'F', 'M', 'M')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
