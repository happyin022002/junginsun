...
public class ConstraintManageDBDAOInsertLinkConstraintCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   @[s_node_fm]" ).append("\n"); 
		query.append("  ,@[s_node_to]" ).append("\n"); 
		query.append("  ,@[s_ts_mode]" ).append("\n"); 
		...
		query.append("  ,NVL((select max(lnk_cnst_seq) + 1 from PRD_LNK_CNST_MGMT), 1)" ).append("\n"); 
		query.append("  ,@[spcl_cgo_cntr_tp_cd]" ).append("\n"); 
		query.append("  ,@[cntr_sz_cd]   " ).append("\n"); 
		query.append(")" ).append("\n"); 
