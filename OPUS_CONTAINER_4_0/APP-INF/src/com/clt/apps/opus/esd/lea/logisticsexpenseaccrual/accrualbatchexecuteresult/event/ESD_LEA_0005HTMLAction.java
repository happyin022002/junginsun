...
*@FileName : ESD_LEA_0005HTMLAction.java
...
public class ESD_LEA_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0005HTMLAction 객체를 생성
	 */
	public ESD_LEA_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0005Event event = new EsdLea0005Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchResultContainerTPSZListVO((SearchAccrualBatchResultContainerTPSZListVO)getVO(request, SearchAccrualBatchResultContainerTPSZListVO .class));
		}
