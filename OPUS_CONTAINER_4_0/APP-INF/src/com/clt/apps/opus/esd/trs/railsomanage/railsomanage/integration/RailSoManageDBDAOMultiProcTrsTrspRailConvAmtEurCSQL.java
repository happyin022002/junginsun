...
*@FileName : RailSoManageDBDAOMultiProcTrsTrspRailConvAmtEurCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailSoManageDBDAOMultiProcTrsTrspRailConvAmtEurCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SO에 요율정보(EUR 단위)를 요율변환 테이블에 추가 SQL
	  * </pre>
	  */
	public RailSoManageDBDAOMultiProcTrsTrspRailConvAmtEurCSQL(){
		setQuery();
		...
		query.append("FileName : RailSoManageDBDAOMultiProcTrsTrspRailConvAmtEurCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TRS_COMMON_PKG.GET_CONVERSION_EUR_AMT_FNC (@[po_local_curr_cd], @[po_basic_rt])," ).append("\n"); 
		query.append("TRS_COMMON_PKG.GET_CONVERSION_EUR_AMT_FNC (@[po_local_curr_cd], @[po_fuel_scg_rt])," ).append("\n"); 
		query.append("TRS_COMMON_PKG.GET_CONVERSION_EUR_AMT_FNC (@[po_local_curr_cd], @[po_over_wgt_scg_rt])," ).append("\n"); 
		query.append("@[cre_ofc_cd]," ).append("\n"); 
		query.append("@[cre_usr_id]," ).append("\n"); 
