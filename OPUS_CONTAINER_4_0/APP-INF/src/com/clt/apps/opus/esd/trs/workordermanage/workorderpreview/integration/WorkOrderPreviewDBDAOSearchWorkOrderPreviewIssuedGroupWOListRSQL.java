...
public class WorkOrderPreviewDBDAOSearchWorkOrderPreviewIssuedGroupWOListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT D.TRSP_SO_OFC_CTY_CD," ).append("\n"); 
		query.append("       D.TRSP_SO_SEQ," ).append("\n"); 
		query.append("       D.TRSP_SO_STS_CD," ).append("\n"); 
		query.append("       DENSE_RANK() OVER (" ).append("\n"); 
		query.append("         ORDER BY D.WO_ISS_NO" ).append("\n"); 
		query.append("       ) WO_ISS_NO," ).append("\n"); 
		query.append("       D.TRSP_WO_OFC_CTY_CD," ).append("\n"); 
		query.append("       D.TRSP_WO_SEQ," ).append("\n"); 
		query.append("       D.WO_FMT_TP_CD," ).append("\n"); 
		query.append("       D.WO_FMT_TP_NM," ).append("\n"); 
		query.append("       D.TRSP_SO_CMB_TP_CD," ).append("\n"); 
		query.append("       D.TRSP_COST_DTL_MOD_CD," ).append("\n"); 
		query.append("       D.CGO_TP_CD," ).append("\n"); 
		query.append("       D.VNDR_SEQ," ).append("\n"); 
		query.append("       D.TRSP_CRR_MOD_CD," ).append("\n"); 
		query.append("       D.FM_NOD_CD," ).append("\n"); 
		query.append("       D.VIA_NOD_CD," ).append("\n"); 
		query.append("       D.DOR_NOD_CD," ).append("\n"); 
		query.append("       D.TO_NOD_CD," ).append("\n"); 
		query.append("       D.FDR_VSL_CD," ).append("\n"); 
		query.append("       D.FDR_SKD_VOY_NO," ).append("\n"); 
		query.append("       D.FDR_SKD_DIR_CD" ).append("\n"); 
		query.append("  FROM (SELECT B.TRSP_SO_OFC_CTY_CD," ).append("\n"); 
		query.append("               B.TRSP_SO_SEQ," ).append("\n"); 
		query.append("               B.TRSP_SO_STS_CD," ).append("\n"); 
		query.append("               MIN(ROWNUM) over " ).append("\n"); 
		query.append("               (PARTITION BY B.TRSP_WO_OFC_CTY_CD," ).append("\n"); 
		...
		query.append("                    ORDER BY B.TRSP_WO_OFC_CTY_CD," ).append("\n"); 
		query.append("                             B.TRSP_WO_SEQ," ).append("\n"); 
		query.append("                             B.TRSP_SO_TP_CD, " ).append("\n"); 
		query.append("                             B.WO_FMT_TP_CD, " ).append("\n"); 
		query.append("                             B.VNDR_SEQ, " ).append("\n"); 
		...
		query.append("                       THEN 'MM'" ).append("\n"); 
		query.append("                  WHEN A.TRSP_SO_TP_CD = 'O'" ).append("\n"); 
		query.append("                       AND A.TRSP_COST_DTL_MOD_CD NOT IN ('ER', 'CN', 'CF') THEN 'NC'" ).append("\n"); 
		...
		query.append("ORDER BY TRSP_SO_OFC_CTY_CD, TRSP_SO_SEQ" ).append("\n"); 
