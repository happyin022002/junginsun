...
*@FileName : USA404EDIStatusInquiryDBDAOUpdateEqrRepoIf2SPPUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOUpdateEqrRepoIf2SPPUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPP에서 SO 정보를 EQR IF 테이블에 수정 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOUpdateEqrRepoIf2SPPUSQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOUpdateEqrRepoIf2SPPUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
