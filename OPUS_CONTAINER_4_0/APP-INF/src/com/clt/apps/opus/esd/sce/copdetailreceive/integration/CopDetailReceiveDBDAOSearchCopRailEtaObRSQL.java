...
*@FileName : CopDetailReceiveDBDAOSearchCopRailEtaObRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopDetailReceiveDBDAOSearchCopRailEtaObRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CopDetailReceiveDBDAOSearchCopRailEtaObRSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOSearchCopRailEtaObRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(@[rail_vndr],'NS',MIN(COP_NO||COP_DTL_SEQ),MAX(COP_NO||COP_DTL_SEQ))  cop_no_eta" ).append("\n"); 
