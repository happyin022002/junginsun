...
*@FileName : TerminalAgreementManageDBDAOaddSpecialFeederCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOaddSpecialFeederCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * China Special Feeder화면에 POL과 POD를 추가한다.
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOaddSpecialFeederCSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOaddSpecialFeederCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TES_TML_SPCL_FDR" ).append("\n"); 
		query.append("(" ).append("\n"); 
