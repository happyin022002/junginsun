...
public class Edi315SendDBDAOSearchBkgCustInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               SH.CUST_CNT_CD || SH.CUST_SEQ        	                                SHPRCODE," ).append("\n"); 
		...
		query.append("               BKG_TOKEN_NL_FNC(SH.cust_nm, 1,'')              	                        SHPR1," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(SH.cust_nm, 2,'')              	                        SHPR2," ).append("\n"); 
		query.append("			   DECODE(SH.ADDR_PRN_FLG, 'Y', BKG_TOKEN_NL_FNC(SH.cust_addr, 1,''), '')	    SHPR3," ).append("\n"); 
		query.append("               DECODE(SH.ADDR_PRN_FLG, 'Y', BKG_TOKEN_NL_FNC(SH.cust_addr, 2,''), '')	    SHPR4," ).append("\n"); 
		query.append("               DECODE(SH.ADDR_PRN_FLG, 'Y', BKG_TOKEN_NL_FNC(SH.cust_addr, 3,''), '')	    SHPR5," ).append("\n"); 
		...
		query.append("               CN.CUST_CNT_CD || CN.CUST_SEQ        	                                CNEECODE," ).append("\n"); 
		...
		query.append("               BKG_TOKEN_NL_FNC(CN.cust_nm, 1,'')              	                        CNEE1," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(CN.cust_nm, 2,'')              	                        CNEE2," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(CN.cust_addr, 1,'')            	                        CNEE3," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(CN.cust_addr, 2,'')            	                        CNEE4," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(CN.cust_addr, 3,'')            	                        CNEE5," ).append("\n"); 
		...
		query.append("               NF.CUST_CNT_CD || NF.CUST_SEQ         	                                NTFYCODE," ).append("\n"); 
		...
		query.append("			   BKG_TOKEN_NL_FNC(NF.cust_nm, 1,'')              	                        NTFY1," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(NF.cust_nm, 2,'')              	                        NTFY2," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(NF.cust_addr, 1,'')            	                        NTFY3," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(NF.cust_addr, 2,'')            	                        NTFY4," ).append("\n"); 
		query.append("               BKG_TOKEN_NL_FNC(NF.cust_addr, 3,'')            	                        NTFY5," ).append("\n"); 
