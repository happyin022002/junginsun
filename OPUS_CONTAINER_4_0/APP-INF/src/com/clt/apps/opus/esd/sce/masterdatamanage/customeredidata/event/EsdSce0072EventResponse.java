...
*@FileName : EsdSce0072EventResponse.java
...
public class EsdSce0072EventResponse extends EventResponseSupport  {
     ...
     * @param csDesc
     */
    public EsdSce0072EventResponse(String csGrpId, String tpId, String csDesc){
     ...
     * @param map
     */
    public EsdSce0072EventResponse(HashMap<String, String> map){
        ...
        this.custCd = JSPUtil.getNull((String)map.get("cust_cd"));
    } 
     ...
     * @param cnt
     */
    public EsdSce0072EventResponse(HashMap<String, String> map, int cnt){
    	this.csGrpId = JSPUtil.getNull((String)map.get("cs_grp_id"));
        this.tpId	= JSPUtil.getNull((String)map.get("tp_id"));
        this.csDesc = JSPUtil.getNull((String)map.get("cs_desc"));
        this.ediSts = JSPUtil.getNull((String)map.get("edi_sts"));
     ...
     * @param rowSet_
     */
    public EsdSce0072EventResponse(DBRowSet rowSet_){
        this.rowSet = rowSet_;
    }
     ...
     * @param cnt
     */
    public EsdSce0072EventResponse(DBRowSet rowSet_, int cnt){
    	this.rowSet = rowSet_;
    	this.cnt = cnt;
    }
     ...
     * @param resultCd_
     */
    public EsdSce0072EventResponse(String resultCd_){
     ...
     * @return String EsdSce072EventResponse
     */
    public String toString() {
        return "EsdSce072EventResponse";
    }
