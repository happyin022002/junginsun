...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyStorageInvoice
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceUSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
