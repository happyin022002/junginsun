...
public class USA404EDIStatusInquiryDBDAOSearch04USA404EDIStatusSendRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,CASE WHEN LENGTH(S.EDI_RCV_VNDR_ABBR_NM) > 0 OR LENGTH(T.EDI_RCV_VNDR_ABBR_NM) > 0 THEN 'Z' ELSE 'X' END EX_VNDR" ).append("\n"); 
		...
		query.append("                WHEN AI.CSTMS_CLR_TP_CD = 'L' THEN (SELECT F.LOC_AMS_PORT_CD FROM MDM_LOCATION F WHERE F.LOC_CD = CND.CSTMS_POD_CD)" ).append("\n"); 
		...
		query.append("               CASE WHEN SUBSTR(A.FM_NOD_CD, 1, 2) = 'CA' OR  SUBSTR(A.TO_NOD_CD, 1, 2) = 'CA' THEN DECODE(A.CGO_TP_CD, 'F', SHIP_DE.CUST_CNT_CD || SHIP_DE.CUST_SEQ) END   " ).append("\n"); 
		...
		query.append("            END" ).append("\n"); 
		query.append("          ELSE CASE WHEN SUBSTR(A.FM_NOD_CD, 1, 2) = 'CA' OR  SUBSTR(A.TO_NOD_CD, 1, 2) = 'CA' THEN  " ).append("\n"); 
		query.append("                    DECODE(A.CGO_TP_CD, 'F', SHIP_DE.CUST_STE_CD)" ).append("\n"); 
		query.append("                END    " ).append("\n"); 
		...
		query.append("            END" ).append("\n"); 
		query.append("          ELSE CASE WHEN SUBSTR(A.FM_NOD_CD, 1, 2) = 'CA' OR  SUBSTR(A.TO_NOD_CD, 1, 2) = 'CA' THEN  " ).append("\n"); 
		query.append("                    DECODE(A.CGO_TP_CD, 'F', SHIP_DE.CUST_ZIP_ID)" ).append("\n"); 
		query.append("               END     " ).append("\n"); 
		...
		query.append("            END" ).append("\n"); 
		query.append("          ELSE CASE WHEN SUBSTR(A.FM_NOD_CD, 1, 2) = 'CA' OR  SUBSTR(A.TO_NOD_CD, 1, 2) = 'CA' THEN " ).append("\n"); 
		query.append("                    DECODE(A.CGO_TP_CD, 'F', SHIP_DE.CUST_CNT_CD, '')" ).append("\n"); 
		query.append("               END     " ).append("\n"); 
		...
		query.append("      ,'NYK INTERNATIONAL' BILL_N" ).append("\n"); 
		...
		query.append("      ,'SG' BILL_CN" ).append("\n"); 
		...
		query.append("      ,LPAD(O.BIL_EDI_CTRL_SEQ, 8, '0') CREDIT_OLD" ).append("\n"); 
		query.append("      ,'M' || LPAD(O.BIL_EDI_CTRL_SEQ, 8, '0') MTC_CREDIT_OLD" ).append("\n"); 
		query.append("      ,SUBSTR(A.EQ_NO, 1, 4) EQINIT_OLD" ).append("\n"); 
		query.append("      ,SUBSTR(A.EQ_NO, 5, 6) EQNO_OLD" ).append("\n"); 
		...
		query.append("					   AND P.IMDG_CLSS_CD = R.HZD_MTRL_CLSS_CD(+)" ).append("\n"); 
		query.append("					   AND NVL(R.STCC_CD, 'N/A') = NVL((SELECT MIN(TST.STCC_CD)" ).append("\n"); 
		query.append("														 FROM TRS_STCC TST" ).append("\n"); 
		query.append("														WHERE TST.UN_CMDT_CD = P.IMDG_UN_NO" ).append("\n"); 
		query.append("														  AND TST.HZD_MTRL_CLSS_CD = P.IMDG_CLSS_CD)" ).append("\n"); 
		query.append("													  ,'N/A')) A" ).append("\n"); 
		query.append("				  ,(" ).append("\n"); 
