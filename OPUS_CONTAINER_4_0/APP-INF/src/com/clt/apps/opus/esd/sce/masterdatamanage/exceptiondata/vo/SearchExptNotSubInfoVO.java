...
*@FileName : SearchExptNotSubInfoVO.java
*@FileTitle : SearchExptNotSubInfoVO
*Open Issues :
*Change history :
...
public class SearchExptNotSubInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchExptNotSubInfoVO> models = new ArrayList<SearchExptNotSubInfoVO>();
	...
	public SearchExptNotSubInfoVO() {}

	public SearchExptNotSubInfoVO(String ibflag, String pagerows, String rIbflag, String rSubscGrpCd, String rNtfdOfcCd, String rGlobalId, String rName, String rEmail, String rCntOfc, String rUsrId, String rUpdDt, String rAct, String copExptSubscCsSeq, String subscGrpNtfdPtyCd) {
		this.rName = rName;
	 ...
	 * @param request
	 * @return SearchExptNotSubInfoVO[]
	 */
	public SearchExptNotSubInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchExptNotSubInfoVO[]
	 */
	public SearchExptNotSubInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchExptNotSubInfoVO();
				if (rName[i] != null)
		...
		return getSearchExptNotSubInfoVOs();
	}
	 ...
	 * @return SearchExptNotSubInfoVO[]
	 */
	public SearchExptNotSubInfoVO[] getSearchExptNotSubInfoVOs(){
		SearchExptNotSubInfoVO[] vos = (SearchExptNotSubInfoVO[])models.toArray(new SearchExptNotSubInfoVO[models.size()]);
		return vos;
	}
