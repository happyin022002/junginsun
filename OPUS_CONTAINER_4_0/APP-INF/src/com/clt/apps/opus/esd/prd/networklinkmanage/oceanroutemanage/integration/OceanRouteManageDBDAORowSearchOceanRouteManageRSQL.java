...
public class OceanRouteManageDBDAORowSearchOceanRouteManageRSQL implements ISQLTemplate{
	...
	public OceanRouteManageDBDAORowSearchOceanRouteManageRSQL(){
		...
		params.put("n4th_skd_dir_cd",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		query.append("SELECT 'Y' UPD_IND_CD" ).append("\n"); 
		...
		query.append("   AND NVL(N1ST_SKD_DIR_CD, 'X') = RTRIM(@[n1st_skd_dir_cd])" ).append("\n"); 
		...
		query.append("   AND NVL(N2ND_SKD_DIR_CD, 'X') = NVL(RTRIM(@[n2nd_skd_dir_cd]), 'X')" ).append("\n"); 
		...
		query.append("   AND NVL(N3RD_SKD_DIR_CD, 'X') = NVL(RTRIM(@[n3rd_skd_dir_cd]), 'X')" ).append("\n"); 
		...
		query.append("   AND NVL(N4TH_SKD_DIR_CD, 'X') = NVL(RTRIM(@[n4th_skd_dir_cd]), 'X')" ).append("\n"); 
		query.append("  -- AND NVL(UPD_IND_CD, 'S') = 'N'" ).append("\n"); 
