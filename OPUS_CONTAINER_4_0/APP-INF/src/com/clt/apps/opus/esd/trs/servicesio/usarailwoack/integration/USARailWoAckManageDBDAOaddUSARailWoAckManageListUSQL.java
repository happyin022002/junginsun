...
public class USARailWoAckManageDBDAOaddUSARailWoAckManageListUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		,X.WBL_NO					= NVL(@[wbl_no], X.WBL_NO)" ).append("\n"); 
		query.append("		,X.CXL_RQST_DT              = DECODE(@[bil_edi_rcv_rslt_cd], 'A', NULL, GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[cre_ofc_cd]))" ).append("\n"); 
		query.append("		,X.CXL_RQST_RJCT_RSN		= DECODE(@[bil_edi_rcv_rslt_cd], 'A', NULL, @[cxl_rqst_rjct_rsn])" ).append("\n"); 
