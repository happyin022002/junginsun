...
*@FileName : ESD_LEA_0006HTMLAction.java
...
public class ESD_LEA_0006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0006HTMLAction 객체를 생성
	 */
	public ESD_LEA_0006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0006Event event = new EsdLea0006Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchResultRevenueMonthListVO((SearchAccrualBatchResultRevenueMonthListVO)getVO(request, SearchAccrualBatchResultRevenueMonthListVO .class));
		}
