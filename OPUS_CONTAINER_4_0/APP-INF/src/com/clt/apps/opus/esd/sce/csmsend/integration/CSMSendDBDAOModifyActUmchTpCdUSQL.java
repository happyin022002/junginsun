...
*@FileName : CSMSendDBDAOModifyActUmchTpCdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSMSendDBDAOModifyActUmchTpCdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSMSendDBDAOModifyActUmchTpCdUSQL(){
		setQuery();
		...
		query.append("FileName : CSMSendDBDAOModifyActUmchTpCdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCE_CNTR_STS_MSG_TGT" ).append("\n"); 
