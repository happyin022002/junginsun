...
public class StatusInquiryDBDAOSearchTPBDetailInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",DECODE( (SELECT COUNT(1) FROM TPB_OTS_GRP_STS WHERE OTS_STS_CD = 'T' AND N3PTY_NO = B.N3PTY_NO), 0, TRUNC(SYSDATE - B.CFM_DT), TRUNC(SYSDATE - (SELECT MAX(CRE_DT) FROM TPB_OTS_GRP_STS WHERE OTS_STS_CD = 'T' AND N3PTY_NO = B.N3PTY_NO) )) AS OVERDUE" ).append("\n"); 
