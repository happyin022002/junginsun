...
public class SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListEurDrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	  ,CASE WHEN TRSP_COST_DTL_MOD_CD = 'DR' AND TRSP_BND_CD = 'I' THEN NVL(T_ACT_CUST_CD, TO_CHAR(CNEE_CUST_SEQ)) ELSE T_ACT_CUST_CD  END 	ACT_CUST_CD" ).append("\n"); 
		query.append("      ,T_ACT_CUST_CNT_CD AS ACT_CUST_CNT_CD" ).append("\n"); 
		query.append("      ,T_ACT_CUST_SEQ AS ACT_CUST_SEQ" ).append("\n"); 
		query.append("      ,'' AS ACT_CUST_ADDR_SEQ" ).append("\n"); 
		...
		query.append("      ,'' AS CNTC_PSON_FAX_NO" ).append("\n"); 
		query.append("      ,T_CNTC_PSON_NM AS CNTC_PSON_NM" ).append("\n"); 
		query.append("      ,T_TRSP_RQST_ORD_RMK AS SPCL_INSTR_RMK " ).append("\n"); 
		query.append("      ,NULL AS USA_DO_USR_INFO" ).append("\n"); 
		query.append("      ,NULL AS DO_CRE_DATE" ).append("\n"); 
		query.append("      ,NULL AS DO_CRE_TIME" ).append("\n"); 
		...
		query.append("      ,NVL2(T_EXIST, 'KGS', WGT_MEAS_UT_CD) WGT_MEAS_UT_CD" ).append("\n"); 
		...
		query.append("      ,TRS_COMMON_PKG.GET_CONV_WGT_TO_KGS_FNC(NVL2(T_EXIST, 'KGS', WGT_MEAS_UT_CD), NVL2(T_EXIST, T_CNTR_WGT, CNTR_WGT)) AS CNTR_KGS_WGT" ).append("\n"); 
		query.append("      ,TRS_COMMON_PKG.GET_CONV_WGT_TO_LBS_FNC(NVL2(T_EXIST, 'KGS', WGT_MEAS_UT_CD), NVL2(T_EXIST, T_CNTR_WGT, CNTR_WGT)) AS CNTR_LBS_WGT" ).append("\n"); 
		...
		query.append("      ,T_CSTMS_CLR_NO  AS CUSTOMSCLEARANCENO" ).append("\n"); 
		query.append("      ,DECODE(T_CSTMS_CLR_NO,NULL, '', 'Y')   AS CUSTOMSCLEARANCE      " ).append("\n"); 
		query.append("      ,T_MLT_STOP_DE_FLG AS MLT_STOP_DE_FLG" ).append("\n"); 
		query.append("      ,T_PROC_CFM_IND_CD AS PROC_CFM_IND_CD" ).append("\n"); 
		query.append("      ,TRSP_COST_DTL_MOD_SEP" ).append("\n"); 
		query.append("      ,T_DCGO_SEQ AS DCGO_SEQ" ).append("\n"); 
		query.append("      ,T_RC_SEQ AS RC_SEQ" ).append("\n"); 
		query.append("      ,T_AWK_CGO_SEQ AS AWK_CGO_SEQ" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("           ,(SELECT MIN(DCGO_SEQ) FROM BKG_EUR_TRO_DG_SEQ DG WHERE DG.BKG_NO=X.BKG_NO AND DG.IO_BND_CD=X.TRSP_BND_CD AND DG.TRO_SEQ = X.TRO_SEQ) AS T_DCGO_SEQ" ).append("\n"); 
		query.append("           " ).append("\n"); 
		...
		query.append("                         ||'^'|| TO_CHAR(NVL(HD.TRNS_REV_AMT,0)+NVL(HD.NMF_TRNS_REV_AMT, 0)+NVL(HD.ADD_REV_AMT, 0))" ).append("\n"); 
		query.append("                         ||'^'|| HD.CFM_OFC_CD" ).append("\n"); 
		query.append("                         ||'^'|| HD.CFM_USR_ID" ).append("\n"); 
		query.append("                         ||'^'|| TO_CHAR(NVL2(HD.CFM_UPD_DT,HD.CFM_UPD_DT,HD.CFM_DT) ,'YYYYMMDDHH24MISS')" ).append("\n"); 
		...
		query.append("                         ||'^'|| RTRIM(SUBSTR(DTL.DOR_ADDR, 51, 50))||' '||RTRIM(SUBSTR(DTL.DOR_ADDR, 101, 50))||' '||RTRIM(SUBSTR(DTL.DOR_ADDR, 151, 50))" ).append("\n"); 
		query.append("                         ||'^'|| SUBSTR(DTL.DOR_ADDR, 1, 50)" ).append("\n"); 
		...
		query.append("                     AND ROWNUM = 1 ) DTL_INFO" ).append("\n"); 
