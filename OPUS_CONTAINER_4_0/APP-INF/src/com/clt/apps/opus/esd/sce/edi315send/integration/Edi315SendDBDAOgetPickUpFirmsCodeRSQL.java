...
public class Edi315SendDBDAOgetPickUpFirmsCodeRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT CASE WHEN YD2.YD_CSTMS_NO IS NOT NULL THEN YD2.YD_CSTMS_NO || '/' || YD2.YD_CD" ).append("\n"); 
		query.append("            ELSE NULL" ).append("\n"); 
		query.append("        END AS PKUP_FIRMS" ).append("\n"); 
		...
		query.append("          AND AVVD.SKD_DIR_CD = BKGM.SKD_DIR_CD ) LEFT OUTER JOIN BKG_HRD_CDG_CTNT AHDG -- ANRBS SUB CODE" ).append("\n"); 
