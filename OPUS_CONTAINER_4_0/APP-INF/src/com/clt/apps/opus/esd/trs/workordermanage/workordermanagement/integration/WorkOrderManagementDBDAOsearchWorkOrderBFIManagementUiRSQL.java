...
*@FileName : WorkOrderManagementDBDAOsearchWorkOrderBFIManagementUiRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderManagementDBDAOsearchWorkOrderBFIManagementUiRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchWorkOrderBFIManagementUi
	  * </pre>
	  */
	public WorkOrderManagementDBDAOsearchWorkOrderBFIManagementUiRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderManagementDBDAOsearchWorkOrderBFIManagementUiRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
