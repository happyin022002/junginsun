...
public class TerminalAgreementManageDBDAOSearchTerminalAgreementTerminalRateDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("D.R4, D.R5, D.R7, D.F2, D.F4, D.O2, D.O4, D.S2, D.S4," ).append("\n"); 
		query.append("D.T2, D.T4, D.A2, D.A4, D.P2, D.P4, D.F5," ).append("\n"); 
		...
		query.append(",MAX(F2) F2, MAX(F4) F4 ,MAX(O2) O2, MAX(O4) O4, MAX(S2) S2, MAX(S4) S4" ).append("\n"); 
		query.append(",MAX(T2) T2, MAX(T4) T4, MAX(A2) A2, MAX(A4) A4, MAX(P2) P2, MAX(P4) P4" ).append("\n"); 
