...
public class SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListUsaDrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	  ,CASE WHEN TRSP_COST_DTL_MOD_CD = 'DR' AND TRSP_BND_CD ='I'  AND " ).append("\n"); 
		...
		query.append("				) IN ('XXX', 'WEB', 'TRS D/O') THEN CNEE_CUST_CNT_CD||TO_CHAR(CNEE_CUST_SEQ)" ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("      ,CASE WHEN D_EXIST IS NOT NULL THEN D_SPCL_INSTR_RMK " ).append("\n"); 
		...
		query.append("      ,CASE WHEN D_EXIST IS NOT NULL THEN D_USA_DO_USR_INFO " ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN N_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("       END AS USA_DO_USR_INFO " ).append("\n"); 
		query.append("      ,CASE WHEN D_EXIST IS NOT NULL THEN (SELECT USR_NM FROM COM_USER WHERE USR_ID = D_USA_DO_USR_INFO)" ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN N_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("       END AS USA_DO_USR_INFO1" ).append("\n"); 
		query.append("       ,CASE WHEN D_EXIST IS NOT NULL THEN (SELECT XTN_PHN_NO FROM COM_USER WHERE USR_ID = D_USA_DO_USR_INFO)" ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN N_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("       END AS USA_DO_USR_INFO2" ).append("\n"); 
		query.append("       ,CASE WHEN D_EXIST IS NOT NULL THEN (SELECT USR_EML FROM COM_USER WHERE USR_ID = D_USA_DO_USR_INFO)" ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN N_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("       END AS USA_DO_USR_INFO3" ).append("\n"); 
		query.append("      ,CASE WHEN D_EXIST IS NOT NULL THEN SUBSTR(D_DO_CRE_DT,1,8) " ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN N_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("       END AS DO_CRE_DATE " ).append("\n"); 
		query.append("      ,CASE WHEN D_EXIST IS NOT NULL THEN SUBSTR(D_DO_CRE_DT,9) " ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN N_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		...
		query.append("      ,CASE WHEN D_EXIST IS NOT NULL THEN NULL" ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN DECODE(T_PROC_CFM_IND_CD,'Y','C')" ).append("\n"); 
		...
		query.append("           ,NVL(REGEXP_SUBSTR(X.CGO_RLSE, '[^^]+', 1, 1), 'N') AS CGOR_FRT_PAY_IND_FLG" ).append("\n"); 
		query.append("           ,NVL(REGEXP_SUBSTR(X.CGO_RLSE, '[^^]+', 1, 2), 'N') AS CGOR_ORG_BL_RCVR_IND_FLG" ).append("\n"); 
		query.append("           ,NVL(REGEXP_SUBSTR(X.CGO_RLSE, '[^^]+', 1, 3), 'N') AS CGOR_CSTMS_ACPT_RE_IND_FLG" ).append("\n"); 
		...
		query.append("            WHEN SUBSTR(X.TRO_INFO, INSTR(X.TRO_INFO, '^', 1,14) + 1, INSTR(X.TRO_INFO, '^', 1,15) - INSTR(X.TRO_INFO, '^', 1,14) - 1) = 'Y' THEN 'DP'" ).append("\n"); 
		...
		query.append("           ,TRS_CYDOOR_COMM_PKG.GET_MULTI_LST_LOC(X.FM_NOD_CD, DECODE(X.TRSP_COST_DTL_MOD_CD, 'DR', X.DOR_NOD_CD, X.TO_NOD_CD)) AS LST_LOC_CD" ).append("\n"); 
		...
		query.append("           ,CASE WHEN X.MST_LCL_CD = 'P' AND SUBSTR(X.BDR_INFO, INSTR(X.BDR_INFO, '^', 1, 1) + 1) = 'N'  AND X.TRSP_BND_CD            = 'I' AND X.TRSP_COST_DTL_MOD_CD   = 'DR'  THEN 'FALSE'" ).append("\n"); 
		query.append("                 WHEN X.MST_LCL_CD = 'P' THEN 'TRUE'" ).append("\n"); 
		...
		query.append("           ,'' LSE_CNTR_FLG" ).append("\n"); 
		query.append("           ,'' TRSP_CRR_MOD_CD2" ).append("\n"); 
		query.append("		   ,X.R_CCT AS R_CCT" ).append("\n"); 
		query.append("		   ,X.T_CCT AS T_CCT" ).append("\n"); 
		...
		query.append("           ,SUBSTR(X.TRO_INFO, INSTR(X.TRO_INFO, '^', 1,13) + 1,  INSTR(X.TRO_INFO, '^', 1,14) -  INSTR(X.TRO_INFO, '^', 1,13)  - 1) AS TRI_AXL_REQ_FLG " ).append("\n"); 
		query.append("           " ).append("\n"); 
		...
		query.append("           ,SUBSTR(X.CUST_INFO_N, INSTR(X.CUST_INFO_N, '^', 1,10) + 1,  INSTR(X.CUST_INFO_N, '^', 1,11) -  INSTR(X.CUST_INFO_N, '^', 1,10)  - 1) AS N_EXIST" ).append("\n"); 
		query.append("           " ).append("\n"); 
		...
		query.append("           ,DECODE(X.CGO_TP_CD, 'F', DECODE(B.BKG_STS_CD, 'W', 'W')) BKG_STS_CD" ).append("\n"); 
		query.append("           ,DECODE(X.CGO_TP_CD, 'F', DECODE(B.BKG_STS_CD, 'W', INTG.INTG_CD_VAL_DESC)) BKG_STS_CD_NM" ).append("\n"); 
		...
		query.append("                       AND  DOH.BL_NO   = TMP.BL_NO" ).append("\n"); 
		query.append("                       AND  DOD.EQ_NO   = TMP.EQ_NO) DO_INFO" ).append("\n"); 
		...
		query.append("			  AND TMP.BKG_NO = RCL.BKG_NO(+)" ).append("\n"); 
		query.append("			  AND RCL.CLZ_TP_CD(+) = 'R'" ).append("\n"); 
		query.append("			  AND TMP.BKG_NO = PCL.BKG_NO(+)" ).append("\n"); 
