...
public class EsdTpb0121Event extends EventSupport {
	...
	public SearchEACIssuanceListVO[] getSearchEACIssuanceListVOs() {
		SearchEACIssuanceListVO[] rtnVOs = null;
		if (this.searchEACIssuanceListVOs != null) {
			rtnVOs = Arrays.copyOf(searchEACIssuanceListVOs, searchEACIssuanceListVOs.length);
		}
		return rtnVOs;
	}

	public void setSearchEACIssuanceListVOs(SearchEACIssuanceListVO[] searchEACIssuanceListVOs){
		if(searchEACIssuanceListVOs != null){
			SearchEACIssuanceListVO[] tmpVOs = Arrays.copyOf(searchEACIssuanceListVOs, searchEACIssuanceListVOs.length);
			this.searchEACIssuanceListVOs = tmpVOs;
		}
	}
