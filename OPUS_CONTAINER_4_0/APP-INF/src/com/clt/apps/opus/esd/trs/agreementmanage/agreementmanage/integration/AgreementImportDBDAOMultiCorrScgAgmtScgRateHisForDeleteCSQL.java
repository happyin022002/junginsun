...
*@FileName : AgreementImportDBDAOMultiCorrScgAgmtScgRateHisForDeleteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOMultiCorrScgAgmtScgRateHisForDeleteCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Surcharge Rate Deletion History 입력
	  * </pre>
	  */
	public AgreementImportDBDAOMultiCorrScgAgmtScgRateHisForDeleteCSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAOMultiCorrScgAgmtScgRateHisForDeleteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
