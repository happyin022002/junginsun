...
*@FileName : OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOffdock3rdIFlist
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT ROWNUM TMP_TPB_SEQ, @[tmp_dtl_seq] TMP_DTL_SEQ, 'A' CALC_TP_CD," ).append("\n"); 
		query.append("'TM' CALC_COST_GRP_CD, S.CNTR_NO, S.TML_SO_OFC_CTY_CD, S.TML_SO_SEQ," ).append("\n"); 
		...
		query.append("--T.BL_NO_TP, T.BL_NO_CHK, T.BKG_NO_SPLIT," ).append("\n"); 
		...
		query.append("--L.BL_NO_TP, L.BL_NO_CHK, L.BKG_NO_SPLIT," ).append("\n"); 
		...
		query.append("AND DECODE(L.RC_FLG,'Y','Y','N') = @[param_rc_flg]" ).append("\n"); 
