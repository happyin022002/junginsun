...
*@FileName : SearchEGSPManageVO.java
*@FileTitle : SearchEGSPManageVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esd.spe.mastermanage.evaluationgroupserviceprovidermanage.vo;
...
public class SearchEGSPManageVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEGSPManageVO> models = new ArrayList<SearchEGSPManageVO>();
	...
	public SearchEGSPManageVO() {}

	public SearchEGSPManageVO(String ibflag, String pagerows, String egId, String egIdSeq, String vndrSeq, String vndrLglEngNm, String engVndrRmk, String egRhqCd, String egCtyCd, String svcCateCd, String egIdEtc) {
		this.ibflag = ibflag;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("eg_id_etc", getEgIdEtc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("eg_id_etc", "egIdEtc");
	 ...
	 * @param egIdEtc
	 */
	public void setEgIdEtc(String egIdEtc) {
		this.egIdEtc = egIdEtc;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setEgIdEtc(JSPUtil.getParameter(request, prefix + "eg_id_etc", ""));
	 ...
	 */
	public SearchEGSPManageVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEGSPManageVO[]
	 */
	public SearchEGSPManageVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEGSPManageVO model = null;
		...
		try {
			...
			String[] egIdEtc = (JSPUtil.getParameter(request, prefix	+ "eg_id_etc", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			
			for (int i = 0; i < length; i++) {
				model = new SearchEGSPManageVO();
				if (ibflag[i] != null)
	...
	public SearchEGSPManageVO[] getSearchEGSPManageVOs(){
		SearchEGSPManageVO[] vos = (SearchEGSPManageVO[])models.toArray(new SearchEGSPManageVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.egIdEtc = this.egIdEtc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
