...
public class EsdTpb0117Event extends EventSupport {
	...
	public SearchTPBStatusSummaryVO[] getSearchTPBStatusSummaryVOs() {
		SearchTPBStatusSummaryVO[] rtnVOs = null;
		if (this.searchTPBStatusSummaryVOs != null) {
			rtnVOs = Arrays.copyOf(searchTPBStatusSummaryVOs, searchTPBStatusSummaryVOs.length);
		}
		return rtnVOs;
	}

	public void setSearchTPBStatusSummaryVOs(SearchTPBStatusSummaryVO[] searchTPBStatusSummaryVOs){
		if(searchTPBStatusSummaryVOs != null){
			SearchTPBStatusSummaryVO[] tmpVOs = Arrays.copyOf(searchTPBStatusSummaryVOs, searchTPBStatusSummaryVOs.length);
			this.searchTPBStatusSummaryVOs = tmpVOs;
		}
	}
