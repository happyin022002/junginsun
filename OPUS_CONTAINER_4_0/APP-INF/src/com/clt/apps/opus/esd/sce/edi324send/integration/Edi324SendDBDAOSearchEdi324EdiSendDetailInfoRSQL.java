...
public class Edi324SendDBDAOSearchEdi324EdiSendDetailInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , ROUND((BK.CNTR_WGT * DECODE(BK.WGT_UT_CD, 'KGS', '2.2046', '1') ),3) CNTR_LBS_WGT" ).append("\n"); 
		...
		query.append("     , DST.YD_NM AS DEST_YD_NM" ).append("\n"); 
		...
		query.append("     , (SELECT DMY.YD_LOC_CTY_NM, DMY.YD_LOC_STE_CD, DML.LOC_NM, DMY.YD_NM" ).append("\n"); 
