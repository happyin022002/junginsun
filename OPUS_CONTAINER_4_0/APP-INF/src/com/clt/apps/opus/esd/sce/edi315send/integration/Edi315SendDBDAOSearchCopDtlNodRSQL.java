...
*@FileName : Edi315SendDBDAOSearchCopDtlNodRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Edi315SendDBDAOSearchCopDtlNodRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * for search cop detail node
	  * </pre>
	  */
	public Edi315SendDBDAOSearchCopDtlNodRSQL(){
		setQuery();
		...
		query.append("FileName : Edi315SendDBDAOSearchCopDtlNodRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
