...
*@FileName : BkgCopManageDBDAOSearchBfSplitCopInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOSearchBfSplitCopInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BkgCopManageDBDAOSearchBfSplitCopInfoRSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOSearchBfSplitCopInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
