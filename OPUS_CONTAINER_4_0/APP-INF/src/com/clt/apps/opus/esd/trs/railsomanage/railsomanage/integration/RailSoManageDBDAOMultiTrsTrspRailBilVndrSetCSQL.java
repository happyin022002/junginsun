...
*@FileName : RailSoManageDBDAOMultiTrsTrspRailBilVndrSetCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailSoManageDBDAOMultiTrsTrspRailBilVndrSetCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RailSoManageDBDAOMultiTrsTrspRailBilVndrSetCSQL(){
		setQuery();
		...
		query.append("FileName : RailSoManageDBDAOMultiTrsTrspRailBilVndrSetCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
