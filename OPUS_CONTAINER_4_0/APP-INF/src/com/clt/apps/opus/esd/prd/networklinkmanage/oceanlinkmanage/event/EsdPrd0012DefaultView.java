		...
		try {
			...
			if (eventResponse != null) {
				...
				for (int i = 0; i < rsVoList.size(); i++) {
					...
					xmlString.append("<TD><![CDATA[" + JSPUtil.getNull(colValues.get("skd_dir_cd")) + "]]></TD>");
					xmlString.append("<TD><![CDATA[" + JSPUtil.getNull(colValues.get("fm_port_cd")) + "]]></TD>");
					...
					xmlString.append("<TD><![CDATA[" + JSPUtil.getNull(colValues.get("to_port_cd")) + "]]></TD>");
