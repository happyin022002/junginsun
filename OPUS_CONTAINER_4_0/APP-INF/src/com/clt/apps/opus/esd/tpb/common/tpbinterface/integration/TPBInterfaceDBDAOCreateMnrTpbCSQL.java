...
*@FileName : TPBInterfaceDBDAOCreateMnrTpbCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TPBInterfaceDBDAOCreateMnrTpbCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TPBInterfaceDBDAOCreateMnrTpbCSQL(){
		setQuery();
		...
		params.put("src_vndr_cnt_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("estm_dtl_seq_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("src_vndr_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("estm_rvis_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TPBInterfaceDBDAOCreateMnrTpbCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("call TPB_CRE_IF_DATA_MNR_PRC(" ).append("\n"); 
		...
		query.append(",@[estm_dtl_seq_no]" ).append("\n"); 
		query.append(",@[estm_rvis_no]" ).append("\n"); 
