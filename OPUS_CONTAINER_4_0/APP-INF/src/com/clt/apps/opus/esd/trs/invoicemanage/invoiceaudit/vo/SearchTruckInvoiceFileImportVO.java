...
public class SearchTruckInvoiceFileImportVO extends AbstractValueObject {
	...
	/* Column Info */
	private String emptyEqNoVerifyCheck = null;
	/* Column Info */
	...
	public SearchTruckInvoiceFileImportVO(String ibflag, String pagerows, String eqNo, String orgEqNo, String eqTpszCd, String orgEqTpszCd, String eqKndCd, String fmLocValue, String fmYardValue, String viaLocValue, String viaYardValue, String toLocValue, String toYardValue, String dorLocValue, String dorYardValue, String custCntCd, String custSeq, String dorDeAddr, String currCd, String bzcAmt, String negoAmt, String fuelScgAmt, String etcAddAmt, String woTotAmt, String trspInvCalcLgcTpCd, String invXchRt, String invCurrCd, String invBzcAmt, String invEtcAddAmt, String trspWoOfcCtyCd, String trspWoSeq, String trspWoOfcCtyCdSeq, String creDt, String creTm, String copExeDt, String bkgNo, String blNo, String cgoTpCd, String spclCgoCntrTpCd, String trspBndCd, String trspCostDtlModCd, String dorSvcTpCd, String n3ptyBilFlg, String verifyResult, String interRmk, String spclInstrRmk, String cntrNo, String cntrTpszCd, String orgGateOutDt, String destGateInDt, String trspSoOfcCtyCdSeq, String trspSoOfcCtyCd, String trspSoSeq, String surchargeKey, String trspMtyCostModCd, String trspSoTpCd, String creOfcCd, String costActGrpCd, String cntrSubFlg, String refInvNo, String emptyEqNoVerifyCheck) {
		...
		this.emptyEqNoVerifyCheck = emptyEqNoVerifyCheck;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cop_exe_dt", getCopExeDt());
		...
		this.hashColumns.put("empty_eq_no_verify_check", getEmptyEqNoVerifyCheck());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cop_exe_dt", "copExeDt");
		...
		this.hashFields.put("empty_eq_no_verify_check", "emptyEqNoVerifyCheck");
	 ...
	 * @return copExeDt
	 */
	public String getCopExeDt() {
		return this.copExeDt;
	}
	...
	/**
	 * Column Info
	 * @return emptyEqNoVerifyCheck
	 */
	public String getEmptyEqNoVerifyCheck() {
		return this.emptyEqNoVerifyCheck;
	}
	 ...
	 * @param copExeDt
	 */
	public void setCopExeDt(String copExeDt) {
		this.copExeDt = copExeDt;
	}
	...
	/**
	 * Column Info
	 * @param emptyEqNoVerifyCheck
	 */
	public void setEmptyEqNoVerifyCheck(String emptyEqNoVerifyCheck) {
		this.emptyEqNoVerifyCheck = emptyEqNoVerifyCheck;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCopExeDt(JSPUtil.getParameter(request, prefix + "cop_exe_dt", ""));
		...
		setEmptyEqNoVerifyCheck(JSPUtil.getParameter(request, prefix + "empty_eq_no_verify_check", ""));
	...
	public SearchTruckInvoiceFileImportVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] copExeDt = (JSPUtil.getParameter(request, prefix	+ "cop_exe_dt", length));
			...
			String[] emptyEqNoVerifyCheck = (JSPUtil.getParameter(request, prefix	+ "empty_eq_no_verify_check", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (emptyEqNoVerifyCheck[i] != null)
					model.setEmptyEqNoVerifyCheck(emptyEqNoVerifyCheck[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.copExeDt = this.copExeDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.emptyEqNoVerifyCheck = this.emptyEqNoVerifyCheck .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
