...
public class SaveOceanRouteVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSRouteRmk(JSPUtil.getParameter(request, "s_route_note", ""));
