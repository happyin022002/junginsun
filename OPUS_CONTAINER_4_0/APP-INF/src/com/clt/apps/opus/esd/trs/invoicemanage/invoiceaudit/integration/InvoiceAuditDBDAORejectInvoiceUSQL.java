...
*@FileName : InvoiceAuditDBDAORejectInvoiceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceAuditDBDAORejectInvoiceUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice 상태를 Reject 상태로 수정
	  * </pre>
	  */
	public InvoiceAuditDBDAORejectInvoiceUSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceAuditDBDAORejectInvoiceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET INV_RJCT_FLG        = 'Y'" ).append("\n"); 
		query.append("      ,TRSP_INV_AUD_STS_CD = 'RJ'" ).append("\n"); 
