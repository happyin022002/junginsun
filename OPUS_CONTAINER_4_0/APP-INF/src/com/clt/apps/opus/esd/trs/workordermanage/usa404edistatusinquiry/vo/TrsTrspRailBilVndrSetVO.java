...
public class TrsTrspRailBilVndrSetVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("appl_rt", getApplRt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("appl_rt", "applRt");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTrspRailScgCd(JSPUtil.getParameter(request, "trsp_rail_scg_cd", ""));
		setApplRt(JSPUtil.getParameter(request, "appl_rt", ""));
		setTrspAgmtScgSeq(JSPUtil.getParameter(request, "trsp_agmt_scg_seq", ""));
		setComScgKndCd(JSPUtil.getParameter(request, "com_scg_knd_cd", ""));
		setComScgSeq(JSPUtil.getParameter(request, "com_scg_seq", ""));
	}
	...
	public TrsTrspRailBilVndrSetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] applRt = (JSPUtil.getParameter(request, prefix	+ "appl_rt", length));
	...
	*/
	public void unDataFormat(){
		...
		this.applRt = this.applRt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
