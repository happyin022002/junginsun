...
*@FileName : Edi315SendDBDAOGetCopVeVdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Edi315SendDBDAOGetCopVeVdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Edi315SendDBDAOGetCopVeVdRSQL(){
		setQuery();
		...
		query.append("FileName : Edi315SendDBDAOGetCopVeVdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if(${e_chk_sts} != '')" ).append("\n"); 
		query.append("and     EDI_STS_CD      like  @[e_chk_sts]||'%'" ).append("\n"); 
