...
*@FileName : ManualInputDBDAORemoveActualActivityMappingDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualInputDBDAORemoveActualActivityMappingDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ManualInputDBDAORemoveActualActivityMappingDSQL(){
		setQuery();
		...
		query.append("FileName : ManualInputDBDAORemoveActualActivityMappingDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE SCE_ACT_ACT_MAPG" ).append("\n"); 
