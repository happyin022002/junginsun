...
*@FileName : InvoiceManageDBDAOSearchInvoiceOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManageDBDAOSearchInvoiceOfficeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * Invoice Office 유무 확인
	  * </pre>
	  */
	public InvoiceManageDBDAOSearchInvoiceOfficeRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceManageDBDAOSearchInvoiceOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(INV_ISS_OFC_CD) CNT" ).append("\n"); 
