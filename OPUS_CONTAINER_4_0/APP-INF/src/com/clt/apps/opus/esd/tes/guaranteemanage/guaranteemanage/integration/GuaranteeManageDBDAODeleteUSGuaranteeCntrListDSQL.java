...
*@FileName : GuaranteeManageDBDAODeleteUSGuaranteeCntrListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GuaranteeManageDBDAODeleteUSGuaranteeCntrListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guarantee CNTR 목록 삭제
	  * </pre>
	  */
	public GuaranteeManageDBDAODeleteUSGuaranteeCntrListDSQL(){
		setQuery();
		...
		query.append("FileName : GuaranteeManageDBDAODeleteUSGuaranteeCntrListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE	FROM	TES_GNTE_CNTR_LIST" ).append("\n"); 
