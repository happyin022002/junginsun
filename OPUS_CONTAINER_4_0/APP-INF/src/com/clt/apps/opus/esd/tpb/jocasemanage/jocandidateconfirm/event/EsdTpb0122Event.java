...
public class EsdTpb0122Event extends EventSupport {
	...
	public void setSearchJOCandidateConfirmListVOS(SearchJOCandidateConfirmListVO[] searchJOCandidateConfirmListVOs){
		if(searchJOCandidateConfirmListVOs != null){
			SearchJOCandidateConfirmListVO[] tmpVOs = Arrays.copyOf(searchJOCandidateConfirmListVOs, searchJOCandidateConfirmListVOs.length);
			this.searchJOCandidateConfirmListVOs = tmpVOs;
		}
	}
	...
	public SearchJOCandidateConfirmListVO[] getSearchJOCandidateConfirmListVOS(){
		SearchJOCandidateConfirmListVO[] rtnVOs = null;
		if (this.searchJOCandidateConfirmListVOs != null) {
			rtnVOs = Arrays.copyOf(searchJOCandidateConfirmListVOs, searchJOCandidateConfirmListVOs.length);
		}
		return rtnVOs;
	}
