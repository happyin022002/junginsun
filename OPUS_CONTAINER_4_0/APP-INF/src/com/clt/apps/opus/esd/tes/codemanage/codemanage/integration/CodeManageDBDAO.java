...
//			int insCnt = 
			new SQLExecuter("").executeUpdate((ISQLTemplate)new CodeManageDBDAOModifyCostCodeUSQL(), param, null);
...
//	}
    ...
    /**
     * Terminal SO Cost Code 조회<br>
     *
     * @param model 
     * @return DBRowSet 
     * @exception DAOException
     */
    public DBRowSet searchTmnlSoCostCode(TesTmlSoCostVO model) throws DAOException {
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CodeManageDBDAOSearchTmnlSoCostCodeRSQL(), param, velParam);
    ...
    /**
     * Terminal Agreement Cost Code 조회<br>
     *
     * @param model 
     * @return DBRowSet 
     * @exception DAOException
     */
    public DBRowSet searchTmnlAgmtCostCode(TesTmlAgmtCostVO model) throws DAOException {
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CodeManageDBDAOSearchTmnlAgmtCostCodeRSQL(), param, velParam);
    ...
    /**
     * Terminal Agreement Verify Method 조회<br>
     *
     * @param model 
     * @return DBRowSet 
     * @exception DAOException
     */
    public DBRowSet searchTmnlAgmtVrfyMzdCode(TesTmlAgmtVrfyMzdVO model) throws DAOException {
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CodeManageDBDAOSearchTmnlAgmtVrfyMzdRSQL(),  param, velParam);
