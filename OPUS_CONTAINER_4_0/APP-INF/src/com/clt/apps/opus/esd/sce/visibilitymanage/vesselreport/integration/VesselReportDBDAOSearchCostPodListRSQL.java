...
public class VesselReportDBDAOSearchCostPodListRSQL implements ISQLTemplate{
	...
	public VesselReportDBDAOSearchCostPodListRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.alps.esd.sce.visibilitymanage.vesselreport.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("#if (${cost_div} == 'PHXSC')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${cost_div} == 'TORBB')" ).append("\n"); 
