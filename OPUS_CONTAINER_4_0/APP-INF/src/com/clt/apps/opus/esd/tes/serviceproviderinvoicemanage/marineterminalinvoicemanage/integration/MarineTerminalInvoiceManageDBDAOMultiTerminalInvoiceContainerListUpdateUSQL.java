...
*@FileName : MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceContainerListUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceContainerListUpdateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceContainerListUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceContainerListUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("						,IO_BND_CD                  = DECODE(@[io_bnd_cd],'X',LOWER(@[io_bnd_cd_df]),@[io_bnd_cd])		-- io_bnd_cd    io_bnd_cd_df는 dtl정보에서 가져옴" ).append("\n"); 
		...
		query.append("						,TML_TRNS_MOD_CD            = @[tml_trns_mod_cd]  							-- tml_trns_mod_cd" ).append("\n"); 
		...
		query.append("						,TS_MTY_FLG                 = DECODE(@[cntr_sty_cd],'M',DECODE(@[locl_ts_ind_cd],'T','Y',''),'')" ).append("\n"); 
		query.append("						,SUB_TRD_CD					= DECODE(@[sub_trd_cd],'','','OTH','O',@[sub_trd_cd])" ).append("\n"); 
