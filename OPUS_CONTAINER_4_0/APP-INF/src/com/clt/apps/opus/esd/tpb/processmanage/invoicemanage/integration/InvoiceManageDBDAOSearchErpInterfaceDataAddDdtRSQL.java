...
*@FileName : InvoiceManageDBDAOSearchErpInterfaceDataAddDdtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManageDBDAOSearchErpInterfaceDataAddDdtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchErpInterfaceDataAddDdt
	  * </pre>
	  */
	public InvoiceManageDBDAOSearchErpInterfaceDataAddDdtRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceManageDBDAOSearchErpInterfaceDataAddDdtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(ADD_AMT,0)-NVL(DDCT_AMT,0)" ).append("\n"); 
