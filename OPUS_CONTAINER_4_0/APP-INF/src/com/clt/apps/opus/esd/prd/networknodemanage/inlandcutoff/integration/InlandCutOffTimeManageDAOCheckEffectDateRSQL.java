...
*@FileName : InlandCutOffTimeManageDAOCheckEffectDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCutOffTimeManageDAOCheckEffectDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InlandCutOffTimeManageDAOCheckEffectDate
	  * </pre>
	  */
	public InlandCutOffTimeManageDAOCheckEffectDateRSQL(){
		setQuery();
		...
		query.append("FileName : InlandCutOffTimeManageDAOCheckEffectDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
