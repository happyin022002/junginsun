...
public class Edi315SendVO extends AbstractValueObject {
	...
	/* Column Info */
	private String copCallModule = null;
	...
	public Edi315SendVO(String ibflag, String pagerows, String rcvDt, String rcvSeq, String ediStatus, String custStatus, String mvmtSts, String copActCd, String bkgNo, String blNo, String cntrNo, String copNo, String copDtlSeq, String currVvd, String eventDt, String eventYard, String creDt, String creId, String callFrom, String manFlg, String logFlg, String ediGrpCd, String actRcvIfKeyDt, String actRcvIfKeyNo, String copInd, String costActGrpSeq, String updId, String updDt, String cntrCallCnt, String vdlByCntrAttach, String ediIfKeyDt, String ediIfKeySeq, String callFmSrcId, String fmBtchFlg, String ifRmk, String copCallModule) {
		...
		this.copCallModule = copCallModule;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cop_call_module", getCopCallModule());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cop_call_module", "copCallModule");
	...
	/**
	 * Column Info
	 * @return copCallModule
	 */
	public String getCopCallModule() {
		return copCallModule;
	}
	/**
	 * Column Info
	 * @param copCallModule
	 */
	public void setCopCallModule(String copCallModule) {
		this.copCallModule = copCallModule;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCopCallModule(JSPUtil.getParameter(request, prefix + "cop_call_module", ""));
	}
	...
	public Edi315SendVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] copCallModule = (JSPUtil.getParameter(request, prefix	+ "cop_call_module", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (copCallModule[i] != null)
					model.setCopCallModule(copCallModule[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.copCallModule = this.copCallModule .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
