 ...
 *@FileName : ESD_PRD_0039HTMLAction.java
 ...
 * 
 * @author
 * @see EsdPrd0039Event , ESD_PRD_0039EventResponse 참조
 * @since J2EE 1.6
 */
public class ESD_PRD_0039HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 6333237295305704560L;

	/**
	 * ESD_PRD_0039HTMLAction 객체를 생성
	 */
	public ESD_PRD_0039HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_PRD_0039Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsdPrd0039Event event = new EsdPrd0039Event();
		event.setPrdTmlVgmCctHisVO((PrdTmlVgmCctHisVO) getVO(request, PrdTmlVgmCctHisVO.class));
