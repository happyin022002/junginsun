...
public class PrdCreateManageDBDAOUpdatePrdDtlObTrspModDtermUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PrdCreateManageDBDAOUpdatePrdDtlObTrspModDtermUSQL(){
		setQuery();
		...
		query.append("FileName : PrdCreateManageDBDAOUpdatePrdDtlObTrspModDtermUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
