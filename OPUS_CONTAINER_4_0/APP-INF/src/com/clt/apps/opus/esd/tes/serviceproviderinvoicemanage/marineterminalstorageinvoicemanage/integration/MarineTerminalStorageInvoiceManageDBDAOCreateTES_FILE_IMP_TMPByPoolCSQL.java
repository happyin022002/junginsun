...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateTES_FILE_IMP_TMPByPool
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
