 ...
 * @since J2EE 1.6
 */
public class ESD_SCE_3303HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SCE_3303HTMLAction Object creation
	 */
	public ESD_SCE_3303HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce3303Event event = new EsdSce3303Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setActivityGroupMappingVO((ActivityGroupMappingVO)getVO(request, ActivityGroupMappingVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setActivityGroupMappingVOs((ActivityGroupMappingVO[])getVOs(request, ActivityGroupMappingVO .class));
