...
*@FileName : RailBillingReqCreateDBDAOUpdateEqrRepoExeSoIfEmptyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailBillingReqCreateDBDAOUpdateEqrRepoExeSoIfEmptyUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Update EQR_REPO_EXE_SO_IF (Empty Cntr) SQL
	  * </pre>
	  */
	public RailBillingReqCreateDBDAOUpdateEqrRepoExeSoIfEmptyUSQL(){
		setQuery();
		...
		query.append("FileName : RailBillingReqCreateDBDAOUpdateEqrRepoExeSoIfEmptyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
