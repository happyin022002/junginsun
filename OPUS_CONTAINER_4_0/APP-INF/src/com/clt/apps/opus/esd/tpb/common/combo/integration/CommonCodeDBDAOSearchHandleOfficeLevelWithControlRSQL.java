...
*@FileName : CommonCodeDBDAOSearchHandleOfficeLevelWithControlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonCodeDBDAOSearchHandleOfficeLevelWithControlRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchHandleOfficeLevelWithControl
	  * </pre>
	  */
	public CommonCodeDBDAOSearchHandleOfficeLevelWithControlRSQL(){
		setQuery();
		...
		query.append("FileName : CommonCodeDBDAOSearchHandleOfficeLevelWithControlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SELECT n3pty_ofc_tp_cd AS office_level, ofc_cd, NULL AS rhq_cd, NULL AS ho_cd" ).append("\n"); 
		query.append("         FROM TPB_HNDL_OFC" ).append("\n"); 
		query.append("        WHERE 1=1" ).append("\n"); 
