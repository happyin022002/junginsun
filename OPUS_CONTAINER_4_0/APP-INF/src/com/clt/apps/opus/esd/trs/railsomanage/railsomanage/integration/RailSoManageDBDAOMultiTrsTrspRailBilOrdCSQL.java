...
public class RailSoManageDBDAOMultiTrsTrspRailBilOrdCSQL implements ISQLTemplate{
	...
	public RailSoManageDBDAOMultiTrsTrspRailBilOrdCSQL(){
		...
		params.put("cnd_cstms_clr_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("	CND_CSTMS_CLR_FLG," ).append("\n"); 
		...
		query.append("	@[stcc_cd]," ).append("\n"); 
		query.append("	@[stcc_desc]," ).append("\n"); 
		query.append("	DECODE(@[cnd_cstms_clr_flg], '1', 'Y', 'N')," ).append("\n"); 
		query.append("	NVL(@[upln_so_flg], 'N')" ).append("\n"); 
		query.append(")" ).append("\n"); 
