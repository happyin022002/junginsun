 ...
 * 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.sce.csmsendeur.basic;

import java.io.IOException;
import java.io.Reader;
import java.sql.SQLException;

import com.clt.apps.opus.esd.sce.csmsendeur.integration.CSMSendEurDBDAO;
import com.clt.apps.opus.esd.sce.csmsendeur.integration.CSMSendEurEAIDAO;
	...
	public void sendFlatFileIntoQueue(CSMSendEurVO cSMSendEurVO) throws EventException {
		try {
			...
			if (cSMSendEurVO != null) {
				String inActRcvDt = cSMSendEurVO.getActRcvDt();
				String inActRcvNo = cSMSendEurVO.getActRcvNo();
				DBRowSet rowSet = dbDao.searchFlatFileToBeSent(inActRcvDt, inActRcvNo);
				while (rowSet.next()) {
