...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOCancelStorageInvoiceRejectUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOCancelStorageInvoiceRejectUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CancelStorageInvoiceReject
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOCancelStorageInvoiceRejectUSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOCancelStorageInvoiceRejectUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
