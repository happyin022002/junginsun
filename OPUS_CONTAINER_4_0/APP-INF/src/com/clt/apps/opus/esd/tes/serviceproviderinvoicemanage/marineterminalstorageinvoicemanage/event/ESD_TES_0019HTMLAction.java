...
*@FileName : ESD_TES_019HTMLAction.java
 ...
 *
 * @author kimjinjoo
 * @see EsdTes0019Event , ESD_TES_019EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0019HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_019HTMLAction 객체를 생성
	 */
	public ESD_TES_0019HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_019Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		log.debug("\n\nESD_TES_0019Event Start============================\n");

		EsdTes0019Event event = new EsdTes0019Event();
	...
	public void doEnd(HttpServletRequest request, Event event) {
		...
		if(log.isDebugEnabled()) log.debug("ESD_TES_019Event================================ doENd\n");
	}
