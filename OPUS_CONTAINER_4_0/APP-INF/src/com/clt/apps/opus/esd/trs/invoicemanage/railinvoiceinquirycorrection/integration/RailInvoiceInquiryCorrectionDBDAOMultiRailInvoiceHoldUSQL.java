...
*@FileName : RailInvoiceInquiryCorrectionDBDAOMultiRailInvoiceHoldUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailInvoiceInquiryCorrectionDBDAOMultiRailInvoiceHoldUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiRailInvoiceHold UPDATE
	  * </pre>
	  */
	public RailInvoiceInquiryCorrectionDBDAOMultiRailInvoiceHoldUSQL(){
		setQuery();
		...
		query.append("FileName : RailInvoiceInquiryCorrectionDBDAOMultiRailInvoiceHoldUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
