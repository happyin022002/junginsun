...
*@FileName : CSMSendEurDBDAOModifyActUmchTpCdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSMSendEurDBDAOModifyActUmchTpCdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSMSendEurDBDAOModifyActUmchTpCdUSQL(){
		setQuery();
		...
		query.append("FileName : CSMSendEurDBDAOModifyActUmchTpCdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCE_CSM_TGT_EUR " ).append("\n"); 
		query.append("SET    ACT_UMCH_TP_CD = @[act_umch_tp_cd]," ).append("\n"); 
		query.append("       UPD_DT = SYSDATE, " ).append("\n"); 
		query.append("       UMCH_CHK_DT = SYSDATE  " ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("#if (${act_umch_tp_cd} != 'XX') " ).append("\n"); 
		query.append("	  , cop_evnt_seq = nvl(cop_evnt_seq, 0) + 1 	" ).append("\n"); 
