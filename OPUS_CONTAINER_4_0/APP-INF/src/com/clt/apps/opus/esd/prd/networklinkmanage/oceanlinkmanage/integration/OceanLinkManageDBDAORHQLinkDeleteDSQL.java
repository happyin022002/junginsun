...
*@FileName : OceanLinkManageDBDAORHQLinkDeleteDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanLinkManageDBDAORHQLinkDeleteDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanLinkManageDBDAORHQLinkDeleteDSQL(){
		setQuery();
		...
		query.append("FileName : OceanLinkManageDBDAORHQLinkDeleteDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
