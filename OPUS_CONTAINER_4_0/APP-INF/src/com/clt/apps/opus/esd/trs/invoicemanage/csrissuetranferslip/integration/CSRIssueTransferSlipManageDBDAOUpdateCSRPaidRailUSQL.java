...
*@FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRPaidRailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOUpdateCSRPaidRailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOUpdateCSRPaidRailUSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRPaidRailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
