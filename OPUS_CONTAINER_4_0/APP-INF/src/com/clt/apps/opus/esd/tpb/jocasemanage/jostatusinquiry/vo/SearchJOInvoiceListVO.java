...
*@FileName : SearchJOInvoiceListVO.java
*@FileTitle : SearchJOInvoiceListVO
*Open Issues :
*Change history :
...
public class SearchJOInvoiceListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchJOInvoiceListVO> models = new ArrayList<SearchJOInvoiceListVO>();
	 ...
	 */
	public SearchJOInvoiceListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchJOInvoiceListVO[]
	 */
	public SearchJOInvoiceListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchJOInvoiceListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchJOInvoiceListVO();
		...
		return getSearchJOInvoiceListVOs();
	}
	...
	public SearchJOInvoiceListVO[] getSearchJOInvoiceListVOs(){
		SearchJOInvoiceListVO[] vos = (SearchJOInvoiceListVO[])models.toArray(new SearchJOInvoiceListVO[models.size()]);
		return vos;
	}
