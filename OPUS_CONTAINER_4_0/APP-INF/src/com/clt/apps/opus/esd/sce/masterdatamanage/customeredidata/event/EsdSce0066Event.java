...
public class EsdSce0066Event extends EventSupport {
	 ...
	 * 
	 * @param SearchCargoTrackingDataOptionsVO
	 *            schCtdOpts
	 ...
	 * 
	 * @param updateCargoTrackingDataVOs
	 *            List<UpdateCargoTrackingDataVO>
	 * @return
	 * @throws
	 */
	public void setUCTDVOs(
			List<UpdateCargoTrackingDataVO> updateCargoTrackingDataVOs) {
