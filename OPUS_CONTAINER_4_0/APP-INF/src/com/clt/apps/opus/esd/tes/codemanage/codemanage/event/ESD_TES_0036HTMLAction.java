...
*@FileName : ESD_TES_0036HTMLAction.java
 ...
 *
 *@author jongbaemoon
 * @see EsdTes0036Event , ESD_TES_0036EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0036HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TES_0036HTMLAction 객체를 생성
	 */
	public ESD_TES_0036HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 UI_ESD_TES_0036Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes0036Event event = new EsdTes0036Event(); 
