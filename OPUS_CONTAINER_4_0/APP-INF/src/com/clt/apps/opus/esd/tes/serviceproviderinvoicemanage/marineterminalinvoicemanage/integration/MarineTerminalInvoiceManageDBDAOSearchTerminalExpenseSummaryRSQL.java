...
public class MarineTerminalInvoiceManageDBDAOSearchTerminalExpenseSummaryRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT 'SINHO' HQ_OFC_CD,                                                                   				" ).append("\n"); 
		query.append("    --DECODE(L.CONTI_CD, 'F', 'HAMUR','E','HAMUR','M','NYCNA','A', O.AR_HD_QTR_OFC_CD ) RHQ_OFC_CD,    " ).append("\n"); 
		...
		query.append("        , V.VNDR_LGL_ENG_NM, V.VNDR_CNT_CD , V.VNDR_LOCL_LANG_NM	                                   		" ).append("\n"); 
