 ...
 * @since J2EE 1.4
 */
public class EsdEas0008EventResponse extends EventResponseSupport {
     ...
     */
    public EsdEas0008EventResponse() {
    }
     ...
     */
    public EsdEas0008EventResponse(DBRowSet rowSet , int totalCount, String successFlag) {
        this.rowSet = rowSet;
     ...
     * @param successFlag 성공여부
     */
    public EsdEas0008EventResponse(DBRowSet rowSet, String successFlag) {
        this.rowSet = rowSet;
        this.successFlag = successFlag ;
    }
