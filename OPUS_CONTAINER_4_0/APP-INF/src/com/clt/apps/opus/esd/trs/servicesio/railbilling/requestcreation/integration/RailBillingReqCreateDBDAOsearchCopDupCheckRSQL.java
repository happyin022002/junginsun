...
*@FileName : RailBillingReqCreateDBDAOsearchCopDupCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailBillingReqCreateDBDAOsearchCopDupCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * getSQLSearchCopDupCheck
	  * </pre>
	  */
	public RailBillingReqCreateDBDAOsearchCopDupCheckRSQL(){
		setQuery();
		...
		query.append("FileName : RailBillingReqCreateDBDAOsearchCopDupCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
