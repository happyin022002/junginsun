...
*@FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceRailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceRailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateCSRInterfaceRail
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceRailUSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceRailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET WRK.TRSP_INV_AUD_STS_CD 	= 'IF'" ).append("\n"); 
