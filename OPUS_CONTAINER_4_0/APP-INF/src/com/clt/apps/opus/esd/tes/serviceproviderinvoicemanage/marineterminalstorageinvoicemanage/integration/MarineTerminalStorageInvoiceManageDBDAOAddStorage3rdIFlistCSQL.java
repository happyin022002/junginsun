...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOAddStorage3rdIFlistCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOAddStorage3rdIFlistCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOAddStorage3rdIFlistCSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOAddStorage3rdIFlistCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
