...
*@FileName : InvoiceManageDBDAOUpdateInvoiceRevisionIssueCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManageDBDAOUpdateInvoiceRevisionIssueCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateInvoiceRevisionIssue
	  * </pre>
	  */
	public InvoiceManageDBDAOUpdateInvoiceRevisionIssueCSQL(){
		setQuery();
		...
		params.put("s_n3pty_inv_if_tp_nm",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_contact_info",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : InvoiceManageDBDAOUpdateInvoiceRevisionIssueCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL TPB_INV_RVIS_PKG.UPD_INV_RVIS_ISSUE(" ).append("\n"); 
		...
		query.append(",@[s_n3pty_inv_if_tp_nm]" ).append("\n"); 
		query.append(",@[fax_eml_snd_no]" ).append("\n"); 
		query.append(",@[s_contact_info]" ).append("\n"); 
