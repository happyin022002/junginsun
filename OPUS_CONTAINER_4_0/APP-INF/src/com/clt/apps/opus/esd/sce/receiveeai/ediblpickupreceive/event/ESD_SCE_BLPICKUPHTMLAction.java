...
*@FileName : EsdSceBLPICKUPHTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESD_SCE_BLPICKUPHTMLAction extends HTMLActionSupport{
	/**
	 * 
	 */
	 ...
	 * Constructor 
	 */
	public ESD_SCE_BLPICKUPHTMLAction(){
		log.debug("Starting NoUI Program TEST:ID ");
	}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsdSceBLPickUpEvent로 파싱하여 request에 셋팅<br>
     * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSceBLPickUpEvent event = new EsdSceBLPickUpEvent();
        ...
        if (command.isCommand(FormCommand.SEARCH)) {
			...
			event.setEventName("EsdSceBLPickUpEvent");
