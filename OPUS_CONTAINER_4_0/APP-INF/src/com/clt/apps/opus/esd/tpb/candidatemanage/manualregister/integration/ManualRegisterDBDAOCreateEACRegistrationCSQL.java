...
*@FileName : ManualRegisterDBDAOCreateEACRegistrationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualRegisterDBDAOCreateEACRegistrationCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateEACRegistration
	  * </pre>
	  */
	public ManualRegisterDBDAOCreateEACRegistrationCSQL(){
		setQuery();
		...
		params.put("s_bkg_no_split",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_src_vndr_cnt_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_bl_no_tp",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_bl_no_chk",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_reg_type",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_if_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ManualRegisterDBDAOCreateEACRegistrationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
