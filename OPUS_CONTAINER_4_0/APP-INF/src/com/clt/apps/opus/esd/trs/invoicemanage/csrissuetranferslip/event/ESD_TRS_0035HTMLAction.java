...
*@FileName : ESD_TRS_035HTMLAction.java
 ...
 *
 * @author kimjin
 * @see EsdTrs0035Event , ESD_TRS_035EventResponse 참조
 * @since J2EE 1.6
 */
public class ESD_TRS_0035HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESD_TRS_035HTMLAction 객체를 생성
	 */
	public ESD_TRS_0035HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TRS_035Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0035Event event = new EsdTrs0035Event();
		...
		String[] trsp_inv_aud_sts_cd = request.getParameterValues("trsp_inv_aud_sts_cd");
		...
		event.setTrsp_inv_aud_sts_cd(trsp_inv_aud_sts_cd);
