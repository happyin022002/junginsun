...
public class EsdTpb0133Event extends EventSupport {
	...
	public void setSearchInterfacedCancelListVOS(SearchInterfacedCancelListVO[] SearchInterfacedCancelListVOs){
		if(SearchInterfacedCancelListVOs != null){
			SearchInterfacedCancelListVO[] tmpVOs = Arrays.copyOf(SearchInterfacedCancelListVOs, SearchInterfacedCancelListVOs.length);
			this.searchInterfacedCancelListVOs = tmpVOs;
		}
	}
	...
	public SearchInterfacedCancelListVO[] getSearchInterfacedCancelListVOS(){
		SearchInterfacedCancelListVO[] tempVOs = null;
		
		if (this.searchInterfacedCancelListVOs != null) {
			tempVOs = Arrays.copyOf(this.searchInterfacedCancelListVOs, this.searchInterfacedCancelListVOs.length);
		}
		return tempVOs;		
	}
}