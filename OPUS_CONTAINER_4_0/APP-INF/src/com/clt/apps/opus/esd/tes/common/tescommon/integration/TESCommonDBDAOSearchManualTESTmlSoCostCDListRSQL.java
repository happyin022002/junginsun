...
*@FileName : TESCommonDBDAOSearchManualTESTmlSoCostCDListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESCommonDBDAOSearchManualTESTmlSoCostCDListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LGS COST CODE Inquiry
	  * </pre>
	  */
	public TESCommonDBDAOSearchManualTESTmlSoCostCDListRSQL(){
		setQuery();
		...
		query.append("FileName : TESCommonDBDAOSearchManualTESTmlSoCostCDListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
