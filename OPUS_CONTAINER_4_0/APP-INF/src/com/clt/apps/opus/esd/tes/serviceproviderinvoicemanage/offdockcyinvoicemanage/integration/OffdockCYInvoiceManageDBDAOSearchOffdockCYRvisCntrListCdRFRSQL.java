...
*@FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdRFRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdRFRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOffdockCYRvisCntrListCdRF
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdRFRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdRFRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND L.RC_FLG IS NOT NULL AND L.RC_FLG = 'Y'" ).append("\n"); 
