...
*@FileName : CARIssueTransferSlipManageDBDAOSearchApOfcCDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CARIssueTransferSlipManageDBDAOSearchApOfcCDRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CARIssueTransferSlipManageDBDAOSearchApOfcCDRSQL(){
		setQuery();
		...
		query.append("FileName : CARIssueTransferSlipManageDBDAOSearchApOfcCDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
