...
public class SearchYardDetailVO extends AbstractValueObject {
	...
	/* Column Info */
	private String minimumDwellR = null;
	/* Column Info */
	private String tel = null;
	/* Column Info */
	private String operator2Name = null;
	/* Column Info */
	private String minimumDwellD = null;
	/* Column Info */
	...
	/* Column Info */
	private String averageDwellD = null;
	/* Column Info */
	...
	/* Column Info */
	private String averageDwellR = null;
	/* Column Info */
	...
	public SearchYardDetailVO(String ibflag, String pagerows, String yardCode, String locationCode, String yardName, String nodeType, String hubNode, String serviceTypeMarinet, String serviceTypeBarget, String serviceTypeCy, String serviceTypeCfs, String serviceTypeRailramp, String serviceTypePseudoy, String person, String email, String tel, String fax, String postalCode, String yardAddress, String gateWeekOpen, String gateWeekClose, String gateSatOpen, String gateSatClose, String gateSunOpen, String gateSunClose, String gateHolidayOpen, String gateHolidayClose, String averageDwellR, String averageDwellD, String minimumDwellR, String minimumDwellD, String freeTime, String yardOperator1, String operator1Name, String yardOperator2, String operator2Name, String yardOperator3, String operator3Name, String officeCode, String demIbCollection, String demObCollection, String yardOwnership, String bondedYard, String cTpat, String yardOnOff, String nodeCode) {
		...
		this.minimumDwellR = minimumDwellR;
		this.tel = tel;
		this.operator2Name = operator2Name;
		this.minimumDwellD = minimumDwellD;
		...
		this.averageDwellD = averageDwellD;
		this.fax = fax;
		...
		this.averageDwellR = averageDwellR;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("minimum_dwell_r", getMinimumDwellR());
		this.hashColumns.put("tel", getTel());
		this.hashColumns.put("operator2_name", getOperator2Name());
		this.hashColumns.put("minimum_dwell_d", getMinimumDwellD());
		...
		this.hashColumns.put("average_dwell_d", getAverageDwellD());
		...
		this.hashColumns.put("average_dwell_r", getAverageDwellR());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("minimum_dwell_r", "minimumDwellR");
		this.hashFields.put("tel", "tel");
		this.hashFields.put("operator2_name", "operator2Name");
		this.hashFields.put("minimum_dwell_d", "minimumDwellD");
		...
		this.hashFields.put("average_dwell_d", "averageDwellD");
		...
		this.hashFields.put("average_dwell_r", "averageDwellR");
	...
	/**
	 * Column Info
	 * @return minimumDwellR
	 */
	public String getMinimumDwellR() {
		return this.minimumDwellR;
	}
	...
	/**
	 * Column Info
	 * @return minimumDwellD
	 */
	public String getMinimumDwellD() {
		return this.minimumDwellD;
	}
	...
	/**
	 * Column Info
	 * @return averageDwellD
	 */
	public String getAverageDwellD() {
		return this.averageDwellD;
	}
	...
	/**
	 * Column Info
	 * @return averageDwellR
	 */
	public String getAverageDwellR() {
		return this.averageDwellR;
	}
	 ...
	 * @param minimumDwellR
	 */
	public void setMinimumDwellR(String minimumDwellR) {
		this.minimumDwellR = minimumDwellR;
	}
	 ...
	 * @param minimumDwellD
	 */
	public void setMinimumDwellD(String minimumDwellD) {
		this.minimumDwellD = minimumDwellD;
	}
	 ...
	 * @param averageDwellD
	 */
	public void setAverageDwellD(String averageDwellD) {
		this.averageDwellD = averageDwellD;
	}
	 ...
	 * @param averageDwellR
	 */
	public void setAverageDwellR(String averageDwellR) {
		this.averageDwellR = averageDwellR;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMinimumDwellR(JSPUtil.getParameter(request, "minimum_dwell_r", ""));
		setTel(JSPUtil.getParameter(request, "tel", ""));
		setOperator2Name(JSPUtil.getParameter(request, "operator2_name", ""));
		setMinimumDwellD(JSPUtil.getParameter(request, "minimum_dwell_d", ""));
		...
		setAverageDwellD(JSPUtil.getParameter(request, "average_dwell_d", ""));
		...
		setAverageDwellR(JSPUtil.getParameter(request, "average_dwell_r", ""));
	...
	public SearchYardDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] minimumDwellR = (JSPUtil.getParameter(request, prefix	+ "minimum_dwell_r", length));
			...
			String[] minimumDwellD = (JSPUtil.getParameter(request, prefix	+ "minimum_dwell_d", length));
			...
			String[] averageDwellD = (JSPUtil.getParameter(request, prefix	+ "average_dwell_d", length));
			...
			String[] averageDwellR = (JSPUtil.getParameter(request, prefix	+ "average_dwell_r", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (minimumDwellR[i] != null)
					model.setMinimumDwellR(minimumDwellR[i]);
				if (tel[i] != null)
					model.setTel(tel[i]);
				if (operator2Name[i] != null)
					model.setOperator2Name(operator2Name[i]);
				if (minimumDwellD[i] != null)
					model.setMinimumDwellD(minimumDwellD[i]);
				...
				if (averageDwellD[i] != null)
					model.setAverageDwellD(averageDwellD[i]);
				if (fax[i] != null)
					model.setFax(fax[i]);
				...
				if (averageDwellR[i] != null)
					model.setAverageDwellR(averageDwellR[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.minimumDwellR = this.minimumDwellR .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.minimumDwellD = this.minimumDwellD .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.averageDwellD = this.averageDwellD .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.averageDwellR = this.averageDwellR .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
