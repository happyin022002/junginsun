...
*@FileName : VskEmailSetupDBDAOAddVslSkdEmlSetUpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VskEmailSetupDBDAOAddVslSkdEmlSetUpCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSL E-MAIL 대상 추가 ( SCE_VSL_SKD_EML )
	  * </pre>
	  */
	public VskEmailSetupDBDAOAddVslSkdEmlSetUpCSQL(){
		setQuery();
		...
		params.put("fmPortCdHis",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esd.sce.emailjobmanage.vskemailsetup.integration").append("\n"); 
		query.append("FileName : VskEmailSetupDBDAOAddVslSkdEmlSetUpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCE_VSL_SKD_EML(" ).append("\n"); 
		...
		query.append("VSKD_DUR_ID," ).append("\n"); 
		...
		query.append("@[fmPortCdHis]," ).append("\n"); 
		query.append("@[toPortCd]," ).append("\n"); 
		query.append("@[vskdDurId]||'D'," ).append("\n"); 
