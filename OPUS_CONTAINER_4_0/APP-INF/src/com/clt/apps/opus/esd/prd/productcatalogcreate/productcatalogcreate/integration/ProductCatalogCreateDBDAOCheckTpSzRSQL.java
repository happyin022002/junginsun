...
*@FileName : ProductCatalogCreateDBDAOCheckTpSzRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogCreateDBDAOCheckTpSzRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProductCatalogCreateDBDAOCheckTpSzRSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogCreateDBDAOCheckTpSzRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(CNTR_TPSZ_CD) CNT" ).append("\n"); 
