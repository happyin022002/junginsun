...
*@FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewSvcOrdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOAddWorkOrderPreviewSvcOrdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOAddWorkOrderPreviewSvcOrdUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewSvcOrdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , WO_EXE_DT         = DECODE(TRSP_COST_DTL_MOD_CD,'DR',NVL(DOR_NOD_PLN_DT, GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(CRE_OFC_CD)), GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(CRE_OFC_CD))" ).append("\n"); 
