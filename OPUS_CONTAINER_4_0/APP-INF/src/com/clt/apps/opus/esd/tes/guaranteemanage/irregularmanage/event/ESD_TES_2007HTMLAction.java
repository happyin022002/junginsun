...
*@FileName : ESD_TES_2007HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esd.tes.guaranteemanage 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 * - Parsing 한 정보를 Event로 변환, request에 담아 GuaranteeManageSC로 실행요청<br>
 * - GuaranteeManageSC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 * @author yOng hO lEE
 * @see GuaranteeManageEvent 참조
 * @since J2EE 1.6
 */

public class ESD_TES_2007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TES_2007HTMLAction 객체를 생성
	 */
	public ESD_TES_2007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes2007Event event = new EsdTes2007Event();
