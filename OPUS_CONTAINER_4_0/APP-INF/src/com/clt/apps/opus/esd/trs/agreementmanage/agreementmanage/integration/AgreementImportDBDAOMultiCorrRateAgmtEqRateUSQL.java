...
public class AgreementImportDBDAOMultiCorrRateAgmtEqRateUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("MERGE INTO TRS_AGMT_EQ_RT R" ).append("\n"); 
		query.append("USING (SELECT A.EFF_FM_DT, A.EFF_TO_DT, A.CURR_CD, A.TRSP_ONE_WY_RT, A.TRSP_RND_RT, A.WTR_RCV_TERM_CD, A.WTR_DE_TERM_CD, " ).append("\n"); 
		query.append("              A.TRSP_AGMT_BDL_QTY, A.TO_WGT, A.WGT_MEAS_UT_CD, A.TRSP_RVS_APLY_FLG, A.EQ_KND_CD, A.USR_DEF_RMK, A.UPD_USR_ID, A.UPD_DT," ).append("\n"); 
		query.append("              A.TRSP_AGMT_OFC_CTY_CD, A.TRSP_AGMT_SEQ, A.TRSP_AGMT_RT_TP_SER_NO, A.TRSP_AGMT_NOD_SEQ, A.TRSP_AGMT_RT_SEQ," ).append("\n"); 
		...
		query.append("              B.WTR_RCV_TERM_CD AS WTR_RCV_TERM_CD_TMP, " ).append("\n"); 
		query.append("              B.WTR_DE_TERM_CD AS WTR_DE_TERM_CD_TMP, " ).append("\n"); 
		query.append("              B.TRSP_AGMT_BDL_QTY AS TRSP_AGMT_BDL_QTY_TMP, " ).append("\n"); 
		query.append("              B.TO_WGT AS TO_WGT_TMP, " ).append("\n"); 
		query.append("              B.WGT_MEAS_UT_CD AS WGT_MEAS_UT_CD_TMP, " ).append("\n"); 
		query.append("              B.TRSP_RVS_APLY_FLG AS TRSP_RVS_APLY_FLG_TMP, " ).append("\n"); 
		...
		query.append("ON (    R.TRSP_AGMT_OFC_CTY_CD = C.TRSP_AGMT_OFC_CTY_CD" ).append("\n"); 
		...
		query.append("    AND R.TRSP_AGMT_NOD_SEQ = C.TRSP_AGMT_NOD_SEQ" ).append("\n"); 
		query.append("    AND R.TRSP_AGMT_RT_SEQ = C.TRSP_AGMT_RT_SEQ" ).append("\n"); 
		query.append("    )" ).append("\n"); 
		...
		query.append("      ,WTR_RCV_TERM_CD   = WTR_RCV_TERM_CD_TMP" ).append("\n"); 
		query.append("      ,WTR_DE_TERM_CD    = WTR_DE_TERM_CD_TMP" ).append("\n"); 
		query.append("      ,TRSP_AGMT_BDL_QTY = TRSP_AGMT_BDL_QTY_TMP" ).append("\n"); 
		query.append("      ,TO_WGT            = TO_WGT_TMP" ).append("\n"); 
		query.append("      ,WGT_MEAS_UT_CD    = WGT_MEAS_UT_CD_TMP" ).append("\n"); 
		query.append("      ,TRSP_RVS_APLY_FLG = TRSP_RVS_APLY_FLG_TMP" ).append("\n"); 
