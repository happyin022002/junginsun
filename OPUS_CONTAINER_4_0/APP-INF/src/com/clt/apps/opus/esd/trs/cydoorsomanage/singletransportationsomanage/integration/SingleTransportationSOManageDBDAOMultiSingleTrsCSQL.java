...
public class SingleTransportationSOManageDBDAOMultiSingleTrsCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , TO_DATE(@[n1st_nod_pln_dt]||  NVL2(@[n1st_nod_pln_dt], @[n1st_nod_pln_dt_hms], ''), 'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append("     , TO_DATE(@[dor_nod_pln_dt] ||  NVL2(@[dor_nod_pln_dt], @[dor_nod_pln_dt_hms], ''), 'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append("     , TO_DATE(@[lst_nod_pln_dt] ||  NVL2(@[lst_nod_pln_dt], @[lst_nod_pln_dt_hms], ''), 'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append("     , @[cust_nomi_trkr_flg]" ).append("\n"); 
		...
		query.append("     , @[lse_cntr_flg]" ).append("\n"); 
		query.append("     , @[tri_axl_req_flg]" ).append("\n"); 
		query.append("     , BKG_GET_SLOT_NO_FNC(@[cop_no])" ).append("\n"); 
