...
public class AddSceEdiSndRsltVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("trsp_leg_nm", getTrspLegNm());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("trsp_leg_nm", "trspLegNm");
    ...
    public void setTrspLegNm(String trspLegNm) {
        this.trspLegNm = trspLegNm;
    }

    public String getTrspLegNm() {
        return this.trspLegNm;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setTrspLegNm(JSPUtil.getParameter(request, prefix + "trsp_leg_nm", ""));
    }
	...
	*/
    public void unDataFormat() {
        ...
        this.trspLegNm = this.trspLegNm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
