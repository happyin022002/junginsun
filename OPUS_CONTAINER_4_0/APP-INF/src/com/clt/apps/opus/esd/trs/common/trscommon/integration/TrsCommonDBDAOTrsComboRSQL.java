...
*@FileName : TrsCommonDBDAOTrsComboRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsCommonDBDAOTrsComboRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrsCommonDBDAOTrsComboRSQL(){
		setQuery();
		...
		query.append("FileName : TrsCommonDBDAOTrsComboRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
