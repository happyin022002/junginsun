...
*@FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdAKRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdAKRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOffdockCYRvisCntrListCdAK
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdAKRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYRvisCntrListCdAKRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND L.AWK_CGO_FLG IS NOT NULL AND L.AWK_CGO_FLG <> 'N'" ).append("\n"); 
