...
*@FileName : JOOutstandinggroupManageDBDAOMultiTPBGroupModifyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOutstandinggroupManageDBDAOMultiTPBGroupModifyUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOOutstandinggroupManageDBDAOMultiTPBGroupModifyUSQL(){
		setQuery();
		...
		query.append("FileName : JOOutstandinggroupManageDBDAOMultiTPBGroupModifyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
