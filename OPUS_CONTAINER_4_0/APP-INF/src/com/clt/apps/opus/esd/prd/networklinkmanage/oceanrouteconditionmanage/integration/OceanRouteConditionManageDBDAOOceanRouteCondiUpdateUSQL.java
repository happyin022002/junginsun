...
*@FileName : OceanRouteConditionManageDBDAOOceanRouteCondiUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteConditionManageDBDAOOceanRouteCondiUpdateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanRouteConditionManageDBDAOOceanRouteCondiUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteConditionManageDBDAOOceanRouteCondiUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE prd_port_tml_mtx ptm" ).append("\n"); 
		query.append("SET tml_cd = @[tml_cd] ," ).append("\n"); 
