...
*@FileName : CandidateConfirmDBDAOModifyCandidateListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CandidateConfirmDBDAOModifyCandidateListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CandidateConfirmDBDAOModifyCandidateListUSQL(){
		setQuery();
		...
		query.append("FileName : CandidateConfirmDBDAOModifyCandidateListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
