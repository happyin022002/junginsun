...
*@FileName : TESInvoiceCommonDBDAOUpdateDetailN3ptyFlgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInvoiceCommonDBDAOUpdateDetailN3ptyFlgUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SO_DTL의 N3PTY_FLG Y Update
	  * </pre>
	  */
	public TESInvoiceCommonDBDAOUpdateDetailN3ptyFlgUSQL(){
		setQuery();
		...
		query.append("FileName : TESInvoiceCommonDBDAOUpdateDetailN3ptyFlgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("N3PTY_FLG	= 'Y'" ).append("\n"); 
