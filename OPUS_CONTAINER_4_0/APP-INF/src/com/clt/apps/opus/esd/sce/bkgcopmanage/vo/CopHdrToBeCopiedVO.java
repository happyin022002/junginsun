...
*@FileName : CopHdrToBeCopiedVO.java
*@FileTitle : CopHdrToBeCopiedVO
*Open Issues :
*Change history :
...
public class CopHdrToBeCopiedVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CopHdrToBeCopiedVO> models = new ArrayList<CopHdrToBeCopiedVO>();
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCfmApntDt(JSPUtil.getParameter(request, prefix + "cfm_apnt_dt", ""));
		setCfmObDorArrDt(JSPUtil.getParameter(request, prefix + "cfm_ob_dor_arr_dt", ""));
		...
		setRailRcvCoffDtSrcTpCd(JSPUtil.getParameter(request, prefix + "rail_rcv_coff_dt_src_tp_cd", ""));
		...
		setCopFshDt(JSPUtil.getParameter(request, prefix + "cop_fsh_dt", ""));
		...
		setProvCntrNo(JSPUtil.getParameter(request, prefix + "prov_cntr_no", ""));
	 ...
	 * @param request
	 * @return CopHdrToBeCopiedVO[]
	 */
	public CopHdrToBeCopiedVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CopHdrToBeCopiedVO[]
	 */
	public CopHdrToBeCopiedVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CopHdrToBeCopiedVO model = null;
	 ...
	 * @return CopHdrToBeCopiedVO[]
	 */
	public CopHdrToBeCopiedVO[] getCopHdrToBeCopiedVOs(){
		CopHdrToBeCopiedVO[] vos = (CopHdrToBeCopiedVO[])models.toArray(new CopHdrToBeCopiedVO[models.size()]);
		return vos;
	}
