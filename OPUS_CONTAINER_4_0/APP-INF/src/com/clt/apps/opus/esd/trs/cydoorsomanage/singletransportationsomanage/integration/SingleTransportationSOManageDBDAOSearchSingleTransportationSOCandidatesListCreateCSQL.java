...
*@FileName : SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListCreateCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListCreateCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/O Candidate 선정후 Temp Table에 자료입력
	  * </pre>
	  */
	public SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListCreateCSQL(){
		setQuery();
		...
		params.put("rail_cre_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("rail_to_nod_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListCreateCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[upln_so_flg]" ).append("\n"); 
		query.append(",@[trsp_so_sts_nm]" ).append("\n"); 
		query.append(",TO_DATE(@[rail_cre_dt], 'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append(",@[rail_to_nod_cd]" ).append("\n"); 
		query.append(",@[pod_conti_cd]" ).append("\n"); 
		query.append(",@[tro_seq]" ).append("\n"); 
		query.append(",@[tro_sub_seq]" ).append("\n"); 
