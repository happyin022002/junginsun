...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esd.trs.common.breakbulkcargodetailinquiry.integration;
...
public class BreakBulkCargoDetailInquiryDBDAOSearchBreakBulkCargoDetailInquiryRSQL implements ISQLTemplate{
	...
	public BreakBulkCargoDetailInquiryDBDAOSearchBreakBulkCargoDetailInquiryRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esd.trs.common.breakbulkcargodetailinquiry.integration").append("\n"); 
