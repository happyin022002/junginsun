...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.sce.visibilitymanage.edi214Receive;

import com.clt.apps.opus.esd.sce.visibilitymanage.edi214Receive.basic.Edi214ReceiveBC;
...
/**
 * SCE EDI_214_MSG Logic ServiceCommand<br>
 * - SCE에 EDI_214_MSG에 대한 비지니스 트랜잭션을 처리한다.<br>
 * @param 
 * @author yjlee
