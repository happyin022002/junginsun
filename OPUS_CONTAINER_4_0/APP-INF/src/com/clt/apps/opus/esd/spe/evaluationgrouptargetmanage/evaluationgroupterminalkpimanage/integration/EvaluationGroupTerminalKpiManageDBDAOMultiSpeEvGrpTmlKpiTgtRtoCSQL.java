...
*@FileName : EvaluationGroupTerminalKpiManageDBDAOMultiSPE_EV_GRP_TML_KPI_TGT_RTOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EvaluationGroupTerminalKpiManageDBDAOMultiSpeEvGrpTmlKpiTgtRtoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * spe_ev_grp_tml_kpi_tgt_rto Insert
	  * </pre>
	  */
	public EvaluationGroupTerminalKpiManageDBDAOMultiSpeEvGrpTmlKpiTgtRtoCSQL(){
		setQuery();
		...
		query.append("FileName : EvaluationGroupTerminalKpiManageDBDAOMultiSPE_EV_GRP_TML_KPI_TGT_RTOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SPE_EV_GRP_TML_KPI_TGT_RTO (" ).append("\n"); 
		...
		query.append("@[eg_id]" ).append("\n"); 
		query.append(",	TO_NUMBER(@[eg_id_seq])" ).append("\n"); 
		query.append(",	'TMLP'" ).append("\n"); 
		query.append(",	@[ev_yr]" ).append("\n"); 
		query.append(",	UPPER(@[yd_cd])" ).append("\n"); 
		query.append(",	DECODE(@[kpi_ut_cd],'%','PC','PT','PO','MM','MM')" ).append("\n"); 
		query.append(",	@[kpi_tgt_rto]" ).append("\n"); 
		query.append(",	@[kpi_wgt_rto]" ).append("\n"); 
		query.append(",	@[kpi_perf_rto]" ).append("\n"); 
		query.append(",	@[vndr_seq]" ).append("\n"); 
