...
*@FileName : OceanLinkManageDBDAORHQLinkDelete5USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanLinkManageDBDAORHQLinkDelete5USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanLinkManageDBDAORHQLinkDelete5USQL(){
		setQuery();
		...
		query.append("FileName : OceanLinkManageDBDAORHQLinkDelete5USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" 	OCN_ROUT_DELT_RMK = SYSDATE||' ID:'||@[upd_usr_id] ||'  ,Deleted by RHQ Ocean Link, N4TH lane'          			 			 " ).append("\n"); 
		query.append("  WHERE ts_ind_cd = 'T' " ).append("\n"); 
		query.append("    AND upd_ind_cd IN ('C', 'U', 'S') " ).append("\n"); 
		query.append("    AND lnk_knt > 3 " ).append("\n"); 
		query.append("    AND n4th_pol_cd = RTRIM (@[s_from] ) " ).append("\n"); 
		query.append("    AND n4th_pod_cd = RTRIM (@[s_to] )  " ).append("\n"); 
		query.append("    AND n4th_lane_fdr_flg = 'Y'" ).append("\n"); 
