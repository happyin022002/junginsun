...
*@FileName : Edi315SendDBDAOGetRsltPickNoInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Edi315SendDBDAOGetRsltPickNoInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * for getRslt_pick_no_info
	  * </pre>
	  */
	public Edi315SendDBDAOGetRsltPickNoInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Edi315SendDBDAOGetRsltPickNoInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  PKUP_EDI_322_NO  FROM (" ).append("\n"); 
		...
		query.append("and     EDI_STS_CD      = 'NT'" ).append("\n"); 
