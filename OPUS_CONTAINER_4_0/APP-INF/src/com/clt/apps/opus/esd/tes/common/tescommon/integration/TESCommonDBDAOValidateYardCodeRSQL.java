...
*@FileName : TESCommonDBDAOValidateYardCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESCommonDBDAOValidateYardCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESCommonDBDAOValidateYardCodeRSQL(){
		setQuery();
		...
		query.append("FileName : TESCommonDBDAOValidateYardCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
