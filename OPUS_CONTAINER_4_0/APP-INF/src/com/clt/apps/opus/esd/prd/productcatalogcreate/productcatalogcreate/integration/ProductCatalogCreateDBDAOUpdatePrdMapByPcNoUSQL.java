...
*@FileName : ProductCatalogCreateDBDAOUpdatePrdMapByPcNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogCreateDBDAOUpdatePrdMapByPcNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ProductCatalogCreateDBDAOUpdatePrdMapInitUSQL
	  * </pre>
	  */
	public ProductCatalogCreateDBDAOUpdatePrdMapByPcNoUSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogCreateDBDAOUpdatePrdMapByPcNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
