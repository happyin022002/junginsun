...
public class EsdSce0125Event extends EventSupport {
	...
	public ExceptionalRouteVO[] getExceptionalRouteVOs() {
		ExceptionalRouteVO[] rtnVOs = null;
		if (this.exceptionalRouteVOs != null) {
			rtnVOs = Arrays.copyOf(exceptionalRouteVOs, exceptionalRouteVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setExceptionalRouteVOs(ExceptionalRouteVO[] exceptionalRouteVOs) {
		if(exceptionalRouteVOs != null){
			ExceptionalRouteVO[] tmpVOs = Arrays.copyOf(exceptionalRouteVOs, exceptionalRouteVOs.length);
			this.exceptionalRouteVOs = tmpVOs;
		}
	}
