...
*@FileName : ESD_SPE_0009HTMLAction.java
...
public class ESD_SPE_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SPE_0009HTMLAction 객체를 생성
	 */
	public ESD_SPE_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSpe0009Event event = new EsdSpe0009Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSpeEvGrpTmlKpiTgtRtoVOs((SpeEvGrpTmlKpiTgtRtoVO[])getVOs(request, SpeEvGrpTmlKpiTgtRtoVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchEGTerminalKpiManageVO((SearchEGTerminalKpiManageVO)getVO(request, SearchEGTerminalKpiManageVO .class));
		}
