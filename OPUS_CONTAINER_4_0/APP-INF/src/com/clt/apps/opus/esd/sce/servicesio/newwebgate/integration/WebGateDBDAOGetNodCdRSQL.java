...
*@FileName : WebGateDBDAOGetNodCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WebGateDBDAOGetNodCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WebGateDBDAOGetNodCdRSQL(){
		setQuery();
		...
		query.append("FileName : WebGateDBDAOGetNodCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
