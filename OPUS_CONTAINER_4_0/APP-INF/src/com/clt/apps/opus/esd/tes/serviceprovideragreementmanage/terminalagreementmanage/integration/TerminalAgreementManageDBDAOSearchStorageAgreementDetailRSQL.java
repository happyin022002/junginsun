...
public class TerminalAgreementManageDBDAOSearchStorageAgreementDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		, decode(a.io_bnd_cd,'S','Same','I','IB','O','OB',a.io_bnd_cd) as IO_BND_CD, DECODE(a.tml_free_dys_tp_cd, 'D','F','R','' ) FT_DYS" ).append("\n"); 
		...
		query.append("		, A2_FD,  A4_FD                                                            											" ).append("\n"); 
		...
		query.append("		, decode(tml_cntr_sty_cd,'S','Same',tml_cntr_sty_cd) as TML_CNTR_STY_CD																					" ).append("\n"); 
		...
		query.append("			    , MAX(R2_FD) R2_FD, MAX(R4_FD) R4_FD, MAX(R5_FD) R5_FD ,MAX(R7_FD) R7_FD                                             " ).append("\n"); 
		query.append("			    , MAX(F2_FD) F2_FD, MAX(F4_FD) F4_FD                                                                                 " ).append("\n"); 
		query.append("			    , MAX(O2_FD) O2_FD, MAX(O4_FD) O4_FD                                                                                 " ).append("\n"); 
		query.append("			    , MAX(S2_FD) S2_FD, MAX(S4_FD) S4_FD                                                                                 " ).append("\n"); 
		query.append("			    , MAX(T2_FD) T2_FD, MAX(T4_FD) T4_FD                                                                                 " ).append("\n"); 
		query.append("			    , MAX(A2_FD) A2_FD, MAX(A4_FD) A4_FD                                                                                 " ).append("\n"); 
		query.append("			    , MAX(P2_FD) P2_FD, MAX(P4_FD) P4_FD                                                                                 " ).append("\n"); 
		query.append("			    , MAX(F5_FD) F5_FD" ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(D2_R),MAX(D2_R)) D2_R " ).append("\n"); 
		query.append("                , DECODE(LGS_COST_CD,'SRXXDC',SUM(D4_R),MAX(D4_R)) D4_R " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(D5_R),MAX(D5_R)) D5_R " ).append("\n"); 
		query.append("                , DECODE(LGS_COST_CD,'SRXXDC',SUM(D7_R),MAX(D7_R)) D7_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(D8_R),MAX(D8_R)) D8_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(D9_R),MAX(D9_R)) D9_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(DW_R),MAX(DW_R)) DW_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(DX_R),MAX(DX_R)) DX_R " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(R2_R),MAX(R2_R)) R2_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(R4_R),MAX(R4_R)) R4_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(R5_R),MAX(R5_R)) R5_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(R7_R),MAX(R7_R)) R7_R                                                     " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(F2_R),MAX(F2_R)) F2_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(F4_R),MAX(F4_R)) F4_R                                                                                     " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(O2_R),MAX(O2_R)) O2_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(O4_R),MAX(O4_R)) O4_R                                                                                     " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(S2_R),MAX(S2_R)) S2_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(S4_R),MAX(S4_R)) S4_R                                                                                     " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(T2_R),MAX(T2_R)) T2_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(T4_R),MAX(T4_R)) T4_R                                                                                     " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(A2_R),MAX(A2_R)) A2_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(A4_R),MAX(A4_R)) A4_R                                                                                     " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(P2_R),MAX(P2_R)) P2_R " ).append("\n"); 
		query.append("				, DECODE(LGS_COST_CD,'SRXXDC',SUM(P4_R),MAX(P4_R)) P4_R                                                                                     " ).append("\n"); 
		query.append("			    , DECODE(LGS_COST_CD,'SRXXDC',SUM(F5_R),MAX(F5_R)) F5_R 																									" ).append("\n"); 
		...
		query.append(" 						DECODE(B.CNTR_APLY_TP_CD, 'D', DECODE(B.CNTR_TPSZ_CD,'S4',AGMT_DYS,0), 0)  S4_FD,     					" ).append("\n"); 
