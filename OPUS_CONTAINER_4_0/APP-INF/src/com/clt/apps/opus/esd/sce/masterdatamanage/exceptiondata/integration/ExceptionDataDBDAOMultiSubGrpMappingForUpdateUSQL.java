...
*@FileName : ExceptionDataDBDAOMultiSubGrpMappingForUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExceptionDataDBDAOMultiSubGrpMappingForUpdateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ExceptionDataDBDAOMultiSubGrpMappingForUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : ExceptionDataDBDAOMultiSubGrpMappingForUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("set COP_EXPT_SUBSC_GRP_CD = @[r_subseq_grp]" ).append("\n"); 
		query.append(",SUBSC_GRP_NTFD_PTY_CD = @[r_noti_prty]" ).append("\n"); 
