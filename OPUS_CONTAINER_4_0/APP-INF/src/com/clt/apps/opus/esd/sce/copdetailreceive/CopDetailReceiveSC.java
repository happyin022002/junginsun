...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.sce.copdetailreceive;
...
/**
 * CopDetailReceive Business Logic ServiceCommand - CopDetailReceive 대한 비지니스 트랜잭션을 처리한다.
 * 
 * @author JeongSeon An
...
public class CopDetailReceiveSC extends ServiceCommandSupport {
	 ...
	 * CopDetailReceive system 업무에서 발생하는 모든 이벤트의 분기처리<br>
	 * 
	 * @param Event e
