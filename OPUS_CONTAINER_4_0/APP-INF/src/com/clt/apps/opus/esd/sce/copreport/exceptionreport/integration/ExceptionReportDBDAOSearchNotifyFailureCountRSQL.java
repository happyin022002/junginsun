...
*@FileName : ExceptionReportDBDAOSearchNotifyFailureCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExceptionReportDBDAOSearchNotifyFailureCountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ExceptionReportDBDAOSearchNotifyFailureCountRSQL(){
		setQuery();
		...
		query.append("FileName : ExceptionReportDBDAOSearchNotifyFailureCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  COUNT(1) OVER(PARTITION BY '1') AS TOT_CNT,t2.*" ).append("\n"); 
		...
		query.append("#if (${occr_ofc} != '')" ).append("\n"); 
		query.append("AND mst.cre_ofc_cd IN (" ).append("\n"); 
		query.append("#foreach($ele IN ${occr_ofc})" ).append("\n"); 
