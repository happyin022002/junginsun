...
*@FileName : InlandRouteManageDBDAOCheckWrsRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOCheckWrsRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InlandRouteManageDBDAOCheckWrs
	  * </pre>
	  */
	public InlandRouteManageDBDAOCheckWrsRSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageDBDAOCheckWrsRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
