...
public class SingleTransportationSOManageDBDAOMultiSingleTransportationCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	TO_DATE(@[n1st_nod_pln_dt], 'YYYYMMDD')," ).append("\n"); 
		query.append("	TO_DATE(@[lst_nod_pln_dt], 'YYYYMMDD')," ).append("\n"); 
		query.append("#if( ${cbstatus} == 'CF' )" ).append("\n"); 
		...
		query.append("	LPAD(SUBSTR(@[trsp_so_seq], -7), 7, '0'),	--CNTR_SLT_NO" ).append("\n"); 
