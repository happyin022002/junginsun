...
*@FileName : SearchExptDetailList3VO.java
*@FileTitle : SearchExptDetailList3VO
*Open Issues :
*Change history :
...
public class SearchExptDetailList3VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchExptDetailList3VO> models = new ArrayList<SearchExptDetailList3VO>();
	...
	public SearchExptDetailList3VO() {}

	public SearchExptDetailList3VO(String ibflag, String pagerows, String copExptTpCd, String exptCdNm, String copExptTpDtlCd, String copExptTpDtlNm, String copExptTpDtlDesc, String fmExptCd, String fmAct, String fmActNm, String toExptCd, String toAct, String toActNm, String usrId, String updDt, String actFlg) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return SearchExptDetailList3VO[]
	 */
	public SearchExptDetailList3VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchExptDetailList3VO[]
	 */
	public SearchExptDetailList3VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchExptDetailList3VO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchExptDetailList3VO();
				if (updDt[i] != null)
		...
		return getSearchExptDetailList3VOs();
	}
	 ...
	 * @return SearchExptDetailList3VO[]
	 */
	public SearchExptDetailList3VO[] getSearchExptDetailList3VOs(){
		SearchExptDetailList3VO[] vos = (SearchExptDetailList3VO[])models.toArray(new SearchExptDetailList3VO[models.size()]);
		return vos;
	}
