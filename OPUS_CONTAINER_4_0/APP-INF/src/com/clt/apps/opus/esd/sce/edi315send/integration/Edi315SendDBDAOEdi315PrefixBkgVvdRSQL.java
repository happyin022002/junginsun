...
public class Edi315SendDBDAOEdi315PrefixBkgVvdRSQL implements ISQLTemplate{
	...
	public Edi315SendDBDAOEdi315PrefixBkgVvdRSQL(){
		...
		params.put("e_pol_amsport1",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("e_pod_amsqual1",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("e_pol_amsqual1",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("e_vsl_consort_voy_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("e_vsl_cnt_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("e_pod_amsport1",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("                   @[e_vsl_consort_voy_no]    vsl_consort_voy_no," ).append("\n"); 
		query.append("                   @[e_vsl_cnt_cd]            vsl_cnt_cd," ).append("\n"); 
		query.append("                   @[e_pol_amsqual1]          pol_amsqual1," ).append("\n"); 
		query.append("                   @[e_pol_amsport1]          pol_amsport1," ).append("\n"); 
		query.append("                   @[e_pod_amsqual1]          pod_amsqual1," ).append("\n"); 
		query.append("                   @[e_pod_amsport1]          pod_amsport1" ).append("\n"); 
