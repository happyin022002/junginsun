...
*@FileName : SingleTransportationSOManageDBDAOEmptyRemoveSingleTrsEqrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SingleTransportationSOManageDBDAOEmptyRemoveSingleTrsEqrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SingleTransportationSOManageDBDAOEmptyRemoveSingleTrsEqrUSQL(){
		setQuery();
		...
		query.append("FileName : SingleTransportationSOManageDBDAOEmptyRemoveSingleTrsEqrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
