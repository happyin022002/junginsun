...
*@FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedScgDtlFuelCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedScgDtlFuelCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * trs_trsp_scg_dtl fule 정보 insert
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedScgDtlFuelCSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedScgDtlFuelCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
