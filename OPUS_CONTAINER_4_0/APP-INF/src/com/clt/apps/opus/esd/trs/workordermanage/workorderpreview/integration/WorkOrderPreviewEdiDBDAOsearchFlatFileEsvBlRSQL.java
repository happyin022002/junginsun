...
*@FileName : WorkOrderPreviewEdiDBDAOsearchFlatFileEsvBlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewEdiDBDAOsearchFlatFileEsvBlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderPreviewEdiDBDAOsearchFlatFileEsvBlRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewEdiDBDAOsearchFlatFileEsvBlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT SO.BL_NO" ).append("\n"); 
