...
*@FileName : ESD_LEA_0014HTMLAction.java
...
public class ESD_LEA_0014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0014HTMLAction 객체를 생성
	 */
	public ESD_LEA_0014HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0014Event event = new EsdLea0014Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchResultOfficeListVO((SearchAccrualBatchResultOfficeListVO)getVO(request, SearchAccrualBatchResultOfficeListVO .class));
		}
