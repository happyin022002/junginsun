...
public class CARIssueTransferSlipManageDBDAOCheckCalcCostCDRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("--		소급 적용 처리 기능 추가 ( 2009-06-17)" ).append("\n"); 
		...
		query.append("				DECODE(D.TML_CRR_CD,NULL,'N','','N',DECODE(D.TML_CRR_CD,' ','N','NYK','N','Y')) --LGS_COST_CD가 'A' MODE 일 경우 CRR_CD가 NULL,' ','NYK'이외의 값이면 통과" ).append("\n"); 
		...
		query.append("	 SELECT H.VNDR_NO VNDR_SEQ, D.ATTR_CTNT1 INV_NO, D.DTRB_COA_VVD_CD" ).append("\n"); 
		...
		query.append("	 AND A.VSL_CD||A.SKD_VOY_NO||A.SKD_DIR_CD||A.RLANE_DIR_CD = D.DTRB_COA_VVD_CD" ).append("\n"); 
