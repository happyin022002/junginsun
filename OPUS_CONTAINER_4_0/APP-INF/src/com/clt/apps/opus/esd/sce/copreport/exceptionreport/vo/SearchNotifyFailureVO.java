...
*@FileName : SearchNotifyFailureVO.java
*@FileTitle : SearchNotifyFailureVO
*Open Issues :
*Change history :
...
public class SearchNotifyFailureVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchNotifyFailureVO> models = new ArrayList<SearchNotifyFailureVO>();
	 ...
	 */
	public SearchNotifyFailureVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchNotifyFailureVO[]
	 */
	public SearchNotifyFailureVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchNotifyFailureVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchNotifyFailureVO();
				if (tActdt[i] != null)
		...
		return getSearchNotifyFailureVOs();
	}
	...
	public SearchNotifyFailureVO[] getSearchNotifyFailureVOs(){
		SearchNotifyFailureVO[] vos = (SearchNotifyFailureVO[])models.toArray(new SearchNotifyFailureVO[models.size()]);
		return vos;
	}
