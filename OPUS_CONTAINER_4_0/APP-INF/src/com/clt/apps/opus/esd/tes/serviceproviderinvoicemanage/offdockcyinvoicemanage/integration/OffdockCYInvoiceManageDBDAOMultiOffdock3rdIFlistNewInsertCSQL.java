...
*@FileName : OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewInsertCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiOffdock3rdIFlistNewInsert
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewInsertCSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TML_N3PTY_TP_CD              ," ).append("\n"); 
		...
		query.append("N3PTY_INV_DT                 ," ).append("\n"); 
		query.append("N3PTY_TERM_DT                ," ).append("\n"); 
		query.append("N3PTY_CSR_CURR_CD            ," ).append("\n"); 
