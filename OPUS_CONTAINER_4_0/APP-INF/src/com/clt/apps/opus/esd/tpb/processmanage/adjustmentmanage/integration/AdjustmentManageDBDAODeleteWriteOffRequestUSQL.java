...
public class AdjustmentManageDBDAODeleteWriteOffRequestUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AdjustmentManageDBDAODeleteWriteOffRequestUSQL(){
		setQuery();
		...
		query.append("FileName : AdjustmentManageDBDAODeleteWriteOffRequestUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
