CREATE OR REPLACE FUNCTION OPUSADM.PRD_GET_FEEDER_VVD_SKD2_FNC
/* ========================================================
   1. Object Name      : PRD_GET_FEEDER_VVD_SKD2_FNC
   2. Version          : 1.0
   3. Create Date      : 2010.05.06
   4. Sub System       : Product Catalog
   5. Author           :
   6. Description      : FEEDER 단일 LINK인 경우만 VVD 산출(ACTIVATION CHECK삭제)
