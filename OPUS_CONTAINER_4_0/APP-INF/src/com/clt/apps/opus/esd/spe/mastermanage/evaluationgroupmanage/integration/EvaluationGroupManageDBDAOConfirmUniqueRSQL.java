...
*@FileName : EvaluationGroupManageDBDAOConfirmUniqueRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EvaluationGroupManageDBDAOConfirmUniqueRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EvaluationGroupManageDBDAOConfirmUniqueRSQL(){
		setQuery();
		...
		query.append("FileName : EvaluationGroupManageDBDAOConfirmUniqueRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
