...
*@FileName : TerminalAgreementManageDBDAORemoveAgreementDTLDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAORemoveAgreementDTLDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAORemoveAgreementDTLDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAORemoveAgreementDTLDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE	FROM  TES_TML_AGMT_DTL" ).append("\n"); 
