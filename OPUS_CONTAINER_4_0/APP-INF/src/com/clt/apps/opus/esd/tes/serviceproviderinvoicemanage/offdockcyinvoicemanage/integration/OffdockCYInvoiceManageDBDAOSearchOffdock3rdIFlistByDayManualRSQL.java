...
*@FileName : OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistByDayManualRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistByDayManualRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOffdock3rdIFlistByDayManual
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistByDayManualRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOSearchOffdock3rdIFlistByDayManualRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[tmp_dtl_seq] TMP_DTL_SEQ, D.CALC_TP_CD," ).append("\n"); 
