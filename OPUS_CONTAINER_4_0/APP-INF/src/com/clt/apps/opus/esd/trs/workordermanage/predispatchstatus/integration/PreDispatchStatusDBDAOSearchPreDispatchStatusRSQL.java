...
*@FileName : PreDispatchStatusDBDAOSearchPreDispatchStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esd.trs.workordermanage.predispatchstatus.integration;
...
public class PreDispatchStatusDBDAOSearchPreDispatchStatusRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchPreDispatchStatus SELECT
	  * </pre>
	  */
	public PreDispatchStatusDBDAOSearchPreDispatchStatusRSQL(){
		setQuery();
		...
		params.put("hid_todate",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("wo_iss_ofc_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("hid_frmdate",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esd.trs.workordermanage.predispatchstatus.integration").append("\n"); 
		query.append("FileName : PreDispatchStatusDBDAOSearchPreDispatchStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,SUBSTR(PKUP_INFO, INSTR(PKUP_INFO, '^', 1, 3) + 1,  INSTR(PKUP_INFO, '^', 1, 3) -  INSTR(PKUP_INFO, '^', 1, 3)  - 1) AS LAST_FREE_DT" ).append("\n"); 
		query.append("      ,SUBSTR(PKUP_INFO, INSTR(PKUP_INFO, '^', 1, 4) + 1,  INSTR(PKUP_INFO, '^', 1, 4) -  INSTR(PKUP_INFO, '^', 1, 4)  - 1) AS PU_NO_CRE_DT" ).append("\n"); 
		...
		query.append("             ,(SELECT      PU.PKUP_NO" ).append("\n"); 
		...
		query.append("                  AND LOC.EQ_CTRL_OFC_CD = PU.OFC_CD" ).append("\n"); 
		query.append("                  AND PU.BKG_NO    = A.BKG_NO" ).append("\n"); 
		query.append("                  AND PU.CNTR_NO   = A.EQ_NO" ).append("\n"); 
		query.append("                  AND LOC.DELT_FLG = 'N') PKUP_INFO" ).append("\n"); 
		...
		query.append("                AND F.DLY_DIS_SNT_DT BETWEEN TO_DATE(@[hid_frmdate], 'YYYYMMDD') AND TO_DATE(@[hid_todate], 'YYYYMMDD') + 0.99999" ).append("\n"); 
		query.append("            #elseif ( ${rad_wonotic} == 'N' )" ).append("\n"); 
		query.append("                AND G.TRSP_CNTR_AVAL_SNT_DT BETWEEN TO_DATE(@[hid_frmdate], 'YYYYMMDD') AND TO_DATE(@[hid_todate], 'YYYYMMDD') + 0.99999" ).append("\n"); 
		query.append("            #end" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        #if ( ${reference_no} != '' )" ).append("\n"); 
		query.append("            AND F.TRSP_DIS_REF_NO = @[reference_no]" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("        #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        #if (${arr_bkg_no} != '' )" ).append("\n"); 
		...
		query.append("        #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        #if (${arr_bill_no} != '' )" ).append("\n"); 
		...
		query.append("        #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        #if (${arr_cntr_no} != '' )" ).append("\n"); 
