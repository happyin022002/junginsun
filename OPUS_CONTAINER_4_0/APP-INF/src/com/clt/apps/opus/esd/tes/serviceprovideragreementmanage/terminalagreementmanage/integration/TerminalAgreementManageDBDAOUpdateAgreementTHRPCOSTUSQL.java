...
*@FileName : TerminalAgreementManageDBDAOUpdateAgreementTHRPCOSTUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOUpdateAgreementTHRPCOSTUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOUpdateAgreementTHRPCOSTUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOUpdateAgreementTHRPCOSTUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("update  TES_TML_AGMT_DTL" ).append("\n"); 
		query.append("        set THRP_COST_CD_FLG = '', THRP_LGS_COST_CD = ''" ).append("\n"); 
		query.append("where 1=1" ).append("\n"); 
		query.append("and TML_AGMT_OFC_CTY_CD =  @[tml_agmt_ofc_cty_cd]" ).append("\n"); 
		query.append("and TML_AGMT_SEQ = @[tml_agmt_seq] " ).append("\n"); 
		query.append("and TML_AGMT_VER_NO = @[tml_agmt_ver_no]" ).append("\n"); 
		query.append("and THRP_COST_CD_FLG = 'Y'" ).append("\n"); 
