...
package com.clt.apps.opus.esd.trs.supplementsomanage.supplementsomanage.vo;
...
public class SupplementVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setScgIndCd(JSPUtil.getParameter(request, "scg_ind_cd", ""));
	}
