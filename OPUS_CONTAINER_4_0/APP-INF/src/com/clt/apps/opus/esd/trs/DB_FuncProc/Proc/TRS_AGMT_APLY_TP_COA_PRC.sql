CREATE OR REPLACE PROCEDURE TRS_AGMT_APLY_TO_COA_PRC
(    
  ...
  ----------------------------- */
      ...
      CURSOR TRS_AGMT_RATE_CSR IS
          ...
          SELECT      Y.COST_ACT_GRP_CD                                                                  /* ACTIVITY GROUP CODE */
                    ...
                    , CASE SUBSTR(Y.COA_COST_SRC_CD,1,2) WHEN 'TR' THEN 'BZC'
                                                         WHEN 'SC' THEN 
                                                                   CASE SUBSTR(Y.COA_COST_SRC_CD,3,2) WHEN 'FU' THEN 'FU'
                                                                                                      WHEN 'OW' THEN 'OW'
                                                                                                      ELSE ''
                                                                   END
                                                         WHEN 'SM' THEN 
