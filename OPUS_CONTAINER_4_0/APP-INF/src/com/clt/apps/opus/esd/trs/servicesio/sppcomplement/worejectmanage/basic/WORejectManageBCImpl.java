...
* 1.0 최초 생성
=========================================================*/
package com.clt.apps.opus.esd.trs.servicesio.sppcomplement.worejectmanage.basic;

import m2soft.rdsystem.server.core.rddbagent.util.serverexport.ServerExportException;

import com.clt.apps.opus.esd.trs.servicesio.sppcomplement.worejectmanage.integration.WORejectManageDBDAO;
import com.clt.apps.opus.esd.trs.servicesio.sppcomplement.worejectmanage.integration.WORejectManageEAIDAO;
