...
*@FileName : PoolChassisDBDAOConfirmInsertInvoicePoolChassisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PoolChassisDBDAOConfirmInsertInvoicePoolChassisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PoolChassisDBDAOConfirmInsertInvoicePoolChassisCSQL(){
		setQuery();
		...
		query.append("FileName : PoolChassisDBDAOConfirmInsertInvoicePoolChassisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
