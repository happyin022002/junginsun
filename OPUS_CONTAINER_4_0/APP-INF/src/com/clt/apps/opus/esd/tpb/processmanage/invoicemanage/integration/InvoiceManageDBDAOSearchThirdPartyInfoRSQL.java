...
public class InvoiceManageDBDAOSearchThirdPartyInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	  /* 2009-04-23 O Wan-Ki 1.6 N200904160080, Invoice Creation 폼 변경 (주소선택기능추가)	*/" ).append("\n"); 
		query.append("	  ,'' VNDR_CUST_ADDR2" ).append("\n"); 
		...
		query.append("	     WHERE CUST_CNT_CD||CUST_SEQ = @[s_trd_party_code] ) VNDR_CUST_ADDR2" ).append("\n"); 
