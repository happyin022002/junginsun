...
public class EsdTrs0040Event extends EventSupport {
	...
	public void setTrsTrspRfndInvVOs(TrsTrspRfndInvVO[] trsTrspRfndInvVOs) {
		if (trsTrspRfndInvVOs != null) {
			TrsTrspRfndInvVO[] tmpVOs = Arrays.copyOf(trsTrspRfndInvVOs, trsTrspRfndInvVOs.length);
			this.trsTrspRfndInvVOs = tmpVOs;
		} // end if
	}

	public TrsTrspRfndInvVO[] getTrsTrspRfndInvVOs() {
		TrsTrspRfndInvVO[] rtnVOs = null;
		if (this.trsTrspRfndInvVOs != null) {
			rtnVOs = Arrays.copyOf(this.trsTrspRfndInvVOs, this.trsTrspRfndInvVOs.length);
		} // end if
		return rtnVOs;
	}
