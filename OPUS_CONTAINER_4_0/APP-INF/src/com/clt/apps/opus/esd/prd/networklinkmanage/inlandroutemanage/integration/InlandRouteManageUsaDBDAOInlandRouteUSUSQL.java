...
*@FileName : InlandRouteManageUsaDBDAOInlandRouteUSUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageUsaDBDAOInlandRouteUSUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRouteManageUsaDBDAOInlandRouteUSUSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageUsaDBDAOInlandRouteUSUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
