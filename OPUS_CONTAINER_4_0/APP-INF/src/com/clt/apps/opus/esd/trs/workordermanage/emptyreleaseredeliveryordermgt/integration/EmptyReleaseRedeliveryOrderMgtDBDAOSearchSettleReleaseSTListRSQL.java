...
*@FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchSettleReleaseSTListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyReleaseRedeliveryOrderMgtDBDAOSearchSettleReleaseSTListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyReleaseRedeliveryOrderMgtDBDAOSearchSettleReleaseSTListRSQL(){
		setQuery();
		...
		query.append("FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchSettleReleaseSTListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   /*********************************/" ).append("\n"); 
		query.append("   AND ORD.TRSP_COST_DTL_MOD_CD = 'CF'    /** Carriou **/" ).append("\n"); 
