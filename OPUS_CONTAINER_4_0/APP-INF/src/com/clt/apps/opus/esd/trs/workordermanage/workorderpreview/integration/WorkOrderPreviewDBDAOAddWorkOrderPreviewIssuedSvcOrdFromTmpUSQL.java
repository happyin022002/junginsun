...
*@FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedSvcOrdFromTmpUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedSvcOrdFromTmpUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * trs_trsp_svc_ord_prv_tmp 의 데이터를 trs_trsp_svc_ord에 update
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedSvcOrdFromTmpUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedSvcOrdFromTmpUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		  	DECODE(VSL_CD, NULL, 'CNTC', VSL_CD)					" ).append("\n"); 
		...
		query.append("				DECODE(A.VSL_CD,NULL,A.TRSP_OTR_COST_MON_DT,A.TRSP_OTR_COST_MON_DT) " ).append("\n"); 
		query.append("		  	ELSE									" ).append("\n"); 
		query.append("				DECODE(A.VSL_CD,NULL,TO_CHAR(B.LOCL_CRE_DT,'YYMM'),A.SKD_VOY_NO)	" ).append("\n"); 
		...
		query.append("	   (										" ).append("\n"); 
		query.append("		  SELECT									" ).append("\n"); 
		query.append("		  	DECODE(VSL_CD, NULL, 'M', SKD_DIR_CD)					" ).append("\n"); 
		query.append("		  FROM TRS_TRSP_SVC_ORD							" ).append("\n"); 
		query.append("		  WHERE									" ).append("\n"); 
		query.append("		  	TRSP_SO_OFC_CTY_CD	= @[trsp_so_ofc_cty_cd]		" ).append("\n"); 
		query.append("		  	AND TRSP_SO_SEQ		= @[trsp_so_seq]		" ).append("\n"); 
