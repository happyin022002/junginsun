...
*@FileName : ESD_SCE_0068HTMLAction.java
 ...
 *
 * @author Hyunsu, Ryu
 * @see EsdSce0068Event , EsdSce0068EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_SCE_0068HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
     * COM_ENS_0B2HTMLAction 객체를 생성
     */
    public ESD_SCE_0068HTMLAction() {}
    ...
    public Event perform (HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce0068Event event = new EsdSce0068Event();
