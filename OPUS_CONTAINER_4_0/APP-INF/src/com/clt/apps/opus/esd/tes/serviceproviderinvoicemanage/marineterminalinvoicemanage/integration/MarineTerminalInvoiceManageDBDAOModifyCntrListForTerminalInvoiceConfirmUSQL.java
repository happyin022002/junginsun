...
public class MarineTerminalInvoiceManageDBDAOModifyCntrListForTerminalInvoiceConfirmUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           , DECODE(D.TML_CRR_CD,NULL,C.ACCT_CD,'',C.ACCT_CD,'TSG',C.ACCT_CD,C.CRR_ACCT_CD) ACCT_CD    -- 2008-07-31: 이D의 요청으로 전용terminal이외도 타선사인경우 타선사 Acct를 물린다." ).append("\n"); 
