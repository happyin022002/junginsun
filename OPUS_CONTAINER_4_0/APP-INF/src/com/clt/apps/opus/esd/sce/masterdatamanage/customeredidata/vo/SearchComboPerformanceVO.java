...
*@FileName : SearchComboPerformanceVO.java
*@FileTitle : SearchComboPerformanceVO
*Open Issues :
*Change history :
...
public class SearchComboPerformanceVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchComboPerformanceVO> models = new ArrayList<SearchComboPerformanceVO>();
	...
	public SearchComboPerformanceVO() {}

	public SearchComboPerformanceVO(String ibflag, String pagerows, String csGrpId, String tpId, String csDesc, String custCd, String ediSts) {
		this.ediSts = ediSts;
		this.ibflag = ibflag;
		this.csDesc = csDesc;
		this.custCd = custCd;
	 ...
	 */
	public SearchComboPerformanceVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchComboPerformanceVO[]
	 */
	public SearchComboPerformanceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchComboPerformanceVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchComboPerformanceVO();
				if (ediSts[i] != null)
		...
		return getSearchComboPerformanceVOs();
	}
	 ...
	 * @return SearchComboPerformanceVO[]
	 */
	public SearchComboPerformanceVO[] getSearchComboPerformanceVOs(){
		SearchComboPerformanceVO[] vos = (SearchComboPerformanceVO[])models.toArray(new SearchComboPerformanceVO[models.size()]);
		return vos;
	}
