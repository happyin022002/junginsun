...
*@FileName : OtherSOManageDAOSearchContainerEqNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OtherSOManageDBDAOSearchContainerEqNoRSQL implements ISQLTemplate{
	...
	public OtherSOManageDBDAOSearchContainerEqNoRSQL(){
		...
		query.append("FileName : OtherSOManageDAOSearchContainerEqNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("CNTR_NO in (" ).append("\n"); 
		query.append("" ).append("\n"); 
