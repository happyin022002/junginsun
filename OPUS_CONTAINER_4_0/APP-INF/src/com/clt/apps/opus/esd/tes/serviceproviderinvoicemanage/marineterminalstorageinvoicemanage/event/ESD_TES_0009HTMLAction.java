...
*@FileName : ESD_TES_009HTMLAction.java
 ...
 *
 * @author byungheeyoo
 * @see EsdTes0009Event , ESD_TES_009EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0009HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_009HTMLAction 객체를 생성
	 */
	public ESD_TES_0009HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_009Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("\n\n  ESD_TES_0009HTMLAction  \n\n");

		EsdTes0009Event event = new EsdTes0009Event();
