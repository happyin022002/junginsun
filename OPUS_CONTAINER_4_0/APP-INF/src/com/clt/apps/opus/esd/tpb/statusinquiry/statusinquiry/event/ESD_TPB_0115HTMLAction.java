...
*@FileName : ESD_TPB_0115HTMLAction.java
...
public class ESD_TPB_0115HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0115HTMLAction 객체를 생성
	 */
	public ESD_TPB_0115HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0115Event event = new EsdTpb0115Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchTPBDetailInfoVO((SearchTPBDetailInfoVO)getVO(request, SearchTPBDetailInfoVO .class));
		}
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchTPBDetailListVO((SearchTPBDetailListVO)getVO(request, SearchTPBDetailListVO .class));
		}
