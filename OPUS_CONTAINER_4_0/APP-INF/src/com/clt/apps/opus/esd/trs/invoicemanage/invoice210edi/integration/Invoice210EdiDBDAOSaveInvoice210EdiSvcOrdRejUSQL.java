...
*@FileName : Invoice210EdiDBDAOSaveInvoice210EdiSvcOrdRejUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Invoice210EdiDBDAOSaveInvoice210EdiSvcOrdRejUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * saveInvoice210Edi TRS_TRSP_SVC_ORD TABLE UPDATE
	  * </pre>
	  */
	public Invoice210EdiDBDAOSaveInvoice210EdiSvcOrdRejUSQL(){
		setQuery();
		...
		query.append("FileName : Invoice210EdiDBDAOSaveInvoice210EdiSvcOrdRejUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
