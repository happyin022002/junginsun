...
public class CommonPopUpManageDBDAO extends DBDAOSupport {
	...
	public List<ComVvdManagementVO> searchVVDManage(ComVvdManagementConditionVO comVvdManagementConditionVO) throws DAOException {
		...
		try {
			if (comVvdManagementConditionVO != null) {
				Map<String, String> mapVO = comVvdManagementConditionVO.getColumnValues();

				param.putAll(mapVO);
				velParam.putAll(mapVO);

				// VVD = vsl_cd/skd_voy_no/skd_dir_cd 처리
				if (velParam.get("selvvd") != null & !((String) velParam.get("selvvd")).trim().equals("")) {
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public List<ComOfficeManagementVO> searchServiceOfficeCodeManage(ComOfficeManagementVO comOfficeManagementVO) throws DAOException {
		DBRowSet dbRowset = null;
	 ...
	 * @throws DAOException
	 */
	public int searchSCNOManageCount(SCNOManagementVO sCNOManagementVO) throws DAOException {
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			if (sCNOManagementVO != null) {
				...
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				param.put("cust_cnt_seq", ((String) param.get("cust_cnt_seq")).toUpperCase());
			}
			dbRowset = new SQLExecuter("")
					.executeQuery(
	 ...
	 * @throws DAOException
	 */
	public DBRowSet searchSCNOManage(SCNOManagementVO sCNOManagementVO) throws DAOException {
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
	 ...
	 * @throws DAOException
	 */
	public String searchEMAILTemplateContent(SignOnUserAccount account) throws DAOException {
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 * @throws DAOException
	 */
	public DBRowSet searchEMAILRecipients(String param)throws DAOException {
		DBRowSet dbRowset = null;
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			if (!StringUtils.isBlank(param)) {
				velParam.put("bkg_no", param.toUpperCase().split(","));
			}
			
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new CommonPopUpManageDBDAOSearchEMAILRecipientsRSQL(),null, velParam);
