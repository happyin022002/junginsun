...
*@FileName : SearchInvoiceSheetSetVO.java
*@FileTitle : SearchInvoiceSheetSetVO
*Open Issues :
*Change history :
...
public class SearchInvoiceSheetSetVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchInvoiceSheetSetVO> models = new ArrayList<SearchInvoiceSheetSetVO>();
	...
	public SearchInvoiceSheetSetVO() {}

	public SearchInvoiceSheetSetVO(String ibflag, String pagerows, String invIssOfcCd, String coNm, String ofcAddr, String ofcPhnNo, String ofcFaxNo, String bilToLocDivCd, String invRmk1, String invRmk2, String vatXchRt, String vatXchRtDiv, String sInvIssOfcCd, String creUsrId, String updUsrId) {
	 ...
	 */
	public SearchInvoiceSheetSetVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchInvoiceSheetSetVO[]
	 */
	public SearchInvoiceSheetSetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchInvoiceSheetSetVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchInvoiceSheetSetVO();
		...
		return getSearchInvoiceSheetSetVOs();
	}
	...
	public SearchInvoiceSheetSetVO[] getSearchInvoiceSheetSetVOs(){
		SearchInvoiceSheetSetVO[] vos = (SearchInvoiceSheetSetVO[])models.toArray(new SearchInvoiceSheetSetVO[models.size()]);
		return vos;
	}
