...
*@FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceUSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOUpdateCSRInterfaceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
