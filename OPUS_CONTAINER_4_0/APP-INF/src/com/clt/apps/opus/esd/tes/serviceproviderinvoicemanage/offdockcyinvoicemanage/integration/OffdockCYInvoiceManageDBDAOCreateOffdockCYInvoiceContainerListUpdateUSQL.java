...
*@FileName : OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceContainerListUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceContainerListUpdateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateOffdockCYInvoiceContainerListUpdate
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceContainerListUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOCreateOffdockCYInvoiceContainerListUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   TML_RVIS_IND_FLG    =@[tml_rvis_ind_flg]  ," ).append("\n"); 
