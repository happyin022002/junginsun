...
public class CSMSendEurDBDAOAddFlatFileCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		'$$$MSGSTART:'||RPAD('NYK', 20, ' ')||RPAD('EUOLAF', 20, ' ')||RPAD('CSM315', 10, ' ')||@[flt_file_ref_no]||chr(13)||chr(10) ||" ).append("\n"); 
		query.append("		'MUID : ' || to_char(sysdate, 'yyyymmddhh24miss') || chr(13) || chr(10) || " ).append("\n"); 
		query.append("		'SNDID : ' || 'NYK' || chr(13) || chr(10) || " ).append("\n"); 
		query.append("		'RCVID : ' || 'EUOLAF' || chr(13) || chr(10) || " ).append("\n"); 
		query.append("		'322ID : ' || @[stnd_edi_sts_cd] || chr(13) || chr(10) ||" ).append("\n"); 
		...
		query.append("		'W_UNIT : ' || bkgd.WGT_UT_CD || chr(13) || chr(10) ||                                              " ).append("\n"); 
		query.append("		'WEIGHT : ' || bkgd.ACT_WGT || chr(13) || chr(10) ||" ).append("\n"); 
		query.append("		'MEA_UNIT : ' || chr(13) || chr(10) || " ).append("\n"); 
		query.append("		'MEA_QTY : ' || chr(13) || chr(10) || " ).append("\n"); 
		query.append("		'P_UNIT : ' || bkgd.PCK_TP_CD || chr(13) || chr(10) ||" ).append("\n"); 
		query.append("		'PACKAGE : ' || bkgd.pck_qty || chr(13) || chr(10) ||" ).append("\n"); 
		query.append("		'CNTR NBR : ' || tgt.cntr_no || chr(13) || chr(10) ||                                                                       " ).append("\n"); 
		query.append("		'CNTR TYPE : ' || cntr.CNTR_TPSZ_CD || chr(13) || chr(10) ||" ).append("\n"); 
		...
		query.append("		'CUST_REF_NO : ' || BKGC.ref_no || chr(13) || chr(10) ||" ).append("\n"); 
