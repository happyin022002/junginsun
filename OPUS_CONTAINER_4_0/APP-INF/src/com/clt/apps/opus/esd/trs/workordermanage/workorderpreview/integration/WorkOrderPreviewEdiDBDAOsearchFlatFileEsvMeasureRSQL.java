...
*@FileName : WorkOrderPreviewEdiDBDAOsearchFlatFileEsvMeasureRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewEdiDBDAOsearchFlatFileEsvMeasureRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderPreviewEdiDBDAOsearchFlatFileEsvMeasureRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewEdiDBDAOsearchFlatFileEsvMeasureRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,DECODE(LEVEL, 1, 'Height', 2, 'Width', 3, 'Depth', 4, 'Volume', 5, 'Net weight', 6, 'Tare weight', 7, 'Gross weight', 8, 'Verified Gross Mass') COL" ).append("\n"); 
		query.append("      FROM DUAL" ).append("\n"); 
		query.append("      CONNECT BY LEVEL < 9)" ).append("\n"); 
		query.append("    SELECT A.COL AS MEAS_TYPE" ).append("\n"); 
		query.append("        ,DECODE(A.L, 1, Height, 2, Width, 3, Depth, 4, MEAS_QTY, 5, CNTR_WGT, 6, TARE_WGT, 7, GROSS_WGT, 8, VGM_WGT) AS MEAS_QTY" ).append("\n"); 
		query.append("        ,DECODE(A.L, 1, 'M', 2, 'M', 3, 'M', 4, 'CBM', 5, UNIT_CD, 6, UNIT_CD, 7, UNIT_CD, 8, NVL2(VGM_WGT_UT_CD, 'KG', '')) AS MEAS_UNIT" ).append("\n"); 
