...
*@FileName : PickupReturnCyManageDBDAOChkDupPickupReturnCYRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PickupReturnCyManageDBDAOChkDupPickupReturnCYRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PickupReturnCyManageDBDAOChkDupPickupReturnCYRSQL(){
		setQuery();
		...
		query.append("FileName : PickupReturnCyManageDBDAOChkDupPickupReturnCYRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(1) DUP_CNT" ).append("\n"); 
		query.append("  FROM PRD_PKUP_RTN_YD" ).append("\n"); 
		query.append(" WHERE POR_DEL_CD = @[por_del_cd]" ).append("\n"); 
		query.append("   AND POL_POD_CD = @[pol_pod_cd]" ).append("\n"); 
