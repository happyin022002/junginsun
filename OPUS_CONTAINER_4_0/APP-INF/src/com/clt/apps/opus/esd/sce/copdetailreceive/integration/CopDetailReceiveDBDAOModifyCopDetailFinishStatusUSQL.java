...
*@FileName : CopDetailReceiveDBDAOModifyCopDetailFinishStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopDetailReceiveDBDAOModifyCopDetailFinishStatusUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyCopDetailFinishStatus
	  * </pre>
	  */
	public CopDetailReceiveDBDAOModifyCopDetailFinishStatusUSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOModifyCopDetailFinishStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
