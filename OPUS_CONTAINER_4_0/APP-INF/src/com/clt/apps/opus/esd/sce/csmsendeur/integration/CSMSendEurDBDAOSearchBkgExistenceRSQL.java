...
*@FileName : CSMSendEurDBDAOSearchBkgExistenceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSMSendEurDBDAOSearchBkgExistenceRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSMSendEurDBDAOSearchBkgExistenceRSQL(){
		setQuery();
		...
		query.append("FileName : CSMSendEurDBDAOSearchBkgExistenceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
