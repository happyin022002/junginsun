...
*@FileName : SearchTPBOfficeListVO.java
*@FileTitle : SearchTPBOfficeListVO
*Open Issues :
*Change history :
...
public class SearchTPBOfficeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchTPBOfficeListVO> models = new ArrayList<SearchTPBOfficeListVO>();
	...
	public SearchTPBOfficeListVO() {}

	public SearchTPBOfficeListVO(String ibflag, String pagerows, String ofcCd, String n3ptyOfcCd, String rhqCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String sOfcCd, String sIfOfcCd, String sIfRhqCd) {
		this.updDt = updDt;
		this.rhqCd = rhqCd;
	 ...
	 */
	public SearchTPBOfficeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchTPBOfficeListVO[]
	 */
	public SearchTPBOfficeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchTPBOfficeListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchTPBOfficeListVO();
				if (updDt[i] != null)
		...
		return getSearchTPBOfficeListVOs();
	}
	...
	public SearchTPBOfficeListVO[] getSearchTPBOfficeListVOs(){
		SearchTPBOfficeListVO[] vos = (SearchTPBOfficeListVO[])models.toArray(new SearchTPBOfficeListVO[models.size()]);
		return vos;
	}
