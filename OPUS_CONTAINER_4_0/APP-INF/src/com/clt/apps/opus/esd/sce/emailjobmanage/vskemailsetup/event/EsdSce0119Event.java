...
public class EsdSce0119Event extends EventSupport {
	...
	public VslSkdEmlSetUpVO[] getVslSkdEmlSetUpVos() {
		VslSkdEmlSetUpVO[] rtnVOs = null;
		if (this.vslSkdEmlSetUpVos != null) {
			rtnVOs = Arrays.copyOf(vslSkdEmlSetUpVos, vslSkdEmlSetUpVos.length);
		}
		return rtnVOs;
	}

	public void setVslSkdEmlSetUpVos(VslSkdEmlSetUpVO[] vslSkdEmlSetUpVos) {
		if(vslSkdEmlSetUpVos != null){
			VslSkdEmlSetUpVO[] tmpVOs = Arrays.copyOf(vslSkdEmlSetUpVos, vslSkdEmlSetUpVos.length);
			this.vslSkdEmlSetUpVos = tmpVOs;
		}
	}
