...
*@FileName : OffdockCYInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOCreateTES_FILE_IMP_TMPByPoolCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
