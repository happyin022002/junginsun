...
*@FileName : CustomerEdiDBDBDAOSearchCargoTrackingDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerEdiDBDBDAOSearchCargoTrackingDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomerEdiDBDBDAOSearchCargoTrackingDataRSQL(){
		setQuery();
		...
		query.append("FileName : CustomerEdiDBDBDAOSearchCargoTrackingDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
