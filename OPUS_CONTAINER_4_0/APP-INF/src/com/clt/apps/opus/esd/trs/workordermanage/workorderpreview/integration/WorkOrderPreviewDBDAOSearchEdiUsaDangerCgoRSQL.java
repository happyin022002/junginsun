...
*@FileName : WorkOrderPreviewDBDAOSearchEdiUsaDangerCgoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOSearchEdiUsaDangerCgoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchEdi_USA_DANGER_CGO
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOSearchEdiUsaDangerCgoRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOSearchEdiUsaDangerCgoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("#if (${trsp_bnd_cd} == 'O' && ${trsp_cost_dtl_mod_cd} == 'DR')" ).append("\n"); 
		query.append("" ).append("\n"); 
