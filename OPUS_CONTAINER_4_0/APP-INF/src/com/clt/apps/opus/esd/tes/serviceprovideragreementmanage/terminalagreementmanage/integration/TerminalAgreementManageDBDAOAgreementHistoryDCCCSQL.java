...
*@FileName : TerminalAgreementManageDBDAOAgreementHistoryDCCCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOAgreementHistoryDCCCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Danger Cargo Class Insert
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOAgreementHistoryDCCCSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOAgreementHistoryDCCCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM	TES_TML_AGMT_DG_CGO_CLSS" ).append("\n"); 
