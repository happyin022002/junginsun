...
public class OtherSOManageDAOSearchGensetEqNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OtherSOManageDAOSearchGensetEqNoRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FROM 	FROM CGM_EQUIPMENT" ).append("\n"); 
