...
*@FileName : VskEmailSetupDBDAORemoveEmlJbSubscSetUpDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VskEmailSetupDBDAORemoveEmlJbSubscSetUpDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSL E-MAIL 대상 삭제 ( SCE_EML_JB_SUBSC )
	  * </pre>
	  */
	public VskEmailSetupDBDAORemoveEmlJbSubscSetUpDSQL(){
		setQuery();
		...
		query.append("FileName : VskEmailSetupDBDAORemoveEmlJbSubscSetUpDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE SCE_EML_JB_SUBSC" ).append("\n"); 
