...
*@FileName : InvoiceAuditDBDAOSaveInvoiceAuditCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceAuditDBDAOSaveInvoiceAuditCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceAuditDBDAOSaveInvoiceAuditCSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceAuditDBDAOSaveInvoiceAuditCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  ,NVL(@[vat_amt], 0)" ).append("\n"); 
		query.append("  ,NVL(@[wht_amt], 0)" ).append("\n"); 
		query.append("  ,NVL(@[tot_amt], 0)" ).append("\n"); 
