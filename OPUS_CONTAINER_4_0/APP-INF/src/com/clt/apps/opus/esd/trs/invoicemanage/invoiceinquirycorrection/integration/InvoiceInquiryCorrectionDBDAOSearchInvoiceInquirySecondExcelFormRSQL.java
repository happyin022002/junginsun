...
public class InvoiceInquiryCorrectionDBDAOSearchInvoiceInquirySecondExcelFormRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	,NVL(C.BZC_AMT, 0) + NVL(C.ETC_ADD_AMT, 0) + NVL(C.FUEL_SCG_AMT, 0) + NVL(C.NEGO_AMT, 0) AS WO_TOT_AMT" ).append("\n"); 
		...
		query.append("	,NVL(C.INV_ADJ_BZC_AMT, 0) INV_ADJ_BZC_AMT" ).append("\n"); 
