...
public class InlandRouteManageDBDAOSearchEmptyInlandRouteMasterListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    o2_flg, o4_flg, a2_flg, a4_flg, r5_flg ,r2_flg," ).append("\n"); 
		query.append("    upd_usr_id, to_char(upd_dt,'yyyy-mm-dd') upd_dt" ).append("\n"); 
		...
		query.append("                  o2_capa_flg, o4_capa_flg, a2_capa_flg, a4_capa_flg, r2_capa_flg,r5_capa_flg, upd_usr_id, upd_dt " ).append("\n"); 
		query.append("             FROM ( " ).append("\n"); 
		...
		query.append("                        m.o2_capa_flg, m.o4_capa_flg, m.a2_capa_flg, m.a4_capa_flg, m.r5_capa_flg, " ).append("\n"); 
		query.append("                        m.UPD_USR_ID, m.UPD_DT," ).append("\n"); 
		query.append("                        m.r2_capa_flg" ).append("\n"); 
