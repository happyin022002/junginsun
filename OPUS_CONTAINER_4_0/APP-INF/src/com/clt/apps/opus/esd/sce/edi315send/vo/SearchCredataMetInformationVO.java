...
*@FileName : SearchCredataMetInformationVO.java
*@FileTitle : SearchCredataMetInformationVO
*Open Issues :
*Change history :
...
public class SearchCredataMetInformationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchCredataMetInformationVO> models = new ArrayList<SearchCredataMetInformationVO>();
	...
	public SearchCredataMetInformationVO() {}

	public SearchCredataMetInformationVO(String ibflag, String pagerows, String podeta1, String podeta1Gmt, String podetd1, String podetd1Gmt) {
	 ...
	 * @param request
	 * @return SearchCredataMetInformationVO[]
	 */
	public SearchCredataMetInformationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCredataMetInformationVO[]
	 */
	public SearchCredataMetInformationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchCredataMetInformationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchCredataMetInformationVO();
				if (podetd1[i] != null)
		...
		return getSearchCredataMetInformationVOs();
	}
	 ...
	 * @return SearchCredataMetInformationVO[]
	 */
	public SearchCredataMetInformationVO[] getSearchCredataMetInformationVOs(){
		SearchCredataMetInformationVO[] vos = (SearchCredataMetInformationVO[])models.toArray(new SearchCredataMetInformationVO[models.size()]);
		return vos;
	}
