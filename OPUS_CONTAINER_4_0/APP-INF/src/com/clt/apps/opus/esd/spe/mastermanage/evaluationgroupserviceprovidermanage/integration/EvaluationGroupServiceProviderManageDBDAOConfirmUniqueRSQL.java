...
*@FileName : EvaluationGroupServiceProviderManageDBDAOConfirmUniqueRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EvaluationGroupServiceProviderManageDBDAOConfirmUniqueRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EvaluationGroupServiceProviderManageDBDAOConfirmUniqueRSQL(){
		setQuery();
		...
		query.append("FileName : EvaluationGroupServiceProviderManageDBDAOConfirmUniqueRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM SPE_EV_GRP_SVC_PROV_MTCH" ).append("\n"); 
