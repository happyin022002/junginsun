...
*@FileName : WorkOrderIssueDBDAOsetFrustrateSoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderIssueDBDAOsetFrustrateSoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderIssueDBDAOsetFrustrateSoUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderIssueDBDAOsetFrustrateSoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
