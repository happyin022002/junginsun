...
*@FileName : ESD_TPB_811HTMLAction.java
...
public class ESD_TPB_0811HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_811HTMLAction 객체를 생성
	 */
	public ESD_TPB_0811HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0811Event event = new EsdTpb0811Event();
		 
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchContainerInfoVOs((SearchContainerInfoVO[])getVOs(request, SearchContainerInfoVO .class,""));
		} else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchContainerInfoVO((SearchContainerInfoVO)getVO(request, SearchContainerInfoVO .class));
		}
