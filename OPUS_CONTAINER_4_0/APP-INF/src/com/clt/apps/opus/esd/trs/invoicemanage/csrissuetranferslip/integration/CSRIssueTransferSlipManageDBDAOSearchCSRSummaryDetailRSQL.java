...
public class CSRIssueTransferSlipManageDBDAOSearchCSRSummaryDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(" 		,	DECODE(INV_INDICATOR, 'RF', INV_BZC_AMT      , INV_BZC_AMT	  ) INV_BZC_AMT        	" ).append("\n"); 
		query.append(" 		,	DECODE(INV_INDICATOR, 'RF', INV_VAT_AMT      , INV_VAT_AMT	  ) INV_VAT_AMT         " ).append("\n"); 
		query.append(" 		,	DECODE(INV_INDICATOR, 'RF', INV_WHLD_TAX_AMT , INV_WHLD_TAX_AMT)	INV_WHLD_TAX_AMT    " ).append("\n"); 
		query.append(" 		,	DECODE(INV_INDICATOR, 'RF', INV_TTL_AMT		 , INV_TTL_AMT	  ) INV_TTL_AMT         " ).append("\n"); 
