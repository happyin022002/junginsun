...
*@FileName : AgreementImportDBDAOMultiCorrRateAgmtEqRateHisForDeleteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOMultiCorrRateAgmtEqRateHisForDeleteCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Rate Deletion History Insert
	  * </pre>
	  */
	public AgreementImportDBDAOMultiCorrRateAgmtEqRateHisForDeleteCSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAOMultiCorrRateAgmtEqRateHisForDeleteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
