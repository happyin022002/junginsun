...
*@FileName : VskEmailSetupDBDAOModifyVslSkdEmlSetUpUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VskEmailSetupDBDAOModifyVslSkdEmlSetUpUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSL E-MAIL 대상 변경 ( SCE_VSL_SKD_EML )
	  * </pre>
	  */
	public VskEmailSetupDBDAOModifyVslSkdEmlSetUpUSQL(){
		setQuery();
		...
		query.append("FileName : VskEmailSetupDBDAOModifyVslSkdEmlSetUpUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCE_VSL_SKD_EML" ).append("\n"); 
		query.append("SET VSL_SLAN_CD = @[vslSlanCd]," ).append("\n"); 
		query.append("TO_PORT_CD = @[toPortCd]," ).append("\n"); 
		query.append("VSKD_DUR_ID = @[vskdDurId]||'D'" ).append("\n"); 
