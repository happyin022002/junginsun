...
public class GuaranteeManageDBDAOSearchUSGuaranteeHdrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			WHERE YD_CD = GH.YD_CD ) YD_NM" ).append("\n"); 
		...
		query.append("		, TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC((SELECT OFC_CD FROM TABLE (COM_OfficeCodeMgr_PKG.COM_getOfficeCodeList_FNC('000001', 'TES'))), CRE_DT, OFC_CD), 'YYYY-MM-DD') CRE_DT" ).append("\n"); 
