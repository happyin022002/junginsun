...
public class SearchRTRInfoVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRCustCntCd(JSPUtil.getParameter(request, "r_cust_cnt_cd", ""));
		setCstmsAcptFlg(JSPUtil.getParameter(request, "cstms_acpt_flg", ""));
		setCgoTpCd(JSPUtil.getParameter(request, "cgo_tp_cd", ""));
		setDwellTime(JSPUtil.getParameter(request, "dwell_time", ""));
		setRVvd(JSPUtil.getParameter(request, "r_vvd", ""));
		setCustomerLoc(JSPUtil.getParameter(request, "customer_loc", ""));
		setPodPol(JSPUtil.getParameter(request, "pod_pol", ""));
		setRBlNo(JSPUtil.getParameter(request, "r_bl_no", ""));
		...
		setRCustSeq(JSPUtil.getParameter(request, "r_cust_seq", ""));
		setDateKind(JSPUtil.getParameter(request, "date_kind", ""));
		setRBkgNo(JSPUtil.getParameter(request, "r_bkg_no", ""));
		setRPolpod(JSPUtil.getParameter(request, "r_polpod", ""));
		...
		setRScno(JSPUtil.getParameter(request, "r_scno", ""));
		setRDest(JSPUtil.getParameter(request, "r_dest", ""));
		...
		setTDep(JSPUtil.getParameter(request, "t_dep", ""));
		setDwellKind(JSPUtil.getParameter(request, "dwell_kind", ""));
		setROrigin(JSPUtil.getParameter(request, "r_origin", ""));
		setRailcomp(JSPUtil.getParameter(request, "railcomp", ""));
