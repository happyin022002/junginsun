...
public class SearchAdjustmentManageListVO {
	
	private static final long serialVersionUID = 1L;
	
	private Collection<SearchAdjustmentManageListVO> models = new ArrayList<SearchAdjustmentManageListVO>();
	...
	public SearchAdjustmentManageListVO() {}

	public SearchAdjustmentManageListVO(String ibflag, String pagerows, String n3ptyOfcTpCd, String ofcCd, String sOfcCd, String rhqCd, String n3ptyCtrlOfcCd, String n3ptyOfcCd, String n3ptyArOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public SearchAdjustmentManageListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchAdjustmentManageListVO[]
	 */
	public SearchAdjustmentManageListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchAdjustmentManageListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchAdjustmentManageListVO();
				if (updDt[i] != null)
		...
		return getSearchAdjustmentManageListVOs();
	}
	...
	public SearchAdjustmentManageListVO[] getSearchAdjustmentManageListVOs(){
		SearchAdjustmentManageListVO[] vos = (SearchAdjustmentManageListVO[])models.toArray(new SearchAdjustmentManageListVO[models.size()]);
		return vos;
	}
