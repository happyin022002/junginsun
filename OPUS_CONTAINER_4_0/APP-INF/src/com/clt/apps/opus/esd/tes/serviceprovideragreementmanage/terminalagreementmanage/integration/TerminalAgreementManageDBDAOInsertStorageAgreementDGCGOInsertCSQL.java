...
*@FileName : TerminalAgreementManageDBDAOInsertStorageAgreementDGCGOInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertStorageAgreementDGCGOInsertCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertStorageAgreementDGCGOInsertCSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertStorageAgreementDGCGOInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
