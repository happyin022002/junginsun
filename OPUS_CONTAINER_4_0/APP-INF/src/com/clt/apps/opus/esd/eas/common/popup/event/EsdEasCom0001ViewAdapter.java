...
*@FileName : EsdEasCom0001ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsdEasCom0001ViewAdapter extends EasDefaultViewAdapter {
                ...
                if( rowSet != null ){
                    ...
                    while(rowSet.next()){
                        ...
                        for(int j = 0; j < rowSet.getMetaData().getColumnCount(); j++){
                        	sb.append("<TD></TD>");
                        	sb.append("<TD><![CDATA[").append(getNull(rowSet.getString("OFC_CD_NAME")) + "]]></TD>");
                        	sb.append("<TD><![CDATA[").append(getNull(rowSet.getString("OFC_CD")) + "]]></TD>");
                        }//for end
                        sb.append("</TR>\n");
                    }//while end
                }//if end
