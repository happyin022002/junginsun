...
*@FileName : MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceN3rdParyIFSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceN3rdParyIFSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiTerminalInvoiceN3rdParyIFSeq
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceN3rdParyIFSeqRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceN3rdParyIFSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
