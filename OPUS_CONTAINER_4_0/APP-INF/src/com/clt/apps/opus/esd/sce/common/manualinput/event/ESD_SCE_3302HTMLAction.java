 ...
 * @since J2EE 1.6
 */
public class ESD_SCE_3302HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SCE_3302HTMLAction Object creation
	 */
	public ESD_SCE_3302HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce3302Event event = new EsdSce3302Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setActivityGroupVO((ActivityGroupVO)getVO(request, ActivityGroupVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setActivityGroupVOs((ActivityGroupVO[])getVOs(request, ActivityGroupVO .class));
