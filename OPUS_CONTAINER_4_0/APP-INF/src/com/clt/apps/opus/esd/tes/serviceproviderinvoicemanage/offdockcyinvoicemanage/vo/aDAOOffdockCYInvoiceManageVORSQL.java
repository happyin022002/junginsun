...
public class aDAOOffdockCYInvoiceManageVORSQL implements ISQLTemplate{
	...
	public aDAOOffdockCYInvoiceManageVORSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esd.tes.serviceproviderinvoicemanage.offdockcyinvoicemanage.vo").append("\n"); 
	...
	public void setQuery(){
		...
		query.append(", '' tmpmode --you should change 'tmpmode' to 'mode'" ).append("\n"); 
		...
		query.append(", '' dtl_by_eq_only_mode" ).append("\n"); 
