...
*@FileName : CustomerEdiDBDAOSearchDetailOtherReportCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerEdiDBDAOSearchDetailOtherReportCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchDetailOtherReportCnt
	  * </pre>
	  */
	public CustomerEdiDBDAOSearchDetailOtherReportCntRSQL(){
		setQuery();
		...
		query.append("FileName : CustomerEdiDBDAOSearchDetailOtherReportCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("select  DISTINCT vvd,a.bkg_no, a.cntr_no, por_cd, pol_cd, pod_cd, del_cd,'' flg" ).append("\n"); 
		...
		query.append(",r.nod_cd,to_char(r.cre_dt,'yyyymmdd') cre_dt1, to_char(r.cre_dt,'hh24miss') cre_dt2, a.cop_no , a.bl_no, r.act_dt, flt_file_ref_no" ).append("\n"); 
		query.append("from  ( select r.EDI_GRP_CD, r.bkg_no, r.cntr_no, r.EDI_STS_CD, r.edi_sub_sts_cd," ).append("\n"); 
		query.append("r.edi_snd_knt, r.act_dt, r.nod_cd, r.GMT_DT, r.upd_dt,r.cre_dt, r.flt_file_ref_no" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if(${pol} != '')" ).append("\n"); 
		query.append("AND h.pol_nod_cd LIKE '${pod}%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${pod} != '')" ).append("\n"); 
