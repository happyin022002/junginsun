...
*@FileName : SearchTableGlMonXchRtVO.java
*@FileTitle : SearchTableGlMonXchRtVO
*Open Issues :
*Change history :
...
public class SearchGlMonXchRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchGlMonXchRtVO> models = new ArrayList<SearchGlMonXchRtVO>();
	...
	public SearchGlMonXchRtVO() {}

	public SearchGlMonXchRtVO(String ibflag, String pagerows, String acctXchRtYrmon, String acctXchRtLvl, String currCd) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return SearchTableGlMonXchRtVO[]
	 */
	public SearchGlMonXchRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchTableGlMonXchRtVO[]
	 */
	public SearchGlMonXchRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchGlMonXchRtVO model = null;
		...
		return getSearchTableGlMonXchRtVOs();
	}
	 ...
	 * @return SearchTableGlMonXchRtVO[]
	 */
	public SearchGlMonXchRtVO[] getSearchTableGlMonXchRtVOs(){
		SearchGlMonXchRtVO[] vos = (SearchGlMonXchRtVO[])models.toArray(new SearchGlMonXchRtVO[models.size()]);
		return vos;
	}
