...
import com.clt.apps.opus.common.tableSync.jms.integration.ReceiveQueueArMstRevVvdDBDAO;
...
import com.clt.irep.erp.FNS0420001Document;
import com.clt.irep.erp.FNS0420001Document.FNS0420001;
import com.clt.irep.erp.FNS0420001Document.FNS0420001.DataArea;
import com.clt.irep.erp.FNS0420001Document.FNS0420001.DataArea.ROWSET;
import com.clt.irep.erp.FNS0420001Document.FNS0420001.DataArea.ROWSET.ROW;
...
public class ReceiveQueueArMstRevVvdBCImpl extends BasicCommandSupport
	...
	public Collection receiveBKGTB(XmlObject xmlObject) {
		...
		for (int i = 0; row != null && i < row.length; i++) {
			...
			model.setRevPortCd 	(row[i].getCALLINGPORT());
