...
public class CniUtil {
	...
	protected static Logger log = Logger.getLogger("CniUtil.java");
	/**
    ...
    */
	...
	public static void setCargoClaimNo(SignOnUserAccount account,String cgoClmNo) {
		...
		StringBuffer tmp = new StringBuffer(cgoClmNo);
...
//			cgoClmNo = cgoClmNo + " ";
	...
	public static void setDwClaimNo(SignOnUserAccount account,String dwClmNo) {
		...
		StringBuffer tmp = new StringBuffer(dwClmNo);
		while (tmp.length() < 20) {
//			dwClmNo = dwClmNo + " ";
			tmp.append(" ");
		}
		dwClmNo = tmp.toString();
	...
	public static void setAreaInfo(SignOnUserAccount account,String area) {
		...
		StringBuffer tmp = new StringBuffer(area);
		while (tmp.length() < 20) {
//			area = area + " ";
			tmp.append(" ");
		}
	...
	public static void setVvd(SignOnUserAccount account,String vvd) {
		...
		StringBuffer tmp = new StringBuffer(vvd);
		while (tmp.length() < 20) {
//			vvd = vvd + " ";
			tmp.append(" ");
		}
	...
	public static void setRoles(SignOnUserAccount account,String roles) {
		...
		StringBuffer tmp = new StringBuffer(roles);
		while (tmp.length() < 220) {
//			roles = roles + " ";
			tmp.append(" ");
		}
