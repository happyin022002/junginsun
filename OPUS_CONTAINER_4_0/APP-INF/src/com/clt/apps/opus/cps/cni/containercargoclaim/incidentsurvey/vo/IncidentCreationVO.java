...
*@FileName : IncidentCreationVO.java
*@FileTitle : IncidentCreationVO
*Open Issues :
*Change history :
...
public class IncidentCreationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<IncidentCreationVO> models = new ArrayList<IncidentCreationVO>();
	...
	public IncidentCreationVO() {}

	public IncidentCreationVO(String ibflag, String pagerows, String cgoClmInciNo, String clmAreaCd, String creOfcCd, String inciPlcTpCd, String creUsrId, String creDt, String updDt, String inciOccrDt, String inciRefVvdNo, String inciLocCd, String inciSubjNm, String inciDevDesc) {
		this.updDt = updDt;
	 ...
	 */
	public IncidentCreationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return IncidentCreationVO[]
	 */
	public IncidentCreationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		IncidentCreationVO model = null;
	 ...
	 * @return IncidentCreationVO[]
	 */
	public IncidentCreationVO[] getIncidentCreationVOs(){
		IncidentCreationVO[] vos = (IncidentCreationVO[])models.toArray(new IncidentCreationVO[models.size()]);
		return vos;
	}
