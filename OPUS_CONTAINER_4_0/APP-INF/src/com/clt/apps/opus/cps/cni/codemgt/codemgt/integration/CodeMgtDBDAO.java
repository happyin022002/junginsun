...
/**
 * OPUS GEMMasterCodeMgtDAO <br>
 * - OPUS-GEMCommon system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
 * @author cjm
...
//	public String searchVesselName(String vslCd) {
...
//	}
	...
	public List<SearchVesselListVO> searchVesselList(String vslCd, String vslNm) throws DAOException {
		 ...
		 */
		 @SuppressWarnings("unchecked")
		public List<SearchClaimCodeListVO> searchClaimCodeList(String typeCd) throws DAOException {
			DBRowSet dbRowset = null;
			List<SearchClaimCodeListVO> searchClaimCodeListVO = null;
			//query parameter
			Map<String, Object> param = new HashMap<String, Object>();
			...
			try{
				...
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CodeMgtDBDAOSearchClaimCodeListVORSQL(), param, null);
				searchClaimCodeListVO = (List)RowSetUtil.rowSetToVOs(dbRowset, SearchClaimCodeListVO .class);
			}catch(SQLException se){
				log.error(se.getMessage(),se);
				throw new DAOException(new ErrorHandler(se).getMessage());
			}catch(Exception ex){
