...
*@FileName : SearchClaimCodeListVO.java
*@FileTitle : SearchClaimCodeListVO
*Open Issues :
*Change history :
...
public class SearchClaimCodeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchClaimCodeListVO> models = new ArrayList<SearchClaimCodeListVO>();
	...
	public SearchClaimCodeListVO() {}

	public SearchClaimCodeListVO(String ibflag, String pagerows, String clmMiscCd, String clmMiscNm) {
		this.ibflag = ibflag;
	 ...
	 */
	public SearchClaimCodeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchClaimCodeListVO[]
	 */
	public SearchClaimCodeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchClaimCodeListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchClaimCodeListVO();
				if (ibflag[i] != null)
		...
		return getSearchClaimCodeListVOs();
	}
	 ...
	 * @return SearchClaimCodeListVO[]
	 */
	public SearchClaimCodeListVO[] getSearchClaimCodeListVOs(){
		SearchClaimCodeListVO[] vos = (SearchClaimCodeListVO[])models.toArray(new SearchClaimCodeListVO[models.size()]);
		return vos;
	}
