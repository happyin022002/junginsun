...
*@FileName : CPS_CNI_0307HTMLAction.java
...
public class CPS_CNI_0307HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CPS_CNI_0307HTMLAction 객체를 생성
	 */
	public CPS_CNI_0307HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsCni0307Event event = new CpsCni0307Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setCurrCd(request.getParameter("search_curr_cd"));
		}
