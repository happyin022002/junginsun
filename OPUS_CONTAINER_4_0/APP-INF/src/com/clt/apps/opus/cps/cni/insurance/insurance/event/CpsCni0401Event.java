...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.cps.cni.insurance.insurance.event;
...
public class CpsCni0401Event extends EventSupport {
	...
	public void setCustomInsuranceVOS(CustomInsuranceVO[] customInsuranceVOs){
		if(customInsuranceVOs != null){
			CustomInsuranceVO[] tmpVOs = java.util.Arrays.copyOf(customInsuranceVOs, customInsuranceVOs.length);
			this.customInsuranceVOs = tmpVOs;
		}
	}
	...
	public void setCustomPremiumInstallmentVOS(CustomPremiumInstallmentVO[] customPremiumInstallmentVOs){
		if(customPremiumInstallmentVOs != null){
			CustomPremiumInstallmentVO[] tmpVOs = java.util.Arrays.copyOf(customPremiumInstallmentVOs, customPremiumInstallmentVOs.length);
			this.customPremiumInstallmentVOs = tmpVOs;
		}
	}
	...
	public CustomInsuranceVO[] getCustomInsuranceVOS(){
		CustomInsuranceVO[] rtnVOs = null;
		if (this.customInsuranceVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(customInsuranceVOs, customInsuranceVOs.length);
		}
		return rtnVOs;
	}
	...
	public CustomPremiumInstallmentVO[] getCustomPremiumInstallmentVOS(){
		CustomPremiumInstallmentVO[] rtnVOs = null;
		if (this.customPremiumInstallmentVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(customPremiumInstallmentVOs, customPremiumInstallmentVOs.length);
		}
		return rtnVOs;
	}
