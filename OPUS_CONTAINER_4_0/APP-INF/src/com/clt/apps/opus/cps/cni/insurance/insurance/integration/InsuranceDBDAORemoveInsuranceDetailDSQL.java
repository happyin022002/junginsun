...
*@FileName : InsuranceDBDAORemoveInsuranceDetailDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InsuranceDBDAORemoveInsuranceDetailDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Insurance 계약 상세를 삭제한다
	  * </pre>
	  */
	public InsuranceDBDAORemoveInsuranceDetailDSQL(){
		setQuery();
		...
		query.append("FileName : InsuranceDBDAORemoveInsuranceDetailDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
