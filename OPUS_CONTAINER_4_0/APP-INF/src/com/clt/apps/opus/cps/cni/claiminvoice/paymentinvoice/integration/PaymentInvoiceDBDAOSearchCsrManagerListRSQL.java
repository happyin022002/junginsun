...
*@FileName : PaymentInvoiceDBDAOSearchCsrManagerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PaymentInvoiceDBDAOSearchCsrManagerListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PaymentInvoiceDBDAOSearchCsrManagerListRSQL(){
		setQuery();
		...
		query.append("FileName : PaymentInvoiceDBDAOSearchCsrManagerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       , (SELECT CLM_AREA_CD FROM CNI_AREA_OFC WHERE OFC_CD = B.INV_OFC_CD) CLM_AREA_CD" ).append("\n"); 
		...
		query.append("             AND H.INV_OFC_CD         IN (SELECT OFC_CD FROM CNI_AREA_OFC WHERE CLM_AREA_CD = @[clm_area_cd])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
