 ...
 * HTTP Parser<br>
 * - com.clt.apps.nis2010.esm.gae.gaecommon 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class CPS_GEM_0111HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0111Event event = new CpsGem0111Event();
		
		//[Confirm]
		if(command.isCommand(FormCommand.ADD)) {			
			String month = JSPUtil.getParameter(request, "acct_xch_rt_yrmon",DateTime.getYear()+"");			
			month = month.replace("-", "");
