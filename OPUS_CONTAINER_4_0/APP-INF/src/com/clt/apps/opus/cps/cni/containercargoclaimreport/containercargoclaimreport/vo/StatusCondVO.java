...
*@FileName : StatusCondVO.java
*@FileTitle : StatusCondVO
*Open Issues :
*Change history :
...
public class StatusCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<StatusCondVO> models = new ArrayList<StatusCondVO>();
	...
	public StatusCondVO(String ibflag, String pagerows, String classCd, String period, String fromPeriod, String toPeriod, String area, String status, String vt, String pageNo, String hdlrOfcCd, String hdlrUsrId, String mgrUsrId, String hndlOfcCd, String lablClmPtyNo, String sveyClmPtyNo, String fmalClmRcvOfcCd, String clmtClmPtyNo, String clmtClmAgnPtyNo, String slvClmPtyNo, String insurClmPtyNo, String clmStlAuthUsrId, String trnkRefVvdNo, String porCd, String polCd, String podCd, String delCd, String fvd, String n1stPreTsLocCd, String n1stPstTsLocCd, String crrTermCd, String inciPlcTpCd, String slanCd, String clmCgoTpCd, String cgoClmTpCd, String mjrClmDmgLssCd, String minrClmDmgLssCd, String lit, String cgoClmStlTpCd, String fromClmtUsdAmt, String toClmtUsdAmt, String fromCgoClmStlUsdAmt, String toCgoClmStlUsdAmt, String cgoClmInciNo, String reportId) {
		this.porCd = porCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("report_id", getReportId());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("report_id", "reportId");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setReportId(JSPUtil.getParameter(request, prefix + "report_id", ""));
	 ...
	 * @return StatusCondVO[]
	 */
	public StatusCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StatusCondVO[]
	 */
	public StatusCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		StatusCondVO model = null;
		...
		try {
			...
			String[] reportId = (JSPUtil.getParameter(request, prefix	+ "report_id", length));
	 ...
	 * @return StatusCondVO[]
	 */
	public StatusCondVO[] getStatusCondVOs(){
		StatusCondVO[] vos = (StatusCondVO[])models.toArray(new StatusCondVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.reportId = this.reportId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
