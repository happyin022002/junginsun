...
*@FileName : CNI_COM_HTMLAction.java
*@FileTitle : CNI 공통 HTMLAction
*Open Issues :
*Change history :
...
package com.clt.apps.opus.cps.cni.common.event;
...
public class CNI_COM_HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;

    /**
     * CNI_COM_HTMLAction 객체를 생성
     */
    public CNI_COM_HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        CniComEvent event = new CniComEvent();
