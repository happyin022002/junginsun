...
*@FileName : GwApproveStatusVO.java
*@FileTitle : GwApproveStatusVO
*Open Issues :
*Change history :
...
public class GwApproveStatusVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<GwApproveStatusVO> models = new ArrayList<GwApproveStatusVO>();
...
/**
	 ...
	 */
	public GwApproveStatusVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return GwApproveStatusVO[]
	 */
	public GwApproveStatusVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		GwApproveStatusVO model = null;
	 ...
	 * @return GwApproveStatusVO[]
	 */
	public GwApproveStatusVO[] getGwApproveStatusVOs(){
		GwApproveStatusVO[] vos = (GwApproveStatusVO[])models.toArray(new GwApproveStatusVO[models.size()]);
		return vos;
	}
