...
*@FileName : GEMCommonDBDAOSearchMajorListByOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMCommonDBDAOSearchMajorListByOfficeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMCommonDBDAOSearchMajorListByOfficeRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("AND             L_3 IN (SELECT OFC_CD" ).append("\n"); 
		...
		query.append("FileName : GEMCommonDBDAOSearchMajorListByOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}