...
*@FileName : CPS_CNI_0021HTMLAction.java
 ...
 * HTTP Parser<br>
 * @author 박제성
 * @see CpsCni0021Event 참조
 * @since J2EE 1.4
 */

public class CPS_CNI_0021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_CNI_0021HTMLAction 객체를 생성
	 */
	public CPS_CNI_0021HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsCni0021Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		CpsCni0021Event event = new CpsCni0021Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)||command.isCommand(FormCommand.PRINT)) {
			// 조회조건
			OccurrenceAnalysisCondVO dto = (OccurrenceAnalysisCondVO)getVO(request, OccurrenceAnalysisCondVO.class);
			event.setOccurrenceAnalysisCondVO(dto);			
