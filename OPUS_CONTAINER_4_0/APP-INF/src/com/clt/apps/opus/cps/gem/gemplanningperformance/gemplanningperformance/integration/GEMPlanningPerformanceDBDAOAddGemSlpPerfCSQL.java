...
public class GEMPlanningPerformanceDBDAOAddGemSlpPerfCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(SLP_TJ_NO, SLP_SEQ_NO, RSLT_YRMON, OFC_CD, SUB_OFC_CD, GEN_EXPN_CD, SUB_GEN_EXPN_CD" ).append("\n"); 
		query.append(",ACCT_CD, SLP_CTR_CD, SLP_CURR_CD, SLP_AMT, SLP_VNDR_CD, GL_EFF_DT, GEN_EXPN_FNL_LOCL_AMT" ).append("\n"); 
		query.append(",SLP_PERF_AMT, SLP_DESC, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("VALUES (@[slp_tj_no], @[slp_seq_no], SUBSTR(@[rslt_yrmon],1,6), @[ofc_cd], @[sub_ofc_cd], @[gen_expn_cd], @[sub_gen_expn_cd]" ).append("\n"); 
		query.append(",@[acct_cd], @[slp_ctr_cd], @[slp_curr_cd], @[slp_amt], @[slp_vndr_cd], @[gl_eff_dt], @[gen_expn_fnl_locl_amt]" ).append("\n"); 
		query.append(",@[slp_perf_amt], @[slp_desc], @[cre_usr_id], sysdate, @[upd_usr_id], sysdate" ).append("\n"); 
		query.append(")" ).append("\n"); 
