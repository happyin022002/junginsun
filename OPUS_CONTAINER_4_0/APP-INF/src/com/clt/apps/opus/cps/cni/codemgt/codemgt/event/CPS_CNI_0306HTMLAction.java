...
*@FileName : CPS_CNI_0306HTMLAction.java
...
public class CPS_CNI_0306HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CPS_CNI_0306HTMLAction 객체를 생성
	 */
	public CPS_CNI_0306HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsCni0306Event event = new CpsCni0306Event();
