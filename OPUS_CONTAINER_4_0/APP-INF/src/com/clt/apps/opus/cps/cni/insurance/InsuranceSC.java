...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.cps.cni.insurance;
...
import com.clt.apps.opus.cps.cni.insurance.insurance.basic.InsuranceBC;
import com.clt.apps.opus.cps.cni.insurance.insurance.basic.InsuranceBCImpl;
import com.clt.apps.opus.cps.cni.insurance.insurance.event.CpsCni0401Event;
...
import com.clt.apps.opus.cps.cni.insurance.vesselstatus.basic.VesselStatusBC;
import com.clt.apps.opus.cps.cni.insurance.vesselstatus.basic.VesselStatusBCImpl;
import com.clt.apps.opus.cps.cni.insurance.vesselstatus.event.CpsCni0403Event;
...
/**
 * OPUS-Insurance Business Logic ServiceCommand - OPUS-Insurance 대한 비지니스 트랜잭션을 처리한다.
 * 
 * @author Yoon, Seyeong
 * @see InsuranceDBDAO
 * @since J2EE 1.6
...
public class InsuranceSC extends ServiceCommandSupport {
	 ...
	 * OPUS-Insurance system 업무에서 발생하는 모든 이벤트의 분기처리<br>
	 * 
	 * @param e Event
