...
*@FileName : CniClmPrveVO.java
*@FileTitle : CniClmPrveVO
*Open Issues :
*Change history :
...
public class CniClmPrveVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CniClmPrveVO> models = new ArrayList<CniClmPrveVO>();
	...
	public CniClmPrveVO(String ibflag, String pagerows, String clmPrveNo, String clmPrveDivCd, String effDt, String expDt, String creOfcCd, String clmPrveSubjNm, String clmPrveDesc, String clmPrveReadKnt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return CniClmPrveVO[]
	 */
	public CniClmPrveVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CniClmPrveVO[]
	 */
	public CniClmPrveVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CniClmPrveVO model = null;
	 ...
	 * @return CniClmPrveVO[]
	 */
	public CniClmPrveVO[] getCniClmPrveVOs(){
		CniClmPrveVO[] vos = (CniClmPrveVO[])models.toArray(new CniClmPrveVO[models.size()]);
		return vos;
	}
