...
*@FileName : CustomFileDwcInsuranceVO.java
*@FileTitle : CustomFileDwcInsuranceVO
*Open Issues :
*Change history :
...
public class CustomFileDwcInsuranceVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomFileDwcInsuranceVO> models = new ArrayList<CustomFileDwcInsuranceVO>();
	...
	public CustomFileDwcInsuranceVO() {}

	public CustomFileDwcInsuranceVO(String ibflag, String pagerows, String clmFileSeq, String clmFileTpCd, String clmBztpCd, String fileSavId, String fileNm, String fileDesc, String dwClmNo, String fileDownload, String insurTpCd, String insurPlcyYr, String insurClmPtyNo, String instInsurTpCd, String instInsurPlcyYr, String instPrmInsurTpCd, String cgoClmRefNo, String clmFileDpSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CustomFileDwcInsuranceVO[]
	 */
	public CustomFileDwcInsuranceVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomFileDwcInsuranceVO[]
	 */
	public CustomFileDwcInsuranceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomFileDwcInsuranceVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CustomFileDwcInsuranceVO();
				if (updDt[i] != null)
		...
		return getCustomFileDwcInsuranceVOs();
	}
	...
	public CustomFileDwcInsuranceVO[] getCustomFileDwcInsuranceVOs(){
		CustomFileDwcInsuranceVO[] vos = (CustomFileDwcInsuranceVO[])models.toArray(new CustomFileDwcInsuranceVO[models.size()]);
		return vos;
	}
