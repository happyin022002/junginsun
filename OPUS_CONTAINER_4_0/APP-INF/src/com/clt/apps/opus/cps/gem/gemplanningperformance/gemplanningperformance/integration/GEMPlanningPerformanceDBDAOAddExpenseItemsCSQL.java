...
*@FileName : GEMPlanningPerformanceDBDAOAddExpenseItemsCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOAddExpenseItemsCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOAddExpenseItemsCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOAddExpenseItemsCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}