...
*@FileName : PlanningStatusVO.java
*@FileTitle : PlanningStatusVO
*Open Issues :
*Change history :
...
public class PlanningStatusVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PlanningStatusVO> models = new ArrayList<PlanningStatusVO>();
	...
	/* Column Info */
	private String crntGenExpnApstsCdRj = null;
	/* Column Info */
	...
	/* Column Info */
	private String crntGenExpnApstsCdAp = null;
	/* Column Info */
	...
	public PlanningStatusVO() {}

	public PlanningStatusVO(String ibflag, String pagerows, String genExpnRqstNo, String genExpnRqstSeq, String fmGenExpnCd, String toGenExpnCd, String fmGenExpnItmNo, String fmGenExpnItmDesc, String toGenExpnItmNo, String toGenExpnItmDesc, String fmOfcCd, String toOfcCd, String rqstOfcCd, String fmRqAmt, String toRqAmt, String fmAdAmt, String toAdAmt, String crntGenExpnAproStepCd, String crntGenExpnApstsCd, String crntGenExpnApstsCdRj, String crntGenExpnApstsCdAp, String ap1, String ap2, String ap3, String ap4, String creUsrId, String genExpnRqstTpCd, String genExpnAproAuthOfcCd, String fmLoclCurrCd, String toLoclCurrCd, String fmUtVal, String toUtVal, String fmUsdLoclXchRt, String fmLoclKrwXchRt, String fmUsdKrwXchRt, String toUsdLoclXchRt, String toLoclKrwXchRt, String toUsdKrwXchRt, String creDt, String fmEngAbbrNm, String toEngAbbrNm, String fmKrnAbbrNm, String toKrnAbbrNm, String rqstOpinRmk, String itmUpdDt, String reqUpdDt) {
		...
		this.crntGenExpnApstsCdRj = crntGenExpnApstsCdRj;
		this.creDt = creDt;
		...
		this.crntGenExpnApstsCdAp = crntGenExpnApstsCdAp;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("crnt_gen_expn_apsts_cd_rj", getCrntGenExpnApstsCdRj());
		...
		this.hashColumns.put("crnt_gen_expn_apsts_cd_ap", getCrntGenExpnApstsCdAp());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("crnt_gen_expn_apsts_cd_rj", "crntGenExpnApstsCdRj");
		...
		this.hashFields.put("crnt_gen_expn_apsts_cd_ap", "crntGenExpnApstsCdAp");
	...
	/**
	 * Column Info
	 * @return crntGenExpnApstsCdRj
	 */
	public String getCrntGenExpnApstsCdRj() {
		return this.crntGenExpnApstsCdRj;
	}
	...
	/**
	 * Column Info
	 * @return crntGenExpnApstsCdAp
	 */
	public String getCrntGenExpnApstsCdAp() {
		return this.crntGenExpnApstsCdAp;
	}
	...
	/**
	 * Column Info
	 * @param crntGenExpnApstsCdRj
	 */
	public void setCrntGenExpnApstsCdRj(String crntGenExpnApstsCdRj) {
		this.crntGenExpnApstsCdRj = crntGenExpnApstsCdRj;
	}
	 ...
	 */
	public void setCrntGenExpnApstsCdAp(String crntGenExpnApstsCdAp) {
		this.crntGenExpnApstsCdAp = crntGenExpnApstsCdAp;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCrntGenExpnApstsCdRj(JSPUtil.getParameter(request, "crnt_gen_expn_apsts_cd_rj", ""));
		...
		setCrntGenExpnApstsCdAp(JSPUtil.getParameter(request, "crnt_gen_expn_apsts_cd_ap", ""));
	 ...
	 */
	public PlanningStatusVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PlanningStatusVO[]
	 */
	public PlanningStatusVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PlanningStatusVO model = null;
		...
		try {
			...
			String[] crntGenExpnApstsCdRj = (JSPUtil.getParameter(request, prefix	+ "crnt_gen_expn_apsts_cd_rj", length));
			...
			String[] crntGenExpnApstsCdAp = (JSPUtil.getParameter(request, prefix	+ "crnt_gen_expn_apsts_cd_ap", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (crntGenExpnApstsCdRj[i] != null)
					model.setCrntGenExpnApstsCdRj(crntGenExpnApstsCdRj[i]);
				if (creDt[i] != null)
				...
				if (crntGenExpnApstsCdAp[i] != null)
					model.setCrntGenExpnApstsCdAp(crntGenExpnApstsCdAp[i]);
				if (reqUpdDt[i] != null)
	 ...
	 * @return PlanningStatusVO[]
	 */
	public PlanningStatusVO[] getPlanningStatusVOs(){
		PlanningStatusVO[] vos = (PlanningStatusVO[])models.toArray(new PlanningStatusVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.crntGenExpnApstsCdRj = this.crntGenExpnApstsCdRj .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.crntGenExpnApstsCdAp = this.crntGenExpnApstsCdAp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
