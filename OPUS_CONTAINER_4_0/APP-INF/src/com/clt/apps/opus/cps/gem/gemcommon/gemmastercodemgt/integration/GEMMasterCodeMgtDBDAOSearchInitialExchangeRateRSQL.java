...
public class GEMMasterCodeMgtDBDAOSearchInitialExchangeRateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 일반관리비 비용계획시 사용할 계획 환율 정보
	  * </pre>
	  */
	public GEMMasterCodeMgtDBDAOSearchInitialExchangeRateRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : GEMMasterCodeMgtDBDAOSearchInitialExchangeRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}