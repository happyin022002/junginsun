...
public class ClaimMainDBDAOSearchImpendingTBIndemnityClaimListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        WHERE" ).append("\n"); 
		query.append("            (" ).append("\n"); 
		query.append("                B.TM_BAR_DT   >= TO_CHAR (CNI_GET_GMT_FNC (@[usr_id]), 'YYYYMMDD')" ).append("\n"); 
		query.append("                AND B.TM_BAR_DT <= TO_CHAR (CNI_GET_GMT_FNC (@[usr_id]) + INTERVAL '15' DAY, 'YYYYMMDD')" ).append("\n"); 
		query.append("            )" ).append("\n"); 
