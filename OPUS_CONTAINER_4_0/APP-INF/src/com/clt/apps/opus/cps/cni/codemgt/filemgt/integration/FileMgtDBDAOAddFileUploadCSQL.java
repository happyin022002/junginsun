...
*@FileName : FileMgtDBDAOAddFileUploadCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FileMgtDBDAOAddFileUploadCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FileMgtDBDAOAddFileUploadCSQL(){
		setQuery();
		...
		query.append("FileName : FileMgtDBDAOAddFileUploadCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		 COM_UPLD_FILE" ).append("\n"); 
