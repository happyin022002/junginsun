...
*@FileName : CPS_GEM_0012HTMLAction.java
...
public class CPS_GEM_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0012HTMLAction 객체를 생성
	 */
	public CPS_GEM_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0012Event event = new CpsGem0012Event();
		
		if(command.isCommand(FormCommand.SEARCH)||
		   command.isCommand(FormCommand.SEARCHLIST)) {
			
			event.setGemXchRtVO((GemXchRtVO)getVO(request, GemXchRtVO .class));
		}
