...
import com.clt.apps.opus.cps.cni.insurance.vesselstatus.integration.VesselStatusDBDAO;
...
/**
 * OPUS-Vessel Status Entry Business Logic Command Interface<br>
 * - OPUS-Vessel Status Entry에 대한 비지니스 로직에 대한 인터페이스<br>
 *
 * @author Yoon, Seyeong
