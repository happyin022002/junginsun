...
*@FileName : GemCngOfcVO.java
*@FileTitle : GemCngOfcVO
*Open Issues :
*Change history :
...
public class GemCngOfcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<GemCngOfcVO> models = new ArrayList<GemCngOfcVO>();
	...
	public GemCngOfcVO(String ibflag, String pagerows, String ofcCd, String cngOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String ofcCngRmk) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setOfcCngRmk(JSPUtil.getParameter(request, "ofc_cng_rmk", ""));
	 ...
	 * @return GemCngOfcVO[]
	 */
	public GemCngOfcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return GemCngOfcVO[]
	 */
	public GemCngOfcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		GemCngOfcVO model = null;
	...
	public GemCngOfcVO[] getGemCngOfcVOs(){
		GemCngOfcVO[] vos = (GemCngOfcVO[])models.toArray(new GemCngOfcVO[models.size()]);
		return vos;
	}
