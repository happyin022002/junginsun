...
public class ContainerCargoClaimReportDBDAOSearchOccurrenceAnalysisByHofcRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("                  , COUNT (DECODE (CGO_CLM_TP_CD, 'PHY', CGO_CLM_NO))    AS CASE1                  " ).append("\n"); 
		query.append("				  , SUM (DECODE (CGO_CLM_TP_CD, 'PHY', CLMT_USD_AMT))    AS AMT1 " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                  , COUNT (DECODE (CGO_CLM_TP_CD, 'WET', CGO_CLM_NO))    AS CASE2                  " ).append("\n"); 
		query.append("				  , SUM (DECODE (CGO_CLM_TP_CD, 'WET', CLMT_USD_AMT))    AS AMT2  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                  , COUNT (DECODE (CGO_CLM_TP_CD, 'STG', CGO_CLM_NO))    AS CASE3                  " ).append("\n"); 
		query.append("				  , SUM (DECODE (CGO_CLM_TP_CD, 'STG', CLMT_USD_AMT))    AS AMT3" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                  , COUNT (DECODE (CGO_CLM_TP_CD, 'NDL', CGO_CLM_NO))    AS CASE4                 " ).append("\n"); 
		query.append("				  , SUM (DECODE (CGO_CLM_TP_CD, 'NDL', CLMT_USD_AMT))    AS AMT4  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                  , COUNT (DECODE (CGO_CLM_TP_CD, 'RDL', CGO_CLM_NO))    AS CASE5                  " ).append("\n"); 
		query.append("				  , SUM (DECODE (CGO_CLM_TP_CD, 'RDL', CLMT_USD_AMT))    AS AMT5" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                  , COUNT (DECODE (CGO_CLM_TP_CD, 'OTR', CGO_CLM_NO))    AS CASE6                  " ).append("\n"); 
		query.append("				  , SUM (DECODE (CGO_CLM_TP_CD, 'OTR', CLMT_USD_AMT))    AS AMT6     " ).append("\n"); 
		query.append("                                    " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                FROM" ).append("\n"); 
