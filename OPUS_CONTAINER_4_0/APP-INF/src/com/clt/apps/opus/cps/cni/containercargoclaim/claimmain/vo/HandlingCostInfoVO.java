...
public class HandlingCostInfoVO	extends	 AbstractValueObject
{
	...
	public HandlingCostInfoVO(String cgoClmStlXchRt,String clmtLoclXchRt,String cgoClmStlDt,String cgoClmStlLoclAmt,String csClzDt,String clmtLoclAmt,String fmalClmRcvDt,String smnsSveDt,String clmStlAuthNo,String clmtLoclCurrCd,String ptyNm,String hdlrUsrId,String pagerows,String clmMiscNm,String cgoClmStlLoclCurrCd,String ibflag,String cgoClmStlTpCd,String cgoClmStsCd,String clmtUsdAmt,String cgoClmStlUsdAmt,String cgoClmNo,String prlmClmNtcDt,String hdlrOfcCd,String clmAreaCd,String cgoClmPayNo,String vndrSeq)	{
 ...
 //	Getters	and	Setters
	...
	*/
	...
	public HandlingCostInfoVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				String[] cgoClmStlXchRt =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_stl_xch_rt".trim(),	length));
				String[] clmtLoclXchRt =	(JSPUtil.getParameter(request, prefix +	"clmt_locl_xch_rt".trim(),	length));
				String[] cgoClmStlDt =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_stl_dt".trim(),	length));
				String[] cgoClmStlLoclAmt =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_stl_locl_amt".trim(),	length));
				String[] csClzDt =	(JSPUtil.getParameter(request, prefix +	"cs_clz_dt".trim(),	length));
				String[] clmtLoclAmt =	(JSPUtil.getParameter(request, prefix +	"clmt_locl_amt".trim(),	length));
				String[] fmalClmRcvDt =	(JSPUtil.getParameter(request, prefix +	"fmal_clm_rcv_dt".trim(),	length));
				String[] smnsSveDt =	(JSPUtil.getParameter(request, prefix +	"smns_sve_dt".trim(),	length));
				String[] clmStlAuthNo =	(JSPUtil.getParameter(request, prefix +	"clm_stl_auth_no".trim(),	length));
				String[] clmtLoclCurrCd =	(JSPUtil.getParameter(request, prefix +	"clmt_locl_curr_cd".trim(),	length));
				String[] ptyNm =	(JSPUtil.getParameter(request, prefix +	"pty_nm".trim(),	length));
				String[] hdlrUsrId =	(JSPUtil.getParameter(request, prefix +	"hdlr_usr_id".trim(),	length));
				String[] pagerows =	(JSPUtil.getParameter(request, prefix +	"pagerows".trim(),	length));
				String[] clmMiscNm =	(JSPUtil.getParameter(request, prefix +	"clm_misc_nm".trim(),	length));
				String[] cgoClmStlLoclCurrCd =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_stl_locl_curr_cd".trim(),	length));
				String[] ibflag =	(JSPUtil.getParameter(request, prefix +	"ibflag".trim(),	length));
				String[] cgoClmStlTpCd =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_stl_tp_cd".trim(),	length));
				String[] cgoClmStsCd =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_sts_cd".trim(),	length));
				String[] clmtUsdAmt =	(JSPUtil.getParameter(request, prefix +	"clmt_usd_amt".trim(),	length));
				String[] cgoClmStlUsdAmt =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_stl_usd_amt".trim(),	length));
				String[] cgoClmNo =	(JSPUtil.getParameter(request, prefix +	"cgo_clm_no".trim(),	length));
				String[] prlmClmNtcDt =	(JSPUtil.getParameter(request, prefix +	"prlm_clm_ntc_dt".trim(),	length));
				String[] hdlrOfcCd =	(JSPUtil.getParameter(request, prefix +	"hdlr_ofc_cd".trim(),	length));
				String[] clmAreaCd =	(JSPUtil.getParameter(request, prefix +	"clm_area_cd".trim(),	length));
