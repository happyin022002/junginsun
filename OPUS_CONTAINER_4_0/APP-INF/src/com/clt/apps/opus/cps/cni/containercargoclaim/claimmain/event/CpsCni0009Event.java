...
public class CpsCni0009Event extends EventSupport {
	...
	public CniCgoClmCostVO[] getCniCgoClmCostVOs() {
		CniCgoClmCostVO[] rtnVOs = null;
		if (this.cniCgoClmCostVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(cniCgoClmCostVOs, cniCgoClmCostVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setCniCgoClmCostVOs(CniCgoClmCostVO[] cniCgoClmCostVOs){
		if(cniCgoClmCostVOs != null){
			CniCgoClmCostVO[] tmpVOs = java.util.Arrays.copyOf(cniCgoClmCostVOs, cniCgoClmCostVOs.length);
			this.cniCgoClmCostVOs = tmpVOs;
		}
	}
