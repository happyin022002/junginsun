...
import com.clt.apps.opus.cps.cni.containercargoclaim.incidentsurvey.integration.IncidentSurveyDBDAO;
...
/**
 * OPUS-GEMCommon Business Logic Basic Command implementation<br>
 * - OPUS-GEMCommon에 대한 비지니스 로직을 처리한다.<br>
 * 
 * @author choijungmi
