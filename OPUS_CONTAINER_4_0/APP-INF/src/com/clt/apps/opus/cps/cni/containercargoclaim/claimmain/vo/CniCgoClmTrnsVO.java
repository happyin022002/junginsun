...
*@FileName : CniCgoClmTrnsVO.java
*@FileTitle : CniCgoClmTrnsVO
*Open Issues :
*Change history :
...
public class CniCgoClmTrnsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CniCgoClmTrnsVO> models = new ArrayList<CniCgoClmTrnsVO>();
	...
	public CniCgoClmTrnsVO() {}

	public CniCgoClmTrnsVO(String ibflag, String pagerows, String cgoClmNo, String trnsSeq, String trnsOfcCd, String trnsUsrId, String trnsFmOfcCd, String trnsFmUsrId, String trnsFmDt, String clmTrnsAuthCd, String trnsToOfcCd, String trnsToUsrId, String trnsToDt, String trnsRmk, String trnsKnt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTrnsFmOfcCd(JSPUtil.getParameter(request, "trns_fm_ofc_cd", ""));
		setTrnsUsrId(JSPUtil.getParameter(request, "trns_usr_id", ""));
		setTrnsFmDt(JSPUtil.getParameter(request, "trns_fm_dt", ""));
		setTrnsToUsrId(JSPUtil.getParameter(request, "trns_to_usr_id", ""));
		setTrnsKnt(JSPUtil.getParameter(request, "trns_knt", ""));
		setTrnsSeq(JSPUtil.getParameter(request, "trns_seq", ""));
		setClmTrnsAuthCd(JSPUtil.getParameter(request, "clm_trns_auth_cd", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setTrnsRmk(JSPUtil.getParameter(request, "trns_rmk", ""));
		setTrnsFmUsrId(JSPUtil.getParameter(request, "trns_fm_usr_id", ""));
		setTrnsToDt(JSPUtil.getParameter(request, "trns_to_dt", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setCgoClmNo(JSPUtil.getParameter(request, "cgo_clm_no", ""));
		setTrnsToOfcCd(JSPUtil.getParameter(request, "trns_to_ofc_cd", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setTrnsOfcCd(JSPUtil.getParameter(request, "trns_ofc_cd", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return CniCgoClmTrnsVO[]
	 */
	public CniCgoClmTrnsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CniCgoClmTrnsVO[]
	 */
	public CniCgoClmTrnsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CniCgoClmTrnsVO model = null;
	...
	public CniCgoClmTrnsVO[] getCniCgoClmTrnsVOs(){
		CniCgoClmTrnsVO[] vos = (CniCgoClmTrnsVO[])models.toArray(new CniCgoClmTrnsVO[models.size()]);
		return vos;
	}
