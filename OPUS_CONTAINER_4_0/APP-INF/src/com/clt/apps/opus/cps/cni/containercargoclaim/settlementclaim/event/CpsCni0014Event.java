...
public class CpsCni0014Event extends EventSupport {
    ...
    private ApplicationStatusVO applicationStatusVO;

	public ApplicationStatusVO getApplicationStatusVO() {
		return applicationStatusVO;
	}

	public void setApplicationStatusVO(ApplicationStatusVO applicationStatusVO) {
