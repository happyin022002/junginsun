...
*@FileName : CniClassCodeVO.java
*@FileTitle : CniClassCodeVO
*Open Issues :
*Change history :
...
public class CniClassCodeVO extends AbstractValueObject {
	...
	public CniClassCodeVO() {}

	public CniClassCodeVO(String ibflag, String pagerows, String clssClmMiscCd, String clssClmMiscNm, String clssClmMiscAbbrNm, String clssClmMiscRmk, String creOfcCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
