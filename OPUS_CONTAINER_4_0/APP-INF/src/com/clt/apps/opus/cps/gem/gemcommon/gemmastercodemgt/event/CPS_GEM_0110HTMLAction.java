...
*@FileName : CPS_GEM_0110HTMLAction.java
...
public class CPS_GEM_0110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0110HTMLAction 객체를 생성
	 */
	public CPS_GEM_0110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0110Event event = new CpsGem0110Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			String matrixDiv = JSPUtil.getParameter(request, "matrix_div");
			String fromOfcCd = JSPUtil.getParameter(request, "from_ofc_cd");
			String toOfcCd = JSPUtil.getParameter(request, "to_ofc_cd");
						
			event.setMatrixDiv(matrixDiv);
			event.setFromOfcCd(fromOfcCd);
			event.setToOfcCd(toOfcCd);
		}
