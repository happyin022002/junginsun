...
*@FileName : GEMPlanningPerformanceDBDAOModifyExpenseApprovalStepUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOModifyExpenseApprovalStepUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOModifyExpenseApprovalStepUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${apro_opin_rmk} != '')" ).append("\n"); 
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOModifyExpenseApprovalStepUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}