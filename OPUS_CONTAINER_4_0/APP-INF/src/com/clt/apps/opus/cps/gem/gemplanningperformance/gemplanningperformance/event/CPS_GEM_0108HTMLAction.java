...
*@FileName : CPS_GEM_0108HTMLAction.java
 ...
 * @see CpsGem0108Event 참조
 * @since J2EE 1.4
 */

public class CPS_GEM_0108HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0108HTMLAction 객체를 생성
	 */
	public CPS_GEM_0108HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsGem0108Event로 파싱하여 request에 셋팅<br>
