...
*@FileName : CPS_CNI_0035HTMLAction.java
*@FileTitle : View-IndemnityClaim
*Open Issues :
*Change history :
...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.cps.cni.containercargoclaim.indemnityclaim.event;
 ...
 * HTTP Parser<br>
 * @author 박제성
 * @see CpsCni0035Event 참조
 * @since J2EE 1.4
 */

public class CPS_CNI_0035HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_CNI_0035HTMLAction 객체를 생성
	 */
	public CPS_CNI_0035HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsCni0035Event로 파싱하여 request에 셋팅<br>
