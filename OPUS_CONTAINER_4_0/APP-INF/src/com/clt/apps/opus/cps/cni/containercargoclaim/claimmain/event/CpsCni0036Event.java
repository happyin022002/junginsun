 ...
 * @author 양정란 
 * @see CPS_CNI_0036HTMLAction 참조
 * @since J2EE 1.4
 */

public class CpsCni0036Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
    public TransferVO[] getTransferVOs() {
		TransferVO[] rtnVOs = null;
		if (this.transferVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(transferVOs, transferVOs.length);
		}
		return rtnVOs;
	}
	public void setTransferVOs(TransferVO[] transferVOs){
		if(transferVOs != null){
			TransferVO[] tmpVOs = java.util.Arrays.copyOf(transferVOs, transferVOs.length);
			this.transferVOs = tmpVOs;
		}
	}
