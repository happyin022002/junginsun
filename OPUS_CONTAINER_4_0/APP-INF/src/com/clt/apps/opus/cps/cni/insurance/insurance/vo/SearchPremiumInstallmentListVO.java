...
*@FileName : SearchPremiumInstallmentListVO.java
*@FileTitle : SearchPremiumInstallmentListVO
*Open Issues :
*Change history :
...
public class SearchPremiumInstallmentListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchPremiumInstallmentListVO> models = new ArrayList<SearchPremiumInstallmentListVO>();
	...
	public SearchPremiumInstallmentListVO() {}

	public SearchPremiumInstallmentListVO(String ibflag, String pagerows, String insurTpCd, String insurPlcyYr, String insurClmPtyNo, String insurPrmTpCd, String instSeq, String instLoclAmt, String instCurrCd, String instXchRt, String instUsdAmt, String instDueDt, String instPayDt) {
	 ...
	 */
	public SearchPremiumInstallmentListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchPremiumInstallmentListVO[]
	 */
	public SearchPremiumInstallmentListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchPremiumInstallmentListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchPremiumInstallmentListVO();
				if (insurTpCd[i] != null)
		...
		return getSearchPremiumInstallmentListVOs();
	}
	 ...
	 * @return SearchPremiumInstallmentListVO[]
	 */
	public SearchPremiumInstallmentListVO[] getSearchPremiumInstallmentListVOs(){
		SearchPremiumInstallmentListVO[] vos = (SearchPremiumInstallmentListVO[])models.toArray(new SearchPremiumInstallmentListVO[models.size()]);
		return vos;
	}
