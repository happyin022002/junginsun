 ...
 * HTTP Parser<br>
 * @author 진윤ㅇ
 * @see CpsCni0023Event 참조
 * @since J2EE 1.4
 */

public class CPS_CNI_0023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_CNI_0023HTMLAction 객체를 생성
	 */
	public CPS_CNI_0023HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsCni0023Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		CpsCni0023Event event = new CpsCni0023Event();
		
		// ----------------------------------------------------
		// 공통화면 정보 설정 
		// ----------------------------------------------------
		CniClmPrveVO cniClmPrveVO = (CniClmPrveVO)getVO(request, CniClmPrveVO.class);			
		event.setCniClmPrveVO(cniClmPrveVO);		
