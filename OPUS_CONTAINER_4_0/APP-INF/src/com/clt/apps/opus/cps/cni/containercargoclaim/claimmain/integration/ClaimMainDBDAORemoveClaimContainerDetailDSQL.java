...
*@FileName : ClaimMainDBDAORemoveClaimContainerDetailDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAORemoveClaimContainerDetailDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ClaimContainerDetail 삭제
	  * </pre>
	  */
	public ClaimMainDBDAORemoveClaimContainerDetailDSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAORemoveClaimContainerDetailDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CNI_CGO_CLM_CNTR_DTL" ).append("\n"); 
