...
*@FileName : ClaimMainDBDAOSearchContractCarriageExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAOSearchContractCarriageExistRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ContractCarriage 입력수정결정
	  * </pre>
	  */
	public ClaimMainDBDAOSearchContractCarriageExistRSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAOSearchContractCarriageExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM" ).append("\n"); 
		query.append("CNI_CGO_CLM_CTRT" ).append("\n"); 
		query.append("WHERE" ).append("\n"); 
		query.append("CGO_CLM_NO = @[cgo_clm_no]" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(", ' ')" ).append("\n"); 
