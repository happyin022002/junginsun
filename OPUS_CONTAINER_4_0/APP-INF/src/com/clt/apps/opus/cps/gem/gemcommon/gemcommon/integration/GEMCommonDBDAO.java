...
import com.clt.apps.opus.cps.gem.gemcommon.gemcommon.vo.SlipPerfVO;
import com.clt.apps.opus.cps.gem.gemcommon.gemcommon.vo.SumGenExpnAmtVO;
import com.clt.apps.opus.cps.gem.gemcommon.gemcommon.vo.SumSlipPerfAmtVO;
import com.clt.apps.opus.cps.gem.gemcommon.gemmastercodemgt.integration.GEMMasterCodeMgtDBDAOAddInitialExchangeRateInfoCSQL;
import com.clt.apps.opus.cps.gem.gemcommon.gemmastercodemgt.integration.GEMMasterCodeMgtDBDAOSearchAccountListRSQL;
import com.clt.apps.opus.cps.gem.gemcommon.gemmastercodemgt.integration.GEMMasterCodeMgtDBDAOSearchExpenseListRSQL;
import com.clt.apps.opus.cps.gem.gemcommon.gemmastercodemgt.integration.GEMMasterCodeMgtDBDAOSearchGroupListByExpenseRSQL;
import com.clt.apps.opus.cps.gem.gemcommon.gemmastercodemgt.integration.GEMMasterCodeMgtDBDAOSearchSumUpListByOfficeRSQL;
...
public class GEMCommonDBDAO extends DBDAOSupport {
	...
	/**
	 * 로그인 사용자 권한에 따른 조회 가능한 비용 정보 취득
	 * 
	 * @author j.y.o
	 * @category searchOfficeByRole 
	 * @param String gemExpnGrpCd1
	 * @param String genExpnCd
	 * @param String ofcCd 
	 * @return String[]
	 * @throws DAOException
	 */
	public String[] searchExpenseCdByRole(String gemExpnGrpCd1, String genExpnCd , String ofcCd ) throws DAOException {
		...
		try {
			param.put("gem_expn_grp_cd1", gemExpnGrpCd1);
