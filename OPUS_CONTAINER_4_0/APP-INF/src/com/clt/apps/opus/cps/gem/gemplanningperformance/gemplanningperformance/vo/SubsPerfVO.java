...
public class SubsPerfVO extends AbstractValueObject {
	...
	public SubsPerfVO(String ibflag, String pagerows, String rsltYrmon, String ofcCd, String genExpnCd, String loclCurrCd, String rqstUtVal, String abbrNm, String perfAmt, String genExpnAmt, String slpPerfAmt, String ratio, String genExpnOvrRtoRsn, String creDt, String creUsrId, String updUsrId, String slpPerfAmt01) {
	...
	public SubsPerfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] slpPerfAmt01 = (JSPUtil.getParameter(request, prefix	+ "slp_perf_amt01".trim(), length));
