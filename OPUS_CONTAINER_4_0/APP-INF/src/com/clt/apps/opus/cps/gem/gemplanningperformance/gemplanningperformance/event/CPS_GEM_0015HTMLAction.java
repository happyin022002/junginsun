...
public class CPS_GEM_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0015HTMLAction 객체를 생성
	 */
	public CPS_GEM_0015HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsGem0015Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0015Event event = new CpsGem0015Event();		
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {	
			...
			event.setRatioReasonVOs((RatioReasonVO[])getVOs(request, RatioReasonVO .class,""));
		}
