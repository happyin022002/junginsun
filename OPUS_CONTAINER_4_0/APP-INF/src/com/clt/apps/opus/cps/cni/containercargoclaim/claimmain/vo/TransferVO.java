...
public class TransferVO extends AbstractValueObject {
	...
	/* Column Info */
	private String trnsAreaCd = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("trns_area_cd", getTrnsAreaCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("trns_area_cd", "trnsAreaCd");
	 ...
	 * @return trnsAreaCd
	 */
	public String getTrnsAreaCd() {
		return this.trnsAreaCd;
	}
	 ...
	 * @param trnsAreaCd
	 */
	public void setTrnsAreaCd(String trnsAreaCd) {
		this.trnsAreaCd = trnsAreaCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTrnsAreaCd(JSPUtil.getParameter(request, prefix + "trns_area_cd", ""));
	...
	public TransferVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] trnsAreaCd = (JSPUtil.getParameter(request, prefix	+ "trns_area_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (div[i] != null)
					model.setDiv(div[i]);
				if (trnsAreaCd[i] != null)
					model.setTrnsAreaCd(trnsAreaCd[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.trnsAreaCd = this.trnsAreaCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
