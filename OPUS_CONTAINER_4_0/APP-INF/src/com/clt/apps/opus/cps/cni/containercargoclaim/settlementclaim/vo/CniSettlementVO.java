...
*@FileName : CniSettlementVO.java
*@FileTitle : CniSettlementVO
*Open Issues :
*Change history :
...
public class CniSettlementVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CniSettlementVO> models = new ArrayList<CniSettlementVO>();
...
/**
	 ...
	 */
	public CniSettlementVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CniSettlementVO[]
	 */
	public CniSettlementVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CniSettlementVO model = null;
	 ...
	 * @return CniSettlementVO[]
	 */
	public CniSettlementVO[] getCniSettlementVOs(){
		CniSettlementVO[] vos = (CniSettlementVO[])models.toArray(new CniSettlementVO[models.size()]);
		return vos;
	}
