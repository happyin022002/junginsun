...
public class PaymentInvoiceDBDAOSearchCostOfcCdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     DECODE (OFC_KND_CD, '2', DECODE (OFC_TP_CD, 'HQ', AR_HD_QTR_OFC_CD, DECODE (OFC_CD, 'SINHO', AR_HD_QTR_OFC_CD, AP_OFC_CD)), DECODE (OFC_CD, 'SINHO', AR_HD_QTR_OFC_CD, AP_OFC_CD)) AS COST_OFC_CD" ).append("\n"); 
