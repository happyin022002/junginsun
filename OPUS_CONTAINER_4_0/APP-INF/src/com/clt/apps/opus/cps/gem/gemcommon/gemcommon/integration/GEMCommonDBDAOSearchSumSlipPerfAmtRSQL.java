...
*@FileName : GEMCommonDBDAOSearchSumSlipPerfAmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMCommonDBDAOSearchSumSlipPerfAmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMCommonDBDAOSearchSumSlipPerfAmtRSQL(){
		setQuery();
		...
		query.append("FileName : GEMCommonDBDAOSearchSumSlipPerfAmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  , SUM (SLP_PERF_AMT) SUM_SLP_PERF_AMT" ).append("\n"); 
