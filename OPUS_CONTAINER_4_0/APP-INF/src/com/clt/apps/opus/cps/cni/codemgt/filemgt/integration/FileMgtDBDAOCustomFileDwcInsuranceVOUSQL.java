...
*@FileName : FileMgtDBDAOCustomFileDwcInsuranceVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FileMgtDBDAOCustomFileDwcInsuranceVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FileMgtDBDAOCustomFileDwcInsuranceVOUSQL(){
		setQuery();
		...
		query.append("FileName : FileMgtDBDAOCustomFileDwcInsuranceVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
