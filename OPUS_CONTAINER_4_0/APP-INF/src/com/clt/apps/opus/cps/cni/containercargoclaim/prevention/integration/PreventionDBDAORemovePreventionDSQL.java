...
*@FileName : PreventionDBDAORemovePreventionDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PreventionDBDAORemovePreventionDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PreventionDBDAORemovePreventionDSQL(){
		setQuery();
		...
		query.append("FileName : PreventionDBDAORemovePreventionDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CNI_CLM_PRVE" ).append("\n"); 
