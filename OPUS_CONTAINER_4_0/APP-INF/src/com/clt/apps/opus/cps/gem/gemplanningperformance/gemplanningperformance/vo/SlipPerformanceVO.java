...
public class SlipPerformanceVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSlpAmt1(JSPUtil.getParameter(request, "slp_amt1", ""));
		setSlpCurrCd(JSPUtil.getParameter(request, "slp_curr_cd", ""));
		setSlpDesc(JSPUtil.getParameter(request, "slp_desc", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setSlpSeqNo1(JSPUtil.getParameter(request, "slp_seq_no1", ""));
		setChaRatio1(JSPUtil.getParameter(request, "cha_ratio1", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setSlpVndrCd(JSPUtil.getParameter(request, "slp_vndr_cd", ""));
		setAcctCd(JSPUtil.getParameter(request, "acct_cd", ""));
		setSlpTjNo1(JSPUtil.getParameter(request, "slp_tj_no1", ""));
		...
		setTicCd1(JSPUtil.getParameter(request, "tic_cd1", ""));
		...
		setGlEffDt1(JSPUtil.getParameter(request, "gl_eff_dt1", ""));
		setSubGenExpnCd(JSPUtil.getParameter(request, "sub_gen_expn_cd", ""));
		setChaRatio(JSPUtil.getParameter(request, "cha_ratio", ""));
		setOfcCd(JSPUtil.getParameter(request, "ofc_cd", ""));
		setSubAbbrNm(JSPUtil.getParameter(request, "sub_abbr_nm", ""));
		setRatio(JSPUtil.getParameter(request, "ratio", ""));
		setSlpDesc1(JSPUtil.getParameter(request, "slp_desc1", ""));
		setSlpCurrCd1(JSPUtil.getParameter(request, "slp_curr_cd1", ""));
