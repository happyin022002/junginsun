...
*@FileName : CsrManagerListVO.java
*@FileTitle : CsrManagerListVO
*Open Issues :
*Change history :
...
public class CsrManagerListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsrManagerListVO> models = new ArrayList<CsrManagerListVO>();
	...
	public CsrManagerListVO() {}

	public CsrManagerListVO(String ibflag, String pagerows, String ifDt, String csrNo, String invDesc, String csrCurrCd, String csrAmt, String dueDt, String ifStatus, String attrCtnt2, String ifErrRsn, String vndrNo, String vndrTermNm, String aftActFlg, String invIssDt, String invRcvDt, String noOfInv, String ifFlg, String rcvErrFlg, String aproRqstNo, String payGrpLuCd, String costOfcCd, String fmEffDt, String toEffDt, String searchCsrNo, String dtStatus, String ofcCd, String updUsrId, String invStsCd, String invSubSysCd, String clmAreaCd, String invOfcCd) {
		this.ifDt = ifDt;
...
/**
	 ...
	 * @param request
	 * @return CsrManagerListVO[]
	 */
	public CsrManagerListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsrManagerListVO[]
	 */
	public CsrManagerListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsrManagerListVO model = null;
	 ...
	 * @return CsrManagerListVO[]
	 */
	public CsrManagerListVO[] getCsrManagerListVOs(){
		CsrManagerListVO[] vos = (CsrManagerListVO[])models.toArray(new CsrManagerListVO[models.size()]);
		return vos;
	}
