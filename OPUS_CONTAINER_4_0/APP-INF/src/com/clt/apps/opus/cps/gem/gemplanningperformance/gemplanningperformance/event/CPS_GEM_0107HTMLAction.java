...
*@FileName : CPS_GEM_0107HTMLAction.java
*@FileTitle : Performance Inquiry_Transfer
*Open Issues :
*Change history :
...
/**
 * [CPS_GEM-0107] Performance Inquiry_Transfer
 * HTTP Parser<br>
 ...
 * @see CpsGem0107Event 참조
 * @since J2EE 1.4
 */

public class CPS_GEM_0107HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0107HTMLAction 객체를 생성
	 */
	public CPS_GEM_0107HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsGem0107Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0108Event event = new CpsGem0108Event();		
		
		//[Retrieve]
		if(command.isCommand(FormCommand.SEARCH)) {	
			
			PerfInqVO dto = (PerfInqVO)getVO(request, PerfInqVO .class);
			event.setPerfInqVO(dto);
