...
*@FileName : GEMPlanningPerformanceDBDAOAddSubsidiaryActualResultsCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOAddSubsidiaryActualResultsCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOAddSubsidiaryActualResultsCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOAddSubsidiaryActualResultsCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}