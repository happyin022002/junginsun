...
*@FileName : DryWetClaimDBDAOSearchCurrencyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DryWetClaimDBDAOSearchCurrencyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DryWetClaimDBDAOSearchCurrencyRSQL(){
		setQuery();
		...
		query.append("FileName : DryWetClaimDBDAOSearchCurrencyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
