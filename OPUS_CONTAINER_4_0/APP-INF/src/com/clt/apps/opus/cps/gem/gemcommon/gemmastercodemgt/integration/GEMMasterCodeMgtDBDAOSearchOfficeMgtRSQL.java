...
*@FileName : GEMMasterCodeMgtDBDAOSearchOfficeMgtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMMasterCodeMgtDBDAOSearchOfficeMgtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMMasterCodeMgtDBDAOSearchOfficeMgtRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : GEMMasterCodeMgtDBDAOSearchOfficeMgtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}