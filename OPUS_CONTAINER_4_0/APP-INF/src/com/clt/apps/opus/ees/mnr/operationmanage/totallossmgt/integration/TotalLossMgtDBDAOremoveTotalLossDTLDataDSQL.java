...
*@FileName : TotalLossMgtDBDAOremoveTotalLossDTLDataDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class TotalLossMgtDBDAOremoveTotalLossDTLDataDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TotalLossMgtDBDAOremoveTotalLossDTLDataDSQL(){
		setQuery();
		...
		query.append("FileName : TotalLossMgtDBDAOremoveTotalLossDTLDataDSQL").append("\n");
		query.append("*/").append("\n");
	}
