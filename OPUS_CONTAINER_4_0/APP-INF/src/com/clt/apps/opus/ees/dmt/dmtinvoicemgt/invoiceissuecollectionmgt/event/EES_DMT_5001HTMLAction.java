...
*@FileName : EES_DMT_5001HTMLAction.java
...
public class EES_DMT_5001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_5001HTMLAction 객체를 생성
	 */
	public EES_DMT_5001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt5001Event event = new EesDmt5001Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setARInterfaceParmVO((ARInterfaceParmVO)getVO(request, ARInterfaceParmVO .class));
