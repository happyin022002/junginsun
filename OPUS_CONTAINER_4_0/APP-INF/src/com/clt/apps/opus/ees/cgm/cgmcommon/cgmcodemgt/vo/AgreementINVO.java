...
public class AgreementINVO extends AbstractValueObject {
	...
	private Collection<AgreementINVO> models = new ArrayList<AgreementINVO>();
	 ...
	 */
	public AgreementINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AgreementINVO[]
	 */
	public AgreementINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AgreementINVO model = null;
	 ...
	 * @return AgreementINVO[]
	 */
	public AgreementINVO[] getAgreementINVOs(){
		AgreementINVO[] vos = (AgreementINVO[])models.toArray(new AgreementINVO[models.size()]);
		return vos;
	}
