...
*@FileName : CimCommonDBDAOOscarEdiErrorTotalCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CimCommonDBDAOOscarEdiErrorTotalCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CimCommonDBDAOOscarEdiErrorTotalCntRSQL(){
		setQuery();
		...
		query.append("FileName : CimCommonDBDAOOscarEdiErrorTotalCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
