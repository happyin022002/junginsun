...
*@FileName : RepairMgtDBDAOaddRFSpareWOHeaderDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOaddRFSpareWOHeaderDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addRFSpareWOHeaderData
	  * </pre>
	  */
	public RepairMgtDBDAOaddRFSpareWOHeaderDataCSQL(){
		setQuery();
		...
		params.put("spr_prt_brth_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : RepairMgtDBDAOaddRFSpareWOHeaderDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[skd_voy_no]" ).append("\n"); 
		query.append(",	@[skd_dir_cd]" ).append("\n"); 
		query.append(",	TO_DATE(@[spr_prt_brth_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	@[spr_prt_spl_yd_cd]" ).append("\n"); 
		query.append(",	TO_DATE(@[spr_prt_spl_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	@[ord_hdr_rmk]" ).append("\n"); 
		query.append(",	@[file_seq]" ).append("\n"); 
