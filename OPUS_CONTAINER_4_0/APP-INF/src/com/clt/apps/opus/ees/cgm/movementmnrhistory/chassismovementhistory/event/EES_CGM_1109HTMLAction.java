...
public class EES_CGM_1109HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1109HTMLAction 객체를 생성
	 */
	public EES_CGM_1109HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1109Event event = new EesCgm1109Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setCHSmgstChkINVO((CHSmgstChkINVO)getVO(request, CHSmgstChkINVO .class));
		}
