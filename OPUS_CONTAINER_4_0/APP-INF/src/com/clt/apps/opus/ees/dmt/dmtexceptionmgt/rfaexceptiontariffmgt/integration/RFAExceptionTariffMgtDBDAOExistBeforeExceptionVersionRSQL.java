...
*@FileName : RFAExceptionTariffMgtDBDAOExistBeforeExceptionVersionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOExistBeforeExceptionVersionRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Before Exception Request 에 인자로 받은 Version 정보가 존재하는지 조회하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOExistBeforeExceptionVersionRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOExistBeforeExceptionVersionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(RFA_EXPT_VER_SEQ) CNT" ).append("\n"); 
