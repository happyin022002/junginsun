...
*@FileName : EES_LSE_0060HTMLAction.java
...
public class EES_LSE_0060HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0060HTMLAction 객체를 생성
	 */
	public EES_LSE_0060HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0060Event event = new EesLse0060Event();
