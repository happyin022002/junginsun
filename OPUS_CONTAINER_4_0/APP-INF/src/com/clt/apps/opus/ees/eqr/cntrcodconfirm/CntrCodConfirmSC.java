 ...
 *@LastVersion : 1.0
=========================================================*/
package com.clt.apps.opus.ees.eqr.cntrcodconfirm;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.basic.EmptyCODAdjustmentBC;
import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.basic.EmptyCODAdjustmentBCImpl;
import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1054Event;
import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1024Event;
import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1056Event;
import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1023Event;
import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1057Event;
import com.clt.apps.opus.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1021Event;
...
/**
 * OPUS - COD Confirm Business Logic ServiceCommand -
 * 
 * @author 
...
public class CntrCodConfirmSC extends ServiceCommandSupport {
	...
	/**
	 * EQTransportPlanNPerform system <br>
	 */
	public void doStart() {
	 ...
	 */
	public void doEnd() {
		log.debug("CntrCodConfirmSC ");
	}

	/**
	 * OPUS-EQTransportPlanNPerform system <br>
	 * 
	 * @param e Event
	...
	private EventResponse searchMTYREPOByPeriod(Event e) throws EventException {
		log.debug("####### CntrCodConfirmSC.searchMTYREPOByPeriod 1023 ");
	...
	/**
	 * EES_EQR_1024 : [event]<br>
	 * [Confirmation] [delete].<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
	...
	private EventResponse searchVVDInformation(Event e) throws EventException {
		log.debug("####### CntrCodConfirmSC.searchVVDInformation 1024 ");
		// PDTO(Data Transfer Object including Parameters)
	...
	private EventResponse searchYardNETBByVVDPort(Event e) throws EventException {
		log.debug("####### CntrCodConfirmSC.searchYardNETBByVVDPort 1024 ");
		// PDTO(Data Transfer Object including Parameters)
		EesEqr1024Event event = (EesEqr1024Event) e;
