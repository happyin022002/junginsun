...
*@FileName : EES_CTM_0443HTMLAction.java
...
public class EES_CTM_0443HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0443HTMLAction 객체를 생성
	 */
	public EES_CTM_0443HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0443Event event = new EesCtm0443Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCtmCCLMVO((CtmCCLMVO)getVO(request, CtmCCLMVO .class));
		}
