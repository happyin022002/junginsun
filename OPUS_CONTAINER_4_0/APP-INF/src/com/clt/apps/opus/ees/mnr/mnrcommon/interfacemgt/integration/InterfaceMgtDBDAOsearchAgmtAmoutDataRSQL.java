...
*@FileName : InterfaceMgtDBDAOsearchAgmtAmoutDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceMgtDBDAOsearchAgmtAmoutDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InterfaceMgtDBDAOsearchAgmtAmoutDataRSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceMgtDBDAOsearchAgmtAmoutDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT A.COST_CD, A.COST_DTL_CD, A.MNR_RT_TP_CD, A.RPR_QTY, A.AGMT_RT_AMT" ).append("\n"); 
		...
		query.append("#if (${type} == 'A')" ).append("\n"); 
		query.append("   AND A.YD_CD = 'ALL'" ).append("\n"); 
		query.append("#elseif (${type} == 'L')" ).append("\n"); 
		query.append("   AND A.YD_CD = SUBSTR(@[yd_cd], 1, 5)" ).append("\n"); 
		query.append("#elseif (${type} == 'QY')" ).append("\n"); 
		query.append("   AND SUBSTR(A.YD_CD, 1, 5) = @[yd_cd]" ).append("\n"); 
