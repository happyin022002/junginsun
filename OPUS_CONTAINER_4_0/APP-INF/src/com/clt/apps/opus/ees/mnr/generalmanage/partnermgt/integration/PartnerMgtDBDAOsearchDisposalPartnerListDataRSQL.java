...
public class PartnerMgtDBDAOsearchDisposalPartnerListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("             AND MDD.MNR_PRNR_SEQ IS NOT NULL" ).append("\n"); 
		query.append("             AND MDD.MNR_PRNR_CNT_CD =A.MNR_PRNR_CNT_CD" ).append("\n"); 
		query.append("             AND MDD.MNR_PRNR_SEQ =A.MNR_PRNR_SEQ" ).append("\n"); 
		query.append("             AND MDH.DISP_STS_CD NOT IN ('HE','HD')" ).append("\n"); 
		query.append("         ) AS DISP_PROC_CNT" ).append("\n"); 
		...
		query.append("    WHERE  1=1" ).append("\n"); 
		query.append("    AND    MP.MNR_PRNR_CRE_SEQ = MPCP.MNR_PRNR_CRE_SEQ" ).append("\n"); 
		query.append("    AND    MNR_COMMON_PKG.MNR_GET_RHQ_OFC_FNC(MPCP.OFC_CD) = @[user_ofc_cd]" ).append("\n"); 
		query.append(" )" ).append("\n"); 
