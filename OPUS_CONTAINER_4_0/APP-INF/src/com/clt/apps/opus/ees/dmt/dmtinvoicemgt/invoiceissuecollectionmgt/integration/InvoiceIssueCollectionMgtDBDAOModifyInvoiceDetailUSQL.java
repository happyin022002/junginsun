...
public class InvoiceIssueCollectionMgtDBDAOModifyInvoiceDetailUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	,	FM_MVMT_DT = @[fm_mvmt_dt]" ).append("\n"); 
		query.append("	,	TO_MVMT_DT = @[to_mvmt_dt]" ).append("\n"); 
		query.append("	,	FT_CMNC_DT = @[ft_cmnc_dt]" ).append("\n"); 
		query.append("	,	FT_END_DT = @[ft_end_dt]" ).append("\n"); 
