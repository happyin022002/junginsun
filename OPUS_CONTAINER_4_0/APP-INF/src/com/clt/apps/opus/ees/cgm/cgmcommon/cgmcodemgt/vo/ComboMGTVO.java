 ...
 *@FileName : ComboMGTVO.java
 *@FileTitle : ComboMGTVO
 *Open Issues :
 *Change history :
...
public class ComboMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<ComboMGTVO> models = new ArrayList<ComboMGTVO>();
	...
	public ComboMGTVO(String ibflag, String pagerows, String code1, String code2, String code3, String code4, String code5, String code6, String code7, String code8,
			String code9, String desc1, String desc2, String desc3, String desc4, String desc5, String desc6, String desc7, String desc8, String desc9, String vndrSeq,
			String intgCdId, String agmtOfcCtyCd, String agmtSeq, String agmtLstmCd, String chssPoolCd, String eqKndCd, String sccCd, String eqSpecNo, String ofcCd,
			String chssMgstInvKndCd, String costYrmon, String chssPoolNm, String poolMgmtCoCd, String poolMgmtCoNm, String creUsrId, String creDt, String updUsrId,
			String updDt) {
	...
	public Collection<ComboMGTVO> getModels() {
		return models;
	}

	public void setModels(Collection<ComboMGTVO> models) {
		this.models = models;
	}
	 ...
	 * @return ComboMGTVO[]
	 */
	public ComboMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComboMGTVO[]
	 */
	public ComboMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComboMGTVO model = null;
		...
		try {
			...
			String[] poolMgmtCoNm = (JSPUtil.getParameter(request, prefix + "pool_mgmt_co_nm".trim(), length));

			for (int i = 0; i < length; i++) {
				model = new ComboMGTVO();
	...
	public ComboMGTVO[] getComboMGTVOs() {
		ComboMGTVO[] vos = (ComboMGTVO[]) models.toArray(new ComboMGTVO[models.size()]);
		return vos;
	}
