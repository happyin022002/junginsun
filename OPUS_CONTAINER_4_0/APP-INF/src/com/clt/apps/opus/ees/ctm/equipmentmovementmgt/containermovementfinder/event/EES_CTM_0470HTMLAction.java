...
public class EES_CTM_0470HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0408HTMLAction 객체를 생성
	 */
	public EES_CTM_0470HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0470Event event = new EesCtm0470Event();
		...
		if (command.isCommand(FormCommand.SEARCH)) {
			...
			event.setSearchDeletedMVMTListVO((SearchDeletedMVMTListVO)getVO(request, SearchDeletedMVMTListVO.class));
			event.setSearchEdiMsgVO((SearchEdiMsgVO)getVO(request, SearchEdiMsgVO.class));
			
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setSearchMovementListByContainerVO((SearchMovementListByContainerVO)getVO(request, SearchMovementListByContainerVO.class));
			event.setSearchDeletedMVMTListVO((SearchDeletedMVMTListVO)getVO(request, SearchDeletedMVMTListVO.class));
			event.setSearchDeletedMVMTListVOs((SearchDeletedMVMTListVO[])getVOs(request, SearchDeletedMVMTListVO.class,""));
			event.setSearchEdiMsgVO((SearchEdiMsgVO)getVO(request, SearchEdiMsgVO.class));
