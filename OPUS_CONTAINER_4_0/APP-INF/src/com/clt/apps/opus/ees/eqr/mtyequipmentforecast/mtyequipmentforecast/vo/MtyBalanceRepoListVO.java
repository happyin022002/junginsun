...
public class MtyBalanceRepoListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String ordTrspModCd = null;
	/* Column Info */
	...
	public MtyBalanceRepoListVO(String ibflag, String pagerows, String total, String fcastQty7, String fcastQty8, String fcastQty18, String fcastQty5, String fcastQty19, String fcastQty6, String fcastQty3, String fcastQty4, String fcastQty1, String fmYdCd, String fcastQty2, String fcastQty12, String fcastQty13, String fcastQty10, String fcastQty11, String fcastQty16, String fcastQty17, String fcastQty14, String fcastQty9, String fcastQty15, String toYdCd, String trspModCd, String fmEtdDt, String toEtaDt, String ioBndCd, String vvd, String fcastQty20, String lvl, String ordTrspModCd, String vslSlanCd) {
		...
		this.ordTrspModCd = ordTrspModCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ord_trsp_mod_cd", getOrdTrspModCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ord_trsp_mod_cd", "ordTrspModCd");
	 ...
	 * @return ordTrspModCd
	 */
	public String getOrdTrspModCd() {
		return this.ordTrspModCd;
	}
	 ...
	 * @param ordTrspModCd
	 */
	public void setOrdTrspModCd(String ordTrspModCd) {
		this.ordTrspModCd = ordTrspModCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setOrdTrspModCd(JSPUtil.getParameter(request, "ord_trsp_mod_cd", ""));
	...
	public MtyBalanceRepoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ordTrspModCd = (JSPUtil.getParameter(request, prefix	+ "ord_trsp_mod_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ordTrspModCd[i] != null)
					model.setOrdTrspModCd(ordTrspModCd[i]);
				if (ioBndCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.ordTrspModCd = this.ordTrspModCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
