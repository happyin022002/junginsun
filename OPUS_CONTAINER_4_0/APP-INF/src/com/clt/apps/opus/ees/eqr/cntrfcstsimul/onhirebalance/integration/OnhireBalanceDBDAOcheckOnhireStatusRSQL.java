...
*@FileName : OnhireBalanceDBDAOcheckOnhireStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnhireBalanceDBDAOcheckOnhireStatusRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Check duplication of EQR_CTRL_ONH_ORD 
	  * </pre>
	  */
	public OnhireBalanceDBDAOcheckOnhireStatusRSQL(){
		setQuery();
		...
		query.append("FileName : OnhireBalanceDBDAOcheckOnhireStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(1) DUP_CHK " ).append("\n"); 
		query.append("FROM   EQR_CTRL_ONH_ORD" ).append("\n"); 
