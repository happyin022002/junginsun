...
public class VoNameDAOMGSAtdtHistoryVORSQL implements ISQLTemplate{
	...
	public VoNameDAOMGSAtdtHistoryVORSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.cgm.movementmnrhistory.chassismgsetattachdetachhistory.vo").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("'' AS CNTR_NO2" ).append("\n"); 
		query.append(",'' AS ATCH_DT2" ).append("\n"); 
		query.append(",'' AS STATUS" ).append("\n"); 
		query.append(",'' AS ATCH_YD_CD" ).append("\n"); 
		query.append(",'' AS AT" ).append("\n"); 
		...
		query.append(",'' AS DTCH_INP_TP_CD" ).append("\n"); 
		query.append(",'' AS ATCH_INP_TP_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("--,'' AS DTCH_DT" ).append("\n"); 
