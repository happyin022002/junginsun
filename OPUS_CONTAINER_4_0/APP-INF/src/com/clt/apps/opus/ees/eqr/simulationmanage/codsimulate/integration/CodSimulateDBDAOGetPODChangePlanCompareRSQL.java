...
*@FileName : CodSimulateDBDAOGetPODChangePlanCompareRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodSimulateDBDAOGetPODChangePlanCompareRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR PLAN 중에 POD이 변경된 데이터 조회
	  * </pre>
	  */
	public CodSimulateDBDAOGetPODChangePlanCompareRSQL(){
		setQuery();
		...
		query.append("FileName : CodSimulateDBDAOGetPODChangePlanCompareRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("MAX(DECODE(COD_SIM_FLG, 'Y', 'Y' ,'')) TARGETVVD," ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("GROUP BY PLN_YRWK, CO_CD,  VSL_LANE_CD, VVD, TO_ECC_CD, TO_ETB_DT, REPO_PLN_ID ,COD_SIM_FLG" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("GROUP BY PLN_YRWK, CO_CD,  VSL_LANE_CD, VVD, TO_ECC_CD, TO_ETB_DT, REPO_PLN_ID" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("GROUP BY PLN_YRWK , CO_CD,  VSL_LANE_CD,  VVD,  TO_ECC_CD,  TO_ETB_DT" ).append("\n"); 
