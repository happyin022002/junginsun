...
public class RepairMgtDBDAOaddESTWOCreationDetailDataCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , NVL(B.COST_CD, DECODE(@[eq_knd_cd], 'U', DECODE(A.RPR_OFFH_FLG, 'Y', 'MRDRRO', 'MRDRRC'), 'Z', 'MRZSRC', 'G', 'MRGSRC'))" ).append("\n"); 
		query.append("     , MNR_COMMON_PKG.MNR_GET_ACCT_CD_FNC(@[eq_knd_cd], NVL(B.COST_CD, DECODE(@[eq_knd_cd], 'U', 'MRDRRC', 'Z', 'MRZSRC', 'G', 'MRGSRC')), @[eq_tpsz_cd], A.RPR_OFFH_FLG, DECODE(A.RPR_OFFH_FLG, 'Y', 'OF', 'NR')) AS ACCT_CD" ).append("\n"); 
		query.append("     , DECODE(A.RPR_OFFH_FLG, 'Y', 'OF', 'NR') COST_DTL_CD" ).append("\n"); 
		query.append("     , NVL(A.RPR_OFFH_FLG,'N')" ).append("\n"); 
		query.append("     , DECODE(A.RPR_OFFH_FLG, 'Y', 'OF', 'NR') MNR_RT_TP_CD" ).append("\n"); 
		query.append("     , '' MNR_EXPN_DTL_NM" ).append("\n"); 
