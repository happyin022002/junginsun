...
*@FileName : CntrMtyBkgCreateDBDAOsearchRepoPlanIdRRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrMtyBkgCreateDBDAOsearchRepoPlanIdRRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VVD & MT REPO BKG 정보를 통해 해당 REPO Plan ID를 찾는다.
	  * </pre>
	  */
	public CntrMtyBkgCreateDBDAOsearchRepoPlanIdRRSQL(){
		setQuery();
		...
		query.append("FileName : CntrMtyBkgCreateDBDAOsearchRepoPlanIdRRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
