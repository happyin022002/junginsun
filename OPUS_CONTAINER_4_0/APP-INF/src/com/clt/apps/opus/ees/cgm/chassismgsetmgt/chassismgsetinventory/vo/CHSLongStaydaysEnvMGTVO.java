...
*@FileName : CHSLongStaydaysEnvMGTVO.java
*@FileTitle : CHSLongStaydaysEnvMGTVO
*Open Issues :
*Change history :
...
public class CHSLongStaydaysEnvMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSLongStaydaysEnvMGTVO> models = new ArrayList<CHSLongStaydaysEnvMGTVO>();
	...
	public CHSLongStaydaysEnvMGTVO() {}

	public CHSLongStaydaysEnvMGTVO(String ibflag, String pagerows, String stayDysInpUsrId, String n1stInqFmDys, String n1stInqToDys, String n2ndInqFmDys, String n2ndInqToDys, String n3rdInqFmDys, String n3rdInqToDys, String n4thInqFmDys, String n4thInqToDys, String n5thInqFmDys, String n5thInqToDys) {
	 ...
	 */
	public CHSLongStaydaysEnvMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSLongStaydaysEnvMGTVO[]
	 */
	public CHSLongStaydaysEnvMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSLongStaydaysEnvMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSLongStaydaysEnvMGTVO();
		...
		return getCHSLongStaydaysEnvMGTVOs();
	}
	 ...
	 * @return CHSLongStaydaysEnvMGTVO[]
	 */
	public CHSLongStaydaysEnvMGTVO[] getCHSLongStaydaysEnvMGTVOs(){
		CHSLongStaydaysEnvMGTVO[] vos = (CHSLongStaydaysEnvMGTVO[])models.toArray(new CHSLongStaydaysEnvMGTVO[models.size()]);
		return vos;
	}
