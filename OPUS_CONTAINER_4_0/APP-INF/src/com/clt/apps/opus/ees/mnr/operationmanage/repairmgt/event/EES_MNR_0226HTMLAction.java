...
*@FileName : EES_MNR_0226HTMLAction.java
...
public class EES_MNR_0226HTMLAction extends HTMLActionSupport {
 
	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0226HTMLAction 객체를 생성
	 */
	public EES_MNR_0226HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0226Event event = new EesMnr0226Event();
