...
*@FileName : EES_CIM_0022HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.ees.cim.longstayingunclaimeqmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_CIM_0022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0022HTMLAction 객체를 생성
	 */
	public EES_CIM_0022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0022Event event = new EesCim0022Event();
		

		event.setFlaggingSDaysOptionVO ((FlaggingSDaysOptionVO )getVO(request, FlaggingSDaysOptionVO  .class));
		event.setLongStayUclmDetailVO ((LongStayUclmDetailVO )getVO(request, LongStayUclmDetailVO  .class));
		event.setLongStayUclmDetailVOS((LongStayUclmDetailVO[])getVOs(request, LongStayUclmDetailVO .class,""));
