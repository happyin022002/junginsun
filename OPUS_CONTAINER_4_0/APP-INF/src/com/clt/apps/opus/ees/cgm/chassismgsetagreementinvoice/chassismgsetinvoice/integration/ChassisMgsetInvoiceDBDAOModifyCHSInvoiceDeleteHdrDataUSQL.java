...
*@FileName : ChassisMgsetInvoiceDBDAOModifyCHSInvoiceDeleteHdrDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOModifyCHSInvoiceDeleteHdrDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.ModifyCHSInvoiceDeleteHdrData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOModifyCHSInvoiceDeleteHdrDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOModifyCHSInvoiceDeleteHdrDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
