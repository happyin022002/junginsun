...
public class EesCgm1150Event extends EventSupport {
	...
	public ShipCHSMvmtMGTVO[] getShipCHSMvmtMGTVOs() {
		ShipCHSMvmtMGTVO[] rtnVOs = null;
		if (this.shipCHSMvmtMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(shipCHSMvmtMGTVOs, shipCHSMvmtMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setShipCHSMvmtMGTVOs(ShipCHSMvmtMGTVO[] shipCHSMvmtMGTVOs){
		if(shipCHSMvmtMGTVOs != null){
			ShipCHSMvmtMGTVO[] tmpVOs = java.util.Arrays.copyOf(shipCHSMvmtMGTVOs, shipCHSMvmtMGTVOs.length);
			this.shipCHSMvmtMGTVOs = tmpVOs;
		}
	}
}