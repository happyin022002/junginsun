...
*@FileName : SurplusAreaDBDAOModifyPortSurplusAreaQtyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurplusAreaDBDAOModifyPortSurplusAreaQtyUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SurplusAreaDBDAOModifyPortSurplusAreaQtyUSQL(){
		setQuery();
		...
		query.append("FileName : SurplusAreaDBDAOModifyPortSurplusAreaQtyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- EQR_CTRL_INVT_PORT_SIM_QTY merge문" ).append("\n"); 
		query.append("MERGE INTO EQR_CTRL_INVT_PORT_SIM_QTY V" ).append("\n"); 
