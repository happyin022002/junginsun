...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionRatesDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionRatesDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Terms Entry 의 하위 Rate Adjustment 를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionRatesDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionRatesDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}