...
*@FileName : RFAExceptionTariffMgtDBDAOSearchCommodityDefaultListByRFARSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchCommodityDefaultListByRFARSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Default Commodity Search
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchCommodityDefaultListByRFARSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchCommodityDefaultListByRFARSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT A.PRC_CMDT_DEF_CD CMDT_CD" ).append("\n"); 
		query.append("     , B.CMDT_NM" ).append("\n"); 
		query.append("  FROM (SELECT PRC_CMDT_DEF_CD" ).append("\n"); 
		...
		query.append("         WHERE PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("           AND PRC_CMDT_TP_CD = 'C' ) A" ).append("\n"); 
