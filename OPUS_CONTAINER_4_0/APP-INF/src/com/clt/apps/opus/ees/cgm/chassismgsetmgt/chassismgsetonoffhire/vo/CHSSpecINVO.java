...
*@FileName : CHSSpecINVO.java
*@FileTitle : CHSSpecINVO
*Open Issues :
*Change history :
...
public class CHSSpecINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSSpecINVO> models = new ArrayList<CHSSpecINVO>();
	 ...
	 * @return CHSSpecINVO[]
	 */
	public CHSSpecINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSSpecINVO[]
	 */
	public CHSSpecINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSSpecINVO model = null;
	...
	public CHSSpecINVO[] getCHSSpecINVOs(){
		CHSSpecINVO[] vos = (CHSSpecINVO[])models.toArray(new CHSSpecINVO[models.size()]);
		return vos;
	}
