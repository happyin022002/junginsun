...
*@FileName : SCExceptionTariffMgtDBDAOSearchNextCoverageSequenceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchNextCoverageSequenceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Coverage 입력시 사용될 Sequence 를 구한다.
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchNextCoverageSequenceRSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("SELECT	NVL(MAX(CVRG_SEQ), 0) + 1" ).append("\n"); 
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchNextCoverageSequenceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}