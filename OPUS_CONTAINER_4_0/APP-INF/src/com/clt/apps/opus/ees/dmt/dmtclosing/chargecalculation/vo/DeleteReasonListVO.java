...
*@FileName : DeleteReasonListVO.java
*@FileTitle : DeleteReasonListVO
*Open Issues :
*Change history :
...
public class DeleteReasonListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DeleteReasonListVO> models = new ArrayList<DeleteReasonListVO>();
	...
	public DeleteReasonListVO() {}

	public DeleteReasonListVO(String ibflag, String pagerows, String intgCdValCtnt, String intgCdValDpDesc) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return DeleteReasonListVO[]
	 */
	public DeleteReasonListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DeleteReasonListVO[]
	 */
	public DeleteReasonListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DeleteReasonListVO model = null;
	 ...
	 * @return DeleteReasonListVO[]
	 */
	public DeleteReasonListVO[] getDeleteReasonListVOs(){
		DeleteReasonListVO[] vos = (DeleteReasonListVO[])models.toArray(new DeleteReasonListVO[models.size()]);
		return vos;
	}
