...
public class IncomeMgtDBDAOsearchReceivableInvoiceListByINVDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",DECODE(A.CURR_CD,NVL(A.CHG_CURR_CD, A.CURR_CD),A.BZC_AMT + A.VAT_AMT-A.WHLD_TAX_AMT,A.BZC_AMT-A.WHLD_TAX_AMT) TTL_AMT" ).append("\n"); 
		...
		query.append(",B.MNR_SWIFT_NO" ).append("\n"); 
		...
		query.append("AND 'C' = B.MNR_PRNR_STS_CD (+)" ).append("\n"); 
