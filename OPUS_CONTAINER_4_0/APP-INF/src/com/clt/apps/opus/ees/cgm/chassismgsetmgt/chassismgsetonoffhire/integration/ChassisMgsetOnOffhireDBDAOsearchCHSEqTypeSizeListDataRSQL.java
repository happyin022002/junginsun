...
*@FileName : ChassisMgsetOnOffhireDBDAOsearchCHSEqTypeSizeListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOsearchCHSEqTypeSizeListDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOsearchCHSEqTypeSizeListDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOsearchCHSEqTypeSizeListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       A.EQ_TPSZ_REP_CD," ).append("\n"); 
		...
		query.append("	   A.MODI_EQ_TPSZ_CD" ).append("\n"); 
