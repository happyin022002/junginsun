...
public class AgreementGRPVO {
	...
	private List<CustomMnrOrdHdrVO> customMnrOrdHdrVOS = null;
	
	public List<CustomMnrOrdHdrVO> getCustomMnrOrdHdrVOS() {
		return customMnrOrdHdrVOS;
	}

	public void setCustomMnrOrdHdrVOS(List<CustomMnrOrdHdrVO> customMnrOrdHdrVOS) {
		this.customMnrOrdHdrVOS = customMnrOrdHdrVOS;
	}
