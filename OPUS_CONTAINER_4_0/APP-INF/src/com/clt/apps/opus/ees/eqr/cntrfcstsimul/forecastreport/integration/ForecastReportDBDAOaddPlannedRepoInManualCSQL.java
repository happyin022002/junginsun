...
*@FileName : ForecastReportDBDAOaddPlannedRepoInManualCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOaddPlannedRepoInManualCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INTO EQR_CTRL_PLN_REPO_IN 에 Planned Repo In Manual 데이터 저장
	  * </pre>
	  */
	public ForecastReportDBDAOaddPlannedRepoInManualCSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOaddPlannedRepoInManualCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_CTRL_PLN_REPO_IN" ).append("\n"); 
		...
		query.append("(      @[fcast_yrwk] " ).append("\n"); 
		query.append("     , @[vsl_cd]           -- 'XXXX'" ).append("\n"); 
		query.append("     , @[skd_voy_no]       -- '0000'" ).append("\n"); 
		query.append("     , @[skd_dir_cd]       -- 'X'" ).append("\n"); 
		query.append("     , @[pln_repo_sts_cd]  -- 'M'  M/P/G" ).append("\n"); 
		query.append("     , @[pod_yd_cd]" ).append("\n"); 
		query.append("     , TO_DATE(@[to_etb_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append("     , @[vsl_lane_cd]      -- 'XXX'" ).append("\n"); 
		query.append("     , @[loc_cd]" ).append("\n"); 
		query.append("     , @[cre_usr_id]" ).append("\n"); 
