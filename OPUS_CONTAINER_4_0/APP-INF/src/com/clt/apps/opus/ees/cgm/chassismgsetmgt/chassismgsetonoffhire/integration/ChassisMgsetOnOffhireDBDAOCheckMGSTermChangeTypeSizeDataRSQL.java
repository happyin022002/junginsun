...
*@FileName : ChassisMgsetOnOffhireDBDAOCheckMGSTermChangeTypeSizeDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOCheckMGSTermChangeTypeSizeDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetOnOffhireDB.CheckMGSTermChangeTypeSizeData
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOCheckMGSTermChangeTypeSizeDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOCheckMGSTermChangeTypeSizeDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
