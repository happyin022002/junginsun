...
public class CntrRepoExecutionPlanEstablishDBDAOSearchTrunkVesselAndFeederCntrRepoPlanRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	T1_PLN_YRWK" ).append("\n"); 
		query.append("	,T1_CO_CD" ).append("\n"); 
		query.append("	,T1_DIV" ).append("\n"); 
		query.append("	,T1_TRSP_MOD_CD" ).append("\n"); 
		query.append("	,T1_VSL_LANE_CD" ).append("\n"); 
		query.append("	,T1_VVD" ).append("\n"); 
		query.append("	,T1_FM_YD_CD" ).append("\n"); 
		query.append("	,T1_FM_ETD_DT" ).append("\n"); 
		query.append("	,T1_TO_YD_CD" ).append("\n"); 
		query.append("	,T1_TO_ETA_DT" ).append("\n"); 
		query.append("	,T1_TS" ).append("\n"); 
		query.append("	,T1_EQ_REPO_PURP_CD" ).append("\n"); 
		query.append("	,T1_CNTRIMAGE" ).append("\n"); 
		query.append("	,T1_REPO_MTY_BKG_FLG" ).append("\n"); 
		query.append("	,T1_MTY_BKG_NO" ).append("\n"); 
		query.append("	-- T1_BKG_STS_CD" ).append("\n"); 
		query.append("	,T1_REPO_PLN_FB_RSN_CD" ).append("\n"); 
		query.append("	,T1_REPO_PLN_FB_RMK" ).append("\n"); 
		query.append("	,T1_TOTALVOL" ).append("\n"); 
		query.append("	#foreach( $key in ${arrtpsz})" ).append("\n"); 
		query.append("		,T1_VOL${key}" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append("    ,T1_REPO_PLN_ID		-- HIDDEN" ).append("\n"); 
		query.append("	,T1_REF_ID			-- HIDDEN" ).append("\n"); 
		query.append("	,T1_SORTNUM			-- HIDDEN	PLAN(1), Execution(2), SO(3)를 구분" ).append("\n"); 
		query.append("	,T1_NUM				-- HIDDEdN 	NORMAL ROW(1), SUB TOTAL(2), GRAND TOTAL(3) 구분" ).append("\n"); 
		query.append("	,T1_PAST_REPO_PLN_FLG	-- HIDDEN   과거에서 온 PLAN (Y)" ).append("\n"); 
		query.append("	,T1_SPLIT_REPO_PLN_FLG-- HIDDEN   SPLIT 된 EXECUTE 표시(Y)" ).append("\n"); 
		query.append("	,T1_FM_RCC	-- From ecc's RCC" ).append("\n"); 
		query.append("	,T1_TO_RCC	-- To   ecc's RCC" ).append("\n"); 
		query.append("	,T1_FM_LCC	-- From ecc's LCC" ).append("\n"); 
		query.append("	,T1_TO_LCC	-- To   ecc's LCC" ).append("\n"); 
		query.append("	,T1_FM_ECC" ).append("\n"); 
		query.append("	,T1_TO_ECC" ).append("\n"); 
		query.append("	,T1_CNTRNO			-- HIDDEN" ).append("\n"); 
		query.append("	,T1_TPSZNO			-- HIDDEN" ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append("	#foreach( $key in ${arrtpsz})" ).append("\n"); 
		query.append("		,T1_FLAG${key}FLAG" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	,T1_VVD_CNT" ).append("\n"); 
		query.append("	,T1_REPOBKG_FLAG" ).append("\n"); 
		query.append("	,T1_SORT_FRLOC" ).append("\n"); 
		query.append("	,T1_SORT_TOLOC" ).append("\n"); 
		query.append("	,T1_SORT" ).append("\n"); 
		query.append("	,T1_ETA_WEEK" ).append("\n"); 
		query.append("	,T1_PLN_YRWK_NEXT" ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append("	,T1_PLN_SEQ					--HIDDEN" ).append("\n"); 
		query.append("	,T1_TO_YARD" ).append("\n"); 
		query.append("	,NVL((SELECT 'Y' FROM MDM_EQ_ORZ_CHT EOC, MDM_LOCATION ML WHERE EOC.SCC_CD = ML.SCC_CD AND ML.LOC_CD = SUBSTR(T1_FM_YD_CD, 1, 5) AND EOC.DELT_FLG = 'N'" ).append("\n"); 
		query.append("             AND DECODE(T1_DIV, 'Plan', EOC.RCC_CD, EOC.LCC_CD) = (SELECT DECODE(T1_DIV, 'Plan', SUB.RCC_CD, SUB.LCC_CD)FROM MDM_ORGANIZATION MO, MDM_EQ_ORZ_CHT SUB, MDM_LOCATION ML WHERE MO.OFC_CD = @[off_cd]" ).append("\n"); 
		...
		query.append("								AND ROWNUM = 1)) , 'Y') AS T1_FM_CHK_FLG  " ).append("\n"); 
		query.append("	,NVL ((SELECT 'Y'FROM MDM_EQ_ORZ_CHT EOC, MDM_LOCATION ML WHERE EOC.SCC_CD = ML.SCC_CD AND ML.LOC_CD = SUBSTR(T1_TO_YD_CD, 1, 5) AND EOC.DELT_FLG = 'N'" ).append("\n"); 
		query.append("            AND DECODE(T1_DIV, 'Plan', EOC.RCC_CD, EOC.LCC_CD) = (SELECT DECODE(T1_DIV, 'Plan', SUB.RCC_CD, SUB.LCC_CD) FROM MDM_ORGANIZATION MO, MDM_EQ_ORZ_CHT SUB, MDM_LOCATION ML WHERE MO.OFC_CD = @[off_cd]" ).append("\n"); 
		query.append("                                AND MO.LOC_CD = ML.LOC_CD" ).append("\n"); 
		query.append("                                AND ML.SCC_CD = SUB.SCC_CD" ).append("\n"); 
		query.append("                                AND SUB.DELT_FLG = 'N'" ).append("\n"); 
		query.append("                                AND ROWNUM = 1)) , 'Y') AS T1_TO_CHK_FLG  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	,CASE WHEN T1_DIV = 'Plan' THEN " ).append("\n"); 
		query.append("        (SELECT OFC_CD FROM COM_USER WHERE USR_ID = (SELECT UPD_USR_ID FROM EQR_VSL_LODG_DCHG_PLN WHERE REPO_PLN_ID =  @[repo_pln_id] AND PLN_YRWK = T1_PLN_YRWK AND PLN_SEQ = T1_PLN_SEQ ))" ).append("\n"); 
		query.append("     ELSE " ).append("\n"); 
		query.append("        (SELECT OFC_CD FROM COM_USER WHERE USR_ID = (SELECT UPD_USR_ID FROM EQR_VSL_LODG_DCHG_EXE_PLN WHERE REPO_PLN_ID =  @[repo_pln_id] AND PLN_YRWK = T1_PLN_YRWK AND	PLN_SEQ = T1_PLN_SEQ AND REF_ID = T1_REF_ID))" ).append("\n"); 
		query.append("     END T1_OFC_CD  " ).append("\n"); 
		query.append("     " ).append("\n"); 
		query.append("     ,CASE WHEN T1_DIV = 'Plan' THEN " ).append("\n"); 
		query.append("          (SELECT UPD_USR_ID FROM EQR_VSL_LODG_DCHG_PLN WHERE REPO_PLN_ID =  @[repo_pln_id] AND PLN_YRWK = T1_PLN_YRWK AND PLN_SEQ = T1_PLN_SEQ )" ).append("\n"); 
		query.append("     ELSE " ).append("\n"); 
		query.append("          (SELECT UPD_USR_ID FROM EQR_VSL_LODG_DCHG_EXE_PLN WHERE REPO_PLN_ID =  @[repo_pln_id] AND	PLN_YRWK = T1_PLN_YRWK AND PLN_SEQ = T1_PLN_SEQ AND REF_ID = T1_REF_ID )" ).append("\n"); 
		query.append("     END T1_UPD_USR_ID " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	,CASE WHEN T1_DIV = 'Plan' THEN " ).append("\n"); 
		query.append("         TO_CHAR((SELECT UPD_DT FROM EQR_VSL_LODG_DCHG_PLN WHERE REPO_PLN_ID =  @[repo_pln_id] AND PLN_YRWK = T1_PLN_YRWK AND PLN_SEQ = T1_PLN_SEQ ),'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append("     ELSE " ).append("\n"); 
		query.append("         TO_CHAR((SELECT UPD_DT FROM EQR_VSL_LODG_DCHG_EXE_PLN WHERE REPO_PLN_ID =  @[repo_pln_id] AND	PLN_YRWK = T1_PLN_YRWK AND	PLN_SEQ = T1_PLN_SEQ AND REF_ID = T1_REF_ID),'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append("     END T1_UPD_DT " ).append("\n"); 
		query.append("             " ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("		,0										AS T1_TOTALCOST" ).append("\n"); 
		query.append("	#foreach( $key in ${arrtpsz})" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("	#foreach( $key in ${arrtpsz})" ).append("\n"); 
		query.append("		,0										AS T1_BASICRATIO${key}BASICRATIO	--HIDDEN" ).append("\n"); 
		query.append("		,0										AS T1_BASICVOL${key}BASICVOL		--HIDDEN" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	#foreach( $key in ${arrtpsz})" ).append("\n"); 
		...
		query.append("                SELECT /*+ ordered use_hash(VSL_PLN EXE_PLN PLN_FB) */  VSL_PLN.PLN_YRWK " ).append("\n"); 
		...
		query.append("							AND E.SCC_CD = C.SCC_CD" ).append("\n"); 
		query.append("							AND	SUBSTR(A.TO_YD_CD, 0, 5) = F.LOC_CD" ).append("\n"); 
		query.append("							AND F.SCC_CD = D.SCC_CD" ).append("\n"); 
		...
		query.append("                SELECT /*+ ordered use_hash(A B C D E F) */" ).append("\n"); 
		...
		query.append("									END" ).append("\n"); 
		query.append("							ELSE" ).append("\n"); 
		query.append("								--  SYNC CNTR TABLE" ).append("\n"); 
		...
		query.append("                        SELECT /*+ ORDERED use_nl(EXE_PLN PLN_CNTR) */ PLN_CNTR.REPO_PLN_ID " ).append("\n"); 
		...
		query.append("								(SELECT	 DISTINCT EXE_PLN.REPO_PLN_ID  " ).append("\n"); 
		...
		query.append("ORDER BY 1, T1_TRSP_MOD_CD, T1_PLN_SEQ, T1_DIV, T1_SORT, T1_VSL_LANE_CD, T1_VVD, T1_PAST_REPO_PLN_FLG||T1_SORTNUM, T1_MTY_BKG_NO" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("--, BKGNO_SPLIT" ).append("\n"); 
