...
*@FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseCIssuedListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseCIssuedListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseCIssuedListRSQL(){
		setQuery();
		...
		query.append("FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseCIssuedListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* Release - C/H - Issued */" ).append("\n"); 
