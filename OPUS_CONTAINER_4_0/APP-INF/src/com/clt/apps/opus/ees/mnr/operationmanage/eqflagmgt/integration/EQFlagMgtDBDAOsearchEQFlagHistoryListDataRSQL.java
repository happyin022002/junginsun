...
public class EQFlagMgtDBDAOsearchEQFlagHistoryListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",  TO_CHAR(A.MNR_FLG_INP_DT, 'YYYY-MM-DD HH24:MI') AS MNR_FLG_INP_DT" ).append("\n"); 
		...
		query.append("                  )" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY A.EQ_NO,A.MNR_FLG_INP_DT, A.MNR_FLG_SEQ ASC" ).append("\n"); 
