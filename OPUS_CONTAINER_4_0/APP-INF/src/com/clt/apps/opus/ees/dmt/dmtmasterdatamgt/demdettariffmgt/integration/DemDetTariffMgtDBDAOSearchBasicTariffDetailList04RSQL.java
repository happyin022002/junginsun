...
*@FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList04RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchBasicTariffDetailList04RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchBasicTariffDetailList04RSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList04RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",(SELECT INTG_CD_VAL_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD01964' AND INTG_CD_VAL_CTNT = B.DMDT_CHG_CMNC_TP_CD )" ).append("\n"); 
		query.append("||DECODE(B.DMDT_CHG_CMNC_TP_CD, '3', ' '||B.CMNC_HR||'HR' , NULL)" ).append("\n"); 
		query.append("AS DMDT_CHG_CMNC_TP_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
