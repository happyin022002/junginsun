...
*@FileName : CHSCoPoolChargeINVO.java
*@FileTitle : CHSCoPoolChargeINVO
*Open Issues :
*Change history :
...
public class CHSCoPoolChargeINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSCoPoolChargeINVO> models = new ArrayList<CHSCoPoolChargeINVO>();
	 ...
	 */
	public CHSCoPoolChargeINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSCoPoolChargeINVO[]
	 */
	public CHSCoPoolChargeINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSCoPoolChargeINVO model = null;
		...
		return getCHSCoPoolChargeINVOs();
	}
	...
	public CHSCoPoolChargeINVO[] getCHSCoPoolChargeINVOs(){
		CHSCoPoolChargeINVO[] vos = (CHSCoPoolChargeINVO[])models.toArray(new CHSCoPoolChargeINVO[models.size()]);
		return vos;
	}
