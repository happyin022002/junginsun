...
*@FileName : RepairMgtDBDAOaddWODetailByPayINVSeqDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOaddWODetailByPayINVSeqDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addWODetailByPayINVSeqData
	  * </pre>
	  */
	public RepairMgtDBDAOaddWODetailByPayINVSeqDataCSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOaddWODetailByPayINVSeqDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[mnr_ord_seq]" ).append("\n"); 
		query.append(",	(" ).append("\n"); 
		query.append("SELECT NVL(MAX(ORD_DTL_SEQ),0) + 1  FROM MNR_ORD_DTL" ).append("\n"); 
		...
		query.append(",	@[spr_prt_nm]" ).append("\n"); 
		query.append(",	@[yd_cd]" ).append("\n"); 
		query.append(",	TO_DATE(REPLACE(@[rpr_rslt_dt],'-', ''),'YYYYMMDD')" ).append("\n"); 
		query.append(",	@[rpr_qty]" ).append("\n"); 
		query.append(",	@[spr_prt_uc_amt]" ).append("\n"); 
		query.append(",	@[bzc_amt]" ).append("\n"); 
		query.append(",	@[cost_amt]" ).append("\n"); 
