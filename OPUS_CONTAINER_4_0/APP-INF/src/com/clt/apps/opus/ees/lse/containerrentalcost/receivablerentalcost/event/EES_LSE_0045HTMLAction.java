...
*@FileName : EES_LSE_0045HTMLAction.java
 ...
 * @author Jang Jun-Woo
 * @see EesLse0045Event 참조
 * @since J2EE 1.6
 */

public class EES_LSE_0045HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0045HTMLAction 객체를 생성
	 */
	public EES_LSE_0045HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesLse0045Event event = new EesLse0045Event();		
		...
		switch(command.getCommand()) {			
			...
			case FormCommand.MULTI :	//목록저장
				event.setReceivableInvoiceInquiryVOs((ReceivableInvoiceInquiryVO[])getVOs(request, ReceivableInvoiceInquiryVO.class));
				break;
			default :	//do nothing
		}
