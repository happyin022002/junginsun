...
/**
 * EES_MNR_0205 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  EES_MNR_0205HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Jung Ho Min
 * @see EES_MNR_0205HTMLAction 참조
 * @since J2EE 1.6
 */

public class EesMnr0205Event extends EventSupport {
	...
	public void setTireReplacementHistoryVOS(TireReplacementHistoryVO[] tireReplacementHistoryVOs){
		if(tireReplacementHistoryVOs != null){
			TireReplacementHistoryVO[] tmpVOs = java.util.Arrays.copyOf(tireReplacementHistoryVOs, tireReplacementHistoryVOs.length);
			this.tireReplacementHistoryVOs = tmpVOs;
		}
	}
	...
	public TireReplacementHistoryVO[] getTireReplacementHistoryVOS(){
		TireReplacementHistoryVO[] rtnVOs = null;
		if (this.tireReplacementHistoryVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(tireReplacementHistoryVOs, tireReplacementHistoryVOs.length);
		}
		return rtnVOs;
	}
