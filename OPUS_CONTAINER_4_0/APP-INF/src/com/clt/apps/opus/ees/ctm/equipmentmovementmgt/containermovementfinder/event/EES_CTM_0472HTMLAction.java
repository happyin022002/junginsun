...
public class EES_CTM_0472HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0472HTMLAction 객체를 생성
	 */
	public EES_CTM_0472HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0472Event event = new EesCtm0472Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAllBKGVO((SearchAllBKGVO)getVO(request, SearchAllBKGVO.class));
		}			
