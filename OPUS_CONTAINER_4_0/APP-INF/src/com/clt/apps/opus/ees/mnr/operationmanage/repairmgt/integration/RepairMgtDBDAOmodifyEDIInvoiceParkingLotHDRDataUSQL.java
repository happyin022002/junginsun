...
*@FileName : RepairMgtDBDAOmodifyEDIInvoiceParkingLotHDRDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOmodifyEDIInvoiceParkingLotHDRDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyEDIInvoiceParkingLotHDRData
	  * </pre>
	  */
	public RepairMgtDBDAOmodifyEDIInvoiceParkingLotHDRDataUSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOmodifyEDIInvoiceParkingLotHDRDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
