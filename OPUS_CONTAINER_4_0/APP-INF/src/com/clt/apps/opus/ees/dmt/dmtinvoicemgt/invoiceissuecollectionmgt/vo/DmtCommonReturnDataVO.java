...
*@FileName : DmtCommonReturnDataVO.java
*@FileTitle : DmtCommonReturnDataVO
*Open Issues :
*Change history :
...
public class DmtCommonReturnDataVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;
    
    private Collection<DmtCommonReturnDataVO> models = new ArrayList<DmtCommonReturnDataVO>();
    ...
    public DmtCommonReturnDataVO() {}

    public DmtCommonReturnDataVO(String ibflag, String pagerows, String intgCdId, String intgCdValCtnt, String intgCdValDpDesc, String intgCdValDesc, String intgCdValDpSeq, String aplyStDt, String aplyEndDt, String creUsrId, String creDt, String updUsrId, String updDt) {
        this.updDt = updDt;
     ...
     */
    public DmtCommonReturnDataVO[] fromRequestGrid(HttpServletRequest request) {
     ...
     * @return DmtCommonReturnDataVO[]
     */
    public DmtCommonReturnDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        DmtCommonReturnDataVO model = null;
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                model = new DmtCommonReturnDataVO();
                if (updDt[i] != null)
        ...
        return getDmtCommonReturnDataVOs();
    }
    ...
    public DmtCommonReturnDataVO[] getDmtCommonReturnDataVOs(){
        DmtCommonReturnDataVO[] vos = (DmtCommonReturnDataVO[])models.toArray(new DmtCommonReturnDataVO[models.size()]);
        return vos;
    }
