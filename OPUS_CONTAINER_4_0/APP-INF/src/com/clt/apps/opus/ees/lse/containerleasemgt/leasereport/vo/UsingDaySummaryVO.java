...
*@FileName : UsingDaySummaryVO.java
*@FileTitle : UsingDaySummaryVO
*Open Issues :
*Change history :
...
public class UsingDaySummaryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<UsingDaySummaryVO> models = new ArrayList<UsingDaySummaryVO>();
	 ...
	 * @param request
	 * @return UsingDaySummaryVO[]
	 */
	public UsingDaySummaryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsingDaySummaryVO[]
	 */
	public UsingDaySummaryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsingDaySummaryVO model = null;
	 ...
	 * @return UsingDaySummaryVO[]
	 */
	public UsingDaySummaryVO[] getOffHireResultAvgUsingDaySummaryVOs(){
		UsingDaySummaryVO[] vos = (UsingDaySummaryVO[])models.toArray(new UsingDaySummaryVO[models.size()]);
		return vos;
	}
