...
*@FileName : MgsetMovementHistoryDBDAOAddMnrRetirementDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MgsetMovementHistoryDBDAOAddMnrRetirementDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MgsetMovementHistoryDBDAOAddMnrRetirementDataCSQL(){
		setQuery();
		...
		query.append("FileName : MgsetMovementHistoryDBDAOAddMnrRetirementDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append(" @[mgst_no]         " ).append("\n"); 
		query.append(",TO_DATE(@[mvmt_dt],'YYYYMMDD')          " ).append("\n"); 
		query.append(",(SELECT DECODE(MAX(SYS_SEQ)+1,NULL,1,MAX(SYS_SEQ)+1) FROM CGM_MGST_MVMT_HIS WHERE MGST_NO= @[mgst_no] )  " ).append("\n"); 
		...
		query.append(",@[dest_yd_cd]      " ).append("\n"); 
		query.append(",@[gate_io_cd]      " ).append("\n"); 
		query.append(",( SELECT VNDR_SEQ FROM CGM_EQUIPMENT  WHERE EQ_NO = @[chss_no] )   " ).append("\n"); 
		query.append(",@[mvmt_sts_cd]     " ).append("\n"); 
		query.append(",@[mvmt_rsn_cd]     " ).append("\n"); 
		query.append(",@[chss_no]         " ).append("\n"); 
		query.append(",@[bkg_no]         " ).append("\n"); 
