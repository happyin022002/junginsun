...
*@FileName : OnhireApprovalDBDAOaddOnhireApprovalNumberQtyHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnhireApprovalDBDAOaddOnhireApprovalNumberQtyHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LSE_ONH_APRO_QTY_HIS를 생성한다.
	  * </pre>
	  */
	public OnhireApprovalDBDAOaddOnhireApprovalNumberQtyHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : OnhireApprovalDBDAOaddOnhireApprovalNumberQtyHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO LSE_ONH_APRO_QTY_HIS (" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("SELECT CNTR_ONH_AUTH_NO" ).append("\n"); 
		query.append("     , AGMT_CTY_CD" ).append("\n"); 
		query.append("     , AGMT_SEQ" ).append("\n"); 
		query.append("     , CNTR_TPSZ_CD" ).append("\n"); 
		query.append("     , NEW_VAN_TP_CD" ).append("\n"); 
