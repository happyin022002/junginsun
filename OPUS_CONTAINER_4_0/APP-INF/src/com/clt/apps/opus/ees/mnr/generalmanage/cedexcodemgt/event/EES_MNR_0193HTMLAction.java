...
*@FileName : EES_MNR_0193HTMLAction.java
*@FileTitle : EQ Location Code POP UP
*Open Issues :
*Change history :
...
public class EES_MNR_0193HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0193HTMLAction 객체를 생성
	 */
	public EES_MNR_0193HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesMnr0193Event event = new EesMnr0193Event();  
