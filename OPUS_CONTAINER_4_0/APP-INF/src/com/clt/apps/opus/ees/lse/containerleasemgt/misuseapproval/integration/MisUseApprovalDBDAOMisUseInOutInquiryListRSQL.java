...
public class MisUseApprovalDBDAOMisUseInOutInquiryListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        AA.MSS_USE_PLC_NM, " ).append("\n"); 
		query.append("--		AA.PD_CHG_RT_AMT," ).append("\n"); 
		query.append("		DECODE(MST_COMMON_PKG.MST_HO_OFC_CHK_FNC(@[usr_ofc_cd])" ).append("\n"); 
		query.append(" 				,'Y',AA.PD_CHG_RT_AMT" ).append("\n"); 
		query.append(" 				,'N','') AS PD_CHG_RT_AMT," ).append("\n"); 
		query.append("		AA.LFT_CHG_RT_AMT, AA.LIBOR_PTY_NM, " ).append("\n"); 
