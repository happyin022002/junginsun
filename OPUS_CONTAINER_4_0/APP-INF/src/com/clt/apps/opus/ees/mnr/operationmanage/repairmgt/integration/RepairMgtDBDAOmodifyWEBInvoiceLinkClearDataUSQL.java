...
*@FileName : RepairMgtDBDAOmodifyWEBInvoiceLinkClearDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOmodifyWEBInvoiceLinkClearDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RepairMgtDBDAOmodifyWEBInvoiceLinkClearDataUSQL
	  * </pre>
	  */
	public RepairMgtDBDAOmodifyWEBInvoiceLinkClearDataUSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOmodifyWEBInvoiceLinkClearDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
