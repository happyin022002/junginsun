...
package com.clt.apps.opus.ees.dmt.dmtperformanceanalysis.batchhistoryreport.vo;
...
public class DmtBatHisVO extends AbstractValueObject {
	...
	/* Column Info */
	private String sw1BatTm = null;
	/* Column Info */
	private String sw1BatTyp = null;
	/* Column Info */
	private String sw2BatTm = null;
	/* Column Info */
	private String sw2BatTyp = null;
	/* Column Info */
	private String sw3BatTm = null;
	/* Column Info */
	private String sw3BatTyp = null;
	...
	public DmtBatHisVO(String ibflag, String pagerows, String chnBatTyp, String eurBatTm, String usaBatTm, String batHisDt, String swaBatTm, String eurBatTyp, String korBatTm, String korBatTyp, String swaBatTyp, String usaBatTyp, String chnBatTm, String sw1BatTm, String sw1BatTyp, String sw2BatTm, String sw2BatTyp, String sw3BatTm, String sw3BatTyp) {
		...
		this.sw1BatTm = sw1BatTm;
		this.sw1BatTyp = sw2BatTyp;
		this.sw2BatTm = sw2BatTm;
		this.sw2BatTyp = sw2BatTyp;
		this.sw3BatTm = sw3BatTm;
		this.sw3BatTyp = sw3BatTyp;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sw1_bat_tm", getSw1BatTm());
		this.hashColumns.put("sw1_bat_typ", getSw1BatTyp());
		this.hashColumns.put("sw2_bat_tm", getSw2BatTm());
		this.hashColumns.put("sw2_bat_typ", getSw2BatTyp());
		this.hashColumns.put("sw3_bat_tm", getSw3BatTm());
		this.hashColumns.put("sw3_bat_typ", getSw3BatTyp());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sw1_bat_tm", "sw1BatTm");
		this.hashFields.put("sw1_bat_typ", "sw1BatTyp");
		this.hashFields.put("sw2_bat_tm", "sw2BatTm");
		this.hashFields.put("sw2_bat_typ", "sw2BatTyp");
		this.hashFields.put("sw3_bat_tm", "sw3BatTm");
		this.hashFields.put("sw3_bat_typ", "sw3BatTyp");
	...
	public String getSw1BatTm() {
		return sw1BatTm;
	}
	public void setSw1BatTm(String sw1BatTm) {
		this.sw1BatTm = sw1BatTm;
	}
	public String getSw1BatTyp() {
		return sw1BatTyp;
	}
	public void setSw1BatTyp(String sw1BatTyp) {
		this.sw1BatTyp = sw1BatTyp;
	}
	public String getSw2BatTm() {
		return sw2BatTm;
	}
	public void setSw2BatTm(String sw2BatTm) {
		this.sw2BatTm = sw2BatTm;
	}
	public String getSw2BatTyp() {
		return sw2BatTyp;
	}
	public void setSw2BatTyp(String sw2BatTyp) {
		this.sw2BatTyp = sw2BatTyp;
	}
	public String getSw3BatTm() {
		return sw3BatTm;
	}
	public void setSw3BatTm(String sw3BatTm) {
		this.sw3BatTm = sw3BatTm;
	}
	public String getSw3BatTyp() {
		return sw3BatTyp;
	}
	public void setSw3BatTyp(String sw3BatTyp) {
		this.sw3BatTyp = sw3BatTyp;
	}
	/**
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSw1BatTm(JSPUtil.getParameter(request, "sw1_bat_tm", ""));
		setSw1BatTyp(JSPUtil.getParameter(request, "sw1_bat_typ", ""));
		setSw2BatTm(JSPUtil.getParameter(request, "sw2_bat_tm", ""));
		setSw2BatTyp(JSPUtil.getParameter(request, "sw2_bat_typ", ""));
		setSw3BatTm(JSPUtil.getParameter(request, "sw3_bat_tm", ""));
		setSw3BatTyp(JSPUtil.getParameter(request, "sw3_bat_typ", ""));
	}
	...
	public DmtBatHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sw1BatTm = (JSPUtil.getParameter(request, prefix	+ "sw1_bat_tm", length));
			String[] sw1BatTyp = (JSPUtil.getParameter(request, prefix	+ "sw1_bat_typ", length));
			String[] sw2BatTm = (JSPUtil.getParameter(request, prefix	+ "sw2_bat_tm", length));
			String[] sw2BatTyp = (JSPUtil.getParameter(request, prefix	+ "sw2_bat_typ", length));
			String[] sw3BatTm = (JSPUtil.getParameter(request, prefix	+ "sw3_bat_tm", length));
			String[] sw3BatTyp = (JSPUtil.getParameter(request, prefix	+ "sw3_bat_typ", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (sw1BatTm[i] != null)
					model.setSw1BatTm(sw1BatTm[i]);
				if (sw1BatTyp[i] != null)
					model.setSw1BatTyp(sw1BatTyp[i]);
				if (sw2BatTm[i] != null)
					model.setSw2BatTm(sw2BatTm[i]);
				if (sw2BatTyp[i] != null)
					model.setSw2BatTyp(sw2BatTyp[i]);
				if (sw3BatTm[i] != null)
					model.setSw3BatTm(sw3BatTm[i]);
				if (sw3BatTyp[i] != null)
					model.setSw3BatTyp(sw3BatTyp[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.sw1BatTm = this.sw1BatTm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.sw1BatTyp = this.sw1BatTyp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.sw2BatTm = this.sw2BatTm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.sw2BatTyp = this.sw2BatTyp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.sw3BatTm = this.sw3BatTm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.sw3BatTyp = this.sw3BatTyp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
