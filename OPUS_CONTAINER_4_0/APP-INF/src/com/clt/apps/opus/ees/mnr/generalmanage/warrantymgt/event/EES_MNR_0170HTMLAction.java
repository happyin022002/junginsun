...
*@FileName : EES_MNR_0170HTMLAction.java
...
public class EES_MNR_0170HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0170HTMLAction 객체를 생성
	 */
	public EES_MNR_0170HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0170Event event = new EesMnr0170Event();
		//조회  
		if(command.isCommand(FormCommand.SEARCH)) { 
			event.setWarrantyAlertListINVO((WarrantyAlertListINVO)getVO(request, WarrantyAlertListINVO .class));
		}		 
		//저장
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomWarrantyAlertListVOs((CustomWarrantyAlertListVO[])getVOs(request, CustomWarrantyAlertListVO .class,""));
		}        
