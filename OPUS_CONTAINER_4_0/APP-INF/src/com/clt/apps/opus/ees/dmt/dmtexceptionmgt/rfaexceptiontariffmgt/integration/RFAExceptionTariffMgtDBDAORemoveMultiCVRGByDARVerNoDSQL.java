...
*@FileName : RFAExceptionTariffMgtDBDAORemoveMultiCVRGByDARVerNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveMultiCVRGByDARVerNoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DAR No. 와 Version No. 에 해당되는 Multi Origin or Dest. 정보를 삭제한다.
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveMultiCVRGByDARVerNoDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveMultiCVRGByDARVerNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
