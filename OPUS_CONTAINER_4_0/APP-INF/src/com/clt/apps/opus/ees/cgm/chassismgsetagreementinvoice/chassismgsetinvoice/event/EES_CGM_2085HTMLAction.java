...
*@FileName : EES_CGM_2085HTMLAction.java
...
public class EES_CGM_2085HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2085HTMLAction 객체를 생성
	 */
	public EES_CGM_2085HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2085Event event = new EesCgm2085Event();
		
		// Verify
		if(command.isCommand(FormCommand.MULTI01)) {	
			MGSInvoiceImportAuditINVO mgsInvoiceImportAuditINVO = (MGSInvoiceImportAuditINVO)getVO(request, MGSInvoiceImportAuditINVO.class);
			mgsInvoiceImportAuditINVO.setCostYrmon(mgsInvoiceImportAuditINVO.getCostYrmon().replaceAll("-", ""));
			
			event.setMgsInvoiceImportAuditINVO(mgsInvoiceImportAuditINVO);
			event.setMgsInvoiceImportAuditINVOS((MGSInvoiceImportAuditINVO[])getVOs(request, MGSInvoiceImportAuditINVO.class, ""));
