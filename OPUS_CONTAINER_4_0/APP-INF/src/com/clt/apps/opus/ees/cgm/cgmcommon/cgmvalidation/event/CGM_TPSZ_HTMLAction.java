...
*@FileName : CGM_TPSZHTMLAction.java
...
public class CGM_TPSZ_HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CGM_TPSZHTMLAction 객체를 생성
	 */
	public CGM_TPSZ_HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CgmTpszEvent event = new CgmTpszEvent();
		

		if(command.isCommand(FormCommand.SEARCH02)) {
			event.setTpSzDupChkINVO((TpSzDupChkINVO)getVO(request, TpSzDupChkINVO .class));
		}
