...
*@FileName : InvoiceIssueCollectionMgtDBDAOCreateInvoiceNoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOCreateInvoiceNoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DMT_INV_NO 채번 데이터 생성-신규
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOCreateInvoiceNoCSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOCreateInvoiceNoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_INV_NO (" ).append("\n"); 
