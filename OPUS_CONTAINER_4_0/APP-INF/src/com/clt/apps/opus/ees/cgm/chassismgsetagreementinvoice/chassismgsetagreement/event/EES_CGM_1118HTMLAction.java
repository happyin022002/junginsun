...
*@FileName : EES_CGM_1118HTMLAction.java
...
public class EES_CGM_1118HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1118HTMLAction 객체를 생성
	 */
	public EES_CGM_1118HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1118Event event = new EesCgm1118Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			CHSTermChangeResultINVO chsTermChangeResultINVO = (CHSTermChangeResultINVO)getVO(request, CHSTermChangeResultINVO.class);
			event.setChsTermChangeResultINVO(chsTermChangeResultINVO);
		}
