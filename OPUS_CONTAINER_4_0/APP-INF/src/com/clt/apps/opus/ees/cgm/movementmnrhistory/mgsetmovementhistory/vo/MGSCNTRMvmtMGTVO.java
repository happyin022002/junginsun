...
public class MGSCNTRMvmtMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSCNTRMvmtMGTVO> models = new ArrayList<MGSCNTRMvmtMGTVO>();
	 ...
	 */
	public MGSCNTRMvmtMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CNTRMvmtMGTVO[]
	 */
	public MGSCNTRMvmtMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSCNTRMvmtMGTVO model = null;
	 ...
	 * @return CNTRMvmtMGTVO[]
	 */
	public MGSCNTRMvmtMGTVO[] getCNTRMvmtMGTVOs(){
		MGSCNTRMvmtMGTVO[] vos = (MGSCNTRMvmtMGTVO[])models.toArray(new MGSCNTRMvmtMGTVO[models.size()]);
		return vos;
	}
