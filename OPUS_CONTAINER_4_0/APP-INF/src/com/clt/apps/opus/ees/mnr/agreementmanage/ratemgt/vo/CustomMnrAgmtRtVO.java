...
*@FileName : CustomMnrAgmtRtVO.java
*@FileTitle : CustomMnrAgmtRtVO
*Open Issues :
*Change history :
...
public class CustomMnrAgmtRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomMnrAgmtRtVO> models = new ArrayList<CustomMnrAgmtRtVO>();
	...
	/**
	 * CustomMnrAgmtRtVO을 생성함 
	 */ 
	public CustomMnrAgmtRtVO() {}
	
	/**
	 * CustomMnrAgmtRtVO을 생성함 
	 */    
	public CustomMnrAgmtRtVO(String ibflag, String pagerows, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String costCd, String costDtlCd, String mnrRtTpCd, String rprQty, String agmtRtAmt, String creUsrId, String creDt, String updUsrId, String updDt, String usrDefRmk, String ydCd) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setUsrDefRmk(JSPUtil.getParameter(request, "usr_def_rmk", ""));
	 ...
	 * @param request
	 * @return CustomMnrAgmtRtVO[]
	 */
	public CustomMnrAgmtRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomMnrAgmtRtVO[]
	 */
	public CustomMnrAgmtRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMnrAgmtRtVO model = null;
		...
		try {
			...
			String[] agmtRtAmt = (JSPUtil.getParameter(request, prefix	+ "agmt_rt_amt".trim(), length));
	 ...
	 * @return CustomMnrAgmtRtVO[]
	 */
	public CustomMnrAgmtRtVO[] getCustomMnrAgmtRtVOs(){
		CustomMnrAgmtRtVO[] vos = (CustomMnrAgmtRtVO[])models.toArray(new CustomMnrAgmtRtVO[models.size()]);
		return vos;
	}
