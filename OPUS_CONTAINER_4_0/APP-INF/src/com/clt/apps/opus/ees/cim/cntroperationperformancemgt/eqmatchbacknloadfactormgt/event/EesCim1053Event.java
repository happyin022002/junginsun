...
public class EesCim1053Event extends EventSupport {
	...
	public SearchBatchJobStatusVO[] getSearchBatchJobStatusVOs() {
		SearchBatchJobStatusVO[] tmpVOs = null;
		  if (this.searchBatchJobStatusVOs != null) {
		   tmpVOs = new SearchBatchJobStatusVO[searchBatchJobStatusVOs.length];
		   System.arraycopy(searchBatchJobStatusVOs, 0, tmpVOs, 0, tmpVOs.length);
		  }
		  return tmpVOs;
	}
	...
	public void setSearchBatchJobStatusVOs(
		  ...
		  if (searchBatchJobStatusVOs != null) {
			  SearchBatchJobStatusVO[] tmpVOs = new SearchBatchJobStatusVO[searchBatchJobStatusVOs.length];
			   System.arraycopy(searchBatchJobStatusVOs, 0, tmpVOs, 0, tmpVOs.length);
	...
	public SearchOptionByFromToVO[] getSearchOptionByFromToVOs() {
		SearchOptionByFromToVO[] tmpVOs = null;
		  if (this.searchOptionByFromToVOs != null) {
		   ...
		   System.arraycopy(searchOptionByFromToVOs, 0, tmpVOs, 0, tmpVOs.length);
		  }
		  return tmpVOs;
	}
