...
*@FileName : PayableRentalCostDBDAOLseOpLseVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PayableRentalCostDBDAOLseOpLseVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PayableRentalCostDBDAOLseOpLseVODSQL(){
		setQuery();
		...
		query.append("FileName : PayableRentalCostDBDAOLseOpLseVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE LSE_OP_LSE" ).append("\n"); 
