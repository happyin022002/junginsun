...
public class EesCgm1104Event extends EventSupport {
	...
	public CHSMvmtMGTVO[] getChsMvmtMGTVOs() {
		CHSMvmtMGTVO[] rtnVOs = null;
		if (this.chsMvmtMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(chsMvmtMGTVOs, chsMvmtMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setChsMvmtMGTVOs(CHSMvmtMGTVO[] chsMvmtMGTVOs){
		if(chsMvmtMGTVOs != null){
			CHSMvmtMGTVO[] tmpVOs = java.util.Arrays.copyOf(chsMvmtMGTVOs, chsMvmtMGTVOs.length);
			this.chsMvmtMGTVOs = tmpVOs;
		}
	}
