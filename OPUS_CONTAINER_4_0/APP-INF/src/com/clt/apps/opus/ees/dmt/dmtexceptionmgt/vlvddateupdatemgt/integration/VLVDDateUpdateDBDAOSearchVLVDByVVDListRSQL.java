...
public class VLVDDateUpdateDBDAOSearchVLVDByVVDListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	GROUP BY K.SLAN_CD , K.VSL_CD , K.SKD_VOY_NO , K.SKD_DIR_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT LANE, VVD, ETA, ETD, FIRSTVL, LASTVL, VLDATEN, VLDATEB, UPDATED, UPDATEO, UPDATEI, UPDATEN" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("			#if ( ${mvmt} == 'VD' )" ).append("\n"); 
		query.append("            AND     K.VPS_ETD_DT                  BETWEEN TO_DATE(@[frdt],'yyyy-mm-dd') " ).append("\n"); 
		query.append("                                                        AND TO_DATE(@[todt],'yyyy-mm-dd') + .99999" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("            #end" ).append("\n"); 
		query.append("            " ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("ORDER BY LANE, VVD, ETA" ).append("\n"); 
