...
public class PoolChassisHistoryDBDAOsearchPoolMvmtExpenseListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      AA.OWN_CHSS_USD_DYS ," ).append("\n"); 
		query.append("      AA.RATE ," ).append("\n"); 
		query.append("      AA.OWN_CHSS_USD_DYS * AA.RATE EST_AMOUNT" ).append("\n"); 
		query.append("    FROM (" ).append("\n"); 
		...
		query.append("          NVL( MAX(INV.OWN_CHSS_USD_DYS ),0) OWN_CHSS_USD_DYS ," ).append("\n"); 
		...
		query.append("                        SUM(A.POOL_CHSS_USD_DYS) AS OWN_CHSS_USD_DYS," ).append("\n"); 
		...
		query.append("                        AND SUBSTR(A.ONH_YD_CD, 1, 5) = B.OWN_POOL_LOC_CD" ).append("\n"); 
		...
		query.append("              A.COST_YRMON AS MVMT_DT ," ).append("\n"); 
		query.append("              NULL OWN_CHSS_USD_DYS ," ).append("\n"); 
