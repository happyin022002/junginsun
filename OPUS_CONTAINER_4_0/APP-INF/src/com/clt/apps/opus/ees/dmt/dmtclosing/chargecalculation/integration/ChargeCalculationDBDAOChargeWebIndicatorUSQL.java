...
*@FileName : ChargeCalculationDBDAOChargeWebIndicatorUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOChargeWebIndicatorUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOChargeWebIndicator
	  * </pre>
	  */
	public ChargeCalculationDBDAOChargeWebIndicatorUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOChargeWebIndicatorUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET		WEB_IND_FLG		= @[web_ind_flg]" ).append("\n"); 
