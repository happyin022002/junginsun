...
*@FileName : ChassisMgsetInvoiceDBDAOSearchMGSLessorAgmtMatchingDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOSearchMGSLessorAgmtMatchingDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.SearchMGSLessorAgmtMatchingData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOSearchMGSLessorAgmtMatchingDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOSearchMGSLessorAgmtMatchingDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
