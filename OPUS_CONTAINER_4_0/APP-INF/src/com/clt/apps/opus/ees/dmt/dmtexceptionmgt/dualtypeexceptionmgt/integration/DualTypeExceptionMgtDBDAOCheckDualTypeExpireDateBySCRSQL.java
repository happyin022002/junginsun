...
*@FileName : DualTypeExceptionMgtDBDAOCheckDualTypeExpireDateBySCRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DualTypeExceptionMgtDBDAOCheckDualTypeExpireDateBySCRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * S/C 데이터의 Expire Date 보다 크거나 같다면 유효, 작다면 에러
	  * </pre>
	  */
	public DualTypeExceptionMgtDBDAOCheckDualTypeExpireDateBySCRSQL(){
		setQuery();
		...
		query.append("FileName : DualTypeExceptionMgtDBDAOCheckDualTypeExpireDateBySCRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
