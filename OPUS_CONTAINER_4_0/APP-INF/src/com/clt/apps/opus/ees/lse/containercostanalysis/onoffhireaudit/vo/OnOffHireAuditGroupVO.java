...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.ees.lse.containercostanalysis.onoffhireaudit.vo;
...
public class OnOffHireAuditGroupVO {
	...
	private Logger log = Logger.getLogger("com.clt.apps.opus.ees.lse.containercostanalysis.onoffhireaudit.vo");
