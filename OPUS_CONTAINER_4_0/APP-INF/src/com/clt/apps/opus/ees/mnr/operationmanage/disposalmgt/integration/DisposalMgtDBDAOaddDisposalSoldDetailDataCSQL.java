...
*@FileName : DisposalMgtDBDAOaddDisposalSoldDetailDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DisposalMgtDBDAOaddDisposalSoldDetailDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Disposal Sold Creation (EES_MNR_0160) 의 신규저장
	  * </pre>
	  */
	public DisposalMgtDBDAOaddDisposalSoldDetailDataCSQL(){
		setQuery();
		...
		query.append("FileName : DisposalMgtDBDAOaddDisposalSoldDetailDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
