...
public class SearchEDIResultVO extends AbstractValueObject {
	...
	/* Column Info */
	private String intIgnr = null;
	/* Column Info */
	private String intIgnrRatio = null;
	/* Column Info */
	...
	public SearchEDIResultVO(String ibflag, String pagerows, String cn, String cntrNo, String cntrTpszCd, String creLoclDt, String divide, String edi12h, String edi12hRatio, String edi24h, String edi24hRatio, String edi48h, String edi48hRatio, String ediGateIoCd, String ediMvmtStsCd, String ediOver, String ediOverRatio, String ediTtl, String evntDt, String evntYdCd, String gap, String gapRadio, String intErr, String intIgnr, String intIgnrRatio, String intErrRatio, String intOk, String intOkRatio, String intTtl, String lcc, String lccCd, String loc, String method, String mvmtEdiRmk, String pDate1, String pDate2, String pYard1, String pYard2, String rcc, String rccCd, String tpCd, String yard) {
		this.yard = yard;
		this.intErrRatio = intErrRatio;
		this.ediGateIoCd = ediGateIoCd;
		this.lcc = lcc;
		this.intErr = intErr;
		this.intIgnr = intIgnr;
		this.intIgnrRatio = intIgnrRatio;
		this.intTtl = intTtl;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("int_ignr", getIntIgnr());
		this.hashColumns.put("int_ignr_ratio", getIntIgnrRatio());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("int_ignr", "intIgnr");
		this.hashFields.put("int_ignr_ratio", "intIgnrRatio");
	 ...
	 * @return intIgnrRatio
	 */
	public String getIntIgnrRatio() {
		return this.intIgnrRatio;
	}
	 ...
	 * @param intIgnr
	 */
	public void setIntIgnr(String intIgnr) {
		this.intIgnr = intIgnr;
	}
	 ...
	 * @param intIgnrRatio
	 */
	public void setIntIgnrRatio(String intIgnrRatio) {
		this.intIgnrRatio = intIgnrRatio;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setIntIgnr(JSPUtil.getParameter(request, prefix + "int_ignr", ""));
		setIntIgnrRatio(JSPUtil.getParameter(request, prefix + "int_ignr_ratio", ""));
	...
	public SearchEDIResultVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] intIgnr = (JSPUtil.getParameter(request, prefix	+ "int_ignr", length));
			String[] intIgnrRatio = (JSPUtil.getParameter(request, prefix	+ "int_ignr_ratio", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (intIgnr[i] != null)
					model.setIntIgnr(intIgnr[i]);
				if (intIgnrRatio[i] != null)
					model.setIntIgnrRatio(intIgnrRatio[i]);
				if (intTtl[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.intIgnr = this.intIgnr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.intIgnrRatio = this.intIgnrRatio .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
