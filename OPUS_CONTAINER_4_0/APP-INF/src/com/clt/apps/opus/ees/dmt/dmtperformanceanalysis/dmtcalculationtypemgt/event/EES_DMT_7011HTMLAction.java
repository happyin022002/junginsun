...
public class EES_DMT_7011HTMLAction extends HTMLActionSupport {
	...
	/**
	 * EES_DMT_7011HTMLAction 객체를 생성
	 */
	public EES_DMT_7011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDmtCmbSetVO((DmtCmbSetVO)getVO(request, DmtCmbSetVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setDmtCmbSetVOs((DmtCmbSetVO[])getVOs(request, DmtCmbSetVO.class, ""));
		}
