...
*@FileName : DemandNoteSendDBDAOSearchARActualPayerRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemandNoteSendDBDAOSearchARActualPayerRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemandNoteSendDBDAOSearchARActualPayerRSQL(){
		setQuery();
		...
		query.append("FileName : DemandNoteSendDBDAOSearchARActualPayerRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
