...
*@FileName : ChassisMgsetInvoiceDBDAOModifyCHSPayableChgHdrCancelDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOModifyCHSPayableChgHdrCancelDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.ModifyCHSPayableChgHdrCancelData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOModifyCHSPayableChgHdrCancelDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOModifyCHSPayableChgHdrCancelDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
