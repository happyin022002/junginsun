...
public class CustomMnrOrdDtlVO	extends	 AbstractValueObject
{
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mnr_old_seq", getMnrOldSeq());	
	...
	public  HashMap<String, String>  getFieldNames(){
		...
		this.hashFields.put("mnr_old_seq", "mnrOldSeq");
 ...
 //	Getters	and	Setters
	...
	* @param  mnrOldSeq
	*/
	public void	setMnrOldSeq( String	mnrOldSeq ) {
		this.mnrOldSeq =	mnrOldSeq;
	}
	 ...
	 * @return	mnrOldSeq
	 */
	 public	 String	getMnrOldSeq() {
		 return	this.mnrOldSeq;
	 } 
	...
	public void	fromRequest(HttpServletRequest request,	String prefix) {
		...
		setMnrOldSeq(JSPUtil.getParameter(request,	prefix + "mnr_old_seq", ""));
	...
	public CustomMnrOrdDtlVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				...
				String[] mnrOldSeq =	(JSPUtil.getParameter(request, prefix +	"mnr_old_seq".trim(),	length));
				...
				String[] invAdjBzcAmt =	(JSPUtil.getParameter(request, prefix +	"inv_adj_bzc_amt".trim(),	length));
				...
				for	(int i = 0;	i <	length;	i++) {
					model =	new	CustomMnrOrdDtlVO();
						...
						if ( mnrOldSeq[i] !=	null)
						model.setMnrOldSeq( mnrOldSeq[i]);
	...
	*/
	public void	unDataFormat(){
		...
		this.mnrOldSeq =	this.mnrOldSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
