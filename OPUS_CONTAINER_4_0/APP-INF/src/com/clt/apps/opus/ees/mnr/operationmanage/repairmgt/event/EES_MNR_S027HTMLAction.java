...
*@FileName : EES_MNR_S027HTMLAction.java
...
public class EES_MNR_S027HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0027HTMLAction 객체를 생성
	 */
	public EES_MNR_S027HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesMnrS027Event event = new EesMnrS027Event();
