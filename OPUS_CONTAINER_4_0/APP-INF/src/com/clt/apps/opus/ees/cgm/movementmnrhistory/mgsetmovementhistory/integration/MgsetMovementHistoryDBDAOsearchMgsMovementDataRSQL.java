...
*@FileName : MgsetMovementHistoryDBDAOsearchMgsMovementDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MgsetMovementHistoryDBDAOsearchMgsMovementDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MgsetMovementHistoryDBDAOsearchMgsMovementDataRSQL(){
		setQuery();
		...
		query.append("FileName : MgsetMovementHistoryDBDAOsearchMgsMovementDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       AB.CNTR_NO CNTR_NO," ).append("\n"); 
		query.append("       AB.CHSS_NO CHSS_NO," ).append("\n"); 
		query.append("       'OWN'  CNTR_OWNR_CO_CD," ).append("\n"); 
		...
		query.append("	                   AND I.EQ_KND_CD(+) = 'G'" ).append("\n"); 
		query.append("                         " ).append("\n"); 
		...
		query.append(" AB.EQ_NO = B.MGST_NO(+)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("AND AB.EQ_NO = J.EQ_NO(+)" ).append("\n"); 
		query.append("AND J.DTCH_DT(+) = TO_DATE( '88881231', 'YYYYMMDD' )" ).append("\n"); 
		query.append("AND J.EQ_KND_CD(+) = 'Z'" ).append("\n"); 
