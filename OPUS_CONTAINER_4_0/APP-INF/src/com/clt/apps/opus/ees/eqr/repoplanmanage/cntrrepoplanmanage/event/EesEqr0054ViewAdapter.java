...
*@FileName : EesEqr0054ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EesEqr0054ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		EesEqr0054ConditionVO conditionVO = (EesEqr0054ConditionVO) vos.get(0);
