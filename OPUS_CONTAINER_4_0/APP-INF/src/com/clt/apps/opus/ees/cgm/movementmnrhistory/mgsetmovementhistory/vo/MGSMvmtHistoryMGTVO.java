...
public class MGSMvmtHistoryMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSMvmtHistoryMGTVO> models = new ArrayList<MGSMvmtHistoryMGTVO>();
	 ...
	 */
	public MGSMvmtHistoryMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSMvmtHistoryMGTVO[]
	 */
	public MGSMvmtHistoryMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSMvmtHistoryMGTVO model = null;
	 ...
	 * @return CHSMvmtHistoryMGTVO[]
	 */
	public MGSMvmtHistoryMGTVO[] getCHSMvmtHistoryMGTVOs(){
		MGSMvmtHistoryMGTVO[] vos = (MGSMvmtHistoryMGTVO[])models.toArray(new MGSMvmtHistoryMGTVO[models.size()]);
		return vos;
	}
