...
*@FileName : ChassisMgsetInvoiceDBDAOSearchCHSInvoiceOnlyStatusDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOSearchCHSInvoiceOnlyStatusDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.SearchCHSInvoiceOnlyStatusData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOSearchCHSInvoiceOnlyStatusDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOSearchCHSInvoiceOnlyStatusDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
