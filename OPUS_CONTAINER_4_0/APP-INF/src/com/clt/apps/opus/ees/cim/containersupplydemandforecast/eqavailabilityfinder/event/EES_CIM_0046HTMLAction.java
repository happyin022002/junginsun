...
*@FileName : EES_CIM_0046HTMLAction.java
*@FileTitle : BR
*Open Issues :
*Change history :
...
public class EES_CIM_0046HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0046HTMLAction 객체를 생성
	 */
	public EES_CIM_0046HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0046Event event = new EesCim0046Event();
