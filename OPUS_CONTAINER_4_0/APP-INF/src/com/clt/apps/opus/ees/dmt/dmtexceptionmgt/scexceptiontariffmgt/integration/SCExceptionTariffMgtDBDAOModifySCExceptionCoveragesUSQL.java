...
*@FileName : SCExceptionTariffMgtDBDAOModifySCExceptionCoveragesUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOModifySCExceptionCoveragesUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Terms Entry 의 등록된 Group 정보의 하위 Multi Coverage 정보를 수정하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOModifySCExceptionCoveragesUSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOModifySCExceptionCoveragesUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_SC_EXPT_CVRG SET " ).append("\n"); 
		query.append("	CNT_CD = NVL(@[cnt_cd], ' ')" ).append("\n"); 
		...
		query.append("AND	CVRG_SEQ = @[cvrg_seq]" ).append("\n"); 
