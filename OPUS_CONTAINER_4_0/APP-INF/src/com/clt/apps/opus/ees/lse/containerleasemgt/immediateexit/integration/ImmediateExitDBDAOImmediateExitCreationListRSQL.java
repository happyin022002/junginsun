...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.ees.lse.containerleasemgt.immediateexit.integration;
...
public class ImmediateExitDBDAOImmediateExitCreationListRSQL implements ISQLTemplate{
	...
	public ImmediateExitDBDAOImmediateExitCreationListRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.lse.containerleasemgt.immediateexit.integration").append("\n"); 
	...
	public void setQuery(){
		query.append("SELECT  A.IMDT_EXT_FLG, A.CNTR_NO, A.CNTR_TPSZ_CD, " ).append("\n"); 
		...
		query.append("	#foreach($key IN ${cntr_no_list})" ).append("\n"); 
