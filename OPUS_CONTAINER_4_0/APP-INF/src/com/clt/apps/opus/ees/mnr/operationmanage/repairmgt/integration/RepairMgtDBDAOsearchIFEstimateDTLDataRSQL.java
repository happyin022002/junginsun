...
public class RepairMgtDBDAOsearchIFEstimateDTLDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("--        ,(	" ).append("\n"); 
		query.append("--              SELECT " ).append("\n"); 
		query.append("--              DECODE(MRH.EQ_KND_CD,'G','MRGSRC','Z','MRZSRC','U'," ).append("\n"); 
		query.append("--              DECODE(SUBSTR(MRH.EQ_TPSZ_CD , 1, 1) ,'D', 'MRDRRC'" ).append("\n"); 
		...
		query.append("FROM MNR_RPR_RQST_DTL MRD,MNR_RPR_RQST_HDR MRH " ).append("\n"); 
