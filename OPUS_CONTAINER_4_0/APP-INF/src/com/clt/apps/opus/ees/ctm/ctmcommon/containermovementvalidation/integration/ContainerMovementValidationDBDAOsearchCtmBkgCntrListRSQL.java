...
*@FileName : ContainerMovementValidationDBDAOsearchCtmBkgCntrListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementValidationDBDAOsearchCtmBkgCntrListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchCtmBkgCntrList
	  * </pre>
	  */
	public ContainerMovementValidationDBDAOsearchCtmBkgCntrListRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementValidationDBDAOsearchCtmBkgCntrListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND CNT.CNTR_NO = @[p_cntrno]" ).append("\n"); 
