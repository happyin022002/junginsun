...
public class DemDetTariffMgtDBDAOSearchCombinationSetRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", (SELECT INTG_CD_VAL_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD02053' AND INTG_CD_VAL_CTNT = DMDT_CNTR_TP_CD ) AS DMDT_CNTR_TP_NM" ).append("\n"); 
		query.append(", DMDT_CGO_TP_CD" ).append("\n"); 
		query.append(", (SELECT INTG_CD_VAL_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD01963' AND INTG_CD_VAL_CTNT = DMDT_CGO_TP_CD ) AS DMDT_CGO_TP_NM" ).append("\n"); 
