...
package com.clt.apps.opus.ees.cgm.movementmnrhistory.chassismgsetattachdetachhistory.vo;
...
public class CHSMovementHistoryMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSMovementHistoryMGTVO> models = new ArrayList<CHSMovementHistoryMGTVO>();
	...
	public CHSMovementHistoryMGTVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CHSMovementHistoryMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSMovementHistoryMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSMovementHistoryMGTVO();
	...
	public CHSMovementHistoryMGTVO[] getCgmEqAtchDtchHisVOs(){
		CHSMovementHistoryMGTVO[] vos = (CHSMovementHistoryMGTVO[])models.toArray(new CHSMovementHistoryMGTVO[models.size()]);
		return vos;
	}
