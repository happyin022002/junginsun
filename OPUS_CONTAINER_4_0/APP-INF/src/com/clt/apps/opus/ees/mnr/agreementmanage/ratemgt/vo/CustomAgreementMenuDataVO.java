...
public class CustomAgreementMenuDataVO extends AbstractValueObject {
	 ...
	 * CustomAgreementMenuDataVO을 생성함 
	 */    
	public CustomAgreementMenuDataVO(String ibflag, String pagerows, String dpSeq, String tabTitle, String mnrOrdTpCd, String tabType, String eqType, String costCd, String sheetTitle) {
		this.dpSeq = dpSeq;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sheet_title", getSheetTitle());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sheet_title", "sheetTitle");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSheetTitle(JSPUtil.getParameter(request, "sheet_title", ""));
	}
	...
	public CustomAgreementMenuDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sheetTitle = (JSPUtil.getParameter(request, prefix	+ "sheet_title".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (sheetTitle[i] != null)
					model.setSheetTitle(sheetTitle[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.sheetTitle = this.sheetTitle .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
