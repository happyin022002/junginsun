...
*@FileName : RFAExceptionTariffMgtDBDAOExistBeforeExceptionDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOExistBeforeExceptionDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Before Booking Request 의 Version 에 해당되는 Detail 정보가 존재하는지 조회하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOExistBeforeExceptionDetailRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOExistBeforeExceptionDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	COUNT(RFA_RQST_DTL_SEQ)" ).append("\n"); 
