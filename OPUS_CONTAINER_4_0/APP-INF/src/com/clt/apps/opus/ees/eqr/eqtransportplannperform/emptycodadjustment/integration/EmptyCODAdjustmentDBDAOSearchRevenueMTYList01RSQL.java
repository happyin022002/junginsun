...
*@FileName : EmptyCODAdjustmentDBDAOSearchRevenueMTYList01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyCODAdjustmentDBDAOSearchRevenueMTYList01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyCODAdjustmentDBDAOSearchRevenueMTYList01RSQL(){
		setQuery();
		...
		query.append("FileName : EmptyCODAdjustmentDBDAOSearchRevenueMTYList01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("Y.CNTR_NO, Y.CNTR_TPSZ_CD, Y.POL_CD, Y.POD_CD, Y.BAY_NO, Y.XXX, Y.BKG_NO FROM (" ).append("\n"); 
		query.append("SELECT ROWNUM RW,Z.CNTR_NO, Z.CNTR_TPSZ_CD, Z.POL_CD, Z.POD_CD, Z.BAY_NO, Z.XXX, Z.BKG_NO " ).append("\n"); 
		...
		query.append("                    AND		BPN.CRR_CD	=	(SELECT COM_CONSTANTMGR_PKG. COM_GETCOMPANYCODE_FNC" ).append("\n"); 
		...
		query.append("WHERE Y.RW >= 10" ).append("\n"); 
