...
*@FileName : EES_CGM_1142HTMLAction.java
...
public class EES_CGM_1142HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1142HTMLAction 객체를 생성
	 */
	public EES_CGM_1142HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1142Event event = new EesCgm1142Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPoolMvmtINVO((PoolMvmtINVO)getVO(request, PoolMvmtINVO .class));
		}
