...
*@FileName : DisposalPFMCByMonthVO.java
*@FileTitle : DisposalPFMCByMonthVO
*Open Issues :
*Change history :
...
public class DisposalPFMCByMonthVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<DisposalPFMCByMonthVO> models = new ArrayList<DisposalPFMCByMonthVO>();
	...
	public DisposalPFMCByMonthVO() {}

	public DisposalPFMCByMonthVO(String ibflag, String pagerows, String aproMon, String pStrEvntDt, String pEndEvntDt, String pEqKndCd, String pLocTp, String pLocCd, String pDispRsnCd, String pDispTpCd, String pCustCd, String dispQtyTot, String dispQtyCnt, String dispQtyRto, String calPartAmtTot, String tpszDp01, String tpszDp02, String tpszDp03, String tpszDp04, String tpszDp05, String tpszDp06, String tpszDp07, String tpszDp08, String tpszDp09, String tpszDp10, String tpszDp11, String tpszDp12, String tpszDp13, String tpszDp14, String tpszDp15, String tpszDp16, String tpszDp17, String tpszDp18, String tpszDp19, String tpszDp20, String tpszDp21, String tpszDp22, String tpszDp23, String tpszDp24, String tpszDp25, String tpszDp26, String tpszDp27, String tpszDp28, String tpszDp29, String tpszDp30) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("apro_mon", getAproMon());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("apro_mon", "aproMon");
	 ...
	 * @return the aproMon
	 */
	public String getAproMon() {
		return aproMon;
	}

	/**
	 * @param aproMon the aproMon to set
	 */
	public void setAproMon(String aproMon) {
		this.aproMon = aproMon;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAproMon(JSPUtil.getParameter(request, prefix + "apro_mon", ""));
	}
	 ...
	 */
	public DisposalPFMCByMonthVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DisposalPFMCByMonthVO[]
	 */
	public DisposalPFMCByMonthVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DisposalPFMCByMonthVO model = null;
		...
		try {
			...
			String[] aproMon = (JSPUtil.getParameter(request, prefix	+ "apro_mon", length));

			for (int i = 0; i < length; i++) {
				model = new DisposalPFMCByMonthVO();
				if (tpszDp19[i] != null)
	 ...
	 * @return DisposalPFMCByMonthVO[]
	 */
	public DisposalPFMCByMonthVO[] getDisposalPFMCByRCCVOs(){
		DisposalPFMCByMonthVO[] vos = (DisposalPFMCByMonthVO[])models.toArray(new DisposalPFMCByMonthVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.aproMon = this.aproMon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
