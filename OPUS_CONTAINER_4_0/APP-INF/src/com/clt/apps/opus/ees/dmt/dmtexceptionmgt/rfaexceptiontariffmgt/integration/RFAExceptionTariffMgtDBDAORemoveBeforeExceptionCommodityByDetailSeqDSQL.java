...
*@FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCommodityByDetailSeqDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCommodityByDetailSeqDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Commodity by detail seq Delete
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCommodityByDetailSeqDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCommodityByDetailSeqDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM DMT_RFA_EXPT_CMDT" ).append("\n"); 
