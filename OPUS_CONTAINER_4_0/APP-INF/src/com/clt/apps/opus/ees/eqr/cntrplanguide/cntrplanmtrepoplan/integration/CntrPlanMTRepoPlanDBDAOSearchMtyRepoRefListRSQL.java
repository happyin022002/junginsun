...
public class CntrPlanMTRepoPlanDBDAOSearchMtyRepoRefListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("              FROM COA_MON_VVD CMV," ).append("\n"); 
		query.append("                   PARAMS      P" ).append("\n"); 
		...
		query.append("                SELECT " ).append("\n"); 
		query.append("                    NVL(SUM(DECODE(D.CRR_CD, 'HJS', D.CRR_BSA_CAPA)),0) FNL_HJS_BSA_CAPA" ).append("\n"); 
		...
		query.append("            ,NVL(C.N2ND_FNL_CO_BSA_CAPA,NVL(C.BSA_CAPA,0)) BSA_VAL            " ).append("\n"); 
		...
		query.append("            GROUP BY C.TRD_CD, C.RLANE_CD, C.VSL_CD, C.SKD_VOY_NO, C.SKD_DIR_CD, C.REV_PORT_CD, D.BSA_OP_JB_CD, C.BSA_CAPA" ).append("\n"); 
		query.append("            , C.N2ND_FNL_CO_BSA_CAPA" ).append("\n"); 
		...
		query.append("        , TO_NUMBER('') TTL_WT" ).append("\n"); 
		query.append("        , (T.BOX_D2 + T.BOX_R2 + T.BOX_O2 + T.BOX_S2 + T.BOX_F2 + T.BOX_A2 + T.BOX_D4 + T.BOX_O4 + T.BOX_S4 + T.BOX_F4 + T.BOX_A4 + T.BOX_D5 + T.BOX_F5 + T.BOX_R5 + T.BOX_D7 + T.BOX_R9) TTL_BOX" ).append("\n"); 
		query.append("        , (T.BOX_D2 + T.BOX_R2 + T.BOX_O2 + T.BOX_S2 + T.BOX_F2 + T.BOX_A2) TTL_20" ).append("\n"); 
		query.append("        , (T.BOX_D4 + T.BOX_O4 + T.BOX_S4 + T.BOX_F4 + T.BOX_A4) TTL_40" ).append("\n"); 
		...
		query.append("        , NVL((L.BOX_D2 + L.BOX_R2 + L.BOX_O2 + L.BOX_S2 + L.BOX_F2 + L.BOX_A2 + L.BOX_D4*2 + L.BOX_O4*2 + L.BOX_S4*2 + L.BOX_F4*2 + L.BOX_A4*2 + L.BOX_F5*2 + L.BOX_D5*2 + L.BOX_R5*2 + L.BOX_D7*2 + L.BOX_R9*2),0) TTL_TEU" ).append("\n"); 
		query.append("        , TO_NUMBER('') TTL_WT" ).append("\n"); 
		query.append("        , NVL((L.BOX_D2 + L.BOX_R2 + L.BOX_O2 + L.BOX_S2 + L.BOX_F2 + L.BOX_A2 + L.BOX_D4 + L.BOX_O4 + L.BOX_S4 + L.BOX_F4 + L.BOX_A4 + L.BOX_D5 + L.BOX_F5 + L.BOX_R5 + L.BOX_D7 + L.BOX_R9),0) TTL_BOX" ).append("\n"); 
		query.append("        , NVL((L.BOX_D2 + L.BOX_R2 + L.BOX_O2 + L.BOX_S2 + L.BOX_F2 + L.BOX_A2),0) TTL_20" ).append("\n"); 
		query.append("        , NVL((L.BOX_D4 + L.BOX_O4 + L.BOX_S4 + L.BOX_F4 + L.BOX_A4),0) TTL_40" ).append("\n"); 
		...
		query.append("          THEN (T.BOX_D2 + T.BOX_R2 + T.BOX_O2 + T.BOX_S2 + T.BOX_F2 + T.BOX_A2 + T.BOX_D4*2 + T.BOX_O4*2 + T.BOX_S4*2 + T.BOX_F4*2 + T.BOX_A4*2 + T.BOX_D5*2 + T.BOX_F5*2 + T.BOX_R5*2 + T.BOX_D7*2 + T.BOX_R9*2) " ).append("\n"); 
		query.append("          ELSE (T.HG_BOX_D2 + T.HG_BOX_R2 + T.HG_BOX_O2 + T.HG_BOX_S2 + T.HG_BOX_F2 + T.HG_BOX_A2 + T.HG_BOX_D4*2 + T.HG_BOX_O4*2 + T.HG_BOX_S4*2 + T.HG_BOX_F4*2 + T.HG_BOX_A4*2 + T.HG_BOX_D5*2 + T.HG_BOX_F5*2 + T.HG_BOX_R5*2 + T.HG_BOX_D7*2 + T.HG_BOX_R9*2) " ).append("\n"); 
		query.append("          END,0) TTL_TEU" ).append("\n"); 
		query.append("        , TO_NUMBER('') TTL_WT" ).append("\n"); 
		query.append("        , NVL(CASE " ).append("\n"); 
		query.append("          WHEN C.SEQ = '1' " ).append("\n"); 
		query.append("          THEN (T.BOX_D2 + T.BOX_R2 + T.BOX_O2 + T.BOX_S2 + T.BOX_F2 + T.BOX_A2 + T.BOX_D4 + T.BOX_O4 + T.BOX_S4 + T.BOX_F4 + T.BOX_A4 + T.BOX_D5 + T.BOX_F5 + T.BOX_R5 + T.BOX_D7 + T.BOX_R9) " ).append("\n"); 
		query.append("          ELSE (T.HG_BOX_D2 + T.HG_BOX_R2 + T.HG_BOX_O2 + T.HG_BOX_S2 + T.HG_BOX_F2 + T.HG_BOX_A2 + T.HG_BOX_D4 + T.HG_BOX_O4 + T.HG_BOX_S4 + T.HG_BOX_F4 + T.HG_BOX_A4 + T.HG_BOX_D5 + T.HG_BOX_F5 + T.HG_BOX_R5 + T.HG_BOX_D7 + T.HG_BOX_R9) " ).append("\n"); 
		...
		query.append("        , NVL(CASE " ).append("\n"); 
		query.append("          WHEN C.SEQ = '1' " ).append("\n"); 
		query.append("          THEN (T.BOX_D4 + T.BOX_O4 + T.BOX_S4 + T.BOX_F4 + T.BOX_A4) " ).append("\n"); 
		query.append("          ELSE (T.HG_BOX_D4 + T.HG_BOX_O4 + T.HG_BOX_S4 + T.HG_BOX_F4 + T.HG_BOX_A4) " ).append("\n"); 
