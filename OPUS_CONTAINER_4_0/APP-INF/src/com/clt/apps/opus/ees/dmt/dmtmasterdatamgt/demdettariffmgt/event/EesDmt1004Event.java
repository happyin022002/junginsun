...
/**
 * EES-DMT-1004 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  EES-DMT-1004HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kim Tae Kyun
 * @see EES-DMT-1004HTMLAction 참조
 * @since J2EE 1.4
 */
public class EesDmt1004Event extends EventSupport {
