...
public class Utils {
	...
	public static String fill(String str, int spaceNum, String spaceString, String flag) {
		...
		}else if("right".equals(flag)) { //}else if(flag == "right") {
	...
	/*
	 * return today with dateTime format
	 ...
	 * return hashmap that has following data
	 * key1:value1
	 * key2:value2
	 * key3:value3
	 * 
	...
	/**
	 * making String array with Sting
	 * 
	 * @param str String
	 * @return List<String>
	 */
	...
	/**
	 * return column name with status
	 * 
	 * @param status String
	 * @return String
	 */
	...
	/**
	 * converting 15 Container Type Size to 10 Type Size
	 * 
	 * @param tpsz String
	 * @return List<String>
	 */
