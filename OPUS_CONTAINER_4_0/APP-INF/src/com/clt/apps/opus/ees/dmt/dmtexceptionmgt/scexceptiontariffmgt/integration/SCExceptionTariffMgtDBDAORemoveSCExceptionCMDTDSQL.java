...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionCMDTDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionCMDTDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionCMDTDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionCMDTDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}