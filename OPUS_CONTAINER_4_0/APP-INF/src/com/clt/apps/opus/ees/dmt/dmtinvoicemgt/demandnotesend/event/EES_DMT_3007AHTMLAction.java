...
*@FileName : EES_DMT_3007HTMLAction.java
...
public class EES_DMT_3007AHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_3007AHTMLAction 객체를 생성
	 */
	public EES_DMT_3007AHTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		EesDmt3007AEvent event = new EesDmt3007AEvent();
		
		log.debug("\n::CALL::> EES_DMT_3007AHTMLAction - RD html before");
		
		event.setDemandNoteRDParmVOS((DemandNoteRDParmVO[])getVOs(request, DemandNoteRDParmVO .class, ""));
		
		log.debug("\n::CALL::> EES_DMT_3007AHTMLAction - RD html after");
