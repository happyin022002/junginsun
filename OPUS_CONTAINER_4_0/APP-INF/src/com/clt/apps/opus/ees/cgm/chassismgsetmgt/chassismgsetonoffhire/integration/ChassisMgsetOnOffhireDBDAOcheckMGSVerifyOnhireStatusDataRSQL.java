...
*@FileName : ChassisMgsetOnOffhireDBDAOcheckMGSVerifyOnhireStatusDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOcheckMGSVerifyOnhireStatusDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOcheckMGSVerifyOnhireStatusDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOcheckMGSVerifyOnhireStatusDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("'Failed(Active M.G.Set  )'" ).append("\n"); 
		...
		query.append(") THEN" ).append("\n"); 
		query.append("'Already exists in Chassis.'" ).append("\n"); 
		...
		query.append(") THEN" ).append("\n"); 
		query.append("'Failed(Leaesd M.G.Set)'" ).append("\n"); 
		...
		query.append(") THEN" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("'Failed(Own M.G.Set)'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("WHEN  exists (select 'X' from" ).append("\n"); 
		query.append("CGM_EQUIPMENT A" ).append("\n"); 
		query.append("WHERE A.EQ_NO = @[eq_no]" ).append("\n"); 
		...
		query.append("WHERE  TO_DATE(@[onh_dt], 'YYYY-MM-DD') <   (select B.STS_EVNT_DT  from CGM_EQUIPMENT A,CGM_EQ_STS_HIS B" ).append("\n"); 
		query.append("WHERE A.EQ_NO = @[eq_no]" ).append("\n"); 
		query.append("AND A.EQ_NO = B.EQ_NO(+)" ).append("\n"); 
		query.append("AND A.EQ_STS_SEQ = B.EQ_STS_SEQ(+)" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("AND TO_DATE(@[onh_dt], 'YYYY-MM-DD')" ).append("\n"); 
		...
		query.append("WHERE A.AGMT_OFC_CTY_CD = @[agmt_ofc_cty_cd]" ).append("\n"); 
		query.append("AND A.AGMT_SEQ = @[agmt_seq]" ).append("\n"); 
		query.append("AND TO_DATE(@[onh_dt], 'YYYY-MM-DD') BETWEEN A.EFF_DT AND A.EXP_DT" ).append("\n"); 
		...
		query.append("AND  B.MGST_LSE_FX_RT_AMT   > 0" ).append("\n"); 
		query.append("AND A.DELT_FLG = 'N'" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${eq_spec_no} != '')" ).append("\n"); 
		query.append("WHEN  EXISTS (SELECT 'X'" ).append("\n"); 
		query.append("FROM CGM_EQ_SPEC" ).append("\n"); 
		query.append("WHERE EQ_SPEC_NO  = @[eq_spec_no]" ).append("\n"); 
		query.append("AND  EQ_TPSZ_CD != @[eq_tpsz_cd]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(")  THEN" ).append("\n"); 
		query.append("'Type of inputted M.G.Set and Model No. do not match.'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ELSE" ).append("\n"); 
