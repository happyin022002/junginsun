...
*@FileName : EQFlagMgtDBDAOsearchEqStsRmkDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQFlagMgtDBDAOsearchEqStsRmkDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQFlagMgtDBDAOsearchEqStsRmkDataRSQL(){
		setQuery();
		...
		query.append("FileName : EQFlagMgtDBDAOsearchEqStsRmkDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    MNR_FLG_RMK MNR_STS_RMK" ).append("\n"); 
		...
		query.append("		WHERE MLH.MNR_FLG_TP_CD = @[mnr_flg_tp_cd]" ).append("\n"); 
