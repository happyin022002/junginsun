...
/**
 * opus ChassisMgsetAgreementDBDAO <br>
...
public class ChassisMgsetAgreementDBDAO extends DBDAOSupport {
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<MGSAgreementMGTVO> searchMGSAgreementLseRtData(MGSAgreementINVO mgsAgreementINVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<MGSAgreementMGTVO> list = null;
//		MGSAgreementMGTVO mgtVO = null;
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<MGSAgreementMGTVO> searchMGSAgreementLseRt2Data(MGSAgreementINVO mgsAgreementINVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<MGSAgreementMGTVO> list = null;
//		MGSAgreementMGTVO mgtVO = null;
		//query parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new ChassisMgsetAgreementDBDAOSearchMGSAgreementLseRt2DataRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, MGSAgreementMGTVO .class);
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<MGSAgreementMGTVO> searchMGSAgreementLseRt3Data(MGSAgreementINVO mgsAgreementINVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<MGSAgreementMGTVO> list = null;
//		MGSAgreementMGTVO mgtVO = null;
		//query parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new ChassisMgsetAgreementDBDAOSearchMGSAgreementLseRt3DataRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, MGSAgreementMGTVO .class);
	 ...
	 * @exception DAOException
	 */
	public void modifyEQAgreementVersionData(CHSAgreementINVO chsAgreementINVO) throws DAOException, Exception {
		try {
			SQLExecuter sqlExe = new SQLExecuter("");
			if (chsAgreementINVO != null) {
				// query parameter
				...
				int result = sqlExe.executeUpdate((ISQLTemplate) new ChassisMgsetAgreementDBDAOModifyEQAgreementVersionDataUSQL(), param, null);
				if (result == Statement.EXECUTE_FAILED)
					throw new DAOException("Fail to insert SQL");
			}
		} catch (SQLException se) {
	 ...
	 * @exception DAOException
	 */
	public void addEQAgreementHisData(CHSAgreementINVO chsAgreementINVO) throws DAOException, Exception {
		try {
			SQLExecuter sqlExe = new SQLExecuter("");
			if (chsAgreementINVO != null) {
				// query parameter
				...
				int result = sqlExe.executeUpdate((ISQLTemplate) new ChassisMgsetAgreementDBDAOAddCHSEqAgreementHisDataCSQL(), param, null);
				if (result == Statement.EXECUTE_FAILED)
					throw new DAOException("Fail to insert SQL");
			}
		} catch (SQLException se) {
	 ...
	 * @exception DAOException
	 */
	 public boolean checkCHSNonConfirmInvoiceData(CHSAgreementINVO chsAgreementINVO) throws DAOException {
		DBRowSet dbRowset = null;
		boolean chkResult = false;
		int cnt = 0;
		//query parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new ChassisMgsetAgreementDBDAOCheckCHSNonConfirmInvoiceDataRSQL(), param, velParam);
	...
	/**
	 * Searching EQ under the agreement<br>
	 * 
	 * @param CHSAgreementINVO chsAgreementINVO
	 * @return List<CHSStatusInfoINVO>
	 * @exception DAOException
	 */
	@SuppressWarnings("unchecked")
	public List<CHSStatusInfoINVO> searchEQAgmtListData(CHSAgreementINVO chsAgreementINVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<CHSStatusInfoINVO> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new ChassisMgsetAgreementDBDAOSaerchAgmtEQListDataRSQL(),param, velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset,CHSStatusInfoINVO.class);
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch (Exception ex) {
