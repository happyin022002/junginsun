...
*@FileName : InterfaceMgtDBDAOmodifyMnrWOVrfyCdDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceMgtDBDAOmodifyMnrWOVrfyCdDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InterfaceMgtDBDAOmodifyMnrWOVrfyCdDataUSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceMgtDBDAOmodifyMnrWOVrfyCdDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET MNR_VRFY_TP_CD = 'IW'," ).append("\n"); 
