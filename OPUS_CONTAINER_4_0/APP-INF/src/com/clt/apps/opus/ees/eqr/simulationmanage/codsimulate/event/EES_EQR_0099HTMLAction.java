...
*@FileName : EES_EQR_0099HTMLAction.java
...
public class EES_EQR_0099HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0099HTMLAction 객체를 생성
	 */
	public EES_EQR_0099HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0099Event event = new EesEqr0099Event();
