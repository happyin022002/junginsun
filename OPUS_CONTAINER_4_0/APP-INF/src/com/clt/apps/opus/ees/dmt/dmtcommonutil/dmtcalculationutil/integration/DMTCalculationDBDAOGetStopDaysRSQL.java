...
public class DMTCalculationDBDAOGetStopDaysRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                - TO_DATE (TO_CHAR (CLK_STOP_FM_DT, 'YYYYMMDD'), 'YYYYMMDD')" ).append("\n"); 
		query.append("                + 1" ).append("\n"); 
		query.append("              ) TMP_CSTOP_DAY" ).append("\n"); 
		...
		query.append("   AND TO_DATE (TO_CHAR (CLK_STOP_FM_DT, 'YYYYMMDD'), 'YYYYMMDD')" ).append("\n"); 
		query.append("          BETWEEN TO_DATE (@[ftime_end], 'YYYYMMDD')" ).append("\n"); 
		...
		query.append("   AND TO_DATE (TO_CHAR (A.CLK_STOP_FM_DT, 'YYYYMMDD'), 'YYYYMMDD')" ).append("\n"); 
		query.append("          BETWEEN TO_DATE (@[ftime_end], 'YYYYMMDD')" ).append("\n"); 
		query.append("              AND TO_DATE (@[to_date], 'YYYYMMDD')" ).append("\n"); 
