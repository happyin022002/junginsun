...
public class RateMgtDBDAOsearchAgreementComboListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("D.TRSM_MOD_CD" ).append("\n"); 
		...
		query.append("FROM MNR_AGMT_HDR A, MDM_VENDOR B,MNR_PARTNER D,MNR_GEN_CD E, MNR_AGMT_APLY_OFC C" ).append("\n"); 
		...
		query.append("AND D.AGMT_OFC_CTY_CD = A.AGMT_OFC_CTY_CD" ).append("\n"); 
		...
		query.append("AND C.AGMT_OFC_CTY_CD = A.AGMT_OFC_CTY_CD" ).append("\n"); 
		query.append("AND C.AGMT_SEQ = A.AGMT_SEQ" ).append("\n"); 
		query.append("AND C.AGMT_VER_NO = A.AGMT_VER_NO" ).append("\n"); 
		query.append("AND C.APLY_OFC_CD = D.CTRL_OFC_CD" ).append("\n"); 
		query.append("ORDER BY B.VNDR_LGL_ENG_NM, A.VNDR_SEQ" ).append("\n"); 
