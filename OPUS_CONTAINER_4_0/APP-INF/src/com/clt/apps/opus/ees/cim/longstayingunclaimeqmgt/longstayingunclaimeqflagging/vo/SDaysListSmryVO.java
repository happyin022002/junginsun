...
*@FileName : SDaysListSmryVO.java
*@FileTitle : SDaysListSmryVO
*Open Issues :
*Change history :
...
public class SDaysListSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SDaysListSmryVO> models = new ArrayList<SDaysListSmryVO>();
	...
	public SDaysListSmryVO() {}

	public SDaysListSmryVO(String ibflag, String pagerows, String locCd, String sccCd, String eccCd, String lccCd, String rccCd, String cntrTpszCd, String cnmvStsCd, String actQty, String totalQty, String totalAvg, String overQty, String overAvg, String overStayDays, String overRate, String totalRate, String qty1, String avg1, String stayDays1, String rate1, String qty2, String avg2, String stayDays2, String rate2, String qty3, String avg3, String stayDays3, String rate3, String qty4, String avg4, String stayDays4, String rate4, String qty5, String avg5, String stayDays5, String rate5, String qty6, String avg6, String stayDays6, String rate6, String qty7, String avg7, String stayDays7, String rate7, String qty8, String avg8, String stayDays8, String rate8, String qty9, String avg9, String stayDays9, String rate9, String qty10, String avg10, String stayDays10, String rate10, String qty11, String avg11, String stayDays11, String rate11, String qty12, String avg12, String stayDays12, String rate12, String qty13, String avg13, String stayDays13, String rate13, String qty14, String avg14, String stayDays14, String rate14, String qty15, String avg15, String stayDays15, String rate15, String rccDate, String lvl) {
	...
	public void fromRequest(HttpServletRequest request) {
		setTotalRate(JSPUtil.getParameter(request, "total_rate", ""));
		setRccDate(JSPUtil.getParameter(request, "rcc_date", ""));
		setTotalAvg(JSPUtil.getParameter(request, "total_avg", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setOverAvg(JSPUtil.getParameter(request, "over_avg", ""));
		setAvg4(JSPUtil.getParameter(request, "avg4", ""));
		setAvg5(JSPUtil.getParameter(request, "avg5", ""));
		setAvg2(JSPUtil.getParameter(request, "avg2", ""));
		setLocCd(JSPUtil.getParameter(request, "loc_cd", ""));
		setAvg3(JSPUtil.getParameter(request, "avg3", ""));
		setOverRate(JSPUtil.getParameter(request, "over_rate", ""));
		setAvg8(JSPUtil.getParameter(request, "avg8", ""));
		setAvg9(JSPUtil.getParameter(request, "avg9", ""));
		setAvg6(JSPUtil.getParameter(request, "avg6", ""));
		setCntrTpszCd(JSPUtil.getParameter(request, "cntr_tpsz_cd", ""));
		setAvg7(JSPUtil.getParameter(request, "avg7", ""));
		setAvg13(JSPUtil.getParameter(request, "avg13", ""));
		setRate11(JSPUtil.getParameter(request, "rate11", ""));
		setAvg14(JSPUtil.getParameter(request, "avg14", ""));
		setRate12(JSPUtil.getParameter(request, "rate12", ""));
		setAvg15(JSPUtil.getParameter(request, "avg15", ""));
		setRate13(JSPUtil.getParameter(request, "rate13", ""));
		setQty1(JSPUtil.getParameter(request, "qty1", ""));
		setRate14(JSPUtil.getParameter(request, "rate14", ""));
		setRate15(JSPUtil.getParameter(request, "rate15", ""));
		setQty3(JSPUtil.getParameter(request, "qty3", ""));
		setAvg10(JSPUtil.getParameter(request, "avg10", ""));
		setQty2(JSPUtil.getParameter(request, "qty2", ""));
		setAvg11(JSPUtil.getParameter(request, "avg11", ""));
		setQty5(JSPUtil.getParameter(request, "qty5", ""));
		setAvg12(JSPUtil.getParameter(request, "avg12", ""));
		setQty4(JSPUtil.getParameter(request, "qty4", ""));
		setRate4(JSPUtil.getParameter(request, "rate4", ""));
		setRate5(JSPUtil.getParameter(request, "rate5", ""));
		setRate6(JSPUtil.getParameter(request, "rate6", ""));
		setRate7(JSPUtil.getParameter(request, "rate7", ""));
		setRate1(JSPUtil.getParameter(request, "rate1", ""));
		setRate2(JSPUtil.getParameter(request, "rate2", ""));
		setRate3(JSPUtil.getParameter(request, "rate3", ""));
		...
		setRate8(JSPUtil.getParameter(request, "rate8", ""));
		setRate9(JSPUtil.getParameter(request, "rate9", ""));
		setAvg1(JSPUtil.getParameter(request, "avg1", ""));
		...
		setOverQty(JSPUtil.getParameter(request, "over_qty", ""));
		...
		setRate10(JSPUtil.getParameter(request, "rate10", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return SDaysListSmryVO[]
	 */
	public SDaysListSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SDaysListSmryVO[]
	 */
	public SDaysListSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SDaysListSmryVO model = null;
	 ...
	 * @return SDaysListSmryVO[]
	 */
	public SDaysListSmryVO[] getSDaysListSmryVOs(){
		SDaysListSmryVO[] vos = (SDaysListSmryVO[])models.toArray(new SDaysListSmryVO[models.size()]);
		return vos;
	}
