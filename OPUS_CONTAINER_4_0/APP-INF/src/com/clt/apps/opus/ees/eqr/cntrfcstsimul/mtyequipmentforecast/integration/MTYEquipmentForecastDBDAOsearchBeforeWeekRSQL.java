...
*@FileName : MTYEquipmentForecastDBDAOsearchBeforeWeekRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYEquipmentForecastDBDAOsearchBeforeWeekRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYEquipmentForecastDBDAOsearchBeforeWeekRSQL(){
		setQuery();
		...
		query.append("FileName : MTYEquipmentForecastDBDAOsearchBeforeWeekRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
