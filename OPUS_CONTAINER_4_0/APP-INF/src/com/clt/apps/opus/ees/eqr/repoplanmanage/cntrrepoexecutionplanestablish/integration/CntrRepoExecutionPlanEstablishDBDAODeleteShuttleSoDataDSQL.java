...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteShuttleSoDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteShuttleSoDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ECC INTERSNAL EQR_REPO_EXE_SO_IF       삭제   ( 해당 REF_ID )
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteShuttleSoDataDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteShuttleSoDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
