...
*@FileName : TotalLossMgtDBDAOremoveTotalLossHDRDataDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class TotalLossMgtDBDAOremoveTotalLossHDRDataDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TotalLossMgtDBDAOremoveTotalLossHDRDataDSQL(){
		setQuery();
		...
		query.append("FileName : TotalLossMgtDBDAOremoveTotalLossHDRDataDSQL").append("\n");
		query.append("*/").append("\n");
	}
