...
*@FileName : VDMovementVO.java
*@FileTitle : VDMovementVO
*Open Issues :
*Change history :
...
public class VDMovementVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VDMovementVO> models = new ArrayList<VDMovementVO>();
	...
	public VDMovementVO(String ibflag, String pagerows, String seq, String cntrNo, String fmMvmtYdCd, String fmMvmtDt, String bkgNo) {
	 ...
	 * @return VDMovementVO[]
	 */
	public VDMovementVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VDMovementVO[]
	 */
	public VDMovementVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VDMovementVO model = null;
	...
	public VDMovementVO[] getVDMovementVOs(){
		VDMovementVO[] vos = (VDMovementVO[])models.toArray(new VDMovementVO[models.size()]);
		return vos;
	}
