...
*@FileName : GeneralCodeCheckMgtDBDAOsearchPayableInvoiceFileListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralCodeCheckMgtDBDAOsearchPayableInvoiceFileListDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralCodeCheckMgtDBDAOsearchPayableInvoiceFileListDataRSQL
	  * </pre>
	  */
	public GeneralCodeCheckMgtDBDAOsearchPayableInvoiceFileListDataRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralCodeCheckMgtDBDAOsearchPayableInvoiceFileListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
