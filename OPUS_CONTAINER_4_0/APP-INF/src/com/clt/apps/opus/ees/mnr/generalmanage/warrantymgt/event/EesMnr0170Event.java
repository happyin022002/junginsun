...
public class EesMnr0170Event extends EventSupport {
	...
	public CustomWarrantyAlertListVO[] getCustomWarrantyAlertListVOs() {
		CustomWarrantyAlertListVO[] rtnVOs = null;
		if (this.customWarrantyAlertListVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(customWarrantyAlertListVOs, customWarrantyAlertListVOs.length);
		}
		return rtnVOs;
	}

	public void setCustomWarrantyAlertListVOs(CustomWarrantyAlertListVO[] customWarrantyAlertListVOs){
		if(customWarrantyAlertListVOs != null){
			CustomWarrantyAlertListVO[] tmpVOs = java.util.Arrays.copyOf(customWarrantyAlertListVOs, customWarrantyAlertListVOs.length);
			this.customWarrantyAlertListVOs = tmpVOs;
		}
	}
}