...
*@FileName : DMTCalculationTypeMgtDBDAODmtWeekendListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCalculationTypeMgtDBDAODmtWeekendListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DMTCalculationTypeMgtDBDAODmtWeekendListVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.dmt.dmtperformanceanalysis.dmtcalculationtypemgt.integration").append("\n"); 
		query.append("FileName : DMTCalculationTypeMgtDBDAODmtWeekendListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
