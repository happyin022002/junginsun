...
/**
 * OPUS DMTCalculationDBDAO <br>
 * - OPUS-DMTCalulationUtil system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
...
public class DMTCalculationDBDAO extends DBDAOSupport {
	...
	public String searchBscSvrId(String zDcFmYdCd) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBscSvrIdRSQL(), param, velParam);
	...
	public int searchBookingContainerQuantity(String zBkgNo) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBookingContainerQuantityRSQL(), param, velParam);
	...
	public VVDNEtaVO searchInVVDNEta(String bookingNo, String podCode) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOsearchInVVDNEtaRSQL(), param, velParam);
	...
	public VVDNEtaVO searchOutVVDNEta(String bkgNo, String polCode) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOsearchOutVVDNEtaRSQL(), param, velParam);
	...
	public OfficeInfoVO searchOfficeInfoByFmYardCd(String zDbcIoBnd, String zDcFmYdCd)  throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchOfficeInfoByFmYardCdRSQL(), param, velParam);
	...
	public OfficeInfoVO searchOfficeInfoByToYardCd(String zDbcIoBnd, String zDcToYdCd) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchOfficeInfoByToYardCdRSQL(), param, velParam);
	 ...
	 * @throws DAOException
	 */
	public BkgContainerInfoVO searchBkgContainerInfo(String zBkgNo, String zCntrNo  , String zDcFmYdCd, String type) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBkgContainerInfoRSQL(), param, velParam);
	...
	public ChangePODTariffVO changePODTariff(String prmLocCd, String prmDcIoBnd, 
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOChangePODTariffRSQL(), param, velParam);
	...
	public String searchAwkInOut(String zBkgNo, String zCntrNo) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchAwkInOutRSQL(), param, velParam);
	...
	public BasicTariffKeyVO searchBasicTariffByGeneration(BasicTariffParmVO basicTariffParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBasicTariffByGenerationRSQL(), param, velParam);
	...
	public String searchCalculationType(CalculationTypeParmVO calculationTypeParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchCalculationTypeRSQL(), param, velParam);
	 ...
	 * @throws DAOException
	 */
	public long basicFreeTime(String zSvrId  , String zDttCode, long zDtnSeq, long zDtgGrpId, long zDbcBkgQty) throws DAOException {
		long ft_dys = 0;
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBasicFreeTimeRSQL(), param, velParam);
	...
	/**
	 * getDTOCFtime 데이타 모델에 해당되는 값을 불러온다.<br>
	 * 
	...
	public DtocFreeTimeVO getDTOCFtime(DtocFreeTimeParmVO dtocFreeTimeParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDtocFreeTimeRSQL(), param, velParam);
	...
	public int checkChargeCorrection(ChargeArgumentVO chargeArgumentVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOCheckChargeCorrectionRSQL(), param, velParam);
	...
	public String getFixedCmnc(String zVslCd, String zSkdVoyageNo,
			String zSkdDirCd, String zYdCd, String zDttCode, String type) throws DAOException {
		String fixed_cmnc = "";
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetFixedCmncRSQL(), param, velParam);
	...
	public String getNextDay(String prmFromDt) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetNextDayRSQL(), param, velParam);
	...
	public String getInterchangeHR(String prmFromDt, String prmCmncHr) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetInterchangeHRRSQL(), param, velParam);
	...
	public String getGlobalName() throws DAOException {
		...
		try{
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetGlobalNameRSQL(), param, velParam);
			if(dbRowset.next()){ 
	...
	public List<FreeTimeVO> getPrevDay(String prmFromDt) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetPrevDayRSQL(), param, velParam);
	...
	public List<FreeTimeVO> getPlusDay(String rtnFtimeCmnc) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetPlusDayRSQL(), param, velParam);
	 ...
	 * @throws DAOException
	 */
	public List<FreeTimeVO> getTimeClockStopToDt(String prmDttCode, String prmOfcCd, String rtnFtimeCmnc, String prmYardCd) throws DAOException {
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetTimeClockStopToDtRSQL(), param, velParam);
	...
	public String getHolidayToDt(String rtnFtimeCmnc, String cntCd, String rgnCd, String stateCd, String locCd) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetHolidayToDtRSQL(), param, velParam);
	...
	public String getMTDate(String prmSvrId, String prmCntrNo, long prmCnmvCycNo, String prmDttCode, String prmFmCnms) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetMTDateRSQL(), param, velParam);
	...
	public List<OverdayNStatusVO> getOverdayStatus(String str, String str2, long str3, String type, String ofcCd) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetOverdayStatusRSQL(), param, velParam);
	 ...
	 */
    @SuppressWarnings("unchecked")
	public List<StopDaysVO> getStopDays(String prmToDate, String prmDttCode, String prmOfcCd, String prmFtimeEnd, String prmYardCd)  throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetStopDaysRSQL(), param, velParam);
	...
	public List<ChargeListVO> searchDivChrgList(CalculationParmVO calculationParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDivChrgListRSQL(), param, velParam);
	...
	public DmtCmdtGrpVO searchCommodityExceptionByGeneration(CommodityExceptionParmVO commodityExceptionParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchCommodityExceptionByGenerationRSQL(), param, velParam);
	...
	public List<ChargeListVO> searchDivSChrgList(String prmScNo, long prmVerSeq, long prmGrpSeq,	String prmCntrts, long prmOverDay, long prmDivOverDay)throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDivSChrgListRSQL(), param, velParam);
	...
	public List<ChargeListVO> searchDivBChrgList(String prmDarNo, long prmMapgNo, long prmVerSeq, long prmDtlSeq, long prmCmbSeq,	String prmCntrts, long prmOverDay, long prmDivOverDay) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDivBChrgListRSQL(), param, velParam);
	...
	/**
	 * getMinVLDate 데이타 모델에 해당되는 값을 불러온다.<br>
	 * @param String zCntrNo
	 * @param long zCnmvCycNo
	 * @param String zMvmtStsCd
	 * @param String zStartMvmtStsCd
	 * @return String
	 * @throws DAOException
	 */
	public String getMinOCVLDate(String zCntrNo, long zCnmvCycNo, String zMvmtStsCd, String zStartMvmtStsCd)  throws DAOException {
		...
		try{
			...
			param.put("mvmt_sts_cd", 	zMvmtStsCd);
			param.put("start_mvmt_sts_cd", zStartMvmtStsCd);

			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetMinVLDateRSQL(), param, velParam);
	...
	/**
	  ...
	  * @throws DAOException 
	 */
	public DmtOCMvmtVO getMinOCDate(String cntrNo, String cnmvYr, String cnmvSeq, String cnmvSplitNo, String seq)  throws DAOException {
		...
		try{
			...
			param.put("cnmv_seq", 		cnmvSeq);
			param.put("cnmv_split_no",	cnmvSplitNo);
			velParam.put("seq", 		seq);

			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetMinOCDateRSQL(), param, velParam);
			
			if(dbRowset.next()){ 
				dmtOCMvmtVO.setCnmvYr(dbRowset.getString("CNMV_YR"));
				dmtOCMvmtVO.setCnmvSeq(dbRowset.getString("CNMV_SEQ"));
				dmtOCMvmtVO.setCnmvSplitNo(dbRowset.getString("CNMV_SPLIT_NO"));
				dmtOCMvmtVO.setMvmtStsCd(dbRowset.getString("MVMT_STS_CD"));
				dmtOCMvmtVO.setOrgYdCd(dbRowset.getString("ORG_YD_CD"));
				dmtOCMvmtVO.setCnmvEvntDt(dbRowset.getString("CNMV_EVNT_DT"));
			} else {
				log.debug("============================================================================");
				log.debug(" getMinOCVLDate:::: No Data");
				log.debug("============================================================================");
	...
	/**
	  ...
	  * @throws DAOException 
	 */
	public String[] searchCntrKey(String bkgNo, String cntrNo, String zDcFmDate, String zDcFmYdCd, String zDcFmCnms)  throws DAOException {
		...
		try{
			param.put("bkg_no", 		bkgNo);
			param.put("cntr_no", 		cntrNo);
			param.put("fm_mvmt_dt", 	zDcFmDate);
			param.put("fm_mvmt_yd_cd", 	zDcFmYdCd);
			param.put("fm_mvmt_sts_cd",	zDcFmCnms);
			
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchCntrKeyRSQL(), param, velParam);
			
			if(dbRowset.next()){ 
				returnValues[0] = dbRowset.getString("FM_MVMT_YR");;
				returnValues[1] = dbRowset.getString("FM_MVMT_SEQ");;
				returnValues[2] = dbRowset.getString("FM_MVMT_SPLIT_NO");;
			} else {
				log.debug("============================================================================");
				log.debug(" searchCntrKey:::: No Data");
				log.debug("============================================================================");
			}
	...
	public DmtAFTGrpVO searchAFTExceptionByGeneration(AFTExceptionParmVO aftExceptionParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchAFTExceptionByGenerationRSQL(), param, velParam);
	...
	public DmtSCGrpVO searchSCExceptionByGeneration(SCExceptionParmVO scExceptionParmVO)  throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchSCExceptionByGenerationRSQL(), param, velParam);
			if(dbRowset.next()){ 
	...
	public double getLCLExRate(ExchangeRateParmVO exchangeRateParmVO, String SqlOrder) throws DAOException {
		...
		try{
			...
			param.put("ofc_cd",   		DMTCalculationUtil.nullToString(exchangeRateParmVO.getOfcCd())); // 20160510 추가 
			velParam.put("sql_order", SqlOrder); //201003.24 - 1 , 2 에 따라 sql 변경
						
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetLCLExRateRSQL(), param, velParam);
	...
	public double getMonthlyRate(String curCd) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetMonthlyRateRSQL(), param, velParam);
	...
	public double getRoundRate(double acctRateTo, double acctRateFrom) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetRoundRateRSQL(), param, velParam);
	...
	public long getSCEFreeTime(String prmScNo, long prmVerSeq, long prmGrpSeq, long prmQty) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOgetSCEFreeTimeRSQL(), param, velParam);
	...
	public DmtBFRGrpVO searchBFRExceptionByGeneration(BFRExceptionParmVO bfrExceptionParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBFRExceptionByGenerationRSQL(), param, velParam);
			...
			if(dbRowset.next()){ 
				...
				dmtBFRGrpVO.setFtAdjMk(dbRowset.getString("ft_adj_mk")); //[2016.01.04] NYK Add.
			} else {
				log.debug("============================================================================");
	...
	public List<ActCustInfoVO> getCustInfo(String zBkgNo) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetCustInfoRSQL(), param, velParam);
	...
	public double trimCurrencyAmount(double prmAmt, String type) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOTrimCurrencyAmountRSQL(), param, velParam);
	...
	public OverdayNDivVO overdayNDiv(OverdayNDivParmVO overdayNDivParmVO, String type) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOOverdayNDivRSQL(), param, velParam);
	...
	public List<ChargeDataVO> getChargeData(ChargeCalculationParmVO chargeCalculationParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetChargeDataRSQL(), param, velParam);
	...
	public String bbsChargeCalculation(CalculationParmVO calculationParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOBbsChargeCalculationRSQL(), param, velParam);
	 ...
	 * @param String cntCd
	 * @param String weekOfDay
	 * @param String prmExclSat
	 * @param String prmExclSun
	 * @return String
	 * @throws 	DAOException
	 */
	public String checkWeekEnd(String cntCd, String weekOfDay,
			String prmExclSat, String prmExclSun) throws DAOException {
		String exist = "";
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			param.put("cnt_cd", 		cntCd);
			param.put("week_of_day", 	weekOfDay);
			param.put("excl_sat", 		prmExclSat);
			param.put("excl_sun", 		prmExclSun);
			
			
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOCheckWeekEndRSQL(), param, velParam);
	...
	public List<DualTypeExceptionCustInfoVO> getDualTypeExceptionCustInfoBySC(String zBrhScNo)throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetDualTypeExceptionCustInfoBySCRSQL(), param, velParam);
	...
	public List<DualTypeExceptionCustInfoVO> getDualTypeExceptionCustInfoByRFA(String zBrhRfaNo)throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetDualTypeExceptionCustInfoByRFARSQL(), param, velParam);
	...
	public String searchDualTypeExceptionBySC(SCExceptionParmVO scExceptionParmVO)throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDualTypeExceptionBySCRSQL(), param, velParam);
			if(dbRowset.next()){
	...
	public String searchDualTypeExceptionByRFA(BFRExceptionParmVO bfrExceptionParmVO)throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDualTypeExceptionByRFARSQL(), param, velParam);
			if(dbRowset.next()){
				dualFlag = dbRowset.getString("dualflag");
			} else {
				log.debug("============================================================================");
	...
	public MovementVO getMinMovement(MovementParmVO movementParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetMinMovementRSQL(), param, velParam);
	...
	public MovementVO getMaxMovement(MovementParmVO movementParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetMaxMovementRSQL(), param, velParam);
	...
	public MovementVO getPreMovement(MovementParmVO movementParmVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOGetPreMovementRSQL(), param, velParam);
			...
			if(dbRowset.next()){
				...
				movementVO.setBhCnmvCycNo(dbRowset.getString("bh_pre_cnmv_cyc_no"));
			} else {
				log.debug("============================================================================");
	...
	public List<OfficeInfoVO> isCntrOfcTrans(String zSvrId, String zCntrNo, long zCnmvCycNo, String zDttCode, String zLocDiv, long zDccSeq) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOIsCntrOfcTransRSQL(), param, velParam);
			if(dbRowset.next()){
	...
	public BKGRequestInfoVO searchBKGRequestInfo(String zBkgNo,	String zCntrNo  , String zDcFmYdCd) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBKGRequestInfoRSQL(), param, velParam);
	...
	public BookingCustomerBasicVO searchBookingCustomerBasicData(String zBkgNo, String zCntrNo) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBookingCustomerBasicDataRSQL(), param, velParam);
	...
	public ChargeByBookingCustomerCntrVO searchBookingCustomerCntr(String bkgNo, String cntrNo) throws DAOException {
		...
		try{
			param.put("bkg_no",  bkgNo);
			param.put("cntr_no", cntrNo);
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchBookingCustomerCntrRSQL(), param, velParam);
	...
	public List<ChargeByBookingCustomerInvVO> searchChargeByBookingCustomerInvList(String bkgNo, String cntrNo)throws DAOException {
			...
			try{
				...
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchCustomerInvListRSQL(), param, velParam);
	...
	public DMIFnDTICFreeTimeEndDateVO searchDMIFFreeTimeEndDate(String svrId, String cntrNo, long cntrCycNo, String dmdtTrfCd,
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDMIFFreeTimeEndDateRSQL(), param, velParam);
	...
	public DMIFnDTICFreeTimeEndDateVO searchDTICFreeTimeEndDate(String svrId, String cntrNo, long cntrCycNo, String dmdtTrfCd,
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchDTICFreeTimeEndDateRSQL(), param, velParam);
	...
	public String searchSvrId(String zOfcCd)  throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchSvrIdRSQL(), param, velParam);
	...
	/**
	 *  bkgNo 대한 Notification Date를 조회한다.
	 * @param cntrNo
	 * @param FmYdCd
	 * @param bkgNo
	 * @return evntDt
	 * @throws DAOException
	 */
	public String searchNTdate(String cntrNo, String FmYdCd, String bkgNo) throws DAOException {
		DBRowSet dbRowset = null;
		String evntDt = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try{
			param.put("cntr_no", cntrNo);
			param.put("yd_cd", FmYdCd);
			param.put("bkg_no", bkgNo);
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOSearchNTdateRSQL(), param, velParam);
			
			if (dbRowset.next()){
				evntDt = dbRowset.getString("evnt_dt");
			} else {
				log.debug("============================================================================");
				log.debug(" searchNTdate:::: No Data");
				log.debug("============================================================================");
			}
		}catch(SQLException se){
			log.error(se.getMessage(),se);
	...
	/**
	 * getRFAFreeTime 데이타 모델에 해당되는 값을 불러온다.<br>
	 * [2016.01.04] NYK Add
	 * 
	 * @param String prmDarNo
	 ...
	 * @throws DAOException
	 */
	public long getRFAFreeTime(String prmDarNo, long prmMapgSeq, long prmVerSeq, long prmDtlSeq, long prmCmbSeq, long prmDbcBkgQty) throws DAOException {
		long ft_day = 0;
		DBRowSet dbRowset = null;
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			param.put("dar_no"	, prmDarNo);
			param.put("mapg_seq", prmMapgSeq);
			param.put("ver_seq"	, prmVerSeq);
			param.put("dtl_seq"	, prmDtlSeq);
			param.put("cmb_seq"	, prmCmbSeq);
			param.put("qty"		, prmDbcBkgQty);
			
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOgetRFAFreeTimeRSQL(), param, velParam);
			
			if(dbRowset.next()){ 
				ft_day =  dbRowset.getLong("ft_day");
			} else {
				log.debug("============================================================================");
				log.debug(" getRFAFreeTime:::: No Data");
				log.debug("============================================================================");
			}
		}catch(SQLException se){
			log.error(se.getMessage(),se);
	 ...
	 */
	public String[] searchSB45RullingOverday (String cntCd, String locCd, String ydCd, String ioBnd, String effDt, String trfTp) throws DAOException {
		DBRowSet dbRowset = null;
		String[] returnValues = new String[3];
		returnValues[0] = "";
		returnValues[1] = "";
		...
		try {
			...
			velParam.put("trf_tp", trfTp);
			
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOsearchSB45RullingOverdayRSQL(), param, velParam);
			if (dbRowset.next()) {
				returnValues[0] = dbRowset.getString("XCLD_SAT_FLG");
				returnValues[1] = dbRowset.getString("XCLD_SUN_FLG");
				returnValues[2] = dbRowset.getString("XCLD_HOL_FLG");
			}
		} catch (SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	 ...
	 * @Exception SQLException, Exception
	 */
	public String searchPodNodCd (String bkgNo) throws DAOException {
		DBRowSet dbRowset = null;
		String returnValue = "";
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new DMTCalculationDBDAOsearchPodNodCdRSQL(), param, velParam);
			if (dbRowset.next()) {
				returnValue = dbRowset.getString("POD_NOD_CD");
			}
		} catch (SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
