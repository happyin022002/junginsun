...
*@FileName : ChassisMgsetOnOffhireDBDAOsearchCHSStatusHistoryDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOsearchCHSStatusHistoryDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOsearchCHSStatusHistoryDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOsearchCHSStatusHistoryDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND  A.EQ_STS_SEQ  = @[eq_sts_seq]" ).append("\n"); 
