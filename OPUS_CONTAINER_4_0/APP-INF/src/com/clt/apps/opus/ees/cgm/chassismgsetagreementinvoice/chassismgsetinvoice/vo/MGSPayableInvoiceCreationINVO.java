...
*@FileName : MGSPayableInvoiceCreationINVO.java
*@FileTitle : MGSPayableInvoiceCreationINVO
*Open Issues :
*Change history :
...
public class MGSPayableInvoiceCreationINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSPayableInvoiceCreationINVO> models = new ArrayList<MGSPayableInvoiceCreationINVO>();
	...
	public MGSPayableInvoiceCreationINVO() {}
	 ...
	 */
	public MGSPayableInvoiceCreationINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSPayableInvoiceCreationINVO[]
	 */
	public MGSPayableInvoiceCreationINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSPayableInvoiceCreationINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSPayableInvoiceCreationINVO();
				if (currCd[i] != null)
		...
		return getMGSPayableInvoiceCreationINVOs();
	}
	...
	public MGSPayableInvoiceCreationINVO[] getMGSPayableInvoiceCreationINVOs(){
		MGSPayableInvoiceCreationINVO[] vos = (MGSPayableInvoiceCreationINVO[])models.toArray(new MGSPayableInvoiceCreationINVO[models.size()]);
		return vos;
	}
