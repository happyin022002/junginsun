...
*@FileName : CHSHistoricalRptINVO.java
*@FileTitle : CHSHistoricalRptINVO
*Open Issues :
*Change history :
...
public class CHSHistoricalRptINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSHistoricalRptINVO> models = new ArrayList<CHSHistoricalRptINVO>();
	...
	public CHSHistoricalRptINVO() {}

	public CHSHistoricalRptINVO(String ibflag, String pagerows, String crntLccCd, String crntSccCd, String crntYdCd, String inqFmDys, String inqToDys, String period, String periodType, String cnmvStsCd, String cntrPsnStsCd, String reportType, String chss20ftQty, String chss40ftQty, String chss45ftQty) {
	 ...
	 */
	public CHSHistoricalRptINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSHistoricalRptINVO[]
	 */
	public CHSHistoricalRptINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSHistoricalRptINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSHistoricalRptINVO();
		...
		return getCHSHistoricalRptINVOs();
	}
	 ...
	 * @return CHSHistoricalRptINVO[]
	 */
	public CHSHistoricalRptINVO[] getCHSHistoricalRptINVOs(){
		CHSHistoricalRptINVO[] vos = (CHSHistoricalRptINVO[])models.toArray(new CHSHistoricalRptINVO[models.size()]);
		return vos;
	}
