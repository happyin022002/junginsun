...
*@FileName : EES_DMT_6001HTMLAction.java
...
public class EES_DMT_6001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_6001HTMLAction 객체를 생성
	 */
	public EES_DMT_6001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt6001Event event = new EesDmt6001Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCollectionReportParmVO((CollectionReportParmVO)getVO(request, CollectionReportParmVO .class));
		}
