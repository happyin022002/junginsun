...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHirePlanQtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHirePlanQtyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 컨테이너 이송 실행 계획 수정 OnOffHire Plan(EES_EQR_081) DB에 반영한다
	  * INSERT : - REF_ID 생성
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHirePlanQtyCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHirePlanQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_ONF_HIR_PLN_QTY (" ).append("\n"); 
