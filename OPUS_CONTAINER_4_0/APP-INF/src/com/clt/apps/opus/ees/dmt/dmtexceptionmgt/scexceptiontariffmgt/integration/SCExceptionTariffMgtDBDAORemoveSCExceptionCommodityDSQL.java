...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionCommodityDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionCommodityDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff 의 선택한 Group Seq. 에 포함된 모든 Commodity 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionCommodityDSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionCommodityDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
