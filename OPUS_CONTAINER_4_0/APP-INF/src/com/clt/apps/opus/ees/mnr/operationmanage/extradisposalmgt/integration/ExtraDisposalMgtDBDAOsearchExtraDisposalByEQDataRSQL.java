...
*@FileName : ExtraDisposalMgtDBDAOsearchExtraDisposalByEQDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExtraDisposalMgtDBDAOsearchExtraDisposalByEQDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Scrapping Donation Creation 화면에서 조회
	  * </pre>
	  */
	public ExtraDisposalMgtDBDAOsearchExtraDisposalByEQDataRSQL(){
		setQuery();
		...
		query.append("FileName : ExtraDisposalMgtDBDAOsearchExtraDisposalByEQDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
