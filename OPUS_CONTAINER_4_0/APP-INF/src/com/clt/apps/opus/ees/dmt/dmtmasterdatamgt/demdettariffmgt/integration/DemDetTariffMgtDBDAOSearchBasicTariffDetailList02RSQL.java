...
*@FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList02RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchBasicTariffDetailList02RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchBasicTariffDetailList02RSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList02RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY DMDT_TRF_CD, LENGTH(COVRG),COVRG,ORG_DEST,TRF_GRP_SEQ,EFF_DT, EXP_DT" ).append("\n"); 
