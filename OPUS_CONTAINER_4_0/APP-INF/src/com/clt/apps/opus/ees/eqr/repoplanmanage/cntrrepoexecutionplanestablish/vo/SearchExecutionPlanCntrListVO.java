...
public class SearchExecutionPlanCntrListVO extends AbstractValueObject {
	...
	*/
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRstrUsgLblTp(JSPUtil.getParameter(request,	 "rstr_usg_lbl_tp", ""));
		setRstrUsgLblDesc(JSPUtil.getParameter(request,	 "rstr_usg_lbl_desc", ""));
	}
