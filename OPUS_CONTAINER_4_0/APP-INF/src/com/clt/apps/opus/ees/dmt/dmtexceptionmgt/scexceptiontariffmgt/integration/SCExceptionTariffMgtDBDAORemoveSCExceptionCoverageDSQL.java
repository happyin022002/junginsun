...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionCoverageDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionCoverageDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff 의 선택한 Group Seq. 에 포함된 모든 Coverage 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionCoverageDSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionCoverageDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
