...
*@FileName : CHSEqTpSzINVO.java
*@FileTitle : CHSEqTpSzINVO
*Open Issues :
*Change history :
...
public class CHSEqTpSzINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSEqTpSzINVO> models = new ArrayList<CHSEqTpSzINVO>();
	...
	/* Column Info */
	private String modiEqTpszCd = null;
	 ...
	 * @param modiEqTpszCd
	 */
	public CHSEqTpSzINVO(String ibflag, String pagerows, String eqTpszCd, String eqKndCd, String eqTpszRepCd, String dpSeq, String diffDesc, String creUsrId, String creDt, String updUsrId, String updDt, String modiEqTpszCd) {
		this.updDt = updDt;
		this.dpSeq = dpSeq;
		...
		this.modiEqTpszCd = modiEqTpszCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("modi_eq_tpsz_cd", getModiEqTpszCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("modi_eq_tpsz_cd", "modiEqTpszCd");
	 ...
	 * @return modiEqTpszCd
	 */
	public String getModiEqTpszCd() {
		return this.modiEqTpszCd;
	}
	 ...
	 * @param modiEqTpszCd
	 */
	public void setModiEqTpszCd(String modiEqTpszCd) {
		this.modiEqTpszCd = modiEqTpszCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setModiEqTpszCd(JSPUtil.getParameter(request, "modi_eq_tpsz_cd", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return CHSEqTpSzINVO[]
	 */
	public CHSEqTpSzINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSEqTpSzINVO[]
	 */
	public CHSEqTpSzINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSEqTpSzINVO model = null;
		...
		try {
			...
			String[] modiEqTpszCd = (JSPUtil.getParameter(request, prefix	+ "modi_eq_tpsz_cd".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new CHSEqTpSzINVO();
				if (updDt[i] != null)
				...
				if (modiEqTpszCd[i] != null)
					model.setModiEqTpszCd(modiEqTpszCd[i]);
				models.add(model);
			}
	...
	public CHSEqTpSzINVO[] getCHSEqTpSzINVOs(){
		CHSEqTpSzINVO[] vos = (CHSEqTpSzINVO[])models.toArray(new CHSEqTpSzINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.modiEqTpszCd = this.modiEqTpszCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
