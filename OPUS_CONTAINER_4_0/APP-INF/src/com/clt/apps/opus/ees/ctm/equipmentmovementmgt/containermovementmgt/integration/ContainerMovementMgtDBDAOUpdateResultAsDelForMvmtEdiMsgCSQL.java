...
*@FileName : ContainerMovementMgtDBDAOUpdateResultAsDelForMvmtEdiMsgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOUpdateResultAsDelForMvmtEdiMsgCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOUpdateResultAsDelForMvmtEdiMsgCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMgtDBDAOUpdateResultAsDelForMvmtEdiMsgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("             @[edi_mvmt_sts_cd]," ).append("\n"); 
		query.append("             @[evnt_yd_cd]," ).append("\n"); 
		query.append("             GLOBALDATE_PKG.TIME_LOCAL_FNC(DECODE (@[evnt_yd_cd], '', DECODE (@[mvmt_edi_msg_area_cd], 'USA', 'USNYC', 'KOR', 'KRSEL', 'CHN', 'CHSHA', 'SWA', 'SGSIN', 'EUR', 'DEHAM', ''), SUBSTR(@[evnt_yd_cd], 1, 5)))," ).append("\n"); 
		query.append("             GLOBALDATE_PKG.TIME_LOCAL_FNC(DECODE (@[evnt_yd_cd], '', DECODE (@[mvmt_edi_msg_area_cd], 'USA', 'USNYC', 'KOR', 'KRSEL', 'CHN', 'CHSHA', 'SWA', 'SGSIN', 'EUR', 'DEHAM', ''), SUBSTR(@[evnt_yd_cd], 1, 5)))," ).append("\n"); 
