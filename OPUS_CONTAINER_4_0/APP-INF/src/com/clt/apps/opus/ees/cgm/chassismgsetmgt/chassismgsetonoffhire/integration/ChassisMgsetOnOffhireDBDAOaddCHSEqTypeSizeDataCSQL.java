...
public class ChassisMgsetOnOffhireDBDAOaddCHSEqTypeSizeDataCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           (DP_SEQ, EQ_TPSZ_CD, DIFF_DESC, EQ_TPSZ_REP_CD, EQ_KND_CD, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT,MODI_EQ_TPSZ_CD)" ).append("\n"); 
		query.append("     VALUES(@[dp_seq], @[eq_tpsz_cd], @[diff_desc], @[eq_tpsz_rep_cd], @[eq_knd_cd], @[cre_usr_id], SYSDATE, @[upd_usr_id], SYSDATE,@[modi_eq_tpsz_cd])" ).append("\n"); 
