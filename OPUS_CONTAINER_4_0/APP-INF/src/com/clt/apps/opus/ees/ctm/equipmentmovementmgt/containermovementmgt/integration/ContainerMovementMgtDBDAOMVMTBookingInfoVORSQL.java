...
public class ContainerMovementMgtDBDAOMVMTBookingInfoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		NVL(CTR.MTY_PLN_NO, NVL(CTR.MTY_REPO_NO,'')) AS MTY_PLN_NO," ).append("\n"); 
		...
		query.append("       CTR.MVMT_EDI_TP_CD," ).append("\n"); 
		query.append("       CTR.MVMT_EDI_MSG_AREA_CD," ).append("\n"); 
		query.append("       CTR.MVMT_EDI_MSG_YRMONDY," ).append("\n"); 
		query.append("       CTR.MVMT_EDI_MSG_SEQ," ).append("\n"); 
		query.append("       TRNK_VSL_CD||TRNK_SKD_VOY_NO||TRNK_SKD_DIR_CD AS VVD_CD," ).append("\n"); 
		query.append("       CTRT_SEQ," ).append("\n"); 
		query.append("	   TO_CHAR (CTR.DMG_FLG_DT, 'YYYY-MM-DD HH24:MI') AS DMG_FLG_DT," ).append("\n"); 
		query.append("	   TO_CHAR (CTR.DMG_UNFLG_DT, 'YYYY-MM-DD HH24:MI') AS DMG_UNFLG_DT," ).append("\n"); 
		query.append("       CTR.USA_EDI_CD," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("   AND CTR.MVMT_EDI_TP_CD = MSG.MVMT_EDI_TP_CD(+)" ).append("\n"); 
		query.append("   AND CTR.MVMT_EDI_MSG_TP_ID = MSG.MVMT_EDI_MSG_TP_ID(+)" ).append("\n"); 
		query.append("   AND CTR.MVMT_EDI_MSG_AREA_CD = MSG.MVMT_EDI_MSG_AREA_CD(+)" ).append("\n"); 
		query.append("   AND CTR.MVMT_EDI_MSG_YRMONDY = MSG.MVMT_EDI_MSG_YRMONDY(+)" ).append("\n"); 
		query.append("   AND CTR.MVMT_EDI_MSG_SEQ = MSG.MVMT_EDI_MSG_SEQ(+)" ).append("\n"); 
