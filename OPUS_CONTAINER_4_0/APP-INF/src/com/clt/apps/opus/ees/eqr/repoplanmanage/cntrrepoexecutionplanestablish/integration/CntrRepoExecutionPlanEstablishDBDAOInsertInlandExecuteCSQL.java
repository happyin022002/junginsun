...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandExecuteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertInlandExecuteCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * INSERT : - REF_ID 생성
	  * - EQR_INLND_TRSP_EXE_PLN입력
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertInlandExecuteCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandExecuteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_INLND_TRSP_EXE_PLN (" ).append("\n"); 
		...
		query.append(",	@[user_id]" ).append("\n"); 
		query.append(",	SYSDATE" ).append("\n"); 
		query.append(",	(SELECT NVL(MAX(DP_SEQ),0)+1 FROM EQR_INLND_TRSP_EXE_PLN WHERE REPO_PLN_ID = @[repo_pln_id]  AND PLN_SEQ = @[pln_seq])" ).append("\n"); 
		query.append(")" ).append("\n"); 
