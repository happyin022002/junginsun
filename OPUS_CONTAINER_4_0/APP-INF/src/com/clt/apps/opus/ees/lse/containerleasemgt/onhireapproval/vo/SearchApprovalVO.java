...
public class SearchApprovalVO extends AbstractValueObject { 
	...
	public SearchApprovalVO(String ibflag, String pagerows, String q4, String q2, String d2, String o2, String s2, String r2, String a2, String t2, String f2, String p2, String d5, String d4, String o4, String s4, String a4, String f5, String t4, String f4, String r5, String p4, String r4, String d7, String r7, String d9, String d8, String dx, String dw, String d3, String periodStdt, String newVanTpCd, String locCd, String cntrTpszCd, String agmtCtyCd, String lstmCd, String locTp, String agmtSeq, String authNo, String agmtNo, String qtyTotal, String pkupDueDt, String divsion, String periodEddt, String tysz, String q5, String b5, String lstmTpCd) {
		this.t2 = t2;
		this.dw = dw;
		this.p4 = p4;
		this.dx = dx;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("b5", getB5());
		this.hashColumns.put("lstm_tp_cd", getLstmTpCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("b5", "b5");
		this.hashFields.put("lstm_tp_cd", "lstmTpCd");
	 ...
	 * @return lstmTpCd
	 */
	public String getLstmTpCd() {
		return this.lstmTpCd;
	}
	 ...
	 * @param lstmTpCd
	 */
	public void setLstmTpCd(String lstmTpCd) {
		this.lstmTpCd = lstmTpCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setB5(JSPUtil.getParameter(request, "b5", ""));
		setLstmTpCd(JSPUtil.getParameter(request, "lstm_tp_cd", ""));
	}
	...
	public SearchApprovalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] b5 = (JSPUtil.getParameter(request, prefix	+ "b5", length));
			String[] lstmTpCd = (JSPUtil.getParameter(request, prefix	+ "lstm_tp_cd", length));
	...
	*/
	public void unDataFormat(){
		...
		this.b5 = this.b5 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.lstmTpCd = this.lstmTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
