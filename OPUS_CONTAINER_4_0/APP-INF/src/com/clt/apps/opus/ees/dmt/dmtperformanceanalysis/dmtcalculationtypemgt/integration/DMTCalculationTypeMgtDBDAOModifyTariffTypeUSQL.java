...
*@FileName : DMTCalculationTypeMgtDBDAOModifyTariffTypeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCalculationTypeMgtDBDAOModifyTariffTypeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff Type 정보를 변경한다.
	  * </pre>
	  */
	public DMTCalculationTypeMgtDBDAOModifyTariffTypeUSQL(){
		setQuery();
		...
		query.append("FileName : DMTCalculationTypeMgtDBDAOModifyTariffTypeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_TRF_TP" ).append("\n"); 
		query.append("   SET DMDT_TRF_NM = @[dmdt_trf_nm]," ).append("\n"); 
