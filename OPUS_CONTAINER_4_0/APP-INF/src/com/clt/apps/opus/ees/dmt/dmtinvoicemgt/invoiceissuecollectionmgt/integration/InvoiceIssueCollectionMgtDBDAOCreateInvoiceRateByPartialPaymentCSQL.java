...
*@FileName : InvoiceIssueCollectionMgtDBDAOCreateInvoiceRateByPartialPaymentCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOCreateInvoiceRateByPartialPaymentCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOCreateInvoiceRateByPartialPaymentCSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOCreateInvoiceRateByPartialPaymentCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
