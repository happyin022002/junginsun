...
public class EesCgm2019Event extends EventSupport {
	...
	public MGSFoundLostMGTVO[] getMgsFoundLostMGTVOs() {
		MGSFoundLostMGTVO[] rtnVOs = null;
		if (this.mgsFoundLostMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(mgsFoundLostMGTVOs, mgsFoundLostMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setMgsFoundLostMGTVOs(MGSFoundLostMGTVO[] mgsFoundLostMGTVOs){
		if(mgsFoundLostMGTVOs != null){
			MGSFoundLostMGTVO[] tmpVOs = java.util.Arrays.copyOf(mgsFoundLostMGTVOs, mgsFoundLostMGTVOs.length);
			this.mgsFoundLostMGTVOs = tmpVOs;
		}
	}
