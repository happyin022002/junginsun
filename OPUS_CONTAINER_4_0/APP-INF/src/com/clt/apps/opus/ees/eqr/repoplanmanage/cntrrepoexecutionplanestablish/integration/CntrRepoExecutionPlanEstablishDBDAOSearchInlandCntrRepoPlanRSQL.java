...
public class CntrRepoExecutionPlanEstablishDBDAOSearchInlandCntrRepoPlanRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    ,T2_REF_ID REF_ID" ).append("\n"); 
		...
		query.append("	" ).append("\n"); 
		query.append("	,T2_PLN_SEQ PLN_SEQ		-- HIDDEN" ).append("\n"); 
		...
		query.append("    ,SUBSTR(T2_FRLOC, 1, 5) FM_ECC     -- FM ECC" ).append("\n"); 
		query.append("    ,SUBSTR(T2_TOLOC, 1, 5) TO_ECC     -- TO ECC" ).append("\n"); 
		...
		query.append("    ,SOCANCEL_FLAG    -- HIDDEN (SO CANCEL CHECK)" ).append("\n"); 
		query.append("    ,REOPBKG_FLAG     -- HIDDEN (REPO BKG CHECK)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    ,SORT_FRLOC" ).append("\n"); 
		query.append("    ,SORT_TOLOC" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("	,NVL((SELECT 'Y' FROM MDM_EQ_ORZ_CHT EOC, MDM_LOCATION ML WHERE EOC.SCC_CD = ML.SCC_CD  AND ML.LOC_CD = SUBSTR(T2_FRLOC,1,5) AND EOC.DELT_FLG = 'N'" ).append("\n"); 
		...
		query.append("								AND ROWNUM = 1)) , 'Y') AS T2_FM_CHK_FLG  " ).append("\n"); 
		query.append("	,NVL ((SELECT 'Y'FROM MDM_EQ_ORZ_CHT EOC, MDM_LOCATION ML WHERE EOC.SCC_CD = ML.SCC_CD AND ML.LOC_CD = SUBSTR(T2_TOLOC,1,5) AND EOC.DELT_FLG = 'N'" ).append("\n"); 
		query.append("             AND EOC.RCC_CD = (SELECT SUB.RCC_CD FROM MDM_ORGANIZATION MO, MDM_EQ_ORZ_CHT SUB, MDM_LOCATION ML WHERE MO.OFC_CD = @[off_cd]" ).append("\n"); 
		query.append("                                  AND MO.LOC_CD = ML.LOC_CD" ).append("\n"); 
		query.append("                                  AND ML.SCC_CD = SUB.SCC_CD" ).append("\n"); 
		query.append("                                  AND SUB.DELT_FLG = 'N'" ).append("\n"); 
		query.append("                                  AND ROWNUM = 1)) , 'Y') AS T2_TO_CHK_FLG  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	,CASE WHEN DIVISION = 'Plan' THEN " ).append("\n"); 
		query.append("        (SELECT OFC_CD FROM COM_USER WHERE USR_ID = (SELECT UPD_USR_ID FROM EQR_INLND_TRSP_PLN WHERE REPO_PLN_ID =  @[repoPlanID] AND PLN_YRWK = T2_PLN_YRWK AND PLN_SEQ = T2_PLN_SEQ ))" ).append("\n"); 
		query.append("     ELSE " ).append("\n"); 
		query.append("        (SELECT OFC_CD FROM COM_USER WHERE USR_ID = (SELECT UPD_USR_ID FROM EQR_INLND_TRSP_EXE_PLN WHERE REPO_PLN_ID =  @[repoPlanID] AND PLN_YRWK = T2_PLN_YRWK AND PLN_SEQ = T2_PLN_SEQ AND REF_ID = T2_REF_ID))" ).append("\n"); 
		query.append("     END T2_OFC_CD  " ).append("\n"); 
		query.append("             " ).append("\n"); 
		query.append("     ,CASE WHEN DIVISION = 'Plan' THEN " ).append("\n"); 
		query.append("          (SELECT UPD_USR_ID FROM EQR_INLND_TRSP_PLN WHERE REPO_PLN_ID =  @[repoPlanID] AND PLN_YRWK = T2_PLN_YRWK AND PLN_SEQ = T2_PLN_SEQ )" ).append("\n"); 
		query.append("     ELSE " ).append("\n"); 
		query.append("          (SELECT UPD_USR_ID FROM EQR_INLND_TRSP_EXE_PLN WHERE REPO_PLN_ID =  @[repoPlanID] AND	PLN_YRWK = T2_PLN_YRWK AND PLN_SEQ = T2_PLN_SEQ AND REF_ID = T2_REF_ID )" ).append("\n"); 
		query.append("     END T2_UPD_USR_ID " ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append("	,CASE WHEN DIVISION = 'Plan' THEN " ).append("\n"); 
		query.append("         TO_CHAR((SELECT UPD_DT FROM EQR_INLND_TRSP_PLN WHERE REPO_PLN_ID =  @[repoPlanID] AND PLN_YRWK = T2_PLN_YRWK AND PLN_SEQ = T2_PLN_SEQ ),'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append("     ELSE " ).append("\n"); 
		query.append("         TO_CHAR((SELECT UPD_DT FROM EQR_INLND_TRSP_EXE_PLN WHERE REPO_PLN_ID =  @[repoPlanID] AND	PLN_YRWK = T2_PLN_YRWK AND	PLN_SEQ = T2_PLN_SEQ AND REF_ID = T2_REF_ID),'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append("     END T2_UPD_DT " ).append("\n"); 
		query.append("	,DPSEQ" ).append("\n"); 
		query.append("FROM " ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("    PLN_YRWK T2_PLN_YRWK" ).append("\n"); 
		query.append("    ,COMPANY" ).append("\n"); 
		query.append("	,DPSEQ" ).append("\n"); 
		query.append("    ,DIVISION" ).append("\n"); 
		query.append("    ,ITEM" ).append("\n"); 
		query.append("    ,LANE" ).append("\n"); 
		query.append("    ,VVD" ).append("\n"); 
		query.append("    ,FRLOC T2_FRLOC" ).append("\n"); 
		query.append("    ,ETD" ).append("\n"); 
		query.append("    ,TOLOC T2_TOLOC" ).append("\n"); 
		query.append("    ,ETA" ).append("\n"); 
		query.append("    ,PURPOSE" ).append("\n"); 
		query.append("    ,CNTRNO" ).append("\n"); 
		query.append("    ,SOSEND" ).append("\n"); 
		query.append("    ,DECODE(ITEM, 'W', REPOBKG, '') REPOBKG" ).append("\n"); 
		query.append("    ,REF_ID T2_REF_ID" ).append("\n"); 
		query.append("    ,BKG_NO" ).append("\n"); 
		query.append("--    ,BKG_NO_SPLIT" ).append("\n"); 
		query.append("    ,REASON" ).append("\n"); 
		query.append("    ,REASONREMARK" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("	,PLN_SEQ T2_PLN_SEQ		-- HIDDEN" ).append("\n"); 
		query.append("    ,REPO_PLN_ID 	-- HIDDEN" ).append("\n"); 
		query.append("    ,SORTNUM    	-- HIDDEN	PLAN(1), Execution(2), SO(3)를 구분" ).append("\n"); 
		query.append("    ,NUM        	-- HIDDEN 	NORMAL ROW(1), SUB TOTAL(2), GRAND TOTAL(3) 구분" ).append("\n"); 
		query.append("    ,PAST_REPO_PLN_FLG  -- HIDDEN 과거에서 내려온 PLAN (Y)" ).append("\n"); 
		...
		query.append("		,DECODE(B.NUM, 1, A.DPSEQ , 2, '', 3, '') DPSEQ" ).append("\n"); 
		...
		query.append("                ,A.FM_SORT FM_ECC -- SORT에 사용될 SCC의 해당 FM ECC 정보" ).append("\n"); 
		query.append("                ,A.TO_SORT TO_ECC -- SORT에 사용될 SCC의 해당 TO ECC 정보" ).append("\n"); 
		...
		query.append("                    , NVL((SELECT EC.ECC_CD" ).append("\n"); 
		query.append("                       FROM MDM_LOCATION ML, MDM_EQ_ORZ_CHT EC" ).append("\n"); 
		query.append("                       WHERE ML.LOC_CD = SUBSTR(A0.FM_ECC_CD, 1, 5)" ).append("\n"); 
		query.append("                       AND   ML.SCC_CD = EC.SCC_CD" ).append("\n"); 
		query.append("                       AND   ROWNUM    = 1), SUBSTR(A0.FM_ECC_CD, 1, 5)) AS FM_SORT" ).append("\n"); 
		query.append("                   , NVL((SELECT EC.ECC_CD" ).append("\n"); 
		query.append("                       FROM MDM_LOCATION ML, MDM_EQ_ORZ_CHT EC" ).append("\n"); 
		query.append("                       WHERE ML.LOC_CD = SUBSTR(A0.TO_ECC_CD, 1, 5)" ).append("\n"); 
		query.append("                       AND   ML.SCC_CD = EC.SCC_CD" ).append("\n"); 
		query.append("                       AND   ROWNUM    = 1), SUBSTR(A0.TO_ECC_CD, 1, 5)) AS TO_SORT   " ).append("\n"); 
		query.append("                from" ).append("\n"); 
		...
		query.append("				,A.PLN_SEQ" ).append("\n"); 
		query.append("				,A.DP_SEQ           DPSEQ" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("-- query delete" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				,NVL((SELECT A.DP_SEQ" ).append("\n"); 
		query.append("                    FROM EQR_INLND_TRSP_EXE_PLN A" ).append("\n"); 
		query.append("                   WHERE A.REPO_PLN_ID = OUTER.REPO_PLN_ID" ).append("\n"); 
		...
		query.append("	        	MDM_LOCATION F" ).append("\n"); 
		query.append("	        WHERE" ).append("\n"); 
		query.append("				SUBSTR(OUTER.FM_YD_CD, 0, 5) = E.LOC_CD" ).append("\n"); 
		query.append("				      AND   E.SCC_CD = B.SCC_CD" ).append("\n"); 
		...
		query.append("                            MDM_LOCATION F" ).append("\n"); 
		query.append("            			WHERE" ).append("\n"); 
		query.append("							SUBSTR(A.FM_YD_CD, 0, 5) = E.LOC_CD" ).append("\n"); 
		query.append("							      AND E.SCC_CD = B.SCC_CD" ).append("\n"); 
		query.append("            				AND	SUBSTR(A.TO_YD_CD, 0, 5) = F.LOC_CD " ).append("\n"); 
		query.append("            				AND F.SCC_CD = C.SCC_CD" ).append("\n"); 
		...
		query.append(" 	       					AND E.LOC_CD      = D.FM_ECC_CD" ).append("\n"); 
		query.append(" 	       					AND	F.LOC_CD      = D.TO_ECC_CD" ).append("\n"); 
		query.append(" 	        				AND	A.REPO_PLN_ID = @[repoPlanID]" ).append("\n"); 
		...
		query.append("		,DECODE(B.NUM, 1, A.DPSEQ , 2, '', 3, '')" ).append("\n"); 
