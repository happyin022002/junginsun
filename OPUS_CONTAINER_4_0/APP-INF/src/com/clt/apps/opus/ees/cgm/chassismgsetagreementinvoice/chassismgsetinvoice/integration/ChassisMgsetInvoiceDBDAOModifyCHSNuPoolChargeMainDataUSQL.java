...
*@FileName : ChassisMgsetInvoiceDBDAOModifyCHSNuPoolChargeMainDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOModifyCHSNuPoolChargeMainDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.ModifyCHSNuPoolChargeMainData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOModifyCHSNuPoolChargeMainDataUSQL(){
		setQuery();
		...
		params.put("pool_max_rt_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pool_min_rt_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOModifyCHSNuPoolChargeMainDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("CHSS_MGST_INV_STS_CD = @[chss_mgst_inv_sts_cd]," ).append("\n"); 
		...
		query.append("POOL_MAX_RT_AMT = @[pool_max_rt_amt]," ).append("\n"); 
		query.append("POOL_MIN_RT_AMT = @[pool_min_rt_amt]," ).append("\n"); 
		query.append("CHG_SMRY_AMT = @[chg_smry_amt]," ).append("\n"); 
		query.append("INV_SMRY_AMT = @[inv_smry_amt]," ).append("\n"); 
		query.append("INV_USR_ID = @[inv_usr_id]," ).append("\n"); 
