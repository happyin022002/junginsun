...
*@FileName : RFAExceptionTariffMgtDBDAOAddCommodityCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddCommodityCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Commodity Insert
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddCommodityCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddCommodityCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO DMT_RFA_EXPT_CMDT ( " ).append("\n"); 
