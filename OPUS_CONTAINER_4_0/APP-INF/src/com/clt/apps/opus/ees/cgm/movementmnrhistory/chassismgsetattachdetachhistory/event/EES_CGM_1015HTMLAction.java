...
*@FileName : EES_CGM_1015HTMLAction.java
...
public class EES_CGM_1015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1015HTMLAction 객체를 생성
	 */
	public EES_CGM_1015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1015Event event = new EesCgm1015Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsMgsAtdtHistroyMGTvo((CHSAtdtHistoryMGTVO)getVO(request, CHSAtdtHistoryMGTVO .class));
		} else if(command.isCommand(FormCommand.MODIFY)) {
			event.setChsMgsAtdtHistroyMGTvos((CHSAtdtHistoryMGTVO[])getVOs(request, CHSAtdtHistoryMGTVO .class,""));
		}
