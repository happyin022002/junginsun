...
*@FileName : PoolChassisHistoryDBDAOaddPoolChsUseHisSeacasDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PoolChassisHistoryDBDAOaddPoolChsUseHisSeacasDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PoolChassisHistoryDBDAOaddPoolChsUseHisSeacasDataCSQL(){
		setQuery();
		...
		query.append("FileName : PoolChassisHistoryDBDAOaddPoolChsUseHisSeacasDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    @[chss_no] " ).append("\n"); 
		query.append("   , to_date(@[onh_dt],'YYYY-MM-DD HH24:MI:SS', 'NLS_DATE_LANGUAGE = American')" ).append("\n"); 
		query.append("   , decode(@[offh_dt],null,null,'NULL',null,'null',null,'',null,to_date(@[offh_dt],'YYYY-MM-DD HH24:MI:SS', 'NLS_DATE_LANGUAGE = American') )" ).append("\n"); 
		query.append("   , @[pool_chss_usd_dys]" ).append("\n"); 
