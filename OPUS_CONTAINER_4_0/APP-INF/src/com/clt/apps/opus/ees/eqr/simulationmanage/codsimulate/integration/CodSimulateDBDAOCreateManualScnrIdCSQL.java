...
*@FileName : CodSimulateDBDAOCreateManualScnrIdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodSimulateDBDAOCreateManualScnrIdCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CodSimulateDBDAOCreateManualScnrIdCSQL
	  * </pre>
	  */
	public CodSimulateDBDAOCreateManualScnrIdCSQL(){
		setQuery();
		...
		query.append("FileName : CodSimulateDBDAOCreateManualScnrIdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
