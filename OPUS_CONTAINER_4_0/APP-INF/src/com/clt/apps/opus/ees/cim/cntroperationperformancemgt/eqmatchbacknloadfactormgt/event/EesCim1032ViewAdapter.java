...
*@FileName : EesCim1032ViewAdapter.java
 ...
 * @since J2EE 1.5   
 */
public class EesCim1032ViewAdapter extends ViewAdapter {
...
//    				int colCnt = realColNms.length;
    				...
    				if(xTempDvsnVal.equals("Balance")){
    					...
    					sbufXML.append("<TD><![CDATA["+this.checkStringInteger(xTempTotVal)+"]]></TD>\n");
    				}
...
/*  */                  if( xTempYNoVal.equals("1")){     				    
        					...
        					if(xTempDvsnVal.equals("Balance")){
        						...
        						sbufXML.append("<TD><![CDATA["+this.checkStringInteger(xTempStrVal)+"]]></TD>\n");
        					}
