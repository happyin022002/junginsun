...
*@FileName : ChargeCalculationDBDAOChargeBackupByOfficeTransferCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOChargeBackupByOfficeTransferCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addChargeBackupByOfficeTransfer
	  * </pre>
	  */
	public ChargeCalculationDBDAOChargeBackupByOfficeTransferCSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOChargeBackupByOfficeTransferCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",OFC_TRNS_SYS_AREA_GRP_ID" ).append("\n"); 
