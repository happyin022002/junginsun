...
*@FileName : ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SYS_SRC_ID = 'MGS'" ).append("\n"); 
		query.append("AND EXE_YRMON = @[period_eddt]" ).append("\n"); 
		query.append("#if (${div} != '')" ).append("\n"); 
		query.append("AND CNTR_TPSZ_CD = @[div]" ).append("\n"); 
