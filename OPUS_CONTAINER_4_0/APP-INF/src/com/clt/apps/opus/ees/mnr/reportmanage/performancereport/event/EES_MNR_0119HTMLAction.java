...
public class EES_MNR_0119HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0119HTMLAction 객체를 생성
	 */
	public EES_MNR_0119HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0119Event event = new EesMnr0119Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRepairPFMCByRepairCodeINVO((RepairPFMCByRepairCodeINVO)getVO(request, RepairPFMCByRepairCodeINVO .class));
		}
