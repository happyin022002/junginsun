...
*@FileName : ChassisMgsetOnOffhireDBDAOsearchMGSOwnMasterLotDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOsearchMGSOwnMasterLotDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOsearchMGSOwnMasterLotDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOsearchMGSOwnMasterLotDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE A.VNDR_SEQ = D.VNDR_SEQ) AS VNDR_LGL_ENG_NM_EQSPEC," ).append("\n"); 
