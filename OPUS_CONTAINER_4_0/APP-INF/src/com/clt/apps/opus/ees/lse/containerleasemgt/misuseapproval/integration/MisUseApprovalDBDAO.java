...
public class MisUseApprovalDBDAO extends DBDAOSupport {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<MisUseContainerInfoVO> searchMisUseRequestContainerData(String cntrNo, SignOnUserAccount account) throws DAOException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<MisUseReqContainerVO> searchMisUseReqContainerListData(String rqstNo, SignOnUserAccount account) throws DAOException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<MisUseInOutInquiryVO> searchMisUseInOutInquiryListData(SearchParamVO searchParamVO, SignOnUserAccount account) throws DAOException {
