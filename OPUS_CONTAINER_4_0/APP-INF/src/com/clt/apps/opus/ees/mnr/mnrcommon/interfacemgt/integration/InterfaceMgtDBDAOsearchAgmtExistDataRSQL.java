...
*@FileName : InterfaceMgtDBDAOsearchAgmtExistDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceMgtDBDAOsearchAgmtExistDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InterfaceMgtDBDAOsearchAgmtExistDataRSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceMgtDBDAOsearchAgmtExistDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT AGMT_OFC_CTY_CD || AGMT_SEQ AS AGMT_NO" ).append("\n"); 
