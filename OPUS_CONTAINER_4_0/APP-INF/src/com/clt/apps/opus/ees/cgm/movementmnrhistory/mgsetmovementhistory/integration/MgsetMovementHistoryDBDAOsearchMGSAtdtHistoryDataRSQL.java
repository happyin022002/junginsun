...
*@FileName : MgsetMovementHistoryDBDAOsearchMGSAtdtHistoryDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MgsetMovementHistoryDBDAOsearchMGSAtdtHistoryDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MgsetMovementHistoryDBDAOsearchMGSAtdtHistoryDataRSQL(){
		setQuery();
		...
		query.append("FileName : MgsetMovementHistoryDBDAOsearchMGSAtdtHistoryDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                            ,ATDT.CHSS_NO" ).append("\n"); 
		...
		query.append("							,ATDT.CNTR_NO,ATDT.CHSS_NO" ).append("\n"); 
		query.append("							, DECODE(ATCH_dT, DT_LAG1, DECODE(LAG1, DT_LAG2, DECODE(LAG2,DT_LAG3, DECODE( LAG3,DT_LAG4 ,DECODE( LAG4, DT_LAG5 , DECODE(LAG5, DT_LAG6, DECODE(LAG6,DT_LAG7," ).append("\n"); 
