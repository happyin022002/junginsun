...
*@FileName : EES_MST_0022HTMLAction.java
...
public class EES_MST_0022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0022HTMLAction 객체를 생성
	 */
	public EES_MST_0022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0022Event event = new EesMst0022Event();
		

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			event.setMstCntrSpecVO((CntrSpecListBrieflyVO)getVO(request, CntrSpecListBrieflyVO .class));
		}
