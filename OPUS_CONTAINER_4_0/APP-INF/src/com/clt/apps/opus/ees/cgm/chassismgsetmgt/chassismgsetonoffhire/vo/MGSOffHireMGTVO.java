...
*@FileName : MGSOffHireMGTVO.java
*@FileTitle : MGSOffHireMGTVO
*Open Issues :
*Change history :
...
public class MGSOffHireMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSOffHireMGTVO> models = new ArrayList<MGSOffHireMGTVO>();
	...
	public MGSOffHireMGTVO() {}

	public MGSOffHireMGTVO(String ibflag, String pagerows, String stsEvntOfcCd, String agmtRefNo, String no, String agmtSeq, String verify, String agreement, String stsEvntYdCd, String agmtLstmCd, String onhDt, String eqTpszCd, String vndrNm, String delChk, String eqNo, String agmtOfcCtyCd, String vndrSeq, String userId, String stsEvntDt) {
...
/**
	 ...
	 */
	public MGSOffHireMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSOffHireMGTVO[]
	 */
	public MGSOffHireMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSOffHireMGTVO model = null;
	...
	public MGSOffHireMGTVO[] getMGSOffHireMGTVOs(){
		MGSOffHireMGTVO[] vos = (MGSOffHireMGTVO[])models.toArray(new MGSOffHireMGTVO[models.size()]);
		return vos;
	}
