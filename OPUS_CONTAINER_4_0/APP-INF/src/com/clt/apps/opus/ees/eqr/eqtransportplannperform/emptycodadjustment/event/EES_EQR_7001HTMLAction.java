...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.ees.eqr.cntroperationperformancemgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_EQR_7001HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        if(command.isCommand(FormCommand.SEARCH)) {
            ...
            event.setEmptyCODVVDPortVOS((EmptyCODVVDPortVO00[])getVOs(request, EmptyCODVVDPortVO00.class,""));
