...
public class EesCgm1019Event extends EventSupport {
	...
	public CHSLostResultMGTVO[] getChsLostResultMGTVOs() {
		CHSLostResultMGTVO[] rtnVOs = null;
		if (this.chsLostResultMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(chsLostResultMGTVOs, chsLostResultMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setChsLostResultMGTVOs(CHSLostResultMGTVO[] chsLostResultMGTVOs){
		if(chsLostResultMGTVOs != null){
			CHSLostResultMGTVO[] tmpVOs = java.util.Arrays.copyOf(chsLostResultMGTVOs, chsLostResultMGTVOs.length);
			this.chsLostResultMGTVOs = tmpVOs;
		}
	}
