...
*@FileName : EES_LSE_0021HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_LSE_0021HTMLAction extends HTMLActionSupport {
	/*
	 * 객체직렬화 버젼 UID
	 */
	...
	/**
	 * EES_LSE_0021HTMLAction 객체를 생성
	 */
	public EES_LSE_0021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0021Event event = new EesLse0021Event();
		...
		switch(command.getCommand()) {
			...
			case FormCommand.MULTI :	//멀티
				event.setAvailableOffHireDetailVOs((AvailableOffHireDetailVO[])getVOs(request, AvailableOffHireDetailVO.class));
				event.setEmailSendInfoVO((EmailSendInfoVO)getVO(request, EmailSendInfoVO .class));
				break;
			case FormCommand.MULTI01 :	//멀티01
				event.setAvailableOffHireDetailVOs((AvailableOffHireDetailVO[])getVOs(request, AvailableOffHireDetailVO.class));
				break;
			default :	//do nothing
		}
