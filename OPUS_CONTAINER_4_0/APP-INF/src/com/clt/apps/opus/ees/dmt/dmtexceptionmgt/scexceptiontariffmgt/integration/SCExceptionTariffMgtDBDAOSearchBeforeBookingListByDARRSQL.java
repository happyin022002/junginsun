...
public class SCExceptionTariffMgtDBDAOSearchBeforeBookingListByDARRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	, 	DECODE(NVL(FT_ADJ_FLG,'N'), 'N', 'Single', 'Multi') FT_TIR" ).append("\n"); 
		...
		query.append("				,   TRF_DTL.FT_ADJ_FLG " ).append("\n"); 
		query.append("                ,   TRF_DTL.RFA_EXPT_MAPG_SEQ  MAPG_SEQ" ).append("\n"); 
		query.append("			" ).append("\n"); 
