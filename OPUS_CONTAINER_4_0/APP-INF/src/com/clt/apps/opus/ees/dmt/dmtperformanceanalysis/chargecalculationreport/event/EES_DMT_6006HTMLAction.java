...
*@FileName : EES_DMT_6006HTMLAction.java
...
public class EES_DMT_6006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_6006HTMLAction 객체를 생성
	 */
	public EES_DMT_6006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt6006Event event = new EesDmt6006Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSummaryReportByCustomerParmVO((SummaryReportByCustomerParmVO)getVO(request, SummaryReportByCustomerParmVO .class));
		}
