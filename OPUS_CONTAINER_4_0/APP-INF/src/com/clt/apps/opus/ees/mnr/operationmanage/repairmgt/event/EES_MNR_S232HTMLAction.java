...
*@FileName : EES_MNR_S139HTMLAction.java
...
public class EES_MNR_S232HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_S139HTMLAction 객체를 생성
	 */
	public EES_MNR_S232HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnrS232Event event = new EesMnrS232Event(); 
		  	 
		if(command.isCommand(FormCommand.MULTI)) {            
			event.setCustomMnrDatVrfyVOS((CustomMnrDatVrfyVO[])getVOs(request, CustomMnrDatVrfyVO .class,""));
			event.setRPRCreateMgtINVO((VerifyRPRCreateFileListINVO)getVO(request, VerifyRPRCreateFileListINVO .class));
		}  
