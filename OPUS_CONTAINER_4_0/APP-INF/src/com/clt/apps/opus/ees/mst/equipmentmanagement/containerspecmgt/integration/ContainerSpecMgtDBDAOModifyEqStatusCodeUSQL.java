...
*@FileName : ContainerSpecMgtDBDAOModifyEqStatusCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerSpecMgtDBDAOModifyEqStatusCodeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ContainerSpecMgtDBDAOModifyEqStatusCodeUSQL
	  * </pre>
	  */
	public ContainerSpecMgtDBDAOModifyEqStatusCodeUSQL(){
		...
		query.append("FileName : ContainerSpecMgtDBDAOModifyEqStatusCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
