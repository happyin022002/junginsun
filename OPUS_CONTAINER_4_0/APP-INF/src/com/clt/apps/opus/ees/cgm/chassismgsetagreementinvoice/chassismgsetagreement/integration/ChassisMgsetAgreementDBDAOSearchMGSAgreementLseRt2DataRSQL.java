...
*@FileName : ChassisMgsetAgreementDBDAOSearchMGSAgreementLseRt2DataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAOSearchMGSAgreementLseRt2DataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetAgreementDB.SearchMGSAgreementLseRt2Data
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAOSearchMGSAgreementLseRt2DataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAOSearchMGSAgreementLseRt2DataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
