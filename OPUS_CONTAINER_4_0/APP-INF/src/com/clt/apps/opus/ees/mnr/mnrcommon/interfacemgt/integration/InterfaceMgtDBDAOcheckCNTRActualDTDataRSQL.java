...
*@FileName : InterfaceMgtDBDAOcheckCNTRActualDTDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceMgtDBDAOcheckCNTRActualDTDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InterfaceMgtDBDAOcheckCNTRActualDTDataRSQL
	  * </pre>
	  */
	public InterfaceMgtDBDAOcheckCNTRActualDTDataRSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceMgtDBDAOcheckCNTRActualDTDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
