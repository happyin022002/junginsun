...
*@FileName : EES_LSE_0008HTMLAction.java
...
public class EES_LSE_0008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0008HTMLAction 객체를 생성
	 */
	public EES_LSE_0008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0008Event event = new EesLse0008Event();
		...
		if ( command.isCommand(FormCommand.MULTI)) {
			...
			payableRentalCostVO.setLseCtrtNo(request.getParameter("lse_ctrt_no"));
			payableRentalCostVO.setCoCostYrmon(request.getParameter("co_cost_yrmon"));
			//payableRentalCostVO.setLsePayRntlChgCoVOs((LsePayRntlChgCoVO[])getVOs(request, LsePayRntlChgDtlVO.class, "sheet1_"));
		} else if ( command.isCommand(FormCommand.COMMAND01)) {
			payableRentalCostVO.setCoCostYrmon(request.getParameter("co_cost_yrmon"));
			payableRentalCostVO.setUploadFileNm(request.getParameter("upload_file_nm"));
			payableRentalCostVO.setVndrSeq(request.getParameter("vndr_seq"));
		}
