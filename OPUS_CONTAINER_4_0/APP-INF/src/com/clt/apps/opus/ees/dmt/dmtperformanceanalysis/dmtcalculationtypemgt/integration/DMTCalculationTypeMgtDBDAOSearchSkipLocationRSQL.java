...
*@FileName : DMTCalculationTypeMgtDBDAOSearchSkipLocationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCalculationTypeMgtDBDAOSearchSkipLocationRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DMTCalculationTypeMgtDBDAOSearchSkipLocationRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.dmt.dmtperformanceanalysis.dmtcalculationtypemgt.integration").append("\n"); 
		query.append("FileName : DMTCalculationTypeMgtDBDAOSearchSkipLocationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT KEY_LOC_CD," ).append("\n"); 
