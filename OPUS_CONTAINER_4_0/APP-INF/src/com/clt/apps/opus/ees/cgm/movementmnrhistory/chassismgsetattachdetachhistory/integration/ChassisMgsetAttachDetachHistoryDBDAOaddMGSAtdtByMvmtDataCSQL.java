...
*@FileName : ChassisMgsetAttachDetachHistoryDBDAOaddMGSAtdtByMvmtDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAttachDetachHistoryDBDAOaddMGSAtdtByMvmtDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetAttachDetachHistoryDBDAOaddMGSAtdtByMvmtDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAttachDetachHistoryDBDAOaddMGSAtdtByMvmtDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                        FROM CTM_MOVEMENT  M" ).append("\n"); 
		query.append("                        WHERE M.MGST_NO = @[eq_no]" ).append("\n"); 
		query.append("                        AND M.CNMV_EVNT_DT > TO_DATE(@[atch_dt] ,'YYYY-MM-DD HH24:MI:SS') " ).append("\n"); 
