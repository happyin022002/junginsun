...
*@FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionRateAdjustmentDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveBeforeExceptionRateAdjustmentDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 선택한 Before Exception Request 의 Detail 에 해당하는 모든 Rate Adjustment 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveBeforeExceptionRateAdjustmentDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionRateAdjustmentDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_RFA_EXPT_RT" ).append("\n"); 
