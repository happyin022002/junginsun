...
*@FileName : ContainerSpecMgtDBDAOAddEqStatusCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerSpecMgtDBDAOAddEqStatusCodeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ContainerSpecMgtDBDAOAddEqStatusCodeCSQL
	  * </pre>
	  */
	public ContainerSpecMgtDBDAOAddEqStatusCodeCSQL(){
		...
		query.append("FileName : ContainerSpecMgtDBDAOAddEqStatusCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
