...
public class ComboINVO extends AbstractValueObject {
	...
	public ComboINVO(String ibflag, String pagerows, String code1, String code2, String code3, String code4, String code5, String code6, String code7, String code8,
	...
	public Collection<ComboINVO> getModels() {
		return models;
	}

	public void setModels(Collection<ComboINVO> models) {
		this.models = models;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPoolMgmtCoCd(JSPUtil.getParameter(request, "pool_mgmt_co_nm", ""));
	}
