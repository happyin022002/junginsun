...
import com.clt.apps.opus.ees.eqr.repoplanmanage.cntrrepoexecutionplanestablish.vo.EesEqr0143ConditionVO;
...
public class EesEqr0143Event extends EventSupport {
	...
	private EesEqr0143MultiVO[] eesEqr0143MultiVOS = null;
	...
	public EesEqr0143MultiVO[] getEesEqr0143MultiVOS() {
		EesEqr0143MultiVO[] tmpVOs = null;
		if (this.eesEqr0143MultiVOS != null) {
			tmpVOs = new EesEqr0143MultiVO[eesEqr0143MultiVOS.length];
			System.arraycopy(eesEqr0143MultiVOS, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
	...
	public void setEesEqr0143MultiVOS(EesEqr0143MultiVO[] eesEqr0143MultiVOS) {
		if (eesEqr0143MultiVOS != null) {
			EesEqr0143MultiVO[] tmpVOs = new EesEqr0143MultiVO[eesEqr0143MultiVOS.length];
			System.arraycopy(eesEqr0143MultiVOS, 0, tmpVOs, 0, tmpVOs.length);
			this.eesEqr0143MultiVOS = tmpVOs;
		}
	}
