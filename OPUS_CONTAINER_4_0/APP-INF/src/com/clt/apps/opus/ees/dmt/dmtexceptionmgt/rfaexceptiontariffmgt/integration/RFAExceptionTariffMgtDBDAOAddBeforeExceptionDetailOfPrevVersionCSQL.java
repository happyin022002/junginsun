...
*@FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionDetailOfPrevVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddBeforeExceptionDetailOfPrevVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 이전 버전의 모든Before Booking Request 의 Detail 정보를 신규 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddBeforeExceptionDetailOfPrevVersionCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionDetailOfPrevVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,   FT_ADJ_FLG /*2016.01.04 NYK Add*/" ).append("\n"); 
		query.append("    ,   CMDT_FLG   /*2016.01.04 NYK Add*/" ).append("\n"); 
		query.append("		)" ).append("\n"); 
