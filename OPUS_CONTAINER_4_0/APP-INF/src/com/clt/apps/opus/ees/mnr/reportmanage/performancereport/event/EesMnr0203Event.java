...
public class EesMnr0203Event extends EventSupport {
	...
	public void setTirePurcharseBySupplierVOS(TirePurcharseBySupplierVO[] tirePurcharseBySupplierVOs){
		if(tirePurcharseBySupplierVOs != null){
			TirePurcharseBySupplierVO[] tmpVOs = java.util.Arrays.copyOf(tirePurcharseBySupplierVOs, tirePurcharseBySupplierVOs.length);
			this.tirePurcharseBySupplierVOs = tmpVOs;
		}
	}
	...
	public TirePurcharseBySupplierVO[] getTirePurcharseBySupplierVOS(){
		TirePurcharseBySupplierVO[] rtnVOs = null;
		if (this.tirePurcharseBySupplierVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(tirePurcharseBySupplierVOs, tirePurcharseBySupplierVOs.length);
		}
		return rtnVOs;
	}
