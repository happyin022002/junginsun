...
*@FileName : EES_DMT_7012HTMLAction.java
...
public class EES_DMT_7012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_7012HTMLAction 객체를 생성
	 */
	public EES_DMT_7012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt7012Event event = new EesDmt7012Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDmtSkpLocVO((DmtSkpLocVO)getVO(request, DmtSkpLocVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setDmtSkpLocVOs((DmtSkpLocVO[])getVOs(request, DmtSkpLocVO.class, ""));
		}
