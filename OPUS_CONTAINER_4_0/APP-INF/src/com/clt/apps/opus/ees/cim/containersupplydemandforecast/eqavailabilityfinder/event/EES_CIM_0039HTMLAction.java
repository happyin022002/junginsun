...
*@FileName : EES_CIM_0039HTMLAction.java
...
public class EES_CIM_0039HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0001HTMLAction 객체를 생성
	 */
	public EES_CIM_0039HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0039Event event = new EesCim0039Event();
		
		event.setAvailOptionVO((AvailOptionVO)getVO(request, AvailOptionVO .class));
		event.setAvailRepoListVO((AvailRepoListVO)getVO(request, AvailRepoListVO.class));
