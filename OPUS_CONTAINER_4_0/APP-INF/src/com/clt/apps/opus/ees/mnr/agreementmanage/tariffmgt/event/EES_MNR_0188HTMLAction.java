...
*@FileName : EES_MNR_0188HTMLAction.java
...
public class EES_MNR_0188HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0188HTMLAction 객체를 생성
	 */
	public EES_MNR_0188HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0188Event event = new EesMnr0188Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTariffPopupINVO((TariffPopupINVO)getVO(request, TariffPopupINVO .class));
		}
