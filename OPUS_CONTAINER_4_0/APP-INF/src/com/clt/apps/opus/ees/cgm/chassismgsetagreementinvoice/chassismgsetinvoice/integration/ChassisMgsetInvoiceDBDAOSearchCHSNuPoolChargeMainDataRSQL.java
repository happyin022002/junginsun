...
*@FileName : ChassisMgsetInvoiceDBDAOSearchCHSNuPoolChargeMainDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOSearchCHSNuPoolChargeMainDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.SearchCHSNuPoolChargeMainData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOSearchCHSNuPoolChargeMainDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOSearchCHSNuPoolChargeMainDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("A.POOL_MAX_RT_AMT," ).append("\n"); 
		query.append("A.POOL_MIN_RT_AMT," ).append("\n"); 
