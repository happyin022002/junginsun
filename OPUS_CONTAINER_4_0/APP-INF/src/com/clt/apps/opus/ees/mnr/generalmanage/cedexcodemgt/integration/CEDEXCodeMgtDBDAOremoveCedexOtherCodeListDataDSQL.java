...
*@FileName : CEDEXCodeMgtDBDAOremoveCedexOtherCodeListDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CEDEXCodeMgtDBDAOremoveCedexOtherCodeListDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeCedexOtherCodeListData
	  * </pre>
	  */
	public CEDEXCodeMgtDBDAOremoveCedexOtherCodeListDataDSQL(){
		setQuery();
		...
		query.append("FileName : CEDEXCodeMgtDBDAOremoveCedexOtherCodeListDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM mnr_cedex_otr_cd" ).append("\n"); 
