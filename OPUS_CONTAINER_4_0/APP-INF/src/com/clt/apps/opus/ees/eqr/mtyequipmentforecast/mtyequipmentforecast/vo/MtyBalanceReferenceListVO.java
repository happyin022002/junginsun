...
public class MtyBalanceReferenceListVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFcastYrwk0(JSPUtil.getParameter(request, "fcast_yrwk0", ""));
		setTotalFcastQty(JSPUtil.getParameter(request, "total_fcast_qty", ""));
