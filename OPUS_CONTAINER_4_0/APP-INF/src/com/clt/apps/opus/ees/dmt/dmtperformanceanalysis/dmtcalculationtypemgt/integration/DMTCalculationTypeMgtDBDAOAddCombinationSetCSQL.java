...
*@FileName : DMTCalculationTypeMgtDBDAOAddCombinationSetCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCalculationTypeMgtDBDAOAddCombinationSetCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DMTCalculationTypeMgtDBDAOAddCombinationSetCSQL(){
		setQuery();
		...
		query.append("FileName : DMTCalculationTypeMgtDBDAOAddCombinationSetCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_CMB_SET (" ).append("\n"); 
