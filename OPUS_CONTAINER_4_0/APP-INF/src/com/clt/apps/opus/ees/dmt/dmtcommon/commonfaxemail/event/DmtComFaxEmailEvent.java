...
import com.clt.apps.opus.ees.dmt.dmtcommon.commonfinder.event.DMT_COM_HTMLAction;
...
public class DmtComFaxEmailEvent extends EventSupport {
    ...
    */
    public DmtComFaxSndInfoVO[] getDmtComFaxSndInfoVOs() {
    	DmtComFaxSndInfoVO[] tmpVOs = null;
		if (this.dmtComFaxSndInfoVOs != null) {
			tmpVOs = new DmtComFaxSndInfoVO[dmtComFaxSndInfoVOs.length];
			System.arraycopy(dmtComFaxSndInfoVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
    }
    ...
    */
    public void setDmtComFaxSndInfoVOs(DmtComFaxSndInfoVO[] dmtComFaxSndInfoVOs) {
    	if (dmtComFaxSndInfoVOs != null) {
    		DmtComFaxSndInfoVO[] tmpVOs = new DmtComFaxSndInfoVO[dmtComFaxSndInfoVOs.length];
			System.arraycopy(dmtComFaxSndInfoVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.dmtComFaxSndInfoVOs = tmpVOs;
		}
    }
    ...
    */
    public DmtComRDFaxEmailSendInfoVO[] getDmtComRDFaxEmailSendInfoVOs() {
    	DmtComRDFaxEmailSendInfoVO[] tmpVOs = null;
		if (this.dmtComRDFaxEmailSendInfoVOs != null) {
			tmpVOs = new DmtComRDFaxEmailSendInfoVO[dmtComRDFaxEmailSendInfoVOs.length];
			System.arraycopy(dmtComRDFaxEmailSendInfoVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
    }
    ...
    */
    public void setDmtComRDFaxEmailSendInfoVOs(
    	...
    	if (dmtComRDFaxEmailSendInfoVOs != null) {
    		DmtComRDFaxEmailSendInfoVO[] tmpVOs = new DmtComRDFaxEmailSendInfoVO[dmtComRDFaxEmailSendInfoVOs.length];
			System.arraycopy(dmtComRDFaxEmailSendInfoVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.dmtComRDFaxEmailSendInfoVOs = tmpVOs;
		}
    }
