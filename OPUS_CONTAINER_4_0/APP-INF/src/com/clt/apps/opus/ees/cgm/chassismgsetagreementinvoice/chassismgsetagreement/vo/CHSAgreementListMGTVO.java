...
*@FileName : CHSAgreementListMGTVO.java
*@FileTitle : CHSAgreementListMGTVO
*Open Issues :
*Change history :
...
public class CHSAgreementListMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSAgreementListMGTVO> models = new ArrayList<CHSAgreementListMGTVO>();
	 ...
	 * @param request
	 * @return CHSAgreementListMGTVO[]
	 */
	public CHSAgreementListMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSAgreementListMGTVO[]
	 */
	public CHSAgreementListMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSAgreementListMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSAgreementListMGTVO();
				if (lstVerFlg[i] != null)
		...
		return getCHSAgreementListMGTVOs();
	}
	 ...
	 * @return CHSAgreementListMGTVO[]
	 */
	public CHSAgreementListMGTVO[] getCHSAgreementListMGTVOs(){
		CHSAgreementListMGTVO[] vos = (CHSAgreementListMGTVO[])models.toArray(new CHSAgreementListMGTVO[models.size()]);
		return vos;
	}
