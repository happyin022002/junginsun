...
*@FileName : OnhireDomesticNewvanScheduleInputDBDAODeleteYearSubleasePlanDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnhireDomesticNewvanScheduleInputDBDAODeleteYearSubleasePlanDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OnhireDomesticNewvanScheduleInputDBDAODeleteYearSubleasePlanDSQL(){
		setQuery();
		...
		query.append("FileName : OnhireDomesticNewvanScheduleInputDBDAODeleteYearSubleasePlanDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
