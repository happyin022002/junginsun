...
*@FileName : SCExceptionTariffMgtDBDAOAddSCExceptionGroupCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddSCExceptionGroupCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Terms Entry Group 의 단일 정보 입력을 위한 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddSCExceptionGroupCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddSCExceptionGroupCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
