...
public class EesMnr0194Event extends EventSupport {
	...
	public MnrOrderInfoBySparePartVO[] getMnrOrderInfoBySparePartVOs() {
		MnrOrderInfoBySparePartVO[] rtnVOs = null;
		if (this.mnrOrderInfoBySparePartVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(mnrOrderInfoBySparePartVOs, mnrOrderInfoBySparePartVOs.length);
		}
		return rtnVOs;
	}

	public void setMnrOrderInfoBySparePartVOs(MnrOrderInfoBySparePartVO[] mnrOrderInfoBySparePartVOs){
		if(mnrOrderInfoBySparePartVOs != null){
			MnrOrderInfoBySparePartVO[] tmpVOs = java.util.Arrays.copyOf(mnrOrderInfoBySparePartVOs, mnrOrderInfoBySparePartVOs.length);
			this.mnrOrderInfoBySparePartVOs = tmpVOs;
		}
	}
}