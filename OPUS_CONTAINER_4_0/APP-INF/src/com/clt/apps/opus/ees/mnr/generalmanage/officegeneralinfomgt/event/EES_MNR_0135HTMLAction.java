...
public class EES_MNR_0135HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0135HTMLAction 객체를 생성
	 */
	public EES_MNR_0135HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0135Event event = new EesMnr0135Event();
