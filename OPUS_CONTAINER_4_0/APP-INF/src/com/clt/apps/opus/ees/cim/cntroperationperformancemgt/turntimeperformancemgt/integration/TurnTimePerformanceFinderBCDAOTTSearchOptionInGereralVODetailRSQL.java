...
public class TurnTimePerformanceFinderBCDAOTTSearchOptionInGereralVODetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TurnTimePerformanceFinderBCDAOTTSearchOptionInGereralVODetailRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("#if (${inquiryLevel} == 'A')" ).append("\n"); 
			...
			query.append("T.CNTR_TPSZ_CD ) A,CIM_TP_SZ_DP_SEQ_V	S" ).append("\n"); 
		...
		query.append("GROUP BY LOC_CD,DECODE(Y.NO,'1','XX','2','YY')" ).append("\n"); 
		query.append("ORDER BY pol,XXX" ).append("\n"); 

		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.cim.cntroperationperformancemgt.iturntimeperformancefinder.integration").append("\n"); 
		query.append("FileName : ITurnTimePerformanceFinderBCDAOTTSearchOptionInGereralVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}