...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionGroupDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionGroupsDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Terms Entry 에 선택된 Group 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionGroupsDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionGroupDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}