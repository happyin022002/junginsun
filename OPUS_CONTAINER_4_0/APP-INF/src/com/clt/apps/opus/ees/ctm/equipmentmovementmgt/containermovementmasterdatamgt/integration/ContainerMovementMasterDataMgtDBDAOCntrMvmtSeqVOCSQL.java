...
*@FileName : ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Insert Cntr Movement Information
	  * </pre>
	  */
	public ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVOCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CTM_MVMT_SEQ" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("VALUES (@[bkg_cgo_tp_cd]," ).append("\n"); 
		query.append("@[mvmt_sts_cd]," ).append("\n"); 
		query.append("@[cnmv_lvl_no]," ).append("\n"); 
		query.append("@[cnmv_st_psn_flg]," ).append("\n"); 
		query.append("@[cnmv_end_psn_flg]," ).append("\n"); 
