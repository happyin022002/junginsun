...
*@FileName : InvoiceIssueCollectionMgtDBDAOManualKeyByChargeVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOManualKeyByChargeVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 조회된 Charge 정보를 저장할 VO 객체 생성을 위한 쿼리
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOManualKeyByChargeVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.dmt.dmtinvoicemgt.invoiceissuecollectionmgt.integration").append("\n"); 
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOManualKeyByChargeVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
