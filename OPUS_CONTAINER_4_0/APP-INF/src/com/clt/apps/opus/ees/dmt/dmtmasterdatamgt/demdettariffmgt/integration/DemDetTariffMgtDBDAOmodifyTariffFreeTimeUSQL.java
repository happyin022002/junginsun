...
*@FileName : DemDetTariffMgtDBDAOmodifyTariffFreeTimeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOmodifyTariffFreeTimeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOmodifyTariffFreeTimeUSQL(){
		setQuery();
		...
		params.put("ft_to_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ft_fm_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : DemDetTariffMgtDBDAOmodifyTariffFreeTimeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_TRF_FREE_TM" ).append("\n"); 
		query.append("SET FT_FM_QTY = @[ft_fm_qty]" ).append("\n"); 
		query.append(", FT_TO_QTY = @[ft_to_qty]" ).append("\n"); 
