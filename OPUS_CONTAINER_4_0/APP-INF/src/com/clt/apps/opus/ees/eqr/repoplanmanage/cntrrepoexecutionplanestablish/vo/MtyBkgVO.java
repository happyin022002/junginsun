...
public class MtyBkgVO extends AbstractValueObject {
	...
	private MtyBkgCntrVO[] mtyBkgCntrVOs = null;
	
	private EesEqr0059MultiVO eesEqr0059MultiVO = null;
	
	public MtyBkgCntrVO[] getMtyBkgCntrVOs() {
		return mtyBkgCntrVOs;
	}

	public void setMtyBkgCntrVOs(MtyBkgCntrVO[] mtyBkgCntrVOs) {
		this.mtyBkgCntrVOs = mtyBkgCntrVOs;
	}	
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("table_name", "table_name");
