...
public class EesMnr0107Event extends EventSupport {
	...
	public CustomMnrEqDpcVO[] getCustomMnrEqDpcVOs() {
		CustomMnrEqDpcVO[] rtnVOs = null;
		if (this.customMnrEqDpcVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(customMnrEqDpcVOs, customMnrEqDpcVOs.length);
		}
		return rtnVOs;
	}

	public void setCustomMnrEqDpcVOs(CustomMnrEqDpcVO[] customMnrEqDpcVOs){
		if(customMnrEqDpcVOs != null){
			CustomMnrEqDpcVO[] tmpVOs = java.util.Arrays.copyOf(customMnrEqDpcVOs, customMnrEqDpcVOs.length);
			this.customMnrEqDpcVOs = tmpVOs;
		}
	}
}