...
*@FileName : CHECK YARDHTMLAction.java
...
public class CGM_YARD_HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CHECK YARDHTMLAction 객체를 생성
	 */
	public CGM_YARD_HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CgmYardEvent event = new CgmYardEvent();
		

		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setCgmYardINVO((YardINVO)getVO(request, YardINVO .class));
		}
