...
*@FileName : ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseSummaryDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseSummaryDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * chungpa M.G.Set 2206 Summary 조회.
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseSummaryDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseSummaryDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("T1.SYS_SRC_ID = 'MGS' " ).append("\n"); 
		query.append("AND T1.EXE_YRMON = @[period_eddt]" ).append("\n"); 
		query.append("#if (${div} != '')" ).append("\n"); 
		query.append("AND T1.CNTR_TPSZ_CD = @[div]" ).append("\n"); 
