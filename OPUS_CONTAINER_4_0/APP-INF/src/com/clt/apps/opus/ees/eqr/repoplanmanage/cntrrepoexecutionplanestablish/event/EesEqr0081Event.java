...
public class EesEqr0081Event extends EventSupport {
	...
	private EesEqr0081MultiVO[] eesEqr0081MultiVOS = null;
	...
	public EesEqr0081MultiVO[] getEesEqr0081MultiVOS() {
		EesEqr0081MultiVO[] tmpVOs = null;
		if (this.eesEqr0081MultiVOS != null) {
			tmpVOs = new EesEqr0081MultiVO[eesEqr0081MultiVOS.length];
			System.arraycopy(eesEqr0081MultiVOS, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}

	public void setEesEqr0081MultiVOS(EesEqr0081MultiVO[] eesEqr0081MultiVOS) {
		if (eesEqr0081MultiVOS != null) {
			EesEqr0081MultiVO[] tmpVOs = new EesEqr0081MultiVO[eesEqr0081MultiVOS.length];
			System.arraycopy(eesEqr0081MultiVOS, 0, tmpVOs, 0, tmpVOs.length);
			this.eesEqr0081MultiVOS = tmpVOs;
		}
	}
}