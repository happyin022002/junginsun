...
*@FileName : EES_CGM_1117HTMLAction.java
...
public class EES_CGM_1117HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1117HTMLAction 객체를 생성
	 */
	public EES_CGM_1117HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1117Event event = new EesCgm1117Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {	
			event.setChsAgreementListINVO((CHSAgreementListINVO)getVO(request, CHSAgreementListINVO .class));
		}
