...
*@FileName : ChargeCalculationDBDAOModifyInvoiceNoByInvoiceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOModifyInvoiceNoByInvoiceUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Issued 된 Invoice No를 저장
	  * </pre>
	  */
	public ChargeCalculationDBDAOModifyInvoiceNoByInvoiceUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOModifyInvoiceNoByInvoiceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET		DMDT_INV_NO		=	@[dmdt_inv_no]" ).append("\n"); 
