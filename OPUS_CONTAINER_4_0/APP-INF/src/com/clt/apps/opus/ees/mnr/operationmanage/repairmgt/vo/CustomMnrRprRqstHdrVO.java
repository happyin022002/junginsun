...
public class CustomMnrRprRqstHdrVO	extends	 AbstractValueObject
{
	...
	public CustomMnrRprRqstHdrVO(String mnrMeasUtNm,String aproOfcCd,String agmtOfcCd,String pagerows,String vndrNm,String mnrOrdOfcCtyCd,String costCd,String eqDmgTpCd,String rprOffhFlg,String n3ptyBilTtlAmt,String rprRqstSeq,String updUsrId,String mnrEdiNm,String agmtRefNo,String dispNo,String rprStsCd,String agmtSeq,String agmtNo,String mnrRprRmk,String ediId,String trsmModCd,String aproDt,String eqTpszCd,String dmgFlag,String dispFlg,String creUsrId,String trfNo,String agmtOfcCtyCd,String vndrSeq,String autoAmt,String fileSeq,String agmtVerNo,String rprRsltDt,String ifTrcSeq,String recentRprTpCd,String mnrVrfyTpCd,String rqstUsrId,String currCd,String rprRqstVerNo,String rqstRefNo,String mnrInpTpCd,String eqDmgDt,String creDt,String immExt,String rprWrkTpCd,String totalAmt,String upprOfcCd,String ibflag,String rprRqstTmpSeq,String rprDtlStsCd,String rqstEqNo,String rprYdCd,String appovalAmt,String rprRqstLstVerFlg,String n3ptyFlg,String updDt,String rqstDt,String costOfcCd,String rqstUsrNm,String eqKndCd,String dispDtlSeq,String aproUsrId,String mnrOrdSeq,String mnrMeasUtCd,String mvmtDt, String costCdNm, String tmpSeq, String rstrUsgLblTp, String rstrUsgLblVal)	{
	...
	*/
	...
	public CustomMnrRprRqstHdrVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				...
				String[] eqDmgTpCd =	(JSPUtil.getParameter(request, prefix +	"eq_dmg_tp_cd".trim(),	length));
				...
				String[] mnrEdiNm =	(JSPUtil.getParameter(request, prefix +	"mnr_edi_nm".trim(),	length));
				...
				String[] mnrRprRmk =	(JSPUtil.getParameter(request, prefix +	"mnr_rpr_rmk".trim(),	length));
				...
				String[] autoAmt =	(JSPUtil.getParameter(request, prefix +	"auto_amt".trim(),	length));
				...
				String[] recentRprTpCd =	(JSPUtil.getParameter(request, prefix +	"recent_rpr_tp_cd".trim(),	length));
				...
				String[] mnrInpTpCd =	(JSPUtil.getParameter(request, prefix +	"mnr_inp_tp_cd".trim(),	length));
				String[] eqDmgDt =	(JSPUtil.getParameter(request, prefix +	"eq_dmg_dt".trim(),	length));
				String[] creDt =	(JSPUtil.getParameter(request, prefix +	"cre_dt".trim(),	length));
				String[] immExt =	(JSPUtil.getParameter(request, prefix +	"imm_ext".trim(),	length));
				String[] rprWrkTpCd =	(JSPUtil.getParameter(request, prefix +	"rpr_wrk_tp_cd".trim(),	length));
				String[] totalAmt =	(JSPUtil.getParameter(request, prefix +	"total_amt".trim(),	length));
				String[] upprOfcCd =	(JSPUtil.getParameter(request, prefix +	"uppr_ofc_cd".trim(),	length));
				String[] ibflag =	(JSPUtil.getParameter(request, prefix +	"ibflag".trim(),	length));
				String[] rprRqstTmpSeq =	(JSPUtil.getParameter(request, prefix +	"rpr_rqst_tmp_seq".trim(),	length));
				String[] rprDtlStsCd =	(JSPUtil.getParameter(request, prefix +	"rpr_dtl_sts_cd".trim(),	length));
				String[] rqstEqNo =	(JSPUtil.getParameter(request, prefix +	"rqst_eq_no".trim(),	length));
				String[] rprYdCd =	(JSPUtil.getParameter(request, prefix +	"rpr_yd_cd".trim(),	length));
				String[] appovalAmt =	(JSPUtil.getParameter(request, prefix +	"appoval_amt".trim(),	length));
				String[] rprRqstLstVerFlg =	(JSPUtil.getParameter(request, prefix +	"rpr_rqst_lst_ver_flg".trim(),	length));
				...
				String[] mnrMeasUtCd =	(JSPUtil.getParameter(request, prefix +	"mnr_meas_ut_cd".trim(),	length));
				String[] mvmtDt =	(JSPUtil.getParameter(request, prefix +	"mvmt_dt".trim(),	length));
				String[] costCdNm =	(JSPUtil.getParameter(request, prefix +	"cost_cd_nm".trim(),	length));
