...
*@FileName : CollectionDetailReportByOfficeVO.java
*@FileTitle : CollectionDetailReportByOfficeVO
*Open Issues :
*Change history :
...
public class CollectionDetailReportByOfficeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CollectionDetailReportByOfficeVO> models = new ArrayList<CollectionDetailReportByOfficeVO>();
	...
	public CollectionDetailReportByOfficeVO(String porCd, String bzcTrfCurrCd,
			String cntrCycNo, String aftExptDcAmt, String bkgRcvTermCd,
			String chgSeq, String bilAmt, String blNo, String lane,
			String pagerows, String fxFtOvrDys, String issDt, String rfaNo,
			String svrId, String polCd, String ibflag, String dmdtChgStsCd,
			String vvdCd, String scNo, String cntrTpszCd, String ftEndDt,
			String dmdtTrfCd, String toMvmtDt, String ofcRhqCd,
			String dmdtChgLocDivCd, String fmMvmtYdCd, String chgType,
			String toMvmtStsCd, String invChgAmt, String fmMvmtStsCd,
			String exptAmt, String dmdtInvNo, String delCd,
			String dmdtCntrTpCd, String invCurrCd, String ftCmncDt,
			String socFlg, String podCd, String ofcCd, String bkgNo,
			String ftDys, String cntrNo, String fmMvmtDt, String dmdtArIfCd,
			String orgChgAmt, String bkgDeTermCd, String toMvmtYdCd,
			String svcScpCd, String dueDate, String paymentAmt, String otsAmt,
			String bound, String arIfOfcCd, String actPayrNm, String actPayrCd) {
		this.porCd = porCd;
		this.bzcTrfCurrCd = bzcTrfCurrCd;
		this.cntrCycNo = cntrCycNo;
		this.aftExptDcAmt = aftExptDcAmt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("payment_amt", getPaymentAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("payment_amt", "paymentAmt");
	...
	/**
	 * @param otsAmt the otsAmt to set
	 */
	...
	/**
	 * @param arIfOfcCd the arIfOfcCd to set
	 */
	...
	/**
	 * @param actPayrNm the actPayrNm to set
	 */
	...
	/**
	 * @param actPayrCd the actPayrCd to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPaymentAmt(JSPUtil.getParameter(request, "payment_amt", ""));
		...
		setActPayrNm(JSPUtil.getParameter(request, "act_payr_nm", ""));
		setActPayrCd(JSPUtil.getParameter(request, "act_payr_cd", ""));
	}
	 ...
	 */
	public CollectionDetailReportByOfficeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CollectionDetailReportByOfficeVO[]
	 */
	public CollectionDetailReportByOfficeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CollectionDetailReportByOfficeVO model = null;
		...
		try {
			...
			String[] paymentAmt =(JSPUtil.getParameter(request, prefix + "payment_amt", length));
			...
			for (int i = 0; i < length; i++) {
				model = new CollectionDetailReportByOfficeVO();
				if (porCd[i] != null)
				...
				if(paymentAmt[i] != null)
					model.setPaymentAmt(paymentAmt[i]);
				if(    otsAmt    [i] != null)
		...
		return getCollectionDetailReportByOfficeVOs();
	}
	 ...
	 * @return CollectionDetailReportByOfficeVO[]
	 */
	public CollectionDetailReportByOfficeVO[] getCollectionDetailReportByOfficeVOs(){
		CollectionDetailReportByOfficeVO[] vos = (CollectionDetailReportByOfficeVO[])models.toArray(new CollectionDetailReportByOfficeVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.paymentAmt  = this.paymentAmt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
