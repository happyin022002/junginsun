...
public class CntrLotVO	extends	 AbstractValueObject
{
	...
	/*	Column Info	*/
	private  String	 mftYdCd   =  null;
	/*	Column Info	*/
	private  String	 deDt   =  null;
	/*	Column Info	*/
	private  String	 orgDeDt   =  null;
	/*	Column Info	*/
	...
	public CntrLotVO(String lotSeq,String minTemp,String lotLocCd,String pagerows,String effDt,String orgMftVndrSeq,String orgRfMdlNm,String orgRfMkrSeq,String cntrTpszCd,String orgRfRfrNo,String aproTirNo,String toSerNo,String lstmCd,String updUsrId,String unitType,String agmtSeq,String agmtNo,String coCreFlg,String creUsrId,String vndrSeq,String vndrAbbrNm,String orgMinTemp,String rfRfrNo,String cntrHngrRckCd,String orgAgmtNo,String cntrSpecNo,String orgCertiNo,String fmSerNo,String vndrLglEngNm,String lotPlnYr,String orgDeYrmon,String rfMdlNm,String lotNo2,String ibflag,String certiNo,String lotCntrPfxCd,String agmtCtyCd,String aproUicNo,String expDt,String orgPlstFlrFlg,String rangeCount,String mftVndrSeq,String orgFctrySpecNo,String lotNo,String orgCntrHngrRckCd,String aproTctNo,String plstFlrFlg,String deYrmon,String maxTemp,String mftDt,String faIfGrpStsCd,String rfMkrSeq,String ofcCd,String diffRmk,String orgMftDt,String fctrySpecNo,String aproCscNo,String cntrMtrlCd,String orgMaxTemp,String messageErr,String cntrNo,String rfHumidCtrlValCd,String rfCmprCtnt,String cType,String mftYdCd,String deDt,String orgDeDt,String pTime)	{
		this.lotSeq  = lotSeq ;
		...
		this.cType  = cType ;
		this.mftYdCd  = mftYdCd ;
		this.deDt  = deDt ;
		this.orgDeDt  = orgDeDt ;
		this.pTime  = pTime ;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mft_yd_cd", getMftYdCd());		
		this.hashColumns.put("de_dt", getDeDt());		
		this.hashColumns.put("org_de_dt", getOrgDeDt());		
		this.hashColumns.put("p_time", getPTime());		
	...
	public  HashMap<String, String>  getFieldNames(){
		...
		this.hashFields.put("mft_yd_cd", "mftYdCd");
		this.hashFields.put("de_dt", "deDt");
		this.hashFields.put("org_de_dt", "orgDeDt");
		this.hashFields.put("p_time", "pTime");
 ...
 //	Getters	and	Setters
	...
	* @param  mftYdCd
	*/
	public void	setMftYdCd( String	mftYdCd ) {
		this.mftYdCd =	mftYdCd;
	}
	...
	* @param  orgDeDt
	*/
	public void	setOrgDeDt( String	orgDeDt ) {
		this.orgDeDt =	orgDeDt;
	}
	...
	*/
	...
	public void	fromRequest(HttpServletRequest request,	String prefix) {
		...
		setMftYdCd(JSPUtil.getParameter(request,	prefix + "mft_yd_cd", ""));
		setDeDt(JSPUtil.getParameter(request,	prefix + "de_dt", ""));
		setOrgDeDt(JSPUtil.getParameter(request,	prefix + "org_de_dt", ""));
		setPTime(JSPUtil.getParameter(request,	prefix + "p_time", ""));
	}
	...
	public CntrLotVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				...
				String[] orgMftVndrSeq =	(JSPUtil.getParameter(request, prefix +	"org_mft_vndr_seq".trim(),	length));
				String[] orgRfMdlNm =	(JSPUtil.getParameter(request, prefix +	"org_rf_mdl_nm".trim(),	length));
				String[] orgRfMkrSeq =	(JSPUtil.getParameter(request, prefix +	"org_rf_mkr_seq".trim(),	length));
				String[] cntrTpszCd =	(JSPUtil.getParameter(request, prefix +	"cntr_tpsz_cd".trim(),	length));
				String[] orgRfRfrNo =	(JSPUtil.getParameter(request, prefix +	"org_rf_rfr_no".trim(),	length));
				...
				String[] unitType =	(JSPUtil.getParameter(request, prefix +	"unit_type".trim(),	length));
				...
				String[] coCreFlg =	(JSPUtil.getParameter(request, prefix +	"co_cre_flg".trim(),	length));
				String[] creUsrId =	(JSPUtil.getParameter(request, prefix +	"cre_usr_id".trim(),	length));
				String[] vndrSeq =	(JSPUtil.getParameter(request, prefix +	"vndr_seq".trim(),	length));
				String[] vndrAbbrNm =	(JSPUtil.getParameter(request, prefix +	"vndr_abbr_nm".trim(),	length));
				String[] orgMinTemp =	(JSPUtil.getParameter(request, prefix +	"org_min_temp".trim(),	length));
				...
				String[] orgCertiNo =	(JSPUtil.getParameter(request, prefix +	"org_certi_no".trim(),	length));
				...
				String[] orgDeYrmon =	(JSPUtil.getParameter(request, prefix +	"org_de_yrmon".trim(),	length));
				String[] rfMdlNm =	(JSPUtil.getParameter(request, prefix +	"rf_mdl_nm".trim(),	length));
				String[] lotNo2 =	(JSPUtil.getParameter(request, prefix +	"lot_no2".trim(),	length));
				...
				String[] orgPlstFlrFlg =	(JSPUtil.getParameter(request, prefix +	"org_plst_flr_flg".trim(),	length));
				String[] rangeCount =	(JSPUtil.getParameter(request, prefix +	"range_count".trim(),	length));
				String[] mftVndrSeq =	(JSPUtil.getParameter(request, prefix +	"mft_vndr_seq".trim(),	length));
				String[] orgFctrySpecNo =	(JSPUtil.getParameter(request, prefix +	"org_fctry_spec_no".trim(),	length));
				String[] lotNo =	(JSPUtil.getParameter(request, prefix +	"lot_no".trim(),	length));
				String[] orgCntrHngrRckCd =	(JSPUtil.getParameter(request, prefix +	"org_cntr_hngr_rck_cd".trim(),	length));
				...
				String[] orgMftDt =	(JSPUtil.getParameter(request, prefix +	"org_mft_dt".trim(),	length));
				...
				String[] orgMaxTemp =	(JSPUtil.getParameter(request, prefix +	"org_max_temp".trim(),	length));
				...
				String[] cType =	(JSPUtil.getParameter(request, prefix +	"c_type".trim(),	length));
				String[] mftYdCd =	(JSPUtil.getParameter(request, prefix +	"mft_yd_cd".trim(),	length));
				String[] deDt =	(JSPUtil.getParameter(request, prefix +	"de_dt".trim(),	length));
				String[] orgDeDt =	(JSPUtil.getParameter(request, prefix +	"org_de_dt".trim(),	length));
				String[] pTime =	(JSPUtil.getParameter(request, prefix +	"p_time".trim(),	length));
				for	(int i = 0;	i <	length;	i++) {
					model =	new	CntrLotVO();
						...
						if ( mftYdCd[i] !=	null)
						model.setMftYdCd( mftYdCd[i]);
						if ( deDt[i] !=	null)
						model.setDeDt( deDt[i]);
						if ( orgDeDt[i] !=	null)
						model.setOrgDeDt( orgDeDt[i]);
						if ( pTime[i] !=	null)
						model.setPTime( pTime[i]);
					 models.add(model);
				}
	...
	*/
	public void	unDataFormat(){
		...
		this.mftYdCd =	this.mftYdCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.deDt =	this.deDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.orgDeDt =	this.orgDeDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.pTime =	this.pTime.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}	
}