...
public class EesCgm1001Event extends EventSupport {
	...
	public void setCHSEqTpSzINVOS(CHSEqTpSzINVO[] cHSCgmEqTpSzINVOs){
		if(cHSCgmEqTpSzINVOs != null){
			CHSEqTpSzINVO[] tmpVOs = java.util.Arrays.copyOf(cHSCgmEqTpSzINVOs, cHSCgmEqTpSzINVOs.length);
			this.cHSCgmEqTpSzINVOs = tmpVOs;
		}
	}
	...
	public CHSEqTpSzINVO[] getCHSEqTpSzINVOS(){
		CHSEqTpSzINVO[] rtnVOs = null;
		if (this.cHSCgmEqTpSzINVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(cHSCgmEqTpSzINVOs, cHSCgmEqTpSzINVOs.length);
		}
		return rtnVOs;
	}
}
