...
public class GeneralCodeCheckMgtDBDAOsearchVerifyToEstimateDtlDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(" A.INP_MSG1  AS EQ_LOC_CD" ).append("\n"); 
		...
		query.append(",A.INP_MSG11 AS RPR_LBR_HRS" ).append("\n"); 
		...
		query.append("    AND MNR_CD_ID = INP_MSG19) AS COST_CD_NM" ).append("\n"); 
		query.append("FROM MNR_DAT_VRFY A" ).append("\n"); 
		query.append("WHERE " ).append("\n"); 
		query.append("A.TMP_SEQ = @[tmp_seq]" ).append("\n"); 
