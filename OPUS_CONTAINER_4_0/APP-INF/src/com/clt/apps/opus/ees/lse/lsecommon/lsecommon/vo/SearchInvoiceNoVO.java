...
*@FileName : SearchInvoiceNoVO.java
*@FileTitle : SearchInvoiceNoVO
*Open Issues :
*Change history :
...
public class SearchInvoiceNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchInvoiceNoVO> models = new ArrayList<SearchInvoiceNoVO>();
	...
	public SearchInvoiceNoVO() {}

	public SearchInvoiceNoVO(String ibflag, String pagerows, String mdlCd, String invNo, String vndrSeq, String ofcCd, String curCd, String invAmt, String csrNo, String refPk) {
		this.invNo = invNo;
		this.csrNo = csrNo;
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public SearchInvoiceNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchInvoiceNoVO[]
	 */
	public SearchInvoiceNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchInvoiceNoVO model = null;
	...
	public SearchInvoiceNoVO[] getSearchInvoiceNoVOs(){
		SearchInvoiceNoVO[] vos = (SearchInvoiceNoVO[])models.toArray(new SearchInvoiceNoVO[models.size()]);
		return vos;
	}
