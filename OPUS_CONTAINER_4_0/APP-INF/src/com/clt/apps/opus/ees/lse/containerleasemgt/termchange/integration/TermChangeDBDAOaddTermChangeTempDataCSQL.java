...
*@FileName : TermChangeDBDAOaddTermChangeTempDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TermChangeDBDAOaddTermChangeTempDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Lease Term Change 엑셀 로드 할때 사용되는 Temp 쿼리
	  * </pre>
	  */
	public TermChangeDBDAOaddTermChangeTempDataCSQL(){
		setQuery();
		...
		query.append("FileName : TermChangeDBDAOaddTermChangeTempDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
