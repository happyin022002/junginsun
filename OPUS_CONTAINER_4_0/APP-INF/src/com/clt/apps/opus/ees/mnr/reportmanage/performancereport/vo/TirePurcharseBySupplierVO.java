...
*@FileName : TirePurcharseBySupplierVO.java
*@FileTitle : TirePurcharseBySupplierVO
*Open Issues :
*Change history :
...
public class TirePurcharseBySupplierVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TirePurcharseBySupplierVO> models = new ArrayList<TirePurcharseBySupplierVO>();
	...
	public TirePurcharseBySupplierVO() {}

	public TirePurcharseBySupplierVO(String ibflag, String pagerows, String type, String supCd, String title, String cd01, String cd02, String cd03, String cd04, String cd10, String cd05, String cd06, String cd07, String cd08, String cur, String cd09, String ofc, String supNm, String rhq, String brandNm) {
	 ...
	 * @param request
	 * @return TirePurcharseBySupplierVO[]
	 */
	public TirePurcharseBySupplierVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TirePurcharseBySupplierVO[]
	 */
	public TirePurcharseBySupplierVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TirePurcharseBySupplierVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TirePurcharseBySupplierVO();
				if (brandNm[i] != null)
		...
		return getTirePurcharseBySupplierVOs();
	}
	...
	public TirePurcharseBySupplierVO[] getTirePurcharseBySupplierVOs(){
		TirePurcharseBySupplierVO[] vos = (TirePurcharseBySupplierVO[])models.toArray(new TirePurcharseBySupplierVO[models.size()]);
		return vos;
	}
