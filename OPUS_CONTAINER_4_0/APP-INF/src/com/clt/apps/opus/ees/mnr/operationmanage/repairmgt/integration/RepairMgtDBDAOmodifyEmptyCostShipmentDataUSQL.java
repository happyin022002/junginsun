...
*@FileName : RepairMgtDBDAOmodifyEmptyCostShipmentDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOmodifyEmptyCostShipmentDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RepairMgtDBDAOmodifyEmptyCostShipmentDataUSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOmodifyEmptyCostShipmentDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MNR_ORD_DTL" ).append("\n"); 
		...
		query.append("   AND MNR_ORD_OFC_CTY_CD = @[mnr_ord_ofc_cty_cd]" ).append("\n"); 
