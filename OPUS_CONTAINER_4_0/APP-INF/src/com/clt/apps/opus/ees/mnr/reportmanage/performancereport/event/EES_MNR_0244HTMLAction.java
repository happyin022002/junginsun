...
*@FileName : EES_MNR_0244HTMLAction.java
 ...
 * @author Jang Jun-Woo
 * @see EesMnr0244Event 참조
 * @since J2EE 1.6
 */

public class EES_MNR_0244HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0244HTMLAction 객체를 생성
	 */
	public EES_MNR_0244HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesMnr0244Event event = new EesMnr0244Event();

    	switch(command.getCommand()) {
			case FormCommand.SEARCH :	//조회
				event.setDisposalPFMCByRCCVO((DisposalPFMCByRCCVO)getVO(request, DisposalPFMCByRCCVO .class));
			default :	//do nothing
    	}
