...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOUpdateInitInlandExecuteUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOUpdateInitInlandExecuteUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_INLND_TRSP_EXE_PLN 수정   ( 해당 REF_ID )
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOUpdateInitInlandExecuteUSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOUpdateInitInlandExecuteUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
