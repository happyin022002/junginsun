...
*@FileName : EES_MNR_0230HTMLAction.java
...
public class EES_MNR_0230HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0230HTMLAction 객체를 생성
	 */
	public EES_MNR_0230HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0230Event event = new EesMnr0230Event();
			
		ACEPListGRPVO aCEPListGRPVO = new ACEPListGRPVO();
			
		//조회 
		if(command.isCommand(FormCommand.SEARCH)) {	 
			aCEPListGRPVO.setACEPListINVO((ACEPListINVO)getVO(request, ACEPListINVO.class));
		}	
		event.setACEPListGRPVO(aCEPListGRPVO);	   	           
