...
public class RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDARRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	AND RP_HDR.RFA_NO = ( SELECT RFA_NO FROM BKG_BOOKING WHERE BKG_NO = @[bkg_no] )" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	#if(${bl_no} != '')" ).append("\n"); 
		query.append("	AND RP_HDR.RFA_NO = ( SELECT RFA_NO FROM BKG_BOOKING WHERE BL_NO = @[bl_no] )" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
