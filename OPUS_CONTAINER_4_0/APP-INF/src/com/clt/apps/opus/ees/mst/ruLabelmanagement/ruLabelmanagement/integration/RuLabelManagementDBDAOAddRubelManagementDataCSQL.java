...
*@FileName : RuLabelManagementDBDAOAddRubelManagementDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RuLabelManagementDBDAOAddRubelManagementDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RU Label Maintenace Insert
	  * </pre>
	  */
	public RuLabelManagementDBDAOAddRubelManagementDataCSQL(){
		setQuery();
		...
		params.put("rstr_usg_dp_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : RuLabelManagementDBDAOAddRubelManagementDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MST_RSTR_USG_CD (" ).append("\n"); 
		query.append("	RSTR_USG_CD_SEQ" ).append("\n"); 
		query.append(",	RSTR_USG_TP_CD" ).append("\n"); 
		query.append(",	RSTR_USG_LBL_NM" ).append("\n"); 
		query.append(",	RSTR_USG_LBL_DESC" ).append("\n"); 
		query.append(",	RSTR_USG_DP_SEQ" ).append("\n"); 
		...
		query.append(" mst_rstr_usg_cd_seq.nextval" ).append("\n"); 
		query.append(",   @[rstr_usg_tp_cd]" ).append("\n"); 
		query.append(",	@[rstr_usg_lbl_nm]" ).append("\n"); 
		query.append(",	@[rstr_usg_lbl_desc]" ).append("\n"); 
		query.append(",	@[rstr_usg_dp_seq]" ).append("\n"); 
