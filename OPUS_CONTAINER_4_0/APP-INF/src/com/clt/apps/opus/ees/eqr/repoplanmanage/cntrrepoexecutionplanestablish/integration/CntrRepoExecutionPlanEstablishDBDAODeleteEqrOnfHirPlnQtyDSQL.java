...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnQtyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnQtyDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Plan만 있는경우EQR_ONF_HIR_PLN_QTY 데이타 삭제
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnQtyDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnQtyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
