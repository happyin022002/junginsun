...
*@FileName : CustomMnrCdRltByRprVO.java
*@FileTitle : CustomMnrCdRltByRprVO
*Open Issues :
*Change history :
...
public class CustomMnrCdRltByRprVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomMnrCdRltByRprVO> models = new ArrayList<CustomMnrCdRltByRprVO>();
	...
	public CustomMnrCdRltByRprVO() {}

	/**
	 * CustomMnrCdRltByRprVO 객체 생성
	 */
	public CustomMnrCdRltByRprVO(String ibflag, String pagerows, String g, String code, String description, String eqCedexRltTpCd, String fmRltCd, String toRltCd, String creUsrId, String creDt, String updUsrId, String updDt, String eqCmpoCd) {
		this.ibflag = ibflag;
	 ...
	 * @return	CustomMnrCdRltByRprVO[]   VO배열로    
	 */
	public CustomMnrCdRltByRprVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return	CustomMnrCdRltByRprVO[]   VO배열로    
	 */
	public CustomMnrCdRltByRprVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMnrCdRltByRprVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CustomMnrCdRltByRprVO();
				if (ibflag[i] != null)
	 ...
	 * @return	CustomMnrCdRltByRprVO[]   VO배열로    
	 */
	public CustomMnrCdRltByRprVO[] getsearchCodeRelationByDamageDataVOs(){
		CustomMnrCdRltByRprVO[] vos = (CustomMnrCdRltByRprVO[])models.toArray(new CustomMnrCdRltByRprVO[models.size()]);
		return vos;
	}
