...
*@FileName : ChassisMgsetInvoiceDBDAOAddCHSChargeCreateHONDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOAddCHSChargeCreateHONDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.AddCHSChargeCreateHONData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOAddCHSChargeCreateHONDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOAddCHSChargeCreateHONDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    MAX(LSE_USE_DAYS) AS LSE_USE_DAYS," ).append("\n"); 
		...
		query.append("                'HON' AS CH7_CD," ).append("\n"); 
		...
		query.append("                T1.ONH_HNDL_RT_AMT AS LSE_RT_AMT," ).append("\n"); 
		query.append("                T1.ONH_HNDL_RT_AMT AS LSE_CHG_AMT," ).append("\n"); 
		...
		query.append("				'EQCZLT' AS COST_CD," ).append("\n"); 
		query.append("				'510835' AS ACCT_CD" ).append("\n"); 
		...
		query.append("                AND T1.EQ_KND_CD = 'Z'" ).append("\n"); 
		query.append("                AND T2.EQ_KND_CD = 'Z'" ).append("\n"); 
