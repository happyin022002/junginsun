...
*@FileName : LongstayingUnclaimEQFlaggingDBDAOsearchSDaysListTotalDaysDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LongstayingUnclaimEQFlaggingDBDAOsearchSDaysListTotalDaysDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LongstayingUnclaimEQFlaggingDBDAOsearchSDaysListTotalDaysDetailRSQL(){
		setQuery();
		...
		query.append("FileName : LongstayingUnclaimEQFlaggingDBDAOsearchSDaysListTotalDaysDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,SLN_CD" ).append("\n"); 
		query.append("    ,SLN_LANE_CD" ).append("\n"); 
		...
		query.append("(SELECT" ).append("\n"); 
		query.append("    ROW_NUMBER() OVER (ORDER BY A.CNTR_NO) AS ROW_SEQ" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	,MAX(A.VNDR_CD) VNDR_CD" ).append("\n"); 
		query.append("    ,MAX(A.VNDR_NM) VNDR_NM" ).append("\n"); 
		query.append("    ,MAX(A.AGMT_NO) AGMT_NO" ).append("\n"); 
		query.append("    ,MAX(A.SLN_CD) SLN_CD" ).append("\n"); 
		query.append("    ,MAX(A.SLN_LANE_CD) SLN_LANE_CD" ).append("\n"); 
		query.append("    ,MAX(A.SERVICE_CD) SVC_SCP_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	,MAX(A.ORG_YD_CD) ORG_YD_CD                 " ).append("\n"); 
		query.append("	,MAX(A.MVMT_STS_CD) MVMT_STS_CD               " ).append("\n"); 
		query.append("	,TO_CHAR(MAX(A.CNMV_EVNT_DT),'YYYY-MM-DD') CNMV_EVNT_DT              " ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	,LTRIM(TO_CHAR(MAX(A.STAY_DAYS),'9,999'))  STAY_DAYS                  " ).append("\n"); 
		query.append("	,LTRIM(TO_CHAR(MAX(A.TOT_DAYS),'9,999')) TOT_DAYS                  " ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("GROUP BY A.CNTR_NO, A.DMG_FLG_DT, A.DMG_UNFLG_DT" ).append("\n"); 
