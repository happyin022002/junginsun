...
public class EesCgm1018Event extends EventSupport {
	...
	public CHSFoundAutoMGTVO[] getCHSFoundAutoMGTVOS() {
		CHSFoundAutoMGTVO[] rtnVOs = null;
		if (this.cHSFoundAutoMGTVOS != null) {
			rtnVOs = java.util.Arrays.copyOf(cHSFoundAutoMGTVOS, cHSFoundAutoMGTVOS.length);
		}
		return rtnVOs;
	}
	...
	public void setCHSFoundAutoMGTVOS(CHSFoundAutoMGTVO[] foundAutoMGTVOS){
		if(foundAutoMGTVOS != null){
			CHSFoundAutoMGTVO[] tmpVOs = java.util.Arrays.copyOf(foundAutoMGTVOS, foundAutoMGTVOS.length);
			this.cHSFoundAutoMGTVOS = tmpVOs;
		}
	}
