...
*@FileName : ChassisMgsetInventoryDBDAOaddCHSEspAdjustDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInventoryDBDAOaddCHSEspAdjustDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInventoryDBDAOaddCHSEspAdjustDataCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.cgm.chassismgsetmgt.chassismgsetinventory.integration").append("\n"); 
		query.append("FileName : ChassisMgsetInventoryDBDAOaddCHSEspAdjustDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
