...
*@FileName : InvoiceIssueCollectionMgtDBDAOModifyChargeStatusByInvoiceCancelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOModifyChargeStatusByInvoiceCancelUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOModifyChargeStatusByInvoiceCancelUSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOModifyChargeStatusByInvoiceCancelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET		DMDT_CHG_STS_CD	=	DECODE(NVL(FX_FT_OVR_DYS,0), 0, 'N', 'C')" ).append("\n"); 
		query.append("		, DMDT_INV_NO	= 	NULL" ).append("\n"); 
