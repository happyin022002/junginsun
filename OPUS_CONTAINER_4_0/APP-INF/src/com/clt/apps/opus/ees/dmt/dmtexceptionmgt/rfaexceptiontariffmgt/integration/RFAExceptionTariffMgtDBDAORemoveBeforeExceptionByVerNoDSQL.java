...
*@FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionByVerNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveBeforeExceptionByVerNoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Ver No. 에 해당되는 Before Exception Request Detail 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveBeforeExceptionByVerNoDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionByVerNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
