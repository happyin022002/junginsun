...
*@FileName : InvoiceIssueCollectionMgtDBDAOSearchPayerFaxNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOSearchPayerFaxNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOSearchPayerFaxNoRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOSearchPayerFaxNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",PAYR_CNTC_PNT_FAX_NO AS DMDT_PAYR_FAX_NO" ).append("\n"); 
