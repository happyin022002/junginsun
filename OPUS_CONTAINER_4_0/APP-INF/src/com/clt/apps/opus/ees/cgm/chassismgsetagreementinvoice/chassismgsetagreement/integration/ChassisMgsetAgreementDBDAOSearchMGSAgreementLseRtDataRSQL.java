...
public class ChassisMgsetAgreementDBDAOSearchMGSAgreementLseRtDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        CASE WHEN T1.DP_SEQ = '1' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD1," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '2' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD2," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '3' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD3," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '4' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD4," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '5' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD5," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '6' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD6," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '7' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD7," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '8' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD8," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '9' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD9," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '10' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD10," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '11' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD11," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '12' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD12," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '13' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD13," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '14' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD14," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '15' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD15," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '16' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD16," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '17' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD17," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '18' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD18," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '19' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD19," ).append("\n"); 
		query.append("        CASE WHEN T1.DP_SEQ = '20' THEN DECODE(Y.NO,'1',T1.MGST_BLDP_RT_AMT,'2',T1.MGST_LSE_FX_RT_AMT) END AS EQ_TPSZ_CD20" ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("        (" ).append("\n"); 
