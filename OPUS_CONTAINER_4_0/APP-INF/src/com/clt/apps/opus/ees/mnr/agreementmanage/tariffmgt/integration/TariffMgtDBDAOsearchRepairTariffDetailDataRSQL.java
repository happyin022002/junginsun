...
*@FileName : TariffMgtDBDAOsearchRepairTariffDetailDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffMgtDBDAOsearchRepairTariffDetailDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TariffMgtDBDAOsearchRepairTariffDetailDataRSQL(){
		setQuery();
		...
		query.append("FileName : TariffMgtDBDAOsearchRepairTariffDetailDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
