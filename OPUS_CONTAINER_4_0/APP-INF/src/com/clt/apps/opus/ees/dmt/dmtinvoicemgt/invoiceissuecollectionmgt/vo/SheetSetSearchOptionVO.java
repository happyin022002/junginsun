...
*@FileName : SheetSetSearchOptionVO.java
*@FileTitle : SheetSetSearchOptionVO
*Open Issues :
*Change history :
...
public class SheetSetSearchOptionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SheetSetSearchOptionVO> models = new ArrayList<SheetSetSearchOptionVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("trftpp", getTrftpp());
		...
		this.hashColumns.put("shttpp", getShttpp());
		...
		this.hashColumns.put("issoff", getIssoff());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("trftpp", "trftpp");
		...
		this.hashFields.put("shttpp", "shttpp");
		...
		this.hashFields.put("issoff", "issoff");
	 ...
	 * @param trftpp
	 */
	public void setTrftpp(String trftpp) {
		this.trftpp = trftpp;
	}
	 ...
	 * @param shttpp
	 */
	public void setShttpp(String shttpp) {
		this.shttpp = shttpp;
	}
	 ...
	 * @param issoff
	 */
	public void setIssoff(String issoff) {
		this.issoff = issoff;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTrftpp(JSPUtil.getParameter(request, "trftpp", " "));
		...
		setShttpp(JSPUtil.getParameter(request, "shttpp", " "));
		...
		setIssoff(JSPUtil.getParameter(request, "issoff", " "));
	}
	 ...
	 */
	public SheetSetSearchOptionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SheetSetSearchOptionVO[]
	 */
	public SheetSetSearchOptionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SheetSetSearchOptionVO model = null;
		...
		try {
			...
			String[] trftpp = (JSPUtil.getParameter(request, prefix	+ "trftpp", length));
			...
			String[] shttpp = (JSPUtil.getParameter(request, prefix	+ "shttpp", length));
			...
			String[] issoff = (JSPUtil.getParameter(request, prefix	+ "issoff", length));
			
			for (int i = 0; i < length; i++) {
				model = new SheetSetSearchOptionVO();
				if (foot01[i] != null)
		...
		return getSheetSetSearchOptionVOs();
	}
	...
	public SheetSetSearchOptionVO[] getSheetSetSearchOptionVOs(){
		SheetSetSearchOptionVO[] vos = (SheetSetSearchOptionVO[])models.toArray(new SheetSetSearchOptionVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.trftpp = this.trftpp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.shttpp = this.shttpp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.issoff = this.issoff .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
