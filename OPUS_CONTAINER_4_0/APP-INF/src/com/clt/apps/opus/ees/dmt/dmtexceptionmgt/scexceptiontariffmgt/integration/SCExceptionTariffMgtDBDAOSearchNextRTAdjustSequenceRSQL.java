...
*@FileName : SCExceptionTariffMgtDBDAOSearchNextRTAdjustSequenceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchNextRTAdjustSequenceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rate Adjustment 입력시 다음 Sequence 를 조회하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchNextRTAdjustSequenceRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchNextRTAdjustSequenceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}