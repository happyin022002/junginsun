...
*@FileName : RepairMgtDBDAOremoveEstimateDTLDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOremoveEstimateDTLDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeEstimateDTLData
	  * </pre>
	  */
	public RepairMgtDBDAOremoveEstimateDTLDataDSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOremoveEstimateDTLDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
