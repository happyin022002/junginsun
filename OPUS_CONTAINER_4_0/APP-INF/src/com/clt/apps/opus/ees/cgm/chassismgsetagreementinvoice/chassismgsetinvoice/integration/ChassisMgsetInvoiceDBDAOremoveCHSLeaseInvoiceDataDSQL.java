...
*@FileName : ChassisMgsetInvoiceDBDAOremoveCHSLeaseInvoiceDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOremoveCHSLeaseInvoiceDataDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOremoveCHSLeaseInvoiceDataDSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOremoveCHSLeaseInvoiceDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CGM_LSE_INV_TMP" ).append("\n"); 
