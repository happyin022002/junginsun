...
*@FileName : ChassisMgsetOnOffhireDBDAOsearchMGSEqSpecDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOsearchMGSEqSpecDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOsearchMGSEqSpecDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOsearchMGSEqSpecDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(SELECT C.VNDR_LGL_ENG_NM" ).append("\n"); 
		query.append("FROM MDM_VENDOR C" ).append("\n"); 
		query.append("WHERE A.VNDR_SEQ = C.VNDR_SEQ) AS VNDR_SEQ_ENG_NM," ).append("\n"); 
		...
		query.append("AND A.EQ_SPEC_NO = @[eq_spec_no]" ).append("\n"); 
