...
/**
 * ees_mnr_S011 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ees_mnr_S011HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author WanGyu Kim 
 * @see ees_mnr_S011HTMLAction 참조
 * @since J2EE 1.6
 */

public class EesMnrS011Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	public EesMnrS011Event(){}
