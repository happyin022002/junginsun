...
*@FileName : ContainerSpecMgtDBDAOMstCntrVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerSpecMgtDBDAOMstCntrVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MST CONTAINER 테이블 CNTR_MTRL_CD , VNDR_SEQ UPDATE
	  * </pre>
	  */
	public ContainerSpecMgtDBDAOMstCntrVOUSQL(){
		setQuery();
		...
		query.append("FileName : ContainerSpecMgtDBDAOMstCntrVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
