...
*@FileName : EES_DMT_3101HTMLAction.java
...
public class EES_DMT_3101HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_3101HTMLAction 객체를 생성
	 */
	public EES_DMT_3101HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt3101Event event = new EesDmt3101Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setOfficeTransferParmVOS((OfficeTransferParmVO[])getVOs(request, OfficeTransferParmVO .class,""));
		}
		else if(command.isCommand(FormCommand.MULTI01)) {
			event.setChargeArgumentVOS((ChargeArgumentVO[])getVOs(request, ChargeArgumentVO .class,""));
		}
