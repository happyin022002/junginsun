...
public class RFAExceptionGRPVO {
	...
	private List<RFAExceptionFreeTimeVO> 	rFAExceptionFreeTimeVOS = null;
	
	private List<RFAExceptionCommodityVO> 	rFAExceptionCommodityVOS = null;
	...
	public void setRFAExceptionFreeTimeVOS(List<RFAExceptionFreeTimeVO> rFAExceptionFreeTimeVOS) {
		this.rFAExceptionFreeTimeVOS = rFAExceptionFreeTimeVOS;
	}
	
	public void setRFAExceptionCommodityVOS(List<RFAExceptionCommodityVO> rFAExceptionCommodityVOS) {
		this.rFAExceptionCommodityVOS = rFAExceptionCommodityVOS;
	}
	...
	public void setRFAExceptionFreeTimeVOS(RFAExceptionFreeTimeVO[] rFAExceptionFreeTimeVOList) {
		if (rFAExceptionFreeTimeVOList != null && rFAExceptionFreeTimeVOList.length > 0) {
			rFAExceptionFreeTimeVOS = new ArrayList<RFAExceptionFreeTimeVO>();
			for (int i = 0 ; i < rFAExceptionFreeTimeVOList.length ; i++) {
				rFAExceptionFreeTimeVOS.add(rFAExceptionFreeTimeVOList[i]);
			}
		}		
	}	
	
	public void setRFAExceptionCommodityVOS(RFAExceptionCommodityVO[] rFAExceptionCommodityVOList) {
		if (rFAExceptionCommodityVOList != null && rFAExceptionCommodityVOList.length > 0) {
			rFAExceptionCommodityVOS = new ArrayList<RFAExceptionCommodityVO>();
			for (int i = 0 ; i < rFAExceptionCommodityVOList.length ; i++) {
				rFAExceptionCommodityVOS.add(rFAExceptionCommodityVOList[i]);
			}
		}		
	}
	...
	public List<RFAExceptionFreeTimeVO> getRFAExceptionFreeTimeVOS() {
		return rFAExceptionFreeTimeVOS;
	}	
	
	public List<RFAExceptionCommodityVO> getRFAExceptionCommodityVOS() {
		return rFAExceptionCommodityVOS;
	}	
