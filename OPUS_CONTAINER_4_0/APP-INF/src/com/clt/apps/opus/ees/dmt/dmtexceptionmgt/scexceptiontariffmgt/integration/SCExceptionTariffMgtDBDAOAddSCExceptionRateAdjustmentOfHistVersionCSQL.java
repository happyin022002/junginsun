...
public class SCExceptionTariffMgtDBDAOAddSCExceptionRateAdjustmentOfHistVersionCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    PROP_NO,SC_EXPT_VER_SEQ,SC_EXPT_GRP_SEQ,RT_SEQ,FT_FM_DYS,FT_TO_DYS,CNTR_20FT_RT_AMT,CNTR_40FT_RT_AMT,CNTR_HC_RT_AMT" ).append("\n"); 
		query.append("    ,CNTR_45FT_RT_AMT,CRE_USR_ID,CRE_DT,UPD_USR_ID,UPD_DT" ).append("\n"); 
		query.append(")" ).append("\n"); 
