...
*@FileName : RuLabelManagementDBDAOModifyRubelManagementDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RuLabelManagementDBDAOModifyRubelManagementDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RU Label Maintenace Update
	  * </pre>
	  */
	public RuLabelManagementDBDAOModifyRubelManagementDataUSQL(){
		setQuery();
		...
		query.append("FileName : RuLabelManagementDBDAOModifyRubelManagementDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
