...
public class EesCgm1143Event extends EventSupport {
	...
	public PoolExpenseTrendMGTVO[] getPoolExpenseTrendMGTVOs() {
		PoolExpenseTrendMGTVO[] rtnVOs = null;
		if (this.poolExpenseTrendMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(poolExpenseTrendMGTVOs, poolExpenseTrendMGTVOs.length);
		}
		return rtnVOs;
	}
	 ...
	 */
	public void setPoolExpenseTrendMGTVOs(PoolExpenseTrendMGTVO[] poolExpenseTrendMGTVOs){
		if(poolExpenseTrendMGTVOs != null){
			PoolExpenseTrendMGTVO[] tmpVOs = java.util.Arrays.copyOf(poolExpenseTrendMGTVOs, poolExpenseTrendMGTVOs.length);
			this.poolExpenseTrendMGTVOs = tmpVOs;
		}
	}
