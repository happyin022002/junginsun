...
*@FileName : CntrRepoPlanManageDBDAODeleteInlandPlanQtyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAODeleteInlandPlanQtyDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_INLND_TRSP_PLN_QTY 테이블 삭제
	  * 
	  * <Change History>
	  * 1	2009.09.22	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAODeleteInlandPlanQtyDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanManageDBDAODeleteInlandPlanQtyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
