...
public class CNTRMvmtINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CNTRMvmtINVO> models = new ArrayList<CNTRMvmtINVO>();
	...
	public CNTRMvmtINVO(String ibflag, String pagerows, String checkDigit, String pCntrno) {
	 ...
	 * @return CNTRMvmtINVO[]
	 */
	public CNTRMvmtINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CNTRMvmtINVO[]
	 */
	public CNTRMvmtINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CNTRMvmtINVO model = null;
	 ...
	 * @return CNTRMvmtINVO[]
	 */
	public CNTRMvmtINVO[] getCNTRMvmtINVOs(){
		CNTRMvmtINVO[] vos = (CNTRMvmtINVO[])models.toArray(new CNTRMvmtINVO[models.size()]);
		return vos;
	}
