...
*@FileName : RFAExceptionTariffMgtDBDAOSearchBeforeExceptionListByCustomerRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchBeforeExceptionListByCustomerRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Customer Code 와 RFA No. 에 해당되는 DAR History 정보를 조회하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchBeforeExceptionListByCustomerRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchBeforeExceptionListByCustomerRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
