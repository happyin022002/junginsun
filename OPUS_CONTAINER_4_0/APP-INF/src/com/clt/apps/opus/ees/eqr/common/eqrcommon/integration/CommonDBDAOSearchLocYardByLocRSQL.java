...
*@FileName : CommonDBDAOSearchLocYardByLocRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchLocYardByLocRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Truck & Rail & Water Row Add 시 Execution 내 From Loc 및 To Loc 가져 오는 로직
	  * </pre>
	  */
	public CommonDBDAOSearchLocYardByLocRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchLocYardByLocRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
