...
*@FileName : EES_MNR_0236HTMLAction.java
 ...
 * @author 김완규 
 * @see EesMnr0236Event 참조
 * @since J2EE 1.6           
 */
 
public class EES_MNR_0236HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0236HTMLAction 객체를 생성
	 */
	public EES_MNR_0236HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0236Event event = new EesMnr0236Event();
			
		PMFCByAgreementTariffGRPVO pMFCByAgreementTariffGRPVO = new PMFCByAgreementTariffGRPVO();
			
		//조회 
		if(command.isCommand(FormCommand.SEARCH)) {	 
			pMFCByAgreementTariffGRPVO.setPMFCByAgreementTariffINVO((PMFCByAgreementTariffINVO)getVO(request, PMFCByAgreementTariffINVO.class));
		}	
		event.setPMFCByAgreementTariffGRPVO(pMFCByAgreementTariffGRPVO);
