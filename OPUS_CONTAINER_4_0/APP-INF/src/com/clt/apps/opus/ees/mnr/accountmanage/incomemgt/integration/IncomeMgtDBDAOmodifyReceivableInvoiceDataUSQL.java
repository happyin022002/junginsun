...
public class IncomeMgtDBDAOmodifyReceivableInvoiceDataUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	,MNR_BIL_TO_NM = @[mnr_bil_to_nm]" ).append("\n"); 
		query.append("	,MNR_SWIFT_NO = @[mnr_swift_no]" ).append("\n"); 
		query.append("	,MNR_PRNR_TP_CD = DECODE(@[mnr_grp_tp_cd],'RPR','S','B')" ).append("\n"); 
