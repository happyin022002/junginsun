...
*@FileName : LseCommonDBDAOSearchVesselSkdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LseCommonDBDAOSearchVesselSkdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LseCommonDBDAOSearchVesselSkdRSQL(){
		setQuery();
		...
		query.append("FileName : LseCommonDBDAOSearchVesselSkdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  A.SLAN_CD, A.VPS_PORT_CD," ).append("\n"); 
