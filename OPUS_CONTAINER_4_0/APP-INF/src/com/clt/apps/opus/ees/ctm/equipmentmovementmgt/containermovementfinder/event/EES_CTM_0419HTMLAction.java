...
*@FileName : EES_CTM_0419HTMLAction.java
...
public class EES_CTM_0419HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0419HTMLAction 객체를 생성
	 */
	public EES_CTM_0419HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0419Event event = new EesCtm0419Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setConCBookingVO((ConCBookingVO)getVO(request, ConCBookingVO .class));
		}
