...
*@FileName : EES_DMT_4103HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class EES_DMT_4103HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt4103Event event = new EesDmt4103Event();

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setSheetOptionSearchOptionVO((SheetOptionSearchOptionVO)getVO(request, SheetOptionSearchOptionVO .class));
        }else if(command.isCommand(FormCommand.MULTI)) {
            event.setSheetOptionSearchOptionVO((SheetOptionSearchOptionVO)getVO(request, SheetOptionSearchOptionVO .class));
            event.setSheetOptionTermTitleListUpVOs((SheetOptionTermTitleListUpVO[])getVOs(request, SheetOptionTermTitleListUpVO.class,""));
        }
