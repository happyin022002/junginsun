...
public class MTYEquipmentForecastDBDAOsearcForecastAccuracyListByWeekRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("ORDER BY DECODE(A.BOUND,'O/B',1,2), A.YRWK,A.LOC_CD,A.DP_SEQ" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("       ,DECODE(A.DP_SEQ,2,LTRIM(TO_CHAR(A.TOT_QTY,'999,999,999,999')),3,'ABS '||LTRIM(TO_CHAR(A.TOT_QTY,'999,999,999,999')),4,LTRIM(TO_CHAR(ROUND(A.TOT_QTY,1),'999,999,990.9'))||'%',LTRIM(TO_CHAR(A.TOT_QTY,'999,999,999,999'))) TOT_QTY" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("    (" ).append("\n"); 
		query.append("    SELECT A.BOUND" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,1,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY1" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,2,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY2" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,3,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY3" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,4,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY4" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,5,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY5" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,6,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY6" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,7,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY7" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,8,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY8" ).append("\n"); 
		query.append("          ,MAX(DECODE(A.ROWNUM_SEQ,9,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY9" ).append("\n"); 
		query.append("		  ,MAX(DECODE(A.ROWNUM_SEQ,10,A.LOC_CD||'('||LTRIM(TO_CHAR(ROUND(A.TOT_QTY,2),'999,999,990.9'))||'%)')) QTY10" ).append("\n"); 
		...
		query.append("       	  ,'HIDDEN' QTY20  --히든처리위한 구분자      " ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("        SELECT A.BOUND" ).append("\n"); 
		query.append("              ,A.LOC_CD" ).append("\n"); 
