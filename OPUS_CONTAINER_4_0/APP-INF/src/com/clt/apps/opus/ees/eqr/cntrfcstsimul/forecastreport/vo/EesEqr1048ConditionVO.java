...
*@FileName : EesEqr1048ConditionVO.java
*@FileTitle : EesEqr1048ConditionVO
*Open Issues :
*Change history :
...
public class EesEqr1048ConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EesEqr1048ConditionVO> models = new ArrayList<EesEqr1048ConditionVO>();
	...
	public EesEqr1048ConditionVO() {}

	public EesEqr1048ConditionVO(String ibflag, String pagerows, String repoPlnId, String searchFlag, String repoFlag, String fcastYrwk, String locCd, String locGrpCd, String inpYrwk, String tpCd, String repoPlnYrwk, String wkStDt, String wkEndDt, String currFlag, String yard) {
...
/**
	 ...
	 */
	public EesEqr1048ConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EesEqr1048ConditionVO[]
	 */
	public EesEqr1048ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EesEqr1048ConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EesEqr1048ConditionVO();
		...
		return getEesEqr1048ConditionVOs();
	}
	...
	public EesEqr1048ConditionVO[] getEesEqr1048ConditionVOs(){
		EesEqr1048ConditionVO[] vos = (EesEqr1048ConditionVO[])models.toArray(new EesEqr1048ConditionVO[models.size()]);
		return vos;
	}
