...
*@FileName : InterfaceMgtSOLInvoiceBackEndJob.java
*@FileTitle : test
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class InterfaceMgtSOLInvoiceBackEndJob extends BackEndCommandSupport{
	 ...
	 */
	public InterfaceMgtSOLInvoiceBackEndJob(){
...
//		InterfaceGRPVO interfaceGRPVO = new InterfaceGRPVO();
		...
		try {
			command.manageSOLInvoiceDataBasic(ifGRPVO, signOnUserAccount);
	    } catch (Exception e) {
	        log.error("err " + e.toString(), e);
	        throw new EventException(new ErrorHandler("SOL Invoice Upload", new String[] {}).getMessage());
	    }
		return "";
	}
