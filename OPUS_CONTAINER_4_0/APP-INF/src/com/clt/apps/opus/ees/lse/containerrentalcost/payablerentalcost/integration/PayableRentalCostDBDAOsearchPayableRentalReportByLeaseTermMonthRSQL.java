...
public class PayableRentalCostDBDAOsearchPayableRentalReportByLeaseTermMonthRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("           GROUP BY LTMP.LSTM_CD, LTMP.CURR_CD, NVL(LTMP.PAY_VNDR_SEQ, LTMP.VNDR_SEQ), SUBSTR(NVL(VNDR.VNDR_ABBR_NM, '   '), 1, 3)" ).append("\n"); 
		...
		query.append("                    AND ROWNUM           = 1)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("           GROUP BY LTMP.LSTM_CD, LTC.CURR_CD, LTC.VNDR_SEQ, SUBSTR(NVL(VNDR.VNDR_ABBR_NM, '   '), 1, 3)" ).append("\n"); 
		query.append("        )" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		...
		query.append("                AAA.CURR_CD," ).append("\n"); 
		query.append("                ABBR_NM1," ).append("\n"); 
		query.append("                JAN," ).append("\n"); 
		query.append("                FEB," ).append("\n"); 
		query.append("                MAR," ).append("\n"); 
		...
		query.append("                             FROM XXX" ).append("\n"); 
		query.append("                            GROUP BY CURR_CD, LSTM_CD )" ).append("\n"); 
		...
		query.append("          ORDER BY BBB.DP_SEQ , AAA.CURR_CD , ABBR_NM1" ).append("\n"); 
		query.append("       )" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
