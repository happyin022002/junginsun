...
*@FileName : EES_CTM_0409HTMLAction.java
...
public class EES_CTM_0409HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0409HTMLAction 객체를 생성
	 */
	public EES_CTM_0409HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0409Event event = new EesCtm0409Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchMovementListByBkgInfoVO((SearchMovementListByBkgInfoVO)getVO(request, SearchMovementListByBkgInfoVO.class));
		} else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchMovementListByEqrRefInfoVO((SearchMovementListByEqrRefInfoVO)getVO(request, SearchMovementListByEqrRefInfoVO.class));
		}
