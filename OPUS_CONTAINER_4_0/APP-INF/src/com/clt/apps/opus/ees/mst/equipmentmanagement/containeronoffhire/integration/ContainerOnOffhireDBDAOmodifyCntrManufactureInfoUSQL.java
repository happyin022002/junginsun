...
*@FileName : ContainerOnOffhireDBDAOmodifyCntrManufactureInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerOnOffhireDBDAOmodifyCntrManufactureInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyCntrManufactureInfo
	  * </pre>
	  */
	public ContainerOnOffhireDBDAOmodifyCntrManufactureInfoUSQL(){
		setQuery();
		...
		query.append("FileName : ContainerOnOffhireDBDAOmodifyCntrManufactureInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    MFT_DT         = TO_DATE(REPLACE(@[mft_dt],'-'),'YYYYMMDD')" ).append("\n"); 
