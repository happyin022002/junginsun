...
*@FileName : EES_CIM_5005HTMLAction.java
...
public class EES_EQR_5005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_5005HTMLAction 객체를 생성
	 */
	public EES_EQR_5005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr5005Event event = new EesEqr5005Event();
