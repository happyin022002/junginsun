...
*@FileName : EES_MNR_0018HTMLAction.java
...
public class EES_MNR_0018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0018HTMLAction 객체를 생성
	 */
	public EES_MNR_0018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0018Event event = new EesMnr0018Event();
		
		AgreementInfoListGRPVO agreementInfoListGRPVO = new AgreementInfoListGRPVO();
		  
		//조회 
		if(command.isCommand(FormCommand.SEARCH)) {  
			agreementInfoListGRPVO.setAgreementInfoListINVO((AgreementInfoListINVO)getVO(request, AgreementInfoListINVO .class)); 
		}     		        
		//어그리먼트용   
		event.setAgreementInfoListGRPVO(agreementInfoListGRPVO);            
