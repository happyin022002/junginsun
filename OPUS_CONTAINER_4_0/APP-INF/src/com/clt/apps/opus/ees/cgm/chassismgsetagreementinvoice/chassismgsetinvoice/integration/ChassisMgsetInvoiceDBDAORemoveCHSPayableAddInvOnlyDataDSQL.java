...
*@FileName : ChassisMgsetInvoiceDBDAORemoveCHSPayableAddInvOnlyDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAORemoveCHSPayableAddInvOnlyDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.RemoveCHSPayableAddInvOnlyData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAORemoveCHSPayableAddInvOnlyDataDSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAORemoveCHSPayableAddInvOnlyDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND (LSE_CHG_AUD_STS_CD = 'I'  OR LSE_CHG_AUD_STS_CD IS NULL)" ).append("\n"); 
		query.append("AND LSE_CHG_AUD_RSLT_RSN_CD IS NULL" ).append("\n"); 
