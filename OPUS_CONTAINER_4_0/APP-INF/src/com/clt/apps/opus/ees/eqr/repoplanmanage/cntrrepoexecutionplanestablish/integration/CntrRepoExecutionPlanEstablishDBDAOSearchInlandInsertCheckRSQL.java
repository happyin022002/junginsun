...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOSearchInlandInsertCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOSearchInlandInsertCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_INLND_TRSP_PLN 에서 확인
	  * 결과값이 true 이면 insert를 하고 false 이면 update를 수행을 한다.
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOSearchInlandInsertCheckRSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOSearchInlandInsertCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
