...
*@FileName : GeneralCodeCheckMgtDBDAOcheckSldYardCodeDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralCodeCheckMgtDBDAOcheckSldYardCodeDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 조회 - Disposal Sold Creation 에서 Yard 를 체크
	  * </pre>
	  */
	public GeneralCodeCheckMgtDBDAOcheckSldYardCodeDataRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralCodeCheckMgtDBDAOcheckSldYardCodeDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT A.LOC_CD as CD_ID,A.LOC_NM as CD_DESC" ).append("\n"); 
