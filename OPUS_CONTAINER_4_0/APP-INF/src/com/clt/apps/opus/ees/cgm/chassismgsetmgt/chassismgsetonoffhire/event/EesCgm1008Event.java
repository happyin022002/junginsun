...
public class EesCgm1008Event extends EventSupport {
	...
	public CHSOnHireMGTVO[] getCHSOnHireMGTVOs() {
		CHSOnHireMGTVO[] rtnVOs = null;
		if (this.cHSOnHireMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(cHSOnHireMGTVOs, cHSOnHireMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setCHSOnHireMGTVOs(CHSOnHireMGTVO[] onHireMGTVOs){
		if(onHireMGTVOs != null){
			CHSOnHireMGTVO[] tmpVOs = java.util.Arrays.copyOf(onHireMGTVOs, onHireMGTVOs.length);
			this.cHSOnHireMGTVOs = tmpVOs;
		}
	}
