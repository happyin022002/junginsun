...
*@FileName : SCExceptionTariffMgtDBDAORemoveRTAdjustByPropVerNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveRTAdjustByPropVerNoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Prop No. 와 Ver No. 에 해당되는 Rate Adjustment 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveRTAdjustByPropVerNoDSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveRTAdjustByPropVerNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
