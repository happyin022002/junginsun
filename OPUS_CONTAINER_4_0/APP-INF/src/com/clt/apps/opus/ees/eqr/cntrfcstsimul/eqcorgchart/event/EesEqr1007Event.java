...
public class EesEqr1007Event extends EventSupport {
	...
	private EQCOrgChartListVO[] eQCOrgChartListVOs = null;
	...
	public EQCOrgChartListVO[] getEQCOrgChartListVOs() {
		EQCOrgChartListVO[] tmpVOs = null;
		if (this.eQCOrgChartListVOs != null) {
			tmpVOs = new EQCOrgChartListVO[eQCOrgChartListVOs.length];
			System.arraycopy(eQCOrgChartListVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
	...
	public void setEQCOrgChartListVOs(EQCOrgChartListVO[] eQCOrgChartListVOs) {
		if (eQCOrgChartListVOs != null) {
			EQCOrgChartListVO[] tmpVOs = new EQCOrgChartListVO[eQCOrgChartListVOs.length];
			System.arraycopy(eQCOrgChartListVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.eQCOrgChartListVOs = tmpVOs;
		}
	}
