...
*@FileName : MTYCNTRPERFSummaryVO.java
*@FileTitle : MTYCNTRPERFSummaryVO
*Open Issues :
*Change history :
...
public class MTYCNTRPERFSummaryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MTYCNTRPERFSummaryVO> models = new ArrayList<MTYCNTRPERFSummaryVO>();
	 ...
	 */
	public MTYCNTRPERFSummaryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MTYCNTRPERFSummaryVO[]
	 */
	public MTYCNTRPERFSummaryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MTYCNTRPERFSummaryVO model = null;
		...
		try {
			...
			String[] inout = (JSPUtil.getParameter(request, prefix	+ "inout".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				model = new MTYCNTRPERFSummaryVO();
				if (total[i] != null)
		...
		return getMTYCNTRPERFSummaryVOs();
	}
	 ...
	 * @return MTYCNTRPERFSummaryVO[]
	 */
	public MTYCNTRPERFSummaryVO[] getMTYCNTRPERFSummaryVOs(){
		MTYCNTRPERFSummaryVO[] vos = (MTYCNTRPERFSummaryVO[])models.toArray(new MTYCNTRPERFSummaryVO[models.size()]);
		return vos;
	}
