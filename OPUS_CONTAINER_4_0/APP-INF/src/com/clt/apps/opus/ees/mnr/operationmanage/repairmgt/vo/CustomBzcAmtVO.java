...
*@FileName : CustomBzcAmtVO.java
*@FileTitle : CustomBzcAmtVO
*Open Issues :
*Change history :
...
public class CustomBzcAmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<CustomBzcAmtVO> models = new ArrayList<CustomBzcAmtVO>();
	...
	public CustomBzcAmtVO() {}

	public CustomBzcAmtVO(String ibflag, String pagerows, String rprQty, String agmtRtAmt) {
	 ...
	 * @param request
	 * @return CustomBzcAmtVO[]
	 */
	public CustomBzcAmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomBzcAmtVO[]
	 */
	public CustomBzcAmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomBzcAmtVO model = null;
	 ...
	 * @return CustomBzcAmtVO[]
	 */
	public CustomBzcAmtVO[] getCustomBzcAmtVOs(){
		CustomBzcAmtVO[] vos = (CustomBzcAmtVO[])models.toArray(new CustomBzcAmtVO[models.size()]);
		return vos;
	}
