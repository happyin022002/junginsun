...
*@FileName : EES_LSE_0083HTMLAction.java
...
public class EES_LSE_0083HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0083HTMLAction 객체를 생성
	 */
	public EES_LSE_0083HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0083Event event = new EesLse0083Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setReportSearchReceivableVO((ReportSearchReceivableVO)getVO(request, ReportSearchReceivableVO .class));
		}
