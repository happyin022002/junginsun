...
*@FileName : EES_CIM_0029HTMLAction.java
...
public class EES_CIM_0029HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0029HTMLAction 객체를 생성
	 */
	public EES_CIM_0029HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0029Event event = new EesCim0029Event();

		event.setStockByCntrListVO((StockByCntrListVO)getVO(request, StockByCntrListVO .class));
