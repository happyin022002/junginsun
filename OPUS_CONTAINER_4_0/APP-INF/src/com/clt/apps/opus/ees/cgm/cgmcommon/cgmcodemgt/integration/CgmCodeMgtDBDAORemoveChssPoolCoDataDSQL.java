...
public class CgmCodeMgtDBDAORemoveChssPoolCoDataDSQL implements ISQLTemplate {
	...
	/**
	 * <pre>
	 * CGM_CHSS_POOL 데이터 삭제
	 * </pre>
	 */
	public CgmCodeMgtDBDAORemoveChssPoolCoDataDSQL() {
		setQuery();
	...
	public void setQuery() {
		query.append("DELETE FROM CGM_CHSS_POOL WHERE CHSS_POOL_CD = @[chss_pool_cd]").append("\n");
