...
*@FileName : ChassisMgsetAgreementDBDAOCheckMGSAgreementUseEquipmentDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAOCheckMGSAgreementUseEquipmentDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetAgreementDB.CheckMGSAgreementUseEquipmentData
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAOCheckMGSAgreementUseEquipmentDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAOCheckMGSAgreementUseEquipmentDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
