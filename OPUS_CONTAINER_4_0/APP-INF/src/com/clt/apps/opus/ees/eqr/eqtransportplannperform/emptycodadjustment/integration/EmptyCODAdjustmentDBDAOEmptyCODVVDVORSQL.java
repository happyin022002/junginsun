...
public class EmptyCODAdjustmentDBDAOEmptyCODVVDVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("						AND		SUBSTR(VPS1.VPS_PORT_CD,1,2) NOT IN ( 'SA','AE','AU','IN','IR','PK' ) /* 2010.03.23 By YHNam : Skip Ports In ( 'SA','AE','AU','IN','IR','PK' ) */ " ).append("\n"); 
		...
		query.append("			AND		SUBSTR(VPS2.VPS_PORT_CD,1,2) NOT IN ( 'SA','AE','AU','IN','IR','PK' ) /* 2010.03.23 By YHNam : Skip Ports In ( 'SA','AE','AU','IN','IR','PK' ) */" ).append("\n"); 
		...
		query.append("			AND     SCNT2.CONTI_CD		=    'A'  " ).append("\n"); 
		query.append("		" ).append("\n"); 
		...
		query.append("		OR" ).append("\n"); 
		query.append("        ( SUBSTR(TRD.TRD_CD,2,1) = 'M' AND DECODE(OSCNT.CONTI_CD, 'F', 'E', OSCNT.CONTI_CD) =  'M' )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    )" ).append("\n"); 
		...
		query.append("			AND		SUBSTR(VPS1.VPS_PORT_CD,1,2) NOT IN ( 'SA','AE','AU','IN','IR','PK' )" ).append("\n"); 
		...
		query.append("			AND     SCT.CONTI_CD        =    'A'                    /* Only Asisa Port */" ).append("\n"); 
		query.append("			AND		ROWNUM				=	1" ).append("\n"); 
