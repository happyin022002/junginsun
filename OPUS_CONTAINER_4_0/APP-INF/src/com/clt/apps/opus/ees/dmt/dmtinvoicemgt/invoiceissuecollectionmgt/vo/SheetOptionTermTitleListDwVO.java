...
*@FileName : SheetOptionTermTitleListDwVO.java
*@FileTitle : SheetOptionTermTitleListDwVO
*Open Issues :
*Change history :
...
public class SheetOptionTermTitleListDwVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SheetOptionTermTitleListDwVO> models = new ArrayList<SheetOptionTermTitleListDwVO>();
	...
	public SheetOptionTermTitleListDwVO() {}

	public SheetOptionTermTitleListDwVO(String ibflag, String pagerows, String seqq, String alll, String dmif, String dtic, String dmof, String dtoc, String ctic, String ctoc, String term, String issd, String titl, String shtp) {
		this.dtic = dtic;
		this.alll = alll;
		this.dmof = dmof;
		this.ctoc = ctoc;
	 ...
	 */
	public SheetOptionTermTitleListDwVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SheetOptionTermTitleListDwVO[]
	 */
	public SheetOptionTermTitleListDwVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SheetOptionTermTitleListDwVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SheetOptionTermTitleListDwVO();
				if (dtic[i] != null)
		...
		return getSheetOptionTermTitleListDwVOs();
	}
	 ...
	 * @return SheetOptionTermTitleListDwVO[]
	 */
	public SheetOptionTermTitleListDwVO[] getSheetOptionTermTitleListDwVOs(){
		SheetOptionTermTitleListDwVO[] vos = (SheetOptionTermTitleListDwVO[])models.toArray(new SheetOptionTermTitleListDwVO[models.size()]);
		return vos;
	}
