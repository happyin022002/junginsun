...
*@FileName : EES_CTM_0411HTMLAction.java
...
public class EES_CTM_0411HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0411HTMLAction 객체를 생성
	 */
	public EES_CTM_0411HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0411Event event = new EesCtm0411Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setConINTCommonVO((CtmVvdHistoryVO)getVO(request, CtmVvdHistoryVO .class));
		}
