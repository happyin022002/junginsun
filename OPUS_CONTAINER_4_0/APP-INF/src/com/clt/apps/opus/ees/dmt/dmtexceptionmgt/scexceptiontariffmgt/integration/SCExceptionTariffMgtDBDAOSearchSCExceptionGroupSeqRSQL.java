...
*@FileName : SCExceptionTariffMgtDBDAOSearchSCExceptionGroupSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchSCExceptionGroupSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff Version 에 최상위 Group Seq. 를 조회하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchSCExceptionGroupSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchSCExceptionGroupSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
