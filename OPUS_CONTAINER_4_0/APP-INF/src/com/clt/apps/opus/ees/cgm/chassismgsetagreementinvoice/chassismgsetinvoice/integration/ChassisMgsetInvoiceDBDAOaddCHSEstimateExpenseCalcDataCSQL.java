...
*@FileName : ChassisMgsetInvoiceDBDAOaddCHSEstimateExpenseCalcDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOaddCHSEstimateExpenseCalcDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOaddCHSEstimateExpenseCalcDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOaddCHSEstimateExpenseCalcDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", (SELECT ESTM_VVD_TP_CD" ).append("\n"); 
		...
		query.append("AND SKD_DIR_CD = 'M'" ).append("\n"); 
		query.append("AND REV_DIR_CD = 'M')" ).append("\n"); 
		query.append(", (SELECT ESTM_BC_DIV_CD" ).append("\n"); 
		query.append("FROM GL_ESTM_REV_VVD" ).append("\n"); 
		query.append("WHERE EXE_YRMON = @[exe_yrmon]" ).append("\n"); 
		query.append("AND REV_YRMON = @[rev_yrmon]" ).append("\n"); 
		query.append("AND VSL_CD = 'CNTC'" ).append("\n"); 
