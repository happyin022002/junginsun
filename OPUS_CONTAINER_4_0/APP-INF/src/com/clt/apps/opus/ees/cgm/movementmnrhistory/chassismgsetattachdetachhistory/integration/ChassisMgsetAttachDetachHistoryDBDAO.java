...
/**
 * OPUS ChassisMgsetAttachDetachHistoryDBDAO <br>
...
public class ChassisMgsetAttachDetachHistoryDBDAO extends DBDAOSupport {
	...
	/**
	 *  MVMT생성시 관련 MGST로 DT를 수행.[EES_CGM_1109].<br>
	 *
	 * @param cNTRMvmtMGTVO CNTRMvmtMGTVO
	 * @exception DAOException
	 */
	 public void modifyMGSDetachByMgstData(MGSCNTRMvmtMGTVO cNTRMvmtMGTVO) throws DAOException,Exception {
		SQLExecuter sqlExe = new SQLExecuter("");
		//query parameter
		try{
			if(cNTRMvmtMGTVO != null){
				...
				sqlExe.executeUpdate((ISQLTemplate) new ChassisMgsetAttachDetachHistoryDBDAOmodifyMGSDetachByMgstDataUSQL(), param, null);
			}
		} catch (SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	 ...
	 * @exception DAOException
	 */
	public void addMGSAtdtByMvmtData(List<CHSMovementHistoryMGTVO> cHSMovementHistoryMGTVOs) throws DAOException, Exception {
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			if (cHSMovementHistoryMGTVOs.size() > 0) {
				for (int i = 0; i < cHSMovementHistoryMGTVOs.size(); i++) {
					...
					param.putAll(mapVO);
					velParam.putAll(mapVO);
					result = sqlExe.executeUpdate((ISQLTemplate) new ChassisMgsetAttachDetachHistoryDBDAOaddMGSAtdtByMvmtDataCSQL(), param, velParam);
					if (result == Statement.EXECUTE_FAILED)
						throw new DAOException("Fail to insert SQL");
	...
	/**
	  ...
	  * @exception Exception
	  */
	public void modifyMGSAtdtHistoryData(MGSAtdtHistoryMGTVO mGSAtdtHistoryMGTVO) throws DAOException,Exception {
	    SQLExecuter sqlExe = new SQLExecuter("");
			//query parameter
			log.debug("manageCgmChssMvmtHisData==================================");
		try{
			if(mGSAtdtHistoryMGTVO != null){
				Map<String, String> param = mGSAtdtHistoryMGTVO .getColumnValues();

				sqlExe.executeUpdate((ISQLTemplate) new ChassisMgsetAttachDetachHistoryDBDAOmodifyMGSAtdtHistoryDataUSQL(), param, null);
			}
		} catch (SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	...
	/**
	  ...
	  * @exception Exception
	  */
	public void modifyMGSAtdtPreHistoryByCtmUpdData(MGSAtdtHistoryMGTVO mGSAtdtHistoryMGTVO) throws DAOException,Exception {
	    SQLExecuter sqlExe = new SQLExecuter("");
			//query parameter
			log.debug("modifyCHSAtdtPreHistoryByCtmUpdData==================================");
		try{
	  ...
	  * @exception Exception
	  */
	public void modifyMGSAtdtPreHistoryByCtmDelData(MGSAtdtHistoryMGTVO mGSAtdtHistoryMGTVO) throws DAOException,Exception {
	    SQLExecuter sqlExe = new SQLExecuter("");
			//query parameter
			log.debug("modifyCHSAtdtPreHistoryByCtmUpdData==================================");
		try{
