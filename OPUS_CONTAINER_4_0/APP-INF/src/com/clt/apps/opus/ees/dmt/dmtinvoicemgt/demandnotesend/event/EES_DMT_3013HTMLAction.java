...
*@FileName : EES_DMT_3013HTMLAction.java
...
public class EES_DMT_3013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_3013HTMLAction 객체를 생성
	 */
	public EES_DMT_3013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt3013Event event = new EesDmt3013Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDemandNoteListParmVO((DemandNoteListParmVO)getVO(request, DemandNoteListParmVO .class));
		}
