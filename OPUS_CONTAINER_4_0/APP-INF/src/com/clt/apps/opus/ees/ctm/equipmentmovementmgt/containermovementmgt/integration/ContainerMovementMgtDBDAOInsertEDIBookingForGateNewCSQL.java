...
*@FileName : ContainerMovementMgtDBDAOInsertEDIBookingForGateNewCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOInsertEDIBookingForGateNewCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOInsertEDIBookingForGateNewCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMgtDBDAOInsertEDIBookingForGateNewCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CTM_MVMT_EDI_BKG" ).append("\n"); 
