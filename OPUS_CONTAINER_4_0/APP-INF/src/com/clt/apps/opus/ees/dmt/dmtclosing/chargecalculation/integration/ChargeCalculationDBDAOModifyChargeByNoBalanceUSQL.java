...
*@FileName : ChargeCalculationDBDAOModifyChargeByNoBalanceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOModifyChargeByNoBalanceUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChargeCalculationDBDAOModifyChargeByNoBalanceUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOModifyChargeByNoBalanceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET	NOT_CRE_BAL_FLG	=	'Y'" ).append("\n"); 
