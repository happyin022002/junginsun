...
*@FileName : ContainerMovementValidationDBDAOCheckEqrRefNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementValidationDBDAOCheckEqrRefNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementValidationDBDAOCheckEqrRefNoRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementValidationDBDAOCheckEqrRefNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE REF_ID = NVL(@[mty_pln_no])" ).append("\n"); 
