...
public class CntrRepoExecutionPlanEstablishDBDAOSearchExecutionPlanCntrListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	MC.RSTR_USG_LBL_TP ," ).append("\n"); 
		query.append("    MC.RSTR_USG_LBL_DESC" ).append("\n"); 
		...
		query.append("                MST_COMMON_PKG.MST_RU_VAL_GET_FNC(MC.CNTR_NO) AS RSTR_USG_LBL_DESC                                 						   " ).append("\n"); 
		query.append("            FROM " ).append("\n"); 
