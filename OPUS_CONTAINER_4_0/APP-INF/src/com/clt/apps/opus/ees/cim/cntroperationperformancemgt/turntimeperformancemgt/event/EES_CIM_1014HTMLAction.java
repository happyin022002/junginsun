...
*@FileName : EES_CIM_1014HTMLAction.java
...
public class EES_CIM_1014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_1014HTMLAction 객체를 생성
	 */
	public EES_CIM_1014HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim1014Event event = new EesCim1014Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setTurnAroundTimeSearchOptionVO((TurnAroundTimeSearchOptionVO)getVO(request, TurnAroundTimeSearchOptionVO .class));
		}
