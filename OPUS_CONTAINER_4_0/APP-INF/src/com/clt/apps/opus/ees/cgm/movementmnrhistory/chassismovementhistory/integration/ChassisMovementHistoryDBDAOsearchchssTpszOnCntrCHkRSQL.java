...
public class ChassisMovementHistoryDBDAOsearchchssTpszOnCntrCHkRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     ,CASE WHEN SUBSTR(@[eq_tpsz_cd],2,1)='2' AND SUBSTR(A.EQ_TPSZ_CD,3,1) IN ('2', '4') THEN 'OK'" ).append("\n"); 
		query.append("           WHEN SUBSTR(@[eq_tpsz_cd],2,1)IN ('4', '5') AND SUBSTR(A.EQ_TPSZ_CD,3,1) IN ('4', '5', '8') THEN 'OK'" ).append("\n"); 
		query.append("           WHEN SUBSTR(@[eq_tpsz_cd],2,1)='7' AND SUBSTR(A.EQ_TPSZ_CD,3,1) IN ('5', '8') THEN 'OK'" ).append("\n"); 
		query.append("           WHEN SUBSTR(@[eq_tpsz_cd],2,1)='9' AND SUBSTR(A.EQ_TPSZ_CD,3,1) = '8' THEN 'OK'" ).append("\n"); 
