...
public class OnhireApprovalDBDAOsearchOnhireApprovalNumber2RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("LIST.ONH_LOC_CD S_ONH_LOC_CD ," ).append("\n"); 
		query.append("LIST.APRO_RMK S_APRO_RMK," ).append("\n"); 
		query.append("LIST.PKUP_FM_DT S_PKUP_FM_DT," ).append("\n"); 
		...
		query.append("LIST.EFF_DT ," ).append("\n"); 
		query.append("LIST.EXP_DT ," ).append("\n"); 
		query.append("LIST.RETURN_LCC   " ).append("\n"); 
		...
		query.append("Z.ONH_LOC_CD ONH_LOC_CD ," ).append("\n"); 
		...
		query.append("A.LOC_CD AS RETURN_LCC" ).append("\n"); 
		...
		query.append(", Z.P_UP_CHARGE , Z.P_UP_CREDIT , Z.MIN_ONH_DAYS , Z.DPP , Z.PKUP_FM_DT, Z.PKUP_DUE_DT" ).append("\n"); 
		query.append(", Z.DPP_FREE_DAY , Z.ONH_LOC_CD , Z.APRO_RMK , Z.PKUP_DUE_DT ,Z.EFF_DT, Z.EXP_DT, Z.RETURN_LCC )LIST" ).append("\n"); 
