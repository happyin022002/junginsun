...
public class GeneralCodeSearchGRPVO {
	...
	private List<List<CustomMstGeneralCodeVO>> listCustomMstGeneralCodeVOS = null;
	
	public void setListCustomMstGeneralCodeVOS(
			List<List<CustomMstGeneralCodeVO>> listCustomMstGeneralCodeVOS) {
		this.listCustomMstGeneralCodeVOS = listCustomMstGeneralCodeVOS;
	}  
	 
	public List<List<CustomMstGeneralCodeVO>> getListCustomMstGeneralCodeVOS() {
		return listCustomMstGeneralCodeVOS;
	}
...
//	}
	...
	private List<CustomMstGeneralCodeVO> CustomMstGeneralCodeVOS = null;

	public List<CustomMstGeneralCodeVO> getCustomMstGeneralCodeVOS() {
		return CustomMstGeneralCodeVOS;
	}   
		
	public void setCustomMstGeneralCodeVOS(
			List<CustomMstGeneralCodeVO> CustomMstGeneralCodeVOS) {
		this.CustomMstGeneralCodeVOS = CustomMstGeneralCodeVOS;
	}
