...
public class MGSAtchDtchHisMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSAtchDtchHisMGTVO> models = new ArrayList<MGSAtchDtchHisMGTVO>();
	...
	public MGSAtchDtchHisMGTVO() {}

	public MGSAtchDtchHisMGTVO(String ibflag, String pagerows, String eqNo, String cntrNo, String atchYdCd, String atchDt, String dtchYdCd, String dtchDt, String lagDt, String lagDtYd, String leadDt, String leadDtYd) {
	 ...
	 */
	public MGSAtchDtchHisMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CgmEqAtchDtchHisMGTVO[]
	 */
	public MGSAtchDtchHisMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSAtchDtchHisMGTVO model = null;
	 ...
	 * @return CgmEqAtchDtchHisMGTVO[]
	 */
	public MGSAtchDtchHisMGTVO[] getCgmEqAtchDtchHisMGTVOs(){
		MGSAtchDtchHisMGTVO[] vos = (MGSAtchDtchHisMGTVO[])models.toArray(new MGSAtchDtchHisMGTVO[models.size()]);
		return vos;
	}
