...
public class EQFlagListINVO extends AbstractValueObject {
	...
	/* Column Info */
	private String flgYdType = null;
	/* Column Info */
	private String excelLoadFlg = null;
	/* Column Info */
	...
	public EQFlagListINVO(String ibflag, String pagerows, String mnrHngrTrfOtrDesc, String mnrScrpFlg, String mnrTtlLssFlgDt, String mtrlNm, String hngrBarTtlQty, String mnrDonaFlgDt, String sdaysDt, String mnrDmgFlgYdCd, String mnrDispSelTpCd, String mnrOrdOfcCtyCd, String mnrFlgInpDt, String mnrHngrBarTpCd, String pLocTp, String mnrLostHngrQty, String mnrDispSelFlg, String eqList, String utPrice, String dispRsnCd, String eqMvmtIdNo, String mnrDispHngrQty, String lstmCd, String updUsrId, String mnrDispSelFlgYdCd, String dispNo, String mnrDispFlg, String eqMdlNm, String mnrFlgTpCd, String hngrBarAtchKnt, String mnrOrgHngrBarTpCd, String mnrDispFlgDt, String mnrDispFlgYdCd, String toDate, String mnrHngrFlgDt, String mnrScrpFlgDt, String flagType, String eqTpszCd, String dvValue, String bkgNo, String creUsrId, String fromDate, String mnrHngrFlg, String mnrFlgSeq, String mnrHngrDmgQty, String mnrFlgCmplDt, String mnrFlgRmk, String eqMvmtYr, String eqMkrNm, String mvmtDt, String mtrlCd, String rprCostAmt, String manuDt, String mnrScrpFlgYdCd, String barIfChk, String creDt, String crntYdCd, String pLocCd, String mnrTariffType, String hngrBarAmdQty, String mnrStsRmk, String mnrRprFlgYdCd, String mnrRprFlgDt, String cnmvStsCd, String eqNo, String creOfcCd, String woNo, String mnrHngrDtlOffrDesc, String mnrDispSelFlgDt, String updDt, String mnrDmgFlgDtOverDay, String mnrHngrFlgYdCd, String boundTpCd, String mnrFlgYdCd, String mvmtCd, String mnrFlgInpTpCd, String costDtlCd, String eqKndCd, String mnrDonaFlgYdCd, String actInvtQty, String mnrDmgFlgDt, String ofcCd, String mnrDmgFlg, String recentHngrBarAtchKnt, String mnrOrdSeq, String mnrHngrRckCd, String mnrRprFlg, String mnrStsFlg, String dispStsNm, String mnrTtlLssFlgYdCd, String mnrTtlLssFlg, String mnrHngrTrfCd, String mnrDonaFlg, String flgYdType, String excelLoadFlg, String rstrUsgLbl) {
		...
		this.flgYdType = flgYdType;
		this.excelLoadFlg = excelLoadFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("flg_yd_type", getFlgYdType());
		this.hashColumns.put("excel_load_flg", getExcelLoadFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("flg_yd_type", "flgYdType");
		this.hashFields.put("excel_load_flg", "excelLoadFlg");
	 ...
	 * @return flgYdType
	 */
	public String getFlgYdType() {
		return this.flgYdType;
	}
	 ...
	 * @return excelLoadFlg
	 */
	public String getExcelLoadFlg() {
		return this.excelLoadFlg;
	}
	 ...
	 * @param flgYdType
	 */
	public void setFlgYdType(String flgYdType) {
		this.flgYdType = flgYdType;
	}
	 ...
	 * @param excelLoadFlg
	 */
	public void setExcelLoadFlg(String excelLoadFlg) {
		this.excelLoadFlg = excelLoadFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFlgYdType(JSPUtil.getParameter(request, prefix + "flg_yd_type", ""));
		setExcelLoadFlg(JSPUtil.getParameter(request, prefix + "excel_load_flg", ""));
	...
	public EQFlagListINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] flgYdType = (JSPUtil.getParameter(request, prefix	+ "flg_yd_type", length));
			String[] excelLoadFlg = (JSPUtil.getParameter(request, prefix	+ "excel_load_flg", length));
			String[] rstrUsgLbl = (JSPUtil.getParameter(request, prefix	+ "rstr_usg_lbl", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (flgYdType[i] != null)
					model.setFlgYdType(flgYdType[i]);
				if (excelLoadFlg[i] != null)
					model.setExcelLoadFlg(excelLoadFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.flgYdType = this.flgYdType .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.excelLoadFlg = this.excelLoadFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
