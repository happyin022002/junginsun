...
*@FileName : SCExceptionTariffMgtDBDAOSearchCustomerListBySCRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchCustomerListBySCRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Actual Customer 정보를 조회하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchCustomerListBySCRSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchCustomerListBySCRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE	SP_ACT_CUST.PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("" ).append("\n"); 
