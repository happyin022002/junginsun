...
*@FileName : ChassisMgsetOnOffhireDBDAOsearchCHSOnOffhireDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOsearchCHSOnOffhireDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOsearchCHSOnOffhireDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOsearchCHSOnOffhireDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT --B.STS_EVNT_LOC_CD || A.AGMT_LSTM_CD  AS AGREEMENT" ).append("\n"); 
		query.append("      --," ).append("\n"); 
		...
		query.append("      ,MAX(D.INTG_CD_VAL_DP_SEQ)  INTG_CD_VAL_DP_SEQ" ).append("\n"); 
		...
		query.append(" AND D.INTG_CD_ID (+)   = 'CD01948' " ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("   #end" ).append("\n"); 
		query.append("#if ( ${sts_evnt_yd_cd} != '' )" ).append("\n"); 
		query.append("   ORDER BY B.STS_EVNT_YD_CD ,INTG_CD_VAL_DP_SEQ " ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   #if ( ${location} == 'S' )" ).append("\n"); 
		query.append("       ORDER BY B.STS_EVNT_YD_CD ,INTG_CD_VAL_DP_SEQ " ).append("\n"); 
		query.append("   #else" ).append("\n"); 
		query.append("   	   ORDER BY B.STS_EVNT_LOC_CD ,INTG_CD_VAL_DP_SEQ" ).append("\n"); 
		query.append("   #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
