...
public class TariffMgtDBDAOsearchDisposalTariffQuarterListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		CASE WHEN A.RCC_CD IS NOT NULL AND A.LOC_CD IS NULL THEN 'AVG.'" ).append("\n"); 
		query.append("             ELSE A.LOC_CD" ).append("\n"); 
		query.append("        END LOC_CD" ).append("\n"); 
		query.append("		, A.LOC_CNT, A.CURR_CD,    " ).append("\n"); 
