...
public class CgmCheckLocationEvent extends EventSupport {
	...
	public LocationMGTVO[] getLocationMGTVOs() {
		LocationMGTVO[] rtnVOs = null;
		if (this.locationMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(locationMGTVOs, locationMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setLocationMGTVOs(LocationMGTVO[] locationMGTVOs){
		if(locationMGTVOs != null){
			LocationMGTVO[] tmpVOs = java.util.Arrays.copyOf(locationMGTVOs, locationMGTVOs.length);
			this.locationMGTVOs = tmpVOs;
		}
	}
