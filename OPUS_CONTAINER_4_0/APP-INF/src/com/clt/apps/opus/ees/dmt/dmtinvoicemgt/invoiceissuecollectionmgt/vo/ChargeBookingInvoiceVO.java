...
public class ChargeBookingInvoiceVO extends AbstractValueObject {
	...
	/* Column Info */
	private String custCdA = null;
	/* Column Info */
	private String custNmA = null;
	/* Column Info */
	private String custCdF = null;
	/* Column Info */
	private String custNmF = null;
	...
	public ChargeBookingInvoiceVO(String ibflag, String pagerows, String dmdtInvNo, String creDt, String creOfcCd, String creCntCd, String creUsrId, String creUsrNm, String updUsrId, String updUsrNm, String dmdtInvStsCd, String dmdtInvStsNm, String dmdtArIfCd, String arIfDt, String arIfOfcCd, String arIfUsrId, String arIfUsrNm, String crInvNo, String bkgNo, String blNo, String dmdtTrfCd, String scNo, String ofcCd, String vvdCd, String porCd, String polCd, String podCd, String delCd, String rd, String bkgCustCd, String bkgCustNm, String actCustCd, String actCustNm, String issDtPrnFlg, String crTermDys, String payerCd, String payerNm, String ntcKntCd, String overDay, String dmdtPayrCntcPntNm, String custCntcPntSeq, String payrCntcPntPhnNo, String payrCntcPntFaxNo, String payrCntcPntEml, String truckerCd, String truckerNm, String invRefNo, String invRmk, String invRmk1, String invRmk2, String chgCurrCd, String orgChgAmt, String dmdtExptAmt, String chgDcAmt, String bilAmt, String aftInvAdjAmt, String invCurrCd, String invXchRt, String cntrCnt, String totAmt, String dcAmt, String invChgAmt, String taxRto, String taxAmt, String invAmt, String chgType, String rfaNo, String issueDay, String svrId, String bilToLocDivCd, String mnlInvSndFlg, String cntrNo, String vslCd, String skdVoyNo, String skdDirCd, String vpsPortCd, String mnOrgChgAmt, String mnBilAmt, String dueDate, String dmdtCxlRsnCd, String cxlRmk, String invHldRsnCd, String invHldRmk, String dmdtCxlRsnNm, String invHldRsnNm, String updDt, String updOfcCd, String mnlInvRmk, String faxEmailSndCnt, String crArYn, String invTaxRto, String vndrSeq, String vndrNm, String caller, String invPrtFlg, String cntCd, String useRtCurr, String idaExpnTaxRt, String idaEduTaxRt, String idaHighEduTaxRt, String taxRgstNo, String svcCateRmk, String pmntAcctNo, String idaExpnTax, String idaEduTax, String idaHighEduTax, String custCdS, String custNmS, String custCdN, String custNmN, String custCdC, String custNmC, String custCdA, String custNmA, String custCdF, String custNmF) {
		...
		this.custCdA = custCdA;
		this.custNmA = custNmA;
		this.custCdF = custCdF;
		this.custNmF = custNmF;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cust_cd_a", getCustCdA());
		this.hashColumns.put("cust_nm_a", getCustNmA());
		this.hashColumns.put("cust_cd_f", getCustCdF());
		this.hashColumns.put("cust_nm_f", getCustNmF());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cust_cd_a", "custCdA");
		this.hashFields.put("cust_nm_a", "custNmA");
		this.hashFields.put("cust_cd_f", "custCdF");
		this.hashFields.put("cust_nm_f", "custNmF");
	...
	public String getCustCdA() {
		return custCdA;
	}

	public void setCustCdA(String custCdA) {
		this.custCdA = custCdA;
	}

	public String getCustNmA() {
		return custNmA;
	}

	public void setCustNmA(String custNmA) {
		this.custNmA = custNmA;
	}

	public String getCustCdF() {
		return custCdF;
	}

	public void setCustCdF(String custCdF) {
		this.custCdF = custCdF;
	}

	public String getCustNmF() {
		return custNmF;
	}

	public void setCustNmF(String custNmF) {
		this.custNmF = custNmF;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCustCdA(JSPUtil.getParameter(request, "cust_cd_a", ""));
		setCustNmA(JSPUtil.getParameter(request, "cust_nm_a", ""));
		setCustCdF(JSPUtil.getParameter(request, "cust_cd_f", ""));
		setCustNmF(JSPUtil.getParameter(request, "cust_nm_f", ""));
	}
	...
	public ChargeBookingInvoiceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] custCdA = (JSPUtil.getParameter(request, prefix	+ "cust_cd_a", length));
			String[] custNmA = (JSPUtil.getParameter(request, prefix	+ "cust_nm_a", length));
			String[] custCdF = (JSPUtil.getParameter(request, prefix	+ "cust_cd_f", length));
			String[] custNmF = (JSPUtil.getParameter(request, prefix	+ "cust_nm_f", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (custCdA[i] != null)
					model.setCustCdA(custCdA[i]);
				if (custNmA[i] != null)
					model.setCustNmA(custNmA[i]);
				if (custCdF[i] != null)
					model.setCustCdF(custCdF[i]);
				if (custNmF[i] != null)
					model.setCustNmF(custNmF[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.custCdA = this.custCdA .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.custNmA = this.custNmA .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.custCdF = this.custCdF .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.custNmF = this.custCdF .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
