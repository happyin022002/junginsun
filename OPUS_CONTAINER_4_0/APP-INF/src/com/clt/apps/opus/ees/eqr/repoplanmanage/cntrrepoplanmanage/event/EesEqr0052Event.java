...
public class EesEqr0052Event extends EventSupport {
	...
	private EesEqr0052MultiVO[] eesEqr0052MultiVOS = null;
	...
	public EesEqr0052MultiVO[] getEesEqr0052MultiVOS() {
		EesEqr0052MultiVO[] tmpVOs = null;
		if (this.eesEqr0052MultiVOS != null) {
			tmpVOs = new EesEqr0052MultiVO[eesEqr0052MultiVOS.length];
			System.arraycopy(eesEqr0052MultiVOS, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
	...
	public void setEesEqr0052MultiVOS(EesEqr0052MultiVO[] eesEqr0052MultiVOS) {
		if (eesEqr0052MultiVOS != null) {
			EesEqr0052MultiVO[] tmpVOs = new EesEqr0052MultiVO[eesEqr0052MultiVOS.length];
			System.arraycopy(eesEqr0052MultiVOS, 0, tmpVOs, 0, tmpVOs.length);
			this.eesEqr0052MultiVOS = tmpVOs;
		}
	}
