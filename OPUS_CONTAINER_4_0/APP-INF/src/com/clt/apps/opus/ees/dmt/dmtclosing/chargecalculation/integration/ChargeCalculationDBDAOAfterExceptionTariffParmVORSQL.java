...
*@FileName : ChargeCalculationDBDAOAfterExceptionTariffParmVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOAfterExceptionTariffParmVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChargeCalculationDBDAOAfterExceptionTariffParmVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.dmt.dmtclosing.chargecalculation.integration").append("\n"); 
		query.append("FileName : ChargeCalculationDBDAOAfterExceptionTariffParmVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
