...
*@FileName : EesEqr1030ConditionVO.java
*@FileTitle : EesEqr1030ConditionVO
*Open Issues :
*Change history :
...
public class EesEqr1030ConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EesEqr1030ConditionVO> models = new ArrayList<EesEqr1030ConditionVO>();
	...
	public EesEqr1030ConditionVO() {}

	public EesEqr1030ConditionVO(String ibflag, String pagerows, String fRhqcd, String fOfccd) {
		this.ibflag = ibflag;
		this.fOfccd = fOfccd;
		this.fRhqcd = fRhqcd;
...
/**
	 ...
	 */
	public EesEqr1030ConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EesEqr1030ConditionVO[]
	 */
	public EesEqr1030ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EesEqr1030ConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EesEqr1030ConditionVO();
				if (ibflag[i] != null)
		...
		return getEesEqr1030ConditionVOs();
	}
	 ...
	 * @return EesEqr1030ConditionVO[]
	 */
	public EesEqr1030ConditionVO[] getEesEqr1030ConditionVOs(){
		EesEqr1030ConditionVO[] vos = (EesEqr1030ConditionVO[])models.toArray(new EesEqr1030ConditionVO[models.size()]);
		return vos;
	}
