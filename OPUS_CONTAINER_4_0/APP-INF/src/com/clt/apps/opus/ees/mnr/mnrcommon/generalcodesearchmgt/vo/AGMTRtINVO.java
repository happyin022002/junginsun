...
*@FileName : searchMnrAgmtRtVO.java
*@FileTitle : searchMnrAgmtRtVO
*Open Issues :
*Change history :
...
public class AGMTRtINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AGMTRtINVO> models = new ArrayList<AGMTRtINVO>();
	...
	public AGMTRtINVO(String ibflag, String pagerows, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String costCd, String costDtlCd, String mnrRtTpCd, String rprQty, String agmtRtAmt, String creUsrId, String creDt, String updUsrId, String updDt, String ydCd) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return searchMnrAgmtRtVO[]
	 */
	public AGMTRtINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchMnrAgmtRtVO[]
	 */
	public AGMTRtINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AGMTRtINVO model = null;
	 ...
	 * @return searchMnrAgmtRtVO[]
	 */
	public AGMTRtINVO[] getsearchMnrAgmtRtVOs(){
		AGMTRtINVO[] vos = (AGMTRtINVO[])models.toArray(new AGMTRtINVO[models.size()]);
		return vos;
	}
