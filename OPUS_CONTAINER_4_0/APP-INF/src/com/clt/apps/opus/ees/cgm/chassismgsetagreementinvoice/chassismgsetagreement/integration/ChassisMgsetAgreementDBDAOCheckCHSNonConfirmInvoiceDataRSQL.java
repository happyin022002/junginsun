...
*@FileName : ChassisMgsetAgreementDBDAOCheckCHSNonConfirmInvoiceDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAOCheckCHSNonConfirmInvoiceDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAOCheckCHSNonConfirmInvoiceDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAOCheckCHSNonConfirmInvoiceDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
