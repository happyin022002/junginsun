...
public class WaiveReportDBDAOSearchWaveReportByOfficeListRSQL implements ISQLTemplate{
	...
	public WaiveReportDBDAOSearchWaveReportByOfficeListRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.dmt.dmtperformanceanalysis.waivereport.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT  DECODE(@[grp_flg], 'O', X.PROG_OFC_CD, 'R', OV.OFC_N2ND_LVL_CD) AS OFFICE," ).append("\n"); 
		...
		query.append("    )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("GROUP BY DECODE(@[grp_flg], 'O', X.PROG_OFC_CD, 'R', OV.OFC_N2ND_LVL_CD)," ).append("\n"); 
