...
*@FileName : CIMCommonDBDAOAddCtmMovementCorrDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CIMCommonDBDAOAddCtmMovementCorrDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CTM_MOVEMENT 조회하여 CTM_MVMT_CORR테이블에 insert
	  * </pre>
	  */
	public CIMCommonDBDAOAddCtmMovementCorrDataCSQL(){
		setQuery();
		...
		query.append("FileName : CIMCommonDBDAOAddCtmMovementCorrDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
