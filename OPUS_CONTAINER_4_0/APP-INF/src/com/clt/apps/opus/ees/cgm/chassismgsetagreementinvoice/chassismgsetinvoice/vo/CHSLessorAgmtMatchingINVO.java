...
*@FileName : LessorAgmtMatchingINVO.java
*@FileTitle : LessorAgmtMatchingINVO
*Open Issues :
*Change history :
...
public class CHSLessorAgmtMatchingINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSLessorAgmtMatchingINVO> models = new ArrayList<CHSLessorAgmtMatchingINVO>();
	...
	public CHSLessorAgmtMatchingINVO() {}

	public CHSLessorAgmtMatchingINVO(String delChk, String ibflag, String pagerows, String eqKndCd, String agmtNo, String vndrSeq, String invRefNo, String agmtSeq, String agmtOfcCtyCd, String vndrLglEngNm, String creUsrId, String updUsrId) {
		this.delChk = delChk;
	 ...
	 * @param request
	 * @return LessorAgmtMatchingINVO[]
	 */
	public CHSLessorAgmtMatchingINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LessorAgmtMatchingINVO[]
	 */
	public CHSLessorAgmtMatchingINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSLessorAgmtMatchingINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSLessorAgmtMatchingINVO();
				if (delChk[i] != null)
		...
		return getLessorAgmtMatchingINVOs();
	}
	 ...
	 * @return LessorAgmtMatchingINVO[]
	 */
	public CHSLessorAgmtMatchingINVO[] getLessorAgmtMatchingINVOs(){
		CHSLessorAgmtMatchingINVO[] vos = (CHSLessorAgmtMatchingINVO[])models.toArray(new CHSLessorAgmtMatchingINVO[models.size()]);
		return vos;
	}
