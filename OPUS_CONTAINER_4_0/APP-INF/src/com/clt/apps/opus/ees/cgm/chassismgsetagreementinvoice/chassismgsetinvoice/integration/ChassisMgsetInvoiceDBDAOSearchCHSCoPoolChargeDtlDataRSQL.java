...
*@FileName : ChassisMgsetInvoiceDBDAOSearchCHSCoPoolChargeDtlDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOSearchCHSCoPoolChargeDtlDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.SearchCHSCoPoolChargeDtlData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOSearchCHSCoPoolChargeDtlDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOSearchCHSCoPoolChargeDtlDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    T2.POOL_BSRT_AMT," ).append("\n"); 
		...
		query.append("	           A.POOL_BSRT_AMT," ).append("\n"); 
		...
		query.append("				                   AND CHSS_MGST_INV_KND_CD = 'CP'" ).append("\n"); 
