...
import com.clt.apps.opus.ees.eqr.repoplanmanage.cntrreporesult.integration.CntrRepoResultManageDBDAO;
...
/**
 * -CntrRepoResultManage Business Logic Command Interface<br>
 *
 * @author 
 * @see EvetnException 
 * @since J2EE 1.6
...
public class CntrRepoResultManageBCImpl extends BasicCommandSupport implements CntrRepoResultManageBC {
	...
	/**
	 * creating CntrRepoResultManageBCImpl<br>
	 * creating CntrRepoResultManageDBDAO<br>
	 */
