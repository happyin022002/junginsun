...
*@FileName : EES_CGM_1103HTMLAction.java
...
public class EES_CGM_1103HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1103HTMLAction 객체를 생성
	 */
	public EES_CGM_1103HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1103Event event = new EesCgm1103Event();
		
		
		CHSInventoryByVariationDtlINVO cHSInventoryByVariationDtlINVO = new CHSInventoryByVariationDtlINVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			cHSInventoryByVariationDtlINVO = (CHSInventoryByVariationDtlINVO)getVO(request, CHSInventoryByVariationDtlINVO .class);
			event.setCHSInventoryByVariationDtlINVO(cHSInventoryByVariationDtlINVO);
