...
*@FileName : EES_CTM_0415HTMLAction.java
...
public class EES_CTM_0415HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0415HTMLAction 객체를 생성
	 */
	public EES_CTM_0415HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0415Event event = new EesCtm0415Event();
