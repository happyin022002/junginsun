...
*@FileName : CustomMnrStsHisVO.java
*@FileTitle : CustomMnrStsHisVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.ees.mnr.generalmanage.statushistorymgt.vo;
...
public class CustomMnrStsHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomMnrStsHisVO> models = new ArrayList<CustomMnrStsHisVO>();
	 ...
	 * @param request
	 * @return CustomMnrStsHisVO[]
	 */
	public CustomMnrStsHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomMnrStsHisVO[]
	 */
	public CustomMnrStsHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMnrStsHisVO model = null;
	 ...
	 * @return CustomMnrStsHisVO[]
	 */
	public CustomMnrStsHisVO[] getCustomMnrStsHisVOs(){
		CustomMnrStsHisVO[] vos = (CustomMnrStsHisVO[])models.toArray(new CustomMnrStsHisVO[models.size()]);
		return vos;
	}
