...
public class SearchEDIErrorVO extends AbstractValueObject {
	...
	/* Column Info */
	private String corrIgnr = null;
	/* Column Info */
	private String corrIgnrRatio = null;
	/* Column Info */
	private String slvdTtl = null;
	/* Column Info */
	private String slvdTtlRatio = null;
	/* Column Info */
	private String initIgnr = null;
	/* Column Info */
	private String initIgnrRatio = null;
	/* Column Info */
	...
	/* Column Info */
	private String slvdErr = null;
	/* Column Info */
	private String slvdErrRatio = null;
	/* Column Info */
	private String slvdIgnr = null;
	/* Column Info */
	private String slvdIgnrRatio = null;
	/* Column Info */
	private String slvdCntDt = null;
	...
	public SearchEDIErrorVO(String ibflag, String pagerows, String cn, String cntrNo, String cntrTpszCd, String corrErr, String corrErrRatio, String slvdErr, String slvdErrRatio, String slvdIgnr, String slvdIgnrRatio, String corrOk, String corrOkRatio, String corrTtl, String creLoclDt, String dataRadio, String divide, String ediGateIoCd, String ediMvmtStsCd, String evntDt, String evntYdCd, String initErr, String initErrRatio, String corrIgnr, String corrIgnrRatio, String slvdTtl, String slvdTtlRatio, String initIgnr, String initIgnrRatio, String initOk, String initOkRatio, String initTtl, String lcc, String lccCd, String loc, String mvmtEdiRmk, String pDate1, String pDate2, String pYard1, String pYard2, String rcc, String rccCd, String tpCd, String yard, String slvdCntDt) {
		this.yard = yard;
		...
		this.corrIgnr = corrIgnr;
		this.corrIgnrRatio = corrIgnrRatio;
		this.slvdTtl = slvdTtl;
		this.slvdTtlRatio = slvdTtlRatio;
		this.initIgnr = initIgnr;
		this.initIgnrRatio = initIgnrRatio;
		...
		this.slvdErr = slvdErr;
		this.slvdErrRatio = slvdErrRatio;
		this.slvdIgnr = slvdIgnr;
		this.slvdIgnrRatio = slvdIgnrRatio;
		this.slvdCntDt = slvdCntDt;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("corr_ignr", getCorrIgnr());
		this.hashColumns.put("corr_ignr_ratio", getCorrIgnrRatio());
		this.hashColumns.put("slvd_ttl", getSlvdTtl());
		this.hashColumns.put("slvd_ttl_ratio", getSlvdTtlRatio());
		this.hashColumns.put("init_ignr", getInitIgnr());
		this.hashColumns.put("init_ignr_ratio", getInitIgnrRatio());
		...
		this.hashColumns.put("slvd_err", getSlvdErr());
		this.hashColumns.put("slvd_err_ratio", getSlvdErrRatio());
		this.hashColumns.put("slvd_ignr", getSlvdIgnr());
		this.hashColumns.put("slvd_ignr_ratio", getSlvdIgnrRatio());
		this.hashColumns.put("slvd_cnt_dt", getSlvdCntDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("corr_ignr", "corrIgnr");
		this.hashFields.put("corr_ignr_ratio", "corrIgnrRatio");
		this.hashFields.put("slvd_ttl", "slvdTtl");
		this.hashFields.put("slvd_ttl_ratio", "slvdTtlRatio");
		this.hashFields.put("init_ignr", "initIgnr");
		this.hashFields.put("init_ignr_ratio", "initIgnrRatio");
		...
		this.hashFields.put("slvd_err", "slvdErr");
		this.hashFields.put("slvd_err_ratio", "slvdErrRatio");
		this.hashFields.put("slvd_ignr", "slvdIgnr");
		this.hashFields.put("slvd_ignr_ratio", "slvdIgnrRatio");
		this.hashFields.put("slvd_cnt_dt", "slvdCntDt");
	 ...
	 * @return corrIgnr
	 */
	public String getCorrIgnr() {
		return this.corrIgnr;
	}
	
	/**
	 * Column Info
	 * @return corrIgnrRatio
	 */
	public String getCorrIgnrRatio() {
		return this.corrIgnrRatio;
	}
	 ...
	 * @return slvdTtlRatio
	 */
	public String getSlvdTtlRatio() {
		return this.slvdTtlRatio;
	}
	 ...
	 * @return initIgnr
	 */
	public String getInitIgnr() {
		return this.initIgnr;
	}
	
	/**
	 * Column Info
	 * @return initIgnrRatio
	 */
	public String getInitIgnrRatio() {
		return this.initIgnrRatio;
	}
	 ...
	 * @return slvdErrRatio
	 */
	public String getSlvdErrRatio() {
		return this.slvdErrRatio;
	}
	 ...
	 * @return slvdIgnr
	 */
	public String getSlvdIgnr() {
		return this.slvdIgnr;
	}
	
	/**
	 * Column Info
	 * @return slvdIgnrRatio
	 */
	public String getSlvdIgnrRatio() {
		return this.slvdIgnrRatio;
	}
	 ...
	 * @return slvdCntDt
	 */
	public String getSlvdCntDt() {
		return this.slvdCntDt;
	}
	 ...
	 * @param corrIgnr
	 */
	public void setCorrIgnr(String corrIgnr) {
		this.corrIgnr = corrIgnr;
	}
	 ...
	 * @param corrIgnrRatio
	 */
	public void setCorrIgnrRatio(String corrIgnrRatio) {
		this.corrIgnrRatio = corrIgnrRatio;
	}
	 ...
	 * @param slvdTtl
	 */
	public void setSlvdTtl(String slvdTtl) {
		this.slvdTtl = slvdTtl;
	}
	 ...
	 * @param slvdTtlRatio
	 */
	public void setSlvdTtlRatio(String slvdTtlRatio) {
		this.slvdTtlRatio = slvdTtlRatio;
	}
	 ...
	 * @param initIgnr
	 */
	public void setInitIgnr(String initIgnr) {
		this.initIgnr = initIgnr;
	}
	 ...
	 * @param initIgnr
	 */
	public void setInitIgnrRatio(String initIgnrRatio) {
		this.initIgnrRatio = initIgnrRatio;
	}
	 ...
	 * @param slvdErr
	 */
	public void setSlvdErr(String slvdErr) {
		this.slvdErr = slvdErr;
	}
	 ...
	 * @param slvdErrRatio
	 */
	public void setSlvdErrRatio(String slvdErrRatio) {
		this.slvdErrRatio = slvdErrRatio;
	}
	 ...
	 * @param slvdIgnr
	 */
	public void setSlvdIgnr(String slvdIgnr) {
		this.slvdIgnr = slvdIgnr;
	}
	 ...
	 * @param slvdIgnrRatio
	 */
	public void setSlvdIgnrRatio(String slvdIgnrRatio) {
		this.slvdIgnrRatio = slvdIgnrRatio;
	}
	 ...
	 * @param slvdCntDt
	 */
	public void setSlvdCntDt(String slvdCntDt) {
		this.slvdCntDt = slvdCntDt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCorrIgnr(JSPUtil.getParameter(request, prefix + "corr_ignr", ""));
		setCorrIgnrRatio(JSPUtil.getParameter(request, prefix + "corr_ignr_ratio", ""));
		setSlvdTtl(JSPUtil.getParameter(request, prefix + "slvd_ttl", ""));
		setSlvdTtlRatio(JSPUtil.getParameter(request, prefix + "slvd_ttl_ratio", ""));
		setInitIgnr(JSPUtil.getParameter(request, prefix + "init_ignr", ""));
		setInitIgnrRatio(JSPUtil.getParameter(request, prefix + "init_ignr_ratio", ""));
		...
		setSlvdErr(JSPUtil.getParameter(request, prefix + "slvd_err", ""));
		setSlvdErrRatio(JSPUtil.getParameter(request, prefix + "slvd_err_ratio", ""));
		setSlvdIgnr(JSPUtil.getParameter(request, prefix + "slvd_ignr", ""));
		setSlvdIgnrRatio(JSPUtil.getParameter(request, prefix + "slvd_ignr_ratio", ""));
		setSlvdCntDt(JSPUtil.getParameter(request, prefix + "slvd_cnt_dt", ""));
	}
	...
	public SearchEDIErrorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] corrIgnr = (JSPUtil.getParameter(request, prefix	+ "corr_ignr", length));
			String[] corrIgnrRatio = (JSPUtil.getParameter(request, prefix	+ "corr_ignr_ratio", length));
			String[] slvdTtl = (JSPUtil.getParameter(request, prefix	+ "slvd_ttl", length));
			String[] slvdTtlRatio = (JSPUtil.getParameter(request, prefix	+ "slvd_ttl_ratio", length));
			String[] initIgnr = (JSPUtil.getParameter(request, prefix	+ "init_ignr", length));
			String[] initIgnrRatio = (JSPUtil.getParameter(request, prefix	+ "init_ignr_ratio", length));
			...
			String[] slvdErr = (JSPUtil.getParameter(request, prefix	+ "slvd_err", length));
			String[] slvdErrRatio = (JSPUtil.getParameter(request, prefix	+ "slvd_err_ratio", length));
			String[] slvdIgnr = (JSPUtil.getParameter(request, prefix	+ "slvd_ignr", length));
			String[] slvdIgnrRatio = (JSPUtil.getParameter(request, prefix	+ "slvd_ignr_ratio", length));
			String[] slvdCntDt = (JSPUtil.getParameter(request, prefix	+ "slvd_cnt_dt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (corrIgnr[i] != null)
					model.setCorrIgnr(corrIgnr[i]);
				if (corrIgnrRatio[i] != null)
					model.setCorrIgnrRatio(corrIgnrRatio[i]);
				if (slvdTtl[i] != null)
					model.setSlvdTtl(slvdTtl[i]);
				if (slvdTtlRatio[i] != null)
					model.setSlvdTtlRatio(slvdTtlRatio[i]);
				if (initIgnr[i] != null)
					model.setInitIgnr(initIgnr[i]);
				if (initIgnrRatio[i] != null)
					model.setInitIgnrRatio(initIgnrRatio[i]);
				...
				if (slvdErr[i] != null)
					model.setSlvdErr(slvdErr[i]);
				if (slvdErrRatio[i] != null)
					model.setSlvdErrRatio(slvdErrRatio[i]);
				if (slvdIgnr[i] != null)
					model.setSlvdIgnr(slvdIgnr[i]);
				if (slvdIgnrRatio[i] != null)
					model.setSlvdIgnrRatio(slvdIgnrRatio[i]);
				if (slvdCntDt[i] != null)
					model.setSlvdCntDt(slvdCntDt[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.corrIgnr = this.corrIgnr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.corrIgnrRatio = this.corrIgnrRatio .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.slvdTtl = this.slvdTtl .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.slvdTtlRatio = this.slvdTtlRatio .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.initIgnr = this.initIgnr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.initIgnrRatio = this.initIgnrRatio .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.slvdErr = this.slvdErr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.slvdErrRatio = this.slvdErrRatio .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.slvdIgnr = this.slvdIgnr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.slvdIgnrRatio = this.slvdIgnrRatio .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.slvdCntDt = this.slvdCntDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
