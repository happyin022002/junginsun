...
public class CHSmgstChkINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSmgstChkINVO> models = new ArrayList<CHSmgstChkINVO>();
	...
	public CHSmgstChkINVO() {}

	public CHSmgstChkINVO(String ibflag, String pagerows, String result, String fromDt, String chssNo, String eqKndCd, String aciacDivCd, String mgstNo, String eqTpszCd, String toDt, String chk, String tpszCheck, String cntrNo, String cntrTpsz) {
		this.result = result;
		this.fromDt = fromDt;
		this.chssNo = chssNo;
...
/**
	 ...
	 */
	public CHSmgstChkINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSmgstChkINVO[]
	 */
	public CHSmgstChkINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSmgstChkINVO model = null;
	 ...
	 * @return CHSmgstChkINVO[]
	 */
	public CHSmgstChkINVO[] getCHSmgstChkINVOs(){
		CHSmgstChkINVO[] vos = (CHSmgstChkINVO[])models.toArray(new CHSmgstChkINVO[models.size()]);
		return vos;
	}
