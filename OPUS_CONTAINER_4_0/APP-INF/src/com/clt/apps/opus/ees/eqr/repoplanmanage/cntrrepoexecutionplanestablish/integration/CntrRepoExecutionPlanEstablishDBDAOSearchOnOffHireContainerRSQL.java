...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOSearchOnOffHireContainerRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOSearchOnOffHireContainerRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_EXE_PLN_CNTR 테이블에서 OnOff Hire의 특정 ref id의 컨테이너 정보 검색
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOSearchOnOffHireContainerRSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOSearchOnOffHireContainerRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
