...
*@FileName : CommonDBDAOSearchDuplicateCheckEqrWkPrdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOSearchDuplicateCheckEqrWkPrdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EES_EQR_0008화면에서 등록 이전에 등록여부를 체크한다.
	  * </pre>
	  */
	public CommonDBDAOSearchDuplicateCheckEqrWkPrdRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOSearchDuplicateCheckEqrWkPrdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(PLN_YR) AS CNT" ).append("\n"); 
