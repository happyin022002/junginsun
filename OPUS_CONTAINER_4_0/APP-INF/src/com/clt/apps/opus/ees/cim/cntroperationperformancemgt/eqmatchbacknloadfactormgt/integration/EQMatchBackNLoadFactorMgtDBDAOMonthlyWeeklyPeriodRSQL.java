...
*@FileName : EQMatchBackNLoadFactorMgtDBDAOMonthlyWeeklyPeriodRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorMgtDBDAOMonthlyWeeklyPeriodRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQMatchBackNLoadFactorMgtDBDAOMonthlyWeeklyPeriodRSQL(){
		setQuery();
		...
		query.append("FileName : EQMatchBackNLoadFactorMgtDBDAOMonthlyWeeklyPeriodRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT  DISTINCT PLN_YR||'-'||PLN_MON period" ).append("\n"); 
		query.append("FROM    EQR_WK_PRD" ).append("\n"); 
