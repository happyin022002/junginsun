...
*@FileName : EES_CIM_0034HTMLAction.java
...
public class EES_CIM_0034HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0001HTMLAction 객체를 생성
	 */
	public EES_CIM_0034HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0034Event event = new EesCim0034Event();
		
		event.setAvailOptionVO((AvailOptionVO)getVO(request, AvailOptionVO .class));
		event.setAvailListVO((AvailListVO)getVO(request, AvailListVO .class));
