...
*@FileName : ChargeCalculationDBDAOModifyChargeChnDemKeyNoBySZPBBUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOModifyChargeChnDemKeyNoBySZPBBUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOModifyChargeChnDemKeyNoBySZPBBUSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOModifyChargeChnDemKeyNoBySZPBBUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOModifyChargeChnDemKeyNoBySZPBBUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET SUTH_CHN_DEM_KEY_NO = @[svr_id] || @[cntr_no] || LPAD(@[cntr_cyc_no], 4, '0') || @[dmdt_trf_cd]" ).append("\n"); 
		query.append("|| 'SZP' || @[chg_seq]" ).append("\n"); 
		query.append("" ).append("\n"); 
