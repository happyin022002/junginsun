...
*@FileName : ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVODSQL.java
...
public class ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Deleting Cntr Movement Sequence
	  * </pre>
	  */
	public ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVODSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMasterDataMgtDBDAOCntrMvmtSeqVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CTM_MVMT_SEQ" ).append("\n"); 
