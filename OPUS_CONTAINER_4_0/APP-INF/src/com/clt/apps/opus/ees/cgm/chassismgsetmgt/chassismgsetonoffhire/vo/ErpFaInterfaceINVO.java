...
*@FileName : ErpFaInterfaceINVO.java
*@FileTitle : ErpFaInterfaceINVO
*Open Issues :
*Change history :
...
public class ErpFaInterfaceINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ErpFaInterfaceINVO> models = new ArrayList<ErpFaInterfaceINVO>();
	 ...
	 */
	public ErpFaInterfaceINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ErpFaInterfaceINVO[]
	 */
	public ErpFaInterfaceINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ErpFaInterfaceINVO model = null;
	...
	public ErpFaInterfaceINVO[] getErpFaInterfaceINVOs(){
		ErpFaInterfaceINVO[] vos = (ErpFaInterfaceINVO[])models.toArray(new ErpFaInterfaceINVO[models.size()]);
		return vos;
	}
