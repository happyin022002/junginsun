...
*@FileName : ChassisMgsetInvoiceDBDAOAddCHSChargeCreatePDMDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOAddCHSChargeCreatePDMDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.AddCHSChargeCreatePDMData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOAddCHSChargeCreatePDMDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOAddCHSChargeCreatePDMDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        CASE WHEN A.EQ_RNTL_TP_CD = 'D' THEN " ).append("\n"); 
		query.append("                                            (SELECT TR_RT_AMT" ).append("\n"); 
		query.append("                                               FROM CGM_AGMT_LSE_TR_RT" ).append("\n"); 
		query.append("                                              WHERE AGMT_OFC_CTY_CD = A.AGMT_OFC_CTY_CD" ).append("\n"); 
		query.append("                                                AND AGMT_SEQ = A.AGMT_SEQ" ).append("\n"); 
		query.append("                                                AND AGMT_VER_NO = A.AGMT_VER_NO" ).append("\n"); 
		query.append("                                                AND B.LSE_USE_DAYS" ).append("\n"); 
		query.append("                                                BETWEEN RNTL_FM_TR_VAL AND RNTL_TO_TR_VAL" ).append("\n"); 
		query.append("                                                AND EQ_TPSZ_CD = (SELECT EQ_TPSZ_CD FROM CGM_EQUIPMENT WHERE EQ_NO = A.EQ_NO ))" ).append("\n"); 
		query.append("             ELSE A.LSE_RT_AMT END AS LSE_RT_AMT," ).append("\n"); 
		...
		query.append("				CASE " ).append("\n"); 
		query.append("				    WHEN T1.AGMT_LSTM_CD = 'ST' THEN '510832'" ).append("\n"); 
		query.append("				    WHEN T1.AGMT_LSTM_CD = 'LT' THEN '510831'" ).append("\n"); 
		query.append("				    WHEN T1.AGMT_LSTM_CD = 'LP' THEN '510833'" ).append("\n"); 
		query.append("				    ELSE '510832'" ).append("\n"); 
		query.append("				END AS ACCT_CD," ).append("\n"); 
		query.append("                NVL(CASE WHEN T1.EQ_RNTL_TP_CD = 'F' THEN" ).append("\n"); 
		query.append("                        (SELECT CHSS_LSE_RT_AMT" ).append("\n"); 
		...
		query.append("                               AND AGMT_SEQ = T1.AGMT_SEQ" ).append("\n"); 
		query.append("                               AND AGMT_VER_NO = T1.AGMT_VER_NO" ).append("\n"); 
		query.append("                               AND (SELECT COUNT(EQ_NO) FROM CGM_EQUIPMENT " ).append("\n"); 
		query.append("                                    WHERE AGMT_OFC_CTY_CD = T1.AGMT_OFC_CTY_CD" ).append("\n"); 
		query.append("                                          AND AGMT_SEQ = T1.AGMT_SEQ)" ).append("\n"); 
		query.append("                                    BETWEEN RNTL_FM_TR_VAL AND RNTL_TO_TR_VAL" ).append("\n"); 
		query.append("                               AND EQ_TPSZ_CD = (SELECT EQ_TPSZ_CD FROM CGM_EQUIPMENT WHERE EQ_NO = T2.EQ_NO ))" ).append("\n"); 
		query.append("                    END,0) AS LSE_RT_AMT" ).append("\n"); 
		query.append("                ,T1.EQ_RNTL_TP_CD" ).append("\n"); 
		...
		query.append("    	           B.EQ_KND_CD = 'Z'" ).append("\n"); 
