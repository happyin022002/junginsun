...
*@FileName : LseAgmtRtDBDAOCntrSpecVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LseAgmtRtDBDAOCntrSpecVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LseAgmtRtDBDAOCntrSpecVOUSQL(){
		setQuery();
		...
		query.append("FileName : LseAgmtRtDBDAOCntrSpecVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE LSE_AGMT_RT SET " ).append("\n"); 
