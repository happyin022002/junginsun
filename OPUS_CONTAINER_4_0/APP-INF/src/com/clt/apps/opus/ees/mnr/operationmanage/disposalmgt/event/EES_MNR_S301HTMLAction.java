...
*@FileName : EES_MNR_S301HTMLAction.java
*@FileTitle : Bidding List
*Open Issues :
*Change history :
 ...
 * @author 김완규 
 * @see EesMnrS301Event.java 참조 
 * @since J2EE 1.6           
 */ 

public class EES_MNR_S301HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_S301HTMLAction 객체를 생성
	 */	 
	public EES_MNR_S301HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnrS301Event event = new EesMnrS301Event();
