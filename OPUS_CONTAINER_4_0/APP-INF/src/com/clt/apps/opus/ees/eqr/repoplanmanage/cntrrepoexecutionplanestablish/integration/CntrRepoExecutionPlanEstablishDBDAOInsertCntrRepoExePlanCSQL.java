...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanCSQL(){
		setQuery();
		...
		params.put("exectype",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[user_id]" ).append("\n"); 
		query.append(",	SYSDATE" ).append("\n"); 
		query.append(",   (SELECT NVL(MAX(DP_SEQ),0)+1 FROM EQR_REPO_EXE_PLN WHERE REPO_PLN_ID = @[repo_pln_id]  AND PLN_SEQ = @[pln_seq])" ).append("\n"); 
		query.append(")" ).append("\n"); 
