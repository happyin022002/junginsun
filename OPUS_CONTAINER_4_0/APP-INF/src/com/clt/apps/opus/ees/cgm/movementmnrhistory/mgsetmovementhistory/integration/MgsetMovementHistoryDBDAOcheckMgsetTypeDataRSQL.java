...
*@FileName : MgsetMovementHistoryDBDAOcheckMgsetTypeDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MgsetMovementHistoryDBDAOcheckMgsetTypeDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MgsetMovementHistoryDBDAOcheckMgsetTypeDataRSQL(){
		setQuery();
		...
		query.append("FileName : MgsetMovementHistoryDBDAOcheckMgsetTypeDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
