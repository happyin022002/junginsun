...
*@FileName : MstCntrLotDBDAOCntrSpecVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MstCntrLotDBDAOCntrSpecVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MstCntrLotDBDAOCntrSpecVOUSQL(){
		setQuery();
		...
		query.append("FileName : MstCntrLotDBDAOCntrSpecVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
