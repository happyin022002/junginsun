...
*@FileName : EES_MNR_0160HTMLAction.java
...
public class EES_MNR_0160HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0160HTMLAction 객체를 생성
	 */
	public EES_MNR_0160HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0160Event event = new EesMnr0160Event();
		...
		if(command.isCommand(FormCommand.SEARCH)||command.isCommand(FormCommand.SEARCH01)) {	
			disposalSoldGRPVO.setDisposalSoldINVO((DisposalSoldINVO)getVO(request, DisposalSoldINVO.class));
		}
		//저장	 	
		else if(command.isCommand(FormCommand.MULTI)) {   
			disposalSoldGRPVO.setArrayCustomMnrDispDtlVO((CustomMnrDispDtlVO[])getVOs(request,CustomMnrDispDtlVO .class, "dispDtl_" ));
			disposalSoldGRPVO.setDisposalSoldINVO((DisposalSoldINVO)getVO(request, DisposalSoldINVO.class));
		}	
			
		event.setDisposalSoldGRPVO(disposalSoldGRPVO);    	           
