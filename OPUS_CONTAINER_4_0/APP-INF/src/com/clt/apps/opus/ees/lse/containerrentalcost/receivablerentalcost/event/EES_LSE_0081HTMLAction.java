...
*@FileName : EES_LSE_0081HTMLAction.java
*@FileTitle : EQ Receivable Charge Summary by TY/SZ & Month 
*Open Issues :
*Change history :
...
public class EES_LSE_0081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0081HTMLAction 객체를 생성
	 */
	public EES_LSE_0081HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0081Event event = new EesLse0081Event();
