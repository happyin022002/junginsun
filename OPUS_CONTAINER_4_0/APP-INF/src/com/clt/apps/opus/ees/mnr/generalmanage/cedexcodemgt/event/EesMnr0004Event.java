...
public class EesMnr0004Event extends EventSupport {
	...
	public CustomMnrCedexOtrCdVO[] getCustomMnrCedexOtrCdVOS() {
		CustomMnrCedexOtrCdVO[] rtnVOs = null;
		if (this.customMnrCedexOtrCdVOS != null) {
			rtnVOs = java.util.Arrays.copyOf(customMnrCedexOtrCdVOS, customMnrCedexOtrCdVOS.length);
		}
		return rtnVOs;
	}

	public void setCustomMnrCedexOtrCdVOS(CustomMnrCedexOtrCdVO[] customMnrCedexOtrCdVOS){
		if(customMnrCedexOtrCdVOS != null){
			CustomMnrCedexOtrCdVO[] tmpVOs = java.util.Arrays.copyOf(customMnrCedexOtrCdVOS, customMnrCedexOtrCdVOS.length);
			this.customMnrCedexOtrCdVOS = tmpVOs;
		}
	}     
