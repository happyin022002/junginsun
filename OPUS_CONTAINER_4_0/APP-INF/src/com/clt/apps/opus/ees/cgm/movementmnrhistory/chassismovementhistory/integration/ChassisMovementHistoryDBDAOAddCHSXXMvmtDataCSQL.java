...
*@FileName : ChassisMovementHistoryDBDAOAddCHSXXMvmtDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMovementHistoryDBDAOAddCHSXXMvmtDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMovementHistoryDBDAOAddCHSXXMvmtDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMovementHistoryDBDAOAddCHSXXMvmtDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     VALUES (@[chss_no]," ).append("\n"); 
		query.append("             TO_DATE(@[mvmt_dt], 'YYYY-MM-DD HH24:MI:SS')," ).append("\n"); 
		query.append("             (SELECT NVL(MAX(SYS_SEQ), 0) + 1 FROM CGM_CHSS_MVMT_HIS WHERE CHSS_NO = @[chss_no])," ).append("\n"); 
