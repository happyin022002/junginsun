...
*@FileName : FQAResultMgtDBDAOremoveFQAResultDetailDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FQAResultMgtDBDAOremoveFQAResultDetailDataDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FQAResultMgtDBDAOremoveFQAResultDetailDataDSQL(){
		setQuery();
		...
		query.append("FileName : FQAResultMgtDBDAOremoveFQAResultDetailDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MNR_FLD_QLTY_AUD_RSLT" ).append("\n"); 
