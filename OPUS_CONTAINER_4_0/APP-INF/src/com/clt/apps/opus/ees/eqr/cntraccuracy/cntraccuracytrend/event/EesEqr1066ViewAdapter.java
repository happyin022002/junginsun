	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		try{
			while ( rs.next() ){
				...
				if(rs.getString("lcc_cd").equals("ZZZTTL")) { // G.TTL 
				...
				if(rs.getString("yd_cd").equals("XXXXXXX")) { // TTL 
					sbufXML.append("	<TD "+bgColor+" >TTL</TD>");
				}else {
				...
				if(sort_flag.equals("8") || sort_flag.equals("4") || sort_flag.equals("2") ){ // TTL 				
