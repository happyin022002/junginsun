...
*@FileName : PayableRentalCostDBDAOPayableChargeAuditRejectMasterRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PayableRentalCostDBDAOPayableChargeAuditRejectMasterRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PayableRentalCostDBDAOPayableChargeAuditRejectMasterRSQL(){
		setQuery();
		...
		query.append("FileName : PayableRentalCostDBDAOPayableChargeAuditRejectMasterRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE  LSE_PAY_RNTL_STS_CD = 'A'" ).append("\n"); 
