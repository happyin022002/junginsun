...
*@FileName : FreeTimeEndParmVO.java
*@FileTitle : FreeTimeEndParmVO
*Open Issues :
*Change history :
...
public class FreeTimeEndParmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FreeTimeEndParmVO> models = new ArrayList<FreeTimeEndParmVO>();
	...
	public FreeTimeEndParmVO() {}

	public FreeTimeEndParmVO(String ibflag, String pagerows, String fromDt, String bkgCntCd, String bkgRgnCd, String bkgStateCd, String bkgLocCd, String yrdCntCd, String yrdRgnCd, String yrdStateCd, String yrdLocCd, String dttCode, String ofcCd, String exclSat, String exclSun, String exclHoli, String freeTime, String svrId, String cstopIdx, String cstopNo, String yardCd, String ioBndCd, String bkgDeTermCd, String bkgRcvTermCd, String expType) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFreeTime(JSPUtil.getParameter(request, prefix + "free_time", ""));
	 ...
	 * @param request
	 * @return FreeTimeEndParmVO[]
	 */
	public FreeTimeEndParmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FreeTimeEndParmVO[]
	 */
	public FreeTimeEndParmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FreeTimeEndParmVO model = null;
	 ...
	 * @return FreeTimeEndParmVO[]
	 */
	public FreeTimeEndParmVO[] getFreeTimeEndParmVOs(){
		FreeTimeEndParmVO[] vos = (FreeTimeEndParmVO[])models.toArray(new FreeTimeEndParmVO[models.size()]);
		return vos;
	}
