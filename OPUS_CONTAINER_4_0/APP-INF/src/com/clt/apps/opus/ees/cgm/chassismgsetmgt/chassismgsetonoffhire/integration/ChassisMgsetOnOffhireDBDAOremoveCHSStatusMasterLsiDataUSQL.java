...
*@FileName : ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterLsiDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterLsiDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterLsiDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterLsiDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
