...
*@FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionTieredFreeTimeOfHistVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddBeforeExceptionTieredFreeTimeOfHistVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Tiered Free Time of hist verson insert
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddBeforeExceptionTieredFreeTimeOfHistVersionCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionTieredFreeTimeOfHistVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_RFA_EXPT_FREE_TM ( " ).append("\n"); 
		...
		query.append("   AND RFA_EXPT_DAR_NO    = @[rfa_expt_hist_dar_no]" ).append("\n"); 
