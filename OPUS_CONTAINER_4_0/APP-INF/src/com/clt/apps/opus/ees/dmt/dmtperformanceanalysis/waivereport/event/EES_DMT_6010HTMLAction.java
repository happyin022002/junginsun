...
*@FileName : EES_DMT_6010HTMLAction.java
...
public class EES_DMT_6010HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * EES_DMT_6010HTMLAction 객체를 생성
     */
    public EES_DMT_6010HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt6010Event event = new EesDmt6010Event();
        

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setWaiveReportParmVO ((WaiveReportParmVO )getVO(request, WaiveReportParmVO  .class));
        }
