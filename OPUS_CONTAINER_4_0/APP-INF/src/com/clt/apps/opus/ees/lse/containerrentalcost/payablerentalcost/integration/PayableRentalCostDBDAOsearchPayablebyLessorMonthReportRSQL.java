...
public class PayableRentalCostDBDAOsearchPayablebyLessorMonthReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("					AND LTMP.CHG_COST_YRMON BETWEEN  @[period_stdt] AND @[period_eddt]" ).append("\n"); 
		...
		query.append("					AND TO_CHAR(API.INV_EFF_DT,'YYYYMM') BETWEEN @[period_stdt] AND @[period_eddt])" ).append("\n"); 
		query.append("#elseif(${search_tp} == 'Payment')" ).append("\n"); 
		query.append("					AND  LTMP.INV_NO     IN (SELECT   API.INV_NO FROM AP_PAY_INV  API WHERE 1=1 " ).append("\n"); 
		query.append("        			AND  API.INV_SUB_SYS_CD = 'LSE'" ).append("\n"); 
		query.append("        			AND  API.INV_STS_CD = 'D'" ).append("\n"); 
		query.append("        			AND TO_CHAR(API.UPD_DT,'YYYYMM') BETWEEN @[period_stdt] AND @[period_eddt])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("            SELECT " ).append("\n"); 
		query.append("                '20'||SUBSTR( LTC.SKD_VOY_NO  , 0 , 2 ) || '-' || SUBSTR(LTC.SKD_VOY_NO,  -2 )  COST_YRMON," ).append("\n"); 
		query.append("                'OPL' CHARGE_TYPE," ).append("\n"); 
		query.append("                LTC.VNDR_SEQ VNDR_SEQ,         " ).append("\n"); 
		query.append("                SUBSTR(NVL(VNDR.VNDR_ABBR_NM, '   '), 1, 3) ABBR_NM," ).append("\n"); 
		query.append("				LTC.CURR_CD," ).append("\n"); 
		query.append("                LTMP.LSTM_CD LSTM_CD," ).append("\n"); 
		query.append("#foreach($key IN ${tysz})" ).append("\n"); 
		query.append("                SUM(DECODE(CNTR_TPSZ_CD, '$key', LTC.PAY_AMT, 0)) $key ," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("                (" ).append("\n"); 
		query.append("#foreach($key IN ${tysz})" ).append("\n"); 
		query.append("    #if($velocityCount < $tysz.size())" ).append("\n"); 
		query.append("                 SUM(DECODE(CNTR_TPSZ_CD, '$key', LTC.PAY_AMT, 0)) +" ).append("\n"); 
		query.append("    #else" ).append("\n"); 
		query.append("                 SUM(DECODE(CNTR_TPSZ_CD, '$key', LTC.PAY_AMT, 0))" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("          WHERE 1=1 " ).append("\n"); 
		query.append("#if(${search_tp} == 'Cost')" ).append("\n"); 
		query.append("					AND LTC.SKD_VOY_NO BETWEEN SUBSTR(@[period_stdt], -4) AND SUBSTR(@[period_eddt], -4)" ).append("\n"); 
		query.append("#elseif(${search_tp} == 'Revenue')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("            AND @[payable]= 'S'" ).append("\n"); 
		query.append("#if (${vndr_seq} != '')" ).append("\n"); 
		query.append("            AND LTC.VNDR_SEQ = @[vndr_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${agmt_seq} != '' )" ).append("\n"); 
		query.append("            AND LTC.AGMT_CTY_CD  = @[agmt_cty_cd]" ).append("\n"); 
		query.append("            AND LTC.AGMT_SEQ     = @[agmt_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("            AND LTMP.AGMT_CTY_CD = LTC.AGMT_CTY_CD" ).append("\n"); 
		query.append("            AND LTMP.AGMT_SEQ    = LTC.AGMT_SEQ" ).append("\n"); 
		query.append("#if (${cntr_tpsz_cd_str} != '')" ).append("\n"); 
		...
		query.append("                           AND ROWNUM           = 1)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("          GROUP BY LTC.SKD_VOY_NO ,	" ).append("\n"); 
		query.append("                   LTC.VNDR_SEQ ,				            " ).append("\n"); 
		query.append("                   SUBSTR(NVL(VNDR.VNDR_ABBR_NM, '   '), 1, 3) ," ).append("\n"); 
		query.append("				   LTC.CURR_CD ," ).append("\n"); 
		query.append("                   LTMP.LSTM_CD ,   " ).append("\n"); 
		query.append("                   LTC.AGMT_CTY_CD || LTRIM(TO_CHAR(LTC.AGMT_SEQ , '000000'))" ).append("\n"); 
		query.append("          )   " ).append("\n"); 
		...
		query.append("                      AND ROWNUM           = 1)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("GROUP BY LTMP.CURR_CD" ).append("\n"); 
		query.append("	UNION ALL" ).append("\n"); 
		query.append("	SELECT " ).append("\n"); 
		query.append("	       'G.TTL'   COST_YRMON," ).append("\n"); 
		query.append("	       NULL CHARGE_TYPE," ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("#if (${lse_pay_tp_cd} != 'ALL')" ).append("\n"); 
		query.append("       AND LTMP.LSE_PAY_TP_CD = @[lse_pay_tp_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("GROUP BY LTC.CURR_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
