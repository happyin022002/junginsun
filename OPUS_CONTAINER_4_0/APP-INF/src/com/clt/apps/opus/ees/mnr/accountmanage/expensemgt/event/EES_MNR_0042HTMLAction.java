...
*@FileName : EES_MNR_0042HTMLAction.java
...
public class EES_MNR_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0042HTMLAction 객체를 생성
	 */
	public EES_MNR_0042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0042Event event = new EesMnr0042Event();
		...
		//Detail 조회 리스트
			...
			payableInvoiceGRPVO.setPayableINVInquiryINVO((PayableINVInquiryINVO)getVO(request, PayableINVInquiryINVO .class));
			payableInvoiceGRPVO.setArrayCustomPayableInvoiceDetailINVOs((CustomPayableInvoiceDetailINVO[])getVOs(request, CustomPayableInvoiceDetailINVO.class, ""));
		}
