...
public class DemandNoteSendDBDAOSearchDemandNoteIssueMstPreviewRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,MAX (COM_REF) AS COM_REF" ).append("\n"); 
		...
		query.append("              ,'' AS HEADER10" ).append("\n"); 
		query.append("              ,'' AS SH_NUM" ).append("\n"); 
		query.append("              ,USR_NM AS COM_REF" ).append("\n"); 
		query.append("              ,'' AS PRINT_DATE" ).append("\n"); 
		query.append("              ,'' AS DMDT_TRF_NM" ).append("\n"); 
		query.append("			  ,'' AS TITLE" ).append("\n"); 
		query.append("			  ,'' AS TAX_NM" ).append("\n"); 
		...
		query.append("		           ,'Demurrage / Detention Statement') AS TITLE" ).append("\n"); 
		query.append("			  ,'' AS TAX_NM" ).append("\n"); 
		query.append("		  FROM DUAL " ).append("\n"); 
		query.append("		 UNION ALL" ).append("\n"); 
		query.append("		SELECT '' AS CUST_VAT" ).append("\n"); 
		...
		query.append("              ,( SELECT CASE" ).append("\n"); 
		query.append("                          WHEN SUBSTR (LOC_CD,1,2) = 'AU' OR SUBSTR (LOC_CD,1,2) = 'NZ' OR SUBSTR (LOC_CD,1,2) = 'MY'" ).append("\n"); 
		query.append("                             THEN 'GST'" ).append("\n"); 
		query.append("                          ELSE 'VAT'" ).append("\n"); 
		query.append("                       END AS TAX_NM" ).append("\n"); 
		query.append("                  FROM MDM_ORGANIZATION" ).append("\n"); 
