...
*@FileName : MgsetMovementHistoryDBDAOAddMGSXXMvmtDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MgsetMovementHistoryDBDAOAddMGSXXMvmtDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MgsetMovementHistoryDBDAOAddMGSXXMvmtDataCSQL(){
		setQuery();
		...
		query.append("FileName : MgsetMovementHistoryDBDAOAddMGSXXMvmtDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     VALUES (@[mgst_no]," ).append("\n"); 
		query.append("             TO_DATE(@[mvmt_dt], 'YYYY-MM-DD HH24:MI:SS')," ).append("\n"); 
		query.append("             (SELECT NVL(MAX(SYS_SEQ), 0) + 1 FROM CGM_MGST_MVMT_HIS WHERE MGST_NO = @[mgst_no])," ).append("\n"); 
		query.append("             NVL((SELECT CASE" ).append("\n"); 
		query.append("                            WHEN (A.ACIAC_DIV_CD ='A' AND A. AGMT_LSTM_CD NOT IN ('NP', 'CP')) OR (A.ACIAC_DIV_CD <> 'A' AND B.EQ_ASET_STS_CD = 'LST')" ).append("\n"); 
		...
		query.append("               WHERE LOC_CD = SUBSTR(@[yd_cd], 1, 5))," ).append("\n"); 
		query.append("             (SELECT BB.LCC_CD" ).append("\n"); 
		query.append("                FROM MDM_LOCATION AA," ).append("\n"); 
		...
		query.append("             @[cntr_no]," ).append("\n"); 
		query.append("             DECODE(@[cntr_no]," ).append("\n"); 
		query.append("                    NULL," ).append("\n"); 
		query.append("                    NULL," ).append("\n"); 
		query.append("                    NVL((SELECT CASE" ).append("\n"); 
		query.append("                                   WHEN A.ACIAC_DIV_CD = 'A' OR A.CNTR_STS_CD = 'LST'" ).append("\n"); 
		query.append("                                      THEN 'H'" ).append("\n"); 
		query.append("                                   ELSE 'O'" ).append("\n"); 
		query.append("                                END" ).append("\n"); 
