...
*@FileName : EES_MNR_0240HTMLAction.java
 ...
 * @see 	EesMnr0240Event 참조
 * @since 	J2EE 1.6           
 */
 
public class EES_MNR_0240HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0240HTMLAction 객체를 생성
	 */
	public EES_MNR_0240HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0240Event event = new EesMnr0240Event();
