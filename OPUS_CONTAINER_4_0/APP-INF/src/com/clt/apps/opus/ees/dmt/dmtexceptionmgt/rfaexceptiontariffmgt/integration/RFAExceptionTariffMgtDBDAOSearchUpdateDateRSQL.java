...
*@FileName : RFAExceptionTariffMgtDBDAOSearchUpdateDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchUpdateDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Before Booking Request 의 최종 Update Date 를 조회하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchUpdateDateRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchUpdateDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
