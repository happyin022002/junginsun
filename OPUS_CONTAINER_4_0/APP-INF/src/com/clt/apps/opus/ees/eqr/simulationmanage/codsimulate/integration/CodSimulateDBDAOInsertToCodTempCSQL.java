...
*@FileName : CodSimulateDBDAOInsertToCodTempCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodSimulateDBDAOInsertToCodTempCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodSimulateDBDAOInsertToCodTempCSQL(){
		setQuery();
		...
		query.append("FileName : CodSimulateDBDAOInsertToCodTempCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_VSL_LDIS_PLN_COD_TMP" ).append("\n"); 
