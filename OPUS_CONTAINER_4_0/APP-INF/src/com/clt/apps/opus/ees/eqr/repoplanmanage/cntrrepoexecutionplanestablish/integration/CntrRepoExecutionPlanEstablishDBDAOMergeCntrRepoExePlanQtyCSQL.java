...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOMergeCntrRepoExePlanQtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOMergeCntrRepoExePlanQtyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Merge Repo EXE Plan Qty
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOMergeCntrRepoExePlanQtyCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOMergeCntrRepoExePlanQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EQR_REPO_EXE_PLN_QTY I                        	" ).append("\n"); 
		...
		query.append("    		I.FM_ECC_UC_AMT     = @[fm_ecc_uc_amt],                            " ).append("\n"); 
		query.append("    		I.TO_ECC_UC_AMT     = @[to_ecc_uc_amt],                            										" ).append("\n"); 
