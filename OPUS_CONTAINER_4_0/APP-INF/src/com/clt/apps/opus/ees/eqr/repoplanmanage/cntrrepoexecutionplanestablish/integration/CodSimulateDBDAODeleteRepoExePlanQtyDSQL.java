...
*@FileName : CodSimulateDBDAODeleteRepoExePlanQtyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodSimulateDBDAODeleteRepoExePlanQtyDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Delete Repo Plan Qty
	  * </pre>
	  */
	public CodSimulateDBDAODeleteRepoExePlanQtyDSQL(){
		setQuery();
		...
		query.append("FileName : CodSimulateDBDAODeleteRepoExePlanQtyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
