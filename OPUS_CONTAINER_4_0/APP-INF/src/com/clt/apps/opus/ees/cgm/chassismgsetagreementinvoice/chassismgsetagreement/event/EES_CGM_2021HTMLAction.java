...
public class EES_CGM_2021HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		MGSAgreementINVO mgsAgreementINVO1 = new MGSAgreementINVO();
		MGSAgreementINVO mgsAgreementINVO2 = new MGSAgreementINVO();
		MGSAgreementINVO mgsAgreementINVO3 = new MGSAgreementINVO();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setMgsAgreementINVOS1(mgsAgreementINVO1.fromRequestGrid(request,"t3sheet1_"));
			event.setMgsAgreementINVOS2(mgsAgreementINVO2.fromRequestGrid(request,"t3sheet2_"));
			event.setMgsAgreementINVOS3(mgsAgreementINVO3.fromRequestGrid(request,"t3sheet3_"));
