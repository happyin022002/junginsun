...
*@FileName : CntrRepoPlanManageDBDAOModifyRLARepoPlanDtInlandQtyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAOModifyRLARepoPlanDtInlandQtyUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_VSL_LODG_DCHG_PLN 테이블의 vol 수정
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAOModifyRLARepoPlanDtInlandQtyUSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanManageDBDAOModifyRLARepoPlanDtInlandQtyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
