...
*@FileName : RFAExceptionTariffMgtDBDAOSearchAfterBookingListByDateUserIDSNDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchAfterBookingListByDateUserIDSNDRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request & Approval Status 조회(AfterBooking, DATE-UserID, Sent)용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchAfterBookingListByDateUserIDSNDRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchAfterBookingListByDateUserIDSNDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND AFT_RQST.DMDT_EXPT_RQST_STS_CD 	= 'R'" ).append("\n"); 
