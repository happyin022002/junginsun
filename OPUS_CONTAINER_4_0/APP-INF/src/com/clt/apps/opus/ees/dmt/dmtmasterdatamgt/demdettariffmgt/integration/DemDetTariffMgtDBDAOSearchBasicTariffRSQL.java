...
public class DemDetTariffMgtDBDAOSearchBasicTariffRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	, (SELECT INTG_CD_VAL_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD01964' AND INTG_CD_VAL_CTNT = B.DMDT_CHG_CMNC_TP_CD ) AS DMDT_CHG_CMNC_TP_NM" ).append("\n"); 
		...
		query.append("						 AND C.DMDT_CGO_TP_CD = DMDT_CGO_TP_CD)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY B.EFF_DT,B.DMDT_BZC_TRF_GRP_NM, B.TRF_GRP_SEQ,D.INTG_CD_VAL_DP_SEQ, E.INTG_CD_VAL_DP_SEQ" ).append("\n"); 
