...
*@FileName : TransportShceduleInputDBDAOSearchEqrRCCInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransportShceduleInputDBDAOSearchEqrRCCInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Truck & Rail & Water Loc 조회
	  * </pre>
	  */
	public TransportShceduleInputDBDAOSearchEqrRCCInfoRSQL(){
		setQuery();
		...
		query.append("FileName : TransportShceduleInputDBDAOSearchEqrRCCInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    AND   EOC.SCC_CD IN (SELECT ML.SCC_CD" ).append("\n"); 
		query.append("                         FROM MDM_LOCATION ML" ).append("\n"); 
		query.append("                         WHERE ML.LOC_CD = @[ecc_cd]" ).append("\n"); 
