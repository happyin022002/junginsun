...
*@FileName : EES_CGM_2079HTMLAction.java
...
public class EES_CGM_2079HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2079HTMLAction 객체를 생성
	 */
	public EES_CGM_2079HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2079Event event = new EesCgm2079Event();

		MGSInventoryByOfficeINVO  mGSInventoryByOfficeINVO = new MGSInventoryByOfficeINVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			mGSInventoryByOfficeINVO = (MGSInventoryByOfficeINVO)getVO(request, MGSInventoryByOfficeINVO .class);
			event.setMGSInventoryByOfficeINVO(mGSInventoryByOfficeINVO);
		}
		return  event;
	}
