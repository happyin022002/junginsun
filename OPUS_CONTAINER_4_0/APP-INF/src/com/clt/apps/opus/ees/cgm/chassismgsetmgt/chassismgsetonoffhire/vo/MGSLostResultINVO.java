...
public class MGSLostResultINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSLostResultINVO> models = new ArrayList<MGSLostResultINVO>();
     ...
     * @param eqAsetStsCd
     */
	public MGSLostResultINVO(String ibflag, String pagerows, String evntDtStr, String evntDtEnd, String location, String sccCd, String stsEvntYdCd, String eqAsetStsCd) {
		this.ibflag = ibflag;
		this.sccCd = sccCd;
	 ...
	 */
	public MGSLostResultINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSLostResultINVO[]
	 */
	public MGSLostResultINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSLostResultINVO model = null;
	 ...
	 * @return CHSLostResultINVO[]
	 */
	public MGSLostResultINVO[] getCHSLostResultINVOs(){
		MGSLostResultINVO[] vos = (MGSLostResultINVO[])models.toArray(new MGSLostResultINVO[models.size()]);
		return vos;
	}
