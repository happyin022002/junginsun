...
*@FileName : EES_MST_0014HTMLAction.java
...
public class EES_MST_0014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0004HTMLAction 객체를 생성
	 */
	public EES_MST_0014HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0014Event event = new EesMst0014Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setMstEtcVO((MstEtcVO)getVO(request, MstEtcVO .class));
			event.setLeasedCntrVOs((LeasedCntrVO[])getVOs(request, LeasedCntrVO .class,""));
		}
