...
*@FileName : CommonDBDAOsearchNextWeekRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOsearchNextWeekRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOsearchNextWeekRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.eqr.common.eqrcommon.integration ").append("\n"); 
		query.append("FileName : CommonDBDAOsearchNextWeekRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
