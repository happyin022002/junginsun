...
*@FileName : ForecastReportDBDAOsearchMtyWeeklySimulationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOsearchMtyWeeklySimulationRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ForecastReportDBDAOsearchMtyWeeklySimulationRSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOsearchMtyWeeklySimulationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                        AND	  A.CRR_CD		     =	'HJS'" ).append("\n"); 
