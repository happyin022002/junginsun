...
*@FileName : CHSNuPoolChargeINVO.java
*@FileTitle : CHSNuPoolChargeINVO
*Open Issues :
*Change history :
...
public class CHSNuPoolChargeINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSNuPoolChargeINVO> models = new ArrayList<CHSNuPoolChargeINVO>();
	 ...
	 */
	public CHSNuPoolChargeINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSNuPoolChargeINVO[]
	 */
	public CHSNuPoolChargeINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSNuPoolChargeINVO model = null;
		...
		return getCHSNuPoolChargeINVOs();
	}
	...
	public CHSNuPoolChargeINVO[] getCHSNuPoolChargeINVOs(){
		CHSNuPoolChargeINVO[] vos = (CHSNuPoolChargeINVO[])models.toArray(new CHSNuPoolChargeINVO[models.size()]);
		return vos;
	}
