...
*@FileName : DeliveryLocationDBDAOLocationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DeliveryLocationDBDAOLocationRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_EQ_ORZ_CHT Search
	  * </pre>
	  */
	public DeliveryLocationDBDAOLocationRSQL(){
		setQuery();
		...
		query.append("FileName : DeliveryLocationDBDAOLocationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
