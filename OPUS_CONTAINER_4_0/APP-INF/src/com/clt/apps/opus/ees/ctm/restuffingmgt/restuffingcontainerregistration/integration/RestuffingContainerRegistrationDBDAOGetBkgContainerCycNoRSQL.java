...
*@FileName : RestuffingContainerRegistrationDBDAOGetBkgContainerCycNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RestuffingContainerRegistrationDBDAOGetBkgContainerCycNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 부킹 컨테이너에서 컨테이너의 MAX  CNMV_ID_NO, CNMV_SEQ 를 얻어온다 (최종 값 + 1을 위함)
	  * </pre>
	  */
	public RestuffingContainerRegistrationDBDAOGetBkgContainerCycNoRSQL(){
		setQuery();
		...
		query.append("FileName : RestuffingContainerRegistrationDBDAOGetBkgContainerCycNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
