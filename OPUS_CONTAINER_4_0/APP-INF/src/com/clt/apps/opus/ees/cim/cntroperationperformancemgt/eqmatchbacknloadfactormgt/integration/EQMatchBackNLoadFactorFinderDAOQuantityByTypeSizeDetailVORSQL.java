...
*@FileName : EQMatchBackNLoadFactorFinderDAOQuantityByTypeSizeDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorFinderDAOQuantityByTypeSizeDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQMatchBackNLoadFactorFinderDAOQuantityByTypeSizeDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : EQMatchBackNLoadFactorFinderDAOQuantityByTypeSizeDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	DECODE(MAX(Y.NO),'1','I/B','2','O/B','3','Balance','4','M/B(%)') division,MAX(Y.NO) XXX," ).append("\n"); 
		...
		query.append("			) A,CIM_TP_SZ_DP_SEQ_V	S" ).append("\n"); 
		...
		query.append("		LOC_CD, " ).append("\n"); 
		query.append("		YARD_CD,DECODE(Y.NO,'1','AA','2','BB','3','CC','4','DD') " ).append("\n"); 
		query.append("		ORDER BY 1,LOC_CD,YARD_CD,XXX" ).append("\n"); 
