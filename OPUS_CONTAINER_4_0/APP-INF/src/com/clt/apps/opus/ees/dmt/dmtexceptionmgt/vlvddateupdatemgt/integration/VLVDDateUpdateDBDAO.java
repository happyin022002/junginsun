...
public class VLVDDateUpdateDBDAO extends DBDAOSupport {
    ...
    */
	...
	public List<VslDtUpdListVO> searchVLVDByVVDList ( DmtVesselDateUpdateParmVO dmtVesselDateUpdateParmVO ) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new VLVDDateUpdateDBDAOSearchVLVDByVVDListRSQL(), param, velParam);
    ...
    */
    @SuppressWarnings("unchecked")
    public List<VslDtUpdListVO> checkVvdIsExist ( String vvd , String xMvmt , String xPort ) throws DAOException {
        DBRowSet dbRowset = null;
        List<VslDtUpdListVO> list = null;
        //query parameter
        Map<String, Object> param = new HashMap<String, Object>();
        ...
        try{
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new VLVDDateUpdateDBDAOCheckExistVvdRSQL(), param, velParam);
            list = (List)RowSetUtil.rowSetToVOs(dbRowset, VslDtUpdListVO .class);
        }catch(SQLException se){
            log.error(se.getMessage(),se);
            throw new DAOException(new ErrorHandler(se).getMessage());
    ...
    * @throws DAOException
    */
    public String addDateByVvdCd( String xMvmt , String xPort , String vvd , String vldaten , String vldateb , SignOnUserAccount account) throws DAOException {
    ...
    * @throws DAOException
    */
    public String modifyDateByVvdCd( String xMvmt , String xPort , String vvd , String vldaten , String vldateb , SignOnUserAccount account) throws DAOException {
