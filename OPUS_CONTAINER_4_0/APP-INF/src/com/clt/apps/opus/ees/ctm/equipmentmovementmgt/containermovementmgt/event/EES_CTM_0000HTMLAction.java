...
*@FileName : EES_CTM_0000HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0000HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * EES_CTM_0000HTMLAction 객체를 생성
	 */
	public EES_CTM_0000HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0000Event event = new EesCtm0000Event();

		if(command.isCommand(FormCommand.MULTI)) {
			event.setInputRadio(request.getParameter("input_radio"));
			event.setFlatFileText(request.getParameter("mq_text"));			
			//event.setFlatFileVOS((FlatFileForGateNewVO[])getVOs(request, FlatFileForGateNewVO.class,""));
		}
