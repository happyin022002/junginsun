...
*@FileName : CGM_CHSS_POOLHTMLAction.java
...
public class CGM_CHSS_POOLHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CGM_CHSS_POOLHTMLAction 객체를 생성
	 */
	public CGM_CHSS_POOLHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CgmChssPoolEvent event = new CgmChssPoolEvent();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCgmChssPoolINVO((CgmChssPoolINVO)getVO(request, CgmChssPoolINVO .class));
		}
