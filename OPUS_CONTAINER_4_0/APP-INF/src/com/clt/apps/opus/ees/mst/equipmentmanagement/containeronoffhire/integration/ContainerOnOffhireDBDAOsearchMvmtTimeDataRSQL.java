...
public class ContainerOnOffhireDBDAOsearchMvmtTimeDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("NVL(MAX(TO_CHAR(DECODE(TRUNC(CNMV_EVNT_DT),TO_DATE(REPLACE(@[cnmv_evnt_dt],'-'),'YYYYMMDD HH24:MI'),CNMV_EVNT_DT+0.0007,TO_DATE(REPLACE(@[cnmv_evnt_dt],'-'),'YYYYMMDD HH24:MI')),'YYYYMMDD HH24:MI')),TO_CHAR(TO_DATE(REPLACE(@[cnmv_evnt_dt],'-'),'YYYYMMDD HH24:MI'),'YYYY-MM-DD HH24:MI')) DT" ).append("\n"); 
