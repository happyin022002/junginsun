...
public class RFAProgressVO extends AbstractValueObject {
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setCmdtList(JSPUtil.getParameter(request, prefix + "cmdt_list", ""));
