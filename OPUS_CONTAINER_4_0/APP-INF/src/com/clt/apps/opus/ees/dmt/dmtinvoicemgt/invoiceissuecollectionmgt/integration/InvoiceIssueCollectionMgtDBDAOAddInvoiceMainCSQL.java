...
public class InvoiceIssueCollectionMgtDBDAOAddInvoiceMainCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	DECODE(UPPER(@[ida_expn_tax_rt]    ), 'NULL', null, @[ida_expn_tax_rt]    ) " ).append("\n"); 
		query.append(",	DECODE(UPPER(@[ida_expn_tax]       ), 'NULL', null, @[ida_expn_tax]       ) " ).append("\n"); 
		query.append(",	DECODE(UPPER(@[ida_edu_tax_rt]     ), 'NULL', null, @[ida_edu_tax_rt]     ) " ).append("\n"); 
		query.append(",	DECODE(UPPER(@[ida_edu_tax]        ), 'NULL', null, @[ida_edu_tax]        ) " ).append("\n"); 
		query.append(",	DECODE(UPPER(@[ida_high_edu_tax_rt]), 'NULL', null, @[ida_high_edu_tax_rt]) " ).append("\n"); 
		query.append(",	DECODE(UPPER(@[ida_high_edu_tax]   ), 'NULL', null, @[ida_high_edu_tax]   ) " ).append("\n"); 
		query.append(")" ).append("\n"); 
