...
*@FileName : ChassisMgsetAgreementDBDAOAddCHSAgreementMainDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAOAddCHSAgreementMainDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetAgreementDB.AddCHSAgreementMainData
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAOAddCHSAgreementMainDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAOAddCHSAgreementMainDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    EQ_RNTL_TP_CD," ).append("\n"); 
		query.append("    DPP_TP_CD," ).append("\n"); 
		query.append("    DPP_RT_AMT," ).append("\n"); 
		query.append("    DPP_CVRG_AMT," ).append("\n"); 
		query.append("    LMSM_AMT," ).append("\n"); 
		query.append("    ONH_HNDL_RT_AMT," ).append("\n"); 
		query.append("    OFFH_HNDL_RT_AMT," ).append("\n"); 
		query.append("    DRP_OFF_LMT_QTY," ).append("\n"); 
		query.append("    DRP_OFF_LMT_TP_CD," ).append("\n"); 
		query.append("    DRP_OFF_LMT_RTO," ).append("\n"); 
		query.append("    DRP_OFF_LMT_PRD_CD," ).append("\n"); 
