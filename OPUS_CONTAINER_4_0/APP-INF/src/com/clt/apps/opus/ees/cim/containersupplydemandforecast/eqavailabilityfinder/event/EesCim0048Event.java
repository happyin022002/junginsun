 ...
 *@FileName : EES_CIM_0048Event.java
 *@FileTitle : OFF Detail
 *Open Issues :
 *Change history :
...
/**
 * EES_CIM_0048 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - EES_CIM_0048HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 * 
 * @author kim jong jun
 * @see EES_CIM_0048HTMLAction 참조
 * @since J2EE 1.5
 */

public class EesCim0048Event extends EventSupport {
