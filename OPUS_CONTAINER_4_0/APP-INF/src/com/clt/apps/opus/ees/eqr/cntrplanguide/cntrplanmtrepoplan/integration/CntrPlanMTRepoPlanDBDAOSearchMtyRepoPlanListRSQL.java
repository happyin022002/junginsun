...
public class CntrPlanMTRepoPlanDBDAOSearchMtyRepoPlanListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            -- 마지막 PORT 제외 로직(마지막은 POL 로 인정안함, 2013-12-12, )" ).append("\n"); 
		...
		query.append("            FROM " ).append("\n"); 
		query.append("            (" ).append("\n"); 
		query.append("                SELECT * FROM COA_MON_VVD" ).append("\n"); 
		query.append("                        WHERE VSL_CD     = SUBSTR(@[vvdRetrieveVal], 0, 4)" ).append("\n"); 
		query.append("                        AND   SKD_VOY_NO = SUBSTR(@[vvdRetrieveVal], 5, 4)" ).append("\n"); 
		...
		query.append("        ,CASE" ).append("\n"); 
		query.append("        WHEN HDR.POL_YD_CD IS NOT NULL AND HDR.POD_YD_CD IS NOT NULL AND HDR.POL_YD_CD = HDR.POD_YD_CD" ).append("\n"); 
		query.append("        THEN (MTY.GRP_LODG_D2 + 2*(MTY.GRP_LODG_D4 + MTY.GRP_LODG_D5 + MTY.GRP_LODG_D7 + MTY.GRP_LODG_R2 + MTY.GRP_LODG_R5 + MTY.GRP_LODG_R9 + MTY.GRP_LODG_O2 + MTY.GRP_LODG_O4 + MTY.GRP_LODG_S2 + MTY.GRP_LODG_S4 + MTY.GRP_LODG_F2 + MTY.GRP_LODG_F4 + MTY.GRP_LODG_F5 + MTY.GRP_LODG_A2 + MTY.GRP_LODG_A4))" ).append("\n"); 
		query.append("        ELSE TO_NUMBER('')" ).append("\n"); 
		query.append("        END MTY_LODG_PLN_TEU" ).append("\n"); 
		query.append("        ,CASE" ).append("\n"); 
		query.append("        WHEN HDR.POL_YD_CD IS NOT NULL AND HDR.POD_YD_CD IS NOT NULL AND HDR.POL_YD_CD = HDR.POD_YD_CD" ).append("\n"); 
		query.append("        THEN (MTY.GRP_LODG_D2 + MTY.GRP_LODG_D4 + MTY.GRP_LODG_D5 + MTY.GRP_LODG_D7 + MTY.GRP_LODG_R2 + MTY.GRP_LODG_R5 + MTY.GRP_LODG_R9 + MTY.GRP_LODG_O2 + MTY.GRP_LODG_O4 + MTY.GRP_LODG_S2 + MTY.GRP_LODG_S4 + MTY.GRP_LODG_F2 + MTY.GRP_LODG_F4 + MTY.GRP_LODG_F5 + MTY.GRP_LODG_A2 + MTY.GRP_LODG_A4)" ).append("\n"); 
		query.append("        ELSE TO_NUMBER('')" ).append("\n"); 
		...
		query.append("            +NVL(SUM(DECODE(TPSZ_CD, 'A4', CNTR_QTY)), 0) MTY_BKG_QTY" ).append("\n"); 
