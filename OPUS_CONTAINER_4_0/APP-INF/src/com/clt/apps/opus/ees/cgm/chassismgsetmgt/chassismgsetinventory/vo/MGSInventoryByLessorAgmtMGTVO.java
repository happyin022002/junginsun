 ...
 *@FileName : MGSInventoryByLessorAgmtMGTVO.java
 *@FileTitle : MGSInventoryByLessorAgmtMGTVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class MGSInventoryByLessorAgmtMGTVO	extends	 AbstractValueObject
{

	private	 static final long serialVersionUID = 1L;

	private	 Collection<MGSInventoryByLessorAgmtMGTVO>  models =	new	ArrayList<MGSInventoryByLessorAgmtMGTVO>();
	...
	/**	Constructor	*/
	public MGSInventoryByLessorAgmtMGTVO(){}

	public MGSInventoryByLessorAgmtMGTVO(String agmtRefNo,String ibflag,String eqTpszCdUmg,String eqTpszCdClg,String eqTpszCdTotal,String vndrSeq,String agmtNo,String vndrLglEngNm,String crntOfcCd,String agmtLstmCd,String eqKndCd,String pagerows,String eqTpszCd1,String eqTpszCd2,String eqTpszCd3,String eqTpszCd4,String eqTpszCd5,String eqTpszCd6,String eqTpszCd7,String eqTpszCd8,String eqTpszCd9,String eqTpszCd10,String eqTpszCd11,String eqTpszCd12,String eqTpszCd13,String eqTpszCd14,String eqTpszCd15,String eqTpszCd16,String eqTpszCd17,String eqTpszCd18,String eqTpszCd19,String eqTpszCd20)	{
 ...
 //	Getters	and	Setters
	...
	*/
	...
	public void	fromRequest(HttpServletRequest request,	String prefix) {
		...
		setCrntOfcCd(JSPUtil.getParameter(request,	prefix + "crnt_ofc_cd", ""));
	 ...
	 */
	public MGSInventoryByLessorAgmtMGTVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return MGSInventoryByLessorAgmtMGTVO[]
	 */
	public MGSInventoryByLessorAgmtMGTVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		MGSInventoryByLessorAgmtMGTVO model = null;
		...
		try	{
				...
				String[] crntOfcCd =	(JSPUtil.getParameter(request, prefix +	"crnt_ofc_cd".trim(),	length));
				...
				for	(int i = 0;	i <	length;	i++) {
					model =	new	MGSInventoryByLessorAgmtMGTVO();
						if ( agmtRefNo[i] !=	null)
		...
		return getMGSInventoryByLessorAgmtMGTVOs();
	}
	...
	public MGSInventoryByLessorAgmtMGTVO[]	 getMGSInventoryByLessorAgmtMGTVOs(){
		MGSInventoryByLessorAgmtMGTVO[] vos = (MGSInventoryByLessorAgmtMGTVO[])models.toArray(new	MGSInventoryByLessorAgmtMGTVO[models.size()]);
		return vos;
		}
