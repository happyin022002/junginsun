...
public class PoolChassisHistoryDBDAOsearchPoolMvmtCompareSmryDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          'OWN_MVMT' COM_DIVISION" ).append("\n"); 
		query.append("        , CASE WHEN  CNTR_OWNR_CO_CD ='H'   THEN 'For OWN CNTR'" ).append("\n"); 
		query.append("               WHEN  CHSS_OWNR_CO_CD ='H'   THEN 'For OWN CHSS'" ).append("\n"); 
		...
		query.append(" 		,SUM(OWN_USDY)  OWN_CHSS_USD_DYS" ).append("\n"); 
		query.append("         ,NVL(MAX(BB.RATE),0) RATE" ).append("\n"); 
		query.append("         ,SUM(OWN_USDY)  * NVL(MAX(BB.RATE),0) TOTAL" ).append("\n"); 
		...
		query.append(" 		,SUM(POOL_CHSS_USD_DYS)  OWN_CHSS_USD_DYS" ).append("\n"); 
		query.append("         ,NVL(MAX(BB.RATE),0) RATE" ).append("\n"); 
