...
*@FileName : EES_DMT_7013HTMLAction.java
...
public class EES_DMT_7013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_7013HTMLAction 객체를 생성
	 */
	public EES_DMT_7013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt7013Event event = new EesDmt7013Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDmtTrfTpVO((DmtTrfTpVO)getVO(request, DmtTrfTpVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setDmtTrfTpVOs((DmtTrfTpVO[])getVOs(request, DmtTrfTpVO.class, ""));
		}
