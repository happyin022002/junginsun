...
*@FileName : CommonDBDAOScnrIdListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOScnrIdListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOScnrIdListRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOScnrIdListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SIM_PLN_ID = @[repo_id]" ).append("\n"); 
		query.append("ORDER BY REPO_PLN_ID ASC" ).append("\n"); 
