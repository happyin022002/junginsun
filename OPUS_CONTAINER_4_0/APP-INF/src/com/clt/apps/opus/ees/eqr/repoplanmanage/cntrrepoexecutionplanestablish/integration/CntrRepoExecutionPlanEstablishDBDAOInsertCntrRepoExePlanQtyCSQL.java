...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanQtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanQtyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Repo Plan Qty Insert
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanQtyCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertCntrRepoExePlanQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_REPO_EXE_PLN_QTY (" ).append("\n"); 
