...
*@FileName : AfterExceptionTariffParmVO.java
*@FileTitle : AfterExceptionTariffParmVO
*Open Issues :
*Change history :
...
public class AfterExceptionTariffParmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AfterExceptionTariffParmVO> models = new ArrayList<AfterExceptionTariffParmVO>();
	...
	public AfterExceptionTariffParmVO() {}

	public AfterExceptionTariffParmVO(String ibflag, String pagerows, String aftExptDarNo, String aftExptAdjSeq, String svrId, String cntrNo, String cntrCycNo, String dmdtTrfCd, String dmdtChgLocDivCd) {
	 ...
	 * @param request
	 * @return AfterExceptionTariffParmVO[]
	 */
	public AfterExceptionTariffParmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AfterExceptionTariffParmVO[]
	 */
	public AfterExceptionTariffParmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AfterExceptionTariffParmVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AfterExceptionTariffParmVO();
		...
		return getAfterExceptionTariffParmVOs();
	}
	 ...
	 * @return AfterExceptionTariffParmVO[]
	 */
	public AfterExceptionTariffParmVO[] getAfterExceptionTariffParmVOs(){
		AfterExceptionTariffParmVO[] vos = (AfterExceptionTariffParmVO[])models.toArray(new AfterExceptionTariffParmVO[models.size()]);
		return vos;
	}
