...
*@FileName : EES_CGM_1098HTMLAction.java
...
public class EES_CGM_1098HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1098HTMLAction 객체를 생성
	 */
	public EES_CGM_1098HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1098Event event = new EesCgm1098Event();
		
		CHSInventoryByAgmtINVO cHSInventoryByAgmtINVO = new CHSInventoryByAgmtINVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			cHSInventoryByAgmtINVO = (CHSInventoryByAgmtINVO)getVO(request, CHSInventoryByAgmtINVO .class);
			event.setCHSInventoryByAgmtINVO(cHSInventoryByAgmtINVO);			
		}
