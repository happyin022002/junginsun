...
*@FileName : VoNameDAOMGSInvoiceImportAuditVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VoNameDAOMGSInvoiceImportAuditVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MGSInvoiceImportAuditMGTVO
	  * </pre>
	  */
	public VoNameDAOMGSInvoiceImportAuditVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.vo").append("\n"); 
		query.append("FileName : VoNameDAOMGSInvoiceImportAuditVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
