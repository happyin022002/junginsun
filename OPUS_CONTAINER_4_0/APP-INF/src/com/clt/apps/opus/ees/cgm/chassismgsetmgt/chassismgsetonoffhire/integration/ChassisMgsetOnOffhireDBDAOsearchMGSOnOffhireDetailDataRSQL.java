...
*@FileName : ChassisMgsetOnOffhireDBDAOsearchMGSOnOffhireDetailDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOsearchMGSOnOffhireDetailDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOsearchMGSOnOffhireDetailDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOsearchMGSOnOffhireDetailDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",'' AS UMG" ).append("\n"); 
		query.append(",''  AS CLG" ).append("\n"); 
