...
*@FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionCoverageOfHistVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddBeforeExceptionCoverageOfHistVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DAR History 에서 선택한 버전의 모든 Before Booking Request 의 Detail 에 해당하는 Multi Origin or Dest. 정보를 현재 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddBeforeExceptionCoverageOfHistVersionCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionCoverageOfHistVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    RFA_EXPT_DAR_NO, RFA_EXPT_MAPG_SEQ, RFA_EXPT_VER_SEQ, RFA_RQST_DTL_SEQ, CVRG_CMB_SEQ, CVRG_CONTI_CD, CVRG_CNT_CD, CVRG_RGN_CD" ).append("\n"); 
		query.append("    , CVRG_STE_CD, CVRG_LOC_CD, ORG_DEST_CONTI_CD, ORG_DEST_CNT_CD, ORG_DEST_RGN_CD, ORG_DEST_STE_CD, ORG_DEST_LOC_CD, N1ST_CMNC_VER_SEQ, CRE_USR_ID" ).append("\n"); 
		query.append("    , CRE_DT, CRE_OFC_CD, UPD_USR_ID, UPD_DT, UPD_OFC_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
