...
public class ContainerOnOffhireDBDAOModifyLeasedCntrMasterDataUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	ONH_DT = TO_DATE(SUBSTR(@[hire_date], 1, 10),'YYYY-MM-DD')" ).append("\n"); 
		...
		query.append(",	CNMV_DT = TO_DATE(SUBSTR(@[hire_date], 1, 10),'YYYY-MM-DD')" ).append("\n"); 
		...
		query.append(",	MFT_DT = TO_DATE(SUBSTR(@[mft_dt], 1, 10),'YYYY-MM-DD')" ).append("\n"); 
		...
		query.append(",   CNTR_OFFH_AUTH_NO = NULL" ).append("\n"); 
		query.append(",   CNTR_GRS_WGT      = NULL" ).append("\n"); 
		query.append(",   TARE_WGT          = NULL" ).append("\n"); 
		query.append(",   REF_ID            = NULL" ).append("\n"); 
