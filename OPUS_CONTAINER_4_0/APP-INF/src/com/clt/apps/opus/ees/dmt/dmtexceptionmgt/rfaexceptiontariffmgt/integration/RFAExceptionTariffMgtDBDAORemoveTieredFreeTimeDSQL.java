...
*@FileName : RFAExceptionTariffMgtDBDAORemoveTieredFreeTimeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveTieredFreeTimeDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Tiered Free Time Delete
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveTieredFreeTimeDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveTieredFreeTimeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_RFA_EXPT_FREE_TM" ).append("\n"); 
