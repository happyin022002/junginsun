...
*@FileName : EES_EQR_1074HTMLAction.java
...
public class EES_EQR_1074HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_5001HTMLAction 객체를 생성
	 */
	public EES_EQR_1074HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr1074Event event = new EesEqr1074Event();
