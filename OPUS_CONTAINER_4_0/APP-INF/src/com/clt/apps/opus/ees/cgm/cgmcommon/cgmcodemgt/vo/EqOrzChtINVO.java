...
*@FileName : EqOrzChtINVO.java
*@FileTitle : EqOrzChtINVO
*Open Issues :
*Change history :
...
public class EqOrzChtINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqOrzChtINVO> models = new ArrayList<EqOrzChtINVO>();
	...
	public EqOrzChtINVO(String ibflag, String pagerows, String eqOrzChtChktype, String eqOrzChtRccCd, String eqOrzChtLccCd, String eqOrzChtSccCd, String eqOrzChtUsFlag) {
		this.ibflag = ibflag;
	 ...
	 * @return EqOrzChtINVO[]
	 */
	public EqOrzChtINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqOrzChtINVO[]
	 */
	public EqOrzChtINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqOrzChtINVO model = null;
	 ...
	 * @return EqOrzChtINVO[]
	 */
	public EqOrzChtINVO[] getEqOrzChtINVOs(){
		EqOrzChtINVO[] vos = (EqOrzChtINVO[])models.toArray(new EqOrzChtINVO[models.size()]);
		return vos;
	}
