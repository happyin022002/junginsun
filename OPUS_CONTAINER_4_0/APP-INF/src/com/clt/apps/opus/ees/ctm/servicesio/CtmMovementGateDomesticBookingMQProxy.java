 ...
 * @since J2EE 1.6
 */
public class CtmMovementGateDomesticBookingMQProxy {
	 ...
	 */
	public void receiveDomesticBooking(TransferEAI eai) throws EventException {
		String str = eai.getMessage();
		log.debug("\n======================================" +
				  "\n[CtmMovementGateDomesticBookingNewMQProxy] : str" +
				  "\n======================================" +
				  "\n" + str +
				  "\n======================================\n");
