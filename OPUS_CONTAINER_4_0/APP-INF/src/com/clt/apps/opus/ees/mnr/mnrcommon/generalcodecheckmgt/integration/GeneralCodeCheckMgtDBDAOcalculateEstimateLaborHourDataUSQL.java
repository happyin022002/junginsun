...
public class GeneralCodeCheckMgtDBDAOcalculateEstimateLaborHourDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * calculateEstimateLaborHourData
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("                    SELECT MRTD.COST_GRP_CD COST_GRP_CD, A.INP_MSG1 LOC_CD, MRTD.VOL_TP_CD VOL_TP_CD, NVL(A.INP_MSG9, A.INP_MSG10) RPR_QTY, MNR_COMMON_PKG.MNR_CONV_MEASURE_FNC(A.INP_MSG8, LTR.MNR_MEAS_UT_CD, A.INP_MSG10, MRTH.MNR_MEAS_UT_CD) RPR_SIZE, MRTD.EQ_CMPO_CD EQ_CMPO_CD, MRTD.EQ_RPR_CD EQ_RPR_CD, MRTD.TRF_DIV_CD TRF_DIV_CD," ).append("\n"); 
		...
		query.append("                    FROM MNR_RPR_TRF_HDR MRTH, MNR_RPR_TRF_DTL MRTD, MNR_AGMT_HDR MAH, MNR_RPR_TRF_HDR LTR, MNR_DAT_VRFY A" ).append("\n"); 
