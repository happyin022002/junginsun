...
*@FileName : TermChangeDBDAOaddMstTempDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TermChangeDBDAOaddMstTempDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TermChangeDBDAOaddMstTempDataCSQL(){
		setQuery();
		...
		query.append("FileName : TermChangeDBDAOaddMstTempDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
