...
public class EesCgm2012Event extends EventSupport {
	...
	public void setMGSOnOffhireSummaryMGTVOS(MGSOnOffhireSummaryMGTVO[] mgsOnOffhireSummaryMGTVOs){
		if(mgsOnOffhireSummaryMGTVOs != null){
			MGSOnOffhireSummaryMGTVO[] tmpVOs = java.util.Arrays.copyOf(mgsOnOffhireSummaryMGTVOs, mgsOnOffhireSummaryMGTVOs.length);
			this.mgsOnOffhireSummaryMGTVOs = tmpVOs;
		}
	}
	...
	public MGSOnOffhireSummaryMGTVO[] getMGSOnOffhireSummaryMGTVOS(){
		MGSOnOffhireSummaryMGTVO[] rtnVOs = null;
		if (this.mgsOnOffhireSummaryMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(mgsOnOffhireSummaryMGTVOs, mgsOnOffhireSummaryMGTVOs.length);
		}
		return rtnVOs;
	}
