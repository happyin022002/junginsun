...
public class RateMgtDBDAOsearchAGMTRateDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#if(${agmt_dis_type} == 'RC')" ).append("\n"); 
		query.append("     AND SUBSTRB(G.MNR_CD_ID, LENGTH(G.MNR_CD_ID) - 1, LENGTH(G.MNR_CD_ID)) = @[agmt_dis_type]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("	 AND SUBSTRB(G.MNR_CD_ID, LENGTH(G.MNR_CD_ID) - 2, LENGTH(G.MNR_CD_ID)) = @[agmt_dis_type]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("ORDER BY C.AGMT_RT_SEQ" ).append("\n"); 
