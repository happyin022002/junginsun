 ...
 * @since J2EE 1.5   
 */
public class EesCim10012ViewAdapter extends ViewAdapter {
...
//	                int colCnt = realColNms.length;
	                ...
	                sbufXML.append("<TD><![CDATA["+JSPUtil.getNull(colValues.get("pol"))+"]]></TD>\n");
	                String xTempDvsnVal = JSPUtil.getNull(colValues.get("etc"));
					if(xTempDvsnVal.equals("T/Time")){
	...
	//                            double xTempVal = Double.parseDouble(xTempStrVal);
		                        ...
		                        sbufXML.append("<TD BGCOLOR ='201, 213, 235'><![CDATA[]]></TD>\n");
