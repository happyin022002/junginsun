...
*@FileName : PerformanceReportDBDAOsearchDisposalPFMCByMonthListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOsearchDisposalPFMCByMonthListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOsearchDisposalPFMCByMonthListRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOsearchDisposalPFMCByMonthListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SELECT  NVL(A.APRO_MON, 'G.TTL') AS APRO_MON, A.DISP_QTY_TOT," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio'" ).append("\n"); 
		...
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN NULL" ).append("\n"); 
		...
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP01, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP01, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP01, 0), '999,999,990')) END TPSZ_DP01," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP02, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP02, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP02, 0), '999,999,990')) END TPSZ_DP02," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP03, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP03, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP03, 0), '999,999,990')) END TPSZ_DP03," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP04, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP04, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP04, 0), '999,999,990')) END TPSZ_DP04," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP05, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP05, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP05, 0), '999,999,990')) END TPSZ_DP05," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP06, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP06, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP06, 0), '999,999,990')) END TPSZ_DP06," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP07, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP07, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP07, 0), '999,999,990')) END TPSZ_DP07," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP08, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP08, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP08, 0), '999,999,990')) END TPSZ_DP08," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP09, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP09, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP09, 0), '999,999,990')) END TPSZ_DP09," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP10, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP10, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP10, 0), '999,999,990')) END TPSZ_DP10," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP11, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP11, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP11, 0), '999,999,990')) END TPSZ_DP11," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP12, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP12, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP12, 0), '999,999,990')) END TPSZ_DP12," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP13, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP13, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP13, 0), '999,999,990')) END TPSZ_DP13," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP14, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP14, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP14, 0), '999,999,990')) END TPSZ_DP14," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP15, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP15, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP15, 0), '999,999,990')) END TPSZ_DP15," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP16, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP16, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP16, 0), '999,999,990')) END TPSZ_DP16," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP17, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP17, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP17, 0), '999,999,990')) END TPSZ_DP17," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP18, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP18, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP18, 0), '999,999,990')) END TPSZ_DP18," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP19, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP19, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP19, 0), '999,999,990')) END TPSZ_DP19," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP20, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP20, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP20, 0), '999,999,990')) END TPSZ_DP20," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP21, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP21, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP21, 0), '999,999,990')) END TPSZ_DP21," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP22, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP22, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP22, 0), '999,999,990')) END TPSZ_DP22," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP23, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP23, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP23, 0), '999,999,990')) END TPSZ_DP23," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP24, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP24, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP24, 0), '999,999,990')) END TPSZ_DP24," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP25, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP25, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP25, 0), '999,999,990')) END TPSZ_DP25," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP26, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP26, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP26, 0), '999,999,990')) END TPSZ_DP26," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP27, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP27, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP27, 0), '999,999,990')) END TPSZ_DP27," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP28, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP28, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP28, 0), '999,999,990')) END TPSZ_DP28," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP29, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP29, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP29, 0), '999,999,990')) END TPSZ_DP29," ).append("\n"); 
		query.append("CASE WHEN A.APRO_MON = 'Ratio' THEN LTRIM(TO_CHAR(A.TPSZ_DP30, '990.00'))||'%'" ).append("\n"); 
		query.append("WHEN A.APRO_MON IN('G.AMT','G.AVG') THEN LTRIM(TO_CHAR(A.TPSZ_DP30, '999,999,990.00'))" ).append("\n"); 
		query.append("ELSE LTRIM(TO_CHAR(NVL(A.TPSZ_DP30, 0), '999,999,990')) END TPSZ_DP30" ).append("\n"); 
		query.append("FROM   (SELECT  A.APRO_MON," ).append("\n"); 
		...
		query.append("GROUP BY ROLLUP(A.APRO_MON)" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT  'G.AMT' AS APRO_MON," ).append("\n"); 
		query.append("MAX(A.DISP_TOT) AS DISP_QTY_TOT," ).append("\n"); 
		query.append("SUM(A.DISP_QTY) AS DISP_QTY_CNT," ).append("\n"); 
		...
		query.append("FROM    TEMP_DROP A" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT  'G.AVG' AS APRO_MON," ).append("\n"); 
		query.append("MAX(A.DISP_TOT) AS DISP_QTY_TOT," ).append("\n"); 
		query.append("SUM(A.DISP_QTY) AS DISP_QTY_CNT," ).append("\n"); 
		query.append("SUM(A.CAL_PART_AMT) AS PART_AMT_TOT," ).append("\n"); 
		...
		query.append("FROM    TEMP_DROP A" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT  'Ratio' AS APRO_MON," ).append("\n"); 
		query.append("MAX(A.DISP_TOT) AS DISP_QTY_TOT," ).append("\n"); 
		query.append("SUM(A.DISP_QTY) AS DISP_QTY_CNT," ).append("\n"); 
		query.append("SUM(A.CAL_PART_AMT) AS PART_AMT_TOT," ).append("\n"); 
		query.append("NULL AS CAL_PART_AMT_TOT," ).append("\n"); 
		...
		query.append("FROM    TEMP_DROP A" ).append("\n"); 
		query.append(") A" ).append("\n"); 
		query.append("ORDER BY DECODE(A.APRO_MON, 'Ratio',3,'G.AVG',2,'G.AMT',1,0), A.APRO_MON" ).append("\n"); 
