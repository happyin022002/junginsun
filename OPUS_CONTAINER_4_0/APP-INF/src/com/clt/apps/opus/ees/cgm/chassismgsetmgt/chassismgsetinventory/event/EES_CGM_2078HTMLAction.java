...
*@FileName : EES_CGM_2078HTMLAction.java
...
public class EES_CGM_2078HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2078HTMLAction 객체를 생성
	 */
	public EES_CGM_2078HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2078Event event = new EesCgm2078Event();

		MGSInventoryByLessorTermINVO  mGSInventoryByLessorTermINVO = new MGSInventoryByLessorTermINVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			mGSInventoryByLessorTermINVO = (MGSInventoryByLessorTermINVO)getVO(request, MGSInventoryByLessorTermINVO .class);
			event.setMGSInventoryByLessorTermINVO(mGSInventoryByLessorTermINVO);
		}
		return  event;
	}
