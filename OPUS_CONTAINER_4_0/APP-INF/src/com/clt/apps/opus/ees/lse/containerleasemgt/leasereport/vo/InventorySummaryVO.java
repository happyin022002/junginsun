...
*@FileName : InventorySummaryVO.java
*@FileTitle : InventorySummaryVO
*Open Issues :
*Change history :
...
public class InventorySummaryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<InventorySummaryVO> models = new ArrayList<InventorySummaryVO>();
	...
	public InventorySummaryVO(String vndrSeq, String vndrAbbrNm, String vndrLglEngNm, String lstmCd, String level, String levelNo, String ibflag, String pagerows, String agmtNo, String agmtCtyCd, String agmtSeq, String refNo, String rstDiv, String tpszTotal, String tpszDp01, String tpszDp02, String tpszDp03, String tpszDp04, String tpszDp05, String tpszDp06, String tpszDp07, String tpszDp08, String tpszDp09, String tpszDp10, String tpszDp11, String tpszDp12, String tpszDp13, String tpszDp14, String tpszDp15, String tpszDp16, String tpszDp17, String tpszDp18, String tpszDp19, String tpszDp20, String tpszDp21, String tpszDp22, String tpszDp23, String tpszDp24, String tpszDp25, String tpszDp26, String tpszDp27, String tpszDp28, String tpszDp29, String tpszDp30, String lsePayTpCd) {
		this.lstmCd = lstmCd;
		this.level = level;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("levelNo", getLevelNO());
		...
		this.hashColumns.put("rst_div", getRstDiv());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rst_div", "rstDiv");
	 ...
	 * @param rstDiv
	 */
	public void setRstDiv(String rstDiv) {
		this.rstDiv = rstDiv;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLevelNo(JSPUtil.getParameter(request, "levelNo", ""));
		...
		setRstDiv(JSPUtil.getParameter(request, "rst_div", ""));
	 ...
	 */
	public InventorySummaryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InventorySummaryVO[]
	 */
	public InventorySummaryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InventorySummaryVO model = null;
		...
		try {
			...
			String[] levelNo = (JSPUtil.getParameter(request, prefix	+ "levelNo", length));
			...
			String[] rstDiv = (JSPUtil.getParameter(request, prefix	+ "rst_div", length));
		...
		return getOffHireResultAvgUsingDaySummaryVOs();
	}
	 ...
	 * @return InventorySummaryVO[]
	 */
	public InventorySummaryVO[] getOffHireResultAvgUsingDaySummaryVOs(){
		InventorySummaryVO[] vos = (InventorySummaryVO[])models.toArray(new InventorySummaryVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.rstDiv = this.rstDiv .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
