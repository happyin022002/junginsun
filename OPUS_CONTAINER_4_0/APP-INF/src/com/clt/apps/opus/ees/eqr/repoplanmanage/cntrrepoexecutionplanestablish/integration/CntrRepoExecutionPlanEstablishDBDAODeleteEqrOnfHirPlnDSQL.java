...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Plan만 있는경우 EQR_ONF_HIR_PLN 데이타 삭제
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteEqrOnfHirPlnDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_ONF_HIR_PLN " ).append("\n"); 
