...
*@FileName : EES_LSE_0002HTMLAction.java
...
public class EES_LSE_0002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0002HTMLAction 객체를 생성
	 */
	public EES_LSE_0002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0002Event event = new EesLse0002Event();
