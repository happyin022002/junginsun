...
*@FileName : SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfHistVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfHistVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff History 에서 선택한 버전의 모든 S/C Exception Tariff Free Time 정보를 현재 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfHistVersionCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfHistVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_SC_EXPT_FREE_TM (" ).append("\n"); 
		query.append("    PROP_NO, SC_EXPT_VER_SEQ, SC_EXPT_GRP_SEQ, FT_SEQ, CNTR_FM_QTY, CNTR_TO_QTY, FT_DYS, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT" ).append("\n"); 
		query.append(")" ).append("\n"); 
