...
*@FileName : EES_LSE_0012HTMLAction.java
...
public class EES_LSE_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0012HTMLAction 객체를 생성
	 */
	public EES_LSE_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0012Event event = new EesLse0012Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPayableRentalInvoiceCostVO((PayableRentalInvoiceCostVO)getVO(request, PayableRentalInvoiceCostVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setPayableRentalInvoiceCostVOS((PayableRentalInvoiceCostVO[])getVOs(request, PayableRentalInvoiceCostVO.class));
		}
		return  event;
	}
