...
public class ChassisMgsetOnOffhireDBDAOaddMGSEqTypeSizeDataCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           (DP_SEQ, EQ_TPSZ_CD, DIFF_DESC, EQ_KND_CD, CRE_USR_ID, CRE_DT," ).append("\n"); 
		query.append("            UPD_USR_ID, UPD_DT, MODI_EQ_TPSZ_CD)" ).append("\n"); 
		query.append("     VALUES( @[dp_seq], @[eq_tpsz_cd], @[diff_desc], @[eq_knd_cd], @[cre_usr_id], SYSDATE," ).append("\n"); 
		query.append("            @[upd_usr_id], SYSDATE, @[modi_eq_tpsz_cd])" ).append("\n"); 
