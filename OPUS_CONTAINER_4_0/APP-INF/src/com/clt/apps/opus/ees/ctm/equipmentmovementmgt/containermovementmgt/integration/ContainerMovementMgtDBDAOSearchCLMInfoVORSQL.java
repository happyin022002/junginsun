...
public class ContainerMovementMgtDBDAOSearchCLMInfoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        SELECT DISTINCT CO.CNTR_NO CNTR_NO, " ).append("\n"); 
		...
		query.append("                CTM_BKG_VVD BV2" ).append("\n"); 
		...
		query.append("        SELECT DISTINCT CT.CNTR_NO CNTR_NO, CO.CNTR_TPSZ_CD, CO.CNMV_STS_CD, @[p_yard1] || @[p_yard2] ORG_YD_CD, " ).append("\n"); 
		...
		query.append("#else" ).append("\n"); 
		query.append("	SELECT DISTINCT CM.CNTR_NO CNTR_NO, " ).append("\n"); 
		query.append("           CO.CNTR_TPSZ_CD, CO.CNMV_STS_CD PREV_STS_CD, @[p_yard1] || @[p_yard2] ORG_YD_CD, '' BKG_NO, '' RCV_TERM_CD, " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	MINUS" ).append("\n"); 
		query.append("	SELECT DISTINCT CT.CNTR_NO CNTR_NO, CO.CNTR_TPSZ_CD, CO.CNMV_STS_CD, @[p_yard1] || @[p_yard2] ORG_YD_CD, '' BKG_NO, '' BKG_RCV_TERM_CD, @[p_date0] MVMT_EVNT_DT, @[p_status] MVMT_STS_CD, SUBSTR(@[p_vvd], 0 ,4) CRNT_VSL_CD," ).append("\n"); 
		query.append("               SUBSTR(@[p_vvd], 5 ,4) CRNT_SKD_VOY_NO, SUBSTR(@[p_vvd], 9,1) CRNT_SKD_DIR_CD, @[p_pol] POL_CD, " ).append("\n"); 
