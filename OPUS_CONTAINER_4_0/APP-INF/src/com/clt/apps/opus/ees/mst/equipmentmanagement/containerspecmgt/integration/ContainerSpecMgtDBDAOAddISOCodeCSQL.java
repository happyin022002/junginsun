...
*@FileName : ContainerSpecMgtDBDAOAddISOCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerSpecMgtDBDAOAddISOCodeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MST ISO Container Type Size Create
	  * </pre>
	  */
	public ContainerSpecMgtDBDAOAddISOCodeCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerSpecMgtDBDAOAddISOCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MST_ISO_CNTR_TP_SZ (" ).append("\n"); 
