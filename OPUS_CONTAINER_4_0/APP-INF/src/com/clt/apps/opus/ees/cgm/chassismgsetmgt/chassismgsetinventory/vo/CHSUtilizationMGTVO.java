...
*@FileName : CHSUtilizationMGTVO.java
*@FileTitle : CHSUtilizationMGTVO
*Open Issues :
*Change history :
...
public class CHSUtilizationMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSUtilizationMGTVO> models = new ArrayList<CHSUtilizationMGTVO>();
	...
	private List<CHSUtilizationMGTVO> list0 = null;
	private List<CHSUtilizationMGTVO> list1 = null;
	private List<CHSUtilizationMGTVO> list2 = null;
	private List<CHSUtilizationMGTVO> list3 = null;
	
	/**
	 * Get List0
	 * @return List<CHSUtilizationMGTVO>
	 */
	public List<CHSUtilizationMGTVO> getList0() {
		return list0;
	}
	/**
	 * Set List0
	 * @param list0 List<CHSUtilizationMGTVO>
	 */
	public void setList0(List<CHSUtilizationMGTVO> list0) {
		this.list0 = list0;
	}	
	 ...
	 * @return List<CHSUtilizationMGTVO>
	 */
	public List<CHSUtilizationMGTVO> getList1() {
		return list1;
	}
	/**
	 * Set List1
	 * @param list1 List<CHSUtilizationMGTVO>
	 */
	public void setList1(List<CHSUtilizationMGTVO> list1) {
		this.list1 = list1;
	}	
	 ...
	 * @return List<CHSUtilizationMGTVO>
	 */
	public List<CHSUtilizationMGTVO> getList2() {
		return list2;
	}
	/**
	 * Set List2
	 * @param list2 List<CHSUtilizationMGTVO>
	 */
	public void setList2(List<CHSUtilizationMGTVO> list2) {
		this.list2 = list2;
	}	
	 ...
	 * @return List<CHSUtilizationMGTVO>
	 */
	public List<CHSUtilizationMGTVO> getList3() {
		return list3;
	}
	/**
	 * Set List3
	 * @param list3 List<CHSUtilizationMGTVO>
	 */
	public void setList3(List<CHSUtilizationMGTVO> list3) {
		this.list3 = list3;
	}	
	...
	public CHSUtilizationMGTVO() {}

	public CHSUtilizationMGTVO(String ibflag, String pagerows, String crntLocCd, String sccCd, String inqFmDys, String inqToDys, String cntrPsnStsCd, String cnmvStsCd, String chss20ftVolQty, String chss40ftVolQty, String chss45ftVolQty) {
	 ...
	 */
	public CHSUtilizationMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSUtilizationMGTVO[]
	 */
	public CHSUtilizationMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSUtilizationMGTVO model = null;
		...
		return getCHSUtilizationMGTVOs();
	}
	...
	public CHSUtilizationMGTVO[] getCHSUtilizationMGTVOs(){
		CHSUtilizationMGTVO[] vos = (CHSUtilizationMGTVO[])models.toArray(new CHSUtilizationMGTVO[models.size()]);
		return vos;
	}
