...
*@FileName : MGSConfirmPayableAmountMGTVO.java
*@FileTitle : MGSConfirmPayableAmountMGTVO
*Open Issues :
*Change history :
...
public class MGSConfirmPayableAmountMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSConfirmPayableAmountMGTVO> models = new ArrayList<MGSConfirmPayableAmountMGTVO>();
...
/**
	 ...
	 * @param request
	 * @return MGSConfirmPayableAmountMGTVO[]
	 */
	public MGSConfirmPayableAmountMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSConfirmPayableAmountMGTVO[]
	 */
	public MGSConfirmPayableAmountMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSConfirmPayableAmountMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSConfirmPayableAmountMGTVO();
		...
		return getMGSConfirmPayableAmountMGTVOs();
	}
	 ...
	 * @return MGSConfirmPayableAmountMGTVO[]
	 */
	public MGSConfirmPayableAmountMGTVO[] getMGSConfirmPayableAmountMGTVOs(){
		MGSConfirmPayableAmountMGTVO[] vos = (MGSConfirmPayableAmountMGTVO[])models.toArray(new MGSConfirmPayableAmountMGTVO[models.size()]);
		return vos;
	}
