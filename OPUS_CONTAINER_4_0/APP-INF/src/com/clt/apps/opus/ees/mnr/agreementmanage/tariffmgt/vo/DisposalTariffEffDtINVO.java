...
*@FileName : DisposalTariffEffDtINVO.java
*@FileTitle : DisposalTariffEffDtINVO
*Open Issues :
*Change history :
...
public class DisposalTariffEffDtINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DisposalTariffEffDtINVO> models = new ArrayList<DisposalTariffEffDtINVO>();
	...
	public DisposalTariffEffDtINVO() {}

	public DisposalTariffEffDtINVO(String ibflag, String pagerows, String mnrDispTrfStsCd, String mnrTrfRmk, String effDt, String mnrDispTrfGrpCd, String mnrDispTrfSeq, String mnrInpTpCd, String mnrDispTrfTpCd, String eqKndCd, String mnrDispTrfLstVerFlg) {
	 ...
	 */
	public DisposalTariffEffDtINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DisposalTariffEffDtINVO[]
	 */
	public DisposalTariffEffDtINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DisposalTariffEffDtINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new DisposalTariffEffDtINVO();
		...
		return getDisposalTariffEffDtINVOs();
	}
	 ...
	 * @return DisposalTariffEffDtINVO[]
	 */
	public DisposalTariffEffDtINVO[] getDisposalTariffEffDtINVOs(){
		DisposalTariffEffDtINVO[] vos = (DisposalTariffEffDtINVO[])models.toArray(new DisposalTariffEffDtINVO[models.size()]);
		return vos;
	}
