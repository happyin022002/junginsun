 ...
 * @since J2EE 1.5   
 */
public class EesCim10112ViewAdapter extends ViewAdapter {
...
//	                int colCnt = realColNms.length;
	                ...
	                String xPol = JSPUtil.getNull(colValues.get("pol"));
					if(xPol.equals("") || xPol == null){
		                sbufXML.append("<TD BOLD='TRUE' DATA-ALIGN='daCenterTop'><![CDATA[Average]]></TD>\n");
					}
					else{
		                sbufXML.append("<TD><![CDATA["+xPol+"]]></TD>\n");
					}
	                sbufXML.append("<TD ><![CDATA["+ JSPUtil.getNull(colValues.get("etc"))+"]]></TD>\n");
