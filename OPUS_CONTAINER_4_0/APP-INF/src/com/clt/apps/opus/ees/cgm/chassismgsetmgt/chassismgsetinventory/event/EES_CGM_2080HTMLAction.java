...
*@FileName : EES_CGM_2080HTMLAction.java
...
public class EES_CGM_2080HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2080HTMLAction 객체를 생성
	 */
	public EES_CGM_2080HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2080Event event = new EesCgm2080Event();

		MGSInventoryByLocationLessorINVO  mGSInventoryByLocationLessorINVO = new MGSInventoryByLocationLessorINVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			mGSInventoryByLocationLessorINVO = (MGSInventoryByLocationLessorINVO)getVO(request, MGSInventoryByLocationLessorINVO .class);
			event.setMGSInventoryByLocationLessorINVO(mGSInventoryByLocationLessorINVO);
		}
		return  event;
	}
