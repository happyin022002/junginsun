...
*@FileName : MgsetMovementHistoryDBDAOAddMGSFoundMvmtDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MgsetMovementHistoryDBDAOAddMGSFoundMvmtDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MgsetMovementHistoryDBDAOAddMGSFoundMvmtDataCSQL(){
		setQuery();
		...
		query.append("FileName : MgsetMovementHistoryDBDAOAddMGSFoundMvmtDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",(SELECT DECODE(MAX(SYS_SEQ)+1,NULL,1,MAX(SYS_SEQ)+1) FROM CGM_MGST_MVMT_HIS WHERE MGST_NO= @[mgst_no] and MVMT_DT = TO_DATE(@[mvmt_dt],'YYYY-MM-DD HH24:MI:SS') )  " ).append("\n"); 
