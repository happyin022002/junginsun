...
public class CHSMvmtBareMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSMvmtBareMGTVO> models = new ArrayList<CHSMvmtBareMGTVO>();
	 ...
	 */
	public CHSMvmtBareMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSMvmtBareMGTVO[]
	 */
	public CHSMvmtBareMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSMvmtBareMGTVO model = null;
	...
	public CHSMvmtBareMGTVO[] getCHSMvmtBareMGTVOs(){
		CHSMvmtBareMGTVO[] vos = (CHSMvmtBareMGTVO[])models.toArray(new CHSMvmtBareMGTVO[models.size()]);
		return vos;
	}
