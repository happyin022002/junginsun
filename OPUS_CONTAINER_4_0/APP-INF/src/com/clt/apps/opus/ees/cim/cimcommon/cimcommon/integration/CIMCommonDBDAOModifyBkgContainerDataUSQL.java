...
*@FileName : CIMCommonDBDAOModifyBkgContainerDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CIMCommonDBDAOModifyBkgContainerDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CIMCommonDBDAOModifyBkgContainerDataUSQL(){
		setQuery();
		...
		query.append("FileName : CIMCommonDBDAOModifyBkgContainerDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET (BC.CNMV_YR, BC.CNMV_ID_NO, BC.CNMV_CYC_NO, BC.CNMV_STS_CD, BC.CNMV_EVNT_DT, ORG_YD_CD)" ).append("\n"); 
