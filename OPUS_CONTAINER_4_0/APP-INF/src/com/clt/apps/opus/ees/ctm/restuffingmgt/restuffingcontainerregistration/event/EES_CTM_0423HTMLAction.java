...
*@FileName : EES_CTM_0423HTMLAction.java
...
public class EES_CTM_0423HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0423HTMLAction 객체를 생성
	 */
	public EES_CTM_0423HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0423Event event = new EesCtm0423Event();


		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setiRetuffingListVO((RetuffingListVO)getVO(request, RetuffingListVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH02)) {
			event.setCtmMvmtXchVO((CtmMvmtXchVO)getVO(request, CtmMvmtXchVO .class));
		}
