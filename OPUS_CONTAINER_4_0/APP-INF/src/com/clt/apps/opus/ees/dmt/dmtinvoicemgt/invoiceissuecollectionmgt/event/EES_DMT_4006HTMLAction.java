...
*@FileName : EES_DMT_4006HTMLAction.java
...
public class EES_DMT_4006HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt4006Event event = new EesDmt4006Event();
        

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setManualInvoiceIssueParmVO((ManualInvoiceIssueParmVO)getVO(request, ManualInvoiceIssueParmVO .class));
