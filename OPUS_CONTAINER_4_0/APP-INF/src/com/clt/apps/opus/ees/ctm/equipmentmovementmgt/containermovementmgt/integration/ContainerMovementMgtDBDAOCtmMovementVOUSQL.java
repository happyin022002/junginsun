...
*@FileName : ContainerMovementMgtDBDAOCtmMovementVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOCtmMovementVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOCtmMovementVOUSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMgtDBDAOCtmMovementVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       CNMV_SPLIT_NO = NVL (@[cnmv_split_no], ' ')," ).append("\n"); 
		...
		query.append("       CNMV_EVNT_DT = TO_DATE (@[cnmv_evnt_dt], 'YYYYMMDD HH24MISS')," ).append("\n"); 
		...
		query.append("       CNMV_CYC_NO = DECODE(@[mvmt_sts_cd], 'OP',@[cnmv_cyc_no], 'OC',@[cnmv_cyc_no], CNMV_CYC_NO)," ).append("\n"); 
