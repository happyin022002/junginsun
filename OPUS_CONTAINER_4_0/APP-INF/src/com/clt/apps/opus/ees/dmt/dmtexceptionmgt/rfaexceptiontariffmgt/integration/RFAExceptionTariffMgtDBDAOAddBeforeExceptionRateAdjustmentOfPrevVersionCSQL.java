...
*@FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionRateAdjustmentOfPrevVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddBeforeExceptionRateAdjustmentOfPrevVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 이전 버전의 모든 Before Booking Request 의 Detail 에 해당되는 Rate Adjustment 정보를 신규 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddBeforeExceptionRateAdjustmentOfPrevVersionCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionRateAdjustmentOfPrevVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    RFA_EXPT_DAR_NO, RFA_EXPT_MAPG_SEQ, RFA_EXPT_VER_SEQ, RFA_RQST_DTL_SEQ, CVRG_CMB_SEQ, RFA_EXPT_RT_SEQ, FT_OVR_DYS, FT_UND_DYS, CNTR_20FT_RT_AMT, CNTR_40FT_RT_AMT," ).append("\n"); 
		query.append("    CNTR_HC_RT_AMT, CNTR_45FT_RT_AMT, N1ST_CMNC_VER_SEQ, CRE_USR_ID, CRE_DT, CRE_OFC_CD, UPD_USR_ID, UPD_DT, UPD_OFC_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
