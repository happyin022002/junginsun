...
*@FileName : CustomMstGeneralCodeVO.java
*@FileTitle : CustomMstGeneralCodeVO
*Open Issues :
*Change history :
...
public class CustomMstGeneralCodeVO extends AbstractValueObject {
	
	private static final long serialVersionUID = 1L;
	
	private Collection<CustomMstGeneralCodeVO> models = new ArrayList<CustomMstGeneralCodeVO>();
	...
	public CustomMstGeneralCodeVO() {}

	/**
	 * CustomMstGeneralCodeVO 객체를 생성  
	 */
	public CustomMstGeneralCodeVO(String ibflag, String pagerows, String cdId, String cdDesc, String evDesc, String maxPntNo) {
		this.cdDesc = cdDesc;
		this.ibflag = ibflag;
		this.cdId = cdId;
	 ...
	 * @return	CustomMstGeneralCodeVO[]   VO배열로    
	 */
	public CustomMstGeneralCodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return	CustomMstGeneralCodeVO[]   VO배열로    
	 */
	public CustomMstGeneralCodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMstGeneralCodeVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CustomMstGeneralCodeVO();
				if (cdDesc[i] != null)
		...
		return getCustomMstGeneralCodeVOs();
	}

	/**
	 * getCustomMstGeneralCodeVOs 
	 * @return	CustomMstGeneralCodeVO[]   VO배열로    
	 */
	public CustomMstGeneralCodeVO[] getCustomMstGeneralCodeVOs(){
		CustomMstGeneralCodeVO[] vos = (CustomMstGeneralCodeVO[])models.toArray(new CustomMstGeneralCodeVO[models.size()]);
		return vos;
	}
