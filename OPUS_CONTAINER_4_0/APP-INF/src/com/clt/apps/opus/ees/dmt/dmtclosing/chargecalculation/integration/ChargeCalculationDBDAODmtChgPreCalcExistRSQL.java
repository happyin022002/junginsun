...
*@FileName : ChargeCalculationDBDAODmtChgPreCalcExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAODmtChgPreCalcExistRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAODmtChgPreCalcExist
	  * </pre>
	  */
	public ChargeCalculationDBDAODmtChgPreCalcExistRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAODmtChgPreCalcExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
