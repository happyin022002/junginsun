...
*@FileName : CommonDBDAOMinMax01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOMinMax01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOMinMax01RSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOMinMax01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("'${curYear}'||MIN(PLN_WK) MINVAL" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("'${tmpYear}'||MAX(PLN_WK) MAXVAL" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("EQR_WK_PRD" ).append("\n"); 
		query.append("WHERE" ).append("\n"); 
