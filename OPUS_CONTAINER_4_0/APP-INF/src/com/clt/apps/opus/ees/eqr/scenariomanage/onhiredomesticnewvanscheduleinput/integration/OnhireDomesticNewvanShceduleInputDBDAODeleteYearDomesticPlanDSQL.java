...
*@FileName : OnhireDomesticNewvanShceduleInputDBDAODeleteYearDomesticPlanDSQL.java
*@FileTitle : sample
*Open Issues :
*Change history :
...
public class OnhireDomesticNewvanShceduleInputDBDAODeleteYearDomesticPlanDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OnhireDomesticNewvanShceduleInputDBDAODeleteYearDomesticPlanDSQL(){
		setQuery();
		...
		query.append("FileName : OnhireDomesticNewvanShceduleInputDBDAODeleteYearDomesticPlanDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
