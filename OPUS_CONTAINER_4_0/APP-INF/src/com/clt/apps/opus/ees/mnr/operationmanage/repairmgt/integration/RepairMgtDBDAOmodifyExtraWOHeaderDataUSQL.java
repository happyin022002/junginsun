...
*@FileName : RepairMgtDBDAOmodifyExtraWOHeaderDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOmodifyExtraWOHeaderDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyExtraWOHeaderData
	  * </pre>
	  */
	public RepairMgtDBDAOmodifyExtraWOHeaderDataUSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOmodifyExtraWOHeaderDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
