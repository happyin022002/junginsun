...
*@FileName : UsLmsLocationListVO.java
*@FileTitle : UsLmsLocationListVO
*Open Issues :
*Change history :
...
public class UsAmsLocationListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsAmsLocationListVO> models = new ArrayList<UsAmsLocationListVO>();
	...
	public UsAmsLocationListVO() {}

	public UsAmsLocationListVO(String ibflag, String pagerows, String locAmsPortCd, String locCd, String locNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public UsAmsLocationListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsLmsLocationListVO[]
	 */
	public UsAmsLocationListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsAmsLocationListVO model = null;
		...
		return getUsLmsLocationListVOs();
	}
	...
	public UsAmsLocationListVO[] getUsLmsLocationListVOs(){
		UsAmsLocationListVO[] vos = (UsAmsLocationListVO[])models.toArray(new UsAmsLocationListVO[models.size()]);
		return vos;
	}
