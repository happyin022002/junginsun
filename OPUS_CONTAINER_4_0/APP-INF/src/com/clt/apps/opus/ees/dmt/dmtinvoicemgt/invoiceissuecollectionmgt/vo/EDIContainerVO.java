...
*@FileName : EDIContainerVO.java
*@FileTitle : EDIContainerVO
*Open Issues :
*Change history :
...
public class EDIContainerVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EDIContainerVO> models = new ArrayList<EDIContainerVO>();
	...
	public EDIContainerVO() {}

	public EDIContainerVO(String ibflag, String pagerows, String bkgNo, String svrId, String cntrNo, String cntrCycNo, String fmMvmtYdCd, String invoiceNo) {
	 ...
	 * @param request
	 * @return EDIContainerVO[]
	 */
	public EDIContainerVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EDIContainerVO[]
	 */
	public EDIContainerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EDIContainerVO model = null;
	 ...
	 * @return EDIContainerVO[]
	 */
	public EDIContainerVO[] getEDIContainerVOs(){
		EDIContainerVO[] vos = (EDIContainerVO[])models.toArray(new EDIContainerVO[models.size()]);
		return vos;
	}
