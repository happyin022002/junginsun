...
*@FileName : CntrPlanGuidelineManageDBDAODelPodDischargingDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAODelPodDischargingDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAODelPodDischargingDSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAODelPodDischargingDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
