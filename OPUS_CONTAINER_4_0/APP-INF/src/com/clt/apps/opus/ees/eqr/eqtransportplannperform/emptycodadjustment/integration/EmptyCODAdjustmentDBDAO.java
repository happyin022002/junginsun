 ...
 * - -EQTransportPlanNPerform system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
...
public class EmptyCODAdjustmentDBDAO extends DBDAOSupport {
	...
	public String insertMTYREPOPlanPORT(String vvd, String lane, String bay, String version, String remark,
			String sh2RC, String flagVLD, EmptyCODVVDPortVO00 emptyCODVVDPortVO, SignOnUserAccount account)
			throws DAOException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<EmptyCODVVDPortVO00> searchMTYREPOPlanV(String vvd, String version,String codCfmDivCd) throws DAOException {
		log.debug("####### EmptyCODAdjustmentDBDAO.searchMTYREPOPlanV 1039 시작");
		DBRowSet dbRowset = null;
		List<EmptyCODVVDPortVO00> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, EmptyCODVVDPortVO01.class);
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch (Exception ex) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<EmptyCODVVDPortVO01> searchMTYREPOPlanL(String vvd, String version,String codCfmDivCd) throws DAOException {
		log.debug("####### EmptyCODAdjustmentDBDAO.searchMTYREPOPlanL 1039 시작");
		DBRowSet dbRowset = null;
		List<EmptyCODVVDPortVO01> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<EmptyCODVVDPortVO02> searchMTYREPOPlanD(String vvd, String version,String codCfmDivCd) throws DAOException {
		log.debug("####### EmptyCODAdjustmentDBDAO.searchMTYREPOPlanD 1039 시작");
		DBRowSet dbRowset = null;
		List<EmptyCODVVDPortVO02> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<EmptyCODVVDPortVO02> searchMTYREPOPlan2(String vvd) throws DAOException {
		...
		try {
			...
			dbRowset2 = new SQLExecuter("").executeQuery((ISQLTemplate) new EmptyCODAdjustmentDBDAOSearchBayplanRSQL(),
					param, velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset2, EmptyCODVVDPortVO02.class);
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch (Exception ex) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<DamageRevenueEmptyListVO01> searchRevenueMTYList01(String vvd, String pod) throws DAOException {
		log.debug("####### EmptyCODAdjustmentDBDAO.searchRevenueMTYList01 1040 시작");
		DBRowSet dbRowset = null;
		List<DamageRevenueEmptyListVO01> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, DamageRevenueEmptyListVO01.class);
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch (Exception ex) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<DamageRevenueEmptyListVO02> searchRevenueMTYList02(String vvd, String pod) throws DAOException {
		log.debug("####### EmptyCODAdjustmentDBDAO.searchRevenueMTYList02 1040 시작");
		DBRowSet dbRowset = null;
		List<DamageRevenueEmptyListVO02> list = null;
		// query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		// velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, DamageRevenueEmptyListVO02.class);
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch (Exception ex) {
