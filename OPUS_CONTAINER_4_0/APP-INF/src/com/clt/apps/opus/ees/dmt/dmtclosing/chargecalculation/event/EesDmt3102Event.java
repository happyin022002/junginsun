...
/**
 * EES_DMT_3102 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  EES_DMT_3102HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Hwang HyoKeun
 * @see EES_DMT_3102HTMLAction 참조
 * @since J2EE 1.6
 */

public class EesDmt3102Event extends EventSupport {
	...
	/** Table Value Object Multi Data 처리 */
	private DmtChgCalcVO[] dmtChgCalcVOs = null;
	
	
	public EesDmt3102Event(){}
	...
	public void setDmtChgCalcVOS(DmtChgCalcVO[] dmtChgCalcVOs){
		if (dmtChgCalcVOs != null) {
			DmtChgCalcVO[] tmpVOs = new DmtChgCalcVO[dmtChgCalcVOs.length];
			System.arraycopy(dmtChgCalcVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.dmtChgCalcVOs = tmpVOs;
		}
	}
	
	public DmtChgCalcVO[] getDmtChgCalcVOS() {
		DmtChgCalcVO[] tmpVOs = null;
		if (this.dmtChgCalcVOs != null) {
			tmpVOs = new DmtChgCalcVO[dmtChgCalcVOs.length];
			System.arraycopy(dmtChgCalcVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
