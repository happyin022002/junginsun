...
*@FileName : PoolChassisHistoryDBDAOmodifyPoolMnrInvoiceImportDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PoolChassisHistoryDBDAOmodifyPoolMnrInvoiceImportDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PoolChassisHistoryDBDAOmodifyPoolMnrInvoiceImportDataUSQL(){
		setQuery();
		...
		params.put("inv_apro_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : PoolChassisHistoryDBDAOmodifyPoolMnrInvoiceImportDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE CGM_POOL_MAINT_RPR_HIS" ).append("\n"); 
		query.append("SET POOL_MGMT_CO_CD  = @[pool_mgmt_co_cd]" ).append("\n"); 
		query.append(",CHSS_POOL_CD     = @[chss_pool_cd]" ).append("\n"); 
		query.append(",VNDR_NM          = @[vndr_nm]" ).append("\n"); 
		query.append(",VNDR_LOC_NM      = @[vndr_loc_nm]" ).append("\n"); 
		query.append(",INV_NO           = @[inv_no]" ).append("\n"); 
		query.append(",CHSS_ASPT_NM     = @[chss_aspt_nm]" ).append("\n"); 
		query.append(",CHSS_CMPO_NM     = @[chss_cmpo_nm]" ).append("\n"); 
		query.append(",CHSS_LOC_NM      = @[chss_loc_nm]" ).append("\n"); 
		query.append(",DMG_DESC         = @[dmg_desc]" ).append("\n"); 
		query.append(",RPR_DESC         = @[rpr_desc]" ).append("\n"); 
		query.append(",RPR_CMPO_QTY     = @[rpr_cmpo_qty]" ).append("\n"); 
		query.append(",RPR_HRS          = @[rpr_hrs]" ).append("\n"); 
		query.append(",RPR_INSP_TP_DESC = @[rpr_insp_tp_desc]" ).append("\n"); 
		query.append(",LBR_COST_AMT     = @[lbr_cost_amt]" ).append("\n"); 
		query.append(",MTRL_COST_AMT    = @[mtrl_cost_amt]" ).append("\n"); 
		query.append(",TAX_AMT          = @[tax_amt]" ).append("\n"); 
		query.append(",COST_TTL_AMT     = @[cost_ttl_amt]" ).append("\n"); 
		query.append(",INV_CRE_DT       = @[inv_cre_dt]" ).append("\n"); 
		query.append(",INV_APRO_DT      = @[inv_apro_dt]" ).append("\n"); 
		query.append(",RPR_RQST_DT      = @[rpr_rqst_dt]" ).append("\n"); 
		query.append(",RPR_CMPL_DT      = @[rpr_cmpl_dt]" ).append("\n"); 
		query.append(",CNTR_NO          = @[cntr_no]" ).append("\n"); 
		query.append(",CHSS_USE_CO_NM   = @[chss_use_co_nm]" ).append("\n"); 
		query.append(",ISS_OFC_NM       = @[iss_ofc_nm]" ).append("\n"); 
		query.append(",CHSS_OWNR_CO_NM  = @[chss_ownr_co_nm]" ).append("\n"); 
		query.append(",RESPB_PTY_NM     = @[respb_pty_nm]" ).append("\n"); 
		query.append(",INV_REF_NO       = @[inv_ref_no]" ).append("\n"); 
		query.append(",SPL_CMPO_TP_CD   = @[spl_cmpo_tp_cd]" ).append("\n"); 
		query.append(",SPL_CMPO_QTY     = @[spl_cmpo_qty]" ).append("\n"); 
