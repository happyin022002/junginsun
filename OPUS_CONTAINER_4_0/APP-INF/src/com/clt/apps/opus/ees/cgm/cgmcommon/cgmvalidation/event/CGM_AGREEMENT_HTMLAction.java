...
*@FileName : CGM_AGREEMENTHTMLAction.java
...
public class CGM_AGREEMENT_HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CGM_AGREEMENTHTMLAction 객체를 생성
	 */
	public CGM_AGREEMENT_HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CgmAgreementEvent event = new CgmAgreementEvent();
		
       
		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setAgrementINVO((AgrementINVO)getVO(request, AgrementINVO .class));
		}
