...
public class PayableRentalCostDBDAOPayableChargeInvoiceRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	          , NVL(A.LGS_COST_FULL_NM, B.LGS_COST_FULL_NM) COST_NM" ).append("\n"); 
		...
		query.append("                         , (SELECT  LSE_RCV_CHG_TP_CD, ACCT_CD, LSTM_CD, COST_CD, LGS_COST_FULL_NM " ).append("\n"); 
		query.append("                            FROM    LSE_RNTL_COST_ACCT_ORD WHERE LSTM_CD = 'XX'" ).append("\n"); 
		query.append("                            UNION ALL" ).append("\n"); 
		query.append("                            SELECT  LSE_RCV_CHG_TP_CD, ACCT_CD, 'BX' , COST_CD, LGS_COST_FULL_NM" ).append("\n"); 
		query.append("                            FROM    LSE_RNTL_COST_ACCT_ORD WHERE LSTM_CD = 'XX'" ).append("\n"); 
		query.append("                            UNION ALL" ).append("\n"); 
		query.append("                            SELECT  LSE_RCV_CHG_TP_CD, ACCT_CD, LSTM_CD, COST_CD, LGS_COST_FULL_NM" ).append("\n"); 
		...
		query.append("			          A.LGS_COST_FULL_NM AS LGS_COST_FULL_NM" ).append("\n"); 
		...
		query.append("		 AND    CASE WHEN A.ACCT_CD IS NULL AND A.LSTM_CD IN('ST','LT', 'MI') " ).append("\n"); 
