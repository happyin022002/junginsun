...
*@FileName : EES_LSE_0093HTMLAction.java
...
public class EES_LSE_0093HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0093HTMLAction 객체를 생성
	 */
	public EES_LSE_0093HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0093Event event = new EesLse0093Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {//조회
			...
			event.setMisUseInOutInquiryVOs((MisUseInOutInquiryVO[])getVOs(request, MisUseInOutInquiryVO.class));
		}
