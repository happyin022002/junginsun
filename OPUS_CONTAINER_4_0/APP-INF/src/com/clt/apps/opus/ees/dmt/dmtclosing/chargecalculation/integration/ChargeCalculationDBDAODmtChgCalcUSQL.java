...
*@FileName : ChargeCalculationDBDAODmtChgCalcUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAODmtChgCalcUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAODmtChgCalcUSQL.Query
	  * </pre>
	  */
	public ChargeCalculationDBDAODmtChgCalcUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAODmtChgCalcUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,@[bzc_trf_seq]" ).append("\n"); 
		query.append("	,@[bzc_trf_grp_seq]" ).append("\n"); 
		query.append("	,TO_DATE(@[bzc_trf_aply_dt],'YYYYMMDDHH24MI')" ).append("\n"); 
		query.append("	,@[rfa_expt_apro_no]" ).append("\n"); 
		query.append("	,@[rfa_expt_dar_no]" ).append("\n"); 
		query.append("	,@[rfa_expt_mapg_seq]" ).append("\n"); 
		query.append("	,@[rfa_expt_ver_seq]" ).append("\n"); 
		...
		query.append("	,@[sc_expt_ver_seq]" ).append("\n"); 
		query.append("	,@[sc_expt_grp_seq]" ).append("\n"); 
		query.append("	,TO_DATE(@[sc_rfa_expt_aply_dt],'YYYYMMDDHH24MI')" ).append("\n"); 
		query.append("	,@[corr_rmk]" ).append("\n"); 
		query.append("	,@[dmdt_inv_no]" ).append("\n"); 
		query.append("	,@[ofc_cd]" ).append("\n"); 
		query.append("	,@[ofc_rhq_cd]" ).append("\n"); 
		...
		query.append("	,@[cmdt_cd]" ).append("\n"); 
		query.append("	,@[cmdt_trf_seq]" ).append("\n"); 
		query.append("	,TO_DATE(@[cmdt_expt_aply_dt],'YYYYMMDDHH24MI')" ).append("\n"); 
		query.append("	,@[cmdt_ovr_dys]" ).append("\n"); 
		query.append("	,@[cmdt_expt_amt]" ).append("\n"); 
		query.append("	,TO_DATE(@[web_mty_dt],'YYYYMMDDHH24MI')" ).append("\n"); 
		query.append("    ,SYSDATE" ).append("\n"); 
