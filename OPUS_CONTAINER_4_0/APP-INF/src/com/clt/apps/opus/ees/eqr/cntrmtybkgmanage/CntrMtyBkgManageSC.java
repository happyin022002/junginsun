...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.ees.eqr.cntrmtybkgmanage;
...
import com.clt.apps.opus.ees.eqr.cntrmtybkgmanage.cntrmtybkgcreate.basic.CntrMtyBkgCreateBC;
import com.clt.apps.opus.ees.eqr.cntrmtybkgmanage.cntrmtybkgcreate.basic.CntrMtyBkgCreateBCImpl;
import com.clt.apps.opus.ees.eqr.cntrmtybkgmanage.cntrmtybkgcreate.event.EesEqr1018Event;
import com.clt.apps.opus.ees.eqr.cntrmtybkgmanage.cntrmtybkgcreate.event.EesEqr1050Event;
import com.clt.apps.opus.ees.eqr.cntrmtybkgmanage.cntrmtybkgcreate.event.EesEqr1051Event;
import com.clt.apps.opus.ees.eqr.cntrmtybkgmanage.cntrmtybkgcreate.event.EesEqr1052Event;
...
/**
 * OPUS-CntrMtyBkgCreate Business Logic ServiceCommand - OPUS-CntrMtyBkgCreate 대한 비지니스 트랜잭션을 처리한다.
 * 
 * @author 
...
public class CntrMtyBkgManageSC extends ServiceCommandSupport {
	 ...
	 * OPUS-CntrMtyBkgCreate system 업무에서 발생하는 모든 이벤트의 분기처리<br>
	 * 
	 * @param e Event
...
//				eesEqr0059MultiVO.setMtyBkgNo(splitBkgBlNoVO.getBkgNo());
				...
				command.modifyCntrMtySplitUpdate(conditionVO);
			}
	...
	private EventResponse searchCntrMtyBkgSplitContainerInfo(Event e) throws EventException {
		...
		try{
			...
			EesEqr1052MultiVO eesEqr1052MultiVO = command.searchCntrMtyBkgSplitContainerInfo(vvd, excel_cntr_no, flag);							
