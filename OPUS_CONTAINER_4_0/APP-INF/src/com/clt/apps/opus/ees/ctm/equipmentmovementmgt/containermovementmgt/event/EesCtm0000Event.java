...
public class EesCtm0000Event extends EventSupport {
	...
	public void setFlatFileVOS(FlatFileForGateNewVO[] flatFileVOs){
		if (flatFileVOs != null) {
			FlatFileForGateNewVO[] tmpVOs = new FlatFileForGateNewVO[flatFileVOs.length];
			System.arraycopy(flatFileVOs, 0, tmpVOs, 0, tmpVOs.length);
	...
	public FlatFileForGateNewVO[] getFlatFileVOS(){
		FlatFileForGateNewVO[] tmpVOs = null;
		if (this.flatFileVOs != null) {
			tmpVOs = new FlatFileForGateNewVO[flatFileVOs.length];
			System.arraycopy(flatFileVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
