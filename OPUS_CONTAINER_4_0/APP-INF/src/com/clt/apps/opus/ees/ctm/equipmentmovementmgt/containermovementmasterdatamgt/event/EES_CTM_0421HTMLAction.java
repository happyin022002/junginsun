...
*@FileName : EES_CTM_0421HTMLAction.java
 ...
 * 2009.4.30
 */
public class EES_CTM_0421HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ees_ctm_0421HTMLAction 객체를 생성
	 */
	public EES_CTM_0421HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0421Event event = new EesCtm0421Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCtmMvmtXchRsnVOS((CtmMvmtXchRsnVO[])getVOs(request, CtmMvmtXchRsnVO .class, ""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCtmMvmtXchRsnVO((CtmMvmtXchRsnVO)getVO(request, CtmMvmtXchRsnVO .class));
		}
