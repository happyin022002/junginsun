...
public class CgmChssPoolEvent extends EventSupport {
	...
	public CgmChssPoolMGTVO[] getCgmChssPoolMGTVOs() {
		CgmChssPoolMGTVO[] rtnVOs = null;
		if (this.cgmChssPoolMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(cgmChssPoolMGTVOs, cgmChssPoolMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setCgmChssPoolMGTVOs(CgmChssPoolMGTVO[] cgmChssPoolMGTVOs){
		if(cgmChssPoolMGTVOs != null){
			CgmChssPoolMGTVO[] tmpVOs = java.util.Arrays.copyOf(cgmChssPoolMGTVOs, cgmChssPoolMGTVOs.length);
			this.cgmChssPoolMGTVOs = tmpVOs;
		}
	}
