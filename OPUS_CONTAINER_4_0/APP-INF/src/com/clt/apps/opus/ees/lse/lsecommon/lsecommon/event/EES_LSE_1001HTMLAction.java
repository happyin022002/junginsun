 ...
 *@FileName : EES_LSE_1001HTMLAction.java
...
public class EES_LSE_1001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	public EES_LSE_1001HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse1001Event event = new EesLse1001Event();
		//if (command.isCommand(FormCommand.SEARCH)) {
		//} else if (command.isCommand(FormCommand.MULTI)) {
		//	event.setLseRntlCostAcctOrdVOs((LseRntlCostAcctOrdVO[]) getVOs(request, LseRntlCostAcctOrdVO.class, "sheet1_"));
		//}
