...
public class CustomMnrPartnerVO extends AbstractValueObject {
	...
	/* Column Info */
	private String dispProcCnt = null;
	...
	public CustomMnrPartnerVO(String ibflag, String pagerows, String bzctNm, String mnrGrpTpCd, String spPtalId, String bztpNm, String mnrPayrCntCd, String mnrPrnrCntCdSeq, String bzetAddr, String mnrPrnrLoclLangNm, String mnrPrnrAbbrNm, String mnrPrnrSeq, String effDt, String mnrPrnrRmk, String mnrPayrSeq, String bankNm, String mnrPrnrStsNm, String updUsrId, String phnNo, String payMzdCd, String ctrlOfcCd, String mnrPrnrTpCd, String dispCnt, String payTermDys, String ediId, String trsmModCd, String creUsrId, String bizRgstNo, String mnrPrnrKndDtlCd, String vndrSeq, String zipCd, String mnrPrnrEml, String mnrSwiftNo, String dptDesc, String faxNo, String fileSeq, String ownrNm, String mnrPrnrCntNm, String mnrBilToNm, String bankAcctNo, String creDt, String mnrPrnrCntCd, String vndrLglEngNm, String mnrPrnrAddr, String mnrPrnrCreSeq, String intlFaxNo, String expDt, String mnrPrnrCapiAmt, String updDt, String mnrPrnrKndCd, String genPayTermCd, String mnrPrnrStsCd, String mnrPrnrLglEngNm, String mnrShopFlg, String spPtalPwd, String payCurrCd, String checkbox, String empeKnt, String intlPhnNo, String btnFlg, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String dispProcCnt) {
		this.bzctNm = bzctNm;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("disp_proc_cnt", getDispProcCnt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("disp_proc_cnt", "dispProcCnt");
	...
	public String getDispProcCnt() {
		return dispProcCnt;
	}

	public void setDispProcCnt(String dispProcCnt) {
		this.dispProcCnt = dispProcCnt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDispProcCnt(JSPUtil.getParameter(request, prefix + "disp_proc_cnt", ""));
	}
	...
	public CustomMnrPartnerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] dispProcCnt = (JSPUtil.getParameter(request, prefix	+ "disp_proc_cnt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (dispProcCnt[i] != null)
					model.setDispProcCnt(dispProcCnt[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.dispProcCnt = this.dispProcCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
