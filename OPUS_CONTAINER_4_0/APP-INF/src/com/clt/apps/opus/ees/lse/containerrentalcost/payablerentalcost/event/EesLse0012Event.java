...
public class EesLse0012Event extends EventSupport {
	...
	private PayableRentalInvoiceCostVO[] payableRentalInvoiceCostVOs = null;
	...
	public void setPayableRentalInvoiceCostVOS(PayableRentalInvoiceCostVO[] payableRentalInvoiceCostVOs){
		if (payableRentalInvoiceCostVOs != null) {
			PayableRentalInvoiceCostVO[] tmpVOs = new PayableRentalInvoiceCostVO[payableRentalInvoiceCostVOs.length];
			System.arraycopy(payableRentalInvoiceCostVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.payableRentalInvoiceCostVOs = tmpVOs;
		}
	}
	...
	public PayableRentalInvoiceCostVO[] getPayableRentalInvoiceCostVOS(){
		PayableRentalInvoiceCostVO[] tmpVOs = null;
		if (this.payableRentalInvoiceCostVOs != null) {
			tmpVOs = new PayableRentalInvoiceCostVO[payableRentalInvoiceCostVOs.length];
			System.arraycopy(payableRentalInvoiceCostVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
