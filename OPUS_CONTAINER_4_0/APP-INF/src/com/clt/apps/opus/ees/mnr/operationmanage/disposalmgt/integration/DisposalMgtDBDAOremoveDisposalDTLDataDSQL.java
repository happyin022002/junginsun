...
*@FileName : DisposalMgtDBDAOremoveDisposalDTLDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DisposalMgtDBDAOremoveDisposalDTLDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeDisposalDTLData
	  * </pre>
	  */
	public DisposalMgtDBDAOremoveDisposalDTLDataDSQL(){
		setQuery();
		...
		query.append("FileName : DisposalMgtDBDAOremoveDisposalDTLDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
