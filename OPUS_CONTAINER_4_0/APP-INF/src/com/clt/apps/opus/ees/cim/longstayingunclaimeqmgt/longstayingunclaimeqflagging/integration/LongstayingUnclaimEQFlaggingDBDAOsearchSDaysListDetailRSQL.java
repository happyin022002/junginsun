...
public class LongstayingUnclaimEQFlaggingDBDAOsearchSDaysListDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("		ROW_NUMBER() OVER (ORDER BY A.SUB_LOC_CD,A.CRNT_YD_CD,A.CNTR_NO,A.CNTR_TPSZ_CD,A.LSTM_CD,A.CNMV_STS_CD) AS ROW_SEQ" ).append("\n"); 
		...
		query.append("		,MST_COMMON_PKG.MST_DMG_DT_GET_FNC(A.CNTR_NO, 'FLG') DMG_FLG_DT " ).append("\n"); 
		query.append("		,MST_COMMON_PKG.MST_DMG_DT_GET_FNC(A.CNTR_NO, 'UNFLG') DMG_UNFLG_DT" ).append("\n"); 
