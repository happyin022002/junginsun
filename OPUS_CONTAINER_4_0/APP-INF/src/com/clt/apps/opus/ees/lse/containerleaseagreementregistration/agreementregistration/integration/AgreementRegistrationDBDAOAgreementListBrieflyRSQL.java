...
public class AgreementRegistrationDBDAOAgreementListBrieflyRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	 , AA.OLD_AGMT_NO                       " ).append("\n"); 
		...
		query.append("		AND    UPPER(A.OLD_AGMT_NO) = UPPER(@[old_agmt_no])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("		AND    UPPER(A.LSE_CTRT_NO) LIKE UPPER('%'||@[ref_no]||'%') " ).append("\n"); 
		query.append("#end" ).append("\n"); 
