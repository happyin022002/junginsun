...
*@FileName : EES_CGM_1001HTMLAction.java
...
public class EES_CGM_1001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1001HTMLAction 객체를 생성
	 */
	public EES_CGM_1001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1001Event event = new EesCgm1001Event();
		log.debug("Event 01 !!!!! : " + event);
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCHSEqTpSzINVOS((CHSEqTpSzINVO[])getVOs(request, CHSEqTpSzINVO.class, "sheet1_"));
			log.debug("PARAM1 = : " + (CHSEqTpSzINVO[])getVOs(request, CHSEqTpSzINVO.class, ""));
			log.debug("PARAM2 = : " + (CHSEqTpSzINVO[])getVOs(request, CHSEqTpSzINVO.class, "") == null);
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCHSEqTpSzINVO((CHSEqTpSzINVO)getVO(request, CHSEqTpSzINVO.class));
		}
