...
*@FileName : EES_DMT_7001HTMLAction.java
...
public class EES_DMT_7014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_7014HTMLAction 객체를 생성
	 */
	public EES_DMT_7014HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt7014Event event = new EesDmt7014Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setWeekendVO((WeekendVO)getVO(request, WeekendVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setWeekendVOS((WeekendVO[])getVOs(request, WeekendVO .class));
		}
