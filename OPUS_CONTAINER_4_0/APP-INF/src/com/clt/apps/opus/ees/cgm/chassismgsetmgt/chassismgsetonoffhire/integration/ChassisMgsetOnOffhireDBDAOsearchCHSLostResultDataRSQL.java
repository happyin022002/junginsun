...
public class ChassisMgsetOnOffhireDBDAOsearchCHSLostResultDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '1' THEN 1 END),0) AS EQ_TPSZ_CD1," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '2' THEN 1 END),0) AS EQ_TPSZ_CD2," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '3' THEN 1 END),0) AS EQ_TPSZ_CD3," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '4' THEN 1 END),0) AS EQ_TPSZ_CD4," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '5' THEN 1 END),0) AS EQ_TPSZ_CD5," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '6' THEN 1 END),0) AS EQ_TPSZ_CD6," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '7' THEN 1 END),0) AS EQ_TPSZ_CD7," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '8' THEN 1 END),0) AS EQ_TPSZ_CD8," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '9' THEN 1 END),0) AS EQ_TPSZ_CD9," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '10' THEN 1 END),0) AS EQ_TPSZ_CD10," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '11' THEN 1 END),0) AS EQ_TPSZ_CD11," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '12' THEN 1 END),0) AS EQ_TPSZ_CD12," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '13' THEN 1 END),0) AS EQ_TPSZ_CD13," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '14' THEN 1 END),0) AS EQ_TPSZ_CD14," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '15' THEN 1 END),0) AS EQ_TPSZ_CD15," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '16' THEN 1 END),0) AS EQ_TPSZ_CD16," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '17' THEN 1 END),0) AS EQ_TPSZ_CD17," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '18' THEN 1 END),0) AS EQ_TPSZ_CD18," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '19' THEN 1 END),0) AS EQ_TPSZ_CD19," ).append("\n"); 
		query.append("	NVL(SUM(CASE WHEN A.DP_SEQ = '20' THEN 1 END),0) AS EQ_TPSZ_CD20	" ).append("\n"); 
		query.append("	,MAX(A.VNDR_SEQ) AS VNDR_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	,A.VNDR_SEQ, G.DP_SEQ" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("    GROUP BY  A.STS_EVNT_LOC_CD ,A.AGMT_LSTM_CD,A.VNDR_LGL_ENG_NM" ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
