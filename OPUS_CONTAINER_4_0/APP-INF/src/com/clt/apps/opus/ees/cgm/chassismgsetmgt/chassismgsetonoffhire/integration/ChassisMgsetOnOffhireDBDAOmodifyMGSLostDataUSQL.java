...
*@FileName : ChassisMgsetOnOffhireDBDAOmodifyMGSLostDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOmodifyMGSLostDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOmodifyMGSLostDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOmodifyMGSLostDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",CHSS_MVMT_DT = TO_DATE(@[l_evnt_dt] ,'YYYY-MM-DD')" ).append("\n"); 
