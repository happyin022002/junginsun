...
*@FileName : VoNameDAOMGSChargeCreationVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VoNameDAOMGSChargeCreationVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * chungpa 20091223 2032 charge creation 변경적용사항.
	  * </pre>
	  */
	public VoNameDAOMGSChargeCreationVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.vo").append("\n"); 
		query.append("FileName : VoNameDAOMGSChargeCreationVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
