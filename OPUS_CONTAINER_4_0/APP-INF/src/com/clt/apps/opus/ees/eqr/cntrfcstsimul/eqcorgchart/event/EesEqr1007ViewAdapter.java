...
*@FileName : EesEqr1007ViewAdapter.java
*@FileTitle : EesEqr1007ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.5
 */
public class EesEqr1007ViewAdapter extends ViewAdapter {
    ...
    protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
        ...
        for(int i=0;i<realCnt;i++){
            ...
            sbufXML.append(" <TR");
            if(!getNull(colValues.get("tlevel")).equals("")){
                sbufXML.append(" LEVEL=\"");
                sbufXML.append(getNull(colValues.get("tlevel")));
                sbufXML.append("\"");
            }
    ...
    protected String makeDataTag(DBRowSet rs,String prefix) {
        ...
        try{
            ...
            while (rs.next()) {
                sb.append(" <TR");
                if(!getNull(rs.getObject("tlevel")).equals("")){
                    sb.append(" LEVEL=\"");
                    sb.append(getNull(rs.getObject("tlevel")));
                    sb.append("\"");
                }
