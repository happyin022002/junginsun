...
*@FileName : EES_MNR_0118HTMLAction.java
...
public class EES_MNR_0237HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0237HTMLAction 객체를 생성
	 */
	public EES_MNR_0237HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0237Event event = new EesMnr0237Event();
		
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRepairPFMCByACCTINVO((RepairPFMCByACCTINVO)getVO(request, RepairPFMCByACCTINVO.class));
		}
