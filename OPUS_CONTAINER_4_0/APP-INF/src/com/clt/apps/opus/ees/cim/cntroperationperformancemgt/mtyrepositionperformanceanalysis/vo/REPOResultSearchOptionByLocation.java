...
public class REPOResultSearchOptionByLocation extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<REPOResultSearchOptionByLocation> models = new ArrayList<REPOResultSearchOptionByLocation>();
	...
	public REPOResultSearchOptionByLocation() {}
	 ...
	 * @param company
	 */
	public REPOResultSearchOptionByLocation(String ibflag, String pagerows, String period, String from, String to, String tpsz, String rdtype, String directionwise, String inquirywise, String rcc, String loccode1, String loccode2, String inquirylevel, String cargotype, String soc, String company) {
		this.to = to;
		this.from = from;
		this.period = period;
	 ...
	 */
	public REPOResultSearchOptionByLocation[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return REPOResultSearchOptionByLocationVO[]
	 */
	public REPOResultSearchOptionByLocation[] fromRequestGrid(HttpServletRequest request, String prefix) {
		REPOResultSearchOptionByLocation model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new REPOResultSearchOptionByLocation();
				if (to[i] != null)
					model.setTo(to[i]);
				if (from[i] != null)
	...
	public REPOResultSearchOptionByLocation[] getREPOResultSearchOptionByLocations(){
		REPOResultSearchOptionByLocation[] vos = (REPOResultSearchOptionByLocation[])models.toArray(new REPOResultSearchOptionByLocation[models.size()]);
		return vos;
	}
