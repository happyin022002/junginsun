...
public class InvoiceIssueCollectionMgtDBDAOSearchInvoiceIssueMasterPreviewRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				   ), NULL" ).append("\n"); 
		query.append("--                 ), NULL" ).append("\n"); 
		query.append("--				   ,(DECODE(A.DMDT_INV_STS_CD, 'C','*** CREDIT NOTE ***','*** INVOICE ***'))                                                                      " ).append("\n"); 
		query.append("--                 ,(SELECT DECODE(A.DMDT_INV_STS_CD, 'C','*** CREDIT NOTE('||TIT.CSTMZ_TIT_DESC||') ***','*** INVOICE('||TIT.CSTMZ_TIT_DESC||') ***')                                                                                                                                   " ).append("\n"); 
		query.append("				   ,(DECODE(A.DMDT_INV_STS_CD, 'C', '*** CREDIT NOTE ***', " ).append("\n"); 
		query.append("                                                    DECODE((SELECT SUBSTR(LOC_CD,0,2) " ).append("\n"); 
		query.append("                                                            FROM MDM_ORGANIZATION " ).append("\n"); 
		query.append("                                                            WHERE OFC_CD = A.CRE_OFC_CD), 'AU','*** TAX INVOICE ***', 'MY','*** TAX INVOICE ***'," ).append("\n"); 
		query.append("                                                                                               '*** INVOICE ***')))                                                                                                                          " ).append("\n"); 
		query.append("                   ,(SELECT DECODE(A.DMDT_INV_STS_CD, 'C', '*** CREDIT NOTE('||TIT.CSTMZ_TIT_DESC||') ***', " ).append("\n"); 
		query.append("                                                      DECODE((SELECT SUBSTR(LOC_CD,0,2) " ).append("\n"); 
		query.append("                                                              FROM MDM_ORGANIZATION " ).append("\n"); 
		query.append("                                                              WHERE OFC_CD = A.CRE_OFC_CD), 'AU','*** TAX INVOICE('||TIT.CSTMZ_TIT_DESC||') ***', 'MY','*** TAX INVOICE('||TIT.CSTMZ_TIT_DESC||') ***',  " ).append("\n"); 
		...
		query.append("                                                                             " ).append("\n"); 
		query.append("--        , (SELECT RCV_TERM_CD FROM BKG_BOOKING WHERE BKG_NO = A.BKG_NO ) AS BKG_RCV_TERM_CD                                                                  " ).append("\n"); 
		query.append("--        , (SELECT INTG_CD_VAL_DP_DESC                                                                                                                                         " ).append("\n"); 
		query.append("--           FROM COM_INTG_CD_DTL                                                                                                                                               " ).append("\n"); 
		query.append("--           WHERE INTG_CD_VAL_CTNT = (SELECT RCV_TERM_CD                                                                                                          " ).append("\n"); 
		query.append("--                                     FROM BKG_BOOKING                                                                                          " ).append("\n"); 
		query.append("--                                     WHERE BKG_NO = A.BKG_NO                                                                                        " ).append("\n"); 
		query.append("--                                                               )                                                                                                              " ).append("\n"); 
		query.append("--             AND INTG_CD_ID = 'CD00764'                                                                                                                                       " ).append("\n"); 
		query.append("--          ) AS BKG_RCV_TERM_NM                                                                                                                                                " ).append("\n"); 
		query.append("--        , (SELECT DE_TERM_CD FROM BKG_BOOKING WHERE BKG_NO = A.BKG_NO) AS BKG_DEL_TERM_CD                                                                   " ).append("\n"); 
		query.append("--        , (SELECT INTG_CD_VAL_DP_DESC                                                                                                                                         " ).append("\n"); 
		query.append("--           FROM COM_INTG_CD_DTL                                                                                                                                               " ).append("\n"); 
		query.append("--           WHERE INTG_CD_VAL_CTNT = (SELECT DE_TERM_CD                                                                                                          " ).append("\n"); 
		query.append("--                                     FROM BKG_BOOKING                                                                                          " ).append("\n"); 
		query.append("--                                     WHERE BKG_NO = A.BKG_NO                                                                                        " ).append("\n"); 
		query.append("--                                     )                                                                                                               " ).append("\n"); 
		query.append("--             AND INTG_CD_ID = 'CD00765'                                                                                                                                       " ).append("\n"); 
		...
		query.append("        , ABS(NVL(A.INV_AMT,0)) AS INV_AMT                                                                                                                                                " ).append("\n"); 
		...
		query.append("FROM DMT_INV_MN A, DMT_SH_SET B                                    " ).append("\n"); 
		...
		query.append("      ,A.INV_CURR_CD AS INV_CURR_CD                                           " ).append("\n"); 
		query.append("--      ,NVL(A.BIL_AMT,0) AS TOT_AMT                         " ).append("\n"); 
		...
		query.append("   ,(CASE WHEN A.INV_CURR_CD IN ( 'KRW','JPY' , 'BEF' ,'DJF' , 'ESP' ,'GRD' , 'ITL' ,'LAK' , 'MGF' ,'MRO' , 'MXP' ,'PTE' , 'SDD' ,'MXN' ) THEN" ).append("\n"); 
		query.append("             TRUNC( A.BIL_AMT*A.INV_XCH_RT, 0)" ).append("\n"); 
		query.append("         WHEN A.INV_CURR_CD IN ( 'TWD','IDR', 'VND' ) THEN" ).append("\n"); 
		query.append("          ROUND( A.BIL_AMT*A.INV_XCH_RT, 0)" ).append("\n"); 
		query.append("         ELSE" ).append("\n"); 
		query.append("          ROUND( A.BIL_AMT*A.INV_XCH_RT, 2)" ).append("\n"); 
		query.append("         END - A.INV_CHG_AMT) AS DC_AMT                            " ).append("\n"); 
		query.append("--      ,NVL(A.BIL_AMT,0) - NVL(A.INV_CHG_AMT,0) AS DC_AMT                                                " ).append("\n"); 
		query.append("      ,NVL(A.INV_CHG_AMT,0) AS INV_CHG_AMT                                           " ).append("\n"); 
		query.append("      ,A.TAX_RTO AS TAX_RTO                                               " ).append("\n"); 
		query.append("      ,NVL(A.TAX_AMT,0) AS TAX_AMT                                               " ).append("\n"); 
