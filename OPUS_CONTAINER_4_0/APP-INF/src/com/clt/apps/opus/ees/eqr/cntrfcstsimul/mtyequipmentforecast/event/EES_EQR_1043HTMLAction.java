...
*@FileName : EES_CIM_1044HTMLAction.java
...
public class EES_EQR_1043HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_1043HTMLAction 객체를 생성
	 */
	public EES_EQR_1043HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr1043Event event = new EesEqr1043Event();
		...
		event.setAttribute("search_flag", 	search_flag);	
		
		event.setMtyBalanceOptionVO((MtyBalanceOptionVO)getVO(request, MtyBalanceOptionVO .class));
		event.setMtyBalanceListVO((MtyBalanceListVO)getVO(request, MtyBalanceListVO .class));
