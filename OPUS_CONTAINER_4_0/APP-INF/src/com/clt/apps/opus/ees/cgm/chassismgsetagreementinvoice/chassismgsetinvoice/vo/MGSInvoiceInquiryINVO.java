...
*@FileName : MGSInvoiceInquiryINVO.java
*@FileTitle : MGSInvoiceInquiryINVO
*Open Issues :
*Change history :
...
public class MGSInvoiceInquiryINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSInvoiceInquiryINVO> models = new ArrayList<MGSInvoiceInquiryINVO>();
	 ...
	 */
	public MGSInvoiceInquiryINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSInvoiceInquiryINVO[]
	 */
	public MGSInvoiceInquiryINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSInvoiceInquiryINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSInvoiceInquiryINVO();
		...
		return getMGSInvoiceInquiryINVOs();
	}
	...
	public MGSInvoiceInquiryINVO[] getMGSInvoiceInquiryINVOs(){
		MGSInvoiceInquiryINVO[] vos = (MGSInvoiceInquiryINVO[])models.toArray(new MGSInvoiceInquiryINVO[models.size()]);
		return vos;
	}
