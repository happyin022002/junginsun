...
*@FileName : DemDetTariffMgtDBDAOAddDmtTrfFreeTmCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOAddDmtTrfFreeTmCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOAddDmtTrfFreeTmCSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOAddDmtTrfFreeTmCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[trf_seq]" ).append("\n"); 
		query.append(",	@[trf_grp_seq]" ).append("\n"); 
		query.append(",	(SELECT NVL(MAX(TRF_FT_SEQ),0)+1 FROM DMT_TRF_FREE_TM" ).append("\n"); 
