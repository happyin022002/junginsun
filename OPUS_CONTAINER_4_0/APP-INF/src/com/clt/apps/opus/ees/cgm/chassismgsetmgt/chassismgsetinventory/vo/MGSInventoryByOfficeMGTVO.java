	...
	*/
	...
	public MGSInventoryByOfficeMGTVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				...
				String[] inqToDys =	(JSPUtil.getParameter(request, prefix +	"inq_to_dys".trim(),	length));
				String[] inqFmDys =	(JSPUtil.getParameter(request, prefix +	"inq_fm_dys".trim(),	length));
