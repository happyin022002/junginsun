...
public class EesEqr0059ConditionVO extends AbstractValueObject {
	...
	private String tpszDefault	= "";
	private String nowdate	= "";
	
	private String exectype	= "";
	private String fmContiCd	= "";
	private String toContiCd	= "";
	private String repoPlanId	= "";
	
	private String mtyBkgNo	= "";
	private String refId	= "";
	private String volsec	= "";
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("nowdate", getNowDate());
		...
		this.hashColumns.put("repo_plan_id", getRepoPlanId());
		this.hashColumns.put("mty_bkg_no", getMtyBkgNo());
		this.hashColumns.put("ref_id", getRefId());
		this.hashColumns.put("volsec", getVolsec());
	...
	public String getTpszDefault() {
		return tpszDefault;
	}

	public void setTpszDefault(String tpszDefault) {
		this.tpszDefault = tpszDefault;
	}
	...
	public String getVolsec() {
		return volsec;
	}

	public void setVolsec(String volsec) {
		this.volsec = volsec;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setNowDate(JSPUtil.getParameter(request, "nowdate", ""));
		...
		setRepoPlanId(JSPUtil.getParameter(request, "repo_plan_id", ""));
		
		setMtyBkgNo(JSPUtil.getParameter(request, "mty_bkg_no", ""));
		setRefId(JSPUtil.getParameter(request, "ref_id", ""));
		
		setVolsec(JSPUtil.getParameter(request, "volsec", ""));
	}
	...
	public EesEqr0059ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] repoPlanId = (JSPUtil.getParameter(request, prefix	+ "repo_plan_id", length));
			...
			String[] volsec = (JSPUtil.getParameter(request, prefix	+ "volsec", length));
	...
	*/
	public void unDataFormat(){
		...
		this.nowdate = this.nowdate .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.volsec = this.volsec .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
