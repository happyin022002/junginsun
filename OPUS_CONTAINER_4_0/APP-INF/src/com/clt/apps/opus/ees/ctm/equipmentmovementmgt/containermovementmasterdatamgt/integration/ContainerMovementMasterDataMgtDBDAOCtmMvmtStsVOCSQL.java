...
*@FileName : ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(")" ).append("\n"); 
		query.append("VALUES (@[mvmt_sts_cd]," ).append("\n"); 
		query.append("@[mvmt_sts_nm]," ).append("\n"); 
