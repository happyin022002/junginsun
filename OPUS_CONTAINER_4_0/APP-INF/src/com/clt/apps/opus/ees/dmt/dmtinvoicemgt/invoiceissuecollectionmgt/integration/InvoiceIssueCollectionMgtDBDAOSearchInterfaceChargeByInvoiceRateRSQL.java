...
public class InvoiceIssueCollectionMgtDBDAOSearchInterfaceChargeByInvoiceRateRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	   ,DECODE(C.INV_RT_AMT, 0, C.RT_OVR_CHG_AMT, C.INV_RT_AMT)  AS TRF_RT_AMT" ).append("\n"); 
		query.append("       ,DECODE(C.RT_OVR_DYS, 0, 1, C.RT_OVR_DYS) AS RAT_AS_CNTR_QTY" ).append("\n"); 
