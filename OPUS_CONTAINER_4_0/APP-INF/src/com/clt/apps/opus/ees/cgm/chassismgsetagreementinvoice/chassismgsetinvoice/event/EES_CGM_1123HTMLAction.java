...
*@FileName : EES_CGM_1123HTMLAction.java
...
public class EES_CGM_1123HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1123HTMLAction 객체를 생성
	 */
	public EES_CGM_1123HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1123Event event = new EesCgm1123Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			CHSCoPoolChargeINVO chsCoPoolChargeINVO = (CHSCoPoolChargeINVO)getVO(request, CHSCoPoolChargeINVO .class);
			chsCoPoolChargeINVO.setCostYrmon(chsCoPoolChargeINVO.getCostYrmon().replace("-", ""));
			chsCoPoolChargeINVO.setInvDt(chsCoPoolChargeINVO.getInvDt().replace("-", ""));
			
			event.setChsCoPoolChargeINVO(chsCoPoolChargeINVO);		
			event.setChsCoPoolChargeINVOS((CHSCoPoolChargeINVO[])getVOs(request, CHSCoPoolChargeINVO .class, ""));
		}
		else {
