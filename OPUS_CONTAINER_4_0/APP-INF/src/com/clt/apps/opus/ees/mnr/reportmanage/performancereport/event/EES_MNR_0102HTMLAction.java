...
*@FileName : EES_MNR_0102HTMLAction.java
...
public class EES_MNR_0102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0102HTMLAction 객체를 생성
	 */
	public EES_MNR_0102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0102Event event = new EesMnr0102Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTotalLossPerformanceINVO((TotalLossPerformanceINVO)getVO(request, TotalLossPerformanceINVO .class));
		}
