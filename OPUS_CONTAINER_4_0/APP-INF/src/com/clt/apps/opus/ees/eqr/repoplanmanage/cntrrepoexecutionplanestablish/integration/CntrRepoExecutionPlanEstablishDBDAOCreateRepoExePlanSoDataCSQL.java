...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOCreateRepoExePlanSoDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOCreateRepoExePlanSoDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Repo Plan S/O Insert
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOCreateRepoExePlanSoDataCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOCreateRepoExePlanSoDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       FROM EQR_REPO_EXE_PLN" ).append("\n"); 
