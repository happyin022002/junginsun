...
*@FileName : ChassisMgsetOnOffhireDBDAOsearchCHSInfoDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOsearchCHSInfoDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOsearchCHSInfoDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOsearchCHSInfoDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",TO_CHAR(D.STS_EVNT_DT,'YYYY-MM-DD HH24:MI' ) STS_EVNT_DT" ).append("\n"); 
		query.append(",(SELECT TO_CHAR(MAX(MVMT_DT),'YYYY-MM-DD  HH24:MI' ) FROM CGM_CHSS_MVMT_HIS WHERE CHSS_NO = A.EQ_NO ) MVMT_DT" ).append("\n"); 
