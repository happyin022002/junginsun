...
*@FileName : EES_MNR_0004HTMLAction.java
...
public class EES_MNR_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EESI_MNR_0004HTMLAction 객체를 생성
	 */ 
	public EES_MNR_0004HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0004Event event = new EesMnr0004Event();  
		     
		if(command.isCommand(FormCommand.MULTI)) { 
			event.setCustomMnrCedexOtrCdVOS((CustomMnrCedexOtrCdVO[])getVOs(request, CustomMnrCedexOtrCdVO .class,""));
		}    
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCedexOtherCodeListINVO((CedexOtherCodeListINVO)getVO(request, CedexOtherCodeListINVO .class));
		}      
