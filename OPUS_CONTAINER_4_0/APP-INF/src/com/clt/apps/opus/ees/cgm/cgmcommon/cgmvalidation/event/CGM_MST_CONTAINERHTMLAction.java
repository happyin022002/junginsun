...
*@FileName : CGM_CHS_MASTERHTMLAction.java
*@FileTitle : s
*Open Issues :
*Change history :
...
public class CGM_MST_CONTAINERHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CGM_CHS_MASTERHTMLAction 객체를 생성
	 */
	public CGM_MST_CONTAINERHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	CgmMstContainerEvent event = new CgmMstContainerEvent();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsMasterMGTVO((ChsMasterMGTVO)getVO(request, ChsMasterMGTVO .class));
		}
