...
*@FileName : EES_CIM_0024HTMLAction.java
...
public class EES_CIM_0024HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0022HTMLAction 객체를 생성
	 */
	public EES_CIM_0024HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0024Event event = new EesCim0024Event();
		

		event.setFlaggingSDaysOptionVO ((FlaggingSDaysOptionVO )getVO(request, FlaggingSDaysOptionVO  .class));
		event.setFlaggingListSmryVO ((FlaggingListSmryVO )getVO(request, FlaggingListSmryVO  .class));
		event.setFlaggingListSmryVOS((FlaggingListSmryVO[])getVOs(request, FlaggingListSmryVO .class,""));
