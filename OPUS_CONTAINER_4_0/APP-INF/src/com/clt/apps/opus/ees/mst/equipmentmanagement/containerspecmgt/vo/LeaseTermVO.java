...
*@FileName : leaseTermVO.java
*@FileTitle : leaseTermVO
*Open Issues :
*Change history :
...
public class LeaseTermVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<LeaseTermVO> models = new ArrayList<LeaseTermVO>();
	...
	public LeaseTermVO(String ibflag, String pagerows, String lstmCd, String lstmNm, String lsePrdCtnt, String purOptFlg, String purPrc, String dpSeq, String diffRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.dpSeq = dpSeq;
		this.updDt = updDt;
		this.purPrc = purPrc;
		this.creDt = creDt;
	 ...
	 * @return leaseTermVO[]
	 */
	public LeaseTermVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return leaseTermVO[]
	 */
	public LeaseTermVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LeaseTermVO model = null;
	...
	public LeaseTermVO[] getleaseTermVOs(){
		LeaseTermVO[] vos = (LeaseTermVO[])models.toArray(new LeaseTermVO[models.size()]);
		return vos;
	}
