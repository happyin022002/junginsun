...
*@FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Exception Terms Entry 의 하위 Multi Origin(I) or Destination(O) 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
