...
public class SCExceptionTariffMgtDBDAOCheckDualTypeCoverageRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT	COUNT(CUST_CNT_CD) CNT" ).append("\n"); 
		query.append("FROM	DMT_DUL_TP_EXPT" ).append("\n"); 
		query.append("WHERE	CUST_CNT_CD = @[cust_cnt_cd]" ).append("\n"); 
		query.append("AND	CUST_SEQ = @[cust_seq]" ).append("\n"); 
		query.append("AND	DUL_EXPT_DELT_FLG = 'N'" ).append("\n"); 
		query.append("AND DUL_EXPT_EFF_DT <= TO_DATE(@[dul_expt_eff_dt], 'YYYYMMDD')" ).append("\n"); 
		query.append("AND NVL(DUL_EXPT_EXP_DT, TO_DATE(@[dul_expt_exp_dt], 'YYYYMMDD')) >= TO_DATE(@[dul_expt_exp_dt], 'YYYYMMDD')" ).append("\n"); 
