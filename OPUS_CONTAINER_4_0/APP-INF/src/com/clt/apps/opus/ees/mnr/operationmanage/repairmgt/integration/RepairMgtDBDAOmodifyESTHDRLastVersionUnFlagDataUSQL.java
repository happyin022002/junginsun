...
*@FileName : RepairMgtDBDAOmodifyESTHDRLastVersionUnFlagDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOmodifyESTHDRLastVersionUnFlagDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyESTHDRLastVersionUnFlagData
	  * </pre>
	  */
	public RepairMgtDBDAOmodifyESTHDRLastVersionUnFlagDataUSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOmodifyESTHDRLastVersionUnFlagDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
