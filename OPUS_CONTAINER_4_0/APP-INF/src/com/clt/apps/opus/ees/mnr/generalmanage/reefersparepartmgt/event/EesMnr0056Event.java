...
public class EesMnr0056Event extends EventSupport {
	...
	public RFSparePartInventoryListVO[] getRFSparePartInventoryListVOs() {
		RFSparePartInventoryListVO[] rtnVOs = null;
		if (this.rfSparePartInventoryListVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(rfSparePartInventoryListVOs, rfSparePartInventoryListVOs.length);
		}
		return rtnVOs;
	}
	public void setRFSparePartInventoryListVOs(RFSparePartInventoryListVO[] rfSparePartInventoryListVOs){
		if(rfSparePartInventoryListVOs != null){
			RFSparePartInventoryListVO[] tmpVOs = java.util.Arrays.copyOf(rfSparePartInventoryListVOs, rfSparePartInventoryListVOs.length);
			this.rfSparePartInventoryListVOs = tmpVOs;
		}
	}
