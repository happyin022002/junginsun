...
public class RateMgtDBDAOsearchAgreementMenuDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       B.SHEET_TITLE		" ).append("\n"); 
		...
		query.append("                      A.MNR_CD_ID||'-'||A.MNR_CD_DESC) AS SHEET_TITLE," ).append("\n"); 
		query.append("               DECODE(SUBSTRB(A.MNR_CD_ID," ).append("\n"); 
		query.append("                              LENGTH(A.MNR_CD_ID) - 1," ).append("\n"); 
		query.append("                              LENGTH(A.MNR_CD_ID))," ).append("\n"); 
		query.append("                      'RC'," ).append("\n"); 
		...
		query.append("			   DECODE(A.MNR_ORD_TP_CD, 'LB', 'RC', SUBSTRB(A.MNR_CD_ID,LENGTH(A.MNR_CD_ID) - 2,LENGTH(A.MNR_CD_ID))) AS TAB_TYPE," ).append("\n"); 
		...
		query.append(" GROUP BY B.PRNT_CD_ID, B.TAB_TITLE, B.MNR_ORD_TP_CD, B.TAB_TYPE ,B.COST_CD, B.SHEET_TITLE" ).append("\n"); 
