...
*@FileName : EesEqr1050ConditionVO.java
...
public class EesEqr1050ConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EesEqr1050ConditionVO> models = new ArrayList<EesEqr1050ConditionVO>();
...
//	private String podClptIndSeq = null;
	...
	public EesEqr1050ConditionVO() {}
	
	public EesEqr1050ConditionVO(String ibflag, String pagerows, String targetrow, String bkgNo) {
	 ...
	 */
	public EesEqr1050ConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EesEqr1050ConditionVO[]
	 */
	public EesEqr1050ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EesEqr1050ConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EesEqr1050ConditionVO();
				if (targetrow[i] != null)
		...
		return getEesEqr1050ConditionVOs();
	}
	 ...
	 * @return EesEqr1050ConditionVO[]
	 */
	public EesEqr1050ConditionVO[] getEesEqr1050ConditionVOs(){
		EesEqr1050ConditionVO[] vos = (EesEqr1050ConditionVO[])models.toArray(new EesEqr1050ConditionVO[models.size()]);
		return vos;
	}
