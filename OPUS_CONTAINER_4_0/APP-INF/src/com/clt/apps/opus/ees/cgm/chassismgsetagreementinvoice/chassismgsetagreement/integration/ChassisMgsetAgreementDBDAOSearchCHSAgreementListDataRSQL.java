...
*@FileName : ChassisMgsetAgreementDBDAOSearchCHSAgreementListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAOSearchCHSAgreementListDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetAgreementDB.SearchCHSAgreementListData
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAOSearchCHSAgreementListDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAOSearchCHSAgreementListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
