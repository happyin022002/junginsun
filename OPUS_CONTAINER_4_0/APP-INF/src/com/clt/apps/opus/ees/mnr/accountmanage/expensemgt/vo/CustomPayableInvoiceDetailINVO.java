...
public class CustomPayableInvoiceDetailINVO extends AbstractValueObject {
	...
	/* Column Info */
	private String invConvAmt = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inv_conv_amt", getInvConvAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inv_conv_amt", "invConvAmt");
	...
	public String getInvConvAmt() {
		return invConvAmt;
	}

	public void setInvConvAmt(String invConvAmt) {
		this.invConvAmt = invConvAmt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setInvConvAmt(JSPUtil.getParameter(request, prefix + "inv_conv_amt", ""));
	}
	...
	public CustomPayableInvoiceDetailINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] invConvAmt = (JSPUtil.getParameter(request, prefix	+ "inv_conv_amt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (invConvAmt[i] != null)
					model.setInvConvAmt(invConvAmt[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.invConvAmt = this.invConvAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
