...
*@FileName : EES_MNR_0011HTMLAction.java
...
public class EES_MNR_0011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0011HTMLAction 객체를 생성
	 */
	public EES_MNR_0011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0011Event event = new EesMnr0011Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRepairTariffMgtINVO((RepairTariffMgtINVO)getVO(request, RepairTariffMgtINVO .class));
		} 
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomMnrRprTrfHdrVO((CustomMnrRprTrfHdrVO)getVO(request, CustomMnrRprTrfHdrVO .class));
			event.setArrayCustomMnrRprTrfDtlVOs((CustomMnrRprTrfDtlVO[])getVOs(request,CustomMnrRprTrfDtlVO .class, "" ));
		}
