...
public class PayableRentalCostDBDAOsearchPayableRentalReportByTySzRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                           SUM(DECODE(COST_YRMON, '03', FF, 0)))     OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 0, 0," ).append("\n"); 
		query.append("                          ROUND(" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '01', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '02', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '03', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 1 PRECEDING AND 1 PRECEDING) /" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '01', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '02', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '03', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 2))" ).append("\n"); 
		...
		query.append("                           SUM(DECODE(COST_YRMON, '06', FF, 0)))     OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 0, 0," ).append("\n"); 
		query.append("                          ROUND(" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '04', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '05', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '06', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 1 PRECEDING AND 1 PRECEDING) /" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '04', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '05', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '06', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 2))" ).append("\n"); 
		query.append("                ELSE" ).append("\n"); 
		...
		query.append("                           SUM(DECODE(COST_YRMON, '09', FF, 0)))     OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 0, 0," ).append("\n"); 
		query.append("                          ROUND(" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '07', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '08', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '09', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 1 PRECEDING AND 1 PRECEDING) /" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '07', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '08', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '09', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 2))" ).append("\n"); 
		query.append("                ELSE" ).append("\n"); 
		...
		query.append("                           SUM(DECODE(COST_YRMON, '12', FF, 0)))     OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 0, 0," ).append("\n"); 
		query.append("                          ROUND(" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '10', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '11', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '12', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 1 PRECEDING AND 1 PRECEDING) /" ).append("\n"); 
		query.append("                           SUM(SUM(DECODE(COST_YRMON, '10', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '11', FF, 0))+ " ).append("\n"); 
		query.append("                               SUM(DECODE(COST_YRMON, '12', FF, 0))) OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 2))" ).append("\n"); 
		query.append("                ELSE" ).append("\n"); 
		...
		query.append("                    SUM(DECODE(COST_YRMON, '11', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '12', FF, 0)))" ).append("\n"); 
		query.append("                    OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 0, 0," ).append("\n"); 
		query.append("                  ROUND(" ).append("\n"); 
		query.append("                   SUM(SUM(DECODE(COST_YRMON, '01', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '02', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '03', FF, 0))+" ).append("\n"); 
		...
		query.append("                    SUM(DECODE(COST_YRMON, '11', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '12', FF, 0)))" ).append("\n"); 
		query.append("                    OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 1 PRECEDING AND 1 PRECEDING) /" ).append("\n"); 
		query.append("                    SUM(SUM(DECODE(COST_YRMON, '01', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '02', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '03', FF, 0))+" ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '04', FF, 0))+ " ).append("\n"); 
		...
		query.append("                    SUM(DECODE(COST_YRMON, '11', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '12', FF, 0)))" ).append("\n"); 
		query.append("                    OVER (PARTITION BY CNTR_TPSZ_CD,CURR_CD ORDER BY CNTR_TPSZ_CD, DIV ROWS BETWEEN 2 PRECEDING AND 2 PRECEDING), 2))" ).append("\n"); 
		query.append("               ELSE" ).append("\n"); 
		query.append("                   (SUM(DECODE(COST_YRMON, '01', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '02', FF, 0))+ " ).append("\n"); 
		query.append("                    SUM(DECODE(COST_YRMON, '03', FF, 0))+" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("                             GROUP BY CNTR_TPSZ_CD, SUBSTR(CHG_COST_YRMON, 5, 2), LTMP.CURR_CD" ).append("\n"); 
		query.append("                             UNION ALL" ).append("\n"); 
		query.append("                             SELECT LTC.CNTR_TPSZ_CD," ).append("\n"); 
		query.append("                                    LTC.CURR_CD," ).append("\n"); 
		query.append("                                    SUBSTR(LTC.SKD_VOY_NO, 3, 2) AS COST_YRMON,              " ).append("\n"); 
		query.append("                                    SUM(LTC.OP_LSE_QTY) F1," ).append("\n"); 
		query.append("                                    SUM(LTC.PAY_AMT) F2," ).append("\n"); 
		query.append("                                    DECODE(SIGN(SUM(LTC.OP_LSE_QTY)), 1, ROUND((SUM(LTC.PAY_AMT) / SUM(LTC.OP_LSE_QTY)) * 100 ) / 100) F3" ).append("\n"); 
		...
		query.append("                           AND ROWNUM           = 1)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("            GROUP BY LTC.CNTR_TPSZ_CD, SUBSTR(LTC.SKD_VOY_NO, 3, 2), LTC.CURR_CD) V1," ).append("\n"); 
		...
		query.append("GROUP BY CNTR_TPSZ_CD ,  DIV, CURR_CD   " ).append("\n"); 
		...
		query.append("ORDER BY  TTT.RPT_DP_SEQ ,XXX.CNTR_TPSZ_CD, XXX.CURR_CD, XXX.DIV_SEQ )" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT   " ).append("\n"); 
		query.append("   CNTR_TPSZ_CD ," ).append("\n"); 
		query.append("   DIV," ).append("\n"); 
		...
		query.append("   3 DIV_ORDER," ).append("\n"); 
		...
		query.append("       GROUP BY CURR_CD) V , " ).append("\n"); 
		query.append("     ( SELECT           " ).append("\n"); 
		query.append("           'G.TTL' CNTR_TPSZ_CD ,   " ).append("\n"); 
		query.append("           CURR_CD ,        " ).append("\n"); 
		query.append("           SUM(JAN) JAN ,   " ).append("\n"); 
		...
		query.append("GROUP BY CURR_CD) A " ).append("\n"); 
