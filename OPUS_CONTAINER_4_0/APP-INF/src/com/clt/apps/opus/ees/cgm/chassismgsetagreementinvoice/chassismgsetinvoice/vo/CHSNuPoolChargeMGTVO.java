...
*@FileName : CHSNuPoolChargeMGTVO.java
*@FileTitle : CHSNuPoolChargeMGTVO
*Open Issues :
*Change history :
...
public class CHSNuPoolChargeMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSNuPoolChargeMGTVO> models = new ArrayList<CHSNuPoolChargeMGTVO>();
	...
	public CHSNuPoolChargeMGTVO() {}

	public CHSNuPoolChargeMGTVO(String ibflag, String pagerows, String actionflag, String costBilDys, String chssMgstInvKndCd, String costOfcCd, String dtlPoolCostItmCd, String payInvSeq, String intgCdValDpDesc, String costChssQty, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String eqKndCd, String invNo, String creUsrId, String costYrmon, String costCd, String diffRmk, String costAmt, String vndrSeq, String vndrLglEngNm, String chssMgstInvStsCd, String updUsrId, String invDt, String invUsrId, String currCd, String poolMaxRtAmt, String poolMinRtAmt, String chgSmryAmt, String invSmryAmt) {
		this.currCd = currCd;
	 ...
	 */
	public CHSNuPoolChargeMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSNuPoolChargeMGTVO[]
	 */
	public CHSNuPoolChargeMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSNuPoolChargeMGTVO model = null;
		...
		try {
			...
			String[] poolMinRtAmt = (JSPUtil.getParameter(request, prefix	+ "pool_min_rt_amt", length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix	+ "cre_usr_id", length));
			String[] diffRmk = (JSPUtil.getParameter(request, prefix	+ "diff_rmk", length));
			String[] agmtOfcCtyCd = (JSPUtil.getParameter(request, prefix	+ "agmt_ofc_cty_cd", length));
			String[] vndrSeq = (JSPUtil.getParameter(request, prefix	+ "vndr_seq", length));
			String[] poolMaxRtAmt = (JSPUtil.getParameter(request, prefix	+ "pool_max_rt_amt", length));
			...
			for (int i = 0; i < length; i++) {
				model = new CHSNuPoolChargeMGTVO();
				if (currCd[i] != null)
		...
		return getCHSNuPoolChargeMGTVOs();
	}
	 ...
	 * @return CHSNuPoolChargeMGTVO[]
	 */
	public CHSNuPoolChargeMGTVO[] getCHSNuPoolChargeMGTVOs(){
		CHSNuPoolChargeMGTVO[] vos = (CHSNuPoolChargeMGTVO[])models.toArray(new CHSNuPoolChargeMGTVO[models.size()]);
		return vos;
	}
