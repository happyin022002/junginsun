...
*@FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request & Approval Status 조회(SC, DAR)용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	AND SP_HDR.SC_NO = @[sc_no]" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	#if(${prop_no} != '')" ).append("\n"); 
		query.append("	AND SP_HDR.PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	AND SP_HDR.SC_NO = ( SELECT SC_NO FROM BKG_BOOKING WHERE BKG_NO = @[bkg_no] )" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	#if(${bl_no} != '')" ).append("\n"); 
		query.append("	AND SP_HDR.SC_NO = ( SELECT SC_NO FROM BKG_BOOKING WHERE BL_NO = @[bl_no] )" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
