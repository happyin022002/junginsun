...
public class InvoiceIssueCollectionMgtDBDAOSearchInvoiceInterfaceARByDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		,ROUND (NVL(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[session_ofc_cd]),SYSDATE) " ).append("\n"); 
		query.append("				- M.CRE_DT) AS OVER_DAYS" ).append("\n"); 
		...
		query.append("		,SUBSTR(M.DMDT_INV_NO,3,1) AS DMDT_SUB_INV_NO" ).append("\n"); 
