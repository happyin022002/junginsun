...
*@FileName : CodSimulateDBDAODuplicateCreateRepoPlanCheckCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodSimulateDBDAODuplicateCreateRepoPlanCheckCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CodSimulateDBDAODuplicateCreateRepoPlanCheckCSQL
	  * </pre>
	  */
	public CodSimulateDBDAODuplicateCreateRepoPlanCheckCSQL(){
		setQuery();
		...
		query.append("FileName : CodSimulateDBDAODuplicateCreateRepoPlanCheckCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
