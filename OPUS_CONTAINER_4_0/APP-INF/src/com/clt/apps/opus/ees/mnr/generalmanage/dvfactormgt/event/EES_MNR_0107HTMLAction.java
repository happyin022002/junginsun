...
*@FileName : ESS_MNR_0107HTMLAction.java
*@FileTitle : DV Factor
*Open Issues :
*Change history :
...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.ees.mnr.generalmanage.dvfactormgt.event;
...
public class EES_MNR_0107HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0107HTMLAction 객체를 생성
	 */
	public EES_MNR_0107HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0107Event event = new EesMnr0107Event();
		//저장
		if(command.isCommand(FormCommand.MULTI)) { 
			event.setCustomMnrEqDpcVOs((CustomMnrEqDpcVO[])getVOs(request, CustomMnrEqDpcVO.class,""));
		}
		//조회
		else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setDVFactorINVO((DVFactorINVO)getVO(request, DVFactorINVO .class));
		}     
