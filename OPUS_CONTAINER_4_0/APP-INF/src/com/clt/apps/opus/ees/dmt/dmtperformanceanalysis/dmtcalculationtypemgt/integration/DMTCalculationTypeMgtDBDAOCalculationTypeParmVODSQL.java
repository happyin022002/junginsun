...
*@FileName : DMTCalculationTypeMgtDBDAOCalculationTypeParmVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCalculationTypeMgtDBDAOCalculationTypeParmVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CalculationTypeParmVO Delete
	  * </pre>
	  */
	public DMTCalculationTypeMgtDBDAOCalculationTypeParmVODSQL(){
		setQuery();
		...
		query.append("FileName : DMTCalculationTypeMgtDBDAOCalculationTypeParmVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_CALC_TP" ).append("\n"); 
