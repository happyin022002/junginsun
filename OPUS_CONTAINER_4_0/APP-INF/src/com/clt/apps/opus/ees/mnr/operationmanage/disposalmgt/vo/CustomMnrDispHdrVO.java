...
public class CustomMnrDispHdrVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inq_flg", getInqFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inq_flg", "inqFlg");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setInqFlg(JSPUtil.getParameter(request, prefix + "inq_flg", ""));
	}
	...
	public CustomMnrDispHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] inqFlg = (JSPUtil.getParameter(request, prefix	+ "inq_flg", length));
	...
	*/
	public void unDataFormat(){
		...
		this.inqFlg = this.inqFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
