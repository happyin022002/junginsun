...
public class EqrCommonVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrCommonVO> models = new ArrayList<EqrCommonVO>();
	...
	public EqrCommonVO(String ibflag, String pagerows, String plnYr, String plnWk, String plnMon, String wkStDt, String wkEndDt, String updDt, String creDt, String creUsrId, String updUsrId, String delChk
			, String trdCd, String trdNm, String fmContiCd, String toContiCd, String typeSize) {
		this.updDt = updDt;
		this.delChk = delChk;
		this.plnMon = plnMon;
	...
	/**
	 * @param fmContiCd the fmContiCd to set
	 */
	...
	/**
	 * @param toContiCd the toContiCd to set
	 */
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTypeSize(JSPUtil.getParameter(request, prefix + "to_conti_cd", ""));
	}
	 ...
	 */
	public EqrCommonVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEqrWkPrdVO[]
	 */
	public EqrCommonVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrCommonVO model = null;
	 ...
	 * @return SearchEqrWkPrdVO[]
	 */
	public EqrCommonVO[] getSearchEqrWkPrdVOs(){
		EqrCommonVO[] vos = (EqrCommonVO[])models.toArray(new EqrCommonVO[models.size()]);
		return vos;
	}
