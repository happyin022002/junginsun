...
*@FileName : EES_EQR_0129HTMLAction.java
...
public class EES_EQR_0129HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0129HTMLAction 객체를 생성
	 */
	public EES_EQR_0129HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0129Event event = new EesEqr0129Event();

		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setEesEqr0129ConditionVO((EesEqr0129ConditionVO)getVO(request, EesEqr0129ConditionVO .class));
		}
