...
*@FileName : CommonDBDAOModifyEqrWkPrdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOModifyEqrWkPrdUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EES_EQR_0008의 주차 정보를 수정한다.
	  * </pre>
	  */
	public CommonDBDAOModifyEqrWkPrdUSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOModifyEqrWkPrdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EQR_WK_PRD" ).append("\n"); 
		query.append("   SET PLN_MON = @[pln_mon]" ).append("\n"); 
		query.append("      ,WK_ST_DT = @[wk_st_dt]" ).append("\n"); 
		query.append("      ,WK_END_DT = @[wk_end_dt]" ).append("\n"); 
