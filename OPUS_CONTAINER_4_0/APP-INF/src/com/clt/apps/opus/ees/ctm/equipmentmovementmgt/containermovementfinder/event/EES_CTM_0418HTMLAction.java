...
*@FileName : EES_CTM_0418HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0418HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0418HTMLAction 객체를 생성
	 */
	public EES_CTM_0418HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0418Event event = new EesCtm0418Event();
		event.setMovementEDIReportVO ((MovementEDIReportVO )getVO(request, MovementEDIReportVO  .class));
		event.setUpdateRatioDetailVO ((UpdateRatioDetailVO )getVO(request, UpdateRatioDetailVO  .class));
