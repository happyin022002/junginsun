...
*@FileName : MGSChargeCreationINVO.java
*@FileTitle : MGSChargeCreationINVO
*Open Issues :
*Change history :
...
public class MGSChargeCreationINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSChargeCreationINVO> models = new ArrayList<MGSChargeCreationINVO>();
	 ...
	 */
	public MGSChargeCreationINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSChargeCreationINVO[]
	 */
	public MGSChargeCreationINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSChargeCreationINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSChargeCreationINVO();
				if (agmtEffDt[i] != null)
		...
		return getMGSChargeCreationINVOs();
	}
	...
	public MGSChargeCreationINVO[] getMGSChargeCreationINVOs(){
		MGSChargeCreationINVO[] vos = (MGSChargeCreationINVO[])models.toArray(new MGSChargeCreationINVO[models.size()]);
		return vos;
	}
