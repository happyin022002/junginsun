...
*@FileName : checkVLVDCntrExistsVO.java
*@FileTitle : checkVLVDCntrExistsVO
*Open Issues :
*Change history :
...
public class checkVLVDCntrExistsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<checkVLVDCntrExistsVO> models = new ArrayList<checkVLVDCntrExistsVO>();
	...
	public checkVLVDCntrExistsVO() {}

	public checkVLVDCntrExistsVO(String ibflag, String pagerows, String cntrNo, String checkDigit, String cntrTpszCd, String prevStsCd, String orgYdCd) {
	 ...
	 * @param request
	 * @return checkVLVDCntrExistsVO[]
	 */
	public checkVLVDCntrExistsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return checkVLVDCntrExistsVO[]
	 */
	public checkVLVDCntrExistsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		checkVLVDCntrExistsVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new checkVLVDCntrExistsVO();
				if (prevStsCd[i] != null)
		...
		return getcheckVLVDCntrExistsVOs();
	}
	 ...
	 * @return checkVLVDCntrExistsVO[]
	 */
	public checkVLVDCntrExistsVO[] getcheckVLVDCntrExistsVOs(){
		checkVLVDCntrExistsVO[] vos = (checkVLVDCntrExistsVO[])models.toArray(new checkVLVDCntrExistsVO[models.size()]);
		return vos;
	}
