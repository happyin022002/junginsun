...
*@FileName : ChargeAmountDiscountMgtDBDAORemoveAfterBookingDARDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeAmountDiscountMgtDBDAORemoveAfterBookingDARDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG DAR 정보를 삭제하기 위한 쿼리
	  * </pre>
	  */
	public ChargeAmountDiscountMgtDBDAORemoveAfterBookingDARDSQL(){
		setQuery();
		...
		query.append("FileName : ChargeAmountDiscountMgtDBDAORemoveAfterBookingDARDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_AFT_BKG_ADJ_RQST_DTL" ).append("\n"); 
