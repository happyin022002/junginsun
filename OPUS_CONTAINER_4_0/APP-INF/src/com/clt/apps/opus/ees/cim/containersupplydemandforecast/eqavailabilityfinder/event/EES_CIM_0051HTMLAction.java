...
*@FileName : EES_CIM_0051HTMLAction.java
*@FileTitle : ON Detail
*Open Issues :
*Change history :
...
public class EES_CIM_0051HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0051HTMLAction 객체를 생성
	 */
	public EES_CIM_0051HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0051Event event = new EesCim0051Event();
