...
*@FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionCommodityOfHistVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddBeforeExceptionCommodityOfHistVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Commodity of hist version insert
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddBeforeExceptionCommodityOfHistVersionCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionCommodityOfHistVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND A.RFA_EXPT_DAR_NO    = @[rfa_expt_hist_dar_no]" ).append("\n"); 
		query.append("   AND A.RFA_EXPT_MAPG_SEQ  = @[rfa_expt_hist_mapg_seq]" ).append("\n"); 
		query.append("   AND A.RFA_EXPT_VER_SEQ   = @[rfa_expt_hist_ver_seq]" ).append("\n"); 
