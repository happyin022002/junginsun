...
public class CustomMnrGenCdVO extends AbstractValueObject {
	...
	/* Column Info */
	private String costShpSrchPattNm = null;
	/* Column Info */
	private String acctCd = null;
	/* Column Info */
	private String intgFlg = null;
	/* Column Info */
	private String agmtValFlg = null;
	/* Column Info */
	private String agmtRtFlg = null;
	...
	public CustomMnrGenCdVO(String ibflag, String pagerows, String mnrCdSeq, String eqKndCd, String mnrCdId, String prntCdId, String mnrCdDpDesc, String mnrCdDesc, String mnrCdDpSeq, String pairCdId, String pairCdDpDesc, String pairCdDesc, String pairRefCd, String pairDpSeq, String mnrCdGrpNo, String mnrCdGrpTpCd, String agmtUseFlg, String deltFlg, String mnrCdDfltPntNo, String mnrOrdTpCd, String creUsrId, String creDt, String updUsrId, String updDt, String costShpSrchPattNm, String acctCd, String intgFlg, String agmtValFlg, String agmtRtFlg) {
		...
		this.costShpSrchPattNm = costShpSrchPattNm;
		this.acctCd = acctCd;
		this.intgFlg = intgFlg;
		this.agmtValFlg = agmtValFlg;
		this.agmtRtFlg = agmtRtFlg;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cost_shp_srch_patt_nm", getCostShpSrchPattNm());
		this.hashColumns.put("acct_cd", getAcctCd());
		this.hashColumns.put("intg_flg", getIntgFlg());
		this.hashColumns.put("agmt_val_flg", getAgmtValFlg());
		this.hashColumns.put("agmt_rt_flg", getAgmtRtFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cost_shp_srch_patt_nm", "costShpSrchPattNm");
		this.hashFields.put("acct_cd", "acctCd");
		this.hashFields.put("intg_flg", "intgFlg");
		this.hashFields.put("agmt_val_flg", "agmtValFlg");
		this.hashFields.put("agmt_rt_flg", "agmtRtFlg");
	...
	/**
	 * Column Info
	 * @return costShpSrchPattNm
	 */
	public String getCostShpSrchPattNm() {
		return this.costShpSrchPattNm;
	}
	 ...
	 * @return agmtValFlg
	 */
	public String getAgmtValFlg() {
		return this.agmtValFlg;
	}
	 ...
	 * @return agmtRtFlg
	 */
	public String getAgmtRtFlg() {
		return this.agmtRtFlg;
	}
	...
	/**
	 * Column Info
	 * @param costShpSrchPattNm
	 */
	public void setCostShpSrchPattNm(String costShpSrchPattNm) {
		this.costShpSrchPattNm = costShpSrchPattNm;
	}
	 ...
	 * @param agmtValFlg
	 */
	public void setAgmtValFlg(String agmtValFlg) {
		this.agmtValFlg = agmtValFlg;
	}
	 ...
	 * @param agmtRtFlg
	 */
	public void setAgmtRtFlg(String agmtRtFlg) {
		this.agmtRtFlg = agmtRtFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCostShpSrchPattNm(JSPUtil.getParameter(request, "cost_shp_srch_patt_nm", ""));
		setAcctCd(JSPUtil.getParameter(request, "acct_cd", ""));
		setIntgFlg(JSPUtil.getParameter(request, "intg_flg", ""));
		setAgmtValFlg(JSPUtil.getParameter(request, "agmt_val_flg", ""));
		setAgmtRtFlg(JSPUtil.getParameter(request, "agmt_rt_flg", ""));
	}
	...
	public CustomMnrGenCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] costShpSrchPattNm = (JSPUtil.getParameter(request, prefix	+ "cost_shp_srch_patt_nm", length));
			String[] acctCd = (JSPUtil.getParameter(request, prefix	+ "acct_cd", length));
			String[] intgFlg = (JSPUtil.getParameter(request, prefix	+ "intg_flg", length));
			String[] agmtValFlg = (JSPUtil.getParameter(request, prefix	+ "agmt_val_flg", length));
			String[] agmtRtFlg = (JSPUtil.getParameter(request, prefix	+ "agmt_rt_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (costShpSrchPattNm[i] != null)
					model.setCostShpSrchPattNm(costShpSrchPattNm[i]);
				if (acctCd[i] != null)
					model.setAcctCd(acctCd[i]);
				if (intgFlg[i] != null)
					model.setIntgFlg(intgFlg[i]);
				if (agmtValFlg[i] != null)
					model.setAgmtValFlg(agmtValFlg[i]);
				if (agmtRtFlg[i] != null)
					model.setAgmtRtFlg(agmtRtFlg[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.costShpSrchPattNm = this.costShpSrchPattNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.acctCd = this.acctCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.intgFlg = this.intgFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.agmtValFlg = this.agmtValFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.agmtRtFlg = this.agmtRtFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
