...
public class EES_DMT_7006HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt7006Event event = new EesDmt7006Event();
        

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setDmtFaxEmlSndHisParmVO((DmtFaxEmlSndHisParmVO)getVO(request, DmtFaxEmlSndHisParmVO .class));
        }
