...
*@FileName : CrossItemVO.java
*@FileTitle : CrossItemVO
*Open Issues :
*Change history :
...
public class CrossItemVO extends AbstractValueObject {
	...
	/* UPDATE TRS */
	private boolean updateTrs = false;
	/* findBkgCntr */
	 ...
	 * @return CusCtmMovementVO
	 */
	public boolean getUpdateTrs() {
		return this.updateTrs;
	}
	 ...
	 * @param creUsrId
	 */
	public void setUpdateTrs(boolean updTrs) {
		this.updateTrs = updTrs;
	}
