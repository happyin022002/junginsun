...
public class PayableRentalCostVO {
	...
	private String lsePayTpCd   = "";
	private Integer intLastInvNo        = 0;
	...
	public void setIntLastInvNo(Integer intLastInvNo) {
		this.intLastInvNo = intLastInvNo;
	}

	public Integer getIntLastInvNo() {
		return intLastInvNo;
	}
