...
*@FileName : ContainerOnOffhireDBDAOAddLseCntrLotCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerOnOffhireDBDAOAddLseCntrLotCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerOnOffhireDBDAOAddLseCntrLotCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerOnOffhireDBDAOAddLseCntrLotCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
