...
public class EES_CTM_0473HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0473HTMLAction 객체를 생성
	 */
	public EES_CTM_0473HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0473Event event = new EesCtm0473Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAllEQRRefVO((SearchAllEQRRefVO)getVO(request, SearchAllEQRRefVO.class));
