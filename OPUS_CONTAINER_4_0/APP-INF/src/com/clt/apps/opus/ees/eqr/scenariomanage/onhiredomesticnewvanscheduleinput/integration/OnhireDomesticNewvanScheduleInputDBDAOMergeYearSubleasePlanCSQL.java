...
*@FileName : OnhireDomesticNewvanScheduleInputDBDAOMergeYearSubleasePlanCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnhireDomesticNewvanScheduleInputDBDAOMergeYearSubleasePlanCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_SLSE 테이블의 데이터 입력/수정
	  * </pre>
	  */
	public OnhireDomesticNewvanScheduleInputDBDAOMergeYearSubleasePlanCSQL(){
		setQuery();
		...
		query.append("FileName : OnhireDomesticNewvanScheduleInputDBDAOMergeYearSubleasePlanCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EQR_SCNR_SLSE I" ).append("\n"); 
