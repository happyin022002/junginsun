...
*@FileName : EES_MNR_0136HTMLAction.java
...
public class EES_MNR_0136HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0136HTMLAction 객체를 생성
	 */
	public EES_MNR_0136HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0136Event event = new EesMnr0136Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTariffApprovalINVO((TariffApprovalINVO)getVO(request, TariffApprovalINVO .class));
		} 
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setArrayCustomTariffApprovalVOs((CustomTariffApprovalVO[])getVOs(request, CustomTariffApprovalVO .class,""));
		}
