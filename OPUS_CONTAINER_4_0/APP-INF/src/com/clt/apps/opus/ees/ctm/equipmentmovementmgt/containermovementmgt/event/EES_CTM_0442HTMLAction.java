...
*@FileName : EES_CTM_0442HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0442HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * EES_CTM_0442HTMLAction 객체를 생성
	 */
	public EES_CTM_0442HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0442Event event = new EesCtm0442Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchEDIByContainerVO((SearchEDIByContainerVO)getVO(request, SearchEDIByContainerVO.class));
			event.setSearchEDIByResultRemarkVO((SearchEDIByResultRemarkVO)getVO(request, SearchEDIByResultRemarkVO.class));
		}
