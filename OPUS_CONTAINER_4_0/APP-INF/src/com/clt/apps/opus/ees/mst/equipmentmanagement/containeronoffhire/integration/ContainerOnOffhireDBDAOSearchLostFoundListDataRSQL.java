...
public class ContainerOnOffhireDBDAOSearchLostFoundListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        ,A.CRNT_YD_CD" ).append("\n"); 
		query.append("        ,A.CNMV_DT" ).append("\n"); 
		query.append("     ,DECODE(@[h_cntr_sts_cd], 'RPC', 'O'" ).append("\n"); 
		...
		query.append("                                    AND   B.CNTR_PRE_STS_CD = A.CNTR_STS_CD),'E')" ).append("\n"); 
		query.append("             ) H_CHK1  " ).append("\n"); 
		query.append("     ,DECODE(@[h_cntr_sts_cd], 'RPC', 'O'" ).append("\n"); 
		query.append("                             , DECODE(@[h_cntr_sts_cd],'LST',DECODE(@[h_onh_yd_cd],A.CRNT_YD_CD,'O','E'),'O')" ).append("\n"); 
		query.append("             ) H_CHK2  " ).append("\n"); 
