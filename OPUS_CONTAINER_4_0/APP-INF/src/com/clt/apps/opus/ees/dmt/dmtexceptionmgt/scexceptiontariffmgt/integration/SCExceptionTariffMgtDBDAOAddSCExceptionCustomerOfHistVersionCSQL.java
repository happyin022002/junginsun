...
*@FileName : SCExceptionTariffMgtDBDAOAddSCExceptionCustomerOfHistVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddSCExceptionCustomerOfHistVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff History 에서 선택한 버전의 모든 S/C Exception Tariff Customer정보를 현재 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddSCExceptionCustomerOfHistVersionCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddSCExceptionCustomerOfHistVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_SC_EXPT_ACT_CUST (" ).append("\n"); 
		query.append("    PROP_NO, SC_EXPT_VER_SEQ, SC_EXPT_GRP_SEQ, CUST_CNT_CD, CUST_SEQ, ACT_CUST_FLG, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT    " ).append("\n"); 
		query.append(")" ).append("\n"); 
