...
*@FileName : RFAExceptionTariffMgtDBDAOAddCommentHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddCommentHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DMT/DET Adjustment Request - Before Booking Request 의 Comment History 입력을 위한 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddCommentHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddCommentHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
