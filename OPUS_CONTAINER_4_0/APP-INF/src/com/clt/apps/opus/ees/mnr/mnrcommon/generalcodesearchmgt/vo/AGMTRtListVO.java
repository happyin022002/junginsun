...
*@FileName : AGMTRtListVO.java
*@FileTitle : AGMTRtListVO
*Open Issues :
*Change history :
...
public class AGMTRtListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AGMTRtListVO> models = new ArrayList<AGMTRtListVO>();
	...
	public AGMTRtListVO(String ibflag, String pagerows, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String costCd, String costDtlCd, String mnrRtTpCd, String rprQty, String agmtRtAmt, String creUsrId, String creDt, String updUsrId, String updDt, String ydCd) {
		this.updDt = updDt;
	 ...
	 * @return AGMTRtListVO[]
	 */
	public AGMTRtListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AGMTRtListVO[]
	 */
	public AGMTRtListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AGMTRtListVO model = null;
	 ...
	 * @return AGMTRtListVO[]
	 */
	public AGMTRtListVO[] getAGMTRtListVOs(){
		AGMTRtListVO[] vos = (AGMTRtListVO[])models.toArray(new AGMTRtListVO[models.size()]);
		return vos;
	}
