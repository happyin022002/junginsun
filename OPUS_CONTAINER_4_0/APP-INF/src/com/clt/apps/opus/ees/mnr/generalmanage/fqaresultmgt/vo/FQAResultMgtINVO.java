...
public class FQAResultMgtINVO extends AbstractValueObject {
	 ...
	 * @return HashMap
	 */
	public FQAResultMgtINVO(String ibflag, String pagerows, String vndrSeq, String ofcCd, String fldAudDt, String ydCd, String keyValue, String fileSeq, String arHdQtrCd) {
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
