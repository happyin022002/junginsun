...
*@FileName : CodSimulateDBDAODuplicateCreateRepoPlanCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodSimulateDBDAODuplicateCreateRepoPlanCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * REPO PLAN ID 등록 여부체크
	  * </pre>
	  */
	public CodSimulateDBDAODuplicateCreateRepoPlanCheckRSQL(){
		setQuery();
		...
		query.append("FileName : CodSimulateDBDAODuplicateCreateRepoPlanCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
