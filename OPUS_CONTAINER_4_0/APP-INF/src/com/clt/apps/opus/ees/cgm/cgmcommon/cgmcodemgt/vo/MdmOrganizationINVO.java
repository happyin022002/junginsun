...
*@FileName : MdmOrganizationINVO.java
*@FileTitle : MdmOrganizationINVO
*Open Issues :
*Change history :
...
public class MdmOrganizationINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MdmOrganizationINVO> models = new ArrayList<MdmOrganizationINVO>();
	...
	public MdmOrganizationINVO() {}

	public MdmOrganizationINVO(String ibflag, String pagerows, String ofcCd, String ofcEngNm, String ofcKndCd, String vndrCntCd, String vndrSeq, String locCd, String arCurrCd, String arOfcCd, String arHdQtrOfcCd, String apOfcCd) {
	 ...
	 * @param request
	 * @return MdmOrganizationINVO[]
	 */
	public MdmOrganizationINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MdmOrganizationINVO[]
	 */
	public MdmOrganizationINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MdmOrganizationINVO model = null;
		...
		return getMdmOrganizationINVOs();
	}
	 ...
	 * @return MdmOrganizationINVO[]
	 */
	public MdmOrganizationINVO[] getMdmOrganizationINVOs(){
		MdmOrganizationINVO[] vos = (MdmOrganizationINVO[])models.toArray(new MdmOrganizationINVO[models.size()]);
		return vos;
	}
