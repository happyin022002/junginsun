...
*@FileName : DmtChgCorrHistVO.java
*@FileTitle : DmtChgCorrHistVO
*Open Issues :
*Change history :
...
public class DmtChgCorrHistVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DmtChgCorrHistVO> models = new ArrayList<DmtChgCorrHistVO>();
	 ...
	 * @param request
	 * @return DmtChgCorrHistVO[]
	 */
	public DmtChgCorrHistVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DmtChgCorrHistVO[]
	 */
	public DmtChgCorrHistVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DmtChgCorrHistVO model = null;
	 ...
	 * @return DmtChgCorrHistVO[]
	 */
	public DmtChgCorrHistVO[] getDmtChgCorrHistVOs(){
		DmtChgCorrHistVO[] vos = (DmtChgCorrHistVO[])models.toArray(new DmtChgCorrHistVO[models.size()]);
		return vos;
	}
