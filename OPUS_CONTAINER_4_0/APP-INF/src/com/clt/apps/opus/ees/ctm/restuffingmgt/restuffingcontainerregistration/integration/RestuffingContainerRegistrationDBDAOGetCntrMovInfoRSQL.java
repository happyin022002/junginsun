...
*@FileName : RestuffingContainerRegistrationDBDAOGetCntrMovInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RestuffingContainerRegistrationDBDAOGetCntrMovInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RestuffingContainerRegistrationDBDAOGetCntrMovInfoRSQL(){
		setQuery();
		...
		query.append("FileName : RestuffingContainerRegistrationDBDAOGetCntrMovInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
