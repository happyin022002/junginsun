...
*@FileName : EES_DMT_3102HTMLAction.java
...
public class EES_DMT_3102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_3102HTMLAction 객체를 생성
	 */
	public EES_DMT_3102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt3102Event event = new EesDmt3102Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setChargeArgumentVO((ChargeArgumentVO)getVO(request, ChargeArgumentVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {		// BackEndJob Result Return
			event.setChargeArgumentVO((ChargeArgumentVO)getVO(request, ChargeArgumentVO .class));
			//event.setChargeCalculationContainerVOS((ChargeCalculationContainerVO[])getVOs(request, ChargeCalculationContainerVO .class, ""));
		}
