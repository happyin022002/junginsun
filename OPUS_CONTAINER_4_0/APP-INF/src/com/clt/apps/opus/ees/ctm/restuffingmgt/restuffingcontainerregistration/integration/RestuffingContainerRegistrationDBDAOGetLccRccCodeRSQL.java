...
*@FileName : RestuffingContainerRegistrationDBDAOGetLccRccCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RestuffingContainerRegistrationDBDAOGetLccRccCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RestuffingContainerRegistrationDBDAOGetLccRccCodeRSQL(){
		setQuery();
		...
		query.append("FileName : RestuffingContainerRegistrationDBDAOGetLccRccCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
