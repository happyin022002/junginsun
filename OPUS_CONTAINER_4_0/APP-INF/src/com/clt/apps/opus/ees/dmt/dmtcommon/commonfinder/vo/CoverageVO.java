...
public class CoverageVO extends AbstractValueObject {
	...
	public static final String CVRG_LOCATION = "LOC";
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDulExptEffDt(JSPUtil.getParameter(request, prefix + "dul_expt_eff_dt", ""));
		setDulExptExpDt(JSPUtil.getParameter(request, prefix + "dul_expt_exp_dt", ""));
