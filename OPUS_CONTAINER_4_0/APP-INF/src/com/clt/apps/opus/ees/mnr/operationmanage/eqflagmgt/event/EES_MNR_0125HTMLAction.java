...
*@FileName : EES_MNR_0125HTMLAction.java
*@FileTitle : Container Damage Histroy
*Open Issues :
*Change history : 
...
public class EES_MNR_0125HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0125HTMLAction 객체를 생성
	 */
	public EES_MNR_0125HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0125Event event = new EesMnr0125Event();     
