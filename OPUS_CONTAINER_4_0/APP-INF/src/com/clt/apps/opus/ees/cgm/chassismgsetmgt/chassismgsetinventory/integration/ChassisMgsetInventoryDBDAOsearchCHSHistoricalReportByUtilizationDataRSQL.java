...
*@FileName : ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByUtilizationDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByUtilizationDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByUtilizationDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByUtilizationDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", ROUND(Y.CHSS_20FT_QTY / X.CHSS_20FT_QTY  *100,2) AS CHSS_20FT_QTY" ).append("\n"); 
		query.append(", ROUND(Y.CHSS_40FT_QTY / X.CHSS_40FT_QTY  *100,2) AS CHSS_40FT_QTY" ).append("\n"); 
		query.append(", ROUND(Y.CHSS_45FT_QTY / X.CHSS_45FT_QTY  *100,2) AS CHSS_45FT_QTY" ).append("\n"); 
