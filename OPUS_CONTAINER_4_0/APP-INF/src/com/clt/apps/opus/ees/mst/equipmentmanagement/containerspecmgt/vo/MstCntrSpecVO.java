...
public class MstCntrSpecVO extends AbstractValueObject {
	...
	/*	Column Info	*/
	private  String	 specYrMod   =  null;
	/*	Column Info	*/
	private  String	 hisCntrSpecNo   =  null;
	/*	Column Info	*/
	...
	public MstCntrSpecVO(String ibflag, String pagerows, String cntrSpecNo, String lstmCd, String fctrySpecNo, String lotNo, String cntrTpszCd, String vndrAbbrNm, String cntrMtrlCd, String serRange, String ownCntrFlg, String fromSpecYr, String toSpecYr, String agmtNo, String specYr, String lodCapa, String cntrGrsWgt, String tareWgt, String interLen, String interWdt, String interHgt, String xterLen, String xterWdt, String xterHgt, String opnDorWdt, String opnDorHgt, String rcLdbCapa, String rcLdbHgt, String tnkCapa, String diffRmk, String creUsrId, String creDt, String updUsrId, String updDt, String frackClpsCtnt, String frackBedTikCtnt, String opntpRoofOpnCtnt, String opntpIntrHgtCtnt, String opntpRearHdrOpnCtnt,String mftVndrSeq,String specYrMod,String hisCntrSpecNo,String vndrSeq) {
		...
		this.specYrMod  = specYrMod ;
		this.hisCntrSpecNo  = hisCntrSpecNo ;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("spec_yr_mod", getSpecYrMod());		
		this.hashColumns.put("his_cntr_spec_no", getHisCntrSpecNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("spec_yr_mod", "specYrMod");
		this.hashFields.put("his_cntr_spec_no", "hisCntrSpecNo");
	...
	* @param  specYrMod
	*/
	public void	setSpecYrMod( String	specYrMod ) {
		this.specYrMod =	specYrMod;
	}
	 ...
	 * @return	specYrMod
	 */
	 public	 String	getSpecYrMod() {
		 return	this.specYrMod;
	 } 
	...
	* @param  hisCntrSpecNo
	*/
	public void	setHisCntrSpecNo( String	hisCntrSpecNo ) {
		this.hisCntrSpecNo =	hisCntrSpecNo;
	}
 
	/**
	 * Column Info
	 * @return	hisCntrSpecNo
	 */
	 public	 String	getHisCntrSpecNo() {
		 return	this.hisCntrSpecNo;
	 } 
	...
	*/
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFrackClpsCtnt(JSPUtil.getParameter(request, "frack_clps_ctnt", ""));		
		setFrackBedTikCtnt(JSPUtil.getParameter(request, "frack_bed_tik_ctnt", ""));		
		setOpntpRoofOpnCtnt(JSPUtil.getParameter(request, "opntp_roof_opn_ctnt", ""));		
		setOpntpIntrHgtCtnt(JSPUtil.getParameter(request, "opntp_intr_hgt_ctnt", ""));		
		setOpntpRearHdrOpnCtnt(JSPUtil.getParameter(request, "opntp_rear_hdr_opn_ctnt", ""));	
		setMftVndrSeq(JSPUtil.getParameter(request,	"mft_vndr_seq", ""));
		setSpecYrMod(JSPUtil.getParameter(request,	"spec_yr_mod", ""));
		setHisCntrSpecNo(JSPUtil.getParameter(request,	"his_cntr_spec_no", ""));
	...
	public MstCntrSpecVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] frackClpsCtnt = (JSPUtil.getParameter(request, prefix	+ "frack_clps_ctnt", length));
			String[] frackBedTikCtnt = (JSPUtil.getParameter(request, prefix	+ "frack_bed_tik_ctnt", length));
			String[] opntpRoofOpnCtnt = (JSPUtil.getParameter(request, prefix	+ "opntp_roof_opn_ctnt", length));
			String[] opntpIntrHgtCtnt = (JSPUtil.getParameter(request, prefix	+ "opntp_intr_hgt_ctnt", length));
			String[] opntpRearHdrOpnCtnt = (JSPUtil.getParameter(request, prefix	+ "opntp_rear_hdr_opn_ctnt", length));
			String[] mftVndrSeq =	(JSPUtil.getParameter(request, prefix +	"mft_vndr_seq".trim(),	length));
			String[] specYrMod =	(JSPUtil.getParameter(request, prefix +	"spec_yr_mod".trim(),	length));
			String[] hisCntrSpecNo =	(JSPUtil.getParameter(request, prefix +	"his_cntr_spec_no".trim(),	length));
			...
			for (int i = 0; i < length; i++) {
				...
				if ( specYrMod[i] !=	null)
					model.setSpecYrMod( specYrMod[i]);
				if ( hisCntrSpecNo[i] !=	null)
					model.setHisCntrSpecNo( hisCntrSpecNo[i]);
				if ( vndrSeq[i] !=	null)
	...
	*/
	public void unDataFormat(){
		...
		this.specYrMod =	this.specYrMod.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.hisCntrSpecNo =	this.hisCntrSpecNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
