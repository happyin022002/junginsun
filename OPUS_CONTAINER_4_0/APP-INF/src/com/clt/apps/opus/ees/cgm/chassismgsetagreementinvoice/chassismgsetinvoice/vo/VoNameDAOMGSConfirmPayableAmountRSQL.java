...
*@FileName : VoNameDAOMGSConfirmPayableAmountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VoNameDAOMGSConfirmPayableAmountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MGSConfirmPayableAmount
	  * </pre>
	  */
	public VoNameDAOMGSConfirmPayableAmountRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.vo").append("\n"); 
		query.append("FileName : VoNameDAOMGSConfirmPayableAmountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
