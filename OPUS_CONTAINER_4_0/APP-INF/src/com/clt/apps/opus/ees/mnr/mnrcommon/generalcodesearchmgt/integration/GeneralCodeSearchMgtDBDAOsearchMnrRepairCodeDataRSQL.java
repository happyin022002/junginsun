...
public class GeneralCodeSearchMgtDBDAOsearchMnrRepairCodeDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("A.CD_ID" ).append("\n"); 
		query.append(",A.CD_DESC" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("MCR.TO_RLT_CD AS CD_ID" ).append("\n"); 
		query.append(",MCOD.EQ_CEDEX_OTR_CD_NM  AS CD_DESC" ).append("\n"); 
		query.append("FROM MNR_CD_RLT MCR,MNR_CEDEX_OTR_CD MCOD" ).append("\n"); 
		query.append("WHERE MCR.EQ_CEDEX_RLT_TP_CD = 'CTR'" ).append("\n"); 
