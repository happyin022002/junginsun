...
public class SearchBeforeCntrInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBeforeCntrInfoVO> models = new ArrayList<SearchBeforeCntrInfoVO>();
	 ...
	 */
	public SearchBeforeCntrInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchExecutionPlanCntrListVO[]
	 */
	public SearchBeforeCntrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBeforeCntrInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBeforeCntrInfoVO();
	 ...
	 * @return SearchExecutionPlanCntrListVO[]
	 */
	public SearchBeforeCntrInfoVO[] getSearchExecutionPlanCntrListVOs(){
		SearchBeforeCntrInfoVO[] vos = (SearchBeforeCntrInfoVO[])models.toArray(new SearchBeforeCntrInfoVO[models.size()]);
		return vos;
	}
