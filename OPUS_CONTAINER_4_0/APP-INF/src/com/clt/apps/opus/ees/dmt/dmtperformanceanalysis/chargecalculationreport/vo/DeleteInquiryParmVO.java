...
public class DeleteInquiryParmVO extends AbstractValueObject {
	...
	public DeleteInquiryParmVO(String ibflag, String pagerows, String dtFlg, String fmDt, String toDt, String ofcFlg, String ofcCd, String grpFlg, String delCd, String ofcCdDeltRsnCdList) {
		this.ofcFlg = ofcFlg;
		this.toDt = toDt;
		this.dtFlg = dtFlg;
		this.ofcCd = ofcCd;
