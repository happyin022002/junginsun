...
*@FileName : ChassisMgsetInventoryDBDAOsearchMGSInventoryByLessorTermListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInventoryDBDAOsearchMGSInventoryByLessorTermListDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * chungpa 20090911 2078 list
	  * </pre>
	  */
	public ChassisMgsetInventoryDBDAOsearchMGSInventoryByLessorTermListDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInventoryDBDAOsearchMGSInventoryByLessorTermListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    AND (D.DELT_FLG = 'N' OR D.DELT_FLG IS NULL)" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${s2_eq_tpsz_cd} != 'TOTAL')" ).append("\n"); 
