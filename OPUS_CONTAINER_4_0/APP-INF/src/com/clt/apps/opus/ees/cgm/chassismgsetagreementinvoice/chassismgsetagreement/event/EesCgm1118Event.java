...
public class EesCgm1118Event extends EventSupport {
	...
	public CHSTermChangeResultINVO[] getChsTermChangeResultINVOS() {
		CHSTermChangeResultINVO[] rtnVOs = null;
		if (this.chsTermChangeResultINVOS != null) {
			rtnVOs = java.util.Arrays.copyOf(chsTermChangeResultINVOS, chsTermChangeResultINVOS.length);
		}
		return rtnVOs;
	}

	public void setChsTermChangeResultINVOS(CHSTermChangeResultINVO[] chsTermChangeResultINVOS){
		if(chsTermChangeResultINVOS != null){
			CHSTermChangeResultINVO[] tmpVOs = java.util.Arrays.copyOf(chsTermChangeResultINVOS, chsTermChangeResultINVOS.length);
			this.chsTermChangeResultINVOS = tmpVOs;
		}
	}
}