...
*@FileName : CustomMnrOrdHdrVO.java
*@FileTitle : CustomMnrOrdHdrVO
*Open Issues :
*Change history :
...
public class CustomMnrOrdHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<CustomMnrOrdHdrVO> models = new ArrayList<CustomMnrOrdHdrVO>();
	...
	public CustomMnrOrdHdrVO() {}

	public CustomMnrOrdHdrVO(String ibflag, String pagerows, String vslCd, String currCd, String mnrGrpTpCd, String creDt, String mnrWoTpCd, String sprPrtBrthDt, String mnrOrdOfcCtyCd, String sprPrtSplDt, String costCd, String mnrAgmtAmt, String mnrWrkAmt, String invAmt, String updUsrId, String updDt, String costOfcCd, String agmtSeq, String sprPrtSplTpCd, String skdVoyNo, String eqKndCd, String trsmModCd, String skdDirCd, String ordHdrRmk, String sprPrtSplYdCd, String creUsrId, String mnrInpDt, String mnrOrdSeq, String agmtOfcCtyCd, String vndrSeq, String mnrOrdSndDt, String ordIssOfcCd, String fileSeq, String agmtVerNo, String ifTrcSeq, String agmtNo) {
		this.vslCd = vslCd;
		this.currCd = currCd;
	 ...
	 */
	public CustomMnrOrdHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomMnrOrdHdrVO[]
	 */
	public CustomMnrOrdHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMnrOrdHdrVO model = null;
	 ...
	 * @return CustomMnrOrdHdrVO[]
	 */
	public CustomMnrOrdHdrVO[] getCustomMnrOrdHdrVOs(){
		CustomMnrOrdHdrVO[] vos = (CustomMnrOrdHdrVO[])models.toArray(new CustomMnrOrdHdrVO[models.size()]);
		return vos;
	}
