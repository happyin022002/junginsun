...
*@FileName : ChassisMgsetOnOffhireDBDAOaddMGSFoundHistoryDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOaddMGSFoundHistoryDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOaddMGSFoundHistoryDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOaddMGSFoundHistoryDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",TO_DATE(@[f_evnt_dt],'YYYY-MM-DD')" ).append("\n"); 
