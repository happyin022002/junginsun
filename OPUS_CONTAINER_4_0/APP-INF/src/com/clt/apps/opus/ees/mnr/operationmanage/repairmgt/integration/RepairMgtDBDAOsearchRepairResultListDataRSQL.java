...
public class RepairMgtDBDAOsearchRepairResultListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND B.CRE_DT BETWEEN  GLOBALDATE_PKG.TIME_CONV_OFC_FNC(@[cost_ofc_cd], TO_DATE(@[fromcal], 'YYYY-MM-DD'),MNR_COMMON_PKG.MNR_GET_HOOFC_FNC()) AND GLOBALDATE_PKG.TIME_CONV_OFC_FNC(@[cost_ofc_cd], TO_DATE(@[tocal] || ' 23:59:59', 'YYYY-MM-DD HH24:MI:SS'),MNR_COMMON_PKG.MNR_GET_HOOFC_FNC())" ).append("\n"); 
