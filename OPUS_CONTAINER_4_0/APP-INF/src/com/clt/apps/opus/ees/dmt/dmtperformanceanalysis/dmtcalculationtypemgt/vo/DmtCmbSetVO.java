...
*@FileName : DmtCmbSetVO.java
*@FileTitle : DmtCmbSetVO
*Open Issues :
*Change history :
...
public class DmtCmbSetVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DmtCmbSetVO> models = new ArrayList<DmtCmbSetVO>();
	...
	public DmtCmbSetVO(String ibflag, String pagerows, String dmdtCntrTpCd, String dmdtCgoTpCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return DmtCmbSetVO[]
	 */
	public DmtCmbSetVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DmtCmbSetVO[]
	 */
	public DmtCmbSetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DmtCmbSetVO model = null;
	...
	public DmtCmbSetVO[] getDmtCmbSetVOs(){
		DmtCmbSetVO[] vos = (DmtCmbSetVO[])models.toArray(new DmtCmbSetVO[models.size()]);
		return vos;
	}
