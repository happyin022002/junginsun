...
*@FileName : EES_CGM_1089HTMLAction.java
...
public class EES_CGM_1089HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1089HTMLAction 객체를 생성
	 */
	public EES_CGM_1089HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1089Event event = new EesCgm1089Event();
		
		CHSInventoryGeneralINVO chsInventoryGeneralINVO = new CHSInventoryGeneralINVO();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			chsInventoryGeneralINVO = (CHSInventoryGeneralINVO)getVO(request, CHSInventoryGeneralINVO .class);
			
			event.setChsInventoryGeneralINVO(chsInventoryGeneralINVO);
		}
