...
*@FileName : EES_CIM_1018HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class EES_CIM_1018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_CIM_1018HTMLAction 객체를 생성
	 */
	public EES_CIM_1018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim1018Event event = new EesCim1018Event();
		...
		event.setAttribute("MBSearchOptionInGereralVO"         , event.getMBSearchOptionInGereralVO() );
