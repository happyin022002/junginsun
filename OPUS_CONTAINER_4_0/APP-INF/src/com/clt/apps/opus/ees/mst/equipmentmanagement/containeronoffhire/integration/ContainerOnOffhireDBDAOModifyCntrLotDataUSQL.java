...
*@FileName : ContainerOnOffhireDBDAOModifyCntrLotDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerOnOffhireDBDAOModifyCntrLotDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Container Master Update시 Lot Update 처리
	  * </pre>
	  */
	public ContainerOnOffhireDBDAOModifyCntrLotDataUSQL(){
		setQuery();
		...
		params.put("lot_cntr_tpsz_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ContainerOnOffhireDBDAOModifyCntrLotDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   CNTR_TPSZ_CD	= @[lot_cntr_tpsz_cd] " ).append("\n"); 
