...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteCntrRepoExePlanDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteCntrRepoExePlanDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * REPO PLAN EXE DELETE
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteCntrRepoExePlanDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteCntrRepoExePlanDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    EQR_REPO_EXE_PLN " ).append("\n"); 
