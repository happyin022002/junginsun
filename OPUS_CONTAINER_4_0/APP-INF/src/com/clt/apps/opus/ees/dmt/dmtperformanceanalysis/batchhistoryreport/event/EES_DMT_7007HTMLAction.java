...
*@FileName : EES_DMT_7007HTMLAction.java
...
public class EES_DMT_7007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_7007HTMLAction 객체를 생성
	 */
	public EES_DMT_7007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt7007Event event = new EesDmt7007Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBatHistParmVO((BatHistParmVO)getVO(request, BatHistParmVO .class));
		}
