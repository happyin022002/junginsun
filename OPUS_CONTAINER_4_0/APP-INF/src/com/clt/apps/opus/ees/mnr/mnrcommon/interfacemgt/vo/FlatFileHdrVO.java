...
public class FlatFileHdrVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("com_ofc_cd", getcomOfcCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("com_ofc_cd", "comOfcCd");
	 ...
	 * @return comOfcCd
	 */
	public String getcomOfcCd() {
		return this.comOfcCd;
	}
	 ...
	 * @param comOfcCd
	 */
	public void setcomOfcCd(String comOfcCd) {
		this.comOfcCd = comOfcCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setcomOfcCd(JSPUtil.getParameter(request, "com_ofc_cd", ""));
	...
	public FlatFileHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] comOfcCd = (JSPUtil.getParameter(request, prefix	+ "com_ofc_cd", length));
	...
	*/
	public void unDataFormat(){
		...
		this.comOfcCd = this.comOfcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
