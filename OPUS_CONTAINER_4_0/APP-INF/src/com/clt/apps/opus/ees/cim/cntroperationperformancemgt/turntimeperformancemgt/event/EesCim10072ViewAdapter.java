 ...
 * @since J2EE 1.5   
 */
public class EesCim10072ViewAdapter extends ViewAdapter {
		private static String  tTime = "T/Time";
		/**
...
//	        String[] realColNms=getColHeader(vo);
	        ...
	        for(int i=0;i<realCnt;i++){
	            ...
	            if( i > 0 ){
	                ...
	                // Turn Time 일때는 Row 색 변경
	                if(tTime.equals(JSPUtil.getNull(colValues.get("etc")))){
