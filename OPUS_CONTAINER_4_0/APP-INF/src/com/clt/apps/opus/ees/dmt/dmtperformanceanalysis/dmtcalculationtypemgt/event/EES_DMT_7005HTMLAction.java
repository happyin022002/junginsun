...
*@FileName : EES_DMT_7005HTMLAction.java
...
public class EES_DMT_7005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_7005HTMLAction 객체를 생성
	 */
	public EES_DMT_7005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt7005Event event = new EesDmt7005Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setDmtOfcUsrTrfOptVO((DmtOfcUsrTrfOptVO)getVO(request, DmtOfcUsrTrfOptVO.class));
		}
