...
*@FileName : MGSLessorAgmtMatchingINVO.java
*@FileTitle : MGSLessorAgmtMatchingINVO
*Open Issues :
*Change history :
...
public class MGSLessorAgmtMatchingINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSLessorAgmtMatchingINVO> models = new ArrayList<MGSLessorAgmtMatchingINVO>();
	...
	public MGSLessorAgmtMatchingINVO() {}

	public MGSLessorAgmtMatchingINVO(String delChk, String ibflag, String pagerows, String eqKndCd, String agmtNo, String vndrSeq, String invRefNo, String agmtSeq, String agmtOfcCtyCd, String vndrLglEngNm, String creUsrId, String updUsrId) {
		this.delChk = delChk;
	 ...
	 */
	public MGSLessorAgmtMatchingINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSLessorAgmtMatchingINVO[]
	 */
	public MGSLessorAgmtMatchingINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSLessorAgmtMatchingINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSLessorAgmtMatchingINVO();
				if (delChk[i] != null)
		...
		return getMGSLessorAgmtMatchingINVOs();
	}
	...
	public MGSLessorAgmtMatchingINVO[] getMGSLessorAgmtMatchingINVOs(){
		MGSLessorAgmtMatchingINVO[] vos = (MGSLessorAgmtMatchingINVO[])models.toArray(new MGSLessorAgmtMatchingINVO[models.size()]);
		return vos;
	}
