...
public class CgmCurrencyEvent extends EventSupport {
	...
	public MdmCurrencyMGTVO[] getMdmCurrencyMGTVOs() {
		MdmCurrencyMGTVO[] rtnVOs = null;
		if (this.mdmCurrencyMGTVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(mdmCurrencyMGTVOs, mdmCurrencyMGTVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setMdmCurrencyMGTVOs(MdmCurrencyMGTVO[] mdmCurrencyMGTVOs){
		if(mdmCurrencyMGTVOs != null){
			MdmCurrencyMGTVO[] tmpVOs = java.util.Arrays.copyOf(mdmCurrencyMGTVOs, mdmCurrencyMGTVOs.length);
			this.mdmCurrencyMGTVOs = tmpVOs;
		}
	}
