...
*@FileName : EES_CGM_2023HTMLAction.java
...
public class EES_CGM_2023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2023HTMLAction 객체를 생성
	 */
	public EES_CGM_2023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2023Event event = new EesCgm2023Event();
		
		MGSAgreementListINVO mgsAgreementListINVO = null;

		if(command.isCommand(FormCommand.SEARCH)) {
			
			mgsAgreementListINVO = (MGSAgreementListINVO)getVO(request, MGSAgreementListINVO .class);
			
			mgsAgreementListINVO.setAgmtDtFr(mgsAgreementListINVO.getAgmtDtFr().replaceAll("-", ""));
			mgsAgreementListINVO.setAgmtDtTo(mgsAgreementListINVO.getAgmtDtTo().replaceAll("-", ""));
			
			event.setMgsAgreementListINVO(mgsAgreementListINVO);
		}
