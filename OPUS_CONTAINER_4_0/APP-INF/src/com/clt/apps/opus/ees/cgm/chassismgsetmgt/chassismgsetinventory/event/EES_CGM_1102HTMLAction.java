...
*@FileName : EES_CGM_1102HTMLAction.java
...
public class EES_CGM_1102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1102HTMLAction 객체를 생성
	 */
	public EES_CGM_1102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1102Event event = new EesCgm1102Event();
		
		
		CHSInventoryByVariationINVO cHSInventoryByVariationINVO = new CHSInventoryByVariationINVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			cHSInventoryByVariationINVO = (CHSInventoryByVariationINVO)getVO(request, CHSInventoryByVariationINVO .class);
			event.setCHSInventoryByVariationINVO(cHSInventoryByVariationINVO);
