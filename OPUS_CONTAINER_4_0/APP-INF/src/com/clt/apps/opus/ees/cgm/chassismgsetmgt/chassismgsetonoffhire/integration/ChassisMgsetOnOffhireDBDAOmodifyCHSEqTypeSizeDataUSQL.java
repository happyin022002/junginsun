...
*@FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSEqTypeSizeDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOmodifyCHSEqTypeSizeDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOmodifyCHSEqTypeSizeDataUSQL(){
		setQuery();
		...
		params.put("modi_eq_tpsz_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSEqTypeSizeDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       MODI_EQ_TPSZ_CD = @[modi_eq_tpsz_cd]" ).append("\n"); 
