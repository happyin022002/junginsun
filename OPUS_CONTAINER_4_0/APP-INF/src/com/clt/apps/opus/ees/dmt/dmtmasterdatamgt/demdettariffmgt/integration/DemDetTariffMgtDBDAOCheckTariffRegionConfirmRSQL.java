...
*@FileName : DemDetTariffMgtDBDAOCheckTariffRegionConfirmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOCheckTariffRegionConfirmRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Select Tariff Region Confirm Value
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOCheckTariffRegionConfirmRSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOCheckTariffRegionConfirmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
