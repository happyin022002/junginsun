...
public class EesCtm0461Event extends EventSupport {
	...
	public void setUsLmsLocationListVOS(UsAmsLocationListVO[] usLmsLocationListVOs){
		if (usLmsLocationListVOs != null) {
			UsAmsLocationListVO[] tmpVOs = new UsAmsLocationListVO[usLmsLocationListVOs.length];
			System.arraycopy(usLmsLocationListVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.usLmsLocationListVOs = tmpVOs;
		}
	}
	...
	public UsAmsLocationListVO[] getUsLmsLocationListVOS(){
		UsAmsLocationListVO[] tmpVOs = null;
		if (this.usLmsLocationListVOs != null) {
			tmpVOs = new UsAmsLocationListVO[usLmsLocationListVOs.length];
			System.arraycopy(usLmsLocationListVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
