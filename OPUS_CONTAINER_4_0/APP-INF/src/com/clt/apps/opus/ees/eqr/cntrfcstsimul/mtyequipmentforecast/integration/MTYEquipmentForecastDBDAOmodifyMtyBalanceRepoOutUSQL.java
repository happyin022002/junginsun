...
*@FileName : MTYEquipmentForecastDBDAOmodifyMtyBalanceRepoOutUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYEquipmentForecastDBDAOmodifyMtyBalanceRepoOutUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_CTRL_BAL_RPT_REPO_OUT 테이블 정보 수정
	  * </pre>
	  */
	public MTYEquipmentForecastDBDAOmodifyMtyBalanceRepoOutUSQL(){
		setQuery();
		...
		query.append("FileName : MTYEquipmentForecastDBDAOmodifyMtyBalanceRepoOutUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EQR_CTRL_BAL_RPT_REPO_OUT        " ).append("\n"); 
		query.append("   SET D2_FCAST_QTY   = @[d2_fcast_qty]" ).append("\n"); 
		...
		query.append("      ,REPO_OUT_RMK   = @[repo_out_rmk]  " ).append("\n"); 
