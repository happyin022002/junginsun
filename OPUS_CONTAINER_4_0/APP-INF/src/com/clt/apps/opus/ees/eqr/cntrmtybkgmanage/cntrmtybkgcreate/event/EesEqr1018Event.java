...
public class EesEqr1018Event extends EventSupport {
	...
	public EqrCtrlMtyBkgExeVO[] getEqrCtrlMtyBkgExeVOs() {
		EqrCtrlMtyBkgExeVO[] tmpVOs = null;
		if (this.eqrCtrlMtyBkgExeVOs != null) {
			tmpVOs = new EqrCtrlMtyBkgExeVO[eqrCtrlMtyBkgExeVOs.length];
			System.arraycopy(eqrCtrlMtyBkgExeVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}

	public void setEqrCtrlMtyBkgExeVOs(EqrCtrlMtyBkgExeVO[] eqrCtrlMtyBkgExeVOs) {
		if (eqrCtrlMtyBkgExeVOs != null) {
			EqrCtrlMtyBkgExeVO[] tmpVOs = new EqrCtrlMtyBkgExeVO[eqrCtrlMtyBkgExeVOs.length];
			System.arraycopy(eqrCtrlMtyBkgExeVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.eqrCtrlMtyBkgExeVOs = tmpVOs;
		}
	}
	...
	public EesEqr1018MultiVO[] getEesEqr1018MultiVOs() {
		EesEqr1018MultiVO[] tmpVOs = null;
		if (this.eesEqr1018MultiVOs != null) {
			tmpVOs = new EesEqr1018MultiVO[eesEqr1018MultiVOs.length];
			System.arraycopy(eesEqr1018MultiVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}

	public void setEesEqr1018MultiVOs(EesEqr1018MultiVO[] eesEqr1018MultiVOs) {
		if (eesEqr1018MultiVOs != null) {
			EesEqr1018MultiVO[] tmpVOs = new EesEqr1018MultiVO[eesEqr1018MultiVOs.length];
			System.arraycopy(eesEqr1018MultiVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.eesEqr1018MultiVOs = tmpVOs;
		}
	}
