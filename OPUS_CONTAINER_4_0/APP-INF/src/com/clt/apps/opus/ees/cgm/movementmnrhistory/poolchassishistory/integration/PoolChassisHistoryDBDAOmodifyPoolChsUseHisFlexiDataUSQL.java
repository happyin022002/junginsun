...
*@FileName : PoolChassisHistoryDBDAOmodifyPoolChsUseHisFlexiDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PoolChassisHistoryDBDAOmodifyPoolChsUseHisFlexiDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PoolChassisHistoryDBDAOmodifyPoolChsUseHisFlexiDataUSQL(){
		setQuery();
		...
		query.append("FileName : PoolChassisHistoryDBDAOmodifyPoolChsUseHisFlexiDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET OFFH_DT             =   to_date(@[offh_dt],'yyyy-mm-dd HH24:MI:SS')" ).append("\n"); 
		query.append(",POOL_CHSS_USD_DYS   =   @[pool_chss_usd_dys]" ).append("\n"); 
		query.append(",CHSS_OWNR_CO_CD     =  CASE WHEN EXISTS (SELECT 'X' FROM CGM_EQ_STS_HIS H" ).append("\n"); 
