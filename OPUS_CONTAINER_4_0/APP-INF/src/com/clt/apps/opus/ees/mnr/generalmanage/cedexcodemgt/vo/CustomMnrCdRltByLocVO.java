...
public class CustomMnrCdRltByLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomMnrCdRltByLocVO> models = new ArrayList<CustomMnrCdRltByLocVO>();
	...
	public CustomMnrCdRltByLocVO() {}

	/**
	 * CustomMnrCdRltByLocVO 객체 생성
	 */
	public CustomMnrCdRltByLocVO(String ibflag, String pagerows, String g, String code, String description, String eqCedexRltTpCd, String fmRltCd, String toRltCd, String creUsrId, String creDt, String updUsrId, String updDt, String eqCmpoCd) {
		this.ibflag = ibflag;
	 ...
	 * @return	CustomMnrCdRltByLocVO[]   VO배열로    
	 */
	public CustomMnrCdRltByLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return	CustomMnrCdRltByLocVO[]   VO배열로    
	 */
	public CustomMnrCdRltByLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMnrCdRltByLocVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CustomMnrCdRltByLocVO();
				if (ibflag[i] != null)
	 ...
	 * @return	CustomMnrCdRltByLocVO[]   VO배열로    
	 */
	public CustomMnrCdRltByLocVO[] getsearchCodeRelationByDamageDataVOs(){
		CustomMnrCdRltByLocVO[] vos = (CustomMnrCdRltByLocVO[])models.toArray(new CustomMnrCdRltByLocVO[models.size()]);
		return vos;
	}
