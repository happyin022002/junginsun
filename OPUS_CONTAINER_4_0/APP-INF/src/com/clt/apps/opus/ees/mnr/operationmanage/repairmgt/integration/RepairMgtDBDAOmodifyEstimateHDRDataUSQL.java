...
public class RepairMgtDBDAOmodifyEstimateHDRDataUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     SET A.RQST_EQ_NO = @[rqst_eq_no]" ).append("\n"); 
		query.append("        ,A.RPR_RQST_SEQ = @[rpr_rqst_seq]" ).append("\n"); 
		query.append("        ,A.RPR_RQST_VER_NO = @[rpr_rqst_ver_no]" ).append("\n"); 
		query.append("        ,A.RPR_RQST_LST_VER_FLG = @[rpr_rqst_lst_ver_flg]" ).append("\n"); 
		...
		query.append("		,A.MVMT_GATE_IN_DT = TO_DATE(@[mvmt_dt], 'yyyy-mm-dd')" ).append("\n"); 
