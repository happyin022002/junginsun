...
*@FileName : EES_MNR_0213HTMLAction.java
...
public class EES_MNR_0213HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0213HTMLAction 객체를 생성
	 */
	public EES_MNR_0213HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0213Event event = new EesMnr0213Event();
		//조회  
		if(command.isCommand(FormCommand.SEARCH)) { 
			event.setWarrantyAlertInfoINVO((WarrantyAlertInfoINVO)getVO(request, WarrantyAlertInfoINVO .class));
		}		 
		//저장
