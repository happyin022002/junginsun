...
*@FileName : ChassisMgsetInvoiceDBDAOModifyMGSInvoiceDeleteHdrDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOModifyMGSInvoiceDeleteHdrDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.ModifyMGSInvoiceDeleteHdrData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOModifyMGSInvoiceDeleteHdrDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOModifyMGSInvoiceDeleteHdrDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("LSE_CHG_STS_CD = 'S'," ).append("\n"); 
