...
*@FileName : GeneralCodeSearchMgtDBDAOsearchCostShpSrchPattDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralCodeSearchMgtDBDAOsearchCostShpSrchPattDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralCodeSearchMgtDBDAOsearchCostShpSrchPattDataRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralCodeSearchMgtDBDAOsearchCostShpSrchPattDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COST_SHP_SRCH_PATT_NM" ).append("\n"); 
