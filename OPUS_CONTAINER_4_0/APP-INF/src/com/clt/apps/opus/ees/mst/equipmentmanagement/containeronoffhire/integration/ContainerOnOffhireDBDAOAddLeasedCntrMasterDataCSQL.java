...
public class ContainerOnOffhireDBDAOAddLeasedCntrMasterDataCSQL implements ISQLTemplate{
	...
	public ContainerOnOffhireDBDAOAddLeasedCntrMasterDataCSQL(){
		...
		params.put("lot_pln_yn",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("#if (${rf_humid_ctrl_val_cd} != '')" ).append("\n"); 
		query.append(",   RF_HUMID_CTRL_VAL_CD " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${rf_cmpr_ctnt} != '')" ).append("\n"); 
		query.append(",   RF_CMPR_CTNT " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${lot_seq} != '')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${lot_seq} != '')" ).append("\n"); 
		query.append(",   @[lot_pln_yn] " ).append("\n"); 
		query.append(",   @[lot_loc_cd]" ).append("\n"); 
		query.append(",   @[lot_seq] " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
