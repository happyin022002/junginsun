 ...
 *@FileName : CHSAgreementListINVO.java
 *@FileTitle : CHSAgreementListINVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class CHSAgreementListINVO	extends	 AbstractValueObject
{

	private	 static final long serialVersionUID = 1L;

	private	 Collection<CHSAgreementListINVO>  models =	new	ArrayList<CHSAgreementListINVO>();
 ...
 //	Getters	and	Setters
	...
	*/
	 ...
	 */
	public CHSAgreementListINVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return CHSAgreementListINVO[]
	 */
	public CHSAgreementListINVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		CHSAgreementListINVO model = null;
		...
		try	{
				...
				for	(int i = 0;	i <	length;	i++) {
					model =	new	CHSAgreementListINVO();
						if ( lstVerFlg[i] !=	null)
		...
		return getCHSAgreementListINVOs();
	}
	...
	public CHSAgreementListINVO[]	 getCHSAgreementListINVOs(){
		CHSAgreementListINVO[] vos = (CHSAgreementListINVO[])models.toArray(new	CHSAgreementListINVO[models.size()]);
		return vos;
		}
