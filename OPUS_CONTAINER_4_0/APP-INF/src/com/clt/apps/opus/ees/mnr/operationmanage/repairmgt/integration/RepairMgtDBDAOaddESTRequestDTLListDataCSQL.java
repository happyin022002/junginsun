...
*@FileName : RepairMgtDBDAOaddESTRequestDTLListDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOaddESTRequestDTLListDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addESTRequestDTLListData
	  * </pre>
	  */
	public RepairMgtDBDAOaddESTRequestDTLListDataCSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOaddESTRequestDTLListDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("MRD.RQST_EQ_NO" ).append("\n"); 
		query.append(",MRD.RPR_RQST_SEQ" ).append("\n"); 
		query.append(",(MRD.RPR_RQST_VER_NO + 1)" ).append("\n"); 
		...
		query.append("MRD.RQST_EQ_NO = @[rqst_eq_no]" ).append("\n"); 
