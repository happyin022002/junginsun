...
*@FileName : ContainerMovementFinderDBDAOSearchCntrInfoByEqrRefRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementFinderDBDAOSearchCntrInfoByEqrRefRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchCntrInfoByEqrRef
	  * </pre>
	  */
	public ContainerMovementFinderDBDAOSearchCntrInfoByEqrRefRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementFinderDBDAOSearchCntrInfoByEqrRefRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          FROM (SELECT C.CNTR_NO," ).append("\n"); 
		...
		query.append("                 WHERE NVL(MTY_PLN_NO, MTY_REPO_NO) = @[mty_pln_no]) AA" ).append("\n"); 
		query.append("         GROUP BY CNTR_NO) C1" ).append("\n"); 
