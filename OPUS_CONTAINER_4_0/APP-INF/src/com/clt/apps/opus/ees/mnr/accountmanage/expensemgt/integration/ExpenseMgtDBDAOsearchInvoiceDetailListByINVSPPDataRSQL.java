...
*@FileName : ExpenseMgtDBDAOsearchInvoiceDetailListByINVSPPDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExpenseMgtDBDAOsearchInvoiceDetailListByINVSPPDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ExpenseMgtDBDAOsearchInvoiceDetailListByINVSPPDataRSQL
	  * </pre>
	  */
	public ExpenseMgtDBDAOsearchInvoiceDetailListByINVSPPDataRSQL(){
		setQuery();
		...
		query.append("FileName : ExpenseMgtDBDAOsearchInvoiceDetailListByINVSPPDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",A.COST_AMT INV_AMT" ).append("\n"); 
		...
		query.append("AND T.PAY_INV_SEQ = @[pay_inv_seq]" ).append("\n"); 
