...
public class ChassisMgsetInvoiceDBDAOsearchCHSLeaseInvoiceVerifyDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      WHEN A.CHG_CD = 'PDM' THEN" ).append("\n"); 
		query.append("           CASE " ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'ST' THEN '510832'" ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'LT' THEN '510831'" ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'LP' THEN '510833' " ).append("\n"); 
		query.append("           ELSE '510832'" ).append("\n"); 
		query.append("           END" ).append("\n"); 
		query.append("      WHEN A.CHG_CD = 'WDP' THEN" ).append("\n"); 
		query.append("           CASE " ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'ST' THEN '510832'" ).append("\n"); 
		...
		query.append("      WHEN A.CHG_CD = 'DOC' THEN" ).append("\n"); 
		query.append("           CASE " ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'ST' THEN '510834'" ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'LT' THEN '510834'" ).append("\n"); 
		query.append("           ELSE '510834'" ).append("\n"); 
		query.append("           END" ).append("\n"); 
		query.append("      WHEN A.CHG_CD IN ('HON','DON') THEN '510835'" ).append("\n"); 
		query.append("      WHEN A.CHG_CD IN ('HOF','DOF') THEN '510835'" ).append("\n"); 
		query.append("      WHEN A.CHG_CD = 'GTO' THEN '510836'" ).append("\n"); 
		query.append("      WHEN A.CHG_CD = 'GTI' THEN '510837'" ).append("\n"); 
		query.append("          " ).append("\n"); 
		query.append("      ELSE " ).append("\n"); 
		query.append("           CASE " ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'ST' THEN '510838'" ).append("\n"); 
		query.append("           WHEN C.AGMT_LSTM_CD = 'LT' THEN '510838'" ).append("\n"); 
		query.append("           ELSE '510838'" ).append("\n"); 
		query.append("           END" ).append("\n"); 
