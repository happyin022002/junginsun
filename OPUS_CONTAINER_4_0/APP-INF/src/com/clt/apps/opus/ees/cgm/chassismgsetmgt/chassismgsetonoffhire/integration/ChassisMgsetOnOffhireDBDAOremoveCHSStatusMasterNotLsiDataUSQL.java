...
*@FileName : ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterNotLsiDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterNotLsiDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterNotLsiDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOremoveCHSStatusMasterNotLsiDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
