...
public class EesMnr0191Event extends EventSupport {
	...
	public CustomEQWorkOrderHistoryListVO[] getCustomEQWorkOrderHistoryListVOs() {
		CustomEQWorkOrderHistoryListVO[] rtnVOs = null;
		if (this.customEQWorkOrderHistoryListVOs != null) {
			rtnVOs = java.util.Arrays.copyOf(customEQWorkOrderHistoryListVOs, customEQWorkOrderHistoryListVOs.length);
		}
		return rtnVOs;
	}

	public void setCustomEQWorkOrderHistoryListVOs(CustomEQWorkOrderHistoryListVO[] customEQWorkOrderHistoryListVOs){
		if(customEQWorkOrderHistoryListVOs != null){
			CustomEQWorkOrderHistoryListVO[] tmpVOs = java.util.Arrays.copyOf(customEQWorkOrderHistoryListVOs, customEQWorkOrderHistoryListVOs.length);
			this.customEQWorkOrderHistoryListVOs = tmpVOs;
		}
	}
}