...
*@FileName : GeneralCodeCheckMgtDBDAOmodifyEQFlagFileListByFlagDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralCodeCheckMgtDBDAOmodifyEQFlagFileListByFlagDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyEQFlagFileListByFlagData
	  * </pre>
	  */
	public GeneralCodeCheckMgtDBDAOmodifyEQFlagFileListByFlagDataUSQL(){
		setQuery();
		...
		query.append("FileName : GeneralCodeCheckMgtDBDAOmodifyEQFlagFileListByFlagDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
