...
public class EES_DMT_7010HTMLAction extends HTMLActionSupport {
	...
	/**
	 * EES_DMT_7010HTMLAction 객체를 생성
	 */
	public EES_DMT_7010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setCalculationTypeParmVOS((CalculationTypeParmVO[])getVOs(request, CalculationTypeParmVO .class, "sheet1_"));
		}
