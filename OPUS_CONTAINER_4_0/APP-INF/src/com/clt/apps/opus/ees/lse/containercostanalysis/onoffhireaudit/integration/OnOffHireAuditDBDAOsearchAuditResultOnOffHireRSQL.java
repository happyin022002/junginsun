...
public class OnOffHireAuditDBDAOsearchAuditResultOnOffHireRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Lessor 와 자사를 비교하여 Concidence Discrepancy 자사 Lessor 데이타를 추출한다.
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("       --=COM-DATA====================================OFF-HIRE=START" ).append("\n"); 
		query.append("       ( SELECT" ).append("\n"); 
		query.append("                A.AGMT_CTY_CD," ).append("\n"); 
		query.append("                A.AGMT_SEQ," ).append("\n"); 
		...
		query.append("       --=COM-DATA====================================ON-HIRE=START" ).append("\n"); 
		query.append("       (SELECT" ).append("\n"); 
		query.append("                A.AGMT_CTY_CD," ).append("\n"); 
		query.append("                A.AGMT_SEQ," ).append("\n"); 
		query.append("                B.LSTM_CD," ).append("\n"); 
		...
		query.append("#elseif (${audit_tp} == 'A' ) " ).append("\n"); 
		query.append("       --=COM-DATA====================================ALL=START" ).append("\n"); 
		query.append("       ( SELECT" ).append("\n"); 
		query.append("                A.AGMT_CTY_CD," ).append("\n"); 
		query.append("                A.AGMT_SEQ," ).append("\n"); 
		query.append("                B.LSTM_CD," ).append("\n"); 
