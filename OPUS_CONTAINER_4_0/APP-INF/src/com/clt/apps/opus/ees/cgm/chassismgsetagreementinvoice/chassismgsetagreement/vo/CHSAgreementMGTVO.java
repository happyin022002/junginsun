 ...
 *@FileName : CHSAgreementMGTVO.java
 *@FileTitle : CHSAgreementMGTVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class CHSAgreementMGTVO	extends	 AbstractValueObject
{

	private	 static final long serialVersionUID = 1L;

	private	 Collection<CHSAgreementMGTVO>  models =	new	ArrayList<CHSAgreementMGTVO>();
 ...
 //	Getters	and	Setters
	...
	*/
	 ...
	 */
	public CHSAgreementMGTVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return CHSAgreementMGTVO[]
	 */
	public CHSAgreementMGTVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		CHSAgreementMGTVO model = null;
	 ...
	 * @return CHSAgreementMGTVO[]
	 */
	public CHSAgreementMGTVO[]	 getCHSAgreementMGTVOs(){
		CHSAgreementMGTVO[] vos = (CHSAgreementMGTVO[])models.toArray(new	CHSAgreementMGTVO[models.size()]);
		return vos;
		}
