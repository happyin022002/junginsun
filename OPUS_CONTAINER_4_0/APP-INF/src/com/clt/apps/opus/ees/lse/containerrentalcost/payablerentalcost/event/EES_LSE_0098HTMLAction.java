...
*@FileName : EES_LSE_0098HTMLAction.java
...
public class EES_LSE_0098HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0008HTMLAction 객체를 생성
	 */
	public EES_LSE_0098HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesLse0098Event event = new EesLse0098Event();
