...
*@FileName : ForecastReportDBDAOcheckMtyWeeklySimulationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOcheckMtyWeeklySimulationRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ForecastReportDBDAOcheckMtyWeeklySimulationRSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOcheckMtyWeeklySimulationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/*" ).append("\n"); 
		query.append("--  1.정의 : EQR_CTRL_MTY_WKY_SIM 중복확인쿼리" ).append("\n"); 
		...
		query.append(" FROM EQR_CTRL_MTY_WKY_SIM" ).append("\n"); 
