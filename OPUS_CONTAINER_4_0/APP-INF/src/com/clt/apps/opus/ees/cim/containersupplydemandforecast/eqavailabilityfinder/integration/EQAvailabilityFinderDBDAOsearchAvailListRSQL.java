...
public class EQAvailabilityFinderDBDAOsearchAvailListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          , DECODE(C.LOC_TP, 'R', D.SCC_CD, 'L', D.SCC_CD, 'E', D.SCC_CD, A.YD_CD) AS YD_CD" ).append("\n"); 
		query.append("          , DECODE(C.LOC_TP, 'R', D.RCC_CD, 'L', D.LCC_CD, 'E', D.ECC_CD, D.SCC_CD) AS SCC_CD" ).append("\n"); 
		...
		query.append("    GROUP BY DECODE(C.LOC_TP, 'R', D.SCC_CD, 'L', D.SCC_CD, 'E', D.SCC_CD, A.YD_CD)" ).append("\n"); 
		query.append("          ,  DECODE(C.LOC_TP, 'R', D.RCC_CD, 'L', D.LCC_CD, 'E', D.ECC_CD, D.SCC_CD)" ).append("\n"); 
		query.append("          ,  A.FCAST_DT" ).append("\n"); 
		query.append("    ORDER BY DECODE(C.LOC_TP, 'R', D.SCC_CD, 'L', D.SCC_CD, 'E', D.SCC_CD, A.YD_CD)" ).append("\n"); 
		query.append("          ,  DECODE(C.LOC_TP, 'R', D.RCC_CD, 'L', D.LCC_CD, 'E', D.ECC_CD, D.SCC_CD)" ).append("\n"); 
		query.append("          ,  A.FCAST_DT" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("    GROUP BY A.SCC_CD, A.FCAST_DT" ).append("\n"); 
		query.append("    ORDER BY A.SCC_CD,A.FCAST_DT" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("#if (${s_type} == '01')" ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
		...
		query.append("#elseif (${s_type} == '02')" ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
		query.append("   LOC_LEVEL" ).append("\n"); 
		query.append("  ,YD_CD" ).append("\n"); 
		query.append("  ,SCC_CD" ).append("\n"); 
