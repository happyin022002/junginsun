...
*@FileName : SCExceptionTariffMgtDBDAOAddSCExceptionGroupOfHistVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddSCExceptionGroupOfHistVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff History 에서 선택한 버전의 모든 S/C Exception Tariff Group 정보를 현재 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddSCExceptionGroupOfHistVersionCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddSCExceptionGroupOfHistVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
