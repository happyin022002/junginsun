...
*@FileName : TpSzDupChkINVO.java
*@FileTitle : TpSzDupChkINVO
*Open Issues :
*Change history :
...
public class TpSzDupChkINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TpSzDupChkINVO> models = new ArrayList<TpSzDupChkINVO>();
	...
	public TpSzDupChkINVO() {}

	public TpSzDupChkINVO(String ibflag, String pagerows, String eqTpszCd, String eqKndCd, String eqTpszRepCd, String diffDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public TpSzDupChkINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TpSzDupChkINVO[]
	 */
	public TpSzDupChkINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TpSzDupChkINVO model = null;
	 ...
	 * @return TpSzDupChkINVO[]
	 */
	public TpSzDupChkINVO[] getTpSzDupChkINVOs(){
		TpSzDupChkINVO[] vos = (TpSzDupChkINVO[])models.toArray(new TpSzDupChkINVO[models.size()]);
		return vos;
	}
