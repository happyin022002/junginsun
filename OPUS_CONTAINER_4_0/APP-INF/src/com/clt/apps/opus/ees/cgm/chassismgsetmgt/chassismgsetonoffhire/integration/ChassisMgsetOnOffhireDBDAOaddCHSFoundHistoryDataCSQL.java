...
*@FileName : ChassisMgsetOnOffhireDBDAOaddCHSFoundHistoryDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOaddCHSFoundHistoryDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOaddCHSFoundHistoryDataCSQL(){
		setQuery();
		...
		params.put("f_evnt_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOaddCHSFoundHistoryDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",SUBSTR(@[f_evnt_yd_cd],0,5)" ).append("\n"); 
		query.append(",@[ofc_cd]" ).append("\n"); 
		query.append(",TO_DATE(@[f_evnt_dt] 	,'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
