...
*@FileName : ChassisMgsetOnOffhireDBDAOaddMGSLostHistoryDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOaddMGSLostHistoryDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOaddMGSLostHistoryDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOaddMGSLostHistoryDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",TO_DATE(@[l_evnt_dt],'YYYY-MM-DD')" ).append("\n"); 
