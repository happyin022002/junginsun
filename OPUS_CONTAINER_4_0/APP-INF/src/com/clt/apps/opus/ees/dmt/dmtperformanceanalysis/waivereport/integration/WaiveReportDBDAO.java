...
package com.clt.apps.opus.ees.dmt.dmtperformanceanalysis.waivereport.integration;
...
/*----------------------------------------------------------------------------------------*/
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new WaiveReportDBDAOSearchWaveReportByOfficeListRSQL(), param, velParam, true);
...
/*----------------------------------------------------------------------------------------*/
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new WaiveReportDBDAOSearchWaveReportByOfficeDetailListRSQL(), param, velParam, true);
