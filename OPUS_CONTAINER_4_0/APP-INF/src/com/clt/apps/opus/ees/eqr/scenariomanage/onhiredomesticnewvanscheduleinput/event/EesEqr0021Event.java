...
public class EesEqr0021Event extends EventSupport {
	...
	private EqrScnrDmstVO[] eqrScnrDmstVOS = null;
	...
	public EqrScnrDmstVO[] getEqrScnrDmstVOS() {
		EqrScnrDmstVO[] tmpVOs = null;
		if (this.eqrScnrDmstVOS != null) {
			tmpVOs = new EqrScnrDmstVO[eqrScnrDmstVOS.length];
			System.arraycopy(eqrScnrDmstVOS, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
	...
	public void setEqrScnrDmstVOS(EqrScnrDmstVO[] eqrScnrDmstVOS) {
		if (eqrScnrDmstVOS != null) {
			EqrScnrDmstVO[] tmpVOs = new EqrScnrDmstVO[eqrScnrDmstVOS.length];
			System.arraycopy(eqrScnrDmstVOS, 0, tmpVOs, 0, tmpVOs.length);
			this.eqrScnrDmstVOS = tmpVOs;
		}
	}
