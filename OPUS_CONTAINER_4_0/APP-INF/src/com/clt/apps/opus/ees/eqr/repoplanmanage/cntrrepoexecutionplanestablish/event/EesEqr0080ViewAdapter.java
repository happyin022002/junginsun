		...
		try {
			...
			// INLAND 는 FROM, TO중 하나만 맞으면 작업을 허용합니다.
				while (rowSet.next()) {
					...
					level_Check = true;
					/*if(user_level.equals("1")  ||	    ( user_level.equals("2") && (user_modify_location.equals(rowSet.getString(editPosition + 3)) || user_modify_location.equals(rowSet.getString(editPosition + 4))) ) || 
