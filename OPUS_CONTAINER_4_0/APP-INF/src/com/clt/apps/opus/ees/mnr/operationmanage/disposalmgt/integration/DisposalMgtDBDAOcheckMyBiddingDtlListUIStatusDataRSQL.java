...
*@FileName : DisposalMgtDBDAOcheckMyBiddingDtlListUIStatusDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DisposalMgtDBDAOcheckMyBiddingDtlListUIStatusDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 조회 -  EES_MNR_S304  디테일 정보의 저장상태를 조회한다.
	  * </pre>
	  */
	public DisposalMgtDBDAOcheckMyBiddingDtlListUIStatusDataRSQL(){
		setQuery();
		...
		query.append("FileName : DisposalMgtDBDAOcheckMyBiddingDtlListUIStatusDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
