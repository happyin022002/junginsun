...
*@FileName : InterfaceMgtDBDAOmodifyNewPortTmpDtlDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceMgtDBDAOmodifyNewPortTmpDtlDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InterfaceMgtDBDAOmodifyNewPortTmpDtlDataUSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceMgtDBDAOmodifyNewPortTmpDtlDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
