...
*@FileName : ConsultationSlipRequestMgtDBDAOcreateApInvDTRBEviTllCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOcreateApInvDTRBEviTllCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * createApInvDTRBEviTll
	  * R4J 관련 CSR 프로그램 수정 ( DBDAO에 SQL문을 삭제하기 위함 )
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOcreateApInvDTRBEviTllCSQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOcreateApInvDTRBEviTllCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("DTRB_COA_ACCT_CD, DTRB_COA_VVD_CD, DTRB_COA_INTER_CO_CD," ).append("\n"); 
		query.append("DTRB_COA_FTU_N1ST_CD, DTRB_COA_FTU_N2ND_CD," ).append("\n"); 
		...
		query.append("LINE_TP_LU_CD," ).append("\n"); 
		query.append("DECODE(CURR_CD," ).append("\n"); 
		query.append("'KRW',ROUND(SUM(CSR_AMT),0)," ).append("\n"); 
		query.append("'JPY',ROUND(SUM(CSR_AMT),0)," ).append("\n"); 
		query.append("ROUND(SUM(CSR_AMT),2))           CSR_AMT," ).append("\n"); 
		query.append("INV_DESC," ).append("\n"); 
		query.append("INV_TAX_CD," ).append("\n"); 
		query.append("DTRB_COA_CO_CD," ).append("\n"); 
		query.append("DTRB_COA_RGN_CD," ).append("\n"); 
		...
		query.append("H.INV_CURR_CD                                CURR_CD," ).append("\n"); 
		query.append("-NVL(D.INV_AMT,0)                            CSR_AMT," ).append("\n"); 
		...
		query.append("'957112'                                     DTRB_COA_ACCT_CD," ).append("\n"); 
		...
		query.append("'957112'                                      ATTR_CATE_NM," ).append("\n"); 
		query.append("NULL                                          ATTR_CTNT1," ).append("\n"); 
		query.append("NULL                                          ATTR_CTNT2," ).append("\n"); 
		query.append("NULL                                          ATTR_CTNT3," ).append("\n"); 
