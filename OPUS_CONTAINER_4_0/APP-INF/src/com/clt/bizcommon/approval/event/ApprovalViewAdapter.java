...
public class ApprovalViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"apro_rqst_no","crnt_apro_seq","apsts_cd","sub_sys_cd","rqst_st_dt","cost_ofc_cd","csr_no","inv_knt","vndr_seq","pay_due_dt","curr_cd","apro_ttl_amt","apro_rmk","appyn"};
