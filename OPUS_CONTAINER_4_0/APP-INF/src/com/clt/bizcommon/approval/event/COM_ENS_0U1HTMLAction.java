...
*@FileName : COM_ENS_0U1HTMLAction.java
*@FileTitle : VVD
*Open Issues :
*Change history :
 ...
 * @see ComEns0U1Event , COM_ENS_0U1EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_ENS_0U1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0U1HTMLAction 객체를 생성
	 */
	public COM_ENS_0U1HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_ENS_0U1Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComEns0U1Event event = new ComEns0U1Event();
    	...
    	event.setApprovalCsrVOS((ApprovalCsrVO[])getVOs(request, ApprovalCsrVO.class, ""));
    	
    	if(command.isCommand(FormCommand.COMMAND01)) {	
    		ApprovalCsrVO vo = new ApprovalCsrVO();
    		vo.setAproRqstNo(request.getParameter("f_apro_rqst_no"));
    		vo.setAproRqstSeq(request.getParameter("f_apro_rqst_seq"));
    		vo.setAproRmk(request.getParameter("f_apro_rmk"));
    		vo.setCsrNo(request.getParameter("f_csr_no"));
    		
    		event.setApprovalCsrVO(vo);
		} 
