...
*@FileName : ApprovalRouteVO.java
*@FileTitle : ApprovalRouteVO
*Open Issues :
*Change history :
...
public class ApprovalRouteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ApprovalRouteVO> models = new ArrayList<ApprovalRouteVO>();
	...
	public ApprovalRouteVO() {}

	public ApprovalRouteVO(String ibflag, String pagerows, String aproSeq, String aproUsrId, String aproUsrNm, String aproOfcCd, String aproUsrJbTitNm, String aproRoutSeq, String usrId) {
...
/**
	 ...
	 * @param request
	 * @return ApprovalRouteVO[]
	 */
	public ApprovalRouteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ApprovalRouteVO[]
	 */
	public ApprovalRouteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ApprovalRouteVO model = null;
	...
	public ApprovalRouteVO[] getApprovalRouteVOs(){
		ApprovalRouteVO[] vos = (ApprovalRouteVO[])models.toArray(new ApprovalRouteVO[models.size()]);
		return vos;
	}
