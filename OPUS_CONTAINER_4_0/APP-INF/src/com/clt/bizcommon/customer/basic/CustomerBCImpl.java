...
public class CustomerBCImpl   extends BasicCommandSupport implements CustomerBC {
	 ...
	 */
    public List<SearchCustomerVO> searchCustomerList(String custCd, String custNm, String ofcCd, int iPage, String include, String cust) throws EventException {
        try {
	 ...
	 * @throws EventException
	 */
    public List<SearchCustomerVO> searchCustomerList(String custCd, String custNm, String ofcCd, int iPage, String include, String cust , String mdmYN, String deltFlg, String locCd, String creditFlg) throws EventException {
    	try {
    		return  dbDao.searchCustomerList(custCd, custNm, ofcCd, iPage, include, cust, mdmYN, deltFlg, locCd, creditFlg);
    	} catch (DAOException de) {
    		log.error("err "+de.toString(),de);
    		throw new EventException(de.getMessage());
    	} catch (Exception e2) {
