...
*@FileName : BkgKrWhfBrthVO.java
*@FileTitle : BkgKrWhfBrthVO
*Open Issues :
*Change history :
...
public class BkgKrWhfBrthVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgKrWhfBrthVO> models = new ArrayList<BkgKrWhfBrthVO>();
	...
	public BkgKrWhfBrthVO() {}

	public BkgKrWhfBrthVO(String ibflag, String pagerows, String portCd, String brthCd, String brthKrNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return BkgKrWhfBrthVO[]
	 */
	public BkgKrWhfBrthVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgKrWhfBrthVO[]
	 */
	public BkgKrWhfBrthVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgKrWhfBrthVO model = null;
	 ...
	 * @return BkgKrWhfBrthVO[]
	 */
	public BkgKrWhfBrthVO[] getBkgKrWhfBrthVOs(){
		BkgKrWhfBrthVO[] vos = (BkgKrWhfBrthVO[])models.toArray(new BkgKrWhfBrthVO[models.size()]);
		return vos;
	}
