...
*@FileName : CsqQtaNewLaneOfcCostVO.java
*@FileTitle : CsqQtaNewLaneOfcCostVO
*Open Issues :
*Change history :
...
public class CsqQtaNewLaneOfcCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaNewLaneOfcCostVO> models = new ArrayList<CsqQtaNewLaneOfcCostVO>();
...
/**
	 ...
	 * @param request
	 * @return CsqQtaNewLaneOfcCostVO[]
	 */
	public CsqQtaNewLaneOfcCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaNewLaneOfcCostVO[]
	 */
	public CsqQtaNewLaneOfcCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaNewLaneOfcCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CsqQtaNewLaneOfcCostVO();
				if (updDt[i] != null)
		...
		return getCsqQtaNewLaneOfcCostVOs();
	}
	...
	public CsqQtaNewLaneOfcCostVO[] getCsqQtaNewLaneOfcCostVOs(){
		CsqQtaNewLaneOfcCostVO[] vos = (CsqQtaNewLaneOfcCostVO[])models.toArray(new CsqQtaNewLaneOfcCostVO[models.size()]);
		return vos;
	}
