...
*@FileName : CsqDirConvVO.java
*@FileTitle : CsqDirConvVO
*Open Issues :
*Change history :
...
public class CsqDirConvVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqDirConvVO> models = new ArrayList<CsqDirConvVO>();
	...
	public CsqDirConvVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String convDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.trdCd = trdCd;
		this.bseYr = bseYr;
...
/**
	 ...
	 * @return CsqDirConvVO[]
	 */
	public CsqDirConvVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqDirConvVO[]
	 */
	public CsqDirConvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqDirConvVO model = null;
	...
	public CsqDirConvVO[] getCsqDirConvVOs(){
		CsqDirConvVO[] vos = (CsqDirConvVO[])models.toArray(new CsqDirConvVO[models.size()]);
		return vos;
	}
