...
*@FileName : CsqQtaLaneOfcVO.java
*@FileTitle : CsqQtaLaneOfcVO
*Open Issues :
*Change history :
...
public class CsqQtaLaneOfcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaLaneOfcVO> models = new ArrayList<CsqQtaLaneOfcVO>();
	...
	public CsqQtaLaneOfcVO() {}

	public CsqQtaLaneOfcVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String trdCd, String rlaneCd, String dirCd, String rgnOfcCd, String rhqCd, String subTrdCd, String csqActFlg, String addFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.rhqCd = rhqCd;
...
/**
	 ...
	 */
	public CsqQtaLaneOfcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaLaneOfcVO[]
	 */
	public CsqQtaLaneOfcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaLaneOfcVO model = null;
	...
	public CsqQtaLaneOfcVO[] getCsqQtaLaneOfcVOs(){
		CsqQtaLaneOfcVO[] vos = (CsqQtaLaneOfcVO[])models.toArray(new CsqQtaLaneOfcVO[models.size()]);
		return vos;
	}
