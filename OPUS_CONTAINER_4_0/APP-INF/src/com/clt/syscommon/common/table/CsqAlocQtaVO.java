...
*@FileName : CsqAlocQtaVO.java
*@FileTitle : CsqAlocQtaVO
*Open Issues :
*Change history :
...
public class CsqAlocQtaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqAlocQtaVO> models = new ArrayList<CsqAlocQtaVO>();
...
/**
	 ...
	 * @return CsqAlocQtaVO[]
	 */
	public CsqAlocQtaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqAlocQtaVO[]
	 */
	public CsqAlocQtaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqAlocQtaVO model = null;
	 ...
	 * @return CsqAlocQtaVO[]
	 */
	public CsqAlocQtaVO[] getCsqAlocQtaVOs(){
		CsqAlocQtaVO[] vos = (CsqAlocQtaVO[])models.toArray(new CsqAlocQtaVO[models.size()]);
		return vos;
	}
