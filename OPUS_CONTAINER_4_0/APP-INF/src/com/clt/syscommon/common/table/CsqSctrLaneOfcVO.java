...
*@FileName : CsqSctrLaneOfcVO.java
*@FileTitle : CsqSctrLaneOfcVO
*Open Issues :
*Change history :
...
public class CsqSctrLaneOfcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrLaneOfcVO> models = new ArrayList<CsqSctrLaneOfcVO>();
...
/**
	 ...
	 */
	public CsqSctrLaneOfcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrLaneOfcVO[]
	 */
	public CsqSctrLaneOfcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrLaneOfcVO model = null;
	...
	public CsqSctrLaneOfcVO[] getCsqSctrLaneOfcVOs(){
		CsqSctrLaneOfcVO[] vos = (CsqSctrLaneOfcVO[])models.toArray(new CsqSctrLaneOfcVO[models.size()]);
		return vos;
	}
