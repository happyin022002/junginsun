	...
	*/
	...
	public ApPayInvDtlVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				...
				String[] soSeq =	(JSPUtil.getParameter(request, prefix +	"so_seq".trim(),	length));
				String[] creDt =	(JSPUtil.getParameter(request, prefix +	"cre_dt".trim(),	length));
				String[] pagerows =	(JSPUtil.getParameter(request, prefix +	"pagerows".trim(),	length));
				String[] invRgstSeq =	(JSPUtil.getParameter(request, prefix +	"inv_rgst_seq".trim(),	length));
				String[] revDirCd =	(JSPUtil.getParameter(request, prefix +	"rev_dir_cd".trim(),	length));
				String[] ibflag =	(JSPUtil.getParameter(request, prefix +	"ibflag".trim(),	length));
				String[] so20ftQty =	(JSPUtil.getParameter(request, prefix +	"so_20ft_qty".trim(),	length));
				String[] acctCd =	(JSPUtil.getParameter(request, prefix +	"acct_cd".trim(),	length));
				String[] cntrTpszCd =	(JSPUtil.getParameter(request, prefix +	"cntr_tpsz_cd".trim(),	length));
				String[] so40ftQty =	(JSPUtil.getParameter(request, prefix +	"so_40ft_qty".trim(),	length));
				...
				String[] soOfcCtyCd =	(JSPUtil.getParameter(request, prefix +	"so_ofc_cty_cd".trim(),	length));
				String[] skdVoyNo =	(JSPUtil.getParameter(request, prefix +	"skd_voy_no".trim(),	length));
				String[] skdDirCd =	(JSPUtil.getParameter(request, prefix +	"skd_dir_cd".trim(),	length));
				String[] soTeuQty =	(JSPUtil.getParameter(request, prefix +	"so_teu_qty".trim(),	length));
				String[] soUtQty =	(JSPUtil.getParameter(request, prefix +	"so_ut_qty".trim(),	length));
				...
				String[] actVvdCd =	(JSPUtil.getParameter(request, prefix +	"act_vvd_cd".trim(),	length));
