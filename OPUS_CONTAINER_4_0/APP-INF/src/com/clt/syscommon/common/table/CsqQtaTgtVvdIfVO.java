...
*@FileName : CsqQtaTgtVvdIfVO.java
*@FileTitle : CsqQtaTgtVvdIfVO
*Open Issues :
*Change history :
...
public class CsqQtaTgtVvdIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaTgtVvdIfVO> models = new ArrayList<CsqQtaTgtVvdIfVO>();
	...
	public CsqQtaTgtVvdIfVO() {}

	public CsqQtaTgtVvdIfVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String vslCd, String skdVoyNo, String skdDirCd, String bseMon, String bseWk, String subTrdCd, String iocCd, String fnlBsaCapa, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
		this.vslCd = vslCd;
...
/**
	 ...
	 * @param request
	 * @return CsqQtaTgtVvdIfVO[]
	 */
	public CsqQtaTgtVvdIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaTgtVvdIfVO[]
	 */
	public CsqQtaTgtVvdIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaTgtVvdIfVO model = null;
	 ...
	 * @return CsqQtaTgtVvdIfVO[]
	 */
	public CsqQtaTgtVvdIfVO[] getCsqQtaTgtVvdIfVOs(){
		CsqQtaTgtVvdIfVO[] vos = (CsqQtaTgtVvdIfVO[])models.toArray(new CsqQtaTgtVvdIfVO[models.size()]);
		return vos;
	}
