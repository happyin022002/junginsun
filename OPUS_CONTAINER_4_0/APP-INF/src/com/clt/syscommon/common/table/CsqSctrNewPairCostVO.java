...
*@FileName : CsqSctrNewPairCostVO.java
*@FileTitle : CsqSctrNewPairCostVO
*Open Issues :
*Change history :
...
public class CsqSctrNewPairCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrNewPairCostVO> models = new ArrayList<CsqSctrNewPairCostVO>();
...
/**
	 ...
	 * @param request
	 * @return CsqSctrNewPairCostVO[]
	 */
	public CsqSctrNewPairCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrNewPairCostVO[]
	 */
	public CsqSctrNewPairCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrNewPairCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CsqSctrNewPairCostVO();
				if (updDt[i] != null)
		...
		return getCsqSctrNewPairCostVOs();
	}
	 ...
	 * @return CsqSctrNewPairCostVO[]
	 */
	public CsqSctrNewPairCostVO[] getCsqSctrNewPairCostVOs(){
		CsqSctrNewPairCostVO[] vos = (CsqSctrNewPairCostVO[])models.toArray(new CsqSctrNewPairCostVO[models.size()]);
		return vos;
	}
