...
*@FileName : CsqSctrPerfIfVO.java
*@FileTitle : CsqSctrPerfIfVO
*Open Issues :
*Change history :
...
public class CsqSctrPerfIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrPerfIfVO> models = new ArrayList<CsqSctrPerfIfVO>();
...
/**
	 ...
	 */
	public CsqSctrPerfIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrPerfIfVO[]
	 */
	public CsqSctrPerfIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrPerfIfVO model = null;
	...
	public CsqSctrPerfIfVO[] getCsqSctrPerfIfVOs(){
		CsqSctrPerfIfVO[] vos = (CsqSctrPerfIfVO[])models.toArray(new CsqSctrPerfIfVO[models.size()]);
		return vos;
	}
