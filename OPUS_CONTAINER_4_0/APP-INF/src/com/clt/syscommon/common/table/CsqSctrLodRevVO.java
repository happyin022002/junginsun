...
*@FileName : CsqSctrLodRevVO.java
*@FileTitle : CsqSctrLodRevVO
*Open Issues :
*Change history :
...
public class CsqSctrLodRevVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrLodRevVO> models = new ArrayList<CsqSctrLodRevVO>();
...
/**
	 ...
	 */
	public CsqSctrLodRevVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrLodRevVO[]
	 */
	public CsqSctrLodRevVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrLodRevVO model = null;
	...
	public CsqSctrLodRevVO[] getCsqSctrLodRevVOs(){
		CsqSctrLodRevVO[] vos = (CsqSctrLodRevVO[])models.toArray(new CsqSctrLodRevVO[models.size()]);
		return vos;
	}
