...
*@FileName : CsqSctrNewLaneVO.java
*@FileTitle : CsqSctrNewLaneVO
*Open Issues :
*Change history :
...
public class CsqSctrNewLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrNewLaneVO> models = new ArrayList<CsqSctrNewLaneVO>();
	...
	public CsqSctrNewLaneVO() {}

	public CsqSctrNewLaneVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String rlaneCd, String dirCd, String trdCd, String subTrdCd, String srcTrdCd, String srcRlaneCd, String srcDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return CsqSctrNewLaneVO[]
	 */
	public CsqSctrNewLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrNewLaneVO[]
	 */
	public CsqSctrNewLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrNewLaneVO model = null;
	 ...
	 * @return CsqSctrNewLaneVO[]
	 */
	public CsqSctrNewLaneVO[] getCsqSctrNewLaneVOs(){
		CsqSctrNewLaneVO[] vos = (CsqSctrNewLaneVO[])models.toArray(new CsqSctrNewLaneVO[models.size()]);
		return vos;
	}
