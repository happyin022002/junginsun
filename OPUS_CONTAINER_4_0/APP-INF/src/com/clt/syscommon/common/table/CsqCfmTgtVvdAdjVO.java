...
*@FileName : CsqCfmTgtVvdAdjVO.java
*@FileTitle : CsqCfmTgtVvdAdjVO
*Open Issues :
*Change history :
...
public class CsqCfmTgtVvdAdjVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqCfmTgtVvdAdjVO> models = new ArrayList<CsqCfmTgtVvdAdjVO>();
...
/**
	 ...
	 * @param request
	 * @return CsqCfmTgtVvdAdjVO[]
	 */
	public CsqCfmTgtVvdAdjVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqCfmTgtVvdAdjVO[]
	 */
	public CsqCfmTgtVvdAdjVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqCfmTgtVvdAdjVO model = null;
	 ...
	 * @return CsqCfmTgtVvdAdjVO[]
	 */
	public CsqCfmTgtVvdAdjVO[] getCsqCfmTgtVvdAdjVOs(){
		CsqCfmTgtVvdAdjVO[] vos = (CsqCfmTgtVvdAdjVO[])models.toArray(new CsqCfmTgtVvdAdjVO[models.size()]);
		return vos;
	}
