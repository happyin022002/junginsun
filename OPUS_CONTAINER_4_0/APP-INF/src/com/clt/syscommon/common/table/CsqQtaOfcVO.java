...
*@FileName : CsqQtaOfcVO.java
*@FileTitle : CsqQtaOfcVO
*Open Issues :
*Change history :
...
public class CsqQtaOfcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaOfcVO> models = new ArrayList<CsqQtaOfcVO>();
	...
	public CsqQtaOfcVO(String ibflag, String pagerows, String rgnOfcCd, String rhqCd, String addFlg, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return CsqQtaOfcVO[]
	 */
	public CsqQtaOfcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaOfcVO[]
	 */
	public CsqQtaOfcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaOfcVO model = null;
	...
	public CsqQtaOfcVO[] getCsqQtaOfcVOs(){
		CsqQtaOfcVO[] vos = (CsqQtaOfcVO[])models.toArray(new CsqQtaOfcVO[models.size()]);
		return vos;
	}
