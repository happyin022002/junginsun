...
*@FileName : CsqSctrPfGrpVO.java
*@FileTitle : CsqSctrPfGrpVO
*Open Issues :
*Change history :
...
public class CsqSctrPfGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrPfGrpVO> models = new ArrayList<CsqSctrPfGrpVO>();
	...
	public CsqSctrPfGrpVO() {}

	public CsqSctrPfGrpVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String rlaneCd, String pfGrpCd, String pfSvcTpCd, String trdCd, String subTrdCd, String pfRoutDesc, String csqActFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
...
/**
	 ...
	 * @param request
	 * @return CsqSctrPfGrpVO[]
	 */
	public CsqSctrPfGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrPfGrpVO[]
	 */
	public CsqSctrPfGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrPfGrpVO model = null;
	 ...
	 * @return CsqSctrPfGrpVO[]
	 */
	public CsqSctrPfGrpVO[] getCsqSctrPfGrpVOs(){
		CsqSctrPfGrpVO[] vos = (CsqSctrPfGrpVO[])models.toArray(new CsqSctrPfGrpVO[models.size()]);
		return vos;
	}
