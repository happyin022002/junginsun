...
*@FileName : CsqQtaRlseVerVO.java
*@FileTitle : CsqQtaRlseVerVO
*Open Issues :
*Change history :
...
public class CsqQtaRlseVerVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaRlseVerVO> models = new ArrayList<CsqQtaRlseVerVO>();
	...
	public CsqQtaRlseVerVO() {}

	public CsqQtaRlseVerVO(String ibflag, String pagerows, String qtaRlseVerNo, String bseTpCd, String bseYr, String bseQtrCd, String csqVerStsCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return CsqQtaRlseVerVO[]
	 */
	public CsqQtaRlseVerVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaRlseVerVO[]
	 */
	public CsqQtaRlseVerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaRlseVerVO model = null;
	 ...
	 * @return CsqQtaRlseVerVO[]
	 */
	public CsqQtaRlseVerVO[] getCsqQtaRlseVerVOs(){
		CsqQtaRlseVerVO[] vos = (CsqQtaRlseVerVO[])models.toArray(new CsqQtaRlseVerVO[models.size()]);
		return vos;
	}
