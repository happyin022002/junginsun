...
*@FileName : CsqSctrPairCostVO.java
*@FileTitle : CsqSctrPairCostVO
*Open Issues :
*Change history :
...
public class CsqSctrPairCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrPairCostVO> models = new ArrayList<CsqSctrPairCostVO>();
...
/**
	 ...
	 * @param request
	 * @return CsqSctrPairCostVO[]
	 */
	public CsqSctrPairCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrPairCostVO[]
	 */
	public CsqSctrPairCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrPairCostVO model = null;
	 ...
	 * @return CsqSctrPairCostVO[]
	 */
	public CsqSctrPairCostVO[] getCsqSctrPairCostVOs(){
		CsqSctrPairCostVO[] vos = (CsqSctrPairCostVO[])models.toArray(new CsqSctrPairCostVO[models.size()]);
		return vos;
	}
