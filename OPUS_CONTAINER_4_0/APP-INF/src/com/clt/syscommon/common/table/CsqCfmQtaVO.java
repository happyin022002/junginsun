...
*@FileName : CsqCfmQtaVO.java
*@FileTitle : CsqCfmQtaVO
*Open Issues :
*Change history :
...
public class CsqCfmQtaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqCfmQtaVO> models = new ArrayList<CsqCfmQtaVO>();
...
/**
	 ...
	 * @return CsqCfmQtaVO[]
	 */
	public CsqCfmQtaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqCfmQtaVO[]
	 */
	public CsqCfmQtaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqCfmQtaVO model = null;
	...
	public CsqCfmQtaVO[] getCsqCfmQtaVOs(){
		CsqCfmQtaVO[] vos = (CsqCfmQtaVO[])models.toArray(new CsqCfmQtaVO[models.size()]);
		return vos;
	}
