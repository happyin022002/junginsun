...
*@FileName : CsqQtaLodRevVO.java
*@FileTitle : CsqQtaLodRevVO
*Open Issues :
*Change history :
...
public class CsqQtaLodRevVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaLodRevVO> models = new ArrayList<CsqQtaLodRevVO>();
...
/**
	 ...
	 */
	public CsqQtaLodRevVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaLodRevVO[]
	 */
	public CsqQtaLodRevVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaLodRevVO model = null;
	...
	public CsqQtaLodRevVO[] getCsqQtaLodRevVOs(){
		CsqQtaLodRevVO[] vos = (CsqQtaLodRevVO[])models.toArray(new CsqQtaLodRevVO[models.size()]);
		return vos;
	}
