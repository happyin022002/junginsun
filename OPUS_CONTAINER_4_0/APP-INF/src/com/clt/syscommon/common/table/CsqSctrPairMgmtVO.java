...
*@FileName : CsqSctrPairMgmtVO.java
*@FileTitle : CsqSctrPairMgmtVO
*Open Issues :
*Change history :
...
public class CsqSctrPairMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrPairMgmtVO> models = new ArrayList<CsqSctrPairMgmtVO>();
	...
	public CsqSctrPairMgmtVO() {}

	public CsqSctrPairMgmtVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String rlaneCd, String dirCd, String pfGrpCd, String polCd, String podCd, String trdCd, String subTrdCd, String polCallSeq, String podCallSeq, String csqActFlg, String csqMnSctrFlg, String addFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
...
/**
	 ...
	 */
	public CsqSctrPairMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrPairMgmtVO[]
	 */
	public CsqSctrPairMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrPairMgmtVO model = null;
	...
	public CsqSctrPairMgmtVO[] getCsqSctrPairMgmtVOs(){
		CsqSctrPairMgmtVO[] vos = (CsqSctrPairMgmtVO[])models.toArray(new CsqSctrPairMgmtVO[models.size()]);
		return vos;
	}
