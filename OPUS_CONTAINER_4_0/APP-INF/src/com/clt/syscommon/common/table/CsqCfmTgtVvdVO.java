...
*@FileName : CsqCfmTgtVvdVO.java
*@FileTitle : CsqCfmTgtVvdVO
*Open Issues :
*Change history :
...
public class CsqCfmTgtVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqCfmTgtVvdVO> models = new ArrayList<CsqCfmTgtVvdVO>();
...
/**
	 ...
	 * @param request
	 * @return CsqCfmTgtVvdVO[]
	 */
	public CsqCfmTgtVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqCfmTgtVvdVO[]
	 */
	public CsqCfmTgtVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqCfmTgtVvdVO model = null;
	 ...
	 * @return CsqCfmTgtVvdVO[]
	 */
	public CsqCfmTgtVvdVO[] getCsqCfmTgtVvdVOs(){
		CsqCfmTgtVvdVO[] vos = (CsqCfmTgtVvdVO[])models.toArray(new CsqCfmTgtVvdVO[models.size()]);
		return vos;
	}
