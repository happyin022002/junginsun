...
*@FileName : CsqPerfIfVO.java
*@FileTitle : CsqPerfIfVO
*Open Issues :
*Change history :
...
public class CsqPerfIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqPerfIfVO> models = new ArrayList<CsqPerfIfVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("csq_lvl_cd", getCsqLvlCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("csq_lvl_cd", "csqLvlCd");
	 ...
	 * @return csqLvlCd
	 */
	public String getCsqLvlCd() {
		return this.csqLvlCd;
	}
	 ...
	 * @param csqLvlCd
	 */
	public void setCsqLvlCd(String csqLvlCd) {
		this.csqLvlCd = csqLvlCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCsqLvlCd(JSPUtil.getParameter(request, prefix + "csq_lvl_cd", ""));
	 ...
	 * @return CsqPerfIfVO[]
	 */
	public CsqPerfIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqPerfIfVO[]
	 */
	public CsqPerfIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqPerfIfVO model = null;
	 ...
	 * @return CsqPerfIfVO[]
	 */
	public CsqPerfIfVO[] getCsqPerfIfVOs(){
		CsqPerfIfVO[] vos = (CsqPerfIfVO[])models.toArray(new CsqPerfIfVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.csqLvlCd = this.csqLvlCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
