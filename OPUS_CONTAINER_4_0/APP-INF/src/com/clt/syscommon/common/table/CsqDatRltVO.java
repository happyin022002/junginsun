...
*@FileName : CsqDatRltVO.java
*@FileTitle : CsqDatRltVO
*Open Issues :
*Change history :
...
public class CsqDatRltVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqDatRltVO> models = new ArrayList<CsqDatRltVO>();
	...
	public CsqDatRltVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String trdCd, String rlaneCd, String convDirCd, String rhqCd, String teamCd, String obDivCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return CsqDatRltVO[]
	 */
	public CsqDatRltVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqDatRltVO[]
	 */
	public CsqDatRltVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqDatRltVO model = null;
	...
	public CsqDatRltVO[] getCsqDatRltVOs(){
		CsqDatRltVO[] vos = (CsqDatRltVO[])models.toArray(new CsqDatRltVO[models.size()]);
		return vos;
	}
