...
*@FileName : CsqQtaStepVerVO.java
*@FileTitle : CsqQtaStepVerVO
*Open Issues :
*Change history :
...
public class CsqQtaStepVerVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaStepVerVO> models = new ArrayList<CsqQtaStepVerVO>();
	...
	public CsqQtaStepVerVO() {}

	public CsqQtaStepVerVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String qtaStepCd, String qtaVerNo, String trdCd, String convDirCd, String csqVerStsCd, String cfmGdt, String creOfcCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CsqQtaStepVerVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaStepVerVO[]
	 */
	public CsqQtaStepVerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaStepVerVO model = null;
	...
	public CsqQtaStepVerVO[] getCsqQtaStepVerVOs(){
		CsqQtaStepVerVO[] vos = (CsqQtaStepVerVO[])models.toArray(new CsqQtaStepVerVO[models.size()]);
		return vos;
	}
