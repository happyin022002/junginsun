...
*@FileName : CsqQtaRbcVO.java
*@FileTitle : CsqQtaRbcVO
*Open Issues :
*Change history :
...
public class CsqQtaRbcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaRbcVO> models = new ArrayList<CsqQtaRbcVO>();
...
/**
	 ...
	 * @return CsqQtaRbcVO[]
	 */
	public CsqQtaRbcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaRbcVO[]
	 */
	public CsqQtaRbcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaRbcVO model = null;
	 ...
	 * @return CsqQtaRbcVO[]
	 */
	public CsqQtaRbcVO[] getCsqQtaRbcVOs(){
		CsqQtaRbcVO[] vos = (CsqQtaRbcVO[])models.toArray(new CsqQtaRbcVO[models.size()]);
		return vos;
	}
