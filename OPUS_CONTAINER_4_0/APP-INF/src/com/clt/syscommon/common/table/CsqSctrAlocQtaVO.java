...
*@FileName : CsqSctrAlocQtaVO.java
*@FileTitle : CsqSctrAlocQtaVO
*Open Issues :
*Change history :
...
public class CsqSctrAlocQtaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrAlocQtaVO> models = new ArrayList<CsqSctrAlocQtaVO>();
...
/**
	 ...
	 * @param request
	 * @return CsqSctrAlocQtaVO[]
	 */
	public CsqSctrAlocQtaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrAlocQtaVO[]
	 */
	public CsqSctrAlocQtaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrAlocQtaVO model = null;
	 ...
	 * @return CsqSctrAlocQtaVO[]
	 */
	public CsqSctrAlocQtaVO[] getCsqSctrAlocQtaVOs(){
		CsqSctrAlocQtaVO[] vos = (CsqSctrAlocQtaVO[])models.toArray(new CsqSctrAlocQtaVO[models.size()]);
		return vos;
	}
