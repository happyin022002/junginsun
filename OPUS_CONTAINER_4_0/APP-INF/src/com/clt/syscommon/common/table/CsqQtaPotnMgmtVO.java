...
*@FileName : CsqQtaPotnMgmtVO.java
*@FileTitle : CsqQtaPotnMgmtVO
*Open Issues :
*Change history :
...
public class CsqQtaPotnMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaPotnMgmtVO> models = new ArrayList<CsqQtaPotnMgmtVO>();
	...
	public CsqQtaPotnMgmtVO() {}

	public CsqQtaPotnMgmtVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String qtaStepCd, String qtaVerNo, String rhqCd, String rgnOfcCd, String trdCd, String rlaneCd, String convDirCd, String dirCd, String subTrdCd, String gidLodPotnRto, String gidRevPotnRto, String lodPotnRto, String revPotnRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CsqQtaPotnMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaPotnMgmtVO[]
	 */
	public CsqQtaPotnMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaPotnMgmtVO model = null;
	...
	public CsqQtaPotnMgmtVO[] getCsqQtaPotnMgmtVOs(){
		CsqQtaPotnMgmtVO[] vos = (CsqQtaPotnMgmtVO[])models.toArray(new CsqQtaPotnMgmtVO[models.size()]);
		return vos;
	}
