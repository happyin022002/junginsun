...
*@FileName : CsqQtaTgtVvdVO.java
*@FileTitle : CsqQtaTgtVvdVO
*Open Issues :
*Change history :
...
public class CsqQtaTgtVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaTgtVvdVO> models = new ArrayList<CsqQtaTgtVvdVO>();
...
/**
	 ...
	 */
	public CsqQtaTgtVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaTgtVvdVO[]
	 */
	public CsqQtaTgtVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaTgtVvdVO model = null;
	...
	public CsqQtaTgtVvdVO[] getCsqQtaTgtVvdVOs(){
		CsqQtaTgtVvdVO[] vos = (CsqQtaTgtVvdVO[])models.toArray(new CsqQtaTgtVvdVO[models.size()]);
		return vos;
	}
