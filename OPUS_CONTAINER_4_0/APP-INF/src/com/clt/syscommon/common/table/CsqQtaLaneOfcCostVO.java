...
*@FileName : CsqQtaLaneOfcCostVO.java
*@FileTitle : CsqQtaLaneOfcCostVO
*Open Issues :
*Change history :
...
public class CsqQtaLaneOfcCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaLaneOfcCostVO> models = new ArrayList<CsqQtaLaneOfcCostVO>();
...
/**
	 ...
	 */
	public CsqQtaLaneOfcCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaLaneOfcCostVO[]
	 */
	public CsqQtaLaneOfcCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaLaneOfcCostVO model = null;
		...
		return getCsqQtaLaneOfcCostVOs();
	}
	...
	public CsqQtaLaneOfcCostVO[] getCsqQtaLaneOfcCostVOs(){
		CsqQtaLaneOfcCostVO[] vos = (CsqQtaLaneOfcCostVO[])models.toArray(new CsqQtaLaneOfcCostVO[models.size()]);
		return vos;
	}
