...
*@FileName : CsqQtaNewLaneVO.java
*@FileTitle : CsqQtaNewLaneVO
*Open Issues :
*Change history :
...
public class CsqQtaNewLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqQtaNewLaneVO> models = new ArrayList<CsqQtaNewLaneVO>();
	...
	public CsqQtaNewLaneVO() {}

	public CsqQtaNewLaneVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String srcTrdCd, String srcRlaneCd, String srcDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CsqQtaNewLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqQtaNewLaneVO[]
	 */
	public CsqQtaNewLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqQtaNewLaneVO model = null;
	...
	public CsqQtaNewLaneVO[] getCsqQtaNewLaneVOs(){
		CsqQtaNewLaneVO[] vos = (CsqQtaNewLaneVO[])models.toArray(new CsqQtaNewLaneVO[models.size()]);
		return vos;
	}
