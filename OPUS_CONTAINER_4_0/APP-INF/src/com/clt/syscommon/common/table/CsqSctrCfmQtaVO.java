...
*@FileName : CsqSctrCfmQtaVO.java
*@FileTitle : CsqSctrCfmQtaVO
*Open Issues :
*Change history :
...
public class CsqSctrCfmQtaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsqSctrCfmQtaVO> models = new ArrayList<CsqSctrCfmQtaVO>();
...
/**
	 ...
	 * @param request
	 * @return CsqSctrCfmQtaVO[]
	 */
	public CsqSctrCfmQtaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsqSctrCfmQtaVO[]
	 */
	public CsqSctrCfmQtaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsqSctrCfmQtaVO model = null;
	 ...
	 * @return CsqSctrCfmQtaVO[]
	 */
	public CsqSctrCfmQtaVO[] getCsqSctrCfmQtaVOs(){
		CsqSctrCfmQtaVO[] vos = (CsqSctrCfmQtaVO[])models.toArray(new CsqSctrCfmQtaVO[models.size()]);
		return vos;
	}
