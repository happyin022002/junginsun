...
public class CodeMgmtMstVO extends AbstractValueObject {
	...
	/* Column Info */
	private String intgCdEngDesc = null;
	/* Column Info */
	...
	public CodeMgmtMstVO(String ibflag, String pagerows, String intgCdId, String ownrSubSysCd, String intgCdNm, String intgCdDesc, String intgCdEngDesc, String intgCdUseFlg, String intgCdTpNm, String intgCdLen, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		...
		this.intgCdEngDesc = intgCdEngDesc;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("intg_cd_eng_desc", getIntgCdEngDesc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("intg_cd_eng_desc", "intgCdEngDesc");
	...
	/**
	 * Column Info
	 * @return intgCdEngDesc
	 */
	public String getIntgCdEngDesc() {
		return this.intgCdEngDesc;
	}
	 ...
	 * @param intgCdDesc
	 */
	public void setIntgCdEngDesc(String intgCdEngDesc) {
		this.intgCdEngDesc = intgCdEngDesc;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIntgCdEngDesc(JSPUtil.getParameter(request, "intg_cd_eng_desc", ""));
	...
	public CodeMgmtMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] intgCdEngDesc = (JSPUtil.getParameter(request, prefix	+ "intg_cd_eng_desc".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (intgCdEngDesc[i] != null)
					model.setIntgCdEngDesc(intgCdEngDesc[i]);
				if (creUsrId[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.intgCdEngDesc = this.intgCdEngDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
