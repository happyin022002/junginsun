...
public class UserDAOComUserIbisIfCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(" COM_USER_IBIS_IF_SEQ.NEXTVAL, @[usr_id], @[usr_nm], @[usr_pwd], @[use_flg], @[mphn_no], @[fax_no], @[usr_eml], @[cnt_cd], @[lang_tp_cd],                                               " ).append("\n"); 
		...
		query.append(" @[ofc_cd] , sysdate, -1, @[if_mnpl_cd]                      " ).append("\n"); 
		query.append(")" ).append("\n"); 
