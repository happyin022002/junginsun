...
public class CodeMgmtDtlVO extends AbstractValueObject {
	...
	public CodeMgmtDtlVO(String ibflag, String pagerows, String intgCdId, String intgCdValCtnt, String intgCdValDpDesc, String intgCdValDesc, String intgCdValEngDesc, String intgCdValDpSeq, String aplyStDt, String aplyEndDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIntgCdValEngDesc(JSPUtil.getParameter(request, "intg_cd_val_eng_desc", ""));
	...
	public CodeMgmtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] intgCdValEngDesc = (JSPUtil.getParameter(request, prefix	+ "intg_cd_val_eng_desc".trim(), length));
