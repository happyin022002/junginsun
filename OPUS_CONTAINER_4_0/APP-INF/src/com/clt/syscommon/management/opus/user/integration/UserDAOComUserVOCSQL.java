...
*@FileName : UserDAOComUserVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserDAOComUserVOCSQL implements ISQLTemplate{
	...
	public UserDAOComUserVOCSQL(){
		...
		query.append("FileName : UserDAOComUserVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" @[usr_id], @[usr_nm], @[usr_pwd], @[use_flg], @[mphn_no], @[fax_no], @[usr_eml], @[cnt_cd], @[lang_tp_cd],                                               " ).append("\n"); 
		query.append(" @[gmt_tmzn_cd], @[cnt_dt_fmt_cd], @[cnt_no_fmt_cd], @[xtn_phn_no], @[jb_eng_nm], @[psn_eng_nm]," ).append("\n"); 
		query.append(" @[grd_eng_nm], @[dflt_eml], @[cre_usr_id], sysdate, @[upd_usr_id], sysdate, @[usr_locl_nm], @[usr_auth_tp_cd]," ).append("\n"); 
		query.append(" @[ofc_cd] , sysdate, -1                      " ).append("\n"); 
		query.append(")" ).append("\n"); 
