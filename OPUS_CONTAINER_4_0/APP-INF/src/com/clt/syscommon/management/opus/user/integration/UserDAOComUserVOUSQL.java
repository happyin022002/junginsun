...
public class UserDAOComUserVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(" jb_eng_nm           = @[jb_eng_nm] ,                                              " ).append("\n"); 
		query.append(" psn_eng_nm          = @[psn_eng_nm] ,                                              " ).append("\n"); 
		query.append(" grd_eng_nm          = @[grd_eng_nm] ,                                           " ).append("\n"); 
		...
		query.append(" usr_pwd_cre_dt      = to_date( @[usr_pwd_cre_dt] ,'YYYYMMDDHH24MISS'),  " ).append("\n"); 
