...
public class MailMonitoringEAIDAO extends EAIDAOSupport {
	 ...
	 */
	public String sendMail(InfoVO comEmlSndInfoVO, CtntVO ctntVO, List<AtchFileVO> atchFileVOs, List<RptDsgnXptInfoVO> rptDsgnXptInfoVOs) throws MailerAppException, CheckUtilsException, DAOException {
		Mail mail = new Mail();
