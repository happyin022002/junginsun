...
public class FAX_SENDHTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		String rvcrFromRequest = request.getParameter("rcvr_info_ctnt");
		log.debug("!!!!!REQUEST--------------->["+rvcrFromRequest+"]");
		
		FaxSendEvent event = new FaxSendEvent();
		
		ComFaxSndInfoVO comFaxSndInfoVO = (ComFaxSndInfoVO)getVO(request, ComFaxSndInfoVO .class);
		String comFaxRcvr = comFaxSndInfoVO.getRcvrInfoCtnt();
		log.debug("!!!!!Changed comFaxRcvr--------------->["+comFaxRcvr+"]");
		
		event.setComFaxSndInfoVO((ComFaxSndInfoVO)getVO(request, ComFaxSndInfoVO .class));
		String rcv = event.getComFaxSndInfoVO().getRcvrInfoCtnt();
		
		log.debug("!!!!!Changed--------------->["+rcv+"]");
