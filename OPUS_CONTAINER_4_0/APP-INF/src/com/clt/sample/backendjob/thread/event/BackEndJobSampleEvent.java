...
public class BackEndJobSampleEvent extends EventSupport {
	...
	public void setComBakEndJbVOS(List<ComBakEndJbVO> comBakEndJbVOs){
		ComBakEndJbVO[] arrayComBakEndJbVOs = new ComBakEndJbVO[comBakEndJbVOs.size()];
		this. comBakEndJbVOs = comBakEndJbVOs.toArray(arrayComBakEndJbVOs);
	}
	...
	public List<ComBakEndJbVO> getComBakEndJbVOS(){
		return Arrays.asList(comBakEndJbVOs);
	}
