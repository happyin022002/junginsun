...
public class FtpSC extends ServiceCommandSupport {
	...
	private EventResponse sendFtpRpt(Event e) throws FtpException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		FtpSendEvent event = (FtpSendEvent)e;
		SendFileBC command = new SendFileBCImpl();
		eventResponse.setETCData("KEY", command.sendFileRpt(event.getFtpMetaInfo()));
		return eventResponse;
	}
